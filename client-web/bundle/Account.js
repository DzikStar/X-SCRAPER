            ...
            const Y = c().a15648a4,
                ...
                Ce = ({ analytics: e, featureSwitches: t, onClose: n = D.Z, userClaims: s, viewerUser: c, acceptedFollowerCount: Ce, pendingFollowerCount: Ze }) => {
                    ...
                    i.useEffect(() => {
                        Ve &&
                            Se.get(Ee).then((e) => {
                                Ae(!e?.analyticsClickedV2), Le(!e?.[Ve?.key]);
                            });
                    }, [Se, Ve]);
                    const Ue = (0, $.I0)();
                    i.useEffect(() => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Account.742e90ea.js.map
