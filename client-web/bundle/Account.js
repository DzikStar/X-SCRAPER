    ...
    ["bundle.Account", "shared~loader.DashMenu~loader.DashModal"],
    {
            ...
            const Y = c().a15648a4,
                ...
                Ce = ({ analytics: e, featureSwitches: t, onClose: n = D.Z, userClaims: s, viewerUser: c, acceptedFollowerCount: Ce, pendingFollowerCount: Ze }) => {
                    ...
                    i.useEffect(() => {
                        Ne &&
                            Se.get(Ee).then((e) => {
                                Ae(!e?.analyticsClickedV2), Me(!e?.[Ne?.key]);
                            });
                    }, [Se, Ne]);
                    const Ue = (0, $.I0)();
                    i.useEffect(() => {
                    ...
                    const ze = (0, $.v9)(K.Lz),
                        ...
                        Dt = () => ({
                            ...
                            icon: T.default,
                            decoration: De && Le && Ne ? i.createElement(o.ZP, { background: "blue500" }, Ne.label) : null,
                        }),
                        Mt = { label: ue, onClick: pt("verified_organization_dashboard_item"), link: "/i/verified", icon: T.default },
                        ...
                        $t = We && !Xe,
                        jt = qe,
                        Kt = (0, M.Z)([Ut, kt, et ? Tt : void 0, ot ? Et : void 0, $t ? xt() : void 0, dt ? Nt : void 0, Re ? wt : void 0, yt, tt ? ft : void 0, jt ? (Ye ? Mt : Dt()) : void 0, at ? Ct : void 0, Ke ? bt : void 0, Ze || Ce ? vt : void 0, mt ? Zt() : void 0, It, Ft, st ? Bt : void 0, Ot ? zt : void 0, At, Pt]).filter(Be),
                        Ht = i.useContext(N.hC),
                        Wt = (0, M.Z)([Ut, O.yw.Lists > Ht && Re ? wt : void 0, O.yw.Premium > Ht && et ? Tt : void 0, O.yw.PremiumSignup > Ht && $t ? xt() : void 0, O.yw.Bookmarks > Ht ? yt : void 0, O.yw.Payments > Ht && ot ? Et : void 0, O.yw.Communities > Ht && dt ? Nt : void 0, O.yw.Articles > Ht && Je ? ft : void 0, O.yw.CommunityNotes > Ht && Ke ? bt : void 0, O.yw.Analytics > Ht && mt ? Zt() : void 0, It, O.yw.VerifiedOrgDash > Ht && jt && Ye ? Mt : void 0, (((!Ye || s.isLegacyVerifiedOrg()) && O.yw.VerifiedOrgSignup > Ht) || (s.isVerifiedOrgAffiliate() && !s.isVerifiedOrg())) && t.isTrue("blue_business_vo_nav_for_legacy_verified") ? Dt() : void 0, at ? Ct : void 0, He ? ht : void 0, Ze || Ce ? vt : void 0, Ft, O.yw.Jobs > Ht && st ? Bt : void 0, void 0, rt ? Lt : void 0, lt ? Vt : void 0, Ot ? zt : void 0, At]).filter(Be);
        ...
        64672: (e, t, n) => {
            ...
            class b extends i.Component {
                render() {
                    return i.createElement(u.Z, null, i.createElement(c.Z.Configure, { documentTitle: _, title: this._renderUserName() }, i.createElement(r.Z, { style: y.dashmenu }, i.createElement(d.Z, null))));
                }
                _renderUserName() {
        ...
        621399: (e, t, n) => {
            ...
            const O = (e, t) => {
                ...
                $ = (0, V.Z)()
                    ...
                    .propsFromActions(() => ({ playerOpen: N.eX.playerOpen, fetchUserProfileAndVideos: U.Sn }))
                                ...
                                ? (a.scribe({ element: "unfollow-button", action: "click", data: { profile_id: t.id_str } }),
                                  r({
                                      ...
                                      primaryAction: {
                                          buttonText: Y,
                                          onClick: () => {
                                              l(U.fv({ userId: t.id_str, screenName: t?.screen_name })), n();
                                          },
                                      },
                                      secondaryAction: {
                                          buttonText: J,
            ...
            const ae = p().j87c21f4,
                ...
                we = (e) => `${T.sN}.${M.rQ}.${de}.carousel-${e}`,
                ve = (e) => `${T.sN}.${M.rQ}.${de}.${ue}.video-${e}`,
                    ...
                    const $ = i.useCallback(() => {
                        ...
                        te = i.useCallback(
                            (e) => {
                                ...
                                switch (e.key) {
                                    case "ArrowUp":
                                        if (0 === t) return (0, r.setFocus)(`${T.sN}.${M.rQ}.${q}`), !0;
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Account.caa66a6a.js.map
