...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AccountAnalytics-2efd9702"],
    {
        793279: (e, s, t) => {
            t.d(s, { C: () => c });
            var a = t(552322),
                ...
                l = t(110929),
                i = t(31674);
            const o = (0, l.j)("inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-subtext3 font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden", { variants: { variant: { default: "border-transparent bg-primary text-primary-foreground [a&]:hover:bg-primary/90", secondary: "border-transparent bg-secondary text-secondary-foreground [a&]:hover:bg-secondary/90", destructive: "border-transparent bg-destructive text-white [a&]:hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40", outline: "text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground" } }, defaultVariants: { variant: "default" } });
            function c({ className: e, variant: s, asChild: t = !1, ...l }) {
                const c = t ? r.g7 : "span";
                return (0, a.jsx)(c, { "data-slot": "badge", className: (0, i.cn)(o({ variant: s }), e), ...l });
            }
        },
        917317: (e, s, t) => {
            t.d(s, { Ol: () => o, Zb: () => i, aY: () => d, ll: () => c });
            var a = t(552322),
                r = t(202784),
                l = t(31674);
            const i = r.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { ref: t, className: (0, l.cn)("rounded-xl border bg-card text-text shadow", e), ...s }));
            i.displayName = "Card";
            const o = r.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { ref: t, className: (0, l.cn)("flex flex-col space-y-1.5 p-6", e), ...s }));
            o.displayName = "CardHeader";
            const c = r.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { ref: t, className: (0, l.cn)("font-semibold leading-none tracking-tight", e), ...s }));
            c.displayName = "CardTitle";
            r.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { ref: t, className: (0, l.cn)("text-subtext2 text-gray-700", e), ...s })).displayName = "CardDescription";
            const d = r.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { ref: t, className: (0, l.cn)("p-6 pt-0", e), ...s }));
            d.displayName = "CardContent";
            r.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { ref: t, className: (0, l.cn)("flex items-center p-6 pt-0", e), ...s })).displayName = "CardFooter";
        },
        713990: (e, s, t) => {
            t.d(s, { Bw: () => f, Ph: () => n, Ql: () => g, i4: () => h, ki: () => m });
            var a = t(552322),
                r = t(734670),
                l = t(202784),
                i = t(31674),
            ...
            const n = r.fC,
                m = (r.ZA, r.B4),
                h = l.forwardRef(({ children: e, className: s, ...t }, l) => (0, a.jsxs)(r.xz, { ref: l, className: (0, i.cn)("bg-background ring-offset-background focus:ring-primary flex h-10 w-full items-center justify-between rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-gray-700 [&>span]:line-clamp-1", s), ...t, children: [e, (0, a.jsx)(r.JO, { asChild: !0, children: (0, a.jsx)(o.Z, { className: "ml-2 h-4 w-4 opacity-50" }) })] }));
            h.displayName = r.xz.displayName;
            const x = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)(r.u_, { ref: t, className: (0, i.cn)("flex cursor-default items-center justify-center py-1", e), ...s, children: (0, a.jsx)(c.Z, { className: "h-4 w-4" }) }));
            x.displayName = r.u_.displayName;
            const v = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)(r.$G, { ref: t, className: (0, i.cn)("flex cursor-default items-center justify-center py-1", e), ...s, children: (0, a.jsx)(o.Z, { className: "h-4 w-4" }) }));
            v.displayName = r.$G.displayName;
            const f = l.forwardRef(({ children: e, className: s, position: t = "popper", ...l }, o) => (0, a.jsx)(r.h_, { children: (0, a.jsxs)(r.VY, { ref: o, className: (0, i.cn)("bg-background text-text data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-lg border shadow-md", "popper" === t && "data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1", s), position: t, ...l, children: [(0, a.jsx)(x, {}), (0, a.jsx)(r.l_, { className: (0, i.cn)("p-1", "popper" === t && "h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]"), children: e }), (0, a.jsx)(v, {})] }) }));
            f.displayName = r.VY.displayName;
            l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)(r.__, { ref: t, className: (0, i.cn)("py-1.5 pl-8 pr-2 text-sm font-semibold", e), ...s })).displayName = r.__.displayName;
            const g = l.forwardRef(({ children: e, className: s, showIndicator: t = !0, ...l }, o) => (0, a.jsxs)(r.ck, { ref: o, className: (0, i.cn)("focus:bg-gray-0 focus:text-text relative flex w-full cursor-pointer select-none items-center rounded py-1.5 pl-8 pr-2 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50", s), ...l, children: [t && (0, a.jsx)("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: (0, a.jsx)(r.wU, { children: (0, a.jsx)(d.Z, { className: "h-4 w-4" }) }) }), (0, a.jsx)(r.eT, { children: e })] }));
            g.displayName = r.ck.displayName;
            l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)(r.Z0, { ref: t, className: (0, i.cn)("bg-muted -mx-1 my-1 h-px", e), ...s })).displayName = r.Z0.displayName;
        },
        199705: (e, s, t) => {
            t.d(s, { RM: () => c, SC: () => n, iA: () => i, pj: () => h, ss: () => m, xD: () => o, yt: () => d });
            var a = t(552322),
                r = t(31674),
                l = t(202784);
            const i = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("div", { className: "relative w-full overflow-auto", children: (0, a.jsx)("table", { ref: t, className: (0, r.cn)("text-subtext1 w-full caption-bottom", e), ...s }) }));
            i.displayName = "Table";
            const o = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("thead", { ref: t, className: (0, r.cn)("[&_tr]:border-b", e), ...s }));
            o.displayName = "TableHeader";
            const c = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("tbody", { ref: t, className: (0, r.cn)("[&_tr:last-child]:border-0", e), ...s }));
            c.displayName = "TableBody";
            const d = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("tfoot", { ref: t, className: (0, r.cn)("border-t bg-gray-100/50 font-medium [&>tr]:last:border-b-0", e), ...s }));
            d.displayName = "TableFooter";
            const n = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("tr", { ref: t, className: (0, r.cn)("border-b transition-colors hover:bg-gray-100/50 data-[state=selected]:bg-gray-100", e), ...s }));
            n.displayName = "TableRow";
            const m = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("th", { ref: t, className: (0, r.cn)("h-12 px-4 text-left align-middle font-medium text-gray-700 [&:has([role=checkbox])]:pr-0", e), ...s }));
            m.displayName = "TableHead";
            const h = l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("td", { ref: t, className: (0, r.cn)("p-4 align-middle [&:has([role=checkbox])]:pr-0", e), ...s }));
            h.displayName = "TableCell";
            l.forwardRef(({ className: e, ...s }, t) => (0, a.jsx)("caption", { ref: t, className: (0, r.cn)("text-subtext1 mt-4 text-gray-700", e), ...s })).displayName = "TableCaption";
        },
        476865: (e, s, t) => {
            t.d(s, { SP: () => c, dr: () => o, mQ: () => i, nU: () => d });
            var a = t(552322),
                r = t(362834),
                l = t(31674);
            function i({ className: e, ...s }) {
                return (0, a.jsx)(r.fC, { "data-slot": "tabs", className: (0, l.cn)("flex flex-col gap-2", e), ...s });
            }
            function o({ className: e, ...s }) {
                return (0, a.jsx)(r.aV, { "data-slot": "tabs-list", className: (0, l.cn)("bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-1", e), ...s });
            }
            ...
            function d({ className: e, ...s }) {
                return (0, a.jsx)(r.VY, { "data-slot": "tabs-content", className: (0, l.cn)("flex-1 outline-none", e), ...s });
            }
        },
        697250: (e, s, t) => {
            t.d(s, { Z: () => r });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AccountAnalytics-2efd9702.ee7dcaca.js.map
