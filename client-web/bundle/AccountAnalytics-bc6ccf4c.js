...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AccountAnalytics-bc6ccf4c", "icons/IconAccessibilityCircle-js", "icons/IconChevronRight-js", "icons/IconHeartStroke-js"],
    {
        247291: (e, t, r) => {
            r.d(t, { Z: () => O });
            r(136728);
            ...
            const m = Object.freeze({ large: 54, medium: 46, small: 36, xSmall: 12 }),
                ...
                h = ({ color: e = "blue500", label: t, size: r = "large", value: o }) => {
                    const n = o ? r : "xSmall",
                        ...
                        u = `0 0 6 ${i}`;
                    return l.createElement(a.Z, { style: p.row }, l.createElement(a.Z, { style: [p.svg, { height: i }, !s && { marginTop: d.default.theme.spaces.space2 }] }, l.createElement("svg", { height: "100%", preserveAspectRatio: "none", viewBox: u, width: "100%" }, l.createElement("rect", { fill: d.default.theme.colors[e], height: i, rx: 3, width: 6 }))), l.createElement(a.Z, { style: p.column }, l.createElement(c.ZP, { color: "gray700", size: "subtext2", style: p.title, weight: "medium" }, t), s && l.createElement(c.ZP, { size: s, weight: "bold" }, o)));
                };
            var g = r(635998),
                b = r(689107),
                f = r(154003);
            ...
            const Z = (e) => {
                ...
                z = ({ arcWidth: e, chartId: t, data: r, radius: o }) => {
                    const n = l.useRef(Array.from({ length: r.length }, () => null)),
                        ...
                        { a11yViews: x, circles: z } = l.useMemo(() => {
                            ...
                            return (
                                r.forEach(({ color: i, label: u, popover: f, value: y }, E) => {
                                    const Z = u ? I({ value: B(y), label: u }) : M({ value: B(y) }),
                                        x = v && g !== E ? 0.5 : 1,
                                        D = f ? "pointer" : "default";
                                    var z;
                                    o.push(l.createElement("circle", { cx: m, cy: m, fill: "none", key: u ?? E, onBlur: b, onFocus: () => C(E), onMouseLeave: b, onMouseOver: () => C(E), r: s, stroke: d.default.theme.colors[i ?? P], strokeDasharray: k(p, y, E === r.length - 1), strokeDashoffset: S(p, e), strokeWidth: c, style: { opacity: x, cursor: D } })),
                                        t.push(
                                            l.createElement(a.Z, {
                                                "aria-label": Z,
                                                focusable: 0 === E,
                        ...
                        }, [r, v, g, m, b, s, p, c, w, C, h]),
                        R = (null !== g && r[g].popover) || null;
                    return l.createElement(u.Z, { contentStyle: { minWidth: 0 }, disabled: f, enableEnterKeyToggle: !!R, enableHover: !0, hoverDelay: "short", onHoverCardUnmount: y, onOpen: E, preferredVerticalOrientation: "up", renderContent: () => R }, l.createElement(a.Z, { "aria-label": D, focusable: !1, id: t, role: "application" }, l.createElement("svg", { height: i, onFocus: Z, onMouseOver: Z, style: { transform: "rotate(-90deg)" }, width: i }, z), x));
                },
                R = d.default.create((e) => ({ pie: { display: "flex", alignItems: "center" }, legend: { gap: e.spaces.space24 }, titleBar: { display: "flex", flexDirection: "row", alignItems: "center", marginBottom: e.spaces.space20 }, title: { paddingVertical: e.spaces.space12 } })),
                O = ({ arcWidth: e = 0.4, data: t, legendPosition: r, radius: o, title: n, titleDescription: u }) => {
                    ...
                    return l.createElement(a.Z, { "aria-labelledby": d, role: "figure" }, n && l.createElement(a.Z, { style: R.titleBar }, l.createElement(c.ZP, { "aria-level": 1, role: "heading", size: "headline1", style: R.title, weight: "heavy" }, n), u ? l.createElement(g.Z, { label: n, popover: u }) : null, l.createElement(Z, { chartTitle: n, maxValue: x, minValue: C, noOfCategories: t.length })), l.createElement(a.Z, { style: I.container }, f && l.createElement(a.Z, { style: [R.legend, I.legend] }, S), l.createElement(a.Z, { onLayout: v, style: [R.pie, I.pie] }, l.createElement(z, { arcWidth: e, chartId: d, data: k, radius: p }))));
                };
        },
        98996: (e, t, r) => {
            r.d(t, { Z: () => p });
            ...
            const m = s.default.create((e) => ({ chart: { display: "flex", flex: 1 }, popover: { minWidth: 0 } })),
                p = (e) => {
                    const { barConfig: t, data: r, style: o } = e,
                        { normalizer: n, valueLabelsFormatter: s } = (function (e, t) {
                        ...
                        p = u({ minValue: s(Math.min(...r.map((e) => e.value)) / n), maxValue: s(Math.max(...r.map((e) => e.value)) / n) }),
        ...
        536606: (e, t, r) => {
            ...
            const u = (e) => {
                const { decoration: t, isCompact: r, progressBarConfig: u, statConfig: m, title: p, valueCurrent: h, valueMax: g } = e,
                    b = (0, n.F)(),
                    f = ((v = u), s.default.theme.colors[v?.color || "blue900"]);
                var v;
                const y = (function (e) {
                ...
                return l.createElement(a.Z, { style: d.root }, l.createElement(a.Z, { style: d.decoration }, t), l.createElement(a.Z, { style: d.title }, l.createElement(o.ZP, { size: "subtext2", weight: "medium" }, p)), l.createElement(a.Z, { id: b, style: d.valueLabel }, m.value ? l.createElement(c.Z, null, l.createElement(c.Z.Value, null, m.value), l.createElement(c.Z.Label, null, m.label)) : l.createElement(o.ZP, { weight: "bold" }, m.label)), l.createElement(a.Z, { style: r ? d.progressBarContainerCompact : d.progressBarContainer, testID: "progressBarStats-progressBarContainer" }, l.createElement(i.Z, { "aria-describedby": b, "aria-valuemax": g, colorValue: f, progress: h / g, progressStyle: y, style: E })));
            };
        ...
        98538: (e, t, r) => {
            ...
            (d.Group = (e) =>
                ...
                (d.Label = ({ children: e, style: t }) => l.createElement(u.Consumer, null, ({ onMedia: r }) => l.createElement(o.ZP, { children: e, color: r ? "white" : "gray700", size: s, style: t }))),
                (d.Value = ({ animated: e, children: t, count: r, style: a, weight: n = "bold" }) => l.createElement(u.Consumer, null, ({ onMedia: c }) => (e ? l.createElement(i.ZP, { children: t, count: r, size: s, style: a, weight: n }) : l.createElement(o.ZP, { children: t, color: c ? "white" : "text", size: s, style: a, weight: n }))));
                            ...
                            l.createElement(
                                ...
                                d.map((e, r) =>
                                    l.createElement(
                                        ...
                                        t.map((t, a) => l.createElement("td", { key: `${r}-${a}`, style: m.cell }, l.createElement(s.ZP, null, e[t.field]))),
                                    ),
                                ),
                            ),
                        ),
        ...
        58399: (e, t, r) => {
            ...
            const c = (e = {}) => {
                const t = l.useContext(n.Z),
                    { direction: r } = (0, o.Z)();
                return (0, a.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [i.Z.root, e.style, t && i.Z.iconRTL], viewBox: "0 0 24 24", children: l.createElement("g", null, l.createElement("path", { d: "M14.586 12L7.543 4.96l1.414-1.42L17.414 12l-8.457 8.46-1.414-1.42L14.586 12z" })) }, { writingDirection: r });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AccountAnalytics-bc6ccf4c.320a1e8a.js.map
