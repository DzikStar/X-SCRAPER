    ...
    ["bundle.AccountAnalytics-bda42643"],
    {
        481899: (e, s, t) => {
            ...
            function p() {
                ...
                return (0, a.jsxs)("div", {
                    className: (0, o.cn)("relative overflow-hidden", "w-full h-full max-w-[1024px] min-h-[3em] rounded-xl p-4 shadow-lg flex flex-col", "text-white"),
                    children: [
                        (0, a.jsx)("div", { className: (0, o.cn)("absolute inset-0 z-[-1]", "bg-gradient-to-b from-[#a17dff] to-[#8a65f2]", f && ["before:content-['']", "before:absolute before:inset-0", "before:bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))]", "before:from-magenta-500/40", "before:to-transparent", "before:pointer-events-none"]) }),
                        (0, a.jsxs)("div", {
                            className: "flex items-center mb-2",
                            children: [
                                (0, a.jsxs)("div", { className: "flex items-center gap-1 flex-1 mr-2", children: [(0, a.jsx)(n.q, { url: t?.profileImageUrl, size: "medium" }), (0, a.jsx)(l.R, { name: t?.name || s.Unknown, badges: { verifiedType: t?.verifiedType, affiliation: t?.badge ? { label: t.badge.description || "", url: t.badge.url || "" } : void 0 }, withLink: "external", color: "white", size: "body" }), (0, a.jsx)("div", { className: "bg-white/35 text-white ml-1 px-2 py-1 rounded-md font-medium text-subtext1", children: s.Host }), 2 === e?.narrowCastSpaceType && (0, a.jsx)(h.O, { label: s.subscriberOnly, children: (0, a.jsx)("div", { className: "ml-1", children: (0, a.jsx)(u.Z, { className: "size-5 text-white" }) }) })] }),
                                (0, a.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        e &&
                                            (0, a.jsx)("button", {
                                                type: "button",
                                                className: (0, o.cn)("size-8 rounded-full border border-white/50 text-white bg-white/10 flex justify-center items-center transition-colors hover:bg-white/20"),
                                                onClick: (s) => {
                        ...
                        (0, a.jsxs)("div", { className: (0, o.cn)("text-subtext1 font-normal", e?.start && "max-[987px]:flex max-[987px]:justify-between max-[987px]:items-center"), children: [e?.scheduledStart && "Running" !== e.state && "Ended" !== e.state ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)("span", { className: "font-medium", children: [s.ScheduledFor, " "] }), p(e.scheduledStart)] }) : e?.start ? (0, a.jsx)("span", { children: p(e.start) }) : "", e?.duration && (0, a.jsxs)("div", { className: "flex items-center gap-1 min-[988px]:hidden", children: [(0, a.jsx)(d.Z, { className: "size-3.5" }), (0, a.jsx)("span", { children: (0, m.LU)(e.duration) })] })] }),
                        e?.duration && (0, a.jsxs)("div", { className: "hidden min-[988px]:flex items-center gap-1 mt-auto ml-auto text-subtext1 font-normal", children: [(0, a.jsx)(d.Z, { className: "size-3.5" }), (0, a.jsx)("span", { children: (0, m.LU)(e.duration) })] }),
                    ],
                });
            }
            var f = t(917317);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AccountAnalytics-bda42643.3479c45a.js.map
