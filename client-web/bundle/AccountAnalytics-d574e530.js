...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AccountAnalytics-d574e530"],
    {
        734670: (e, t, n) => {
            n.d(t, { $G: () => Ue, B4: () => Ee, JO: () => Ne, VY: () => We, Z0: () => ze, ZA: () => Oe, __: () => Ae, ck: () => He, eT: () => Be, fC: () => Ie, h_: () => Ve, l_: () => Le, u_: () => Fe, wU: () => Ke, xz: () => De });
            var o = n(202784),
                r = n(928316),
                l = n(380106),
                a = n(395656),
                ...
                H = (e) => {
                    const { __scopeSelect: t, children: n, open: r, defaultOpen: l, onOpenChange: a, value: i, defaultValue: s, onValueChange: c, dir: u, name: p, autoComplete: f, disabled: m, required: g, form: w } = e,
                        ...
                        [P, j] = o.useState(!1),
                        k = (0, d.gm)(u),
                        [M = !1, I] = (0, y.T)({ prop: r, defaultProp: l, onChange: a }),
                    ...
                    return (0, T.jsx)(v.fC, {
                        ...
                        children: (0, T.jsxs)(W, {
                            ...
                            children: [
                                ...
                                L ? (0, T.jsxs)(ke, { "aria-hidden": !0, required: g, tabIndex: -1, name: p, autoComplete: f, value: D, onChange: (e) => E(e.target.value), disabled: m, form: w, children: [void 0 === D ? (0, T.jsx)("option", { value: "" }) : null, Array.from(A)] }, B) : null,
                            ],
                        }),
                    });
                };
                ...
                K = o.forwardRef((e, t) => {
                    ...
                    return (0, T.jsx)(v.ee, {
                        ...
                        children: (0, T.jsx)(g.WV.button, {
                            ...
                            "data-placeholder": je(c.value) ? "" : void 0,
                            ...l,
                            ref: u,
                            ...
                            onKeyDown: (0, a.M)(l.onKeyDown, (e) => {
                                const t = "" !== h.current;
                                e.ctrlKey || e.altKey || e.metaKey || 1 !== e.key.length || m(e.key), (t && " " === e.key) || (j.includes(e.key) && (x(), e.preventDefault()));
                            }),
                        }),
                    });
                });
            ...
            var F = "SelectValue",
                U = o.forwardRef((e, t) => {
                    ...
                    return (
                        ...
                        (0, T.jsx)(g.WV.span, { ...i, ref: p, style: { pointerEvents: "none" }, children: je(c.value) ? (0, T.jsx)(T.Fragment, { children: a }) : l })
                    );
                });
            U.displayName = F;
            ...
            var X = 10,
                [G, $] = E(Y),
                J = o.forwardRef((e, t) => {
                    const { __scopeSelect: n, position: r = "item-aligned", onCloseAutoFocus: l, onEscapeKeyDown: i, onPointerDownOutside: c, side: d, sideOffset: h, align: v, alignOffset: m, arrowPadding: g, collisionBoundary: x, collisionPadding: y, sticky: S, hideWhenDetached: b, avoidCollisions: C, ...j } = e,
                        k = L(Y, n),
                        [M, R] = o.useState(null),
                        [D, E] = o.useState(null),
                        N = (0, s.e)(t, (e) => R(e)),
                    ...
                    const U = o.useCallback(
                        ...
                        z = o.useCallback(() => U([V, M]), [U, V, M]);
                    o.useEffect(() => {
                        B && z();
                    }, [B, z]);
                    const { onOpenChange: q, triggerPointerDownPosRef: Z } = k;
                    o.useEffect(() => {
                        if (M) {
                            let e = { x: 0, y: 0 };
                            const t = (t) => {
                                ...
                                n = (n) => {
                                    e.x <= 10 && e.y <= 10 ? n.preventDefault() : M.contains(n.target) || q(!1), document.removeEventListener("pointermove", t), (Z.current = null);
                                };
                            return (
                    ...
                    const [X, $] = Me((e) => {
                        ...
                        J = o.useCallback(
                            (e, t, n) => {
                                const o = !F.current && !n;
                                ((void 0 !== k.value && k.value === t) || o) && (W(e), o && (F.current = !0));
                            },
                            [k.value],
                        ),
                        te = o.useCallback(() => M?.focus(), [M]),
                        ne = o.useCallback(
                            (e, t, n) => {
                                const o = !F.current && !n;
                                ((void 0 !== k.value && k.value === t) || o) && A(e);
                            },
                            [k.value],
                        ),
                        oe = "popper" === r ? ee : Q,
                            ...
                            children: (0, T.jsx)(f.M, {
                                ...
                                children: (0, T.jsx)(u.XB, {
                                    ...
                                    children: (0, T.jsx)(oe, {
                                        ...
                                        onPlaced: () => K(!0),
                                        ref: N,
                                        style: { display: "flex", flexDirection: "column", outline: "none", ...j.style },
                                        onKeyDown: (0, a.M)(j.onKeyDown, (e) => {
            ...
            var Q = o.forwardRef((e, t) => {
                        ...
                        if (i.trigger && i.valueNode && d && p && x && y && b) {
                            ...
                            if (M <= T) {
                                ...
                                const t = p.clientHeight - x.offsetTop - x.offsetHeight,
                                    n = M + Math.max(j, k + (e ? P : 0) + t + g);
                                d.style.height = n + "px";
                            } else {
                                const e = a.length > 0 && y === a[0].ref.current;
                                d.style.top = "0px";
                                const t = Math.max(T, f + x.offsetTop + (e ? _ : 0) + k) + R;
                                (d.style.height = t + "px"), (x.scrollTop = M - T + x.offsetTop);
                            }
                ...
                return (0, T.jsx)(te, { scope: n, contentWrapper: d, shouldExpandOnScrollRef: m, onScrollButtonChange: k, children: (0, T.jsx)("div", { ref: u, style: { display: "flex", flexDirection: "column", position: "fixed", zIndex: P }, children: (0, T.jsx)(g.WV.div, { ...a, ref: h, style: { boxSizing: "border-box", maxHeight: "100%", ...a.style } }) }) });
            });
                        ...
                        children: (0, T.jsx)(R.ItemSlot, {
                            ...
                            children: (0, T.jsx)(g.WV.div, {
                                ...
                                onKeyDown: (0, a.M)(c.onKeyDown, (e) => {
                                    ("" !== u.searchRef?.current && " " === e.key) || (k.includes(e.key) && b(), " " === e.key && e.preventDefault());
                                }),
                            }),
                        }),
                    });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AccountAnalytics-d574e530.33af5d8a.js.map
