...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AccountAnalytics-e907d115"],
    {
        247291: (e, t, r) => {
            r.d(t, { Z: () => A });
            r(136728);
            ...
            const m = Object.freeze({ large: 54, medium: 46, small: 36, xSmall: 12 }),
                ...
                b = ({ color: e = "blue500", label: t, size: r = "large", value: a }) => {
                    const n = a ? r : "xSmall",
                        ...
                        u = `0 0 6 ${s}`;
                    return l.createElement(o.Z, { style: p.row }, l.createElement(o.Z, { style: [p.svg, { height: s }, !i && { marginTop: d.default.theme.spaces.space2 }] }, l.createElement("svg", { height: "100%", preserveAspectRatio: "none", viewBox: u, width: "100%" }, l.createElement("rect", { fill: d.default.theme.colors[e], height: s, rx: 3, width: 6 }))), l.createElement(o.Z, { style: p.column }, l.createElement(c.ZP, { color: "gray700", size: "subtext2", style: p.title, weight: "medium" }, t), i && l.createElement(c.ZP, { size: i, weight: "bold" }, a)));
                };
            var f = r(635998),
                h = r(689107),
                g = r(154003);
            ...
            const x = (e) => {
                    const { chartTitle: t, maxValue: r, minValue: a, noOfCategories: n } = e,
                        s = w({ chartTitle: t, minValue: a, maxValue: r, noOfCategories: y(n) });
                    return l.createElement(o.Z, null, l.createElement(u.Z, { enableEnterKeyToggle: !0, preferredVerticalOrientation: "up", renderContent: (e) => l.createElement(o.Z, { "aria-label": s, role: "dialog", style: Z.popover }, l.createElement(o.Z, { style: Z.popoverTitle }, l.createElement(c.ZP, { size: "title3", weight: "heavy" }, E)), l.createElement(o.Z, { style: Z.popoverText }, l.createElement(c.ZP, { color: "gray700", size: "body", weight: "normal" }, s)), l.createElement(g.ZP, { onPress: e, type: "primaryOutlined" }, C)), withArrow: !0 }, l.createElement(o.Z, { role: "button" }, l.createElement(h.default, { "aria-label": v, style: Z.a11yIcon }))));
                },
                ...
                O = n().ef8b2f54,
                P = "blue500",
                M = ({ arcWidth: e, chartId: t, data: r, radius: a }) => {
                    const n = l.useRef(Array.from({ length: r.length }, () => null)),
                        ...
                        { a11yViews: Z, circles: M } = l.useMemo(() => {
                            let e = 0;
                            const t = [],
                                a = [];
                            return (
                                r.forEach(({ color: s, label: u, popover: g, value: v }, E) => {
                                    const x = u ? D({ value: I(v), label: u }) : B({ value: I(v) }),
                                        Z = y && f !== E ? 0.5 : 1,
                                        O = g ? "pointer" : "default";
                                    var M;
                                    a.push(l.createElement("circle", { cx: m, cy: m, fill: "none", key: u ?? E, onBlur: h, onFocus: () => C(E), onMouseLeave: h, onMouseOver: () => C(E), r: i, stroke: d.default.theme.colors[s ?? P], strokeDasharray: k(p, v, E === r.length - 1), strokeDashoffset: S(p, e), strokeWidth: c, style: { opacity: Z, cursor: O } })),
                                        t.push(
                                            l.createElement(o.Z, {
                                                "aria-label": x,
                                                focusable: 0 === E,
                        ...
                        }, [r, y, f, m, h, i, p, c, w, C, b]),
                        $ = (null !== f && r[f].popover) || null;
                    return l.createElement(u.Z, { contentStyle: { minWidth: 0 }, disabled: g, enableEnterKeyToggle: !!$, enableHover: !0, hoverDelay: "short", onHoverCardUnmount: v, onOpen: E, preferredVerticalOrientation: "up", renderContent: () => $ }, l.createElement(o.Z, { "aria-label": O, focusable: !1, id: t, role: "application" }, l.createElement("svg", { height: s, onFocus: x, onMouseOver: x, style: { transform: "rotate(-90deg)" }, width: s }, M), Z));
                },
                ...
                A = ({ arcWidth: e = 0.4, data: t, legendPosition: r, radius: a, title: n, titleDescription: u }) => {
                    const d = (0, i.b)(),
                        ...
                        S = l.useMemo(() => (g ? k.map(({ color: e, label: t, value: r }, o) => l.createElement(b, { color: e ?? P, key: t, label: t ?? "", size: "small", value: I(r) })) : []), [k, g]),
                        D = ((e, t, r) => {
                            switch (t) {
                                case "right":
                    ...
                    return l.createElement(o.Z, { "aria-labelledby": d, role: "figure" }, n && l.createElement(o.Z, { style: $.titleBar }, l.createElement(c.ZP, { "aria-level": 1, role: "heading", size: "headline1", style: $.title, weight: "heavy" }, n), u ? l.createElement(f.Z, { label: n, popover: u }) : null, l.createElement(x, { chartTitle: n, maxValue: Z, minValue: C, noOfCategories: t.length })), l.createElement(o.Z, { style: D.container }, g && l.createElement(o.Z, { style: [$.legend, D.legend] }, S), l.createElement(o.Z, { onLayout: y, style: [$.pie, D.pie] }, l.createElement(M, { arcWidth: e, chartId: d, data: k, radius: p }))));
                };
        },
        661810: (e, t, r) => {
            r.d(t, { Z: () => n });
            ...
            function n({ spacing: e, style: t }) {
                return l.createElement(o.Z, { role: "separator", style: [s.divider, { marginVertical: null != e ? a.default.theme.spaces[e] : void 0 }, t] });
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AccountAnalytics-e907d115.1409f55a.js.map
