            ...
            const g = p.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                _ = ({ actionPrimary: e, actionSecondary: t, children: n, headline: _, icon: y, iconColor: h, image: b, onDismiss: k, shouldDisplay: f, text: v, withMask: w = !0 }) => {
                    const [T, x] = a.useState(!1),
                        ...
                        C = (n) => a.createElement(l.Z, { style: [g.root, b && g.rootWithImage] }, Z(), a.createElement(l.Z, { style: g.container }, K(), S(), E({ action: e, dismiss: n, type: t && "primaryFilled" }), E({ action: t, dismiss: n }))),
                        Z = () => {
        ...
        403556: (e, t, n) => {
            ...
            class v extends l.Component {
                ...
                render() {
                    ...
                    return l.createElement(h.Z, { "aria-label": t, "aria-selected": C, focusable: !!C, interactiveStyles: Z, link: L, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? w.pill : w.link, u && C ? w.active : null, d ? (u ? w.compactPill : w.compactLink) : null, m ? w.roundedRect : null, T], withoutInteractiveStyles: _ || u }, ({ isFocused: t, isHovered: c }) => l.createElement(o.Z, { style: u && w.flexGrow }, l.createElement(p.ZP, { size: _ ? "headline2" : void 0, style: [w.text, { color: this._getTextColor(C, c, _, u) }, d && w.compactText, _ && t && w.focusedText], weight: K }, e && l.createElement(e, { style: w.icon }), i, _ || u ? null : l.createElement(o.Z, { style: C && [w.border, { backgroundColor: s.default.theme.colors[r] }] })), n ? l.createElement(g.Z, { count: n, standalone: !0, style: [w.badge, n >= 10 && w.multiDigitBadge, n >= 20 && w.truncatedCountBadge], truncatedCountFormatter: f, unreadCountLabel: b, withBorder: !1 }) : a ? l.createElement(g.Z, { pip: !0, standalone: !0, style: w.badgePip, textColor: "red500", unreadCountLabel: k, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-6107ac1a.c014715a.js.map
