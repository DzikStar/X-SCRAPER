    ...
    ["bundle.Articles-6107ac1a"],
    {
                                                ...
                                                selections: [
                                                    {
                                                        ...
                                                        selections: [
                                                            ...
                                                            { alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "author_results", plural: !1, selections: [{ alias: null, args: null, concreteType: null, kind: "LinkedField", name: "result", plural: !1, selections: [r, { kind: "InlineFragment", selections: [s, o], type: "User", abstractKey: null }], storageKey: null }, o], storageKey: null },
                                                        ],
                                                        storageKey: null,
                                                    },
                                                    o,
            ...
            const g = p.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                _ = ({ actionPrimary: e, actionSecondary: t, children: n, headline: _, icon: y, iconColor: h, image: b, onDismiss: k, shouldDisplay: f, text: v, withMask: w = !0 }) => {
                    const [T, x] = a.useState(!1),
                        F = (e) => a.createElement(u.Z, { onDismiss: R, renderContent: () => C(R), switchOnlyOnXSmallBreakpoint: !0, visibilityBehavior: i.J.forceVisible, withArrow: !0, withFixedPosition: !0, withMask: w }, e),
                        L = () => a.createElement(m.Z, { onMaskClick: () => R(), type: "center", withMask: !0 }, C(R)),
                        C = (n) => a.createElement(l.Z, { style: [g.root, b && g.rootWithImage] }, S(), a.createElement(l.Z, { style: g.container }, K(), E(), Z({ action: e, dismiss: n, type: t && "primaryFilled" }), Z({ action: t, dismiss: n }))),
                        S = () => {
                        ...
                        E = () => a.createElement(r.ZP, { color: "gray700", style: g.description }, v),
        ...
        403556: (e, t, n) => {
            ...
            class v extends l.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: a, children: i, color: s, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: m, isWebRedesign: _, retainScrollPosition: v, style: T, to: x } = this.props,
                        { location: F } = this.state,
                        L = x ? this._getMemoizedLink(x, v) : void 0,
                    ...
                    return l.createElement(h.Z, { "aria-label": t, "aria-selected": C, focusable: !!C, interactiveStyles: S, link: L, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? w.pill : w.link, u && C ? w.active : null, d ? (u ? w.compactPill : w.compactLink) : null, m ? w.roundedRect : null, T], withoutInteractiveStyles: _ || u }, ({ isFocused: t, isHovered: c }) => l.createElement(o.Z, { style: u && w.flexGrow }, l.createElement(p.ZP, { size: _ ? "headline2" : void 0, style: [w.text, { color: this._getTextColor(C, c, _, u) }, d && w.compactText, _ && t && w.focusedText], weight: K }, e && l.createElement(e, { style: w.icon }), i, _ || u ? null : l.createElement(o.Z, { style: C && [w.border, { backgroundColor: r.default.theme.colors[s] }] })), n ? l.createElement(g.Z, { count: n, standalone: !0, style: [w.badge, n >= 10 && w.multiDigitBadge, n >= 20 && w.truncatedCountBadge], truncatedCountFormatter: f, unreadCountLabel: b, withBorder: !1 }) : a ? l.createElement(g.Z, { pip: !0, standalone: !0, style: w.badgePip, textColor: "red500", unreadCountLabel: k, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-6107ac1a.f6e9a26a.js.map
