            ...
            const g = p.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                _ = ({ actionPrimary: e, actionSecondary: t, children: n, headline: _, icon: y, iconColor: b, image: h, onDismiss: k, shouldDisplay: f, text: w, withMask: v = !0 }) => {
                    const [T, x] = a.useState(!1),
                        L = (e) => a.createElement(u.Z, { onDismiss: E, renderContent: () => C(E), switchOnlyOnXSmallBreakpoint: !0, visibilityBehavior: i.J.forceVisible, withArrow: !0, withFixedPosition: !0, withMask: v }, e),
                        F = () => a.createElement(m.Z, { onMaskClick: () => E(), type: "center", withMask: !0 }, C(E)),
                        C = (n) => a.createElement(l.Z, { style: [g.root, h && g.rootWithImage] }, K(), a.createElement(l.Z, { style: g.container }, S(), Z(), R({ action: e, dismiss: n, type: t && "primaryFilled" }), R({ action: t, dismiss: n }))),
                        K = () => {
                        ...
                        R = ({ action: e, dismiss: t, type: n }) => e && a.createElement(c.ZP, { link: e.link && e.link, onPress: e.onClick ? e.onClick : t, size: "large", style: g.actionButton, type: n }, e.text),
                        E = () => {
                            k && k(), x(!0);
                        };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-6107ac1a.65fc894a.js.map
