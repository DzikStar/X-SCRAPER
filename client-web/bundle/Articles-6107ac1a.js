            ...
            const g = p.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                _ = ({ actionPrimary: e, actionSecondary: n, children: t, headline: _, icon: y, iconColor: b, image: k, onDismiss: h, shouldDisplay: f, text: w, withMask: v = !0 }) => {
                    const [T, x] = a.useState(!1),
                        ...
                        C = (t) => a.createElement(l.Z, { style: [g.root, k && g.rootWithImage] }, S(), a.createElement(l.Z, { style: g.container }, K(), R(), Z({ action: e, dismiss: t, type: n && "primaryFilled" }), Z({ action: n, dismiss: t }))),
                        S = () => {
        ...
        403556: (e, n, t) => {
            ...
            class w extends l.Component {
                ...
                render() {
                    ...
                    return l.createElement(b.Z, { "aria-label": n, "aria-selected": C, focusable: !!C, interactiveStyles: S, link: L, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? v.pill : v.link, u && C ? v.active : null, d ? (u ? v.compactPill : v.compactLink) : null, m ? v.roundedRect : null, T], withoutInteractiveStyles: _ || u }, ({ isFocused: n, isHovered: c }) => l.createElement(o.Z, { style: u && v.flexGrow }, l.createElement(p.ZP, { size: _ ? "headline2" : void 0, style: [v.text, { color: this._getTextColor(C, c, _, u) }, d && v.compactText, _ && n && v.focusedText], weight: K }, e && l.createElement(e, { style: v.icon }), i, _ || u ? null : l.createElement(o.Z, { style: C && [v.border, { backgroundColor: r.default.theme.colors[s] }] })), t ? l.createElement(g.Z, { count: t, standalone: !0, style: [v.badge, t >= 10 && v.multiDigitBadge, t >= 20 && v.truncatedCountBadge], truncatedCountFormatter: f, unreadCountLabel: k, withBorder: !1 }) : a ? l.createElement(g.Z, { pip: !0, standalone: !0, style: v.badgePip, textColor: "red500", unreadCountLabel: h, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-6107ac1a.a33ed1ba.js.map
