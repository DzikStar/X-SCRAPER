    ...
    ["bundle.Articles-a2dee9c7"],
    {
            ...
            class p extends i.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: n, fixed: r, hideBackButton: o, isFullWidth: a, isLarge: c, leftControl: d, middleControl: p, position: _, rightControl: m, secondaryBar: b, style: g, subtitle: h, title: y, titleDomId: w, titleIconCell: f, titleIconCellSize: k, withBackground: v, withWideContainer: E } = this.props,
                        ...
                        C = o ? d : i.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        F = (function (e, t, n) {
                            return e && !(t && n);
                        })(!!v, T, !!b);
                    return i.createElement(i.Fragment, null, i.createElement(s.Z, { centerTitle: t, centeredLogo: n, isFullWidth: a, isLarge: c, leftControl: C, middleControl: p, position: u(_, T, r), rightControl: m, style: g, subtitle: h, title: y, titleDomId: w, titleIconCell: f, titleIconCellSize: k, withBackground: F, withWideContainer: E }), b || null);
                }
                render() {
            ...
            class g extends i.Component {
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: n, appBarStyle: o, backLocation: a, documentTitle: l, headerless: c, history: p, leftControl: _, middleControl: m, onBackClick: g, rightControl: h, screenType: y, searchBoxOptions: w, secondaryBar: f, showBackButtonOnRoot: k, showSubtitleOnRoot: v, showSubtitleOnWideDetail: E, showTitleOnRoot: T, subtitle: C, title: F, titleIconCell: I, titleIconCellSize: S, withDetailOpen: Z, withSearchBox: x, withTweetButton: L, withWideContainer: R } = this.props,
                        ...
                        P = (O && !k) || (B && e),
                        N = (O && !T) || (B && e && !T),
                        W = O ? s.ey : B ? s.vX : void 0,
                        M = i.createElement(r.Z, { style: b.appBarContainer }, i.createElement(d.ZP, { backLocation: a, fixed: !1, hideBackButton: P, history: p, leftControl: _, middleControl: m, onBackClick: g, rightControl: h, secondaryBar: f, style: o, subtitle: A ? C : void 0, title: N ? void 0 : F, titleDomId: W, titleIconCell: I, titleIconCellSize: S, withWideContainer: R })),
                        U = O || (D && Z) ? null : i.createElement(u.Z.Configure, { SideNavButton: t, TabBar: n, backLocation: a, documentTitle: l, headerless: c, middleControl: m, onBackClick: g, rightControl: h, searchBoxOptions: w, subtitle: C, title: F, withSearchBox: x, withTweetButton: L });
                    return i.createElement(i.Fragment, null, U, M);
                }
            }
        ...
        546608: (e, t, n) => {
            ...
            const Z = (0, I.ZP)({ namespace: "articles" }),
                ...
                R = (0, F.Z)()
                    ...
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, C.zr)("ARTICLE_SUMMARY") })),
                O = w().afb7e8f8,
                ...
                B = (0, T.ZP)(
                    R(({ article: e, createLocalApiErrorHandler: t, id: n, location: y, socialContext: w, withInternalLink: T }) => {
                        const C = (0, E.Z)(),
                            F = i.useContext(o.ZP),
                            { article_url: I, description: S, domain: Z, image_url: x, publish_date: L, title: R } = e || {},
                            ...
                            P = i.useMemo(() => {
                                const e = (0, f.Z)(C.contextualScribeData.items || []) || {};
                                return { url: I, items: [(0, k.Z)({}, e, { article_details: { publisher_name: Z, is_showing_label: !1, is_ad_free: !1 } })] };
                            }, [C.contextualScribeData.items, I, Z]),
                            N = i.useCallback(() => {
                                C.scribe({ action: "impression", data: P });
                            }, [C, P]);
                        if (
                            (i.useEffect(() => {
                                N();
                            ...
                            return null;
                        const { contextImageUrls: W, landingUrl: M, text: U } = w || {},
                            z = x ? { url: x, height: 750, width: 1250 } : void 0,
                            K = { pathname: I, external: !0 },
                            $ = (e) => {
                                C.scribe({ element: T ? "read_article" : "article_header", action: "open_link", data: P });
                            },
                            q = () => {
                                C.scribe({ element: "conversation_view", action: "click", data: P });
                            },
                            ...
                            j = V
                                ...
                                : void 0,
                            Q = i.createElement(i.Fragment, null, i.createElement(r.Z, { style: D.horizontalContainer }, i.createElement(r.Z, { style: D.textContainer }, i.createElement(l.Z, { style: D.middotGroup }, Z && i.createElement(s.ZP, { color: "gray700", id: B.domain, size: "subtext2", weight: "bold" }, Z), L && i.createElement(s.ZP, { color: "gray700", id: B.timestamp, size: "subtext2" }, i.createElement(c.Z, { timestamp: L }))), i.createElement(s.ZP, { color: "text", id: B.title, link: j, numberOfLines: 3, size: "headline2", style: D.text, weight: "bold", withInteractiveStyling: !1 }, R), S ? i.createElement(s.ZP, { id: B.description, numberOfLines: 2 }, S) : null, T ? i.createElement(r.Z, { style: D.buttonContainer }, i.createElement(d.ZP, { link: K, onClick: $, size: "xSmall", type: "primaryOutlined" }, O)) : null), z ? i.createElement(r.Z, { style: D.imageContainer }, i.createElement(u.Z, { ratio: p.default.theme.aspectRatios.square }, i.createElement(_.Z, { "aria-label": "", aspectMode: m.Z.SQUARE, image: z }))) : null), i.createElement(b.Z, { contextType: "Facepile", iconSize: "large", id: B.socialContext, text: U, textSize: "subtext2", userAvatarUrls: W, withLeftPadding: !1, withTextCentered: !0 }));
                        return T ? i.createElement(v.Z, { exact: !1, path: j?.pathname || "" }, (e) => i.createElement(g.Z, { "aria-labelledby": A.join(" "), "aria-selected": e, link: j, onClick: q, role: "article", style: D.container }, Q)) : i.createElement(h.Z, { link: K, onClick: $, style: [D.container, D.bottomBorder] }, Q);
                    }),
                );
        },
        376293: (e, t, n) => {
            "use strict";
            n.d(t, { $f: () => T, KV: () => h, LI: () => Z, SC: () => E, Vt: () => f, ed: () => x, op: () => C });
            var i = n(202784),
                r = n(190286),
                o = n(111677),
                a = n.n(o),
            ...
            const u = a().cfd2f35e,
                ...
                T = (e, t) => ({ confirmButtonType: "destructiveFilled", headline: p({ screenName: e }), label: m, text: t ? g({ screenName: e }) : b({ screenName: e }) }),
                C = ({ blockAction: e, blockSubtext: t, isSoftBlockEnabled: n, source: i, testID: r, unblockAction: o, unblockSubtext: a, user: l }) => {
                    let s,
                        u = c.Z;
                    const p = Z(l, n);
                    switch (i) {
                ...
                Z = (e, t) => (e.blocking ? ((e, t) => ({ confirmButtonType: "primary", headline: y({ screenName: e }), label: f, text: t ? v : k }))(e.screen_name, t) : T(e.screen_name, t)),
        ...
        90086: (e, t, n) => {
            ...
            const L = (0, n(335632).G)({}),
                ...
                B = () => i.createElement(T.Z, { header: O, message: D, style: P.emptyState }),
                A = (e) => {
                    ...
                    return (
                        ...
                        i.createElement(I.Z, { anchoring: F.Z, entryConfiguration: L, module: n, renderEmptyState: B, title: R })
                    );
                },
                P = C.default.create((e) => ({ emptyState: { height: `calc(100vh - ${e.componentDimensions.appBarHeight})`, justifyContent: "center", marginVertical: 0 } })),
                N = x(i.memo(A));
            var W = n(2430),
                M = n(506063);
            const U = (e, t) => (0, w.t5)(e, w.q4),
                z = (e, t) => {
                    const {
                        location: n,
                        match: { params: i },
                ...
                $ = (0, S.Z)()
                    .propsFromState(() => ({ seedType: z, showFriendsOfFriendsNUX: U, timeWindowQuery: K }))
                ...
                oe = ({ addFlag: e, analytics: t, history: n, location: l, match: s, seedType: E, showFriendsOfFriendsNUX: T, timeWindowQuery: C }) => {
                    const { featureSwitches: F } = i.useContext(b.rC),
                        ...
                        O = i.useCallback(() => (E === M.v.FRIENDS_OF_FRIENDS ? "fof" : "following"), [E]),
                        D = Z ? `_${O()}` : "",
                        B = i.useCallback(() => {
                            t.scribe({ action: "impression", section: `top_articles${D}`, data: { context: `time_window_${te(C)}` } });
                        }, [t, D, C]);
                    i.useEffect(() => {
                        B();
                    }, [B]);
                    const A = i.useCallback(
                            (e) => {
                                const t = s.params.articleId,
                                    ...
                                    r = re(l.pathname);
                                I && !t && i ? n.replace(`/i/articles/${E}/${i}${R(C)}`) : I || r || n.replace(`/i/articles/${E}${R(C)}`);
                            },
                            [s.params.articleId, l.pathname, n, I, E, C],
                        ),
                        P = (e) => () => {
                            n.replace(`/i/articles/${E}${R(e)}`);
                        },
                        W = [
                            { text: Q({ count: 1 }), onClick: P(1) },
                            { text: Q({ count: 2 }), onClick: P(2) },
                            { text: Q({ count: 4 }), onClick: P(4) },
                            { text: Q({ count: 8 }), onClick: P(8) },
                            { text: Q({ count: 24 }), onClick: P(24) },
                        ],
                        U = i.createElement(o.Z, { Icon: c.default, label: G, renderActionMenu: (e) => i.createElement(r.Z, { items: W, onCloseRequested: e, shouldCloseOnClick: !0 }) }),
                        z = (e) => e === E,
                        K = (e) => `/i/articles/${e}${R(C)}`,
                        $ = () => {
                            e(w.q4), L(!1);
                        },
                        V = () => {
                            const e = K(M.v.FRIENDS_OF_FRIENDS);
                            n.replace(e), $();
                        },
                        j = (e) => i.createElement(a.Z, { actionPrimary: { text: J, onClick: V }, actionSecondary: { text: ee, onClick: $ }, headline: Y, icon: d.default, iconColor: "primary", onDismiss: $, shouldDisplay: x, text: X, withMask: !0 }, ie[e]),
                        oe = ne.map((e) => ({
                            key: e,
                            label: e === M.v.FRIENDS_OF_FRIENDS && x && !z(e) ? j(e) : ie[e],
                            isActive: () => z(e),
                            to: { pathname: K(e) },
                            onClick: () => {
                    ...
                    return i.createElement(i.Fragment, null, i.createElement(g.Z, { title: q }), i.createElement(p.Z, { rightControl: S ? U : void 0, screenType: "root", showSubtitleOnRoot: !0, subtitle: H({ count: C || 24 }), title: i.createElement(m.Z, { text: q }) }, Z ? i.createElement(_.Z, { links: oe, visibleItemIndex: ae }) : null, i.createElement(N, { module: le, onEntriesChanged: A })));
                },
                ae = $(oe);
        },
        463818: (e, t, n) => {
            "use strict";
            n.r(t), n.d(t, { default: () => S, query: () => C });
            var i,
                r,
                o,
                a,
            ...
            const f = { context: "ArticleRedirect" },
                ...
                T = { type: "CustomRetry", content: () => E },
                C = d,
                F = ({ articleEntityId: e }) => {
                    const t = _()(C, { articleEntityId: e }),
                ...
                I = (e) => {
                    ...
                    return t && n ? u.createElement(h.N, { errorConfig: f, fallback: T }, u.createElement(F, { articleEntityId: t })) : E;
                },
                S = u.memo(I);
        },
        537028: (e, t, n) => {
            ...
            var k = n(506063),
                ...
                C = n(962741),
                F = n(263863);
            const I = (0, v.Z)({}, (0, T.G)({}), { [C.ZP.Tweet]: { handlers: { [F.Z.TweetWithoutCard]: (0, E.Cw)({ createAdditionalProps: () => ({ withCardLinks: !0 }) }) } } }),
                S = c().d35d74e4,
                Z = c().f88e624e,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-a2dee9c7.820f07aa.js.map
