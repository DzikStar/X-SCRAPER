...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Articles-a2dee9c7"],
    {
        195382: (e, n, t) => {
                                                ...
                                                selections: [
                                                    {
                                                        ...
                                                        selections: [
                                                            ...
                                                            { alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "author_results", plural: !1, selections: [{ alias: null, args: null, concreteType: null, kind: "LinkedField", name: "result", plural: !1, selections: [s, { kind: "InlineFragment", selections: [a, d], type: "User", abstractKey: null }], storageKey: null }, d], storageKey: null },
                                                        ],
                                                        storageKey: null,
                                                    },
                                                    d,
            ...
            o.hash = "599f9dbb54d711563bc5d95de3db7b40";
            const u = o;
        },
        897455: (e, n, t) => {
            t.d(n, { Z: () => d });
        ...
        66351: (e, n, t) => {
            ...
            var i,
                ...
                k = {
                    ...
                    kind: "Request",
                    operation: {
                        argumentDefinitions: [i, l, r, s, d, c, o, _, a, u, m],
                        kind: "Operation",
                        name: "managementListsPageTimelineQuery",
                        selections: [
                            {
        ...
        483557: (e, n, t) => {
            ...
            const se = (e) => ({ ...ae.k(e), ...re.kX(e), cursor: -1 }),
                ...
                we = ({ apiClient: e, featureSwitches: n }) => ({
                    ...
                    createList(t, l) {
                        const { description: r, mode: d, name: o } = t;
                        return e.graphQL(L(), { isPrivate: "private" === d.toLowerCase(), name: o, description: r, ...(0, a.S)(n) }).then((e) => (0, i.Fv)(e.list, s.Z));
                    },
                    editBannerImage(t, l) {
                    ...
                    fetchList(t, l) {
                        if (t.list_id) return e.graphQL(U(), { listId: t.list_id, ...(0, a.S)(n) }, ge).then((e) => (0, i.Fv)(e.list, s.Z));
                        if (t.slug) {
                    ...
                    fetchCombinedLists: ({ count: t, cursor: i, userId: l }) => e.graphQL(o(), { userId: l, count: t, cursor: i, ...(0, a.d)(n) }, de).then(le.k7),
                    fetchListsManagementPageTimeline: ({ count: t, cursor: i }) =>
                        e.graphQL(Y(), { count: t, cursor: i, ...(0, a.d)(n) }, ue).then((e) => {
                            const n = e.viewer?.list_management_timeline?.timeline;
                            return n || ie.cY;
                        }),
                    fetchTweetsGraphQL(t, i) {
                        const { count: l, cursor: r, listId: s, useRanked: d } = t,
                            o = d ? C() : Q(),
                            u = { listId: s, count: l, cursor: r, ...(0, a.d)(n) };
                        return e.graphQL(o, u, ke).then((e) => {
                            const n = e.list.tweets_timeline?.timeline;
                            return n || ie.cY;
                        });
                    },
                    fetchMembersGraphQL(t, i) {
                        ...
                        return e.graphQL(K(), { listId: s, count: l, cursor: r, ...(0, a.d)(n) }, Le).then((e) => {
                            const n = e.list.members_timeline?.timeline;
                            return n || ie.cY;
                        });
                    },
                    fetchRecommendedUsersGraphQL(t, i) {
                        const { count: r, cursor: s, displayLocation: d, listId: o } = t,
                            u = d === l.O.Creation ? w() : T(),
                            c = { listId: o, count: r, cursor: s, ...(0, a.d)(n) };
                        return e.graphQL(u, c, he).then((e) => {
                            const n = e.list.recommended_users?.timeline;
                            return n || ie.cY;
                        });
                    },
                    ...
                    fetchSuggestedLists: ({ count: t, cursor: i }) => e.graphQL(P(), { count: t, cursor: i, ...(0, a.d)(n) }, oe).then((e) => e.list_discovery_list_mixer_timeline?.timeline || ie.cY),
                    ...
                    editList(t, l) {
                        const { description: r, list_id: d, mode: o, name: u } = t;
                        return e.graphQL(ne(), { listId: d, isPrivate: "private" === o.toLowerCase(), description: r, name: u, ...(0, a.S)(n) }).then((e) => (0, i.Fv)(e.list, s.Z));
                    },
                });
        },
        969066: (e, n, t) => {
            ...
            const c = (0, l.kj)((e) => {
                ...
                _ = ({ apiClient: e, featureSwitches: n }) => ({
                    fetchArticleTweetsTimeline(t) {
                        ...
                        return e.graphQL(o(), { ...t, ...(0, r.d)(n), articleListSeedType: l }, c).then((e) => e?.article_by_rest_id?.tweets_timeline?.timeline || u.cY);
                    },
                    fetchArticleTimeline(t) {
                        const l = t.articleListSeedType === i.v.FRIENDS_OF_FRIENDS ? "FriendsOfFriends" : "FollowingList";
                        return e.graphQL(s(), { ...t, ...(0, r.d)(n), articleListSeedType: l }, m).then((e) => e?.article_timeline?.timeline || u.cY);
                    },
                });
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-a2dee9c7.90f8269a.js.map
