        ...
        483557: (e, n, t) => {
            ...
            const se = (e) => ({ ...ae.k(e), ...re.kX(e), cursor: -1 }),
                ...
                we = ({ apiClient: e, featureSwitches: n }) => ({
                    ...
                    removeFromList(t, i) {
                        const { list_id: r, user_id: d } = t;
                        return e.graphQL(D(), { listId: r, userId: d, ...(0, a.S)(n) }, pe).then((e) => (0, l.Fv)(e.list, s.Z));
                    },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-a2dee9c7.a5791e7a.js.map
