    ...
    ["bundle.Articles-bc6ccf4c"],
    {
        425376: (e, t, n) => {
            ...
            const h = m.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                g = ({ actionPrimary: e, actionSecondary: t, children: n, headline: g, icon: f, iconColor: b, image: y, onDismiss: C, shouldDisplay: x, text: v, withMask: E = !0 }) => {
                    const [k, w] = o.useState(!1),
                        Z = (e) => o.createElement(u.Z, { onDismiss: T, renderContent: () => P(T), switchOnlyOnXSmallBreakpoint: !0, visibilityBehavior: r.J.forceVisible, withArrow: !0, withFixedPosition: !0, withMask: E }, e),
                        S = () => o.createElement(p.Z, { onMaskClick: () => T(), type: "center", withMask: !0 }, P(T)),
                        P = (n) => o.createElement(a.Z, { style: [h.root, y && h.rootWithImage] }, B(), o.createElement(a.Z, { style: h.container }, _(), R(), M({ action: e, dismiss: n, type: t && "primaryFilled" }), M({ action: t, dismiss: n }))),
                        B = () => {
                        ...
                        R = () => o.createElement(s.ZP, { color: "gray700", style: h.description }, v),
                        M = ({ action: e, dismiss: t, type: n }) => e && o.createElement(c.ZP, { link: e.link && e.link, onPress: e.onClick ? e.onClick : t, size: "large", style: h.actionButton, type: n }, e.text),
                        T = () => {
                            C && C(), w(!0);
                        };
                    return x && !k ? (n ? Z(n) : S()) : n || null;
                };
        },
        664064: (e, t, n) => {
            n.d(t, { Z: () => c });
        ...
        491915: (e, t, n) => {
            ...
            function f(e) {
                ...
                return (
                    ...
                    o.createElement(a.Z, null, o.createElement(a.Z, { style: [e.animationContainerStyle, C.centerAnimation] }, o.createElement("div", { ref: u, style: e.animationStyle }), l && c.current && p && o.createElement(h, { animation: c.current, autoplay: t })))
                );
            }
            f.Prepare = function () {
                return (
        ...
        403556: (e, t, n) => {
            ...
            class v extends a.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: o, children: r, color: i, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: v, style: k, to: w } = this.props,
                        { location: Z } = this.state,
                        S = w ? this._getMemoizedLink(w, v) : void 0,
                        P = c ? c(w) : Z?.pathname === S?.pathname,
                        B = f.Z.generate({ backgroundColor: "transparent", color: s.default.theme.colors.text, insetFocusRing: !0 }),
                        _ = g ? "medium" : P ? "bold" : "medium";
                    return a.createElement(b.Z, { "aria-label": t, "aria-selected": P, focusable: !!P, interactiveStyles: B, link: S, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? E.pill : E.link, u && P ? E.active : null, d ? (u ? E.compactPill : E.compactLink) : null, p ? E.roundedRect : null, k], withoutInteractiveStyles: g || u }, ({ isFocused: t, isHovered: c }) => a.createElement(l.Z, { style: u && E.flexGrow }, a.createElement(m.ZP, { size: g ? "headline2" : void 0, style: [E.text, { color: this._getTextColor(P, c, g, u) }, d && E.compactText, g && t && E.focusedText], weight: _ }, e && a.createElement(e, { style: E.icon }), r, g || u ? null : a.createElement(l.Z, { style: P && [E.border, { backgroundColor: s.default.theme.colors[i] }] })), n ? a.createElement(h.Z, { count: n, standalone: !0, style: [E.badge, n >= 10 && E.multiDigitBadge, n >= 20 && E.truncatedCountBadge], truncatedCountFormatter: x, unreadCountLabel: y, withBorder: !1 }) : o ? a.createElement(h.Z, { pip: !0, standalone: !0, style: E.badgePip, textColor: "red500", unreadCountLabel: C, withBorder: !1 }) : null));
                }
            }
            ...
            const y = h().e8d93005,
                ...
                x = ({ color: e, count: t }) => {
                    ...
                    return o.createElement(f.ZP, null, ({ containerWidth: a }) => {
                        return o.createElement(b.ZP, { color: e, count: t, size: "subtext2", style: [C.count, ((r = a), r < u.default.theme.breakpoints.small && C.narrowCount)] }, t > 0 ? (((e) => e < u.default.theme.breakpoints.xxSmall)(a) || n.length >= 5 ? y(t) : n) : void 0);
                        var r;
                    });
                };
            class v extends o.PureComponent {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !r.Z.reducedMotionEnabled && e && m) return o.createElement(d.ZP, { animation: h || p.Bf, animationContainerStyle: E[t], animationStyle: S, onAnimationEnd: s, onAnimationStart: l, onError: c });
                            {
                                const r = n && e ? e : this.props.Icon;
                                return o.createElement(r, { style: [E[t], !a && i && w.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                            const { count: e, withCount: t } = this.props;
                            return t ? o.createElement(x, { count: e }) : null;
                        }),
                        (this._handlePress = (e) => {
                ...
                render() {
                    const { "aria-label": e, focusable: t, enableKeyboardShortcuts: n, isActive: i, isDisabled: s, isPresentational: c, keyboardShortcut: p, link: m, preventFocusShift: h, renderMenu: g, renderWrapper: f = o.Fragment, style: b, testID: y } = this.props,
                        C = !u.default.theme.highContrastEnabled && !r.Z.reducedMotionEnabled;
                    return o.createElement(
                        a.Z,
                        { style: [w.root, b] },
                        o.createElement(
                        ...
                        C ? o.createElement(d.ZP.Prepare, null) : null,
                    );
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-bc6ccf4c.9bfefb5a.js.map
