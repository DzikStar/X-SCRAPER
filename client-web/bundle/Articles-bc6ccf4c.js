    ...
    ["bundle.Articles-bc6ccf4c"],
    {
        425376: (e, t, a) => {
            ...
            const u = m.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                g = ({ actionPrimary: e, actionSecondary: t, children: a, headline: g, icon: f, iconColor: b, image: y, onDismiss: x, shouldDisplay: v, text: C, withMask: Z = !0 }) => {
                    const [w, k] = i.useState(!1),
                        S = (e) => i.createElement(p.Z, { onDismiss: _, renderContent: () => P(_), switchOnlyOnXSmallBreakpoint: !0, visibilityBehavior: s.J.forceVisible, withArrow: !0, withFixedPosition: !0, withMask: Z }, e),
                        E = () => i.createElement(h.Z, { onMaskClick: () => _(), type: "center", withMask: !0 }, P(_)),
                        P = (a) => i.createElement(o.Z, { style: [u.root, y && u.rootWithImage] }, z(), i.createElement(o.Z, { style: u.container }, R(), B(), M({ action: e, dismiss: a, type: t && "primaryFilled" }), M({ action: t, dismiss: a }))),
                        z = () => {
                        ...
                        R = () => i.createElement(n.ZP, { size: "title3", weight: "heavy" }, g),
                        B = () => i.createElement(n.ZP, { color: "gray700", style: u.description }, C),
        ...
        403556: (e, t, a) => {
            ...
            class C extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: a, badgePip: i, children: s, color: r, isActive: c, isCompact: d, isPillLink: p, isRoundedRect: h, isWebRedesign: g, retainScrollPosition: C, style: w, to: k } = this.props,
                        { location: S } = this.state,
                        E = k ? this._getMemoizedLink(k, C) : void 0,
                        P = c ? c(k) : S?.pathname === E?.pathname,
                        z = f.Z.generate({ backgroundColor: "transparent", color: n.default.theme.colors.text, insetFocusRing: !0 }),
                        R = g ? "medium" : P ? "bold" : "medium";
                    return o.createElement(b.Z, { "aria-label": t, "aria-selected": P, focusable: !!P, interactiveStyles: z, link: E, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [p ? Z.pill : Z.link, p && P ? Z.active : null, d ? (p ? Z.compactPill : Z.compactLink) : null, h ? Z.roundedRect : null, w], withoutInteractiveStyles: g || p }, ({ isFocused: t, isHovered: c }) => o.createElement(l.Z, { style: p && Z.flexGrow }, o.createElement(m.ZP, { size: g ? "headline2" : void 0, style: [Z.text, { color: this._getTextColor(P, c, g, p) }, d && Z.compactText, g && t && Z.focusedText], weight: R }, e && o.createElement(e, { style: Z.icon }), s, g || p ? null : o.createElement(l.Z, { style: P && [Z.border, { backgroundColor: n.default.theme.colors[r] }] })), a ? o.createElement(u.Z, { count: a, standalone: !0, style: [Z.badge, a >= 10 && Z.multiDigitBadge, a >= 20 && Z.truncatedCountBadge], truncatedCountFormatter: v, unreadCountLabel: y, withBorder: !1 }) : i ? o.createElement(u.Z, { pip: !0, standalone: !0, style: Z.badgePip, textColor: "red500", unreadCountLabel: x, withBorder: !1 }) : null));
                }
            }
            (C.contextType = g.Z), (C.defaultProps = { children: [], color: "primary", retainScrollPosition: !0 });
            const Z = n.default.create((e) => ({
                        ...
                        g = o.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: s, ...r }, c) => {
                                    const d = u ? [k.linkRedesign, 0 === c && k.firstLinkRedesign, e && 0 === c && k.withNoPaddingStart] : void 0;
                                    return o.createElement(w, (0, i.Z)({ viewType: s }, r, { isCompact: a, isPillLink: n, isRoundedRect: l, isWebRedesign: u, style: d }), t);
                                }),
                            [e, a, n, l, u, c],
                        );
                    return o.createElement(s.Z, { "aria-label": t, buttonsContainerStyle: n && k.gap, childrenStyle: !u && k.flexGrow, key: h, style: [n ? null : k.segmentedControl, u && k.leftAligned, d], visibleItemIndex: p }, g);
                };
        },
        620522: (e, t, a) => {
            a.d(t, { Z: () => i });
        ...
        517747: (e, t, a) => {
            ...
            const n = (e = {}) => {
                const { direction: t } = (0, s.Z)();
                return (0, o.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [r.Z.root, e.style], viewBox: "0 0 24 24", children: i.createElement("g", null, i.createElement("path", { d: "M14 6V3h2v8h-2V8H3V6h11zm7 2h-3.5V6H21v2zM8 16v-3h2v8H8v-3H3v-2h5zm13 2h-9.5v-2H21v2z" })) }, { writingDirection: t });
            };
            n.metadata = { width: 24, height: 24 };
            const l = n;
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-bc6ccf4c.f79b8a5a.js.map
