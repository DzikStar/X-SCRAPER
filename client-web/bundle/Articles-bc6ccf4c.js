    ...
    ["bundle.Articles-bc6ccf4c"],
    {
        425376: (e, t, n) => {
            ...
            const h = m.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                g = ({ actionPrimary: e, actionSecondary: t, children: n, headline: g, icon: f, iconColor: b, image: y, onDismiss: x, shouldDisplay: v, text: C, withMask: E = !0 }) => {
                    const [S, k] = o.useState(!1),
                        ...
                        T = () => o.createElement(s.ZP, { color: "gray700", style: h.description }, C),
        ...
        403556: (e, t, n) => {
            ...
            class C extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: o, children: a, color: i, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: C, style: S, to: k } = this.props,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles-bc6ccf4c.ae3679ea.js.map
