            ...
            const F = (0, Z.ZP)({ namespace: "articles" }),
                ...
                D = (0, E.ZP)(
                    P(({ article: e, createLocalApiErrorHandler: t, id: n, location: y, socialContext: f, withInternalLink: E }) => {
                        ...
                        return E ? i.createElement(C.Z, { exact: !1, path: U?.pathname || "" }, (e) => i.createElement(g.Z, { "aria-labelledby": A.join(" "), "aria-selected": e, link: U, onClick: j, role: "article", style: R.container }, G)) : i.createElement(b.Z, { link: M, onClick: q, style: [R.container, R.bottomBorder] }, G);
                    }),
                );
        },
        90086: (e, t, n) => {
            ...
            const $ = (e, t) => (0, f.t5)(e, f.q4),
                ...
                oe = ({ addFlag: e, analytics: t, history: n, location: l, match: s, seedType: k, showFriendsOfFriendsNUX: E, timeWindowQuery: x }) => {
                    ...
                    return i.createElement(i.Fragment, null, i.createElement(g.Z, { title: j }), i.createElement(p.Z, { rightControl: T ? $ : void 0, screenType: "root", showSubtitleOnRoot: !0, subtitle: V({ count: x || 24 }), title: i.createElement(h.Z, { text: j }) }, F ? i.createElement(m.Z, { links: oe, visibleItemIndex: ae }) : null, i.createElement(z, { module: le, onEntriesChanged: A })));
                },
                ae = q(oe);
        },
        463818: (e, t, n) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles.e4e8fd5a.js.map
