    ...
    ["bundle.Articles"],
    {
            ...
            const u = (0, r.kj)((e) => {
                ...
                m = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchArticleTimeline(n) {
                        const r = n.articleListSeedType === i.v.FRIENDS_OF_FRIENDS ? "FriendsOfFriends" : "FollowingList";
                        return e.graphQL(s(), { ...n, ...(0, o.d)(t), articleListSeedType: r }, p).then((e) => e?.article_timeline?.timeline || d.cY);
                    },
                });
        },
        415725: (e, t, n) => {
            ...
            var i = n(202784),
                ...
                a = n(822228);
            const s = "activeRoute",
                l = o.default.create((e) => ({ activeRoot: { backgroundColor: e.colors.gray0 }, overlay: { ...o.default.absoluteFillObject, borderEndStyle: "solid", borderEndWidth: e.borderWidths.medium, borderEndColor: e.colors.primary, zIndex: 1 } })),
                c = ({ children: e, ...t }) => i.createElement(a.Z, t, (t) => i.createElement(r.Z, { style: t && l.activeRoot, testID: s }, "function" == typeof e ? e(t) : e, t ? i.createElement(r.Z, { pointerEvents: "none", style: l.overlay }) : null));
        },
        625661: (e, t, n) => {
            "use strict";
            n.d(t, { ZP: () => p });
            ...
            class p extends i.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: n, fixed: r, hideBackButton: o, isFullWidth: a, isLarge: c, leftControl: d, middleControl: p, position: m, rightControl: _, secondaryBar: g, style: b, subtitle: h, title: y, titleDomId: f, titleIconCell: w, titleIconCellSize: k, withBackground: v, withWideContainer: C } = this.props,
                        { isModal: E } = this.context,
                        T = o ? d : i.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        x = (function (e, t, n) {
                            return e && !(t && n);
                        })(!!v, E, !!g);
                    return i.createElement(i.Fragment, null, i.createElement(l.Z, { centerTitle: t, centeredLogo: n, isFullWidth: a, isLarge: c, leftControl: T, middleControl: p, position: u(m, E, r), rightControl: _, style: b, subtitle: h, title: y, titleDomId: f, titleIconCell: w, titleIconCellSize: k, withBackground: x, withWideContainer: C }), g || null);
                }
                render() {
        ...
        290402: (e, t, n) => {
            ...
            const u = c().aa6e3300,
                p = ({ retryMessage: e, ...t }, n) => {
                    ...
                    return r.createElement(a.Z, (0, i.Z)({}, t, { icon: s ? void 0 : r.createElement(d.default, { style: m.icon }), retryMessage: s ? e : u }));
                },
        ...
        222718: (e, t, n) => {
            ...
            var i = n(202784),
                ...
                m = n(715601),
                _ = n(392237);
            const g = _.default.create((e) => ({ fill: { flex: 1, alignSelf: "stretch" }, viewportView: { ..._.default.absoluteFillObject, overflowY: "auto" }, appBarContainer: { position: "sticky", top: 0, backfaceVisibility: "hidden", zIndex: e.componentZIndices.appBarZIndex } }));
            class b extends i.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildren = () => {
                            const { children: e } = this.props;
                            return this.context.rootDetailPerColumnScroll ? i.createElement(r.Z, { style: g.fill }, i.createElement(m.Z, { style: g.viewportView }, this._renderInlineNav({ isTwoColumnLayout: !0 }), e)) : e;
                        });
                }
                render() {
                ...
                _renderForOneColumnLayout() {
                    const { appBarStyle: e, children: t, leftControl: n, screenType: r, showBackButtonOnRoot: o, showSubtitleOnRoot: a, showSubtitleOnWideDetail: l, showTitleOnRoot: c, withBottomBorder: d, withDetailOpen: p, ...m } = this.props;
                    return i.createElement(i.Fragment, null, (0, s.ZP)() ? this._renderInlineNav({ isTwoColumnLayout: !1 }) : i.createElement(u.Z.Configure, m), t);
                }
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: n, appBarStyle: o, backLocation: a, documentTitle: s, headerless: c, history: p, leftControl: m, middleControl: _, onBackClick: b, rightControl: h, screenType: y, searchBoxOptions: f, secondaryBar: w, showBackButtonOnRoot: k, showSubtitleOnRoot: v, showSubtitleOnWideDetail: C, showTitleOnRoot: E, subtitle: T, title: x, titleIconCell: S, titleIconCellSize: Z, withDetailOpen: F, withSearchBox: I, withTweetButton: L, withWideContainer: R } = this.props,
                        B = "root" === y,
                        P = "secondaryRoot" === y,
                        D = "primaryDetail" === y,
                        O = (D && C) || (B && v),
                        A = (B && !k) || (D && e),
                        N = (B && !E) || (D && e && !E),
                        W = B ? l.ey : D ? l.vX : void 0,
                        z = i.createElement(r.Z, { style: g.appBarContainer }, i.createElement(d.ZP, { backLocation: a, fixed: !1, hideBackButton: A, history: p, leftControl: m, middleControl: _, onBackClick: b, rightControl: h, secondaryBar: w, style: o, subtitle: O ? T : void 0, title: N ? void 0 : x, titleDomId: W, titleIconCell: S, titleIconCellSize: Z, withWideContainer: R })),
                        M = B || (P && F) ? null : i.createElement(u.Z.Configure, { SideNavButton: t, TabBar: n, backLocation: a, documentTitle: s, headerless: c, middleControl: _, onBackClick: b, rightControl: h, searchBoxOptions: f, subtitle: T, title: x, withSearchBox: I, withTweetButton: L });
                    return i.createElement(i.Fragment, null, M, z);
                }
            }
        ...
        507651: (e, t, n) => {
            ...
            const l = (e) => {
                    const t = (0, o.useHistory)(),
                        { isCompact: n, ...l } = e;
                    return r.createElement(a.Z, (0, i.Z)({}, l, { isCompact: n || (0, s.HD)(t) }));
                },
                c = r.memo(l);
        },
        890882: (e, t, n) => {
            ...
            const o = (e) => {
                const { featureSwitches: t, userClaims: n } = i.useContext(r.rC),
                    ...
                    { text: s } = e;
                return a && o ? i.createElement(i.Fragment, null, s) : s;
            };
        },
        546608: (e, t, n) => {
            "use strict";
            ...
            var i = n(202784),
                ...
                S = n(502909),
                Z = n(600823);
            const F = (0, S.ZP)({ namespace: "articles" }),
                I = Z.Z.register(F),
                L = (e, t) => I.select(e, t.id.toString()),
                R = (0, x.Z)()
                ...
                D = (0, E.ZP)(
                    R(({ article: e, createLocalApiErrorHandler: t, id: n, location: y, socialContext: f, withInternalLink: E }) => {
                        const T = (0, C.Z)(),
                            x = i.useContext(o.ZP),
                            { article_url: S, description: Z, domain: F, image_url: I, publish_date: L, title: R } = e || {},
                            ...
                            A = i.useMemo(() => {
                                ...
                                return { url: S, items: [(0, k.Z)({}, e, { article_details: { publisher_name: F, is_showing_label: !1, is_ad_free: !1 } })] };
                            }, [T.contextualScribeData.items, S, F]),
                            N = i.useCallback(() => {
                        ...
                        const { contextImageUrls: W, landingUrl: z, text: M } = f || {},
                            ...
                            j = V
                                ...
                                : void 0,
                            G = i.createElement(i.Fragment, null, i.createElement(r.Z, { style: P.horizontalContainer }, i.createElement(r.Z, { style: P.textContainer }, i.createElement(s.Z, { style: P.middotGroup }, F && i.createElement(l.ZP, { color: "gray700", id: D.domain, size: "subtext2", weight: "bold" }, F), L && i.createElement(l.ZP, { color: "gray700", id: D.timestamp, size: "subtext2" }, i.createElement(c.Z, { timestamp: L }))), i.createElement(l.ZP, { color: "text", id: D.title, link: j, numberOfLines: 3, size: "headline2", style: P.text, weight: "bold", withInteractiveStyling: !1 }, R), Z ? i.createElement(l.ZP, { id: D.description, numberOfLines: 2 }, Z) : null, E ? i.createElement(r.Z, { style: P.buttonContainer }, i.createElement(d.ZP, { link: H, onClick: q, size: "xSmall", type: "primaryOutlined" }, B)) : null), $ ? i.createElement(r.Z, { style: P.imageContainer }, i.createElement(u.Z, { ratio: p.default.theme.aspectRatios.square }, i.createElement(m.Z, { "aria-label": "", aspectMode: _.Z.SQUARE, image: $ }))) : null), i.createElement(g.Z, { contextType: "Facepile", iconSize: "large", id: D.socialContext, text: M, textSize: "subtext2", userAvatarUrls: W, withLeftPadding: !1, withTextCentered: !0 }));
                        return E ? i.createElement(v.Z, { exact: !1, path: j?.pathname || "" }, (e) => i.createElement(b.Z, { "aria-labelledby": O.join(" "), "aria-selected": e, link: j, onClick: U, role: "article", style: P.container }, G)) : i.createElement(h.Z, { link: H, onClick: q, style: [P.container, P.bottomBorder] }, G);
                    }),
                );
        },
        376293: (e, t, n) => {
            "use strict";
            n.d(t, { $f: () => E, KV: () => h, LI: () => F, SC: () => C, Vt: () => w, ed: () => I, op: () => T });
            var i = n(202784),
                r = n(190286),
                o = n(111677),
                a = n.n(o),
            ...
            const u = a().cfd2f35e,
                ...
                E = (e, t) => ({ confirmButtonType: "destructiveFilled", headline: p({ screenName: e }), label: _, text: t ? b({ screenName: e }) : g({ screenName: e }) }),
                T = ({ blockAction: e, blockSubtext: t, isSoftBlockEnabled: n, source: i, testID: r, unblockAction: o, unblockSubtext: a, user: s }) => {
                    let l,
                        u = c.Z;
                    const p = F(s, n);
                    switch (i) {
                    ...
                    return { confirmation: p, onClick: u, testID: r, shortcutKey: l, Icon: x(s.blocking), text: Z(s), subText: S({ user: s, blockSubtext: t, unblockSubtext: a }) };
                },
                ...
                F = (e, t) => (e.blocking ? ((e, t) => ({ confirmButtonType: "primary", headline: y({ screenName: e }), label: w, text: t ? v : k }))(e.screen_name, t) : E(e.screen_name, t)),
                I = ({ confirmation: e, handleConfirm: t, onClose: n }) => {
                    const { confirmButtonType: o, headline: a, label: s, text: l } = e;
                    return i.createElement(r.Z, { cancelButtonLabel: u, confirmButtonLabel: s, confirmButtonType: o, headline: a, onCancel: n, onConfirm: t, text: l });
                };
        },
        712816: (e, t, n) => {
            "use strict";
        ...
        466380: (e, t, n) => {
            ...
            const a = (0, r.ZP)({ namespace: "topics" }),
                s = (0, r.tb)(a, { context: "FETCH_TOPIC", endpoint: (e) => e.withEndpoint(i.ZP).fetchOneTopic, params: ([e], t) => ({ topicId: e }) }),
                l = {
                    addTopic: function (e) {
                        return u.add({ [e.id]: e });
                    },
                ...
                u = { ...a, ...s, ...l, ...d, customActionTypes: (0, r.X7)(d) },
                p = o.Z.register(u);
        },
        90086: (e, t, n) => {
            "use strict";
            ...
            const F = (e, t) => t.module.selectEntries(e),
                I = (0, Z.Z)().propsFromState(() => ({ entries: F }));
            const L = (0, n(335632).G)({}),
                R = l().b7fa0cfe,
                B = l().e950f6e0,
                P = i.createElement(l().I18NFormatMessage, { $i18n: "d9cb9d0b" }, i.createElement(C.ZP, { color: "link", link: "/i/connect_people" }, l().e7dcfb81)),
                D = () => i.createElement(E.Z, { header: B, message: P, style: A.emptyState }),
                O = (e) => {
            ...
            const M = (e, t) => (0, f.t5)(e, f.q4),
                ...
                oe = ({ addFlag: e, analytics: t, history: n, location: s, match: l, seedType: C, showFriendsOfFriendsNUX: E, timeWindowQuery: T }) => {
                    const { featureSwitches: x } = i.useContext(g.rC),
                        S = (0, h.Cz)(),
                        Z = x.isTrue("longform_top_articles_time_window_enabled"),
                        F = x.isTrue("longform_top_articles_friends_of_friends_enabled"),
                        [I, L] = i.useState(E),
                        R = (e) => `?time_window=${e || 24}`,
                        B = i.useCallback(() => (C === z.v.FRIENDS_OF_FRIENDS ? "fof" : "following"), [C]),
                        P = F ? `_${B()}` : "",
                        D = i.useCallback(() => {
                    ...
                    const O = i.useCallback(
                            ...
                            [l.params.articleId, s.pathname, n, S, C, T],
                        ),
                        A = (e) => () => {
                        ...
                        j = (e) => i.createElement(a.Z, { actionPrimary: { text: Y, onClick: V }, actionSecondary: { text: ee, onClick: q }, headline: J, icon: d.default, iconColor: "primary", onDismiss: q, shouldDisplay: I, text: X, withMask: !0 }, ie[e]),
                        oe = ne.map((e) => ({
                            key: e,
                            label: e === z.v.FRIENDS_OF_FRIENDS && I && !$(e) ? j(e) : ie[e],
                            isActive: () => $(e),
                            to: { pathname: H(e) },
                            onClick: () => {
                        ...
                        se = i.useMemo(() => ((e, t = 864e5) => (0, v.Z)({ timelineId: `articlesTimeline-${e}-${t}`, network: { getEndpoint: (e) => e.withEndpoint(w.ZP).fetchArticleTimeline, getEndpointParams: ({ count: n, cursor: i }) => ({ count: n, cursor: "string" == typeof i ? i : void 0, articleListSeedType: e, timeWindowMillis: t }) }, context: "FETCH_TOP_ARTICLES_TIMELINE", perfKey: "articlesTimeline", formatResponse: k.Z }))(C, te(T || 24)), [C, T]);
                    return i.createElement(i.Fragment, null, i.createElement(b.Z, { title: U }), i.createElement(p.Z, { rightControl: Z ? M : void 0, screenType: "root", showSubtitleOnRoot: !0, subtitle: K({ count: T || 24 }), title: i.createElement(_.Z, { text: U }) }, F ? i.createElement(m.Z, { links: oe, visibleItemIndex: ae }) : null, i.createElement(N, { module: se, onEntriesChanged: O })));
                },
                ae = q(oe);
        },
        463818: (e, t, n) => {
                                                ...
                                                selections: [
                                                    {
                                                        ...
                                                        plural: !1,
                                                        selections: [
                                                            { alias: null, args: null, concreteType: "TweetResults", kind: "LinkedField", name: "tweet_results", plural: !1, selections: [o, (l = { alias: null, args: null, kind: "ScalarField", name: "id", storageKey: null })], storageKey: null },
                                                            { alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "author_results", plural: !1, selections: [{ alias: null, args: null, concreteType: null, kind: "LinkedField", name: "result", plural: !1, selections: [s, { kind: "InlineFragment", selections: [a, l], type: "User", abstractKey: null }], storageKey: null }, l], storageKey: null },
                                                        ],
                                                        storageKey: null,
                                                    },
                                                    l,
            ...
            const w = { context: "ArticleRedirect" },
                ...
                S = (e) => {
                    ...
                    return t && n ? u.createElement(h.N, { errorConfig: w, fallback: E }, u.createElement(x, { articleEntityId: t })) : C;
                },
                Z = u.memo(S);
        },
        537028: (e, t, n) => {
            ...
            var i = n(202784),
                ...
                y = n(750085),
                f = n(218951);
            const w = (e, t) => (0, f.Z)({ timelineId: `articleTweetsTimeline-${e}-${t}`, network: { getEndpoint: (e) => e.withEndpoint(h.ZP).fetchArticleTweetsTimeline, getEndpointParams: ({ count: n, cursor: i }) => ({ articleId: e, articleListSeedType: t, count: n, cursor: "string" == typeof i ? i : void 0 }) }, context: "FETCH_ARTICLE_TWEETS_TIMELINE", perfKey: "articleTweetsTimeline", formatResponse: y.Z });
            var k = n(506063),
                v = n(769471),
                C = n(801184),
                E = n(335632),
            ...
            const S = (0, v.Z)({}, (0, E.G)({}), { [T.ZP.Tweet]: { handlers: { [x.Z.TweetWithoutCard]: (0, C.Cw)({ createAdditionalProps: () => ({ withCardLinks: !0 }) }) } } }),
                Z = c().d35d74e4,
                F = c().f88e624e,
                I = s.default.create((e) => ({ contentWrapper: { height: `calc(100vh - ${e.componentDimensions.appBarHeight} - 1px)` }, viewport: { flex: 1, height: "100%", width: "100%" }, withOverflow: { overflow: "auto" } })),
                L = (0, b.Z)(
                    (e) => {
                        const t = Number(e.match.params.articleId),
                            n = (0, o.useHistory)(),
                            s = i.useMemo(() => [I.viewport, !(0, d.HD)(n) && I.withOverflow], [n]);
                        return i.createElement(
                            ...
                            i.createElement(
                                ...
                                i.createElement(r.Z, { "aria-atomic": !0, "aria-live": "polite" }, i.createElement(a.ZP, { visuallyHidden: !0 }, F), i.createElement(_.Z, { id: t, withInternalLink: !1 })),
                                i.createElement(
                                    m.Z,
                                    { style: s },
                                    i.createElement(g.Z, {
        ...
        425376: (e, t, n) => {
            ...
            const _ = m.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                g = ({ actionPrimary: e, actionSecondary: t, children: n, headline: g, icon: b, iconColor: h, image: y, onDismiss: f, shouldDisplay: w, text: k, withMask: v = !0 }) => {
                    const [C, E] = i.useState(!1),
                        ...
                        S = (n) => i.createElement(r.Z, { style: [_.root, y && _.rootWithImage] }, Z(), i.createElement(r.Z, { style: _.container }, F(), I(), L({ action: e, dismiss: n, type: t && "primaryFilled" }), L({ action: t, dismiss: n }))),
                        Z = () => {
                            let e = b && i.createElement(b, { style: h ? [_.icon, { color: m.default.theme.colors[h] }] : _.icon });
                            return y && !d.Z.isEnabled && (e = i.createElement(a.Z, { "aria-label": "", aspectMode: l.Z.exact(2), image: y })), e && i.createElement(r.Z, { style: _.graphic }, e);
                        },
                        F = () => i.createElement(s.ZP, { size: "title3", weight: "heavy" }, g),
                        I = () => i.createElement(s.ZP, { color: "gray700", style: _.description }, k),
        ...
        879113: (e, t, n) => {
            ...
            class m extends i.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: n, fetchStatus: r, icon: o, loadingMessage: a, onRequestRetry: d, render: m, renderFailure: _, retryMessage: g, retryable: b } = this.props;
                    switch (r) {
                        case c:
                            return b ? i.createElement(s.Z, { icon: o, onRequestRetry: d, retryMessage: g }) : n ? i.createElement(l.m, { failureMessage: n }) : _();
                        case u:
        ...
        403556: (e, t, n) => {
            ...
            class k extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: i, children: o, color: a, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: k, style: C, to: E } = this.props,
                        ...
                        Z = b.Z.generate({ backgroundColor: "transparent", color: s.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: u ? v.pillHoverStyle.backgroundColor : void 0 }),
                        F = g ? "medium" : S ? "bold" : "medium";
                    return r.createElement(h.Z, { "aria-label": t, "aria-selected": S, focusable: !!S, interactiveStyles: Z, link: x, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(u ? [v.pillStyle] : [v.link]), ...(u && S ? [v.pillActiveStyle] : []), d ? (u ? v.compactPill : v.compactLink) : null, p ? v.roundedRect : null, C], withoutInteractiveStyles: g }, ({ isFocused: t, isHovered: c }) => r.createElement(l.Z, { style: u && v.flexGrow }, r.createElement(m.ZP, { size: g ? "headline2" : void 0, style: [v.text, { color: this._getTextColor(S, c, g, u) }, d && v.compactText, g && t && v.focusedText, u && v.pillTextStyle, u && S && v.pillActiveTextStyle, u && c && v.pillHoverTextStyle], weight: F }, e && r.createElement(e, { style: v.icon }), o, g || u ? null : r.createElement(l.Z, { style: S && [v.border, { backgroundColor: s.default.theme.colors[a] }] })), n ? r.createElement(_.Z, { count: n, standalone: !0, style: [v.badge, n >= 10 && v.multiDigitBadge, n >= 20 && v.truncatedCountBadge], truncatedCountFormatter: w, unreadCountLabel: y, withBorder: !1 }) : i ? r.createElement(_.Z, { pip: !0, standalone: !0, style: v.badgePip, textColor: "red500", unreadCountLabel: f, withBorder: !1 }) : null));
                }
            }
            ...
            const v = s.default.create((e) => ({
                ...
                T = ({ alignFirstItem: e, "aria-label": t, isCompact: n, isPillLink: s, isRoundedRect: l, links: c, style: d, visibleItemIndex: u }) => {
                    const p = c
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        g = r.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: o, ...a }, c) => {
                                    ...
                                    return r.createElement(C, (0, i.Z)({ viewType: o }, a, { isCompact: n, isPillLink: s, isRoundedRect: l, isWebRedesign: _, style: d }), t);
                                }),
                            [e, n, s, l, _, c],
                        );
                    return r.createElement(o.Z, { "aria-label": t, buttonsContainerStyle: s && E.gap, childrenStyle: !_ && E.flexGrow, key: p, style: [s ? null : E.segmentedControl, _ && E.leftAligned, d], visibleItemIndex: u }, g);
                };
        },
        98440: (e, t, n) => {
            "use strict";
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles.3252691a.js.map
