    ...
    ["bundle.Articles", "icons/IconFilter-js", "icons/IconFollowArrowLeft-js", "icons/IconSparkle-js"],
    {
        ...
        625661: (e, t, n) => {
            ...
            class p extends i.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: n, fixed: r, hideBackButton: o, isFullWidth: a, isLarge: c, leftControl: d, middleControl: p, position: m, rightControl: h, secondaryBar: _, style: g, subtitle: b, title: y, titleDomId: f, titleIconCell: w, titleIconCellSize: v, withBackground: E, withWideContainer: C } = this.props,
                        { isModal: k } = this.context,
                        x = o ? d : i.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        S = (function (e, t, n) {
                            return e && !(t && n);
                        })(!!E, k, !!_);
                    return i.createElement(i.Fragment, null, i.createElement(s.Z, { centerTitle: t, centeredLogo: n, isFullWidth: a, isLarge: c, leftControl: x, middleControl: p, position: u(m, k, r), rightControl: h, style: g, subtitle: b, title: y, titleDomId: f, titleIconCell: w, titleIconCellSize: v, withBackground: S, withWideContainer: C }), _ || null);
                }
                render() {
        ...
        222718: (e, t, n) => {
            ...
            class g extends i.Component {
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: n, appBarStyle: o, backLocation: a, documentTitle: l, headerless: c, history: p, leftControl: m, middleControl: h, onBackClick: g, rightControl: b, screenType: y, searchBoxOptions: f, secondaryBar: w, showBackButtonOnRoot: v, showSubtitleOnRoot: E, showSubtitleOnWideDetail: C, showTitleOnRoot: k, subtitle: x, title: S, titleIconCell: Z, titleIconCellSize: T, withDetailOpen: F, withSearchBox: I, withTweetButton: B, withWideContainer: L } = this.props,
                        P = "root" === y,
                        R = "secondaryRoot" === y,
                        D = "primaryDetail" === y,
                        A = (D && C) || (P && E),
                        z = (P && !v) || (D && e),
                        W = (P && !k) || (D && e && !k),
                        O = P ? s.ey : D ? s.vX : void 0,
                        N = i.createElement(r.Z, { style: _.appBarContainer }, i.createElement(d.ZP, { backLocation: a, fixed: !1, hideBackButton: z, history: p, leftControl: m, middleControl: h, onBackClick: g, rightControl: b, secondaryBar: w, style: o, subtitle: A ? x : void 0, title: W ? void 0 : S, titleDomId: O, titleIconCell: Z, titleIconCellSize: T, withWideContainer: L })),
                        M = P || (R && F) ? null : i.createElement(u.Z.Configure, { SideNavButton: t, TabBar: n, backLocation: a, documentTitle: l, headerless: c, middleControl: h, onBackClick: g, rightControl: b, searchBoxOptions: f, subtitle: x, title: S, withSearchBox: I, withTweetButton: B });
        ...
        546608: (e, t, n) => {
            ...
            const F = (0, Z.ZP)({ namespace: "articles" }),
                ...
                D = (0, k.ZP)(
                    L(({ article: e, createLocalApiErrorHandler: t, id: n, location: y, socialContext: f, withInternalLink: k }) => {
                        const x = (0, C.Z)(),
                            S = i.useContext(o.ZP),
                            { article_url: Z, description: T, domain: F, image_url: I, publish_date: B, title: L } = e || {},
                            ...
                            W = i.useCallback(() => {
                                x.scribe({ action: "impression", data: z });
                            }, [x, z]);
                        if (
                            (i.useEffect(() => {
                                W();
                        ...
                        const { contextImageUrls: O, landingUrl: N, text: M } = f || {},
                            H = I ? { url: I, height: 750, width: 1250 } : void 0,
                            $ = { pathname: Z, external: !0 },
                            q = (e) => {
                                x.scribe({ element: k ? "read_article" : "article_header", action: "open_link", data: z });
                            },
                            V = () => {
                                x.scribe({ element: "conversation_view", action: "click", data: z });
                            },
                            j = N ? S.getLinkFromUrtUrl(N) : void 0,
                            K = j ? S.withAnchorless(j) : void 0,
                            U = K
                                ? {
                                      ...K,
                                ...
                                : void 0,
                            G = i.createElement(i.Fragment, null, i.createElement(r.Z, { style: R.horizontalContainer }, i.createElement(r.Z, { style: R.textContainer }, i.createElement(l.Z, { style: R.middotGroup }, F && i.createElement(s.ZP, { color: "gray700", id: D.domain, size: "subtext2", weight: "bold" }, F), B && i.createElement(s.ZP, { color: "gray700", id: D.timestamp, size: "subtext2" }, i.createElement(c.Z, { timestamp: B }))), i.createElement(s.ZP, { color: "text", id: D.title, link: U, numberOfLines: 3, size: "headline2", style: R.text, weight: "bold", withInteractiveStyling: !1 }, L), T ? i.createElement(s.ZP, { id: D.description, numberOfLines: 2 }, T) : null, k ? i.createElement(r.Z, { style: R.buttonContainer }, i.createElement(d.ZP, { link: $, onClick: q, size: "xSmall", type: "primaryOutlined" }, P)) : null), H ? i.createElement(r.Z, { style: R.imageContainer }, i.createElement(u.Z, { ratio: p.default.theme.aspectRatios.square }, i.createElement(m.Z, { "aria-label": "", aspectMode: h.Z.SQUARE, image: H }))) : null), i.createElement(_.Z, { contextType: "Facepile", iconSize: "large", id: D.socialContext, text: M, textSize: "subtext2", userAvatarUrls: O, withLeftPadding: !1, withTextCentered: !0 }));
                        return k ? i.createElement(E.Z, { exact: !1, path: U?.pathname || "" }, (e) => i.createElement(g.Z, { "aria-labelledby": A.join(" "), "aria-selected": e, link: U, onClick: V, role: "article", style: R.container }, G)) : i.createElement(b.Z, { link: $, onClick: q, style: [R.container, R.bottomBorder] }, G);
                    }),
                );
        },
        90086: (e, t, n) => {
            ...
            const B = (0, n(335632).G)({}),
                L = s().b7fa0cfe,
                P = s().e950f6e0,
                R = i.createElement(s().I18NFormatMessage, { $i18n: "d9cb9d0b" }, i.createElement(C.ZP, { color: "link", link: "/i/connect_people" }, s().e7dcfb81)),
                D = () => i.createElement(k.Z, { header: P, message: R, style: z.emptyState }),
                A = (e) => {
                    ...
                    return (
                        ...
                        i.createElement(Z.Z, { anchoring: S.Z, entryConfiguration: B, module: n, renderEmptyState: D, title: L })
                    );
                },
                z = x.default.create((e) => ({ emptyState: { height: `calc(100vh - ${e.componentDimensions.appBarHeight})`, justifyContent: "center", marginVertical: 0 } })),
                W = I(i.memo(A));
            var O = n(2430),
                N = n(506063);
            const M = (e, t) => (0, f.t5)(e, f.q4),
                ...
                q = (0, T.Z)()
                    .propsFromState(() => ({ seedType: H, showFriendsOfFriendsNUX: M, timeWindowQuery: $ }))
                ...
                ie = Object.freeze({ [N.v.FOLLOWS]: K, [N.v.FRIENDS_OF_FRIENDS]: U }),
                re = (e) => {
                    const t = `(${N.v.FOLLOWS}|${N.v.FRIENDS_OF_FRIENDS})`,
                        n = new RegExp(t, "g");
                    return !!e.match(n);
                },
                oe = ({ addFlag: e, analytics: t, history: n, location: l, match: s, seedType: C, showFriendsOfFriendsNUX: k, timeWindowQuery: x }) => {
                    const { featureSwitches: S } = i.useContext(_.rC),
                        ...
                        [I, B] = i.useState(k),
                        L = (e) => `?time_window=${e || 24}`,
                        P = i.useCallback(() => (C === N.v.FRIENDS_OF_FRIENDS ? "fof" : "following"), [C]),
                        R = F ? `_${P()}` : "",
                        D = i.useCallback(() => {
                    ...
                    const A = i.useCallback(
                            (e) => {
                                const t = s.params.articleId,
                                    ...
                                    r = re(l.pathname);
                                Z && !t && i ? n.replace(`/i/articles/${C}/${i}${L(x)}`) : Z || r || n.replace(`/i/articles/${C}${L(x)}`);
                            },
                            [s.params.articleId, l.pathname, n, Z, C, x],
                        ),
                        z = (e) => () => {
                            n.replace(`/i/articles/${C}${L(e)}`);
                        },
                        O = [
                            { text: G({ count: 1 }), onClick: z(1) },
                            { text: G({ count: 2 }), onClick: z(2) },
                            { text: G({ count: 4 }), onClick: z(4) },
                            { text: G({ count: 8 }), onClick: z(8) },
                            { text: G({ count: 24 }), onClick: z(24) },
                        ],
                        ...
                        K = () => {
                            const e = $(N.v.FRIENDS_OF_FRIENDS);
                            n.replace(e), q();
                        },
                        U = (e) => i.createElement(a.Z, { actionPrimary: { text: J, onClick: K }, actionSecondary: { text: ee, onClick: q }, headline: Y, icon: d.default, iconColor: "primary", onDismiss: q, shouldDisplay: I, text: X, withMask: !0 }, ie[e]),
                        oe = ne.map((e) => ({
                            key: e,
                            label: e === N.v.FRIENDS_OF_FRIENDS && I && !H(e) ? U(e) : ie[e],
                            isActive: () => H(e),
                            to: { pathname: $(e) },
                            onClick: () => {
                        ...
                        le = i.useMemo(() => ((e, t = 864e5) => (0, E.Z)({ timelineId: `articlesTimeline-${e}-${t}`, network: { getEndpoint: (e) => e.withEndpoint(w.ZP).fetchArticleTimeline, getEndpointParams: ({ count: n, cursor: i }) => ({ count: n, cursor: "string" == typeof i ? i : void 0, articleListSeedType: e, timeWindowMillis: t }) }, context: "FETCH_TOP_ARTICLES_TIMELINE", perfKey: "articlesTimeline", formatResponse: v.Z }))(C, te(x || 24)), [C, x]);
                    return i.createElement(i.Fragment, null, i.createElement(g.Z, { title: V }), i.createElement(p.Z, { rightControl: T ? M : void 0, screenType: "root", showSubtitleOnRoot: !0, subtitle: j({ count: x || 24 }), title: i.createElement(h.Z, { text: V }) }, F ? i.createElement(m.Z, { links: oe, visibleItemIndex: ae }) : null, i.createElement(W, { module: le, onEntriesChanged: A })));
                },
                ae = q(oe);
        },
        463818: (e, t, n) => {
            ...
            const w = { context: "ArticleRedirect" },
                v = g().h965157c,
                E = g().cd388852,
                C = u.createElement(h.Z, { header: v, message: E }),
                k = { type: "CustomRetry", content: () => C },
                x = d,
                S = ({ articleEntityId: e }) => {
                ...
                Z = (e) => {
                    ...
                    return t && n ? u.createElement(b.N, { errorConfig: w, fallback: k }, u.createElement(S, { articleEntityId: t })) : C;
                },
                T = u.memo(Z);
        },
        537028: (e, t, n) => {
            ...
            var v = n(506063),
                ...
                x = n(962741),
                S = n(263863);
            const Z = (0, E.Z)({}, (0, k.G)({}), { [x.ZP.Tweet]: { handlers: { [S.Z.TweetWithoutCard]: (0, C.Cw)({ createAdditionalProps: () => ({ withCardLinks: !0 }) }) } } }),
                T = c().d35d74e4,
                F = c().f88e624e,
        ...
        425376: (e, t, n) => {
            ...
            const h = m.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                _ = ({ actionPrimary: e, actionSecondary: t, children: n, headline: _, icon: g, iconColor: b, image: y, onDismiss: f, shouldDisplay: w, text: v, withMask: E = !0 }) => {
                    const [C, k] = i.useState(!1),
                        x = (e) => i.createElement(u.Z, { onDismiss: L, renderContent: () => Z(L), switchOnlyOnXSmallBreakpoint: !0, visibilityBehavior: o.J.forceVisible, withArrow: !0, withFixedPosition: !0, withMask: E }, e),
                        S = () => i.createElement(p.Z, { onMaskClick: () => L(), type: "center", withMask: !0 }, Z(L)),
        ...
        403556: (e, t, n) => {
            ...
            class v extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: i, children: o, color: a, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: _, retainScrollPosition: v, style: C, to: k } = this.props,
                        { location: x } = this.state,
                        S = k ? this._getMemoizedLink(k, v) : void 0,
                        Z = c ? c(k) : x?.pathname === S?.pathname,
                        T = g.Z.generate({ backgroundColor: "transparent", color: l.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: u ? E.pillHoverStyle.backgroundColor : void 0 }),
                        F = _ ? "medium" : Z ? "bold" : "medium";
                    return r.createElement(b.Z, { "aria-label": t, "aria-selected": Z, focusable: !!Z, interactiveStyles: T, link: S, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(u ? [E.pillStyle] : [E.link]), ...(u && Z ? [E.pillActiveStyle] : []), d ? (u ? E.compactPill : E.compactLink) : null, p ? E.roundedRect : null, C], withoutInteractiveStyles: _ }, ({ isFocused: t, isHovered: c }) => r.createElement(s.Z, { style: u && E.flexGrow }, r.createElement(m.ZP, { size: _ ? "headline2" : void 0, style: [E.text, { color: this._getTextColor(Z, c, _, u) }, d && E.compactText, _ && t && E.focusedText, u && E.pillTextStyle, u && Z && E.pillActiveTextStyle, u && c && E.pillHoverTextStyle], weight: F }, e && r.createElement(e, { style: E.icon }), o, _ || u ? null : r.createElement(s.Z, { style: Z && [E.border, { backgroundColor: l.default.theme.colors[a] }] })), n ? r.createElement(h.Z, { count: n, standalone: !0, style: [E.badge, n >= 10 && E.multiDigitBadge, n >= 20 && E.truncatedCountBadge], truncatedCountFormatter: w, unreadCountLabel: y, withBorder: !1 }) : i ? r.createElement(h.Z, { pip: !0, standalone: !0, style: E.badgePip, textColor: "red500", unreadCountLabel: f, withBorder: !1 }) : null));
                }
            }
                        ...
                        _ = r.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: o, ...a }, c) => {
                                    ...
                                    return r.createElement(C, (0, i.Z)({ viewType: o }, a, { isCompact: n, isPillLink: l, isRoundedRect: s, isWebRedesign: h, style: d }), t);
                                }),
                            [e, n, l, s, h, c],
                        );
                    return r.createElement(o.Z, { "aria-label": t, buttonsContainerStyle: l && k.gap, childrenStyle: !h && k.flexGrow, key: p, style: [l ? null : k.segmentedControl, h && k.leftAligned, d], visibleItemIndex: u }, _);
                };
        },
        40644: (e, t, n) => {
            "use strict";
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return i.createElement(c.ZP.Consumer, null, ({ direction: s }) => i.createElement(a.ZP, { color: e ? n : o, dir: s, style: [k.inner, e && "blue500" === n && k.blue500] }, i.createElement(r.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), l, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: r, iconSize: o, isActive: a, isDisabled: c, showBackgroundWhenActive: d } = this.props,
                                ...
                                m = d && a && !e?.isHovered;
                            return i.createElement(s.Z, { hoverLabel: r, interactiveStyles: p, interactivityState: e, style: [u.default.absoluteFill, C[m ? "haloBackground" : n], !c && k.iconBackground, "small" === o && k.iconSmallBoundingBox, m && k.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !o.Z.reducedMotionEnabled && e && m) return i.createElement(d.ZP, { animation: h || p.Bf, animationContainerStyle: E[t], animationStyle: S, onAnimationEnd: l, onAnimationStart: s, onError: c });
                            {
                                const o = n && e ? e : this.props.Icon;
                                return i.createElement(o, { style: [E[t], !r && a && k.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                    ...
                    return i.createElement(
                        ...
                        i.createElement(
                            ...
                            c
                                ...
                                : i.createElement(s.Z, { "aria-haspopup": _ ? "menu" : void 0, "aria-label": e, disabled: l, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: p, link: m, onClick: this._handlePress, preventFocusShift: h, renderMenu: _, style: [k.triggerAreaRoot, k.outlineNone], testID: y }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles.60f05d2a.js.map
