    ...
    ["bundle.Articles", "icons/IconFilter-js", "icons/IconFollowArrowLeft-js", "icons/IconSparkle-js"],
    {
        ...
        625661: (e, t, i) => {
            ...
            class p extends n.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: i, fixed: r, hideBackButton: o, isFullWidth: a, isLarge: c, leftControl: d, middleControl: p, position: m, rightControl: _, secondaryBar: h, style: g, subtitle: b, title: y, titleDomId: f, titleIconCell: w, titleIconCellSize: v, withBackground: k, withWideContainer: C } = this.props,
                        { isModal: E } = this.context,
                        T = o ? d : n.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        x = (function (e, t, i) {
                            return e && !(t && i);
                        })(!!k, E, !!h);
                    return n.createElement(n.Fragment, null, n.createElement(s.Z, { centerTitle: t, centeredLogo: i, isFullWidth: a, isLarge: c, leftControl: T, middleControl: p, position: u(m, E, r), rightControl: _, style: g, subtitle: b, title: y, titleDomId: f, titleIconCell: w, titleIconCellSize: v, withBackground: x, withWideContainer: C }), h || null);
                }
                render() {
        ...
        222718: (e, t, i) => {
            ...
            class g extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildren = () => {
                            ...
                            return this.context.rootDetailPerColumnScroll ? n.createElement(r.Z, { style: h.fill }, n.createElement(m.Z, { style: h.viewportView }, this._renderInlineNav({ isTwoColumnLayout: !0 }), e)) : e;
                        });
                }
                render() {
                    return n.createElement(o.ZP, null, ({ containerWidth: e }) => (a.Z.isTwoColumnLayout(e) ? this._renderForTwoColumnLayout() : this._renderForOneColumnLayout()));
                }
                _renderForOneColumnLayout() {
                    const { appBarStyle: e, children: t, leftControl: i, screenType: r, showBackButtonOnRoot: o, showSubtitleOnRoot: a, showSubtitleOnWideDetail: s, showTitleOnRoot: c, withBottomBorder: d, withDetailOpen: p, ...m } = this.props;
                    return n.createElement(n.Fragment, null, (0, l.ZP)() ? this._renderInlineNav({ isTwoColumnLayout: !1 }) : n.createElement(u.Z.Configure, m), t);
                }
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: i, appBarStyle: o, backLocation: a, documentTitle: l, headerless: c, history: p, leftControl: m, middleControl: _, onBackClick: g, rightControl: b, screenType: y, searchBoxOptions: f, secondaryBar: w, showBackButtonOnRoot: v, showSubtitleOnRoot: k, showSubtitleOnWideDetail: C, showTitleOnRoot: E, subtitle: T, title: x, titleIconCell: S, titleIconCellSize: Z, withDetailOpen: I, withSearchBox: F, withTweetButton: L, withWideContainer: R } = this.props,
                        B = "root" === y,
                        D = "secondaryRoot" === y,
                        P = "primaryDetail" === y,
                        O = (P && C) || (B && k),
                        A = (B && !v) || (P && e),
                        z = (B && !E) || (P && e && !E),
                        N = B ? s.ey : P ? s.vX : void 0,
                        M = n.createElement(r.Z, { style: h.appBarContainer }, n.createElement(d.ZP, { backLocation: a, fixed: !1, hideBackButton: A, history: p, leftControl: m, middleControl: _, onBackClick: g, rightControl: b, secondaryBar: w, style: o, subtitle: O ? T : void 0, title: z ? void 0 : x, titleDomId: N, titleIconCell: S, titleIconCellSize: Z, withWideContainer: R })),
                        W = B || (D && I) ? null : n.createElement(u.Z.Configure, { SideNavButton: t, TabBar: i, backLocation: a, documentTitle: l, headerless: c, middleControl: _, onBackClick: g, rightControl: b, searchBoxOptions: f, subtitle: T, title: x, withSearchBox: F, withTweetButton: L });
                    return n.createElement(n.Fragment, null, W, M);
                }
            }
        ...
        496364: (e, t, i) => {
            ...
            const l = (e) => {
                ...
                return (0, o.HD)(t) ? e.children || null : n.createElement(a.Z, e);
            };
        },
        332878: (e, t, i) => {
            "use strict";
                ...
                P = (0, E.ZP)(
                    R(({ article: e, createLocalApiErrorHandler: t, id: i, location: y, socialContext: f, withInternalLink: E }) => {
                        const T = (0, C.Z)(),
                            ...
                            P = { domain: a.b(), timestamp: a.b(), title: a.b(), description: a.b(), adFree: a.b(), socialContext: a.b() },
                            O = [P.domain, P.timestamp, P.title, P.description, P.socialContext],
                            A = n.useMemo(() => {
                        ...
                        const { contextImageUrls: N, landingUrl: M, text: W } = f || {},
                            ...
                            U = M ? x.getLinkFromUrtUrl(M) : void 0,
                            K = U ? x.withAnchorless(U) : void 0,
                            j = K
                                ? {
                                      ...K,
                                ...
                                : void 0,
                            G = n.createElement(n.Fragment, null, n.createElement(r.Z, { style: D.horizontalContainer }, n.createElement(r.Z, { style: D.textContainer }, n.createElement(l.Z, { style: D.middotGroup }, I && n.createElement(s.ZP, { color: "gray700", id: P.domain, size: "subtext2", weight: "bold" }, I), L && n.createElement(s.ZP, { color: "gray700", id: P.timestamp, size: "subtext2" }, n.createElement(c.Z, { timestamp: L }))), n.createElement(s.ZP, { color: "text", id: P.title, link: j, numberOfLines: 3, size: "headline2", style: D.text, weight: "bold", withInteractiveStyling: !1 }, R), Z ? n.createElement(s.ZP, { id: P.description, numberOfLines: 2 }, Z) : null, E ? n.createElement(r.Z, { style: D.buttonContainer }, n.createElement(d.ZP, { link: V, onClick: $, size: "xSmall", type: "primaryOutlined" }, B)) : null), H ? n.createElement(r.Z, { style: D.imageContainer }, n.createElement(u.Z, { ratio: p.default.theme.aspectRatios.square }, n.createElement(m.Z, { "aria-label": "", aspectMode: _.Z.SQUARE, image: H }))) : null), n.createElement(h.Z, { contextType: "Facepile", iconSize: "large", id: P.socialContext, text: W, textSize: "subtext2", userAvatarUrls: N, withLeftPadding: !1, withTextCentered: !0 }));
                        return E ? n.createElement(k.Z, { exact: !1, path: j?.pathname || "" }, (e) => n.createElement(g.Z, { "aria-labelledby": O.join(" "), "aria-selected": e, link: j, onClick: q, role: "article", style: D.container }, G)) : n.createElement(b.Z, { link: V, onClick: $, style: [D.container, D.bottomBorder] }, G);
                    }),
                );
        },
        376293: (e, t, i) => {
            ...
            const u = a().cfd2f35e,
                ...
                E = (e, t) => ({ confirmButtonType: "destructiveFilled", headline: p({ screenName: e }), label: _, text: t ? g({ screenName: e }) : h({ screenName: e }) }),
        ...
        163390: (e, t, i) => {
            "use strict";
            i.d(t, { OX: () => p, Od: () => d, PN: () => m, uq: () => c, wR: () => h });
            var n = i(251067),
                r = i(522171),
                o = i(111677),
                a = i.n(o),
        ...
        90086: (e, t, i) => {
            ...
            const L = (0, i(335632).G)({}),
                R = s().b7fa0cfe,
                B = s().e950f6e0,
                D = n.createElement(s().I18NFormatMessage, { $i18n: "d9cb9d0b" }, n.createElement(C.ZP, { color: "link", link: "/i/connect_people" }, s().e7dcfb81)),
                P = () => n.createElement(E.Z, { header: B, message: D, style: A.emptyState }),
                O = (e) => {
                    ...
                    return (
                        ...
                        n.createElement(S.Z, { anchoring: x.Z, entryConfiguration: L, module: i, renderEmptyState: P, title: R })
                    );
                },
            ...
            const W = (e, t) => (0, f.t5)(e, f.q4),
                ...
                oe = ({ addFlag: e, analytics: t, history: i, location: l, match: s, seedType: C, showFriendsOfFriendsNUX: E, timeWindowQuery: T }) => {
                    const { featureSwitches: x } = n.useContext(h.rC),
                        S = (0, b.Cz)(),
                    ...
                    const O = n.useCallback(
                        ...
                        j = (e) => n.createElement(a.Z, { actionPrimary: { text: Y, onClick: K }, actionSecondary: { text: ee, onClick: $ }, headline: J, icon: d.default, iconColor: "primary", onDismiss: $, shouldDisplay: F, text: X, withMask: !0 }, ne[e]),
                        oe = ie.map((e) => ({
                            key: e,
                    ...
                    return n.createElement(n.Fragment, null, n.createElement(g.Z, { title: q }), n.createElement(p.Z, { rightControl: Z ? W : void 0, screenType: "root", showSubtitleOnRoot: !0, subtitle: U({ count: T || 24 }), title: n.createElement(_.Z, { text: q }) }, I ? n.createElement(m.Z, { links: oe, visibleItemIndex: ae }) : null, n.createElement(z, { module: le, onEntriesChanged: O })));
                },
                ae = $(oe);
        },
        463818: (e, t, i) => {
        ...
        425376: (e, t, i) => {
            ...
            const _ = m.default.create((e) => ({ root: { paddingVertical: e.spacesPx.space32 }, rootWithImage: { paddingTop: 0 }, graphic: { marginBottom: e.spacesPx.space20 }, icon: { alignSelf: "center", height: e.spacesPx.space64, width: e.spacesPx.space64 }, container: { paddingHorizontal: e.spacesPx.space32 }, description: { marginTop: e.spacesPx.space8, marginBottom: e.spacesPx.space4 }, actionButton: { marginTop: e.spacesPx.space16 } })),
                h = ({ actionPrimary: e, actionSecondary: t, children: i, headline: h, icon: g, iconColor: b, image: y, onDismiss: f, shouldDisplay: w, text: v, withMask: k = !0 }) => {
                    const [C, E] = n.useState(!1),
                        ...
                        Z = () => {
                            let e = g && n.createElement(g, { style: b ? [_.icon, { color: m.default.theme.colors[b] }] : _.icon });
                        ...
                        I = () => n.createElement(l.ZP, { size: "title3", weight: "heavy" }, h),
        ...
        879113: (e, t, i) => {
            ...
            class m extends n.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: i, fetchStatus: r, icon: o, loadingMessage: a, onRequestRetry: d, render: m, renderFailure: _, retryMessage: h, retryable: g } = this.props;
                    switch (r) {
                        case c:
                            return g ? n.createElement(l.Z, { icon: o, onRequestRetry: d, retryMessage: h }) : i ? n.createElement(s.m, { failureMessage: i }) : _();
                        case u:
        ...
        403556: (e, t, i) => {
            ...
            class v extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: i, badgePip: n, children: o, color: a, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: h, retainScrollPosition: v, style: C, to: E } = this.props,
                        { location: T } = this.state,
                        x = E ? this._getMemoizedLink(E, v) : void 0,
                        S = c ? c(E) : T?.pathname === x?.pathname,
                        Z = g.Z.generate({ backgroundColor: "transparent", color: l.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: u ? k.pillHoverStyle.backgroundColor : void 0 }),
                        I = h ? "medium" : S ? "bold" : "medium";
                    return r.createElement(b.Z, { "aria-label": t, "aria-selected": S, focusable: !!S, interactiveStyles: Z, link: x, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(u ? [k.pillStyle] : [k.link]), ...(u && S ? [k.pillActiveStyle] : []), d ? (u ? k.compactPill : k.compactLink) : null, p ? k.roundedRect : null, C], withoutInteractiveStyles: h }, ({ isFocused: t, isHovered: c }) => r.createElement(s.Z, { style: u && k.flexGrow }, r.createElement(m.ZP, { size: h ? "headline2" : void 0, style: [k.text, { color: this._getTextColor(S, c, h, u) }, d && k.compactText, h && t && k.focusedText, u && k.pillTextStyle, u && S && k.pillActiveTextStyle, u && c && k.pillHoverTextStyle], weight: I }, e && r.createElement(e, { style: k.icon }), o, h || u ? null : r.createElement(s.Z, { style: S && [k.border, { backgroundColor: l.default.theme.colors[a] }] })), i ? r.createElement(_.Z, { count: i, standalone: !0, style: [k.badge, i >= 10 && k.multiDigitBadge, i >= 20 && k.truncatedCountBadge], truncatedCountFormatter: w, unreadCountLabel: y, withBorder: !1 }) : n ? r.createElement(_.Z, { pip: !0, standalone: !0, style: k.badgePip, textColor: "red500", unreadCountLabel: f, withBorder: !1 }) : null));
                }
            }
            ...
            const k = l.default.create((e) => ({
                ...
                T = ({ alignFirstItem: e, "aria-label": t, isCompact: i, isPillLink: l, isRoundedRect: s, links: c, style: d, visibleItemIndex: u }) => {
                    ...
                    return r.createElement(o.Z, { "aria-label": t, buttonsContainerStyle: l && E.gap, childrenStyle: !_ && E.flexGrow, key: p, style: [l ? null : E.segmentedControl, _ && E.leftAligned, d], visibleItemIndex: u }, h);
                };
        },
        517747: (e, t, i) => {
            "use strict";
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Articles.ab17703a.js.map
