    ...
    ["bundle.AudioSpacePeek", "bundle.AudioSpaceDetail", "loader.AudioContextVoiceMedia", "icons/IconFollowArrowLeft-js", "icons/IconSound-js", "icons/IconSparkle-js"],
    {
            ...
            const f = "block",
                ...
                w = (0, p.M)((e) => {
                    const { featureSwitches: t } = (0, d.QZ)(),
                        { onBlock: o, onClose: s, onMute: l, onRemoveFollower: p, onReportUser: w, onShare: E, onUnblock: Z, onUnmute: I, user: M } = e,
                        C = [],
                        P = (t, o) => {
                    ...
                    M.followed_by &&
                        ...
                        C.push((0, u.op)({ blockAction: (e) => P(e, o), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => P(e, Z), user: M })),
                        C.push({
                            Icon: i.default,
                            onClick: () => {
                                s(), w();
                            ...
                            testID: y,
                            text: D({ screenName: M.screen_name }),
                        });
                ...
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
                            ...
                            return e ? r.createElement(n.ZP, { "aria-label": y, hoverLabel: { label: D }, icon: r.createElement(l.default, null), onPress: this._handleUnfollow, style: t, type: "primaryOutlined" }) : r.createElement(n.ZP, { "aria-label": g, hoverLabel: { label: v }, icon: r.createElement(i.default, null), onPress: this._handleFollow, style: t, type: "primaryOutlined" });
                        }),
                        (this._handleFollow = () => {
        ...
        62857: (e, t, o) => {
            ...
            class M extends n.Component {
                ...
                render() {
                    return n.createElement(d.Z, { "aria-label": I, fetchStatus: this.state.allUsersUnavailable ? b.ZP.LOADED : this.props.fetchStatus, onRequestRetry: this._handleFetch, render: this._renderContent, retryable: !1 });
                }
                _fetchUsersIfNeeded() {
        ...
        376293: (e, t, o) => {
            o.d(t, { $f: () => Z, KV: () => g, LI: () => _, SC: () => E, Vt: () => D, ed: () => S, op: () => I });
            var r = o(202784),
                n = o(190286),
                a = o(111677),
                s = o.n(a),
            ...
            const u = s().cfd2f35e,
                ...
                Z = (e, t) => ({ confirmButtonType: "destructiveFilled", headline: m({ screenName: e }), label: p, text: t ? b({ screenName: e }) : f({ screenName: e }) }),
                I = ({ blockAction: e, blockSubtext: t, isSoftBlockEnabled: o, source: r, testID: n, unblockAction: a, unblockSubtext: s, user: l }) => {
                    ...
                    return { confirmation: m, onClick: u, testID: n, shortcutKey: i, Icon: M(l.blocking), text: P(l), subText: C({ user: l, blockSubtext: t, unblockSubtext: s }) };
                },
                M = (e) => (e ? i.default : l.default),
                C = ({ blockSubtext: e, unblockSubtext: t, user: o }) => (!o.blocking && e ? e(o.screen_name) : o.blocking ? t : void 0),
                P = (e) => (e.blocking ? v({ screenName: e.screen_name }) : h({ screenName: e.screen_name })),
                _ = (e, t) => (e.blocking ? ((e, t) => ({ confirmButtonType: "primary", headline: y({ screenName: e }), label: D, text: t ? w : k }))(e.screen_name, t) : Z(e.screen_name, t)),
        ...
        847607: (e, t, o) => {
            o.d(t, { Aq: () => u, FK: () => y, GS: () => l, N1: () => h, PY: () => m, X6: () => v, cm: () => i });
            o(202784);
            var r = o(111677),
                n = o.n(r),
                a = o(391366),
            ...
            const p = (e, t) => !!e.promotedContent[t],
                ...
                b =
                    ...
                    (a, s, { api: i }) => {
                        ...
                        return (0, l._O)(a, { params: g, request: i.withEndpoint(n.Z).log })({ actionTypes: c, context: "APP_PROMOTED_CONTENT_LOG", meta: g }, (e, t) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpacePeek.5ec4688a.js.map
