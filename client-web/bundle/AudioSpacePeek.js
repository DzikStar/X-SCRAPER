...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AudioSpacePeek", "loader.AudioDock", "bundle.AudioSpaceDetail", "loader.AudioContextVoiceMedia"],
    {
            ...
            const f = "block",
                ...
                w = (0, p.M)((e) => {
                    ...
                    P.followed_by &&
                        ...
                        C.push((0, u.op)({ blockAction: (e) => Z(e, t), isSoftBlockEnabled: o.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => Z(e, E), user: P })),
                        C.push({
                            Icon: d.default,
                            onClick: () => {
                                s(), w();
                    ...
                    const _ = C.map(({ Icon: e, onClick: o, testID: t, text: r }) => ({ text: r, onClick: o, Icon: e, testID: t }));
                ...
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
                            ...
                            return e ? r.createElement(n.ZP, { "aria-label": y, hoverLabel: { label: v }, icon: r.createElement(l.default, null), onPress: this._handleUnfollow, style: o, type: "primaryOutlined" }) : r.createElement(n.ZP, { "aria-label": b, hoverLabel: { label: g }, icon: r.createElement(d.default, null), onPress: this._handleFollow, style: o, type: "primaryOutlined" });
                        }),
                        (this._handleFollow = () => {
        ...
        62857: (e, o, t) => {
            ...
            const k = (e, o) => o.userIds,
                ...
                M = (e, o) => {
                    const { userIds: t } = o;
                    return t.reduce((o, t) => {
                        const r = v.ZP.selectFetchStatus(e, t);
        ...
        376293: (e, o, t) => {
            t.d(o, { $f: () => E, KV: () => b, LI: () => _, SC: () => M, Vt: () => v, ed: () => A, op: () => I });
            var r = t(202784),
                n = t(190286),
                a = t(674132),
                s = t.n(a),
            ...
            const u = s().cfd2f35e,
                ...
                I = ({ blockAction: e, blockSubtext: o, isSoftBlockEnabled: t, source: r, testID: n, unblockAction: a, unblockSubtext: s, user: l }) => {
                    ...
                    return { confirmation: m, onClick: u, testID: n, shortcutKey: d, Icon: P(l.blocking), text: Z(l), subText: C({ user: l, blockSubtext: o, unblockSubtext: s }) };
                },
                ...
                _ = (e, o) => (e.blocking ? ((e, o) => ({ confirmButtonType: "primary", headline: y({ screenName: e }), label: v, text: o ? w : k }))(e.screen_name, o) : E(e.screen_name, o)),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpacePeek.9ddcc97a.js.map
