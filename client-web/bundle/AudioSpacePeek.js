...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AudioSpacePeek", "bundle.AudioSpaceDetail"],
    {
            ...
            const c = (e, t) => (t.communityId ? d.ZP.select(e, t.communityId) : void 0),
                ...
                m = ({ community: e, communityId: t, createLocalApiErrorHandler: o, isPinned: s, onActionButtonJoinClick: l, onPress: d, pinTimeline: i, shouldDisplayPin: c, style: u, thumbnailSize: m, unpinTimeline: h, withActionButton: p }) => {
                    ...
                    if (e) {
                        ...
                        return r.createElement(n.Z, { communityId: t, isNsfw: o, media: a, memberCount: s, membersFacepile: i, name: c, onActionButtonJoinClick: l, onPress: d, style: u, thumbnailSize: m, topic: h?.topic_name, withActionButton: p, withPinAction: D });
                    }
                    return null;
                },
                h = (0, l.Z)()
                ...
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
                            ...
                            return e ? r.createElement(n.ZP, { "aria-label": y, hoverLabel: { label: k }, icon: r.createElement(l.default, null), onPress: this._handleUnfollow, style: t, type: "primaryOutlined" }) : r.createElement(n.ZP, { "aria-label": b, hoverLabel: { label: g }, icon: r.createElement(d.default, null), onPress: this._handleFollow, style: t, type: "primaryOutlined" });
                        }),
                        (this._handleFollow = () => {
            ...
            const v = (e, t) => t.userIds,
                ...
                E = (e, t) => {
                    ...
                    return o.reduce((t, o) => {
                        ...
                        return r && (t[o] = r === D.ZP.NONE ? D.ZP.LOADING : r), t;
                    }, {});
                },
                M = (0, g.Z)()
                    .propsFromState(() => ({
                        availableUserIds: (0, y.Z)(w, (e) => e),
                        fetchStatus: (0, y.Z)(w, E, v, (e, t, o) => {
                            let r = D.ZP.LOADED;
        ...
        376293: (e, t, o) => {
            o.d(t, { $f: () => M, KV: () => b, LI: () => C, SC: () => E, Vt: () => k, ed: () => A, op: () => I });
            var r = o(202784),
                n = o(190286),
                a = o(111677),
                s = o.n(a),
            ...
            const u = s().cfd2f35e,
                ...
                M = (e, t) => ({ confirmButtonType: "destructiveFilled", headline: m({ screenName: e }), label: p, text: t ? D({ screenName: e }) : f({ screenName: e }) }),
            ...
            const p = (e, t) => !!e.promotedContent[t],
                ...
                D =
                    ...
                    (a, s, { api: d }) => {
                        ...
                        return (0, l._O)(a, { params: b, request: d.withEndpoint(n.Z).log })({ actionTypes: i, context: "APP_PROMOTED_CONTENT_LOG", meta: b }, (e, t) => {
        ...
        879113: (e, t, o) => {
            ...
            class h extends r.Component {
                ...
                render() {
                    ...
                    switch (n) {
                        case i:
                            return D ? r.createElement(l.Z, { icon: a, onRequestRetry: c, retryMessage: f }) : o ? r.createElement(d.m, { failureMessage: o }) : p();
                        case u:
