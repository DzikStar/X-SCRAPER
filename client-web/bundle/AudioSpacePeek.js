            ...
            const f = "block",
                ...
                D = (0, p.M)((e) => {
                    ...
                    _.followed_by &&
                        ...
                        Z.push((0, u.op)({ blockAction: (e) => I(e, n), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => I(e, C), user: _ })),
                        Z.push({
                            Icon: l.default,
                            onClick: () => {
                                s(), D();
                    ...
                    const S = Z.map(({ Icon: e, onClick: t, testID: n, text: o }) => ({ text: o, onClick: t, Icon: e, testID: n }));
        ...
        376293: (e, t, n) => {
            ...
            const u = s().cfd2f35e,
                ...
                P = ({ blockAction: e, blockSubtext: t, isSoftBlockEnabled: n, source: o, testID: r, unblockAction: a, unblockSubtext: s, user: i }) => {
                    ...
                    return { confirmation: m, onClick: u, testID: r, shortcutKey: l, Icon: _(i.blocking), text: I(i), subText: Z({ user: i, blockSubtext: t, unblockSubtext: s }) };
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpacePeek.3528a51a.js.map
