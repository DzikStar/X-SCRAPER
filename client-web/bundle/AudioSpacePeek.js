    ...
    ["bundle.AudioSpacePeek", "loader.AudioDock", "bundle.AudioSpaceDetail", "loader.AudioContextVoiceMedia"],
    {
            ...
            const f = "block",
                ...
                E = (0, p.M)((e) => {
                    const { featureSwitches: t } = (0, d.QZ)(),
                        { onBlock: o, onClose: s, onMute: l, onRemoveFollower: p, onReportUser: E, onShare: w, onUnblock: P, onUnmute: C, user: M } = e,
                        I = [],
                        _ = (t, o) => {
                    ...
                    M.followed_by &&
                        ...
                        I.push((0, u.op)({ blockAction: (e) => _(e, o), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => _(e, P), user: M })),
                        I.push({
                            Icon: i.default,
                            onClick: () => {
                                s(), E();
        ...
        812190: (e, t, o) => {
            ...
            var n = o(202784),
                ...
                i = o(491963),
                c = o(709318);
            const d = (e, { communityId: t }) => (t ? i.ZP.select(e, t) : void 0),
                u = (e, { communityId: t }) => !!t && (0, c.H4)(e, t),
        ...
        376293: (e, t, o) => {
            o.d(t, { $f: () => P, KV: () => y, LI: () => Z, SC: () => w, Vt: () => k, ed: () => S, op: () => C });
            var n = o(202784),
                r = o(190286),
                a = o(674132),
                s = o.n(a),
            ...
            const u = s().cfd2f35e,
                ...
                P = (e, t) => ({ confirmButtonType: "destructiveFilled", headline: m({ screenName: e }), label: p, text: t ? b({ screenName: e }) : f({ screenName: e }) }),
                C = ({ blockAction: e, blockSubtext: t, isSoftBlockEnabled: o, source: n, testID: r, unblockAction: a, unblockSubtext: s, user: l }) => {
                    let i,
                        u = c.Z;
                    const m = Z(l, o);
                    switch (n) {
                ...
                Z = (e, t) => (e.blocking ? ((e, t) => ({ confirmButtonType: "primary", headline: g({ screenName: e }), label: k, text: t ? E : v }))(e.screen_name, t) : P(e.screen_name, t)),
        ...
        163390: (e, t, o) => {
            ...
            const c = Object.freeze({ toggleCommandCenter: "mod+k", openKeyboardShortcuts: "?", swipeLeft: "left", swipeRight: "right", nextItem: "j", previousItem: "k", refresh: ".", nightMode: "z", bookmark: "b", block: "x", mute: "u", newTweet: "n", newMessage: "m", toggleDMDrawer: "i", goHome: "g h", goExplore: "g e", goNotifications: "g n", goMentions: "g r", goProfile: "g p", goLikes: "g l", goLists: "g i", goMessages: "g m", goGrok: "g g", goToDrafts: "g f", goToScheduled: "g t", goSettings: "g s", goToUser: "g u", goBookmarks: "g b", goTopArticles: "g a", goDisplay: "g d", search: "/", audio: { dock: "a d", play: "a space", mute: "a m" }, video: { play1: "k", play2: "space", mute: "m" }, columns: { createNewColumn: "c n", duplicateColumn: "c d", focusOnReorderButton: "c r", lastColumn: "c 0", nextColumn: "]", nthColumn: "c 1..9", prevColumn: "[", removeColumn: "c backspace", toggleColumnOptions: "c o", undoRemoveColumn: "c u" }, decks: { createNewDeck: "d n", editActiveDeck: "d e", lastPinnedDeck: "d 0", manageAllDecks: "d m", nthPinnedDeck: "d 1..9" }, labs: { openCommandCenter: ">" } }),
                ...
                m = () => [
                    ...
                    { description: s().a9ae1e78, keys: c.search, universal: !0 },
        ...
        678773: (e, t, o) => {
            ...
            const l = (e = {}) => {
                ...
                return (0, r.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [s.Z.root, e.style], viewBox: "0 0 24 24", children: n.createElement("g", null, n.createElement("path", { d: "M19.996 10h-16V8h16v2zm0 6h-16v-2h16v2z" })) }, { writingDirection: t });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpacePeek.3d67da8a.js.map
