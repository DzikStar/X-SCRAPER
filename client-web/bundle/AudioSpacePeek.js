    ...
    ["bundle.AudioSpacePeek", "loader.AudioDock", "bundle.AudioSpaceDetail", "loader.AudioContextVoiceMedia"],
    {
            ...
            const f = "block",
                ...
                w = (0, p.M)((e) => {
                    ...
                    P.followed_by &&
                        ...
                        _.push((0, u.op)({ blockAction: (e) => Z(e, t), isSoftBlockEnabled: o.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => Z(e, M), user: P })),
                        _.push({
                            Icon: d.default,
                            onClick: () => {
                                s(), w();
                    ...
                    const C = _.map(({ Icon: e, onClick: o, testID: t, text: r }) => ({ text: r, onClick: o, Icon: e, testID: t }));
        ...
        812190: (e, o, t) => {
            ...
            var r = t(202784),
                ...
                d = t(491963),
                i = t(709318);
            const c = (e, o) => (o.communityId ? d.ZP.select(e, o.communityId) : void 0),
                u = (e, o) => !!o.communityId && (0, i.H4)(e, o.communityId),
            ...
            const v = (e, o) => o.userIds,
                ...
                E = (e, o) => {
                    ...
                    return t.reduce((o, t) => {
                        ...
                        return r && (o[t] = r === D.ZP.NONE ? D.ZP.LOADING : r), o;
                    }, {});
                },
                M = (0, g.Z)()
                    .propsFromState(() => ({
        ...
        376293: (e, o, t) => {
            t.d(o, { $f: () => M, KV: () => b, LI: () => C, SC: () => E, Vt: () => k, ed: () => A, op: () => I });
            var r = t(202784),
                n = t(190286),
                a = t(111677),
                s = t.n(a),
            ...
            const u = s().cfd2f35e,
                ...
                I = ({ blockAction: e, blockSubtext: o, isSoftBlockEnabled: t, source: r, testID: n, unblockAction: a, unblockSubtext: s, user: l }) => {
                    ...
                    return { confirmation: m, onClick: u, testID: n, shortcutKey: d, Icon: P(l.blocking), text: Z(l), subText: _({ user: l, blockSubtext: o, unblockSubtext: s }) };
                },
                ...
                C = (e, o) => (e.blocking ? ((e, o) => ({ confirmButtonType: "primary", headline: y({ screenName: e }), label: k, text: o ? w : v }))(e.screen_name, o) : M(e.screen_name, o)),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpacePeek.1cdb537a.js.map
