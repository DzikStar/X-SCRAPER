        ...
        242454: (e, t, r) => {
            ...
            const d = s.default.create((e) => ({ container: { backgroundColor: e.colors.cellBackground }, root: { justifyContent: "center", minHeight: e.spaces.space48, paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space16 } })),
                u = ({ align: e = "center", color: t, label: r, ...u }) => {
                    const m = c.Z.generate({ backgroundColor: s.default.theme.colors.transparent, color: s.default.theme.colors[t], insetFocusRing: !0 });
                    return l.createElement(a.Z, { style: d.container }, l.createElement(i.Z, (0, o.Z)({}, u, { interactiveStyles: m, style: d.root }), l.createElement(n.ZP, { align: e, color: t }, r)));
                };
        },
        420412: (e, t, r) => {
            r.d(t, { Z: () => i });
            ...
            function i({ borderColor: e = "borderColor", isSlim: t = !1, label: r }) {
                const { isWebRedesign: i } = a.ZP.useProps(),
                    d = "borderColor" === e || "nestedBorderColor" === e ? s[e] : { backgroundColor: c.default.theme.colors[e] ?? c.default.theme.colors.borderColor };
                return r ? o.createElement(n.Z, { style: !t && s.root, withGutter: !0 }, o.createElement(l.Z, { style: s.gapColumn }, o.createElement(l.Z, { style: [s.gap, d] })), o.createElement(l.Z, { style: s.gapText }, r), o.createElement(l.Z, { style: s.gapColumn }, o.createElement(l.Z, { style: [s.gap, d] }))) : o.createElement(l.Z, { style: [!t && s.root, i() && s.rootRedesign, s.gap, d] });
            }
            ...
            class c extends l.Component {
                render() {
                    const { children: e, style: t, withGutter: r, ...n } = this.props,
                        c = l.Children.map(e, (e) => e && l.cloneElement(e, { style: [e.props.style, i.column, r && i.withGutterColumn] }));
                    return l.createElement(a.Z, (0, o.Z)({ style: [t, i.root, r && i.withGutter] }, n), c);
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpaceReport.96745f0a.js.map
