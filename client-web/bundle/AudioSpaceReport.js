...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AudioSpaceReport", "loader.AudioDock", "loader.AudioContextVoiceMedia", "icons/IconChevronRight-js", "icons/IconFollowArrowLeft-js", "icons/IconSparkle-js"],
    {
        242454: (e, t, r) => {
            r.d(t, { Z: () => u });
            var o = r(807896),
            ...
            const d = s.default.create((e) => ({ container: { backgroundColor: e.colors.cellBackground }, root: { justifyContent: "center", minHeight: e.spaces.space48, paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space16 } })),
                u = ({ align: e = "center", color: t, label: r, ...u }) => {
                    const h = i.Z.generate({ backgroundColor: s.default.theme.colors.transparent, color: s.default.theme.colors[t], insetFocusRing: !0 });
                    return l.createElement(a.Z, { style: d.container }, l.createElement(c.Z, (0, o.Z)({}, u, { interactiveStyles: h, style: d.root }), l.createElement(n.ZP, { align: e, color: t }, r)));
                };
        },
        420412: (e, t, r) => {
            r.d(t, { Z: () => c });
            ...
            function c({ borderColor: e = "borderColor", isSlim: t = !1, label: r }) {
                ...
                return r ? o.createElement(n.Z, { style: !t && s.root, withGutter: !0 }, o.createElement(l.Z, { style: s.gapColumn }, o.createElement(l.Z, { style: [s.gap, d] })), o.createElement(l.Z, { style: s.gapText }, r), o.createElement(l.Z, { style: s.gapColumn }, o.createElement(l.Z, { style: [s.gap, d] }))) : o.createElement(l.Z, { style: [!t && s.root, c() && s.rootRedesign, s.gap, d] });
            }
            ...
            class i extends l.Component {
                render() {
                    const { children: e, style: t, withGutter: r, ...n } = this.props,
                        i = l.Children.map(e, (e) => e && l.cloneElement(e, { style: [e.props.style, c.column, r && c.withGutterColumn] }));
                    return l.createElement(a.Z, (0, o.Z)({ style: [t, c.root, r && c.withGutter] }, n), i);
                }
            }
        ...
        58399: (e, t, r) => {
            ...
            var o = r(202784),
                ...
                i = r(347101);
            const c = (e = {}) => {
                const t = o.useContext(n.Z),
                    { direction: r } = (0, a.Z)();
                return (0, l.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [i.Z.root, e.style, t && i.Z.iconRTL], viewBox: "0 0 24 24", children: o.createElement("g", null, o.createElement("path", { d: "M14.586 12L7.543 4.96l1.414-1.42L17.414 12l-8.457 8.46-1.414-1.42L14.586 12z" })) }, { writingDirection: r });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpaceReport.6993f97a.js.map
