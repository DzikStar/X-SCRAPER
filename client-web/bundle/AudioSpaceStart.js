...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.AudioSpaceStart", "loader.AudioDock", "loader.AudioContextVoiceMedia", "icons/IconChevronDown-js", "icons/IconSchedule-js"],
    {
        337631: (e, t, r) => {
            r.d(t, { Z: () => i });
            var a,
        ...
        108837: (e, t, r) => {
            ...
            const u = d.default.create((e) => ({ header: { flexGrow: 1, padding: e.spaces.space16, flexDirection: "row", justifyContent: "space-between" }, chevronMargin: { marginStart: e.spaces.space12 }, chevronExpanded: { color: e.colors.primary, transform: "rotate(-180deg)" }, chevronAnimation: { transitionDuration: "100ms" }, title: { flexDirection: "row" }, iconBefore: { marginEnd: e.spaces.space8 }, iconAfter: { marginStart: e.spaces.space8 } })),
                h = ({ accordionItemId: e = "", children: t, headerStyles: r, icon: h, iconColor: p, iconImage: m, iconSide: g, isExpanded: b = !1, onClick: y, onToggle: f, testID: v, title: C, titleColor: _, titleStyles: E }) => {
                    const w = s.Z.generate({ backgroundColor: "transparent", color: d.default.theme.colors.primary, customFocusBackgroundColor: d.default.theme.colors.gray0, customHoverBackgroundColor: d.default.theme.colors.gray0, customPressedBackgroundColor: d.default.theme.colors.gray0, insetFocusRing: !0 }),
                        D = g || "AfterTitle",
                        x = () =>
                            h
                                ? ((e, t) => {
                    ...
                    return a.createElement(
                        ...
                        a.createElement(
                            ...
                            a.createElement(n.Z, { style: u.title }, "BeforeTitle" === D ? x() : null, a.createElement(i.ZP, { color: _ && _, style: E, testID: "title", weight: "bold" }, C), "AfterTitle" === D ? x() : null),
                            (() => {
        ...
        586855: (e, t, r) => {
            ...
            const l = 1,
                ...
                b = 11,
                y = 12,
                f = { [l]: { label: n().hac89ab0, numDays: 31 }, [i]: { label: n().ef30b30a, numDays: 28, numDaysLeapYear: 29 }, [s]: { label: n().b56920fa, numDays: 31 }, [c]: { label: n().b1a0f1ec, numDays: 30 }, [d]: { label: n().daf779c8, numDays: 31 }, [u]: { label: n().c6ad074e, numDays: 30 }, [h]: { label: n().f1db106c, numDays: 31 }, [p]: { label: n().i4e80b7a, numDays: 31 }, [m]: { label: n().efa6cc1e, numDays: 30 }, [g]: { label: n().f40a0cbe, numDays: 31 }, [b]: { label: n().ac74a31c, numDays: 30 }, [y]: { label: n().i6c1e4b2, numDays: 31 } },
                v = (e) => ({ label: `${e}`, value: `${e}` }),
                C = (0, o.Z)(1, 29).map(v),
                _ = (0, o.Z)(1, 30).map(v),
                E = (0, o.Z)(1, 31).map(v),
        ...
        466818: (e, t, r) => {
            ...
            class g extends a.PureComponent {
                    ...
                    return a.createElement(
                        ...
                        a.createElement(d.ZP.Consumer, null, ({ direction: e }) => {
                            ...
                            return a.createElement(
                                ...
                                a.createElement(
                                    h,
                                    { "aria-describedby": x, "aria-invalid": w, "aria-labelledby": this._labelID, disabled: t, id: this._id, onBlur: this._handleBlur, onChange: this._handleChange, onFocus: this._handleFocus, ref: this._selectRef, style: [b.select, { fontFamily: s }, t && i.Z.disabled], testID: f || "", value: v },
                                ...
                                a.createElement(o.default, { style: [b.dropdownCaret, _ && i.Z.validColor, !(!c && !r) && i.Z.invalidColor] }),
                            );
                        }),
                ...
                _renderLabel() {
                    ...
                    return a.createElement(s.ZP, { color: t || e ? "red500" : n ? "primary" : "gray700", id: this._labelID, role: "label", style: b.label }, r);
                }
                _renderHelperText() {
                    return a.createElement(n.Z, { "aria-live": "polite" }, a.createElement(s.ZP, { color: "gray700", id: this._helperID, style: b.helperText }, this.props.helperText));
                }
                _renderErrorText() {
                    return a.createElement(n.Z, { "aria-live": "polite" }, a.createElement(s.ZP, { color: "red500", id: this._errorID, style: b.helperText }, this.props.errorText));
                }
            }
        ...
        564619: (e, t, r) => {
            ...
            class C extends a.Component {
                ...
                _renderHelperText() {
                    ...
                    return a.createElement(n.Z, { "aria-live": "polite" }, a.createElement(s.ZP, { color: "gray700", style: E.subtext }, e));
                }
                _renderErrorText() {
                    const { errorText: e } = this.props;
                    return a.createElement(n.Z, { "aria-live": "assertive" }, a.createElement(s.ZP, { color: "red500", style: E.subtext }, e));
                }
            }
            class _ {
                constructor(e, t) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.AudioSpaceStart.8fab716a.js.map
