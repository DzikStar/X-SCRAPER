    ...
    ["bundle.BadgeViolationsNotification"],
    {
        625661: (t, e, o) => {
            ...
            class p extends i.Component {
                ...
                _renderContent() {
                    const { backButtonType: t, centerTitle: e, centeredLogo: o, fixed: r, hideBackButton: n, isFullWidth: a, isLarge: c, leftControl: d, middleControl: p, position: u, rightControl: m, secondaryBar: g, style: B, subtitle: b, title: y, titleDomId: f, titleIconCell: k, titleIconCellSize: C, withBackground: x, withWideContainer: _ } = this.props,
                        { isModal: Z } = this.context,
                        w = n ? d : i.createElement(l.Z, { backButtonType: t, onClick: this._handleBackClick }),
                        E = (function (t, e, o) {
                            return t && !(e && o);
                        })(!!x, Z, !!g);
                    return i.createElement(i.Fragment, null, i.createElement(s.Z, { centerTitle: e, centeredLogo: o, isFullWidth: a, isLarge: c, leftControl: w, middleControl: p, position: h(u, Z, r), rightControl: m, style: B, subtitle: b, title: y, titleDomId: f, titleIconCell: k, titleIconCellSize: C, withBackground: E, withWideContainer: _ }), g || null);
                }
                render() {
                ...
                constructor(...t) {
                    super(...t),
                        (this._renderChildViewAppBar = () => {
                            ...
                            return i.createElement(r.Z, { style: k ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, i.createElement(d.ZP, { backButtonType: o || (k ? "close" : "back"), backLocation: n, centerTitle: a, fixed: !k, hideBackButton: l, history: s, isFullWidth: h, isLarge: p, middleControl: u, onBackClick: g, ref: t, rightControl: B, secondaryBar: b, style: [k && m.appBarModal, e], subtitle: y, title: f, titleDomId: c.Q_ }));
                        }),
            ...
            class Z extends i.Component {
                ...
                render() {
                    const { fetchStatus: t, history: e } = this.props,
                        o = t === B.ZP.LOADED;
                    return i.createElement(u.Z, { backLocation: C, containerStyle: !o && w.loading, history: e, renderHeader: o ? _ : void 0 }, i.createElement(l.Z, { fetchStatus: t, onRequestRetry: this._handleRequestRetry, render: this._render, retryMessage: x, retryable: !0 }));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.BadgeViolationsNotification.7439197a.js.map
