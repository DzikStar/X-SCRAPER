    ...
    ["bundle.Birdwatch-e019dbda"],
    {
        ...
        337523: (e, t, o) => {
            ...
            class v extends n.Component {
                ...
                render() {
                    ...
                    const E = this._getModule(i, o?.tabs?.initialTabId, t, l),
                        ...
                        h = _ ? 1e3 * _ : void 0;
                    return n.createElement(b.nO, { namespace: this._getTimelineNamespace() }, n.createElement(F.Z, { entryConfiguration: e, module: E, pollingIntervalMsOverride: h, prerollDisplayLocation: a, refreshControl: r, renderEmptyState: s, renderUnavailable: d, title: c, withoutHeadroom: u }));
                }
            }
            v.contextType = M.rC;
            const H = Z(v);
            ...
            function K(e) {
                ...
                return n.createElement(G.Z, { style: Y.root }, n.createElement(b.nO, { data: i, namespace: l }, n.createElement(W.Z, { displayType: o, facepile: a, onFollowHeaderOffscreen: ({ isOffscreen: e }) => d(!e), topicId: s, topicLandingContext: r, withDivider: !0 })));
            }
            ...
            const he = Q.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                pe = ue(function (e) {
                    const t = e.navBar.topicId ? e.navBar.topicId : "",
                        ...
                        h = (0, l.Z)({}, r, _);
                    return s ? n.createElement(b.nO, { data: E, namespace: h }, n.createElement(n.Fragment, null, i ? n.createElement(re.Z, { canonical: Ee(t), description: s.description, title: s.name, type: "article" }) : null, d ? n.createElement(ae.Z, { deepLink: _e(t) }) : null, n.createElement(G.Z, { style: he.rightControl }, n.createElement(G.Z, { style: he.followButtonContainer }, n.createElement(ne.Z, { animateMount: !0, show: o, type: "fade" }, n.createElement(se.ZP, { size: "medium", textMode: de.q.FollowTopic, topic: s }))), u ? n.createElement(ie.ZP, { copyLinkShareLabel: be, scribeNamespace: h, url: Ee(t) }) : null))) : null;
                }),
                Se = i().e9f1fbcc,
                me = n.createElement(c.Z, null),
                we = (e) => {
                    const { TabBar: t, backLocation: o, documentTitle: a, entryConfiguration: d, fab: i, getTabLink: c, hasTabNavigation: S, history: m, initialFetchStatus: w, initialPageNamespace: T, logoButton: C, module: I, onBackClick: A, pageConfiguration: N, prerollDisplayLocation: f, renderEmptyState: D, renderUnavailable: R, rightControl: g, selectedTabId: U, sidebarContent: L, timelinePrefix: M, title: y, withAppLinks: F, withBottomLoginSignupBar: P, withDeferredView: B, withOpenGraphMeta: Z, withSearchBox: v, withTweetButton: x } = e,
                        G = (0, r.tj)(),
        ...
        979090: (e, t, o) => {
            o.d(t, { $e: () => De, BG: () => ne, Bb: () => Be, Bs: () => re, C7: () => Ne, EW: () => Ae, HO: () => _e, JL: () => le, Jn: () => pe, Kc: () => Ue, Ld: () => Pe, Lt: () => X, Ly: () => Y, OV: () => oe, PL: () => se, Pi: () => me, Qg: () => W, SZ: () => He, V0: () => ye, Wk: () => ee, X3: () => Le, _T: () => Qe, _b: () => ve, aZ: () => Oe, ap: () => ie, cS: () => ae, dw: () => $, eD: () => de, eY: () => Te, et: () => V, f3: () => be, f_: () => Me, gH: () => Ee, gP: () => xe, jm: () => j, kT: () => Fe, kX: () => ke, lC: () => Re, lW: () => ce, lw: () => fe, mZ: () => Ge, mv: () => we, oV: () => We, pN: () => Ie, qm: () => ge, r9: () => q, sz: () => J, tk: () => K, vF: () => Se, w6: () => ue, wK: () => Ze, wd: () => he, ww: () => Ce });
            o(571372), o(136728);
            var n = o(744531),
                a = o(401388),
                r = o(106067),
            ...
            const Q = [],
                ...
                Me = (e) => ({ meta: { note_id: e }, type: h.SUCCESS }),
                ye =
                    (e) =>
                    (t, o, { api: n }) =>
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Birdwatch-e019dbda.70b6003a.js.map
