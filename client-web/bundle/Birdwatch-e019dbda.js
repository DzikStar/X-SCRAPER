...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Birdwatch-e019dbda"],
    {
        ...
        337523: (e, t, n) => {
            ...
            class v extends o.Component {
                ...
                render() {
                    ...
                    const E = this._getModule(i, n?.tabs?.initialTabId, t, l),
                        ...
                        b = _ ? 1e3 * _ : void 0;
                    return o.createElement(h.nO, { namespace: this._getTimelineNamespace() }, o.createElement(F.Z, { entryConfiguration: e, module: E, pollingIntervalMsOverride: b, prerollDisplayLocation: a, refreshControl: r, renderEmptyState: s, renderUnavailable: d, title: c, withoutHeadroom: u }));
                }
            }
            v.contextType = M.rC;
            const H = Z(v);
            ...
            const V = (e, t) => {
                const n = (0, j.z)(),
                    ...
                    s = o.useMemo(() => ({ items: [z.Z.forTopic(e, t)] }), [t, e]);
                return (
                    (0, q.q)(() => {
            ...
            function K(e) {
                const {
                    ...
                    { data: i, namespace: l } = V(s, t);
                return o.createElement(G.Z, { style: Y.root }, o.createElement(h.nO, { data: i, namespace: l }, o.createElement(W.Z, { displayType: n, facepile: a, onFollowHeaderOffscreen: ({ isOffscreen: e }) => d(!e), topicId: s, topicLandingContext: r, withDivider: !0 })));
            }
            ...
            const J = (e, t) => t.module.selectPageConfiguration(e),
                ...
                ee = (0, $.P1)(J, X, (e, t) => t !== b.Z.LOADED || (!!e && !!e.tabs)),
                te = (0, I.Z)()
            ...
            const ce = (e, t) => {
                ...
                he = i().ed88e742;
            const be = Q.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                pe = ue(function (e) {
                    const t = e.navBar.topicId ? e.navBar.topicId : "",
                        ...
                        { data: E, namespace: _ } = V(t, a),
                        b = (0, l.Z)({}, r, _);
                    return s ? o.createElement(h.nO, { data: E, namespace: b }, o.createElement(o.Fragment, null, i ? o.createElement(re.Z, { canonical: Ee(t), description: s.description, title: s.name, type: "article" }) : null, d ? o.createElement(ae.Z, { deepLink: _e(t) }) : null, o.createElement(G.Z, { style: be.rightControl }, o.createElement(G.Z, { style: be.followButtonContainer }, o.createElement(oe.Z, { animateMount: !0, show: n, type: "fade" }, o.createElement(se.ZP, { size: "medium", textMode: de.q.FollowTopic, topic: s }))), u ? o.createElement(ie.ZP, { copyLinkShareLabel: he, scribeNamespace: b, url: Ee(t) }) : null))) : null;
                }),
                Se = i().e9f1fbcc,
                me = o.createElement(c.Z, null),
                we = (e) => {
                    const { TabBar: t, backLocation: n, documentTitle: a, entryConfiguration: d, fab: i, getTabLink: c, hasTabNavigation: S, history: m, initialFetchStatus: w, initialPageNamespace: T, logoButton: C, module: I, onBackClick: A, pageConfiguration: N, prerollDisplayLocation: D, renderEmptyState: f, renderUnavailable: R, rightControl: g, selectedTabId: U, sidebarContent: L, timelinePrefix: M, title: y, withAppLinks: F, withBottomLoginSignupBar: P, withDeferredView: B, withOpenGraphMeta: Z, withSearchBox: v, withTweetButton: x } = e,
                        G = (0, r.tj)(),
                    ...
                    return o.createElement(h.nO, { namespace: J }, o.createElement(p.Z, null, o.createElement(_.Z, { TabBar: t, backLocation: n, documentTitle: a, history: m, logoButton: C, onBackClick: A, primaryContent: oe, rightControl: ee || g, secondaryBar: ae, sidebarContent: L, subtitle: V, title: X && W ? y : $, withBottomLoginSignupBar: P, withSearchBox: v, withTweetButton: x })));
                };
        ...
        26232: (e, t, n) => {
            ...
            class S extends o.Component {
                constructor(...e) {
                    super(...e),
                        (this._render = () => {
                            ...
                            return !t || r < 1 ? null : 1 === r ? o.createElement(i.Z, { cacheKey: "sliceTimeline", footer: e, identityFunction: b, items: t, noItemsRenderer: n, onNearEnd: this._handleNearEnd, onScrollEnd: s, renderer: d, withoutHeadroom: l }) : o.createElement(a.Z, { ListEmptyComponent: n, data: t, keyExtractor: b, numColumns: r, renderItem: p(d) });
                        }),
                        (this._handleNearEnd = () => {
                ...
                render() {
                    ...
                    return t ? o.createElement(d.Z, { "aria-label": h, fetchStatus: e, onRequestRetry: this._handleFetch, render: this._render, retryMessage: n, retryable: !0 }) : null;
                }
            }
        ...
        979090: (e, t, n) => {
            n.d(t, { $e: () => Re, BG: () => ae, Bb: () => Ze, Bs: () => se, C7: () => De, EW: () => Ne, HO: () => he, JL: () => ce, Jn: () => Se, Kc: () => Le, Ld: () => Be, Lt: () => ee, Ly: () => $, OV: () => oe, PL: () => de, Pi: () => we, Qg: () => q, SZ: () => ke, V0: () => Fe, Wk: () => te, X3: () => Me, _T: () => We, _b: () => He, aZ: () => ge, ap: () => le, cS: () => re, dw: () => J, eD: () => ie, eY: () => Ce, et: () => K, f3: () => be, f_: () => ye, gH: () => _e, gP: () => Ge, jm: () => z, kT: () => Pe, kX: () => xe, lC: () => Oe, lW: () => ue, lw: () => fe, mZ: () => Qe, mv: () => Te, oV: () => qe, pN: () => Ae, qm: () => Ue, r9: () => j, sz: () => X, tk: () => Y, vF: () => me, w6: () => Ee, wK: () => ve, wd: () => pe, ww: () => Ie });
            n(571372), n(136728);
            var o = n(744531),
                a = n(401388),
                r = n(106067),
            ...
            const h = "birdwatchNotes",
                b = `rweb/${h}`,
                p = (0, l.dg)(b, "DELETE_NOTE"),
                S = (0, l.dg)(b, "CREATE_RATING"),
                m = (0, l.dg)(b, "DELETE_RATING"),
                w = (0, l.dg)(b, "SELECT_ALIAS"),
                T = (0, l.dg)(b, "CREATE_APPEAL"),
                C = (0, l.dg)(b, "EDIT_NOTIFICATION_SETTINGS"),
                I = Object.freeze({ REQUEST: "rweb/birdwatchNotes/CREATE_BIRDWATCH_BAT_SIGNAL_REQUEST", SUCCESS: "rweb/birdwatchNotes/CREATE_BIRDWATCH_BAT_SIGNAL_SUCCESS", FAILURE: "rweb/birdwatchNotes/CREATE_BIRDWATCH_BAT_SIGNAL_FAILURE" }),
                A = Object.freeze({ REQUEST: "rweb/birdwatchNotes/DELETE_BIRDWATCH_BAT_SIGNAL_REQUEST", SUCCESS: "rweb/birdwatchNotes/DELETE_BIRDWATCH_BAT_SIGNAL", FAILURE: "rweb/birdwatchNotes/DELETE_BIRDWATCH_BAT_SIGNAL" }),
                N = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_BIRDWATCH_BAT_SIGNAL_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_BIRDWATCH_BAT_SIGNAL_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_BIRDWATCH_BAT_SIGNAL_FAILURE" }),
                D = (Object.freeze({ REQUEST: "rweb/birdwatchNotes/EDIT_SHOW_MOBILE_NAVIGATION_SETTINGS_REQUEST", SUCCESS: "rweb/birdwatchNotes/EDIT_SHOW_MOBILE_NAVIGATION_SETTINGS_SUCCESS", FAILURE: "rweb/birdwatchNotes/EDIT_SHOW_MOBILE_NAVIGATION_SETTINGS_FAILURE" }), Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_DATA_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_DATA_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_DATA_FAILURE" })),
                f = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_CAN_BE_MEDIA_NOTE_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_CAN_BE_MEDIA_NOTE_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_CAN_BE_MEDIA_NOTE_FAILURE" }),
                R = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_NOTE_TRANSLATION_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_NOTE_TRANSLATION_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_NOTE_TRANSLATION_FAILURE" }),
                O = Object.freeze({ REQUEST: "rweb/birdwatchNotes/ADMIT_USER_REQUEST", SUCCESS: "rweb/birdwatchNotes/ADMIT_USER_SUCCESS", FAILURE: "rweb/birdwatchNotes/ADMIT_USER_FAILURE" }),
                g = Object.freeze({ REQUEST: "rweb/birdwatchNotes/REMOVE_USER_REQUEST", SUCCESS: "rweb/birdwatchNotes/REMOVE_USER_SUCCESS", FAILURE: "rweb/birdwatchNotes/REMOVE_USER_FAILURE" }),
                U = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_ALIAS_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_ALIAS_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_ALIAS_FAILURE" }),
                L = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_SIGNUP_ELIGIBILITY_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_SIGNUP_ELIGIBILITY_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_SIGNUP_ELIGIBILITY_FAILURE" }),
                ...
                y = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_ALIAS_SELECT_OPTIONS_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_ALIAS_SELECT_OPTIONS_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_ALIAS_SELECT_OPTIONS_FAILURE" }),
                F = Object.freeze({ REQUEST: "rweb/birdwatchNotes/CREATE_NOTE_REQUEST", SUCCESS: "rweb/birdwatchNotes/CREATE_NOTE_SUCCESS", FAILURE: "rweb/birdwatchNotes/CREATE_NOTE_FAILURE" }),
                P = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_TWEET_NOTES_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_TWEET_NOTES_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_TWEET_NOTES_FAILURE" }),
                B = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_BIRDWATCH_PROFILE_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_BIRDWATCH_PROFILE_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_BIRDWATCH_PROFILE_FAILURE" }),
                ...
                v = Object.freeze({ REQUEST: "rweb/birdwatchNotes/FETCH_NOTE_REQUEST", SUCCESS: "rweb/birdwatchNotes/FETCH_NOTE_SUCCESS", FAILURE: "rweb/birdwatchNotes/FETCH_NOTE_FAILURE" }),
                ...
                k = "rweb/birdwatchNotes/UPDATE_STREAMED_NOTE_TRANSLATION",
                x = "rweb/birdwatchNotes/SAVE_FORM_DRAFT",
                G = "rweb/birdwatchNotes/SAVE_BIRDWATCH_PATH",
                Q = { drafts: {}, notes: {}, noteRequests: {}, tweetNotes: {}, contributor: {}, publicData: {}, matchData: { fetchStatus: c.ZP.LOADING }, sourceLinks: {}, sources: {}, paths: {} };
            i.Z.register({
                [h]: function (e = Q, t) {
                    if (!t) return e;
                    switch (t.type) {
                        ...
                        case P.SUCCESS: {
                            ...
                            if (n) {
                                ...
                                return a?.ownNoteId && (u.ownNoteId = a?.ownNoteId), (u.canUserWriteNotesOnPost = a?.canUserWriteNotesOnPost), t.meta ? { ...e, notes: { ...e.notes, ...s, ...l }, tweetNotes: { ...e.tweetNotes, [o]: u } } : e;
                            }
                        ...
                        case k: {
                            const { note_id: n, translation: o } = t.payload;
                            return { ...e, notes: { ...e.notes, [n]: { ...e.notes[n], streamedNoteTranslation: o } } };
                        }
                        default:
                            return e;
                    }
            ...
            const W = [],
                ...
                K = (e) => e[h].matchData,
                Y = (e, t) => e[h].sourceLinks[t],
                $ = (e, t) => {
                    const n = e[h].tweetNotes[t];
                    return n ? n.canUserWriteNotesOnPost : void 0;
                },
                J = (e, t) => {
                    if (!t) return null;
                    const n = ((e, t) => e[h].tweetNotes[t]?.ownNoteId)(e, t);
                    return n ? q(e, n) : null;
                },
                X = (e) => e[h].publicData,
                ee = (e, t) => {
                    const n = t ? V(e, t) : void 0;
                    if (n) {
                        return n.map((t) => q(e, t)).filter(Boolean);
                    }
                    return W;
                },
                te = (e, t) => {
                    const n = t ? ((e, t) => e[h].tweetNotes[t]?.notMisleadingIds)(e, t) : void 0;
                    if (n) {
                        return n.map((t) => q(e, t)).filter(Boolean);
                    }
                    return W;
                ...
                ie = (e, t) => !!(e[h].contributor[t]?.isTopWriter || e[h].contributor?.isTopWriter),
                le = (e, t) => e[h].contributor[t]?.isTopWriter || !1,
                ce = (e) => {
                    const t = e[h].contributor;
                ...
                me =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchBirdwatchBatSignal, params: e })({ actionTypes: N, context: "FETCH_BIRDWATCH_BAT_SIGNAL", meta: { tweet_id: e } }),
                we =
                    (e) =>
                    (t, n, { api: o }) => {
                        const a = !!V(n(), e),
                            s = be(n(), e) === c.ZP.LOADING;
                        return a || s
                            ? Promise.resolve()
                            : t(
                                  (
                                      (e) =>
                                      (t, n, { api: o }) =>
                                          (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchNotes, params: { tweet_id: e } })({ actionTypes: P, context: "FETCH_TWEET_NOTES", meta: { tweet_id: e } }, (e) => {
                                              if (e) {
                                                  const { entities: t } = e;
                        ...
                        return a || s
                            ...
                            : t(
                                  (
                                      ...
                                      (t, n, { api: o }) =>
                                          e
                                              ? (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchBirdwatchProfile, params: { alias: e } })({ actionTypes: B, context: "FETCH_BIRDWATCH_PROFILE", meta: { alias: e } }, (e) => {
                                                    if (e) {
                                                        const { entities: t } = e;
                                                        return t && [(0, u.dP)(t)];
                                                    }
                ...
                Ce =
                    () =>
                    (e, t, { api: n }) =>
                        !!de(t()) ? Promise.resolve() : e(Oe()),
                Ie =
                    (e) =>
                    (t, n, { api: o }) => {
                        const a = !!q(n(), e),
                            s = pe(n(), e) === c.ZP.LOADING;
                        return a || s
                            ? Promise.resolve()
                            : t(
                                  (
                                      (e) =>
                                      (t, n, { api: o }) =>
                                          (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchOneNote, params: { note_id: e } })({ actionTypes: v, context: "FETCH_NOTE", meta: { note_id: e } })
                                  )(e),
                              );
                    },
                Ae =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchCanTweetBeMediaNote, params: e })({ actionTypes: f, context: "FETCH_CAN_BE_MEDIA_NOTE", meta: { tweetId: e } }),
                Ne =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchNoteTranslation, params: e })({ actionTypes: R, context: "FETCH_NOTE_TRANSLATION", meta: { note_id: e } }),
                De =
                    (e) =>
                    async (t, n, { api: o }) => {
                        const a = { content_type: "COMMUNITY_NOTE", id: e },
                            ...
                            i = (e, n) => {
                                var o;
                                t(((o = { note_id: e, translation: { ...n, result: n.result ? (0, s.Z)((0, d.$)(), n.result) : void 0 } }), { type: k, payload: o }));
                            };
                        i(e, r);
                        const l = new AbortController();
                        try {
                            const t = await o.fetchClient.dispatch("/2/grok/translation.json", { method: "POST", credentials: "include", body: JSON.stringify(a), signal: l.signal }, "https://api.x.com");
                            ...
                            if (!n) throw ((r.state = E.H.ERROR), (r.fetchStatus = c.ZP.FAILED), i(e, r), new Error("Failed to translate because reader is not present."));
                            const s = new TextDecoder();
                            let d = "";
                            const u = async (t) => {
                                const o = t ? _.T9 : _.UG,
                                    { done: a, value: l } = await (0, _.yE)("COMMUNITY_NOTE_TIMEOUT_BETWEEN_CHUNKS", () => n.read(), o, "Timeout between streaming chunks");
                                if (a) {
                            ...
                            (r.state = E.H.ERROR), (r.fetchStatus = c.ZP.FAILED), i(e, r), l.abort();
                        }
                    },
                fe =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).fetchTweetSourceLink, params: e })({ actionTypes: M, context: "FETCH_SOURCE_LINK_TWEET", meta: { tweet_id: e } }),
                Re =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).fetchSignUpEligiblity })({ actionTypes: L, context: "FETCH_SIGNUP_ELIGIBILITY" }),
                Oe =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).fetchAuthenticatedUserProfile, params: {} })({ actionTypes: U, context: "FETCH_AUTHENTICATED_USER_PROFILE" }),
                ge =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).fetchAliasSelfSelectStatus, params: {} })({ actionTypes: Z, context: "FETCH_SHOW_ALIAS_SELECT", meta: {} }),
                Ue =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).fetchAliasSelfSelectOptions, params: {} })({ actionTypes: y, context: "FETCH_ALIAS_SELECT_OPTIONS", meta: {} }),
                Le =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).selectAlias, params: { alias: e } })({ actionTypes: w, context: "SELECT_ALIAS", meta: { alias: e } }),
                Me =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).acknowledgeEarnOut, params: {} })({ actionTypes: H, context: "PROFILE_ACKNOWLEDGE_EARN_OUT", meta: {} }),
                ye = (e) => ({ meta: { note_id: e }, type: p.SUCCESS }),
                Fe =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).deleteBirdwatchBatSignal, params: { tweet_id: e } })({ actionTypes: A, context: "DELETE_BIRDWATCH_BATSIGNAL", meta: { tweet_id: e } }),
                Pe =
                    (e, t, n, o) =>
                    (a, s, { api: d }) =>
                        (0, l._O)(a, { request: d.withEndpoint(r.Z).createNote, params: { tweet_id: e, is_media_note: n, is_helpful_for_all_posts: o, data: t } })({ actionTypes: F, context: "CREATE_NOTE" }),
                Be = (e) => (t) => {
                    t(((e) => ({ type: x, payload: e }))(e));
                },
                Ze = (e) => (t) => {
                ...
                ve =
                    (e, t, n, o, a) =>
                    (s, d, { api: i }) =>
                        (0, l._O)(s, { request: i.withEndpoint(r.Z).createRating, params: { note_id: e, tweet_id: n, data: t, rating_source: o, source_platform: a } })({ actionTypes: S, context: "CREATE_RATING", meta: { note_id: e } }),
                He =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).deleteRating, params: { note_id: e } })({ actionTypes: m, context: "DELETE_RATING", meta: { note_id: e } }),
                ke =
                    (e, t) =>
                    (n, o, { api: a }) =>
                        (0, l._O)(n, { request: a.withEndpoint(r.Z).admitUser, params: { admit_date: e, user_id: t } })({ actionTypes: O, context: "ADMIT_USER", meta: { admit_date: e, user_id: t } }),
                xe =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).removeUser, params: {} })({ actionTypes: g, context: "REMOVE_USER", meta: {} }),
                Ge =
                    (e) =>
                    (t, n, { api: o }) =>
                ...
                Qe =
                    (e, t) =>
                    (n, o, { api: a }) =>
                        (0, l._O)(n, { request: a.withEndpoint(r.Z).createBirdwatchBatSignal, params: { tweet_id: e, source_link: t } })({ actionTypes: I, context: "CREATE_BAT_SIGNAL", meta: { tweet_id: e } }),
                We =
                    (e) =>
                    (t, n, { api: o }) =>
                        (0, l._O)(t, { request: o.withEndpoint(r.Z).editNotificationSettings, params: { settings: e } })({ actionTypes: C, context: "EDIT_NOTIFICATION_SETTINGS", meta: { settings: e } }),
                qe =
                    () =>
                    (e, t, { api: n }) =>
                        (0, l._O)(e, { request: n.withEndpoint(r.Z).fetchPublicData, params: {} })({ actionTypes: D, context: "FETCH_DATA", meta: {} });
        },
        302101: (e, t, n) => {
            n.d(t, { N: () => r });
            var o = n(106067),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Birdwatch-e019dbda.a59062ea.js.map
