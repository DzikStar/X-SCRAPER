    ...
    ["bundle.Birdwatch-e019dbda"],
    {
        ...
        337523: (e, t, o) => {
            ...
            const A = (e, t) => t.module.selectInitialFetchStatus(e),
                ...
                D = (0, I.Z)()
                    .propsFromState(() => ({ initialFetchStatus: A, pageConfiguration: N, selectedTab: f }))
                    ...
                    super(...e),
                        ...
                        (this._render = () => {
                            ...
                            if (r && r.tabs) {
                                ...
                                return n.createElement(n.Fragment, null, n.createElement(S.Z, { alignFirstItem: (0, T.ZP)(), links: l, visibleItemIndex: i }));
                            }
                            return null;
                        });
                }
            ...
            const be = Q.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                ...
                Te = (e) => {
                    const { TabBar: t, backLocation: o, documentTitle: a, entryConfiguration: d, fab: i, getTabLink: c, hasTabNavigation: S, history: m, initialFetchStatus: T, initialPageNamespace: w, logoButton: C, module: I, onBackClick: A, pageConfiguration: N, prerollDisplayLocation: f, renderEmptyState: D, renderUnavailable: R, rightControl: g, selectedTabId: U, sidebarContent: L, timelinePrefix: M, title: y, withAppLinks: F, withBottomLoginSignupBar: P, withDeferredView: B, withOpenGraphMeta: Z, withSearchBox: v, withTweetButton: x } = e,
                        G = (0, r.tj)(),
                        ...
                        te = B ? u.Z : n.Fragment,
                        oe = n.createElement(n.Fragment, null, X, n.createElement(te, null, n.createElement(H, { entryConfiguration: Q, initialModule: I, prerollDisplayLocation: f, renderEmptyState: D, renderUnavailable: R, selectedTabId: U, timelinePrefix: M, title: y, withoutHeadroom: !0 }))),
            ...
            Te.defaultProps = { entryConfiguration: (0, x.G)({}), renderEmptyState: () => n.createElement(a.Z, { header: Se }), sidebarContent: me, withDeferredView: !1, withAppLinks: !1, withOpenGraphMeta: !1 };
            const we = te(Te);
        },
        709070: (e, t, o) => {
            o.d(t, { Z: () => r });
        ...
        979090: (e, t, o) => {
            o.d(t, { $e: () => De, BG: () => ne, Bb: () => Be, Bs: () => re, C7: () => Ne, EW: () => Ae, HO: () => _e, JL: () => le, Jn: () => pe, Kc: () => Ue, Ld: () => Pe, Lt: () => X, Ly: () => Y, OV: () => oe, PL: () => se, Pi: () => me, Qg: () => W, SZ: () => He, V0: () => ye, Wk: () => ee, X3: () => Le, _T: () => Qe, _b: () => ve, aZ: () => Oe, ap: () => ie, cS: () => ae, dw: () => $, eD: () => de, eY: () => we, et: () => V, f3: () => he, f_: () => Me, gH: () => Ee, gP: () => xe, jm: () => j, kT: () => Fe, kX: () => ke, lC: () => Re, lW: () => ce, lw: () => fe, mZ: () => Ge, mv: () => Te, oV: () => We, pN: () => Ie, qm: () => ge, r9: () => q, sz: () => J, tk: () => K, vF: () => Se, w6: () => ue, wK: () => Ze, wd: () => be, ww: () => Ce });
            o(571372), o(136728);
            var n = o(744531),
                a = o(401388),
                r = o(106067),
            ...
            const _ = "birdwatchNotes",
                ...
                T = (0, l.dg)(h, "CREATE_APPEAL"),
                w = (0, l.dg)(h, "EDIT_NOTIFICATION_SETTINGS"),
            ...
            const Q = [],
                ...
                xe =
                    (e) =>
                    (t, o, { api: n }) =>
                        (0, l._O)(t, { request: n.withEndpoint(r.Z).createAppeal, params: { note_id: e } })({ actionTypes: T, context: "CREATE_APPEAL", meta: { note_id: e } }),
                Ge =
                    (e, t) =>
                    (o, n, { api: a }) =>
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Birdwatch-e019dbda.cdc6a9ea.js.map
