    ...
    ["bundle.Birdwatch-e019dbda"],
    {
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getModule = (0, g.Z)((e, t, n, o) => {
                            if (e?.id !== t) {
                                if (e?.urtEndpoint) return (0, U.Z)({ urtUrl: e?.urtEndpoint, timelinePrefix: o });
            ...
            const he = Q.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                ...
                we = (e) => {
                    const { TabBar: t, backLocation: n, documentTitle: a, entryConfiguration: d, fab: i, getTabLink: c, hasTabNavigation: S, history: m, initialFetchStatus: w, initialPageNamespace: T, logoButton: C, module: I, onBackClick: A, pageConfiguration: N, prerollDisplayLocation: f, renderEmptyState: D, renderUnavailable: R, rightControl: g, selectedTabId: L, sidebarContent: U, timelinePrefix: M, title: y, withAppLinks: F, withBottomLoginSignupBar: P, withDeferredView: B, withOpenGraphMeta: Z, withSearchBox: v, withTweetButton: x } = e,
                        ...
                        te = B ? u.Z : o.Fragment,
                        ne = o.createElement(o.Fragment, null, X, o.createElement(te, null, o.createElement(H, { entryConfiguration: Q, initialModule: I, prerollDisplayLocation: f, renderEmptyState: D, renderUnavailable: R, selectedTabId: L, timelinePrefix: M, title: y, withoutHeadroom: !0 }))),
        ...
        979090: (e, t, n) => {
            ...
            const Q = [],
                ...
                se = (e, t) => !!(e[_].contributor[t]?.isTopWriter || e[_].contributor?.isTopWriter),
                de = (e, t) => e[_].contributor[t]?.isTopWriter || !1,
                ie = (e) => {
                    const t = e[_].contributor;
                ...
                Ue = (e) => ({ meta: { note_id: e }, type: h.SUCCESS }),
                Me =
                    (e) =>
                    (t, n, { api: o }) =>
