    ...
    ["bundle.Birdwatch-e019dbda"],
    {
        ...
        337523: (e, t, a) => {
            ...
            class v extends o.Component {
                ...
                render() {
                    ...
                    const E = this._getModule(i, a?.tabs?.initialTabId, t, l),
                        ...
                        h = b ? 1e3 * b : void 0;
                    return o.createElement(_.nO, { namespace: this._getTimelineNamespace() }, o.createElement(F.Z, { entryConfiguration: e, module: E, pollingIntervalMsOverride: h, prerollDisplayLocation: n, refreshControl: r, renderEmptyState: d, renderUnavailable: s, title: c, withoutHeadroom: u }));
                }
            }
            v.contextType = M.rC;
            const H = Z(v);
            ...
            function K(e) {
                ...
                return o.createElement(x.Z, { style: Y.root }, o.createElement(_.nO, { data: i, namespace: l }, o.createElement(W.Z, { displayType: a, facepile: n, onFollowHeaderOffscreen: ({ isOffscreen: e }) => s(!e), topicId: d, topicLandingContext: r, withDivider: !0 })));
            }
            ...
            const he = Q.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                Se = ue(function (e) {
                    const t = e.navBar.topicId ? e.navBar.topicId : "",
                        ...
                        { data: E, namespace: b } = j(t, n),
                        h = (0, l.Z)({}, r, b);
                    return d ? o.createElement(_.nO, { data: E, namespace: h }, o.createElement(o.Fragment, null, i ? o.createElement(re.Z, { canonical: Ee(t), description: d.description, title: d.name, type: "article" }) : null, s ? o.createElement(ne.Z, { deepLink: be(t) }) : null, o.createElement(x.Z, { style: he.rightControl }, o.createElement(x.Z, { style: he.followButtonContainer }, o.createElement(oe.Z, { animateMount: !0, show: a, type: "fade" }, o.createElement(de.ZP, { size: "medium", textMode: se.q.FollowTopic, topic: d }))), u ? o.createElement(ie.ZP, { copyLinkShareLabel: _e, scribeNamespace: h, url: Ee(t) }) : null))) : null;
                }),
                pe = i().e9f1fbcc,
                ...
                we = (e) => {
                    ...
                    return o.createElement(_.nO, { namespace: J }, o.createElement(S.Z, null, o.createElement(b.Z, { TabBar: t, backLocation: a, documentTitle: n, history: m, logoButton: C, onBackClick: I, primaryContent: oe, rightControl: ee || g, secondaryBar: ne, sidebarContent: L, subtitle: j, title: X && W ? y : $, withBottomLoginSignupBar: P, withSearchBox: v, withTweetButton: G })));
                };
        ...
        26232: (e, t, a) => {
            ...
            class p extends o.Component {
                ...
                render() {
                    ...
                    return t ? o.createElement(s.Z, { "aria-label": _, fetchStatus: e, onRequestRetry: this._handleFetch, render: this._render, retryMessage: a, retryable: !0 }) : null;
                }
            }
        ...
        979090: (e, t, a) => {
            a.d(t, { $e: () => Ae, BG: () => ee, Bb: () => Me, Bs: () => ae, EW: () => Te, HO: () => ce, JL: () => de, Jn: () => be, Kc: () => fe, Ld: () => Le, Lt: () => Y, OV: () => X, PL: () => oe, Pi: () => he, Qg: () => x, SZ: () => Pe, V0: () => ge, Wk: () => $, X3: () => Re, _T: () => He, _b: () => Fe, aZ: () => Ne, ap: () => re, cS: () => te, dw: () => j, eD: () => ne, eY: () => pe, et: () => z, f3: () => ue, f_: () => Oe, gH: () => le, gP: () => Ze, jm: () => W, kT: () => Ue, kX: () => Be, lC: () => Ie, lW: () => se, lw: () => Ce, mZ: () => ve, mv: () => Se, oV: () => ke, pN: () => we, qm: () => De, r9: () => Q, sz: () => K, tk: () => V, vF: () => _e, w6: () => ie, wK: () => ye, wd: () => Ee, ww: () => me });
            var o = a(744531),
                n = a(401388),
                r = a(106067),
                d = a(256563),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Birdwatch-e019dbda.7a53e6da.js.map
