        ...
        274407: (e, t, n) => {
            ...
            const x = (e) => {
                    const t = r()(v.Z, e.community),
                        ...
                        a = i.useMemo(() => {
                            if ("User" === t.creator_results.result?.__typename) return i.createElement(I.Z, { isBlueVerified: t.creator_results.result.is_blue_verified || !1, isVerified: t.creator_results.result.legacy?.verified || !1, screenName: t.creator_results.result.legacy?.screen_name || "", withLink: !0 });
                        }, [t]);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Communities-5d92a2cf.5e88df6a.js.map
