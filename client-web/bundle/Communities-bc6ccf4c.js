    ...
    ["bundle.Communities-bc6ccf4c", "icons/IconChevronDown-js", "icons/IconFollowPlus-js", "icons/IconHashStroke-js", "icons/IconSearchMinusStroke-js"],
    {
        738545: (e, t, o) => {
            ...
            const m = r().i2785009,
                ...
                v = (e) => {
                    ...
                    return t ? a.createElement(i.Z, { style: C.labelBar }, a.createElement(d.ZP, { color: "gray700", size: "subtext2", weight: "medium" }, t), o ? a.createElement(u.Z, { label: t, popover: o }) : null) : null;
                },
                _ = (e) => {
                    const { style: t, unit: o } = e;
                    return o ? a.createElement(d.ZP, { color: "gray700", style: [C.unitText, t], weight: "medium" }, o) : null;
                },
                w = (e) => {
                    let t,
                        o,
                        { trendValue: s } = e;
                    return void 0 === s ? null : (Math.abs(s) < 0.1 ? ((s = Math.round(1e3 * s) / 1e3), (t = g(s))) : ((s = Math.round(100 * s) / 100), (t = m(s))), (o = ((e, t) => (e < 0 ? f({ trendValueNegativePercent: t }) : 0 === e ? b : y({ trendValuePositivePercent: t })))(s, t)), s < 0 ? a.createElement(i.Z, { style: C.trendBar, testID: "trendLabel" }, a.createElement(n.default, { "aria-label": o, style: C.trendIconNeg }), a.createElement(d.ZP, { "aria-hidden": !0, color: "red500", size: "body", weight: "medium" }, t)) : 0 === s ? a.createElement(i.Z, { style: C.trendBar, testID: "trendLabel" }, a.createElement(l.default, { "aria-label": o, style: C.trendIconZero }), a.createElement(d.ZP, { "aria-hidden": !0, color: "gray700", size: "body", weight: "medium" }, t)) : a.createElement(i.Z, { style: C.trendBar, testID: "trendLabel" }, a.createElement(c.default, { "aria-label": o, style: C.trendIconPos }), a.createElement(d.ZP, { "aria-hidden": !0, color: "green500", size: "body", weight: "medium" }, t)));
                },
                ...
                x = (e) => {
                    ...
                    return a.createElement(i.Z, { style: C.dataPoint }, a.createElement(v, { label: s, popover: r }), a.createElement(i.Z, { style: C.valueBar }, t ? a.createElement(h.ZP, { count: o, size: n, style: m, weight: "bold" }, u) : a.createElement(d.ZP, { size: n, style: m, weight: "bold" }, u), a.createElement(_, { style: g, unit: p }), a.createElement(w, { trendValue: c })), l);
                };
        },
        635998: (e, t, o) => {
            o.d(t, { Z: () => g });
        ...
        392027: (e, t, o) => {
            ...
            class r extends a.PureComponent {
                render() {
                    ...
                    return a.createElement(i.ZP, { "aria-label": e, backgroundColor: t, color: m, disabled: s, icon: l, link: r, onPress: d, renderMenu: h, size: "xLarge", style: [n.root, !c && n.iconOnly, p], testID: u }, c);
                }
            }
        ...
        420412: (e, t, o) => {
            ...
            function l({ borderColor: e = "borderColor", isSlim: t = !1, label: o }) {
                ...
                return o ? a.createElement(r.Z, { style: !t && c.root, withGutter: !0 }, a.createElement(i.Z, { style: c.gapColumn }, a.createElement(i.Z, { style: [c.gap, d] })), a.createElement(i.Z, { style: c.gapText }, o), a.createElement(i.Z, { style: c.gapColumn }, a.createElement(i.Z, { style: [c.gap, d] }))) : a.createElement(i.Z, { style: [!t && c.root, l() && c.rootRedesign, c.gap, d] });
            }
            ...
            class n extends i.Component {
                render() {
                    const { children: e, style: t, withGutter: o, ...r } = this.props,
                        n = i.Children.map(e, (e) => e && i.cloneElement(e, { style: [e.props.style, l.column, o && l.withGutterColumn] }));
                    return i.createElement(s.Z, (0, a.Z)({ style: [t, l.root, o && l.withGutter] }, r), n);
                }
            }
        ...
        548485: (e, t, o) => {
            ...
            const _ = y.default.create((e) => ({ mask: { backgroundColor: "transparent", borderWidth: e.spaces.space4, borderColor: e.colors.primary, boxShadow: `0 0 0 9999px ${e.colors.activeFaintGray}` }, circle: { borderRadius: e.borderRadii.infinite } })),
                w = ({ circle: e, height: t, width: o }) => a.createElement(s.Z, { pointerEvents: "none", style: [_.mask, { width: o, height: t }, e && _.circle] });
            var C = o(807896),
                x = o(151624),
                E = o(933895);
            class S extends a.Component {
                constructor(e) {
                    super(e),
                        ...
                        (this._panResponder = {}),
                        (this._setRef = (e) => {
                            const { onPanEnd: t, onPanMove: o, onPinchMove: a, onWheel: i } = this.props;
                            if (e) {
                                (o || t || a) && (this._removeTouchMoveToScrollListener = (0, E.O)(e, this._preventDefaultEvent, !1)), i && (this._removeScrollToScaleListener = (0, E.Y)(e, this._preventDefaultEvent, !1));
                        ...
                        (this._handlePanResponderMove = (e, t) => {
                            ...
                            if (2 === t.numberActiveTouches) {
                                if (a) {
                                    const e = ((s = i[0]), (r = i[1]), Math.sqrt(Math.pow(s.pageY - r.pageY, 2) + Math.pow(s.pageX - r.pageX, 2))),
                        ...
                        (this._handleWheel = (e) => {
                            const { clientX: t, clientY: o, deltaX: a, deltaY: i } = e,
                                { x: s, y: r } = this._centerPosition,
                                n = s - t,
                                l = r - o;
                            this.props.onWheel && this.props.onWheel(a, i, n, l);
                        }),
                ...
                render() {
                    const { children: e, onPanEnd: t, onPanMove: o, onPinchMove: i, onWheel: r, ...n } = this.props;
                    return a.createElement(s.Z, (0, C.Z)({}, n, { onWheel: this._handleWheel, ref: this._setRef }, this._panResponder.panHandlers), this.props.children);
                }
                    ...
                    super(e),
                        ...
                        (this._getImageDimensions = () => {
                            const { imageScale: e } = this.state,
                                ...
                                { height: i, width: s } = f.Z.getCoverDimensions({ width: a, height: o }, t);
                            return { width: s * Math.pow(2, e), height: i * Math.pow(2, e) };
                        }),
                        (this._getMaskDimensions = () => {
                            const { aspectRatio: e, containerHeight: t, containerWidth: o } = this.state,
                                { height: a, width: i } = f.Z.getContainDimensions({ width: o - 50, height: t - 50 }, e);
                        ...
                        (this._setDefaultCropData = () => {
                            ...
                            (this._panStyles.top = n - e.top * i * Math.pow(2, s)), (this._previousTop = this._panStyles.top), (this._panStyles.left = r - e.left * i * Math.pow(2, s)), (this._previousLeft = this._panStyles.left), this._updateStyles();
                        }),
                        ...
                        (this._handlePinchMove = (e, t, o, a, i) => {
                            const s = e / 200;
                            this.setState(({ imageScale: e }) => {
                                const r = Math.min(this._maxScale, Math.max(e + s, 0));
                                return (this._panStyles.left += t * (r - e) + a), (this._panStyles.top += o * (r - e) + i), (this._previousLeft = this._panStyles.left), (this._previousTop = this._panStyles.top), { imageScale: r };
                            });
                        }),
                        (this._adjustToInBounds = () => {
                            ...
                            let r = !1;
                            o < 0 && ((r = !0), (this._panStyles.left += o), (this._previousLeft += o)), a < 0 && ((r = !0), (this._panStyles.top += a), (this._previousTop += a)), i > 0 && ((r = !0), (this._panStyles.left += i), (this._previousLeft += i)), s > 0 && ((r = !0), (this._panStyles.top += s), (this._previousTop += s)), r && this._updateStyles();
                        }),
                        (this._updateStyles = () => {
                        ...
                        (this._getUnscaledCropData = () => {
                            const { height: e, width: t } = this._getImageDimensions(),
                                { height: o, width: a } = this._getMaskDimensions(),
                                { left: i, top: s } = this._panStyles;
                            return { top: (e - o) / 2 - s, left: (t - a) / 2 - i, width: a, height: o };
                        }),
        ...
        30183: (e, t, o) => {
            ...
            const r = o(392237).default.create((e) => ({ root: { paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space16 }, withBottomRadius: { borderBottomStartRadius: e.borderRadii.xLarge, borderBottomEndRadius: e.borderRadii.xLarge } })),
                n = function ({ align: e, link: t, onPress: o, text: n, weight: l, withBottomRadius: c, withDarkerInteractiveBackground: d }) {
                    return a.createElement(s.Z, { link: t, onPress: o, style: [r.root, c && r.withBottomRadius], withDarkerInteractiveBackground: d }, a.createElement(i.ZP, { align: e, color: "primary", weight: l }, n));
                };
        },
        449479: (e, t, o) => {
            o.d(t, { Z: () => y });
            ...
            class y extends a.Component {
                ...
                render() {
                    ...
                    return a.createElement(
                        ...
                        s ? a.createElement(i.Z, { id: this._labelId, role: "label", style: v.header }, a.createElement(r.ZP, { style: v.label, weight: "bold" }, s), t ? a.createElement(r.ZP, { color: "gray700", size: "subtext2" }, t) : null) : null,
        ...
        101890: (e, t, o) => {
            ...
            var a = o(202784),
                ...
                s = o(449479),
                r = o(392237);
            const n = (e) => a.createElement(i.Z, { style: l.root }, a.createElement(s.Z, e)),
        ...
        403556: (e, t, o) => {
            ...
            class w extends i.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: o, badgePip: a, children: s, color: r, isActive: c, isCompact: d, isPillLink: h, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: w, style: x, to: E } = this.props,
                        { location: S } = this.state,
                        Z = E ? this._getMemoizedLink(E, w) : void 0,
                        P = c ? c(E) : S?.pathname === Z?.pathname,
                        k = f.Z.generate({ backgroundColor: "transparent", color: n.default.theme.colors.text, insetFocusRing: !0 }),
                        R = g ? "medium" : P ? "bold" : "medium";
                    return i.createElement(b.Z, { "aria-label": t, "aria-selected": P, focusable: !!P, interactiveStyles: k, link: Z, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [h ? C.pill : C.link, h && P ? C.active : null, d ? (h ? C.compactPill : C.compactLink) : null, p ? C.roundedRect : null, x], withoutInteractiveStyles: g || h }, ({ isFocused: t, isHovered: c }) => i.createElement(l.Z, { style: h && C.flexGrow }, i.createElement(u.ZP, { size: g ? "headline2" : void 0, style: [C.text, { color: this._getTextColor(P, c, g, h) }, d && C.compactText, g && t && C.focusedText], weight: R }, e && i.createElement(e, { style: C.icon }), s, g || h ? null : i.createElement(l.Z, { style: P && [C.border, { backgroundColor: n.default.theme.colors[r] }] })), o ? i.createElement(m.Z, { count: o, standalone: !0, style: [C.badge, o >= 10 && C.multiDigitBadge, o >= 20 && C.truncatedCountBadge], truncatedCountFormatter: _, unreadCountLabel: y, withBorder: !1 }) : a ? i.createElement(m.Z, { pip: !0, standalone: !0, style: C.badgePip, textColor: "red500", unreadCountLabel: v, withBorder: !1 }) : null));
                }
            }
            ...
            const C = n.default.create((e) => ({
                ...
                S = ({ alignFirstItem: e, "aria-label": t, isCompact: o, isPillLink: n, isRoundedRect: l, links: c, style: d, visibleItemIndex: h }) => {
                    const p = c
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        g = i.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: s, ...r }, c) => {
                                    ...
                                    return i.createElement(x, (0, a.Z)({ viewType: s }, r, { isCompact: o, isPillLink: n, isRoundedRect: l, isWebRedesign: m, style: d }), t);
                                }),
                            [e, o, n, l, m, c],
                        );
                    return i.createElement(s.Z, { "aria-label": t, buttonsContainerStyle: n && E.gap, childrenStyle: !m && E.flexGrow, key: p, style: [n ? null : E.segmentedControl, m && E.leftAligned, d], visibleItemIndex: h }, g);
                };
        },
        123588: (e, t, o) => {
            ...
            const n = (e = {}) => {
                ...
                return (0, i.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [r.Z.root, e.style], viewBox: "0 0 24 24", children: a.createElement("g", null, a.createElement("path", { d: "M12 3.59l7.457 7.45-1.414 1.42L13 7.41V21h-2V7.41l-5.043 5.05-1.414-1.42L12 3.59z" })) }, { writingDirection: t });
            };
        ...
        487552: (e, t, o) => {
            ...
            const n = (e = {}) => {
                const { direction: t } = (0, s.Z)();
                return (0, i.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [r.Z.root, e.style], viewBox: "0 0 24 24", children: a.createElement("g", null, a.createElement("path", { d: "M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z" })) }, { writingDirection: t });
            };
            n.metadata = { width: 24, height: 24 };
            const l = n;
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Communities-bc6ccf4c.df45729a.js.map
