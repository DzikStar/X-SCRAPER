    ...
    ["bundle.Compose-6107ac1a", "loader.AudioContextVoiceMedia", "icons/IconFoursquareNoMargin-js"],
    {
        625661: (e, t, r) => {
            ...
            class h extends o.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: r, fixed: a, hideBackButton: n, isFullWidth: l, isLarge: d, leftControl: c, middleControl: h, position: p, rightControl: m, secondaryBar: b, style: g, subtitle: f, title: C, titleDomId: y, titleIconCell: v, titleIconCellSize: Z, withBackground: w, withWideContainer: B } = this.props,
                        { isModal: k } = this.context,
                        E = n ? c : o.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        M = (function (e, t, r) {
                            return e && !(t && r);
                        })(!!w, k, !!b);
                    return o.createElement(o.Fragment, null, o.createElement(i.Z, { centerTitle: t, centeredLogo: r, isFullWidth: l, isLarge: d, leftControl: E, middleControl: h, position: u(p, k, a), rightControl: m, style: g, subtitle: f, title: C, titleDomId: y, titleIconCell: v, titleIconCellSize: Z, withBackground: M, withWideContainer: B }), b || null);
                }
                render() {
            ...
            const p = r.p + "MarchMadnessBannerDark.42aa2dea.png",
                ...
                f = ({ buttonOnSameLine: e, link: t, occasion: r, styleOverrides: u, withBackgroundImage: h }) => {
                    ...
                    const y = () => {
                        ...
                        { backgroundcolor: v, buttonSize: Z, cardWidth: w, marginbottom: B, textcolor: k } = u ?? {},
                        E = v ? n.default.theme.colors[v] : n.default.theme.colors.gray0,
                    ...
                    return h ? o.createElement(l.Z, { interactiveStyles: null, link: t, onPress: y, style: C.bannerContainer }, o.createElement(s.Z, { resizeMode: "contain", source: { uri: "light" === n.default.theme.paletteName ? S.image.lightMode : S.image.darkMode }, style: { height: 85 } })) : o.createElement(a.Z, { style: [C.card, { backgroundColor: E }, { maxWidth: w }, { marginBottom: x }], testID: "popupCard" }, o.createElement(a.Z, { style: e ? C.horizontalContent : C.verticalContent }, o.createElement(a.Z, { style: e ? C.textContainer : null }, o.createElement(i.ZP, { size: "headline2", style: [C.popupTitle, { alignSelf: "flex-start" }], weight: "bold" }, S.header), o.createElement(i.ZP, { size: "subtext1", style: [C.popupDescription, { color: M }] }, S.description, " ", e ? null : S.legalDisclaimer)), o.createElement(a.Z, { style: C.buttonContainer }, o.createElement(d.ZP, { backgroundColor: "light" === n.default.theme.paletteName ? "orange300" : "orange600", borderColor: "transparent", link: t, onClick: y, size: "medium", style: [C.popupButton, { width: Z }] }, S.buttonText), e && o.createElement(i.ZP, { size: "subtext3", style: [C.legalDisclaimer, { color: M }] }, S.legalDisclaimer))));
                },
                C = n.default.create((e) => ({ card: { backgroundColor: e.colors.gray0, borderRadius: e.spaces.space16, padding: e.spaces.space16, alignItems: "center", maxWidth: 350, width: "100%" }, transparent: { backgroundColor: "transparent" }, popupTitle: { marginBottom: e.spaces.space8, textAlign: "start" }, popupDescription: { textAlign: "start", marginEnd: e.spaces.space12 }, legalDisclaimer: { position: "absolute", top: "60px", end: "50%", transform: "translateX(50%)", textAlign: "center", minWidth: 100, opacity: 0.7 }, popupButton: { width: "100%", borderRadius: e.spaces.space24, marginTop: e.spaces.space12, height: e.spaces.space40 }, buttonContainer: { position: "relative" }, horizontalContent: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "100%", paddingBottom: e.spaces.space8 }, verticalContent: { width: "100%" }, textContainer: { flex: 1 }, bannerContainer: { marginBottom: e.spaces.space16 } }));
        },
        941399: (e, t, r) => {
            r.d(t, { F: () => i });
            var o = r(202784),
        ...
        980407: (e, t, r) => {
            ...
            class p extends o.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: r, backLocation: n, centerTitle: l, hideBackButton: s, history: i, isFullWidth: u, isLarge: h, middleControl: p, onBackClick: b, rightControl: g, secondaryBar: f, subtitle: C, title: y } = this.props,
                                { isModal: v } = this.context;
                            return o.createElement(a.Z, { style: v ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, o.createElement(c.ZP, { backButtonType: r || (v ? "close" : "back"), backLocation: n, centerTitle: l, fixed: !v, hideBackButton: s, history: i, isFullWidth: u, isLarge: h, middleControl: p, onBackClick: b, ref: e, rightControl: g, secondaryBar: f, style: [v && m.appBarModal, t], subtitle: C, title: y, titleDomId: d.Q_ }));
                        }),
                ...
                render() {
                    ...
                    return o.createElement(i.Z, null, o.createElement(u.Z.Configure, { documentTitle: s, headerless: !0, title: b }), o.createElement(a.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [m.root, f && m.rootModal] }, !f && C, o.createElement(n.Z, { isFullWidth: d, isLarge: c, style: [m.container, f && m.containerModal, l] }, f ? o.createElement(h.Z, { style: m.viewport }, C, r) : r), t ? o.createElement(a.Z, { style: [m.bottomBarModal, !f && !g && m.bottomBarMobile] }, o.createElement(n.Z, { isFullWidth: d, isLarge: c }, t)) : null));
                }
            }
        ...
        62857: (e, t, r) => {
            ...
            const Z = (e, t) => t.userIds,
                ...
                B = (e, t) => {
                    const { userIds: r } = t;
                    return r.reduce((t, r) => {
                        const o = v.ZP.selectFetchStatus(e, r);
                        return o && (t[r] = o === g.ZP.NONE ? g.ZP.LOADING : o), t;
                    }, {});
                },
                k = (0, y.Z)()
                    .propsFromState(() => ({
                        availableUserIds: (0, C.Z)(w, (e) => e),
                        fetchStatus: (0, C.Z)(w, B, Z, (e, t, r) => {
                            let o = g.ZP.LOADED;
            ...
            class M extends a.Component {
                ...
                render() {
                    return a.createElement(c.Z, { "aria-label": E, fetchStatus: this.state.allUsersUnavailable ? g.ZP.LOADED : this.props.fetchStatus, onRequestRetry: this._handleFetch, render: this._renderContent, retryable: !1 });
                }
                _fetchUsersIfNeeded() {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Compose-6107ac1a.9976654a.js.map
