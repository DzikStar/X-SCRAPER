    ...
    ["bundle.Compose-e019dbda"],
    {
        625661: (e, t, i) => {
            ...
            class h extends a.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: i, fixed: n, hideBackButton: o, isFullWidth: s, isLarge: l, leftControl: c, middleControl: h, position: p, rightControl: b, secondaryBar: m, style: S, subtitle: f, title: y, titleDomId: g, titleIconCell: _, titleIconCellSize: w, withBackground: C, withWideContainer: E } = this.props,
                        { isModal: T } = this.context,
                        A = o ? c : a.createElement(r.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        B = (function (e, t, i) {
                            return e && !(t && i);
                        })(!!C, T, !!m);
                    return a.createElement(a.Fragment, null, a.createElement(d.Z, { centerTitle: t, centeredLogo: i, isFullWidth: s, isLarge: l, leftControl: A, middleControl: h, position: u(p, T, n), rightControl: b, style: S, subtitle: f, title: y, titleDomId: g, titleIconCell: _, titleIconCellSize: w, withBackground: B, withWideContainer: E }), m || null);
                }
                render() {
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: i, backLocation: o, centerTitle: s, hideBackButton: r, history: d, isFullWidth: u, isLarge: h, middleControl: p, onBackClick: m, rightControl: S, secondaryBar: f, subtitle: y, title: g } = this.props,
                                { isModal: _ } = this.context;
                            return a.createElement(n.Z, { style: _ ? [b.childViewAppBarRoot, b.appBarZindex] : b.appBarZindex }, a.createElement(c.ZP, { backButtonType: i || (_ ? "close" : "back"), backLocation: o, centerTitle: s, fixed: !_, hideBackButton: r, history: d, isFullWidth: u, isLarge: h, middleControl: p, onBackClick: m, ref: e, rightControl: S, secondaryBar: f, style: [_ && b.appBarModal, t], subtitle: y, title: g, titleDomId: l.Q_ }));
                        }),
        ...
        373554: (e, t, i) => {
            ...
            const S = s.default.create((e) => ({ root: { margin: `-${e.spaces.space12}` } })),
                f = function ({ "aria-label": e = p, acceptGifs: t = !0, acceptImages: i = !0, acceptVideo: s = !0, customMimeTypes: r = [], icon: d = b, size: l = "medium", style: c, withIcon: u = !0, ...f }) {
                    const y = m({ acceptGifs: t, acceptImages: i, acceptVideo: s }).concat(r).join(",");
                    return n.createElement(o.Z, (0, a.Z)({}, f, { accept: y, "aria-label": e, icon: u ? d : void 0, size: l, style: [S.root, c], testID: h }));
                };
        },
        751170: (e, t, i) => {
            i.d(t, { A: () => b, Z: () => y });
            ...
            class m extends a.Component {
                ...
                render() {
                    const { borderRadius: e, enableGif: t, mediaItem: i, onClick: r, resizeMode: d } = this.props,
                        ...
                        b = this._getImageSrc();
                    return a.createElement(n.Z, { onClick: r, style: h }, u || !b ? a.createElement(o.Z, { "aria-label": p, style: f.activityIndicator }) : a.createElement(s.Z, { resizeMode: d, source: b, style: f.image }));
                }
            }
            ...
            class B extends a.Component {
                ...
                render() {
                    const { children: e, dataSaverMode: t, getVideoRef: i, style: n, variants: o, ...s } = this.props,
                        r = (0, T.IM)((0, A.rD)(o), t);
                    return (0, E.Z)("video", { ...s, children: [r.map((e) => a.createElement("source", { key: e.src, src: e.src, type: e.type })), e], ref: this._setVideoRef, style: n });
                }
            }
            ...
            class N extends a.Component {
                    ...
                    super(...e),
                        ...
                        (this._handleMediaPreviewLayout = (e) => {
                            ...
                            const {
                                ...
                                { height: s, width: r } = a,
                                d = r / s;
                            Math.abs(d - o / n) > 0.05 && ("width" === i ? this.setState({ mediaContainerSizeStyle: { width: n * d } }) : "height" === i && this.setState({ mediaContainerSizeStyle: { height: o / d } }));
                        }),
                ...
                _renderGifPreview(e, t) {
                    const { playGif: i } = this.state,
                        o = { uri: i ? e : t };
                    return a.createElement(n.Z, { onClick: this._handleGifClick, style: l.default.absoluteFill }, a.createElement(c.Z, { resizeMode: "cover", source: o, style: O.video }));
                }
                _renderImagePreview() {
                    const { borderRadius: e, enableGif: t, imageResizeMode: i, mediaItem: n, onClick: o } = this.props;
                    return a.createElement(D.Z, { borderRadius: e, enableGif: t, mediaItem: n, onClick: o, resizeMode: i });
                }
                _renderVideoPreview(e, t, i, n) {
                    ...
                    if (this.context.featureSwitches.isTrue("responsive_web_composer_configurable_video_player_enabled") && n instanceof C.ZP) {
                        let s = [];
                        (0, _.TO)(n.fileHandle) && (s = [{ src: t, type: e }]);
                        const r = o.mediaMetadata?.subtitles,
                            d = o?.trimData;
                        return a.createElement(P, { mediaFile: n, mediaId: String(i), mediaItem: o, subtitles: r, trimData: d, variants: s });
                    }
                    {
        ...
        536790: (e, t, i) => {
            ...
            class c extends a.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this.render = () => {
                            ...
                            return a.createElement(o.H1, { composeCommunityId: t, contextText: i, isInline: n, isInlineReply: r, isRichText: !0, onDismiss: this._handleDismiss, onSelectItem: this._handleSelectItem, onTypeaheadStateChange: d, query: h, ref: this._genericWrapperRef, source: l || s._4.Compose }, e(this._handleInputChange));
                        }),
                        ...
                        (this._handleInputChange = (e) => {
                            if (!(0, d.T)(e)) throw new Error("RichTextTypeaheadComposeWrapper cannot handle plain text input changes");
                            {
                                const { queryContext: t } = this.state,
                                    ...
                                    { end: n, start: o, word: s } = r.si(this._getCaret(e), a),
                                    d = r.bR(s || "", "compose");
                                if (d?.q === i) return;
                                if ((this._genericWrapperRef.current && this._genericWrapperRef.current.resetSelectedItem(), -1 === o)) this._setQueryContext(void 0);
                                    ...
                                    this._setQueryContext({ word: t, resultType: i, editorState: e, startIndex: o, endIndex: n });
                ...
                _replaceToken(e, t) {
                    const { editorState: i, endIndex: a, startIndex: o } = t,
                        s = i.getSelection().merge({ anchorKey: i.getSelection().getFocusKey(), anchorOffset: o, focusOffset: a }),
                        r = n.Modifier.replaceText(i.getCurrentContent(), s, e),
        ...
        959587: (e, t, i) => {
            ...
            const d = "animated_gif",
                ...
                c = (e) => {
                    ...
                    let s;
                    if (i === d) s = a.createElement(n.ZP, { weight: "bold" }, "GIF");
                    else if ("vine" === i) s = a.createElement(r.default, { "aria-label": "Vine", style: u.icon });
                    else if (i === l && t) {
        ...
        652904: (e, t, i) => {
            ...
            class l extends a.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const l = n || r;
                    ((l && n !== r) || (!l && i !== o) || a !== s || d) && this._performPageUpdates(this.props);
                }
                render() {
            ...
            class B extends n.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderContent = () => {
                            const { availableUserIds: e, createLocalApiErrorHandler: t, fetchStatus: i, fetchUsersIfNeeded: o, filterPredicate: s, userIds: r, ...d } = this.props;
        ...
        964917: (e, t, i) => {
            ...
            const r = "scheduledTweets",
                d = { fetchStatus: s.ZP.NONE, scheduledTweets: [] },
            ...
            function p(e = d, t) {
                ...
                switch (t.type) {
                    case c.SUCCESS:
                        if (t.payload) return { ...e, fetchStatus: s.ZP.LOADED, scheduledTweets: t.payload };
                        break;
                    case c.FAILURE:
            ...
            const b = (e) => e[r].scheduledTweets,
                ...
                f =
                    (e) =>
                    (t, i, { api: n }) =>
                        (0, o._O)(t, { request: n.withEndpoint(a.Z).deleteScheduledTweet, params: { scheduled_tweet_id: e } })({ actionTypes: h, context: u, meta: { deleteScheduledTweetId: e } });
        },
        108304: (e, t, i) => {
            ...
            var a = i(202784),
                ...
                D = i(632960);
            const R = (0, E.Z)()
                .propsFromState(() => ({ autotaggedLocation: A.Xm, initialResults: A.jK, initialFetchStatus: A.ke, lastSearchResults: A.uD, lastSearchFetchStatus: A.tn, position: T.Bz, taggedLocation: D._d, userCountry: B.GG }))
                .propsFromActions(() => ({ createLocalApiErrorHandler: (0, C.zr)("PLACE_PICKER"), loadGeoLocation: T.iG, fetchInitialPlacesIfNeeded: A.BJ, searchPlaces: A.k6, updateLastSelectedPlace: A.T5, updateSettings: v.VP, updateSingleComposer: D.zi }))
            ...
            class q extends a.Component {
                constructor(e) {
                    super(e),
                        ...
                        (this._renderPlaceSubtext = (e) => {
                            ...
                            if (n && r && 2 === r.length && t) {
                                const e = ((e, t) => {
                                    ...
                                    return 7917.6 * Math.asin(Math.sqrt(Math.sin(n / 2) * Math.sin(n / 2) + Math.cos(i) * Math.cos(a) * Math.sin(o / 2) * Math.sin(o / 2)));
                                })({ lat: t.coords.latitude, long: t.coords.longitude }, { lat: r[1], long: r[0] });
                                return a.createElement(
                                    o.Z,
                                    null,
                                    a.createElement(s.ZP, null, n),
                                    a.createElement(
                                        s.ZP,
                                        null,
                                        ((e, t = "us") => {
                        ...
                        (this._renderPlaces = (e) => (e.length ? e.map((e) => this._renderPlace(e)) : a.createElement(s.ZP, { align: "center", style: Q.noPlacesText }, V))),
                    ...
                    const { user: w } = t.retweeted_status || t,
                        ...
                        v = (e) => {
                            ...
                            const { user: i } = t.retweeted_status || t,
                                n = -1 !== g.indexOf(e),
                                o = e === i.id_str,
                                s = a.createElement(r.Z, { checked: !n, disabled: o, onChange: E(e) });
                            return a.createElement(b.ZP, { bottomControl: B, cellClickable: !o, decoration: s, isFakeButtonRoleWithListItem: !o, key: e, onClick: E(e), promotedItemType: "users", userId: e, withLink: !1 });
                        };
                    return a.createElement(f.nO, { namespace: Z }, a.createElement(p.Z, { backLocation: "/compose/post", history: e, onBackClick: T, rightControl: a.createElement(l.ZP, { onPress: T, size: "xSmall", type: "brandFilled" }, R), title: D }, v(w.id_str), c.length ? a.createElement(n.Z, null, a.createElement(o.Z, null), a.createElement(s.Z, { rightControl: A(), text: I }), a.createElement(m.Z, { renderUserCell: v, userIds: c })) : null));
                },
                k = v(x);
        },
        379069: (e, t, i) => {
            ...
            const _ = ({ "aria-label": e, expiration: t, getAccessibilityLiveLabel: i, onTimeElapsed: n }) => {
                    ...
                    a.useEffect(() => {
                        const e = setInterval(() => {
                            const i = g(+t),
                                a = o.current?.(i);
                            u(a), l(i), "00:00" === i.formatted && (clearInterval(e), s.current?.());
                        }, 500);
            ...
            const j = (e) => z.tS(e, ""),
                ...
                se = J((e) => e.quotedStatus),
                re = (e, t) => (t.quotedStatus ? t.quotedStatus : se(e, t)),
            ...
            function me(e, t) {
                ...
                let n;
                const o = (0, O.br)(e);
                if ((a ? (n = a) : i && i.includes("/home") && o.type === W.FO.COMMUNITY && (n = o.id), n)) {
            ...
            function Se(e, t) {
                const { previousPath: i, selectedCommunityId: a } = t.location.state || {},
                    n = (0, O.br)(e);
                let o;
                if ((a ? (o = a) : i && i.includes("/home") && n.type === W.FO.COMMUNITY && (o = n.id), o)) {
            ...
            const fe = J((e) => e.trustedFriendsValue),
                ...
                we = (0, M.Z)()
                    .propsFromState(() => ({
                        ...
                        composerData: (0, Z.P1)(j, oe, re, N.gz, ae, (e, t, i, a, n) =>
                            e.map((e, o) => {
                                const s = (0, x.Z)(e.mediaIds || []),
                                    r = a.filter((e) => s.has(e.id));
                                return { ...de(e), media: r, quotedStatus: 0 === o ? i : void 0, text: 0 === o && t && !n ? t : e.text };
                            }),
                        ),
            ...
            function De({ minutes: e, seconds: t }) {
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._handleAppBarHeight = (0, S.Z)(() => {
                            const e = s.findDOMNode(this._appBarRef);
                        ...
                        (this._renderAppBarRightControl = () => {
                            const { isValid: e } = this.state,
                                { isModal: t } = this.context,
                                { activeUser: i, audienceControlsValue: n, composerData: o, inReplyToStatus: s, isEdit: l, isSelfThreadReply: c, isSending: u } = this.props,
                                h = "all" === n.conversationControlsValue,
                                p = !e || u || !i || this.is_uploading;
                            return a.createElement(r.Z, { style: Oe.rightControlContainer }, l ? this._renderCountdownTimer() : a.createElement(P.Z, { disabled: p, isAudienceAll: h, isComposerValid: e, isEdit: !!l, isModal: t, isQuote: this.isQuoteTweet, isReply: !!s, isRetweet: !!this.isRetweet, isScheduled: this.isScheduled, isSelfThreadReply: !!c, isThread: this.isThread, onTweetWithBoostPress: this._handleSendTweetWithBoost, renderFallback: this._renderDraftsHeading, shouldShow: !t, tweetText: o[0].text, viewer: i }), t ? null : a.createElement(d.ZP, { disabled: p, onPress: this._handleSendTweet, size: "small", testID: Re, type: "brandFilled" }, (0, A.of)({ inReplyToStatus: !!s, isSelfThreadReply: !!c, isQuoteTweet: !!this.isQuoteTweet, isRetweet: !!this.isRetweet, isScheduled: !!this.isScheduled, isThread: this.isThread, isEdit: !!l })));
                        }),
                        (this._renderHeaderWithProgressBar = (e) => {
                            const { isModal: t } = this.context,
                                { isAutoSaving: i, isSending: n, sendingProgress: o } = this.props;
                            return a.createElement(a.Fragment, null, a.createElement(l.Z, { progress: n && !i ? Math.max(o, 0.02) : 0, style: [Oe.progressBar, t && Oe.progressBarModal] }), e);
                        }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Compose-e019dbda.ae205caa.js.map
