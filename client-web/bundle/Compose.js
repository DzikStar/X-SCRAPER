    ...
    ["bundle.Compose", "loader.AudioContextVoiceMedia"],
    {
        ...
        376293: (e, t, s) => {
            ...
            const u = a().cfd2f35e,
                ...
                k = ({ blockAction: e, blockSubtext: t, isSoftBlockEnabled: s, source: o, testID: n, unblockAction: r, unblockSubtext: a, user: i }) => {
                    let l,
                        u = c.Z;
                    const h = v(i, s);
                    switch (o) {
                    ...
                    return { confirmation: h, onClick: u, testID: n, shortcutKey: l, Icon: Z(i.blocking), text: B(i), subText: R({ user: i, blockSubtext: t, unblockSubtext: a }) };
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Compose.a72d357a.js.map
