    ...
    ["bundle.Conversation-0d835cf1"],
    {
        364753: (e, t, n) => {
            ...
            const u = ({ analytics: e, cancelButtonLabel: t, confirmButtonLabel: n, headline: a, onCancel: r, onConfirm: i, subtext: u }) => ((0, s.d)("drop_off_screen"), o.createElement(c.Z, { cancelButtonLabel: t, confirmButtonLabel: n, confirmButtonType: "primary", headline: a, onCancel: r, onConfirm: i, testID: l.Z.dropoffScreen, text: u })),
                ...
                m = r().cfd2f35e,
                g = r().g8844150,
                h = ({ analytics: e, children: t, history: n, qpRouteParams: a, screensAllowedToNavigate: r }) => {
                    const [c, s] = o.useState(null),
                        ...
                        h = o.useMemo(() => {
                            const { quickPromotePlatform: e, screenName: t, statusId: n } = a;
                            return r ? r.map((o) => (0, i.WS)(t, n, e, o)) : [];
                        }, [a, r]),
                        y = o.useCallback(
                            (e, t) => {
                                const o = n.location,
                                    a = l.some((t) => e.pathname.includes(t)),
                                    r = h.some((e) => o.pathname.includes(e));
                                return !!(c || a || r) || (s({ nextLocation: e, action: t, currentLocation: o }), !1);
                            },
                            [n.location, l, h, c],
                        );
                    o.useEffect(() => n.block(y), [y, n]);
                    const b = o.useCallback(() => {
                            (0, i.hq)(e)(i.Ur.dropOffScreenCancel()), s(null);
                        }, [s, e]),
                        C = o.useCallback(() => {
                            if (((0, i.hq)(e)(i.Ur.dropOffScreenConfirm()), null == c)) return;
                            const { action: t, nextLocation: o } = c;
                            switch (t) {
                                case "PUSH":
                                    n.push(o);
                                    break;
                    ...
                    return c ? o.createElement(u, { analytics: e, cancelButtonLabel: m, confirmButtonLabel: g, headline: d, onCancel: b, onConfirm: C, subtext: p }) : t;
                };
        },
        649038: (e, t, n) => {
            n.d(t, { ZP: () => he });
                ...
                H =
                    ...
                    (n) => {
                        const { quickPromotePlatform: o, screenName: a, statusId: r } = t.params,
                            i = (0, I.WS)(a, r, o, I.MN.Done);
                        return (0, S.kb)({ history: e, statusId: r, nextPath: i, analytics: n });
                    },
                j = (0, v.Z)()
                    .propsFromState(() => ({ dailyBudget: L, durationDays: q, availableBudgets: N, lang: M.VT, country: S.QE, currency: F, audience: z, errorMessage: A, coupons: U, enrollCouponErrorCode: V, fundingInstrument: R, adsAccount: O, promoteStatus: W, selectedPaymentMethod: S.DY, targetedLocations: $ }))
                    .propsFromActions((e) => ({ createLocalApiErrorHandler: (0, B.zr)("QUICK_PROMOTE_BUDGET_SELECT_SCREEN"), createPromotion: H(e), setDailyBudget: S.p_, setBudgetDuration: S.g_, fetchForecastedAudienceIfNeeded: S.qL, setBudgetErrorMessage: S.rS }))
                    .withAnalytics(I.EP),
                G = b().i982d424,
                Y = b().e7eb3684,
                K = b().d9f6e3ce,
            ...
            class me extends a.PureComponent {
                    ...
                    super(...e),
                        ...
                        (this._handleDurationSlider = (e) => {
                            const { analytics: t, durationDays: n, setBudgetDuration: o } = this.props,
                                a = pe[e];
                            n !== a && ((0, I.hq)(t)(I.Ur.setBudgetDuration(`${a}`)), o(a), this._fetchForecastedAudienceIfNeeded());
                        }),
                        (this._handleBudgetSlider = (e) => {
                            const { analytics: t, availableBudgets: n, dailyBudget: o, setDailyBudget: a } = this.props,
                                r = n[e];
                            o !== r && ((0, I.hq)(t)(I.Ur.setDailyBudget(`${r}`)), a(r), this._fetchForecastedAudienceIfNeeded());
                        }),
                ...
                componentDidMount() {
                    ...
                    (0, I.hq)(e)(I.Ur.budgetSelectPageLoad()), this._fetchForecastedAudienceIfNeeded();
                }
                ...
                render() {
                    const { adsAccount: e, audience: t, availableBudgets: n, country: y, coupons: P, currency: B, dailyBudget: v, durationDays: M, errorMessage: L, fundingInstrument: q, lang: A, match: N, promoteStatus: F, selectedPaymentMethod: R, targetedLocations: O } = this.props,
                        W = v.toLocaleString((0, x.It)(A), { currency: B, style: "currency", maximumFractionDigits: 0, minimumFractionDigits: 0 }),
                        ...
                        a.createElement(
                            ...
                            a.createElement(
                                ...
                                a.createElement(d.ZP, null, ({ windowWidth: e }) => {
                                    ...
                                    return a.createElement(
                                        p.Z,
                                        { interactiveStyles: xe, link: fe ? (!q || _e ? (0, I.WS)(be, Ce, ye, I.MN.Payment) : "CREDIT_CARD" === q?.type ? (0, I.WS)(be, Ce, ye, I.MN.PaymentSelect) : void 0) : void 0, style: t ? ge.mobilePaymentContainer : ge.paymentContainer },
                                        ...
                                        a.createElement(
                                            ...
                                            se
                                                ? (function ({ balance: e, currency: t, lang: n, subtotal: o }) {
                                                  ...
                                                  })({ subtotal: v * M, balance: ce?.total_amount || 0, currency: B, lang: A })
                                                : null,
                                        ),
                                    );
                                }),
                                q ? a.createElement(g.ZP, { disabled: _e || S.LK.includes(F), onPress: this._handlePromote, size: "xLarge", testID: T.Z.reviewButton, type: "primaryFilled" }, ae) : a.createElement(g.ZP, { disabled: _e || S.LK.includes(F), link: Pe, size: "xLarge", testID: T.Z.reviewButton, type: "primaryFilled" }, this._getPaymentDescription(Ee, le)),
                                a.createElement(
                                    h.Z,
                                    { align: "center", style: ge.terms },
                                    (function (e, t, n, o) {
                                        return n ? a.createElement(b().I18NFormatMessage, { $i18n: "b3816c8b" }, a.createElement(u.ZP, { link: (0, I.s0)(e) }, b().i8b90688), a.createElement(u.ZP, { link: (0, I.bx)(t, o) }, b().a93bd26d)) : a.createElement(b().I18NFormatMessage, { $i18n: "ee48f791" }, a.createElement(u.ZP, { link: (0, I.s0)(e) }, b().d31dc460));
                                    })(y, A, ue, ie),
                                ),
                            ),
                        ),
        ...
        661345: (e, t, n) => {
            ...
            var C = n(708852),
                ...
                w = n(879122);
            function D({ style: e }) {
                return o.createElement(P.Z, { style: e }, o.createElement(x.Z, { "aria-label": "", aspectMode: S.Z.exact(600 / 406), image: w }));
            }
            function Z({ headerImage: e, style: t }) {
                return o.createElement(P.Z, { style: t }, o.createElement(x.Z, { "aria-label": "", aspectMode: S.Z.COVER, image: e }));
            }
            function k({ style: e }) {
                const t = (0, C.D2)(),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Conversation-0d835cf1.62de07ea.js.map
