    ...
    ["bundle.ConversationParticipants-bc6ccf4c", "bundle.FollowerRequests-bc6ccf4c"],
    {
        ...
        537439: (e, t, n) => {
            ...
            const B = a().ae408b76,
                ...
                M = P.default.create((e) => ({ small: { height: e.lineHeights.subtext3, width: e.lineHeights.subtext3 }, medium: { height: e.spaces.space48, width: e.spaces.space48 }, large: { height: e.lineHeights.subtext2, width: e.lineHeights.subtext2 }, xLarge: { height: e.lineHeights.subtext1, width: e.lineHeights.subtext1 }, xxLarge: { height: e.lineHeights.headline1, width: e.lineHeights.headline1 }, xxxLarge: { height: e.lineHeights.headline1, width: e.lineHeights.headline1 } })),
                ...
                A = ({ contextType: e, iconColor: t, iconSize: n, link: o, retweetData: a, text: Z, topicData: k, userAvatarUrls: B }) => {
                    const { isSelfRetweet: A, name: H, screenName: W } = a || {},
                        Q = ((e, t, n, o = []) => {
                            const a = M[t],
                                ...
                                I = r.createElement(d.default, { style: Z }),
                                L = r.createElement(u.default, { style: z.circle }),
                                R = r.createElement(m.default, { style: Z }),
                                _ = r.createElement(h.default, { style: Z }),
                                A = r.createElement(p.default, { style: Z }),
                                ...
                                j = r.createElement(v.default, { style: Z }),
                    ...
                    switch (e) {
                        case T.Q.Retweet:
                            return { Icon: Q, text: Z || _(H, A), link: W ? `https://twitter.com/${W}` : void 0 };
                        case T.Q.Pin:
                            return { Icon: Q, text: Z || F };
                        case T.Q.ReplyPin:
                            return { Icon: Q, text: D };
                        case T.Q.Topic:
                            return { Icon: Q, "aria-label": "Recommendation" === k?.functionalityType || "RecWithEducation" === k?.functionalityType ? L({ topicName: Z }) : I({ topicName: Z }), text: Z ? r.createElement(R, { text: Z }) : null, link: o };
                        default:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationParticipants-bc6ccf4c.d2fa31ea.js.map
