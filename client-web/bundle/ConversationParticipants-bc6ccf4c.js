...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.ConversationParticipants-bc6ccf4c", "bundle.FollowerRequests-bc6ccf4c"],
    {
        642153: (e, t, r) => {
            r.d(t, { Z: () => l });
            var o = r(202784),
            ...
            const T = n().ae408b76,
                ...
                D = (e, t) =>
                    t
                        ? T
                        : ((e) => {
                              const t = o.createElement(z, { text: e });
                ...
                M = ({ contextType: e, iconColor: t, iconSize: r, link: a, retweetData: n, text: Z, topicData: S, userAvatarUrls: T }) => {
                    const { isSelfRetweet: M, name: W, screenName: N } = n || {},
                        V = ((e, t, r, a = []) => {
                            const n = H[t],
                                Z = [r ? { color: L.default.theme.colors[r] } : Q.colorDeepGray, n],
                                ...
                                I = o.createElement(u.default, { style: Q.circle }),
                                z = o.createElement(m.default, { style: Z }),
                                D = o.createElement(h.default, { style: Z }),
                                M = o.createElement(p.default, { style: Z }),
                                W = o.createElement(g.default, { style: Z }),
                                N = o.createElement(f.default, { style: Z }),
                                V = o.createElement(y.default, { style: Z }),
                                _ = o.createElement(b.default, { style: Z }),
                                A = o.createElement(w.default, { style: Z }),
                                U = o.createElement(v.default, { style: Z }),
                                $ = o.createElement(C.default, { style: Z }),
                                O = o.createElement(x.default, { style: Z }),
                                j = o.createElement(k.Z, { borderColor: "cellBackground", userAvatarSize: t, userAvatarUrls: a }),
                    ...
                    switch (e) {
                        case F.Q.Retweet:
                            return { Icon: V, text: Z || D(W, M), link: N ? `https://twitter.com/${N}` : void 0 };
                        case F.Q.Pin:
                            return { Icon: V, text: Z || P };
                        case F.Q.ReplyPin:
                            return { Icon: V, text: R };
                        case F.Q.Topic:
                            return { Icon: V, "aria-label": "Recommendation" === S?.functionalityType || "RecWithEducation" === S?.functionalityType ? I({ topicName: Z }) : B({ topicName: Z }), text: Z ? o.createElement(z, { text: Z }) : null, link: a };
                        default:
                            return { Icon: V, text: Z ? o.createElement(z, { text: Z }) : null, link: a };
                    }
                };
        },
        126962: (e, t, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationParticipants-bc6ccf4c.9e619c9a.js.map
