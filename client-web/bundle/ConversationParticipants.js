    ...
    ["bundle.ConversationParticipants"],
    {
        625661: (e, t, o) => {
            ...
            class h extends r.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: a, hideBackButton: n, isFullWidth: s, isLarge: d, leftControl: c, middleControl: h, position: p, rightControl: m, secondaryBar: f, style: b, subtitle: D, title: k, titleDomId: y, titleIconCell: g, titleIconCellSize: w, withBackground: v, withWideContainer: M } = this.props,
                        { isModal: I } = this.context,
                        _ = n ? c : r.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        E = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!v, I, !!f);
                    return r.createElement(r.Fragment, null, r.createElement(i.Z, { centerTitle: t, centeredLogo: o, isFullWidth: s, isLarge: d, leftControl: _, middleControl: h, position: u(p, I, a), rightControl: m, style: b, subtitle: D, title: k, titleDomId: y, titleIconCell: g, titleIconCellSize: w, withBackground: E, withWideContainer: M }), f || null);
                }
                render() {
            ...
            const f = "block",
                ...
                v = (0, m.M)((e) => {
                    const { featureSwitches: t } = (0, c.QZ)(),
                        { onBlock: o, onClose: s, onMute: l, onRemoveFollower: m, onReportUser: v, onShare: M, onUnblock: I, onUnmute: _, user: E } = e,
                        C = [],
                        P = (t, o) => {
                    ...
                    E.followed_by &&
                        ...
                        C.push((0, u.op)({ blockAction: (e) => P(e, o), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => P(e, I), user: E })),
                        C.push({
                            Icon: i.default,
                            onClick: () => {
                                s(), v();
        ...
        376293: (e, t, o) => {
            o.d(t, { $f: () => I, KV: () => D, LI: () => Z, SC: () => M, Vt: () => g, ed: () => A, op: () => _ });
            var r = o(202784),
                a = o(190286),
                n = o(674132),
                s = o.n(n),
            ...
            const u = s().cfd2f35e,
                ...
                Z = (e, t) => (e.blocking ? ((e, t) => ({ confirmButtonType: "primary", headline: k({ screenName: e }), label: g, text: t ? v : w }))(e.screen_name, t) : I(e.screen_name, t)),
        ...
        747644: (e, t, o) => {
            ...
            class E extends r.Component {
                ...
                render() {
                    ...
                    return r.createElement(l.Z, { backLocation: `/${o.toLowerCase()}/status/${a}`, history: t, title: _ }, r.createElement(s.Z, { "aria-label": I, fetchStatus: e, onRequestRetry: this._handleFetch, render: this._renderList }));
                }
            }
            const C = M(E);
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationParticipants.abfd1a8a.js.map
