                ...
                J = ({ audioChart: e = !1, barConfig: t, data: a, dataGrouped: l, gridlines: o, labelStyle: c, stacked: p = !1, style: m, ticks: g, title: f, titleDescription: h }) => {
                    ...
                    if (void 0 !== a)
                        (x = L),
                            ...
                            (b = r.createElement(R, { audioChartGenerator: C, barConfig: t, data: a, frequencies: v, maxValue: P, minValue: k }));
                    else {
                        if (void 0 === l) return null;
                        (w = void 0), (E = l.length), p ? ((b = r.createElement(H, { barConfig: t, data: l, maxValue: P, minValue: k })), (x = q)) : ((b = r.createElement(z, { barConfig: t, data: l, maxValue: P, minValue: k })), (x = _));
                    }
                    return r.createElement(n.Z, { "aria-labelledby": y, role: "figure" }, f && r.createElement(n.Z, { style: U.titleBar }, r.createElement(i.ZP, { focusable: !1, id: y, role: "heading", size: "subtext2", style: U.title, weight: "medium" }, f), h ? r.createElement(d.Z, { label: f, popover: h }) : null, r.createElement(Z, { chartTitle: f, chartType: x, maxValue: P, minValue: k, noOfCategories: E, playAudioChart: w })), r.createElement(n.Z, { style: [U.grid, m] }, r.createElement(n.Z, { "aria-label": K, focusable: !1, key: "chartArea", role: "application", style: U.chartArea }, r.createElement(j, { gridlines: o, maxValue: P, minValue: k }), b), r.createElement(n.Z, { key: "yAxis", style: U.yAxis }, r.createElement(N, { maxValue: P, minValue: k, ticks: g })), r.createElement(n.Z, { key: "xAxis", style: U.xAxis }, r.createElement(F, { data: a || l, labelStyle: c }))));
                };
        },
        738545: (e, t, a) => {
            a.d(t, { ZP: () => Z });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationWithRelay-1f1c1973.efcc157a.js.map
