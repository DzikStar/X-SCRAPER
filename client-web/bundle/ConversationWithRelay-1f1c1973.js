    ...
    ["bundle.ConversationWithRelay-1f1c1973"],
    {
        595294: (e, t, a) => {
            ...
            const Z = (e) => {
                    ...
                    return r.createElement(n.Z, null, r.createElement(g.Z, { enableEnterKeyToggle: !0, preferredVerticalOrientation: "up", renderContent: (e) => r.createElement(n.Z, { "aria-label": u, role: "dialog", style: T.popover }, r.createElement(n.Z, { style: T.popoverTitle }, r.createElement(i.ZP, { size: "title3", weight: "heavy" }, y)), r.createElement(n.Z, { style: T.popoverText }, r.createElement(i.ZP, { color: "gray700", size: "body", weight: "normal" }, u)), c ? r.createElement(m.ZP, { "aria-label": v, onPress: c, style: T.audioChartButton, type: "primaryFilled" }, x) : null, r.createElement(m.ZP, { onPress: e, type: "primaryOutlined" }, E)), withArrow: !0 }, r.createElement(n.Z, { role: "button" }, r.createElement(p.default, { "aria-label": h, style: T.audioChartIcon }))));
                },
                T = c.default.create((e) => ({ popover: { padding: e.spaces.space32 }, popoverTitle: { marginBottom: e.spaces.space8 }, popoverText: { marginBottom: e.spaces.space24 }, audioChartButton: { marginBottom: e.spaces.space8 }, audioChartIcon: { color: e.colors.gray700, fontSize: e.fontSizes.subtext3, cursor: "pointer", marginStart: e.spaces.space4 } })),
                C = { borderRadii: "xSmall", layout: "fixedSpacing", spacing: "space2", width: "space56" };
            ...
            const P = (e, t, a) => (100 * (e - a)) / (t - a),
                ...
                $ = (e) => e.map((e) => e.values.map((e) => e.value).reduce((e, t) => e + t)),
                I = (e) => (t) => e.popover ?? null,
                k = o().dec1d7ef,
                A = o().f765bead,
                z = ({ barConfig: e, data: t, maxValue: a, minValue: l }) => {
                    const o = r.useRef([]),
                        i = { ...C, ...e },
                    ...
                    return t.map((e, i) => {
                        ...
                        return r.createElement(
                            ...
                            r.createElement(
                                g.Z,
                                { contentStyle: { minWidth: 0 }, disabled: !h, enableEnterKeyToggle: !0, enableHover: !0, hoverDelay: "short", key: `barGroup${i}`, onDismiss: () => f(i), onHoverCardUnmount: () => f(i), onOpen: () => d(i), preferredVerticalOrientation: "up", renderContent: I(e), withArrow: !0, wrapperStyle: { flex: s ? null : 1, flexDirection: "row", alignItems: "flex-end", width: "100%", height: `${P(c, a, l)}%` } },
                                e.values.map((a, l) => {
                                    const s = e.label ? k({ label: e.label?.props.children, group: a.group, value: a.value }) : A({ group: a.group, value: a.value });
                ...
                R = ({ audioChartGenerator: e, barConfig: t, data: a, frequencies: l, maxValue: o, minValue: i }) => {
                    ...
                    return a.map((t, o) => {
                        ...
                        return r.createElement(
                            ...
                            r.createElement(
                                g.Z,
                                { contentStyle: { minWidth: 0 }, disabled: !c, enableEnterKeyToggle: !0, enableHover: !0, hoverDelay: "short", onDismiss: () => y(o), onHoverCardUnmount: () => y(o), onOpen: () => p(o), preferredVerticalOrientation: "up", renderContent: I(t), withArrow: !0, wrapperStyle: h(t) },
                                r.createElement(n.Z, {
                                    "aria-label": i,
                                    focusable: 0 === o,
                                    key: `bar${o}`,
                ...
                O = o().dec1d7ef,
                M = o().f765bead,
                H = ({ barConfig: e, data: t, maxValue: a, minValue: l }) => {
                    ...
                    return t.map((e, a) => {
                        ...
                        return r.createElement(
                            ...
                            r.createElement(
                                ...
                                e.values.map((l, s) => {
                                    const c = e.label ? O({ label: e.label?.props.children, group: l.group, value: l.value }) : M({ group: l.group, value: l.value });
                                    return r.createElement(n.Z, {
                                        "aria-label": c,
                                        focusable: !0,
                ...
                J = ({ audioChart: e = !1, barConfig: t, data: a, dataGrouped: l, gridlines: o, labelStyle: c, stacked: p = !1, style: m, ticks: g, title: f, titleDescription: h }) => {
                    ...
                    let b, x, v, E, w;
                    const T = r.useRef();
                    T.current || (T.current = new u.Z());
                    const C = g ? g.map((e) => e.value) : [],
                        D = ((e, t, a) => (void 0 !== e ? V(e) : void 0 !== t ? (a ? $(t) : V(t)) : void B()(e || t, "Either data or groupedData props must be passed")))(a, l, p);
                    if (!D) return null;
                    ...
                    if (void 0 !== a)
                        (x = L),
                            (E = a.length),
                            e &&
                                ((v = T.current?.mapDataPointsToFrequencies([...D, ...C])),
                                (w = () => {
                                    T?.current?.playDisconnectedDataPointsAsTone(a, 0.7, 0.3);
                                })),
                            (b = r.createElement(R, { audioChartGenerator: T, barConfig: t, data: a, frequencies: v, maxValue: P, minValue: I }));
                    else {
                        if (void 0 === l) return null;
                        (w = void 0), (E = l.length), p ? ((b = r.createElement(H, { barConfig: t, data: l, maxValue: P, minValue: I })), (x = q)) : ((b = r.createElement(z, { barConfig: t, data: l, maxValue: P, minValue: I })), (x = _));
                    }
                    return r.createElement(n.Z, { "aria-labelledby": y, role: "figure" }, f && r.createElement(n.Z, { style: U.titleBar }, r.createElement(i.ZP, { focusable: !1, id: y, role: "heading", size: "subtext2", style: U.title, weight: "medium" }, f), h ? r.createElement(d.Z, { label: f, popover: h }) : null, r.createElement(Z, { chartTitle: f, chartType: x, maxValue: P, minValue: I, noOfCategories: E, playAudioChart: w })), r.createElement(n.Z, { style: [U.grid, m] }, r.createElement(n.Z, { "aria-label": K, focusable: !1, key: "chartArea", role: "application", style: U.chartArea }, r.createElement(j, { gridlines: o, maxValue: P, minValue: I }), b), r.createElement(n.Z, { key: "yAxis", style: U.yAxis }, r.createElement(N, { maxValue: P, minValue: I, ticks: g })), r.createElement(n.Z, { key: "xAxis", style: U.xAxis }, r.createElement(F, { data: a || l, labelStyle: c }))));
                };
        },
        738545: (e, t, a) => {
            a.d(t, { ZP: () => Z });
