    ...
    ["bundle.ConversationWithRelay-1f1c1973"],
    {
        595294: (e, t, a) => {
            ...
            const P = (e, t, a) => (100 * (e - a)) / (t - a),
                ...
                $ = o().dec1d7ef,
                A = o().f765bead,
                S = ({ barConfig: e, data: t, maxValue: a, minValue: n }) => {
                    const o = r.useRef([]),
                        i = { ...D, ...e },
                    ...
                    return t.map((e, i) => {
                        ...
                        return r.createElement(
                            ...
                            r.createElement(
                                h.Z,
                                { contentStyle: { minWidth: 0 }, disabled: !g, enableEnterKeyToggle: !0, enableHover: !0, hoverDelay: "short", key: `barGroup${i}`, onDismiss: () => f(i), onHoverCardUnmount: () => f(i), onOpen: () => d(i), preferredVerticalOrientation: "up", renderContent: I(e), withArrow: !0, wrapperStyle: { flex: s ? null : 1, flexDirection: "row", alignItems: "flex-end", width: "100%", height: `${P(c, a, n)}%` } },
                                e.values.map((a, n) => {
                ...
                G = ({ audioChartGenerator: e, barConfig: t, data: a, frequencies: n, maxValue: o, minValue: i }) => {
                    ...
                    return a.map((t, o) => {
                        const i = t.label ? z({ label: t.label, value: t.value }) : W({ value: t.value }),
                            c = !!t.popover;
                        return r.createElement(
                            l.Z,
                            ...
                            r.createElement(
                                h.Z,
                                { contentStyle: { minWidth: 0 }, disabled: !c, enableEnterKeyToggle: !0, enableHover: !0, hoverDelay: "short", onDismiss: () => y(o), onHoverCardUnmount: () => y(o), onOpen: () => p(o), preferredVerticalOrientation: "up", renderContent: I(t), withArrow: !0, wrapperStyle: g(t) },
                                r.createElement(l.Z, {
                                    "aria-label": i,
                                    focusable: 0 === o,
                                    key: `bar${o}`,
                ...
                J = ({ audioChart: e = !1, barConfig: t, data: a, dataGrouped: n, gridlines: o, labelStyle: c, stacked: p = !1, style: m, ticks: h, title: f, titleDescription: g }) => {
                    const y = (0, s.b)();
                    let b, v, x, E, w;
                    const C = r.useRef();
                    ...
                    if (void 0 !== a)
                        ...
                        (w = void 0), (E = n.length), p ? ((b = r.createElement(H, { barConfig: t, data: n, maxValue: P, minValue: I })), (v = q)) : ((b = r.createElement(S, { barConfig: t, data: n, maxValue: P, minValue: I })), (v = _));
                    }
                    return r.createElement(l.Z, { "aria-labelledby": y, role: "figure" }, f && r.createElement(l.Z, { style: N.titleBar }, r.createElement(i.ZP, { focusable: !1, id: y, role: "heading", size: "subtext2", style: N.title, weight: "medium" }, f), g ? r.createElement(d.Z, { label: f, popover: g }) : null, r.createElement(Z, { chartTitle: f, chartType: v, maxValue: P, minValue: I, noOfCategories: E, playAudioChart: w })), r.createElement(l.Z, { style: [N.grid, m] }, r.createElement(l.Z, { "aria-label": K, focusable: !1, key: "chartArea", role: "application", style: N.chartArea }, r.createElement(j, { gridlines: o, maxValue: P, minValue: I }), b), r.createElement(l.Z, { key: "yAxis", style: N.yAxis }, r.createElement(U, { maxValue: P, minValue: I, ticks: h })), r.createElement(l.Z, { key: "xAxis", style: N.xAxis }, r.createElement(F, { data: a || n, labelStyle: c }))));
                };
        },
        738545: (e, t, a) => {
            a.d(t, { ZP: () => Z });
            ...
            const h = o().i2785009,
                ...
                Z = (e) => {
                    ...
                    return r.createElement(l.Z, { style: w.dataPoint }, r.createElement(v, { label: n, popover: o }), r.createElement(l.Z, { style: w.valueBar }, t ? r.createElement(d.ZP, { count: a, size: i, style: h, weight: "bold" }, m) : r.createElement(u.ZP, { size: i, style: h, weight: "bold" }, m), r.createElement(x, { style: f, unit: p }), r.createElement(E, { trendValue: c })), s);
                };
        },
        635998: (e, t, a) => {
            a.d(t, { Z: () => f });
        ...
        879113: (e, t, a) => {
            ...
            class m extends r.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: a, fetchStatus: l, icon: n, loadingMessage: o, onRequestRetry: u, render: m, renderFailure: h, retryMessage: f, retryable: g } = this.props;
                    switch (l) {
                        case c:
                            return g ? r.createElement(i.Z, { icon: n, onRequestRetry: u, retryMessage: f }) : a ? r.createElement(s.m, { failureMessage: a }) : h();
                        case d:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationWithRelay-1f1c1973.894da30a.js.map
