...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.ConversationWithRelay-1f1c1973"],
    {
        595294: (e, t, a) => {
            ...
            var D = a(614983),
                P = a.n(D);
            const V = (e, t, a) => (100 * (e - a)) / (t - a),
                k = (e) => [].concat(...e.map((e) => (void 0 !== e.value ? e.value : e.values.map((e) => e.value)))),
                I = (e) => e.map((e) => e.values.map((e) => e.value).reduce((e, t) => e + t)),
                T = (e) => (t) => e.popover ?? null,
                S = o().dec1d7ef,
                $ = o().f765bead,
                z = ({ barConfig: e, data: t, maxValue: a, minValue: n }) => {
                    ...
                    return t.map((e, i) => {
                        ...
                        return r.createElement(
                            ...
                            r.createElement(
                                f.Z,
                                { contentStyle: { minWidth: 0 }, disabled: !h, enableEnterKeyToggle: !0, enableHover: !0, hoverDelay: "short", key: `barGroup${i}`, onDismiss: () => g(i), onHoverCardUnmount: () => g(i), onOpen: () => d(i), preferredVerticalOrientation: "up", renderContent: T(e), withArrow: !0, wrapperStyle: { flex: s ? null : 1, flexDirection: "row", alignItems: "flex-end", width: "100%", height: `${V(c, a, n)}%` } },
                                e.values.map((a, n) => {
                                    const s = e.label ? S({ label: e.label?.props.children, group: a.group, value: a.value }) : $({ group: a.group, value: a.value });
                ...
                W = ({ audioChartGenerator: e, barConfig: t, data: a, frequencies: n, maxValue: o, minValue: i }) => {
                    ...
                    return a.map((t, o) => {
                        ...
                        return r.createElement(
                            ...
                            r.createElement(
                                f.Z,
                                { contentStyle: { minWidth: 0 }, disabled: !c, enableEnterKeyToggle: !0, enableHover: !0, hoverDelay: "short", onDismiss: () => b(o), onHoverCardUnmount: () => b(o), onOpen: () => p(o), preferredVerticalOrientation: "up", renderContent: T(t), withArrow: !0, wrapperStyle: h(t) },
                                r.createElement(l.Z, {
                                    "aria-label": i,
                                    focusable: 0 === o,
                                    key: `bar${o}`,
                ...
                F = o().f7b30768,
                K = o().hcd54328,
                _ = ({ gridlines: e, maxValue: t, minValue: a }) => (e ? e.map((e, n) => r.createElement(l.Z, { key: `gridline${n}`, style: [U.gridLine, { bottom: `${V(e, t, a)}%` }], testID: `gridline${n}` })) : null),
                ...
                N = ({ maxValue: e, minValue: t, ticks: a }) => {
                    ...
                    return o.map((a, n) => {
                        const i = 0 === n ? V(a.value, e, t) : (100 * (a.value - o[n - 1].value)) / (e - t);
                ...
                J = ({ audioChart: e = !1, barConfig: t, data: a, dataGrouped: n, gridlines: o, labelStyle: c, stacked: p = !1, style: m, ticks: f, title: g, titleDescription: h }) => {
                    const b = (0, s.b)();
                    let y, v, x, E, w;
                    const C = r.useRef();
                    C.current || (C.current = new u.Z());
                    const B = f ? f.map((e) => e.value) : [],
                        D = ((e, t, a) => (void 0 !== e ? k(e) : void 0 !== t ? (a ? I(t) : k(t)) : void P()(e || t, "Either data or groupedData props must be passed")))(a, n, p);
                    if (!D) return null;
                    ...
                    if (void 0 !== a)
                        (v = j),
                            ...
                            (y = r.createElement(W, { audioChartGenerator: C, barConfig: t, data: a, frequencies: x, maxValue: V, minValue: T }));
                    else {
                        if (void 0 === n) return null;
                        (w = void 0), (E = n.length), p ? ((y = r.createElement(H, { barConfig: t, data: n, maxValue: V, minValue: T })), (v = F)) : ((y = r.createElement(z, { barConfig: t, data: n, maxValue: V, minValue: T })), (v = K));
                    }
                    return r.createElement(l.Z, { "aria-labelledby": b, role: "figure" }, g && r.createElement(l.Z, { style: U.titleBar }, r.createElement(i.ZP, { focusable: !1, id: b, role: "heading", size: "subtext2", style: U.title, weight: "medium" }, g), h ? r.createElement(d.Z, { label: g, popover: h }) : null, r.createElement(Z, { chartTitle: g, chartType: v, maxValue: V, minValue: T, noOfCategories: E, playAudioChart: w })), r.createElement(l.Z, { style: [U.grid, m] }, r.createElement(l.Z, { "aria-label": L, focusable: !1, key: "chartArea", role: "application", style: U.chartArea }, r.createElement(_, { gridlines: o, maxValue: V, minValue: T }), y), r.createElement(l.Z, { key: "yAxis", style: U.yAxis }, r.createElement(N, { maxValue: V, minValue: T, ticks: f })), r.createElement(l.Z, { key: "xAxis", style: U.xAxis }, r.createElement(q, { data: a || n, labelStyle: c }))));
                };
        },
        738545: (e, t, a) => {
            a.d(t, { ZP: () => Z });
            ...
            const f = o().i2785009,
                ...
                Z = (e) => {
                    const { animated: t, count: a, label: n, popover: o, size: i, subTextList: s, trendValue: c, unit: p, value: m } = e,
                        f = p || void 0 !== c ? w.textWithMargin : void 0,
                        g = void 0 !== c ? w.textWithMargin : void 0;
                    return r.createElement(l.Z, { style: w.dataPoint }, r.createElement(v, { label: n, popover: o }), r.createElement(l.Z, { style: w.valueBar }, t ? r.createElement(d.ZP, { count: a, size: i, style: f, weight: "bold" }, m) : r.createElement(u.ZP, { size: i, style: f, weight: "bold" }, m), r.createElement(x, { style: g, unit: p }), r.createElement(E, { trendValue: c })), s);
                };
        },
        635998: (e, t, a) => {
            a.d(t, { Z: () => g });
            ...
            const p = o().affbaf62,
                m = o().c388d026,
                f = d.default.create((e) => ({ popover: { padding: e.spaces.space32 }, popoverTitle: { marginBottom: e.spaces.space8 }, popoverText: { marginBottom: e.spaces.space24 }, iconInformation: { color: e.colors.gray700, fontSize: e.fontSizes.subtext3, cursor: "pointer", marginStart: e.spaces.space4 } })),
                g = (e) => {
                    const { label: t, popover: a } = e;
                    return r.createElement(l.Z, null, r.createElement(u.Z, { enableEnterKeyToggle: !0, preferredVerticalOrientation: "up", renderContent: (e) => r.createElement(l.Z, { role: "dialog", style: f.popover }, r.createElement(l.Z, { style: f.popoverTitle }, r.createElement(s.ZP, { size: "title3", weight: "heavy" }, t)), r.createElement(l.Z, { style: f.popoverText }, a), r.createElement(c.ZP, { onPress: e, type: "primaryOutlined" }, m)), withArrow: !0 }, r.createElement(l.Z, { role: "button" }, r.createElement(i.default, { "aria-label": p, style: f.iconInformation }))));
                };
        },
        247291: (e, t, a) => {
            a.d(t, { Z: () => z });
            ...
            const p = Object.freeze({ large: 54, medium: 46, small: 36, xSmall: 12 }),
                ...
                f = ({ color: e = "blue500", label: t, size: a = "large", value: n }) => {
                    const o = n ? a : "xSmall",
                        i = p[o],
                        c = ((e) => {
                            switch (e) {
            ...
            const Z = (e) => {
                    ...
                    const o = r.useRef(Array.from({ length: a.length }, () => null)),
                        ...
                        m = ((e) => 2 * Math.PI * e)(c),
                        {
                            ...
                            return (
                                ...
                                r.useMemo(() => ({ focusSliceFromKeyboard: d, forceHidePopover: p, onSliceBlur: m, onSliceMouseOver: f, onPopoverOpen: g, onPopoverClose: h, focusedSlice: t, isPopoverDisabled: l, isSliceHighlighted: o }), [d, t, p, l, o, h, g, m, f])
                            );
                        })(a),
                        Z = r.useCallback((e) => {
                        ...
                        { a11yViews: C, circles: S } = r.useMemo(() => {
                            ...
                            return (
                                a.forEach(({ color: i, label: u, popover: b, value: v }, x) => {
                                    const Z = u ? V({ value: P(v), label: u }) : k({ value: P(v) }),
                                        C = y && g !== x ? 0.5 : 1,
                                        I = b ? "pointer" : "default";
                                    var S;
                                    n.push(r.createElement("circle", { cx: p, cy: p, fill: "none", key: u ?? x, onBlur: h, onFocus: () => w(x), onMouseLeave: h, onMouseOver: () => w(x), r: c, stroke: d.default.theme.colors[i ?? T], strokeDasharray: B(m, v, x === a.length - 1), strokeDashoffset: D(m, e), strokeWidth: s, style: { opacity: C, cursor: I } })),
                                        t.push(
                                            r.createElement(l.Z, {
                                                "aria-label": Z,
                                                focusable: 0 === x,
                        ...
                        }, [a, y, g, p, h, c, m, s, E, w, f]),
                        $ = (null !== g && a[g].popover) || null;
                    return r.createElement(u.Z, { contentStyle: { minWidth: 0 }, disabled: b, enableEnterKeyToggle: !!$, enableHover: !0, hoverDelay: "short", onHoverCardUnmount: v, onOpen: x, preferredVerticalOrientation: "up", renderContent: () => $ }, r.createElement(l.Z, { "aria-label": I, focusable: !1, id: t, role: "application" }, r.createElement("svg", { height: i, onFocus: Z, onMouseOver: Z, style: { transform: "rotate(-90deg)" }, width: i }, S), C));
                },
                ...
                z = ({ arcWidth: e = 0.4, data: t, legendPosition: a, radius: n, title: o, titleDescription: u }) => {
                    const d = (0, c.b)(),
                        ...
                        D = r.useMemo(() => (b ? B.map(({ color: e, label: t, value: a }, l) => r.createElement(f, { color: e ?? T, key: t, label: t ?? "", size: "small", value: P(a) })) : []), [B, b]),
                        V = ((e, t, a) => {
                            switch (t) {
                                case "right":
                    ...
                    return r.createElement(l.Z, { "aria-labelledby": d, role: "figure" }, o && r.createElement(l.Z, { style: $.titleBar }, r.createElement(s.ZP, { "aria-level": 1, role: "heading", size: "headline1", style: $.title, weight: "heavy" }, o), u ? r.createElement(g.Z, { label: o, popover: u }) : null, r.createElement(Z, { chartTitle: o, maxValue: C, minValue: w, noOfCategories: t.length })), r.createElement(l.Z, { style: V.container }, b && r.createElement(l.Z, { style: [$.legend, V.legend] }, D), r.createElement(l.Z, { onLayout: y, style: [$.pie, V.pie] }, r.createElement(S, { arcWidth: e, chartId: d, data: B, radius: m }))));
                };
        },
        98996: (e, t, a) => {
            a.d(t, { Z: () => m });
            ...
            const p = c.default.create((e) => ({ chart: { display: "flex", flex: 1 }, popover: { minWidth: 0 } })),
                m = (e) => {
                    const { barConfig: t, data: a, style: n } = e,
                        ...
                        f = r.useCallback((e) => () => e.popover ?? null, []),
                        g = a.map((e, a) => {
                            ...
                            const m = c(d / o),
                                ...
                                b = f(e);
                            return r.createElement(s.Z, { contentStyle: p.popover, enableEnterKeyToggle: !!e.popover, enableHover: !0, hoverDelay: "short", key: `progressBar${a}Popover`, preferredVerticalOrientation: "up", renderContent: b, withArrow: !0 }, r.createElement(l.Z, { focusable: !0 }, r.createElement(i.Z, { decoration: n, isCompact: !0, key: `progressBar${a}`, progressBarConfig: g, statConfig: h, title: u, valueCurrent: d, valueMax: o })));
                        });
                    return r.createElement(l.Z, { "aria-label": m, focusable: !0, role: "figure", style: [p.chart, n] }, g);
                };
        },
        885015: (e, t, a) => {
            a.d(t, { Z: () => c });
        ...
        536606: (e, t, a) => {
            ...
            var r = a(202784),
                ...
                c = a(392237);
            const u = (e) => {
                const { decoration: t, isCompact: a, progressBarConfig: u, statConfig: p, title: m, valueCurrent: f, valueMax: g } = e,
                    h = (0, o.F)(),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationWithRelay-1f1c1973.7fa17d4a.js.map
