...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.ConversationWithRelay-e96e9bea"],
    {
        ...
        999325: (e, a, l) => {
                                ...
                                selections: [
                                    {
                                        ...
                                        selections: [
                                            ...
                                            { kind: "InlineFragment", selections: [{ alias: null, args: null, concreteType: "Tweet", kind: "LinkedField", name: "tweet", plural: !1, selections: Z, storageKey: null }], type: "TweetWithVisibilityResults", abstractKey: null },
                                        ],
                                        storageKey: null,
                                    },
                                    h,
            ...
            q.hash = "cf04955724597180d1689fb60c8ab013";
            const I = q;
        },
        393416: (e, a, l) => {
            l.d(a, { Z: () => r });
        ...
        625661: (e, a, l) => {
            ...
            class m extends n.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: a, centeredLogo: l, fixed: t, hideBackButton: i, isFullWidth: r, isLarge: d, leftControl: c, middleControl: m, position: g, rightControl: k, secondaryBar: p, style: y, subtitle: _, title: b, titleDomId: f, titleIconCell: T, titleIconCellSize: F, withBackground: h, withWideContainer: w } = this.props,
                        { isModal: K } = this.context,
                        v = i ? c : n.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        L = (function (e, a, l) {
                            return e && !(a && l);
                        })(!!h, K, !!p);
                    return n.createElement(n.Fragment, null, n.createElement(o.Z, { centerTitle: a, centeredLogo: l, isFullWidth: r, isLarge: d, leftControl: v, middleControl: m, position: u(g, K, t), rightControl: k, style: y, subtitle: _, title: b, titleDomId: f, titleIconCell: T, titleIconCellSize: F, withBackground: L, withWideContainer: w }), p || null);
                }
                render() {
        ...
        290402: (e, a, l) => {
            ...
            const u = d().aa6e3300,
                m = ({ retryMessage: e, ...a }, l) => {
                    ...
                    return t.createElement(r.Z, (0, n.Z)({}, a, { icon: s ? void 0 : t.createElement(c.default, { style: g.icon }), retryMessage: s ? e : u }));
                },
        ...
        980407: (e, a, l) => {
            ...
            class g extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: a, backButtonType: l, backLocation: i, centerTitle: r, hideBackButton: s, history: o, isFullWidth: u, isLarge: m, middleControl: g, onBackClick: p, rightControl: y, secondaryBar: _, subtitle: b, title: f } = this.props,
                                { isModal: T } = this.context;
                            return n.createElement(t.Z, { style: T ? [k.childViewAppBarRoot, k.appBarZindex] : k.appBarZindex }, n.createElement(c.ZP, { backButtonType: l || (T ? "close" : "back"), backLocation: i, centerTitle: r, fixed: !T, hideBackButton: s, history: o, isFullWidth: u, isLarge: m, middleControl: g, onBackClick: p, ref: e, rightControl: y, secondaryBar: _, style: [T && k.appBarModal, a], subtitle: b, title: f, titleDomId: d.Q_ }));
                        }),
                ...
                render() {
                    ...
                    return n.createElement(o.Z, null, n.createElement(u.Z.Configure, { documentTitle: s, headerless: !0, title: p }), n.createElement(t.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [k.root, _ && k.rootModal] }, !_ && b, n.createElement(i.Z, { isFullWidth: d, isLarge: c, style: [k.container, _ && k.containerModal, r] }, _ ? n.createElement(m.Z, { style: k.viewport }, b, l) : l), a ? n.createElement(t.Z, { style: [k.bottomBarModal, !_ && !y && k.bottomBarMobile] }, n.createElement(i.Z, { isFullWidth: d, isLarge: c }, a)) : null));
                }
            }
        ...
        301758: (e, a, l) => {
            ...
            const p = (e, a) => a.tweetId,
                ...
                _ = (0, m.Z)()
                    ...
                    const { featureSwitches: f, viewerUserId: T } = t.useContext(c.rC),
                        F = (0, d.z)(),
                    ...
                    const w = t.useCallback(
                        ...
                        v = u && (0, o.D$)(u, T, e),
                        L = v && (0, o.rl)(v);
                    return t.createElement(i.ZP.Provider, { value: { isEditTweetConsumptionEnabled: () => f.isTrue("responsive_web_edit_tweet_enabled") || f.isTrue("subscriptions_feature_labs_1004") } }, t.createElement(r.Z, (0, n.Z)({}, b, { loggedInUserId: T, onAvatarClick: m, onMediaClick: g, onPress: w, onScreenNameClick: p, shouldShowAltLabelAlways: !0, socialContextProps: L, tweet: u, withBirdwatchPivot: K })));
                });
        },
        301410: (e, a, l) => {
            l.d(a, { i: () => k.ZP, z: () => b });
                        ...
                        return (
                            ...
                            r
                                ? n.createElement(
                                      ...
                                      n.createElement(y, { errorHandler: c(a.errorConfig.options || {}), key: r.fetchKey, retry: g }, (a, l) => (a ? t({ fetchStatus: k.ZP.FAILED, error: a, data: null, retry: l }) : n.createElement(_, { query: e, queryRef: r, render: t }))),
                                  )
                                : null
                        );
                    };
        ...
        858440: (e, a, l) => {
            ...
            var n = l(878052),
                t = l(202784);
            function i() {
                var e = (0, t.useState)(() => n.Z.get("window")),
                    a = e[0],
                    l = e[1];
                return (
                    (0, t.useEffect)(() => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ConversationWithRelay-e96e9bea.9989d35a.js.map
