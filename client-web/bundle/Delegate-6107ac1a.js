                        ...
                        selections: [
                            i,
                            {
                                ...
                                selections: [
                                                        ...
                                                        selections: [
                                                            (d = { alias: null, args: null, kind: "ScalarField", name: "__typename", storageKey: null }),
                                                            {
                                                                ...
                                                                selections: [
                                                                    ...
                                                                    (m = { alias: null, args: null, concreteType: "ApiUser", kind: "LinkedField", name: "legacy", plural: !1, selections: [{ alias: null, args: null, kind: "ScalarField", name: "id_str", storageKey: null }], storageKey: null }),
                                                                    ...
                                                                    (F = { alias: null, args: null, concreteType: "UserRelationshipPerspectives", kind: "LinkedField", name: "relationship_perspectives", plural: !1, selections: [{ alias: null, args: null, kind: "ScalarField", name: "followed_by", storageKey: null }], storageKey: null }),
                                                                    (K = {
                                                                        alias: null,
                                                                        args: null,
                                    ...
                                    u,
                                    { alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "handle_results", plural: !1, selections: [{ alias: null, args: null, concreteType: null, kind: "LinkedField", name: "result", plural: !1, selections: [d, { kind: "InlineFragment", selections: [u, c, g, p, m, y, k, F, K, _, r], type: "User", abstractKey: null }], storageKey: null }, r], storageKey: null },
                                    r,
                                ],
                                storageKey: null,
                            },
        ...
        779610: (e, l, n) => {
            ...
            const d = (e) => {
                    const { decoration: l, description: n, disabled: d = !1, isActive: g = !1, label: p, link: m, onPress: y, paddingHorizontal: k, renderRightContent: F, role: b = "tab", styleOverride: K, testID: _ = "pivot", thumbnail: h, thumbnailSize: f, withoutArrow: L = !1 } = e,
                        ...
                        C = n ? ("string" == typeof n ? a.createElement(t.ZP, { color: "gray700", size: "subtext2", testID: `${_}-description` }, n) : n) : null,
                        D = a.useMemo(() => ("space0" === k ? { paddingHorizontal: 0 } : { paddingHorizontal: k ? o.default.theme.spaces[k] : o.default.theme.componentDimensions.gutterHorizontal }), [k]);
                    return a.createElement(u.Z, { "aria-selected": "tab" === b ? g : null, disabled: d, link: d ? void 0 : m, onPress: y, role: b, style: [c.root, D, d && c.disabled, K], testID: _, withInteractiveStyling: !!m || !!y }, a.createElement(r.Z, { style: c.contentContainer }, h ? a.createElement(r.Z, { style: v }, h) : null, a.createElement(r.Z, { style: c.content }, T, C), F ? F() : null, (!m && !y) || d || L ? null : S ? a.createElement(s.default, { style: c.icon }) : a.createElement(i.default, { style: c.icon })), l);
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Delegate-6107ac1a.a5c418aa.js.map
