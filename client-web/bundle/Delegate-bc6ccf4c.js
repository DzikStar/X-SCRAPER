    ...
    ["bundle.Delegate-bc6ccf4c", "loader.AudioDock", "bundle.AudioSpaceReport", "loader.AudioContextVoiceMedia"],
    {
        ...
        779610: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                c = n(392237);
            const d = (e) => {
                    const { decoration: t, description: n, disabled: d = !1, isActive: p = !1, label: h, link: m, onPress: g, paddingHorizontal: f, renderRightContent: b, role: y = "tab", styleOverride: C, testID: E = "pivot", thumbnail: Z, thumbnailSize: v, withoutArrow: x = !1 } = e,
                    ...
                    return r.createElement(s.Z, { "aria-selected": "tab" === y ? p : null, disabled: d, link: d ? void 0 : m, onPress: g, role: y, style: [u.root, P, d && u.disabled, C], testID: E, withInteractiveStyling: !!m || !!g }, r.createElement(o.Z, { style: u.contentContainer }, Z ? r.createElement(o.Z, { style: k }, Z) : null, r.createElement(o.Z, { style: u.content }, w, S), b ? b() : null, (!m && !g) || d || x ? null : _ ? r.createElement(a.default, { style: u.icon }) : r.createElement(i.default, { style: u.icon })), t);
                },
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && h) return r.createElement(d.ZP, { animation: m || p.Bf, animationContainerStyle: v[t], animationStyle: _, onAnimationEnd: l, onAnimationStart: s, onError: c });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return r.createElement(a, { style: [v[t], !o && i && k.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Delegate-bc6ccf4c.1e28e29a.js.map
