    ...
    ["bundle.Delegate-bc6ccf4c", "loader.AudioDock", "bundle.AudioSpaceReport", "loader.AudioContextVoiceMedia"],
    {
        ...
        779610: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                c = n(392237);
            const d = (e) => {
                    const { decoration: t, description: n, disabled: d = !1, isActive: p = !1, label: h, link: m, onPress: g, paddingHorizontal: f, renderRightContent: b, role: y = "tab", styleOverride: C, testID: E = "pivot", thumbnail: v, thumbnailSize: Z, withoutArrow: x = !1 } = e,
                        k = [u.thumbnailContainer, "medium" === Z && u.thumbnailContainerMedium],
                        w = "string" == typeof h ? r.createElement(l.ZP, null, h) : h,
                        _ = "object" == typeof m && m.external && !m.openInSameFrame,
                        S = n ? ("string" == typeof n ? r.createElement(l.ZP, { color: "gray700", size: "subtext2", testID: `${E}-description` }, n) : n) : null,
                    ...
                    return r.createElement(s.Z, { "aria-selected": "tab" === y ? p : null, disabled: d, link: d ? void 0 : m, onPress: g, role: y, style: [u.root, P, d && u.disabled, C], testID: E, withInteractiveStyling: !!m || !!g }, r.createElement(o.Z, { style: u.contentContainer }, v ? r.createElement(o.Z, { style: k }, v) : null, r.createElement(o.Z, { style: u.content }, w, S), b ? b() : null, (!m && !g) || d || x ? null : _ ? r.createElement(a.default, { style: u.icon }) : r.createElement(i.default, { style: u.icon })), t);
                },
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return r.createElement(c.ZP.Consumer, null, ({ direction: s }) => r.createElement(i.ZP, { color: e ? n : a, dir: s, style: [k.inner, e && "blue500" === n && k.blue500] }, r.createElement(o.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), l, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: c, showBackgroundWhenActive: d } = this.props,
                                ...
                                h = d && i && !e?.isHovered;
                            return r.createElement(s.Z, { hoverLabel: o, interactiveStyles: p, interactivityState: e, style: [u.default.absoluteFill, x[h ? "haloBackground" : n], !c && k.iconBackground, "small" === a && k.iconSmallBoundingBox, h && k.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && h) return r.createElement(d.ZP, { animation: m || p.Bf, animationContainerStyle: Z[t], animationStyle: _, onAnimationEnd: l, onAnimationStart: s, onError: c });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return r.createElement(a, { style: [Z[t], !o && i && k.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            c
                                ...
                                : r.createElement(s.Z, { "aria-haspopup": g ? "menu" : void 0, "aria-label": e, disabled: l, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: p, link: h, onClick: this._handlePress, preventFocusShift: m, renderMenu: g, style: [k.triggerAreaRoot, k.outlineNone], testID: y }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Delegate-bc6ccf4c.75925f9a.js.map
