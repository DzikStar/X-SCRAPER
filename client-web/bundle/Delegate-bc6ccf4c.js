    ...
    ["bundle.Delegate-bc6ccf4c", "loader.AudioDock", "bundle.AudioSpaceReport", "loader.AudioContextVoiceMedia", "icons/IconExiting-js"],
    {
        242454: (e, t, r) => {
            ...
            const d = c.default.create((e) => ({ container: { backgroundColor: e.colors.cellBackground }, root: { justifyContent: "center", minHeight: e.spaces.space48, paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space16 } })),
                u = ({ align: e = "center", color: t, label: r, ...u }) => {
                    ...
                    return o.createElement(l.Z, { style: d.container }, o.createElement(i.Z, (0, a.Z)({}, u, { interactiveStyles: h, style: d.root }), o.createElement(n.ZP, { align: e, color: t }, r)));
                };
        },
        661810: (e, t, r) => {
            r.d(t, { Z: () => n });
        ...
        779610: (e, t, r) => {
            ...
            var a = r(202784),
                ...
                c = r(392237);
            const d = (e) => {
                    const { decoration: t, description: r, disabled: d = !1, isActive: h = !1, label: p, link: m, onPress: g, paddingHorizontal: b, renderRightContent: f, role: y = "tab", styleOverride: C, testID: v = "pivot", thumbnail: Z, thumbnailSize: E, withoutArrow: w = !1 } = e,
                        _ = [u.thumbnailContainer, "medium" === E && u.thumbnailContainerMedium],
                        k = "string" == typeof p ? a.createElement(s.ZP, null, p) : p,
                        x = "object" == typeof m && m.external && !m.openInSameFrame,
                        z = r ? ("string" == typeof r ? a.createElement(s.ZP, { color: "gray700", size: "subtext2", testID: `${v}-description` }, r) : r) : null,
                    ...
                    return a.createElement(i.Z, { "aria-selected": "tab" === y ? h : null, disabled: d, link: d ? void 0 : m, onPress: g, role: y, style: [u.root, R, d && u.disabled, C], testID: v, withInteractiveStyling: !!m || !!g }, a.createElement(o.Z, { style: u.contentContainer }, Z ? a.createElement(o.Z, { style: _ }, Z) : null, a.createElement(o.Z, { style: u.content }, k, z), f ? f() : null, (!m && !g) || d || w ? null : x ? a.createElement(l.default, { style: u.icon }) : a.createElement(n.default, { style: u.icon })), t);
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Delegate-bc6ccf4c.63177f0a.js.map
