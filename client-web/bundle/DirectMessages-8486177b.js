...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.DirectMessages-8486177b", "bundle.GrokDrawer-8486177b", "bundle.UserAvatar-8486177b", "shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-29ff9b73"],
    {
        389071: (e, t, s) => {
            ...
            function S({ conversationKey: e }) {
                ...
                return {
                    ...
                    selectCurrentResponseFollowUps: function (e) {
                        const s = t(e);
                        if (s.messageIds.length < 2) return y;
                    ...
                    selectLastAssistantMessage: function (e) {
                        const s = t(e),
                            n = (0, a.Z)(s.messageIds, (e) => s.messages[e].sender === l.CI.ASSISTANT);
                        if (n) return { id: n, message: s.messages[n] };
                    },
                    selectLastAssistantMessageWithImage: function (e) {
                        const s = t(e),
                            n = (0, a.Z)(s.messageIds, (e) => s.messages[e].sender === l.CI.ASSISTANT && void 0 !== s.messages[e].fileAttachments && s.messages[e].fileAttachments.length > 0 && s.messages[e].fileAttachments.some((e) => e.mimeType.startsWith("image")));
                        if (n) return { id: n, message: s.messages[n] };
                    },
                    selectLastHumanMessage: function (e) {
                        const s = t(e),
                            n = (0, a.Z)(s.messageIds, (e) => s.messages[e].sender === l.CI.HUMAN);
                        if (n) return { id: n, message: s.messages[n] };
                    },
                    selectLastHumanMessageWithImage: function (e) {
                        const s = t(e),
                            n = (0, a.Z)(s.messageIds, (e) => s.messages[e].sender === l.CI.HUMAN && void 0 !== s.messages[e].fileAttachments && s.messages[e].fileAttachments.length > 0 && s.messages[e].fileAttachments.some((e) => e.mimeType.startsWith("image")));
                        if (n) return { id: n, message: s.messages[n] };
                    },
                    ...
                    selectMetadataForLastMessage: function (e) {
                        ...
                        const n = s.messageIds.length,
                            r = s.messageIds[n - 1],
                            a = s.messages[r];
                        return a && a.agentChatItemId && a.userChatItemId ? { agentChatItemId: a.agentChatItemId, userChatItemId: a.userChatItemId, feedbackLabels: a.feedbackLabels } : void 0;
                    },
            ...
            function A(e = I(), t) {
                ...
                switch (t.type) {
                    ...
                    case m.OW: {
                        const s = (function (e) {
                                const t = (0, a.Z)(e.messageIds, (t) => e.messages[t].sender === l.CI.HUMAN);
                    ...
                    case m.my: {
                        ...
                        const n = e.messages[e.messageIds[s]].promptMetadata,
                            ...
                            a = {};
                        for (const t of r) a[t] = e.messages[t];
                        return { ...e, messageIds: r, messages: a, currentResponse: { ...g, promptMetadata: n }, currentQuery: void 0, status: m.Q_.WAITING };
                    }
                    case m.ru:
                    ...
                    case m.A0:
                        if (1 === t.payload) {
                            const t = e.experimentData.experiments[1],
                                ...
                                n = `${s.length}`,
                                r = _({ ...t, message: t?.message ?? "", sender: t?.sender ?? l.CI.ASSISTANT, promptSource: e.promptSource ?? "" }, e);
                    ...
                    case m.FV: {
                        const n = t.payload,
                            r = C(e.messageIds),
                            a = s(),
                            o = _({ message: e.currentResponse?.message ? `${e.currentResponse.message}...\n\n${n}` : n, sender: e.currentResponse?.sender ?? l.CI.ASSISTANT, localOnly: !0, allowRetry: !0 }, e);
                        return { ...e, messageIds: e.messageIds.concat(r), messages: { ...e.messages, ...a, [r]: o }, currentResponse: void 0, currentQuery: void 0, status: m.Q_.IDLE };
                    }
                    case m.Gy: {
                        const t = C(e.messageIds),
                            s = _({ ...e.currentResponse, message: e.currentResponse?.message ?? "", sender: e.currentResponse?.sender ?? l.CI.ASSISTANT, thinkingTrace: e.currentResponse?.thinkingTrace, promptSource: e.promptSource ?? "" }, e);
                    ...
                    case m.L0: {
                        ...
                        const a = e.messageIds.slice(0, n),
                            o = {};
                        for (const t of a) o[t] = e.messages[t];
                        const i = { ...r, message: t.payload.text, fileAttachments: t.payload.fileAttachments, bannerMessages: [] };
                        return { ...e, messageIds: [...a, s], messages: { ...o, [s]: i }, currentResponse: { ...g, promptMetadata: { promptSource: "NATURAL", action: "EDIT" } }, currentQuery: void 0, status: m.Q_.WAITING, editingMessageId: void 0 };
                    }
                    case m.cw:
            ...
            d.Z.register(
                {
                    [m.Yf]: function (e = h, t) {
                        ...
                        switch (t.type) {
                            case m.$t: {
                                const s = t.payload;
                                return { ...e, conversationList: -1 === e.conversationList.indexOf(s) ? [s, ...e.conversationList] : [...e.conversationList], conversations: { ...e.conversations, [s]: I() }, currentConversation: s };
                            }
                            case m.Yb:
                            ...
                            case m.lh.REQUEST: {
                                ...
                                n && r.push(n);
                                const a = { ...e.pinnedConversationsIdMap };
                                return (a[s] = !0), { ...e, conversationHistory: { ...e.conversationHistory, items: e.conversationHistory.items.map((e) => ({ ...e, is_pinned: e.grokConversation.rest_id === s || e.is_pinned })) }, pinnedConversations: { ...e.pinnedConversations, items: (0, i.Z)(r, (e) => e.grokConversation.id).sort((e, t) => (t.created_at_ms ?? 0) - (e.created_at_ms ?? 0)) }, pinnedConversationsIdMap: a };
                            }
                            case m.lh.FAILURE: {
                                const s = t.meta?.conversationId ?? "";
                            ...
                            default: {
                                ...
                                return s ? { ...e, conversations: { ...e.conversations, [s]: A(e.conversations[s], t) } } : e;
                            }
                        }
                    },
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.DirectMessages-8486177b.1d1cf47a.js.map
