    ...
    ["bundle.DirectMessages-9f4db315", "loader.MediaPickerWithPreview"],
    {
        ...
        6157: (e, t, o) => {
            ...
            function L({ apiClient: e }) {
                return {
                    clearConversations: (t, o) => e.graphQL(s(), {}).then((e) => (e.clear_grok_conversations?.grok_deletion_error?.error_code && (0, i.ZP)("GraphQL clear grok conversations failed."), e)),
                    ...
                    fetchPinnedConversations: ({ cursor: t }) => e.graphQL(w(), { cursor: t }).then((e) => e),
        ...
        573839: (e, t, o) => {
            "use strict";
            o.d(t, { K: () => n });
            const n = (e, t, o = !1, n = !1, r) => {
                const i = e.isTrue("dm_secret_conversations_enabled"),
                    a = e.isTrue("dm_secret_conversations_for_blue_verified_enabled"),
                    s = e.isTrue("dm_secret_conversations_for_graduated_access_enabled"),
                    l = e.isTrue("subscriptions_premium_tiers_encrypted_dms_gating_update_enabled") ? t.isAnyPremiumSubscriber() : o;
                return i || (a && (l || "Business" === r || "Government" === r)) || (s && n);
            };
        },
        927075: (e, t, o) => {
            "use strict";
            ...
            const l = a().f325afc4,
                d = a().cdcebd22,
                c = ({ testID: e }) => n.createElement(r.ZP, { "aria-label": l, hoverLabel: { label: d }, icon: n.createElement(s.default, null), link: "/messages/compose", pullRight: !0, testID: e, type: "primaryText" });
        },
        201787: (e, t, o) => {
            "use strict";
            o.d(t, { Z: () => d });
            var n = o(202784),
                ...
                s = o(711223);
            const l = a().h810143c,
                d = ({ "aria-label": e, conversationId: t, link: o, style: i }) => {
                    const a = n.createElement(s.default, null);
                    return n.createElement(r.ZP, { "aria-label": e || l, hoverLabel: { label: l }, icon: a, key: t, link: o, pullRight: !0, style: i, type: "primaryText" });
                };
        },
        625661: (e, t, o) => {
            "use strict";
            ...
            class h extends n.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: r, hideBackButton: i, isFullWidth: a, isLarge: d, leftControl: c, middleControl: h, position: u, rightControl: _, secondaryBar: m, style: b, subtitle: g, title: y, titleDomId: f, titleIconCell: C, titleIconCellSize: w, withBackground: v, withWideContainer: k } = this.props,
                        { isModal: x } = this.context,
                        Z = i ? c : n.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        B = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!v, x, !!m);
                    return n.createElement(n.Fragment, null, n.createElement(l.Z, { centerTitle: t, centeredLogo: o, isFullWidth: a, isLarge: d, leftControl: Z, middleControl: h, position: p(u, x, r), rightControl: _, style: b, subtitle: g, title: y, titleDomId: f, titleIconCell: C, titleIconCellSize: w, withBackground: B, withWideContainer: k }), m || null);
                }
                render() {
        ...
        947135: (e, t, o) => {
            ...
            class a extends n.Component {
                ...
                render() {
                    const { align: e, color: t, confirmationSheetConfirmButtonLabel: o, confirmationSheetConfirmButtonType: a, confirmationSheetHeadline: s, confirmationSheetText: l, label: d } = this.props;
                    return n.createElement(n.Fragment, null, n.createElement(r.Z, { align: e, color: t, label: d, onPress: this._handleClick }), this.state.showConfirmation ? n.createElement(i.Z, { confirmButtonLabel: o, confirmButtonType: a, headline: s, onCancel: this._handleCancel, onConfirm: this._handleConfirm, text: l }) : null);
                }
            }
        ...
        850496: (e, t, o) => {
            ...
            const y = p().b87ca51a,
                f = p().eebff22c,
                C = n.createElement(h.default, null);
            class w extends n.Component {
                render() {
                    const { borderRadius: e, description: t, innerStyle: o, maskStyle: s, mediaItem: l, onAddMediaFiles: d, onCrop: c, onRemove: p, rootStyle: h, withDragDrop: u } = this.props,
                        _ = l && !l.uploader,
                        m = n.createElement(n.Fragment, null, this._renderPreview(), _ ? null : n.createElement(n.Fragment, null, n.createElement(r.Z, { style: [k.mask, s, v[e]] }), n.createElement(r.Z, { style: [k.overlaidContent, o] }, n.createElement(r.Z, { style: k.buttonsContainer }, this._renderMediaEdit(), c ? this._renderMediaCrop() : null, p ? this._renderMediaRemove() : null), t ? n.createElement(i.ZP, { align: "center", color: "gray700", size: "subtext1", style: k.description }, t) : null)));
                    return n.createElement(r.Z, { style: [k.container, h, v[e]] }, u && d ? n.createElement(a.ZP, { onFilesAdded: d, style: [k.dragDropContainer, v[e]] }, m) : m);
                }
                _renderMediaRemove() {
                ...
                _renderMediaEdit() {
                    ...
                    return a ? n.createElement(m.Z, { acceptGifs: e, acceptVideo: t, "aria-label": o, icon: r, multiple: i, onChange: a, size: "large", style: k.mediaPicker, type: "onMediaDominantColorFilled" }) : n.createElement(s.ZP, { "aria-label": o, icon: r, onPress: l, size: "large", type: "onMediaDominantColorFilled" });
                }
                _renderPreview() {
                    const { aspectRatio: e, borderRadius: t, currentContent: o, mediaItem: r } = this.props;
                    return r ? n.createElement(l.Z, { ratio: e }, n.createElement(b.Z, { borderRadius: t, enableGif: !1, mediaItem: r, style: k.mediaPreview, withCloseButton: !1 })) : o;
                }
            }
            w.defaultProps = { acceptGifs: !1, acceptVideo: !1, aspectRatio: 1, borderRadius: g.A.NONE, icon: C };
            const v = d.default.create((e) => ({ infinite: { borderRadius: e.borderRadii.infinite }, medium: { borderRadius: e.borderRadii.small }, none: { borderRadius: e.borderRadii.none } })),
                k = d.default.create((e) => ({ mediaPreview: { height: "100%" }, overlaidContent: { alignItems: "center", height: "100%", justifyContent: "center", opacity: 0.75, position: "absolute", top: 0, width: "100%" }, buttonsContainer: { alignItems: "center", flexDirection: "row", justifyContent: "center" }, buttonLeftPadding: { marginStart: e.spaces.space20 }, mask: { backgroundColor: e.colors.translucentBlack30, height: "100%", position: "absolute", top: 0, width: "100%" }, container: { justifyContent: "center", overflow: "hidden" }, dragDropContainer: { borderWidth: e.borderWidths.medium, borderColor: e.colors.transparent, borderStyle: "solid" }, mediaPicker: { margin: 0 }, description: { marginTop: e.spaces.space16 } }));
        },
        980407: (e, t, o) => {
            "use strict";
            o.d(t, { Z: () => m, w: () => u });
            ...
            class u extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: o, backLocation: i, centerTitle: a, hideBackButton: s, history: l, isFullWidth: p, isLarge: h, middleControl: u, onBackClick: m, rightControl: b, secondaryBar: g, subtitle: y, title: f } = this.props,
                                { isModal: C } = this.context;
                            return n.createElement(r.Z, { style: C ? [_.childViewAppBarRoot, _.appBarZindex] : _.appBarZindex }, n.createElement(c.ZP, { backButtonType: o || (C ? "close" : "back"), backLocation: i, centerTitle: a, fixed: !C, hideBackButton: s, history: l, isFullWidth: p, isLarge: h, middleControl: u, onBackClick: m, ref: e, rightControl: b, secondaryBar: g, style: [C && _.appBarModal, t], subtitle: y, title: f, titleDomId: d.Q_ }));
                        }),
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: o, containerStyle: a, documentTitle: s, isFullWidth: d, isLarge: c, renderHeader: u, title: m, withoutBottomBarMobile: b } = this.props,
                        { isModal: g } = this.context,
                        y = u ? u(this._renderChildViewAppBar()) : this._renderChildViewAppBar();
                    return n.createElement(l.Z, null, n.createElement(p.Z.Configure, { documentTitle: s, headerless: !0, title: m }), n.createElement(r.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [_.root, g && _.rootModal] }, !g && y, n.createElement(i.Z, { isFullWidth: d, isLarge: c, style: [_.container, g && _.containerModal, a] }, g ? n.createElement(h.Z, { style: _.viewport }, y, o) : o), t ? n.createElement(r.Z, { style: [_.bottomBarModal, !g && !b && _.bottomBarMobile] }, n.createElement(i.Z, { isFullWidth: d, isLarge: c }, t)) : null));
                }
            }
        ...
        300234: (e, t, o) => {
            ...
            class v extends n.Component {
                ...
                render() {
                    const { children: e, onDismiss: t, onLayout: o, style: i } = this.props,
                        a = !!t;
                    return n.createElement(r.Z, { onLayout: o, onTouchEnd: a ? this._handleTouchEnd : void 0, onTouchMove: a ? this._handleTouchMove : void 0, onTouchStart: a ? this._handleTouchStart : void 0, style: i, testID: "swipe-to-dismiss" }, e);
                }
            }
            const k = v;
            var x = o(992942),
            ...
            class P extends n.PureComponent {
                ...
                componentDidUpdate(e, t) {
                    (0, d.Z)(e.photo, this.props.photo) || (this.setState({ loadingVariant: null }), P._selectCachedVariant(this.props.photo).then((e) => this.setState({ loadingVariant: e })));
                }
                render() {
                    const { dataSaver: e, imageStyle: t, onError: o, onLoad: i, onTap: a, onZoomed: s, photo: l, resetZoom: d, style: c, zoomable: p } = this.props,
                        { loadingVariant: h } = this.state,
                        u = (e && h && Math.max(h.width, h.height) >= 680 ? h.uri : null) || P._selectSource(l);
                    if (!u || null === h) return null;
                    const _ = n.createElement(x.Z, { "aria-label": l.ext_alt_text ? l.ext_alt_text : E, defaultSource: h && h.uri, draggable: !0, onError: h ? void 0 : o, onLoad: i, onLoadEnd: this._handleLoadEnd, onLoadStart: this._handleLoadStart, resizeMode: "contain", source: u, style: [L.img, t] });
                    return n.createElement(r.Z, { style: c }, this.state.imageLoading ? D : null, p ? n.createElement(Z.Z, { onTap: a, onZoomed: s, resetZoom: d }, _) : _);
                }
                static _selectCachedVariant(e) {
                    const t = B.Z.getOriginalImage(e);
            ...
            const L = l.default.create((e) => ({ img: { ...l.default.absoluteFillObject, height: "auto", margin: "auto", maxHeight: "100%", maxWidth: "100%", width: "auto" }, progressBar: { position: "absolute", top: 0, zIndex: 1 } })),
                D = n.createElement(S.Z, { ariaValueText: T, indeterminate: !0, style: L.progressBar }),
                M = P;
            var R = o(78067);
            class F extends n.PureComponent {
                ...
                render() {
                    ...
                    return n.createElement(r.Z, { style: e }, n.createElement(r.Z, { style: A.root }, this._renderVideo()));
                }
                ...
                _renderVideo() {
                    const { isVerticalVideoNoBlackBars: e, promotedContent: t, video: o, videoId: r } = this.props;
            ...
            const A = l.default.create({ root: { flexBasis: 0, flexGrow: 1, flexShrink: 1, justifyContent: "center" } }),
                ...
                W = (e) => {
                    const { businessAvatar: t = !1, isAvatar: o, isCurrentlyDisplayed: a, mediaDetail: s, onDismiss: l, onTap: d, promotedContent: c, videoId: p, ...h } = e,
                        ...
                        { height: B, width: I } = y,
                        S = (0, f.hC)("rweb_video_vertical_aspect_ratio_enabled"),
                        E = S || v || o ? (0, C.I5)({ mediaWidth: Z, mediaHeight: x, containerWidth: I, containerHeight: B }, o) : q.mediaItem;
                            ...
                            onLayout:
                                S || v || o
                                    ? (e) => {
                                          ...
                                          (o === y.width && t === y.height) || w({ width: o, height: t });
                                      }
                                    : void 0,
                            style: q.root,
                        },
                            ...
                            : n.createElement(
                                  ...
                                  "photo" === s.type
                                      ? n.createElement(
                                            M,
                                            (0, _.Z)({}, h, {
                                                imageStyle: o && !t && q.avatarImage,
                                                onError: (e) => {
                                                    g(e.nativeEvent.error);
                                                },
                                                onLoad: () => {
                                                    g(null);
                                                },
                                      ...
                                      : i.Z.isVideo(s) && p
                                        ? n.createElement(G, { isCurrentlyDisplayed: a, isVerticalVideoNoBlackBars: S, promotedContent: c, style: q.container, video: s, videoId: p })
                                        : null,
                              ),
                    );
                },
                q = l.default.create((e) => ({ root: { flexGrow: 1, justifyContent: "center", alignItems: "center", flexShrink: 1 }, mediaItem: { flexGrow: 1, width: "100%", height: "100%" }, container: { height: "100%", position: "absolute", width: "100%" }, errorDetail: { alignItems: "center", alignSelf: "center", justifyContent: "center", position: "absolute", height: "100%", maxWidth: 400 }, avatarImage: { borderRadius: e.borderRadii.infinite, margin: e.spaces.space16 } })),
                z = n.memo(W, (e, t) => (0, d.Z)(e, t));
                    ...
                    const { businessAvatar: e, dataSaver: t, mediaIndex: o, mediaItems: a, onDismiss: s, onTap: l, promotedContent: d } = this.props,
                        ...
                        p = a.map((r, p) => {
                            const h = i.Z.isVideo(r),
                                ...
                                _ = o === p;
                            return h && !u ? null : n.createElement(z, { businessAvatar: e, dataSaver: t, isAvatar: this.props.isAvatar, isCurrentlyDisplayed: _, key: p, mediaDetail: a[p], onDismiss: c ? void 0 : s, onTap: l, onZoomed: _ ? this._handleMediaDetailZoomed : void 0, promotedContent: d, resetZoom: o !== p, videoId: u });
                        });
            ...
            (N.contextType = h.rC), (N.defaultProps = { mediaIndex: 0, onMediaDetailZoomed: c.Z, onMediaItemChanged: c.Z });
        ...
        827094: (e, t, o) => {
            ...
            class y extends n.Component {
                ...
                render() {
                    const { backgroundColor: e, children: t, footerButtons: o, forceDominantButtonColor: l, forceModalStyle: d, hideButtons: c, mediaItem: p, mediaUrl: m, overlayFooter: y, topRightButton: w } = this.props,
                    ...
                    return n.createElement(
                        ...
                        n.createElement(a.Z, { interactiveStyles: null, onClick: this._handleCloseButtonPress, pointerEvents: c ? "none" : void 0, role: "none", style: [f.buttonWrapper, f.buttonWrapperLeft, _.nk, c && f.fadeOut] }, (t) => n.createElement(s.ZP, { "aria-label": b, dominantColor: e.rgb, hoverLabel: { label: b }, icon: n.createElement(h.default, null), interactivityState: t, onClick: this._handleCloseButtonPress, type: p || m || l ? "onMediaDominantColorFilled" : "onMediaWhiteFilled" })),
                        w ? n.createElement(r.Z, { pointerEvents: c ? "none" : void 0, style: [f.buttonWrapper, f.buttonWrapperRight, _.nk, c && f.fadeOut] }, w) : null,
                        I
                            ? n.createElement(
                                  r.Z,
        ...
        253493: (e, t, o) => {
            ...
            var n = o(202784),
                ...
                m = o(715601),
                b = o(392237);
            const g = b.default.create((e) => ({ fill: { flex: 1, alignSelf: "stretch" }, viewportView: { ...b.default.absoluteFillObject, overflowY: "auto" }, appBarContainer: { position: "sticky", top: 0, backfaceVisibility: "hidden", zIndex: e.componentZIndices.appBarZIndex } }));
            class y extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildren = () => {
                            const { children: e } = this.props;
                            return this.context.rootDetailPerColumnScroll ? n.createElement(a.Z, { style: g.fill }, n.createElement(m.Z, { style: g.viewportView }, this._renderInlineNav({ isTwoColumnLayout: !0 }), e)) : e;
                        });
                }
                render() {
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: o, appBarStyle: r, backLocation: i, documentTitle: s, headerless: l, history: d, leftControl: p, middleControl: _, onBackClick: m, rightControl: b, screenType: y, searchBoxOptions: f, secondaryBar: C, showSubtitleOnRoot: w, showSubtitleOnWideDetail: v, subtitle: k, title: x, titleIconCell: Z, titleIconCellSize: B, withDetailOpen: I, withSearchBox: S, withTweetButton: E, withWideContainer: T } = this.props,
                        P = "root" === y,
                        L = "secondaryRoot" === y,
                        D = "primaryDetail" === y,
                        M = (D && v) || (P && w),
                        R = P || (D && e),
                        F = P ? c.ey : D ? c.vX : void 0,
                        A = n.createElement(a.Z, { style: g.appBarContainer }, n.createElement(h.ZP, { backLocation: i, fixed: !1, hideBackButton: R, history: d, leftControl: p, middleControl: _, onBackClick: m, rightControl: b, secondaryBar: C, style: r, subtitle: M ? k : void 0, title: x, titleDomId: F, titleIconCell: Z, titleIconCellSize: B, withWideContainer: T })),
                        G = P || (L && I) ? null : n.createElement(u.Z.Configure, { SideNavButton: t, TabBar: o, backLocation: i, documentTitle: s, headerless: l, middleControl: _, onBackClick: m, rightControl: b, searchBoxOptions: f, subtitle: k, title: x, withSearchBox: S, withTweetButton: E });
                    return n.createElement(n.Fragment, null, G, A);
                }
            }
        ...
        470015: (e, t, o) => {
            ...
            var n = o(807896),
                ...
                d = o(64899);
            const c = function (e) {
                const { bodyRichText: t, bodyText: o, onImpression: c, primaryAction: p, shouldRenderBorder: h = !1, titleRichText: u, titleText: _, ...m } = e,
                    b = (0, s.Z)(),
                    g = () => {
                        b.scribe({ action: "click" });
                    },
                    y = u ? r.createElement(a.Z, { entities: u.entities, onEntityClick: g, text: u.text }) : _ && _.length ? _ : null,
                    f = t ? r.createElement(a.Z, { entities: t.entities, onEntityClick: g, text: t.text }) : o && o.length ? o : null,
                    C = (e) => ({
                        ...p,
                        onClick: (t) => {
                    ...
                    w = r.createElement(d.H.Consumer, null, ({ handleNextSlide: e }) => r.createElement(i.Z, (0, n.Z)({}, m, { headline: y, primaryAction: p ? C(e) : void 0, shouldRenderBorder: h, subtext: f })));
                return "function" == typeof c ? r.createElement(l.Z, { onImpression: c }, w) : w;
            };
        },
        64899: (e, t, o) => {
            "use strict";
            ...
            var n = o(202784),
                r = o(516951);
            const i = n.createContext({ handleNextSlide: r.Z });
        },
        199127: (e, t, o) => {
            "use strict";
            o.r(t), o.d(t, { MediaPickerWithPreview: () => d, default: () => c });
            var n = o(202784),
                r = o(850496),
                i = o(373554),
                a = o(668214),
                s = o(497294);
            const l = (0, a.Z)().propsFromActions(() => ({ addMedia: s.rA, processMultipleMedia: s.G$ }));
            class d extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._handleAddMediaFiles = (e) => {
                            const { addMedia: t, location: o, onChange: n, onFailure: r, processMultipleMedia: i } = this.props,
                                a = this._getAcceptedFileInputs(),
                                s = Array.from(e).find((e) => a.includes(e.type));
                            s &&
                                t([s], { location: o }).then((e) => {
                                    n && n(e.map((e) => e.id)), i(e, { onFailure: r });
                                });
                        }),
                ...
                render() {
                    const { acceptGifs: e, acceptVideo: t, "aria-label": o, aspectRatio: i, borderRadius: a, currentContent: s, description: l, innerStyle: d, maskStyle: c, mediaItem: p, onCrop: h, onRemove: u, rootStyle: _ } = this.props;
                    return n.createElement(r.Z, { acceptGifs: e, acceptVideo: t, "aria-label": o, aspectRatio: i, borderRadius: a, currentContent: s, description: l, innerStyle: d, maskStyle: c, mediaItem: p, onAddMediaFiles: this._handleAddMediaFiles, onCrop: h, onRemove: u, rootStyle: _, withDragDrop: !0 });
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.DirectMessages-9f4db315.1267580a.js.map
