    ...
    ["bundle.DirectMessages-bfd49e49", "bundle.UserAvatar-2291c9da"],
    {
        ...
        250781: (e, t, s) => {
            ...
            const l = (e) => {
                ...
                E = async ({ analytics: e, api: t, dispatch: s, eventTag: E, flags: S, grokModule: m, method: _ = "POST", requestBody: p, requestParams: R }) => {
                    const h = E ? ` (${E})` : "",
                        T = (function () {
                    ...
                    const P = new a.Fk(p.deepsearchArgs);
                    let M = [],
                        y = [],
                        G = "",
                        F = !1,
                    ...
                    const L = async ({ method: r, requestParams: o }) => {
                            ...
                            t.fetchClient
                                .dispatch(l, { method: r, credentials: "include", params: "GET" === r ? o : null, body: "POST" === r ? JSON.stringify(p) : null, signal: C?.signal, keepalive: S?.enableKeepalive }, S?.enableGrokApiHost ? "https://grok.x.com" : void 0)
                                .then(async (t) => {
                        ...
                        H = async (t) => {
                            C.abort(), D++, (v = !0), (0, n.mm)(e, D, t), (C = new AbortController()), await s(m.setAbortController(C)), L({ method: "GET", requestParams: { ...R, conversationId: u(), responseToChatItemId: G, streamInitialChunkWhole: !1 } });
                        };
            ...
            const E =
                ...
                async (T, N, { api: U, featureSwitches: P }) => {
                    ...
                    const F = r.ZP.isAndroid(),
                        D = r.ZP.isIOS();
                    if ((null != y.selectCurrentResponseMessage(N()) && (await T((0, c.I)({ analytics: e, conversationKey: t }))), (G ??= await (0, l.X)({ analytics: e, api: U, dispatch: T, grokModule: y, analysisEntityId: s })), !G)) return void (0, o.Uk)(e, "conversation couln't be found or created");
                    let v;
                    ...
                    const j = { message: R ?? "", sender: i.CI.HUMAN, promptSource: O ?? "", ...(s ? { postIds: [s] } : void 0) };
                    E && (j.fileAttachments = E), w && (j.isDeepsearch = w), b && (j.isReasoning = b);
                    const Y = { responses: Q.concat(j), systemPromptName: K, grokModelOptionId: H, conversationId: G, returnSearchResults: _, returnCitations: S, promptMetadata: m, imageGenerationCount: I, requestFeatures: p, ...(s ? { analysisEntityId: s } : void 0), geoLocation: v, enableSideBySide: !("GROK_ANALYZE" === m.promptSource || h || D || F || w || b), toolOverrides: V, isDeepsearch: w, isReasoning: b, personalityId: k, deepsearchArgs: A ?? (w ? x?.deepsearchArgs : void 0) };
                    T(y.setPromptSource(O || "")), T(y.setUsingExperiment(!1)), T(y.userSendMessage(j, m)), (0, o.pv)(e, { conversationLength: Q.length, isFileAttached: Boolean(j.fileAttachments?.length), isDeepsearch: Y.isDeepsearch || void 0, isReasoning: Y.isReasoning || void 0 }), g?.();
                    const W = P.isTrue("responsive_web_grok_enable_add_response_keepalive") && (w || b),
                        B = P.getNumberValue("responsive_web_grok_add_response_num_retries", 0);
                    return (0, d.D)({ grokModule: y, requestBody: Y, dispatch: T, analytics: e, api: U, flags: { enableLocation: L, enableGrokApiHost: M, numRetries: B, enableKeepalive: W } });
                };
        },
        63538: (e, t, s) => {
            s.d(t, { O: () => n });
        ...
        189953: (e, t, s) => {
            s.d(t, { $t: () => ne, A0: () => me, BA: () => se, BS: () => P, CH: () => y, CR: () => Z, Cr: () => O, DX: () => B, Dh: () => p, Dn: () => M, En: () => d, FF: () => Q, FV: () => N, Gy: () => k, HF: () => S, IK: () => a, JO: () => Y, Jt: () => re, KH: () => I, L0: () => $, Lc: () => n, OW: () => U, Oj: () => f, P9: () => j, Q_: () => o, Qg: () => v, Qh: () => X, Sv: () => i, TY: () => D, Tv: () => q, UN: () => w, VK: () => c, WK: () => te, Ws: () => l, Xg: () => z, Xi: () => L, Y8: () => E, Yb: () => h, Yf: () => r, Yx: () => u, ZN: () => W, _i: () => ce, ar: () => x, cA: () => Se, cw: () => oe, dK: () => g, dO: () => R, dZ: () => F, dw: () => ue, f1: () => Ee, j$: () => _e, k$: () => H, lQ: () => ee, lh: () => m, lm: () => _, mq: () => pe, my: () => b, nK: () => A, o$: () => G, px: () => ie, qd: () => V, ru: () => ge, ub: () => C, vc: () => K, vi: () => T, wG: () => ae, x5: () => J, yB: () => le, z2: () => de });
            const r = "grok",
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.DirectMessages-bfd49e49.a502706a.js.map
