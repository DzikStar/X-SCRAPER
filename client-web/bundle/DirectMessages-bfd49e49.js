...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.DirectMessages-bfd49e49", "bundle.UserAvatar-2291c9da", "shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2b309ab6"],
    {
        507990: (e, t, s) => {
            s.d(t, { Y: () => r });
            ...
            const g = [],
                ...
                p = ({ analytics: e, api: t, dispatch: s, eventTag: p, flags: E, grokModule: h, method: S = "POST", requestBody: R, requestParams: _ }) => {
                    ...
                    let M = !1,
                        N = !1;
                    const P = new d.EG();
                    P.setRequestedCount(R.imageGenerationCount || 0);
                    const D = R.responses[R.responses.length - 1];
                    if (D && D.fileAttachments && D.fileAttachments.length) {
                        const e = D.fileAttachments.find((e) => e.url && e.mimeType.startsWith("image"));
                        e &&
                            (e.dimensions
                                                    ...
                                                    try {
                                                        if (O || "GET" !== S) {
                                                            ...
                                                            if (("error" === t.result?.responseType && s(h.grokResponseFileAttachments([])), t.result?.imageAttachmentCount)) {
                                                                ...
                                                                R.imageGenerationCount && (e = Math.min(e, R.imageGenerationCount)), P.setCount(e);
                                                            }
                                                            if ((t.result?.imageWidth && t.result?.imageHeight && s(h.setExpectedImageAspectRatio(t.result?.imageWidth / t.result?.imageHeight)), "image" === t.result?.responseType || t.result?.imageAttachment?.imageUrl)) {
                                                                ...
                                                                P.addAttachment({ fileName: e?.fileName ?? "image", mimeType: e?.mimeType ?? "image/jpeg", mediaId: e?.mediaIdStr, url: e?.imageUrl }), s(h.grokResponseFileAttachments(P.generateAttachmentList()));
                                                            }
                                                            ...
                                                            if ((o && (o.imageAttachmentUpdate && s(h.imageIntermediateResult({ ...o.imageAttachmentUpdate, progress: o.imageAttachmentUpdate.progress / 100, imageUrl: o.imageAttachmentUpdate.imageUrl })), o.imageAttachmentRemoval && (P.setAttachmentAsModerated(o.imageAttachmentRemoval.imageIdStr), s(h.grokResponseFileAttachments(P.generateAttachmentList())))), E?.enableLocation && t.result?.doLocationRequest && !R.geoLocation && s(h.grokResponseCardAttachment({ cardType: "geo_location_request" })), t.result?.cardAttachment)) {
        ...
        155281: (e, t, s) => {
            ...
            const g = async ({ analytics: e, api: t, dispatch: s, eventTag: g, flags: E, grokModule: h, method: S = "POST", requestBody: R, requestParams: _ }) => {
                ...
                const P = new a.Fk(R.deepsearchArgs);
                let D = [],
                    y = [],
                    F = "",
                    G = !1,
                        ...
                        t.fetchClient
                            ...
                            .then(async (t) => {
                                ...
                                if ((n && s(h.updatePerformanceMetrics({ traceId: n })), !t.ok)) {
                                    ...
                                    return s(h.grokResponseError(a)), p({ deepSearchSummaryAccumulator: P, analytics: e, dispatch: s, errorMessage: a, grokModule: h, resumabilityQueue: b, method: r }), void (0, o.Uk)(e, `add-response failed with status ${t.status}${T}`);
                                }
                                const l = t.body?.getReader();
                                if (!l) return p({ deepSearchSummaryAccumulator: P, analytics: e, dispatch: s, grokModule: h, resumabilityQueue: b, method: r, errorMessage: `reader was not found${T}` }), s(h.grokResponseError(c.NE)), void (0, o.Uk)(e, `reader was not found${T}`);
                                    ...
                                    (async function t({ done: n, value: m }) {
                                        if (n) {
                                            ...
                                            if ((!C.length || C.every((e) => "" === e)) && !G) {
                                                ...
                                                return p({ deepSearchSummaryAccumulator: P, analytics: e, dispatch: s, errorMessage: t, grokModule: h, resumabilityQueue: b, method: r }), s(h.grokResponseError(c.NE)), (0, o.Uk)(e, t), void f.record("network-error");
                                            }
                                            f.record("time-to-last-chunk"),
                                                ...
                                                })({ deepSearchSummaryAccumulator: P, analytics: e, dispatch: s, grokModule: h, method: r, resumabilityQueue: b });
                                        }
                                        if (m) {
                                                ...
                                                for (const n of t)
                                                    if (w || "GET" !== r) {
                                                        ...
                                                        if (t.result?.postIds) s(h.grokResponsePosts(t.result.postIds, o));
                                                            ...
                                                            "thinkingTrace" === i && U && (U = !1), "message" === i && O[0].length > 0 && !U && ((U = !0), "GET" === r ? b.resumingDispatch(() => s(h.updatePerformanceMetrics({ thinkingTraceEnd: Date.now() }))) : s(h.updatePerformanceMetrics({ thinkingTraceEnd: Date.now() }))), "GET" === r ? b.resumingDispatch(() => s(h.grokResponseTyping(n, i, o))) : s(h.grokResponseTyping(n, i, o)), (t.result?.messageTag === a.iS.FINAL || (t.result?.message && "STARTED" === P.state)) && (P.updateFinalAnswer({ messageTag: a.iS.FINAL, message: t.result?.message || "" }), P.complete(), "GET" === r ? (b.resumingDispatch(() => s(h.updatePerformanceMetrics({ thinkingTraceEnd: Date.now() }))), b.resumingDispatch(() => s(h.grokResponseDeepSearchUpdate(P)))) : (s(h.updatePerformanceMetrics({ thinkingTraceEnd: Date.now() })), s(h.grokResponseDeepSearchUpdate(P))));
                                                        }
                                                        if (("error" === t.result?.responseType && s(h.grokResponseFileAttachments([])), t.result?.imageAttachmentCount)) {
                                                            let e = t.result.imageAttachmentCount;
                                                        ...
                                                        t.result?.feedbackLabels && s(h.grokResponseFeedbackLabels(t.result.feedbackLabels)), t.result?.disclaimer && s(h.grokResponseDisclaimer(t.result.disclaimer)), t.result?.followUpSuggestions && s(h.grokResponseFollowUpSuggestions(t.result.followUpSuggestions)), t.result?.followUpSuggestedMode && s(h.grokResponseFollowUpSuggestedMode(t.result?.followUpSuggestedMode)), t.result?.chatResponseAnnotations && s(h.grokResponseChatResponseAnnotations(t.result.chatResponseAnnotations)), t.result?.upsell && s(h.grokResponseUpsell(t.result.upsell)), (t.agentChatItemId || t.userChatItemId) && (t.agentChatItemId && (F = t.agentChatItemId), s(h.updatePerformanceMetrics({ startStreamTime: Date.now() })), s(h.grokResponseMetadata({ agentChatItemId: t.agentChatItemId, userChatItemId: t.userChatItemId }))), t.result?.webResults && (D.push(...(t.result?.webResults || [])), (D = D.filter((e, t, s) => t === s.findIndex((t) => t.url === e.url))), s(h.grokWebResults(D, o))), t.result?.citedWebResults && s(h.grokCitedWebResults(t.result.citedWebResults, o));
                                                        ...
                                                        if ((t.result?.memoryReferences && s(h.grokResponseMemoryReferences(t.result.memoryReferences)), t.result?.messageTag && (t.result?.message || t.result?.messageStepId))) {
                                                            const e = t.result?.messageTag;
                                                            e !== a.iS.FINAL && e !== a.iS.FINAL_LONG && (P.updateStepsFromRawMessage({ message: t.result?.message || "", messageTag: e, messageStepId: t.result?.messageStepId || -1, webResults: t.result?.webResults || [], xPostIds: t.result?.xPostIds || [] }), "GET" === r ? b.resumingDispatch(() => s(h.grokResponseDeepSearchUpdate(P))) : s(h.grokResponseDeepSearchUpdate(P)));
                                                        }
                                                    } else {
                                                        ...
                                                        if (e.deepsearchHeaders && e?.deepsearchHeaders.length > 0) {
                                                            ...
                                                            for (const t of e.deepsearchHeaders) {
                                                                ...
                                                                for (const r of t.steps) {
                                                                    const t = (r.xPostIds || []).map((e) => e),
                                                                        a = (r.webResults || []).map((e) => ({ url: e.url, favicon: e.favicon, favicon_base64: e.favicon_base64, language: e.language, snippet: e.snippet, title: e.title }));
                                                                    t.length && (y.push(...t), (y = y.filter((e, t, s) => t === s.findIndex((t) => t === e))), s(i.Z.fetchMultiple(t))), a.length && (D.push(...a), (D = D.filter((e, t, s) => t === s.findIndex((t) => t.url === e.url)))), e.push({ header: r.header || "", assistant: r.assistant || "", decision: r.decision || "", finalMessage: r.finalMessage || "", functionCall: r.functionCall || "", rawFunctionResult: r.rawFunctionResult || "", summary: r.summary || "", webResults: a, xPostIds: t });
                                                                }
                                                                r.push({ header: t.header || "", steps: e });
                                                            }
                                                            t.initiateFromHistoryResponses(r, !0), s(h.grokResponseDeepSearchUpdate(t));
                            ...
                            .catch(async (t) => {
                                L = !1;
                                if (t instanceof window.DOMException && "AbortError" === t.name) "STARTED" === P.state && (0, o.YI)(e, { durationMs: P.getStreamDuration(), messageTagCounts: P.debugMessageTagCount }), b.abortQueue(), f.record("abort");
                                else {
                                    if (H()) return void (await x(t.message));
                                    p({ deepSearchSummaryAccumulator: P, analytics: e, dispatch: s, grokModule: h, resumabilityQueue: b, method: r, errorMessage: t ? t.message : void 0 }), s(h.grokResponseError(c.NE)), (0, o.kl)(e, t), f.record("error");
                                }
            ...
            const g =
                ...
                async (f, O, { api: U, featureSwitches: M }) => {
                    const N = !r.ZP.isTwitterApp() && M.isTrue("responsive_web_grok_api_enable_grok_host"),
                        P = (0, a.bD)(t);
                    let D = P.selectConversationId(O());
                    const y = r.ZP.isAndroid(),
                        F = r.ZP.isIOS();
                    if ((null != P.selectCurrentResponseMessage(O()) && (await f((0, c.I)({ analytics: e, conversationKey: t }))), (D ??= await (0, u.X)({ analytics: e, api: U, dispatch: f, grokModule: P, analysisEntityId: s })), !D)) return void (0, n.Uk)(e, "conversation couln't be found or created");
                    let G;
                    ...
                    const L = m ?? P.selectMode(O()),
                        K = (0, a.F9)(O()),
                        H = P.selectConversationForAPI(O()),
                        x = (0, a.en)(O()),
                        Q = { ...A };
                    ...
                    const q = { responses: H.concat(j), systemPromptName: L, grokModelOptionId: K, conversationId: D, returnSearchResults: S, returnCitations: E, promptMetadata: h, imageGenerationCount: I, requestFeatures: R, ...(s ? { analysisEntityId: s } : void 0), geoLocation: G, enableSideBySide: !("GROK_ANALYZE" === h.promptSource || T || F || y || b || w), toolOverrides: Q, isDeepsearch: b, isReasoning: w, personalityId: C, deepsearchArgs: b ? x?.deepsearchArgs : void 0 };
                    f(P.setPromptSource(k || "")), f(P.setUsingExperiment(!1)), f(P.userSendMessage(j, h)), (0, n.pv)(e, { conversationLength: H.length, isFileAttached: Boolean(j.fileAttachments?.length), isDeepsearch: q.isDeepsearch || void 0, isReasoning: q.isReasoning || void 0 }), p?.();
                    const W = M.isTrue("responsive_web_grok_enable_add_response_keepalive") && (b || w),
                        V = M.getNumberValue("responsive_web_grok_add_response_num_retries", 0);
                    return (V > 0 ? l.u : d.D)({ grokModule: P, requestBody: q, dispatch: f, analytics: e, api: U, flags: { enableLocation: v, enableGrokApiHost: N, numRetries: V, enableKeepalive: W } });
                };
        },
        63538: (e, t, s) => {
            s.d(t, { O: () => o });
        ...
        189953: (e, t, s) => {
            s.d(t, { $t: () => oe, A0: () => Ee, BA: () => se, BS: () => N, CH: () => D, CR: () => Z, Cr: () => I, DX: () => Y, Dh: () => S, Dn: () => P, En: () => d, FF: () => x, FV: () => U, Gy: () => O, HF: () => p, IK: () => a, JO: () => W, Jt: () => re, KH: () => f, L0: () => z, Lc: () => o, OW: () => M, Oj: () => b, P9: () => q, Q_: () => n, Qg: () => v, Qh: () => X, Sv: () => i, TY: () => G, Tv: () => B, UN: () => w, VK: () => c, WK: () => te, Ws: () => l, Xg: () => $, Xi: () => L, Y8: () => u, Yb: () => _, Yf: () => r, Yx: () => g, ZN: () => V, ar: () => Q, cA: () => pe, cw: () => ne, dK: () => m, dO: () => R, dZ: () => F, dw: () => ge, f1: () => ue, j$: () => he, k$: () => H, lQ: () => ee, lh: () => E, li: () => ce, lm: () => h, mq: () => Se, my: () => A, nK: () => C, o$: () => y, px: () => ie, qd: () => j, ru: () => me, ub: () => k, vc: () => K, vi: () => T, wG: () => ae, x5: () => J, yB: () => le, z2: () => de });
            const r = "grok",
                ...
                D = "rweb/grok/GROK_RESPONSE_FEEDBACK_LABELS",
                ...
                W = "rweb/grok/SET_EXPECTED_IMAGE_ASPECT_RATIO",
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.DirectMessages-bfd49e49.d832a06a.js.map
