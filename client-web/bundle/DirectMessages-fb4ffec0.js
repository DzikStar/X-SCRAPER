...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.DirectMessages-fb4ffec0"],
    {
        ...
        397159: (e, t, s) => {
            ...
            const c = i().c3f04d9c,
                d = i().cbdddb0a,
                l = { HEADER: "header", ASSISTANT: "assistant", DECISION: "decision", RAW_FUNCTION_RESULT: "raw_function_result", FUNCTION: "function", SUMMARY: "summary", FINAL: "final", SOFT_STOP: "softstop", FINAL_LONG: "final_long" },
            ...
            class g {
                constructor(e) {
                    (this.initiateFromHistoryResponses = (e, t = !1) => {
                        ...
                        for (const t of e) {
                            const e = { id: n().v4(), state: m.COMPLETED, header: t.header || c, subSteps: [] };
                            for (let s = 0; s < t.steps.length; s++) {
                                ...
                                if ((a.assistant && ((this.accumulatedTrace += a.assistant), (this.traceEnabled = !0)), a.summary)) {
                                    ...
                                    (this.accumulatedSummary += t), e.subSteps.push({ messageStepId: s + n, messageTag: l.SUMMARY, summary: t, webResults: a.webResults, xPostIds: a.xPostIds, toolUsageCardResults: a.toolUsageCardResults }), n++;
                                }
                                if (a.decision) {
                                    const t = this.parseMessageJSON(a.decision),
                                        { markdown: r, text: i } = this.getContentForDecisionAction(t);
                                    e.subSteps.push({ messageStepId: s + n, messageTag: l.DECISION, actionIcon: this.getIconForDecisionAction(t), actionType: t?.action, actionMarkdownSummary: r, actionSummary: i, actionWebResult: this.webResults.find((e) => e.url === t?.action_input?.url), actionState: "COMPLETED", webResults: a.webResults, xPostIds: a.xPostIds }), n++;
                                }
                            }
                            this.steps.push(e);
                        }
                        ...
                        (this.sortSubstepsByStepIdMessageTag = (e) => {
                            const t = [l.SUMMARY, l.DECISION, l.RAW_FUNCTION_RESULT];
                        ...
                        (this.complete = (e = !0) => {
                            "COMPLETED" !== this.state &&
                                ...
                                e && this.steps.push({ id: n().v4(), state: m.COMPLETED, header: d, subSteps: [], isCompleteHeader: !0 }),
            ...
            const h = (e) => ({ data: { name: e.name || "", conversationId: e.conversation_id }, id: e.conversation_id, type: u.El.DMConversation }),
                g = (e, t, s, a = !1) => {
                    const o = e && new RegExp(`(^|.*\\s)${n()(e)}.*`, "i"),
                        c = ((e, t) => (0, r.Z)(e.map((e) => (0, m.Z)(e, t).map((e) => e.user))))(t.sort(l.Z), s)
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.DirectMessages-fb4ffec0.5ea1ba0a.js.map
