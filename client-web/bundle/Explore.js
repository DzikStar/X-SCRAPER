    ...
    ["bundle.Explore", "bundle.AudioSpaceDetail"],
    {
        ...
        337523: (e, t, n) => {
                    ...
                    super(...e),
                        ...
                        (this._getModule = (0, A.Z)((e, t, n, a) => {
                            if (e?.id !== t) {
                                ...
                                if (e?.graphQLTimelineId) return (0, Z.R)(e.graphQLTimelineId);
                            }
                            return n;
                        })),
            ...
            const be = W.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                ...
                ye = (e) => {
                    const { TabBar: t, backLocation: n, documentTitle: o, entryConfiguration: l, fab: i, getTabLink: c, hasTabNavigation: f, history: w, initialFetchStatus: y, initialPageNamespace: D, logoButton: M, module: E, onBackClick: C, pageConfiguration: S, prerollDisplayLocation: k, renderEmptyState: T, renderUnavailable: I, rightControl: A, selectedTabId: Z, sidebarContent: v, timelinePrefix: x, title: N, withAppLinks: P, withBottomLoginSignupBar: B, withDeferredView: R, withOpenGraphMeta: L, withSearchBox: G, withTweetButton: O } = e,
                        $ = (0, r.tj)(),
                        ...
                        te = R ? u.Z : a.Fragment,
                        ne = a.createElement(a.Fragment, null, J, a.createElement(te, null, a.createElement(F, { entryConfiguration: W, initialModule: E, prerollDisplayLocation: k, renderEmptyState: T, renderUnavailable: I, selectedTabId: Z, timelinePrefix: x, title: N, withoutHeadroom: !0 }))),
                        ae = i ? a.createElement(p.Z, { component: d.Z, fab: i }, ne) : ne,
                        oe = c && f ? a.createElement(_, { getTabLink: c, module: E, selectedTabId: Z }) : void 0;
                    return a.createElement(h.nO, { namespace: Y }, a.createElement(g.Z, null, a.createElement(m.Z, { TabBar: t, backLocation: n, documentTitle: o, history: w, logoButton: M, onBackClick: C, primaryContent: ae, rightControl: ee || A, secondaryBar: oe, sidebarContent: v, subtitle: Q, title: J && z ? N : X, withBottomLoginSignupBar: B, withSearchBox: G, withTweetButton: O })));
                };
        ...
        849461: (e, t, n) => {
            ...
            const k = { ...(0, n(335632).G)({ withThirdPartyCards: !0, errorContext: "EXPLORE_SCREEN" }) },
                ...
                I = l().c797b44e,
                _ = l().a19ce060,
                A = () => a.createElement(h.Z, null),
                Z = () => a.createElement(o.Z, { message: _ }),
                v = 600,
                x = 315,
            ...
            class M extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: a, children: r, color: d, isActive: s, isCompact: c, isPillLink: u, isRoundedRect: p, isWebRedesign: b, retainScrollPosition: M, style: C, to: S } = this.props,
                        ...
                        T = S ? this._getMemoizedLink(S, M) : void 0,
                        I = s ? s(S) : k?.pathname === T?.pathname,
                        _ = g.Z.generate({ backgroundColor: "transparent", color: l.default.theme.colors.text, insetFocusRing: !0 }),
                        A = b ? "medium" : I ? "bold" : "medium";
                    return o.createElement(f.Z, { "aria-label": t, "aria-selected": I, focusable: !!I, interactiveStyles: _, link: T, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? E.pill : E.link, u && I ? E.active : null, c ? (u ? E.compactPill : E.compactLink) : null, p ? E.roundedRect : null, C], withoutInteractiveStyles: b || u }, ({ isFocused: t, isHovered: s }) => o.createElement(i.Z, { style: u && E.flexGrow }, o.createElement(m.ZP, { size: b ? "headline2" : void 0, style: [E.text, { color: this._getTextColor(I, s, b, u) }, c && E.compactText, b && t && E.focusedText], weight: A }, e && o.createElement(e, { style: E.icon }), r, b || u ? null : o.createElement(i.Z, { style: I && [E.border, { backgroundColor: l.default.theme.colors[d] }] })), n ? o.createElement(h.Z, { count: n, standalone: !0, style: [E.badge, n >= 10 && E.multiDigitBadge, n >= 20 && E.truncatedCountBadge], truncatedCountFormatter: D, unreadCountLabel: w, withBorder: !1 }) : a ? o.createElement(h.Z, { pip: !0, standalone: !0, style: E.badgePip, textColor: "red500", unreadCountLabel: y, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Explore.e40da99a.js.map
