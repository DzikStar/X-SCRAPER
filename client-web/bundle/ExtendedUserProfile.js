...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.ExtendedUserProfile", "icons/IconPlusCircle-js"],
    {
        ...
        96702: (e, t, r) => {
            ...
            const x = ({ content: e }) => (
                ...
                I = ({ content: e, previewHeight: t, shouldTruncate: r = !0 }) => {
                    const [s, a] = n.useState(0),
                        ...
                        u = n.useRef(null);
                    n.useEffect(() => {
                        u.current && 0 === s && a(u.current.offsetHeight);
                    }, [s]);
                    const m = n.useMemo(() => {
                    ...
                    return m && m.hasText()
                        ? n.createElement(
                              ...
                              p && n.createElement(h.ZP, { color: "link", onPress: () => d(!c), size: "subtext1", style: w.link, withInteractiveStyling: !0 }, c ? "Show less" : "Show more"),
                          )
                        : null;
                },
                ...
                N = ({ block: e, isEditing: t }) => {
                    const { hasWorkHistorySection: r, sectionType: s } = (0, o.eF)(),
                        d = e.result?.content,
                        u = n.useMemo(() => s === a.NB.ABOUT && r, [r, s]);
            ...
            const F = T().a2f2faab,
                M = ({ endMonth: e, endYear: t, isCurrent: r, startMonth: l, startYear: s }) => {
                    const a = (0, B.ZU)(l, s),
                        o = (0, B.ZU)(e, t);
                    return a ? n.createElement(S.Z, null, n.createElement(T().I18NFormatMessage, { $i18n: "bab4ce51", start: F(a), end: r ? "Present" : o ? F(o) : "" }), n.createElement(h.ZP, null, (0, B.HM)(a, o || new Date()))) : null;
                },
        ...
        381335: (e, t, r) => {
            ...
            const m = i().h6a724ac,
                ...
                f = ({ onCompleted: e, useIconButton: t }) => {
                    const { blockCount: r, sectionQueryId: a } = (0, d.eF)(),
                    ...
                    return n.createElement(n.Fragment, null, t ? n.createElement(l.Z, { style: E.iconButton }, n.createElement(s.ZP, { disabled: !o || !f, icon: n.createElement(c.default, null), onClick: _, size: "xSmall", type: "destructiveText" })) : n.createElement(s.ZP, { disabled: !o || !f, onClick: _, size: "large", type: "destructiveText" }, b), y && o && f ? n.createElement(u.Z, { blockId: o, headline: m, onClose: Z, onCompleted: e, queryId: r > 1 ? i : a || g, subtext: p, userId: f }) : null);
                };
        },
        485822: (e, t, r) => {
            r.d(t, { Z: () => w });
            ...
            const _ = p().b721eb38,
                k = ({ blocks: e, isEditing: t = !1 }) => {
                    ...
                    return n.createElement(l.Z, { style: v.root }, n.createElement(l.Z, { style: v.header }, n.createElement(d.ZP, { size: "title4", weight: "bold" }, _), x && I && n.createElement(d.ZP, { hoverLabel: { label: (0, Z.Q)(s) } }, n.createElement(Z.K3, { style: v.visibilityIcon, visibility: s })), x && t && n.createElement(Z.ZP, { currentVisibility: s, sectionId: r })), n.createElement(l.Z, null, e?.length ? n.createElement(y.Z, { blocks: C, isEditing: t }) : n.createElement(n.Fragment, null, t ? n.createElement(u.Z, { interactiveStyles: w, onClick: k, style: v.container }, n.createElement(d.ZP, null, "Tell us about yourself"), n.createElement(b.default, null)) : null)));
                },
            ...
            const _ = p().a622dfcc,
                k = ({ blocks: e, isEditing: t = !1 }) => {
                    ...
                    const I = a === m,
                        ...
                        N = (0, g.s1)(C);
                    return n.createElement(l.Z, { style: v.root }, n.createElement(l.Z, { style: v.headerSection }, n.createElement(d.ZP, { size: "title4", weight: "bold" }, _), x && I && n.createElement(d.ZP, { hoverLabel: { label: (0, Z.Q)(s) } }, n.createElement(Z.K3, { style: v.visibilityIcon, visibility: s })), x && t && n.createElement(Z.ZP, { currentVisibility: s, sectionId: r })), n.createElement(l.Z, { style: v.blocksList }, N && N.length > 0 ? n.createElement(y.Z, { blocks: N, isEditing: t }) : null, n.createElement(n.Fragment, null, t ? n.createElement(u.Z, { interactiveStyles: w, onClick: k, style: v.container }, n.createElement(d.ZP, null, "Add experience"), n.createElement(b.default, null)) : null)));
                },
        ...
        991617: (e, t, r) => {
            r.d(t, { Fo: () => a, Vo: () => m, Y_: () => i, _L: () => p, bQ: () => c, dq: () => u, eF: () => d, j7: () => b, se: () => o, w: () => s });
            var n = r(202784),
                l = r(565058);
        ...
        695431: (e, t, r) => {
            ...
            const o = (e, t) => t.match.params.screenName || "",
                ...
                d = (e, t) => a.ZP.selectUserSuspendMessage(e, o(0, t)),
                u = (e, t) => a.ZP.selectByScreenName(e, o(0, t)),
                m = (0, l.Z)()
                    .propsFromState(() => ({ isNotFound: i, isSuspended: c, suspendMessage: d, screenName: o, user: u, viewerUserId: s._h }))
        ...
        728441: (e, t, r) => {
            ...
            const F = ({ profileBlocksRef: e }) => {
                ...
                D = ({ analytics: e, hasProfileBlocks: t, profileBlocksRef: r, screenName: n, user: u, viewerUserId: m }) => {
                    ...
                    return l.createElement(d.Z, { backLocation: `/${n}`, history: b, primaryContent: u ? (t ? l.createElement(H, { profileBlocksRef: r }) : l.createElement(f.Z, { header: "This user does not have an expanded bio", message: "Try searching for another.", screenName: n })) : null, rightControl: u?.id_str === m ? l.createElement(a.ZP, { link: "/settings/bio", onClick: E, size: "xSmall", type: "primaryOutlined" }, "Edit") : u ? l.createElement(k.Z, { user: u }) : null, sidebarContent: l.createElement(o.Z, null), subtitle: `@${n}`, title: (0, i.Z)(u), titleIconCell: (0, c.Z)(u) });
                },
                U = (e) => {
                ...
                O = (0, _.Z)((e) => {
                    ...
                    return (
                        ...
                        a && i ? (s ? l.createElement(Z.i, { screenName: a, suspendMessage: o }) : i.blocked_by ? l.createElement(y.T, { screenName: a }) : !i.protected || (i && c === i.id_str) || i.following ? (n ? l.createElement(g.Y, { screenName: a }) : l.createElement(u.H, { errorConfig: V }, l.createElement(U, e))) : l.createElement(h.X, { screenName: a })) : null
                    );
                });
        },
        806208: (e, t, r) => {
            ...
            const R = ({ analytics: e, expandedProfile: t, hasProfileBlocks: r, history: n, screenName: a, user: o, viewerUserId: c }) => {
                ...
                F = (e) => {
                    ...
                    return t && a ? l.createElement(B, (0, n.Z)({ expandedProfile: a, hasProfileBlocks: s }, e)) : null;
                },
                ...
                H = (0, S.Z)((e) => {
                    ...
                    return (
                        ...
                        a && i ? (s ? l.createElement(N.i, { screenName: a, suspendMessage: o }) : i.blocked_by ? l.createElement(I.T, { screenName: a }) : !i.protected || (i && c === i.id_str) || i.following ? (n ? l.createElement(w.Y, { screenName: a }) : l.createElement(g.H, { errorConfig: M }, l.createElement(F, e))) : l.createElement(C.X, { screenName: a })) : null
                    );
                });
        },
        416699: (e, t, r) => {
        ...
        972796: (e, t, r) => {
            ...
            const c = o().ica87fde,
                ...
                u = (e) => {
                    const { screenName: t } = e,
                        r = n.useMemo(() => n.createElement(o().I18NFormatMessage, { $i18n: "e6264621", screenName: t }, n.createElement(s.ZP, { link: d }, o().c7ec6faf)), [t]);
        ...
        21437: (e, t, r) => {
            ...
            const c = o().bd598c70,
                ...
                u = (e) => {
                    const { screenName: t } = e,
                        r = n.useMemo(() => n.createElement(o().I18NFormatMessage, { $i18n: "i1824ce3", screenName: t }, n.createElement(s.ZP, { link: d }, o().e617164b)), [t]);
                    return n.createElement(i.Z, { header: c, message: r, screenName: t });
                },
                m = n.memo(u);
        },
        220544: (e, t, r) => {
            ...
            var n = r(202784),
                ...
                i = r(416699);
            const c = a().g8475f82,
                d = n.createElement(a().I18NFormatMessage, { $i18n: "da9d52d7" }, n.createElement(l.ZP, { link: "https://support.x.com/articles/18311" }, a().j5e1cf59)),
                u = (e) => {
                    const { screenName: t, suspendHeader: r, suspendMessage: l } = e,
                        s = r ? n.createElement(o.Z, { entities: r.entities, rtl: r.rtl, text: r.text }) : c,
                        a = l ? n.createElement(o.Z, { entities: l.entities, rtl: l.rtl, text: l.text }) : d;
        ...
        524496: (e, t, r) => {
            ...
            const Z = n.memo(function (e) {
                    ...
                    return (
                        ...
                        n.createElement(d.ZP, null, ({ containerWidth: e }) => n.createElement(s.Z, { style: _.fontFamily }, n.createElement(l.Editor, { blockRenderMap: y, blockRendererFn: Z, blockStyleFn: (0, c.su)(b.Z.isNarrowScreenWidth(e)), editorState: g, onChange: o.Z, readOnly: !0, webDriverTestID: "longformRichTextComponent" })))
                    );
                }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ExtendedUserProfile.fe02fe7a.js.map
