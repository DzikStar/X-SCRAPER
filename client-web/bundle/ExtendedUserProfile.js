    ...
    ["bundle.ExtendedUserProfile"],
    {
        ...
        96702: (e, t, r) => {
            ...
            const F = T().a2f2faab,
                M = ({ endMonth: e, endYear: t, isCurrent: r, startMonth: l, startYear: s }) => {
                    const a = (0, B.ZU)(l, s),
                        o = (0, B.ZU)(e, t);
                    return a ? n.createElement(N.Z, null, n.createElement(T().I18NFormatMessage, { $i18n: "bab4ce51", start: F(a), end: r ? "Present" : o ? F(o) : "" }), n.createElement(h.ZP, null, (0, B.HM)(a, o || new Date()))) : null;
                },
            ...
            const Z = p().a622dfcc,
                k = ({ blocks: e, isEditing: t = !1 }) => {
                    ...
                    const w = a === m,
                        ...
                        S = (0, g.s1)(C);
                    return n.createElement(l.Z, { style: v.root }, n.createElement(l.Z, { style: v.headerSection }, n.createElement(u.ZP, { size: "title4", weight: "bold" }, Z), x && w && n.createElement(u.ZP, { hoverLabel: { label: (0, _.Q)(s) } }, n.createElement(_.K3, { style: v.visibilityIcon, visibility: s })), x && t && n.createElement(_.ZP, { currentVisibility: s, sectionId: r })), n.createElement(l.Z, { style: v.blocksList }, S && S.length > 0 ? n.createElement(y.Z, { blocks: S, isEditing: t }) : null, n.createElement(n.Fragment, null, t ? n.createElement(d.Z, { interactiveStyles: I, onClick: k, style: v.container }, n.createElement(u.ZP, null, "Add experience"), n.createElement(b.default, null)) : null)));
                },
        ...
        728441: (e, t, r) => {
            ...
            const B = ({ profileBlocksRef: e }) => {
                    const t = I()(b.m1, e),
                        r = t?.items?.find((e) => e?.block_type === T.Mp.RICHTEXT),
                        n = r?.data?.value || "",
                        s = l.useMemo(() => {
                            try {
                    ...
                    return (
                        (0, N.q)(() => {
                            (0, w.fH)((0, R.yW)(R.Hx, R.K), R.Hx);
                        }),
                        l.createElement(v.Z, { style: F.root }, s && (0, k.convertFromRaw)(s).hasText() ? l.createElement(P.Z, { className: R.Hx }, l.createElement(v.Z, { style: F.richText }, l.createElement(C.Z, { contentState: s, paragraphFontSizeOverride: R.K.paragraphFontSize }))) : null)
                    );
                },
                F = S.default.create((e) => ({ root: { paddingVertical: e.spaces.space20 }, flexRow: { display: "flex", flexDirection: "row", alignItems: "center", gap: e.spaces.space8, paddingVertical: e.spaces.space8, paddingHorizontal: e.spaces.space16 }, flexCol: { display: "flex", flexDirection: "column" }, flexOne: { flex: 1 }, avatar: { width: 90, height: 90 }, richText: { color: e.colors.text, padding: e.spaces.space16 } })),
                M = l.memo(B),
                H = ({ analytics: e, hasProfileBlocks: t, profileBlocksRef: r, screenName: n, user: d, viewerUserId: m }) => {
                    ...
                    return l.createElement(u.Z, { backLocation: `/${n}`, history: b, primaryContent: d ? (t ? l.createElement(M, { profileBlocksRef: r }) : l.createElement(f.Z, { header: "This user does not have an expanded bio", message: "Try searching for another.", screenName: n })) : null, rightControl: d?.id_str === m ? l.createElement(a.ZP, { link: "/settings/bio", onClick: E, size: "xSmall", type: "primaryOutlined" }, "Edit") : d ? l.createElement(Z.Z, { user: d }) : null, sidebarContent: l.createElement(o.Z, null), subtitle: `@${n}`, title: (0, i.Z)(d), titleIconCell: (0, c.Z)(d) });
                },
                D = (e) => {
                    ...
                    return t && s ? l.createElement(H, (0, n.Z)({ hasProfileBlocks: a, profileBlocksRef: s }, e)) : null;
                },
                ...
                V = (0, _.Z)((e) => {
                    ...
                    return (
                        ...
                        a && i ? (s ? l.createElement(h.i, { screenName: a, suspendMessage: o }) : !i.protected || (i && c === i.id_str) || i.following ? (n ? l.createElement(g.Y, { screenName: a }) : l.createElement(d.H, { errorConfig: U }, l.createElement(D, e))) : l.createElement(y.X, { screenName: a })) : null
                    );
                });
        },
        806208: (e, t, r) => {
            ...
            var n = r(807896),
                ...
                S = r(695431),
                N = r(990229);
            const P = ({ analytics: e, expandedProfile: t, hasProfileBlocks: r, history: n, screenName: a, user: o, viewerUserId: c }) => {
                    l.useEffect(() => {
                ...
                B = (e) => {
                    ...
                    return t && a ? l.createElement(T, (0, n.Z)({ expandedProfile: a, hasProfileBlocks: s }, e)) : null;
                },
                F = { context: "EXTENDED_USER_PROFILE_V2" },
                M = (0, S.Z)((e) => {
                    const { createLocalApiErrorHandler: t, fetchOneUserByScreenNameIfNeeded: r, isNotFound: n, isSuspended: s, screenName: a, suspendMessage: o, user: i, viewerUserId: c } = e;
                    return (
                        l.useEffect(() => {
                        ...
                        a && i ? (s ? l.createElement(C.i, { screenName: a, suspendMessage: o }) : !i.protected || (i && c === i.id_str) || i.following ? (n ? l.createElement(I.Y, { screenName: a }) : l.createElement(g.H, { errorConfig: F }, l.createElement(B, e))) : l.createElement(w.X, { screenName: a })) : null
                    );
                });
        },
        416699: (e, t, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ExtendedUserProfile.38f491ba.js.map
