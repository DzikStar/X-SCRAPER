    ...
    ["bundle.GifSearch"],
    {
        ...
        625661: (e, a, t) => {
            ...
            class u extends o.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: a, centeredLogo: t, fixed: r, hideBackButton: d, isFullWidth: n, isLarge: i, leftControl: c, middleControl: u, position: m, rightControl: p, secondaryBar: D, style: g, subtitle: f, title: y, titleDomId: M, titleIconCell: b, titleIconCellSize: w, withBackground: S, withWideContainer: k } = this.props,
                        { isModal: _ } = this.context,
                        C = d ? c : o.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        I = (function (e, a, t) {
                            return e && !(a && t);
                        })(!!S, _, !!D);
                    return o.createElement(o.Fragment, null, o.createElement(s.Z, { centerTitle: a, centeredLogo: t, isFullWidth: n, isLarge: i, leftControl: C, middleControl: u, position: h(m, _, r), rightControl: p, style: g, subtitle: f, title: y, titleDomId: M, titleIconCell: b, titleIconCellSize: w, withBackground: I, withWideContainer: k }), D || null);
                }
                render() {
        ...
        118092: (e, a, t) => {
            ...
            const A = [],
                ...
                P = (e, { module: a, query: t }) => a.selectNextFetchStatus(e, t),
                x = (e) => {
                ...
                v = (0, S.Z)()
                    .propsFromState(() => ({ initialFetchStatus: Z, items: E, nextFetchStatus: P, oldMediaIds: x }))
                    ...
                    super(e, a),
                        ...
                        (this._render = () => {
                            const { items: e, query: a } = this.props,
                                { width: t } = this.state,
                                r = e ? this._brickLayout(e, 150, t) : H;
                        ...
                        (this._handleClickFactory = (e) => () => {
                            const { addExternalMediaUpload: a, addMediaToDM: t, fromSearch: o, gifSearchKey: r, history: d, onClickGif: n, scribeAction: l, setMediaMetadata: s, updateSingleComposerV2: i } = this.props,
                                ...
                                S = a({ mediaCategory: r === g.AD.Composition || r === g.AD.NoteComposition ? f.xz.TweetGif : f.xz.DMGif, mediaType: "image/gif", previewMediaType: "video/mp4", previewUrl: y, sourceUrl: p, stillMediaUrl: b.still_image_url, width: M, height: D }),
                                k = S.map((e) => e.id),
                                _ = { found_media_origin: h, provider: m, url: w };
                            if ((c && s(k[0], { defaultAltText: c, gifMetadata: _ }), r === g.AD.Composition)) {
                            ...
                            } else r === g.AD.DMComposition ? t(k, _) : r === g.AD.NoteComposition && n?.(S);
        ...
        16569: (e, a, t) => {
            ...
            const _ = (e, a) => (0, S.l4)(e).shouldAutoPlayGif,
                C = (0, w.Z)().propsFromState(() => ({ shouldAutoPlayGif: _, isDataSaverEnabled: S.IX, effectiveAutoplayOption: k.AP }));
            var I = t(74938),
                A = t(663194);
            const Z = c().a50ba822,
                E = c().a9ae1e78,
            ...
            class N extends o.Component {
                ...
                render() {
                    ...
                    return o.createElement(g.nO, { namespace: this._getScribeNamespace(r) }, o.createElement(d.Switch, null, o.createElement(d.Route, { exact: !0, path: v.search }, o.createElement(P, n)), o.createElement(d.Route, { exact: !0, path: `${v.category}/${y.kM}` }, o.createElement(x, n)), o.createElement(d.Route, { component: b.default })));
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.GifSearch.367be1ca.js.map
