    ...
    ["bundle.GifSearch"],
    {
        ...
        625661: (e, a, t) => {
            ...
            class u extends o.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: a, centeredLogo: t, fixed: r, hideBackButton: d, isFullWidth: n, isLarge: i, leftControl: c, middleControl: u, position: m, rightControl: p, secondaryBar: D, style: g, subtitle: f, title: y, titleDomId: M, titleIconCell: b, titleIconCellSize: w, withBackground: k, withWideContainer: S } = this.props,
                        { isModal: _ } = this.context,
                        I = d ? c : o.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        C = (function (e, a, t) {
                            return e && !(a && t);
                        })(!!k, _, !!D);
                    return o.createElement(o.Fragment, null, o.createElement(s.Z, { centerTitle: a, centeredLogo: t, isFullWidth: n, isLarge: i, leftControl: I, middleControl: u, position: h(m, _, r), rightControl: p, style: g, subtitle: f, title: y, titleDomId: M, titleIconCell: b, titleIconCellSize: w, withBackground: C, withWideContainer: S }), D || null);
                }
                render() {
        ...
        980407: (e, a, t) => {
            ...
            class m extends o.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: a, backButtonType: t, backLocation: d, centerTitle: n, hideBackButton: l, history: s, isFullWidth: h, isLarge: u, middleControl: m, onBackClick: D, rightControl: g, secondaryBar: f, subtitle: y, title: M } = this.props,
                                { isModal: b } = this.context;
                            return o.createElement(r.Z, { style: b ? [p.childViewAppBarRoot, p.appBarZindex] : p.appBarZindex }, o.createElement(c.ZP, { backButtonType: t || (b ? "close" : "back"), backLocation: d, centerTitle: n, fixed: !b, hideBackButton: l, history: s, isFullWidth: h, isLarge: u, middleControl: m, onBackClick: D, ref: e, rightControl: g, secondaryBar: f, style: [b && p.appBarModal, a], subtitle: y, title: M, titleDomId: i.Q_ }));
                        }),
                ...
                render() {
                    ...
                    return o.createElement(s.Z, null, o.createElement(h.Z.Configure, { documentTitle: l, headerless: !0, title: D }), o.createElement(r.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [p.root, f && p.rootModal] }, !f && y, o.createElement(d.Z, { isFullWidth: i, isLarge: c, style: [p.container, f && p.containerModal, n] }, f ? o.createElement(u.Z, { style: p.viewport }, y, t) : t), a ? o.createElement(r.Z, { style: [p.bottomBarModal, !f && !g && p.bottomBarMobile] }, o.createElement(d.Z, { isFullWidth: i, isLarge: c }, a)) : null));
                }
            }
        ...
        349035: (e, a, t) => {
            ...
            var o = t(202784),
                r = t(272175);
            const d = (0, t(500002).ZP)(({ staticContext: e, status: a = 404 }) => (e && (e.statusCode = a), o.createElement(r.ql, null, o.createElement("meta", { content: "noindex, nofollow", name: "robots" }))));
        },
        334346: (e, a, t) => {
            t.d(a, { C: () => s, Z: () => l });
            var o = t(807896),
        ...
        56851: (e, a, t) => {
            ...
            class D extends o.PureComponent {
                render() {
                    return o.createElement(r.Z, { testID: u }, o.createElement(h.Z, null), o.createElement(d.Z, { style: g.root }, o.createElement(n.ZP, { align: "center", color: "gray700", style: g.retryText }, m), o.createElement(l.ZP, { link: { pathname: "/search" }, type: "brandFilled" }, p)));
                }
            }
        ...
        317861: (e, a, t) => {
            ...
            const s = "gifSearch",
                ...
                f = (0, o.UY)({ categories: p.reducer, category: D.reducer, search: g.reducer });
            d.Z.register({ [s]: f });
        },
        564895: (e, a, t) => {
            t.d(a, { ZP: () => y });
            ...
            class g extends o.Component {
                ...
                render() {
                    ...
                    return (0, c.Z)() && (s || i) ? o.createElement(r.Z, { style: f.root }, o.createElement(d.ZP, { color: "gray700" }, D), o.createElement(n.Z, { "aria-label": D, onValueChange: this._handleSwitchChanged, value: l })) : null;
                }
            }
        ...
        278066: (e, a, t) => {
            ...
            const { Categories: g } = D,
                ...
                y = (e) => g.selectInitialFetchStatus(e),
                M = (0, p.Z)()
                    .propsFromState(() => ({ categories: (0, u.P1)(f, (e) => (e ? (0, m.Z)(e.map((e) => (e.display_name ? e : void 0))) : void 0)), initialFetchStatus: y }))
        ...
        118092: (e, a, t) => {
            ...
            var w = t(459679),
                ...
                C = t(632960);
            const A = [],
                Z = (e, { module: a, query: t }) => a.selectInitialFetchStatus(e, t),
                E = (e, { module: a, query: t }) => a.selectItems(e, t),
                ...
                x = (0, k.Z)()
                    .propsFromState(() => ({ initialFetchStatus: Z, items: E, nextFetchStatus: v, oldMediaIds: P }))
                    ...
                    super(e, a),
                        ...
                        (this._render = () => {
                            const { items: e, query: a } = this.props,
                                { width: t } = this.state,
                                r = e ? this._brickLayout(e, 150, t) : V;
                        ...
                        (this._getMemoizedRowRenderer = (0, h.Z)((e, a, t) => (r) => {
                            ...
                            return o.createElement(
                                ...
                                r.map((a, d) => {
                                    ...
                                    return (s += h), o.createElement(L, { altText: a.alt_text || z, animatedMediaUrl: m, backgroundColor: (0, y.d)(a.index), height: n, key: a.index, onClick: t(a), shouldAutoPlayGif: e, stillMediaUrl: u, width: h });
                                }),
                            );
                        })),
                            ...
                            const { addExternalMediaUpload: a, addMediaToDM: t, fromSearch: o, gifSearchKey: r, history: d, onClickGif: n, scribeAction: l, setMediaMetadata: s, updateSingleComposerV2: i } = this.props,
                                {
                                    ...
                                    preview_image: { height: D, url: y, width: M },
                                    thumbnail_images: [b],
                                    url: w,
                                } = e,
                                k = a({ mediaCategory: r === g.AD.Composition || r === g.AD.NoteComposition ? f.xz.TweetGif : f.xz.DMGif, mediaType: "image/gif", previewMediaType: "video/mp4", previewUrl: y, sourceUrl: p, stillMediaUrl: b.still_image_url, width: M, height: D }),
                                S = k.map((e) => e.id),
                                _ = { found_media_origin: h, provider: m, url: w };
                            if ((c && s(S[0], { defaultAltText: c, gifMetadata: _ }), r === g.AD.Composition)) {
                                const { oldMediaIds: e } = this.props,
                                    a = [...(0, u.Z)(e.concat(S))];
                                i({ updates: { mediaIds: this.context.featureSwitches.isTrue("rweb_mixed_media_uploads_enabled") ? a : S, gifMetadata: _ } });
                            } else r === g.AD.DMComposition ? t(S, _) : r === g.AD.NoteComposition && n?.(k);
                            l({ page: r, section: "gif_search", element: "category", action: o ? "search" : "select" }), d?.go(-2);
                        }),
                        (this._renderEmptyItem = () => o.createElement(n.Z, { header: O, message: K })),
                        (this._getRenderMemoizedFooter = (0, h.Z)((e, a) => o.createElement(m.Z, { fetchStatus: e, onRequestRetry: a, render: H }))),
        ...
        16569: (e, a, t) => {
            ...
            var o = t(202784),
                ...
                k = t(38562),
                S = t(659773);
            const _ = (e, a) => (0, k.l4)(e).shouldAutoPlayGif,
                I = (0, w.Z)().propsFromState(() => ({ shouldAutoPlayGif: _, isDataSaverEnabled: k.IX, effectiveAutoplayOption: S.AP }));
            var C = t(74938),
                A = t(663194);
            const Z = c().a50ba822,
                E = c().a9ae1e78,
            ...
            class N extends o.Component {
                    ...
                    super(e, a),
                        ...
                        (this._handleClear = () => {
                            const { history: e, isDataSaverEnabled: a, location: t } = this.props,
                                o = t.pathname.startsWith(x.category),
                                r = t.pathname === x.search && t.state && t.state.query;
                ...
                render() {
                    ...
                    if (!r) return o.createElement(f.Z, { to: "/" });
                    const n = { gifSearchKey: r, history: e, location: a, searchBox: this._renderSearchBox(), shouldAutoPlayGif: t };
                    return o.createElement(g.nO, { namespace: this._getScribeNamespace(r) }, o.createElement(d.Switch, null, o.createElement(d.Route, { exact: !0, path: x.search }, o.createElement(v, n)), o.createElement(d.Route, { exact: !0, path: `${x.category}/${y.kM}` }, o.createElement(P, n)), o.createElement(d.Route, { component: b.default })));
                }
        ...
        466441: (e, a, t) => {
            ...
            function M(e) {
                ...
                return (
                    ...
                    o.createElement(m.Z, null, o.createElement(c.Z.Configure, { backLocation: "/", documentTitle: f, title: y }), o.createElement(d.Z, { style: t && b.modal }, o.createElement(u.Z, null)), o.createElement(h.Z, { title: f, withMeta: !1 }))
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.GifSearch.ab7f4fba.js.map
