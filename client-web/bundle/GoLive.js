        ...
        857289: (e, t, a) => {
            ...
            const g = { close: h().ia5e7488, goLive: h().e5323e36, placeholder: h().ic05a146, startNow: h().cdf630be },
                w = () => {
                    ...
                    return l.createElement(d.Z, { onMaskClick: p, restoreFocusInFocusTrapView: !0, type: "bottom", withMask: !0 }, l.createElement(l.Fragment, null, l.createElement(n.Z, { leftControl: l.createElement(s.ZP, { "aria-label": g.close, hoverLabel: { label: g.close }, icon: l.createElement(m.default, null), onPress: p, type: "primaryText" }) }), l.createElement(v.default, { style: f.decorationIcon }), l.createElement(c.Z, { style: f.container }, l.createElement(o.ZP, { size: "title3", weight: "bold" }, g.goLive), l.createElement(i.Z, { onChange: u, placeholder: g.placeholder, style: f.textInput, value: t }), l.createElement(c.Z, { style: f.rowGoLive }, l.createElement(s.ZP, { onPress: () => {}, size: "large", style: f.flex, type: "brandFilled" }, g.startNow)))));
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.GoLive.4e87f9da.js.map
