    ...
    ["bundle.GraduatedAccess"],
    {
        25704: (e, t, n) => {
            ...
            const c = s().j24c37b2,
                d = ({ Content: e, contentStyle: t, actionLabel: n = c, flag: r, graphic: s, graphicDisplayMode: d, headline: u, isFullHeightOnMobile: p, enableMaskForDismiss: m, onAction: h, onClose: g, onSecondaryAction: b, secondaryActionLabel: C, supportUrl: y, subtext: k, withCloseButton: E, shouldShowForLoggedOut: v = !1, shouldAddEducationFlagOnClose: f = !0, shouldAddEducationFlagOnSecondary: w = !0, shouldAddEducationFlagOnPrimary: M = !0 }) => {
                    ...
                    return a.createElement(o.Z, { actionLabel: n, contentStyle: t, enableMaskForDismiss: m, graphic: s, graphicDisplayMode: d || "none", headline: u, isFullHeightOnMobile: p, onAction: L, onClose: Z, onSecondaryAction: U, secondaryActionLabel: C, subtext: k, supportUrl: y, withCloseButton: E }, e ? a.createElement(e, null) : null);
                },
                u = a.memo(d);
        },
        621416: (e, t, n) => {
        ...
        534999: (e, t, n) => {
            ...
            const b = s.default.create((e) => ({ decorationContainer: { color: e.colors.primary, height: e.spaces.space24, width: e.spaces.space24, marginEnd: e.spaces.space20 } })),
                ...
                Z = d().i6671128,
                U = d().d5e4d0a6,
                B = () => a.createElement(r.Z, { style: L.itemsContainer }, a.createElement(l.Z, { items: F.promptItems }), a.createElement(i.ZP, { link: S.learnMoreUrl, style: L.supportLink }, S.learnMoreTitle)),
                D = () => {
            ...
            const _ = s.default.create((e) => ({ contentContainer: { marginBottom: e.spaces.space16 }, itemsContainer: { marginBottom: e.spaces.space24 }, itemContainer: { paddingStart: 0, paddingEnd: 0 }, supportLink: { marginTop: e.spaces.space64 } })),
                ...
                T = () => {
                    ...
                    return a.createElement(r.Z, { style: _.itemsContainer }, a.createElement(l.Z, { items: A.promptItems }), a.createElement(i.ZP, { link: S.learnMoreUrl, onClick: n, style: _.supportLink }, S.learnMoreTitle));
                },
                I = () => {
                    const e = (0, o.useHistory)(),
                        t = (0, H.z)();
                    ...
                    return a.createElement(u.Z, { Content: T, actionLabel: S.ctaTitle, contentStyle: _.contentContainer, enableMaskForDismiss: !0, flag: p.Uq, graphicDisplayMode: "icon", headline: x, isFullHeightOnMobile: !0, onAction: r, onClose: s, shouldAddEducationFlagOnClose: !1, subtext: O, withCloseButton: !0 });
                };
            var z = n(668214),
                N = n(723819);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.GraduatedAccess.13e13a0a.js.map
