    ...
    ["bundle.Grok-63cb1cc4"],
    {
            ...
            const c =
                ...
                async (p, f, { api: b, featureSwitches: k }) => {
                    const C = !a.ZP.isTwitterApp() && k.isTrue("responsive_web_grok_api_enable_grok_host"),
                        w = (0, o.bD)(t),
                        T = w.selectConversationId(f()),
                        x = a.ZP.isAndroid(),
                        S = a.ZP.isIOS();
                    if (!T) return void (0, s.Uk)(e, "edit function failed to find a conversationId");
                    const I = w.selectMode(f()),
                        R = w.selectMessageIds(f()),
                        Z = w.selectConversationWithLocalMessages(f()),
                        P = (0, o.F9)(f()),
                        A = R.indexOf(c);
                    if (-1 === A) return void (0, s.Uk)(e, "edit function couldn't find an actionable response");
                    const D = Z[A];
                    ...
                    const M = [...Z.slice(0, A).map((e) => ({ message: e.message, fileAttachments: e.fileAttachments, sender: e.sender, isDeepsearch: e.isDeepsearch, isReasoning: e.isReasoning })), { sender: D.sender, fileAttachments: l, message: h, isDeepsearch: E, isReasoning: y }],
                        G = (0, o.en)(f());
                    let L = {};
                    G && G.toolOverrides && (L = G.toolOverrides);
                    const K = { responses: M, systemPromptName: I, conversationId: T, grokModelOptionId: P, resampleResponseId: D.userChatItemId, returnSearchResults: u, returnCitations: m, requestFeatures: g, ...(n && 1 === M.length ? { analysisEntityId: n } : void 0), promptMetadata: O, imageGenerationCount: _, enableSideBySide: !x && !S, isDeepsearch: E, isReasoning: y, personalityId: v, toolOverrides: L, deepsearchArgs: E ? G?.deepsearchArgs : void 0 };
                    null != w.selectCurrentResponseMessage(f()) && (await p((0, r.I)({ analytics: e, conversationKey: t }))), h && p(w.commitEditChanges(c, h, l)), (0, s.dd)(e, { conversationLength: M.length, isDeepsearch: K.isDeepsearch || void 0, isReasoning: K.isReasoning || void 0 }), d?.();
                    ...
                    (0, i.D)({ grokModule: w, requestBody: K, analytics: e, dispatch: p, api: b, eventTag: "rewrite", flags: { enableGrokApiHost: C, enableKeepalive: N, numRetries: B } });
                };
        },
        69966: (e, t, n) => {
            n.d(t, { C: () => c });
                ...
                (e, t, { api: n, featureSwitches: c }) => {
                    ...
                    return p({ actionTypes: i.Yx, context: "FETCH_GROK_HOME", meta: {} }, (e) => {
                        ...
                        if (e) {
                            ...
                            e.grok_home?.ineligible_reasons && t.push((0, a.v0)([...(e.grok_home?.ineligible_reasons ?? [])])), e.grok_home?.free_access_enabled && t.push((0, a.uz)(e.grok_home?.free_access_enabled)), e.grok_home?.preferred_prompts && t.push((0, a.jP)([...e.grok_home.preferred_prompts.map((e) => ({ ...e, tool_overrides: { imageGen: e.tool_overrides?.image_gen, webSearch: e.tool_overrides?.web_search, xSearch: e.tool_overrides?.x_search, xMediaSearch: e.tool_overrides?.x_media_search, xPostAnalyze: e.tool_overrides?.x_post_analyze, trendsSearch: e.tool_overrides?.trends_search } }))]));
                        }
                        return t;
                    });
                };
                    ...
                    return new Promise((t) => {
                        ...
                        if ("string" == typeof a) {
                            const C = k.selectMode(y()),
                                w = k.selectConversationWithLocalMessages(y()),
                                T = (0, o.F9)(y()),
                                x = w.findLastIndex((e) => e.sender === i.CI.ASSISTANT && e.userChatItemId === n);
                            ...
                            const S = w[x],
                                ...
                                R = w.slice(0, x).map((e) => ({ message: e.message, sender: e.sender, fileAttachments: e.fileAttachments }));
                            let Z;
                            ...
                            const A = (0, o.en)(y()),
                                D = { ...f };
                            if (A && A.toolOverrides) {
                                const e = A.toolOverrides;
                            ...
                            const O = S.isDeepsearch,
                                M = S.isReasoning,
                                G = { responses: R, systemPromptName: C, conversationId: a, grokModelOptionId: T, returnSearchResults: m, returnCitations: d, requestFeatures: g, resampleResponseId: n, imageGenerationCount: h, ...(p && 1 === R.length ? { analysisEntityId: p } : void 0), promptMetadata: I, toolOverrides: D, geoLocation: Z, enableSideBySide: !1, isDeepsearch: O, isReasoning: M, personalityId: _, deepsearchArgs: O ? A?.deepsearchArgs : void 0 };
                            null != k.selectCurrentResponseMessage(y()) && (await u((0, c.I)({ analytics: e, conversationKey: t }))), u(k.regenerateResponse(S)), (0, s.c3)(e, { conversationLength: R.length + 1, isDeepsearch: O || void 0, isReasoning: M || void 0 });
                            const L = v.isTrue("responsive_web_grok_enable_add_response_keepalive") && (O || M),
                                K = v.getNumberValue("responsive_web_grok_add_response_num_retries", 0);
                            return (0, l.D)({ grokModule: k, requestBody: G, analytics: e, dispatch: u, api: E, eventTag: "regenerate", flags: { enableLocation: P, enableGrokApiHost: b, numRetries: K, enableKeepalive: L } });
                        }
                    });
                };
        },
        ...
        856626: (e, t, n) => {
            ...
            var a = n(202784),
                ...
                A = n(143670),
                D = n(487552);
            function O({ active: e, hoverLabel: t, icon: n, isDropdown: o, label: s, onPress: r }) {
                return a.createElement(R.ZP, { "aria-label": s || t, backgroundColor: "gray0", borderColor: e ? "gray700" : "transparent", hoverLabel: t ? { label: t } : void 0, icon: n || void 0, onPress: r, size: "small", style: M.button }, a.createElement(Z.ZP, { size: "body", style: M.text, weight: "normal" }, s, o && " "), o && a.createElement(D.default, { style: M.text }));
            }
            ...
            function G({ icon: e, label: t, menuItems: n }) {
                ...
                return a.createElement(
                    r.Z,
                    null,
                    a.createElement(O, { icon: e, isDropdown: !0, label: t, onPress: i }),
                    o &&
                        a.createElement(
                            P.default,
            ...
            function H(e) {
                switch (e) {
                    case "IconQuoteStroke":
                        return a.createElement(x.default, { style: U.iconColor });
                    case "IconEye":
                        return a.createElement(S.default, { style: U.iconColor });
                    case "IconMediaCollapse":
                        return a.createElement(I.default, { style: U.iconColor });
                    default:
                        return null;
                }
            }
            function z({ initalText: e, model: t, onEnhance: n }) {
                ...
                return (
                    ...
                    a.createElement(r.Z, null, a.createElement(T.Z, { appTextSize: "headline1", leftAligned: !0, maxNumberOfLines: 4, multiline: !0, numberOfLines: 1, onChange: c, styleType: "selection", value: o }), a.createElement(r.Z, { style: U.toolRow }, p))
                );
            }
            const U = l.default.create((e) => ({ toolRow: { paddingStart: e.spaces.space12, paddingEnd: e.spaces.space12, paddingBottom: e.spaces.space8, paddingTop: e.spaces.space8, flexDirection: "row", gap: e.spaces.space8 }, iconColor: { color: l.default.theme.colors.gray1000 } }));
            var j = n(661810),
                q = n(737691),
                $ = n(379327),
                V = n(567778),
                    ...
                    a.createElement(
                        ...
                        a.createElement(
                            ...
                            a.createElement(
                                r.Z,
                                { style: ee.toolRow },
                                _ && a.createElement(O, { active: l, hoverLabel: Q.DiffButtonLabel, key: "diff", label: `± ${Math.round(_.differencePercentage).toString()}%`, onPress: E }),
                                a.createElement(O, {
                                ...
                                t ? a.createElement(O, { key: "resample", label: Q.Remix, onPress: () => t(d) }) : null,
                                a.createElement(O, { icon: a.createElement($.default, null), key: "select", label: Q.Insert, onPress: () => n(d, c, (_ && _.differencePercentage) || 0) }),
                            ),
                        ),
                        l && d.length
                            ? a.createElement(
            ...
            function oe({ children: e }) {
                const t = (0, E.I0)(),
                    ...
                    Z = (0, f.u)(),
                    P = (0, E.v9)(v.F9),
                    A = a.useMemo(() => ({ subscription_level: Z, grok_details: { grok_mode: "regular", grok_model: P } }), [Z, P]);
                a.useEffect(
                    () => (
                        t((0, b.C)({ analytics: n })()),
                        () => {
                ...
                return a.createElement(_.nO, { data: A, namespace: ne }, a.createElement(g.Z, { documentTitle: te, history: o, onBackClick: p, title: te }, a.createElement(r.Z, { ref: R, style: se.contentWrapper }, a.createElement(C.n, { isModal: l, maxHeight: 500, sectionCount: m.length }, a.createElement(z, { initalText: I, model: P, onEnhance: D }), m.map(({ atoms: e, postText: t, showDiff: n, title: o }, s) => a.createElement(J, { atoms: e, key: s, onSelect: O, orginalPostText: t, showDiff: n, title: o })).reverse()))));
            }
        ...
        979521: (e, t, n) => {
                    ...
                    o = a.useCallback(
                        (a) => (
                            ...
                            (async function (e, t, n) {
                                try {
                                    const a = await Promise.all(n.map((t) => (t?.url && B.includes(new URL(t.url).hostname) ? (0, D.f)(t.url || "", !0, !0) : e((0, M.X)(t.url || "")).then((e) => new File([e || new Blob()], "grok.jpg", { type: "image/jpeg" }))))),
            ...
            function j({ atoms: e, onSelect: t }) {
                const n = (0, s.Dv)(e.fileAttachments),
                    ...
                    u = a.useRef(new z.Z.Value(0)).current;
                return (
                    a.useEffect(() => {
                        z.Z.parallel([z.Z.timing(u, { toValue: d.height, duration: 160, useNativeDriver: !1 })]).start();
                    }, [d, u]),
                    a.createElement(
                        z.Z.View,
                        ...
                        a.createElement(
                            ...
                            p ? n.map((e, n) => a.createElement(r.Z, { key: `slot_${n}`, style: i.itemStyle }, a.createElement(U.Z, { aspectRatio: i.aspectRatio, file: e, intermediateResults: e.intermediateResults, isImageActionsEnabled: !1, isLoading: !!l, key: `${e.fileName}_${n}`, onClick: () => t(e) }))) : null,
                        ),
                    )
                );
            }
            const q = d.default.create((e) => ({ fileAttachmentContainer: { width: "100%", flexDirection: "row", justifyContent: "center", paddingBottom: e.spaces.space12 }, fileAttachmentContainerMulti: { flexWrap: "wrap", gap: e.spaces.space12 }, fileAttachmentMultiItem: { width: "48%" }, fileAttachmentSingleItem: { width: "98%" } })),
                $ = { height: void 0, aspectRatio: 4 / 3, itemStyle: q.fileAttachmentSingleItem, containerStyle: q.fileAttachmentContainer },
                V = { height: 400, aspectRatio: void 0, itemStyle: q.fileAttachmentMultiItem, containerStyle: [q.fileAttachmentContainer, q.fileAttachmentContainerMulti] },
                W = V.height,
                Y = a.memo(j);
            var X = n(731708),
                Q = n(737691),
            ...
            function ye({ promptTextSender: e }) {
                ...
                return a.createElement(
                    ...
                    a.createElement(S.b, { coverUrl: T, label: ie, onClose: t, onSendPrompt: e, prompt: ie }),
                    a.createElement(S.b, {
                        coverUrl: x,
                        label: ce,
                        onClose: t,
            ...
            function ke({ children: e }) {
                const t = (0, b.I0)(),
                    ...
                    N = a.useCallback(
                        (e) => {
                            const t = new _.T(m);
                            T((e) => (e.length && e[e.length - 1].abort(), [...e, t])), t.updatePrompt(e.text || ""), (t.imageGenerationCount = l), (t.model = G || ""), (t.promptSource = "POST_COMPOSER_IMAGE_GEN"), t.generate({ prompt: e, analytics: n });
                        },
                        [n, m, T, G, l],
                    ),
                    B = a.useCallback(
                ...
                const z = a.useCallback(() => o.goBack(), [o]),
                    U = F(),
                    j = a.useCallback(
                        (e) => {
                            U(e).then(z);
                    ...
                    q = (0, y.u)(),
                    $ = a.useMemo(() => ({ subscription_level: q, grok_details: { grok_mode: "regular", grok_model: G } }), [q, G]);
                return a.createElement(E.nO, { data: $, namespace: se }, a.createElement(f.Z, { documentTitle: re, history: o, onBackClick: z, title: re }, M ? a.createElement(R.w, { upsell: M }) : null, a.createElement(r.Z, { ref: c, style: Ce.contentWrapper }, a.createElement(r.Z, { style: Ce.inputContainer }, !M && G ? a.createElement(I.Z, { abortController: x.abortController, conversationKey: _e, disableFileUploads: !0, hasAccess: !0, isIdle: !D || O, placeholder: le, promptSender: N, useMagicWandIcon: !0, useNonExpanded: !0 }) : null), a.createElement(A.n, { isModal: d, maxHeight: 2 * W + 70, sectionCount: g.length }, g.map((e, t) => a.createElement(r.Z, { key: `grokMessages${t}` }, a.createElement(ae, { atoms: e, isLoadingAny: ge, key: `PromptRow${t}` }), a.createElement(Y, { atoms: e, key: `InlineAttachmentGallery${t}`, onSelect: j }))).reverse(), a.createElement(ve, { promptTextSender: B }), a.createElement(Y, { atoms: u, key: "history", onSelect: j })))));
            }
            const Ce = d.default.create((e) => ({ inputContainer: { paddingBottom: e.spaces.space12, paddingStart: e.spaces.space2, paddingEnd: e.spaces.space2 }, contentWrapper: { paddingStart: e.spaces.space12, paddingEnd: e.spaces.space12, paddingBottom: e.spaces.space12, flex: 1, backgroundColor: e.colors.cellBackground }, presentPromptContainer: { gap: e.spaces.space32, flexDirection: "row", alignItems: "center", justifyContent: "center" } }));
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Grok-63cb1cc4.6e934f7a.js.map
