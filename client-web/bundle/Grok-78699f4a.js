    ...
    ["bundle.Grok-78699f4a"],
    {
        791786: (e, a, d) => {
            ...
            function W({ abortController: e, conversationKey: a, disableFileUploads: d, grokShare: u, hasAccess: c, inputAtBottom: W, inputAtHome: X, insideConversation: J, isIdle: Q, mode: q, onFieldTextInputRef: Y, placeholder: ee, promptSender: ae, useDraftPersistence: de, useMagicWandIcon: ne, useNonExpanded: oe }) {
                ...
                Ie = ve ? Ie : void 0;
                const Pe = (0, p.hC)("responsive_web_grok_file_upload_enabled"),
                    Be = (0, p.hC)("responsive_web_grok_show_citations"),
                    Re = (0, p.hC)("responsive_web_grok_personality_button_enabled"),
                    xe = (0, p.hC)("responsive_web_grok_new_home_layout"),
                    [Ze, Te] = n.useState(!1),
                    { loading: _e } = (0, E.Z)(),
                    Fe = n.useRef(_e),
                    Ne = n.useRef(null),
                    ...
                    je = (0, f.p)(),
                    He = Object.keys(Le).some((e) => Le[e]?.isUploading),
                    $e = Object.keys(Le).some((e) => Le[e]?.isPendingAutomaticPromptSend),
                    [Ue, We] = n.useState(""),
                    Ve = (0, o.Dv)(b.dd),
                    Xe = 0 === Ue.length,
                                ...
                                () =>
                                    (0, h.Z)((e) => {
                                        l &&
                                            t.get(H).then((a) => {
                                                const d = { ...a };
                                                d?.drafts || (d.drafts = new Map()), d?.drafts && d.drafts.set(l, e), t.set(H, d);
                                            });
                                    }, 500),
                                [t, l],
                            );
                ...
                const aa = ze.length > 0,
                    ...
                    na = n.useMemo(() => (Ue.trim().length > 0 || aa) && da && !$e, [Ue, aa, da, $e]),
                    ...
                    ua = (0, m.r)(async () => {
                        try {
                            if (ae)
                                ...
                                e ? (Te(!1), ze.forEach((e) => Ke(e)), We(""), le.push(`/i/grok?conversation=${e}&text=${encodeURIComponent(Ue)}`)) : je({ text: $ });
                            } else
                                Ae
                                    ? Ie &&
                                      (await te(
                ...
                const ha = n.useCallback(
                    ...
                    ba = n.useCallback(
                        (e) => {
                            pe || "Enter" !== e.key || e.shiftKey || (e.preventDefault(), na && ca());
                        },
                        [pe, na, ca],
                    ),
                    pa = n.useCallback(
                ...
                const ya = n.useMemo(() => n.createElement(L.Z, { fadeIn: Fe.current, isInProgress: !Q, isInputCompact: me, isLoading: Ze || $e, isSendEnabled: na, onSend: ca, onStop: ha, useMagicWandIcon: ne }), [Q, Ze, $e, na, ca, ha, ne, me]),
                    ka = n.useMemo(
                        () =>
                            n.createElement(
                                t.Z,
                                ...
                                n.createElement(
                                    ...
                                    Ma &&
                                        n.createElement(
                                            n.Fragment,
                                            null,
                                            n.createElement(F.Z, { disabled: ce, fadeIn: Fe.current, focused: be, isInputCompact: me, label: "", useButtonsForExpandedInput: !0 }),
                                            n.createElement(K.Z, {
                                                disabled: null !== Je,
                                                fadeIn: Fe.current,
                                                focused: be,
                ...
                return (
                    ...
                    n.useEffect(() => {
                        if ((Se.text.length > 0 && We(Se.text), Se.attachments.length > 0)) for (const e of Se.attachments) Oe(e);
                        Se.modeButtonFilterKey && (ye(Se.modeButtonFilterKey), Da()), (Se.text.length > 0 || Se.attachments.length > 0 || Se.modeButtonFilterKey) && te((0, w.Uo)(a, { text: "", attachments: [] }));
                    }, [Se, a, te, Oe, Da, ye]),
                    oe
                        ? n.createElement(
                              t.Z,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Grok-78699f4a.5de36a7a.js.map
