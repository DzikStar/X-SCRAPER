    ...
    ["bundle.Grok-bc6ccf4c", "shared~loader.JetfuelFrame~loader.TimelineFrameHandler~loader.PremiumLoaders~icons/IconAccountsStroke-js~icon"],
    {
            ...
            class c extends i.Component {
                ...
                render() {
                    const { activeStyle: e, allowDragDrop: t, children: r, style: l } = this.props,
                        { active: n } = this.state,
                        c = t ? s.dragBorderValid : s.dragBorderInvalid;
                    return i.createElement(o, { onDragEnter: this._handleDragEnter, onDragLeave: this._handleDragLeave, onDragOver: this._handleDragOver, onDrop: this._handleDragDrop, style: [s.root, l, n && c, n && e] }, i.createElement(a.Z, { style: s.inner }, "function" == typeof r ? r(n) : r));
                }
                _updateDragCount(e) {
                    (this._dragEnterCount = e), 0 === this._dragEnterCount ? this.setState({ active: !1 }) : this._dragEnterCount > 0 && this.setState({ active: !0 });
                }
            }
            c.defaultProps = { allowDragDrop: !0 };
        ...
        449161: (e, t, r) => {
            ...
            class m extends a.Component {
                ...
                render() {
                    const { accept: e, disabled: t, multiple: r, onChange: l, testID: n, ...s } = this.props,
                        m = !(e?.includes("video") || e?.includes("gif"));
                    return a.createElement(a.Fragment, null, a.createElement(o.ZP, (0, i.Z)({ hoverLabel: e ? { label: m ? h : d } : void 0 }, s, { disabled: t, onPress: this._handlePress })), (0, c.Z)("input", { accept: e, disabled: t, multiple: r, onChange: this._handleChange, ref: this._handleFileInputButtonRef, style: g.input, tabIndex: -1, testID: n, type: "file" }));
                }
            }
            m.defaultProps = { disabled: !1, multiple: !1 };
            const g = s.default.create((e) => ({ input: { width: "0.1px", height: "0.1px", opacity: 0, overflow: "hidden", position: "absolute", zIndex: -1 } })),
                p = m;
        },
        403556: (e, t, r) => {
            r.d(t, { Z: () => x });
            ...
            class C extends a.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: r, badgePip: i, children: l, color: n, isActive: s, isCompact: d, isPillLink: h, isRoundedRect: m, isWebRedesign: u, retainScrollPosition: C, style: Z, to: z } = this.props,
                        { location: x } = this.state,
                        D = z ? this._getMemoizedLink(z, C) : void 0,
                        M = s ? s(z) : x?.pathname === D?.pathname,
                        k = v.Z.generate({ backgroundColor: "transparent", color: o.default.theme.colors.text, insetFocusRing: !0 }),
                        _ = u ? "medium" : M ? "bold" : "medium";
                    return a.createElement(b.Z, { "aria-label": t, "aria-selected": M, focusable: !!M, interactiveStyles: k, link: D, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [h ? E.pill : E.link, h && M ? E.active : null, d ? (h ? E.compactPill : E.compactLink) : null, m ? E.roundedRect : null, Z], withoutInteractiveStyles: u || h }, ({ isFocused: t, isHovered: s }) => a.createElement(c.Z, { style: h && E.flexGrow }, a.createElement(g.ZP, { size: u ? "headline2" : void 0, style: [E.text, { color: this._getTextColor(M, s, u, h) }, d && E.compactText, u && t && E.focusedText], weight: _ }, e && a.createElement(e, { style: E.icon }), l, u || h ? null : a.createElement(c.Z, { style: M && [E.border, { backgroundColor: o.default.theme.colors[n] }] })), r ? a.createElement(p.Z, { count: r, standalone: !0, style: [E.badge, r >= 10 && E.multiDigitBadge, r >= 20 && E.truncatedCountBadge], truncatedCountFormatter: w, unreadCountLabel: f, withBorder: !1 }) : i ? a.createElement(p.Z, { pip: !0, standalone: !0, style: E.badgePip, textColor: "red500", unreadCountLabel: y, withBorder: !1 }) : null));
                }
            }
            ...
            const E = o.default.create((e) => ({
                ...
                x = ({ alignFirstItem: e, "aria-label": t, isCompact: r, isPillLink: o, isRoundedRect: c, links: s, style: d, visibleItemIndex: h }) => {
                    const m = s
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        u = a.useMemo(
                            () =>
                                s.filter(Boolean).map(({ label: t, viewType: l, ...n }, s) => {
                                    const d = p ? [z.linkRedesign, 0 === s && z.firstLinkRedesign, e && 0 === s && z.withNoPaddingStart] : void 0;
                                    return a.createElement(Z, (0, i.Z)({ viewType: l }, n, { isCompact: r, isPillLink: o, isRoundedRect: c, isWebRedesign: p, style: d }), t);
                                }),
                            [e, r, o, c, p, s],
                        );
        ...
        782947: (e, t, r) => {
            ...
            const p = g.default.create((e) => ({ backgroundGrey: { backgroundColor: e.colors.gray100 }, backgroundDefault: { backgroundColor: e.colors.cellBackground }, root: { overflow: "hidden", flexDirection: "row", justifyContent: "space-between", gap: e.spaces.space16, flexGrow: 1, borderColor: e.colors.transparent, borderWidth: e.borderWidths.medium }, alignCenter: { alignItems: "center" }, padding16: { padding: e.spaces.space16 }, padding8: { paddingHorizontal: e.spaces.space8, paddingVertical: e.spaces.space4 }, boxShadow: { boxShadow: e.boxShadows.medium }, withMarginTop: { marginTop: e.spaces.space20 }, borderRadiusLarge: { borderRadius: e.borderRadii.large }, borderRadiusInfinite: { borderRadius: e.borderRadii.infinite }, checked: { borderColor: e.colors.primary }, interactive: { cursor: "pointer" }, withMarginEnd: { marginEnd: e.spaces.space20 }, grow: { flexGrow: 1 }, iconContainer: { alignSelf: "flex-start", flexDirection: "column", justifyContent: "center", width: e.spaces.space40, height: e.spaces.space40 }, labelContainer: { flexDirection: "column", justifyContent: "center", flex: 1 }, inlineCalloutContainer: { marginTop: e.spaces.space8 }, description: { marginTop: e.spaces.space4 }, descriptionWithPill: { marginTop: e.spaces.space2 }, endContentContainer: { justifyContent: "center", flexDirection: "column" }, row: { flexDirection: "row", alignItems: "center" }, marginTop4: { marginTop: e.spaces.space4 }, marginBottom8: { marginBottom: e.spaces.space8 }, info: { flexDirection: "row", justifyContent: "space-between", marginBottom: e.spaces.space8 }, infoIcon: { fontSize: ".74em", color: e.colors.gray700 }, backgroundTransparent: { backgroundColor: e.colors.transparent }, pill: { marginBottom: e.spaces.space4 }, inlinePill: { marginStart: e.spaces.space4 } })),
                ...
                v = ({ "aria-label": e, "aria-posinset": t, "aria-setsize": r, checked: i, dedicatedPillRow: l, description: g, disabled: v, disabledInlineCallout: b, endContent: f, horizontal: y, illustration: w, infoLabel: C, infoLabelType: E, inlineCallout: Z, label: z, name: x, onChange: D, pillText: M, pillType: k, reverseLabels: _, secondaryContent: B, secondaryDescription: L, switchStyle: V, testID: H }) => {
                    const S = (0, m.b)(),
                        P = (0, m.b)(),
                        I = (0, m.b)(),
                        T = a.createElement(s.ZP, { color: V ? (i ? "text" : "gray800") : "text", id: S, role: "label", size: V ? "body" : "headline2", testID: "headline-label", weight: V ? "normal" : "bold" }, z),
                        R = !!g && a.createElement(s.ZP, { color: "gray700", id: P, size: "subtext1", style: M ? p.descriptionWithPill : p.description, testID: "description-label" }, g),
                        W = a.createElement(s.ZP, { color: "gray700", role: "label", size: "subtext2", style: p.description }, L),
                        F = M ? a.createElement(d.ZP, { style: l ? p.pill : p.inlinePill, type: k }, M) : null,
                        A = a.createElement(a.Fragment, null, l ? F : null, a.createElement(n.Z, { style: [p.row, C && p.marginBottom8] }, _ ? R : T, l ? null : F), a.createElement(n.Z, { style: [p.row, _ && p.marginTop4] }, _ ? T : R), B || (L ? W : void 0)),
                        j = V ? "unset" : (r ? 100 / r : 100) + "%",
                        $ = V ? [p.padding8, p.borderRadiusLarge, i ? p.backgroundDefault : p.backgroundTransparent] : [p.padding16, p.boxShadow, p.borderRadiusLarge, i ? p.checked : null, p.backgroundDefault];
                    return a.createElement(a.Fragment, null, a.createElement(h.Z, { disabled: v, style: [p.root, ...$, y ? { maxWidth: j, ...p.grow } : null, 1 === t || y ? null : p.withMarginTop, t !== r && y && !V && p.withMarginEnd, !v && p.interactive], testID: H, withInteractiveStyling: !V }, !!w && a.createElement(n.Z, { style: p.iconContainer, testID: "illustration" }, w), a.createElement(n.Z, { style: [p.labelContainer, V && p.alignCenter] }, !!C && a.createElement(n.Z, { style: p.info }, a.createElement(d.ZP, { background: "green" === E ? "green500" : "red" === E ? "magenta500" : "yellow" === E ? "orange50" : "gray500" }, a.createElement(s.ZP, { color: "yellow" === E ? "orange900" : "whiteOnColor", size: "subtext3", weight: "bold" }, C)), "red" !== E && "yellow" !== E && a.createElement(o.default, { style: p.infoIcon, testID: "infoIcon" })), A, i && !!Z && a.createElement(n.Z, { style: p.inlineCalloutContainer, testID: "inlineCallout" }, Z)), !!f && a.createElement(n.Z, { style: p.endContentContainer, testID: "endContent" }, a.createElement(s.ZP, { id: I, size: "subtext1", weight: "bold" }, f)), a.createElement("input", { "aria-describedby": `${P} ${I}`, "aria-label": e, "aria-labelledby": S, "aria-posinset": t, "aria-setsize": r, checked: i, disabled: v, name: x, onChange: i ? c.Z : D, style: u, type: "radio" })), v && b ? b : null);
                },
                b = (e) => {
        ...
        557707: (e, t, r) => {
            ...
            var i = r(807896),
                ...
                f = r(392237);
            const y = c().af8fa2ae,
                w = a.createElement(s.default, null);
            class C extends a.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderContentWithLayer = ({ windowWidth: e }) => {
                            const { LayerComponent: t, style: r, testID: l, variant: o } = this.props,
                                c = r?.length ? [...r] : [r],
                                s = o ? this._renderVariantContent() : this._renderContent();
                            return a.createElement(
                                t,
                                null,
                                a.createElement(
                                    ...
                                    a.createElement(u.Z, { id: "Toast" }, (t, r) => a.createElement(n.Z, (0, i.Z)({ ref: t() }, r({ role: "alert", style: [E.root, o && this._getRootVariantStyle(), ...c, e > f.default.theme.breakpoints.medium && E.rootWide], testID: l })), s)),
                                ),
                            );
                        }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Grok-bc6ccf4c.0d1ce5fa.js.map
