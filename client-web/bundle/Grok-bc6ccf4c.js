    ...
    ["bundle.Grok-bc6ccf4c", "shared~loader.JetfuelFrame~loader.TimelineFrameHandler~loader.PremiumLoaders~icons/IconAccountsStroke-js~icon"],
    {
            ...
            class y extends i.Component {
                ...
                render() {
                    ...
                    return i.createElement(p.ZP.Consumer, null, ({ direction: p }) => {
                        ...
                        return i.createElement(u.Z.Modal, null, i.createElement(g.Z, null, i.createElement(m.Z, null, i.createElement(l.Z, { onClick: this._handleMaskClick, onKeyUp: this._handleEsc, style: [C.mask, x, M, b ? C.backgroundBlur : null, "left" === t ? C.alignLeft : C.alignRight] }, (0, h.Z)("div", { role: "dialog", onTransitionEnd: this._handleTransitionEnd, ref: this._setAnimationNode, onClick: w, style: [C.root, b ? C.backgroundRootBlur : null, Z, M, n], children: i.createElement(i.Fragment, null, f ? i.createElement(c.Z, { leftControl: "left" === t ? e : "right" === t ? this._renderCloseButton(r) : null, rightControl: "left" === t ? this._renderCloseButton(r) : "right" === t ? e : null, style: v, subtitle: o, title: d }) : null, i.createElement(l.Z, { style: C.contentContainer }, a)) })))));
                    });
                }
            ...
            class C extends l.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: r, badgePip: i, children: a, color: n, isActive: c, isCompact: d, isPillLink: h, isRoundedRect: m, isWebRedesign: p, retainScrollPosition: C, style: E, to: Z } = this.props,
                        ...
                        k = v.Z.generate({ backgroundColor: "transparent", color: o.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: h ? z.pillHoverStyle.backgroundColor : void 0 }),
                        _ = p ? "medium" : M ? "bold" : "medium";
                    return l.createElement(b.Z, { "aria-label": t, "aria-selected": M, focusable: !!M, interactiveStyles: k, link: D, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(h ? [z.pillStyle] : [z.link]), ...(h && M ? [z.pillActiveStyle] : []), d ? (h ? z.compactPill : z.compactLink) : null, m ? z.roundedRect : null, E], withoutInteractiveStyles: p }, ({ isFocused: t, isHovered: c }) => l.createElement(s.Z, { style: h && z.flexGrow }, l.createElement(g.ZP, { size: p ? "headline2" : void 0, style: [z.text, { color: this._getTextColor(M, c, p, h) }, d && z.compactText, p && t && z.focusedText, h && z.pillTextStyle, h && M && z.pillActiveTextStyle, h && c && z.pillHoverTextStyle], weight: _ }, e && l.createElement(e, { style: z.icon }), a, p || h ? null : l.createElement(s.Z, { style: M && [z.border, { backgroundColor: o.default.theme.colors[n] }] })), r ? l.createElement(u.Z, { count: r, standalone: !0, style: [z.badge, r >= 10 && z.multiDigitBadge, r >= 20 && z.truncatedCountBadge], truncatedCountFormatter: w, unreadCountLabel: f, withBorder: !1 }) : i ? l.createElement(u.Z, { pip: !0, standalone: !0, style: z.badgePip, textColor: "red500", unreadCountLabel: y, withBorder: !1 }) : null));
                }
            }
        ...
        782947: (e, t, r) => {
            ...
            const u = g.default.create((e) => ({ backgroundGrey: { backgroundColor: e.colors.gray100 }, backgroundDefault: { backgroundColor: e.colors.cellBackground }, root: { overflow: "hidden", flexDirection: "row", justifyContent: "space-between", gap: e.spaces.space16, flexGrow: 1, borderColor: e.colors.transparent, borderWidth: e.borderWidths.medium }, alignCenter: { alignItems: "center" }, padding16: { padding: e.spaces.space16 }, padding8: { paddingHorizontal: e.spaces.space8, paddingVertical: e.spaces.space4 }, boxShadow: { boxShadow: e.boxShadows.medium }, withMarginTop: { marginTop: e.spaces.space20 }, borderRadiusLarge: { borderRadius: e.borderRadii.large }, borderRadiusInfinite: { borderRadius: e.borderRadii.infinite }, checked: { borderColor: e.colors.primary }, interactive: { cursor: "pointer" }, withMarginEnd: { marginEnd: e.spaces.space20 }, grow: { flexGrow: 1 }, iconContainer: { alignSelf: "flex-start", flexDirection: "column", justifyContent: "center", width: e.spaces.space40, height: e.spaces.space40 }, labelContainer: { flexDirection: "column", justifyContent: "center", flex: 1 }, inlineCalloutContainer: { marginTop: e.spaces.space8 }, description: { marginTop: e.spaces.space4 }, descriptionWithPill: { marginTop: e.spaces.space2 }, endContentContainer: { justifyContent: "center", flexDirection: "column" }, row: { flexDirection: "row", alignItems: "center" }, marginTop4: { marginTop: e.spaces.space4 }, marginBottom8: { marginBottom: e.spaces.space8 }, info: { flexDirection: "row", justifyContent: "space-between", marginBottom: e.spaces.space8 }, infoIcon: { fontSize: ".74em", color: e.colors.gray700 }, backgroundTransparent: { backgroundColor: e.colors.transparent }, pill: { marginBottom: e.spaces.space4 }, inlinePill: { marginStart: e.spaces.space4 } })),
                ...
                v = ({ "aria-label": e, "aria-posinset": t, "aria-setsize": r, checked: i, dedicatedPillRow: a, description: g, disabled: v, disabledInlineCallout: b, endContent: f, horizontal: y, illustration: w, infoLabel: C, infoLabelType: z, inlineCallout: E, label: Z, name: x, onChange: D, pillText: M, pillType: k, reverseLabels: _, secondaryContent: B, secondaryDescription: S, switchStyle: V, testID: H }) => {
                    const L = (0, m.b)(),
                        T = (0, m.b)(),
                        I = (0, m.b)(),
                        P = l.createElement(c.ZP, { color: V ? (i ? "text" : "gray800") : "text", id: L, role: "label", size: V ? "body" : "headline2", testID: "headline-label", weight: V ? "normal" : "bold" }, Z),
                        R = !!g && l.createElement(c.ZP, { color: "gray700", id: T, size: "subtext1", style: M ? u.descriptionWithPill : u.description, testID: "description-label" }, g),
                        W = l.createElement(c.ZP, { color: "gray700", role: "label", size: "subtext2", style: u.description }, S),
                        F = M ? l.createElement(d.ZP, { style: a ? u.pill : u.inlinePill, type: k }, M) : null,
                        A = l.createElement(l.Fragment, null, a ? F : null, l.createElement(n.Z, { style: [u.row, C && u.marginBottom8] }, _ ? R : P, a ? null : F), l.createElement(n.Z, { style: [u.row, _ && u.marginTop4] }, _ ? P : R), B || (S ? W : void 0)),
                    ...
                    return l.createElement(l.Fragment, null, l.createElement(h.Z, { disabled: v, style: [u.root, ...$, y ? { maxWidth: j, ...u.grow } : null, 1 === t || y ? null : u.withMarginTop, t !== r && y && !V && u.withMarginEnd, !v && u.interactive], testID: H, withInteractiveStyling: !V }, !!w && l.createElement(n.Z, { style: u.iconContainer, testID: "illustration" }, w), l.createElement(n.Z, { style: [u.labelContainer, V && u.alignCenter] }, !!C && l.createElement(n.Z, { style: u.info }, l.createElement(d.ZP, { background: "green" === z ? "green500" : "red" === z ? "magenta500" : "yellow" === z ? "orange50" : "gray500" }, l.createElement(c.ZP, { color: "yellow" === z ? "orange900" : "whiteOnColor", size: "subtext3", weight: "bold" }, C)), "red" !== z && "yellow" !== z && l.createElement(o.default, { style: u.infoIcon, testID: "infoIcon" })), A, i && !!E && l.createElement(n.Z, { style: u.inlineCalloutContainer, testID: "inlineCallout" }, E)), !!f && l.createElement(n.Z, { style: u.endContentContainer, testID: "endContent" }, l.createElement(c.ZP, { id: I, size: "subtext1", weight: "bold" }, f)), l.createElement("input", { "aria-describedby": `${T} ${I}`, "aria-label": e, "aria-labelledby": L, "aria-posinset": t, "aria-setsize": r, checked: i, disabled: v, name: x, onChange: i ? s.Z : D, style: p, type: "radio" })), v && b ? b : null);
                },
                b = (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Grok-bc6ccf4c.915c04ea.js.map
