    ...
    ["bundle.Grok-c69e90f3"],
    {
        663587: (e, t, a) => {
            ...
            function x({ onDismiss: e }) {
                ...
                const [P, L] = n.useState(S.G.all),
                    ...
                    B = n.useMemo(() => (c ? n.createElement(Z.D, { query: c, queryKey: x }) : P === S.G.images ? n.createElement(k.v, null) : P === S.G.pins ? n.createElement(b.s, null) : n.createElement(w.c, { onSearchSubmit: R, searchKey: x, searchValue: c ?? "" })), [c, x, P, R]),
                    [D] = (0, y.ZP)();
                return n.createElement(h.nO, { namespace: I }, n.createElement(u.Z, null, D ? n.createElement(f.T, { documentTitle: v }) : null, n.createElement(m.Z, { customSearchBox: l ? n.createElement(C.v, { initialValue: c ?? "", onSubmit: R }) : void 0, documentTitle: v, history: t, isFullWidth: !0, onBackClick: A, primaryContent: n.createElement(s.Z, { style: T.container }, d.ZP.isWebView() ? n.createElement(r.Z, { size: "space56" }) : null, B), primaryContentLabel: v, rightControl: n.createElement(n.Fragment, null), secondaryBar: c ? null : n.createElement(S.k, { onTabChange: L, selectedTab: P }), sidebarContent: null, title: l ? void 0 : v, withBorderLessLayout: D, withSearchBox: l })));
            }
        ...
        86629: (e, t, a) => {
            ...
            function C() {
                ...
                return t ? n.createElement(v, { conversationKey: t, defaultEditMode: r, fileAttachments: o, indexArg: s, intermediateImageResults: l, messageId: a }) : n.createElement(g.Z, { to: "/home" });
            }
            const Z = [],
                S = [],
                I = [];
            function v({ conversationKey: e, defaultEditMode: t, fileAttachments: a, indexArg: o, intermediateImageResults: C, messageId: v }) {
                (0, _.n)(!0);
                const [T, M] = n.useState(t),
                    ...
                    N = v || z[z.length - 1],
                    U = (0, p.bD)(e),
                    F = (0, u.v9)((e) => U.selectMessageById(e, K ? N : null)),
                    O = a || F.fileAttachments || S,
                    H = C || F.intermediateImageResults || I,
                ...
                const se = T ? n.createElement(E.eQ, { contentUrl: ne || "", conversationKey: e, grokFile: ae, onSend: A, setEditMode: M }) : n.createElement(E.rO, { allMediaIds: W, allMediaUrls: $, contentUrl: ne, isLoading: !ne, mediaId: ee, mediaUrl: te, setEditMode: M });
                return n.createElement(
                    d.Z.Configure,
                    { headerless: !0 },
                    n.createElement(
                        c.Z,
                        { backgroundColor: (0, m.L$)(), footerButtons: se, forceDominantButtonColor: !0, onCloseButtonPress: A },
                        n.createElement(
                            s.Z,
                            ...
                            j.width &&
                                ...
                                n.createElement(
                                    ...
                                    O.map((e, t) => {
                                        const a = W[t],
                                            i = O.find((e) => e.mediaId === a) ?? { fileName: "image", mimeType: "image/jpeg" },
                                            r = H.filter((e) => e.imageIdStr === a),
                                            o = D ? F.expectedImageAspectRatio || k : V[t] || k,
                                            l = V[t] || D ? Math.min(j.width, j.height * o) * G : void 0;
                                        return n.createElement(
                                            s.Z,
                                            { key: `slot_${t}`, style: [j, x.center] },
                                            n.createElement(f.Z, {
                                                aspectRatio: F.expectedImageAspectRatio,
                                                centerJustify: !0,
                                                file: i,
                                                height: j.height * G,
        ...
        177695: (e, t, a) => {
            ...
            const g = (e) => {
                    ...
                    return n.createElement(d.Z.Configure, { headerless: !0 }, n.createElement(c.Z, { backgroundColor: (0, m.L$)(), forceDominantButtonColor: !0, onCloseButtonPress: Z }, n.createElement(s.Z, { style: f.container }, E ? n.createElement(r.Z, null) : n.createElement(o.Z, { onLoad: () => a(1), resizeMode: "center", source: S, style: [f.image, f.imageTransition, { opacity: t }] }))));
                },
        ...
        365803: (e, t, a) => {
            ...
            const J = (e, t) => (0, Y.UM)(e, t.grokShareId),
                ...
                re = ee(({ grokShare: e, grokShareId: t }) => {
                    (0, Q.Z)();
                    const a = (0, y.hC)("responsive_web_grok_download_favicons"),
                        s = (0, w.I0)(),
                        r = (0, w.v9)(k.Qb),
                        l = (0, Z.eX)();
                    n.useEffect(() => {
                        s(W.ZP.fetchOneIfNeeded(V.c0));
                    }, [s]),
                        n.useEffect(() => {
                            s((0, F.V)(t));
                        }, [s, t]);
                    const c = (0, o.LX)(),
                        d =
                            e?.items
                                ...
                                .flat()
                                .filter(Boolean) ?? [],
                        m = d.length > 0 ? d[d.length - 1] : void 0,
                        u = (0, N.K)(e?.items[e.items.length - 1].message || "");
                    return n.createElement(
                        G.BQ,
                        { isCompactLayout: c, isEditingEnabled: !1, isGrokShare: !0, isPagedScroll: !1, isShowButtons: !1, isShowCarousel: !0, scrollable: window },
                        n.createElement(
                            i.Z,
                            { style: [ie.container, c ? ie.narrowContainer : void 0] },
                            n.createElement(
                                i.Z,
                                { style: ie.content },
                                2 === e?.items.length && n.createElement(D.ql, null, n.createElement("meta", { content: e.items[0].message, property: "og:title" }), n.createElement("meta", { content: u, property: "og:description" }), m ? n.createElement("meta", { content: m, property: "og:image" }) : null),
                                c ? null : n.createElement(z.Z, { size: "space32" }),
                                e?.items
                                    .map((e, t) => {
                                        if ((e.message || e.thinking_trace || (e.deepsearch_headers && e.deepsearch_headers.length > 0)) && e.sender) {
                                            const i = e.message,
                                                r = "User" === e.sender ? O.CI.HUMAN : O.CI.ASSISTANT,
                                                o = r === O.CI.ASSISTANT && !i;
                                            let l,
                                                c = "";
                                            e.thinking_trace && (c = e.thinking_trace), e.ui_layout?.reasoning_ui_layout && ("Split" === e.ui_layout.reasoning_ui_layout ? (l = "SPLIT") : "Unified" === e.ui_layout.reasoning_ui_layout && (l = "UNIFIED"));
                                            const d = (e.file_attachments ?? []).map((e) => ({ mediaId: e.media_id, fileName: e.file_name ?? ne, mimeType: e.mime_type ?? se, url: e.url, isPublic: !0 })),
                                                m = [];
                                            ...
                                            let u = [],
                                                ...
                                                g = [],
                                                f = {};
                                            e.deepsearch_args && (f = e.deepsearch_args);
                                            const y = new U.fQ({ deepsearchArgs: f });
                                            if (e.deepsearch_headers && e.deepsearch_headers.length > 0) {
                                                const t = [];
                                                for (const n of e.deepsearch_headers) {
                                                    const e = [];
                                                    for (const t of n.steps) {
                                                        const n = (t.x_post_ids || []).map((e) => e),
                                                            s = (t.web_results || []).map((e) => ({ url: e.url, favicon: e.favicon, favicon_base64: e.favicon_base64, language: e.language, snippet: e.snippet, title: e.title })),
                                                            i = [];
                                                        if (t.tool_usage_card_results)
                                                            for (const e of t.tool_usage_card_results) {
                                                                const t = { toolUsageCardId: e.tool_usage_card_id, webResults: (e.web_results || []).map((e) => (a && (e.favicon || e.favicon_base64 || (e.favicon = (0, O.TK)(e.url))), e)), xPostIds: (e.x_post_ids || []).map((e) => e) };
                                                                i.push(t), s.push(...(e.web_results || [])), n.push(...(e.x_post_ids || []));
                                                            }
                                                        u.push(...n), h.push(...s), e.push({ header: t.header || "", assistant: t.assistant || "", decision: t.decision || "", finalMessage: t.final_message || "", functionCall: t.function_call || "", rawFunctionResult: t.raw_function_result || "", summary: t.summary || "", webResults: s, xPostIds: n, toolUsageCardResults: i });
                                                    }
                                                    t.push({ header: n.header || "", steps: e }), s(H.Z.fetchMultiple(u));
                                                }
                                                y.initiateFromHistoryResponses(t);
                                            } else e.post_ids_results && ((u = e.post_ids_results?.map((e) => e.result?.rest_id).filter(Boolean)), (u = u.filter((e, t, a) => t === a.findIndex((t) => t === e)))), e.media_post_ids_results && (p = e.media_post_ids_results?.map((e) => e.result?.rest_id).filter(Boolean)), e.web_results && ((h = [...e.web_results]), (h = h.filter((e, t, a) => t === a.findIndex((t) => t.url === e.url)))), e.cited_web_results && (g = [...e.cited_web_results]);
                                            return r === O.CI.ASSISTANT ? n.createElement(q.Z, { bannerMessages: [], cardAttachments: m, citedWebResults: g, conversationKey: "", fileAttachments: d, id: t.toString(), isLoading: o, isPastThinkingTrace: "" !== c, key: t.toString(), mediaTweetIds: p, messageStepAccumulator: y, reasoningLayout: l, sender: r, text: i, trace: c, tweetIds: u, webResults: h }) : n.createElement(j.Z, { conversationKey: "", fileAttachments: d, hasCustomization: e.has_customization, id: t.toString(), key: t.toString(), text: i });
                                        }
                                        return null;
                                    })
                                    .filter((e) => !!e),
                            ...
                            r && n.createElement(i.Z, { style: ie.inputContainer }, n.createElement(i.Z, { style: ie.inputWrap }, n.createElement($.Z, { conversationKey: l, disableFileUploads: !0, grokShare: t, hasAccess: !0, isIdle: !0, placeholder: te, useNonExpanded: !0 }), n.createElement(i.Z, { style: ie.inputWrapDisclamer }, n.createElement(P.ZP, { color: "gray500", size: "subtext1" }, ae)))),
                        ),
                    );
                }),
        ...
        206089: (e, t, a) => {
            ...
            function W({ item: e }) {
                ...
                const E = (0, U.I0)(),
                    ...
                    C = { avatarUri: l, entities: {}, name: o?.name, screenName: o?.screen_name, userId: "userId" },
                    Z = n.useMemo(() => ({ height: t - v }), [t]),
                    { openGrok: S } = (0, O.Z)(),
                    [W, $] = n.useState(!1),
                    q = n.useCallback(() => {
                        $(!0);
                ...
                return n.createElement(
                    ...
                    n.createElement(
                        ...
                        n.createElement(
                            ...
                            n.createElement(M.ZP, (0, x.Z)({ displayMode: "SubscribableUser", style: j.flex, withLink: !0 }, C)),
                            n.createElement(
                                s.Z,
            ...
            function Q() {
                ...
                return n.createElement(s.Z, { style: m }, n.createElement(E.Z, null, n.createElement(n.Suspense, { fallback: null }, n.createElement(V, { onDataUpdate: a }))), n.createElement(y.Z, { data: e, getItemLayout: u, initialScrollIndex: i, keyExtractor: G, onEndReached: t, onEndReachedThreshold: 5, onScroll: p, ref: d, removeClippedSubviews: !0, renderItem: c, showsVerticalScrollIndicator: !1, style: m }));
            }
