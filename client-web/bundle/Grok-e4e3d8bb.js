...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Grok-e4e3d8bb"],
    {
        ...
        309401: (e, a, d) => {
            ...
            const h = ({ analytics: e, api: a, atoms: d, enableGrokApiHost: r, eventTag: n, requestBody: t }) => {
                const i = (function () {
                ...
                return (
                    ...
                    a.fetchClient
                        ...
                        .then(async (a) => {
                            ...
                            return (
                                clearTimeout(u),
                                (async function a({ done: u, value: h }) {
        ...
        965728: (e, a, d) => {
            d.d(a, { C_: () => S, I5: () => p, K2: () => D, L$: () => l, Rb: () => m, nk: () => h, sI: () => w, xr: () => A });
            var r = d(202784),
                o = d(483677),
                n = d(782578),
                t = d(393058),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Grok-e4e3d8bb.9d18798a.js.map
