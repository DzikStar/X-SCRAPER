...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Grok-f8a31592"],
    {
        ...
        299399: (e, t, a) => {
            ...
            const D = r.default.create((e) => ({ headerContainer: { width: "100%", transition: "background-color 0.2s ease" }, cardHeader: { display: "flex", flexDirection: "row", width: "100%", justifyContent: "space-between", alignItems: "center" }, infoContainer: { color: e.colors.gray700, display: "flex", flexDirection: "column", gap: 6 }, icon: { color: e.colors.gray700, transition: "transform 0.2s ease", height: e.spaces.space16, width: e.spaces.space16 }, expandedIcon: { transform: "rotate(90deg)" }, thinkingLabel: { flexDirection: "row", gap: e.spaces.space4, alignItems: "center" }, elapsedTime: { color: e.colors.text, fontSize: e.fontSizes.body }, iconContainer: { position: "relative", width: e.spaces.space16, height: e.spaces.space16 }, lightBulbIcon: { fill: "none", color: e.colors.text, position: "absolute", top: "50%", start: "50%", transform: "translate(-50%, -50%)", width: "100%", height: "100%", opacity: 0 }, loadingIcon: { position: "absolute", top: "50%", start: "50%", transform: "translate(-25%, -76%)", width: "100%", height: "100%", opacity: 0 }, iconVisible: { opacity: 1, animationDuration: "0.5s", animationKeyframes: [{ "0%": { opacity: 0 }, "100%": { opacity: 1 } }] }, iconHide: { opacity: 0, animationDuration: "0.5s", animationKeyframes: [{ "0%": { opacity: 1 }, "100%": { opacity: 0 } }] } }));
                ...
                return (
                    ...
                    n.createElement(
                        ...
                        n.createElement(
                            ...
                            ({ isHovered: o }) => n.createElement(s.Z, { style: z.headerContainer }, n.createElement(I, { completed: e, completedTimestamp: t, expanded: x, fromTimestamp: a, id: b, isPastSummary: C }), C ? null : n.createElement(s.Z, { style: [{ width: "100%", height: 150, position: "relative" }, { display: h || x ? "none" : "flex" }] }, n.createElement(g.w, { charLimit: 2e3, text: w }), n.createElement(c.Z, { angle: 0, colors: D(), style: z.traceGradientTop }), n.createElement(c.Z, { angle: 180, colors: D(), style: z.traceGradientBottom }))),
                        ),
                        n.createElement(s.Z, { style: [z.collapsedOuterThinkingContainer, x ? z.expandedOuterThinkingContainer : void 0] }, n.createElement(s.Z, { style: { position: "relative" } }, n.createElement(m.Z, { size: "space8" }), n.createElement(o.Z, { contentContainerStyle: z.thinkingContentContainer, ref: T, showsVerticalScrollIndicator: !1, style: z.thinkingContainer }, n.createElement(y.default, { disableCodeBlockStickyHeader: !0, disableLinks: d.ZP.isWebView(), isAnimated: !1, markdownText: w, style: z.markdownStyle }), n.createElement(s.Z, { ref: k, style: { position: "relative", top: -250, width: 100, height: 1 } })), n.createElement(m.Z, { size: "space8" }), n.createElement(c.Z, { angle: 0, colors: D(), style: z.thinkingGradientTop }), n.createElement(c.Z, { angle: 180, colors: D(), style: z.thinkingGradientBottom }))),
                    )
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Grok-f8a31592.78bf78da.js.map
