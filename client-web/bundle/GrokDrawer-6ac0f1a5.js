...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ...
    {
        448781: (e, a, n) => {
            n.d(a, { XD: () => g, ZP: () => S, eK: () => y, p9: () => v, pB: () => w, yF: () => k, z_: () => M });
            var o = n(202784),
                d = n(214997),
                r = n(325686),
                t = n(731708),
            ...
            const p = u().g7b1c574,
                ...
                M = "deeper",
                A = [
                    { label: g, description: k, value: w },
                    { label: v, description: y, value: M },
                ],
                ...
                S = () => {
                    ...
                    return o.createElement(
                        r.Z,
                        { style: C.container },
                        o.createElement(d.Z, { contentContainerStyle: [C.contentContainerScrollView, g ? C.compactContentContainerScrollView : void 0], style: C.scrollView }, o.createElement(t.ZP, { style: C.title, weight: "bold" }, f), o.createElement(t.ZP, { style: C.subtitle }, D), o.createElement(r.Z, { style: C.section }, o.createElement(l.Z, { horizontal: !g, name: "", onChange: k, options: A, value: n?.deepsearchArgs?.mode || A[0].value }))),
                        o.createElement(
                            r.Z,
                            { style: [C.buttonContainer, g ? C.compactButtonContainer : void 0] },
                            o.createElement(
                                i.ZP,
                                {
        ...
        357606: (e, a, n) => {
            ...
            function q({ conversationUrl: e }) {
                ...
                return d.createElement(
                    ...
                    o
                        ? d.createElement(w.Z, { onMiddleControlClick: l, rightControl: d.createElement(Y, { conversationUrl: e, handleToggleVisibility: l, isExpanded: o, onClose: i }), style: ee.roundedAppBarCorners, title: d.createElement(r.Z, { style: ee.titleContainer }, d.createElement(y.x1, null), d.createElement(L, null)) })
                        : d.createElement(
                              k.Z,
                              {
                                  onPress: () => {
            ...
            function oe({ width: e }) {
                const a = (0, u.cm)(),
                    ...
                    k =
                        ((w = n),
                        (0, D.Zx)(({ windowHeight: e }) => {
                            const a = g.I2.find((a) => w <= Math.ceil(e * a));
                ...
                const A = d.useCallback(
                    ...
                    C = d.useMemo(() => [g.ZP.allowPointer, g.ZP.main, y ? { minHeight: k, maxWidth: null } : g.ZP.collapsedSmall], [y, k]);
                return (function () {
        ...
        807901: (e, a, n) => {
            ...
            function f() {
                const e = (0, s.I0)(),
                    ...
                    v = (0, d.useLocation)(),
                    y = o.useCallback(() => {
                        const o = new URLSearchParams(v.search),
                    ...
                    M = o.useCallback(() => {
                        r && (e(a.clearConversation()), n.push("/i/grok"), (0, b.ZY)(w), g());
                    }, [w, r, e, a, n, g]),
                    A = o.useCallback(() => {
                        r && (e(a.clearConversation()), (0, b.ZY)(w), g());
                    }, [w, r, e, a, g]),
                    C = o.useCallback(
                        (e) => {
                            const a = [
                                {
                                    disabled: D === c.IK.REGULAR,
                                    onClick: function () {
                                        f(c.IK.REGULAR, w);
                                    },
                                    text: p,
                ...
                return { canClearConversation: r, handleBackClick: y, handleClearConversationClick: M, handleClearConversationClickWithoutNav: A, isEligible: k, renderActionsMenu: C };
            }
        },
        654917: (e, a, n) => {
            ...
            function p() {
                const { userClaims: e } = (0, l.QZ)(),
                    ...
                    D = (0, s.v9)(n.selectMode),
                    g = (0, s.v9)(n.selectStatus),
                    k = (0, s.v9)(c.Pt),
                ...
                e.isTrueAndEnabled("subscriptions_inapp_grok") ? (S = "premium") : (E || y) && (S = v.length > 0 ? "restricted" : "free");
                const I = o.useCallback(
                        async (e, a) => {
                            D !== e && (t(n.setMode(e)), r.ZP.isTwitterApp() || (await t((0, u.O)(e, M))), (0, b.RC)(a, e));
                        },
                        [t, n, D, M],
                    ),
                    _ = o.useCallback(
                        async (e, a, n) => {
                            e !== M && (t((0, c.j1)(e, a)), r.ZP.isTwitterApp() || (await t((0, u.O)(D, e))), (0, b.JO)(n, e));
                        },
                        [t, D, M],
                    );
                return { messageIds: d, access: S, status: g, grokSettingsStatus: k, conversationKey: a, conversationId: w, analysisEntityId: A, accessRestrictedReasons: v, fetchConversationIdStatus: p, fetchConversationIdError: f, mode: D, model: M, changeMode: I, changeModel: _, usingExperiment: C };
            }
        },
        962379: (e, a, n) => {
            n.d(a, { Z: () => l });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.GrokDrawer-6ac0f1a5.2130052a.js.map
