        ...
        6157: (e, t, s) => {
            ...
            function A({ apiClient: e }) {
                return {
                    ...
                    setPreferences: ({ grokMode: t, grokModelOptionId: s }) => e.graphQL(L(), { grokMode: t, grokModelOptionId: s }).then((e) => (e.set_grok_preferences?.preference_update_error?.error_code && (0, o.ZP)("GraphQL set grok preferences failed."), e)),
                    fetchConversation: ({ restId: t }) => e.graphQL(c(), { restId: t }).then((e) => e),
                    fetchGrokShareGraphQL: ({ grok_share_id: t }) => e.graphQL(R(), { grok_share_id: t }).then((e) => e),
                ...
                new Promise((a, r) => {
                    ...
                    (i.responseType = "blob"),
                        (i.onreadystatechange = () => {
                            i.readyState === window.XMLHttpRequest.DONE && (200 === i.status ? a(i.response) : r(new Error("Unexpected status code")));
                        }),
                        (i.withCredentials = t),
                        (i.onerror = (e) => r(e)),
                        (i.ontimeout = (e) => r(e)),
                        i.open("GET", o.toString(), !0),
                        i.send();
                });
        },
        397159: (e, t, s) => {
                    ...
                    (this.initiateFromHistoryResponses = (e, t = !1) => {
                                ...
                                switch (e.messageTag) {
                                    ...
                                    case c.SUMMARY: {
                                        ...
                                        if (s) {
                                            ...
                                            if ((t.trim() && (_.bulletPoints = [...(_.bulletPoints || []), t]), e.webResults && e.webResults.length && (this.addWebResults(e.webResults || []), e.toolUsageCardId))) {
                                                const t = _.toolUsageCardResults?.map((t) => (t.toolUsageCardId === e.toolUsageCardId ? { ...t, webResults: e.webResults } : t));
                                                _.toolUsageCardResults = t;
                                            }
                                            if (e.xPostIds && e.xPostIds.length && (this.addXPostIds(e.xPostIds || []), e.toolUsageCardId)) {
                                                const t = _.toolUsageCardResults?.map((t) => (t.toolUsageCardId === e.toolUsageCardId ? { ...t, xPostIds: e.xPostIds } : t));
                                                _.toolUsageCardResults = t;
                                            }
                                        }
                                    ...
                                    case c.DECISION: {
                                        ...
                                        (_.actionIcon = this.getIconForDecisionAction(t)), (_.actionType = t?.action), (_.actionSummary = a), (_.actionMarkdownSummary = s), (u = !0);
                                        break;
                                    }
                                    case c.RAW_FUNCTION_RESULT:
                                        if (!((e.webResults && e.webResults.length) || (e.xPostIds && e.xPostIds.length))) break;
                                        e.webResults && ((_.webResults = e.webResults), this.addWebResults(e.webResults || [])), e.xPostIds && ((_.xPostIds = e.xPostIds), this.addXPostIds(e.xPostIds || [])), _.actionState, (u = !0);
                                }
                                u && ((o.subSteps[i] = { ..._ }), (o.subSteps = [...o.subSteps]));
                            } else {
                                let t = null;
                                switch (e.messageTag) {
                                    case c.ASSISTANT:
                                    ...
                                    case c.SUMMARY: {
                                        ...
                                        t = { messageStepId: e.messageStepId, messageTag: e.messageTag, summary: a, toolUsageCardResults: s ? [{ toolUsageCardId: s.id, webResults: e.webResults, xPostIds: e.xPostIds }] : [], bulletPoints: r };
                                        break;
                                    }
                                    case c.DECISION: {
                        ...
                        (this.complete = (e = !0) => {
                            "COMPLETED" !== this.state &&
                                ...
                                e && this.steps.push({ id: r().v4(), state: p.COMPLETED, header: _, subSteps: [], isCompleteHeader: !0 }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.GrokDrawer-9f4db315.71bde5ba.js.map
