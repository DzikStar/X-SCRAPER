        ...
        237983: (e, a, t) => {
            ...
            const oe = s.default.create((e) => ({ tabsContainer: { display: "flex", flexDirection: "row" }, tabs: { flexBasis: 1, flexGrow: 1, paddingEnd: e.spaces.space4 }, rightControlContainer: { borderBottomColor: e.colors.borderColor, borderBottomStyle: "solid", borderBottomWidth: e.borderWidths.small, justifyContent: "center", paddingHorizontal: e.spaces.space8 }, focusedModeRightControlContainer: { paddingHorizontal: 0 } })),
                de = j(function ({ analytics: e, createLocalApiErrorHandlerFetchPins: a, fetchPinnedTimelinesIfNeeded: t, isSubscriber: o, onRefresh: d, pinnedTimelines: i, rightControl: l, selectedTimeline: s, sort: c, updateSettings: u }) {
                    ...
                    const C = (0, O.ZP)();
                    return l ? r.createElement(n.Z, { style: oe.tabsContainer }, r.createElement(N.Z, { alignFirstItem: C, links: S, style: oe.tabs }), r.createElement(n.Z, { style: [oe.rightControlContainer, w && oe.focusedModeRightControlContainer] }, l), b && r.createElement(Q, { onChange: f, onDismiss: g, value: c })) : r.createElement(r.Fragment, null, r.createElement(N.Z, { alignFirstItem: C, links: S }), b && r.createElement(Q, { onChange: f, onDismiss: g, value: c }));
                });
            var ie = t(652904),
                le = t(614983),
                se = t.n(le),
                    ...
                    loader: () =>
                        (Le.H1.preload() || Promise.resolve()).then(() =>
                            Promise.all([
                                ...
                                t.e("shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-719a1591"),
        ...
        403556: (e, a, t) => {
            ...
            class w extends n.Component {
                ...
                render() {
                    ...
                    return n.createElement(g.Z, { "aria-label": a, "aria-selected": E, focusable: !!E, interactiveStyles: _, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? C.pill : C.link, u && E ? C.active : null, c ? (u ? C.compactPill : C.compactLink) : null, p ? C.roundedRect : null, M], withoutInteractiveStyles: h || u }, ({ isFocused: a, isHovered: s }) => n.createElement(l.Z, { style: u && C.flexGrow }, n.createElement(b.ZP, { size: h ? "headline2" : void 0, style: [C.text, { color: this._getTextColor(E, s, h, u) }, c && C.compactText, h && a && C.focusedText], weight: T }, e && n.createElement(e, { style: C.icon }), o, h || u ? null : n.createElement(l.Z, { style: E && [C.border, { backgroundColor: i.default.theme.colors[d] }] })), t ? n.createElement(m.Z, { count: t, standalone: !0, style: [C.badge, t >= 10 && C.multiDigitBadge, t >= 20 && C.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: D, withBorder: !1 }) : r ? n.createElement(m.Z, { pip: !0, standalone: !0, style: C.badgePip, textColor: "red500", unreadCountLabel: S, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.973098aa.js.map
