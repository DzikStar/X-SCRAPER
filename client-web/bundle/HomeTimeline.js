    ...
    ["bundle.HomeTimeline", "icons/IconBookmarkCollectionsStroke-js", "icons/IconChevronDown-js", "icons/IconDocument-js", "icons/IconGifPillStroke-js", "icons/IconWriteStroke-js"],
    {
        789831: (e, t, a) => {
            ...
            const i = s.default.create((e) => ({ root: { paddingBottom: `calc(${e.spaces.space64} + ${e.spaces.space20} * 2)` } })),
                d = ({ children: e, component: t, fab: a, shouldRenderFab: s = !0, style: d, withoutBottomPadding: c, ...u }) => {
                    const m = t || n.Z,
                        p = s && !(0, l.ZP)();
        ...
        507651: (e, t, a) => {
            ...
            const i = (e) => {
                    ...
                    return o.createElement(s.Z, (0, r.Z)({}, e, { isCompact: (0, l.HD)(t) }));
                },
                d = o.memo(i);
        },
        920603: (e, t, a) => {
            ...
            const y = ({ renderProperties: e, wrapperStyles: t }) => {
                    ...
                    return r.createElement(a, { style: [t, o] });
                },
                C = ({ buttonProps: e, destinationLink: t, onDestinationClick: a, renderProperties: { action_label: n, icon: s } }) => r.createElement(h.ZP, { link: t, onClick: a, type: e?.type }, r.createElement(o.Z, { style: D.buttonInner }, s ? r.createElement(y, { renderProperties: s, wrapperStyles: [D.iconWrapper, "CircleFill" === s.icon_type ? D.smallIconWrapper : null] }) : null, r.createElement(b.ZP, null, n))),
                D = g.default.create((e) => ({ buttonInner: { flexDirection: "row", alignItems: "center" }, iconWrapper: { paddingEnd: e.spaces.space8, verticalAlign: "middle" }, smallIconWrapper: { height: ".6em" } }));
            var w = a(992942),
                M = a(439592);
            const E = ({ destinationLink: e, onDestinationClick: t, renderProperties: { cta: a, image_url: n, primary_label: s, secondary_label: l } }) => {
                    const i = n ? "whiteOnColor" : void 0;
                    return r.createElement(o.Z, { style: k.cardOuter }, n ? r.createElement(w.Z, { aspectMode: M.Z.COVER, source: { uri: n }, style: k.image }) : null, r.createElement(o.Z, { style: k.cardInner }, r.createElement(b.ZP, { color: i, size: "headline1", weight: "heavy" }, s), l ? r.createElement(b.ZP, { color: i }, l) : null, r.createElement(C, { buttonProps: { type: "brandFilled" }, destinationLink: e, onDestinationClick: t, renderProperties: a })));
                },
                ...
                S = ({ destinationLink: e, onDestinationClick: t, renderProperties: a }) => {
                    const n = r.useMemo(() => {
                        const o = { destinationLink: e, onDestinationClick: t };
                        switch (a.__typename) {
                            case "UpsellButtonRenderProperties":
                                return r.createElement(C, (0, p.Z)({}, o, { renderProperties: a }));
                            case "UpsellCardRenderProperties":
                                return r.createElement(E, (0, p.Z)({}, o, { renderProperties: a }));
                            default:
                                return null;
                        }
                    }, [a, e, t]);
                ...
                v = ({ attributionParams: e, trackClick: t, trackImpression: a, upsellContent: o }) => {
                    ...
                    r.useEffect(() => {
                        c && (u ? a() : l.scribeAction("impression"));
                    }, [c, l, a, u]);
                    const p = m(e, o.destination),
                        h = r.useCallback(() => {
                            u ? t() : l.scribeAction("click");
                        }, [l, t, u]);
                    return r.createElement("div", { ref: d }, r.createElement(S, { destinationLink: p, onDestinationClick: h, renderProperties: o.render_properties }));
                },
                _ = (e) => r.createElement(l.nO, { data: { referer: e.attributionParams.referrer }, namespace: { component: "unified-upsell", element: e.upsellContent.key } }, r.createElement(v, e));
            var Z = a(722517);
            const T = ({ attributionParams: e, surfaceKey: t, trackClick: a, trackDismiss: o, trackImpression: n, upsellContent: s }) => r.useMemo(() => r.createElement(_, { attributionParams: e, trackClick: a, trackDismiss: o, trackImpression: n, upsellContent: s }), [e, a, o, n, s]),
                P = ({ surfaceKey: e, wrapperStyles: t }) => {
                    const { attributionParams: a, trackClick: n, trackDismiss: s, trackImpression: l, upsellContent: i } = (0, Z.Z)(e);
                    return r.useMemo(() => (i && a ? r.createElement(o.Z, { style: t }, r.createElement(T, { attributionParams: a, surfaceKey: e, trackClick: n, trackDismiss: s, trackImpression: l, upsellContent: i })) : null), [a, i, e, n, s, l, t]);
                },
                R = r.memo(P);
        },
        387524: (e, t, a) => {
                        ...
                        ? o.createElement(
                              ...
                              o.createElement(l.ZP, null, ({ windowWidth: e }) => {
                                  ...
                                  return o.createElement(
                                      ...
                                      o.createElement(d.Z, { id: "FloatingActionButtonBase" }, (e, l) => o.createElement(n.Z, (0, r.Z)({ ref: e() }, l({ style: p })), o.createElement(c.Z, (0, r.Z)({}, f, { "aria-label": t, label: s ? a : void 0, onPress: D, style: u && h.buttonMicro })))),
                                  );
                              }),
                          )
                        : null;
        ...
        355883: (e, t, a) => {
            ...
            class l extends r.PureComponent {
                ...
                render() {
                    const { "aria-label": e, icon: t, label: a, scribeComponent: l } = this.props;
                    return r.createElement(o.Z, { "aria-label": e, href: s, icon: t, label: a, onPress: this._handlePress, scribeComponent: l, testID: n.Z.tweet });
                }
            }
            const i = l;
        },
        32677: (e, t, a) => {
            ...
            const i = n().j0179e90,
                ...
                u = ({ getLocationState: e, history: t }) => r.createElement(l.Z, { "aria-label": i, getLocationState: e, history: t, icon: c, label: d, scribeComponent: "floating_compose_button" });
        },
        635510: (e, t, a) => {
            a.d(t, { Z: () => r });
        ...
        652904: (e, t, a) => {
            ...
            class d extends r.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const d = o || l;
                    ((d && o !== l) || (!d && a !== n) || r !== s || i) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        438965: (e, t, a) => {
            a.d(t, { FE: () => n, Hx: () => i, Oj: () => o, P3: () => d, QO: () => l, j: () => s });
            var r = a(942893);
        ...
        383675: (e, t, a) => {
            ...
            var r = a(503768),
                ...
                n = a(750085),
                s = a(218951);
            const l = ({ endpointParams: e, endpointUrl: t, isUserRefreshable: a, timelineId: r }) => (0, s.Z)({ timelineId: r, isUserRefreshable: a, network: { getEndpoint: (e) => e.withEndpoint(o.Z).fetchGeneric, getEndpointParams: ({ count: a, cursor: r }) => ({ ...e, cursor: "string" == typeof r ? r : void 0, count: a, endpointUrl: t }) }, context: "FETCH_TIMELINE", perfKey: "generic" }),
                i = (e, t) => (0, s.Z)({ timelineId: `generic-graphql-timeline-${e}`, isUserRefreshable: t, network: { getEndpoint: (e) => e.withEndpoint(r.ZP).fetchGenericTimelineById, getEndpointParams: ({ count: t, cursor: a }) => ({ cursor: "string" == typeof a ? a : void 0, count: t, timelineId: e }) }, formatResponse: n.Z, context: "FETCH_GENERIC_TIMELINE_GQL", perfKey: "genericGQL" });
        },
        506653: (e, t, a) => {
            a.d(t, { Z: () => s });
            var r = a(483557),
                o = a(750085),
                n = a(218951);
            const s = ({ listId: e, useRanked: t = !1 }) => (0, n.Z)({ timelineId: l({ listId: e, useRanked: t }), network: { getEndpoint: (e) => e.withEndpoint(r.ZP).fetchTweetsGraphQL, getEndpointParams: ({ count: a, cursor: r }) => ({ listId: e, count: a, cursor: "string" == typeof r ? r : void 0, useRanked: t }) }, formatResponse: o.Z, context: "FETCH_LIST_TIMELINE_GRAPHQL", perfKey: "listTweetsGraphQL" });
            function l({ listId: e, useRanked: t = !1 }) {
                return `listTweets-GraphQL-${e}-${t ? "ranked" : "latest"}`;
            }
        },
        237983: (e, t, a) => {
            a.r(t), a.d(t, { HomeTimeline: () => Mt, default: () => kt });
            var r = a(202784),
                o = a(325686),
                n = a(420412),
                s = a(108362),
                ...
                P = ({ setTransitionState: e, transitionState: t }) => {
                        ...
                        l = r.useCallback(
                            (e, n) => {
                                ...
                                return r.createElement(g.Z, {
                                    actionText: r.createElement(o.Z, { style: R.focusedModePopoverMenuItem }, r.createElement(f.ZP, null, e), a === l ? r.createElement(w.default, { style: R.focusedModeGreenCheck }) : r.createElement(M.default, null)),
                                    onClick: () => {
                                        a !== l && "Idle" === t && s(!a), n();
                                    },
                                });
                    ...
                    return r.createElement(
                        y.Z,
                        {
                            ...
                            renderContent: (e) => r.createElement(r.Fragment, null, l(T, e), r.createElement(C.Z, { style: R.divider }), l(Z, e)),
                            withMask: !0,
                        },
                        r.createElement(D.ZP, { icon: r.createElement(E.default, null), style: R.focusedModeButton }, r.createElement(f.ZP, { style: R.focusedModeButtonText }, n ? Z : T), r.createElement(k.default, null)),
                    );
                },
            ...
            const ne = d.default.create((e) => ({ tabsContainer: { display: "flex", flexDirection: "row" }, tabs: { flexBasis: 1, flexGrow: 1, paddingEnd: e.spaces.space4 }, rightControlContainer: { borderBottomColor: e.colors.borderColor, borderBottomStyle: "solid", borderBottomWidth: e.borderWidths.small, justifyContent: "center", paddingHorizontal: e.spaces.space8 }, focusedModeRightControlContainer: { paddingHorizontal: 0 } })),
                se = V(function ({ analytics: e, createLocalApiErrorHandlerFetchPins: t, fetchPinnedTimelinesIfNeeded: a, isSubscriber: n, onRefresh: s, pinnedTimelines: l, rightControl: i, selectedTimeline: d, sort: c, updateSettings: u }) {
                        ...
                        return {
                            ...
                            onClick: () => {
                                if (a) o ? h(!0) : s();
                                    ...
                                    e.scribe({ section: n, element: s, action: "switch", data: { duration_ms: a } });
                                }
                            },
                    ...
                    n && C.push(y({ name: ae, type: O.Jz.CREATOR_SUBSCRIPTIONS })), l.forEach((e) => C.push(y(e)));
            ...
            function Se({ timelineType: e }) {
                const t = (0, we.z)(),
                    ...
                    n = r.useMemo(() => (e === O.Jz.COMMUNITY ? Me : e === O.Jz.LIST ? ke : Ee), [e]);
            ...
            const Ie = u().f089620c,
                xe = (0, pe.ZP)(
                    ye(({ history: e, location: t, selectedTimeline: a, sort: o, recordTTFT: n = ce.jN, timelineRef: s, viewerUserId: l }) => {
                                ...
                                () =>
                                    (function ({ history: e, location: t, selectedTimeline: a, sort: r, viewerUserId: o }) {
                                        const n = (0, ve.HD)(e) ? e.location.query.id : void 0,
                                            ...
                                            l = s || a.type,
                                            i = n || a.id,
                                            d = s ? s === O.Jz.HOME_LATEST : a.type === O.Jz.HOME_LATEST;
                                        return l === O.Jz.COMMUNITY && i ? (0, _e.Qx)(String(i), { displayLocation: "Home", rankingMode: r }) : l === O.Jz.CREATOR_SUBSCRIPTIONS ? (0, Re.Z)({ userId: o }) : l === O.Jz.GENERIC && i ? (0, Ze.R)(String(i)) : l === O.Jz.LIST && i ? (0, Pe.Z)({ listId: String(i) }) : (0, Te.ZP)({ useLatest: d, userId: o });
                                    })({ history: e, location: t, selectedTimeline: a, sort: o, viewerUserId: l }),
                                [e, t, a, o, l],
                            ),
                            h = r.useCallback(() => r.createElement(Se, { timelineType: a.type }), [a]),
                        ...
                        return r.createElement(be.Z, { entryConfiguration: b, isSingleDirection: c, module: p, onEntriesRendered: u, prerollDisplayLocation: he.Nw.TIMELINE_HOME, renderEmptyState: h, timelineRef: s, title: Ie, withNewTweetsPill: !0 });
                    }),
                );
            var Be = a(791983),
                Ae = a(523561),
            ...
            function Mt({ analytics: e, history: t, isSideNavExpandedByUser: a, location: d, selectedTimeline: c }) {
                ...
                const E = r.useCallback(() => {
                    ...
                    S = r.useMemo(() => r.createElement(r.Fragment, null, !(0, F.ZP)() || p || M ? null : r.createElement(r.Fragment, null, r.createElement(st, { history: t, location: d }), r.createElement(n.Z, { isSlim: !0 })), r.createElement(b.Z, { component: s.Z, fab: r.createElement(H.Z, { history: t }) }, r.createElement(xe, { timelineRef: k }))), [t, M, p, d, k]),
                    v = { page: "home", section: c.type === O.Jz.GENERIC ? c.scribe : O.yu[c.type] },
                    Z = !(0, F.ZP)(),
                    T = Z ? r.createElement(h.Z, { style: Et.icon }) : void 0,
                    R = Z ? null : Ct,
                    z = u.isTrue("rweb_sourcemap_migration"),
                    N = u.isTrue("rweb_sourcemap_migration_focused_mode"),
                    W = g.isAnyPremiumSubscriber(),
                    [G, U] = (0, l.Zx)(({ windowWidth: e }) => [lt.Z.isOneColumnViewportCenteredSquishedLayoutRedesign(e, !!a), lt.Z.isTwoColumnOrWiderLayoutRedesign(e, !!a)]),
                    $ = z && N && W && U,
                    [j] = _(),
                    V = (0, i.$u)(),
                    [J, q, K, Q] = bt(!!a),
                    Y = r.useMemo(() => r.createElement(se, { onRefresh: E, rightControl: $ && r.createElement(P, { setTransitionState: q, transitionState: J }) }), [q, $, J, E]),
                    X = r.useMemo(() => {
                        if (Z && !g.isAnyPremiumSubscriber()) {
        ...
        661810: (e, t, a) => {
            ...
            function s({ spacing: e, style: t }) {
                return r.createElement(o.Z, { role: "separator", style: [l.divider, { marginVertical: null != e ? n.default.theme.spaces[e] : void 0 }, t] });
            }
        ...
        392027: (e, t, a) => {
            ...
            class s extends r.PureComponent {
                render() {
                    const { "aria-label": e, backgroundColor: t, color: a, disabled: n, href: s, icon: i, label: d, onPress: c, renderMenu: u, style: m, testID: p } = this.props,
                        h = ((e, t) => ("primary" === e && "white" === t ? "whiteOnColor" : "white" === e && "primary" === t ? "primaryOnWhite" : t))(t, a);
                    return r.createElement(o.ZP, { "aria-label": e, backgroundColor: t, color: h, disabled: n, icon: i, link: s, onPress: c, renderMenu: u, size: "xLarge", style: [l.root, !d && l.iconOnly, m], testID: p }, d);
                }
            }
        ...
        420412: (e, t, a) => {
            ...
            function i({ borderColor: e = "borderColor", isSlim: t = !1, label: a }) {
                ...
                return a ? r.createElement(s.Z, { style: !t && d.root, withGutter: !0 }, r.createElement(o.Z, { style: d.gapColumn }, r.createElement(o.Z, { style: [d.gap, c] })), r.createElement(o.Z, { style: d.gapText }, a), r.createElement(o.Z, { style: d.gapColumn }, r.createElement(o.Z, { style: [d.gap, c] }))) : r.createElement(o.Z, { style: [!t && d.root, i() && d.rootRedesign, d.gap, c] });
            }
            ...
            class l extends o.Component {
                render() {
                    const { children: e, style: t, withGutter: a, ...s } = this.props,
                        l = o.Children.map(e, (e) => e && o.cloneElement(e, { style: [e.props.style, i.column, a && i.withGutterColumn] }));
                    return o.createElement(n.Z, (0, r.Z)({ style: [t, i.root, a && i.withGutter] }, s), l);
                }
            }
        ...
        449479: (e, t, a) => {
            ...
            class p extends r.Component {
                ...
                render() {
                    const { "aria-posinset": e, "aria-setsize": t, checked: a, disabled: u, helpText: p, label: b, name: g, testID: f } = this.props,
                        ...
                        D = a ? y : C;
                    return r.createElement(i.Z, { disabled: u }, (i) => r.createElement(o.Z, { role: "label", style: [h.root, !u && h.interactive], testID: f }, r.createElement(o.Z, { style: h.topContainer }, r.createElement(s.ZP, { id: this.labelId }, b), r.createElement(o.Z, { style: h.radioContainer }, r.createElement(c.Z, { interactiveStyles: D, interactivityState: i, style: h.radioBackground }, r.createElement(o.Z, { style: [h.circle, a && h.circleActive, u && h.circleDisabled, a && u && h.circleCheckedAndDisabled] }, a ? r.createElement(n.default, { style: h.checkMark }) : null)), (0, l.Z)("input", { "aria-posinset": e, "aria-setsize": t, "aria-describedby": this.descriptionId, "aria-labelledby": this.labelId, checked: a, disabled: u, name: g, onChange: this._handleChange, ref: this._setRef, style: [h.nativeControl], type: "radio" }))), p ? r.createElement(s.ZP, { color: "gray700", id: this.descriptionId, size: "subtext2", style: h.helpText }, p) : null));
                }
                focus() {
            ...
            class y extends r.Component {
                ...
                render() {
                    const { "aria-label": e, description: t, disabled: a, label: n, name: l, options: i, value: d } = this.props;
                    return r.createElement(
                        o.Z,
                        { "aria-label": e, "aria-labelledby": n && !e ? this._labelId : void 0, role: "radiogroup", style: a && C.disabled, testID: `${g}${l}` },
                        n ? r.createElement(o.Z, { id: this._labelId, role: "label", style: C.header }, r.createElement(s.ZP, { style: C.label, weight: "bold" }, n), t ? r.createElement(s.ZP, { color: "gray700", size: "subtext2" }, t) : null) : null,
                        i.map((e, t) => r.createElement(b, { "aria-posinset": t + 1, "aria-setsize": i.length, checked: e.value === d, disabled: a, helpText: e.helpText, key: e.value, label: e.label, name: l, onChange: this._handleItemChanged(e.value), ref: this._setRadioRef(t, e.value === d), testID: e.testID })),
                    );
                }
            }
        ...
        403556: (e, t, a) => {
            ...
            class w extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: a, badgePip: r, children: n, color: s, isActive: d, isCompact: c, isPillLink: u, isRoundedRect: m, isWebRedesign: b, retainScrollPosition: w, style: E, to: k } = this.props,
                        { location: S } = this.state,
                        v = k ? this._getMemoizedLink(k, w) : void 0,
                        _ = d ? d(k) : S?.pathname === v?.pathname,
                        Z = g.Z.generate({ backgroundColor: "transparent", color: l.default.theme.colors.text, insetFocusRing: !0 }),
                        T = b ? "medium" : _ ? "bold" : "medium";
                    return o.createElement(f.Z, { "aria-label": t, "aria-selected": _, focusable: !!_, interactiveStyles: Z, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? M.pill : M.link, u && _ ? M.active : null, c ? (u ? M.compactPill : M.compactLink) : null, m ? M.roundedRect : null, E], withoutInteractiveStyles: b || u }, ({ isFocused: t, isHovered: d }) => o.createElement(i.Z, { style: u && M.flexGrow }, o.createElement(p.ZP, { size: b ? "headline2" : void 0, style: [M.text, { color: this._getTextColor(_, d, b, u) }, c && M.compactText, b && t && M.focusedText], weight: T }, e && o.createElement(e, { style: M.icon }), n, b || u ? null : o.createElement(i.Z, { style: _ && [M.border, { backgroundColor: l.default.theme.colors[s] }] })), a ? o.createElement(h.Z, { count: a, standalone: !0, style: [M.badge, a >= 10 && M.multiDigitBadge, a >= 20 && M.truncatedCountBadge], truncatedCountFormatter: D, unreadCountLabel: y, withBorder: !1 }) : r ? o.createElement(h.Z, { pip: !0, standalone: !0, style: M.badgePip, textColor: "red500", unreadCountLabel: C, withBorder: !1 }) : null));
                }
            }
            ...
            const M = l.default.create((e) => ({
                ...
                S = ({ alignFirstItem: e, "aria-label": t, isCompact: a, isPillLink: l, isRoundedRect: i, links: d, style: c, visibleItemIndex: u }) => {
                    const m = d
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        b = o.useMemo(
                            () =>
                                d.filter(Boolean).map(({ label: t, viewType: n, ...s }, d) => {
                                    ...
                                    return o.createElement(E, (0, r.Z)({ viewType: n }, s, { isCompact: a, isPillLink: l, isRoundedRect: i, isWebRedesign: h, style: c }), t);
                                }),
                            [e, a, l, i, h, d],
                        );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.19417a4a.js.map
