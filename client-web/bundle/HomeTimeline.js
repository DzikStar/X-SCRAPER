...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.HomeTimeline", "icons/IconBarChartHorizontalStroke-js", "icons/IconBookStrokeOn-js", "icons/IconBookmarkCollectionsStroke-js", "icons/IconCameraVideoStroke-js", "icons/IconFireStroke-js"],
    {
        789831: (e, t, a) => {
            a.d(t, { Z: () => d });
            var r = a(807896),
        ...
        920603: (e, t, a) => {
            ...
            const S = ({ destinationLink: e, onDestinationClick: t, renderProperties: { cta: a, image_url: n, primary_label: l, primary_label_icon: s, secondary_label: i } }) => {
                ...
                Z = (e) => r.createElement(s.nO, { data: { referer: e.attributionParams.referrer }, namespace: { component: "unified-upsell", element: e.upsellContent.key } }, r.createElement(_, e));
            var T = a(722517);
            const P = ({ attributionParams: e, surfaceKey: t, trackClick: a, trackDismiss: o, trackImpression: n, upsellContent: l }) => r.useMemo(() => r.createElement(Z, { attributionParams: e, trackClick: a, trackDismiss: o, trackImpression: n, upsellContent: l }), [e, a, o, n, l]),
                R = ({ surfaceKey: e, wrapperStyles: t }) => {
                    const { attributionParams: a, trackClick: n, trackDismiss: l, trackImpression: s, upsellContent: i } = (0, T.Z)(e);
        ...
        237983: (e, t, a) => {
                ...
                P = ({ setTransitionState: e, transitionState: t }) => {
                    ...
                    return r.createElement(
                        y.Z,
                        {
                            ...
                            renderContent: (e) => r.createElement(r.Fragment, null, s(T, e), r.createElement(C.Z, { style: R.divider }), s(Z, e)),
                            withMask: !0,
                        },
                        r.createElement(D.ZP, { icon: r.createElement(E.default, null), style: R.focusedModeButton }, r.createElement(f.ZP, { style: R.focusedModeButtonText }, n ? Z : T), r.createElement(S.default, null)),
                    );
                },
            ...
            var I = a(788994),
                ...
                $ = a(390387);
            const j = (0, U.Z)()
                .propsFromState(() => ({ pinnedTimelines: V.GE, selectedTimeline: V.br, isSubscriber: $.pG, sort: V.sI }))
                .propsFromActions(() => ({ createLocalApiErrorHandlerFetchPins: (0, G.zr)("HOME_TIMELINE_FETCH_PINS"), fetchPinnedTimelinesIfNeeded: V.Mq, updateSettings: V.VP }))
                .withAnalytics();
            var J = a(138099),
                q = a(449479);
            const K = u().a2118086,
            ...
            var se = a(652904),
                ...
                ge = a(438965),
                fe = a(335632);
            const ye = (0, U.Z)().propsFromState(() => ({ selectedTimeline: V.br, sort: V.sI, viewerUserId: $._h }));
            var Ce = a(807896),
                De = a(457311),
                we = a(725516);
            ...
            const Ie = u().f089620c,
                xe = (0, pe.ZP)(
                    ye(({ history: e, location: t, selectedTimeline: a, sort: o, recordTTFT: n = ce.jN, timelineRef: l, viewerUserId: s }) => {
                        const { featureSwitches: i } = r.useContext(A.rC),
                            d = r.useRef(!0);
                            ...
                            p = r.useMemo(
                                () =>
                                    (function ({ history: e, location: t, selectedTimeline: a, sort: r, viewerUserId: o }) {
                                        ...
                                        return s === O.Jz.COMMUNITY && i ? (0, _e.Qx)(String(i), { displayLocation: "Home", rankingMode: r }) : s === O.Jz.CREATOR_SUBSCRIPTIONS ? (0, Re.Z)({ userId: o }) : s === O.Jz.GENERIC && i ? (0, Ze.R)(String(i)) : s === O.Jz.LIST && i ? (0, Pe.Z)({ listId: String(i) }) : (0, Te.ZP)({ useLatest: d, userId: o });
            ...
            const qe = (0, U.Z)()
                ...
                at = r.createElement(Ve.default, null),
                rt = r.createElement($e.default, null),
                ...
                lt = (0, ze.Z)({
                    loader: () =>
                        (Ae.H1.preload() || Promise.resolve()).then(() =>
                            Promise.all([
                                a.e("icons.2"),
                                a.e("icons.24"),
                                a.e("icons.10"),
            ...
            var ft = a(936572);
            const yt = (0, U.Z)()
                    .propsFromState(() => ({ selectedTimeline: V.br, isSideNavExpandedByUser: ft.op }))
            ...
            function Mt({ analytics: e, history: t, isSideNavExpandedByUser: a, location: d, selectedTimeline: c }) {
                const { featureSwitches: u, isRestrictedSession: p, userClaims: g } = (0, A.QZ)(),
                ...
                const E = r.useCallback(() => {
                    ...
                    j = (0, i.$u)(),
                    [J, q, K, Q] = bt(!!a),
                    Y = r.useMemo(() => r.createElement(le, { onRefresh: E, rightControl: V && r.createElement(P, { setTransitionState: q, transitionState: J }) }), [q, V, J, E]),
                    X = r.useMemo(() => {
                        if (Z && !g.isAnyPremiumSubscriber()) {
                            if (u.isTrue("subscriptions_upsells_home_nav_migration_enabled")) return r.createElement(z.Z, { surfaceKey: "HomeNav" });
                    ...
                    ee = r.useMemo(() => r.createElement(o.Z, { style: [Et.searchContainer, it.W.contentOneColumnRedesign, G && Et.squished, K] }, r.createElement(Ae.Rj, { shouldHandleSearchShortcut: !0 })), [G, K]);
                return r.createElement(ut.nO, { namespace: v }, r.createElement(se.Z, { locationKey: v.page }, V && $ && ee, r.createElement(B.Z, { centeredLogo: T, disjointHeader: Dt, documentTitle: Ct, history: t, onTabRefresh: E, primaryContent: k, primaryContentStyles: V && K, rightControl: X, secondaryBar: Y, sidebarContent: V && $ ? null : r.createElement(o.Z, { style: V && Q }, wt), title: R, withAppBar: !j }), V && $ && !G && r.createElement(o.Z, { style: Et.floatingFooter }, r.createElement(I.Z, { align: "right", itemLayout: "vertical", withOverflow: !0 }))));
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.76b9275a.js.map
