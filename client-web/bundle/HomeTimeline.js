...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.HomeTimeline", "icons/IconBookStrokeOn-js"],
    {
        789831: (e, t, a) => {
            a.d(t, { Z: () => d });
            var r = a(807896),
        ...
        507651: (e, t, a) => {
            ...
            const i = (e) => {
                    const t = (0, n.useHistory)(),
                        { isCompact: a, ...i } = e;
                    return o.createElement(s.Z, (0, r.Z)({}, i, { isCompact: a || (0, l.HD)(t) }));
                },
                d = o.memo(i);
        },
        920603: (e, t, a) => {
            ...
            const y = ({ renderProperties: e, wrapperStyles: t }) => {
                ...
                D = ({ buttonProps: e, destinationLink: t, onDestinationClick: a, renderProperties: { action_label: n, icon: s } }) => r.createElement(h.ZP, { link: t, onClick: a, type: e?.type }, r.createElement(o.Z, { style: w.buttonInner }, s ? r.createElement(y, { renderProperties: s, wrapperStyles: w.iconWrapper }) : null, r.createElement(b.ZP, null, n))),
            ...
            var M = a(992942),
                S = a(439592);
            const E = ({ destinationLink: e, onDestinationClick: t, renderProperties: { cta: a, image_url: n, primary_label: s, primary_label_icon: l, secondary_label: i } }) => {
                    const d = n ? "whiteOnColor" : void 0;
                    return r.createElement(o.Z, { style: k.cardOuter }, n ? r.createElement(M.Z, { aspectMode: S.Z.COVER, source: { uri: n }, style: k.image }) : null, r.createElement(o.Z, { style: k.cardInner }, r.createElement(o.Z, { style: k.primaryLabelContainer }, l ? r.createElement(y, { renderProperties: l, wrapperStyles: k.primaryLabelIconWrapper }) : null, r.createElement(b.ZP, { color: d, size: "headline1", weight: "heavy" }, s)), i ? r.createElement(b.ZP, { color: d }, i) : null, r.createElement(D, { buttonProps: { type: "brandFilled" }, destinationLink: e, onDestinationClick: t, renderProperties: a })));
                },
                ...
                T = (e) => r.createElement(l.nO, { data: { referer: e.attributionParams.referrer }, namespace: { component: "unified-upsell", element: e.upsellContent.key } }, r.createElement(v, e));
            var Z = a(722517);
            const P = ({ attributionParams: e, surfaceKey: t, trackClick: a, trackDismiss: o, trackImpression: n, upsellContent: s }) => r.useMemo(() => r.createElement(T, { attributionParams: e, trackClick: a, trackDismiss: o, trackImpression: n, upsellContent: s }), [e, a, o, n, s]),
                R = ({ surfaceKey: e, wrapperStyles: t }) => {
                    ...
                    return r.useMemo(() => (i && a ? r.createElement(o.Z, { style: t }, r.createElement(P, { attributionParams: a, surfaceKey: e, trackClick: n, trackDismiss: s, trackImpression: l, upsellContent: i })) : null), [a, i, e, n, s, l, t]);
                },
                I = r.memo(R);
        },
        387524: (e, t, a) => {
        ...
        237983: (e, t, a) => {
            a.r(t), a.d(t, { HomeTimeline: () => Mt, default: () => Et });
            var r = a(202784),
                o = a(325686),
                n = a(420412),
                s = a(108362),
                ...
                P = ({ setTransitionState: e, transitionState: t }) => {
                    ...
                    return r.createElement(
                        y.Z,
                        {
                            ...
                            renderContent: (e) => r.createElement(r.Fragment, null, l(Z, e), r.createElement(C.Z, { style: R.divider }), l(T, e)),
                            withMask: !0,
                        },
                        r.createElement(D.ZP, { icon: r.createElement(S.default, null), style: R.focusedModeButton }, r.createElement(f.ZP, { style: R.focusedModeButtonText }, n ? T : Z), r.createElement(E.default, null)),
                    );
                },
            ...
            const ne = d.default.create((e) => ({ tabsContainer: { display: "flex", flexDirection: "row" }, tabs: { flexBasis: 1, flexGrow: 1, paddingEnd: e.spaces.space4 }, rightControlContainer: { borderBottomColor: e.colors.borderColor, borderBottomStyle: "solid", borderBottomWidth: e.borderWidths.small, justifyContent: "center", paddingHorizontal: e.spaces.space8 }, focusedModeRightControlContainer: { paddingHorizontal: 0 } })),
                se = j(function ({ analytics: e, createLocalApiErrorHandlerFetchPins: t, fetchPinnedTimelinesIfNeeded: a, isSubscriber: n, onRefresh: s, pinnedTimelines: l, rightControl: i, selectedTimeline: d, sort: c, updateSettings: u }) {
            ...
            var le = a(652904),
                ...
                ge = a(438965),
                fe = a(335632);
            const ye = (0, U.Z)().propsFromState(() => ({ selectedTimeline: $.br, sort: $.sI, viewerUserId: V._h }));
            var Ce = a(807896),
                De = a(457311),
                we = a(725516);
            const Me = { header: u().a1ab9c80, message: u().b32c4fb0 },
                ...
                Ee = { header: u().a2515900, message: u().je23cdb2 };
                                ...
                                () =>
                                    (function ({ history: e, location: t, selectedTimeline: a, sort: r, viewerUserId: o }) {
                                        const n = (0, _e.HD)(e) ? e.location.query.id : void 0,
                                            s = (0, _e.HD)(e) ? e.location.query.mode : void 0,
                                            l = s || a.type,
                                            i = n || a.id,
                                            d = s ? s === O.Jz.HOME_LATEST : a.type === O.Jz.HOME_LATEST;
                                        return l === O.Jz.COMMUNITY && i ? (0, ve.Qx)(String(i), { displayLocation: "Home", rankingMode: r }) : l === O.Jz.CREATOR_SUBSCRIPTIONS ? (0, Re.Z)({ userId: o }) : l === O.Jz.GENERIC && i ? (0, Te.R)(String(i)) : l === O.Jz.LIST && i ? (0, Pe.Z)({ listId: String(i) }) : (0, Ze.ZP)({ useLatest: d, userId: o });
            ...
            function Mt({ analytics: e, history: t, isSideNavExpandedByUser: a, location: d, selectedTimeline: c }) {
                ...
                const S = r.useCallback(() => {
                    ...
                    k = r.useMemo(() => r.createElement(r.Fragment, null, !(0, F.ZP)() || p || M ? null : r.createElement(r.Fragment, null, r.createElement(st, { history: t, location: d }), r.createElement(n.Z, { isSlim: !0 })), r.createElement(b.Z, { component: s.Z, fab: r.createElement(L.Z, { history: t }) }, r.createElement(xe, { timelineRef: E }))), [t, M, p, d, E]),
                    ...
                    j = (0, i.$u)(),
                    [J, q, K, Q] = bt(!!a),
                    Y = r.useMemo(() => r.createElement(se, { onRefresh: S, rightControl: $ && r.createElement(P, { setTransitionState: q, transitionState: J }) }), [q, $, J, S]),
                    X = r.useMemo(() => {
                        if (T && !g.isAnyPremiumSubscriber()) {
                            ...
                            if ("" !== u.getStringValue("subscriptions_upsells_premium_home_nav")) return r.createElement(o.Z, { style: St.upsellContainer }, r.createElement(x.Z, { variant: "HomeNav" }));
                        }
                        return null;
                    }, [T, g, u]),
        ...
        403556: (e, t, a) => {
            ...
            class w extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: a, badgePip: r, children: n, color: s, isActive: d, isCompact: c, isPillLink: u, isRoundedRect: m, isWebRedesign: b, retainScrollPosition: w, style: S, to: E } = this.props,
            ...
            const M = l.default.create((e) => ({
                ...
                k = ({ alignFirstItem: e, "aria-label": t, isCompact: a, isPillLink: l, isRoundedRect: i, links: d, style: c, visibleItemIndex: u }) => {
                    const m = d
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        b = o.useMemo(
                            () =>
                                d.filter(Boolean).map(({ label: t, viewType: n, ...s }, d) => {
                                    const c = h ? [E.linkRedesign, 0 === d && E.firstLinkRedesign, e && 0 === d && E.withNoPaddingStart] : void 0;
                                    return o.createElement(S, (0, r.Z)({ viewType: n }, s, { isCompact: a, isPillLink: l, isRoundedRect: i, isWebRedesign: h, style: c }), t);
                                }),
                            [e, a, l, i, h, d],
                        );
                    return o.createElement(n.Z, { "aria-label": t, buttonsContainerStyle: l && E.gap, childrenStyle: !h && E.flexGrow, key: m, style: [l ? null : E.segmentedControl, h && E.leftAligned, c], visibleItemIndex: u }, b);
                };
        },
        847988: (e, t, a) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.5a123dfa.js.map
