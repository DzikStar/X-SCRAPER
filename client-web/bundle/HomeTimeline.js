...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.HomeTimeline", "icons/IconBookmarkCollectionsStroke-js", "icons/IconFilm-js"],
    {
        ...
        920603: (e, t, a) => {
            ...
            var M = a(992942),
                S = a(439592);
            const k = ({ destinationLink: e, onDestinationClick: t, renderProperties: { cta: a, image_url: n, primary_label: l, primary_label_icon: s, secondary_label: i } }) => {
                    const d = n ? "whiteOnColor" : void 0;
                    return r.createElement(o.Z, { style: E.cardOuter }, n ? r.createElement(M.Z, { aspectMode: S.Z.COVER, source: { uri: n }, style: E.image }) : null, r.createElement(o.Z, { style: E.cardInner }, r.createElement(o.Z, { style: E.primaryLabelContainer }, s ? r.createElement(y, { renderProperties: s, wrapperStyles: E.primaryLabelIconWrapper }) : null, r.createElement(b.ZP, { color: d, size: "headline1", weight: "heavy" }, l)), i ? r.createElement(b.ZP, { color: d }, i) : null, r.createElement(D, { buttonProps: { type: "brandFilled" }, destinationLink: e, onDestinationClick: t, renderProperties: a })));
                },
                    ...
                    const n = r.useMemo(() => {
                        ...
                        switch (a.__typename) {
                            ...
                            case "UpsellCardRenderProperties":
                                return r.createElement(k, (0, p.Z)({}, o, { renderProperties: a }));
                            default:
                                return null;
                        }
                    }, [a, e, t]);
        ...
        237983: (e, t, a) => {
            ...
            const v = () => {
                ...
                P = ({ setTransitionState: e, transitionState: t }) => {
                    ...
                    return r.createElement(
                        ...
                        r.createElement(D.ZP, { icon: r.createElement(S.default, null), style: R.focusedModeButton }, r.createElement(f.ZP, { style: R.focusedModeButtonText }, n ? T : Z), r.createElement(k.default, null)),
                    );
                },
            ...
            function Ee({ timelineType: e }) {
                const t = (0, we.z)(),
                    ...
                    n = r.useMemo(() => (e === O.Jz.COMMUNITY ? Me : e === O.Jz.LIST ? ke : Se), [e]);
                            ...
                            p = r.useMemo(
                                () =>
                                    (function ({ history: e, location: t, selectedTimeline: a, sort: r, viewerUserId: o }) {
                                        ...
                                        return s === O.Jz.COMMUNITY && i ? (0, ve.Qx)(String(i), { displayLocation: "Home", rankingMode: r }) : s === O.Jz.CREATOR_SUBSCRIPTIONS ? (0, Re.Z)({ userId: o }) : s === O.Jz.GENERIC && i ? (0, Te.R)(String(i)) : s === O.Jz.LIST && i ? (0, Pe.Z)({ listId: String(i) }) : (0, Ze.ZP)({ useLatest: d, userId: o });
                                    })({ history: e, location: t, selectedTimeline: a, sort: o, viewerUserId: s }),
                                [e, t, a, o, s],
                            ),
                            h = r.useCallback(() => r.createElement(Ee, { timelineType: a.type }), [a]),
            ...
            function Mt({ analytics: e, history: t, isSideNavExpandedByUser: a, location: d, selectedTimeline: c }) {
                ...
                const S = r.useCallback(() => {
                    ...
                    E = r.useMemo(() => r.createElement(r.Fragment, null, !(0, F.ZP)() || p || M ? null : r.createElement(r.Fragment, null, r.createElement(lt, { history: t, location: d }), r.createElement(n.Z, { isSlim: !0 })), r.createElement(b.Z, { component: l.Z, fab: r.createElement(L.Z, { history: t }) }, r.createElement(xe, { timelineRef: k }))), [t, M, p, d, k]),
        ...
        403556: (e, t, a) => {
            ...
            class w extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: a, badgePip: r, children: n, color: l, isActive: d, isCompact: c, isPillLink: u, isRoundedRect: m, isWebRedesign: b, retainScrollPosition: w, style: S, to: k } = this.props,
                        { location: E } = this.state,
                        _ = k ? this._getMemoizedLink(k, w) : void 0,
                        v = d ? d(k) : E?.pathname === _?.pathname,
            ...
            const M = s.default.create((e) => ({
                ...
                E = ({ alignFirstItem: e, "aria-label": t, isCompact: a, isPillLink: s, isRoundedRect: i, links: d, style: c, visibleItemIndex: u }) => {
                    const m = d
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        b = o.useMemo(
                            () =>
                                d.filter(Boolean).map(({ label: t, viewType: n, ...l }, d) => {
                                    ...
                                    return o.createElement(S, (0, r.Z)({ viewType: n }, l, { isCompact: a, isPillLink: s, isRoundedRect: i, isWebRedesign: h, style: c }), t);
                                }),
                            [e, a, s, i, h, d],
                        );
                    return o.createElement(n.Z, { "aria-label": t, buttonsContainerStyle: s && k.gap, childrenStyle: !h && k.flexGrow, key: m, style: [s ? null : k.segmentedControl, h && k.leftAligned, c], visibleItemIndex: u }, b);
                };
        },
        28862: (e, t, a) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.0a994eea.js.map
