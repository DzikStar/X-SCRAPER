    ...
    ["bundle.HomeTimeline", "icons/IconCameraVideoStroke-js", "icons/IconDrafts-js"],
    {
        920603: (e, a, r) => {
            ...
            const S = ({ destinationLink: e, onDestinationClick: a, renderProperties: { cta: r, image_url: o, primary_label: l, primary_label_icon: d, secondary_label: i } }) => {
                    ...
                    return t.createElement(n.Z, { style: _.cardOuter }, o ? t.createElement(w.Z, { aspectMode: E.Z.COVER, source: { uri: o }, style: _.image }) : null, t.createElement(n.Z, { style: _.cardInner }, t.createElement(n.Z, { style: _.primaryLabelContainer }, d ? t.createElement(D, { renderProperties: d, wrapperStyles: _.primaryLabelIconWrapper }) : null, t.createElement(b.ZP, { color: s, size: "headline1", weight: "heavy" }, l)), i ? t.createElement(b.ZP, { color: s }, i) : null, t.createElement(M, { buttonProps: { type: "brandFilled" }, destinationLink: e, onDestinationClick: a, renderProperties: r })));
                },
                _ = f.default.create((e) => ({ cardOuter: { borderRadius: e.borderRadii.large, borderColor: e.colors.borderColor, borderWidth: e.borderWidths.small, backgroundColor: e.colors.cellBackground }, cardInner: { gap: e.spaces.space12, alignItems: "flex-start", paddingVertical: e.spaces.space12, paddingHorizontal: e.spaces.space16 }, image: { position: "absolute", width: "100%", height: "100%", borderRadius: e.borderRadii.large }, primaryLabelContainer: { flexDirection: "row", alignItems: "center" }, primaryLabelIconWrapper: { paddingEnd: e.spaces.space8, verticalAlign: "middle" } })),
                k = ({ destinationLink: e, onDestinationClick: a, renderProperties: r }) => {
                    const o = t.useMemo(() => {
                ...
                v = ({ attributionParams: e, trackClick: a, trackImpression: r, upsellContent: n }) => {
                    ...
                    return t.createElement("div", { ref: s }, t.createElement(k, { destinationLink: p, onDestinationClick: h, renderProperties: n.render_properties }));
                },
        ...
        237983: (e, a, r) => {
                ...
                Be = (0, pe.ZP)(
                    De(({ history: e, location: a, selectedTimeline: r, sort: n, recordTTFT: o = ce.jN, timelineRef: l, viewerUserId: d }) => {
                        ...
                        const c = r.type === U.Jz.HOME && i.isTrue("rweb_home_nav_single_direction_scroll_enabled"),
                            ...
                            p = t.useMemo(
                                () =>
                                    (function ({ history: e, location: a, selectedTimeline: r, sort: t, viewerUserId: n }) {
                                        const o = (0, ke.HD)(e) ? e.location.query.id : void 0,
                                            l = (0, ke.HD)(e) ? e.location.query.mode : void 0,
                                            d = l || r.type,
                                            i = o || r.id,
                            ...
                            h = t.useCallback(() => t.createElement(_e, { timelineType: r.type }), [r]),
            ...
            function wa({ analytics: e, history: a, isSideNavExpandedByUser: r, location: s, selectedTimeline: c }) {
                ...
                const E = t.useCallback(() => {
                    ...
                    _ = t.useMemo(() => t.createElement(t.Fragment, null, !(0, F.ZP)() || p || w ? null : t.createElement(t.Fragment, null, t.createElement(la, { history: a, location: s }), t.createElement(o.Z, { isSlim: !0 })), t.createElement(b.Z, { component: l.Z, fab: t.createElement(z.Z, { history: a }) }, t.createElement(Be, { timelineRef: S }))), [a, w, p, s, S]),
                    k = { page: "home", section: c.type === U.Jz.GENERIC ? c.scribe : U.yu[c.type] },
                    T = !(0, F.ZP)(),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.b8448f7a.js.map
