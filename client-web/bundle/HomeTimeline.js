    ...
    ["bundle.HomeTimeline", "icons/IconBarChartHorizontalStroke-js", "icons/IconFireStroke-js", "icons/IconGifPillStroke-js"],
    {
        ...
        237983: (e, a, r) => {
            ...
            var Z = r(788994),
                ...
                j = r(390387);
            const J = (0, G.Z)()
                .propsFromState(() => ({ pinnedTimelines: V.GE, selectedTimeline: V.br, isSubscriber: j.pG, sort: V.sI }))
                .propsFromActions(() => ({ createLocalApiErrorHandlerFetchPins: (0, W.zr)("HOME_TIMELINE_FETCH_PINS"), fetchPinnedTimelinesIfNeeded: V.Mq, updateSettings: V.VP }))
                .withAnalytics();
            var $ = r(138099),
                K = r(449479);
            const q = u().a2118086,
            ...
            var de = r(652904),
                ...
                fe = r(438965),
                ge = r(335632);
            const De = (0, G.Z)().propsFromState(() => ({ selectedTimeline: V.br, sort: V.sI, viewerUserId: j._h }));
            var ye = r(807896),
                Me = r(457311),
                Ce = r(725516);
            ...
            const Ze = u().f089620c,
                Be = (0, pe.ZP)(
                    De(({ history: e, location: a, selectedTimeline: r, sort: n, recordTTFT: o = ce.jN, timelineRef: l, viewerUserId: d }) => {
                        const { featureSwitches: i } = t.useContext(z.rC),
                            s = t.useRef(!0);
            ...
            const Ke = (0, G.Z)()
                ...
                aa = t.createElement(Ge.default, null),
                ra = t.createElement(Ve.default, null),
                ...
                oa = Ke(({ userAvatarURI: e }) => {
                    const a = t.useMemo(() => t.createElement(He.Z.Consumer, null, ({ avatarSize: a }) => t.createElement(Ne.Z, { size: a, style: na.avatar, uri: e })), [e]),
                        r = !(0, Je.vS)();
            ...
            var ga = r(936572);
            const Da = (0, G.Z)()
                    .propsFromState(() => ({ selectedTimeline: V.br, isSideNavExpandedByUser: ga.op }))
            ...
            function wa({ analytics: e, history: a, isSideNavExpandedByUser: r, location: s, selectedTimeline: c }) {
                const { featureSwitches: u, isRestrictedSession: p, userClaims: f } = (0, z.QZ)(),
                ...
                const E = t.useCallback(() => {
                    ...
                    k = t.useMemo(() => t.createElement(t.Fragment, null, !(0, F.ZP)() || p || w ? null : t.createElement(t.Fragment, null, t.createElement(la, { history: a, location: s }), t.createElement(o.Z, { isSlim: !0 })), t.createElement(b.Z, { component: l.Z, fab: t.createElement(H.Z, { history: a }) }, t.createElement(Be, { timelineRef: S }))), [a, w, p, s, S]),
                    ...
                    [W, G] = (0, d.Zx)(({ windowWidth: e }) => [da.Z.isOneColumnViewportCenteredSquishedLayoutRedesign(e, !!r), da.Z.isTwoColumnOrWiderLayoutRedesign(e, !!r)]),
                    V = N && L && O && G,
                    [j] = v(),
                    J = (0, i.$u)(),
                    [$, K, q, Y] = ba(!!r),
                    Q = t.useMemo(() => t.createElement(le, { onRefresh: E, rightControl: V && t.createElement(P, { setTransitionState: K, transitionState: $ }) }), [K, V, $, E]),
                    X = t.useMemo(() => {
                    ...
                    ee = t.useMemo(() => t.createElement(n.Z, { style: [Ea.searchContainer, ia.W.contentOneColumnRedesign, W && Ea.squished, q] }, t.createElement(ze.Rj, { shouldHandleSearchShortcut: !0 })), [W, q]);
                return t.createElement(ua.nO, { namespace: _ }, t.createElement(de.Z, { locationKey: _.page }, V && j && ee, t.createElement(x.Z, { centeredLogo: I, disjointHeader: Ma, documentTitle: ya, history: a, onTabRefresh: E, primaryContent: k, primaryContentStyles: V && q, rightControl: X, secondaryBar: Q, sidebarContent: V && j ? null : t.createElement(n.Z, { style: V && Y }, Ca), title: R, withAppBar: !J }), V && j && !W && t.createElement(n.Z, { style: Ea.floatingFooter }, t.createElement(Z.Z, { align: "right", itemLayout: "vertical", withOverflow: !0 }))));
            }
        ...
        937450: (e, a, r) => {
            ...
            const d = (e = {}) => {
                const { direction: a } = (0, o.Z)();
                return (0, n.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [l.Z.root, e.style], viewBox: "0 0 24 24", children: t.createElement("g", null, t.createElement("path", { d: "M3 5.5C3 4.119 4.12 3 5.5 3h13C19.88 3 21 4.119 21 5.5v13c0 1.381-1.12 2.5-2.5 2.5h-13C4.12 21 3 19.881 3 18.5v-13zM5.5 5c-.28 0-.5.224-.5.5v13c0 .276.22.5.5.5h13c.28 0 .5-.224.5-.5v-13c0-.276-.22-.5-.5-.5h-13zM18 10.711V9.25h-3.74v5.5h1.44v-1.719h1.7V11.57h-1.7v-.859H18zM11.79 9.25h1.44v5.5h-1.44v-5.5zm-3.07 1.375c.34 0 .77.172 1.02.43l1.03-.86c-.51-.601-1.28-.945-2.05-.945C7.19 9.25 6 10.453 6 12s1.19 2.75 2.72 2.75c.85 0 1.54-.344 2.05-.945v-2.149H8.38v1.032H9.4v.515c-.17.086-.42.172-.68.172-.76 0-1.36-.602-1.36-1.375 0-.688.6-1.375 1.36-1.375z" })) }, { writingDirection: a });
            };
            d.metadata = { width: 24, height: 24 };
            const i = d;
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.HomeTimeline.ab8e779a.js.map
