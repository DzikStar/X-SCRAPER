    ...
    ["bundle.ImmersiveMediaViewer", "bundle.AudioSpaceDetail"],
    {
        ...
        519125: (e, t, o) => {
            ...
            const P = Object.freeze({ Default: "ui_defaultLabel", TransparentCursor: "ui_transparentCursor" }),
                C = { ...(0, I.G)({}), [d.ZP.Tweet]: (0, g.Z)({ hideConversationControlsEducationText: !0, withMuteConversation: !0 }) },
                E = ({ changeDropdownState: e, hideReplyContextMode: t, isCurrentUserRootAuthor: o, isReaderMode: n, isTransparentCursorsEnabled: a, replyDropdownSelection: i, rootTweetAuthorId: s, tweetTextSize: c, withFocalTweetMedia: g, withRuxInjections: I }) =>
                    (0, r.Z)({}, C, {
                        ...
                        [d.ZP.Tombstone]: { handlers: { [T]: (0, f._n)({ isFocalTweet: !0, isReaderMode: n, withHideReply: o }), [u.Z.Inline]: (0, f._n)({ isReaderMode: n, tweetDismissFeedbackKey: o ? l.qt : void 0, withHideReply: o }) } },
                    ...
                    return (o) => {
                        ...
                        return (0, i.Z)(b, (o, n) => {
                            const a = o.type === d.ZP.TimelineCursor && (o.content.cursorType === s.CursorType.ShowMoreThreads || o.content.cursorType === s.CursorType.ShowMoreThreadsPrompt),
                                i = o.type === d.ZP.Label && o.content.text === D;
                ...
                Z = ({ contextTweetId: e, conversationPosition: t, entry: o, socialContext: n, topicFollowPrompt: r }) => c.Wf({ ...o, conversationPosition: t, referringContext: { contextTweetId: e, socialContext: n } }, { displayType: T }),
        ...
        927192: (e, t, o) => {
            ...
            const g = (e, t) => {
                ...
                I = (0, f.Z)().propsFromState(() => ({ isTimelineTerminatedAtTop: g, contextualClientEventInfo: M }));
            var T = o(519125);
            const D = a().d35d74e4,
                v = (e) => {
                    switch (e) {
            ...
            class C extends n.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getMemoizedPreprocessor = (0, i.Z)((e, t, o, n, r, a, i) => (0, T.Mu)({ focalTweetId: r, contextTweetId: t, contextualClientEventInfo: o, socialContext: e, topicFollowPrompt: a, promotedContent: n, showOnlyRelevantReplies: i }))),
                        ...
                        (this._getMemoizedEntryConfig = (0, i.Z)((e, t, o, n, r, a) => {
                            const i = e && n && e === n;
                            return (0, T.ZP)({ changeDropdownState: this.props.changeDropdownState, isCurrentUserRootAuthor: !!i, hideReplyContextMode: t, replyDropdownSelection: o, rootTweetAuthorId: n, withFocalTweetMedia: r, withRuxInjections: a });
                        })),
        ...
        897695: (e, t, o) => {
            o.r(t), o.d(t, { ImmersiveMediaViewerScreen: () => Te, default: () => ve });
                ...
                render() {
                    ...
                    return n.createElement(
                        ...
                        n.createElement(
                            ...
                            n.createElement(
                                _.Z,
                                { onScroll: this._handleScroll, ref: this._scrollRef, scrollEventThrottle: 16, showsHorizontalScrollIndicator: !1, showsVerticalScrollIndicator: !1, style: L.scrollView, testID: "vss-scroll-view" },
                                this.props.list.map((o, r) => {
                                    const i = Math.abs(t - r) <= 1;
                                    return n.createElement(a.Z, { key: o.id, style: { height: e, maxHeight: e, width: "100%" } }, n.createElement(a.Z, { style: L.scrollSnapItem }, n.createElement(a.Z, { style: L.scrollSnapItemInner }, i && n.createElement(N, { item: o, key: o.id }))));
                                }),
                            ),
                        ),
                    );
            ...
            const L = s.default.create(() => ({ scrollView: { overflowY: "auto", scrollSnapType: "y mandatory", height: "100%" }, scrollSnapItem: { width: "100%", scrollSnapAlign: "start", scrollSnapStop: "always" }, scrollSnapItemInner: { height: window.innerHeight, width: "100%" } })),
                U = (0, A.Z)((0, k.Z)(B)),
            ...
            class V extends n.PureComponent {
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._keyboardShortcutHandlers = { [T.uq.refresh]: this._handleKeyboardRefresh, [T.uq.nextItem]: this._handleKeyboardFocusNext, [T.uq.previousItem]: this._handleKeyboardFocusPrevious }),
            ...
            (V.contextType = D.y3), (V.defaultProps = { onPositionRestored: g.Z, onAtEnd: g.Z, onAtStart: g.Z, onNearEnd: g.Z, onNearStart: g.Z, onScrollEnd: g.Z, noItemsRenderer: M.Z, withKeyboardShortcuts: !1 });
                    ...
                    const k = n.useCallback(
                            (e) => {
                                if (b) {
                                    ...
                                    d.replace(`${b.permalink}/mediaViewer?currentTweet=${e.id_str}&currentTweetUser=${e.user.screen_name}${o}`), T(e);
                                }
                            },
                            [d, b, l.search],
                        ),
                                ...
                                n.createElement(
                                    ...
                                    n.createElement(
                                        ...
                                        n.createElement(
                                            ...
                                            y && n.createElement(j.Z, { entryConfiguration: Me, module: B, previewEntries: b ? [G.Se({ id: y, sortIndex: "stable_sort_index" })] : void 0, scroller: z, title: ge }),
                                        ),
                                    ),
                                    n.createElement(a.Z, { style: D && De.desktopMediaDrawer, testID: D ? "immersive-viewer-desktop-conversation-drawer" : void 0 }, I && ((e, t) => !!e || t)(D, M) ? n.createElement(te.Z, { location: l, rootTweet: I, screenName: f, tweet: I, tweetId: I.id_str }) : null),
                                ),
                            ),
                        ),
                    );
                },
                De = s.default.create((e) => ({ container: { flexDirection: "row", overflowX: "hidden", overflowY: "hidden", height: "100%", width: "100%", position: "relative" }, neighbor: { flexGrow: 1, flexShrink: 1 }, desktopNeighbor: { display: "flex", flexDirection: "row" }, desktopTimelineContainer: { flex: 2 }, desktopMediaDrawer: { flex: 1 } })),
                ve = pe((0, q.Z)(Te));
        },
        67534: (e, t, o) => {
            o.d(t, { Z: () => w });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ImmersiveMediaViewer.e022006a.js.map
