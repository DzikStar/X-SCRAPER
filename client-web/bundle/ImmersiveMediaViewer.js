    ...
    ["bundle.ImmersiveMediaViewer", "bundle.AudioSpaceDetail", "icons/IconFilter-js"],
    {
        ...
        519125: (e, t, o) => {
            ...
            const P = Object.freeze({ Default: "ui_defaultLabel", TransparentCursor: "ui_transparentCursor" }),
                C = { ...(0, D.G)({}), [d.ZP.Tweet]: (0, T.Z)({ hideConversationControlsEducationText: !0, withMuteConversation: !0 }) },
                S = ({ changeDropdownState: e, hideReplyContextMode: t, isCurrentUserRootAuthor: o, isReaderMode: n, isTransparentCursorsEnabled: a, replyDropdownSelection: i, rootTweetAuthorId: s, tweetTextSize: c, withFocalTweetMedia: T, withRuxInjections: D }) =>
                    (0, r.Z)({}, C, {
                        ...
                        [d.ZP.Tombstone]: { handlers: { [I]: (0, f._n)({ isFocalTweet: !0, isReaderMode: n, withHideReply: o }), [u.Z.Inline]: (0, f._n)({ isReaderMode: n, tweetDismissFeedbackKey: o ? l.qt : void 0, withHideReply: o }) } },
                        ...
                        [d.ZP.TimelineCursor]: (0, m.Z)({ withRuxInjections: D }),
        ...
        927192: (e, t, o) => {
            ...
            const T = (e, t) => {
                ...
                D = (0, f.Z)().propsFromState(() => ({ isTimelineTerminatedAtTop: T, contextualClientEventInfo: g }));
            var I = o(519125);
            const M = a().d35d74e4,
                v = (e) => {
                    switch (e) {
                    ...
                    super(e, t),
                        ...
                        (this._handlePositionUpdate = (e, t) => {
                            const { onItemsRendered: o } = this.props,
                                n = this.state.list;
                            0 === e && this.props.onAtStart(O), e === n.length - 1 && this.props.onAtEnd(O), 1 === e && this.props.onNearStart(O), e === n.length - 2 && this.props.onNearEnd(O), n[e] ? o && o({ positions: [{ id: n[e].id, rectangle: t }], viewport: t }) : (0, D.ZP)(`VerticalSnapScroller could not update position to ${e}, itemList was ${n.length} elements.`, { level: "warning" });
                        }),
                        ...
                        n.createElement(
                            ...
                            n.createElement(
                                ...
                                n.createElement(
                                    ...
                                    n.createElement(a.Z, { style: M && Me.desktopMediaDrawer, testID: M ? "immersive-viewer-desktop-conversation-drawer" : void 0 }, D && ((e, t) => !!e || t)(M, g) ? n.createElement(te.Z, { location: l, rootTweet: D, screenName: f, tweet: D, tweetId: D.id_str }) : null),
                                ),
                            ),
                        ),
                    );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ImmersiveMediaViewer.daa95a3a.js.map
