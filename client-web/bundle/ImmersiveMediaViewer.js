...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.ImmersiveMediaViewer", "bundle.AudioSpaceDetail", "icons/IconFilter-js"],
    {
        349035: (e, t, o) => {
            o.d(t, { Z: () => a });
            var n = o(202784),
        ...
        519125: (e, t, o) => {
            ...
            var n = o(662678),
                ...
                I = o(801184),
                M = o(335632);
            const v = "FocalTweetInlineTombstone",
                T = "More Replies";
            let D;
            const P = Object.freeze({ Default: "ui_defaultLabel", TransparentCursor: "ui_transparentCursor" }),
                C = { ...(0, M.G)({}), [d.ZP.Tweet]: (0, g.Z)({ hideConversationControlsEducationText: !0, withMuteConversation: !0 }) },
                E = ({ changeDropdownState: e, hideReplyContextMode: t, isCurrentUserRootAuthor: o, isReaderMode: n, isTransparentCursorsEnabled: a, replyDropdownSelection: i, rootTweetAuthorId: s, tweetTextSize: c, withFocalTweetMedia: g, withRuxInjections: M }) =>
                    (0, r.Z)({}, C, {
                        ...
                        [d.ZP.Tweet]: {
                            handlers: {
                                ...
                                [h.Z.SelfThread]: (0, I.Cw)({ hideReplyContextMode: t }),
                                [h.Z.ReaderMode]: (0, I.Cw)({ hideConversationControlsEducationText: !0, hideExclusivityInfoEducationTextInReplies: !0, hideHighlightedUserLabel: !0, hideTrustedFriendsEducationTextInReplies: !0, isReaderMode: !0, shouldSelfThreadIncludeAvatar: !1, showWithheldBannerOnMyTweets: !1, tweetTextSize: c, withActionsDisabled: !1, withMuteConversation: !1, withRemoveFromBookmarks: !1, withSelfThread: !1, withUserPresence: !1 }),
                            },
                        },
                        [d.ZP.Tombstone]: { handlers: { [v]: (0, f._n)({ isFocalTweet: !0, isReaderMode: n, withHideReply: o }), [u.Z.Inline]: (0, f._n)({ isReaderMode: n, tweetDismissFeedbackKey: o ? l.qt : void 0, withHideReply: o }) } },
                        [d.ZP.Label]: p.ov({ selectDisplayType: (e) => ((e, t) => (t && e.content.text === T ? P.TransparentCursor : P.Default))(e, a), handlers: { [P.TransparentCursor]: w.L, [P.Default]: w.k } }),
                        [d.ZP.TimelineCursor]: (0, m.Z)({ withRuxInjections: M }),
                    ...
                    return (o) => {
                        ...
                        return (0, i.Z)(b, (o, n) => {
                            const a = o.type === d.ZP.TimelineCursor && (o.content.cursorType === s.CursorType.ShowMoreThreads || o.content.cursorType === s.CursorType.ShowMoreThreadsPrompt),
                                i = o.type === d.ZP.Label && o.content.text === T;
                            if (l && (a || i)) return void 0 === y && o.content.cursorType === s.CursorType.ShowMoreThreadsPrompt ? (D = n) : void 0 === y && (y = n), !1;
                            if (l && void 0 !== y && n >= y) return !1;
                            if (l && void 0 === y && n >= D) return !1;
                            const p = n > m;
                ...
                Z = ({ contextTweetId: e, conversationPosition: t, entry: o, socialContext: n, topicFollowPrompt: r }) => c.Wf({ ...o, conversationPosition: t, referringContext: { contextTweetId: e, socialContext: n } }, { displayType: v }),
        ...
        927192: (e, t, o) => {
            ...
            const g = (e, t) => {
                ...
                I = (e, t) => t.location.state && t.location.state.contextualClientEventInfo,
                M = (0, f.Z)().propsFromState(() => ({ isTimelineTerminatedAtTop: g, contextualClientEventInfo: I }));
            var v = o(519125);
            const T = a().d35d74e4,
                D = (e) => {
                    switch (e) {
            ...
            class C extends n.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getMemoizedPreprocessor = (0, i.Z)((e, t, o, n, r, a, i) => (0, v.Mu)({ focalTweetId: r, contextTweetId: t, contextualClientEventInfo: o, socialContext: e, topicFollowPrompt: a, promotedContent: n, showOnlyRelevantReplies: i }))),
                        ...
                        (this._getMemoizedEntryConfig = (0, i.Z)((e, t, o, n, r, a) => {
                            const i = e && n && e === n;
                            return (0, v.ZP)({ changeDropdownState: this.props.changeDropdownState, isCurrentUserRootAuthor: !!i, hideReplyContextMode: t, replyDropdownSelection: o, rootTweetAuthorId: n, withFocalTweetMedia: r, withRuxInjections: a });
                        })),
        ...
        897695: (e, t, o) => {
            o.r(t), o.d(t, { ImmersiveMediaViewerScreen: () => ve, default: () => De });
            ...
            class V extends n.PureComponent {
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._keyboardShortcutHandlers = { [v.uq.refresh]: this._handleKeyboardRefresh, [v.uq.nextItem]: this._handleKeyboardFocusNext, [v.uq.previousItem]: this._handleKeyboardFocusPrevious }),
                        ...
                        (this._render = () => {
                            ...
                            return n.createElement(D.Z, { enabled: e, handlers: this._keyboardShortcutHandlers }, n.createElement(L, { list: this.state.list, onPositionUpdate: this._handlePositionUpdate, onScrollEnd: this._handleScrollEnd, ref: this._renderer }));
                        }),
                        ...
                        (this._handlePositionUpdate = (e, t) => {
                            const { onItemsRendered: o } = this.props,
                                n = this.state.list;
                            0 === e && this.props.onAtStart(O), e === n.length - 1 && this.props.onAtEnd(O), 1 === e && this.props.onNearStart(O), e === n.length - 2 && this.props.onNearEnd(O), n[e] ? o && o({ positions: [{ id: n[e].id, rectangle: t }], viewport: t }) : (0, M.ZP)(`VerticalSnapScroller could not update position to ${e}, itemList was ${n.length} elements.`, { level: "warning" });
                        }),
            ...
            (V.contextType = T.y3), (V.defaultProps = { onPositionRestored: g.Z, onAtEnd: g.Z, onAtStart: g.Z, onNearEnd: g.Z, onNearStart: g.Z, onScrollEnd: g.Z, noItemsRenderer: I.Z, withKeyboardShortcuts: !1 });
            ...
            const ve = (e) => {
                    const { analytics: t, forwardPivotInfo: o, history: d, location: l, mode: m, pinnedTweet: b, pinnedTweetId: y, pinnedTweetUser: f } = e,
                        g = (0, K.hC)("immersive_viewer_enable_profile_viewer"),
                        [I] = n.useState(!1),
                        [M, v] = n.useState(null),
                        [T, D] = n.useState(!1),
                        [P, C] = n.useState(!1),
                    ...
                    (0, u.q)(() => {
                        if ((t.scribe({ action: "impression" }), !(A >= s.default.theme.breakpoints.large)))
                            return (
                                D(A >= s.default.theme.breakpoints.large),
                    ...
                    const k = n.useCallback(
                            (e) => {
                                if (b) {
                                    ...
                                    d.replace(`${b.permalink}/mediaViewer?currentTweet=${e.id_str}&currentTweetUser=${e.user.screen_name}${o}`), v(e);
                                }
                            },
                            [d, b, l.search],
                        ),
                        ...
                        B = n.useMemo(() => (g && "profile" === m ? ee(y) : X(y, f)), [m, y, f, g]),
                        U = n.useMemo(() => {
                            if (!b) return null;
                            const e = ((e) => {
                    ...
                    return n.createElement(
                        ...
                        n.createElement(
                            ...
                            n.createElement(
                                a.Z,
                                { style: Te.container, testID: "modalContainer" },
                                n.createElement(
                                    a.Z,
                                    { style: [Te.neighbor, T && Te.desktopNeighbor] },
                                    n.createElement(
                                        a.Z,
                                        { style: T && Te.desktopTimelineContainer },
                                        n.createElement(
                                            w.H.Provider,
                                            {
                                            ...
                                            y && n.createElement(j.Z, { entryConfiguration: Ie, module: B, previewEntries: b ? [G.Se({ id: y, sortIndex: "stable_sort_index" })] : void 0, scroller: $, title: ge }),
                                        ),
                                    ),
                                    n.createElement(a.Z, { style: T && Te.desktopMediaDrawer, testID: T ? "immersive-viewer-desktop-conversation-drawer" : void 0 }, M && ((e, t) => !!e || t)(T, I) ? n.createElement(te.Z, { location: l, rootTweet: M, screenName: f, tweet: M, tweetId: M.id_str }) : null),
                                ),
                            ),
                        ),
                    );
                },
                Te = s.default.create((e) => ({ container: { flexDirection: "row", overflowX: "hidden", overflowY: "hidden", height: "100%", width: "100%", position: "relative" }, neighbor: { flexGrow: 1, flexShrink: 1 }, desktopNeighbor: { display: "flex", flexDirection: "row" }, desktopTimelineContainer: { flex: 2 }, desktopMediaDrawer: { flex: 1 } })),
                De = pe((0, q.Z)(ve));
        },
        67534: (e, t, o) => {
            o.d(t, { Z: () => w });
            ...
            const m = r.default.create((e) => ({ root: { backgroundColor: e.colors.cellBackground, overflow: "auto", width: p.p, borderStartWidth: e.borderWidths.small, borderColor: e.colors.borderColor, borderStyle: "solid" } })),
                w = function ({ contextTweetId: e, location: t, promotedContent: o, rootTweet: r, screenName: p, socialContext: w, tweet: b, tweetId: y }) {
                    const [f, g] = n.useState(i.r.relevance),
                        I = (0, c.I0)(),
                        M = (0, d.n7)("CONVERSATION_DRAWER"),
                        v = n.useMemo(() => (0, l.i)(p), [p]),
                        T = (e, t) => {
                            let o = "Relevance";
                    ...
                    return n.createElement(
                        ...
                        n.createElement(s.Z, {
                            apiErrorHandlerMap: v,
                            changeDropdownState: (e) => {
                                g(e), I((0, h.Z)(T(y, e))).catch(M({}));
                            },
                            contextTweetId: e,
                            focalTweet: b,
                            focalTweetId: y,
        ...
        517747: (e, t, o) => {
            ...
            const s = (e = {}) => {
                ...
                return (0, r.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [i.Z.root, e.style], viewBox: "0 0 24 24", children: n.createElement("g", null, n.createElement("path", { d: "M14 6V3h2v8h-2V8H3V6h11zm7 2h-3.5V6H21v2zM8 16v-3h2v8H8v-3H3v-2h5zm13 2h-9.5v-2H21v2z" })) }, { writingDirection: t });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ImmersiveMediaViewer.628d019a.js.map
