    ...
    ["bundle.JobSearch-b308cbaf"],
    {
            ...
            class d extends a.Component {
                ...
                render() {
                    const { children: e, title: t } = this.props,
                        o = s({ title: t });
                    return a.createElement(l.Z, { "aria-labelledby": this._listDomId, role: "region" }, a.createElement(r.Z, { "aria-level": 1, id: this._listDomId, role: "heading", style: n.default.visuallyHidden }, t), a.createElement(l.Z, { "aria-label": o }, e));
                }
            }
            const m = d;
        },
        ...
        903233: (e, t, o) => {
            ...
            const i = n.default.create((e) => ({ root: { display: "flex", flexDirection: "row", height: "calc(100vh - 236px)", marginHorizontal: e.spaces.space16, borderWidth: e.borderWidths.small, borderColor: e.colors.borderColor, borderRadius: e.borderRadii.small, borderStyle: "solid" }, leftRoot: { display: "flex", overflow: "auto" }, rightRoot: { display: "flex", flexBasis: "auto", flexGrow: 1, flexShrink: 1, borderStartWidth: e.borderWidths.small, borderStartColor: e.colors.borderColor, borderStartStyle: "solid", overflow: "auto" }, mobileRoot: { display: "flex", height: "100%" }, mobileLeftRoot: { display: "flex", width: "100%", borderWidth: "0px", borderColor: e.colors.borderColor, borderStyle: "solid", borderBottomStartRadius: e.borderRadii.small }, mobileRightRoot: { position: "absolute", width: "100%", start: "0px", top: "0px", display: "none" }, mobileRightRootActive: { display: "block", backgroundColor: e.colors.cellBackground }, mobileOverlayPosition: { position: "absolute", top: 0, bottom: 0, start: 0, end: 0 }, overlayPosition: { position: "absolute", top: 0, bottom: 0, start: e.spaces.space16, end: e.spaces.space16 }, overlay: { backgroundColor: e.colors.navigationBackground } })),
                s = ({ isFullWidth: e = !1, isRightRootActive: t = !1, leftContent: o, mobileRootStyles: s, overlay: c, rightContent: d, rootStyles: m }) => {
                    const u = (0, l.Ji)(),
                        p = a.useMemo(() => ({ ...i.overlay, opacity: n.default.isDarkerMode() ? 0.8 : 0.9 }), []);
        ...
        247411: (e, t, o) => {
            ...
            const D = E().d13d697c,
                R = [
                    ...
                    { pathname: "/i/hiring", label: E().e0ba641a, icon: v.default, isActive: (e) => /(\/)?i\/hiring(\/\d+)?(\/)?$/.test(e), shouldHide: (e) => e.isVerifiedOrg(), decoration: a.createElement(h.ZP, { background: "blue500" }, a.createElement(g.ZP, { size: "subtext2" }, D)) },
                ],
                P = () => {
                    ...
                    return a.createElement(
                        r.Z,
                        { style: W.links },
                        R.map((l) => ((!l.featureSwitch || e.isTrue(l.featureSwitch)) && !l.shouldHide?.(t) ? a.createElement(a.Fragment, { key: l.pathname }, a.createElement(r.Z, null, l.isActive(o) ? a.createElement(r.Z, { style: W.currentLink }, a.createElement(g.ZP, { weight: "bold" }, l.label)) : a.createElement(b.ZP, { backgroundColor: "transparent", borderColor: "transparent", color: "buttonBlack", link: l.pathname }, l.label, l.decoration && a.createElement(r.Z, { style: W.decoration }, l.decoration)))) : null)),
                    );
                },
                T = () => {
                    const { featureSwitches: e, userClaims: t } = (0, i.QZ)(),
                    ...
                    return a.createElement(
                        ...
                        R.map((o) => ((!o.featureSwitch || e.isTrue(o.featureSwitch)) && !o.shouldHide?.(t) ? a.createElement(k.Z, { decoration: o.decoration, icon: o.icon, key: o.pathname, label: o.label, link: o.pathname }) : null)),
                ...
                W = l.default.create((e) => ({ root: { width: "100%" }, container: { width: "100%", padding: e.spaces.space16, display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, header: { gap: e.spaces.space16, display: "flex", flexDirection: "row", alignItems: "center" }, links: { gap: e.spaces.space4, display: "flex", flexDirection: "row", alignItems: "center" }, currentLink: { flexDirection: "row", alignItems: "center", paddingHorizontal: e.spaces.space16, height: e.spaces.space20, color: e.colors.text, borderRadius: e.borderRadii.infinite, backgroundColor: e.colors.gray0, borderColor: e.colors.gray0, minWidth: e.spaces.space36, minHeight: e.spaces.space36 }, mobileSearchContainer: { borderTopColor: e.colors.borderColor, borderTopStyle: "solid", borderTopWidth: e.borderWidths.small, borderBottomColor: e.colors.borderColor, borderBottomStyle: "solid", borderBottomWidth: e.borderWidths.small, paddingVertical: e.spaces.space4, width: "100%" }, searchContainer: { flex: 1, maxWidth: "300px", minWidth: "200px" }, decoration: { paddingStart: e.spaces.space8 } })),
                B = ({ isLoggedIn: e }) => {
                    const t = (0, p.Ji)(),
                        { featureSwitches: o } = (0, i.QZ)(),
                        l = o.isTrue("recruiting_global_jobs_search_enabled"),
                        n = o.isTrue("recruiting_job_recommendations_enabled");
                    return a.createElement(r.Z, { style: W.root }, a.createElement(m, null, a.createElement(r.Z, { style: W.container }, t ? null : a.createElement(_.Z, { disableMenuToggleWhenOpen: !0, renderCustomMenuItems: T }), a.createElement(r.Z, { style: W.header }, a.createElement(I.Z, null), t && a.createElement(P, null)), a.createElement(r.Z, { style: W.links }, t && l && a.createElement(r.Z, { style: W.searchContainer }, a.createElement(j, { styleType: "pill" })), e && t ? a.createElement(a.Fragment, null, n && a.createElement(b.ZP, { icon: a.createElement(Z.default, null), link: "/jobs/get-recommendations", testID: "recommendation-settings-btn", type: "primaryText" }), a.createElement(S.Z, { isExpanded: !1 })) : a.createElement(r.Z, null)))));
                },
                L = () => null,
                A = l.default.create((e) => ({ root: { height: "100vh", width: "100%", flex: 1 }, webViewSpacer: { paddingBottom: "24px" } })),
                M = ({ children: e }) => {
                    (0, s.ph)(), (0, s.G1)();
        ...
        856438: (e, t, o) => {
            ...
            var a = o(202784),
                ...
                c = o(262009);
            const d = s().a71d7584,
                m = n.default.create((e) => ({ label: { alignSelf: "auto" }, featuredLabel: { display: "flex", flexDirection: "row", gap: e.spaces.space4, alignItems: "center" }, featuredIcon: { height: e.spaces.space12 } })),
                u = () => a.createElement(r.ZP, { style: m.label, type: "priority" }, a.createElement(l.ZP, { style: m.featuredLabel }, a.createElement(c.default, { style: m.featuredIcon }), d));
        },
        150123: (e, t, o) => {
            o.d(t, { Z: () => n });
            var a = o(202784),
                r = o(691533),
                l = o(402058);
            const n = (e) => a.createElement(r.Z, { hideOnError: !0 }, a.createElement(l.Z, e));
        },
        965245: (e, t, o) => {
            o.d(t, { Z: () => s });
            var a = o(807896),
                ...
                n = o(414939),
                i = o(334346);
            const s = ({ accessibilityTitle: e, footer: t = r.createElement(n.Z, null), ...o }) => {
        ...
        998693: (e, t, o) => {
            ...
            const Z = p().jaaa8984,
                ...
                x = ({ onChange: e, onEnter: t, onSelect: o, value: a }) => {
                    const { isModal: l } = r.useContext(c.Z),
                        i = r.useRef(null),
                        m = s()(),
                        [u, p] = r.useState(!1),
                        [x, v] = r.useState([]),
                        ...
                        P = r.useCallback(
                            (e) => {
                                ...
                                return r.createElement(r.Fragment, null, u ? r.createElement(E.Z, { isLoading: S, items: t, onItemClick: R, ref: e.ref, source: y._4.JobLocation, style: e.style }) : null);
                            },
                            [R, x, S, u],
                        ),
                        T = r.useCallback(
                            (e) => {
                                const { onFocus: o } = e;
                                return r.createElement(d.Z, { Icon: b.default, autoComplete: "off", label: Z, name: "location-selector-input", onChange: D, onFocus: o, onKeyPress: t, ref: i, style: w.inputStyle, testID: "location-selector-input", value: a });
                            },
                            [D, t, a],
                        );
                    return r.createElement(f.default, { isInModal: l, renderCustomDropdown: P, renderCustomInput: T, rounded: !0, source: y._4.JobLocation, testID: "location-selector", userLimit: 20 });
                };
        },
        46705: (e, t, o) => {
            o.d(t, { X: () => a, g: () => r });
                        ...
                        a.createElement(
                            ...
                            a.createElement(
                                ...
                                o
                                    ...
                                    : null,
                                a.createElement(n.ZP, { numberOfLines: 1, size: "headline1", style: g.itemLabel, weight: "bold" }, c),
        ...
        652904: (e, t, o) => {
            ...
            class c extends a.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const c = r || i;
                    ((c && r !== i) || (!c && o !== l) || a !== n || s) && this._performPageUpdates(this.props);
                }
                render() {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.JobSearch-b308cbaf.5738cfea.js.map
