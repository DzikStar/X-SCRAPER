...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.JobSearch-b308cbaf"],
    {
        ...
        247411: (e, t, o) => {
            ...
            const R = Z().d13d697c,
                D = [
                    { pathname: "/jobs", label: Z().b72c924c, icon: C.default, featureSwitch: "recruiting_global_jobs_search_enabled", isActive: (e) => /(\/)?jobs(\/\d+)?(\/)?$/.test(e) },
                    { pathname: "/jobs/recommended", label: Z().f4da95a0, icon: w.default, featureSwitch: "recruiting_job_recommendations_enabled", isActive: (e) => /(\/)?jobs\/recommended(\/\d+)?(\/)?$/.test(e) },
                    { pathname: "/jobs/saved", label: Z().eedd808c, icon: v.default, featureSwitch: "recruiting_job_recommendations_enabled", isActive: (e) => /(\/)?jobs\/saved(\/\d+)?(\/)?$/.test(e) },
                    { pathname: "/i/hiring", label: Z().e0ba641a, icon: x.default, isActive: (e) => /(\/)?i\/hiring(\/\d+)?(\/)?$/.test(e), shouldHide: (e) => e.isVerifiedOrg(), decoration: a.createElement(h.ZP, { background: "blue500" }, a.createElement(g.ZP, { size: "subtext2" }, R)) },
                ],
                P = () => {
                ...
                T = () => {
                    ...
                    return a.createElement(
                        ...
                        e.isTrue("recruiting_job_recommendations_enabled") && a.createElement(k.Z, { icon: E.default, label: Z().bb081ea2, link: "/jobs/get-recommendations" }),
                    );
                },
                j = ({ styleType: e }) => {
        ...
        998693: (e, t, o) => {
            ...
            const E = p().jaaa8984,
                ...
                v = ({ onChange: e, onEnter: t, onSelect: o, value: a }) => {
                    const { isModal: n } = r.useContext(c.Z),
                        ...
                        P = r.useCallback(
                            (e) => {
                                ...
                                return r.createElement(r.Fragment, null, u ? r.createElement(Z.Z, { isLoading: _, items: t, onItemClick: D, ref: e.ref, source: y._4.JobLocation, style: e.style }) : null);
                            },
                            [D, v, _, u],
                        ),
                        T = r.useCallback(
                            (e) => {
                                const { onFocus: o } = e;
                                return r.createElement(d.Z, { Icon: b.default, autoComplete: "off", label: E, name: "location-selector-input", onChange: R, onFocus: o, onKeyPress: t, ref: i, style: w.inputStyle, testID: "location-selector-input", value: a });
                            },
                            [R, t, a],
                        );
        ...
        906433: (e, t, o) => {
            ...
            const u = () => d().d9ef2842,
                p = d().d86bbf0f,
                b = d().h6beb5fb,
                h = ({ badgeCount: e, decoration: t, icon: o, iconColor: s, label: c, link: d, onClick: h, pip: f, rightControl: y, testID: Z }) =>
                    a.createElement(
                        r.Z,
                        { style: g.dashMenuItem },
                        a.createElement(
                            n.Z,
                            { link: d, onClick: h, style: g.link, testID: Z },
                            a.createElement(
                                r.Z,
                                { style: g.item },
                                o
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.JobSearch-b308cbaf.0f2c663a.js.map
