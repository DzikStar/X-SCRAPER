    ...
    ["bundle.KeyboardShortcuts"],
    {
        625661: (e, t, o) => {
            ...
            class u extends r.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: i, hideBackButton: s, isFullWidth: a, isLarge: c, leftControl: d, middleControl: u, position: h, rightControl: m, secondaryBar: g, style: y, subtitle: k, title: b, titleDomId: v, titleIconCell: f, titleIconCellSize: w, withBackground: B, withWideContainer: C } = this.props,
                        { isModal: x } = this.context,
                        Z = s ? d : r.createElement(n.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        E = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!B, x, !!g);
                    return r.createElement(r.Fragment, null, r.createElement(l.Z, { centerTitle: t, centeredLogo: o, isFullWidth: a, isLarge: c, leftControl: Z, middleControl: u, position: p(h, x, i), rightControl: m, style: y, subtitle: k, title: b, titleDomId: v, titleIconCell: f, titleIconCellSize: w, withBackground: E, withWideContainer: C }), g || null);
                }
                render() {
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: o, backLocation: s, centerTitle: a, hideBackButton: n, history: l, isFullWidth: p, isLarge: u, middleControl: h, onBackClick: g, rightControl: y, secondaryBar: k, subtitle: b, title: v } = this.props,
                                { isModal: f } = this.context;
                            return r.createElement(i.Z, { style: f ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, r.createElement(d.ZP, { backButtonType: o || (f ? "close" : "back"), backLocation: s, centerTitle: a, fixed: !f, hideBackButton: n, history: l, isFullWidth: p, isLarge: u, middleControl: h, onBackClick: g, ref: e, rightControl: y, secondaryBar: k, style: [f && m.appBarModal, t], subtitle: b, title: v, titleDomId: c.Q_ }));
                        }),
            ...
            const k = (0, g.Z)()
                ...
                x = ({ history: e, location: t, viewerUserScreenName: o }) => {
                    const { userClaims: i } = r.useContext(u.rC),
                        ...
                        y = n(d),
                        k = [
                            { headerText: f, shortcuts: m },
                            { headerText: w, shortcuts: g },
                            { headerText: B, shortcuts: y },
                            { headerText: C, shortcuts: [] },
                        ];
                    return r.createElement(p.Z, { documentTitle: b, history: e, isLarge: !0, title: v }, r.createElement(Z, { isModal: a, shortcuts: k }));
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.KeyboardShortcuts.e0c274fa.js.map
