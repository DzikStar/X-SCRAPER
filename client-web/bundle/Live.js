...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Live", "bundle.AudioSpaceDetail"],
    {
                ...
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
                            ...
                            return e ? r.createElement(n.ZP, { "aria-label": D, hoverLabel: { label: y }, icon: r.createElement(s.default, null), onPress: this._handleUnfollow, style: t, type: "primaryOutlined" }) : r.createElement(n.ZP, { "aria-label": g, hoverLabel: { label: w }, icon: r.createElement(i.default, null), onPress: this._handleFollow, style: t, type: "primaryOutlined" });
                        }),
                        (this._handleFollow = () => {
        ...
        241304: (e, t, a) => {
                ...
                return r.createElement(
                    ...
                    d
                        ? r.createElement(
                              ...
                              r.createElement(o.Z, { style: S.header }, r.createElement(i.ZP, { weight: "bold" }, C), r.createElement(i.ZP, null, `@${m.screen_name}`)),
                              Object.entries(p)
                                  .filter(([e, t]) => t)
                                  .map(([e, t]) => {
                                      const o = k[e];
                                      if (o) {
                                          ...
                                          return r.createElement(i.ZP, { color: "text", key: e, link: s, onPress: l, style: S.service, withInteractiveStyling: !1 }, o.icon, o.label);
                                      }
                                  }),
                          )
                        : null,
            ...
            const S = d.default.create((e) => ({ close: { end: e.spaces.space16, position: "absolute", top: e.spaces.space16 }, header: { alignItems: "center", justifyContent: "center", marginHorizontal: "auto" }, service: { display: "flex", cursor: "pointer", gap: e.spaces.space8, marginBottom: e.spaces.space16 }, sheet: { padding: e.spaces.space16 } }));
        },
        684511: (e, t, a) => {
            a.d(t, { Z: () => r });
            a(202784);
        ...
        679180: (e, t, a) => {
            ...
            function f(e) {
                ...
                return r.createElement(
                    ...
                    d.isEditing
                        ? r.createElement(l.Z, { appTextSize: "headline1", inputStyle: g.titleInput, maxLength: 256, maxNumberOfLines: 3, multiline: !0, onChange: _, onSubmitEditing: y ? void 0 : E, placeholder: b.defaultTitle, rightContent: r.createElement(v, null), styleType: "selection", value: d.draftTitle })
                        : r.createElement(
                              n.Z,
                              { style: g.broadcastTitleRow },
                              r.createElement(s.Z, { displayTextRange: w, entities: D, linkify: !0, size: "headline1", style: g.broadcastTitleText, text: d.currentTitle, weight: "bold" }),
                              a &&
        ...
        365470: (e, t, a) => {
            ...
            const ae = b().jade381b,
                ...
                se = r.memo(({ broadcast: e, broadcastId: t, broadcaster: a, isLive: n }) => {
                    const { featureSwitches: s, viewerUserId: i } = (0, _.QZ)(),
                        d = (0, W.useHistory)(),
                        c = (0, Q.I0)(),
                        m = (0, z.b9)(te.Tc),
                        h = r.useCallback(() => {
            ...
            function Be(e) {
                const { broadcast: t, broadcastId: a, broadcaster: l, createLocalApiErrorHandler: p, fetchBroadcast: x, fetchLatestBroadcast: N, fetchStatus: F, latestBroadcastFetched: B, screenName: R, timecode: U } = e,
                    O = r.useContext(_.rC),
                    { viewerUserId: z } = O,
                    W = l?.id_str === z,
                    j = (0, s.Zx)(Pe),
                ...
                const q = r.useMemo(() => {
                    ...
                    G = r.useCallback(() => {
                        ...
                        return a ? r.createElement(o.Z, { style: Re.labelOverlay }, r.createElement(i.ZP, null, a)) : null;
                    }, [t, Y, V]),
                    K = r.useCallback(() => {
                        const e = t && t.pre_live_slate_url ? { url: t.pre_live_slate_url, width: 600, height: 337 } : Fe;
                        return r.createElement(o.Z, null, r.createElement(n.ql, { prioritizeSeoTags: !0 }, r.createElement("meta", { content: e.url, property: "og:image" }), r.createElement("meta", { content: e.width, property: "og:image:width" }), r.createElement("meta", { content: e.height, property: "og:image:height" })), r.createElement(d.Z, { "aria-label": Ae, aspectMode: c.Z.exact(m.default.theme.aspectRatios.landscape), image: e, previewMode: !1 }), G());
                    }, [t, G]),
                    J = r.useMemo(() => {
                        const e = t && t.media_key,
                            s = !a && l && B,
                            i = Te(t);
                        return t && t.state === S.N8.NotStarted ? K() : s ? r.createElement(o.Z, { style: Re.offlineContainer }, r.createElement(u.ZP, { size: "title2" }, ke({ screenName: R }))) : t && l && a && i && e ? r.createElement(r.Fragment, null, r.createElement(n.ql, { prioritizeSeoTags: !0 }, r.createElement("meta", { content: i.url, property: "og:image" }), r.createElement("meta", { content: i.width, property: "og:image:width" }), r.createElement("meta", { content: i.height, property: "og:image:height" })), r.createElement(P.Z, { "aria-label": Ae, aspectRatio: ve, displayOptions: Ze, poster: i, source: { variants: [], videoId: f.Z.forBroadcast(a), contentId: e }, videoType: "video" })) : null;
                    }, [t, a, l, B, K, R]),
                    Q = r.useMemo(() => r.createElement(o.Z, { style: Re.chat }, r.createElement(v.Z, { broadcastId: a ?? "", defaultChatNotice: ke({ screenName: R }) })), [a, R]),
                    X = r.useCallback(() => r.createElement(Z.aM, null, r.createElement(o.Z, { style: [Re.container, H ? Re.navBorder : void 0] }, r.createElement(o.Z, { style: Re.videoContainer }, r.createElement(L, null, J), a && r.createElement(o.Z, { style: Re.title }, r.createElement(A.H, { broadcastId: a, canEdit: W, remoteTitle: q })), r.createElement(se, { broadcast: t, broadcastId: a, broadcaster: l, isLive: t?.state === S.N8.Running })), j && Q)), [Q, J, t, a, l, W, j, H, q]);
                return r.createElement(
                    C.nO,
                    { namespace: Ne },
                    r.createElement(
                        ...
                        ((e) => {
                            const n = l?.name,
                                ...
                                s = Le(a || ""),
                                i = Le(a || "", U);
                            return l ? r.createElement(r.Fragment, null, r.createElement(y.Z, { canonical: s, description: e, title: n, type: "article" }), r.createElement(w.Z, { deepLink: o }), r.createElement(k.Z, { broadcast: t, broadcaster: l, id: a || "", timecode: U, title: e, url: i })) : null;
                        })(q),
                        r.createElement(E.Z, { title: q, withMeta: !1 }),
                        r.createElement(h.Z, { "aria-label": Se, fetchStatus: F, onRequestRetry: $, render: X }),
                    ),
                );
            }
            const Re = m.default.create((e) => ({ container: { display: "flex", flexDirection: "row", height: "100vh", overflow: "hidden" }, chat: { borderStartWidth: e.borderWidths.small, borderColor: e.colors.borderColor, height: "100vh", width: "340px" }, labelOverlay: { position: "absolute", bottom: e.spaces.space12, start: e.spaces.space12 }, navBorder: { borderStartWidth: e.borderWidths.small, borderColor: e.colors.borderColor }, title: { alignItems: "center", display: "flex", flexDirection: "row", gap: e.spaces.space12, justifyContent: "space-between", paddingHorizontal: e.spaces.space12, paddingTop: e.spaces.space12 }, offlineContainer: { aspectRatio: ve, backgroundColor: e.colors.gray0, flex: 1, justifyContent: "center", alignItems: "center" }, videoContainer: { flex: 1, WebkitOverflowScrolling: "touch", scrollbarWidth: "none", msOverflowStyle: "none", overflow: "auto" } })),
                Ue = Me((0, x.Z)(Be));
        },
        978053: (e, t, a) => {
            a.d(t, { default: () => b });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Live.5311dcda.js.map
