    ...
    ["bundle.LiveEvent-6107ac1a"],
    {
            ...
            const s = n().e3098e07,
                ...
                g = {
                    ...
                    formatWeekRange: (e) => {
                        ...
                        const s = new Date(Date.UTC(a.getUTCFullYear(), 0, 4)),
                            i = Math.floor((a.getTime() - s.getTime()) / 6048e5 + 1),
                            r = new Date(),
                            o = n > r ? r : n,
                            c = `${a.toLocaleString("en-US", { month: "short", day: "numeric" })} - ${o.toLocaleString("en-US", { month: "short", day: "numeric", year: "numeric" })}`;
                        return [a.getUTCFullYear(), i, c];
                    },
                };
        },
        661810: (e, t, l) => {
            ...
            function i({ spacing: e, style: t }) {
                return a.createElement(n.Z, { role: "separator", style: [r.divider, { marginVertical: null != e ? s.default.theme.spaces[e] : void 0 }, t] });
            }
            const r = s.default.create((e) => ({ divider: { backgroundColor: e.colors.borderColor, height: e.borderWidths.small } }));
        },
        392027: (e, t, l) => {
            l.d(t, { Z: () => o });
            var a = l(202784),
            ...
            class i extends a.PureComponent {
                render() {
                    const { "aria-label": e, backgroundColor: t, color: l, disabled: s, href: i, icon: o, label: c, onPress: d, renderMenu: u, style: p, testID: h } = this.props,
                        m = ((e, t) => ("primary" === e && "white" === t ? "whiteOnColor" : "white" === e && "primary" === t ? "primaryOnWhite" : t))(t, l);
                    return a.createElement(n.ZP, { "aria-label": e, backgroundColor: t, color: m, disabled: s, icon: o, link: i, onPress: d, renderMenu: u, size: "xLarge", style: [r.root, !c && r.iconOnly, p], testID: h }, c);
                }
            }
        ...
        420412: (e, t, l) => {
            ...
            function o({ borderColor: e = "borderColor", isSlim: t = !1, label: l }) {
                ...
                return l ? a.createElement(i.Z, { style: !t && c.root, withGutter: !0 }, a.createElement(n.Z, { style: c.gapColumn }, a.createElement(n.Z, { style: [c.gap, d] })), a.createElement(n.Z, { style: c.gapText }, l), a.createElement(n.Z, { style: c.gapColumn }, a.createElement(n.Z, { style: [c.gap, d] }))) : a.createElement(n.Z, { style: [!t && c.root, o() && c.rootRedesign, c.gap, d] });
            }
        ...
        885015: (e, t, l) => {
            ...
            class r extends n.Component {
                render() {
                    const { children: e, style: t, withGutter: l, ...i } = this.props,
                        r = n.Children.map(e, (e) => e && n.cloneElement(e, { style: [e.props.style, o.column, l && o.withGutterColumn] }));
                    return n.createElement(s.Z, (0, a.Z)({ style: [t, o.root, l && o.withGutter] }, i), r);
                }
            }
        ...
        149202: (e, t, l) => {
            ...
            class f extends a.Component {
                ...
                render() {
                    const { children: e, isRefreshing: t } = this.props,
                        ...
                        i = { pullDistance: (0, s.ST)(l, s.um.stiff) };
                    return a.createElement(
                        r.Z,
                        { style: b.root },
                        a.createElement(s.y_, { style: i }, ({ pullDistance: t }) => a.createElement(r.Z, { ref: this._getListViewRef, style: !!t && { transform: [{ translate3d: `0,${t}px,0` }] } }, a.createElement(r.Z, { ref: this._getPullViewRef, style: b.ptrCell }, n), a.createElement(r.Z, { style: t ? b.children : void 0 }, e))),
                    );
                }
                componentDidMount() {
            ...
            const b = m.default.create((e) => ({ root: { display: "block", position: "relative" }, ptrCell: { alignItems: "center", borderBottomWidth: "1px", borderBottomStyle: "solid", borderBottomColor: e.colors.borderColor, height: "4rem", justifyContent: "center", start: "0", position: "absolute", end: "0", top: "-4rem" }, children: { transform: [{ translate3d: "0, 0, 0" }] }, refreshArrow: { height: "2rem", color: e.colors.gray300, transitionProperty: "transform", transitionDuration: "250ms" }, refreshArrowReady: { transform: [{ rotate: "180deg" }] } })),
                _ = function ({ canRefresh: e = !0, children: t, isRefreshing: l = !1, onRefresh: n }) {
        ...
        403556: (e, t, l) => {
            ...
            class k extends n.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: l, badgePip: a, children: s, color: i, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: k, style: P, to: C } = this.props,
                        { location: T } = this.state,
                        w = C ? this._getMemoizedLink(C, k) : void 0,
                        E = c ? c(C) : T?.pathname === w?.pathname,
                        L = y.Z.generate({ backgroundColor: "transparent", color: r.default.theme.colors.text, insetFocusRing: !0 }),
                        R = g ? "medium" : E ? "bold" : "medium";
                    return n.createElement(f.Z, { "aria-label": t, "aria-selected": E, focusable: !!E, interactiveStyles: L, link: w, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? S.pill : S.link, u && E ? S.active : null, d ? (u ? S.compactPill : S.compactLink) : null, p ? S.roundedRect : null, P], withoutInteractiveStyles: g || u }, ({ isFocused: t, isHovered: c }) => n.createElement(o.Z, { style: u && S.flexGrow }, n.createElement(h.ZP, { size: g ? "headline2" : void 0, style: [S.text, { color: this._getTextColor(E, c, g, u) }, d && S.compactText, g && t && S.focusedText], weight: R }, e && n.createElement(e, { style: S.icon }), s, g || u ? null : n.createElement(o.Z, { style: E && [S.border, { backgroundColor: r.default.theme.colors[i] }] })), l ? n.createElement(m.Z, { count: l, standalone: !0, style: [S.badge, l >= 10 && S.multiDigitBadge, l >= 20 && S.truncatedCountBadge], truncatedCountFormatter: v, unreadCountLabel: b, withBorder: !1 }) : a ? n.createElement(m.Z, { pip: !0, standalone: !0, style: S.badgePip, textColor: "red500", unreadCountLabel: _, withBorder: !1 }) : null));
                }
            }
                        ...
                        g = n.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: s, ...i }, c) => {
                                    ...
                                    return n.createElement(P, (0, a.Z)({ viewType: s }, i, { isCompact: l, isPillLink: r, isRoundedRect: o, isWebRedesign: m, style: d }), t);
                                }),
                            [e, l, r, o, m, c],
                        );
        ...
        165822: (e, t, l) => {
            ...
            const o = r.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                c = ({ "aria-label": e, containerStyle: t, disabled: l, isCompact: c, link: d, lower: u, onClick: p, stackLayoutLowerStyle: h, stackLayoutUpperStyle: m, upper: g, withInsetFocusRing: y = !0, withInteractiveStyling: f = !1 }) => {
                    const b = s.Z.generate({ backgroundColor: r.default.theme.colors.transparent, color: r.default.theme.colors.primary, insetFocusRing: y }),
                        _ = a.createElement(a.Fragment, null, a.createElement(n.Z, { style: [o.defaultUpperContainerStyle, m, c && { height: "auto" }] }, g), u ? a.createElement(n.Z, { style: [o.defaultLowerContainerStyle, h] }, u) : null);
                    return a.createElement(i.Z, { "aria-label": e, disabled: l, interactive: f, interactiveStyles: f ? b : void 0, link: d, onClick: p, style: [o.root, t] }, _);
                };
        },
        470014: (e, t, l) => {
            l.d(t, { Z: () => u });
            ...
            const d = o.default.create((e) => ({ root: { padding: e.spaces.space4 }, upper: { height: "auto" }, title: { paddingBottom: e.spaces.space4 }, description: { paddingBottom: e.spaces.space8 }, previousPrice: { textDecorationLine: "line-through", marginStart: e.spaces.space4 }, price: { paddingBottom: e.spaces.space8 }, imageColorOverlay: { position: "absolute", backgroundColor: e.colors.gray700, opacity: 0.05, width: "100%", height: "100%" }, imageOverlay: { position: "absolute", bottom: e.spaces.space12, start: e.spaces.space12, marginEnd: e.spaces.space12, paddingVertical: e.spaces.space4, paddingHorizontal: e.spaces.space8, backgroundColor: e.colors.white, borderRadius: e.borderRadii.xLarge } })),
                u = (e) => {
                    const { "aria-label": t, containerStyle: l, description: o, image: u, imageOverlayText: p, link: h, onClick: m, previousPrice: g, price: y, title: f } = e,
                        b = p ? a.createElement(i.ZP, { color: "alwaysBaseGray1100", size: "subtext3", style: d.imageOverlay, weight: "bold" }, p) : null,
                        _ = a.createElement(a.Fragment, null, a.createElement(s.Z, { "aria-label": t, aspectMode: r.Z.SQUARE, image: u }), a.createElement(n.Z, { style: d.imageColorOverlay }), b),
                        v = g ? a.createElement(i.ZP, { color: "gray700", numberOfLines: 1, style: d.previousPrice, weight: "normal" }, g) : null,
                        k = y ? a.createElement(i.ZP, { numberOfLines: 1, size: "subtext2", style: d.price }, y, v) : null,
                        S = a.createElement(a.Fragment, null, a.createElement(i.ZP, { numberOfLines: 1, style: d.title, weight: "bold" }, f), a.createElement(i.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2", style: d.description }, o), k);
                    return a.createElement(c.Z, { "aria-label": t, containerStyle: [d.root, l], link: h, lower: S, onClick: m, stackLayoutUpperStyle: d.upper, upper: _, withInteractiveStyling: !0 });
                };
        },
        874090: (e, t, l) => {
            l.d(t, { Z: () => n });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-6107ac1a.4f40d5ba.js.map
