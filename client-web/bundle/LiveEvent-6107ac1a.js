            ...
            class k extends n.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: l, badgePip: a, children: s, color: i, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: k, style: P, to: C } = this.props,
                        ...
                        L = c ? c(C) : w?.pathname === E?.pathname,
                        T = y.Z.generate({ backgroundColor: "transparent", color: r.default.theme.colors.text, insetFocusRing: !0 }),
                        R = g ? "medium" : L ? "bold" : "medium";
                    return n.createElement(f.Z, { "aria-label": t, "aria-selected": L, focusable: !!L, interactiveStyles: T, link: E, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? S.pill : S.link, u && L ? S.active : null, d ? (u ? S.compactPill : S.compactLink) : null, p ? S.roundedRect : null, P], withoutInteractiveStyles: g || u }, ({ isFocused: t, isHovered: c }) => n.createElement(o.Z, { style: u && S.flexGrow }, n.createElement(h.ZP, { size: g ? "headline2" : void 0, style: [S.text, { color: this._getTextColor(L, c, g, u) }, d && S.compactText, g && t && S.focusedText], weight: R }, e && n.createElement(e, { style: S.icon }), s, g || u ? null : n.createElement(o.Z, { style: L && [S.border, { backgroundColor: r.default.theme.colors[i] }] })), l ? n.createElement(m.Z, { count: l, standalone: !0, style: [S.badge, l >= 10 && S.multiDigitBadge, l >= 20 && S.truncatedCountBadge], truncatedCountFormatter: v, unreadCountLabel: b, withBorder: !1 }) : a ? n.createElement(m.Z, { pip: !0, standalone: !0, style: S.badgePip, textColor: "red500", unreadCountLabel: _, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-6107ac1a.bf99108a.js.map
