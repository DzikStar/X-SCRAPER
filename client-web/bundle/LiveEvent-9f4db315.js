            ...
            const B = { page: "trending_event_timeline", section: "trending_event_header" },
                ...
                M = (e) => {
                    const t = (0, b.z)(),
                        ...
                        w = d().ef1042f8,
                        T = () => {
                            const e = [{ Icon: u.default, onClick: I, text: Y }, ...n.map((e) => ({ Icon: p.default, onClick: () => S(e.action_value), text: e.name }))];
                            return (
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-9f4db315.2d3b938a.js.map
