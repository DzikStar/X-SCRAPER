        ...
        219770: (e, t, n) => {
            ...
            const B = { page: "trending_event_timeline", section: "trending_event_header" },
                ...
                M = (e) => {
                    ...
                    return i.createElement(a.Z, { style: j.headerRoot }, i.createElement(U, { isSaved: P, trendId: c }), i.createElement(C, { trendId: c }), i.createElement(G, { id: c }), i.createElement(s.ZP, { icon: i.createElement(m.default, { style: j.button }), renderMenu: (e) => i.createElement(o.Z, { items: T(), onCloseRequested: e, shouldCloseOnClick: !0 }), size: "medium", style: j.button, type: "onMediaText" }));
                },
                V = i.memo(M),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-9f4db315.3bf0e87a.js.map
