(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.LiveEvent-9f4db315"],
    {
        ...
        219770: (e, t, n) => {
            ...
            const D = d().i2209530,
                ...
                B = (e) => {
                    const { isSaved: t, trendId: n } = e,
                        i = t ? O : D,
                        o = (0, h.I0)(),
                        s = t ? r.createElement(S.default, { style: L.button }) : r.createElement(I.default, { style: L.button });
            ...
            var R = n(688715),
                z = n(907552);
            const A = { page: "trending_event_timeline", section: "trending_event_header" },
                M = l.default.create((e) => ({ button: { marginEnd: e.spaces.space8 } })),
                F = (e) => {
                    const { hashtag: t, id: n } = e,
                        o = (0, R.ju)(`https://x.com/i/trending/${n}`);
                    return r.createElement(i.Z, { style: M.button }, r.createElement(z.ZP, { scribeNamespace: A, shareText: t, url: o }));
                },
                $ = { page: "trending_event_timeline", section: "trending_event_header", element: "contribute_to_birdwatch" },
                j = d().a9042b6c,
                Q = (e) => {
                    const t = (0, f.z)(),
                        ...
                        C = d().ef1042f8,
                        P = () => {
                            const e = [{ Icon: u.default, onClick: T, text: j }, ...n.map((e) => ({ Icon: m.default, onClick: () => Z(e.action_value), text: e.name }))];
                            return (
                    ...
                    return r.createElement(i.Z, { style: H.headerRoot }, r.createElement(N, { isSaved: y, trendId: c }), r.createElement(x, { trendId: c }), r.createElement(F, { id: c }), r.createElement(a.ZP, { icon: r.createElement(p.default, { style: H.button }), renderMenu: (e) => r.createElement(s.Z, { items: P(), onCloseRequested: e, shouldCloseOnClick: !0 }), size: "medium", style: H.button, type: "onMediaText" }));
                },
                U = r.memo(Q),
        ...
        162246: (e, t, n) => {
            ...
            class k extends r.PureComponent {
                ...
                _renderDockingControls(e, t) {
                    return r.createElement(i.Z, { style: T.dockingControls }, r.createElement(a.ZP, { "aria-label": E, icon: r.createElement(u.default, null), onPress: e, type: "brandText" }), r.createElement(a.ZP, { "aria-label": w, icon: r.createElement(m.default, null), onPress: t, type: "brandText" }));
                }
            }
            k.defaultProps = { placeholder: r.createElement(s.Z, { ratio: l.default.theme.aspectRatios.landscape }), visibleThreshold: 0 };
            const T = l.default.create((e) => ({ root: { zIndex: 1 }, dockedContainer: { bottom: 0, end: 0, marginEnd: e.spaces.space20, boxShadow: e.boxShadows.small, maxWidth: _.Z.columnWidths.secondary.normal, position: "fixed", width: _.Z.columnWidths.secondary.normal }, dockingControls: { flexDirection: "row", alignItems: "baseline" } })),
                Z = k;
        },
        414939: (e, t, n) => {
            "use strict";
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-9f4db315.01cf2b7a.js.map
