            ...
            const B = { page: "trending_event_timeline", section: "trending_event_header" },
                ...
                Y = (e) => {
                    const t = (0, b.z)(),
                        ...
                        S = d().ef1042f8,
                        T = () => {
                            const e = [{ Icon: u.default, onClick: I, text: M }, ...n.map((e) => ({ Icon: p.default, onClick: () => w(e.action_value), text: e.name }))];
                            return (
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-9f4db315.62ca0dda.js.map
