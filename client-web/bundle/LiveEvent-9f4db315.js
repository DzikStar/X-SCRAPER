            ...
            const z = { page: "trending_event_timeline", section: "trending_event_header" },
                ...
                F = (e) => {
                    const { hashtag: t, id: n } = e,
                        o = (0, L.ju)(`https://x.com/i/trending/${n}`);
                ...
                j = (e) => {
                    ...
                    return r.createElement(i.Z, { style: H.headerRoot }, r.createElement(R, { isSaved: y, trendId: c }), r.createElement(x, { trendId: c }), r.createElement(F, { id: c }), r.createElement(a.ZP, { icon: r.createElement(p.default, { style: H.button }), renderMenu: (e) => r.createElement(s.Z, { items: P(), onCloseRequested: e, shouldCloseOnClick: !0 }), size: "medium", style: H.button, type: "onMediaText" }));
                },
                U = r.memo(j),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-9f4db315.c40973ca.js.map
