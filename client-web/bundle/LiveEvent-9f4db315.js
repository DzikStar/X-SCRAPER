    ...
    ["bundle.LiveEvent-9f4db315"],
    {
        ...
        219770: (e, t, n) => {
                        ...
                        r.createElement(
                            ...
                            !o &&
                                r.createElement(a.ZP, {
                                    "aria-label": k,
                                    hoverLabel: { label: k },
                                    icon: r.createElement(w.default, { "aria-label": k, style: P.button }),
                                    onClick: () => {
                                        c((0, g.x)(t)), i(!0);
                                    },
                                    size: "medium",
            ...
            const z = { page: "trending_event_timeline", section: "trending_event_header" },
                ...
                F = { page: "trending_event_timeline", section: "trending_event_header", element: "contribute_to_birdwatch" },
                $ = d().a9042b6c,
                Q = (e) => {
                    const t = (0, f.z)(),
                        ...
                        Z = r.useCallback(
                            (e) => {
                                k((0, g.V)(c, e)), (0, v.fz)({ text: "Your input has been submitted." });
                            },
                            [c, k],
                        ),
                        C = d().ef1042f8,
                        P = () => {
                            const e = [{ Icon: u.default, onClick: T, text: $ }, ...n.map((e) => ({ Icon: _.default, onClick: () => Z(e.action_value), text: e.name }))];
                            return (
                    ...
                    return r.createElement(i.Z, { style: U.headerRoot }, r.createElement(L, { isSaved: y, trendId: c }), r.createElement(x, { trendId: c }), r.createElement(j, { id: c }), r.createElement(a.ZP, { icon: r.createElement(p.default, { style: U.button }), renderMenu: (e) => r.createElement(s.Z, { items: P(), onCloseRequested: e, shouldCloseOnClick: !0 }), size: "medium", style: U.button, type: "onMediaText" }));
                },
                H = r.memo(Q),
        ...
        208560: (e, t, n) => {
            ...
            const u = (e) => l.T[e.currency_code.toUpperCase()](parseInt(e.micro_value, 10) / 1e6),
                ...
                b = (e) => {
                    ...
                    return { formattedDescription: p(b, f), formattedPercentOff: v && !y ? m(g, v) : void 0, formattedPreviousPrice: v && !y ? u(v) : void 0, formattedPrice: y ? void 0 : _(g, r), formattedTitle: d, image: "ApiImage" === h.__typename ? h.original_img_url : "", url: s.url };
                },
                f = (e) => {
        ...
        162246: (e, t, n) => {
            ...
            const y = function (e) {
                    ...
                    return (
                        r.useEffect(() => {
                            o && !_ && a(!1), o || s === _ || (l(_), d({ ...g, action: _ ? v.dockedOnScroll : v.undockOnScroll }));
                        }, [o, s, d, _]),
                        r.useEffect(() => {
                            if (!s && o) c && c();
                            else if (!s && n?.current) {
            ...
            class k extends r.PureComponent {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._render = ({ closeRequested: e, dockRequested: t, requestClose: n, requestUndock: o }) => {
                            ...
                            return r.createElement(b.Z.Provider, { value: { closeRequested: e, dockRequested: t } }, t && s, r.createElement(i.Z, { style: t ? [T.dockedContainer, this._getDockedBottomStyle()] : void 0 }, t && this._renderDockingControlBar(o, n), a));
                        }),
                ...
                render() {
                    ...
                    return r.createElement(p.ZP, { onPlacementChange: this._handlePlacementChange, style: T.root }, r.createElement(y, { onCloseDockComplete: n, onDockingScribeAction: i, render: this._render, requestDock: e && !t }));
                }
                ...
                _renderDockingControls(e, t) {
                    return r.createElement(i.Z, { style: T.dockingControls }, r.createElement(a.ZP, { "aria-label": E, icon: r.createElement(u.default, null), onPress: e, type: "brandText" }), r.createElement(a.ZP, { "aria-label": w, icon: r.createElement(_.default, null), onPress: t, type: "brandText" }));
                }
            }
            k.defaultProps = { placeholder: r.createElement(s.Z, { ratio: l.default.theme.aspectRatios.landscape }), visibleThreshold: 0 };
            const T = l.default.create((e) => ({ root: { zIndex: 1 }, dockedContainer: { bottom: 0, end: 0, marginEnd: e.spaces.space20, boxShadow: e.boxShadows.small, maxWidth: m.Z.columnWidths.secondary.normal, position: "fixed", width: m.Z.columnWidths.secondary.normal }, dockingControls: { flexDirection: "row", alignItems: "baseline" } })),
                Z = k;
        },
        414939: (e, t, n) => {
            "use strict";
        ...
        111685: (e, t, n) => {
            ...
            const f = s.default.create((e) => ({ description: { marginTop: e.spaces.space12 } })),
                ...
                w = ({ author: e, coverTweet: t, description: n, descriptionEntities: s, imageAttribution: c, isTOO: d, mediaType: u, pivotText: _, preTitle: m, remindMeButton: p, time: b, title: f, withHashflags: h }) => {
                    const g = () => (e ? r.createElement(i.Z, null, r.createElement(l.S3, { author: e, size: "body", withLink: !0, withScreenName: !0 }), b ? w(!0) : null) : null),
                        ...
                        E = () => (m ? r.createElement(a.Z, null, r.createElement(o.ZP, { color: "gray700", numberOfLines: 1, size: "body", weight: "bold" }, m), b ? w() : null) : null);
                    return r.createElement(r.Fragment, null, d && m ? E() : g() || E(), r.createElement(o.ZP, { dir: "auto", size: "title4", style: y.title, weight: "heavy", withHashflags: h }, f), n || t || c ? r.createElement(v, { coverTweet: t, description: n, descriptionEntities: s, imageAttribution: c, mediaType: u, pivotText: _ }) : null, p ? r.createElement(i.Z, { style: y.remindMeButton }, p) : null);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-9f4db315.9162623a.js.map
