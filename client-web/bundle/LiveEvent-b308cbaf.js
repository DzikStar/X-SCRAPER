    ...
    ["bundle.LiveEvent-b308cbaf"],
    {
        ...
        741692: (e, t, r) => {
            ...
            const d = "placeholderIcon",
                ...
                g = ({ style: e }) => o.createElement(n.Z, { style: [h.lightningBadge, e] }, o.createElement(c.default, { style: h.lightningIcon })),
                u = ({ icon: e }) => o.createElement(n.Z, { style: h.placeholderIconContainer, testID: d }, "news" === e ? o.createElement(s.default, { style: h.placeholderIcon }) : "lists" === e ? o.createElement(l.default, { style: h.placeholderIcon }) : o.createElement(m.default, { style: h.placeholderIcon })),
        ...
        954970: (e, t, r) => {
            ...
            const d = function (e) {
                ...
                const g = d ? "primaryOutlined" : "primaryFilled",
                    u = d ? c : s;
        ...
        514029: (e, t, r) => {
            ...
            class h extends o.Component {
                        ...
                        t = ((e) => {
                            ...
                            if (t) {
                                const { id: e, participant_scores: r, progress_strings: o, status: n, winner_id: a } = t,
                                    i = n === d.I.LIVE;
                                return { isLive: i, progressStrings: u({ id: e, status: n, isLive: i }) ? o.join(" ") : o[0], participantScores: r, winnerId: a };
                            }
                        })(e);
                ...
                _renderScoreCardWithHeader(e) {
                    ...
                    return o.createElement(o.Fragment, null, t ? o.createElement(a.Z, { text: g }) : null, this._renderScoresAndMatchStatus(e));
                }
                ...
                _renderTeamRow(e, t, r) {
                    const {
                        ...
                        u = r || g ? "bold" : "normal",
                        h = d ? `${m.split(" ")[0]} ${d}` : m;
                    return o.createElement(n.Z, { key: a, style: y.teamRow, testID: p }, o.createElement(c.Z, { source: s.url, style: y.teamLogo }), o.createElement(i.ZP, { align: "left", numberOfLines: 1, style: y.teamName }, l), o.createElement(i.ZP, { style: y.teamScore, weight: u }, h), o.createElement(n.Z, { style: [y.winnerContainer, g && y.winner] }));
                }
            }
        ...
        650554: (e, t, r) => {
            ...
            var o = r(202784),
                ...
                g = r(668214),
                u = r(256727);
            const h = (e, t) => (t.commerceItemId ? u.Z.select(e, t.commerceItemId) : void 0),
                y = (0, g.Z)().propsFromState(() => ({ commerceItem: h }))((e) => {
            ...
            const E = (e, t) =>
                    t.module
                        .selectItems(e)
                        .map((t) => (t ? u.Z.select(e, t) : void 0))
                        .filter(Boolean),
                b = (0, g.Z)().propsFromState((e) => ({ commerceItems: E })),
                w = s().e9f1fbcc,
                I = s().c9b302f8,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LiveEvent-b308cbaf.921d775a.js.map
