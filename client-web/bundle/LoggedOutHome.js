    ...
    ["bundle.LoggedOutHome", "bundle.AudioSpaceDetail"],
    {
        ...
        572067: (e, t, n) => {
            ...
            var o = n(202784),
                a = n(272175);
            const i = (e) => {
                const { canonical: t, description: n = "", image: i, imageAlt: r, imageH: s, imageType: l, imageW: c, title: p, ttl: d, type: m } = e;
                return o.createElement(a.ql, null, m ? o.createElement("meta", { content: m, property: "og:type" }) : null, t ? o.createElement("meta", { content: t, property: "og:url" }) : null, p ? o.createElement("meta", { content: p, property: "og:title" }) : null, o.createElement("meta", { content: n, property: "og:description" }), i ? o.createElement("meta", { content: i, property: "og:image" }) : null, l ? o.createElement("meta", { content: l, property: "og:image:type" }) : null, c ? o.createElement("meta", { content: c, property: "og:image:width" }) : null, s ? o.createElement("meta", { content: s, property: "og:image:height" }) : null, r ? o.createElement("meta", { content: r, property: "og:image:alt" }) : null, d ? o.createElement("meta", { content: d, property: "og:ttl" }) : null);
            };
        },
        105019: (e, t, n) => {
            n.d(t, { Z: () => p });
        ...
        885824: (e, t, n) => {
            ...
            function x() {
                const e = o.createElement(g().I18NFormatMessage, { $i18n: "e4af7661" }, o.createElement(c.ZP, { color: "buttonWhite", link: S, withUnderline: !0 }, g().ga3121d5));
                return o.createElement(_, { body: e, title: E });
            }
            function k(e) {
                ...
                return o.createElement(_, { body: t, title: E });
            }
            function _(e) {
                return o.createElement(s.Z, { style: w.cookieComplianceMessageWrap }, o.createElement(c.ZP, { color: "buttonWhite", size: "headline2", weight: "medium" }, e.title), o.createElement(c.ZP, { color: "buttonWhite", size: "subtext2", style: w.cookieComplianceExpandedDetails }, e.body));
            }
            const C = o.forwardRef(function (e, t) {
                    ...
                    const u = (0, p.pj)();
                    return l ? o.createElement(s.Z, { ref: t, style: [w.root, u && w.rootNarrow] }, i ? o.createElement(x, null) : o.createElement(k, { onExpand: a }), o.createElement(s.Z, { style: [w.buttonContainer, u && w.buttonContainerNarrow] }, o.createElement(d.ZP, { dominantColor: "alwaysBaseGray1100", onPress: r, size: "medium", style: [w.ctaButton, u && w.ctaButtonNarrow], type: m.default.isDarkMode() ? "onMediaDominantColorFilled" : "onMediaWhiteFilled" }, y), o.createElement(d.ZP, { dominantColor: "alwaysBaseGray1100", onPress: c, size: "medium", style: [w.ctaButton, u && w.ctaButtonNarrow], type: m.default.isDarkMode() ? "onMediaDominantColorFilled" : "onMediaWhiteFilled" }, B))) : null;
                }),
                w = m.default.create((e) => ({ root: { alignItems: "center", boxShadow: e.boxShadows.xSmall, flexDirection: "row", width: "100%", justifyContent: "space-evenly", paddingVertical: e.componentDimensions.gutterVertical, paddingHorizontal: e.componentDimensions.gutterHorizontal, backgroundColor: e.colors.buttonBlack }, rootNarrow: { flexDirection: "column", paddingVertical: e.componentDimensions.gutterVertical, paddingTop: e.spaces.space20, backgroundColor: e.colors.buttonBlack }, buttonContainer: { flexDirection: "column", marginVertical: e.spaces.space16, marginStart: e.spaces.space20 }, buttonContainerNarrow: { width: "100%", maxWidth: 550, marginStart: 0, flexDirection: "column", flexWrap: "wrap" }, ctaButton: { height: e.spaces.space40, marginBottom: e.spaces.space8, width: 420, flexGrow: 0, flexShrink: 0 }, ctaButtonNarrow: { marginStart: 0, width: "100%" }, cookieComplianceMessageWrap: { flex: 1, maxWidth: 640 }, cookieComplianceExpandedDetails: { marginTop: e.spaces.space8, marginBottom: e.spaces.space8 }, background: { backgroundColor: e.colors.buttonBlack } }));
            function Z(e, t = 100) {
        ...
        664918: (e, t, n) => {
            ...
            function l(e) {
                const t = (0, o.bL)(e);
                return t ? (d(t) ? (m(t) ? (t[1] ? s.AcceptAllCookies : t[2] ? s.RefuseNonEssentialCookies : ((0, a.ZP)("Invalid consent signal state"), s.Invalid)) : s.NotSet) : s.Invalid) : s.NotSet;
            }
            function c(e) {
            ...
            function u(e) {
                const t = (0, o.bL)(e);
                return !t || !d(t) || !m(t) || t.consent_version < i || t.text_version < r;
            }
        },
        421023: (e, t, n) => {
            n.d(t, { A: () => o });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.LoggedOutHome.4c37afea.js.map
