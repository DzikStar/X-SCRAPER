    ...
    ["bundle.MultiAccount"],
    {
            ...
            class h extends r.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: a, hideBackButton: n, isFullWidth: i, isLarge: l, leftControl: d, middleControl: h, position: p, rightControl: m, secondaryBar: g, style: f, subtitle: b, title: C, titleDomId: y, titleIconCell: B, titleIconCellSize: _, withBackground: k, withWideContainer: w } = this.props,
                        ...
                        Z = n ? d : r.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        A = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!k, E, !!g);
                    return r.createElement(r.Fragment, null, r.createElement(c.Z, { centerTitle: t, centeredLogo: o, isFullWidth: i, isLarge: l, leftControl: Z, middleControl: h, position: u(p, E, a), rightControl: m, style: f, subtitle: b, title: C, titleDomId: y, titleIconCell: B, titleIconCellSize: _, withBackground: A, withWideContainer: w }), g || null);
                }
                render() {
        ...
        290402: (e, t, o) => {
            ...
            const u = l().aa6e3300,
                h = ({ retryMessage: e, ...t }, o) => {
                    ...
                    return a.createElement(i.Z, (0, r.Z)({}, t, { icon: s ? void 0 : a.createElement(d.default, { style: p.icon }), retryMessage: s ? e : u }));
                },
        ...
        980407: (e, t, o) => {
            ...
            class p extends r.Component {
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: o, containerStyle: i, documentTitle: s, isFullWidth: l, isLarge: d, renderHeader: p, title: g, withoutBottomBarMobile: f } = this.props,
                        { isModal: b } = this.context,
        ...
        229412: (e, t, o) => {
            ...
            function W(e) {
                const { accountSwitch: t, accountUsers: o, activeUser: d, clearDelegateUser: u, delegateAccountCount: h, delegateUser: _, isDelegateEnabled: k, isUpdatedManageAccounts: w, onDelegateSwitch: A, onUserSwitch: v, userTestId: S, withBadges: x = !1 } = e,
                    L = !!_,
                    M = o.some((e) => e.user_id === d.id_str) || (h && h > 0) || L,
                    I = r.useCallback(() => {
                        u && u();
                    }, [u]),
                    U = r.useCallback(
                    ...
                    G = r.useCallback(({ badgeCount: e, isActiveUser: t, withBadges: o }) => (t ? (k ? r.createElement(m.default, { style: [V.IconCheckmarkCircleFill, V.userDecoration] }) : r.createElement(f.default, { style: [V.iconCheckMark, V.userDecoration] })) : e && o ? r.createElement(i.Z, { count: e, standalone: !0, style: V.userDecoration, truncatedCountFormatter: z, unreadCountLabel: H }) : void 0), [k]),
                    ...
                    J = [];
                return !w && k && J.push(q), J.push(O), w && k && J.push(q), r.createElement(r.Fragment, null, w && k && r.createElement(a.Z, { style: V.personalAccountsLabel }, r.createElement(s.ZP, { color: "gray700", weight: "bold" }, R)), M ? r.createElement(r.Fragment, null, r.createElement(c.ZP, { affiliateBadgeInfo: d.highlightedLabel, avatarDecoration: w && r.createElement(E, { notificationCount: T + D }), avatarUri: d.profile_image_url_https, badgeContext: "account", decoration: j({ withBadges: x, isActiveUser: !_, isLoggedInUser: !0 }), displayMode: "UserCompact", isBlueVerified: d.is_blue_verified, isProtected: d.protected, isVerified: d.verified, name: d.name, onCellClick: L ? I : void 0, screenName: d.screen_name, testID: S, userId: d.id_str, verifiedType: d.verified_type, withLink: !1 }), w && r.createElement(l.Z, { style: V.accountDivider })) : null, J, !w && (M || h || o.length) ? r.createElement(l.Z, { spacing: "space12" }) : null);
            }
                    ...
                    super(...e),
                        ...
                        (this._updatedRenderActions = () => {
                            const e = this.context.featureSwitches.getNumberValue("responsive_web_multiple_account_limit", 5),
                                ...
                                n = o.length >= e;
                            return r.createElement(r.Fragment, null, n ? r.createElement(a.Z, { style: [Q.whiteBackground, Q.infoText, Q.updatedAccountLimitText] }, r.createElement(i.ZP, { align: "center", color: "gray700" }, (t ? z : H)({ maxAccounts: e }), " ")) : r.createElement(s.ZP, { onPress: this._handleAddAccount, style: Q.updatedAddAccountButton, testID: M }, r.createElement(i.ZP, { color: "buttonBlack", weight: "normal" }, D)), r.createElement(a.Z, { style: Q.updatedLogoutAllButtonWrapper }, r.createElement(g.Z, { color: "red500", confirmationSheetConfirmButtonLabel: N, confirmationSheetConfirmButtonType: "primary", confirmationSheetHeadline: j, confirmationSheetText: q, key: "logoutAllButton", label: G, onConfirmationSheetConfirm: this._handleLogoutAll, withBottomBorder: !1 })));
                        }),
                        (this._renderActions = () => {
                            const e = this.context.featureSwitches.getNumberValue("responsive_web_multiple_account_limit", 5),
                                { users: t } = this.props,
                                o = t.length >= e;
                            return r.createElement(r.Fragment, null, r.createElement(c.Z, { align: "left", color: "primary", disabled: o, label: D, onPress: this._handleAddAccount, testID: M }), r.createElement(a.Z, { style: [Q.whiteBackground, Q.infoText] }, r.createElement(i.ZP, { color: "gray700" }, (o ? R : F)({ maxAccounts: e }), " ", r.createElement(i.ZP, { link: V }, W))), r.createElement(l.Z, null), r.createElement(g.Z, { color: "red500", confirmationSheetConfirmButtonLabel: N, confirmationSheetConfirmButtonType: "primary", confirmationSheetHeadline: j, confirmationSheetText: q, key: "logoutAllButton", label: G, onConfirmationSheetConfirm: this._handleLogoutAll, withBottomBorder: !1 }));
                        }),
                        (this._renderUsers = () => {
        ...
        242454: (e, t, o) => {
            ...
            const d = l.default.create((e) => ({ container: { backgroundColor: e.colors.cellBackground }, root: { justifyContent: "center", minHeight: e.spaces.space48, paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space16 } })),
                u = ({ align: e = "center", color: t, label: o, ...u }) => {
                    const h = s.Z.generate({ backgroundColor: l.default.theme.colors.transparent, color: l.default.theme.colors[t], insetFocusRing: !0 });
                    return a.createElement(n.Z, { style: d.container }, a.createElement(c.Z, (0, r.Z)({}, u, { interactiveStyles: h, style: d.root }), a.createElement(i.ZP, { align: e, color: t }, o)));
                };
        },
        661810: (e, t, o) => {
            o.d(t, { Z: () => i });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.MultiAccount.08dbf70a.js.map
