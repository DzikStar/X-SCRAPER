    ...
    ["bundle.MultiAccount"],
    {
        ...
        229412: (e, t, o) => {
            ...
            const R = h().c61eea74,
                ...
                H = h().h6beb5fb;
            function V(e) {
                const { accountSwitch: t, accountUsers: o, activeUser: d, clearDelegateUser: u, delegateAccountCount: h, delegateUser: _, isDelegateEnabled: k, isUpdatedManageAccounts: w, onDelegateSwitch: Z, onUserSwitch: v, userTestId: S, withBadges: x = !1 } = e,
                    M = !!_,
        ...
        366273: (e, t, o) => {
            ...
            const M = (0, w.Z)()
                    ...
                    .propsFromActions(() => ({ clearDelegateUser: v.YJ, fetchMultiAccountListIfNeeded: E.s2, createLocalApiErrorHandler: (0, k.zr)("ACCOUNT_SWITCHER_MULTI_LIST_FETCH"), logout: S.Z, logoutAll: S.d, sendAllPreviews: Z.MH, switchAccount: A.y }))
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.MultiAccount.3335e24a.js.map
