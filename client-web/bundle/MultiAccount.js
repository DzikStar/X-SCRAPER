    ...
    ["bundle.MultiAccount"],
    {
            ...
            class h extends r.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: a, hideBackButton: n, isFullWidth: i, isLarge: l, leftControl: d, middleControl: h, position: p, rightControl: m, secondaryBar: g, style: f, subtitle: b, title: C, titleDomId: y, titleIconCell: B, titleIconCellSize: _, withBackground: k, withWideContainer: w } = this.props,
                        ...
                        v = n ? d : r.createElement(c.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        Z = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!k, E, !!g);
                    return r.createElement(r.Fragment, null, r.createElement(s.Z, { centerTitle: t, centeredLogo: o, isFullWidth: i, isLarge: l, leftControl: v, middleControl: h, position: u(p, E, a), rightControl: m, style: f, subtitle: b, title: C, titleDomId: y, titleIconCell: B, titleIconCellSize: _, withBackground: Z, withWideContainer: w }), g || null);
                }
                render() {
        ...
        229412: (e, t, o) => {
            ...
            const M = h().c61eea74,
                ...
                T = ({ accountUsers: e, activeUser: t, handleMultiAccountSwitch: o, isUpdatedManageAccounts: n, renderUserDecoration: d, userTestId: u, withBadges: h }) => {
                    const p = (0, y.v9)(x.BP),
                        ...
                        _ = r.useMemo(() => (p && p > 0 ? r.createElement(a.Z, { onClick: B, style: D.personalAccountsLabel }, r.createElement(c.ZP, { color: "gray700", weight: "bold" }, M), g ? r.createElement(A.default, { style: D.IconChevronUp }) : r.createElement(S.default, { style: D.IconChevronDown })) : null), [m, p, B, g]),
                        k = r.useMemo(
                            () =>
                                b.map((e) => {
            ...
            const z = h().c61eea74,
                ...
                R = h().h6beb5fb;
            function V(e) {
                const { accountSwitch: t, accountUsers: o, activeUser: d, clearDelegateUser: u, delegateAccountCount: h, delegateUser: _, isDelegateEnabled: k, isUpdatedManageAccounts: w, onDelegateSwitch: Z, onUserSwitch: A, userTestId: S, withBadges: x = !1 } = e,
                    M = !!_,
                    ...
                    G = r.useCallback(({ badgeCount: e, isActiveUser: t, withBadges: o }) => (t ? (k ? r.createElement(m.default, { style: [W.IconCheckmarkCircleFill, W.userDecoration] }) : r.createElement(f.default, { style: [W.iconCheckMark, W.userDecoration] })) : e && o ? r.createElement(i.Z, { count: e, standalone: !0, style: W.userDecoration, truncatedCountFormatter: R, unreadCountLabel: H }) : void 0), [k]),
                    j = r.useMemo(() => (w ? N : G), [w, G, N]),
                    q = r.useMemo(() => r.createElement(v.ZP, { activeUserId: d.id_str, delegateUser: _, isUpdatedManageAccounts: w, key: 0, onDelegateSwitch: Z ?? b.Z, renderUserDecoration: j }), [d.id_str, _, w, Z, j]),
                    ...
                    J = [];
                return !w && k && J.push(q), J.push(O), w && k && J.push(q), r.createElement(r.Fragment, null, w && k && r.createElement(a.Z, { style: W.personalAccountsLabel }, r.createElement(c.ZP, { color: "gray700", weight: "bold" }, z)), L ? r.createElement(r.Fragment, null, r.createElement(s.ZP, { affiliateBadgeInfo: d.highlightedLabel, avatarDecoration: w && r.createElement(E, { notificationCount: T + D }), avatarUri: d.profile_image_url_https, badgeContext: "account", decoration: j({ withBadges: x, isActiveUser: !_, isLoggedInUser: !0 }), displayMode: "UserCompact", isBlueVerified: d.is_blue_verified, isProtected: d.protected, isVerified: d.verified, name: d.name, onCellClick: M ? I : void 0, screenName: d.screen_name, testID: S, userId: d.id_str, verifiedType: d.verified_type, withLink: !1 }), w && r.createElement(l.Z, { style: W.accountDivider })) : null, J, !w && (L || h || o.length) ? r.createElement(l.Z, { spacing: "space12" }) : null);
            }
        ...
        366273: (e, t, o) => {
            ...
            const M = (0, w.Z)()
                    ...
                    .propsFromActions(() => ({ clearDelegateUser: A.YJ, fetchMultiAccountListIfNeeded: E.s2, createLocalApiErrorHandler: (0, k.zr)("ACCOUNT_SWITCHER_MULTI_LIST_FETCH"), logout: S.Z, logoutAll: S.d, sendAllPreviews: Z.MH, switchAccount: v.y }))
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.MultiAccount.b44831ba.js.map
