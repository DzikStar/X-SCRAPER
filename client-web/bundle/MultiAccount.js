            ...
            const M = p().c61eea74,
                ...
                T = ({ accountUsers: e, activeUser: t, handleMultiAccountSwitch: o, isUpdatedManageAccounts: n, renderUserDecoration: d, userTestId: u, withBadges: p }) => {
                    const h = (0, y.v9)(x.BP),
                        ...
                        w = r.useMemo(() => r.createElement(a.Z, { style: D.facePileContainer }, r.createElement(Z.Z, { userAvatarSize: "large", userAvatarUrls: b.map((e) => e.avatar_image_url) }), C > 0 ? r.createElement(i.Z, { count: C, standalone: !0, truncatedCountFormatter: U, unreadCountLabel: I }) : null), [b, C]);
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderUsers = () => {
                            ...
                            if (!a) return null;
                            const s = { accountSwitch: this._handleSwitchAccount, accountUsers: n, activeUser: a, clearDelegateUser: e, delegateAccountCount: t, delegateUser: o, isDelegateEnabled: !0, userTestId: I, withBadges: i, isUpdatedManageAccounts: this.isUpdatedManageAccounts };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.MultiAccount.f46ad30a.js.map
