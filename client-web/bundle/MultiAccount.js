    ...
    ["bundle.MultiAccount"],
    {
        625661: (e, t, o) => {
            ...
            class p extends r.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: a, hideBackButton: n, isFullWidth: i, isLarge: l, leftControl: d, middleControl: p, position: h, rightControl: m, secondaryBar: g, style: f, subtitle: b, title: C, titleDomId: y, titleIconCell: B, titleIconCellSize: _, withBackground: k, withWideContainer: w } = this.props,
                        { isModal: E } = this.context,
                        A = n ? d : r.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        Z = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!k, E, !!g);
                    return r.createElement(r.Fragment, null, r.createElement(c.Z, { centerTitle: t, centeredLogo: o, isFullWidth: i, isLarge: l, leftControl: A, middleControl: p, position: u(h, E, a), rightControl: m, style: f, subtitle: b, title: C, titleDomId: y, titleIconCell: B, titleIconCellSize: _, withBackground: Z, withWideContainer: w }), g || null);
                }
                render() {
        ...
        947135: (e, t, o) => {
            ...
            class i extends r.Component {
                ...
                render() {
                    const { align: e, color: t, confirmationSheetConfirmButtonLabel: o, confirmationSheetConfirmButtonType: i, confirmationSheetHeadline: s, confirmationSheetText: c, label: l } = this.props;
                    return r.createElement(r.Fragment, null, r.createElement(a.Z, { align: e, color: t, label: l, onPress: this._handleClick }), this.state.showConfirmation ? r.createElement(n.Z, { confirmButtonLabel: o, confirmButtonType: i, headline: s, onCancel: this._handleCancel, onConfirm: this._handleConfirm, text: c }) : null);
                }
            }
        ...
        290402: (e, t, o) => {
            ...
            const u = l().aa6e3300,
                p = ({ retryMessage: e, ...t }, o) => {
                    ...
                    return a.createElement(i.Z, (0, r.Z)({}, t, { icon: s ? void 0 : a.createElement(d.default, { style: h.icon }), retryMessage: s ? e : u }));
                },
        ...
        980407: (e, t, o) => {
            ...
            class h extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: o, backLocation: n, centerTitle: i, hideBackButton: s, history: c, isFullWidth: u, isLarge: p, middleControl: h, onBackClick: g, rightControl: f, secondaryBar: b, subtitle: C, title: y } = this.props,
                                { isModal: B } = this.context;
                            return r.createElement(a.Z, { style: B ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, r.createElement(d.ZP, { backButtonType: o || (B ? "close" : "back"), backLocation: n, centerTitle: i, fixed: !B, hideBackButton: s, history: c, isFullWidth: u, isLarge: p, middleControl: h, onBackClick: g, ref: e, rightControl: f, secondaryBar: b, style: [B && m.appBarModal, t], subtitle: C, title: y, titleDomId: l.Q_ }));
                        }),
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: o, containerStyle: i, documentTitle: s, isFullWidth: l, isLarge: d, renderHeader: h, title: g, withoutBottomBarMobile: f } = this.props,
                        { isModal: b } = this.context,
                        C = h ? h(this._renderChildViewAppBar()) : this._renderChildViewAppBar();
                    return r.createElement(c.Z, null, r.createElement(u.Z.Configure, { documentTitle: s, headerless: !0, title: g }), r.createElement(a.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [m.root, b && m.rootModal] }, !b && C, r.createElement(n.Z, { isFullWidth: l, isLarge: d, style: [m.container, b && m.containerModal, i] }, b ? r.createElement(p.Z, { style: m.viewport }, C, o) : o), t ? r.createElement(a.Z, { style: [m.bottomBarModal, !b && !f && m.bottomBarMobile] }, r.createElement(n.Z, { isFullWidth: l, isLarge: d }, t)) : null));
                }
            }
        ...
        229412: (e, t, o) => {
            ...
            const M = p().c61eea74,
                ...
                U = p().d86bbf0f,
                I = p().h6beb5fb,
                T = ({ accountUsers: e, activeUser: t, handleMultiAccountSwitch: o, isUpdatedManageAccounts: n, renderUserDecoration: d, userTestId: u, withBadges: p }) => {
                    const h = (0, y.v9)(x.BP),
                        m = !0,
                        [g, f] = r.useState(!1),
                        ...
                        _ = r.useMemo(() => (h && h > 0 ? r.createElement(a.Z, { onClick: B, style: D.personalAccountsLabel }, r.createElement(s.ZP, { color: "gray700", weight: "bold" }, M), g ? r.createElement(S.default, { style: D.IconChevronUp }) : r.createElement(v.default, { style: D.IconChevronDown })) : null), [m, h, B, g]),
                        k = r.useMemo(
                            () =>
                                b.map((e) => {
                        ...
                        w = r.useMemo(() => r.createElement(a.Z, { style: D.facePileContainer }, r.createElement(Z.Z, { userAvatarSize: "large", userAvatarUrls: b.map((e) => e.avatar_image_url) }), C > 0 ? r.createElement(i.Z, { count: C, standalone: !0, truncatedCountFormatter: I, unreadCountLabel: U }) : null), [b, C]);
                    return b.length > 0 ? r.createElement(r.Fragment, null, !n && _, n || g || void 0 === h || 0 === h ? k : w) : null;
                },
            ...
            const R = p().c61eea74,
                ...
                z = p().h6beb5fb;
            function W(e) {
                const { accountSwitch: t, accountUsers: o, activeUser: d, clearDelegateUser: u, delegateAccountCount: p, delegateUser: _, isDelegateEnabled: k, isUpdatedManageAccounts: w, onDelegateSwitch: Z, onUserSwitch: S, userTestId: v, withBadges: x = !1 } = e,
                    M = !!_,
                    L = o.some((e) => e.user_id === d.id_str) || (p && p > 0) || M,
                    U = r.useCallback(() => {
                        u && u();
                    }, [u]),
                    I = r.useCallback(
                        ({ hasBadge: e, isProtected: o, userId: r }) =>
                            () => {
                                t({ hasBadge: e, isProtected: o, userId: r }), S?.();
                            },
                        [t, S],
                    ),
                    T = (0, y.v9)(B.pm),
                                ...
                                t &&
                                    o.push(
                                        r.createElement(
                                            ...
                                            r.createElement(h.default, { style: N.IconExiting }),
                                        ),
                                    ),
                                o.push(e ? r.createElement(m.default, { style: N.updatedIconCheckmarkCircleFill }) : r.createElement(g.default, { style: N.IconChevronRight })),
                                r.createElement(
                                    a.Z,
                    ...
                    G = r.useCallback(({ badgeCount: e, isActiveUser: t, withBadges: o }) => (t ? (k ? r.createElement(m.default, { style: [N.IconCheckmarkCircleFill, N.userDecoration] }) : r.createElement(f.default, { style: [N.iconCheckMark, N.userDecoration] })) : e && o ? r.createElement(i.Z, { count: e, standalone: !0, style: N.userDecoration, truncatedCountFormatter: z, unreadCountLabel: H }) : void 0), [k]),
                    j = r.useMemo(() => (w ? V : G), [w, G, V]),
                    q = r.useMemo(() => r.createElement(A.ZP, { activeUserId: d.id_str, delegateUser: _, isUpdatedManageAccounts: w, key: 0, onDelegateSwitch: Z ?? b.Z, renderUserDecoration: j }), [d.id_str, _, w, Z, j]),
                    O = r.useMemo(() => r.createElement(P, { accountUsers: o, activeUser: d, handleMultiAccountSwitch: I, isUpdatedManageAccounts: !!w, key: 1, renderUserDecoration: j, userTestId: v, withBadges: x }), [o, d, I, w, j, v, x]),
                    J = [];
                return !w && k && J.push(q), J.push(O), w && k && J.push(q), r.createElement(r.Fragment, null, w && k && r.createElement(a.Z, { style: N.personalAccountsLabel }, r.createElement(s.ZP, { color: "gray700", weight: "bold" }, R)), L ? r.createElement(r.Fragment, null, r.createElement(c.ZP, { affiliateBadgeInfo: d.highlightedLabel, avatarDecoration: w && r.createElement(E, { notificationCount: T + D }), avatarUri: d.profile_image_url_https, badgeContext: "account", decoration: j({ withBadges: x, isActiveUser: !_, isLoggedInUser: !0 }), displayMode: "UserCompact", isBlueVerified: d.is_blue_verified, isProtected: d.protected, isVerified: d.verified, name: d.name, onCellClick: M ? U : void 0, screenName: d.screen_name, testID: v, userId: d.id_str, verifiedType: d.verified_type, withLink: !1 }), w && r.createElement(l.Z, { style: N.accountDivider })) : null, J, !w && (L || p || o.length) ? r.createElement(l.Z, { spacing: "space12" }) : null);
            }
        ...
        652904: (e, t, o) => {
            ...
            class l extends r.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const l = a || s;
                    ((l && a !== s) || (!l && o !== n) || r !== i || c) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        366273: (e, t, o) => {
            ...
            var r = o(202784),
                ...
                x = o(919022);
            const M = (0, w.Z)()
                    .propsFromState(() => ({ delegateAccountCount: S.BP, delegateUser: S.sy, loggedInUser: x.ZP.selectLoggedInUser, fetchStatus: E.UD, users: E.pc }))
                    .propsFromActions(() => ({ clearDelegateUser: S.YJ, fetchMultiAccountListIfNeeded: E.s2, createLocalApiErrorHandler: (0, k.zr)("ACCOUNT_SWITCHER_MULTI_LIST_FETCH"), logout: v.Z, logoutAll: v.d, sendAllPreviews: Z.MH, switchAccount: A.y }))
                    .withAnalytics({ page: "account_switcher" }),
                L = "AccountSwitcher_Add_Button",
                U = "AccountSwitcher_Switch_Button",
                I = h().b8e1d524,
                T = h().e69b7e02,
                D = h().j0a8da6e,
                P = h().b6bd6ae4,
                ...
                z = h().d075dc89,
                W = h().i859a9d4,
                N = (0, n.ju)("https://help.x.com/managing-your-account/managing-multiple-twitter-accounts"),
                V = h().ae1bbb26,
                G = h().bade139e,
                j = h().ae33b982,
                q = h().fa07bf68,
                    ...
                    super(...e),
                        ...
                        (this._updatedRenderActions = () => {
                            const e = this.context.featureSwitches.getNumberValue("responsive_web_multiple_account_limit", 5),
                                ...
                                n = o.length >= e;
                            return r.createElement(r.Fragment, null, n ? r.createElement(a.Z, { style: [Q.whiteBackground, Q.infoText, Q.updatedAccountLimitText] }, r.createElement(i.ZP, { align: "center", color: "gray700" }, (t ? z : H)({ maxAccounts: e }), " ")) : r.createElement(s.ZP, { onPress: this._handleAddAccount, style: Q.updatedAddAccountButton, testID: L }, r.createElement(i.ZP, { color: "buttonBlack", weight: "normal" }, D)), r.createElement(a.Z, { style: Q.updatedLogoutAllButtonWrapper }, r.createElement(g.Z, { color: "red500", confirmationSheetConfirmButtonLabel: V, confirmationSheetConfirmButtonType: "primary", confirmationSheetHeadline: j, confirmationSheetText: q, key: "logoutAllButton", label: G, onConfirmationSheetConfirm: this._handleLogoutAll, withBottomBorder: !1 })));
                        }),
                        (this._renderActions = () => {
                            const e = this.context.featureSwitches.getNumberValue("responsive_web_multiple_account_limit", 5),
                                { users: t } = this.props,
                                o = t.length >= e;
                            return r.createElement(r.Fragment, null, r.createElement(c.Z, { align: "left", color: "primary", disabled: o, label: D, onPress: this._handleAddAccount, testID: L }), r.createElement(a.Z, { style: [Q.whiteBackground, Q.infoText] }, r.createElement(i.ZP, { color: "gray700" }, (o ? R : F)({ maxAccounts: e }), " ", r.createElement(i.ZP, { link: N }, W))), r.createElement(l.Z, null), r.createElement(g.Z, { color: "red500", confirmationSheetConfirmButtonLabel: V, confirmationSheetConfirmButtonType: "primary", confirmationSheetHeadline: j, confirmationSheetText: q, key: "logoutAllButton", label: G, onConfirmationSheetConfirm: this._handleLogoutAll, withBottomBorder: !1 }));
                        }),
                        (this._renderUsers = () => {
                            const { clearDelegateUser: e, delegateAccountCount: t, delegateUser: o, loggedInUser: a, users: n, withBadges: i = !1 } = this.props;
                            if (!a) return null;
                            const s = { accountSwitch: this._handleSwitchAccount, accountUsers: n, activeUser: a, clearDelegateUser: e, delegateAccountCount: t, delegateUser: o, isDelegateEnabled: !0, userTestId: U, withBadges: i, isUpdatedManageAccounts: this.isUpdatedManageAccounts };
                            return r.createElement(C.a, s);
                        }),
        ...
        242454: (e, t, o) => {
            ...
            const d = l.default.create((e) => ({ container: { backgroundColor: e.colors.cellBackground }, root: { justifyContent: "center", minHeight: e.spaces.space48, paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space16 } })),
                u = ({ align: e = "center", color: t, label: o, ...u }) => {
                    const p = s.Z.generate({ backgroundColor: l.default.theme.colors.transparent, color: l.default.theme.colors[t], insetFocusRing: !0 });
                    return a.createElement(n.Z, { style: d.container }, a.createElement(c.Z, (0, r.Z)({}, u, { interactiveStyles: p, style: d.root }), a.createElement(i.ZP, { align: e, color: t }, o)));
                };
        },
        879113: (e, t, o) => {
            o.d(t, { Z: () => h });
            ...
            class h extends r.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: o, fetchStatus: a, icon: n, loadingMessage: i, onRequestRetry: d, render: h, renderFailure: m, retryMessage: g, retryable: f } = this.props;
                    switch (a) {
                        case l:
                            return f ? r.createElement(s.Z, { icon: n, onRequestRetry: d, retryMessage: g }) : o ? r.createElement(c.m, { failureMessage: o }) : m();
                        case u:
        ...
        420412: (e, t, o) => {
            ...
            function c({ borderColor: e = "borderColor", isSlim: t = !1, label: o }) {
                const { isWebRedesign: c } = n.ZP.useProps(),
                    d = "borderColor" === e || "nestedBorderColor" === e ? l[e] : { backgroundColor: s.default.theme.colors[e] ?? s.default.theme.colors.borderColor };
                return o ? r.createElement(i.Z, { style: !t && l.root, withGutter: !0 }, r.createElement(a.Z, { style: l.gapColumn }, r.createElement(a.Z, { style: [l.gap, d] })), r.createElement(a.Z, { style: l.gapText }, o), r.createElement(a.Z, { style: l.gapColumn }, r.createElement(a.Z, { style: [l.gap, d] }))) : r.createElement(a.Z, { style: [!t && l.root, c() && l.rootRedesign, l.gap, d] });
            }
            ...
            class s extends a.Component {
                render() {
                    const { children: e, style: t, withGutter: o, ...i } = this.props,
                        s = a.Children.map(e, (e) => e && a.cloneElement(e, { style: [e.props.style, c.column, o && c.withGutterColumn] }));
                    return a.createElement(n.Z, (0, r.Z)({ style: [t, c.root, o && c.withGutter] }, i), s);
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.MultiAccount.8d068cea.js.map
