            ...
            class u {
                constructor(e, t) {
                    (this.scribeRequest = (e) => {
                        ...
                        if (n || !t) {
                            ...
                            if (((t = { request: { host: r.origin, method: e.method, headers: e.headers, path: r.pathname, uri: e.url }, headers: {}, body: "", status: n ? n.status : 500 }), !(n instanceof a.Z))) return;
                        }
                        if (this._shouldFilter(i)) return;
                        this._flushResourceTimingBuffer();
                        const o = (0, s.Z)(this._buffer, (e) => {
                            const { request: t } = e;
                        ...
                        (this._getNetworkMeasurements = () => ({ connection_type: this._networkInfo.type || "unknown", speed_class: this._networkInfo.effectiveType, download_mbps: this._networkInfo.downlink, download_max_mbps: this._networkInfo.downlinkMax, rtt_ms: this._networkInfo.rtt, reduced_data_usage: this._networkInfo.saveData })),
                        ...
                        (this._scribe = e),
                        (this._options = { apiErrorSampleSize: 0, apiSampleSize: 0, cdnSampleSize: 0, navSampleSize: 0, cdnHostList: [], ...t }),
                        (this._buffer = []),
                        (this._networkInfo = {}),
                        r.Z.getConnectionInfo().then((e) => {
                            this._updateNetworkInfo(e), r.Z.addEventListener("connectionChange", this._updateNetworkInfo);
                        }),
                ...
                _sample(e) {
                    const { event_type: t } = e,
                        n = this._options[{ "api:all": "apiSampleSize", "api:error": "apiErrorSampleSize", "cdn:all": "cdnSampleSize", "web:nav": "navSampleSize" }[t]] || 0;
