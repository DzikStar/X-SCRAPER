    ...
    ["bundle.NotABot"],
    {
        ...
        372551: (e, t, r) => {
            ...
            var a = r(584550),
                ...
                u = r(601377),
                p = r.n(u);
            const m = ({ apiClient: e, featureSwitches: t }) => ({ fetchSubscriptionProductDetails: (t) => e.graphQL(d(), t).then((e) => e.web_subscription_product_details), fetchSubscriptionProductCheckoutUrl: (t) => e.graphQL(c(), t).then((e) => e.subscriptioncheckoutsession_create_for_blue?.session_url), fetchNotABotCheckoutUrl: (t) => e.graphQL(s(), t).then((e) => e.subscriptioncheckoutsession_create_for_not_a_bot?.session_url), fetchProductSubscriptions: (t) => e.graphQL(o(), t).then((e) => e.viewer_v2?.list_product_subscriptions), switchTier: (t) => e.graphQL(p(), t).then((e) => e) });
        },
        625661: (e, t, r) => {
            "use strict";
            r.d(t, { ZP: () => p });
            ...
            class p extends a.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: r, fixed: o, hideBackButton: i, isFullWidth: s, isLarge: l, leftControl: d, middleControl: p, position: m, rightControl: h, secondaryBar: f, style: b, subtitle: _, title: g, titleDomId: S, titleIconCell: E, titleIconCellSize: y, withBackground: P, withWideContainer: C } = this.props,
                        { isModal: T } = this.context,
                        k = i ? d : a.createElement(n.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        I = (function (e, t, r) {
                            return e && !(t && r);
                        })(!!P, T, !!f);
                    return a.createElement(a.Fragment, null, a.createElement(c.Z, { centerTitle: t, centeredLogo: r, isFullWidth: s, isLarge: l, leftControl: k, middleControl: p, position: u(m, T, o), rightControl: h, style: b, subtitle: _, title: g, titleDomId: S, titleIconCell: E, titleIconCellSize: y, withBackground: I, withWideContainer: C }), f || null);
                }
                render() {
                    const { secondaryBar: e } = this.props,
                        { isModal: t } = this.context,
                        r = l.Z.getBackgroundStyles();
                    return t ? a.createElement(s.Z, { style: !!e && r }, this._renderContent()) : this._renderContent();
                }
            }
        ...
        290402: (e, t, r) => {
            ...
            const u = l().aa6e3300,
                p = ({ retryMessage: e, ...t }, r) => {
                    ...
                    return o.createElement(s.Z, (0, a.Z)({}, t, { icon: n ? void 0 : o.createElement(d.default, { style: m.icon }), retryMessage: n ? e : u }));
                },
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: r, backLocation: i, centerTitle: s, hideBackButton: n, history: c, isFullWidth: u, isLarge: p, middleControl: m, onBackClick: f, rightControl: b, secondaryBar: _, subtitle: g, title: S } = this.props,
                                { isModal: E } = this.context;
                            return a.createElement(o.Z, { style: E ? [h.childViewAppBarRoot, h.appBarZindex] : h.appBarZindex }, a.createElement(d.ZP, { backButtonType: r || (E ? "close" : "back"), backLocation: i, centerTitle: s, fixed: !E, hideBackButton: n, history: c, isFullWidth: u, isLarge: p, middleControl: m, onBackClick: f, ref: e, rightControl: b, secondaryBar: _, style: [E && h.appBarModal, t], subtitle: g, title: S, titleDomId: l.Q_ }));
                        }),
        ...
        652904: (e, t, r) => {
            ...
            class l extends a.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const l = o || n;
                    ((l && o !== n) || (!l && r !== i) || a !== s || c) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        97882: (e, t, r) => {
            ...
            const i = { AED: o().d857e44d, ALL: o().cb87e3db, ARS: o().a9d5ffd1, AUD: o().a0e8371d, BAM: o().gcc50dc9, BDT: o().a6a43585, BGN: o().a0cc8f2d, BHD: o().i31c32c5, BRL: o().i7dc69e9, BYR: o().c14a6c03, CAD: o().jaa3d537, CHF: o().a824080b, CLP: o().d9c0bedb, CNY: o().bf8c0613, COP: o().i8163625, CZK: o().adb53ba1, DKK: o().iabf697d, DZD: o().a1a0555b, EGP: o().f266f3d9, EUR: o().a9a8652b, GBP: o().dbf40761, GHS: o().b0d993d9, GTQ: o().ac1308e1, HKD: o().a7889ab3, HRK: o().c614f5cd, HUF: o().i55d57e3, IDR: o().e4b6002b, ILS: o().d28e983b, INR: o().e8c9232d, IQD: o().c8994ae1, ISK: o().f821c2a5, JPY: o().j348b9c9, KES: o().i6f93b9b, KRW: o().c6150bd5, KWD: o().i8921e09, KZT: o().ef239279, LBP: o().hecdb149, MAD: o().fdd039b7, MKD: o().f30c2c37, MXN: o().d9ea7bff, MYR: o().ea3df4b7, NGN: o().jaac21bb, NOK: o().hb435ced, NZD: o().ce699d81, PEN: o().bc56d3d7, PHP: o().f8561913, PKR: o().g6485d53, PLN: o().ff561cc1, QAR: o().b42011d3, RON: o().a6660bcd, RSD: o().f9b80449, RUB: o().gdee4d5d, SAR: o().h36f2103, SEK: o().a19ad037, SGD: o().g713f699, THB: o().ff2e39af, TND: o().be34316d, TRY: o().aef81b75, TWD: o().fcce70a5, TZS: o().jc9d352f, UAH: o().be1cb8c5, UGX: o().j9371501, USD: o().j7d4397d, VEF: o().d61441dd, VND: o().e2a99e97, ZAR: o().f7ce19ab, ZMW: o().b2a0213f },
                s = ({ amount: e, currencyCode: t = "USD", formatter: r = 1e6, removeTrailingZeros: a = !1, strictAmount: o = !1 }) => {
                    const s = o ? e : parseInt(e, 10) / r,
                        c = i[t]?.(s);
                    return a ? n(c) : c;
                },
                n = (e) => {
        ...
        365265: (e, t, r) => {
            ...
            const c = "subscriptionPayments",
                ...
                h = { products: {}, checkoutUrls: {}, productSubscriptions: { fetchStatus: n.ZP.NONE }, switchTier: { fetchStatus: n.ZP.NONE } };
            const f = (e, t) => {
                ...
                C =
                    (e) =>
                    (t, r, { api: o }) => {
                        const i = (0, s._O)(t, { params: { id: e }, request: o.withEndpoint(a.Z).fetchSubscriptionProductDetails }),
                            c = f(r(), e);
                        return c !== n.ZP.NONE && c !== n.ZP.FAILED ? Promise.resolve() : i({ actionTypes: d, context: "FETCH_SUBSCRIPTION_PRODUCT_DETAILS", meta: { id: e } });
                    },
                T =
                    (e) =>
                    (t, r, { api: o }) => {
                        const i = (0, s._O)(t, { params: { external_product_id: e.externalProductId, success_url: e.successUrl, cancel_url: e.cancelUrl, external_price_id: e.externalPriceId, promotion_data: e.promotion_data }, request: o.withEndpoint(a.Z).fetchSubscriptionProductCheckoutUrl }),
                            c = _(r(), e.id);
                        return c !== n.ZP.NONE && c !== n.ZP.FAILED ? Promise.resolve() : i({ actionTypes: u, context: l, meta: { id: e.id } });
                    },
                k =
                    (e) =>
                    (t, r, { api: o }) => {
                        const i = (0, s._O)(t, { params: { external_product_id: e.externalProductId, success_url: e.successUrl, cancel_url: e.cancelUrl, external_price_id: e.externalPriceId }, request: o.withEndpoint(a.Z).fetchNotABotCheckoutUrl }),
                            c = _(r(), e.id);
                        return c !== n.ZP.NONE && c !== n.ZP.FAILED ? Promise.resolve() : i({ actionTypes: u, context: l, meta: { id: e.id } });
                    },
                I =
                    () =>
                    (e, t, { api: r }) => {
                        const o = (0, s._O)(e, { params: { fetchPrices: !1 }, request: r.withEndpoint(a.Z).fetchProductSubscriptions }),
                            i = S(t());
                        return i !== n.ZP.NONE && i !== n.ZP.FAILED ? Promise.resolve() : o({ actionTypes: p, context: "FETCH_PRODUCT_SUBSCRIPTIONS", meta: {} });
                    },
                B =
                    (e) =>
                    (t, r, { api: o }) => {
                        const i = (0, s._O)(t, { params: { price_id: e }, request: o.withEndpoint(a.Z).switchTier }),
                            c = P(r());
                        return c !== n.ZP.NONE && c !== n.ZP.FAILED ? Promise.resolve() : i({ actionTypes: m, context: "TIER_SWITCH" });
                    };
            i.Z.register({
                [c]: function (e = h, t) {
                    if (!t) return e;
        ...
        993187: (e, t, r) => {
            ...
            const S = "not-a-bot-container",
                ...
                C = (e) => {
                    const t = (0, s.useHistory)(),
                        r = (0, g.z)(),
                        { disabled: o, isMobile: n, onSubscribe: l, price: d } = e,
                        m = a.createElement(
                            f.ZP,
                            {
                    ...
                    return a.createElement(i.Z, { style: P.buttonWrapperRedesign }, a.createElement(i.Z, { style: [P.buttonWrapper, P.buttonWrapperRedesign, n ? null : P.positionSticky], testID: S }, m, I));
                };
            var T = r(668214);
            const k = (0, T.Z)().withAnalytics({ page: "not_a_bot", section: "marketing" }),
                ...
                B = k((e) => {
                    const [t, r] = a.useState(!1),
                        [o, i] = a.useState(""),
                        { onClick: s, webviewMessageHandler: n } = e,
                        c = a.useCallback(
                            (e) => {
                        ...
                        l = a.useCallback(() => {
                            ...
                            r(!0), s && s();
                            var e;
                            (e = "handle-subscribe"), n.postMessage({ message: e });
                        }, [t, r, s, n]);
                    return (
                        a.useEffect(() => {
                            const e = (e) => {
            ...
            const v = (0, T.Z)()
                ...
                N = u().c41e1023,
                A = v((e) => {
                    const { analytics: t, checkoutUrl: r, checkoutUrlFetchStatus: o, fetchNotABotCheckoutUrl: i, fetchSubscriptionProductDetails: n, isMobile: c, onClick: l, productDetails: d, productDetailsFetchStatus: u, stripeProductId: p, stripeProductIdUnhashed: m } = e,
        ...
        877895: (e, t, r) => {
            ...
            function f(e) {
                ...
                return a.createElement(s.Z, { allowBackNavigation: !0, enableMaskForDismiss: !0, onMaskClick: r, type: "full" }, a.createElement(o.Z, { style: b.content }, a.createElement(n.ZP, { size: "title2", style: b.title, weight: "heavy" }, m), a.createElement(n.ZP, { style: b.subtitle }, h), a.createElement(c.ZP, { onPress: r, size: "xLarge", type: "primaryFilled" }, p)));
            }
        ...
        334891: (e, t, r) => {
            ...
            function h({ history: e }) {
                ...
                return a.createElement(i.Z, { allowBackNavigation: !1, enableMaskForDismiss: !1, onMaskClick: t, type: "center" }, a.createElement(o.Z, { style: f.root }, a.createElement(s.ZP, { size: "title2", weight: "heavy" }, p), a.createElement(s.ZP, null, m), a.createElement(n.ZP, { onPress: t, size: "large", type: "primaryFilled" }, u)));
            }
        ...
        336629: (e, t, r) => {
            ...
            var a = r(97882),
                o = r(685731);
            const i = ({ annualPriceMonthly: e, includeTax: t, percentOff: r, price: i }) => (0, a.x)({ amount: (0, o.aU)(i, t, r) / (e ? 12 : 1), currencyCode: i?.currency_code.toUpperCase(), removeTrailingZeros: !0 });
        },
        862695: (e, t, r) => {
            "use strict";
            r.d(t, { V: () => g, f: () => _ });
            ...
            const d = c().i57aeafb,
                ...
                f = c().b67c37de,
                b = c().a8363765,
                _ = ({ activeDiscountInfo: e, discountInfo: t, formattedPrice: r, includeTax: a, isFreeTrial: o, isTierSwitching: i, price: s, selectedInterval: n, shouldRemoveExtraStep: c, withAnnualPriceMonthly: d }) => (o ? ("Month" === n ? p({ price: r }) : m({ price: r })) : t || e ? g({ formattedPrice: r, selectedInterval: n, includeDiscountedPrice: "Year" === n && d, discountedFormattedPrice: (0, l.T)({ price: s, includeTax: a, percentOff: i ? e?.promotion_metadata?.percent_off : t?.metadata.percent_off, annualPriceMonthly: !1 }), duration: i ? e?.promotion_metadata?.duration_in_interval : t?.metadata.duration_in_interval, includeThenLabel: !1 }) : d && "Year" === n && c ? b({ price: r }) : "Month" === n ? h : f),
                g = ({ discountedFormattedPrice: e, duration: t, formattedPrice: r, includeDiscountedPrice: s, includeThenLabel: n, selectedInterval: l }) => {
                    let h;
                    return (h = "Month" === l ? (s ? a.createElement(c().I18NFormatMessage, { $i18n: "a629c16f", discountedPrice: e ?? "", duration: t ?? "" }, a.createElement(i.ZP, { style: { textDecorationLine: "line-through" } }, c().df3ed1c8({ standardPrice: r }))) : d({ duration: t, standardPrice: r })) : s ? a.createElement(c().I18NFormatMessage, { $i18n: "c142e70f", discountedPrice: e ?? "", duration: t ?? "" }, a.createElement(i.ZP, { style: { textDecorationLine: "line-through" } }, c().g261b098({ standardPrice: r }))) : u({ duration: t, standardPrice: r })), n && (h = a.createElement(o.Z, null, a.createElement(i.ZP, { style: S.marginBottom }, h), a.createElement(i.ZP, null, "Year" === l ? m({ price: r }) : p({ price: r })))), h;
                },
                S = s.default.create((e) => ({ marginBottom: { marginBottom: e.spaces.space8 } }));
        },
        879113: (e, t, r) => {
            "use strict";
            r.d(t, { Z: () => m });
            ...
            class m extends a.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: r, fetchStatus: o, icon: i, loadingMessage: s, onRequestRetry: d, render: m, renderFailure: h, retryMessage: f, retryable: b } = this.props;
                    switch (o) {
                        case l:
                            return b ? a.createElement(n.Z, { icon: i, onRequestRetry: d, retryMessage: f }) : r ? a.createElement(c.m, { failureMessage: r }) : h();
                        case u:
                            return a.createElement(c.J, { "aria-label": e, color: t, loadingMessage: s });
                        case p:
                            return null;
                        default:
                            return m();
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.NotABot.1d9a688a.js.map
