    ...
    ["bundle.Notifications"],
    {
        ...
        233935: (e, d, a) => {
            ...
            const s = "settingsAppBar",
                u = i().bb081ea2,
                c = n.memo(({ onPress: e, pullRight: d, to: a }) => n.createElement(o.ZP, { "aria-label": u, hoverLabel: { label: u }, icon: n.createElement(t.default, null), link: a, onPress: e, pullRight: d, style: b.button, testID: s, type: "primaryText" })),
        ...
        789831: (e, d, a) => {
            ...
            const t = l.default.create((e) => ({ root: { paddingBottom: `calc(${e.spaces.space64} + ${e.spaces.space20} * 2)` } })),
                s = ({ children: e, component: d, fab: a, shouldRenderFab: l = !0, style: s, withoutBottomPadding: u, ...c }) => {
                    const b = d || r.Z,
                        p = l && !(0, i.ZP)();
                    return o.createElement(b, (0, n.Z)({}, c, { style: [p && !u && t.root, s] }), e, p ? a : null);
                };
        },
        817682: (e, d, a) => {
            "use strict";
            ...
            const D = u().aed79c54,
                ...
                v = () => n.createElement(n.Fragment, null, n.createElement(l.ZP, null, m), n.createElement(o.Z, { style: C.details }, n.createElement(c.default, { style: C.icon }), n.createElement(o.Z, null, n.createElement(l.ZP, { style: C.title }, S), n.createElement(l.ZP, null, A)), n.createElement(b.default, { style: C.icon }), n.createElement(o.Z, null, n.createElement(l.ZP, { style: C.title }, w), n.createElement(l.ZP, null, M)), n.createElement(p.default, { style: C.icon }), n.createElement(o.Z, null, n.createElement(l.ZP, { style: C.title }, y), n.createElement(l.ZP, null, f)))),
            ...
            const h = t.default.create((e) => ({ root: { marginHorizontal: "auto", width: "100%" }, rootMedium: { position: "absolute", bottom: 0, start: 0, end: 0 }, rootLarge: { maxWidth: 1e3 }, fabStaysAboveSafeArea: { top: `calc(${t.default.iPhoneOffsetBottom} - ${c.ZM.getAppBarHeight()} - ${e.spaces.space20})` }, fab: { bottom: e.spaces.space20, alignSelf: "flex-end", end: e.spaces.space20 }, fabLarge: { end: e.spaces.space20 }, fabMicro: { bottom: e.spaces.space16, end: e.spaces.space16 }, buttonMicro: { height: e.spaces.space40, width: e.spaces.space40 } })),
                D = (e) => {
                    const { "aria-label": d, label: a, onPress: D, scribeComponent: m, ...S } = e,
                        ...
                        y = c.ZM.useCollapsibleNavBars(),
                        f = [...c.Ah({ elementPosition: "bottom" }), y && h.fabStaysAboveSafeArea];
                    return A
                        ? o.createElement(
                              l.Z.FloatingAction,
                              null,
                              o.createElement(i.ZP, null, ({ windowWidth: e }) => {
                                  ...
                                  return o.createElement(
                                      ...
                                      o.createElement(s.Z, { id: "FloatingActionButtonBase" }, (e, i) => o.createElement(r.Z, (0, n.Z)({ ref: e() }, i({ style: p })), o.createElement(u.Z, (0, n.Z)({}, S, { "aria-label": d, label: l ? a : void 0, onPress: M, style: c && h.buttonMicro })))),
                                  );
                              }),
                          )
                        : null;
        ...
        32677: (e, d, a) => {
            ...
            const t = r().j0179e90,
                s = r().ee69d769({ verb: "" }),
                u = n.createElement(l.default, null),
                c = ({ getLocationState: e, history: d }) => n.createElement(i.Z, { "aria-label": t, getLocationState: e, history: d, icon: u, label: s, scribeComponent: "floating_compose_button" });
        },
        635510: (e, d, a) => {
            "use strict";
            a.d(d, { Z: () => n });
        ...
        652904: (e, d, a) => {
            ...
            class s extends n.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const s = o || i;
                    ((s && o !== i) || (!s && a !== r) || n !== l || t) && this._performPageUpdates(this.props);
                }
                render() {
            ...
            const s = r.default.create((e) => ({ curationControl: { marginStart: e.spaces.space20 } })),
                u = (0, i.Z)((e) => {
                    const { analytics: d, feedbackItems: a, isDisplayedOnMedia: r } = e,
                        ...
                        u = n.useCallback(() => d.scribe({ element: "caret", action: "click" }), [d]);
                    return a && a.length > 0 ? n.createElement(o.Z, { onClick: u, renderActionMenu: i, style: s.curationControl, testID: t.Z.caret, withDarkBackground: r }) : null;
                });
        },
        337455: (e, d, a) => {
            "use strict";
        ...
        451275: (e, d, a) => {
            "use strict";
            a.r(d), a.d(d, { NOTIFICATIONS_CONTEXT: () => A, NOTIFICATIONS_PERFKEY: () => w, default: () => B, fetchAllGraphqlNotificationsTimeline: () => _, fetchAllNotificationsTimeline: () => g, notificationsModule: () => y, updateLastSeenCursor: () => f });
            var n = a(516951),
                o = a(414742),
                r = a(715551),
                l = a.n(r),
            ...
            const A = "FETCH_NOTIFICATIONS_TIMELINE_GRAPHQL",
                ...
                y = (e = S.l.All, d = void 0, a = !1) => {
                    if (!a)
                        return (0, D.Z)({
                            timelineId: `notifications-${e}-${d ?? ""}`,
                            network: {
                                getEndpoint: (e) => e.withEndpoint(u.Z).fetchNotifications,
                                getEndpointParams: (d) => {
                                    const { polling: a, ...n } = d;
                                    return { type: e, ...n };
                                },
                    ...
                    const n = M.get(e) || "All";
                    return (0, D.Z)({ timelineId: `notifications-${e}-${d ?? ""}`, network: { getEndpoint: (e) => e.withEndpoint(s).fetchNotifications, getEndpointParams: ({ count: e, cursor: a, polling: o }) => ({ count: e, cursor: "string" == typeof a ? a : void 0, timelineType: n, userId: d }) }, formatResponse: c.Z, postFetchAction: m.Z, context: "FETCH_NOTIFICATIONS_TIMELINE", perfKey: "notifications", staleIntervalMs: 5e3, actAsUserId: d });
                },
                f =
                    (e = S.l.All, d = void 0) =>
                    (a, o, { api: r }) => {
                        ...
                        if (i) {
                            ...
                            r.withEndpoint(u.Z).updateNotificationsLastSeenCursor(d).catch(o);
                        }
                    },
                g = y(S.l.All).fetchInitialOrTop,
                _ = y(S.l.All, void 0, !0).fetchInitialOrTop,
                B = y(S.l.All);
        },
        853292: (e, d, a) => {
            "use strict";
            ...
            var n = a(202784),
                ...
                l = a(934712);
            const i = (e) => {
                const { featureSwitches: d } = n.useContext(o.rC),
                    a = d.isTrue("rweb_graphql_notifications_tab_enabled"),
                    i = n.useMemo(() => (0, l.p)(r.l.All, a), [a]);
        ...
        400115: (e, d, a) => {
            ...
            const i = (e) => {
                const { featureSwitches: d } = n.useContext(o.rC),
                    a = d.isTrue("rweb_graphql_notifications_tab_enabled"),
                    i = n.useMemo(() => (0, l.p)(r.l.Mentions, a), [a]);
                return n.createElement(i, e);
            };
        },
        80550: (e, d, a) => {
            ...
            var n = a(202784),
                ...
                f = a(390387);
            const g = (0, M.Z)()
                .propsFromState(() => ({ allNotificationsUnreadCount: y.pm, isLoggedInUserActiveCreator: f.WM }))
            ...
            const B = i().eb75875e,
                ...
                O = (e) => {
                    const { featureSwitches: d } = n.useContext(p.rC),
                        ...
                        M = n.useMemo(() => n.createElement(b.Z, { alignFirstItem: (0, m.ZP)(), "aria-label": I, links: S }), [S]);
                    return n.createElement(
                        ...
                        n.createElement(c.Z, {
                            ...
                            primaryContent: (() => {
                                ...
                                return n.createElement(u.Z, { component: r.Z, fab: e }, w);
                            })(),
                            rightControl: T,
                            secondaryBar: M,
        ...
        934712: (e, d, a) => {
            ...
            var M = a(817682);
            const y = "leave_this_conversation_inline_education",
                f = t().j24c37b2,
                g = t().e839db3a,
                _ = t().eba8b1c8,
                B = t().i859a9d4,
                v = t().j745b8a6,
                k = ({ onClose: e }) => n.createElement(p.nO, { namespace: { element: "leave_this_conversation_education_sheet" } }, n.createElement(M.Z, { actionLabel: f, onAction: e, onClose: e })),
                ...
                C = (e) => {
                    const { onDismiss: d } = e,
                        ...
                        l = (0, h.z)();
                    n.useEffect(() => {
                        l.scribe({ element: y, action: "impression" });
                    }, [l]);
                    const i = [
                        {
                            text: g,
                            onClick: () => {
                                l.scribe({ element: y, action: "dismiss" }), d();
                            },
                        },
                    ];
                    return n.createElement(
            ...
            var L = a(552378),
                ...
                O = a(175856),
                U = a(5849);
            const V = (0, F.Z)((e, d, a) => d && d.notificationsModule(e, void 0, a));
            var $ = a(351322),
                j = a(801184),
                G = a(335632),
                q = a(263863);
            const Q = { ...(0, G.G)({ tweetDismissable: !0, withMuteConversation: !0 }), [H.ZP.Tweet]: $.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [q.Z.Tweet]: (0, j.Cw)({ withMuteConversation: !0, withUnreadStyles: !0 }), [q.Z.QuotedTweet]: (0, j.$Q)({ isCondensed: !0 }) } }) },
                K = t().eb75875e,
                X = t().e9f1fbcc,
                J = t().j887d006,
                Y = t().c06d4306,
            ...
            class ne extends n.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderTwitterBlueVerifiedEmptyState = () => n.createElement(l.Z, { header: X, imageVariants: x.VerificationCheck, message: ee, onButtonPress: this._handleEmptyTimelineButtonPress, onImpression: this._handleEmptyTimelineImpression })),
                        (this._renderSubscribersEmptyState = () => n.createElement(l.Z, { header: X, message: ae, onButtonPress: this._handleEmptyTimelineButtonPress, onImpression: this._handleEmptyTimelineImpression })),
                ...
                render() {
                    ...
                    return e ? n.createElement(T.Z, null, n.createElement(E.Z, { entryConfiguration: Q, header: this._renderTimelineHeader(), key: "notification-timeline", module: e, onAtTop: this._handleAtTop, renderEmptyState: this._renderEmptyTimeline, title: K })) : null;
                }
                        ...
                        ((e, d) => {
                            ...
                            return (0, z.Z)()
                                .propsFromState(() => ({
                                    ...
                                    unreadCount: (n, { history: o, ntabData: r }) => a(e, r, d)?.selectUnreadEntriesCount(n),
                                    timelineHasTweets: (n, { history: o, ntabData: r }) => {
                                        const l = a(e, r, d),
                                            i = l?.selectEntries(n),
                                            t = i?.some((e) => e.type === H.ZP.Tweet);
                                        return !!t;
                                    },
                                }))
                                .propsFromActions(({ history: n, ntabData: o }) => ({
                                    setNotificationsPageLoaded: (e) => (d) => {
                                        d((0, W.Wl)(e));
                                    },
                                    addLeaveThisConversationEducationFlag: () => (0, O.pj)(O.QV),
                                    markAllAsRead: a(e, o, d)?.markAllAsRead,
                                ...
                                .adjustStateProps(({ shouldShowUnmentionEducation: n, timelineHasTweets: o, unreadCount: r }, { history: l, ntabData: i }) => ({ ntabData: null, notificationsModule: a(e, i, d), notificationsType: e, shouldShowUnmentionEducation: n, timelineHasTweets: o, unreadCount: r }))
        ...
        100273: (e, d, a) => {
            ...
            const i = (e) => {
                const { featureSwitches: d } = n.useContext(o.rC),
                    a = d.isTrue("rweb_graphql_notifications_tab_enabled"),
                    i = n.useMemo(() => (0, l.p)(r.l.Subscribers, a), [a]);
                return n.createElement(i, e);
            };
        },
        217999: (e, d, a) => {
            ...
            const i = (e) => {
                const { featureSwitches: d } = n.useContext(o.rC),
                    a = d.isTrue("rweb_graphql_notifications_tab_enabled"),
                    i = n.useMemo(() => (0, l.p)(r.l.Verified, a), [a]);
                return n.createElement(i, e);
            };
        },
        392027: (e, d, a) => {
            ...
            class l extends n.PureComponent {
                render() {
                    const { "aria-label": e, backgroundColor: d, color: a, disabled: r, href: l, icon: t, label: s, onPress: u, renderMenu: c, style: b, testID: p } = this.props,
                        h = ((e, d) => ("primary" === e && "white" === d ? "whiteOnColor" : "white" === e && "primary" === d ? "primaryOnWhite" : d))(d, a);
                    return n.createElement(o.ZP, { "aria-label": e, backgroundColor: d, color: h, disabled: r, icon: t, link: l, onPress: u, renderMenu: c, size: "xLarge", style: [i.root, !s && i.iconOnly, b], testID: p }, s);
                }
            }
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderImage = (e, d, a) => {
                            ...
                            return a && (l = n.createElement(u.Z, { link: a, role: "" }, " ", l)), e.isCentered ? n.createElement(o.Z, { style: m.centeredImage, testID: h }, n.createElement(o.Z, { style: { width: `${e.width}px`, height: `${e.height}px`, ...e.style } }, l)) : e.style ? n.createElement(o.Z, { style: e.style }, l) : l;
                        }),
                        (this._renderTitle = () => {
                        ...
                        (this._renderAction = ({ action: e, buttonSize: d, buttonType: a, style: r, testID: l }) => {
                            const { secondaryAction: i } = this.props,
                                { link: s, onClick: u, text: c } = e;
                            return n.createElement(o.Z, { style: [this.styles.actionContainer, r, { justifyContent: "flex-start" }], testID: l }, n.createElement(t.ZP, { link: s, onPress: u, size: d, style: { width: i ? "100%" : "auto" }, type: a }, c));
                        });
                }
                render() {
                    const { headline: e, image: d, imageActionUrl: a, imageVariants: r, primaryAction: l, rightControl: i, secondaryAction: t, shouldRenderBorder: s, subtext: u } = this.props;
                    return n.createElement(o.Z, { style: s ? [S.root, S.rootMargin] : m.root }, n.createElement(n.Fragment, null, d ? this._renderImage(d, r, a) : null, e || u || l || t ? n.createElement(o.Z, { style: this.styles.rootPadding, testID: c }, this._renderTitle(), this._renderBodyText(), l ? this._renderAction({ action: l, buttonType: "primaryFilled", style: this.styles.primaryAction, buttonSize: "large", testID: b }) : null, t ? this._renderAction({ action: t, buttonType: "primaryOutlined", style: this.styles.secondaryAction, buttonSize: "large", testID: p }) : null) : null), i ? n.createElement(o.Z, { style: m.rightControl }, i) : null);
                }
                get styles() {
        ...
        403556: (e, d, a) => {
            ...
            class y extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": d, badgeCount: a, badgePip: n, children: r, color: l, isActive: s, isCompact: u, isPillLink: c, isRoundedRect: b, isWebRedesign: D, retainScrollPosition: y, style: g, to: _ } = this.props,
                        { location: B } = this.state,
                        v = _ ? this._getMemoizedLink(_, y) : void 0,
                        k = s ? s(_) : B?.pathname === v?.pathname,
                        P = m.Z.generate({ backgroundColor: "transparent", color: i.default.theme.colors.text, insetFocusRing: !0 }),
                        C = D ? "medium" : k ? "bold" : "medium";
                    return o.createElement(S.Z, { "aria-label": d, "aria-selected": k, focusable: !!k, interactiveStyles: P, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [c ? f.pill : f.link, c && k ? f.active : null, u ? (c ? f.compactPill : f.compactLink) : null, b ? f.roundedRect : null, g], withoutInteractiveStyles: D || c }, ({ isFocused: d, isHovered: s }) => o.createElement(t.Z, { style: c && f.flexGrow }, o.createElement(p.ZP, { size: D ? "headline2" : void 0, style: [f.text, { color: this._getTextColor(k, s, D, c) }, u && f.compactText, D && d && f.focusedText], weight: C }, e && o.createElement(e, { style: f.icon }), r, D || c ? null : o.createElement(t.Z, { style: k && [f.border, { backgroundColor: i.default.theme.colors[l] }] })), a ? o.createElement(h.Z, { count: a, standalone: !0, style: [f.badge, a >= 10 && f.multiDigitBadge, a >= 20 && f.truncatedCountBadge], truncatedCountFormatter: M, unreadCountLabel: A, withBorder: !1 }) : n ? o.createElement(h.Z, { pip: !0, standalone: !0, style: f.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
            (y.contextType = D.Z), (y.defaultProps = { children: [], color: "primary", retainScrollPosition: !0 });
            const f = i.default.create((e) => ({
                ...
                B = ({ alignFirstItem: e, "aria-label": d, isCompact: a, isPillLink: i, isRoundedRect: t, links: s, style: u, visibleItemIndex: c }) => {
                    const b = s
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        D = o.useMemo(
                            () =>
                                s.filter(Boolean).map(({ label: d, viewType: r, ...l }, s) => {
                                    const u = h ? [_.linkRedesign, 0 === s && _.firstLinkRedesign, e && 0 === s && _.withNoPaddingStart] : void 0;
                                    return o.createElement(g, (0, n.Z)({ viewType: r }, l, { isCompact: a, isPillLink: i, isRoundedRect: t, isWebRedesign: h, style: u }), d);
                                }),
                            [e, a, i, t, h, s],
                        );
                    return o.createElement(r.Z, { "aria-label": d, buttonsContainerStyle: i && _.gap, childrenStyle: !h && _.flexGrow, key: b, style: [i ? null : _.segmentedControl, h && _.leftAligned, u], visibleItemIndex: c }, D);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Notifications.78ab98ca.js.map
