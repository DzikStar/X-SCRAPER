    ...
    ["bundle.Notifications"],
    {
        ...
        934712: (e, d, a) => {
            ...
            const M = "leave_this_conversation_inline_education",
                ...
                k = s.default.create((e) => ({ footerLearnMoreLink: { whiteSpace: "nowrap" }, wrapper: { borderBottomColor: e.colors.borderColor, borderBottomWidth: e.borderWidths.small } })),
                C = (e) => {
                    const { onDismiss: d } = e,
                        [a, r] = n.useState(!1),
                        l = (0, h.z)();
        ...
        403556: (e, d, a) => {
            ...
            class M extends o.Component {
                ...
                render() {
                    ...
                    return o.createElement(S.Z, { "aria-label": d, "aria-selected": P, focusable: !!P, interactiveStyles: k, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [s ? f.pill : f.link, s && P ? f.active : null, c ? (s ? f.compactPill : f.compactLink) : null, b ? f.roundedRect : null, g], withoutInteractiveStyles: D || s }, ({ isFocused: d, isHovered: u }) => o.createElement(t.Z, { style: s && f.flexGrow }, o.createElement(p.ZP, { size: D ? "headline2" : void 0, style: [f.text, { color: this._getTextColor(P, u, D, s) }, c && f.compactText, D && d && f.focusedText], weight: C }, e && o.createElement(e, { style: f.icon }), r, D || s ? null : o.createElement(t.Z, { style: P && [f.border, { backgroundColor: i.default.theme.colors[l] }] })), a ? o.createElement(h.Z, { count: a, standalone: !0, style: [f.badge, a >= 10 && f.multiDigitBadge, a >= 20 && f.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: A, withBorder: !1 }) : n ? o.createElement(h.Z, { pip: !0, standalone: !0, style: f.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Notifications.5f7e43fa.js.map
