    ...
    ["bundle.Notifications"],
    {
        ...
        789831: (e, a, o) => {
            ...
            const s = l.default.create((e) => ({ root: { paddingBottom: `calc(${e.spaces.space64} + ${e.spaces.space20} * 2)` } })),
                i = ({ children: e, component: a, fab: o, shouldRenderFab: l = !0, style: i, withoutBottomPadding: c, ...u }) => {
                    const h = a || r.Z,
                        b = l && !(0, t.ZP)();
        ...
        817682: (e, a, o) => {
            ...
            const p = c().aed79c54,
                ...
                P = () => d.createElement(d.Fragment, null, d.createElement(l.ZP, null, D), d.createElement(n.Z, { style: T.details }, d.createElement(u.default, { style: T.icon }), d.createElement(n.Z, null, d.createElement(l.ZP, { style: T.title }, M), d.createElement(l.ZP, null, w)), d.createElement(h.default, { style: T.icon }), d.createElement(n.Z, null, d.createElement(l.ZP, { style: T.title }, f), d.createElement(l.ZP, null, y)), d.createElement(b.default, { style: T.icon }), d.createElement(n.Z, null, d.createElement(l.ZP, { style: T.title }, A), d.createElement(l.ZP, null, g)))),
                C = () => d.createElement(n.Z, { style: T.footerContainer }, d.createElement(l.ZP, { align: "center" }, _, " ", d.createElement(l.ZP, { color: "text", link: k, style: T.footerLearnMoreLink, withUnderline: !0 }, S))),
                I = () => d.createElement(l.ZP, { style: T.headline }, p),
                ...
                v = (e) => {
                    const { actionLabel: a, onAction: o, onClose: n, onSecondaryAction: r, secondaryActionLabel: l } = e,
                        s = (0, m.z)();
                    d.useEffect(() => {
        ...
        507651: (e, a, o) => {
            ...
            const s = (e) => {
                    const a = (0, r.useHistory)(),
                        { isCompact: o, ...s } = e;
                    return n.createElement(l.Z, (0, d.Z)({}, s, { isCompact: o || (0, t.HD)(a) }));
                },
                i = n.memo(s);
        },
        387524: (e, a, o) => {
                        ...
                        ? n.createElement(
                              ...
                              n.createElement(t.ZP, null, ({ windowWidth: e }) => {
                                  const l = e > s.default.theme.breakpoints.large,
                                      ...
                                      h = [m.root, t && m.rootMedium, l && m.rootLarge],
                                      b = [m.fab, l && m.fabLarge, u && m.fabMicro, g];
                                  return n.createElement(
                                      r.Z,
                                      { "aria-label": a, pointerEvents: "box-none", role: "complementary", style: h },
                                      n.createElement(i.Z, { id: "FloatingActionButtonBase" }, (e, t) => n.createElement(r.Z, (0, d.Z)({ ref: e() }, t({ style: b })), n.createElement(c.Z, (0, d.Z)({}, M, { "aria-label": a, label: l ? o : void 0, onPress: y, style: u && m.buttonMicro })))),
                                  );
                              }),
                          )
                        : null;
                    ...
                    super(...e),
                        (this._handlePress = (e) => {
                            ...
                            const { getLocationState: a, history: o } = this.props,
                                d = { pathname: l, state: (a && a()) || {} };
                            o.push(d);
                        });
                }
                render() {
                    const { "aria-label": e, icon: a, label: o, scribeComponent: t } = this.props;
                    return d.createElement(n.Z, { "aria-label": e, href: l, icon: a, label: o, onPress: this._handlePress, scribeComponent: t, testID: r.Z.tweet });
                }
            }
            const s = t;
        },
        32677: (e, a, o) => {
            ...
            const s = r().j0179e90,
                ...
                u = ({ getLocationState: e, history: a }) => d.createElement(t.Z, { "aria-label": s, getLocationState: e, history: a, icon: c, label: i, scribeComponent: "floating_compose_button" });
        },
        635510: (e, a, o) => {
            "use strict";
            o.d(a, { Z: () => d });
        ...
        652904: (e, a, o) => {
            ...
            class i extends d.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const i = n || t;
                    ((i && n !== t) || (!i && o !== r) || d !== l || s) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        927389: (e, a, o) => {
            ...
            var d = o(202784),
                n = o(247056),
                r = o(392237);
            const l = (0, o(523561).Z)({ loader: () => o.e("loader.FeedbackSheet").then(o.bind(o, 774426)) });
            var t = o(725516),
                s = o(851623);
            const i = r.default.create((e) => ({ curationControl: { marginStart: e.spaces.space20 } })),
                c = (0, t.Z)((e) => {
                    const { analytics: a, feedbackItems: o, isDisplayedOnMedia: r } = e,
                        t = d.useCallback((e) => (o ? d.createElement(l, { actionItems: o, onClose: e }) : null), [o]),
                        c = d.useCallback(() => a.scribe({ element: "caret", action: "click" }), [a]);
                    return o && o.length > 0 ? d.createElement(n.Z, { onClick: c, renderActionMenu: t, style: i.curationControl, testID: s.Z.caret, withDarkBackground: r }) : null;
                });
        },
        552378: (e, a, o) => {
            "use strict";
            ...
            const l = (e, a) => (o) => n.createElement(r, { modules: a }, (a) => n.createElement(e, (0, d.Z)({}, a, o)));
        },
        451275: (e, a, o) => {
            "use strict";
        ...
        80550: (e, a, o) => {
            "use strict";
            o.r(a), o.d(a, { NotificationsScreen: () => H, default: () => O });
            var d = o(202784),
                n = o(107267),
                r = o(108362),
                l = o(111677),
                ...
                A = o(390387);
            const g = (0, f.Z)()
                .propsFromState(() => ({ allNotificationsUnreadCount: y.pm, isLoggedInUserActiveCreator: A.WM }))
            ...
            const S = t().eb75875e,
                ...
                I = t().bc8baa08,
                T = t().a98ba778,
                v = d.createElement(s.Z, { pullRight: !0, to: "/settings/notifications" }),
                E = t().eb75875e,
                B = (0, w.p)(
                    () =>
                        Promise.all([
                ...
                L = { to: _._N, key: k, label: k, retainScrollPosition: !1 },
                N = { to: _.JV, key: P, label: P, retainScrollPosition: !1 },
                F = { to: _.JK, key: C, label: C, retainScrollPosition: !1 },
                z = { to: _.ag, key: I, label: I, retainScrollPosition: !1 },
                W = () => d.createElement(M.Z, { to: _._N }),
                H = (e) => {
                    const { featureSwitches: a } = d.useContext(b.rC),
                        { history: o, isLoggedInUserActiveCreator: l } = e,
                        t = a.isTrue("responsive_web_subscribers_ntab_for_creators_enabled"),
                        s = l && t,
                        M = d.useMemo(() => {
                            const e = [L, F, N];
                            return s && e.splice(2, 0, z), e;
                        }, [s]),
                        w = s ? R : W,
                        f = d.createElement(n.Switch, null, d.createElement(n.Route, { component: B, exact: !0, path: _._N }), d.createElement(n.Route, { component: x, exact: !0, path: _.JV }), d.createElement(n.Route, { component: Z, exact: !0, path: _.JK }), d.createElement(n.Route, { component: w, exact: !0, path: _.ag }), d.createElement(n.Route, { component: W, exact: !0, path: _.Im })),
                        y = d.useMemo(() => d.createElement(h.Z, { alignFirstItem: (0, D.ZP)(), "aria-label": T, links: M }), [M]);
        ...
        934712: (e, a, o) => {
            ...
            const A = "leave_this_conversation_inline_education",
                ...
                T = (e) => {
                    const { onDismiss: a } = e,
                        ...
                        l = (0, m.z)();
                    d.useEffect(() => {
                        l.scribe({ element: A, action: "impression" });
                    }, [l]);
                    const t = [
                        {
                            text: _,
                            onClick: () => {
                                l.scribe({ element: A, action: "dismiss" }), a();
                            },
                        },
                    ];
                    return d.createElement(
                        ...
                        d.createElement(
                            ...
                            d.createElement(c.Z, {
                                ...
                                rightControl: d.createElement(h.Z, { feedbackItems: t, isDisplayedOnMedia: !0 }),
            ...
            var G = o(351322),
                ...
                j = o(335632),
                q = o(263863);
            const Q = { ...(0, j.G)({ tweetDismissable: !0, withMuteConversation: !0 }), [z.ZP.Tweet]: G.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [q.Z.Tweet]: (0, $.Cw)({ withMuteConversation: !0, withUnreadStyles: !0 }), [q.Z.QuotedTweet]: (0, $.$Q)({ isCondensed: !0 }) } }) },
                K = s().eb75875e,
                X = s().e9f1fbcc,
                J = s().j887d006,
                Y = s().c06d4306,
            ...
            class de extends d.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderTwitterBlueVerifiedEmptyState = () => d.createElement(l.Z, { header: X, imageVariants: R.VerificationCheck, message: ee, onButtonPress: this._handleEmptyTimelineButtonPress, onImpression: this._handleEmptyTimelineImpression })),
                        (this._renderSubscribersEmptyState = () => d.createElement(l.Z, { header: X, message: oe, onButtonPress: this._handleEmptyTimelineButtonPress, onImpression: this._handleEmptyTimelineImpression })),
                    ...
                    (0, L.C)(
                        ((e) => {
                            ...
                            return (0, W.Z)()
                                ...
                                .adjustStateProps(({ shouldShowUnmentionEducation: o, timelineHasTweets: d, unreadCount: n }, { history: r, ntabData: l }) => ({ ntabData: null, notificationsModule: a(e, l), notificationsType: e, shouldShowUnmentionEducation: o, timelineHasTweets: d, unreadCount: n }))
        ...
        392027: (e, a, o) => {
            ...
            class l extends d.PureComponent {
                render() {
                    const { "aria-label": e, backgroundColor: a, color: o, disabled: r, href: l, icon: s, label: i, onPress: c, renderMenu: u, style: h, testID: b } = this.props,
                        m = ((e, a) => ("primary" === e && "white" === a ? "whiteOnColor" : "white" === e && "primary" === a ? "primaryOnWhite" : a))(a, o);
                    return d.createElement(n.ZP, { "aria-label": e, backgroundColor: a, color: m, disabled: r, icon: s, link: l, onPress: c, renderMenu: u, size: "xLarge", style: [t.root, !i && t.iconOnly, h], testID: b }, i);
                }
            }
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderImage = (e, a, o) => {
                            let l = d.createElement(r.Z, { "aria-label": "", aspectMode: t.Z.exact(e.width / e.height), backgroundColor: e.backgroundColor, customVariants: a, image: e });
                            return o && (l = d.createElement(c.Z, { link: o, role: "" }, " ", l)), e.isCentered ? d.createElement(n.Z, { style: D.centeredImage, testID: m }, d.createElement(n.Z, { style: { width: `${e.width}px`, height: `${e.height}px`, ...e.style } }, l)) : e.style ? d.createElement(n.Z, { style: e.style }, l) : l;
                        }),
                        (this._renderTitle = () => {
                            const { headline: e } = this.props;
                            return e ? d.createElement(l.ZP, { align: "left", role: "heading", size: "title3", style: D.flexGrow, weight: "heavy", withHashflags: !0 }, e) : null;
                        }),
                        (this._renderBodyText = () => {
                            const { subtext: e } = this.props;
                            return e ? d.createElement(l.ZP, { align: "left", color: "gray700", style: this.styles.body, withHashflags: !0 }, e) : null;
                        }),
                        (this._renderAction = ({ action: e, buttonSize: a, buttonType: o, style: r, testID: l }) => {
                            const { secondaryAction: t } = this.props,
                                { link: i, onClick: c, text: u } = e;
                            return d.createElement(n.Z, { style: [this.styles.actionContainer, r, { justifyContent: "flex-start" }], testID: l }, d.createElement(s.ZP, { link: i, onPress: c, size: a, style: { width: t ? "100%" : "auto" }, type: o }, u));
                        });
                }
                render() {
                    const { headline: e, image: a, imageActionUrl: o, imageVariants: r, primaryAction: l, rightControl: t, secondaryAction: s, shouldRenderBorder: i, subtext: c } = this.props;
                    return d.createElement(n.Z, { style: i ? [M.root, M.rootMargin] : D.root }, d.createElement(d.Fragment, null, a ? this._renderImage(a, r, o) : null, e || c || l || s ? d.createElement(n.Z, { style: this.styles.rootPadding, testID: u }, this._renderTitle(), this._renderBodyText(), l ? this._renderAction({ action: l, buttonType: "primaryFilled", style: this.styles.primaryAction, buttonSize: "large", testID: h }) : null, s ? this._renderAction({ action: s, buttonType: "primaryOutlined", style: this.styles.secondaryAction, buttonSize: "large", testID: b }) : null) : null), t ? d.createElement(n.Z, { style: D.rightControl }, t) : null);
                }
                get styles() {
        ...
        403556: (e, a, o) => {
            ...
            class A extends n.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": a, badgeCount: o, badgePip: d, children: r, color: l, isActive: i, isCompact: c, isPillLink: u, isRoundedRect: h, isWebRedesign: p, retainScrollPosition: A, style: _, to: S } = this.props,
                        { location: k } = this.state,
                        P = S ? this._getMemoizedLink(S, A) : void 0,
                        C = i ? i(S) : k?.pathname === P?.pathname,
                        I = D.Z.generate({ backgroundColor: "transparent", color: t.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: u ? g.pillHoverStyle.backgroundColor : void 0 }),
                        T = p ? "medium" : C ? "bold" : "medium";
                    return n.createElement(M.Z, { "aria-label": a, "aria-selected": C, focusable: !!C, interactiveStyles: I, link: P, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(u ? [g.pillStyle] : [g.link]), ...(u && C ? [g.pillActiveStyle] : []), c ? (u ? g.compactPill : g.compactLink) : null, h ? g.roundedRect : null, _], withoutInteractiveStyles: p }, ({ isFocused: a, isHovered: i }) => n.createElement(s.Z, { style: u && g.flexGrow }, n.createElement(b.ZP, { size: p ? "headline2" : void 0, style: [g.text, { color: this._getTextColor(C, i, p, u) }, c && g.compactText, p && a && g.focusedText, u && g.pillTextStyle, u && C && g.pillActiveTextStyle, u && i && g.pillHoverTextStyle], weight: T }, e && n.createElement(e, { style: g.icon }), r, p || u ? null : n.createElement(s.Z, { style: C && [g.border, { backgroundColor: t.default.theme.colors[l] }] })), o ? n.createElement(m.Z, { count: o, standalone: !0, style: [g.badge, o >= 10 && g.multiDigitBadge, o >= 20 && g.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: w, withBorder: !1 }) : d ? n.createElement(m.Z, { pip: !0, standalone: !0, style: g.badgePip, textColor: "red500", unreadCountLabel: f, withBorder: !1 }) : null));
                }
            }
            (A.contextType = p.Z), (A.defaultProps = { children: [], color: "primary", retainScrollPosition: !0 });
            const g = t.default.create((e) => ({
                ...
                k = ({ alignFirstItem: e, "aria-label": a, isCompact: o, isPillLink: t, isRoundedRect: s, links: i, style: c, visibleItemIndex: u }) => {
                    const h = i
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        p = n.useMemo(
                            () =>
                                i.filter(Boolean).map(({ label: a, viewType: r, ...l }, i) => {
                                    const c = m ? [S.linkRedesign, 0 === i && S.firstLinkRedesign, e && 0 === i && S.withNoPaddingStart] : void 0;
                                    return n.createElement(_, (0, d.Z)({ viewType: r }, l, { isCompact: o, isPillLink: t, isRoundedRect: s, isWebRedesign: m, style: c }), a);
                                }),
                            [e, o, t, s, m, i],
                        );
                    return n.createElement(r.Z, { "aria-label": a, buttonsContainerStyle: t && S.gap, childrenStyle: !m && S.flexGrow, key: h, style: [t ? null : S.segmentedControl, m && S.leftAligned, c], visibleItemIndex: u }, p);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Notifications.c1c6d4fa.js.map
