    ...
    ["bundle.Notifications"],
    {
        ...
        233935: (e, d, a) => {
            ...
            const c = "settingsAppBar",
                u = i().bb081ea2,
                s = n.memo(({ onPress: e, pullRight: d, to: a }) => n.createElement(o.ZP, { "aria-label": u, hoverLabel: { label: u }, icon: n.createElement(t.default, null), link: a, onPress: e, pullRight: d, style: b.button, testID: c, type: "primaryText" })),
        ...
        789831: (e, d, a) => {
            ...
            const t = l.default.create((e) => ({ root: { paddingBottom: `calc(${e.spaces.space64} + ${e.spaces.space20} * 2)` } })),
                c = ({ children: e, component: d, fab: a, shouldRenderFab: l = !0, style: c, withoutBottomPadding: u, ...s }) => {
                    const b = d || r.Z,
                        p = l && !(0, i.ZP)();
                    return o.createElement(b, (0, n.Z)({}, s, { style: [p && !u && t.root, c] }), e, p ? a : null);
                };
        },
        817682: (e, d, a) => {
            "use strict";
            ...
            const D = u().aed79c54,
                ...
                g = u().h8dde772,
                B = u().i859a9d4,
                _ = (0, r.ju)("https://help.x.com/using-twitter/mentions-and-replies#mention-control"),
                ...
                k = () => n.createElement(o.Z, { style: C.footerContainer }, n.createElement(l.ZP, { align: "center" }, g, " ", n.createElement(l.ZP, { color: "text", link: _, style: C.footerLearnMoreLink, withUnderline: !0 }, B))),
                        ...
                        ? o.createElement(
                              ...
                              o.createElement(i.ZP, null, ({ windowWidth: e }) => {
                                  ...
                                  return o.createElement(
                                      ...
                                      o.createElement(c.Z, { id: "FloatingActionButtonBase" }, (e, i) => o.createElement(r.Z, (0, n.Z)({ ref: e() }, i({ style: p })), o.createElement(u.Z, (0, n.Z)({}, S, { "aria-label": d, label: l ? a : void 0, onPress: y, style: s && h.buttonMicro })))),
                                  );
                              }),
                          )
                        : null;
        ...
        32677: (e, d, a) => {
            ...
            const t = r().j0179e90,
                ...
                s = ({ getLocationState: e, history: d }) => n.createElement(i.Z, { "aria-label": t, getLocationState: e, history: d, icon: u, label: c, scribeComponent: "floating_compose_button" });
        },
        635510: (e, d, a) => {
            "use strict";
            a.d(d, { Z: () => n });
        ...
        652904: (e, d, a) => {
            ...
            class c extends n.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const c = o || i;
                    ((c && o !== i) || (!c && a !== r) || n !== l || t) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        927389: (e, d, a) => {
            ...
            const c = r.default.create((e) => ({ curationControl: { marginStart: e.spaces.space20 } })),
                u = (0, i.Z)((e) => {
                    ...
                    return a && a.length > 0 ? n.createElement(o.Z, { onClick: u, renderActionMenu: i, style: c.curationControl, testID: t.Z.caret, withDarkBackground: r }) : null;
                });
        },
        337455: (e, d, a) => {
            "use strict";
        ...
        451275: (e, d, a) => {
            "use strict";
            a.r(d), a.d(d, { NOTIFICATIONS_CONTEXT: () => A, NOTIFICATIONS_PERFKEY: () => w, default: () => B, fetchAllNotificationsTimeline: () => g, notificationsModule: () => M, updateLastSeenCursor: () => f });
            var n = a(516951),
                o = a(414742),
                r = a(715551),
                l = a.n(r),
            ...
            const t = (0, o.kj)((e) => !!!e?.viewer_v2?.user_results?.result?.notification_timeline?.timeline, "GQL Notifications: Failed to query for Notifications timeline"),
                c = ({ apiClient: e, featureSwitches: d }) => ({
        ...
        80550: (e, d, a) => {
            ...
            const _ = i().eb75875e,
                ...
                N = { to: B._N, key: v, label: v, retainScrollPosition: !1 },
                F = { to: B.JV, key: k, label: k, retainScrollPosition: !1 },
                z = { to: B.JK, key: P, label: P, retainScrollPosition: !1 },
                W = { to: B.ag, key: C, label: C, retainScrollPosition: !1 },
                H = () => n.createElement(A.Z, { to: B._N }),
                O = (e) => {
                    const { featureSwitches: d } = n.useContext(p.rC),
                        ...
                        A = t ? L : H,
                        w = n.createElement(o.Switch, null, n.createElement(o.Route, { component: Z, exact: !0, path: B._N }), n.createElement(o.Route, { component: R, exact: !0, path: B.JV }), n.createElement(o.Route, { component: x, exact: !0, path: B.JK }), n.createElement(o.Route, { component: A, exact: !0, path: B.ag }), n.createElement(o.Route, { component: H, exact: !0, path: B.Im })),
                    ...
                    return n.createElement(
                        ...
                        n.createElement(s.Z, {
                            ...
                            rightControl: T,
                            secondaryBar: y,
                            sidebarContent: n.createElement(c.Z, null),
                            title: E,
                        }),
                    );
                },
        ...
        392027: (e, d, a) => {
            ...
            class l extends n.PureComponent {
                render() {
                    const { "aria-label": e, backgroundColor: d, color: a, disabled: r, href: l, icon: t, label: c, onPress: u, renderMenu: s, style: b, testID: p } = this.props,
                        h = ((e, d) => ("primary" === e && "white" === d ? "whiteOnColor" : "white" === e && "primary" === d ? "primaryOnWhite" : d))(d, a);
                    return n.createElement(o.ZP, { "aria-label": e, backgroundColor: d, color: h, disabled: r, icon: t, link: l, onPress: u, renderMenu: s, size: "xLarge", style: [i.root, !c && i.iconOnly, b], testID: p }, c);
                }
            }
        ...
        913309: (e, d, a) => {
                    ...
                    super(...e),
                        ...
                        (this._renderAction = ({ action: e, buttonSize: d, buttonType: a, style: r, testID: l }) => {
                            const { secondaryAction: i } = this.props,
                                { link: c, onClick: u, text: s } = e;
                            return n.createElement(o.Z, { style: [this.styles.actionContainer, r, { justifyContent: "flex-start" }], testID: l }, n.createElement(t.ZP, { link: c, onPress: u, size: d, style: { width: i ? "100%" : "auto" }, type: a }, s));
                        });
                }
                render() {
                    const { headline: e, image: d, imageActionUrl: a, imageVariants: r, primaryAction: l, rightControl: i, secondaryAction: t, shouldRenderBorder: c, subtext: u } = this.props;
                    return n.createElement(o.Z, { style: c ? [S.root, S.rootMargin] : m.root }, n.createElement(n.Fragment, null, d ? this._renderImage(d, r, a) : null, e || u || l || t ? n.createElement(o.Z, { style: this.styles.rootPadding, testID: s }, this._renderTitle(), this._renderBodyText(), l ? this._renderAction({ action: l, buttonType: "primaryFilled", style: this.styles.primaryAction, buttonSize: "large", testID: b }) : null, t ? this._renderAction({ action: t, buttonType: "primaryOutlined", style: this.styles.secondaryAction, buttonSize: "large", testID: p }) : null) : null), i ? n.createElement(o.Z, { style: m.rightControl }, i) : null);
                }
                get styles() {
            ...
            const m = c.default.create((e) => ({ root: { backgroundColor: e.colors.cellBackground }, flexGrow: { flexGrow: 1 }, centeredImage: { display: "flex", flexDirection: "row", justifyContent: "center" }, rightControl: { paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.componentDimensions.gutterVertical, position: "absolute", end: 0, top: 0 } })),
                S = c.default.create((e) => ({ root: { borderColor: e.colors.nestedBorderColor, borderWidth: e.borderWidths.small, borderRadius: e.borderRadii.xLarge, overflow: "hidden" }, rootMargin: { marginStart: e.spaces.space16, marginEnd: e.spaces.space16 } })),
                A = c.default.create((e) => ({ rootPadding: { padding: e.spaces.space32 }, body: { marginTop: e.spaces.space8 }, actionContainer: { flexDirection: "row" }, primaryAction: { marginTop: e.spaces.space28 }, secondaryAction: { marginTop: e.spaces.space16 } })),
                w = c.default.create((e) => ({ rootPadding: { padding: e.spaces.space16 }, body: { marginTop: e.spaces.space2 }, actionContainer: { flexDirection: "row" }, primaryAction: { marginTop: e.spaces.space4 }, secondaryAction: { marginTop: e.spaces.space2 } }));
        },
        403556: (e, d, a) => {
            "use strict";
            a.d(d, { Z: () => _ });
            ...
            class M extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": d, badgeCount: a, badgePip: n, children: r, color: l, isActive: c, isCompact: u, isPillLink: s, isRoundedRect: b, isWebRedesign: D, retainScrollPosition: M, style: g, to: B } = this.props,
                        { location: _ } = this.state,
                        v = B ? this._getMemoizedLink(B, M) : void 0,
                        k = c ? c(B) : _?.pathname === v?.pathname,
                        P = m.Z.generate({ backgroundColor: "transparent", color: i.default.theme.colors.text, insetFocusRing: !0 }),
                        C = D ? "medium" : k ? "bold" : "medium";
                    return o.createElement(S.Z, { "aria-label": d, "aria-selected": k, focusable: !!k, interactiveStyles: P, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [s ? f.pill : f.link, s && k ? f.active : null, u ? (s ? f.compactPill : f.compactLink) : null, b ? f.roundedRect : null, g], withoutInteractiveStyles: D || s }, ({ isFocused: d, isHovered: c }) => o.createElement(t.Z, { style: s && f.flexGrow }, o.createElement(p.ZP, { size: D ? "headline2" : void 0, style: [f.text, { color: this._getTextColor(k, c, D, s) }, u && f.compactText, D && d && f.focusedText], weight: C }, e && o.createElement(e, { style: f.icon }), r, D || s ? null : o.createElement(t.Z, { style: k && [f.border, { backgroundColor: i.default.theme.colors[l] }] })), a ? o.createElement(h.Z, { count: a, standalone: !0, style: [f.badge, a >= 10 && f.multiDigitBadge, a >= 20 && f.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: A, withBorder: !1 }) : n ? o.createElement(h.Z, { pip: !0, standalone: !0, style: f.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
            ...
            const f = i.default.create((e) => ({
                ...
                _ = ({ alignFirstItem: e, "aria-label": d, isCompact: a, isPillLink: i, isRoundedRect: t, links: c, style: u, visibleItemIndex: s }) => {
                    const b = c
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        D = o.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: d, viewType: r, ...l }, c) => {
                                    const u = h ? [B.linkRedesign, 0 === c && B.firstLinkRedesign, e && 0 === c && B.withNoPaddingStart] : void 0;
                                    return o.createElement(g, (0, n.Z)({ viewType: r }, l, { isCompact: a, isPillLink: i, isRoundedRect: t, isWebRedesign: h, style: u }), d);
                                }),
                            [e, a, i, t, h, c],
                        );
                    return o.createElement(r.Z, { "aria-label": d, buttonsContainerStyle: i && B.gap, childrenStyle: !h && B.flexGrow, key: b, style: [i ? null : B.segmentedControl, h && B.leftAligned, u], visibleItemIndex: s }, D);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Notifications.1706986a.js.map
