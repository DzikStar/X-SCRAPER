...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.OAuth", "icons/IconFollowArrowLeft-js", "icons/IconSparkle-js"],
    {
        811105: (e, t, r) => {
            r.d(t, { Z: () => u });
            var o = r(202784),
            ...
            const P = n().ae408b76,
                ...
                B = ({ contextType: e, iconColor: t, iconSize: r, link: a, retweetData: n, text: S, topicData: _, userAvatarUrls: P }) => {
                    const { isSelfRetweet: B, name: M, screenName: O } = n || {},
                        z = ((e, t, r, a = []) => {
                            const n = R[t],
                                ...
                                D = o.createElement(u.default, { style: S }),
                    ...
                    switch (e) {
                        ...
                        case L.Q.Topic:
                            return { Icon: z, "aria-label": "Recommendation" === _?.functionalityType || "RecWithEducation" === _?.functionalityType ? F({ topicName: S }) : I({ topicName: S }), text: S ? o.createElement(D, { text: S }) : null, link: a };
                        default:
                            return { Icon: z, text: S ? o.createElement(D, { text: S }) : null, link: a };
                    }
                };
        },
        126962: (e, t, r) => {
            ...
            class m extends o.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: r, id: l, onLayout: c, rightControl: d, style: u, testID: m, textColor: g, textSize: y, topControl: f, weight: E, withBottomBorder: C, withLeftPadding: b, withTextCentered: w, ...v } = this.props,
                        { Icon: x, "aria-label": S, link: Z, text: _ } = (0, p.Z)(v),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.OAuth.7295a29a.js.map
