...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Ocf-9f4db315"],
    {
        ...
        169576: (e, t, a) => {
            ...
            const h = a.p + "MarchMadnessBannerDark.42aa2dea.png",
                ...
                g = ({ buttonOnSameLine: e, link: t, occasion: a, styleOverrides: p, withBackgroundImage: u }) => {
                    const h = (0, c.z)(),
                        m = f[a] || "Occasion",
                        g = u ? `${m}WithBackgroundImage` : m;
                    i.useEffect(() => {
                        h.scribe({ component: g, action: "impression" });
                    }, [h, g]);
                    const y = () => {
                            h.scribe({ component: g, action: "click", element: "card" });
                        },
                        { backgroundcolor: v, buttonSize: w, cardWidth: E, marginbottom: Z, textcolor: P } = p ?? {},
                        C = v ? n.default.theme.colors[v] : n.default.theme.colors.gray0,
                        I = P ? n.default.theme.colors[P] : n.default.theme.colors.gray900,
                        S = Z ? n.default.theme.spaces[Z] : n.default.theme.spaces.space16,
                        D = { [f.MarchMadness]: { header: b.header, description: b.description, legalDisclaimer: b.legalDisclaimer, buttonText: b.buttonText, image: b.image } }[a];
                    return u ? i.createElement(r.Z, { interactiveStyles: null, link: t, onPress: y, style: _.bannerContainer }, i.createElement(o.Z, { resizeMode: "contain", source: { uri: "light" === n.default.theme.paletteName ? D.image.lightMode : D.image.darkMode }, style: { height: 85 } })) : i.createElement(s.Z, { style: [_.card, { backgroundColor: C }, { maxWidth: E }, { marginBottom: S }], testID: "popupCard" }, i.createElement(s.Z, { style: e ? _.horizontalContent : _.verticalContent }, i.createElement(s.Z, { style: e ? _.textContainer : null }, i.createElement(l.ZP, { size: "headline2", style: [_.popupTitle, { alignSelf: "flex-start" }], weight: "bold" }, D.header), i.createElement(l.ZP, { size: "subtext1", style: [_.popupDescription, { color: I }] }, D.description, " ", e ? null : D.legalDisclaimer)), i.createElement(s.Z, { style: _.buttonContainer }, i.createElement(d.ZP, { backgroundColor: "light" === n.default.theme.paletteName ? "orange300" : "orange600", borderColor: "transparent", link: t, onClick: y, size: "medium", style: [_.popupButton, { width: w }] }, D.buttonText), e && i.createElement(l.ZP, { size: "subtext3", style: [_.legalDisclaimer, { color: I }] }, D.legalDisclaimer))));
                },
        ...
        290402: (e, t, a) => {
            ...
            const p = d().aa6e3300,
                u = ({ retryMessage: e, ...t }, a) => {
                    const o = n.Z.isOnline();
                    return s.createElement(r.Z, (0, i.Z)({}, t, { icon: o ? void 0 : s.createElement(c.default, { style: h.icon }), retryMessage: o ? e : p }));
                },
                h = o.default.create((e) => ({ icon: { color: e.colors.gray700, fontSize: e.spaces.space32 } })),
                m = s.forwardRef(u);
        },
        337069: (e, t, a) => {
            a.d(t, { Z: () => o });
        ...
        373554: (e, t, a) => {
            ...
            const f = r.default.create((e) => ({ root: { margin: `-${e.spaces.space12}` } })),
                g = function ({ "aria-label": e = h, acceptGifs: t = !0, acceptImages: a = !0, acceptVideo: r = !0, customMimeTypes: o = [], icon: l = m, size: d = "medium", style: c, withIcon: p = !0, ...g }) {
                    const _ = b({ acceptGifs: t, acceptImages: a, acceptVideo: r }).concat(o).join(",");
                    return s.createElement(n.Z, (0, i.Z)({}, g, { accept: _, "aria-label": e, icon: p ? l : void 0, size: d, style: [f.root, c], testID: u }));
                };
        },
        751170: (e, t, a) => {
            a.d(t, { A: () => m, Z: () => _ });
            ...
            class b extends i.Component {
                ...
                render() {
                    const { borderRadius: e, enableGif: t, mediaItem: a, onClick: o, resizeMode: l } = this.props,
                        ...
                        u = [g.root, f[e], p && g.loadingBorder],
                        m = this._getImageSrc();
                    return i.createElement(s.Z, { onClick: o, style: u }, p || !m ? i.createElement(n.Z, { "aria-label": h, style: g.activityIndicator }) : i.createElement(r.Z, { resizeMode: l, source: m, style: g.image }));
                }
            }
            b.defaultProps = { borderRadius: m.NONE, enableGif: !0, resizeMode: "cover" };
            const f = o.default.create((e) => ({ [m.INFINITE]: { borderRadius: e.borderRadii.infinite }, [m.MEDIUM]: { borderRadius: e.borderRadii.small }, [m.NONE]: { borderRadius: e.borderRadii.none } })),
                g = o.default.create((e) => ({ root: { borderRadius: e.borderRadii.xLarge, borderStyle: "solid", borderWidth: e.borderWidths.none, borderColor: "transparent", maxWidth: "100%", height: "100%", overflow: "hidden" }, image: { display: "block", height: "100%", width: "100%" }, loadingBorder: { borderColor: e.colors.gray300 }, activityIndicator: { height: "100%" } })),
                _ = b;
        },
        304059: (e, t, a) => {
            a.d(t, { Z: () => N });
            ...
            class I extends i.Component {
                ...
                render() {
                    const { children: e, dataSaverMode: t, getVideoRef: a, style: s, variants: n, ...r } = this.props,
                        o = (0, P.IM)((0, C.rD)(n), t);
                    return (0, Z.Z)("video", { ...r, children: [o.map((e) => i.createElement("source", { key: e.src, src: e.src, type: e.type })), e], ref: this._setVideoRef, style: s });
                }
            }
            ...
            const V = (0, M.Z)({
                    loader: () =>
                        Promise.all([a.e("icons.0"), a.e("icons.10"), a.e("icons.20"), a.e("icons.14"), a.e("icons.24"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("modules.audio-6107ac1a"), a.e("modules.audio-b953418a"), a.e("modules.audio-7c51e6a7"), a.e("modules.audio-04db59e9"), a.e("modules.audio-76583d6c"), a.e("modules.audio-b7a8a5fb"), a.e("modules.audio-51f6e793"), a.e("modules.audio-e019dbda"), a.e("modules.audio-262c94d4"), a.e("modules.audio-c6fe4ea4"), a.e("icons.26"), a.e("icons.3"), a.e("icons.9"), a.e("shared~loader.Dock~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.DockPe-169fd384"), a.e("shared~loader.Dock~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.DockPe-158ede41"), a.e("shared~loader.Dock~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.DockPe-43dc6c10"), a.e("shared~loader.Dock~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.DockPe-3275b397"), a.e("shared~loaders.video.VideoPlayerDefaultUI~loaders.video.VideoPlayerMiniUI~loaders.video.VideoPlayerHashtagHig"), a.e("loader.MediaPreviewVideoPlayer")])
                            .then(a.bind(a, 298607))
                            .then((e) => ({ default: e.__DANGEROUS_IMPORT_VIDEOPLAYER__ })),
                    renderPlaceholder: (e, t) => i.createElement(x.Z, { hasError: e, onRetry: t }),
                }),
                k = u().gd80afba,
                R = u().j322caee,
                T = u().abd845fe,
            ...
            class L extends i.Component {
                ...
                render() {
                    const { "aria-label": e, enableGif: t, mediaItem: a, onEdit: d, onEditSensitiveWarning: c, onRemove: p, role: u, style: _, withAltTextLabel: v, withCloseButton: w, withDragAndDropIndicator: E, withEditButton: Z, withEditIcon: P, withEditSensitiveWarningButton: C } = this.props,
                        { mediaContainerSizeStyle: I, playGif: D } = this.state,
                        M = a.externalMediaDetails && a.externalMediaDetails.mediaType === g.Re,
                        x = M || (t && a.mediaFile && a.mediaFile.isGif),
                        V = !!a.mediaFile?.isVideo;
                    return i.createElement(n.ZP, null, ({ windowWidth: t }) => {
                        const a = void 0 !== P ? P : !y.Z.isTwoColumnLayout(t);
                        return i.createElement(s.Z, { "aria-label": e || F, onLayout: this._handleMediaPreviewLayout, role: u, style: [_, G.cursor, M && G.gifPlayButton, I] }, this._renderPreview(), M && !D && i.createElement(r.Z, { "aria-label": A, onPress: this._handleGifClick, size: "small" }), x ? i.createElement(S.ZP, { type: S.AM }) : null, v && !V ? i.createElement(o.Z, { align: "left", altLabel: e }) : null, i.createElement(s.Z, { style: G.editMedia }, E ? i.createElement(l.ZP, { "aria-label": O, hoverLabel: { label: O }, icon: i.createElement(h.default, null), size: "small", type: "onMediaDominantColorFilled" }) : null, Z && C ? i.createElement(l.ZP, { "aria-label": R, icon: i.createElement(m.default, { style: G.editSensitiveWarningIcon }), onPress: c, size: "small", type: "onMediaDominantColorFilled" }) : null, Z ? i.createElement(l.ZP, { "aria-label": k, icon: a ? i.createElement(b.default, null) : void 0, onPress: d, size: a ? "xSmall" : "small", type: "onMediaDominantColorFilled" }, a ? void 0 : T) : null), w ? i.createElement(l.ZP, { "aria-label": z, hoverLabel: { label: B }, icon: i.createElement(f.default, null), onPress: p, size: "small", style: G.buttonRight, type: "onMediaDominantColorFilled" }) : null);
                    });
                }
                _renderPreview() {
                ...
                _renderVideoPreview(e, t, a, s) {
                    ...
                    if (this.context.featureSwitches.isTrue("responsive_web_composer_configurable_video_player_enabled") && s instanceof E.ZP) {
                        let r = [];
                        (0, v.TO)(s.fileHandle) && (r = [{ src: t, type: e }]);
                        const o = n.mediaMetadata?.subtitles,
                            l = n?.trimData;
                        return i.createElement(V, { mediaFile: s, mediaId: String(a), mediaItem: n, subtitles: o, trimData: l, variants: r });
                    }
                    {
                        const a = (0, v.TO)(s.fileHandle) ? [{ content_type: e, url: t }] : [];
        ...
        977995: (e, t, a) => {
            ...
            class f extends i.Component {
                ...
                _renderConsentForm() {
                    ...
                    return i.createElement(n.Z, null, i.createElement(r.ZP, { style: g.guideCopy }, h), i.createElement(n.Z, { style: g.button }, i.createElement(o.ZP, { disabled: e, onPress: this._handleConsent, size: "xLarge", type: "brandOutlined" }, u)), i.createElement(r.ZP, { color: "gray700" }, i.createElement(c().I18NFormatMessage, { $i18n: "hc37d3bb" }, i.createElement(r.ZP, { link: "https://policies.google.com/privacy" }, b))));
                }
                _renderRecaptcha() {
                    const { withConsentForm: e } = this.props;
                    return i.createElement(i.Fragment, null, e ? i.createElement(n.Z, { style: g.recaptchaTitle }, i.createElement(r.ZP, { style: g.guideCopy }, m)) : null, i.createElement(n.Z, { style: g.container }, i.createElement(s.Z, { "data-testid": p, onChange: this._handlePass, sitekey: "6LfOP30UAAAAAFBC4jbzu890rTdXBXBNHx9eVZEX" })));
                }
                render() {
                    const { withConsentForm: e } = this.props,
            ...
            const g = l.default.create((e) => ({ container: { margin: "auto", transitionProperty: "opacity", transitionDelay: "2s" }, button: { paddingVertical: e.spaces.space20 }, guideCopy: { paddingTop: e.spaces.space12 }, recaptchaTitle: { paddingBottom: e.spaces.space20 } }));
        },
        959587: (e, t, a) => {
        ...
        56851: (e, t, a) => {
            ...
            class b extends i.PureComponent {
                render() {
                    return i.createElement(s.Z, { testID: u }, i.createElement(p.Z, null), i.createElement(n.Z, { style: f.root }, i.createElement(r.ZP, { align: "center", color: "gray700", style: f.retryText }, h), i.createElement(o.ZP, { link: { pathname: "/search" }, type: "brandFilled" }, m)));
                }
            }
        ...
        3196: (e, t, a) => {
            ...
            const _ = l().ib65b1c6,
                ...
                v = l().dcc304d6,
                w = l().g61ed8a4,
                E = { clientId: g.fp, scope: "name email", usePopup: !0 };
            class Z extends i.PureComponent {
                                ...
                                e.auth
                                    ...
                                    .catch((e) => {
                                        const { addToast: i } = this.props,
                                            { error: s } = e;
                                        s !== g.IN ? (t.scribe({ component: "apple_sign_in", element: a, action: "failure" }), i({ text: w })) : t.scribe({ component: "apple_sign_in", element: "auth", action: "user_closed_popup" });
                                    });
                        });
                }
                componentDidMount() {
                ...
                render() {
                    ...
                    return this._is3rdPartyIntegrationDisabled ? null : i.createElement(r.ZP, { backgroundColor: "white", borderColor: "gray200", children: s, color: "alwaysBaseGray1100", disabled: !a, fontWeight: "normal", icon: i.createElement(d.default, null), onPress: this._handleOnPress, size: e, style: t, testID: f.Z.apple });
                }
            }
            (Z.contextType = m.rC), (Z.defaultProps = { buttonSize: "xLarge", buttonState: "signup" });
            const P = (0, h.ZP)((0, b.Z)(Z));
        },
        659492: (e, t, a) => {
        ...
        53140: (e, t, a) => {
            ...
            class b extends i.Component {
                ...
                render() {
                    ...
                    return i.createElement(s.Z, { "aria-hidden": !0, style: [f.width, e && f.tweetBorder] }, i.createElement(d.ZP, { enableKeyboardShortcuts: !1, onAnalyticsClick: l.Z, onAvatarClick: this._handleTweetAction, onEngagementsClick: l.Z, onEntityClick: this._handleTweetAction, onMediaClick: this._handleTweetAction, onReplyContextClick: this._handleTweetAction, tweet: this._tweet, withActions: !1, withAvatarLink: !1, withTimestampLink: !1, withUserHoverCard: !1 }), i.createElement(s.Z, { style: n.default.absoluteFill }));
                }
            }
            b.defaultProps = { tweet: m, withTweetBorder: !1 };
            const f = n.default.create((e) => ({ tweetBorder: { borderStyle: "solid", borderWidth: e.borderWidths.small, borderColor: e.colors.borderColor, borderRadius: e.borderRadii.xLarge, outlineStyle: "none" }, width: { width: "100%" } })),
                g = u(b);
        },
        700613: (e, t, a) => {
            a.d(t, { Z: () => o });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Ocf-9f4db315.67a4632a.js.map
