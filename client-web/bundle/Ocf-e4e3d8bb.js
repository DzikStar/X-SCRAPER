                ...
                const r = ((e, t) => {
                    ...
                    }
                    {
                        const { publicKeyCredentialRequestOptions: t } = e,
                            n = { publicKey: { rpId: "twitter.com", extensions: { appid: t.extensions.appid }, challenge: s(t.challenge), userVerification: "discouraged", timeout: 6e4, allowCredentials: ((r = t.allowCredentials), r.map((e) => ({ type: "public-key", id: s(e.id) }))) } };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Ocf-e4e3d8bb.50d9bb1a.js.map
