                ...
                if (!v[O])
                    for (j = 0, R = p.length; j < R; j++) {
                        ...
                        if (-1 !== w.indexOf(V)) {
                            ...
                            J === V && (J = escape(V)), (w = w.split(V).join(J));
                        }
                    }
                var Z = w.indexOf("#");
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Ocf-e96e9bea.619fa77a.js.map
