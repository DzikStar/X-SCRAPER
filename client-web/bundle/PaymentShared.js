...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.PaymentShared"],
    {
            ...
            var s,
                ...
                g = {
                    ...
                    operation: {
                        ...
                        name: "usePaymentsConfigQuery",
                        selections: [
                            { alias: null, args: s, concreteType: "XPaymentsClientConfig", kind: "LinkedField", name: "get_payments_client_config", plural: !1, selections: [l, t, r, i, o, u, d, c, m, { alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "support_user_results", plural: !1, selections: [p, { alias: null, args: null, kind: "ScalarField", name: "id", storageKey: null }], storageKey: null }], storageKey: 'get_payments_client_config(s:"4721")' },
                            { alias: null, args: s, concreteType: null, kind: "LinkedField", name: "get_transfer_methods_config", plural: !1, selections: [{ alias: null, args: null, kind: "ScalarField", name: "__typename", storageKey: null }, y], storageKey: 'get_transfer_methods_config(s:"4721")' },
                        ],
                    },
        ...
        445664: (e, n, a) => {
            ...
            const c = s.Z,
                m = ({ environment: e }) =>
                    r()(e, c, {}, { fetchPolicy: "network-only" })
                        .toPromise()
                        .then((e) => {
                ...
                p = (e) => {
                    const n = e?.fetchKey,
                        [a, s] = l.useState(1),
                        { data: t, refetch: r, refetchStatus: i } = (0, u.A)(c, {}, { fetchKey: n }),
                        m = t?.get_customer ?? {},
                    ...
                    return (
                        ...
                        { ...(0, d.S9)({ roles: _, permissions: g }), id: y, permissions: g, roles: _, fetchCount: a, refetchStatus: i }
                    );
                };
        },
        412450: (e, n, a) => {
            ...
            var s = a(990312),
                ...
                o = a(514639);
            const u = s.Z,
                d = { "payments-dev.x.com": o.Re.development, "money-dev.x.com": o.Re.development, "payments-staging.x.com": o.Re.staging, "money-staging.x.com": o.Re.staging, "money.x.com": o.Re.production, "payments-prod.x.com": o.Re.production },
                c = () => {
                    const e = t()(u, {}),
        ...
        983304: (e, n, a) => {
            ...
            const _ = () => {
                ...
                k = ({ allowLockedSession: e }) => {
                    const { environment: n, forwardWithSdkUrl: a, sardineApiSubdomain: s, sardineClientID: r, sardineEnvironment: g, sardinePixelSubdomain: k, sardineSdkUrl: h, socurePublicKey: S } = (0, y.Z)(),
                        K = (0, o.useLocation)(),
                        b = (0, o.useHistory)(),
                        F = K.pathname,
                        v = (0, t.Dv)(d.lZ),
                        P = (0, c.hC)("payments_forward_with_enabled"),
                        [C, w] = l.useState(!1),
                        [T] = i()(f),
                        L = l.useCallback(
                            ({ challengeId: e }) => {
                                ...
                                a === F && (a !== m.CM ? b.push(m.CM, n) : b.replace(m.CM, n));
                            },
                            [F, b],
                        ),
                        x = l.useCallback(() => {
        ...
        482924: (e, n, a) => {
            ...
            function p(e, n, a) {
                const l = i()(n),
                    ...
                    h = (0, m.p)(e, n, a);
                return s.useMemo(() => (y ? { data: h, refetch: k, refetchStatus: c.ZP.FAILED, refetchError: y } : { data: h, refetch: k, refetchStatus: _ ? c.ZP.LOADING : c.ZP.NONE, refetchError: void 0 }), [h, y, _, k]);
            }
        },
        762371: (e, n, a) => {
            ...
            const p = ({ isActive: e }) => {
                ...
                y = ({ Component: e, options: n, ...a }) => {
                    const { permissionsAllOf: s, permissionsAnyOf: t, requireRedirect: o = !0 } = n,
                        { location: c } = a,
                        m = c.state?.cameFromOCF ? "PaymentsFromOcf" : "Payments",
                    ...
                    const k = p({ isActive: g }),
                        h = c.pathname;
                    if (k) return l.createElement(d.Z, { to: k });
                    if (!g && o && h !== _) return l.createElement(d.Z, { to: _ });
                    const S = !s || s.every((e) => f?.includes(e)),
                        K = !t || t.some((e) => f?.includes(e));
                    return !f || (S && K) ? l.createElement(e, a) : l.createElement(d.Z, { to: r.Xj });
                };
            function g({ Component: e, options: n, ...a }) {
                const { allowLockedSession: r, permissionsAllOf: i, permissionsAnyOf: u } = n,
                    [d] = (0, o.Z)({ allowLockedSession: !!r });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.PaymentShared.f5cc160a.js.map
