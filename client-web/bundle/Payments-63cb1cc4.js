    ...
    ["bundle.Payments-63cb1cc4"],
    {
        ...
        351190: (e, t, a) => {
            ...
            const x = { page: "money", section: "account" },
                _ = "Unlock Full Account",
                v = `${_} - Account details`,
                I = (e) => {
                    const { permissions: t, roles: a } = (0, f.Z)({ fetchKey: "Payments" }),
                        { balance: u, interest: g } = (0, P.Z)(),
                        y = (0, Z.jh)(),
                        x = (0, l.useHistory)(),
                        I = (0, k.Gs)(t),
                        { handlePreferencesChange: w, isInProgress: S, preferences: T, refetch: D } = (0, C.Z)(),
                        A = r.useMemo(() => T.enable_bill_pay, [T]),
                        W = r.useMemo(() => t?.includes(m.d.CreateWithdrawal) || t?.includes(m.d.CreateDeposit), [t]),
                        z = r.useCallback(() => {
                            w("enable_bill_pay", !0), D();
                        }, [w, D]),
                        F = r.useCallback(() => {
                            x.replace(h.C2);
                        }, [x]),
                        L = t?.includes(m.d.CreateDeposit),
                        M = r.useCallback(() => x.goBack(), [x]),
                        B = L ? r.createElement(n.Z, { style: y.footer }, A ? r.createElement(c.ZP, { backgroundColor: "gray0", borderColor: "transparent", color: "red500", disabled: S, fontWeight: "normal", onClick: F, size: "xLarge" }, S ? r.createElement(o.Z, null) : "Disable Outgoing Payments") : r.createElement(c.ZP, { backgroundColor: "gray0", borderColor: "transparent", color: "text", disabled: S, fontWeight: "normal", onClick: z, size: "xLarge" }, S ? r.createElement(o.Z, null) : "Enable Outgoing Payments"), r.createElement(c.ZP, { backgroundColor: "gray0", borderColor: "transparent", color: "text", fontWeight: "normal", link: h.IN, size: "xLarge" }, "Deposit funds")) : !W && I ? r.createElement(n.Z, { style: y.footer }, r.createElement(c.ZP, { backgroundColor: "gray0", borderColor: "transparent", color: "text", fontWeight: "normal", icon: r.createElement(d.default, null), link: { pathname: (0, k.FW)({ roles: a }), state: { closePath: h.l_, redirectPath: h.l_ } }, size: "xLarge" }, _)) : null;
                    return r.createElement(p.Z, { backButtonType: "close", bottomBar: B, history: x, onBackClick: M }, r.createElement(n.Z, { style: y.container }, r.createElement(n.Z, { style: N.accountContainer }, r.createElement(n.Z, { style: N.balanceContainer, testID: "account-balance" }, r.createElement(s.ZP, { size: "headline2", weight: "bold" }, "Balance"), r.createElement(n.Z, null, u ? r.createElement(E.Z, { amount: u.available_amount_local_micro, size: "title0", style: N.veritcalPadding }) : null)), g ? r.createElement(n.Z, { style: N.interest }, g.apy && r.createElement(n.Z, { style: N.flexGap }, r.createElement(s.ZP, { color: "gray700", size: "subtext1" }, "Current interest rate"), r.createElement(s.ZP, { size: "subtext1", weight: "medium" }, (0, k.Bj)({ apy: g.apy }))), r.createElement(n.Z, { style: N.flexGap }, r.createElement(s.ZP, { color: "gray700", size: "subtext1" }, "Total interest earned"), r.createElement(E.Z, { amount: g.earned.local_micro, currency: g.pending.currency, size: "subtext1", weight: "medium" })), g.pending && r.createElement(n.Z, { style: N.flexGap }, r.createElement(s.ZP, { color: "gray700", size: "subtext1" }, "Pending interest"), r.createElement(E.Z, { amount: g.pending.local_micro, currency: g.pending.currency, size: "subtext1", weight: "medium" }))) : null, W ? r.createElement(r.Fragment, null, r.createElement(i.Z, { spacing: "space8" }), r.createElement(n.Z, { style: N.flexCol, testID: "account-details" }, r.createElement(s.ZP, { size: "headline2", weight: "bold" }, "Account details"), r.createElement(b.Z, { ariaLabel: v }))) : null)));
                },
        ...
        99387: (e, t, a) => {
            ...
            const C = "Verifying your identity",
                ...
                _ = { [p.P_.onboarding]: { headline: "Setting up your account" }, [p.P_.upgradeToKycVerified]: { headline: C, targetRole: u.N.KycVerified, challengeCompleteMessage: b.q9.completeKyc }, [p.P_.upgradeToKycDocumentsVerified]: { headline: C, targetRole: u.N.KycDocumentsVerified, challengeCompleteMessage: b.q9.completeDocv }, [p.P_.selfieVerification]: { headline: C, targetRole: u.N.SelfieVerified, challengeCompleteMessage: b.q9.completeSelfie }, [p.P_.autoclaim]: { headline: "Processing your transactions", errorMessage: "We're still processing your transactions. We'll notify you once they are complete.", subtext: "It may take up to 3 business days for the funds to be settled" }, [p.P_.checkPendingTransactions]: { headline: "Processing your transactions", errorMessage: "We're still processing your transactions. We'll notify you once they are complete.", subtext: "It may take up to 3 business days for the funds to be settled" }, [p.P_.updateName]: { headline: x }, [p.P_.updateAddress]: { headline: x }, [p.P_.questions]: { headline: "Checking your account status" } },
                v = ({ challengeId: e, challengeInitiator: t, errorRedirectPath: a, linkType: l, redirectPath: u, redirectState: d, targetRole: C }) => {
                    const x = (0, o.useHistory)(),
                        v = c()(),
                        I = (0, f.z)(),
                        w = (0, m.p)(),
                        { headline: S, errorMessage: N = k, targetRole: T, subtext: D = Z, challengeCompleteMessage: A } = _[l],
                        W = C ?? T,
                    ...
                    return (
                                          ...
                                          .then((a) => {
                                              ...
                                              switch (l) {
                                                  ...
                                                  case p.P_.upgradeToKycDocumentsVerified:
                                                      if (c && c.includes(W)) {
                                                          clearInterval(n), (0, P.J$)(v);
                                                          const a = (0, P.yH)({ roles: c });
                                                          s ? x.replace(p.Xy) : e && A ? x.replace((0, P.Ix)({ challengeInitiator: t }), { redirectPath: u, redirectState: d, challengeId: e, message: A, challengeInitiator: t }) : a ? x.replace(p.Am) : o ? x.replace(p.wD) : x.replace(u ?? p.gp, d);
                                                      }
                                                      (0, P.ab)({ roles: c }) && (clearInterval(n), (0, P.J$)(v), x.replace(p.gp));
                                                      break;
                                                  case p.P_.autoclaim:
                                                  ...
                                                  case p.P_.updateAddress:
                                                      r && c && (clearInterval(n), (0, P.J$)(v), x.replace(s ? p.Xy : (u ?? p.iE.personal), d));
                                                      break;
                                                  case p.P_.questions:
                                                      clearInterval(n), (0, P.J$)(v), x.replace(u ?? p.gp, d);
                                              }
                                          })
                                          .catch(() => {
                                              F(n);
                        ...
                        }, [I, v, F, x, l, u, W, d, e, t, A]),
                        r.createElement(y.Z, { headline: S, subtext: z })
                    );
                },
                I = { context: "PaymentsAccountsPoller" },
                w = (e) => r.createElement(d.H, { errorConfig: I }, r.createElement(v, e)),
                S = r.memo(w);
        },
        496743: (e, t, a) => {
            ...
            const S = p.Z,
                ...
                T = (e) => {
                    ...
                    return r.createElement(r.Fragment, null, c ? r.createElement(g.Z, null, a ? r.createElement(g.Z, { style: d.ZP.header }, r.createElement(f.ZP, { size: "headline2", weight: "bold" }, "All Transactions")) : null, r.createElement(_.Z, { emptyStateDescription: "Once you have some activity, it will show up here.", fetchNext: l, slice: c })) : null);
                },
                D = (e) => {
                ...
                A = y.default.create(() => ({ tabStrip: { width: "100%" } })),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Payments-63cb1cc4.19b548aa.js.map
