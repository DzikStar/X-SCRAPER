    ...
    ["bundle.Payments-9f4db315", "loader.FeedbackSheet"],
    {
        ...
        625661: (e, t, n) => {
            ...
            class h extends o.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: n, fixed: r, hideBackButton: i, isFullWidth: a, isLarge: c, leftControl: d, middleControl: h, position: p, rightControl: m, secondaryBar: f, style: b, subtitle: C, title: y, titleDomId: g, titleIconCell: B, titleIconCellSize: k, withBackground: w, withWideContainer: x } = this.props,
                        { isModal: Z } = this.context,
                        E = i ? d : o.createElement(l.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        v = (function (e, t, n) {
                            return e && !(t && n);
                        })(!!w, Z, !!f);
                    return o.createElement(o.Fragment, null, o.createElement(s.Z, { centerTitle: t, centeredLogo: n, isFullWidth: a, isLarge: c, leftControl: E, middleControl: h, position: u(p, Z, r), rightControl: m, style: b, subtitle: C, title: y, titleDomId: g, titleIconCell: B, titleIconCellSize: k, withBackground: v, withWideContainer: x }), f || null);
                }
                render() {
        ...
        980407: (e, t, n) => {
            ...
            class p extends o.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: n, backLocation: i, centerTitle: a, hideBackButton: l, history: s, isFullWidth: u, isLarge: h, middleControl: p, onBackClick: f, rightControl: b, secondaryBar: C, subtitle: y, title: g } = this.props,
                                { isModal: B } = this.context;
                            return o.createElement(r.Z, { style: B ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, o.createElement(d.ZP, { backButtonType: n || (B ? "close" : "back"), backLocation: i, centerTitle: a, fixed: !B, hideBackButton: l, history: s, isFullWidth: u, isLarge: h, middleControl: p, onBackClick: f, ref: e, rightControl: b, secondaryBar: C, style: [B && m.appBarModal, t], subtitle: y, title: g, titleDomId: c.Q_ }));
                        }),
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: n, containerStyle: a, documentTitle: l, isFullWidth: c, isLarge: d, renderHeader: p, title: f, withoutBottomBarMobile: b } = this.props,
        ...
        507651: (e, t, n) => {
            ...
            const s = (e) => {
                    ...
                    return r.createElement(a.Z, (0, o.Z)({}, e, { isCompact: (0, l.HD)(t) }));
                },
                c = r.memo(s);
        },
        652904: (e, t, n) => {
        ...
        547195: (e, t, n) => {
            ...
            const p = "Send or Request",
                ...
                B = (e) => ((0, l.hC)("payments_enabled") ? o.createElement(h.N, { errorConfig: b, fallback: C }, o.createElement(g, e)) : null),
                k = o.memo(B);
        },
        524084: (e, t, n) => {
            n.d(t, { Z: () => a });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Payments-9f4db315.36303cfa.js.map
