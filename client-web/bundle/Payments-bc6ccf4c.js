            ...
            class C extends i.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: o, badgePip: r, children: a, color: n, isActive: c, isCompact: d, isPillLink: p, isRoundedRect: u, isWebRedesign: g, retainScrollPosition: C, style: S, to: k } = this.props,
                        ...
                        R = k ? this._getMemoizedLink(k, C) : void 0,
                    ...
                    return i.createElement(b.Z, { "aria-label": t, "aria-selected": E, focusable: !!E, interactiveStyles: W, link: R, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(p ? [x.pillStyle] : [x.link]), ...(p && E ? [x.pillActiveStyle] : []), d ? (p ? x.compactPill : x.compactLink) : null, u ? x.roundedRect : null, S], withoutInteractiveStyles: g }, ({ isFocused: t, isHovered: c }) => i.createElement(s.Z, { style: p && x.flexGrow }, i.createElement(h.ZP, { size: g ? "headline2" : void 0, style: [x.text, { color: this._getTextColor(E, c, g, p) }, d && x.compactText, g && t && x.focusedText, p && x.pillTextStyle, p && E && x.pillActiveTextStyle, p && c && x.pillHoverTextStyle], weight: I }, e && i.createElement(e, { style: x.icon }), a, g || p ? null : i.createElement(s.Z, { style: E && [x.border, { backgroundColor: l.default.theme.colors[n] }] })), o ? i.createElement(m.Z, { count: o, standalone: !0, style: [x.badge, o >= 10 && x.multiDigitBadge, o >= 20 && x.truncatedCountBadge], truncatedCountFormatter: w, unreadCountLabel: y, withBorder: !1 }) : r ? i.createElement(m.Z, { pip: !0, standalone: !0, style: x.badgePip, textColor: "red500", unreadCountLabel: v, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Payments-bc6ccf4c.f7b78eda.js.map
