    ...
    ["bundle.Payments-d97a9c6b"],
    {
        ...
        671738: (e, t, n) => {
            ...
            var a = n(202784),
                ...
                l = n(727384),
                m = n(392046);
            const d = ({ accountId: e, addAccountLink: t, addBankCardLink: n, handleDismiss: c, onSelectAccountId: o, paymentMethods: d }) => {
                ...
                u = ({ accountId: e, addAccountLink: t, addBankCardLink: n, onSelectAccountId: r, paymentMethods: s, selectedAccount: o }) => {
                    const i = a.useCallback((c) => a.createElement(d, { accountId: e, addAccountLink: t, addBankCardLink: n, handleDismiss: c, onSelectAccountId: r, paymentMethods: s }), [e, t, n, r, s]);
                    return a.createElement(c.Z, { renderContent: i, withArrow: !0 }, a.createElement(m.Z, { account: o, withChevron: !0, withInteractiveStyling: !0 }));
                },
        ...
        448518: (e, t, n) => {
            ...
            function ne({ amount: e, challengeId: t, currency: n, isViewerSender: s, onSuccess: c, receiverScreenName: o, recordId: i, senderScreenName: l, status: m, transactionId: d, transactionType: u, withPrimaryOnly: y }) {
                const p = e ? (0, r.vw)({ amount: e, currency: n }) : null,
                    ...
                    Z = a.useMemo(() => (f ? a.createElement(U, { amount: p, key: "PayRequest", onSuccess: c, recordId: i, size: y ? "small" : "medium", transactionId: d, type: y ? "secondaryFilled" : "primaryFilled", userScreenName: o }) : null), [f, p, c, o, i, d, y]),
                    w = a.useMemo(() => (f ? a.createElement(F, { amount: p, key: "DeclineRequest", recordId: i, transactionId: d, userScreenName: o }) : null), [f, p, o, i, d]),
            ...
            const S = a.Z,
                C = ({ itemRef: e }) => {
                    const t = o()(S, e),
                        ...
                        H = (0, E.GU)({ transactionType: D, isViewerSender: M, productCode: R }),
                        ...
                        O = (0, E.lD)({ status: $, reasonCode: T, isViewerSender: M }),
                        U = (0, E.qK)({ transactionType: D, description: z, productCode: R, accountName: Y ? (Y.accountType ? `${Y.accountType} ${Y.accountName.name}` : `${Y.accountName.name}`) : "", createdAt: C, statusLabel: O }),
                        B = (0, E._T)({ status: $ }),
                        J = (0, E.Gl)({ status: $ }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Payments-d97a9c6b.1a3bec8a.js.map
