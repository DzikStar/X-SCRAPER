...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.Payments-d97a9c6b"],
    {
        ...
        743250: (e, t, n) => {
            ...
            const Z = "Verify",
                ...
                S = ({ itemRef: e, supportLink: t }) => {
                        ...
                        y = (({ action: e, supportLink: t, url: n }) => {
                            switch (e) {
                                ...
                                case g.C.KycVerification:
                                    return { label: Z, link: { pathname: k.AU.tier2.verifyIdentityPath, state: { closePath: k.gp } } };
                                case g.C.KycDocumentUpload:
                                    return { label: Z, link: { pathname: k.AU.tier3.verifyIdentityPath, state: { closePath: k.gp } } };
                                case g.C.SelfieVerification:
                                    return { label: Z, link: { pathname: k.AU.selfie.verifyIdentityPath, state: { closePath: k.gp } } };
                                case g.C.Deposit:
                    ...
                    return r.createElement(i.Z, { key: n.title, style: P.dE.listItem, withInteractiveStyling: !1 }, r.createElement(l.Z, { Icon: C, color: S, size: "xLarge" }), r.createElement(s.Z, { style: P.dE.listItemFlex }, r.createElement(s.Z, { style: P.dE.listItemContent }, r.createElement(s.Z, { style: P.dE.listItemFlex }, r.createElement(m.ZP, null, n.title), r.createElement(m.ZP, { color: "gray700" }, n.subtitle)), a ? r.createElement(E.Z, { variant: "MoneyInterest" }) : y ? r.createElement(d.ZP, { link: y.link, size: "small", type: "secondaryFilled" }, y.label) : null)));
                },
                C = r.memo(S);
        },
        86320: (e, t, n) => {
        ...
        413713: (e, t, n) => {
            ...
            const o = "Review limits",
                ...
                p = ({ errors: e, linkState: t, roles: n }) => {
                    const s = y({ errors: e }),
                        c = s?.action,
                        o = u({ errors: e, roles: n }) ?? c?.link,
                        i = c && o ? { ...c, link: { pathname: o, state: t } } : void 0;
                    return a.createElement(r.Z.Danger, { action: i, text: s.message, withIcon: !0 });
                },
                h = a.memo(p);
        },
        19804: (e, t, n) => {
        ...
        89319: (e, t, n) => {
            ...
            function g(e) {
                return a.createElement(o.H, { errorConfig: p }, a.createElement(h, e));
            }
            const f = a.memo(g);
        },
        448518: (e, t, n) => {
            ...
            const g = ({ amount: e, onSuccess: t, recordId: n, senderScreenName: l, size: g, transactionId: f, type: I }) => {
                    const [E, k] = (0, p.bf)(),
                        ...
                        b = (0, r.Fs)({ permissions: P, permission: i.d.ClaimTransfer }),
                        v = (0, y.z)(),
                        w = (0, s.useHistory)(),
                        S = (0, m.p)(),
                        C = a.useCallback(
                        ...
                        x = k || !b;
                    return a.createElement(c.ZP, { disabled: x, onPress: C, size: g ?? "medium", type: I }, k ? a.createElement(o.Z, { size: "small" }) : "Accept");
                },
            ...
            const P = ({ amount: e, onSuccess: t, recordId: n, size: l, transactionId: p, type: g }) => {
                    const [f, I] = (0, k.yA)(),
                        ...
                        Z = (0, r.Fs)({ permissions: E, permission: i.d.ConfirmUnrecognizedPayment }),
                        b = (0, y.z)(),
                        v = (0, s.useHistory)(),
                        w = (0, m.p)(),
                        S = a.useCallback(
                        ...
                        C = I || !Z;
                    return a.createElement(c.ZP, { disabled: C, onPress: S, size: l ?? "medium", type: g }, I ? a.createElement(o.Z, { size: "small" }) : "Approve");
                },
                Z = { context: "PaymentsPayRequest" };
            function b(e) {
                return a.createElement(l.H, { errorConfig: Z }, a.createElement(P, e));
            }
            const v = a.memo(b);
            var w = n(604347);
            const S = ({ amount: e, onSuccess: t, recordId: n, size: l, transactionId: p, userScreenName: g }) => {
                    const [f, I] = (0, w.Z)(),
                        ...
                        S = a.useCallback(
                            (a) => {
                                a && a.preventDefault(),
                                    Z.scribe({ page: "money", section: "cancel-request", element: "cancel", action: "click" }),
                                    f({ transactionId: p, recordId: n })
                                        .then(({ challengeId: a, status: s, transactionId: c }) => {
                                            const o = e && g ? (({ formattedAmount: e, userScreenName: t }) => `You canceled the ${e} request to @${t}.`)({ formattedAmount: e, userScreenName: g }) : null,
                                                i = (0, r.wu)({ status: s, challengeId: a });
                                            i ? b.push(i, { challengeId: a, successMessage: o, challengeInitiator: d.kW.transaction, recordId: n }) : (o && v({ text: o }), t?.());
                                        })
                                        .catch((e) => {
                                            const t = (0, h.XE)({ errors: e, roles: k });
                                            t ? b.replace(t, { redirectPath: `${d.bR}/${p}`, closePath: d.gp }) : v({ text: (0, h.kJ)({ errors: e }).message });
                                        });
                            },
                            [Z, f, p, n, e, g, t, v, k, b],
                        ),
            ...
            const N = ({ amount: e, onSuccess: t, receiverScreenName: n, recordId: l, size: p, transactionId: g }) => {
                    const [f, I] = (0, A.Z)(),
                        ...
                        w = a.useCallback(
                            (a) => {
                                a && a.preventDefault(),
                                    Z.scribe({ page: "money", section: "cancel-transaction", element: "cancel", action: "click" }),
                                    f({ transactionId: g, recordId: l })
                                        .then(({ challengeId: a, status: s, transactionId: c }) => {
                                            const o = e && n ? (({ formattedAmount: e, receiverScreenName: t }) => `You canceled the ${e} transfer to @${t}.`)({ formattedAmount: e, receiverScreenName: n }) : null,
                                                i = (0, r.wu)({ status: s, challengeId: a });
                                            i ? b.push(i, { challengeId: a, successMessage: o, challengeInitiator: d.kW.transaction, recordId: l }) : (o && v({ text: o }), t?.());
                                        })
                                        .catch((e) => {
                                            const t = (0, h.XE)({ errors: e, roles: k });
                                            t ? b.replace(t, { redirectPath: `${d.bR}/${g}`, closePath: d.gp }) : v({ text: (0, h.kJ)({ errors: e }).message });
                                        });
                            },
                            [v, e, Z, f, b, t, l, k, n, g],
                        ),
            ...
            const _ = ({ amount: e, onSuccess: t, recordId: n, size: l, transactionId: p, userScreenName: g }) => {
                    const [f, I] = (0, D.C7)(),
                        ...
                        w = a.useCallback(
                            (a) => {
                                a && a.preventDefault(),
                                    Z.scribe({ page: "money", section: "review-request", element: "decline", action: "click" }),
                                    f({ transactionId: p, recordId: n })
                                        .then(({ challengeId: a, status: s, transactionId: c }) => {
                                            const o = e && g ? (({ formattedAmount: e, userScreenName: t }) => `You declined the ${e} request from @${t}.`)({ formattedAmount: e, userScreenName: g }) : null,
                                                i = (0, r.wu)({ status: s, challengeId: a });
                                            i ? b.push(i, { challengeId: a, challengeInitiator: d.kW.transaction, successMessage: o, recordId: n }) : (o && v({ text: o }), t?.());
                                        })
                                        .catch((e) => {
                                            const t = (0, h.XE)({ errors: e, roles: k });
                                            t ? b.replace(t, { redirectPath: `${d.bR}/${p}`, closePath: d.gp }) : v({ text: (0, h.kJ)({ errors: e }).message });
            ...
            const V = a.memo(L),
                M = ({ amount: e, onSuccess: t, recordId: n, senderScreenName: l, size: g, transactionId: f }) => {
                    const [I, E] = (0, p.C7)(),
                        k = (0, y.z)(),
                        P = (0, s.useHistory)(),
                        Z = (0, m.p)(),
                        { permissions: b, roles: v } = (0, u.Z)({ fetchKey: "Payments" }),
                        w = (0, r.Fs)({ permissions: b, permission: i.d.ClaimTransfer }),
                        S = a.useCallback(
                            (a) => {
                                a && a.preventDefault(),
                                    ...
                                    I({ transactionId: f, recordId: n })
                                        .then(({ challengeId: a, status: s, transactionId: c }) => {
                                            const o = e && l ? (({ formattedAmount: e, senderScreenName: t }) => `You declined ${e} from @${t}.`)({ formattedAmount: e, senderScreenName: l }) : null,
                                                i = (0, r.wu)({ status: s, challengeId: a });
                                            i ? P.push(i, { challengeId: a, challengeInitiator: d.kW.transaction, successMessage: o, recordId: n }) : (o && Z({ text: o }), t?.());
                                        })
                                        .catch((e) => {
                                            const t = (0, h.XE)({ errors: e, roles: v });
                                            t ? P.replace(t, { redirectPath: `${d.bR}/${f}`, closePath: d.gp }) : Z({ text: (0, h.kJ)({ errors: e }).message });
                                        });
                            },
                            [Z, e, k, I, P, t, n, v, l, f],
                        ),
                        C = E || !w;
                    return a.createElement(c.ZP, { disabled: C, onPress: S, size: g ?? "medium", type: "primaryOutlined" }, E ? a.createElement(o.Z, { size: "small" }) : "Decline");
                },
                q = { context: "PaymentsDeclineTransfer" };
            function H(e) {
                return a.createElement(l.H, { errorConfig: q }, a.createElement(M, e));
            }
            const K = a.memo(H),
                W = ({ amount: e, onSuccess: t, recordId: n, size: l, transactionId: p, type: g, userScreenName: f }) => {
                    const [I, E] = (0, D.iP)(),
                        ...
                        Z = (0, r.Fs)({ permissions: k, permission: i.d.RespondToRequestTransfer }),
                        b = (0, y.z)(),
                        v = (0, s.useHistory)(),
                        w = (0, m.p)(),
                        S = a.useCallback(
                        ...
                        C = E || !Z;
                    return a.createElement(c.ZP, { disabled: C, onPress: S, size: l ?? "medium", type: g }, E ? a.createElement(o.Z, { size: "small" }) : "Pay");
                },
                                    ...
                                    g({ transactionId: p, recordId: n })
                                        .then(({ challengeId: a, status: s, transactionId: c }) => {
                                            const o = e ? (({ formattedAmount: e }) => `You rejected the ${e} payment.`)({ formattedAmount: e }) : null,
                                                i = (0, r.wu)({ status: s, challengeId: a });
                                            i ? b.push(i, { challengeId: a, challengeInitiator: d.kW.confirmUnrecognisedPayment, successMessage: o, recordId: n }) : (o && v({ text: o }), t?.());
                                        })
                                        .catch((e) => {
            ...
            function ne({ amount: e, challengeId: t, currency: n, isViewerSender: s, onSuccess: c, receiverScreenName: o, recordId: i, senderScreenName: l, status: m, transactionId: d, transactionType: u, withPrimaryOnly: y }) {
                const p = e ? (0, r.vw)({ amount: e, currency: n }) : null,
                    ...
                    k = (0, r.BC)({ status: m }),
                    P = a.useMemo(() => (g ? a.createElement($, { amount: p, key: "CancelTransfer", onSuccess: c, receiverScreenName: o, recordId: i, transactionId: d }) : null), [g, p, c, o, i, d]),
                    Z = a.useMemo(() => (I ? a.createElement(z, { amount: p, key: "CancelRequest", recordId: i, transactionId: d, userScreenName: l }) : null), [I, p, i, l, d]),
                    b = a.useMemo(() => (f ? a.createElement(O, { amount: p, key: "PayRequest", onSuccess: c, recordId: i, size: y ? "small" : "medium", transactionId: d, type: y ? "secondaryFilled" : "primaryFilled", userScreenName: o }) : null), [f, p, c, o, i, d, y]),
                    w = a.useMemo(() => (f ? a.createElement(V, { amount: p, key: "DeclineRequest", recordId: i, transactionId: d, userScreenName: o }) : null), [f, p, o, i, d]),
                    S = a.useMemo(() => (h ? a.createElement(E, { amount: p, key: "AcceptTransfer", onSuccess: c, recordId: i, senderScreenName: l, size: y ? "small" : "medium", transactionId: d, type: y ? "secondaryFilled" : "primaryFilled" }) : null), [h, p, c, i, l, d, y]),
                    C = a.useMemo(() => (h ? a.createElement(K, { amount: p, key: "DeclineTransfer", recordId: i, senderScreenName: l, transactionId: d }) : null), [h, p, i, l, d]),
                    ...
                    R = a.useMemo(() => [...(y ? [b, S, N] : [P, Z, b, w, S, C, A, x])], [S, x, Z, P, w, C, b, A, N, y]);
            ...
            const S = a.Z,
                C = ({ itemRef: e }) => {
                    const t = o()(S, e),
                        ...
                        L = A.sender_results?.result,
                        V = A.payment_method,
                        M = A.merchant_details,
                        q = (0, f.Z)({ senderId: L?.rest_id }),
                        H = (0, E.GU)({ transactionType: D, isViewerSender: q, productCode: R }),
                        K = _ || "User" !== F?.__typename || "User" !== L?.__typename ? null : q ? F : L,
                        W = (0, E.zK)({ transactionType: D, productCode: R, merchantDetails: M, amountType: H }),
                        Y = D === y.x.Deposit || D === y.x.Withdraw ? (0, E.Ou)(V) : null,
                        U = (0, E.lD)({ status: $, reasonCode: T, isViewerSender: q }),
