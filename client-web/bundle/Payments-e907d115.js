    ...
    ["bundle.Payments-e907d115"],
    {
        ...
        779610: (e, t, o) => {
            ...
            var r = o(202784),
                ...
                c = o(392237);
            const d = (e) => {
                    const { decoration: t, description: o, disabled: d = !1, isActive: u = !1, label: h, link: m, onPress: g, paddingHorizontal: f, renderRightContent: b, role: y = "tab", styleOverride: w, testID: C = "pivot", thumbnail: x, thumbnailSize: k, withoutArrow: v = !1 } = e,
                        S = [p.thumbnailContainer, "medium" === k && p.thumbnailContainerMedium],
                        R = "string" == typeof h ? r.createElement(s.ZP, null, h) : h,
                        Z = "object" == typeof m && m.external && !m.openInSameFrame,
                        E = o ? ("string" == typeof o ? r.createElement(s.ZP, { color: "gray700", size: "subtext2", testID: `${C}-description` }, o) : o) : null,
                    ...
                    return r.createElement(l.Z, { "aria-selected": "tab" === y ? u : null, disabled: d, link: d ? void 0 : m, onPress: g, role: y, style: [p.root, W, d && p.disabled, w], testID: C, withInteractiveStyling: !!m || !!g }, r.createElement(a.Z, { style: p.contentContainer }, x ? r.createElement(a.Z, { style: S }, x) : null, r.createElement(a.Z, { style: p.content }, R, E), b ? b() : null, (!m && !g) || d || v ? null : Z ? r.createElement(i.default, { style: p.icon }) : r.createElement(n.default, { style: p.icon })), t);
                },
        ...
        403556: (e, t, o) => {
            ...
            class x extends a.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: o, badgePip: r, children: i, color: n, isActive: c, isCompact: d, isPillLink: p, isRoundedRect: u, isWebRedesign: g, retainScrollPosition: x, style: v, to: S } = this.props,
                    ...
                    return a.createElement(b.Z, { "aria-label": t, "aria-selected": E, focusable: !!E, interactiveStyles: W, link: Z, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [p ? k.pill : k.link, p && E ? k.active : null, d ? (p ? k.compactPill : k.compactLink) : null, u ? k.roundedRect : null, v], withoutInteractiveStyles: g || p }, ({ isFocused: t, isHovered: c }) => a.createElement(l.Z, { style: p && k.flexGrow }, a.createElement(h.ZP, { size: g ? "headline2" : void 0, style: [k.text, { color: this._getTextColor(E, c, g, p) }, d && k.compactText, g && t && k.focusedText], weight: P }, e && a.createElement(e, { style: k.icon }), i, g || p ? null : a.createElement(l.Z, { style: E && [k.border, { backgroundColor: s.default.theme.colors[n] }] })), o ? a.createElement(m.Z, { count: o, standalone: !0, style: [k.badge, o >= 10 && k.multiDigitBadge, o >= 20 && k.truncatedCountBadge], truncatedCountFormatter: C, unreadCountLabel: y, withBorder: !1 }) : r ? a.createElement(m.Z, { pip: !0, standalone: !0, style: k.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
            ...
            const k = s.default.create((e) => ({
                ...
                R = ({ alignFirstItem: e, "aria-label": t, isCompact: o, isPillLink: s, isRoundedRect: l, links: c, style: d, visibleItemIndex: p }) => {
                    const u = c
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        g = a.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: i, ...n }, c) => {
                                    ...
                                    return a.createElement(v, (0, r.Z)({ viewType: i }, n, { isCompact: o, isPillLink: s, isRoundedRect: l, isWebRedesign: m, style: d }), t);
                                }),
                            [e, o, s, l, m, c],
                        );
        ...
        165822: (e, t, o) => {
            ...
            const l = s.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                c = ({ "aria-label": e, containerStyle: t, disabled: o, isCompact: c, link: d, lower: p, onClick: u, stackLayoutLowerStyle: h, stackLayoutUpperStyle: m, upper: g, withInsetFocusRing: f = !0, withInteractiveStyling: b = !1 }) => {
                    const y = i.Z.generate({ backgroundColor: s.default.theme.colors.transparent, color: s.default.theme.colors.primary, insetFocusRing: f }),
                        w = r.createElement(r.Fragment, null, r.createElement(a.Z, { style: [l.defaultUpperContainerStyle, m, c && { height: "auto" }] }, g), p ? r.createElement(a.Z, { style: [l.defaultLowerContainerStyle, h] }, p) : null);
                    return r.createElement(n.Z, { "aria-label": e, disabled: o, interactive: b, interactiveStyles: b ? y : void 0, link: d, onClick: u, style: [l.root, t] }, w);
                };
        },
        953035: (e, t, o) => {
            o.d(t, { Z: () => d });
            ...
            const c = s.default.create((e) => {
                ...
                d = ({ containerStyle: e, icon: t = a.default, iconColor: o = "primary", link: d, onClick: p, text: u, isCompact: h, disabled: m, isLoading: g, withInteractiveStyling: f }) => {
                    const b = r.useMemo(() => ({ color: s.default.theme.colors[o] }), [o]);
                    return r.createElement(l.Z, { "aria-label": u, containerStyle: [c.container, e], disabled: m, isCompact: h, link: d, lower: g ? r.createElement(i.Z, { size: "small" }) : r.createElement(n.ZP, { style: b }, u), onClick: p, stackLayoutLowerStyle: [c.lower, h ? c.compact : null], stackLayoutUpperStyle: c.upper, upper: r.createElement(t, { style: [c.icon, b] }), withInteractiveStyling: f });
                };
        },
        183806: (e, t, o) => {
            o.d(t, { Z: () => r });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Payments-e907d115.bb4edd4a.js.map
