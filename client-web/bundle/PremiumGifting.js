    ...
    ["bundle.PremiumGifting"],
    {
        ...
        738235: (e, a, t) => {
            ...
            var V = t(685731),
                ...
                O = t(688715),
                W = t(847579);
            const G = (0, O.ju)("https://legal.x.com/purchaser-terms"),
                $ = (0, O.ju)("https://help.x.com/using-x/x-premium/gifting"),
            ...
            const J = q,
                ...
                de = (e) => {
                    const a = (0, b.useParams)().screenName || "",
                        ...
                        O = I ? (0, w.x)({ amount: (0, V.aU)(I, R), currencyCode: I.currency_code.toUpperCase(), removeTrailingZeros: !0 }) : null,
                        W = m.useCallback(() => {
                        ...
                        Y = m.useMemo(() => {
                            const e = o || P,
                                a = !l || e;
                            return m.createElement(g.Z, { style: [me.footer, q] }, m.createElement(_.ZP, { disabled: a, onPress: j, type: "primaryFilled" }, e ? m.createElement(k.Z, null) : ne({ price: O })), m.createElement(Q, null));
                        }, [O, j, P, o, q, l]),
                        ...
                        le = D.St[l];
                    return J && a && G && O && G?.premium_gifting_eligible ? m.createElement(Z.Z, { backButtonType: "close", bottomBar: Y, history: n, onBackClick: W }, m.createElement(g.Z, { style: [me.root, q] }, m.createElement(g.Z, { style: me.content }, m.createElement(v.ZP, { align: "center", size: "title2", weight: "heavy" }, A ? re({ percentage: 40 }) : te), "User" === G.__typename ? m.createElement(g.Z, { style: me.alignCenter }, m.createElement(z.Z, { size: "custom", style: me.userAvatar, user: G, withLink: !1 }), m.createElement(U.Z, { style: me.alignCenter, user: G, withLink: !1, withStackedLayout: !0 })) : null, m.createElement(B.ZP, { label: ie, onChange: X, options: J, testID: "tier", value: l }), m.createElement(v.ZP, null, m.createElement(F().I18NFormatMessage, { $i18n: "ccd45e5f", tier: le, screenName: a, price: O }))))) : m.createElement(H.Z, { to: "/home" });
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.PremiumGifting.c71aa43a.js.map
