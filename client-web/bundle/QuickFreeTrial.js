    ...
    ["bundle.QuickFreeTrial"],
    {
        ...
        328146: (e, t, a) => {
            ...
            var D,
                ...
                L = {
                    fragment: {
                        argumentDefinitions: [(D = { defaultValue: null, kind: "LocalArgument", name: "end_timestamp_msec" }), (I = { defaultValue: null, kind: "LocalArgument", name: "lookback_days" }), (M = { defaultValue: null, kind: "LocalArgument", name: "start_timestamp_msec" })],
                        kind: "Fragment",
                        metadata: null,
                    ...
                    kind: "Request",
                    operation: { argumentDefinitions: [I, M, D], kind: "Operation", name: "useAdStatsQuery", selections: P },
            ...
            const A = z,
                ...
                ne = ({ adStats: e, trialSubscription: t }) => {
                    ...
                    const d = "Ended" === t.status,
                        ...
                        T = r.useMemo(() => r.createElement(i.Z, { style: de.footer }, r.createElement(i.Z, { style: de.gradient }), d ? r.createElement(i.Z, { style: [de.buttonGroup, de.buttonGroupAnimation] }, r.createElement(f.ZP, { link: b, size: "xLarge", type: "primaryFilled" }, U), r.createElement(f.ZP, { color: "gray700", onClick: w, style: de.noThanksButton }, $)) : r.createElement(i.Z, { style: [de.buttonGroup, de.buttonGroupAnimation] }, r.createElement(f.ZP, { onClick: w, size: "xLarge", type: "primaryFilled" }, j), r.createElement(f.ZP, { link: b, size: "xLarge", type: "primaryOutlined" }, U))), [d, b, w]);
            ...
            const we = b().g2c63852,
                ...
                Pe = (e) => r.createElement(m.nO, { namespace: { component: "not-eligible" } }, r.createElement(Me, e)),
            ...
            const Ne = Re,
                ...
                $e = ({ quickFreeTrialProductType: e, setHideBackButton: t }) => {
                    ...
                    return d ? r.createElement(Fe, null) : s && y?.duration_in_minutes ? r.createElement(Se, { durationInMinutes: y.duration_in_minutes, quickFreeTrialProductType: e }) : g && m?.status ? ("NoAds" === e ? f : void 0) : g || k ? r.createElement(l.Z, null) : r.createElement(Pe, null);
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.QuickFreeTrial.9021720a.js.map
