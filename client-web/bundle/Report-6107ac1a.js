            ...
            const se = (e) => ({ ...re.k(e), ...ae.kX(e), cursor: -1 }),
                ...
                ye = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchOwnershipsGraphQL(n, i) {
                        ...
                        return e.graphQL(M(), { userId: o, isListMemberTargetUserId: s, count: _, cursor: a, ...(0, r.d)(t) }, oe).then(_e.k7);
                    },
                    ...
                    removeFromList(n, _) {
                        const { list_id: a, user_id: o } = n;
                        return e.graphQL(N(), { listId: a, userId: o, ...(0, r.S)(t) }, me).then((e) => (0, i.Fv)(e.list, s.Z));
                    },
                    ...
                    destroySubscribers(n, _) {
                        const { list_id: a } = n;
                        return e.graphQL($(), { listId: a, ...(0, r.S)(t) }, be).then((e) => (0, i.Fv)(e.list, s.Z));
                    },
                    toggleMute(t, n) {
                        const { listId: i, mute: _ } = t;
                        return _ ? e.graphQL(R(), { listId: i }) : e.graphQL(X(), { listId: i });
                    },
                    editList(n, _) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Report-6107ac1a.b2c579ea.js.map
