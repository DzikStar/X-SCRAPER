    ...
    ["bundle.Report"],
    {
        ...
        296196: (e, t, r) => {
            ...
            const k = (e) => e[f.Yf].search?.recentSearches,
                ...
                x =
                    () =>
                    (e, t, { userPersistence: r }) => (e({ type: T }), r.set(C, { recentSearches: [] }));
            s.Z.register(
                { [f.Yf]: R },
                () =>
        ...
        679406: (e, t, r) => {
            ...
            const G = (e, t) => t.location && t.location.state && t.location.state.clientReferer,
                ...
                ee = (e, t) => {
                    ...
                    switch (r) {
                        case T.C2.Tweet:
                        case T.C2.AppealTweetWarning:
                        case T.C2.LimitedDiscoveryAppealTweet:
                        case T.C2.ProfileOnlyDiscoveryAppealTweet:
                        case T.C2.HideCommunityTweet:
                ...
                te = (e, t) => {
                    const r = X(e, t) === T.C2.User ? J(0, t) : void 0;
                    return r ? q.ZP.select(e, r) : void 0;
                },
                re = (e, t) => {
                    let r;
                    const o = X(e, t);
                    if (((o !== T.C2.DMConversation && o !== T.C2.DMMessage) || (r = o === T.C2.DMConversation ? J(0, t) : t.location.state ? t.location.state.conversationId : void 0), r)) {
                        const t = (0, L.x)(e, r),
                            o = ((e) => H.x0(e))(e);
                        return oe(t, o);
                    }
                ...
                se = (e, t) => (X(e, t) === T.C2.Moment ? N.Z.select(e, J(0, t)) : void 0),
                ne = (e, t) => {
                    const r = X(e, t) === T.C2.List ? J(0, t) : void 0;
            ...
            class Ce extends o.Component {
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._getCommunityId = () => {
                            ...
                            if (t === T.C2.RemoveCommunityMember) return e;
                        }),
                        (this._getReportUrl = () => {
                ...
                _wasAccessedDirectly() {
                    ...
                    return !e || !c || (a === T.C2.AppealTweetWarning && !l) || (a === T.C2.LimitedDiscoveryAppealTweet && !l) || (a === T.C2.ProfileOnlyDiscoveryAppealTweet && !l) || (a === T.C2.HideCommunityTweet && !l) || (a === T.C2.RemoveCommunityMember && !t && !i) || (a === T.C2.Tweet && !l) || (a === T.C2.User && !d) || (a === T.C2.DMConversation && !r) || (a === T.C2.DMMessage && (!i || !r)) || (a === T.C2.Moment && !n && !p) || (a === T.C2.List && !o);
                }
                _getScribeNamespace() {
                ...
                _getScribeData() {
                    ...
                    if (t === T.C2.Tweet || t === T.C2.AppealTweetWarning || t === T.C2.LimitedDiscoveryAppealTweet || t === T.C2.ProfileOnlyDiscoveryAppealTweet) this._scribeData = { associations: { [S.Z.AssociationType.ASSOCIATED_TWEET]: { association_id: o && o.id_str, association_namespace: { page: r?.page } } }, promoted: !!e, items: o ? [R.Z.forTweet(o)] : [] };
                    else if (t === T.C2.User) {
                        const e = s ? [R.Z.forUser(s.id_str)] : [];
                        this._scribeData = { associations: { [S.Z.AssociationType.ASSOCIATED_USER]: { association_id: s && s.id_str } }, items: e, targets: e };
                    }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Report.b6778cca.js.map
