            ...
            function ve(e) {
                ...
                const l = (0, m.Z)(),
                    p = () => {
                        ...
                        return n.createElement(o.Z, { testID: ee.loggedOutPrivacySection }, n.createElement(s.Z, { text: se }), n.createElement(S.Z, { description: e ? v() : void 0, label: ce, link: "/settings/account/personalization" }), n.createElement(S.Z, { label: ue, link: "/settings/your_twitter_data" }), t.featureSwitches.isTrue("responsive_web_cookie_compliance_banner_enabled") ? n.createElement(S.Z, { description: he, label: be, link: "/settings/cookie_preferences" }) : null, n.createElement(c.ZP, { style: J.Z.descriptionText }, pe), E(), n.createElement(Pe, null));
                    },
                    { delegateRole: b } = e,
                    A = () => {
                    ...
                    P = () => (t.featureSwitches.isTrue("report_center_mvp_r2_enabled") ? n.createElement(S.Z, { label: _e, link: "/settings/report-center" }) : null),
                    v = () => {
                    ...
                    n.createElement(
                        ...
                        I() || (0, f.D0)(t.featureSwitches) === f.fD.AcceptAllCookies
                            ? n.createElement(h.Z, {
                                  ...
                                  render: t.viewerUserId ? (B ? () => n.createElement(n.Fragment, null, a ? null : n.createElement(o.Z, { role: "tablist" }, "Admin" === b && n.createElement(S.Z, { label: Se, link: "/settings/security_and_account_access", testID: ee.accountAccessLink }))) : () => n.createElement(n.Fragment, null, A(), a ? null : n.createElement(o.Z, { role: "tablist" }, n.createElement(S.Z, { label: me, link: "/settings/account", testID: ee.accountLink }), M(l), n.createElement(S.Z, { label: Ee, link: "/settings/monetization" }), k(), C(), n.createElement(S.Z, { label: Se, link: "/settings/security_and_account_access", testID: ee.accountAccessLink }), n.createElement(S.Z, { label: ne, link: "/settings/privacy_and_safety", testID: ee.privacyAndSafetyLink }), P(), n.createElement(S.Z, { label: de, link: "/settings/notifications", testID: ee.notificationsLink }), n.createElement(S.Z, { label: De, link: "/settings/accessibility_display_and_languages", testID: ee.accessibilityLink }), _(), n.createElement(S.Z, { label: fe, link: "/settings/about", testID: ee.aboutLink }), n.createElement(i.Z, { label: te, link: Me, testID: ee.helpCenterLink }), Z()))) : p,
                              })
                            : p(),
                    ),
                );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Settings-8ed0fac5.c47fa9fa.js.map
