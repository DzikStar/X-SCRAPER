...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsExtendedProfile-6107ac1a", "icons/IconNumberedList-js"],
    {
        491939: (e, n, t) => {
            t.d(n, { Z: () => i });
            var l,
        ...
        751475: (e, n, t) => {
            ...
            const o = r().b15c0a18,
                ...
                d = (e) => {
                    ...
                    const p = l.useCallback((e, n) => !(!f && d(e, n)) || (g({ nextLocation: e, action: n }), !1), [f, d]);
                    l.useEffect(() => {
                        const e = a.block(p);
                        return () => e();
                    }, [p, a]);
                    ...
                    return l.createElement(l.Fragment, null, n, f ? l.createElement(i.Z, { cancelButtonLabel: c, confirmButtonLabel: u, confirmButtonType: "destructiveFilled", headline: o, onCancel: h, onConfirm: b, text: s }) : null);
                };
        },
        135904: (e, n, t) => {
            t.d(n, { c: () => r, n: () => a });
        ...
        779802: (e, n, t) => {
            t.d(n, { $u: () => w, Ak: () => K, KJ: () => v, LI: () => x, P7: () => h, PW: () => D, QF: () => b, Qm: () => y, Tr: () => E, b$: () => p, db: () => B, et: () => S, fR: () => g, iH: () => F, lD: () => k, su: () => _, u4: () => L, wX: () => P });
            var l = t(202784),
                a = t(111677),
                r = t.n(a),
                i = t(394123),
            ...
            const g = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                p = (e) => [
                    { buttonTestId: "btn-bold", Icon: i.default, key: g.bold, onPress: e(g.bold) },
                    { buttonTestId: "btn-italic", Icon: o.default, key: g.italic, onPress: e(g.italic) },
        ...
        491915: (e, n, t) => {
            ...
            function g({ animation: e, autoplay: n }) {
                ...
                return (
                    ...
                    l.createElement(
                        ...
                        l.createElement(u.ZP, { style: p.frames }, `${i}/${e.totalFrames}`),
                        l.createElement(
                            a.Z,
                            { style: p.slider },
                            l.createElement(m.Z, {
            ...
            const p = r.default.create((e) => ({ container: { width: "100%", flexDirection: "row", alignItems: "center" }, frames: { marginStart: e.spaces.space12 }, slider: { flex: 1, marginStart: e.spaces.space12 } }));
            function h(e) {
                ...
                return (
                    ...
                    l.createElement(a.Z, null, l.createElement(a.Z, { style: [e.animationContainerStyle, y.centerAnimation] }, l.createElement("div", { ref: d, style: e.animationStyle }), s && c.current && m && l.createElement(g, { animation: c.current, autoplay: n })))
                );
            }
            h.Prepare = function () {
                return (
            ...
            const b = { load: () => t.e("ondemand.LottieWeb").then(t.t.bind(t, 548888, 23)) };
        ...
        247056: (e, n, t) => {
            ...
            var l = t(202784),
                ...
                o = t(40644);
            const s = r().gaeb997e;
            const c = function ({ activeColor: e, label: n = s, Icon: t = i.default, iconSize: a = "normal", isDisabled: r, onClick: c, preventFocusShift: u, renderActionMenu: d, style: m, testID: f, withDarkBackground: g = !1 }) {
                ...
                return l.createElement(o.ZP, { Icon: t, activeColor: e || (g ? "white" : void 0), "aria-label": n, backgroundColor: g ? "translucentBlack77" : "transparent", color: g ? "white" : "gray700", hoverLabel: h, iconSize: a, isDisabled: r, onPress: p, preventFocusShift: u, renderMenu: d, style: m, testID: f });
            };
        },
        989272: (e, n, t) => {
            ...
            const f = { position: "absolute" },
                ...
                p = (e) => {
                    const { children: n, containerStyle: t, count: s, ...u } = e,
                        [p, h] = l.useState({ animating: !1, count: e.count, pendingCount: null, text: e.children, oldText: null, pendingText: null, transitionDirection: c }),
                        b = l.useRef(!1);
                    return (
                        l.useEffect(
                            () => (
                        ...
                        l.useEffect(() => {
                            if (b.current)
                                ...
                                else if (n !== p.pendingText) {
                                    n === p.text || ((0, r.Z)(e.count) && p.count === e.count) ? h((e) => ({ ...e, pendingCount: null, pendingText: null })) : (h((t) => ({ ...t, pendingCount: e.count, pendingText: n })), p.animating || d(e.count, n, h));
                                }
                        }, [n]),
                        l.useEffect(() => {
                            b.current &&
                                ...
                                (p.oldText
                                    ...
                                    : p.pendingText && d(p.pendingCount, p.pendingText, h));
                        }, [p.animating, p.oldText]),
                        l.useMemo(() => {
                            const e = m[p.transitionDirection],
                                n = p.oldText && !i.Z.reducedMotionEnabled,
                                r = !p.animating && p.oldText && !i.Z.reducedMotionEnabled,
                                s = { ...f, ...(p.animating ? e.post : e.active) },
                                c = { ...(r ? e.pre : e.active) };
                            return l.createElement(
                                a.Z,
                                { style: [g.root, t] },
                                n ? l.createElement("span", { style: s }, l.createElement(o.ZP, u, p.oldText)) : null,
                                l.createElement(
                                    "span",
                                    {
            ...
            const k = g().e8d93005,
                ...
                v = ({ color: e, count: n }) => {
                    ...
                    return l.createElement(h.ZP, null, ({ containerWidth: a }) => {
                        return l.createElement(b.ZP, { color: e, count: n, size: "subtext2", style: [y.count, ((r = a), r < d.default.theme.breakpoints.small && y.narrowCount)] }, n > 0 ? (((e) => e < d.default.theme.breakpoints.xxSmall)(a) || t.length >= 5 ? k(n) : t) : void 0);
                        var r;
                    });
                };
            class _ extends l.PureComponent {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderIcon = () => {
                            const { ActiveIcon: e, iconSize: n, isActive: t, isDisabled: a, isFaded: i, onAnimationEnd: o, onAnimationStart: s, onError: c, showAnimation: f, transitionAnimationUrl: g } = this.props;
                            if (!d.default.theme.highContrastEnabled && !r.Z.reducedMotionEnabled && e && f) return l.createElement(u.ZP, { animation: g || m.Bf, animationContainerStyle: S[n], animationStyle: E, onAnimationEnd: o, onAnimationStart: s, onError: c });
                            {
                ...
                render() {
                    const { "aria-label": e, focusable: n, enableKeyboardShortcuts: t, isActive: i, isDisabled: o, isPresentational: c, keyboardShortcut: m, link: f, preventFocusShift: g, renderMenu: p, renderWrapper: h = l.Fragment, style: b, testID: k } = this.props,
                    ...
                    return l.createElement(
                        ...
                        l.createElement(
                            ...
                            c
                                ...
                                : l.createElement(s.Z, { "aria-haspopup": p ? "menu" : void 0, "aria-label": e, disabled: o, enableKeyboardShortcuts: t, focusable: n, interactiveStyles: null, keyboardShortcut: m, link: f, onClick: this._handlePress, preventFocusShift: g, renderMenu: p, style: [w.triggerAreaRoot, w.outlineNone], testID: k }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsExtendedProfile-6107ac1a.8c32ab7a.js.map
