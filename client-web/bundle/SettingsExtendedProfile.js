    ...
    ["bundle.SettingsExtendedProfile", "icons/IconItalic-js", "icons/IconNumberedList-js"],
    {
        ...
        242470: (e, t, n) => {
            ...
            const y = n(163956).Z,
                ...
                S = c().a9cc8f96,
                v = c().i2209530,
                x = ({ blockId: e, characterCount: t, disabled: n, editorState: r, onSave: s, queryId: c, sectionId: p, sectionType: g, setDirty: h, setError: b, setSaving: y, userId: x }) => {
                    const E = (0, d.hC)("xprofile_work_history_enabled"),
                        w = (0, f.Z)(),
                        [D] = k(),
                        [C] = _(),
                        I = l.useCallback(() => {
                            ...
                            w.scribe({ ...(0, u.MA)(t, "error", { version: E ? 2 : 1 }) });
                        }, [w, e, E, y]),
                        T = l.useCallback(() => {
                            h(!1), y(!1);
                            const t = e ? "update_block_btn" : "save_block_btn";
                            w.scribe({ ...(0, u.MA)(t, "success", { version: E ? 2 : 1 }) }), s();
                        }, [w, e, E, s, h, y]),
                        $ = l.useCallback(() => {
                            const n = ((e) => {
                                if (!e) return;
                            ...
                            w.scribe({ ...(0, u.MA)(l, "click", {}) }),
                                e && x
                                    ...
                                    : x &&
                                      D(
                                          {
                                              variables: { richtextValue: n, userId: x, sectionId: p, sectionType: g },
                                              onCompleted: T,
                                              updater: (e, t) => {
                        ...
                        }, [r, t, y, e, w, b, C, x, T, I, c, E, D, p, g]);
                    return l.createElement(i.ZP, { disabled: n, onClick: $, size: "large", type: "brandFilled" }, v);
                };
        },
        371879: (e, t, n) => {
        ...
        992915: (e, t, n) => {
            ...
            const Z = I,
                ...
                j = o.createElement(B.default, { style: U.icon }),
                Q = ({ queryId: e }) => {
            ...
            const ve = p().b956c04a,
                xe = p().ifb23caa,
                Ee = p().c2333081,
                we = m.default.create((e) => ({ root: { paddingHorizontal: e.spaces.space16 }, flexRow: { flexDirection: "row", gap: e.spaces.space8, alignItems: "center" }, stickyButton: { position: "sticky", start: 0, end: 0, padding: e.spaces.space16 }, desktopButton: { bottom: 0 }, mobileButton: { bottom: e.componentDimensions.appBarHeight }, v2Button: { padding: e.spaces.space16, justifyContent: "space-between", bottom: 0 }, error: { padding: e.spaces.space16 }, textCountLabel: { flexDirection: "row", alignSelf: "center" } })),
                De = (0, _e.Z)(({ analytics: e, blockId: t, blocksQueryId: n, closeConfirm: l, initialState: a = "", onSave: r, refetch: s, showConfirmDelete: c, userId: d }) => {
                    ...
                    const E = o.useCallback(() => {
                        ...
                        w = (0, fe.c6)(g);
                    let D = w;
                    w > 1 && (D = te.ZP.getFormattedCount(w));
                ...
                Te = ({ hasConsented: e, history: t, profileBlocksRef: n, queryId: l, refetch: a, viewerUser: r }) => {
                    const s = (0, v.p)(),
                        [m, f] = o.useState(!1),
                        p = c()(E.m1, n),
                        S = p?.items?.find((e) => e?.block_type === x.Mp.RICHTEXT),
                        w = S?.data?.value,
                        D = S?.block_id,
                        C = o.useCallback(() => {
                            f(!1);
                ...
                Fe = (e) => {
                    const { data: t, refetch: n } = (0, w.A)(E.vF, {}),
        ...
        779802: (e, t, n) => {
            n.d(t, { $u: () => E, Ak: () => T, KJ: () => _, LI: () => w, P7: () => h, PW: () => x, QF: () => b, Qm: () => y, Tr: () => D, b$: () => g, db: () => F, et: () => v, fR: () => p, iH: () => C, lD: () => k, su: () => S, u4: () => $, wX: () => I });
            var l = n(202784),
                a = n(111677),
                r = n.n(a),
                o = n(394123),
            ...
            const p = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                x = r().b92b6156,
                E = r().ec5ed598,
                w = ({ children: e, extendedWidth: t, size: n, weight: a }) => l.createElement(f.ZP, { extendedWidth: t, size: n, weight: a }, e),
                D = { blockType: h.paragraph, label: E, component: w({ size: "body", children: E }) },
                C = [{ blockType: h.header1, label: v, component: w({ size: "title1", extendedWidth: !0, children: v }) }, { blockType: h.header2, label: x, component: w({ size: "title3", weight: "heavy", children: x }) }, D],
