...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsProfessionalProfileMobileAppSpotlight", "icons/IconChevronRight-js"],
    {
        202407: (e, t, n) => {
            ...
            function E(e) {
                ...
                return o.createElement(
                    ...
                    o.createElement(
                        ...
                        o.createElement(g.ZP, { align: "center", color: "red500", style: k.removeApp }, C),
                    ),
                );
            }
            const k = c.default.create((e) => ({ container: { paddingBottom: e.spaces.space64 }, removeApp: { padding: e.spaces.space16, paddingTop: e.spaces.space40 }, text: { paddingStart: e.spaces.space16, paddingEnd: e.spaces.space16 } })),
                ...
                P = [
                    { key: w.IOS, label: u().aab2fae0, placeholder: u().af40a8e0, component: E, constants: { title: u().d3cd1160, helpLink: "", inputLabel: u().f2124008 } },
                    { key: w.ANDROID, label: u().f7d1a8e0, placeholder: u().af40a8e0, component: E, constants: { title: u().dc0d9d6a, helpLink: "", inputLabel: u().dd1605f0 } },
                ],
                ...
                return o.createElement(
                    m.Z,
                    {
                        ...
                        rightControl: (function () {
                            ...
                            return o.createElement(i.ZP, { disabled: e, onPress: h }, S);
                        })(),
                        title: Z,
                    },
                    o.createElement(
                        ...
                        P.map((e) => {
                            return o.createElement(s.Z, {
                                ...
                                thumbnail: o.createElement(p.default, { style: I.addIcon }),
        ...
        779610: (e, t, n) => {
            ...
            var a = n(202784),
                ...
                c = n(392237);
            const d = (e) => {
                    const { decoration: t, description: n, disabled: d = !1, isActive: p = !1, label: m, link: b, onPress: h, paddingHorizontal: g, renderRightContent: f, role: y = "tab", styleOverride: v, testID: C = "pivot", thumbnail: E, thumbnailSize: k, withoutArrow: Z = !1 } = e,
                        S = [u.thumbnailContainer, "medium" === k && u.thumbnailContainerMedium],
                        w = "string" == typeof m ? a.createElement(i.ZP, null, m) : m,
                        P = "object" == typeof b && b.external && !b.openInSameFrame,
                        L = n ? ("string" == typeof n ? a.createElement(i.ZP, { color: "gray700", size: "subtext2", testID: `${C}-description` }, n) : n) : null,
                        A = a.useMemo(() => ("space0" === g ? { paddingHorizontal: 0 } : { paddingHorizontal: g ? c.default.theme.spaces[g] : c.default.theme.componentDimensions.gutterHorizontal }), [g]);
                    return a.createElement(s.Z, { "aria-selected": "tab" === y ? p : null, disabled: d, link: d ? void 0 : b, onPress: h, role: y, style: [u.root, A, d && u.disabled, v], testID: C, withInteractiveStyling: !!b || !!h }, a.createElement(o.Z, { style: u.contentContainer }, E ? a.createElement(o.Z, { style: S }, E) : null, a.createElement(o.Z, { style: u.content }, w, L), f ? f() : null, (!b && !h) || d || Z ? null : P ? a.createElement(r.default, { style: u.icon }) : a.createElement(l.default, { style: u.icon })), t);
                },
        ...
        58399: (e, t, n) => {
            ...
            const s = (e = {}) => {
                const t = a.useContext(l.Z),
                    { direction: n } = (0, r.Z)();
                return (0, o.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [i.Z.root, e.style, t && i.Z.iconRTL], viewBox: "0 0 24 24", children: a.createElement("g", null, a.createElement("path", { d: "M14.586 12L7.543 4.96l1.414-1.42L17.414 12l-8.457 8.46-1.414-1.42L14.586 12z" })) }, { writingDirection: n });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsProfessionalProfileMobileAppSpotlight.8d1ac1ea.js.map
