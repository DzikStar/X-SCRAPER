...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsProfessionalProfileProfileSpotlight-668fc9f5"],
    {
        941978: (e, t, n) => {
            n.d(t, { C: () => r });
            class r {
        ...
        491915: (e, t, n) => {
            ...
            function g(e) {
                ...
                return (
                    ...
                    r.createElement(o.Z, null, r.createElement(o.Z, { style: [e.animationContainerStyle, y.centerAnimation] }, r.createElement("div", { ref: d, style: e.animationStyle }), c && s.current && m && r.createElement(p, { animation: s.current, autoplay: t })))
                );
            }
            g.Prepare = function () {
                return (
        ...
        247056: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                l = n(40644);
            const c = a().gaeb997e;
            const s = function ({ activeColor: e, label: t = c, Icon: n = i.default, iconSize: o = "normal", isDisabled: a, onClick: s, preventFocusShift: u, renderActionMenu: d, style: m, testID: h, withDarkBackground: p = !1 }) {
                ...
                return r.createElement(l.ZP, { Icon: n, activeColor: e || (p ? "white" : void 0), "aria-label": t, backgroundColor: p ? "translucentBlack77" : "transparent", color: p ? "white" : "gray700", hoverLabel: g, iconSize: o, isDisabled: a, onPress: f, preventFocusShift: u, renderMenu: d, style: m, testID: h });
            };
        },
        280278: (e, t, n) => {
            n.d(t, { ZP: () => f });
        ...
        40644: (e, t, n) => {
            ...
            class C extends r.PureComponent {
                    ...
                    super(...e),
                        ...
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: s, showBackgroundWhenActive: u } = this.props,
                                m = l.Z.generate({ backgroundColor: d.default.theme.colors[n], color: d.default.theme.colors[t], insetFocusRing: !0 }),
                                h = u && i && !e?.isHovered;
                            return r.createElement(c.Z, { hoverLabel: o, interactiveStyles: m, interactivityState: e, style: [d.default.absoluteFill, x[h ? "haloBackground" : n], !s && P.iconBackground, "small" === a && P.iconSmallBoundingBox, h && P.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!d.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && h) return r.createElement(u.ZP, { animation: p || m.Bf, animationContainerStyle: w[t], animationStyle: S, onAnimationEnd: l, onAnimationStart: c, onError: s });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return r.createElement(a, { style: [w[t], !o && i && P.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                ...
                render() {
                    const { "aria-label": e, focusable: t, enableKeyboardShortcuts: n, isActive: i, isDisabled: l, isPresentational: s, keyboardShortcut: m, link: h, preventFocusShift: p, renderMenu: f, renderWrapper: g = r.Fragment, style: b, testID: E } = this.props,
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            s
                                ...
                                : r.createElement(c.Z, { "aria-haspopup": f ? "menu" : void 0, "aria-label": e, disabled: l, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: m, link: h, onClick: this._handlePress, preventFocusShift: p, renderMenu: f, style: [P.triggerAreaRoot, P.outlineNone], testID: E }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsProfessionalProfileProfileSpotlight-668fc9f5.a23d4bea.js.map
