...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsProfessionalProfileProfileSpotlight-bc6ccf4c"],
    {
        941978: (e, t, n) => {
            n.d(t, { C: () => r });
            class r {
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return r.createElement(s.ZP.Consumer, null, ({ direction: c }) => r.createElement(i.ZP, { color: e ? n : a, dir: c, style: [P.inner, e && "blue500" === n && P.blue500] }, r.createElement(o.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), l, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: s, showBackgroundWhenActive: u } = this.props,
                                ...
                                m = u && i && !e?.isHovered;
                            return r.createElement(c.Z, { hoverLabel: o, interactiveStyles: h, interactivityState: e, style: [d.default.absoluteFill, x[m ? "haloBackground" : n], !s && P.iconBackground, "small" === a && P.iconSmallBoundingBox, m && P.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!d.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && m) return r.createElement(u.ZP, { animation: p || h.Bf, animationContainerStyle: C[t], animationStyle: k, onAnimationEnd: l, onAnimationStart: c, onError: s });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return r.createElement(a, { style: [C[t], !o && i && P.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            s
                                ...
                                : r.createElement(c.Z, { "aria-haspopup": f ? "menu" : void 0, "aria-label": e, disabled: l, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: h, link: m, onClick: this._handlePress, preventFocusShift: p, renderMenu: f, style: [P.triggerAreaRoot, P.outlineNone], testID: E }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsProfessionalProfileProfileSpotlight-bc6ccf4c.2bd49aaa.js.map
