...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsProfessionalProfileProfileSpotlight-bc6ccf4c", "icons/IconSparkle-js"],
    {
        941978: (e, t, n) => {
            n.d(t, { C: () => r });
            class r {
        ...
        491915: (e, t, n) => {
            ...
            function g(e) {
                ...
                return (
                    ...
                    r.createElement(o.Z, null, r.createElement(o.Z, { style: [e.animationContainerStyle, y.centerAnimation] }, r.createElement("div", { ref: d, style: e.animationStyle }), c && s.current && h && r.createElement(p, { animation: s.current, autoplay: t })))
                );
            }
            g.Prepare = function () {
                return (
        ...
        247056: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                l = n(40644);
            const c = a().gaeb997e;
            const s = function ({ activeColor: e, label: t = c, Icon: n = i.default, iconSize: o = "normal", isDisabled: a, onClick: s, preventFocusShift: u, renderActionMenu: d, style: h, testID: m, withDarkBackground: p = !1 }) {
                ...
                return r.createElement(l.ZP, { Icon: n, activeColor: e || (p ? "white" : void 0), "aria-label": t, backgroundColor: p ? "translucentBlack77" : "transparent", color: p ? "white" : "gray700", hoverLabel: g, iconSize: o, isDisabled: a, onPress: f, preventFocusShift: u, renderMenu: d, style: h, testID: m });
            };
        },
        280278: (e, t, n) => {
            n.d(t, { ZP: () => f });
            ...
            [s, u].forEach((e) => {
                const t = "0.3s";
                h[e] = { active: { transitionProperty: "transform", transitionDuration: t, transform: "translate3d(0, 0, 0)" }, pre: { transform: `translate3d(0, ${e === s ? "100%" : "-100%"}, 0)` }, post: { transform: `translate3d(0, ${e === s ? "-100%" : "100%"}, 0)`, transitionProperty: "transform", transitionDuration: t } };
            });
                    ...
                    return (
                        ...
                        r.useMemo(() => {
                            const e = h[f.transitionDirection],
                                ...
                                c = { ...m, ...(f.animating ? e.post : e.active) },
                                s = { ...(a ? e.pre : e.active) };
                            return r.createElement(
                                o.Z,
                                { style: [p.root, n] },
                                t ? r.createElement("span", { style: c }, r.createElement(l.ZP, u, f.oldText)) : null,
                                r.createElement(
                                    "span",
                                    {
        ...
        98538: (e, t, n) => {
            ...
            class d extends r.Component {
                ...
                render() {
                    ...
                    return r.createElement(a.ZP, { color: n ? "white" : "text", hoverLabel: this._getHoverLabel(), link: t, onClick: o }, r.createElement(u.Provider, { value: { onMedia: n } }, e));
                }
            }
            (d.Group = (e) =>
                r.createElement(
                ...
                (d.Label = ({ children: e, style: t }) => r.createElement(u.Consumer, null, ({ onMedia: n }) => r.createElement(a.ZP, { children: e, color: n ? "white" : "gray700", size: s, style: t }))),
                (d.Value = ({ animated: e, children: t, count: n, style: o, weight: i = "bold" }) => r.createElement(u.Consumer, null, ({ onMedia: c }) => (e ? r.createElement(l.ZP, { children: t, count: n, size: s, style: o, weight: i }) : r.createElement(a.ZP, { children: t, color: c ? "white" : "text", size: s, style: o, weight: i }))));
        ...
        40644: (e, t, n) => {
            ...
            class C extends r.PureComponent {
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return r.createElement(s.ZP.Consumer, null, ({ direction: c }) => r.createElement(i.ZP, { color: e ? n : a, dir: c, style: [k.inner, e && "blue500" === n && k.blue500] }, r.createElement(o.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), l, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: s, showBackgroundWhenActive: u } = this.props,
                                h = l.Z.generate({ backgroundColor: d.default.theme.colors[n], color: d.default.theme.colors[t], insetFocusRing: !0 }),
                                m = u && i && !e?.isHovered;
                            return r.createElement(c.Z, { hoverLabel: o, interactiveStyles: h, interactivityState: e, style: [d.default.absoluteFill, x[m ? "haloBackground" : n], !s && k.iconBackground, "small" === a && k.iconSmallBoundingBox, m && k.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            const { ActiveIcon: e, iconSize: t, isActive: n, isDisabled: o, isFaded: i, onAnimationEnd: l, onAnimationStart: c, onError: s, showAnimation: m, transitionAnimationUrl: p } = this.props;
                            if (!d.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && m) return r.createElement(u.ZP, { animation: p || h.Bf, animationContainerStyle: w[t], animationStyle: Z, onAnimationEnd: l, onAnimationStart: c, onError: s });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return r.createElement(a, { style: [w[t], !o && i && k.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                ...
                render() {
                    const { "aria-label": e, focusable: t, enableKeyboardShortcuts: n, isActive: i, isDisabled: l, isPresentational: s, keyboardShortcut: h, link: m, preventFocusShift: p, renderMenu: f, renderWrapper: g = r.Fragment, style: b, testID: E } = this.props,
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            s
                                ...
                                : r.createElement(c.Z, { "aria-haspopup": f ? "menu" : void 0, "aria-label": e, disabled: l, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: h, link: m, onClick: this._handlePress, preventFocusShift: p, renderMenu: f, style: [k.triggerAreaRoot, k.outlineNone], testID: E }, (e) => {
            ...
            const w = d.default.create((e) => ({ small: { height: "1em", width: "1em" }, normal: { height: "1.25em", width: "1.25em" }, large: { height: "1.5em", width: "1.5em" } })),
                ...
                k = d.default.create((e) => ({ root: { flexDirection: "row", justifyContent: "flex-start" }, triggerAreaRoot: { justifyContent: "center", minHeight: e.lineHeights.body, overflow: "visible", userSelect: "none" }, inner: { alignItems: "center", display: "flex", justifyContent: "flex-start", transitionProperty: "color", transitionDuration: "0.2s", whiteSpace: "nowrap" }, iconFaded: { opacity: 0.4 }, iconBackground: { borderRadius: e.borderRadii.infinite, margin: -8 }, iconSmallBoundingBox: { margin: -6 }, outlineNone: { outlineStyle: "none" }, blue500: { color: e.colors.blue500 }, white: { color: e.colors.white }, haloBoundingBox: { margin: -6 } })),
                P = "224.5%",
                Z = { width: P, height: P };
        },
        551611: (e, t, n) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsProfessionalProfileProfileSpotlight-bc6ccf4c.32c154ea.js.map
