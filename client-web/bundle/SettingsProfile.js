...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsProfile", "icons/IconChevronRight-js"],
    {
        160664: (e, t, i) => {
            i.d(t, { Z: () => p });
            var a = i(202784),
        ...
        947947: (e, t, i) => {
            i.r(t), i.d(t, { DEFAULT_BIRTHDAY: () => We, ProfileScreen: () => Ke, default: () => je, stylizedCharHelperText: () => ze });
            i(136728);
            var a,
                n,
                r = i(202784),
            ...
            k.hash = "451e17c2bc1e752adf2af7cb2591f649";
            const N = k;
            i(585488);
            var F = i(712696),
                I = i.n(F),
            ...
            const q = (e, t) => {
                ...
                J = (0, K.Z)()
                    .propsFromState(() => ({ viewerUser: Y.ZP.selectViewerUser, avatarMedia: q, bannerMedia: Q, persistedProfileSettings: j.u$ }))
                    .propsFromActions(() => ({ addAvatarMedia: j._D, addBannerMedia: j.NJ, enableVerifiedPhoneLabel: j.OG, disableVerifiedPhoneLabel: j.GJ, fetchUserProfilePhoneState: j.Il, addToast: $.fz, createLocalApiErrorHandler: (0, z.zr)("SETTINGS_PROFILE_SCREEN"), persistProfileSettings: j.g3, removeAvatarMedia: j.Xw, removeBannerMedia: j.HR, removeMediaUpload: G.WU, resetPersistedProfileSettings: j.Ys, removeProfileBanner: j.o8, updateProfile: j.ck, updateProfileAvatar: j.b4, updateProfileBanner: j.T_ }))
            ...
            const ae = S().bfe8d1a2,
                ...
                re = ({ analytics: e, hasProfileBlocks: t }) => {
                    ...
                    return r.createElement(b.Z, { label: a, link: "/settings/bio", onPress: i, testID: ie.Z.editExtendedProfile });
                },
                se = (e) => {
            ...
            const ve = function (e) {
                ...
                return r.createElement(ge.Z, { checked: i, helpText: Se, label: Ce, learnMoreLink: (0, be.ju)("https://help.x.com/rules-and-policies/twitter-india"), name: "verified_phone_status_toggle", onChange: t, testID: "Verified_Phone_Status", type: "switch" });
            };
            var Be = i(161821);
            const Pe = Object.freeze({ SUPERSCRIPT_AND_SUBSCRIPT: "superscript_and_subscript", CURRENCY: "currency", LETTER_LIKE: "letter_like", NUMBER_FORMS: "number_forms", ARROWS: "arrows", MATHEMATICAL: "mathematical", GENERAL_PUNCTUATION: "general_punctuation", ENCLOSED_ALPHANUMERICS: "enclosed_alphanumerics", BOX: "box", GEOMETRIC: "geometric", SPACING_MODIFIER: "spacing_modifier", PUNCTUATION: "punctuation", MISC: "miscellaneous" }),
                Ee = (0, Be.Z)(Pe),
                ye = { [Pe.SUPERSCRIPT_AND_SUBSCRIPT]: { base: "[⁰-ⁱ]|[⁴-₎]|[ₐ-ₜ]", specialChars: {} }, [Pe.CURRENCY]: { base: "[₠-₿]", specialChars: { $: "[$]" } }, [Pe.LETTER_LIKE]: { base: "[℀-⅏]", specialChars: {} }, [Pe.NUMBER_FORMS]: { base: "[⅐-↋]", specialChars: {} }, [Pe.ARROWS]: { base: "[←-⇿]", specialChars: {} }, [Pe.MATHEMATICAL]: { base: "[∀-⋿]|[⊓-⊕]|[⨀-⫿]|[⟀-⟯]|[⦀-⧿]", specialChars: {} }, [Pe.GENERAL_PUNCTUATION]: { base: "[ -⁯]|[⸀-⹿]", specialChars: {} }, [Pe.ENCLOSED_ALPHANUMERICS]: { base: "[①-⓿]", specialChars: {} }, [Pe.BOX]: { base: "[─-╿]|[▀-▟]", specialChars: {} }, [Pe.GEOMETRIC]: { base: "[■-▩]|[▬-▵]|[▷-▿]|[◁-◺]|[◿]", specialChars: {} }, [Pe.SPACING_MODIFIER]: { base: "[ʰ-˿]", specialChars: {} }, [Pe.PUNCTUATION]: { base: "[ -⁯]", specialChars: {} }, [Pe.MISC]: { base: "[⌀-⌙]|[⌜-⌧]|[〈-⏎]|[⏐-⏨]|[⏴-⏷]|[⏻-⏿]|[★-☐]|[☒-☓]|[☖-☗]|[☙-☜]|[☞-☟]|[☡]|[☤-☥]|[☧-☩]|[☫-☭]|[☰-☷]|[☻-☿]|[♁]|[♃-♇]|[♔-♞]|[♡-♢]|[♤]|[♧]|[♩-♺]|[♼-♽]|[⚀-⚑]|[⚘]|[⚚]|[⚝-⚟]|[⚢-⚦]|[⚨-⚩]|[⚬-⚯]|[⚲-⚼]|[⚿-⛃]|[⛆-⛇]|[⛉-⛍]|[⛐]|[⛒]|[⛕-⛨]|[⛫-⛯]|[⛶]|[⛻-⛼]|[⛾-⛿]", specialChars: {} } },
                we = ({ text: e, keys: t = Ee, includeSpecialChars: i = !0 }) => {
                    const a = t
                        .map((e) =>
                            ((e, t = !0) => {
                                const i = ye[e];
                ...
                We = { visibility: x.m.MUTUAL_FOLLOW, year_visibility: x.m.SELF },
            ...
            class Ke extends r.Component {
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._shouldShowDiscardConfirmation = () => {
                            ...
                            return !(0, v.Z)(e, this._initialProfileSettings);
                        }),
                        ...
                        (this._handleMediaUpdateFailureFactory = (e, t) => (i) => {
                            ...
                            if (s) {
                                const e = (0, A.ZP)(s, t);
                                e && a(e);
                            } else i instanceof P.Z && i.errors && "Denied by user validation." === i.errors[0]?.message && "ACTION_UPDATE_USER_AVATAR" === i.context?.action && this._isBlueVerifiedEditProfileErrorMessageEnabled ? a({ text: Ue }) : n({ showToast: !0 })(i);
                            r(e.id);
                        }),
                    ...
                    const { avatarMedia: t, bannerMedia: i, history: a } = this.props,
                        {
                            ...
                            errors: f,
                            profileSettings: { description: m, location: g, name: b, shouldDeleteBanner: C, url: S },
                            showAvatarCropper: v,
                            showBadgeRemovalWarning: B,
                            showBannerCropper: P,
                            showDiscardConfirmation: w,
                        } = this.state,
                        M = r.createElement(o.default, { size: "custom", uri: e.profile_image_url_https }),
                        R = i || (e.profile_banner_url && !C),
                        x = r.createElement(l.Z, { ratio: d.default.theme.aspectRatios.profileBanner }, R ? r.createElement(h.Z, { source: { uri: e.profile_banner_url }, style: Ge.banner }) : null),
                        A = void 0 !== b && (0, c.Z)(b),
                        U = !!((t && !t.uploader) || (i && !i.uploader)) || !!Object.keys(f).length || A,
                        Z = r.createElement(_.ZP, { disabled: U, onPress: this._handleSubmit, size: "small", testID: ie.Z.save, type: "primaryFilled" }, De);
                    return r.createElement(
                        E.Z,
                        { history: a, onBackClick: this._handleCancel, rightControl: Z, title: Me },
                        r.createElement(s.Z, { style: Ge.container }, r.createElement(L.default, { "aria-label": Fe, aspectRatio: 3, currentContent: x, location: D.vC.ProfileBanner, mediaItem: i, onChange: this._handleBannerMediaChange, onFailure: this._handleBannerMediaFailure, onRemove: R ? this._handleBannerMediaRemove : void 0, rootStyle: Ge.bannerContainer }), r.createElement(L.default, { "aria-label": Ne, borderRadius: y.A.INFINITE, currentContent: M, location: D.vC.Avatar, mediaItem: t, onChange: this._handleAvatarMediaChange, onFailure: this._handleAvatarMediaFailure, rootStyle: Ge.avatarContainer }), r.createElement(p.Z, { autoComplete: "off", defaultValue: b, errorText: Ae, helperText: this._renderInputHelperText(), invalid: A, label: Te, maxLength: n, name: "displayName", onChange: this._handleChangeDisplayName }), r.createElement(W, { onCancel: this._handleCancelBadgeRemovalWarning, onConfirm: this._handleBlueVerifiedSaveConfirmation, showBadgeRemovalWarning: B }), r.createElement(p.Z, { defaultValue: m, label: Re, maxLength: 160, multiline: !0, name: "description", numberOfLines: 3, onChange: this._handleChangeDescription }), r.createElement(p.Z, { defaultValue: g, label: xe, maxLength: 30, name: "location", onChange: this._handleChangeLocation }), r.createElement(p.Z, { defaultValue: S || "", label: Le, maxLength: 100, name: "url", onChange: this._handleChangeURL }), this._renderProfileBirthdate(), this._renderBirthdateConfirmationModal(), this._isExtendedProfileEnabled ? this._renderEditExtendedProfilesButton() : null, this._renderProfessionalProfilesButton(), this._isVerifiedPhoneLabelEnabled && this.state.profileSettings.user_phone_state?.has_verified_phone ? this._renderEditPhoneStatus() : null),
                        v ? r.createElement(T.Z, { circle: !0, defaultAspectRatio: 1, media: t, onCancel: this._handleAvatarCropCancel, onDone: this._handleAvatarCropDone }) : null,
                        P ? r.createElement(T.Z, { defaultAspectRatio: 3, media: i, onCancel: this._handleBannerCropCancel, onDone: this._handleBannerCropDone }) : null,
                        w ? r.createElement(u.Z, { confirmButtonLabel: Ve.confirmLabel, confirmButtonType: "destructiveFilled", headline: Ve.headline, onCancel: this._handleCancelDiscardSettings, onConfirm: this._handleConfirmDiscardSettings, text: Ve.text }) : null,
                ...
                _getBirthdateConfirmationModalText() {
                    ...
                    return r.createElement(S().I18NFormatMessage, { $i18n: "e9dec56f" }, r.createElement(w.Z, { birthdate: { day: e, month: t, year: i } }));
                }
                _renderEditPhoneStatus() {
                    return r.createElement(ve, { onChange: this._handlePhoneStatusChange, verifiedPhoneStatus: Boolean(this.state.profileSettings.user_phone_state?.label_display_opt_in) });
                }
                ...
                _renderSwitchToProfessionalButton() {
                    ...
                    return r.createElement(b.Z, { label: e, link: { pathname: "/i/flow/convert_to_professional", state: { input: { requested_variant: t } }, method: "push" }, onPress: this._handleProfessionalConversionClick, testID: ie.Z.switchToProfessional });
                }
                _renderEditProfessionalProfileButton() {
                    const e = r.createElement(g.ZP, { size: "headline1" }, Oe.editProfessionalProfileLabel);
                    return r.createElement(b.Z, { label: e, link: "/settings/professional_profile", onPress: this._handleProfessionalSettingsClick, testID: ie.Z.editProfessionalProfile });
                }
                ...
                _saveChanges() {
                    ...
                    if (t) {
                        ...
                        d(i).then(
                            ...
                            this._handleMediaUpdateFailureFactory(t, Ze),
                        );
                    }
                    i
                        ? h(i.id).then(
                              ...
                              this._handleMediaUpdateFailureFactory(i, ke),
                          )
                    ...
                    l(this._getFormattedState())
                        .then(() => {
                            this._scribeEditedFields(), Z.Z.refreshHTMLCache(), this._handleDismiss();
                        })
                        .catch(a({ showToast: !0 }));
                }
                _getFormattedState() {
        ...
        58399: (e, t, i) => {
            ...
            const l = (e = {}) => {
                const t = a.useContext(s.Z),
                    { direction: i } = (0, r.Z)();
                return (0, n.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [o.Z.root, e.style, t && o.Z.iconRTL], viewBox: "0 0 24 24", children: a.createElement("g", null, a.createElement("path", { d: "M14.586 12L7.543 4.96l1.414-1.42L17.414 12l-8.457 8.46-1.414-1.42L14.586 12z" })) }, { writingDirection: i });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsProfile.b399abda.js.map
