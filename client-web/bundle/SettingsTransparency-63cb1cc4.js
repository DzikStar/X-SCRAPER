...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.SettingsTransparency-63cb1cc4"],
    {
        673110: (e, t, n) => {
            n.d(t, { Gv: () => m, UD: () => p });
            var r = n(226395),
        ...
        159127: (e, t, n) => {
            n.r(t), n.d(t, { AccountActivityScreen: () => u, default: () => _ });
            var r = n(202784),
                a = n(779610),
                s = n(111677),
                o = n.n(s),
            ...
            const d = o().j9d10268,
                ...
                u = ({ location: e }) => r.createElement(i.nO, { namespace: m }, r.createElement(c.Z, null, r.createElement(l.Z, { location: e, title: d }, r.createElement(a.Z, { label: h, link: "/settings/blocked/all" }), r.createElement(a.Z, { label: p, link: "/settings/muted/all" })))),
                _ = u;
        },
        690423: (e, t, n) => {
            ...
            class y extends r.Component {
                ...
                render() {
                    ...
                    return r.createElement(i.Z, null, r.createElement(l.Z, { location: e, title: _ }, r.createElement(a.Z, { description: s > 0 ? g({ count: s }) : null, label: f, link: "/settings/your_twitter_data/login_history" }), r.createElement(a.Z, { description: n > 0 ? Z({ count: n }) : null, label: E, link: "/settings/your_twitter_data/locations" })));
                }
            }
            y.contextType = c.rC;
            const b = u(y);
                ...
                constructor(...e) {
                    super(...e),
                        (this.render = () => {
                            ...
                            return r.createElement(i.Z, null, r.createElement(l.Z, { location: e, title: u }, r.createElement(a.Z, { description: t.tailored_audience_summary ? Z({ count: t.num_twitter_interests }) : null, label: f, link: "/settings/your_twitter_data/twitter_interests" }), r.createElement(a.Z, { description: t.tailored_audience_summary ? Z({ count: t.num_partner_interests }) : null, label: _, link: "/settings/your_twitter_data/partner_interests" }), r.createElement(a.Z, { description: t.tailored_audience_summary ? E({ audienceCount: s, advertiserCount: n }) : null, label: g, link: "/settings/your_twitter_data/audiences" })));
                        }),
                        (this._handleFetchData = () => {
                            const { createLocalApiErrorHandler: e } = this.props;
                            this.props.fetchData().catch(e());
            ...
            class x extends r.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._render = () => r.createElement("div", null, this._renderAges(), this.isLoggedIn ? r.createElement(a.Z, { style: f.Z.infoItem }, r.createElement(s.ZP, { color: "gray700" }, D)) : this._renderUseAge())),
                        (this._renderAges = () => {
                            ...
                            return t ? r.createElement(a.Z, { style: [f.Z.infoItem, f.Z.bottomBorder] }, r.createElement(s.ZP, null, t)) : this._renderMessage(I, C);
                        }),
                        (this._renderMessage = (e, t) => r.createElement(a.Z, { style: [_.Z.calloutTextBlock, _.Z.bottomBorder] }, r.createElement(s.ZP, { align: "center", size: "headline1" }, e), t ? r.createElement(s.ZP, { align: "center", color: "gray700", style: f.Z.helpText }, t) : null)),
                        (this._renderUseAge = () => {
                            const { personalizationPreferences: e } = this.props,
                                t = e && e.age_preferences && e.age_preferences.use_age_for_personalization;
                            return r.createElement(c.Z, { checked: !t, key: "use_age_for_personalization", label: T, name: "use_age_for_personalization", onChange: this._handleBooleanChanged });
                        }),
                ...
                render() {
                    ...
                    return r.createElement(h.Z, null, r.createElement(u.Z, { location: t, title: w }, r.createElement(p.Z, null, r.createElement(a.Z, { style: [f.Z.infoItem, f.Z.bottomBorder] }, r.createElement(s.ZP, { color: "gray700" }, this.isLoggedIn ? A : P)), r.createElement(m.Z, { fetch: this._combinedFetches, fetchStatus: e, render: () => this._render() }))));
                }
            }
            x.contextType = d.rC;
            const v = S(x);
        ...
        546927: (e, t, n) => {
            ...
            const S = (e, t) => (0, b.h1)(y.qu(e), y.I3(e)),
                ...
                H = d().a90be7b4,
                G = d().ba2e82a1,
                M = (0, s.ju)("https://support.x.com/articles/20175257"),
                U = [],
                O = (e) => {
                        ...
                        q = (e, t, n = !1) =>
                            e.length
                                ? r.createElement(
                                      a.Z,
                                      null,
                                      r.createElement(a.Z, null, r.createElement(c.Z, { text: t })),
                                      e.map((t, s) => {
                                          const c = e && e.length - 1 === s;
                                          return r.createElement(a.Z, { key: `device-'${s}`, style: [g.Z.infoItem, c && !n && g.Z.bottomBorder] }, r.createElement(o.ZP, null, t.name), r.createElement(o.ZP, { color: "gray700", style: g.Z.helpText }, k, " ", G(new Date(t.created_at))));
                                      }),
                                  )
                                : null;
                                ...
                                r.createElement(u.Z, {
                                    ...
                                    render: () => {
                                        const e = S.phone || U,
                                            c = S.tablet || U,
                                            l = S.desktop || U,
                                            h = e.length > 0 && c.length > 0 && l.length > 0,
                                            p = { supportLink: r.createElement(o.ZP, { link: M }) };
                                        return r.createElement(
                                            a.Z,
                                            null,
                                            ...
                                            q(e, C, 0 === c.length && 0 === l.length),
                                            q(c, x, 0 === l.length),
                                            q(l, v, !0),
                                            r.createElement(i.Z, null),
                                            t.viewerUserId && r.createElement(o.ZP, { color: "gray700", size: "subtext2", style: [f.Z.infoText, w ? f.Z.bottomBorder : null] }, r.createElement(d().I18NFormatMessage, { $i18n: "i4d58f43" }, r.cloneElement(p.supportLink, null, d().c1b03a07))),
                                            w
                                                ? (() => {
        ...
        154007: (e, t, n) => {
            n.r(t), n.d(t, { TransparencyDashboardGenderScreen: () => G, default: () => M });
            var r = n(807896),
                a = n(202784),
                s = n(325686),
                o = n(731708),
            ...
            class G extends a.Component {
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._render = () => a.createElement("div", null, a.createElement(s.Z, { style: [Z.Z.infoItem, Z.Z.bottomBorder] }, a.createElement(o.ZP, { color: "gray700" }, this.isLoggedIn ? C : B)), this.isLoggedIn ? this._renderGenderSelector() : this._renderLoggedOut())),
                ...
                render() {
                    ...
                    return a.createElement(m.Z, null, a.createElement(g.Z, (0, r.Z)({ location: t, title: I }, n), a.createElement(_.Z, null, a.createElement(f.Z, { fetch: this.combinedFetches, fetchStatus: e, render: () => this._render() }))));
                }
                _renderGenderSelector() {
                    const { gender: e } = this.props;
                    return a.createElement(s.Z, null, a.createElement(c.Z, { name: "gender", onChange: this._handleItemChanged, options: R, value: this.selectedGender }), this.selectedGender === T ? a.createElement(i.Z, { defaultValue: e.value && e.type === T ? e.value : "", label: P, maxLength: 30, name: "genderOther", onChange: this._handleCustomGenderUpdate, type: "text" }) : null);
                }
                _renderLoggedOut() {
                    const { personalizationPreferences: e } = this.props,
        ...
        349154: (e, t, n) => {
            ...
            const Z = (0, f.Z)()
                    ...
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, _.zr)("SETTINGS_TRANSPARENCY_DASHBOARD_LANGUAGE_SCREEN"), fetchData: g.nJ, fetchPreferences: g.CP, updateLanguage: g.BF }))
                    ...
                    super(...e),
                        ...
                        (this._render = () => {
                            const {
                                ...
                                n = e[0],
                                c = e.length > 1 ? e.slice(1) : [],
                                i = t.language_preferences && t.language_preferences.disabled_languages;
                            return r.createElement(
                                "div",
                                null,
                                r.createElement(a.Z, { style: [u.Z.infoItem, u.Z.bottomBorder] }, r.createElement(s.ZP, { color: "gray700" }, b)),
                                n ? r.createElement(a.Z, { style: [u.Z.infoItem, c.length > 0 && u.Z.bottomBorder] }, r.createElement(s.ZP, null, n.display)) : r.createElement(a.Z, { style: c.length > 0 && u.Z.bottomBorder }, this._renderMessage(w, A)),
                                c.length > 0 ? r.createElement(a.Z, { style: [u.Z.infoItem, u.Z.bottomBorder] }, r.createElement(s.ZP, { color: "gray700" }, S)) : null,
                                c.map((e, t) => r.createElement(o.Z, { checked: !i || -1 === i.indexOf(e.key), key: e.key, label: e.display, name: e.key, onChange: this._handleUpdateLanguage })),
                            );
                        }),
        ...
        821853: (e, t, n) => {
            n.r(t), n.d(t, { TransparencyDashboardLocationsScreen: () => C, default: () => x });
            var r = n(202784),
                a = n(325686),
                s = n(731708),
                o = n(909377),
            ...
            const y = (0, g.Z)()
                ...
                S = i().j31a1aa0,
                w = i().e68b09b4,
                A = { headline: i().ddefdd1c, text: i().hea740ac, confirmButtonLabel: i().e68b09b4 },
                D = i().a26e0d52,
                P = i().ae415fd2,
                T = r.createElement(i().I18NFormatMessage, { $i18n: "a1fdeb45" }, r.createElement(s.ZP, { link: "/settings/location_information" }, i().b9d98dec)),
                I = i().he447966;
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._render = () => {
                            ...
                            return r.createElement(h.Z, null, r.createElement("div", null, r.createElement(a.Z, { style: [_.Z.infoItem, _.Z.bottomBorder] }, r.createElement(s.ZP, { color: "gray700" }, S)), t ? this._renderLocations() : this._renderMessage(P, T)));
                        }),
                        (this._renderLocations = () => {
                            const { personalizationData: e } = this.props,
                                t = e.location_history;
                            return r.createElement(a.Z, null, t && t.map((e, t) => r.createElement(a.Z, { key: `loc-'${t}`, style: [_.Z.infoItem, _.Z.locationInfo, _.Z.bottomBorder] }, r.createElement(o.Z, { Icon: l.default, color: "neutral", size: "xLarge", style: _.Z.locationIcon }), r.createElement(s.ZP, null, e))), t && t.length ? r.createElement(d.Z, { confirmationSheetConfirmButtonLabel: A.confirmButtonLabel, confirmationSheetConfirmButtonType: "destructiveFilled", confirmationSheetHeadline: A.headline, confirmationSheetText: A.text, label: w, onConfirmationSheetConfirm: this._handleDeleteLocation, withBottomBorder: !1 }) : this._renderMessage(I));
                        }),
                        (this._renderMessage = (e, t) => r.createElement(a.Z, { style: u.Z.calloutTextBlock }, r.createElement(s.ZP, { align: "center", size: "headline1" }, e), t ? r.createElement(s.ZP, { align: "center", color: "gray700", style: _.Z.helpText }, t) : null)),
        ...
        933015: (e, t, n) => {
            ...
            class w extends r.Component {
                ...
                render() {
                    ...
                    return r.createElement(d.Z, null, r.createElement(p.Z, { location: n, title: E }, r.createElement(c.Z, { description: S }), r.createElement(h.Z, { fetch: e, fetchStatus: t, render: () => this._render() })));
                }
            }
            const A = g(w);
        },
        515321: (e, t, n) => {
            n.r(t), n.d(t, { TransparencyDashboardPartnerInterestsScreen: () => T, default: () => I });
            var r = n(202784),
                a = n(325686),
                s = n(688715),
                o = n(731708),
                    ...
                    super(...e),
                        (this._render = () => {
                            ...
                            return r.createElement(
                                "div",
                                null,
                                r.createElement(a.Z, { style: [_.Z.infoItem, _.Z.bottomBorder] }, r.createElement(o.ZP, { color: "gray700" }, r.createElement(l().I18NFormatMessage, { $i18n: "adc26d49" }, r.createElement(o.ZP, { link: P }, l().e6dbe66b)))),
                                e.map((e) => r.createElement(c.Z, { checked: -1 === n.indexOf(e.id), key: e.id, label: e.display_name, name: e.id.toString(), onChange: this._handleUpdateInterest })),
                                0 === e.length ? this._renderMessage(A, D) : r.createElement(a.Z, { style: u.Z.calloutTextBlock }, r.createElement(o.ZP, { color: "gray700", style: _.Z.helpText }, w)),
                            );
                        }),
                        (this._renderMessage = (e, t) => r.createElement(a.Z, { style: u.Z.calloutTextBlock }, r.createElement(o.ZP, { align: "center", size: "headline1" }, e), t ? r.createElement(o.ZP, { align: "center", color: "gray700", style: _.Z.helpText }, t) : null)),
                        (this._handleFetchData = () => {
                            const { createLocalApiErrorHandler: e } = this.props;
        ...
        546703: (e, t, n) => {
            n.r(t), n.d(t, { TransparencyDashboardRequestDataScreen: () => T, default: () => I });
            var r = n(202784),
                a = n(325686),
                s = n(731708),
                o = n(688715),
            ...
            class T extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._render = () => {
                            ...
                            return r.createElement("div", null, r.createElement(a.Z, { style: [_.Z.infoItem, _.Z.bottomBorder] }, r.createElement(s.ZP, null, e ? b({ primaryEmail: e }) : S)), r.createElement(a.Z, { onClick: this._handleRequestDataClick, role: "button", style: [_.Z.cursor, u.Z.viewItem] }, r.createElement(s.ZP, { align: "center", color: "link" }, e ? A : D)));
                        }),
                ...
                render() {
                    ...
                    return r.createElement(h.Z, null, r.createElement(m.Z, { location: t, title: w }, r.createElement(p.Z, null, this.isLoggedIn ? r.createElement(l.Z, { fetchStatus: e, onRequestRetry: this._handleFetchDevices, render: this._render }) : this._render())));
                }
            }
            T.contextType = d.rC;
            const I = y(T);
        ...
        876634: (e, t, n) => {
            ...
            class L extends r.Component {
                ...
                render() {
                    const { fetchStatus: e, location: t } = this.props;
                    return r.createElement(p.Z, null, r.createElement(_.Z, { location: t, title: I }, r.createElement(m.Z, null, r.createElement(u.Z, { fetch: this._combinedFetches, fetchStatus: e, render: () => this._render() }))));
                }
            }
            L.contextType = h.rC;
            const F = P(L);
        ...
        380052: (e, t, n) => {
            n.r(t), n.d(t, { TransparencyDashboardTwitterInterestsScreen: () => F, default: () => R });
            var r = n(202784),
                a = n(325686),
                s = n(954110),
                o = n(731708),
            ...
            class F extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderTabs = () => {
                            ...
                            const e = [
                                { to: "/settings/your_twitter_data/twitter_interests", key: I, label: I },
                                { to: L, key: T, label: T },
                            ];
                            return r.createElement(p.Z, { "aria-label": P, links: e });
                        }),
                        (this._render = () => {
                            const {
                                location: { pathname: e },
                ...
                render() {
                    const { fetchStatus: e, location: t } = this.props;
                    return r.createElement(u.Z, null, r.createElement(g.Z, { location: t, secondaryBar: this._renderTabs(), title: P }, r.createElement(_.Z, null, r.createElement(c.Z, null, r.createElement(h.Z, { fetchStatus: e, onRequestRetry: this._handleFetchData, render: this._render })))));
                }
            }
            F.contextType = m.rC;
            const R = D(F);
        ...
        791508: (e, t, n) => {
            ...
            const _ = l().j7ad754a,
                ...
                w = c.default.create((e) => ({ backgroundRoot: { flexGrow: 1, backgroundColor: e.colors.gray50 }, contentRoot: { backgroundColor: e.colors.cellBackground, flexGrow: 1, justifyContent: "flex-start" } })),
                A = function (e) {
                    const { location: t } = e,
                        { viewerUserId: n } = r.useContext(d.rC),
                        c = !!n;
                    return r.createElement(p.nO, { namespace: S }, r.createElement(h.Z, null, r.createElement(u.Z, { location: t, title: _ }, r.createElement(m.Z, null, r.createElement(a.Z, { style: w.backgroundRoot }, r.createElement(s.Z, { style: w.contentRoot }, r.createElement(o.Z, { label: f, link: "/settings/your_twitter_data/account" }), c ? r.createElement(o.Z, { label: g, link: "/settings/your_twitter_data/account_history" }) : null, r.createElement(o.Z, { label: E, link: "/settings/your_twitter_data/devices" }), c ? r.createElement(o.Z, { label: Z, link: "/settings/your_twitter_data/account_activity" }) : null, r.createElement(o.Z, { label: y, link: "/settings/your_twitter_data/ads" }), r.createElement(o.Z, { label: b, link: c ? "/settings/download_your_data" : "/settings/your_twitter_data/request_data" })))))));
                };
        },
        342453: (e, t, n) => {
            n.d(t, { Z: () => s });
        ...
        170069: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                s = n(731708),
                o = n(392237);
            const c = ({ children: e }) => r.createElement(a.Z, { style: i.labelContainer }, r.createElement(a.Z, { style: i.contentContainer }, r.createElement(a.Z, { style: i.appText }, r.createElement(s.ZP, { color: "gray700", size: "subtext2" }, e)))),
                i = o.default.create((e) => ({ contentContainer: { alignItems: "center", flex: 1, flexDirection: "row", justifyContent: "space-between" }, labelContainer: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.componentDimensions.gutterVertical, minHeight: `calc(${o.default.theme.lineHeights.headline1} + 2 * ${e.componentDimensions.gutterVertical})` }, appText: { flexShrink: 1, width: "100%" } }));
        },
        609848: (e, t, n) => {
            n.d(t, { Z: () => F });
            var r = n(202784),
            ...
            class v extends r.Component {
                ...
                _renderPasswordPrompt() {
                    const { titleHeader: e } = this.props,
                        ...
                        n = r.createElement(s.ZP, { link: { pathname: (0, o.ju)("https://x.com/i/flow/password_reset"), external: !0, openInSameFrame: !0 } }, I);
                    return r.createElement(r.Fragment, null, e ? r.createElement(c.Z, { text: e }) : null, r.createElement(a.Z, { style: [y.Z.viewItem, y.Z.bottomBorder] }, r.createElement(s.ZP, { color: "gray700", size: "subtext2" }, T)), r.createElement(i.Z, { errorText: t, helperText: n, invalid: !!t, label: P, name: "current_password", onChange: this._handleChange, onSubmitEditing: this._handlePasswordSubmit, type: "password", value: this.state.password }), r.createElement(l.Z, { style: k.buttonContainer }, r.createElement(d.ZP, { disabled: !1, onPress: this._handlePasswordSubmit, style: k.button, type: "brandFilled" }, C)));
                }
                render() {
                    const { fetchStatus: e, location: t, render: n } = this.props,
                        { verificationRequired: a } = this.state,
                        s = e === E.ZP.FAILED && a;
                    return r.createElement(r.Fragment, null, s ? (this._passwordlessSsoEnabled ? r.createElement(Z.Z, { to: { pathname: "/i/flow/verify_account_ownership", state: { input: { requested_variant: t.pathname } } } }) : this._renderPasswordPrompt()) : r.createElement(_.Z, { fetchStatus: e, onRequestRetry: this._handleFetch, render: n }));
                }
            }
            (v.contextType = f.rC), (v.defaultProps = { titleHeader: D });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SettingsTransparency-63cb1cc4.5451885a.js.map
