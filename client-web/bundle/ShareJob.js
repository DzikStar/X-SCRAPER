    ...
    ["bundle.ShareJob"],
    {
        9577: (e, a, l) => {
            ...
            const g = i.default.create((e) => ({ card: { paddingVertical: e.spaces.space12, paddingHorizontal: e.spaces.space20, height: "100%" }, cardLayout: { display: "flex", flexDirection: "column", gap: e.spaces.space8, height: "100%" }, cardMeta: { display: "flex", flexDirection: "column", gap: 8 }, cardSubtext: { display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 12 }, withIcon: { display: "flex", flexDirection: "row", alignItems: "center", gap: e.spaces.space4 }, contentBackground: { backgroundColor: e.colors.cellBackground }, darkModeContentBackground: { backgroundColor: e.colors.gray0 } })),
                y = ({ formattedSalary: e, id: a, isVerifiedOrg: l, isViewerFollowsUser: y, jobIndex: p, location: b, profileId: k, redirectUrl: f, salaryInterval: h, timestamp: _, title: F }) => {
                    const v = (0, d.z)(),
                        E = n.useCallback(() => {
                            v.scribe({ ...(0, m.yt)("jobs_module", "click", "job"), data: { profile_id: k, items: [{ position: p, id: a, is_viewer_follows_user: y }] } });
                        }, [v, a, y, p, k]),
                        w = n.useMemo(() => `/i/jobs/${a}`, [a]);
                    return n.createElement(r.Z, { link: l ? { pathname: w, external: !0 } : f || "", onClick: E, role: "link", style: [g.card, i.default.isDarkMode() ? g.darkModeContentBackground : g.contentBackground] }, n.createElement(t.Z, { style: g.cardLayout }, n.createElement(s.ZP, { hoverLabel: { label: F, withDelay: !0 }, numberOfLines: 1, size: "subtext2", weight: "bold" }, F), n.createElement(t.Z, { style: g.cardMeta }, n.createElement(t.Z, { style: g.withIcon }, n.createElement(s.ZP, { color: "gray700", size: "subtext3" }, n.createElement(o.default, null)), n.createElement(s.ZP, { color: "gray700", hoverLabel: { label: b, withDelay: !0 }, numberOfLines: 1, size: "subtext3", weight: "normal" }, b)), e || _ ? n.createElement(t.Z, { style: g.cardSubtext }, e ? n.createElement(t.Z, { style: g.withIcon }, n.createElement(s.ZP, { color: "gray700", size: "subtext3" }, n.createElement(c.default, null)), n.createElement(s.ZP, { color: "gray700", hoverLabel: { label: b, withDelay: !0 }, numberOfLines: 1, size: "subtext3", style: g.withIcon, weight: "normal" }, (0, u.M)(e, h))) : null, _ ? n.createElement(s.ZP, { color: "gray700", size: "subtext2", weight: "normal" }, _) : null) : null)));
                };
        },
        272590: (e, a, l) => {
            function n() {
        ...
        638679: (e, a, l) => {
            ...
            const ge = Z().h39a5448,
                ...
                ve = ({ history: e }) => d.createElement(b.H, { errorConfig: _e }, d.createElement(p.ZP, { clickMaskToClose: !0, history: e, modalSize: "fitChildren", withBackground: !0 }, d.createElement(m.Z, { style: Fe.modalStyles }, d.createElement(he, null))));
        },
        454104: (e, a, l) => {
            l.d(a, { Z: () => t });
            var n = l(443781);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.ShareJob.76b3980a.js.map
