            ...
            const Ze = Ee,
                ...
                Pe = (e) => {
                    ...
                    const R = s && !!g.verified_program_creator_features?.email_sharing_from_subscribers_enabled,
                        ...
                        de = y.createElement(h.ZP, (0, _.Z)({}, ce, { backgroundColor: "plum500", borderColor: "transparent", color: "white", ref: d, size: "xLarge", style: Be.bigSubscribeButton }), V ? y.createElement(H.Z, null) : Le({ price: oe })),
                        me = y.createElement(h.ZP, (0, _.Z)({}, ce, { disabled: ce.disabled && !m, size: "small", style: [Be.transitionOpacity, m ? Be.opacityNone : void 0], type: "primaryFilled" }), V ? y.createElement(H.Z, { size: "small" }) : Le({ price: oe })),
                        pe = y.createElement(h.ZP, { "aria-label": ne, hoverLabel: { label: ne }, icon: y.createElement(j.default, null), renderMenu: ie, size: "small", style: Be.shareButton, type: "primaryText" }),
                    ...
                    const e = (0, S.useHistory)(),
                        ...
                        l = y.useMemo(
                            () => ({
                                type: "CustomRetry",
                                content: (l) => {
                                    const n = y.createElement(E.Z, { style: je.error }, y.createElement(Z.Z, { description: Ae, title: Re }), y.createElement(h.ZP, { onPress: l, style: je.errorButton, type: "brandFilled" }, Me));
                                    return y.createElement(K.Z, { backButtonType: "close", backLocation: `/${a}`, children: n, history: e });
                                },
                            }),
                            [e, a],
                        );
                    return y.createElement(L.N, { errorConfig: ze, fallback: l }, y.createElement(C.B, null, y.createElement(He, { screenName: a })));
                },
                Oe = y.memo($e),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SuperFollowsSubscribe.36da328a.js.map
