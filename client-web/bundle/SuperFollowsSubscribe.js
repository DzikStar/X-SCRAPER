        ...
        518983: (e, a, l) => {
            ...
            const te = w().be03ecca,
                ...
                ue = ({ consented: e, creatorName: a, setConsented: l, setSubscriptionEmail: n, subscriptionEmail: r }) => {
                    const [t, s] = b.useState(),
                        ...
                        c = b.useCallback((e) => n(e.currentTarget.value), [n]),
                        u = b.useCallback(
                            (e) => {
            ...
            const ye = pe,
                ...
                fe = (e) => {
                    ...
                    return b.createElement(b.Fragment, null, b.createElement(be.Z, { badgeImageUrl: p, badgeName: _, badgeScreenName: y, descriptionValue: g, imageUrl: c, introValue: d, isBlueVerified: h, isProtected: k, isVerified: f, name: o, screenName: u }), b.createElement(A.Z, { style: S }, l, b.createElement(_e.Z, { recurring: !0, style: he.disclaimer }), a));
                },
                he = F.default.create((e) => ({ disclaimer: { marginVertical: e.spaces.space24 }, subscribeButtonContainer: { alignItems: "center", flexGrow: 1, marginBottom: e.spaces.space40, marginTop: e.spaces.space48, paddingHorizontal: e.spaces.space32 }, subscribeButtonContainerWide: { paddingHorizontal: e.spaces.space48 } }));
            var Se = (function () {
            ...
            const Ze = Ee,
                ...
                Pe = (e) => {
                    const { screenName: a, user: l, viewer: n } = e,
                        ...
                        k = (0, h.useHistory)(),
                        f = (0, W.p)(),
                        F = p.legacy?.id_str ?? void 0,
                        v = p.legacy?.screen_name ?? void 0,
                        w = ((e, a, l, n) => {
                            let r = e;
                            return l && n && (r += a), r;
                        ...
                        T = v ? `${x}/${v}/creator-subscriptions/subscribe/success` : x,
                        N = v ? `${x}/${v}/creator-subscriptions/subscribe/failure` : x,
                        ...
                        })({ productId: Z, successUrl: T, cancelUrl: N }),
                        [P] = (() => {
                            const [e, a] = we()(Ke);
                            return [
                                b.useCallback(
                        ...
                        B = b.useMemo(() => {
                            ...
                            !(0, J.d)(k.location) && v && a.includes(`${v}/status`) && (e = "tweet");
                    ...
                    b.useEffect(() => {
                        g.scribe({ element: "subscribe_screen", action: "impression", data: B });
                    }, [B, g]);
                    const R = s && !!p.verified_program_creator_features?.email_sharing_from_subscribers_enabled,
                        z = R && c,
                        ee = z && (!i || !!(0, X.Z)(i)),
                        ae = p.legacy?.name ?? "",
                        ...
                        re = Te,
                        te = b.useCallback(() => {
                            g.scribe({ element: "subscribe_button", action: "click", data: B });
                            const e =
                                    z && !ee && F
                                        ? P({ email: i, creatorId: F, consented: c })
                                              .then((e) => {
                                                  g.scribe({ element: "email_share_consent_update", action: e ? "success" : "error", data: B });
                                              })
                                              .catch(() => {
                                                  g.scribe({ element: "email_share_consent_update", action: "error", data: B });
                                              })
                                        : null,
                                a = U().catch(() => {
                                    f({ text: Ce });
                        ...
                        }, [g, F, B, z, ee, U, P, i, c, f]),
                        se = b.useCallback(() => {
                            M.Z.setString(C), f({ text: Ne }), g.scribe({ action: "share", data: B });
                        }, [f, g, C, B]),
                        ie = b.useCallback(
                            (e) => {
                                const a = [];
                                return a.push({ text: re, Icon: O.default, onClick: se }), g.scribe({ element: "share", action: "click", data: B }), b.createElement(D.Z, { items: a, onCloseRequested: e });
                            },
                            [g, re, se, B],
                        ),
                        oe = E && w ? ((e, a) => G.T[e.toUpperCase()](parseInt(a, 10) / 1e6))(E, w) : void 0,
                        ce = { disabled: (F && L && F === L) || V || !Z || ee, onPress: te },
                        de = b.createElement(S.ZP, (0, _.Z)({}, ce, { backgroundColor: "plum500", borderColor: "transparent", color: "white", ref: d, size: "xLarge", style: Be.bigSubscribeButton }), V ? b.createElement(H.Z, null) : Le({ price: oe })),
                        me = b.createElement(S.ZP, (0, _.Z)({}, ce, { disabled: ce.disabled && !m, size: "small", style: [Be.transitionOpacity, m ? Be.opacityNone : void 0], type: "primaryFilled" }), V ? b.createElement(H.Z, { size: "small" }) : Le({ price: oe })),
                        ge = b.createElement(S.ZP, { "aria-label": ne, hoverLabel: { label: ne }, icon: b.createElement(j.default, null), renderMenu: ie, size: "small", style: Be.shareButton, type: "primaryText" }),
                        pe = b.createElement(A.Z, { style: Be.rightControl }, me, ge),
                        _e = (0, $.$u)();
                ...
                He = ({ screenName: e }) => {
                    ...
                    return n && r ? (n.super_following ? b.createElement(U.Z, { to: `/${e}/creator-subscriptions/manage` }) : n.super_follow_eligible ? b.createElement(x.nO, { namespace: De }, b.createElement(Pe, { screenName: e, user: n, viewer: r })) : b.createElement(U.Z, { to: `/${e}` })) : null;
                },
                $e = () => {
                    const e = (0, h.useHistory)(),
                        ...
                        l = b.useMemo(
                            () => ({
                                type: "CustomRetry",
                                content: (l) => {
                                    const n = b.createElement(E.Z, { style: je.error }, b.createElement(Z.Z, { description: Me, title: Re }), b.createElement(S.ZP, { onPress: l, style: je.errorButton, type: "brandFilled" }, Ae));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SuperFollowsSubscribe.52b0e22a.js.map
