            ...
            const Ze = Ee,
                ...
                Pe = (e) => {
                    const { screenName: a, user: l, viewer: n } = e,
                        ...
                        T = w ? `${x}/${w}/creator-subscriptions/subscribe/success` : x,
                        N = w ? `${x}/${w}/creator-subscriptions/subscribe/failure` : x,
                    ...
                    const R = s && !!p.verified_program_creator_features?.email_sharing_from_subscribers_enabled,
                        ...
                        ee = z && (!i || !!(0, X.Z)(i)),
                        ae = p.legacy?.name ?? "",
                        le = R ? y.createElement(ue, { consented: c, creatorName: ae, setConsented: u, setSubscriptionEmail: o, subscriptionEmail: i }) : null,
                        ne = xe,
                        re = Te,
                        te = y.useCallback(() => {
                        ...
                        ie = y.useCallback(
                            (e) => {
                                const a = [];
                                return a.push({ text: re, Icon: O.default, onClick: se }), g.scribe({ element: "share", action: "click", data: B }), y.createElement(D.Z, { items: a, onCloseRequested: e });
                            },
                            [g, re, se, B],
                        ),
                        oe = E && F ? ((e, a) => G.T[e.toUpperCase()](parseInt(a, 10) / 1e6))(E, F) : void 0,
                        ce = { disabled: (v && L && v === L) || V || !Z || ee, onPress: te },
                        de = y.createElement(S.ZP, (0, _.Z)({}, ce, { backgroundColor: "plum500", borderColor: "transparent", color: "white", ref: d, size: "xLarge", style: Be.bigSubscribeButton }), V ? y.createElement(H.Z, null) : Le({ price: oe })),
                        me = y.createElement(S.ZP, (0, _.Z)({}, ce, { disabled: ce.disabled && !m, size: "small", style: [Be.transitionOpacity, m ? Be.opacityNone : void 0], type: "primaryFilled" }), V ? y.createElement(H.Z, { size: "small" }) : Le({ price: oe })),
                        ge = y.createElement(S.ZP, { "aria-label": ne, hoverLabel: { label: ne }, icon: y.createElement(j.default, null), renderMenu: ie, size: "small", style: Be.shareButton, type: "primaryText" }),
                        pe = y.createElement(A.Z, { style: Be.rightControl }, me, ge),
                        _e = (0, $.$u)();
                ...
                Be = v.default.create((e) => ({ bigSubscribeButton: { width: "100%" }, opacityNone: { opacity: 0 }, rightControl: { flexDirection: "row" }, shareButton: { marginStart: e.spaces.space16 }, transitionOpacity: { transition: "opacity 0.2s 0s ease-in-out" } })),
                Re = F().g61ed8a4,
                Me = F().c3d23f10,
                Ae = F().d338f53e,
                ze = f,
                ...
                He = ({ screenName: e }) => {
                    ...
                    return n && r ? (n.super_following ? y.createElement(U.Z, { to: `/${e}/creator-subscriptions/manage` }) : n.super_follow_eligible ? y.createElement(x.nO, { namespace: De }, y.createElement(Pe, { screenName: e, user: n, viewer: r })) : y.createElement(U.Z, { to: `/${e}` })) : null;
                },
                $e = () => {
                    const e = (0, h.useHistory)(),
                        ...
                        l = y.useMemo(
                            () => ({
                                type: "CustomRetry",
                                content: (l) => {
                                    const n = y.createElement(E.Z, { style: je.error }, y.createElement(Z.Z, { description: Me, title: Re }), y.createElement(S.ZP, { onPress: l, style: je.errorButton, type: "brandFilled" }, Ae));
                ...
                qe = (e) => y.createElement(b.Z, (0, _.Z)({}, e, { component: Oe }));
        },
        273961: (e, a, l) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.SuperFollowsSubscribe.ed7ec4aa.js.map
