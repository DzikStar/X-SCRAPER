...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.TV-6107ac1a", "icons/IconFastforward-js"],
    {
        ...
        978112: (e, a, d) => {
            ...
            const X = L.default.create((e) => ({ root: { ...L.default.absoluteFillObject, backgroundColor: "#000000", position: "fixed" }, logo: { ...L.default.absoluteFillObject, color: e.colors.buttonAlwaysWhite, height: e.spaces.space72, width: e.spaces.space72, margin: "auto" } })),
            ...
            function Y(e) {
                const { children: a } = e,
                    d = l.useRef(L.default.theme.scales).current,
                    o = l.useRef(L.default.theme.paletteName).current,
                ...
                g = ({ autoFocus: e, categories: a, focusBoundaryDirections: d, handleNoriginArrowPress: l, isFocusBoundary: n, name: c, onArrowPress: M, onSelectVideo: f, playVideoPreview: y, returnToFirstElementOnEscape: v, withScrollRestoration: p = !0 }) => {
                    const P = o.useRef(null),
                        ...
                        N = o.useCallback(
                            ...
                            [S.length, l, B, Z, x, f, y],
                        ),
                        O = o.useMemo(() => S.map((e, a) => N({ index: a, item: e })), [S, N]),
                        $ = o.useCallback(
                            (e) => {
                                if (v && L && (0, r.getCurrentFocusKey)() !== L) return (0, r.setFocus)(L), P.current?.setPosition(0), H.current[0]?.(0), !0;
                            },
                            [L, v],
                        ),
                        _ = o.useCallback(
        ...
        674546: (e, a, d) => {
            ...
            const k = function (e) {
                    const { formatLabel: a, min: d = 0, value: i = d, max: c, name: k, onArrowPress: f, step: y, fasterStep: v = y, fastestStep: p = y, onChange: P, onActive: w, withLabel: A, onMouseEnter: I, onMouseLeave: g, onMouseDown: E, ...T } = e,
                        ...
                        J = l.useRef(),
                        x = l.useRef(!1),
                        N = l.useMemo(() => [M.progress, { flexGrow: S }], [S]),
                        O = l.useCallback(
                            (e) => {
                                H(!0), I && I(e);
                            },
        ...
        831489: (e, a, d) => {
            ...
            const s = (e = {}) => {
                ...
                return (0, l.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [n.Z.root, e.style], viewBox: "0 0 24 24", children: o.createElement("g", null, o.createElement("path", { d: "M11 13.67V22l12-10L11 2v8.33L1 2v20l10-8.33z" })) }, { writingDirection: a });
            };
