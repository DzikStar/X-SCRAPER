    ...
    ["bundle.TV-cf3bcfae"],
    {
        ...
        978112: (e, d, a) => {
            ...
            const ee = T.default.create(() => ({ root: { height: T.default.supports("height: 100dvh") ? "100dvh" : "100vh", maxHeight: T.default.supports("height: 100dvh") ? "100dvh" : "100vh", overflow: "hidden", width: "100%" } })),
                    ...
                    (0, P.p)(
                        () =>
                            Promise.all([
                                ...
                                a.e("shared~loader.DashMenu~loader.DashModal~bundle.Account"),
                                a.e("shared~bundle.TV~bundle.Account-6107ac1a"),
                                a.e("shared~bundle.TV~bundle.Account-63393a95"),
                                a.e("shared~bundle.TV~bundle.Account-e019dbda"),
                                a.e("bundle.Account"),
                ...
                pe = (e) => r.createElement(v.Z, (0, o.Z)({}, e, { component: re, fallbackRedirect: A.C2, featureSwitchName: "responsive_web_messages_enabled", match: e.match })),
                Se = (e) => r.createElement(v.Z, (0, o.Z)({}, e, { component: (e) => r.createElement(De, (0, o.Z)({}, e, { pageName: "following", query: "filter:follows filter:videos", searchTab: "following", title: de })), fallbackRedirect: A.C2, featureSwitchName: "responsive_web_messages_enabled", match: e.match })),
            ...
            class Ee extends r.Component {
                ...
                render() {
                    const { contextProviderProps: e, history: d, jotaiStore: a, relayEnvironment: u, store: m } = this.props,
                        M = this.state.isMounted ? r.createElement(i.Router, { children: this._routerProps.children, history: d }) : null;
                    return r.createElement(l.zt, { store: m }, r.createElement(h.nO, { data: { user_agent: s.ZP.userAgent }, namespace: A.ho }, r.createElement(n.zt, { store: a }, r.createElement(c(), { environment: u }, r.createElement(b.ZP, (0, o.Z)({ history: d, store: m }, e), r.createElement(Ie.G, null, r.createElement(S.x, { history: d }, r.createElement(D.__, null, r.createElement(ge.H, { history: d }, r.createElement(Pe.r, { history: d }, r.createElement(F.X, { initialFocusedElement: p.rQ, isEnabled: !0 }, r.createElement(y, { history: d }), r.createElement(t.Z, null, M))))))))))));
                }
            }
        },
        944800: (e, d, a) => {
        ...
        795290: (e, d, a) => {
            ...
            const D = "urn:x-cast:com.x.xtv",
                ...
                S = ({ children: e, history: d }) => {
                        ...
                        C = o.useCallback(
                            (e) => {
                                if ("statusID" in e && "string" == typeof e.statusID && "currentTimeMs" in e && "number" == typeof e.currentTimeMs) {
                                    ...
                                    window.location.pathname.startsWith(`/i/tv/player/${r}`) ? (k(`handleLoad seeking to: ${n.toString()}`), S.current?.seekTo(n / 1e3), S.current?.play()) : window.location.pathname.startsWith("/i/tv/player/") ? (k(`handleLoad history replace to: ${u}`), d.replace(u)) : (k(`handleLoad history push to: ${u}`), d.push(u));
                                }
                                var a, o;
                            },
                            [d, k, S],
                    ...
                    return o.createElement(h.Provider, { value: V }, o.createElement(i.nO, { data: R }, e));
                };
        ...
        305332: (e, d, a) => {
            ...
            const A = "tv-carousel",
                ...
                y = (e) => `${A}-${e}`,
                M = (e) => e.id,
                w = ({ autoFocus: e, categories: d, focusBoundaryDirections: a, isFocusBoundary: r, name: i, onArrowPress: A, onSelectVideo: w, playVideoPreview: f, returnToFirstElementOnEscape: k, withScrollRestoration: B = !0 }) => {
                    const P = (0, b.z)(),
                        { direction: I } = (0, c.Z)(),
                        g = (0, s.Z)(`${i}.${y("0")}.${(0, h.X)("0")}`),
                        ...
                        T = o.useCallback(
                            ({ index: e, item: d }) =>
                                o.createElement(
                                    ...
                                    o.createElement(D.Z, {
                                        content: d.content,
                                        displayType: (0, S.qU)(d.displayType),
                                        key: d.id,
                                        name: y(e.toString()),
                                        onFocus: () => {
            ...
            const k = (e) => `${A}-${e}`,
                ...
                P = ({ autoFocus: e, categories: d, focusBoundaryDirections: a, handleNoriginArrowPress: r, isFocusBoundary: l, name: i, onArrowPress: A, onSelectVideo: m, playVideoPreview: y, returnToFirstElementOnEscape: M, withScrollRestoration: w = !0 }) => {
                    const v = o.useRef(null),
                        P = o.useRef(new Map()),
                        g = (0, b.z)(),
                        { direction: E } = (0, c.Z)(),
                        C = (0, s.Z)(i) || i,
                        T = (0, s.Z)(`${i}.${k("0")}.${(0, h.X)("0")}`),
                        ...
                        F = o.useCallback(
                            ({ index: e, item: d }) => {
                                ...
                                return o.createElement(
                                    ...
                                    o.createElement(D.Z, { content: d.content, displayType: (0, S.qU)(d.displayType), getSetPositionFn: a, handleNoriginArrowPress: r || (() => !1), name: k(e.toString()), onFocus: N[e], onFocusChild: $[e], onReady: L, onSelectVideo: m, playVideoPreview: y, title: d.title }),
                                );
                            },
                            [V.length, r, N, $, L, m, y],
                        ),
                        ...
                        z = o.useCallback(
                            (e) => {
                                ...
                                return r ? (0, n.setFocus)(r) : (0, n.setFocus)(`${C}.${k(a.toString())}.${(0, h.X)("0")}`), v.current?.setPosition(a), !0;
                            },
                            [g, E, V.length, C, A],
                        ),
                        U = o.useCallback((e) => {
        ...
        787557: (e, d, a) => {
            ...
            var o = a(807896),
                ...
                b = a(734261);
            const D = i().ia13bd7c,
                h = ({ disabled: e, displayName: d, icon: a, onArrowPress: o, onKeyPress: n, style: u, value: c }) => {
                    const i = { displayName: d, value: c };
                    return r.createElement(t.C, { "aria-label": d, focusable: !e, name: `key-${d}`, onArrowPress: o, onPress: () => n?.(i), role: "text", style: [S.keyboardKey, u] }, r.createElement(l.ZP, { size: "subtext2", weight: "medium" }, a || d));
                },
                p = ({ disabled: e, onArrowPress: d, onKeyPress: a, style: l, width: u = 6 }) => {
                            ...
                            () =>
                                b.H.rows.flatMap((l, u) =>
                                    l.map((l, i, s) => {
                                        ...
                                        let b = {};
                                        return 0 === u && 0 === i ? (b = S.topLeftKey) : 0 === u && t ? (b = S.topRightKey) : u === c - 1 && 0 === i ? (b = S.bottomLeftKey) : u === c - 1 && t && (b = S.bottomRightKey), r.createElement(n.Z, { key: `tv-keyboard-key-${l.displayName}`, style: { gridColumn: `span ${l.width || 1}` } }, r.createElement(h, (0, o.Z)({}, l, { disabled: e, onArrowPress: d, onKeyPress: a, style: b })));
                                    }),
                                ),
                            [e, c, d, a],
                        );
                    return r.createElement(s.Z, { "aria-label": D, focusable: !e, name: b.o, onArrowPress: d, role: "layout", saveLastFocusedChild: !0, style: [S.container, i, l] }, t);
                },
        ...
        406483: (e, d, a) => {
            ...
            var o = a(202784),
                ...
                m = a(682461),
                y = a(971813);
            const M = (e, d) => e.tv?.relatedVideos?.cursor,
                ...
                P = v(({ currentTweetId: e, cursor: d, fetchRelatedVideosGraphQL: a, isLoading: u, onEscapeOrBack: c, tweets: i }) => {
                    ...
                    return o.createElement(s.nO, { namespace: { section: "suggestions" } }, o.createElement(h.Z, { "aria-label": void 0, autoRestoreFocus: !0, name: "related-videos", onEscapeOrBack: c, role: "grid", style: B.root, trackChildren: !0 }, o.createElement(h.Z, { "aria-label": void 0, name: "related-videos-fake-focus-trap", onFocus: y, role: "none" }), o.createElement(l.ZP, { size: "headline1", style: B.title, weight: "bold" }, f), o.createElement(r.Z, { onScroll: w, style: B.gridContainer }, o.createElement(p.Z, { autoFocus: !0, content: i, name: "related-videos-grid", onNearEnd: M, onSelectVideo: m, scrollOptions: k, width: 4 }))));
                });
        },
        971813: (e, d, a) => {
            a.d(d, { G: () => o });
        ...
        573359: (e, d, a) => {
            ...
            const t = (e) => e.tv?.relatedVideos.videos || [],
                ...
                h = b(({ onFocus: e, style: d, tweets: a }) => {
                    const n = (0, u.Z)(),
                        s = o.useCallback(() => {
                            e();
                        }, [e]);
        ...
        721152: (e, d, a) => {
            ...
            var o = a(202784),
                ...
                b = a(479890);
            const D = c().a9ae1e78,
                h = ({ focusable: e, onEscapeOrBack: d, onPress: a, showValue: l, value: u }) =>
                    o.createElement(
                        r.Z,
                        { style: p.root },
                        o.createElement(t.C, { "aria-label": void 0, focusable: e, name: b.U, onEscapeOrBack: d, onPress: a, role: "link", style: p.searchBar, withBackgroundStyle: !0, withBorderStyle: !1 }, ({ hasFocus: e }) => o.createElement(o.Fragment, null, o.createElement(i.default, { style: [p.icon, p.animated, e && p.iconFocused] }), o.createElement(n.ZP, { color: e ? "white" : "gray700", size: "body", style: p.animated, weight: "bold" }, l ? u : D))),
                    ),
        ...
        674546: (e, d, a) => {
            ...
            const p = i().ed170a6a;
            const S = function (e) {
                    const { formatLabel: d, min: a = 0, value: c = a, max: i, name: S, onArrowPress: m, step: y, fasterStep: M = y, fastestStep: w = y, onChange: v, onActive: f, withLabel: k, onMouseEnter: B, onMouseLeave: P, onMouseDown: I, ...g } = e,
                        [E, C] = r.useState(c),
                        T = r.useRef(),
                        V = E / i,
                        [R, Z] = r.useState(!1),
                                    ...
                                    case b.Qs:
                                        x || z(!0),
                                            ...
                                            W(
                                                ...
                                                })(E, $.current <= 20 ? y : $.current <= 40 ? M : w, d === b.Qs ? "RIGHT" : "LEFT", a, i),
                                            ),
                                            K();
                                        break;
                                    case b.WX:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TV-cf3bcfae.505ed8aa.js.map
