    ...
    ["bundle.TV-e96e9bea"],
    {
        ...
        305332: (e, a, d) => {
            ...
            const A = "tv-carousel",
                ...
                y = (e) => `${A}-${e}`,
                M = (e) => e.id,
                w = ({ autoFocus: e, categories: a, focusBoundaryDirections: d, isFocusBoundary: r, name: c, onArrowPress: A, onSelectVideo: w, playVideoPreview: v, returnToFirstElementOnEscape: k, withScrollRestoration: P = !0 }) => {
                    const B = (0, b.z)(),
                        { direction: I } = (0, i.Z)(),
                            ...
                            ({ index: e, item: a }) =>
                                o.createElement(
                                    ...
                                    o.createElement(D.Z, {
                                        ...
                                        name: y(e.toString()),
                                        onFocus: () => {
                                            e === C.length - 1 && B.scribe({ element: "tv-grid-with-categories", action: "reached_end" });
                                        },
                                        onSelectVideo: w,
                                        playVideoPreview: v,
                                        scrollOptions: m,
            ...
            const k = (e) => `${A}-${e}`,
                ...
                B = ({ autoFocus: e, categories: a, focusBoundaryDirections: d, handleNoriginArrowPress: r, isFocusBoundary: l, name: c, onArrowPress: A, onSelectVideo: m, playVideoPreview: y, returnToFirstElementOnEscape: M, withScrollRestoration: w = !0 }) => {
                    const f = o.useRef(null),
                        ...
                        z = o.useCallback(
                            (e) => {
                                ...
                                const r = B.current.get(`${E}.${k(d.toString())}`);
        ...
        406483: (e, a, d) => {
            ...
            const M = (e, a) => e.tv?.relatedVideos?.cursor,
                ...
                B = f(({ currentTweetId: e, cursor: a, fetchRelatedVideosGraphQL: d, isLoading: u, onEscapeOrBack: i, tweets: c }) => {
                    const S = (0, t.I0)(),
                        A = (0, n.useHistory)(),
                    ...
                    return o.createElement(s.nO, { namespace: { section: "suggestions" } }, o.createElement(h.Z, { "aria-label": void 0, autoRestoreFocus: !0, name: "related-videos", onEscapeOrBack: i, role: "grid", style: P.root, trackChildren: !0 }, o.createElement(h.Z, { "aria-label": void 0, name: "related-videos-fake-focus-trap", onFocus: y, role: "none" }), o.createElement(l.ZP, { size: "headline1", style: P.title, weight: "bold" }, v), o.createElement(r.Z, { onScroll: w, style: P.gridContainer }, o.createElement(p.Z, { autoFocus: !0, content: c, name: "related-videos-grid", onNearEnd: M, onSelectVideo: m, scrollOptions: k, width: 4 }))));
                });
        },
        971813: (e, a, d) => {
            d.d(a, { G: () => o });
        ...
        674546: (e, a, d) => {
            ...
            const p = c().ed170a6a;
            const S = function (e) {
                    const { formatLabel: a, min: d = 0, value: i = d, max: c, name: S, onArrowPress: m, step: y, fasterStep: M = y, fastestStep: w = y, onChange: f, onActive: v, withLabel: k, onMouseEnter: P, onMouseLeave: B, onMouseDown: I, ...g } = e,
                        [C, E] = r.useState(i),
                        T = r.useRef(),
                        V = C / c,
                        [R, x] = r.useState(!1),
        ...
        72845: (e, a, d) => {
            ...
            e.exports = function (e, a) {
                ...
                return (
                    ...
                    t(
                        function () {
                            if (!0 === P.current) return (P.current = !1), void ("NullQueryReference" !== m.kind && k(m.variables, { fetchPolicy: m.fetchPolicy, networkCacheConfig: m.networkCacheConfig }));
                            var a = h.current;
                            if (c.current) {
                                var d,
                                    r = (0, o.default)(a);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TV-e96e9bea.063ecb1a.js.map
