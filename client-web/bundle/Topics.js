    ...
    ["bundle.Topics", "bundle.AudioSpaceDetail"],
    {
        ...
        337523: (e, t, n) => {
            ...
            class F extends a.Component {
                ...
                render() {
                    ...
                    if (this.context.featureSwitches.isTrue("responsive_web_grok_05221996") && "news" === l?.id) return a.createElement(B, null);
                    const u = this._getModule(l, n?.tabs?.initialTabId, t, s),
                        m = this._getRefreshIntervalSecForCurrentTab(),
                        b = m ? 1e3 * m : void 0;
                    return a.createElement(h.nO, { namespace: this._getTimelineNamespace() }, a.createElement(x.Z, { entryConfiguration: e, module: u, pollingIntervalMsOverride: b, prerollDisplayLocation: o, refreshControl: r, renderEmptyState: i, renderUnavailable: d, title: c, withoutHeadroom: p }));
                }
            }
            F.contextType = P.rC;
            const O = R(F);
            ...
            const be = W.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                ...
                ye = (e) => {
                    const { TabBar: t, backLocation: n, documentTitle: o, entryConfiguration: d, fab: l, getTabLink: c, hasTabNavigation: f, history: w, initialFetchStatus: y, initialPageNamespace: E, logoButton: D, module: C, onBackClick: T, pageConfiguration: k, prerollDisplayLocation: M, renderEmptyState: _, renderUnavailable: S, rightControl: Z, selectedTabId: v, sidebarContent: N, timelinePrefix: P, title: B, withAppLinks: x, withBottomLoginSignupBar: A, withDeferredView: L, withOpenGraphMeta: R, withSearchBox: F, withTweetButton: H } = e,
                        ...
                        ee = q ? a.createElement(ge, { isHeaderOffscreen: !U, navBar: q, pageNamespace: Y, withAppLinks: x, withOpenGraphMeta: R }) : null,
                        te = L ? p.Z : a.Fragment,
                        ne = a.createElement(a.Fragment, null, J, a.createElement(te, null, a.createElement(O, { entryConfiguration: W, initialModule: C, prerollDisplayLocation: M, renderEmptyState: _, renderUnavailable: S, selectedTabId: v, timelinePrefix: P, title: B, withoutHeadroom: !0 }))),
                        ae = l ? a.createElement(u.Z, { component: i.Z, fab: l }, ne) : ne,
                        oe = c && f ? a.createElement(I, { getTabLink: c, module: C, selectedTabId: v }) : void 0;
                    return a.createElement(h.nO, { namespace: Y }, a.createElement(g.Z, null, a.createElement(m.Z, { TabBar: t, backLocation: n, documentTitle: o, history: w, logoButton: D, onBackClick: T, primaryContent: ae, rightControl: ee || Z, secondaryBar: oe, sidebarContent: N, subtitle: Q, title: J && U ? B : X, withBottomLoginSignupBar: A, withSearchBox: F, withTweetButton: H })));
                };
        ...
        642081: (e, t, n) => {
            ...
            const P = (0, w.Z)((e, t) => {
                ...
                B = (e) => (0, o.ju)(`https://x.com/i/topics/${e}`),
                x = (e) => `twitter://topics_timeline?id=${e}`,
                A = d().a2a3824a,
                L = d().b8533bac,
                R = d().g3e87c61,
                F = d().g02269ba,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.Topics.e9b7f92a.js.map
