        ...
        403556: (e, a, d) => {
            ...
            class w extends r.Component {
                ...
                render() {
                    ...
                    return r.createElement(m.Z, { "aria-label": a, "aria-selected": P, focusable: !!P, interactiveStyles: I, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? f.pill : f.link, u && P ? f.active : null, s ? (u ? f.compactPill : f.compactLink) : null, b ? f.roundedRect : null, B], withoutInteractiveStyles: h || u }, ({ isFocused: a, isHovered: t }) => r.createElement(c.Z, { style: u && f.flexGrow }, r.createElement(p.ZP, { size: h ? "headline2" : void 0, style: [f.text, { color: this._getTextColor(P, t, h, u) }, s && f.compactText, h && a && f.focusedText], weight: C }, e && r.createElement(e, { style: f.icon }), l, h || u ? null : r.createElement(c.Z, { style: P && [f.border, { backgroundColor: i.default.theme.colors[n] }] })), d ? r.createElement(D.Z, { count: d, standalone: !0, style: [f.badge, d >= 10 && f.multiDigitBadge, d >= 20 && f.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: A, withBorder: !1 }) : o ? r.createElement(D.Z, { pip: !0, standalone: !0, style: f.badgePip, textColor: "red500", unreadCountLabel: M, withBorder: !1 }) : null));
                }
            }
                        ...
                        h = r.useMemo(
                            () =>
                                t.filter(Boolean).map(({ label: a, viewType: l, ...n }, t) => {
                                    const s = D ? [g.linkRedesign, 0 === t && g.firstLinkRedesign, e && 0 === t && g.withNoPaddingStart] : void 0;
                                    return r.createElement(B, (0, o.Z)({ viewType: l }, n, { isCompact: d, isPillLink: i, isRoundedRect: c, isWebRedesign: D, style: s }), a);
                                }),
                            [e, d, i, c, D, t],
                        );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TrustedFriendsManagement.84f62b2a.js.map
