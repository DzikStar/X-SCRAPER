    ...
    ["bundle.TweetActivity"],
    {
        ...
        625661: (e, t, i) => {
            ...
            class p extends r.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: i, fixed: o, hideBackButton: s, isFullWidth: n, isLarge: c, leftControl: d, middleControl: p, position: u, rightControl: h, secondaryBar: m, style: b, subtitle: w, title: g, titleDomId: y, titleIconCell: f, titleIconCellSize: v, withBackground: k, withWideContainer: C } = this.props,
                        { isModal: x } = this.context,
                        S = s ? d : r.createElement(a.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        E = (function (e, t, i) {
                            return e && !(t && i);
                        })(!!k, x, !!m);
                    return r.createElement(r.Fragment, null, r.createElement(l.Z, { centerTitle: t, centeredLogo: i, isFullWidth: n, isLarge: c, leftControl: S, middleControl: p, position: _(u, x, o), rightControl: h, style: b, subtitle: w, title: g, titleDomId: y, titleIconCell: f, titleIconCellSize: v, withBackground: E, withWideContainer: C }), m || null);
                }
                render() {
        ...
        980407: (e, t, i) => {
            ...
            class u extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: i, backLocation: s, centerTitle: n, hideBackButton: a, history: l, isFullWidth: _, isLarge: p, middleControl: u, onBackClick: m, rightControl: b, secondaryBar: w, subtitle: g, title: y } = this.props,
                                { isModal: f } = this.context;
                            return r.createElement(o.Z, { style: f ? [h.childViewAppBarRoot, h.appBarZindex] : h.appBarZindex }, r.createElement(d.ZP, { backButtonType: i || (f ? "close" : "back"), backLocation: s, centerTitle: n, fixed: !f, hideBackButton: a, history: l, isFullWidth: _, isLarge: p, middleControl: u, onBackClick: m, ref: e, rightControl: b, secondaryBar: w, style: [f && h.appBarModal, t], subtitle: g, title: y, titleDomId: c.Q_ }));
                        }),
                ...
                render() {
                    ...
                    return r.createElement(l.Z, null, r.createElement(_.Z.Configure, { documentTitle: a, headerless: !0, title: m }), r.createElement(o.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [h.root, w && h.rootModal] }, !w && g, r.createElement(s.Z, { isFullWidth: c, isLarge: d, style: [h.container, w && h.containerModal, n] }, w ? r.createElement(p.Z, { style: h.viewport }, g, i) : i), t ? r.createElement(o.Z, { style: [h.bottomBarModal, !w && !b && h.bottomBarMobile] }, r.createElement(s.Z, { isFullWidth: c, isLarge: d }, t)) : null));
                }
            }
        ...
        774006: (e, t, i) => {
            ...
            const c = "search-",
                ...
                m = ({ query: e, searchMode: t = s.N3.Top, querySource: i, searchFilters: n, vertical: a, urtEndpointOptions: h, searchTimelinesGraphQLEnabled: m }) => {
                    const b = u(i),
                        w = n && n.peopleFilter ? "searcher_follows" : void 0,
                        g = w ? "-pf" : "",
                        y = n && n.locationFilter && !e.includes(d) ? `${e}${d}` : e,
                        f = { timelineId: `${c}${y}-${t}${b}${g}`, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchSearch, getEndpointParams: (e) => ({ ...h?.requestParams, q: y, social_filter: w, vertical: a, ...p[t], ...e }) }, context: "FETCH_SEARCH_TIMELINE", perfKey: "search", staleIntervalMs: t === s.N3.Live ? 5e3 : void 0, timelineType: "search" };
                    if (m) {
        ...
        394660: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, { ShowSimilarPostsScreen: () => z, default: () => $ });
            var r = i(202784),
                o = i(457311),
                s = i(782261),
                n = i(111677),
            ...
            const g = (0, b.Z)()
                ...
                y = a().fd67deaa,
                f = a().f9183bb6;
            const v = g(function (e) {
                    const { postId: t, scribeNamespace: i } = e,
                        o = ((e) => (0, h.ju)(`https://x.com/i/status/${e}/similar`))(t);
                    return r.createElement(m.S0, { scribeNamespace: i, url: o }, r.createElement(m.by, { label: y, type: "dm" }), r.createElement(m.by, { label: f, type: "copy" }));
                }),
                k = v;
            var C = i(644829),
                x = i(750085),
            ...
            class z extends r.Component {
                ...
                render() {
                    const { history: e, screenName: t, scribeNamespace: i, statusId: o, tweet: n } = this.props,
                        ...
                        m = r.createElement(k, { postId: o, scribeNamespace: i });
                    return r.createElement(p.Z, null, r.createElement(d.Z, { backLocation: `/${t}/status/${o}`, documentTitle: _, history: e, primaryContent: this._render(h, _, u), rightControl: m, sidebarContent: r.createElement(c.Z, null), title: _ }));
                }
            }
            z.contextType = _.rC;
            const $ = R(z);
        ...
        955875: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, { TweetActivityScreen: () => E, default: () => T });
            var r = i(202784),
                o = i(457311),
                s = i(111677),
                n = i.n(s),
            ...
            const h = (e, t) => t.match.params.statusId,
                ...
                S = { likes: () => r.createElement(o.Z, { header: v, message: k }), retweets: () => r.createElement(o.Z, { header: y, message: f }) };
            function E({ activityType: e, history: t, screenName: i, statusId: o, urtModule: s }) {
                const n = `/${i.toLowerCase()}/status/${o}`;
                return s ? r.createElement(a.Z, { backLocation: n, history: t, title: x[e] }, r.createElement(l.Z, { loadingAccessibilityLabel: C[e], module: s, renderEmptyState: S[e], title: x[e] })) : r.createElement(c.Z, { to: n });
            }
            const T = g(E);
        },
        913162: (e, t, i) => {
            "use strict";
            i.r(t), i.d(t, { TweetEngagementsScreen: () => z, default: () => $ });
            i(136728);
            var r = i(202784),
                o = i(457311),
                s = i(111677),
                ...
                k = i(481918),
                C = i(919022);
            const x = { likes: v.Z, retweets: k.Z, quotes: void 0 },
                ...
                constructor(...e) {
                    super(...e),
                        (this._render = () => {
                            ...
                            if ("quotes" === e) return r.createElement(u.Z, { emptyStateComponent: A(0, e), fetchOptions: N, query: s, querySrc: b.Z.TweetDetailQuoteTweet, searchMode: m.N3.Top });
                            return o ? r.createElement(h.Z, { loadingAccessibilityLabel: B, module: o, renderEmptyState: () => A(0, e), title: R[e] }) : r.createElement(w.Z, { to: n });
                        });
                }
                _isOwnTweet() {
        ...
        403556: (e, t, i) => {
            ...
            class v extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: i, badgePip: r, children: s, color: n, isActive: c, isCompact: d, isPillLink: _, isRoundedRect: p, isWebRedesign: m, retainScrollPosition: v, style: C, to: x } = this.props,
                        { location: S } = this.state,
                        E = x ? this._getMemoizedLink(x, v) : void 0,
                        T = c ? c(x) : S?.pathname === E?.pathname,
                        Z = b.Z.generate({ backgroundColor: "transparent", color: a.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: _ ? k.pillHoverStyle.backgroundColor : void 0 }),
                        I = m ? "medium" : T ? "bold" : "medium";
                    return o.createElement(w.Z, { "aria-label": t, "aria-selected": T, focusable: !!T, interactiveStyles: Z, link: E, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(_ ? [k.pillStyle] : [k.link]), ...(_ && T ? [k.pillActiveStyle] : []), d ? (_ ? k.compactPill : k.compactLink) : null, p ? k.roundedRect : null, C], withoutInteractiveStyles: m }, ({ isFocused: t, isHovered: c }) => o.createElement(l.Z, { style: _ && k.flexGrow }, o.createElement(u.ZP, { size: m ? "headline2" : void 0, style: [k.text, { color: this._getTextColor(T, c, m, _) }, d && k.compactText, m && t && k.focusedText, _ && k.pillTextStyle, _ && T && k.pillActiveTextStyle, _ && c && k.pillHoverTextStyle], weight: I }, e && o.createElement(e, { style: k.icon }), s, m || _ ? null : o.createElement(l.Z, { style: T && [k.border, { backgroundColor: a.default.theme.colors[n] }] })), i ? o.createElement(h.Z, { count: i, standalone: !0, style: [k.badge, i >= 10 && k.multiDigitBadge, i >= 20 && k.truncatedCountBadge], truncatedCountFormatter: f, unreadCountLabel: g, withBorder: !1 }) : r ? o.createElement(h.Z, { pip: !0, standalone: !0, style: k.badgePip, textColor: "red500", unreadCountLabel: y, withBorder: !1 }) : null));
                }
            }
            ...
            const k = a.default.create((e) => ({
                ...
                S = ({ alignFirstItem: e, "aria-label": t, isCompact: i, isPillLink: a, isRoundedRect: l, links: c, style: d, visibleItemIndex: _ }) => {
                    const p = c
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        m = o.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: s, ...n }, c) => {
                                    ...
                                    return o.createElement(C, (0, r.Z)({ viewType: s }, n, { isCompact: i, isPillLink: a, isRoundedRect: l, isWebRedesign: h, style: d }), t);
                                }),
                            [e, i, a, l, h, c],
                        );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TweetActivity.56a5303a.js.map
