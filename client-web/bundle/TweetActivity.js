    ...
    ["bundle.TweetActivity"],
    {
        ...
        625661: (e, t, r) => {
            ...
            class p extends i.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: r, fixed: o, hideBackButton: s, isFullWidth: n, isLarge: c, leftControl: d, middleControl: p, position: u, rightControl: m, secondaryBar: h, style: b, subtitle: w, title: g, titleDomId: y, titleIconCell: f, titleIconCellSize: k, withBackground: v, withWideContainer: C } = this.props,
                        { isModal: x } = this.context,
                        S = s ? d : i.createElement(a.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        E = (function (e, t, r) {
                            return e && !(t && r);
                        })(!!v, x, !!h);
                    return i.createElement(i.Fragment, null, i.createElement(l.Z, { centerTitle: t, centeredLogo: r, isFullWidth: n, isLarge: c, leftControl: S, middleControl: p, position: _(u, x, o), rightControl: m, style: b, subtitle: w, title: g, titleDomId: y, titleIconCell: f, titleIconCellSize: k, withBackground: E, withWideContainer: C }), h || null);
                }
                render() {
        ...
        980407: (e, t, r) => {
            ...
            class u extends i.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: r, backLocation: s, centerTitle: n, hideBackButton: a, history: l, isFullWidth: _, isLarge: p, middleControl: u, onBackClick: h, rightControl: b, secondaryBar: w, subtitle: g, title: y } = this.props,
                                { isModal: f } = this.context;
                            return i.createElement(o.Z, { style: f ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, i.createElement(d.ZP, { backButtonType: r || (f ? "close" : "back"), backLocation: s, centerTitle: n, fixed: !f, hideBackButton: a, history: l, isFullWidth: _, isLarge: p, middleControl: u, onBackClick: h, ref: e, rightControl: b, secondaryBar: w, style: [f && m.appBarModal, t], subtitle: g, title: y, titleDomId: c.Q_ }));
                        }),
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: r, containerStyle: n, documentTitle: a, isFullWidth: c, isLarge: d, renderHeader: u, title: h, withoutBottomBarMobile: b } = this.props,
                        { isModal: w } = this.context,
                        g = u ? u(this._renderChildViewAppBar()) : this._renderChildViewAppBar();
                    return i.createElement(l.Z, null, i.createElement(_.Z.Configure, { documentTitle: a, headerless: !0, title: h }), i.createElement(o.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [m.root, w && m.rootModal] }, !w && g, i.createElement(s.Z, { isFullWidth: c, isLarge: d, style: [m.container, w && m.containerModal, n] }, w ? i.createElement(p.Z, { style: m.viewport }, g, r) : r), t ? i.createElement(o.Z, { style: [m.bottomBarModal, !w && !b && m.bottomBarMobile] }, i.createElement(s.Z, { isFullWidth: c, isLarge: d }, t)) : null));
                }
            }
        ...
        774006: (e, t, r) => {
            ...
            const c = "search-",
                ...
                h = ({ query: e, searchMode: t = s.N3.Top, querySource: r, searchFilters: n, vertical: a, urtEndpointOptions: m, searchTimelinesGraphQLEnabled: h }) => {
                    const b = u(r),
                        w = n && n.peopleFilter ? "searcher_follows" : void 0,
                        g = w ? "-pf" : "",
                        y = n && n.locationFilter && !e.includes(d) ? `${e}${d}` : e,
                        f = { timelineId: `${c}${y}-${t}${b}${g}`, network: { getEndpoint: (e) => e.withEndpoint(i.Z).fetchSearch, getEndpointParams: (e) => ({ ...m?.requestParams, q: y, social_filter: w, vertical: a, ...p[t], ...e }) }, context: "FETCH_SEARCH_TIMELINE", perfKey: "search", staleIntervalMs: t === s.N3.Live ? 5e3 : void 0, timelineType: "search" };
                    if (h) {
        ...
        394660: (e, t, r) => {
            ...
            const k = g(function (e) {
                    ...
                    return i.createElement(h.S0, { scribeNamespace: r, url: o }, i.createElement(h.by, { label: y, type: "dm" }), i.createElement(h.by, { label: f, type: "copy" }));
                }),
                v = k;
            var C = r(644829),
                x = r(750085),
            ...
            class $ extends i.Component {
                ...
                render() {
                    const { history: e, screenName: t, scribeNamespace: r, statusId: o, tweet: n } = this.props,
                        ...
                        h = i.createElement(v, { postId: o, scribeNamespace: r });
                    return i.createElement(p.Z, null, i.createElement(d.Z, { backLocation: `/${t}/status/${o}`, documentTitle: _, history: e, primaryContent: this._render(m, _, u), rightControl: h, sidebarContent: i.createElement(c.Z, null), title: _ }));
                }
            }
            $.contextType = _.rC;
            const W = R($);
                ...
                constructor(...e) {
                    super(...e),
                        (this._render = () => {
                            ...
                            if ("quotes" === e) return i.createElement(u.Z, { emptyStateComponent: A(0, e), fetchOptions: M, query: s, querySrc: b.Z.TweetDetailQuoteTweet, searchMode: h.N3.Top });
                            return o ? i.createElement(m.Z, { loadingAccessibilityLabel: B, module: o, renderEmptyState: () => A(0, e), title: R[e] }) : i.createElement(w.Z, { to: n });
                        });
                }
                _isOwnTweet() {
        ...
        403556: (e, t, r) => {
            ...
            class k extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: r, badgePip: i, children: s, color: n, isActive: c, isCompact: d, isPillLink: _, isRoundedRect: p, isWebRedesign: h, retainScrollPosition: k, style: C, to: x } = this.props,
                        ...
                        I = h ? "medium" : T ? "bold" : "medium";
                    return o.createElement(w.Z, { "aria-label": t, "aria-selected": T, focusable: !!T, interactiveStyles: Z, link: E, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(_ ? [v.pillStyle] : [v.link]), ...(_ && T ? [v.pillActiveStyle] : []), d ? (_ ? v.compactPill : v.compactLink) : null, p ? v.roundedRect : null, C], withoutInteractiveStyles: h }, ({ isFocused: t, isHovered: c }) => o.createElement(l.Z, { style: _ && v.flexGrow }, o.createElement(u.ZP, { size: h ? "headline2" : void 0, style: [v.text, { color: this._getTextColor(T, c, h, _) }, d && v.compactText, h && t && v.focusedText, _ && v.pillTextStyle, _ && T && v.pillActiveTextStyle, _ && c && v.pillHoverTextStyle], weight: I }, e && o.createElement(e, { style: v.icon }), s, h || _ ? null : o.createElement(l.Z, { style: T && [v.border, { backgroundColor: a.default.theme.colors[n] }] })), r ? o.createElement(m.Z, { count: r, standalone: !0, style: [v.badge, r >= 10 && v.multiDigitBadge, r >= 20 && v.truncatedCountBadge], truncatedCountFormatter: f, unreadCountLabel: g, withBorder: !1 }) : i ? o.createElement(m.Z, { pip: !0, standalone: !0, style: v.badgePip, textColor: "red500", unreadCountLabel: y, withBorder: !1 }) : null));
                }
            }
                        ...
                        h = o.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: s, ...n }, c) => {
                                    ...
                                    return o.createElement(C, (0, i.Z)({ viewType: s }, n, { isCompact: r, isPillLink: a, isRoundedRect: l, isWebRedesign: m, style: d }), t);
                                }),
                            [e, r, a, l, m, c],
                        );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TweetActivity.d87befba.js.map
