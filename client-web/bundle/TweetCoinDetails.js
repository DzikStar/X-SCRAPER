            ...
            class p extends a.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: l, fixed: n, hideBackButton: r, isFullWidth: i, isLarge: c, leftControl: d, middleControl: p, position: m, rightControl: g, secondaryBar: y, style: h, subtitle: k, title: _, titleDomId: b, titleIconCell: w, titleIconCellSize: f, withBackground: Z, withWideContainer: E } = this.props,
                        ...
                        L = r ? d : a.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        F = (function (e, t, l) {
                            return e && !(t && l);
                        })(!!Z, T, !!y);
                    return a.createElement(a.Fragment, null, a.createElement(o.Z, { centerTitle: t, centeredLogo: l, isFullWidth: i, isLarge: c, leftControl: L, middleControl: p, position: u(m, T, n), rightControl: g, style: h, subtitle: k, title: _, titleDomId: b, titleIconCell: w, titleIconCellSize: f, withBackground: F, withWideContainer: E }), y || null);
                }
                render() {
            ...
            const U = B().fbb7764b,
                ...
                ee = (e) => {
                    const { history: t } = e,
                        ...
                        i = b.useCallback((e) => b.createElement(w.Z, { style: te.title }, b.createElement(v.default, null), b.createElement(f.ZP, { size: "headline1", style: te.spacing, weight: "bold" }, Q({ count: e }))), []),
                        s = b.useCallback(
                            ({ data: e, fetchStatus: l, retry: n }) => {
                                ...
                                if (l === P.ZP.LOADED) {
                                    ...
                                    return b.createElement(x.Z, { backButtonType: "close", history: t, middleControl: i(p), onBackClick: a }, b.createElement(w.Z, { style: te.root }, d ? b.createElement(w.Z, null, b.createElement(T.Z, { text: O }), J(o) ? b.createElement(N, { coins: o || 0, isAnonymous: !1, user: u }) : null, J(s) ? b.createElement(N, { coins: s || 0, isAnonymous: !0, isLoggedinUser: !0, user: u }) : null) : null, c ? b.createElement(w.Z, null, b.createElement(T.Z, { text: G }), b.createElement(S.Z, { cacheKey: "awardsSentByOthers", identityFunction: Y, items: c, renderer: r, withoutHeadroom: !0 })) : null));
                                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TweetCoinDetails.b635affa.js.map
