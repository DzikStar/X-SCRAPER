(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.TweetEditHistory"],
    {
        ...
        119260: (e, t, _) => {
            "use strict";
            _.r(t), _.d(t, { TweetEditHistoryScreen: () => A, default: () => Z });
            var n = _(202784),
                i = _(325686),
                a = _(457311),
                r = _(392237),
            ...
            const y = (0, h.Z)((e) => (0, v.Z)({ timelineId: `tweet-edit-history-${e}`, network: { getEndpoint: (e) => e.withEndpoint(g.Z).fetchEditHistory, getEndpointParams: () => ({ tweetId: e }) }, formatResponse: f.Z, context: "FETCH_EDIT_HISTORY_TIMELINE", perfKey: "editHistoryGraphQL" })),
                ...
                C = () => n.createElement(a.Z, { header: T });
            function A(e) {
                const { history: t, urtModule: _ } = e,
                    a = n.createElement(i.Z, { style: L.root }, n.createElement(b.Z, { loadingAccessibilityLabel: q, module: _, renderEmptyState: C, title: E }));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TweetEditHistory.1356851a.js.map
