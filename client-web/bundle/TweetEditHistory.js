    ...
    ["bundle.TweetEditHistory"],
    {
        ...
        119260: (e, t, _) => {
            ...
            var n = _(202784),
                ...
                v = _(750085),
                f = _(218951);
            const y = (0, h.Z)((e) => (0, f.Z)({ timelineId: `tweet-edit-history-${e}`, network: { getEndpoint: (e) => e.withEndpoint(g.Z).fetchEditHistory, getEndpointParams: () => ({ tweetId: e }) }, formatResponse: v.Z, context: "FETCH_EDIT_HISTORY_TIMELINE", perfKey: "editHistoryGraphQL" })),
                ...
                L = () => n.createElement(a.Z, { header: E });
            function A(e) {
                const { history: t, urtModule: _ } = e,
                    a = n.createElement(i.Z, { style: Z.root }, n.createElement(b.Z, { loadingAccessibilityLabel: I, module: _, renderEmptyState: L, title: x }));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TweetEditHistory.009df7ba.js.map
