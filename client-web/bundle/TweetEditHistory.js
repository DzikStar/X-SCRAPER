    ...
    ["bundle.TweetEditHistory"],
    {
        ...
        119260: (e, t, _) => {
            ...
            const y = (0, h.Z)((e) => (0, v.Z)({ timelineId: `tweet-edit-history-${e}`, network: { getEndpoint: (e) => e.withEndpoint(g.Z).fetchEditHistory, getEndpointParams: () => ({ tweetId: e }) }, formatResponse: f.Z, context: "FETCH_EDIT_HISTORY_TIMELINE", perfKey: "editHistoryGraphQL" })),
                ...
                L = () => n.createElement(a.Z, { header: T });
            function S(e) {
                const { history: t, urtModule: _ } = e,
                    a = n.createElement(i.Z, { style: Z.root }, n.createElement(b.Z, { loadingAccessibilityLabel: q, module: _, renderEmptyState: L, title: I }));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TweetEditHistory.10a2d44a.js.map
