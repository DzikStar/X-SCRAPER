(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.TwitterArticles-6107ac1a", "loader.FeedbackSheet"],
    {
        ...
        37475: (e, t, a) => {
            "use strict";
            a.d(t, { d: () => n });
            const n = Object.freeze({ Public: "Public", Subscribers: "Subscribers" });
        },
        484636: (e, t, a) => {
            "use strict";
            a.d(t, { Z: () => Z });
        ...
        690822: (e, t, a) => {
            ...
            const Z = [
                ...
                B = ({ code: e = "", language: t = "", onAddCode: a, onChange: n }) => {
                    ...
                    return r.createElement(_.Z, { style: D.content }, r.createElement(_.Z, { style: R ? D.rowNarrow : D.row }, h ? r.createElement(E.Z, { onChange: z, onEnter: v.Z, onSelect: j, value: p }) : r.createElement(f.ZP, { label: M, onChange: F, options: Z, style: [D.input, D.rowItem], value: d }), r.createElement(_.Z, { style: D.actionButtons }, r.createElement(g.ZP, { disabled: !l.trim(), onClick: () => c(!s), size: "small", type: "brandText" }, s ? A : x), r.createElement(g.ZP, { disabled: !l.trim(), onClick: q, type: "brandFilled" }, e ? P : I))), s ? r.createElement(_.Z, { style: [D.preview, !R && D.maxHeight] }, r.createElement(w.Z, { code: l, language: d })) : r.createElement(y.Z, { autoComplete: "off", errorText: T({ count: B }), label: S, maxLength: B, multiline: !0, name: "code-input", numberOfLines: 15, onChange: L, style: D.input, validLength: B, value: l }));
                },
            ...
            const z = d().e554f642,
                j = d().fa524058,
                q = d().d4ab68e2,
                G = ({ onCancel: e, onConfirm: t }) => r.createElement(_.Z, { style: N.overlay }, r.createElement(_.Z, { style: N.overlayContent }, r.createElement(L.Z, { animateMount: !0, show: !0 }, r.createElement(_.Z, { style: N.actionBar }, r.createElement(F.ZP, { style: N.confirmationLabel, weight: "bold" }, z), r.createElement(_.Z, { style: N.actionBarButtonContainer }, r.createElement(g.ZP, { onClick: e, size: "small", type: "primaryOutlined" }, j), r.createElement(g.ZP, { onClick: t, size: "small", type: "destructiveOutlined" }, q))))), r.createElement(_.Z, { style: N.mask })),
            ...
            const ne = (e) => (0, te.l4)(e).shouldAutoPlayGif,
                ...
                se = re((e) => {
                    const { effectiveAutoplay: t, isDataSaverEnabled: a, onAddGif: n, shouldAutoPlayGif: i } = e,
                        ...
                        b = !a,
                        h = t ?? (0, K.i)(),
                        f = (i || (0, X.Z)(h)) && !W.Z.reducedMotionEnabled,
                        y = (e) => {
                    ...
                    let k;
                    return (k = s ? r.createElement(Y.Z, { gifSearchKey: V.AD.NoteComposition, onClickGif: n, query: s, shouldAutoPlayGif: f }) : l ? r.createElement(J.Z, { category: l, gifSearchKey: V.AD.NoteComposition, onClickGif: n, shouldAutoPlayGif: f }) : r.createElement($.ZP, { gifSearchKey: V.AD.NoteComposition, onClickCategory: y })), r.createElement(_.Z, null, E, k);
                });
            var ce = a(366929),
                de = a(40610),
                ue = a(540985);
            const pe = d().hf6f2914,
                ...
                ye = ({ onAddLaTeX: e, onChange: t, tex: a = "" }) => {
                    ...
                    return r.createElement(_.Z, { style: ve.content }, r.createElement(_.Z, { style: ve.actionButtons }, r.createElement(g.ZP, { disabled: f, onClick: b, type: "brandFilled" }, a ? he : be), r.createElement(g.ZP, { disabled: h, onClick: () => s(!o), size: "small", type: "brandText" }, o ? me : pe)), c ? r.createElement(de.Z.Danger, { text: ge, withIcon: !0 }) : null, o ? r.createElement(_.Z, { style: [ve.preview, !u && ve.maxHeight] }, r.createElement(ue.Z, { displayMode: !0, onError: v, tex: n })) : r.createElement(y.Z, { autoComplete: "off", errorText: fe({ count: p }), label: _e, maxLength: p, multiline: !0, name: "tex-input", numberOfLines: 15, onChange: m, style: ve.input, validLength: p, value: n }));
                },
            ...
            const Ze = d().c80940f4,
                ...
                Me = ({ markdown: e = "", onAddMarkdown: t, onChange: a }) => {
                    ...
                    return r.createElement(
                        ...
                        (() => {
                            switch (o) {
                                case Se.MARKDOWN:
                                    return r.createElement(y.Z, { autoComplete: "off", errorText: Pe({ count: d }), label: "Add markdown here", maxLength: d, multiline: !0, name: "markdown-input", numberOfLines: 15, onChange: m, style: Te.input, validLength: d, value: n });
                                case Se.PREVIEW:
            ...
            const De = d().ebfd8ac6,
                ...
                He = (e) => {
                    const { attachmentType: t, codeLanguage: a, markdown: o, onAddGif: s, onAddLaTeX: c, onAddMarkdown: d, onAddMedia: u, onAddTweets: _, onClose: f, tex: g } = e,
                        ...
                        T = r.useMemo(() => ({ withKeyboardNavigation: !x, onBackClick: I ? S : void 0 }), [I, x]);
                    return r.createElement(
                        l.Z,
                        (0, n.Z)(
                            {
                                ...
                                style: [Ne.sheet, Z && Ne.sheetNarrow],
                                title: De,
                            },
                            T,
                        ),
                        r.createElement(
                            ...
                            (() => {
                                switch (t) {
                                    case Be.Q.Media:
                                        return r.createElement(m.Z, { acceptGifs: !0, acceptVideo: !0, borderRadius: b.A.MEDIUM, currentContent: Qe, description: Re, icon: We, maskStyle: Ne.mediaPickerMaskStyle, multiple: !0, onAddMediaFiles: u, withDragDrop: !0 });
                                    case Be.Q.GIFs:
                                    ...
                                    case Be.Q.Markdown:
                                        return r.createElement(Me, { markdown: o, onAddMarkdown: d, onChange: P });
                                    case Be.Q.Code:
                                        return r.createElement(R, { code: o, language: a, onAddCode: d, onChange: P });
                                    case Be.Q.LaTeX:
                                        return r.createElement(Ce, { onAddLaTeX: c, onChange: P, tex: g });
                                    default:
                                        return null;
                                }
                            })(),
            ...
            const m = a.p + "MarchMadnessBannerDark.42aa2dea.png",
                ...
                f = ({ buttonOnSameLine: e, link: t, occasion: a, styleOverrides: u, withBackgroundImage: p }) => {
                    ...
                    const y = () => {
                        ...
                        Z = v ? i.default.theme.colors[v] : i.default.theme.colors.gray0,
                        x = k ? i.default.theme.colors[k] : i.default.theme.colors.gray900,
                    ...
                    return p ? n.createElement(l.Z, { interactiveStyles: null, link: t, onPress: y, style: g.bannerContainer }, n.createElement(o.Z, { resizeMode: "contain", source: { uri: "light" === i.default.theme.paletteName ? I.image.lightMode : I.image.darkMode }, style: { height: 85 } })) : n.createElement(r.Z, { style: [g.card, { backgroundColor: Z }, { maxWidth: w }, { marginBottom: A }], testID: "popupCard" }, n.createElement(r.Z, { style: e ? g.horizontalContent : g.verticalContent }, n.createElement(r.Z, { style: e ? g.textContainer : null }, n.createElement(s.ZP, { size: "headline2", style: [g.popupTitle, { alignSelf: "flex-start" }], weight: "bold" }, I.header), n.createElement(s.ZP, { size: "subtext1", style: [g.popupDescription, { color: x }] }, I.description, " ", e ? null : I.legalDisclaimer)), n.createElement(r.Z, { style: g.buttonContainer }, n.createElement(c.ZP, { backgroundColor: "light" === i.default.theme.paletteName ? "orange300" : "orange600", borderColor: "transparent", link: t, onClick: y, size: "medium", style: [g.popupButton, { width: C }] }, I.buttonText), e && n.createElement(s.ZP, { size: "subtext3", style: [g.legalDisclaimer, { color: x }] }, I.legalDisclaimer))));
                },
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getMemoizedProcessedActionItems = (0, s.Z)((e, t, a, n) =>
                            e.reduce((e, { Icon: r, confirmation: i, disabled: l, excludeFromActionMenu: o, isEmphasized: s, link: c, onClick: d, subText: u, testID: p, text: m, withCancelButton: b }, h) => {
                                if (!o) {
                                    const o = d
                                        ? () => {
                                        ...
                                        : a;
                                    e.push({ disabled: l, Icon: r, isEmphasized: s, testID: p, subText: u, text: m, onClick: o, link: c, withBottomBorder: t && t.includes(h) });
                                }
                                return e;
                            }, []),
                        ));
        ...
        290402: (e, t, a) => {
            ...
            const u = c().aa6e3300,
                p = ({ retryMessage: e, ...t }, a) => {
                    ...
                    return r.createElement(l.Z, (0, n.Z)({}, t, { icon: o ? void 0 : r.createElement(d.default, { style: m.icon }), retryMessage: o ? e : u }));
                },
        ...
        850496: (e, t, a) => {
            ...
            class C extends n.Component {
                render() {
                    ...
                    return n.createElement(r.Z, { style: [E.container, p, w[e]] }, m && c ? n.createElement(l.ZP, { onFilesAdded: c, style: [E.dragDropContainer, w[e]] }, h) : h);
                }
                _renderMediaRemove() {
        ...
        873637: (e, t, a) => {
            ...
            class b extends r.Component {
                ...
                _renderCropper() {
                    ...
                    return c ? r.createElement(i.Z, { style: h.cropper }, r.createElement(o.Z, { circle: this.props.circle, defaultAspectRatio: (a && a.aspectRatio) || (d && d.aspectRatio) || t, defaultCropData: a || d, image: { src: c.url, width: u.width, height: u.height }, ref: e, withAspectRatioOptions: l, withZoomControl: s })) : null;
                }
            }
        ...
        662678: (e, t, a) => {
            ...
            function r(e, t) {
                return e.reduce(
                    (a, n, r) => {
                        const i = t ? t(n, r, e) : !!n;
                        return i && a[0].push(n), !i && a[1].push(n), a;
                    },
                    [[], []],
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterArticles-6107ac1a.7069acca.js.map
