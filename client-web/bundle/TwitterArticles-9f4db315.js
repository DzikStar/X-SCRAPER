        ...
        690822: (e, t, a) => {
            ...
            const Z = [
                ...
                B = ({ code: e = "", language: t = "", onAddCode: a, onChange: n }) => {
                    ...
                    return r.createElement(h.Z, { style: D.content }, r.createElement(h.Z, { style: L ? D.rowNarrow : D.row }, _ ? r.createElement(E.Z, { onChange: j, onEnter: v.Z, onSelect: q, value: p }) : r.createElement(f.ZP, { label: R, onChange: F, options: Z, style: [D.input, D.rowItem], value: d }), r.createElement(h.Z, { style: D.actionButtons }, r.createElement(g.ZP, { disabled: !l.trim(), onClick: () => c(!s), size: "small", type: "brandText" }, s ? A : x), r.createElement(g.ZP, { disabled: !l.trim(), onClick: Q, type: "brandFilled" }, e ? P : I))), s ? r.createElement(h.Z, { style: [D.preview, !L && D.maxHeight] }, r.createElement(w.Z, { code: l, language: d })) : r.createElement(y.Z, { autoComplete: "off", errorText: T({ count: B }), label: S, maxLength: B, multiline: !0, name: "code-input", numberOfLines: 15, onChange: M, style: D.input, validLength: B, value: l }));
                },
            ...
            const j = d().e554f642,
                q = d().fa524058,
                Q = d().d4ab68e2,
                G = ({ onCancel: e, onConfirm: t }) => r.createElement(h.Z, { style: z.overlay }, r.createElement(h.Z, { style: z.overlayContent }, r.createElement(M.Z, { animateMount: !0, show: !0 }, r.createElement(h.Z, { style: z.actionBar }, r.createElement(F.ZP, { style: z.confirmationLabel, weight: "bold" }, j), r.createElement(h.Z, { style: z.actionBarButtonContainer }, r.createElement(g.ZP, { onClick: e, size: "small", type: "primaryOutlined" }, q), r.createElement(g.ZP, { onClick: t, size: "small", type: "destructiveOutlined" }, Q))))), r.createElement(h.Z, { style: z.mask })),
            ...
            const ne = (e) => (0, te.l4)(e).shouldAutoPlayGif,
                ...
                se = re((e) => {
                    const { effectiveAutoplay: t, isDataSaverEnabled: a, onAddGif: n, shouldAutoPlayGif: i } = e,
                        ...
                        b = !a,
                        _ = t ?? (0, K.i)(),
                        f = (i || (0, X.Z)(_)) && !H.Z.reducedMotionEnabled,
                        y = (e) => {
                    ...
                    return r.createElement(
                        ...
                        (() => {
                            switch (o) {
                                ...
                                case Se.PREVIEW:
                                    return r.createElement(h.Z, { style: [Te.preview, !c && Te.maxHeight] }, r.createElement(Ee.Z, { markdownText: n }));
                                default:
                                    return null;
                            }
                        })(),
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            (() => {
                                switch (t) {
                                    case Be.Q.Media:
                                        return r.createElement(m.Z, { acceptGifs: !0, acceptVideo: !0, borderRadius: b.A.MEDIUM, currentContent: Ne, description: Le, icon: He, maskStyle: ze.mediaPickerMaskStyle, multiple: !0, onAddMediaFiles: u, withDragDrop: !0 });
                                    case Be.Q.GIFs:
                                    ...
                                    case Be.Q.Markdown:
                                        return r.createElement(Re, { markdown: o, onAddMarkdown: d, onChange: P });
                                    case Be.Q.Code:
                                        return r.createElement(L, { code: o, language: a, onAddCode: d, onChange: P });
                                    case Be.Q.LaTeX:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterArticles-9f4db315.5842763a.js.map
