        ...
        690822: (e, t, a) => {
            ...
            const Z = [
                ...
                R = ({ code: e = "", language: t = "", onAddCode: a, onChange: n }) => {
                    ...
                    return l.createElement(h.Z, { style: M.content }, l.createElement(h.Z, { style: D ? M.rowNarrow : M.row }, _ ? l.createElement(E.Z, { onChange: j, onEnter: y.Z, onSelect: F, value: p }) : l.createElement(f.ZP, { label: B, onChange: q, options: Z, style: [M.input, M.rowItem], value: d }), l.createElement(h.Z, { style: M.actionButtons }, l.createElement(g.ZP, { disabled: !i.trim(), onClick: () => c(!s), size: "small", type: "brandText" }, s ? A : x), l.createElement(g.ZP, { disabled: !i.trim(), onClick: N, type: "brandFilled" }, e ? S : P))), s ? l.createElement(h.Z, { style: [M.preview, !D && M.maxHeight] }, l.createElement(w.Z, { code: i, language: d })) : l.createElement(v.Z, { autoComplete: "off", errorText: I({ count: R }), label: T, maxLength: R, multiline: !0, name: "code-input", numberOfLines: 15, onChange: L, style: M.input, validLength: R, value: i }));
                },
            ...
            const j = d().e554f642,
                F = d().fa524058,
                N = d().d4ab68e2,
                H = ({ onCancel: e, onConfirm: t }) => l.createElement(h.Z, { style: z.overlay }, l.createElement(h.Z, { style: z.overlayContent }, l.createElement(L.Z, { animateMount: !0, show: !0 }, l.createElement(h.Z, { style: z.actionBar }, l.createElement(q.ZP, { style: z.confirmationLabel, weight: "bold" }, j), l.createElement(h.Z, { style: z.actionBarButtonContainer }, l.createElement(g.ZP, { onClick: e, size: "small", type: "primaryOutlined" }, F), l.createElement(g.ZP, { onClick: t, size: "small", type: "destructiveOutlined" }, N))))), l.createElement(h.Z, { style: z.mask })),
            ...
            const ne = (e) => (0, te.l4)(e).shouldAutoPlayGif,
                ...
                se = le((e) => {
                    const { effectiveAutoplay: t, isDataSaverEnabled: a, onAddGif: n, shouldAutoPlayGif: r } = e,
                        ...
                        b = !a,
                        _ = t ?? (0, K.i)(),
                        f = (r || (0, X.Z)(_)) && !G.Z.reducedMotionEnabled,
                        v = (e) => {
            ...
            const Ze = d().c80940f4,
                ...
                Pe = d().h3701ffe,
                Se = d().i3128619,
                Te = Object.freeze({ MARKDOWN: Ze, PREVIEW: xe }),
            ...
            const Me = d().ebfd8ac6,
                ...
                We = l.createElement(s.Z, { ratio: o.default.theme.aspectRatios.landscape }),
                Ge = l.createElement(u.default, null),
                Ve = (e) => {
                    ...
                    return l.createElement(
                        ...
                        l.createElement(
                            ...
                            (() => {
                                switch (t) {
                                    case Re.Q.Media:
                                        return l.createElement(m.Z, { acceptGifs: !0, acceptVideo: !0, borderRadius: b.A.MEDIUM, currentContent: We, description: De, icon: Ge, maskStyle: ze.mediaPickerMaskStyle, multiple: !0, onAddMediaFiles: u, withDragDrop: !0 });
                                    case Re.Q.GIFs:
                                    ...
                                    case Re.Q.Code:
                                        return l.createElement(D, { code: o, language: a, onAddCode: d, onChange: S });
                                    case Re.Q.LaTeX:
