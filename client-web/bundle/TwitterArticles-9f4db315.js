        ...
        690822: (e, t, a) => {
            ...
            const x = [
                ...
                D = ({ code: e = "", language: t = "", onAddCode: a, onChange: n }) => {
                    ...
                    return l.createElement(h.Z, { style: R.content }, l.createElement(h.Z, { style: M ? R.rowNarrow : R.row }, _ ? l.createElement(E.Z, { onChange: F, onEnter: y.Z, onSelect: q, value: p }) : l.createElement(f.ZP, { label: B, onChange: j, options: x, style: [R.input, R.rowItem], value: d }), l.createElement(h.Z, { style: R.actionButtons }, l.createElement(g.ZP, { disabled: !i.trim(), onClick: () => c(!s), size: "small", type: "brandText" }, s ? A : Z), l.createElement(g.ZP, { disabled: !i.trim(), onClick: z, type: "brandFilled" }, e ? T : P))), s ? l.createElement(h.Z, { style: [R.preview, !M && R.maxHeight] }, l.createElement(w.Z, { code: i, language: d })) : l.createElement(v.Z, { autoComplete: "off", errorText: S({ count: D }), label: I, maxLength: D, multiline: !0, name: "code-input", numberOfLines: 15, onChange: L, style: R.input, validLength: D, value: i }));
                },
            ...
            const F = d().e554f642,
                q = d().fa524058,
                z = d().d4ab68e2,
                N = ({ onCancel: e, onConfirm: t }) => l.createElement(h.Z, { style: H.overlay }, l.createElement(h.Z, { style: H.overlayContent }, l.createElement(L.Z, { animateMount: !0, show: !0 }, l.createElement(h.Z, { style: H.actionBar }, l.createElement(j.ZP, { style: H.confirmationLabel, weight: "bold" }, F), l.createElement(h.Z, { style: H.actionBarButtonContainer }, l.createElement(g.ZP, { onClick: e, size: "small", type: "primaryOutlined" }, q), l.createElement(g.ZP, { onClick: t, size: "small", type: "destructiveOutlined" }, z))))), l.createElement(h.Z, { style: H.mask })),
            ...
            const xe = d().c80940f4,
                ...
                Se = o.default.create((e) => ({ input: { paddingHorizontal: 0 }, preview: { borderWidth: e.borderWidths.small, borderRadius: e.borderRadii.small, borderColor: e.colors.gray100, padding: e.spaces.space12, marginVertical: e.spaces.space12, overflow: "auto", minHeight: "30vh" }, maxHeight: { maxHeight: "48vh" } })),
                Be = ({ markdown: e = "", onAddMarkdown: t, onChange: a }) => {
                    const [n, i] = l.useState(e),
                        [o, s] = l.useState(Ie.MARKDOWN),
                        c = (0, r.yu)(),
            ...
            const Re = d().ebfd8ac6,
                ...
                Qe = (e) => {
                    const { attachmentType: t, codeLanguage: a, markdown: o, onAddGif: s, onAddLaTeX: c, onAddMarkdown: d, onAddMedia: u, onAddTweets: h, onClose: f, tex: g } = e,
                        ...
                        S = l.useMemo(() => ({ withKeyboardNavigation: !Z, onBackClick: P ? I : void 0 }), [P, Z]);
                    return l.createElement(
                        i.Z,
                        (0, n.Z)(
                            {
                        ...
                        l.createElement(
                            ...
                            (() => {
                                switch (t) {
                                    ...
                                    case De.Q.Markdown:
                                        return l.createElement(Be, { markdown: o, onAddMarkdown: d, onChange: T });
                                    case De.Q.Code:
                                        return l.createElement(M, { code: o, language: a, onAddCode: d, onChange: T });
                                    case De.Q.LaTeX:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterArticles-9f4db315.5c73e09a.js.map
