    ...
    ["bundle.TwitterBlue-3db873ec"],
    {
        ...
        733569: (e, t, a) => {
            ...
            const J = l.default.create((e) => ({ lock: { color: e.colors.gray700, fontSize: e.fontSizes.headline1 } })),
                ...
                Se = { header: d().b3e50ef2, description: d().bb1a4e44, emoji: "👨‍👩‍👧", icon: i.createElement(Z.default, null) },
                Fe = { header: d().c429e3ba, description: d().j010228e, icon: i.createElement(S.default, null), iconColor: "magenta500" },
                Le = d().h0e1730e,
                Ae = d().c4a37384,
                Ne = d().cb817dae,
                Te = d().jf7f743c,
                ...
                ut = [ie, se, re],
                ot = [le, pe, he, ve, _e, Se],
                st = [Le, Ae, Ne, Te, Ie, Oe, Re, xe],
                ft = [He, Ue, Ge, Me, Ye, qe, ze, We, De],
                mt = [Qe, Je, Ke, Xe, $e],
                bt = [Pe, Be, oe],
                pt = [je, me, ke, Ze, Fe, ge],
                ht = [we, be, Ee, ye, Ce],
                gt = [nt(Be, $), nt(oe, $), nt(je, $), nt(Pe, $), nt(Fe, $), nt(Ze, $), nt(Ve, $)],
                ...
                wt = {
                    ...
                    productContent: {
                        ...
                        BlueVerified: {
                            ...
                            FeatureGraphics: [
                                { id: "adsRemoved", image: { dark: F, light: L }, label: et },
                        ...
                        BlueVerifiedPlus: {
                            ...
                            FeatureGraphics: [
                                { id: "adsRemoved", image: { dark: T, light: I }, label: et, level: lt },
                                { id: "boostedReplies", image: { dark: O, light: R }, label: tt, level: dt },
                                { id: "grok", image: { dark: x, light: H }, label: at, level: ct },
                            ],
        ...
        113054: (e, t, a) => {
            ...
            const h = () => {
                    const e = (0, r.useLocation)(),
                        { featureSwitches: t } = (0, b.QZ)();
                    let a;
                    switch (t.getStringValue("subscriptions_premium_tiers_default_interval", "Year")) {
                        case "Year":
                        default:
                            a = p.rv.Year;
                            break;
                    ...
                    switch (e.state?.plan || e.query?.plan) {
                        case "annual":
                            return p.rv.Year;
                        case "monthly":
                            return p.rv.Month;
                ...
                g = (e) => {
                    ...
                    let i;
                    switch (a.getStringValue("subscriptions_premium_tiers_default_product", "BlueVerified")) {
                        case "BlueVerified":
                        default:
                            i = "BlueVerified";
                            break;
                    ...
                    switch (t.state?.tier || t.query?.tier) {
                        case "premium_basic":
                            return "PremiumBasic";
                        case "premium":
                            return "BlueVerified";
            ...
            const w = (e) => {
                    const t = (0, u.z)(),
                        ...
                        [w, j] = l.useState(p),
                        E = m(),
                        k = g(E.apiContent?.products),
                        [B, C] = l.useState(k),
                        P = s ? "subscriptions_webview" : "subscriptions",
                        V = b ? "tier_switch" : "marketing";
                    l.useEffect(() => {
                        t.scribe({ page: P, section: V, action: "impression", data: { referer: f, referring_page: f } });
                    }, [t, b, f, P, s, V]);
                    const y = { content: E, selectedProduct: B, setSelectedProduct: C, referringPage: f };
                    return l.createElement(n.nO, { namespace: { page: P, section: V } }, s ? l.createElement(_.Z, y) : l.createElement(v.Z, (0, i.Z)({}, y, { isTierSwitching: b, selectedInterval: w, setSelectedInterval: j })));
                },
                j = l.memo(w);
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-3db873ec.43f6855a.js.map
