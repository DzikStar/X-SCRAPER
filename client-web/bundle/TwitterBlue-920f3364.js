    ...
    ["bundle.TwitterBlue-920f3364"],
    {
        192933: (e, t, r) => {
            ...
            const C = (e, t) => e?.filter((e) => !t?.map((e) => e.header).includes(e.header)),
                k = i().dfc5f972,
                z = ({ content: e, hideTitle: t, prices: r, productCategory: n, productContent: o, referringPage: i, selectedInterval: c, selectedProduct: s, setSelectedProduct: d, setShowExtraFeatures: y, showExtraFeatures: b, withExtraFeatures: E, withFeatureFocus: w, withOfferCard: x, withUpsellTier: P }) => {
                    const z = (0, f.Z)(),
                        ...
                        if (e)
                            if (b) {
                                const t = window?.visualViewport?.height,
                                    r = t - (z?.headerHeight || 0) - e.getBoundingClientRect().height;
                    ...
                    return a.createElement(
                        ...
                        B || H ? (B ? null : a.createElement(u.Z, { style: S.featureFocusSection, testID: "feature_focus_section" }, a.createElement(u.Z, { style: S.featureHeadline, testID: "dynamic-header" }, a.createElement(m.ZP, { align: "center", size: "title2", style: S.title, weight: "heavy" }, D?.title), D?.subtitle ? a.createElement(m.ZP, { align: "center", style: S.description }, D.subtitle) : null), D?.features?.[0] ? a.createElement(u.Z, { style: S.featureFocusFeature }, a.createElement(Z, { changeToTier: _, feature: D?.features?.[0] })) : null, a.createElement(m.ZP, { align: "center", color: "gray700", style: S.muchMoreLabel, weight: "medium" }, k))) : a.createElement(h.Z, { content: e, fallbackHeader: o.header, referringPage: i }),
                        a.createElement(
                            u.Z,
                            { style: S.container, testID: `product-features-${n}` },
                            (H ? C(o.features, D?.features) : o.features)?.map((e, t) => a.createElement(Z, { changeToTier: _, feature: e, key: `feature_${t}` })),
                            P && o.upsellFeature ? a.createElement(p.Z, { onClick: () => _(o.upsellFeature?.targetTier), style: S.feature }, a.createElement(g.Z, { colors: [T, I], style: S.gradient }), a.createElement(u.Z, { style: S.featureInner }, a.createElement(m.ZP, { size: "headline1", style: S.emoji }, o.upsellFeature?.icon), a.createElement(m.ZP, { weight: "bold" }, o.upsellFeature.header))) : null,
                            E && o.extraFeatures
                                ? o.extraFeatures.map((e, t) =>
                                      a.createElement(
                                          a.Fragment,
                                          { key: t },
                                          e.label ? a.createElement(m.ZP, { align: "center", color: "gray700", style: S.extraFeaturesLabel, weight: "medium" }, e.label) : null,
                                          a.createElement(
                                              u.Z,
                                              { style: S.extraFeatures, testID: "extra-features" },
                                              (H ? C(e.features, D?.features) : e.features)?.map((e, r) => a.createElement(Z, { changeToTier: _, feature: e, key: `extra_feature_${t}_feautre_${r}` })),
                                          ),
                                      ),
                                  )
                                : null,
                ...
                S = l.default.create((e) => ({ container: { gap: e.spaces.space8, paddingHorizontal: e.spaces.space4 }, extraFeatures: { gap: e.spaces.space8 }, gradient: { position: "absolute", width: "100%", height: "100%", top: 0, borderRadius: e.borderRadii.medium }, title: { marginBottom: e.spaces.space16 }, extraFeaturesLabel: { marginVertical: e.spaces.space4 }, feature: { width: "100%", paddingVertical: e.spaces.space16, borderRadius: e.borderRadii.medium, backgroundColor: e.colors.gray0, flexDirection: "row" }, featureInner: { paddingHorizontal: e.spaces.space20, flexDirection: "row", alignItems: "center", flex: 1 }, emoji: { marginEnd: e.spaces.space16, minWidth: 25 }, featureHeadline: { paddingHorizontal: e.spaces.space8, paddingVertical: e.spaces.space8 }, description: { textAlign: "center" }, featureFocusSection: { paddingHorizontal: e.spaces.space4 }, featureFocusFeature: { marginTop: e.spaces.space16 }, muchMoreLabel: { paddingVertical: e.spaces.space12 } })),
                I = i().i7fbacc4,
                T = ({ content: e, hideTitle: t, prices: r, productListLayout: l, products: o, referringPage: i, selectedInterval: u, selectedProduct: m, selectedProductIndex: p, setSelectedProduct: g, setShowAllFeaturesPage: f, setShowExtraFeatures: h, showExtraFeatures: y, withExtraFeatures: b, withFeatureFocus: E, withOfferCard: w, withUpsellTier: Z }) => {
                    const x = (0, c.Z)(),
                        ...
                        v = "V2" === l ? s.Z : "V3" === l ? d.Z : z;
                    return a.createElement(
                        n.Z,
                        { "aria-label": I, childrenStyle: [F.children, { alignItems: "V3" === l ? "center" : null }], navButtonStyle: F.navButtonStyle, onVisibleRangeChange: P, scrollToCenter: !0, showNavButtonsOnHover: !0, showOverflow: !0, style: F.carousel, visibleItemIndex: p, withScrollIntoView: !1 },
                ...
                F = l.default.create((e) => ({ navButtonStyle: { top: 0, height: "100%", justifyContent: "start", paddingTop: e.spaces.space20, paddingHorizontal: e.spaces.space8 }, children: { width: "100%", scrollSnapAlign: "center" }, carousel: { flexGrow: 1 } })),
                _ = a.memo(T);
        },
        381214: (e, t, r) => {
            r.d(t, { Z: () => v });
        ...
        867754: (e, t, r) => {
            ...
            var a = r(807896),
                ...
                m = r(278637);
            const p = u().e1606e52,
                g = ({ content: e, header: t, isMobile: r, isTierSwitching: s, offerContent: d, offerEndsAtMsec: g, renderOfferContent: f }) => {
                    const y = (0, o.Mv)(),
                        b = (0, i.Gz)(),
                        E = y ? h.marginSmall : b ? h.marginLarge : h.marginMedium,
                        w = y ? { size: "title3", style: h.titleSmall } : b ? { style: h.titleLarge } : { size: "title1", style: h.titleMedium },
                        Z = y ? "body" : b ? "headline1" : "headline2",
                        x = y ? h.countdownSmall : b ? h.countdownLarge : h.countdownMedium;
                    return n.createElement(l.Z, null, n.createElement(l.Z, { style: [h.header, E, h.container] }, n.createElement(c.ZP, (0, a.Z)({}, w, { weight: "bold" }), s ? p : f ? d.title : t.title), n.createElement(c.ZP, { color: "gray900", size: Z }, f ? null : t.description), f && g ? n.createElement(n.Fragment, null, n.createElement(c.ZP, { color: "gray900", size: Z }, d.subtitle), n.createElement(l.Z, { style: [h.countdown, x] }, n.createElement(m.Z, { endsAtMsec: g }))) : null, f ? null : n.createElement(c.ZP, { color: "gray900", size: Z, style: h.voLink }, n.createElement(u().I18NFormatMessage, { $i18n: "c57cd3a3" }, n.createElement(c.ZP, { color: "text", link: "/i/verified-orgs-signup", underlineWeight: "heavy", weight: "bold", withUnderline: !0 }, u().d2f2b91a)))));
                },
                f = n.memo(g),
                h = s.default.create((e) => ({ container: { alignItems: "center", flex: 1, width: "100%", maxWidth: "1280px", marginHorizontal: "auto", paddingHorizontal: e.spaces.space16 }, marginSmall: { marginTop: e.spaces.space56 }, marginMedium: { marginTop: e.spaces.space48 }, marginLarge: { marginTop: 144 * e.scaleMultiplier }, header: { textAlign: "center", maxWidth: 900, alignItems: "center", zIndex: 1, top: 20 }, titleSmall: { marginBottom: e.spaces.space16 }, titleMedium: { marginBottom: e.spaces.space16, fontSize: 54 * e.scaleMultiplier, lineHeight: 60 * e.scaleMultiplier }, titleLarge: { marginBottom: e.spaces.space24, fontSize: 64 * e.scaleMultiplier, lineHeight: 70 * e.scaleMultiplier }, countdown: { maxWidth: "500px", width: "100%" }, countdownSmall: { marginTop: e.spaces.space16 }, countdownMedium: { marginTop: e.spaces.space48 }, countdownLarge: { marginTop: e.spaces.space48 }, voLink: { marginTop: e.spaces.space8 } }));
        },
        985529: (e, t, r) => {
            r.d(t, { Z: () => p });
            var a = r(202784),
        ...
        330463: (e, t, r) => {
            ...
            var a = r(202784),
                ...
                m = r(627706);
            const p = s().b601cfbb,
                g = ({ catalogItems: e, content: t, selectedProduct: r, setShowAllFeaturesPage: i }) => {
                    const c = t.localContent.productContent;
                    return a.createElement(
                        a.Fragment,
                        null,
                        ...
                        a.createElement(
                            ...
                            Object.entries(c).map(([r, l]) => {
                                const i = e.filter((e) => e.productCategory === r),
                                    s = i.find((e) => "Month" === e.chargeInterval),
                                    d = s ? p({ price: s.localisedMonthlyPrice || "undefined" }) : "Currently unavailable";
                                return a.createElement(n.Z, { key: r, style: f.section }, a.createElement(n.Z, { style: f.separator }), a.createElement(o.ZP, { style: f.sectionTitle }, l.productName), c[r].featureAddOnLabel && a.createElement(o.ZP, { style: f.premiumFeatureUpgrades }, c[r].featureAddOnLabel), Array.isArray(l.allFeatureHeaders) && l.allFeatureHeaders.map((e, t) => a.createElement(n.Z, { key: t, style: f.featureRow }, a.createElement(o.ZP, { style: f.featureText }, e), a.createElement(u.default, { style: f.checkmark }))), a.createElement(n.Z, { style: f.buttonContainer }, a.createElement(m.Z, { catalogItemsForProduct: i, content: t, label: d, selectedProduct: r })));
                            }),
                        ),
                    );
                },
                f = i.default.create((e) => ({ container: { flex: 1, paddingHorizontal: e.spaces.space16, paddingTop: e.spaces.space16, marginTop: e.spaces.space36, marginBottom: e.spaces.space4, position: "relative" }, dismisserButton: { position: "absolute", start: 0, top: 10 }, dismissButton: { position: "absolute", start: e.spaces.space4, bottom: 0, top: e.spaces.space12, border: "transparent" }, header: { alignItems: "center", justifyContent: "center", position: "fixed", zIndex: 1, height: e.spaces.space2, width: e.spaces.space2 }, separator: { borderBottomColor: e.colors.gray200, borderBottomWidth: 1, marginBottom: e.spaces.space12 }, title: { fontSize: e.fontSizes.headline1, fontWeight: "700", marginBottom: e.spaces.space12, lineHeight: e.spaces.space24 }, section: { marginBottom: e.spaces.space8 }, sectionTitle: { fontSize: e.fontSizes.headline2, fontWeight: "700", marginBottom: e.spaces.space8 }, featureRow: { flexDirection: "row", alignItems: "center", marginBottom: e.spaces.space12 }, featureText: { fontSize: e.fontSizes.body, flex: 1, fontWeight: "400" }, premiumFeatureUpgrades: { fontSize: e.fontSizes.subtext1, color: e.colors.gray700, marginBottom: e.spaces.space8 }, checkmark: { color: e.colors.green500, marginStart: e.spaces.space8, fontSize: e.fontSizes.body, fontWeight: "bold" }, buttonContainer: { marginVertical: e.spaces.space4 } }));
        },
        632396: (e, t, r) => {
            r.d(t, { Z: () => B });
            var a = r(202784),
            ...
            const x = i().be103b84,
                ...
                I = ({ activeSubscription: e, content: t, index: r, isTargettedUpsellFlow: n, prices: l, productRef: o, productsLength: i, selectedProduct: c }) => {
                    ...
                    const I = "active" === (0, b.yv)({ activeSubscription: e, tier: d.product_category }),
                        T = a.useCallback((e) => [z.carouselHeader, e ? { backgroundImage: `url(${e})` } : null], []),
                        F = a.useCallback(
                            (e, t) => {
                                const r = (0, E.U)(e.icon),
                                    ...
                                    i = [l && z.checkmarkIcon, n && z.iconGrey];
                                return a.createElement(s.Z, { "aria-label": o, focusable: !0, key: t, role: "text", style: z.featureHeadlineContainer }, a.createElement(s.Z, { style: z.featureBucketFeatureTextContainer }, a.createElement(m.ZP, { color: n ? "gray700" : "text", size: "body" }, e.title), e.description ? a.createElement(p.Z, { contentStyle: z.infoPopoverContent, preferredHorizontalOrientation: "end", renderContent: (t) => a.createElement(k, { dismiss: t, feature: e }) }, a.createElement(g.ZP, { "aria-label": P, icon: S, size: "xSmall", style: z.infoButton, testID: `feature_info_${t}`, type: "primaryText" })) : null), null !== r && null === e.variant ? a.createElement(r, { style: i }) : a.createElement(m.ZP, { style: z.variantText }, e.variant));
                            },
                            [d.title],
                        ),
                        _ = a.useCallback(
                            (e) =>
                                a.createElement(
                                    ...
                                    e?.feature_buckets?.buckets.map((e, t) => {
                                        ...
                                        return a.createElement(a.Fragment, { key: t }, a.createElement(s.Z, { style: z.featureCard }, a.createElement(m.ZP, { size: "headline2", style: z.featureCardTitle, weight: "bold" }, e.title), r ? e.features?.map(F) : null));
                                    }),
                                ),
                            [F],
                        ),
                    ...
                    return a.createElement(s.Z, { key: `product-${r}`, style: [z.carouselItem, B], testID: y }, n && 1 === i ? null : a.createElement(s.Z, { style: T(d.image_url) }, a.createElement(m.ZP, { align: "center", color: "white", size: "headline2", weight: "medium" }, d.title), I ? a.createElement(f.ZP, { style: z.activeLabel, type: "subscriptionActive" }, x) : null), a.createElement(s.Z, null, a.createElement(Z.Z, { content: t, prices: l, selectedProduct: d.product_category })), _(d));
                },
                T = i().i7fbacc4,
                F = ({ activeSubscription: e, content: t, isTargettedUpsellFlow: r, prices: l, products: o, referringPage: i, selectedProduct: s, selectedProductIndex: d, setSelectedProduct: u }) => {
                    const m = (0, c.Z)(),
                        p = a.useCallback(
                            ({ index: e, intersectionRatio: t }) => {
                                if (1 === t) {
                    ...
                    return a.createElement(
                        n.Z,
                        { "aria-label": T, childrenStyle: _.children, navButtonStyle: _.navButtonStyle, onVisibleRangeChange: p, scrollToCenter: !0, showNavButtonsOnHover: !0, showOverflow: !0, visibleItemIndex: d, withScrollIntoView: !1 },
                ...
                _ = l.default.create((e) => ({ navButtonStyle: { top: 0, height: "100%", justifyContent: "start", paddingTop: e.spaces.space20, paddingHorizontal: e.spaces.space8 }, children: { width: "93%", scrollSnapAlign: "center" } })),
                B = a.memo(F);
        },
        145278: (e, t, r) => {
            r.d(t, { Z: () => g });
        ...
        731862: (e, t, r) => {
            ...
            const u = (e, t) => (t ? ({ blue: { backgroundImage: `\n            linear-gradient(90.38deg, \n            ${e.colors.blue500} 0.23%, \n            ${e.colors.blue600} 32.73%, \n            ${e.colors.blue500} 50.37%,\n            ${e.colors.blue500} 98.27%)\n          ` }, gold: { backgroundImage: `\n            linear-gradient(90.38deg, \n            ${e.colors.gold50} 0.23%, \n            ${e.colors.gold0} 32.73%, \n            ${e.colors.gold50} 50.37%,\n            ${e.colors.gold100} 98.27%)\n          ` }, special: { borderRadius: 16 }, leftAligned: { borderRadius: o.default.theme.spaces.space12 } }[t] ?? void 0) : void 0),
                ...
                g = ({ buttonFontSize: e, buttonSize: t, disabled: r, disclaimerRef: g, label: h, loading: y, onClick: b, savePill: E, styleOverrides: w, subtext: Z, variant: x }) => {
                    const P = n.useCallback(() => {
                            b();
                        }, [b]),
                        { disclaimerFontColor: v, disclaimerFontSize: C, marginBottom: k, withoutDisclaimerBorder: z } = w ?? {},
                        S = k ? o.default.theme.spaces[k] : null;
                    return n.createElement(n.Fragment, null, n.createElement(l.Z, { style: [f.buttonWrapper, S && { marginBottom: S }] }, E, n.createElement(i.ZP, (0, a.Z)({}, "leftAligned" === x ? { alignContent: "left" } : {}, { allowTextWrap: !0, color: m(x), disabled: r, onClick: P, size: t || "xLarge", style: [u(o.default.theme, x), f.button], textSizeOverride: e || "headline2", type: p(x) }), y ? n.createElement(c.Z, null) : h), Z ? n.createElement(s.ZP, { align: "center", size: "subtext2", style: f.subtext, testID: "purchase-button-subtext" }, Z) : null), g ? n.createElement(l.Z, null, n.createElement(d.Z, { disclaimerRef: g, freeTrialInfo: null, styleOverrides: { disclaimerFontSize: C, disclaimerFontColor: v, withoutDisclaimerBorder: z } })) : null);
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-920f3364.4b2baafa.js.map
