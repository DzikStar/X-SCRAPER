    ...
    ["bundle.TwitterBlue-920f3364"],
    {
        192933: (e, t, r) => {
            ...
            const C = (e, t) => e?.filter((e) => !t?.map((e) => e.header).includes(e.header)),
                ...
                z = ({ content: e, hideTitle: t, prices: r, productCategory: n, productContent: o, referringPage: i, selectedInterval: c, selectedProduct: s, setSelectedProduct: d, setShowExtraFeatures: y, showExtraFeatures: b, withExtraFeatures: E, withFeatureFocus: w, withOfferCard: x, withUpsellTier: P }) => {
                    const z = (0, f.Z)(),
                        { gray0: _, gray50: I } = l.default.theme.colors,
                        T = a.useRef(null);
                    a.useEffect(() => {
                        const { current: e } = T;
                        if (e)
                ...
                _ = i().i7fbacc4,
                I = ({ content: e, hideTitle: t, prices: r, productListLayout: l, products: o, referringPage: i, selectedInterval: u, selectedProduct: m, selectedProductIndex: p, setSelectedProduct: g, setShowAllFeaturesPage: f, setShowExtraFeatures: h, showExtraFeatures: y, withExtraFeatures: b, withFeatureFocus: E, withOfferCard: w, withUpsellTier: Z }) => {
                    const x = (0, c.Z)(),
                        P = a.useCallback(
                    ...
                    return a.createElement(
                        n.Z,
                        { "aria-label": _, childrenStyle: [T.children, { alignItems: "V3" === l ? "center" : null }], navButtonStyle: T.navButtonStyle, onVisibleRangeChange: P, scrollToCenter: !0, showNavButtonsOnHover: !0, showOverflow: !0, style: T.carousel, visibleItemIndex: p, withScrollIntoView: !1 },
        ...
        867754: (e, t, r) => {
            ...
            const g = u().e1606e52,
                f = ({ content: e, header: t, isMobile: r, isTierSwitching: s, offerContent: d, offerEndsAtMsec: f, renderOfferContent: h }) => {
                    ...
                    return n.createElement(l.Z, null, n.createElement(l.Z, { style: [y.header, Z, y.container] }, n.createElement(c.ZP, (0, a.Z)({}, x, { weight: "bold" }), s && E ? g : h ? d.title : t.title), n.createElement(c.ZP, { color: "gray900", size: P }, h ? null : t.description), h && f ? n.createElement(n.Fragment, null, n.createElement(c.ZP, { color: "gray900", size: P }, d.subtitle), n.createElement(l.Z, { style: [y.countdown, v] }, n.createElement(p.Z, { endsAtMsec: f }))) : null, h ? null : n.createElement(c.ZP, { color: "gray900", size: P, style: y.voLink }, n.createElement(u().I18NFormatMessage, { $i18n: "c57cd3a3" }, n.createElement(c.ZP, { color: "text", link: "/i/verified-orgs-signup", underlineWeight: "heavy", weight: "bold", withUnderline: !0 }, u().d2f2b91a)))));
                },
                h = n.memo(f),
        ...
        632396: (e, t, r) => {
            ...
            const x = i().be103b84,
                ...
                _ = ({ activeSubscription: e, content: t, index: r, isTargettedUpsellFlow: n, prices: l, productRef: o, productsLength: i, selectedProduct: c }) => {
                    const d = u()(w.oD, o),
                        h = d.product_category === c;
                    let y = `premium-product-${d.product_category || ""}`;
                    h && (y += "-selected");
                    const _ = "active" === (0, b.yv)({ activeSubscription: e, tier: d.product_category }),
                        I = a.useCallback((e) => [z.carouselHeader, e ? { backgroundImage: `url(${e})` } : null], []),
                        T = a.useCallback(
                            (e, t) => {
                            ...
                            (e) =>
                                a.createElement(
                                    ...
                                    e?.feature_buckets?.buckets.map((e, t) => {
                                        ...
                                        return a.createElement(a.Fragment, { key: t }, a.createElement(s.Z, { style: z.featureCard }, a.createElement(m.ZP, { size: "headline2", style: z.featureCardTitle, weight: "bold" }, e.title), r ? e.features?.map(T) : null));
                                    }),
                                ),
                            [T],
                        ),
                ...
                T = ({ activeSubscription: e, content: t, isTargettedUpsellFlow: r, prices: l, products: o, referringPage: i, selectedProduct: s, selectedProductIndex: d, setSelectedProduct: u }) => {
                    ...
                    return a.createElement(
                        n.Z,
                        { "aria-label": I, childrenStyle: F.children, navButtonStyle: F.navButtonStyle, onVisibleRangeChange: p, scrollToCenter: !0, showNavButtonsOnHover: !0, showOverflow: !0, visibleItemIndex: d, withScrollIntoView: !1 },
                        o?.map((n, i) => a.createElement(_, { activeSubscription: e, content: t, index: i, isTargettedUpsellFlow: r, key: i, prices: l, productRef: n, productsLength: o.length, selectedProduct: s })),
                    );
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-920f3364.e28cf83a.js.map
