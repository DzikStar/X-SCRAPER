            ...
            const S = g().a9904a1c,
                ...
                k = ({ activeSubscription: e, content: t, isMobile: r, isTierSwitching: a, premiumPriceConfig: l, selectedProduct: p, setSelectedProduct: m, shouldRemoveExtraStep: g }) => {
                    const _ = l.featuredPromotionDetails,
                        k = !!_?.promotion,
                        z = (0, y.Z)(),
                        { featureSwitches: T } = (0, h.QZ)(),
                        F = (0, I.Z)(_),
                        [M, O] = o.useState(F);
                    o.useEffect(() => {
                        k && z.scribe({ component: "paywall_with_offer", element: _?.promotion.program_id, action: "impression" });
                    }, [k, _, z]);
                    const D = T.isTrue("subscriptions_offers_localized_pricing_enabled"),
            ...
            const w = d().a1bb9c8a,
                ...
                I = ({ content: { apiContent: e, localContent: t }, footerRef: r, headerFooterOffset: s, headerRef: d, referringPage: I, selectedProduct: _, state: { catalogItems: x, paywallDisplayType: k } }) => {
                    const z = (0, g.hC)("grok_ios_reasoning_research_name_enabled"),
                        [T, B] = a.useState("Month"),
                        F = x.filter((e) => "BlueVerifiedPlus" === e.productCategory),
                        M = F.find((e) => e.chargeInterval === T),
                    ...
                    return a.createElement(
                        ...
                        a.createElement(h.Z, { footerRef: r }, a.createElement(y.Z, { catalogItems: F, selectedInterval: T, setSelectedInterval: B, variant: "special" }), a.createElement(b.Z, { disclaimerRef: e?.subscribe_button, price: M, variant: "special" })),
                    );
                },
                _ = a.memo(I),
            ...
            const P = p().b601cfbb,
                C = ({ catalogItems: e, catalogItemsForProduct: t, content: r, footerRef: d, headerFooterOffset: u, headerRef: p, referringPage: C, selectedProduct: v, selectedProductIndex: _, setSelectedProduct: S, state: x, withPurchaseSheet: k }) => {
                    ...
                    return o.createElement(
                        ...
                        !B && o.createElement(w.Z, { footerRef: d, variant: "condensed" }, o.createElement(n.Z, { style: I.footerContainer }, k ? o.createElement(E.Z, { catalogItemsForProduct: t, content: r, label: T, selectedProduct: v }) : o.createElement(b.Z, { catalogItems: e, catalogItemsForProduct: t, content: r }))),
                    );
                },
                v = o.memo(C),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-964cff98.a05f387a.js.map
