    ...
    ["bundle.TwitterBlue-9f4db315"],
    {
        ...
        116868: (e, t, r) => {
            ...
            const o =
                    ...
                    async (c, l, { api: u, userPersistence: p }) => {
                        const d = await i(p, r, a, o);
                        return d ? (0, s.Vg)(c, { params: { basePixel: e, eventPixel: t, twclid: d }, request: ({ basePixel: e, eventPixel: t, twclid: r } = {}, a) => u.withEndpoint(n).postConversion(e, t, r, a) })("POST_CONVERSION") : Promise.resolve(null);
                    },
                i = async (e, t, r, a) => {
                    let n = t;
        ...
        290008: (e, t, r) => {
            ...
            var a = r(202784),
                ...
                u = r(116868),
                p = r(248186);
            const d = ({ content: e, isTierSwitching: t, referringPage: r, selectedInterval: d, selectedProduct: m, setSelectedInterval: h, setSelectedProduct: f }) => {
                const g = (0, n.useHistory)(),
                    w = (0, l.I0)(),
                    v = (0, i.Z)(),
                    y = a.useMemo(() => (0, o.R)(v), [v]),
                    { isModal: P } = a.useContext(s.Z),
                    S = !P;
                a.useEffect(() => {
                    const e = !!y && (0, c.Ld)(y),
                        a = y && "Stripe" !== y?.payment_source && !e,
                        n = !!(0, c.gS)(y, "FreeTrial", { status: "active" }),
                        s = new URLSearchParams(window.location.search).get("twclid");
                    w((0, u.q)("o8zly", "ojw66", s, "rweb.premiumLandingPage", !0)), ((n && t) || a) && g.replace("/settings/subscription"), e && t && g.replace("/i/premium_cross_grade", { referring_page: r }), y && "Stripe" === y?.payment_source && !t && g.replace("/i/premium_tier_switch", { referring_page: r });
                }, [y, g, t, r, w]);
                const E = a.useMemo(() => !t && !S, [S, t]);
                return a.createElement(p.Z, { activeSubscription: y, content: e, isMobile: S, isTierSwitching: t, selectedInterval: d, selectedProduct: m, setSelectedInterval: h, setSelectedProduct: f, shouldRemoveExtraStep: E });
            };
        },
        320479: (e, t, r) => {
            r.d(t, { Z: () => S });
            ...
            const P = ({ content: e, referringPage: t, selectedProduct: r, setSelectedProduct: o, state: i }) => {
                    ...
                    n.useEffect(() => {
                        ...
                        n.useEffect(() => {
                            const e = setTimeout(() => {
                                P(!0), S.current && S.current && (S.current.style.opacity = 1);
                            }, 25);
                    ...
                    const C = n.useMemo(() => ({ marginTop: _, marginBottom: k }), [_, k]),
                        ...
                        L = { content: e, referringPage: t, selectedProduct: r, setSelectedProduct: o, state: i, catalogItems: i.catalogItems, catalogItemsForProduct: R, headerRef: Z, footerRef: x, headerFooterOffset: C, selectedProductIndex: D };
                    return n.createElement(
                        p.P.Provider,
                        { value: { footerHeight: k, headerHeight: _ } },
                        n.createElement(s.Z, { style: [E.cover, u ? E.show : E.hide] }),
                        n.createElement(
                            s.Z,
                            { ref: S, style: E.root, testID: i.paywallDesignVariant },
                            (() => {
                                switch (i.paywallDesignVariant) {
                                    ...
                                    case "v2":
                                        return n.createElement(v.Z, (0, a.Z)({}, L, { withPurchaseSheet: !0 }));
                                    case "v2_2":
                                        return n.createElement(v.Z, (0, a.Z)({}, L, { withIntervalSelector: !1, withPurchaseSheet: !1 }));
                                    case "v2_3":
                                        return n.createElement(v.Z, (0, a.Z)({}, L, { withIntervalSelector: !0, withPurchaseSheet: !1 }));
                                    case "v3":
                                        return n.createElement(y.Z, (0, a.Z)({}, L, { withPurchaseSheet: !1 }));
                                    default:
                ...
                S = (e) => {
                    ...
                    return n.createElement(n.Fragment, null, p, r?.printDebug ? n.createElement(s.Z, { style: E.printDebug, testID: "webview-paywall-debug" }, n.createElement(o.ZP, null, JSON.stringify(i, null, " \t"))) : null);
                },
                E = i.default.create((e) => ({ activityIndicator: { height: "100vh", display: "flex", justifyContent: "center" }, root: { WebkitUserSelect: "none", userSelect: "none" }, cover: { pointerEvents: "none", opacity: 1, transition: "opacity 100ms", position: "absolute", backgroundColor: e.colors.cellBackground, zIndex: 1, width: "100%", height: "100%" }, show: { opacity: 0 }, hide: { opacity: 1 }, printDebug: { marginBottom: e.spaces.space72 } }));
        },
        757771: (e, t, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-9f4db315.ac6a1ada.js.map
