        ...
        116868: (e, l, a) => {
            ...
            const i =
                    ...
                    async (u, o, { api: d, userPersistence: c }) => {
                        const g = await s(c, a, n, i);
                        return g ? (0, t.Vg)(u, { params: { basePixel: e, eventPixel: l, twclid: g }, request: ({ basePixel: e, eventPixel: l, twclid: a } = {}, n) => d.withEndpoint(r).postConversion(e, l, a, n) })("POST_CONVERSION") : Promise.resolve(null);
                    },
                s = async (e, l, a, n) => {
                    let r = l;
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-a2dee9c7.0b27a86a.js.map
