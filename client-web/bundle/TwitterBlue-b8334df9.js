            ...
            const f = d().f36b8e14,
                ...
                E = ({ activeSubscription: e, isTierSwitching: t, productCategory: r, productPrices: c, selectedInterval: s, shouldRemoveExtraStep: d, withAnnualPriceMonthly: E, withAnnualSavingLabel: P }) => {
                    const S = (0, u.hC)("subscriptions_marketing_page_include_tax_enabled"),
                        ...
                        L = (0, b.f)({ isFreeTrial: !!T, selectedInterval: s, formattedPrice: z, discountInfo: R, activeDiscountInfo: B, price: I, shouldRemoveExtraStep: d, withAnnualPriceMonthly: E, includeTax: S, isTierSwitching: t });
                    if (!I) return a.createElement(o.Z.Danger, { text: f });
                    const $ = c ? (0, m.pB)(c) : null,
                        W = a.createElement(n.ZP, { style: _.saveLabel, type: "subscriptionSaving" }, $),
                        ...
                        A = a.createElement(a.Fragment, null, a.createElement(l.ZP, { style: [_.priceLabel, _.strikethrough] }, "Year" === s && E ? D : z), a.createElement(l.ZP, { style: [_.priceLabel, _.discountPriceLabel], weight: "bold" }, (0, h.T)({ price: I, includeTax: S, percentOff: R?.metadata.percent_off || B?.promotion_metadata?.percent_off, annualPriceMonthly: E && "Year" === s })), F);
                    let Y = O;
                    return T ? (Y = G) : (R || B) && (Y = A), a.createElement(i.Z, null, a.createElement(i.Z, { style: _.priceRow }, Y), a.createElement(i.Z, { style: _.billingRow }, a.createElement(l.ZP, { color: "gray900" }, L), "Year" !== s || !P || R || B ? null : W));
                },
                P = a.memo(E),
            ...
            const Y = v().b8d0bd19,
                H = ({ activeSubscription: e, checkoutButton: t, disclaimerRef: r, interval: o, isTierSwitching: n, onClose: l, product: c, productCategory: s, productTitle: d, shouldRemoveExtraStep: u }) => {
                    ...
                    const h = g && p ? Y({ productName: d }) : d,
                        b = a.createElement(i.Z, { style: U.body, testID: "purchase-sheet" }, a.createElement(R.Z, { activeSubscription: e, isTierSwitching: n, productCategory: s, productPrices: c, selectedInterval: o, shouldRemoveExtraStep: u, withAnnualPriceMonthly: !1, withAnnualSavingLabel: !0 }), t, a.createElement(A.Z, { disclaimerRef: r, freeTrialInfo: g }));
                ...
                V = ({ index: e, numProducts: t }) => {
                    const r = (0, o.Mv)(),
                        n = (0, o.pj)(),
                        l = r ? j.cardSmall : n ? j.cardXLarge : j.cardXXLarge;
                    return a.createElement(i.Z, { style: [j.productCard, l, e !== t && 0 !== t && r ? j.cardMarginBottom : null] });
                },
                ...
                ne = ({ activeSubscription: e, disclaimerRef: t, index: r, isSelected: n, isTierSwitching: c, numProducts: s, premiumPriceConfig: d, productContent: y, productPrices: v, selectedInterval: E, shouldRemoveExtraStep: _ }) => {
                    ...
                    const se = a.createElement(
                        ...
                        me = Y[pe]?.hashed,
                        ge = v ? a.createElement(F.ZP, { activeStripeProductId: me, activeSubscription: e, buttonStyle: c ? de.tierSwitchButton : de.checkoutButton, isTierSwitching: c, premiumPriceConfig: d, productPrices: v, selectedInterval: E, selectedProduct: H, stripeProductId: V, stripeProductIdUnhashed: j, style: de.checkoutButtonInner }) : null,
                        he = L ? de.cardSmall : W ? de.cardXLarge : de.cardXXLarge,
                        be = a.createElement(
                            g.ZP,
                            {
                                onClick: () => {
        ...
        754962: (e, t, r) => {
            ...
            const M = (0, I.ju)("https://legal.x.com/purchaser-terms.html"),
                ...
                W = ({ chargeInterval: e, tierSwitchType: t }) => {
                    let r = "";
                    return "active" === t ? (r = "Year" === e ? L : $) : "upgrade" === t ? (r = z) : "downgrade" === t && (r = D), a.createElement(i.Z, { style: [F.termsOfService, F.positionRelative] }, a.createElement(S.ZP, { align: "left", color: "gray900", size: "subtext2", style: F.justifyText }, r));
                },
                    ...
                    f((e) => {
                        const { activeSubscription: t, analytics: r, buttonStyle: s, buttonType: d, checkoutUrlFetchStatus: u, disabledText: h, disclaimer: b, fetchSubscriptionProductCheckoutUrl: f, isMobile: w, isTierSwitching: E, onClick: P, premiumPriceConfig: _, productPrices: S, selectedInterval: C, selectedProduct: Z, stripeProductId: k, stripeProductIdUnhashed: x, style: I, supportedReferringPage: M, switchTier: T, switchTierFetchStatus: B, title: R } = e,
                            ...
                            ae = a.useMemo(() => {
                                ...
                                return a.createElement(i.Z, { style: K }, r, E && t ? a.createElement(ce, { activeSubscription: t, buttonStyles: te, isMobile: w, premiumPriceConfig: _, price: V, productPrices: S, selectedInterval: C, selectedProduct: Z, setShowSheet: F, setTierSwitchError: G, showSheet: W, stripeProductId: k, switchTier: T, switchTierFetchStatus: B }) : e, b);
                            }, [R, S, O, u, N, J, K, te, B, b, E, d, re, t, w, C, W, k, _, Z, T, V]),
            ...
            const h = (e) => (e ? ({ default: E.blueBorder, horizontal_blue: E.blueBorder, horizontal_gold: E.goldBorder, special: E.whiteBorder, horizontal_green: E.whiteBorder }[e] ?? void 0) : void 0),
                ...
                w = ({ "aria-label": e, "aria-posinset": t, "aria-setsize": r, checked: a, label: n, name: l, onChange: c, price: s, subtext: w, title: _, variant: S = "default" }) => {
                    ...
                    switch (S) {
                        ...
                        case "special":
                            (M = E.horizontalNonLast), (I = [E.horizontalChecked, h(S)]), (T = E.horizontal), (x = i.createElement(i.Fragment, null, n ? i.createElement(o.Z, { style: E.horizontalLabelContainer }, i.createElement(o.Z, { style: [E.horizontalLabel, y(S)] }, i.createElement(u.ZP, { color: v(S), size: "subtext3", weight: "bold" }, n))) : null, i.createElement(o.Z, { style: E.horizontalInner }, i.createElement(u.ZP, { size: f(S) }, _), i.createElement(u.ZP, { size: b(S), style: E.horizontalPrice, weight: "bold" }, s))));
                            break;
                        default:
                    ...
                    return i.createElement(m.Z, { style: [E.common, T, a ? I : null, t !== r ? M : null], testID: `interval_radio_${t || ""}` }, x, i.createElement("input", { "aria-describedby": `${Z} ${k}`, "aria-label": e, "aria-labelledby": C, "aria-posinset": t, "aria-setsize": r, checked: a, name: l, onChange: a ? g.Z : c, style: P, type: "radio" }));
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-b8334df9.f7502cba.js.map
