    ...
    ["bundle.TwitterBlue-cda947e7"],
    {
        ...
        290008: (e, t, r) => {
            ...
            var a = r(202784),
                ...
                u = r(116868),
                d = r(248186);
            const m = ({ content: e, isTierSwitching: t, referringPage: r, selectedProduct: m, setSelectedProduct: p }) => {
                const g = (0, n.useHistory)(),
                    f = (0, s.I0)(),
                    h = (0, c.Z)(),
                    y = a.useMemo(() => (0, o.R)(h), [h]),
                    { isModal: w } = a.useContext(l.Z),
                    E = !w;
                a.useEffect(() => {
                    const e = !!y && (0, i.Ld)(y),
                        a = y && "Stripe" !== y?.payment_source && !e,
                        n = !!(0, i.gS)(y, "FreeTrial", { status: "active" }),
                        l = new URLSearchParams(window.location.search).get("twclid");
                    f((0, u.q)("o8zly", "ojw66", l, "rweb.premiumLandingPage", !0)), ((n && t) || a) && g.replace("/settings/subscription"), e && t && g.replace("/i/premium_cross_grade", { referring_page: r }), y && "Stripe" === y?.payment_source && !t && g.replace("/i/premium_tier_switch", { referring_page: r });
                }, [y, g, t, r, f]);
                const b = a.useMemo(() => !t && !E, [E, t]);
                return a.createElement(d.Z, { activeSubscription: y, content: e, isMobile: E, isTierSwitching: t, selectedProduct: m, setSelectedProduct: p, shouldRemoveExtraStep: b });
            };
        },
        320479: (e, t, r) => {
            r.d(t, { Z: () => Z });
            ...
            const g = d().e1606e52,
                f = ({ content: e, header: t, isMobile: r, isTierSwitching: s, offerContent: u, offerEndsAtMsec: f, renderOfferContent: h }) => {
                    const w = (0, o.Mv)(),
                        ...
                        x = w ? "body" : b ? "headline1" : "headline2",
                        v = w ? y.countdownSmall : b ? y.countdownLarge : y.countdownMedium;
                    return n.createElement(l.Z, null, n.createElement(l.Z, { style: [y.header, Z, y.container] }, n.createElement(i.ZP, (0, a.Z)({}, P, { weight: "bold" }), s && E ? g : h ? u.title : t.title), n.createElement(i.ZP, { color: "gray900", size: x }, h ? null : t.description), h && f ? n.createElement(n.Fragment, null, n.createElement(i.ZP, { color: "gray900", size: x }, u.subtitle), n.createElement(l.Z, { style: [y.countdown, v] }, n.createElement(p.Z, { endsAtMsec: f }))) : null, h ? null : n.createElement(i.ZP, { color: "gray900", size: x, style: y.voLink }, n.createElement(d().I18NFormatMessage, { $i18n: "c57cd3a3" }, n.createElement(i.ZP, { color: "text", link: "/i/verified-orgs-signup", underlineWeight: "heavy", weight: "bold", withUnderline: !0 }, d().d2f2b91a)))));
                },
                h = n.memo(f),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.TwitterBlue-cda947e7.5ae5851a.js.map
