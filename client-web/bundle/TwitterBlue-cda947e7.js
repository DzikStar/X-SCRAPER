    ...
    ["bundle.TwitterBlue-cda947e7"],
    {
        ...
        290008: (e, t, r) => {
            ...
            const p = ({ content: e, isTierSwitching: t, referringPage: r, selectedProduct: p, setSelectedProduct: g }) => {
                const f = (0, n.useHistory)(),
                    ...
                    w = (0, i.Z)({ fetchPrices: y }),
                    E = a.useMemo(() => (0, c.R)(w), [w]),
        ...
        320479: (e, t, r) => {
            ...
            const b = ({ content: e, referringPage: t, selectedProduct: r, setSelectedProduct: o, state: c }) => {
                    ...
                    const x = n.useRef(null),
                        ...
                        [C, _] = n.useState(0);
                    n.useEffect(() => {
                        S(x.current?.clientHeight ?? 0), _(k.current?.clientHeight ?? 0);
                    }, [x.current?.clientHeight, k.current?.clientHeight, u]);
                    const F = n.useMemo(() => ({ marginTop: v, marginBottom: C }), [v, C]),
                        ...
                        I = { content: e, referringPage: t, selectedProduct: r, setSelectedProduct: o, state: c, catalogItems: c.catalogItems, catalogItemsForProduct: z, headerRef: x, footerRef: k, headerFooterOffset: F, selectedProductIndex: T };
                    return n.createElement(
                        d.P.Provider,
                        { value: { footerHeight: C, headerHeight: v } },
                            ...
                            (() => {
                                switch (c.paywallDesignVariant) {
                                    case "feature_focused":
                                        return n.createElement(m.Z, I);
                                    case "one_click":
                                        return n.createElement(f.Z, I);
                                    case "v1_1_1":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !1, withFeatureFocus: !1, withPurchaseSheet: !1, withUpsellTier: !1 }, I));
                                    case "v1_1_2":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !1, withFeatureFocus: !1, withPurchaseSheet: !0, withUpsellTier: !1 }, I));
                                    case "v1_2_1":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !1, withFeatureFocus: !1, withPurchaseSheet: !1, withUpsellTier: !0 }, I));
                                    case "v1_2_2":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !1, withFeatureFocus: !1, withPurchaseSheet: !0, withUpsellTier: !0 }, I));
                                    case "v1_3_1":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !0, withFeatureFocus: !1, withPurchaseSheet: !1, withUpsellTier: !1 }, I));
                                    case "v1_3_1_dynamic":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !0, withFeatureFocus: !0, withPurchaseSheet: !1, withUpsellTier: !1 }, I));
                                    case "v1_3_1_blue":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "blue", withExtraFeatures: !0, withFeatureFocus: !1, withPurchaseSheet: !1, withUpsellTier: !1 }, I));
                                    case "v1_3_2":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !0, withFeatureFocus: !1, withPurchaseSheet: !0, withUpsellTier: !1 }, I));
                                    case "v1_3_2_dynamic":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "gold", withExtraFeatures: !0, withFeatureFocus: !0, withPurchaseSheet: !0, withUpsellTier: !1 }, I));
                                    case "v1_3_2_blue":
                                        return n.createElement(y.Z, (0, a.Z)({ primaryColor: "blue", withExtraFeatures: !0, withFeatureFocus: !1, withPurchaseSheet: !0, withUpsellTier: !1 }, I));
                                    case "offer_v1_1":
                                        return n.createElement(g.Z, (0, a.Z)({}, I, { primaryColor: "gold", withAnnualPriceMonthly: !1 }));
                                    case "offer_v1_2":
                                        return n.createElement(g.Z, (0, a.Z)({}, I, { primaryColor: "blue", withAnnualPriceMonthly: !1 }));
                                    case "offer_v2_1":
                                        return n.createElement(g.Z, (0, a.Z)({}, I, { primaryColor: "gold", withAnnualPriceMonthly: !0 }));
                                    case "offer_v2_2":
                                        return n.createElement(g.Z, (0, a.Z)({}, I, { primaryColor: "blue", withAnnualPriceMonthly: !0 }));
                                    case "special":
                                        return n.createElement(h.Z, I);
                                    case "v2":
                                        return n.createElement(w.Z, (0, a.Z)({}, I, { withPurchaseSheet: !0 }));
                                    case "v2_2":
                                        return n.createElement(w.Z, (0, a.Z)({}, I, { withIntervalSelector: !1, withPurchaseSheet: !1 }));
                                    case "v2_3":
                                        return n.createElement(w.Z, (0, a.Z)({}, I, { withIntervalSelector: !0, withPurchaseSheet: !1 }));
                                    case "v3":
                                        return n.createElement(E.Z, (0, a.Z)({}, I, { withPurchaseSheet: !1 }));
                                    default:
                                        return n.createElement(p.Z, I);
                                }
                            })(),
                        ),
                    );
        ...
        192933: (e, t, r) => {
            ...
            const b = c().i859a9d4,
                ...
                x = a.createElement(E.default, { style: P.iconInfo });
            var v = r(985529);
            const S = (e, t) => e?.filter((e) => !t?.map((e) => e.header).includes(e.header)),
                k = c().dfc5f972,
                C = ({ content: e, hideTitle: t, prices: r, productCategory: n, productContent: o, referringPage: c, selectedInterval: i, selectedProduct: s, setSelectedProduct: u, setShowExtraFeatures: y, showExtraFeatures: w, withExtraFeatures: E, withFeatureFocus: b, withOfferCard: P, withUpsellTier: x }) => {
                    const C = (0, f.Z)(),
                                ...
                                ? o.extraFeatures.map((e, t) =>
                                      a.createElement(
                                          ...
                                          a.createElement(
                                              ...
                                              (M ? S(e.features, B?.features) : e.features)?.map((e, r) => a.createElement(Z, { changeToTier: I, feature: e, key: `extra_feature_${t}_feautre_${r}` })),
                                          ),
                                      ),
                                  )
                                : null,
                ...
                z = ({ content: e, hideTitle: t, prices: r, productListLayout: l, products: o, referringPage: c, selectedInterval: d, selectedProduct: m, selectedProductIndex: p, setSelectedProduct: g, setShowAllFeaturesPage: f, setShowExtraFeatures: h, showExtraFeatures: y, withExtraFeatures: w, withFeatureFocus: E, withOfferCard: b, withUpsellTier: Z }) => {
                    const P = (0, i.Z)(),
                        ...
                        v = "V2" === l ? s.Z : "V3" === l ? u.Z : C;
                    return a.createElement(
                        n.Z,
                        { "aria-label": F, childrenStyle: [T.children, { alignItems: "V3" === l ? "center" : null }], navButtonStyle: T.navButtonStyle, onVisibleRangeChange: x, scrollToCenter: !0, showNavButtonsOnHover: !0, showOverflow: !0, style: T.carousel, visibleItemIndex: p, withScrollIntoView: !1 },
        ...
        381214: (e, t, r) => {
            ...
            const y = (e) => {
                ...
                x = a.createElement(h.default, { style: P.iconInfo }),
                v = a.memo(Z);
        },
        278637: (e, t, r) => {
            r.d(t, { Z: () => f });
        ...
        867754: (e, t, r) => {
            ...
            var a = r(807896),
                ...
                m = r(278637);
            const p = d().e1606e52,
                g = ({ content: e, header: t, isMobile: r, isTierSwitching: s, offerContent: u, offerEndsAtMsec: g, renderOfferContent: f }) => {
                    const y = (0, o.Mv)(),
                        w = (0, c.Gz)(),
                        E = y ? h.marginSmall : w ? h.marginLarge : h.marginMedium,
                        b = y ? { size: "title3", style: h.titleSmall } : w ? { style: h.titleLarge } : { size: "title1", style: h.titleMedium },
                        Z = y ? "body" : w ? "headline1" : "headline2",
                        P = y ? h.countdownSmall : w ? h.countdownLarge : h.countdownMedium;
                    return n.createElement(l.Z, null, n.createElement(l.Z, { style: [h.header, E, h.container] }, n.createElement(i.ZP, (0, a.Z)({}, b, { weight: "bold" }), s ? p : f ? u.title : t.title), n.createElement(i.ZP, { color: "gray900", size: Z }, f ? null : t.description), f && g ? n.createElement(l.Z, { style: [h.countdown, P] }, n.createElement(m.Z, { endsAtMsec: g })) : null, f ? null : n.createElement(i.ZP, { color: "gray900", size: Z, style: h.voLink }, n.createElement(d().I18NFormatMessage, { $i18n: "c57cd3a3" }, n.createElement(i.ZP, { color: "text", link: "/i/verified-orgs-signup", underlineWeight: "heavy", weight: "bold", withUnderline: !0 }, d().d2f2b91a)))));
                },
                f = n.memo(g),
        ...
        330463: (e, t, r) => {
            ...
            const p = s().acfaf7a0,
                g = s().b601cfbb,
                f = ({ catalogItems: e, content: t, selectedProduct: r, setShowAllFeaturesPage: c }) => {
        ...
        632396: (e, t, r) => {
            ...
            const P = c().be103b84,
                            ...
                            (e) =>
                                a.createElement(
                                    ...
                                    e?.feature_buckets?.buckets.map((e, t) => {
                                        ...
                                        return a.createElement(a.Fragment, { key: t }, a.createElement(s.Z, { style: C.featureCard }, a.createElement(m.ZP, { size: "headline2", style: C.featureCardTitle, weight: "bold" }, e.title), r ? e.features?.map(T) : null));
                                    }),
                                ),
                            [T],
                        ),
                ...
                T = ({ activeSubscription: e, content: t, isTargettedUpsellFlow: r, prices: l, products: o, referringPage: c, selectedProduct: s, selectedProductIndex: u, setSelectedProduct: d }) => {
                    ...
                    return a.createElement(
                        n.Z,
                        { "aria-label": z, childrenStyle: I.children, navButtonStyle: I.navButtonStyle, onVisibleRangeChange: p, scrollToCenter: !0, showNavButtonsOnHover: !0, showOverflow: !0, visibleItemIndex: u, withScrollIntoView: !1 },
            ...
            const d = (e, t) => (t ? ({ blue: { backgroundImage: `\n            linear-gradient(90.38deg, \n            ${e.colors.blue500} 0.23%, \n            ${e.colors.blue600} 32.73%, \n            ${e.colors.blue500} 50.37%,\n            ${e.colors.blue500} 98.27%)\n          ` }, gold: { backgroundImage: `\n            linear-gradient(90.38deg, \n            ${e.colors.gold50} 0.23%, \n            ${e.colors.gold0} 32.73%, \n            ${e.colors.gold50} 50.37%,\n            ${e.colors.gold100} 98.27%)\n          ` }, special: { borderRadius: 16 }, leftAligned: { borderRadius: o.default.theme.spaces.space12 } }[t] ?? void 0) : void 0),
                ...
                g = ({ buttonFontSize: e, buttonSize: t, disabled: r, disclaimerRef: g, label: h, loading: y, onClick: w, savePill: E, styleOverrides: b, subtext: Z, variant: P }) => {
                    const x = n.useCallback(() => {
                        ...
                        { disclaimerFontColor: v, disclaimerFontSize: S, marginBottom: k, withoutDisclaimerBorder: C } = b ?? {},
                        _ = k ? o.default.theme.spaces[k] : null;
                    return n.createElement(n.Fragment, null, n.createElement(l.Z, { style: [f.buttonWrapper, _ && { marginBottom: _ }] }, E, n.createElement(c.ZP, (0, a.Z)({}, "leftAligned" === P ? { alignContent: "left" } : {}, { allowTextWrap: !0, color: m(P), disabled: r, onClick: x, size: t || "xLarge", style: [d(o.default.theme, P), f.button], textSizeOverride: e || "headline2", type: p(P) }), y ? n.createElement(i.Z, null) : h), Z ? n.createElement(s.ZP, { align: "center", size: "subtext2", style: f.subtext, testID: "purchase-button-subtext" }, Z) : null), g ? n.createElement(l.Z, null, n.createElement(u.Z, { disclaimerRef: g, freeTrialInfo: null, styleOverrides: { disclaimerFontSize: S, disclaimerFontColor: v, withoutDisclaimerBorder: C } })) : null);
                },
