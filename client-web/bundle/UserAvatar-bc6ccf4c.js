    ...
    ["bundle.UserAvatar-bc6ccf4c"],
    {
        879113: (e, t, o) => {
            ...
            class u extends i.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: o, fetchStatus: n, icon: s, loadingMessage: r, onRequestRetry: c, render: u, renderFailure: g, retryMessage: p, retryable: _ } = this.props;
                    switch (n) {
                        case l:
        ...
        7022: (e, t, o) => {
            ...
            const c = o(401339).Z.isTouchSupported(),
                ...
                d = { height: 0, width: 0, left: 0, right: 0, top: 0, bottom: 0 },
            ...
            class _ extends i.Component {
                ...
                render() {
                    ...
                    return i.createElement(
                        ...
                        i.createElement(n.y_, { style: r }, ({ zoom: e, zoomCenterX: n, zoomCenterY: r }) => i.createElement(s.Z, { ref: this._ref, style: [w.fill, { transform: [{ scale: e }], transformOrigin: `${o ? n : t.x}px ${o ? r : t.y}px` }] }, this.props.children)),
                    );
                }
                componentDidMount() {
                ...
                _handlePanMove(e) {
                    ...
                    let d = 0,
                        u = 0;
                    m - l > 0 && (d = t - i), c - h > 0 && (u = o - n), this.setState({ lastX: t, lastY: o, zoomCenter: { x: (0, r.Z)(s - d, 0, l), y: (0, r.Z)(a - u, 0, h) } });
                }
                _handlePinchStart(e) {
                    const { touches: t } = e;
                ...
                _handlePinchMove(e) {
                    ...
                    const m = g(t[0], t[1]),
                        d = this._lastDistance ? m / this._lastDistance : 1,
                        _ = u(l - c, a + h, n * d),
                        w = p(t[0], t[1]),
                        f = (() => {
                            if (!this._windowDimensions || !o) return s;
                            const { height: e, width: t } = this._windowDimensions;
                            return { x: (0, r.Z)(s.x - (w.x - o), 0, t), y: (0, r.Z)(s.y - (w.y - i), 0, e) };
                        })();
                    (this._lastDistance = m), this.setState({ lastX: w.x, lastY: w.y, zoom: _, zoomCenter: f });
                }
                _handleTapStart(e) {
                    const { touches: t } = e;
            ...
            const w = l.default.create((e) => ({ fill: { flex: 1 } })),
                f = _;
        },
        355586: (e, t, o) => {
        ...
        276259: (e, t, o) => {
            o.d(t, { Lw: () => n, Re: () => m, VJ: () => a, ZF: () => d, hv: () => h, ku: () => i, qp: () => s, uv: () => r, v5: () => c });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserAvatar-bc6ccf4c.45fc7c1a.js.map
