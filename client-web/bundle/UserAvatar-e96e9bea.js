    ...
    ["bundle.UserAvatar-e96e9bea"],
    {
        ...
        6157: (e, t, o) => {
            ...
            function D({ apiClient: e }) {
                return {
                    clearConversations: (t, o) => e.graphQL(s(), {}).then((e) => (e.clear_grok_conversations?.grok_deletion_error?.error_code && (0, a.ZP)("GraphQL clear grok conversations failed."), e)),
                    setPreferences: ({ grokMode: t, grokModelOptionId: o }) => e.graphQL(P(), { grokMode: t, grokModelOptionId: o }).then((e) => (e.set_grok_preferences?.preference_update_error?.error_code && (0, a.ZP)("GraphQL set grok preferences failed."), e)),
        ...
        290402: (e, t, o) => {
            ...
            const _ = d().aa6e3300,
                c = ({ retryMessage: e, ...t }, o) => {
                    ...
                    return r.createElement(i.Z, (0, n.Z)({}, t, { icon: s ? void 0 : r.createElement(p.default, { style: h.icon }), retryMessage: s ? e : _ }));
                },
        ...
        300234: (e, t, o) => {
            ...
            class v extends n.Component {
                ...
                render() {
                    const { children: e, onDismiss: t, onLayout: o, style: a } = this.props,
                        i = !!t;
                    return n.createElement(r.Z, { onLayout: o, onTouchEnd: i ? this._handleTouchEnd : void 0, onTouchMove: i ? this._handleTouchMove : void 0, onTouchStart: i ? this._handleTouchStart : void 0, style: a, testID: "swipe-to-dismiss" }, e);
                }
            }
            const k = v;
            var C = o(992942),
            ...
            class L extends n.PureComponent {
                ...
                render() {
                    const { dataSaver: e, imageStyle: t, onError: o, onLoad: a, onTap: i, onZoomed: s, photo: l, resetZoom: d, style: p, zoomable: _ } = this.props,
                        { loadingVariant: c } = this.state,
                        h = (e && c && Math.max(c.width, c.height) >= 680 ? c.uri : null) || L._selectSource(l);
                    if (!h || null === c) return null;
                    const u = n.createElement(C.Z, { "aria-label": l.ext_alt_text ? l.ext_alt_text : T, defaultSource: c && c.uri, draggable: !0, onError: c ? void 0 : o, onLoad: a, onLoadEnd: this._handleLoadEnd, onLoadStart: this._handleLoadStart, resizeMode: "contain", source: h, style: [P.img, t] });
                    return n.createElement(r.Z, { style: p }, this.state.imageLoading ? D : null, _ ? n.createElement(I.Z, { onTap: i, onZoomed: s, resetZoom: d }, u) : u);
                }
            ...
            class q extends n.PureComponent {
                ...
                render() {
                    ...
                    return n.createElement(r.Z, { style: e }, n.createElement(r.Z, { style: M.root }, this._renderVideo()));
                }
                ...
                _renderVideo() {
                    const { promotedContent: e, video: t, videoId: o } = this.props,
                        [r, i] = t.video_info.aspect_ratio,
                        s = a.Z.extractVideoProps(o, t);
                    return (s.aspectRatio = r / i), n.createElement(G.Z, (0, u.Z)({}, s, { onPlaybackStarted: this._handlePlaybackStarted, playbackCoordination: null, promotedContent: e, setPlayer: this._setPlayer, withPostPlayback: !0 }));
                }
            }
            ...
            class R extends n.Component {
                ...
                render() {
                    const { businessAvatar: e, dataSaver: t, mediaIndex: o, mediaItems: i, onDismiss: s, onTap: l, promotedContent: d } = this.props,
                        ...
                        _ = i.map((r, _) => {
                            const c = a.Z.isVideo(r),
                                h = this._getItemVideoId(r),
                                u = o === _;
                    ...
                    return n.createElement(r.Z, { style: z.root }, i.length > 1 ? this._renderCarousel(_) : _);
                }
                _renderCarousel(e) {
            ...
            class f extends n.Component {
                ...
                render() {
                    ...
                    return n.createElement(
                        n.Fragment,
                        null,
                        n.createElement(r.Z, { onClick: this._handleBackgroundPress, style: x }, t, o ? n.createElement(r.Z, { pointerEvents: p ? "none" : void 0, style: [y.footerButtons, f && C, f && y.footerButtonsAbsolute, p && y.fadeOut] }, n.createElement(a.Z, { withGutter: !0 }, o)) : null),
                        ...
                        v ? n.createElement(r.Z, { pointerEvents: p ? "none" : void 0, style: [y.buttonWrapper, y.buttonWrapperRight, u.nk, p && y.fadeOut] }, v) : null,
                        Z
                            ? n.createElement(
                                  r.Z,
        ...
        890103: (e, t, o) => {
            ...
            r &&
                s(function () {
                    ...
                    for (var i in (e && (a.hasIndices = "d"), a)) r(i, a[i]);
                    return Object.getOwnPropertyDescriptor(d, "flags").get.call(t) !== n || o !== n;
                }) &&
                a(d, "flags", { configurable: !0, get: i });
        },
        936386: (e) => {
            function t(e, t, o) {
                var n, r, a, i, s;
                function l() {
                    var d = Date.now() - i;
                    d < t && d >= 0 ? (n = setTimeout(l, t - d)) : ((n = null), o || ((s = e.apply(a, r)), (a = r = null)));
                }
                null == t && (t = 100);
                var d = function () {
                    (a = this), (r = arguments), (i = Date.now());
                    var d = o && !n;
                    return n || (n = setTimeout(l, t)), d && ((s = e.apply(a, r)), (a = r = null)), s;
                };
                return (
                    (d.clear = function () {
                    ...
                    (d.flush = function () {
                        n && ((s = e.apply(a, r)), (a = r = null), clearTimeout(n), (n = null));
                    }),
                    d
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserAvatar-e96e9bea.4001fada.js.map
