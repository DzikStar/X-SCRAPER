(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserJobs-6107ac1a", "icons/IconNumberedList-js"],
    {
        135904: (e, t, n) => {
            "use strict";
            n.d(t, { c: () => l, n: () => r });
        ...
        524496: (e, t, n) => {
            ...
            var o = n(202784),
                ...
                m = n(392237),
                b = n(135904);
            const g = { [d.P7.atomic]: { element: "section" }, [d.P7.header1]: { element: "h1", wrapper: o.createElement(s.ZP, null) }, [d.P7.header2]: { element: "h2", wrapper: o.createElement(s.ZP, null) } },
            ...
            const w = o.memo(function (e) {
                    ...
                    const m = [(0, h.ez)(i, s), h.aF, h.RU];
                    e.disable_entityLinkDecorator || m.push((0, h.NA)(i, s));
                    const g = f.Z.initEditorState(n, { decorators: m });
                    let w = a.Z;
                    return (
                        t &&
                            (w = (e) => {
                        ...
                        o.createElement(c.ZP, null, ({ containerWidth: e }) => o.createElement(l.Z, { style: k.fontFamily }, o.createElement(r.Editor, { blockRenderMap: y, blockRendererFn: w, blockStyleFn: (0, d.su)(p.Z.isNarrowScreenWidth(e)), editorState: g, onChange: a.Z, readOnly: !0, webDriverTestID: "longformRichTextComponent" })))
                    );
                }),
                k = m.default.create((e) => ({ fontFamily: { fontFamily: e.fontFamilies.normal } }));
        },
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => x, Ak: () => _, KJ: () => w, LI: () => v, P7: () => b, PW: () => $, QF: () => g, Qm: () => D, Tr: () => T, b$: () => m, db: () => C, et: () => E, fR: () => p, iH: () => S, lD: () => y, su: () => k, u4: () => Z, wX: () => z });
            var o = n(202784),
                r = n(111677),
                l = n.n(r),
                i = n(394123),
            ...
            const p = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                $ = l().b92b6156,
                x = l().ec5ed598,
                v = ({ children: e, extendedWidth: t, size: n, weight: r }) => o.createElement(h.ZP, { extendedWidth: t, size: n, weight: r }, e),
                T = { blockType: b.paragraph, label: x, component: v({ size: "body", children: x }) },
                S = [{ blockType: b.header1, label: E, component: v({ size: "title1", extendedWidth: !0, children: E }) }, { blockType: b.header2, label: $, component: v({ size: "title3", weight: "heavy", children: $ }) }, T],
        ...
        466818: (e, t, n) => {
            ...
            var o = n(202784),
                ...
                c = n(224162),
                u = n(392237);
            const f = o.forwardRef((e, t) => (0, d.Z)("select", { ...e, ref: t })),
                h = (e) => (0, d.Z)("option", e);
            let p = 1;
            class m extends o.PureComponent {
                    ...
                    super(e),
                        ...
                        (this._handleChange = (e) => {
                            const { onChange: t, withEmptyOption: n } = this.props,
                                { selectedIndex: o, value: r } = e.target;
                            t && t(r, o - (n ? 1 : 0));
                        }),
                        (this._handleBlur = (e) => {
                ...
                render() {
                    const { "aria-describedby": e, disabled: t, errorText: n, hasError: d, helperText: p, options: m, style: g, testID: y, value: D, withEmptyOption: w } = this.props,
                        { isFocused: k } = this.state,
                        E = s.ZP.getLanguage(),
                        $ = void 0 === d ? !!n : d,
                        x = new Set();
                    n && x.add(this._errorID), e && x.add(e), p && x.add(this._helperID);
                    const v = x.size ? [...x].join(" ") : void 0;
                    return o.createElement(
                        o.Fragment,
                        null,
                        o.createElement(c.ZP.Consumer, null, ({ direction: e }) => {
                            const s = "ja" === E ? u.default.theme.fontFamilies.japan : "rtl" === e || i.Z.isLocaleRTL(E) ? u.default.theme.fontFamilies.rtl : u.default.theme.fontFamilies.normal;
                            return o.createElement(
                                r.Z,
                                { style: [a.Z.border, b.container, t && a.Z.disabled, k && a.Z.focusedBorderValid, $ && a.Z.invalidBorderColor, k && $ && a.Z.focusedBorderInvalid, g] },
                                this._renderLabel(),
                                o.createElement(
                                    f,
                                    { "aria-describedby": v, "aria-invalid": $, "aria-labelledby": this._labelID, disabled: t, id: this._id, onBlur: this._handleBlur, onChange: this._handleChange, onFocus: this._handleFocus, ref: this._selectRef, style: [b.select, { fontFamily: s }, t && a.Z.disabled], testID: y || "", value: D },
                                    w ? o.createElement(h, { disabled: !0, style: b.option, value: "" }) : null,
                                    m.map((e) => {
                                        const { disabled: t, label: n, value: r } = e;
                                        return o.createElement(h, { disabled: t, key: `${n}-${r}`, style: b.option, value: r }, n);
                                    }),
                                ),
                                o.createElement(l.default, { style: [b.dropdownCaret, k && a.Z.validColor, !(!d && !n) && a.Z.invalidColor] }),
                            );
                        }),
                        p ? this._renderHelperText() : null,
                        $ && n ? this._renderErrorText() : null,
                    );
                }
                _renderLabel() {
                    const { errorText: e, hasError: t, label: n } = this.props,
                        { isFocused: r } = this.state;
                    return o.createElement(s.ZP, { color: t || e ? "red500" : r ? "primary" : "gray700", id: this._labelID, role: "label", style: b.label }, n);
                }
                _renderHelperText() {
                    return o.createElement(r.Z, { "aria-live": "polite" }, o.createElement(s.ZP, { color: "gray700", id: this._helperID, style: b.helperText }, this.props.helperText));
                }
                _renderErrorText() {
                    return o.createElement(r.Z, { "aria-live": "polite" }, o.createElement(s.ZP, { color: "red500", id: this._errorID, style: b.helperText }, this.props.errorText));
                }
            }
        ...
        280278: (e, t, n) => {
            ...
            const d = "up",
                ...
                u = (e, t, n) => {
                    n((n) => {
                        const o = (0, l.Z)(e) ? (e > (n.count || 0) ? d : c) : d;
            ...
            [d, c].forEach((e) => {
                const t = "0.3s";
                f[e] = { active: { transitionProperty: "transform", transitionDuration: t, transform: "translate3d(0, 0, 0)" }, pre: { transform: `translate3d(0, ${e === d ? "100%" : "-100%"}, 0)` }, post: { transform: `translate3d(0, ${e === d ? "-100%" : "100%"}, 0)`, transitionProperty: "transform", transitionDuration: t } };
            });
            const h = { position: "absolute" },
                p = s.default.create({ root: { overflow: "hidden" } }),
                m = (e) => {
                    const { children: t, containerStyle: n, count: s, ...c } = e,
                        [m, b] = o.useState({ animating: !1, count: e.count, pendingCount: null, text: e.children, oldText: null, pendingText: null, transitionDirection: d }),
                        g = o.useRef(!1);
                    return (
                        o.useEffect(
                            () => (
                        ...
                        o.useEffect(() => {
                            if (g.current)
                                if (i.Z.reducedMotionEnabled) b((n) => ({ ...n, oldText: null, text: t, pendingText: null, pendingCount: null, count: e.count }));
                                    ...
                                    t === m.text || ((0, l.Z)(e.count) && m.count === e.count) ? b((e) => ({ ...e, pendingCount: null, pendingText: null })) : (b((n) => ({ ...n, pendingCount: e.count, pendingText: t })), m.animating || u(e.count, t, b));
                                }
                        }, [t]),
                        o.useEffect(() => {
                            g.current &&
                                ...
                                (m.oldText
                                    ...
                                    : m.pendingText && u(m.pendingCount, m.pendingText, b));
                        }, [m.animating, m.oldText]),
                        o.useMemo(() => {
                            const e = f[m.transitionDirection],
                                t = m.oldText && !i.Z.reducedMotionEnabled,
                                l = !m.animating && m.oldText && !i.Z.reducedMotionEnabled,
                                s = { ...h, ...(m.animating ? e.post : e.active) },
                                d = { ...(l ? e.pre : e.active) };
                            return o.createElement(
                                r.Z,
                                { style: [p.root, n] },
                                t ? o.createElement("span", { style: s }, o.createElement(a.ZP, c, m.oldText)) : null,
                                o.createElement(
                                    "span",
                                    {
        ...
        936386: (e) => {
            function t(e, t, n) {
                ...
                function s() {
                    var d = Date.now() - i;
                    d < t && d >= 0 ? (o = setTimeout(s, t - d)) : ((o = null), n || ((a = e.apply(l, r)), (l = r = null)));
                }
                null == t && (t = 100);
                var d = function () {
                    (l = this), (r = arguments), (i = Date.now());
                    var d = n && !o;
                    return o || (o = setTimeout(s, t)), d && ((a = e.apply(l, r)), (l = r = null)), a;
                };
                return (
                    (d.clear = function () {
                    ...
                    (d.flush = function () {
                        o && ((a = e.apply(l, r)), (l = r = null), clearTimeout(o), (o = null));
                    }),
                    d
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserJobs-6107ac1a.719b6d9a.js.map
