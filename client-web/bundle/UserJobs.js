    ...
    ["bundle.UserJobs"],
    {
        ...
        985124: (e, a, l) => {
            ...
            const o = Object.freeze({ DISABLED: 0, ENABLED: 10, SYNC_IN_PROGRESS: 20, SYNC_FAILED: 30 }),
                ...
                M = t().c4627fda,
                P = t().db75b47c,
                x = Object.freeze({ intern: w, entry_level: F, junior: E, mid_level: C, senior: I, lead: Z, manager: M, executive: P }),
        ...
        499102: (e, a, l) => {
            ...
            const D = d().f508c49c,
                ...
                E = ({ iconSize: e = "normal", jobId: a, jobUserId: l }) => {
                    const s = (0, g.p)(),
                        d = (0, t.useHistory)(),
                        { userClaims: E, viewerUserId: C } = (0, h.QZ)(),
                        I = (0, y.hC)("recruiting_jobs_list_share_enabled"),
                        Z = (0, y.hC)("recruiting_pin_job_enabled") && (E.isTrueAndEnabled("subscriptions_feature_premium_jobs") || E.isVerifiedOrg()) && C !== l,
                        M = r.useCallback(() => {
                        ...
                        K = r.useCallback(() => {
                            const e = [];
                            return n.Z.isAvailable() && e.push({ text: D, onClick: P, Icon: c.default }), C && (e.push(((e) => ({ text: k, onClick: e, Icon: u.default }))(M)), e.push(((e) => ({ text: A, onClick: e, Icon: p.default }))(x))), Z && e.push(((e) => ({ text: v, onClick: e, Icon: b.default }))(B)), e;
                        }, [P, M, B, x, Z, C]),
                        L = r.useCallback(
                            (e) => {
                                const a = K();
                        ...
                        T = r.useCallback(() => {}, []);
                    return I ? r.createElement(i.ZP, { Icon: m.default, "aria-label": w, color: "text", hoverLabel: F, iconSize: e, onPress: T, renderMenu: L, testID: "job-share-action-btn" }) : null;
                },
                C = r.memo(E);
        },
        771035: (e, a, l) => {
        ...
        736181: (e, a, l) => {
            ...
            const ge = ({ fallbackName: e, user: a }) => {
                ...
                Ee = ({ fetchNext: e, isViewerFollowsUser: a, profileId: l, slice: n, user: o }) => {
                    ...
                    return s ? (s.length ? r.createElement(Y.Z, { cacheKey: "userJobList", footer: null, identityFunction: Fe, items: s, onItemsRendered: p, onNearEnd: e, renderer: d }) : r.createElement(t.Z, { header: "No jobs" })) : null;
                },
                Ce = r.memo(Ee),
                ...
                Pe = (e) => {
                    const { query: a, screenName: l, user: n } = e,
                        ...
                        { data: o, fetchNext: i } = (0, W.C)(Me, t),
                        s = o?.data?.result?.recruiting_organization_results?.result?.consumer_job_search;
                    return s ? r.createElement(H.nO, { namespace: Ie }, r.createElement(O.Z, null, r.createElement(r.Fragment, null, r.createElement(N.Z, { title: Ze(l) }), r.createElement(Ce, { fetchNext: i, isViewerFollowsUser: n.following, profileId: n.id_str, slice: s, user: o.data.result })))) : null;
                },
                xe = { context: "UserJobs" },
                Be = (e) => {
                    const [a] = (0, J.Z)(),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserJobs.e6789aea.js.map
