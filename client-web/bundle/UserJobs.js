    ...
    ["bundle.UserJobs"],
    {
        ...
        736181: (e, l, a) => {
            ...
            var x,
                ...
                U = {
                    fragment: {
                        argumentDefinitions: [(x = { defaultValue: null, kind: "LocalArgument", name: "count" }), (v = { defaultValue: null, kind: "LocalArgument", name: "cursor" }), (C = { defaultValue: null, kind: "LocalArgument", name: "searchParams" }), (Z = { defaultValue: null, kind: "LocalArgument", name: "userId" })],
                        kind: "Fragment",
                        metadata: null,
            ...
            const fe = ({ fallbackName: e, user: l }) => {
                ...
                Fe = ({ allowShare: e = !1, companyName: l, createdAt: a, formattedSalary: r, isFeatured: s, isVerifiedOrg: o, jobId: c, jobTitle: u, location: d, onClick: m, profileId: p, redirectUrl: g, salaryInterval: y, shortDescription: b, user: f, withUserInfo: _ = !1 }) => {
                    (0, de.q)(() => {
                    ...
                    return n.createElement(ie.Z, { interactive: !0, link: o ? { pathname: S, external: !0 } : g || "", onClick: m, style: ke.listContainer }, n.createElement(t.Z, { style: ke.items }, n.createElement(i.ZP, { hoverLabel: h, numberOfLines: 2, size: "subtext1", weight: "bold" }, u), _ ? n.createElement(fe, { fallbackName: l, user: f }) : null, n.createElement(i.ZP, { color: "text", size: "subtext2", weight: "normal" }, d), r ? n.createElement(i.ZP, { color: "text", size: "subtext2", weight: "normal" }, (0, oe.M)(r, y)) : null, k && F ? n.createElement(t.Z, { style: ke.shortDescription }, n.createElement(me.Z, { className: he }, n.createElement(ce.Z, { contentState: k, paragraphFontSizeOverride: _e.paragraphFontSize }))) : null), n.createElement(t.Z, { style: ke.lastRow }, n.createElement(t.Z, { style: ke.itemRow }, n.createElement(t.Z, { style: ke.itemRow }, a ? n.createElement(ue.Z, { cutoff: "years", humanReadable: !0, style: ke.timestamp, timestamp: a }) : null, s ? n.createElement(pe.Z, null) : null), e ? n.createElement(be.Z, { iconSize: "small", jobId: c, jobUserId: p }) : null)));
                },
                Se = ae,
                ...
                Le = (e) => {
                    ...
                    return o ? n.createElement(H.nO, { namespace: Te }, n.createElement(O.Z, null, n.createElement(n.Fragment, null, n.createElement(B.Z, { title: Ke(a) }), n.createElement(we, { fetchNext: i, isViewerFollowsUser: t.following, profileId: t.id_str, slice: o, user: s.data.result })))) : null;
                },
                ze = { context: "UserJobs" },
                je = (e) => {
                    const [l] = (0, M.Z)(),
            ...
            const Je = () => {
                ...
                Be = ({ onDismiss: e, screenName: l }) => n.createElement(Re.Z, { onMaskClick: e, style: Oe.modalContainer, type: "full", withMask: !0 }, n.createElement(t.Z, { style: Oe.modalContent }, n.createElement(i.ZP, null, "Search jobs")), n.createElement(_.Z, { basePath: `/${l}/jobs` }), n.createElement(Je, null), n.createElement(De.ZP, { onClick: e, type: "brandFilled" }, "Done")),
                ...
                qe = E((e) => {
                    ...
                    if (d) {
                        ...
                        return v ? n.createElement(n.Fragment, null, n.createElement(p.Z, { backLocation: "/", history: u, primaryContent: h ? (!h?.protected || h?.following || x ? n.createElement(n.Fragment, null, F && d ? n.createElement(t.Z, { style: Ve.rightControlContainer }, n.createElement(t.Z, { style: Ve.searchContainer }, n.createElement(_.Z, { basePath: `/${d}/jobs`, styleType: "selection" }))) : null, n.createElement(Pe, { screenName: d, user: h })) : n.createElement(r.Z, { header: He })) : null, primaryContentLabel: Me, sidebarContent: S ? n.createElement(t.Z, { style: Ve.sidebarRoot }, n.createElement(m.Z, { isSidebarModule: !0 })) : null, title: e() }), l ? n.createElement(Ae, { onDismiss: C, screenName: d }) : null) : n.createElement(f.Z, { to: `/${d}` });
                    }
                    return null;
                });
        },
                ...
                render() {
                    ...
                    return n.createElement(
                        ...
                        n.createElement(u.ZP.Consumer, null, ({ direction: e }) => {
                            ...
                            return n.createElement(
                                t.Z,
                                { style: [i.Z.border, b.container, l && i.Z.disabled, F && i.Z.focusedBorderValid, E && i.Z.invalidBorderColor, F && E && i.Z.focusedBorderInvalid, f] },
                                this._renderLabel(),
                                n.createElement(
                                    m,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserJobs.ff906a6a.js.map
