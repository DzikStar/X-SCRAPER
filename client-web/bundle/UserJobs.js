        ...
        736181: (e, l, a) => {
            ...
            const _e = ({ fallbackName: e, user: l }) => {
                ...
                Ke = ({ fetchNext: e, isViewerFollowsUser: l, profileId: a, slice: t, user: s }) => {
                    ...
                    return o ? (o.length ? n.createElement(G.Z, { cacheKey: "userJobList", footer: null, identityFunction: we, items: o, onItemsRendered: m, onNearEnd: e, renderer: c }) : n.createElement(r.Z, { header: "No jobs" })) : null;
                },
                Ze = n.memo(Ke),
                ...
                Le = (e) => {
                    ...
                    return o ? n.createElement(H.nO, { namespace: xe }, n.createElement(O.Z, null, n.createElement(n.Fragment, null, n.createElement(B.Z, { title: Ie(a) }), n.createElement(Ze, { fetchNext: i, isViewerFollowsUser: t.following, profileId: t.id_str, slice: o, user: s.data.result })))) : null;
                },
                ze = { context: "UserJobs" },
                je = (e) => {
                    const [l] = (0, M.Z)(),
            ...
            const Je = () => {
                ...
                qe = E((e) => {
                    ...
                    if (d) {
                        ...
                        return C ? n.createElement(n.Fragment, null, n.createElement(p.Z, { backLocation: "/", history: u, primaryContent: h ? (!h?.protected || h?.following || v ? n.createElement(n.Fragment, null, S && d ? n.createElement(t.Z, { style: Ve.rightControlContainer }, n.createElement(t.Z, { style: Ve.searchContainer }, n.createElement(f.Z, { basePath: `/${d}/jobs`, styleType: "selection" }))) : null, n.createElement(Re, { screenName: d, user: h })) : n.createElement(r.Z, { header: He })) : null, primaryContentLabel: Me, sidebarContent: F ? n.createElement(t.Z, { style: Ve.sidebarRoot }, n.createElement(m.Z, { isSidebarModule: !0 })) : null, title: e() }), l ? n.createElement(Ae, { onDismiss: w, screenName: d }) : null) : n.createElement(_.Z, { to: `/${d}` });
                    }
                    return null;
                });
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserJobs.424b8f8a.js.map
