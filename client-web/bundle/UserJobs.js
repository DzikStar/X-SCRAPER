    ...
    ["bundle.UserJobs"],
    {
        ...
        771035: (e, l, a) => {
            ...
            const c = ({ basePath: e, isCompact: l = !1, resetPageOnSearch: a = !1, styleType: c }) => {
                    ...
                    return n.createElement(r.Z, { Icon: s.default, autoComplete: "off", isCompact: l, leftAligned: !0, onChange: h, onClear: _, placeholder: "Search jobs", styleType: c || "pill", testID: "search-jobs-input", value: p, withClearButton: !0 });
                },
                u = n.memo(c);
        },
        736181: (e, l, a) => {
            ...
            var v,
                ...
                U = {
                    fragment: {
                        argumentDefinitions: [(v = { defaultValue: null, kind: "LocalArgument", name: "count" }), (C = { defaultValue: null, kind: "LocalArgument", name: "cursor" }), (w = { defaultValue: null, kind: "LocalArgument", name: "searchParams" }), (Z = { defaultValue: null, kind: "LocalArgument", name: "userId" })],
                        kind: "Fragment",
                        metadata: null,
            ...
            const _e = ({ fallbackName: e, user: l }) => {
                ...
                Fe = ({ allowShare: e = !1, companyName: l, createdAt: a, formattedSalary: r, isFeatured: s, isVerifiedOrg: o, jobId: c, jobTitle: u, location: d, onClick: m, profileId: p, redirectUrl: g, salaryInterval: y, shortDescription: b, user: _, withUserInfo: f = !1 }) => {
                    (0, de.q)(() => {
                        (0, re.fH)((0, ye.yW)(he, fe), he);
                    });
                    ...
                    return n.createElement(ie.Z, { interactive: !0, link: o ? { pathname: S, external: !0 } : g || "", onClick: m, style: ke.listContainer }, n.createElement(t.Z, { style: ke.items }, n.createElement(i.ZP, { hoverLabel: h, numberOfLines: 2, size: "subtext1", weight: "bold" }, u), f ? n.createElement(_e, { fallbackName: l, user: _ }) : null, n.createElement(i.ZP, { color: "text", size: "subtext2", weight: "normal" }, d), r ? n.createElement(i.ZP, { color: "text", size: "subtext2", weight: "normal" }, (0, oe.M)(r, y)) : null, k && F ? n.createElement(t.Z, { style: ke.shortDescription }, n.createElement(me.Z, { className: he }, n.createElement(ce.Z, { contentState: k, paragraphFontSizeOverride: fe.paragraphFontSize }))) : null), n.createElement(t.Z, { style: ke.lastRow }, n.createElement(t.Z, { style: ke.itemRow }, n.createElement(t.Z, { style: ke.itemRow }, a ? n.createElement(ue.Z, { cutoff: "years", humanReadable: !0, style: ke.timestamp, timestamp: a }) : null, s ? n.createElement(pe.Z, null) : null), e ? n.createElement(be.Z, { iconSize: "small", jobId: c, jobUserId: p }) : null)));
                },
                Se = ae,
            ...
            const Je = () => {
                ...
                Be = ({ onDismiss: e, screenName: l }) => n.createElement(Pe.Z, { onMaskClick: e, style: Oe.modalContainer, type: "full", withMask: !0 }, n.createElement(t.Z, { style: Oe.modalContent }, n.createElement(i.ZP, null, "Search jobs")), n.createElement(f.Z, { basePath: `/${l}/jobs` }), n.createElement(Je, null), n.createElement(Ne.ZP, { onClick: e, type: "brandFilled" }, "Done")),
                ...
                qe = E((e) => {
                    ...
                    const v = h?.id_str === k,
                        C = !h || (h && (0, b.n5)({ isOwnProfile: v, isSoftBlockEnabled: E, user: h })),
                        w = n.useCallback(() => {
                            a(!1);
                        }, []);
                    if (d) {
                        ...
                        return C ? n.createElement(n.Fragment, null, n.createElement(p.Z, { backLocation: "/", history: u, primaryContent: h ? (!h?.protected || h?.following || v ? n.createElement(n.Fragment, null, F && d ? n.createElement(t.Z, { style: Ve.rightControlContainer }, n.createElement(t.Z, { style: Ve.searchContainer }, n.createElement(f.Z, { basePath: `/${d}/jobs`, styleType: "selection" }))) : null, n.createElement(Re, { screenName: d, user: h })) : n.createElement(r.Z, { header: He })) : null, primaryContentLabel: Me, sidebarContent: S ? n.createElement(t.Z, { style: Ve.sidebarRoot }, n.createElement(m.Z, { isSidebarModule: !0 })) : null, title: e() }), l ? n.createElement(Ae, { onDismiss: w, screenName: d }) : null) : n.createElement(_.Z, { to: `/${d}` });
                    }
                    return null;
                });
        },
        466818: (e, l, a) => {
            ...
            class y extends n.PureComponent {
                ...
                render() {
                    const { "aria-describedby": e, disabled: l, errorText: a, hasError: c, helperText: g, options: y, style: _, testID: f, value: h, withEmptyOption: k } = this.props,
                    ...
                    return n.createElement(
                        ...
                        n.createElement(u.ZP.Consumer, null, ({ direction: e }) => {
                            ...
                            return n.createElement(
                                ...
                                n.createElement(
                                    m,
                                    { "aria-describedby": C, "aria-invalid": E, "aria-labelledby": this._labelID, disabled: l, id: this._id, onBlur: this._handleBlur, onChange: this._handleChange, onFocus: this._handleFocus, ref: this._selectRef, style: [b.select, { fontFamily: o }, l && i.Z.disabled], testID: f || "", value: h },
                                ...
                                n.createElement(r.default, { style: [b.dropdownCaret, F && i.Z.validColor, !(!c && !a) && i.Z.invalidColor] }),
                            );
                        }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserJobs.4537a47a.js.map
