...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserJobs"],
    {
        ...
        985124: (e, a, l) => {
            l.d(a, { $J: () => s, WA: () => T, ZC: () => v, cj: () => U, eo: () => r.eo, hb: () => B, kW: () => i, pg: () => w, rP: () => o, u4: () => O, xk: () => K });
            var r = l(89217),
                n = l(111677),
                t = l.n(n);
            const o = Object.freeze({ DISABLED: 0, ENABLED: 10, SYNC_IN_PROGRESS: 20, SYNC_FAILED: 30 }),
                ...
                D = t().e8ca78ae,
                S = t().c365dcc6,
                v = Object.freeze({ software_engineering: d, data_analytics: c, product: u, design: m, marketing: p, sales_am: h, operations: g, people_hr: b, finance_accounting: f, legal_compliance: y, science_engineering: _, medical: k, construction_trades: D, other: S }),
                ...
                M = t().c4627fda,
                P = t().db75b47c,
                T = Object.freeze({ intern: E, entry_level: Z, junior: F, mid_level: C, senior: x, lead: I, manager: M, executive: P }),
        ...
        127218: (e, a, l) => {
            ...
            function f(e, a, l) {
                ...
                return r.useMemo(() => {
                    ...
                    return i ? { subsequentFetchStatus: g.ZP.FAILED, error: i, fetchNext: d, fetchPrevious: p, refetch: b, data: k, hasNext: Boolean(l), hasPrevious: Boolean(r) } : { subsequentFetchStatus: n ? g.ZP.LOADING : g.ZP.NONE, error: void 0, fetchNext: d, fetchPrevious: p, refetch: b, data: k, hasNext: Boolean(l), hasPrevious: Boolean(r) };
                }, [e, k, n, i, f, y, _]);
            }
        },
        499102: (e, a, l) => {
            ...
            const k = d().f508c49c,
                ...
                w = d().c2b3f0da,
                E = d().c791d3fc,
                Z = { label: d().ifea3114, withDelay: !0 },
                F = ({ iconSize: e = "normal", jobId: a, jobUserId: l }) => {
                    const i = (0, f.p)(),
                        ...
                        M = r.useCallback(() => {
                            d.push({ query: { text: (0, _.w)((0, y.z)(a)) }, pathname: "/messages/compose" });
                        }, [d, a]),
                        P = r.useCallback(() => {
                            n.Z.setString((0, _.w)((0, y.z)(a))), i({ text: D });
                        }, [i, a]),
                        T = r.useCallback(() => {
                            d.push({ query: { text: (0, _.w)((0, y.z)(a)) }, pathname: "/compose/post" });
                        }, [d, a]),
                        K = r.useCallback(() => {
                        ...
                        L = r.useCallback(() => {
                            const e = [];
                            return n.Z.isAvailable() && e.push({ text: k, onClick: P, Icon: c.default }), C && (e.push(((e) => ({ text: S, onClick: e, Icon: u.default }))(M)), e.push(((e) => ({ text: v, onClick: e, Icon: m.default }))(T))), I && e.push(((e) => ({ text: w, onClick: e, Icon: p.default }))(K)), e;
                        }, [P, M, K, T, I, C]),
                        A = r.useCallback(
                            (e) => {
                                const a = L();
                        ...
                        j = r.useCallback(() => {}, []);
                    return x ? r.createElement(s.ZP, { Icon: h.default, "aria-label": E, color: "text", hoverLabel: Z, iconSize: e, onPress: j, renderMenu: A, testID: "job-share-action-btn" }) : null;
                },
                C = r.memo(F);
        },
        771035: (e, a, l) => {
            ...
            const d = ({ basePath: e, isCompact: a = !1, resetPageOnSearch: l = !1, styleType: d }) => {
                    ...
                    const f = r.useCallback(() => {
                        ...
                        y = r.useMemo(
                            () =>
                                (0, s.Z)((e) => {
                                    b.current && (e.length > 0 ? (l ? m({ q: e, p: "1" }) : u("q", e)) : f());
                                }, 1e3),
                            [f, u, m, l],
                        ),
                        _ = r.useCallback(
                    ...
                    return r.createElement(t.Z, { Icon: o.default, autoComplete: "off", isCompact: a, leftAligned: !0, onChange: _, onClear: f, placeholder: "Search jobs", styleType: d || "pill", testID: "search-jobs-input", value: p, withClearButton: !0 });
                },
                c = r.memo(d);
        },
        736181: (e, a, l) => {
            ...
            var w,
                ...
                z = {
                    fragment: {
                        argumentDefinitions: [(w = { defaultValue: null, kind: "LocalArgument", name: "count" }), (E = { defaultValue: null, kind: "LocalArgument", name: "cursor" }), (Z = { defaultValue: null, kind: "LocalArgument", name: "searchParams" }), (F = { defaultValue: null, kind: "LocalArgument", name: "userId" })],
                        kind: "Fragment",
                        metadata: null,
            ...
            const fe = ({ fallbackName: e, user: a }) => {
                ...
                De = ({ allowShare: e = !1, companyName: a, createdAt: l, formattedSalary: t, isFeatured: o, isVerifiedOrg: i, jobId: d, jobTitle: c, location: u, onClick: m, profileId: p, redirectUrl: h, salaryInterval: g, shortDescription: b, user: f, withUserInfo: y = !1 }) => {
                    (0, ue.q)(() => {
                        (0, te.fH)((0, ge.yW)(_e, ye), _e);
                    });
                    const _ = r.useMemo(() => ({ label: c }), [c]),
                        k = r.useMemo(() => oe.Z.getContentStateFromRaw(b), [b]),
                        D = r.useMemo(() => k && (0, re.convertFromRaw)(k).hasText(), [k]),
                        S = r.useMemo(() => `/i/jobs/${d}`, [d]);
                    return r.createElement(se.Z, { interactive: !0, link: i ? { pathname: S, external: !0 } : h || "", onClick: m, style: ke.listContainer }, r.createElement(n.Z, { style: ke.items }, r.createElement(s.ZP, { hoverLabel: _, numberOfLines: 2, size: "subtext1", weight: "bold" }, c), y ? r.createElement(fe, { fallbackName: a, user: f }) : null, r.createElement(s.ZP, { color: "text", size: "subtext2", weight: "normal" }, u), t ? r.createElement(s.ZP, { color: "text", size: "subtext2", weight: "normal" }, (0, ie.M)(t, g)) : null, k && D ? r.createElement(n.Z, { style: ke.shortDescription }, r.createElement(me.Z, { className: _e }, r.createElement(de.Z, { contentState: k, paragraphFontSizeOverride: ye.paragraphFontSize }))) : null), r.createElement(n.Z, { style: ke.lastRow }, r.createElement(n.Z, { style: ke.itemRow }, r.createElement(n.Z, { style: ke.itemRow }, l ? r.createElement(ce.Z, { cutoff: "years", humanReadable: !0, style: ke.timestamp, timestamp: l }) : null, o ? r.createElement(pe.Z, null) : null), e ? r.createElement(be.Z, { iconSize: "small", jobId: d, jobUserId: p }) : null)));
                },
                Se = le,
                ...
                Ee = $,
                Ze = (e) => e.rest_id,
                Fe = ({ fetchNext: e, isViewerFollowsUser: a, profileId: l, slice: n, user: o }) => {
                    const s = (0, G.z)(),
                        i = Q()(Ee, n).items_results,
                        d = r.useCallback(
                            (e) => {
                    ...
                    return i ? (i.length ? r.createElement(Y.Z, { cacheKey: "userJobList", footer: null, identityFunction: Ze, items: i, onItemsRendered: m, onNearEnd: e, renderer: d }) : r.createElement(t.Z, { header: "No jobs" })) : null;
                },
                Ce = r.memo(Fe),
                ...
                Pe = (e) => {
                    const { query: a, screenName: l, user: n } = e,
                        ...
                        { data: o, fetchNext: s } = (0, W.C)(Me, t),
                        i = o?.data?.result?.recruiting_organization_results?.result?.consumer_job_search;
                    return i ? r.createElement(H.nO, { namespace: xe }, r.createElement(O.Z, null, r.createElement(r.Fragment, null, r.createElement(U.Z, { title: Ie(l) }), r.createElement(Ce, { fetchNext: s, isViewerFollowsUser: n.following, profileId: n.id_str, slice: i, user: o.data.result })))) : null;
                },
                Te = { context: "UserJobs" },
                Ke = (e) => {
                    const [a] = (0, J.Z)(),
                        l = r.useMemo(() => ({ keyword: a.get("q") }), [a]);
                    return r.createElement(B.H, { errorConfig: Te }, r.createElement(Pe, (0, R.Z)({}, e, { query: l })));
                },
                Le = r.memo(Ke);
            var Ae = l(138099),
                je = l(154003),
            ...
            const Ne = () => {
                ...
                Ue = ({ onDismiss: e, screenName: a }) => r.createElement(Ae.Z, { onMaskClick: e, style: Oe.modalContainer, type: "full", withMask: !0 }, r.createElement(n.Z, { style: Oe.modalContent }, r.createElement(s.ZP, null, "Search jobs")), r.createElement(y.Z, { basePath: `/${a}/jobs` }), r.createElement(Ne, null), r.createElement(je.ZP, { onClick: e, type: "brandFilled" }, "Done")),
                ...
                qe = v((e) => {
                    const [a, l] = r.useState(!1),
                        ...
                        D = (0, g.hC)("recruiting_jobs_list_search_enabled"),
                        S = (0, g.hC)("recruiting_job_recommendations_enabled"),
                        v = (0, g.hC)("xprofile_blocked_by_view_enabled");
                    r.useEffect(() => {
                        u && d(u);
                    }, [d, u]);
                    const w = _?.id_str === k,
                        E = !_ || (_ && (0, b.n5)({ isOwnProfile: w, isSoftBlockEnabled: v, user: _ })),
                        Z = r.useCallback(() => {
                            l(!1);
                        }, []);
                    if (u) {
                        ...
                        return E ? r.createElement(r.Fragment, null, r.createElement(p.Z, { backLocation: "/", history: c, primaryContent: _ ? (!_?.protected || _?.following || w ? r.createElement(r.Fragment, null, D && u ? r.createElement(n.Z, { style: We.rightControlContainer }, r.createElement(n.Z, { style: We.searchContainer }, r.createElement(y.Z, { basePath: `/${u}/jobs`, styleType: "selection" }))) : null, r.createElement(Le, { screenName: u, user: _ })) : r.createElement(t.Z, { header: He })) : null, primaryContentLabel: Je, sidebarContent: S ? r.createElement(n.Z, { style: We.sidebarRoot }, r.createElement(m.Z, { isSidebarModule: !0 })) : null, title: e() }), a ? r.createElement(Be, { onDismiss: Z, screenName: u }) : null) : r.createElement(f.Z, { to: `/${u}` });
                    }
                    return null;
                });
        },
        524496: (e, a, l) => {
            ...
            var r = l(202784),
                ...
                g = l(392237),
                b = l(135904);
            const f = { [d.P7.atomic]: { element: "section" }, [d.P7.header1]: { element: "h1", wrapper: r.createElement(i.ZP, null) }, [d.P7.header2]: { element: "h2", wrapper: r.createElement(i.ZP, null) } },
                y = (0, o.Z)(f).reduce((e, [a, l]) => e.set(a, l), n.DefaultDraftBlockRenderMap);
            let _ = !1;
            const k = r.memo(function (e) {
                    ...
                    const f = m.Z.initEditorState(l, { decorators: g });
                    let k = s.Z;
                    return (
                        a &&
                            (k = (e) => {
                        ...
                        r.createElement(c.ZP, null, ({ containerWidth: e }) => r.createElement(t.Z, { style: D.fontFamily }, r.createElement(n.Editor, { blockRenderMap: y, blockRendererFn: k, blockStyleFn: (0, d.su)(h.Z.isNarrowScreenWidth(e)), editorState: f, onChange: s.Z, readOnly: !0, webDriverTestID: "longformRichTextComponent" })))
                    );
                }),
        ...
        466818: (e, a, l) => {
            ...
            class g extends r.PureComponent {
                ...
                render() {
                    const { "aria-describedby": e, disabled: a, errorText: l, hasError: d, helperText: h, options: g, style: f, testID: y, value: _, withEmptyOption: k } = this.props,
                        { isFocused: D } = this.state,
                        S = i.ZP.getLanguage(),
                        v = void 0 === d ? !!l : d,
                        w = new Set();
                    l && w.add(this._errorID), e && w.add(e), h && w.add(this._helperID);
                    const E = w.size ? [...w].join(" ") : void 0;
                    return r.createElement(
                        ...
                        r.createElement(c.ZP.Consumer, null, ({ direction: e }) => {
                            ...
                            return r.createElement(
                                n.Z,
                                { style: [s.Z.border, b.container, a && s.Z.disabled, D && s.Z.focusedBorderValid, v && s.Z.invalidBorderColor, D && v && s.Z.focusedBorderInvalid, f] },
                                this._renderLabel(),
                                r.createElement(
                                    m,
                                    { "aria-describedby": E, "aria-invalid": v, "aria-labelledby": this._labelID, disabled: a, id: this._id, onBlur: this._handleBlur, onChange: this._handleChange, onFocus: this._handleFocus, ref: this._selectRef, style: [b.select, { fontFamily: i }, a && s.Z.disabled], testID: y || "", value: _ },
                                    k ? r.createElement(p, { disabled: !0, style: b.option, value: "" }) : null,
                                    g.map((e) => {
                                        const { disabled: a, label: l, value: n } = e;
                                        return r.createElement(p, { disabled: a, key: `${l}-${n}`, style: b.option, value: n }, l);
                                    }),
                                ),
                                r.createElement(t.default, { style: [b.dropdownCaret, D && s.Z.validColor, !(!d && !l) && s.Z.invalidColor] }),
                            );
                        }),
                ...
                _renderLabel() {
                    ...
                    return r.createElement(i.ZP, { color: a || e ? "red500" : n ? "primary" : "gray700", id: this._labelID, role: "label", style: b.label }, l);
                }
                _renderHelperText() {
                    return r.createElement(n.Z, { "aria-live": "polite" }, r.createElement(i.ZP, { color: "gray700", id: this._helperID, style: b.helperText }, this.props.helperText));
                }
                _renderErrorText() {
                    return r.createElement(n.Z, { "aria-live": "polite" }, r.createElement(i.ZP, { color: "red500", id: this._errorID, style: b.helperText }, this.props.errorText));
                }
            }
        ...
        280278: (e, a, l) => {
            ...
            const d = "up",
                ...
                u = (e, a, l) => {
                    l((l) => {
                        const r = (0, t.Z)(e) ? (e > (l.count || 0) ? d : c) : d;
                        return { ...l, count: e, oldText: l.text, pendingCount: null, pendingText: null, text: a, transitionDirection: r };
                    });
                },
                m = {};
            [d, c].forEach((e) => {
            ...
            const p = { position: "absolute" },
                ...
                g = (e) => {
                    const { children: a, containerStyle: l, count: i, ...c } = e,
                        [g, b] = r.useState({ animating: !1, count: e.count, pendingCount: null, text: e.children, oldText: null, pendingText: null, transitionDirection: d }),
                        f = r.useRef(!1);
                    return (
                        r.useEffect(
                            () => (
                        ...
                        r.useEffect(() => {
                            if (f.current)
                                if (o.Z.reducedMotionEnabled) b((l) => ({ ...l, oldText: null, text: a, pendingText: null, pendingCount: null, count: e.count }));
                                    ...
                                    a === g.text || ((0, t.Z)(e.count) && g.count === e.count) ? b((e) => ({ ...e, pendingCount: null, pendingText: null })) : (b((l) => ({ ...l, pendingCount: e.count, pendingText: a })), g.animating || u(e.count, a, b));
                                }
                        }, [a]),
                        r.useEffect(() => {
                            f.current &&
                        ...
                        r.useMemo(() => {
                            const e = m[g.transitionDirection],
                                ...
                                t = !g.animating && g.oldText && !o.Z.reducedMotionEnabled,
                                i = { ...p, ...(g.animating ? e.post : e.active) },
                                d = { ...(t ? e.pre : e.active) };
                            return r.createElement(
                                n.Z,
                                { style: [h.root, l] },
                                a ? r.createElement("span", { style: i }, r.createElement(s.ZP, c, g.oldText)) : null,
                                r.createElement(
                                    "span",
                                    {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserJobs.a57e1e5a.js.map
