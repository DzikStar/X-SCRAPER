...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserLists-63cb1cc4"],
    {
        ...
        234045: (e, a, r) => {
            ...
            const I = [],
                ...
                P = (0, f.Z)()
                    ...
                    .propsFromActions(() => ({ addToast: y.fz, addUserToList: A.Z.addUserToList, toggleIsMember: A.Z.toggleIsMember, createLocalApiErrorHandler: (0, M.zr)("ADD_LIST_MEMBER_SCREEN"), fetchMembershipsIfNeeded: g.NU, removeUserFromList: A.Z.removeUserFromList }))
            ...
            class B extends t.Component {
                constructor(e) {
                    super(e),
                        ...
                        (this._renderEmptyState = () => t.createElement(n.Z, { buttonLink: "/i/lists/create", buttonText: N, header: R, message: T })),
                        (this._handleFetch = () => {
                ...
                F = (e) => {
                    ...
                    const G = t.useCallback(() => {
                            a.scribe({ element: "delete", action: "click" }),
                                z(q)
                                    ...
                                    .catch((e) => {
                                        H({ defaultToast: { text: T }, showToast: !0 })(e), v(!1);
                                    });
                        }, [a, H, z, c, q, W]),
                        Q = t.useMemo(() => ({ pathname: `${B}/members`, state: { previousStep: g.O.Edit } }), [B]),
                        X = t.useCallback(() => {
                        ...
                        J = t.useCallback(() => t.createElement(t.Fragment, null, t.createElement(o.Z, { style: x.mainSettings }, t.createElement(f.Z, { context: "LIST_EDIT_SCREEN", history: c, list: V, listId: q, location: r, onChange: Y, ref: u })), K(), t.createElement(l.Z, { color: "red500", label: N, onPress: ae }), L && t.createElement(i.Z, { confirmButtonLabel: U.confirmButtonLabel, confirmButtonType: "destructiveFilled", headline: U.headline, onCancel: re, onConfirm: G, text: U.text })), [G, c, V, q, r, K, L]);
                    function Y(e) {
                        I(e);
                    }
                    function ee() {
                    ...
                    return F === w
                        ? t.createElement(
                              ...
                              t.createElement(D.Z, { "aria-label": R, fetchStatus: $, onRequestRetry: j, render: J }),
                          )
        ...
        197503: (e, a, r) => {
            r.r(a), r.d(a, { ListMembersScreen: () => S, default: () => y });
            var t = r(202784),
                o = r(457311),
                d = r(111677),
                s = r.n(d),
            ...
            class S extends t.Component {
                ...
                render() {
                    ...
                    return t.createElement(i.Z, { entryConfiguration: this._getEntryConfiguration(), module: e, renderEmptyState: this._noItemsRenderer, title: g });
                }
            }
            const y = M(S);
        },
        523646: (e, a, r) => {
            ...
            const I = (e, { suggestedUsersModule: a }) => a.selectInitialFetchStatus(e),
                L = (0, S.Z)()
                    ...
                    .propsFromActions(() => ({ cleanupAddedUsers: y.DK, createLocalApiErrorHandler: (0, g.zr)("LIST_SUGGESTED_USERS_SCREEN"), fetchUserIfNeeded: _.ZP.fetchOneIfNeeded, injectSuggestedUser: y.i7 }))
            ...
            class T extends t.Component {
                ...
                render() {
                    ...
                    return t.createElement(o.Z, null, t.createElement(b.nO, { namespace: C }, t.createElement(p.default, { alwaysOpen: !0, filter: R, isModal: !0, onQueryChange: this._handleQueryChange, placeholder: v, renderUserDecoration: this._getMemoizedAddRemoveDecorations(this._isListMemberCountValid, e, r, this._onAdd, this._onRemove), rounded: !0, shouldAutoFocus: !0, shouldFocusOnClear: !0, source: M._4.ListMembersSuggested, style: N.input, withUserHoverCard: !0 })), d && t.createElement(o.Z, { style: N.callout }, t.createElement(s.Z, { Icon: c.default, text: P })), this.state.query ? null : t.createElement(D.Z, { entryConfiguration: this._getMemoizedEntryConfiguration(e, r, this._isListMemberCountValid, this._isCurrentMember, this._onAdd, this._onRemove), module: a, renderEmptyState: this._noItemsRenderer, title: Z }));
                }
            }
            T.contextType = m.rC;
            const N = n.default.create((e) => ({ input: { marginHorizontal: e.spaces.space16, marginVertical: e.spaces.space8 }, callout: { marginHorizontal: e.spaces.space16, marginVertical: e.spaces.space8 } })),
                U = L(T);
        },
        566741: (e, a, r) => {
            r.d(a, { Z: () => c, m: () => l });
        ...
        761893: (e, a, r) => {
            ...
            const y = (e, a) => a.location.state?.previousStep,
                ...
                I = (0, M.Z)()
                    .propsFromState(() => ({ basePath: S.$5, listId: S.xh, memberCount: E, membersModule: (0, p.P1)(S.xh, (e) => (0, A.Z)(e)), previousStep: y, suggestedUserId: _, suggestedUsersModule: (0, p.P1)(S.Fz, S.xh, y, (e, a, r) => (0, g.ZP)({ displayLocation: r, listId: a, listName: e?.name, listDescription: e?.description })) }))
                ...
                T = (0, D.p)(
                    () =>
                        Promise.all([
                            ...
                            r.e("shared~bundle.HomeTimeline~bundle.UserLists"),
                            r.e("bundle.UserLists-6107ac1a"),
                ...
                U = (e) => {
                    const { basePath: a, createLocalApiErrorHandler: r, fetchListIfNeeded: o, history: l, listId: i, location: D, match: p, memberCount: b, membersModule: M, previousStep: f, suggestedUserId: A, suggestedUsersModule: g } = e;
                    t.useEffect(() => {
                        o(i).catch(r());
                    }, [r, o, i]);
                    let S = Z,
                        y = d();
                    f === m.O.Creation ? ((S = P), (y = C)) : f === m.O.Edit && ((S = L), (y = R));
                    const _ = f === m.O.Creation || f === m.O.Edit,
                        ...
                        B = t.useMemo(() => (_ ? t.createElement(u.Z, { "aria-label": S, links: I }) : void 0), [I, _, S]),
                        H = t.useMemo(() => (_ ? t.createElement(s.Switch, null, t.createElement(s.Route, { exact: !0, path: `/i/lists/${i}/members` }, t.createElement(T, { match: p, module: M })), t.createElement(s.Route, { exact: !0, path: `/i/lists/${i}/members/suggested` }, t.createElement(N, { match: p, membersModule: M, suggestedUserId: A, suggestedUsersModule: g }))) : t.createElement(T, { match: p, module: M })), [i, p, M, _, A, g]);
                    return t.createElement(h.nO, { namespace: y }, t.createElement(c.Z, { backButtonType: x, history: l, rightControl: F, secondaryBar: B, title: S }, H));
                },
                F = I(U);
        },
        881206: (e, a, r) => {
            ...
            class K extends t.Component {
                ...
                render() {
                    ...
                    return t.createElement(t.Fragment, null, t.createElement(R.Z, { title: r }), t.createElement(N.Z, null, this._renderHeaderAndContent()));
                }
            ...
            const J = (0, F.Z)(O(K)),
                ...
                ae = i().j681933e,
                re = (e) => {
                    const { createLocalApiErrorHandler: a, fetchListIfNeeded: r, fetchStatus: n, history: l, listId: i, listMode: g, listName: _, location: E, match: I, screenName: L, scribeNamespace: v } = e,
                    ...
                    return (
                        ...
                        n !== S.Z.LOADED || (_ && L) ? t.createElement(f.nO, { data: P }, t.createElement(D.Z, { backLocation: L && `/${L}/lists`, documentTitle: Y, history: l, primaryContent: t.createElement(h.Z, { component: d.Z, fab: w }, n === S.Z.FAILED ? t.createElement(m.Z, { "aria-label": ee, fetchStatus: n, onRequestRetry: R, render: Z }) : Z()), rightControl: C, sidebarContent: t.createElement(u.Z, null), subtitle: L && `@${L}`, title: t.createElement(o.Z, { style: te.title }, t.createElement(s.ZP, null, _), k ? t.createElement(c.default, { "aria-label": ae, role: "img", style: te.iconLock }) : null) })) : t.createElement(y.default, { history: l, location: E, match: I })
                    );
                },
        ...
        510588: (e, a, r) => {
            r.d(a, { $5: () => u, By: () => M, DV: () => S, Fz: () => p, Ge: () => A, Ns: () => I, Wy: () => D, _g: () => _, ax: () => f, cx: () => b, l1: () => y, tt: () => E, xh: () => m });
            var t = r(614983),
                o = r.n(t),
                d = r(842799),
                s = r(286e3),
        ...
        466441: (e, a, r) => {
            ...
            function A(e) {
                ...
                return (
                    ...
                    t.createElement(m.Z, null, t.createElement(c.Z.Configure, { backLocation: "/", documentTitle: M, title: f }), t.createElement(d.Z, { style: r && g.modal }, t.createElement(h.Z, null)), t.createElement(u.Z, { title: M, withMeta: !1 }))
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserLists-63cb1cc4.40b53ffa.js.map
