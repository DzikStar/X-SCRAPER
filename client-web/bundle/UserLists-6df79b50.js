...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserLists-6df79b50"],
    {
        289160: (e, a, d) => {
            ...
            const M = (e) => {
                ...
                I = b((e) => {
                    const { addToast: a, isMember: d, memberCount: r, setTrustedFriendsMemberCount: o, sliceID: l, sliceItemID: t, trustedFriendsId: c, type: D, userId: m } = e,
                        ...
                        g = n.useCallback(() => {
                            h({
                                ...
                                onCompleted(e) {
                                    if ("TrustedFriendsListMemberAddInvalid" === e?.trusted_friends_list_member_add?.__typename) v(!1), a("MaxMembersExceeded" === e?.trusted_friends_list_member_add?.reason ? { text: _ } : { text: y });
                        ...
                        E = n.useCallback(() => {
                            b({
                                ...
                                onCompleted(e) {
                                    if ("TrustedFriendsListMemberRemoveInvalid" === e?.trusted_friends_list_member_remove?.__typename) v(!0), a({ text: A });
                    ...
                    return P ? n.createElement(i.ZP, { "aria-label": p, disabled: I, onPress: E, size: "small", type: "primaryOutlined" }, p) : n.createElement(i.ZP, { "aria-label": f, disabled: M, onPress: g, size: "small", type: "primaryFilled" }, f);
                });
        },
        592240: (e, a, d) => {
            d.d(a, { Z: () => _ });
        ...
        696705: (e, a, d) => {
            d.r(a), d.d(a, { TrustedFriendsMembers: () => A, default: () => _, errorConfig: () => f, trustedFriendsMembersQuery: () => b });
            var r = d(917874),
                o = d(202784),
                n = d(325686),
                l = (d(585488), d(731708)),
                    ...
                    super(...e),
                        ...
                        (this._renderEmptyItem = () => {
                            const { user: e } = this.props,
                                ...
                                d = a === e.id_str;
                            return r.createElement(o.Z, { header: d ? S : y({ screenName: e.screen_name }), message: d ? w : _ });
                        });
                }
                render() {
        ...
        854254: (e, a, d) => {
            ...
            class we extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._getMembershipsLabel = () => (this._isViewerUserView() ? ye : _e)),
                        ...
                        (this._renderPrimaryContent = () => {
                            ...
                            if (a) {
                                return a?.protected && !a?.following && !this._isViewerUserView() ? r.createElement(l.Z, { header: be({ screenName: a.screen_name }), message: Ae }) : r.createElement(f.Z, { component: s.Z, fab: d }, r.createElement(n.Switch, null, r.createElement(n.Route, { exact: !0, path: `/${g.qX}/lists` }, this._isViewerUserView() ? r.createElement(he, { user: a }) : r.createElement(X, { user: a })), r.createElement(n.Route, { exact: !0, path: `/${g.qX}/lists/memberships` }, r.createElement(Se, { user: a }))));
                            }
                            return null;
                        });
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserLists-6df79b50.386c31aa.js.map
