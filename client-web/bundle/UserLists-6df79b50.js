...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserLists-6df79b50"],
    {
                    ...
                    const { addToast: a, isMember: d, memberCount: r, setTrustedFriendsMemberCount: o, sliceID: l, sliceItemID: t, trustedFriendsId: c, type: D, userId: m } = e,
                        ...
                        g = n.useCallback(() => {
                            h({
                                ...
                                onCompleted(e) {
                                    if ("TrustedFriendsListMemberAddInvalid" === e?.trusted_friends_list_member_add?.__typename) v(!1), a("MaxMembersExceeded" === e?.trusted_friends_list_member_add?.reason ? { text: _ } : { text: f });
                                    else if ("TrustedFriendsListMemberAddSuccess" === e?.trusted_friends_list_member_add?.__typename && void 0 !== r) {
                                        const e = r + 1;
                                        k.scribe({ component: `trusted_friends_${D}`, element: "add_trusted_friends_button", action: "click", data: { trusted_friends_control_details: { list_member_count: e } } }), o(e);
                                    }
                                },
                            }),
                                v(!0);
                        ...
                        E = n.useCallback(() => {
                            b({
                                ...
                                onCompleted(e) {
                                    if ("TrustedFriendsListMemberRemoveInvalid" === e?.trusted_friends_list_member_remove?.__typename) v(!0), a({ text: y });
                                    else if ("TrustedFriendsListMemberRemoveSuccess" === e?.trusted_friends_list_member_remove?.__typename && void 0 !== r) {
                                        const e = r - 1;
                                        k.scribe({ component: `trusted_friends_${D}`, element: "remove_trusted_friends_button", action: "click", data: { trusted_friends_control_details: { list_member_count: e } } }), o(e);
                                    }
                                },
                            }),
                                v(!1);
                        }, [a, k, r, b, o, c, m, l, t, D]);
                    return P ? n.createElement(i.ZP, { "aria-label": p, disabled: I, onPress: E, size: "small", type: "primaryOutlined" }, p) : n.createElement(i.ZP, { "aria-label": A, disabled: M, onPress: g, size: "small", type: "primaryFilled" }, A);
                });
        },
        592240: (e, a, d) => {
            d.d(a, { Z: () => _ });
            ...
            const p = o.memo(b),
                A = (e) => e.id,
                y = r.Z;
            function f({ cacheKey: e, emptyStateHeader: a, emptyStateMessage: d, items: r, membersSliceID: n, onFetchNext: u, trustedFriendsId: D }) {
                const m = l()(y, r),
                    h = o.useMemo(
                        () =>
                            (0, i.Z)(
                ...
                return o.createElement(c.Z, { cacheKey: e, identityFunction: A, items: h, noItemsRenderer: b, onNearEnd: u, renderer: M, withoutHeadroom: !0 });
            }
            const _ = o.memo(f);
        },
        696705: (e, a, d) => {
            d.r(a), d.d(a, { TrustedFriendsMembers: () => y, default: () => _, errorConfig: () => A, trustedFriendsMembersQuery: () => b });
            var r = d(917874),
                o = d(202784),
                n = d(325686),
                l = (d(585488), d(731708)),
            ...
            const h = t().ec13f9cc,
                ...
                y = (e) => {
                    ...
                    return o.createElement(n.Z, null, o.createElement(l.ZP, { color: "gray700", size: "body", style: f.education }, o.createElement(t().I18NFormatMessage, { $i18n: "e420d1ed" }, o.createElement(l.ZP, { color: "text", link: c.TRUSTED_FRIENDS_LEARN_MORE_URL, style: f.learnMore, weight: "bold", withUnderline: !0 }, t().f43112a4))), o.createElement(m.Z, { cacheKey: p, emptyStateHeader: h, emptyStateMessage: M, items: s.items_results, membersSliceID: s.__id, onFetchNext: r, trustedFriendsId: a }));
                },
                f = s.default.create((e) => ({ education: { marginHorizontal: e.spaces.space32, textAlign: "center", marginTop: e.spaces.space16, marginBottom: e.spaces.space4 }, learnMore: { whiteSpace: "nowrap" }, activityIndicatior: { paddingVertical: 250 } }));
            function _(e) {
                return o.createElement(u.H, { errorConfig: A }, o.createElement(y, e));
            }
        },
        582313: (e, a, d) => {
            d.r(a), d.d(a, { TrustedFriendsRecommended: () => k, default: () => E, trustedFriendsRecommendedQuery: () => I });
            var r = d(319145),
                o = d(202784),
                n = d(325686),
                l = (d(585488), d(731708)),
            ...
            const f = t().fc9dd578,
                _ = t().ac3fd6e2,
                S = t().eeb4d3f0,
                w = [h.my.TrustedFriendsSuggested],
                I = r.Z,
                P = "TRUSTED_FRIENDS_RECOMMENDED",
                v = { context: P },
                k = (e) => {
                    const [a, d] = o.useState(),
                        ...
                        k = u?.items_results ?? (0, m.o)(),
                        E = o.useCallback(({ user: e, userId: a }) => o.createElement(A.Z, { isMember: e?.is_trusted_friends_list_member, sliceID: v, trustedFriendsId: r, type: p.C.Search, userId: a }), [v, r]);
                    return o.createElement(n.Z, null, o.createElement(D.default, { alwaysOpen: !0, filter: w, isModal: !0, onQueryChange: d, placeholder: f, renderUserDecoration: E, rounded: !0, shouldAutoFocus: !0, shouldFocusOnClear: !0, source: h._4.TrustedFriendsSuggested, style: g.input, trustedFriendsId: r }), a ? null : o.createElement(o.Fragment, null, o.createElement(l.ZP, { color: "gray700", size: "body", style: g.education }, o.createElement(t().I18NFormatMessage, { $i18n: "e420d1ed" }, o.createElement(l.ZP, { color: "text", link: c.TRUSTED_FRIENDS_LEARN_MORE_URL, style: g.learnMore, weight: "bold", withUnderline: !0 }, t().f43112a4))), o.createElement(y.Z, { cacheKey: P, emptyStateHeader: _, emptyStateMessage: S, items: k, membersSliceID: v, onFetchNext: i, trustedFriendsId: r })));
                },
                g = s.default.create((e) => ({ input: { marginHorizontal: e.spaces.space16, marginVertical: e.spaces.space4 }, education: { marginHorizontal: e.spaces.space32, textAlign: "center", marginBottom: e.spaces.space8 }, learnMore: { whiteSpace: "nowrap" }, activityIndicatior: { paddingVertical: 250 } }));
            function E(e) {
                return o.createElement(u.H, { errorConfig: v }, o.createElement(k, e));
            }
        },
        273945: (e, a, d) => {
            d.r(a), d.d(a, { TRUSTED_FRIENDS_LEARN_MORE_URL: () => p, TrustedFriendsManagementScreen: () => _, default: () => S });
            var r = d(202784),
                o = d(107267),
                n = d(688715),
                l = d(111677),
                ...
                _ = (e) => {
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            n ? r.createElement(o.Switch, null, r.createElement(o.Route, { exact: !0, path: `/i/circles/${n}/members` }, r.createElement(y, { trustedFriendsId: n })), r.createElement(o.Route, { exact: !0, path: `/i/circles/${n}/members/suggested` }, r.createElement(f, { trustedFriendsId: n }))) : r.createElement(m.default, e),
                        ),
                    );
                },
                S = _;
        ...
        188856: (e, a, d) => {
            d.r(a), d.d(a, { UserListMembershipsScreen: () => P, default: () => v });
            var r = d(202784),
                o = d(457311),
                n = d(111677),
                l = d.n(n),
            ...
            const p = (e, a) => a.user.id_str,
                ...
                y = (0, h.Z)()
                    .propsFromState(() => ({ listIds: (0, m.P1)(A, (e) => e), module: (0, m.P1)(p, (e) => (0, b.Z)(e)) }))
                    ...
                    super(...e),
                        ...
                        (this._renderEmptyItem = () => {
                            const { user: e } = this.props,
                                ...
                                d = a === e.id_str;
                            return r.createElement(o.Z, { header: d ? S : f({ screenName: e.screen_name }), message: d ? w : _ });
                        });
                }
                render() {
        ...
        854254: (e, a, d) => {
            d.r(a), d.d(a, { UserListsScreen: () => we, default: () => Pe });
            d(136728);
            var r = d(202784),
                o = d(325686),
                n = d(107267),
            ...
            function G(e) {
                ...
                return (
                    ...
                    r.createElement(U.nO, { namespace: z }, r.createElement(C.Z, null, r.createElement(r.Fragment, null, r.createElement(Z.Z, { title: V({ screenName: d.screen_name }) }), r.createElement(F.Z, { entryConfiguration: $, module: i, renderEmptyState: t, title: B }))))
                );
            }
            const X = r.memo(G);
            var K = d(71620),
            ...
            class we extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._getMembershipsLabel = () => (this._isViewerUserView() ? fe : _e)),
                        ...
                        (this._renderPrimaryContent = () => {
                            ...
                            if (a) {
                                return a?.protected && !a?.following && !this._isViewerUserView() ? r.createElement(l.Z, { header: be({ screenName: a.screen_name }), message: ye }) : r.createElement(A.Z, { component: s.Z, fab: d }, r.createElement(n.Switch, null, r.createElement(n.Route, { exact: !0, path: `/${g.qX}/lists` }, this._isViewerUserView() ? r.createElement(he, { user: a }) : r.createElement(X, { user: a })), r.createElement(n.Route, { exact: !0, path: `/${g.qX}/lists/memberships` }, r.createElement(Se, { user: a }))));
                            }
                            return null;
                        });
                }
                ...
                render() {
                    const { history: e, screenName: a, user: d } = this.props,
                        o = !d || (d && (0, P.n5)({ isOwnProfile: this._isViewerUserView(), isSoftBlockEnabled: this.context.featureSwitches.isTrue("xprofile_blocked_by_view_enabled"), user: d })),
                        n = this._isOwnManagementView(),
                        l = this._isMembershipsView() ? this._getMembershipsLabel() : pe;
                    return a ? (o ? r.createElement(y.Z, { backLocation: "/", customSearchBox: n ? r.createElement(S.Z, null) : void 0, history: e, primaryContent: this._renderPrimaryContent(), primaryContentLabel: Ae, rightControl: this._isMembershipsView() ? null : this._renderRightControl(), sidebarContent: r.createElement(b.Z, null), subtitle: n ? void 0 : r.createElement(i.Z, { screenName: a }), title: l, withSearchBox: n }) : r.createElement(k.Z, { to: `/${a}` })) : null;
                }
            }
            we.contextType = f.rC;
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserLists-6df79b50.10bc561a.js.map
