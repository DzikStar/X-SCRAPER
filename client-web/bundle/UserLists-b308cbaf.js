...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserLists-b308cbaf", "loader.MediaPickerWithPreview", "loader.FeedbackSheet"],
    {
        ...
        836640: (e, t, i) => {
            ...
            function f(e) {
                const t = l()(b, e.user),
                    { legacy: i, privacy: a, verification: r } = t,
                    s = t.identity_profile_labels_highlighted_label?.label ? (0, u.H)(t.identity_profile_labels_highlighted_label.label) : void 0,
                    { cellClickable: h, decoration: f, displayMode: g } = e,
                    y = (function () {
                        const { viewerUserId: e } = n.useContext(m.rC);
                        return o()(!!e, "viewerUserId is undefined!"), e;
                    })(),
                    _ = (0, d.useHistory)(),
                    S = n.useCallback(() => ("function" == typeof f ? f({ displayMode: g, viewerUserId: y, userId: i?.id_str ?? "" }) : f), [f, y, i, g]),
                    v = n.useCallback(() => {
                        i?.screen_name && _.push({ pathname: `/${i.screen_name}` });
                    }, [_, i]);
                return n.createElement(c.ZP, { affiliateBadgeInfo: s, avatarUri: i?.profile_image_url_https || "", decoration: S(), displayMode: "UserDetailed", displayNameLabel: e.displayNameLabel, isBlueVerified: !!t.is_blue_verified, isFollowedBy: i?.followed_by, isProtected: a?.protected ?? !1, isVerified: r?.verified ?? !1, name: i?.name || "", onCellClick: h ? v : void 0, promotedItemType: p.bj.USER, screenName: i?.screen_name || "", userId: i?.id_str ?? "", verifiedType: r?.verified_type ?? void 0, withFollowsYou: !0 });
            }
            f.defaultProps = { cellClickable: !0, decoration: null, displayMode: h.Z.UserCompact };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserLists-b308cbaf.d1376eba.js.map
