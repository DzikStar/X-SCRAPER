...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.UserLists-b308cbaf", "loader.MediaPickerWithPreview", "loader.FeedbackSheet"],
    {
        ...
        836640: (e, t, i) => {
            ...
            function g(e) {
                const t = l()(b, e.user),
                    { avatar: i, legacy: n, privacy: r, relationship_perspectives: s, verification: u } = t,
                    g = t.identity_profile_labels_highlighted_label?.label ? (0, h.H)(t.identity_profile_labels_highlighted_label.label) : void 0,
                    { cellClickable: f, decoration: _, displayMode: C } = e,
                    y = (function () {
                        const { viewerUserId: e } = a.useContext(m.rC);
                        return o()(!!e, "viewerUserId is undefined!"), e;
                    })(),
                    v = (0, c.useHistory)(),
                    k = a.useCallback(() => ("function" == typeof _ ? _({ displayMode: C, viewerUserId: y, userId: n?.id_str ?? "" }) : _), [_, y, n, C]),
                    M = a.useCallback(() => {
                        n?.screen_name && v.push({ pathname: `/${n.screen_name}` });
                    }, [v, n]);
                return a.createElement(d.ZP, { affiliateBadgeInfo: g, avatarUri: i?.image_url || "", decoration: k(), displayMode: "UserDetailed", displayNameLabel: e.displayNameLabel, isBlueVerified: !!t.is_blue_verified, isFollowedBy: s?.followed_by ?? !1, isProtected: r?.protected ?? !1, isVerified: u?.verified ?? !1, name: n?.name || "", onCellClick: f ? M : void 0, promotedItemType: p.bj.USER, screenName: n?.screen_name || "", userId: n?.id_str ?? "", verifiedType: u?.verified_type ?? void 0, withFollowsYou: !0 });
            }
            g.defaultProps = { cellClickable: !0, decoration: null, displayMode: u.Z.UserCompact };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserLists-b308cbaf.b3b6d50a.js.map
