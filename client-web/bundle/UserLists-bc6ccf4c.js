    ...
    ["bundle.UserLists-bc6ccf4c", "icons/IconFeedback-js"],
    {
        ...
        779610: (e, t, o) => {
            ...
            var n = o(202784),
                ...
                c = o(392237);
            const d = (e) => {
                    const { decoration: t, description: o, disabled: d = !1, isActive: u = !1, label: m, link: g, onPress: h, paddingHorizontal: b, renderRightContent: f, role: y = "tab", styleOverride: x, testID: C = "pivot", thumbnail: w, thumbnailSize: v, withoutArrow: Z = !1 } = e,
        ...
        403556: (e, t, o) => {
            ...
            class w extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: o, badgePip: n, children: i, color: l, isActive: c, isCompact: d, isPillLink: p, isRoundedRect: u, isWebRedesign: h, retainScrollPosition: w, style: Z, to: E } = this.props,
                        { location: k } = this.state,
                        S = E ? this._getMemoizedLink(E, w) : void 0,
                        P = c ? c(E) : k?.pathname === S?.pathname,
                        T = b.Z.generate({ backgroundColor: "transparent", color: a.default.theme.colors.text, insetFocusRing: !0, customHoverBackgroundColor: p ? v.pillHoverStyle.backgroundColor : void 0 }),
                        z = h ? "medium" : P ? "bold" : "medium";
                    return r.createElement(f.Z, { "aria-label": t, "aria-selected": P, focusable: !!P, interactiveStyles: T, link: S, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [...(p ? [v.pillStyle] : [v.link]), ...(p && P ? [v.pillActiveStyle] : []), d ? (p ? v.compactPill : v.compactLink) : null, u ? v.roundedRect : null, Z], withoutInteractiveStyles: h }, ({ isFocused: t, isHovered: c }) => r.createElement(s.Z, { style: p && v.flexGrow }, r.createElement(m.ZP, { size: h ? "headline2" : void 0, style: [v.text, { color: this._getTextColor(P, c, h, p) }, d && v.compactText, h && t && v.focusedText, p && v.pillTextStyle, p && P && v.pillActiveTextStyle, p && c && v.pillHoverTextStyle], weight: z }, e && r.createElement(e, { style: v.icon }), i, h || p ? null : r.createElement(s.Z, { style: P && [v.border, { backgroundColor: a.default.theme.colors[l] }] })), o ? r.createElement(g.Z, { count: o, standalone: !0, style: [v.badge, o >= 10 && v.multiDigitBadge, o >= 20 && v.truncatedCountBadge], truncatedCountFormatter: C, unreadCountLabel: y, withBorder: !1 }) : n ? r.createElement(g.Z, { pip: !0, standalone: !0, style: v.badgePip, textColor: "red500", unreadCountLabel: x, withBorder: !1 }) : null));
                }
            }
                        ...
                        h = r.useMemo(
                            () =>
                                c.filter(Boolean).map(({ label: t, viewType: i, ...l }, c) => {
                                    ...
                                    return r.createElement(Z, (0, n.Z)({ viewType: i }, l, { isCompact: o, isPillLink: a, isRoundedRect: s, isWebRedesign: g, style: d }), t);
                                }),
                            [e, o, a, s, g, c],
                        );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserLists-bc6ccf4c.0063368a.js.map
