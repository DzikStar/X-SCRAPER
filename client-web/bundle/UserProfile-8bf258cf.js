    ...
    ["bundle.UserProfile-8bf258cf"],
    {
            ...
            const w = c().a2811f96,
                ...
                q = (e) => {
                    ...
                    return l.createElement(
                        ...
                        l.createElement(o.Switch, null, l.createElement(o.Route, { exact: !0, path: "/intent/follow" }, l.createElement(Z, (0, r.Z)({}, ce, be))), l.createElement(o.Route, { exact: !0, path: "/intent/user" }, l.createElement(Z, (0, r.Z)({}, ce, be))), l.createElement(o.Route, { exact: !0, path: `/${A.qX}` }, l.createElement(Z, (0, r.Z)({}, ce, be, { onEntriesRendered: a }))), l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${E}` }, l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "with_replies" }))), l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${_}` }, l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "superfollows" }))), ue ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${T}` }, oe ? l.createElement(b.Z, { variant: "HighlightsProfile" }) : l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "highlights" }))) : null, K ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${R}` }, Y ? l.createElement(b.Z, { variant: "ArticlesProfile" }) : l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "articles" }))) : null, l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${C}` }, l.createElement(N, ce)), L ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/(${I})` }, l.createElement($, (0, r.Z)({ isOwnProfile: L }, ce))) : null, ee ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/(${U})` }, l.createElement(x, ce)) : null, de ? l.createElement(p.Z, { to: `/${V}` }) : null),
                    );
                },
        ...
        975950: (e, d, a) => {
            ...
            var r = a(202784),
                ...
                b = a(443781);
            const s = (e) => {
                    const { featureSwitches: d, userClaims: a } = (0, b.QZ)(),
                        n = a.isAnyPremiumSubscriber(),
                        s = a.isVerifiedOrg(),
                        D = a.isVerifiedOrgAffiliate(),
                        h = a.isLegacyVerifiedOrg(),
                        S = a.isGovVerifiedOrg(),
                        p = "business" === e.user?.verified_type?.toLowerCase(),
                        A = "government" === e.user?.verified_type?.toLowerCase();
                    if ((0, i.Z)() && !s && !D && !h && !p && !S && !A && d.isTrue("vo_upsell_profile_page_enabled")) return r.createElement(l.Z, { style: t.container }, r.createElement(o.Z, { variant: "VerifiedOrgProfileUpsell" }));
                    if (n) return null;
                    return (0, u.Z)({ isOwnProfile: !0, userClaims: a, user: e.user, verifiedType: e.user?.verified_type, featureSwitch: "subscriptions_upsells_get_verified_profile_card", featureSwitches: d }) && e.shouldShowProfileUpsellCard ? r.createElement(l.Z, { style: t.container }, r.createElement(o.Z, { fatigueDismiss: e.dismissProfileUpsellCard, variant: "GetVerifiedProfileCard" })) : e.gotDismissedProfileUpsellCard ? void 0 : r.createElement(c.Z, null);
                },
                t = n.default.create((e) => ({ container: { marginHorizontal: e.spaces.space16 } }));
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-8bf258cf.529e741a.js.map
