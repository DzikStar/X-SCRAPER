            ...
            const w = c().a2811f96,
                ...
                q = (e) => {
                    ...
                    const { screen_name: V } = i,
                        O = X.query,
                        j = i && q === i.id_str,
                        z = c.isTrue("creator_monetization_profile_subscription_tweets_tab_enabled") ? i.super_follow_eligible : (j && d) || i.super_following,
                        L = y,
                        ...
                        ne = re && i.highlights_info?.can_highlight_tweets && j,
                        oe = de && re && c.isTrue("subscriptions_sign_up_enabled") && j && !i.highlights_info?.can_highlight_tweets,
                        ue = ae && (le || ne || oe),
                        ie = (e) => [{ isActive: () => X.pathname.toLowerCase() === `/${V}`.toLowerCase() || X.pathname.toLowerCase() === `/${V}/`.toLowerCase() || X.pathname.indexOf("/intent/follow") > -1 || X.pathname.indexOf("/intent/user") > -1, to: { pathname: `/${V}`, query: O }, key: M, label: M, viewType: "tweets" }, ee ? { to: { pathname: `/${V}/${U}`, query: O }, key: k, label: k, viewType: "affiliates", onClick: e() } : void 0, { to: { pathname: `/${V}/${E}`, query: O }, key: f, label: f, viewType: "tweets_replies", onClick: e() }, z ? { to: { pathname: `/${V}/${T}`, query: O }, key: L, label: L, color: "plum500", viewType: "super_follows_tweets" } : void 0, ue ? { to: { pathname: `/${V}/${_}`, query: O }, key: B, label: B, viewType: "highlight_tweets" } : void 0, K ? { to: { pathname: `/${V}/${R}`, query: O }, key: P, label: P, onClick: e(), viewType: "articles" } : void 0, { to: { pathname: `/${V}/${C}`, query: O }, key: v, label: v, onClick: e(), viewType: "media" }, j ? { to: { pathname: `/${V}/${I}`, query: O }, key: g, label: g, onClick: e(), viewType: "likes" } : void 0],
                    ...
                    return l.createElement(
                        ...
                        l.createElement(o.Switch, null, l.createElement(o.Route, { exact: !0, path: "/intent/follow" }, l.createElement(Z, (0, r.Z)({}, ce, be))), l.createElement(o.Route, { exact: !0, path: "/intent/user" }, l.createElement(Z, (0, r.Z)({}, ce, be))), l.createElement(o.Route, { exact: !0, path: `/${A.qX}` }, l.createElement(Z, (0, r.Z)({}, ce, be, { onEntriesRendered: a }))), l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${E}` }, l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "with_replies" }))), l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${T}` }, l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "superfollows" }))), ue ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${_}` }, oe ? l.createElement(b.Z, { variant: "HighlightsProfile" }) : l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "highlights" }))) : null, K ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${R}` }, Y ? l.createElement(b.Z, { variant: "ArticlesProfile" }) : l.createElement(Z, (0, r.Z)({}, ce, be, { mode: "articles" }))) : null, l.createElement(o.Route, { exact: !0, path: `/${A.qX}/${C}` }, l.createElement(N, ce)), j ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/(${I})` }, l.createElement($, (0, r.Z)({ isOwnProfile: j }, ce))) : null, ee ? l.createElement(o.Route, { exact: !0, path: `/${A.qX}/(${U})` }, l.createElement(x, ce)) : null, de ? l.createElement(p.Z, { to: `/${V}` }) : null),
                    );
                },
        ...
        975950: (e, d, a) => {
            ...
            const s = (e) => {
                    const { featureSwitches: d, userClaims: a } = (0, b.QZ)(),
                        ...
                        D = (0, i.Z)(),
                        h = a.isFreeVerifiedOrg();
                    if (D && !s && !h && d.isTrue("vo_upsell_profile_page_enabled")) return r.createElement(l.Z, { style: t.container }, r.createElement(o.Z, { variant: "VerifiedOrgProfileUpsell" }));
                    if (n) return null;
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-8bf258cf.5edd3f2a.js.map
