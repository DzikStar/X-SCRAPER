    ...
    ["bundle.UserProfile-e019dbda"],
    {
            ...
            const a = (0, n(523561).Z)({
                loader: () =>
                    Promise.all([
                        ...
                        n.e("shared~ondemand.SettingsMonetization~ondemand.SettingsSuperFollows~bundle.Payments~bundle.SuperFollowsSubscri"),
                        n.e("shared~bundle.Payments~bundle.TV"),
                        n.e("bundle.Payments-2c5e6a0d"),
            ...
            function C({ style: e, userId: t }) {
                ...
                return a.createElement(
                    ...
                    d
                        ? a.createElement(
                              i.Z,
                              { onMaskClick: h, style: F.sheet, type: "bottom", withMask: !0 },
                              a.createElement(s.ZP, { "aria-label": P, hoverLabel: T, icon: a.createElement(w.default, null), onPress: h, style: F.close, type: "primaryText" }),
                              a.createElement(o.Z, { style: F.header }, a.createElement(l.ZP, { weight: "bold" }, E), a.createElement(l.ZP, null, `@${u.screen_name}`)),
                              Object.entries(m)
                                  .filter(([e, t]) => t)
                                  .map(([e, t]) => {
                                      const o = k[e];
                                      if (o) {
                                          ...
                                          return a.createElement(l.ZP, { color: "text", key: e, link: i, onPress: s, style: F.service, withInteractiveStyling: !1 }, o.icon, o.label);
                                      }
                                  }),
                          )
                        : null,
        ...
        893664: (e, t, n) => {
            ...
            const i = (e) => {
                ...
                return !!t.legacy && (0, s.n5)({ isOwnProfile: e.isOwnProfile, isSoftBlockEnabled: e.isSoftBlockEnabled, user: t.legacy });
            };
        },
        961104: (e, t, n) => {
            function a(e, t) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-e019dbda.ed1d614a.js.map
