    ...
    ["bundle.UserProfile-e019dbda"],
    {
            ...
            const _ = (e, t) => y.ZP.select(e, t.userId),
                ...
                M = (e) => {
                    ...
                    return r.createElement(s.ZP, {
                        ...
                        icon: I,
                        onPress: () => {
                            !P || i || l || (S({ element: "super_follow_subscribe_button", action: "click" }), w.push(`/${P}/creator-subscriptions/subscribe`, { referring_page: "profile_intent" }));
                        },
        ...
        179562: (e, t, n) => {
            ...
            var r = n(807896),
                ...
                E = n(926597),
                P = n(298219);
            const I = (0, T.ZP)({ namespace: "translationsProfiles", fetchOneContext: "FETCH_PROFILE_TRANSLATION", fetchOneEndpoint: (e) => (t, n) => e.withEndpoint(w.Z).fetchProfileTranslation(t, n).then(S), fetchOneParams: (e) => ({ profileUserId: e }) });
            I.fetchStreamedGrokTranslation =
                ...
                async (n, r, { api: a }) => {
                    ...
                    try {
                        ...
                        if (!t.ok) throw ((s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(I.updateOrAddOne(e, (0, y.Z)(s))), new Error(`invalid response ${t.status}`));
                        const r = t.body?.getReader();
                        if (!r) throw ((s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(I.updateOrAddOne(e, (0, y.Z)(s))), new Error("reader not present"));
                        const l = new TextDecoder();
                        let d = "",
                            c = "";
                        const m = async (t) => {
                            const a = t ? P.T9 : P.UG,
                                { done: o, value: i } = await (0, P.yE)("PROFILE_TIMEOUT_BETWEEN_CHUNKS", () => r.read(), a, t ? "timeout to first chunk" : "timeout between chunks");
                            if (o) {
                                if (0 === d.length) throw new Error("empty string when done");
                                return (s.profileTranslation.translationState = u.H.SUCCESS), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.LOADED), (s.profileTranslation.translation = d), void n(I.updateOrAddOne(e, (0, y.Z)(s)));
                            }
                            const h = l.decode(i);
                            if (((c += h), c.includes("\n"))) {
                                const t = c.split("\n");
                        ...
                        (s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(I.updateOrAddOne(e, (0, y.Z)(s))), i.abort(), (0, D.ZP)(`Failed to translate profile:${e} to ${t.userLanguage} - ${String(r)}`);
                    }
                };
            const S = (e) => {
                ...
                Z = M.Z.register(I),
                k = (e, t) => Z.select(e, t.userId),
                v = (e, t) => Z.selectFetchStatus(e, t.userId),
                A = (0, b.Z)()
                    .propsFromState(() => ({ translation: k, translationFetchStatus: v, userLanguage: g.VT }))
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-e019dbda.e775508a.js.map
