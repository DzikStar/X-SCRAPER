            ...
            const D = h().d7f8a117,
                ...
                C = (e) => {
                    ...
                    return (
                        ...
                        s ? r.createElement(a.nO, { namespace: { component: "analytics_preview" } }, r.createElement(i.H, { errorConfig: { context: "AnalyticPreview" }, suspenseFallback: null }, r.createElement(Z, { config: e.config, dismiss: t, impress: n }))) : null
                    );
                },
                O = () => {
            ...
            const y = (e, t) => _.ZP.select(e, t.userId),
                ...
                E = (e) => {
                    const { analytics: t, createLocalApiErrorHandler: n, isFollowing: i, isSuperFollowing: l, promotedContent: d, style: b, unfollow: g, user: _, userId: y } = e,
                        ...
                        v = r.useCallback(
                            (e) => {
                                y && (Z({ element: "super_follow_subscribe_button", action: "unfollow" }), g(y, { promotedContent: d }).catch(n(p.X))), e();
                            },
                            [n, d, g, y, Z],
                        ),
                        S = r.useCallback(
            ...
            P.fetchStreamedGrokTranslation =
                ...
                async (n, r, { api: o }) => {
                    ...
                    try {
                        ...
                        if (!t.ok) throw ((s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(P.updateOrAddOne(e, (0, _.Z)(s))), new Error("Failed to translate due to invalid API response."));
                        const r = t.body?.getReader();
                        if (!r) throw ((s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(P.updateOrAddOne(e, (0, _.Z)(s))), new Error("Failed to translate because reader is not present."));
                        const l = new TextDecoder();
                        let d = "",
                            c = "";
                        const m = async (t) => {
                            const o = t ? E.T9 : E.UG,
                                { done: a, value: i } = await (0, E.yE)("PROFILE_TIMEOUT_BETWEEN_CHUNKS", () => r.read(), o, "Timeout between streaming chunks");
                            if (a) {
                                const t = 0 === d.length;
                                return (s.profileTranslation.translationState = t ? u.H.ERROR : u.H.SUCCESS), (s.profileTranslation.streamedTranslationFetchStatus = t ? p.iF.FAILED : p.iF.LOADED), (s.profileTranslation.translation = d), void n(P.updateOrAddOne(e, (0, _.Z)(s)));
                            }
                            const h = l.decode(i);
                            if (((c += h), c.includes("\n"))) {
                                const t = c.split("\n");
                                ...
                                for (const r of t) {
                                    ...
                                    t.result && "BIO" === t.result.content_type && (t.result.text && ((d += t.result.text), (s.profileTranslation.translation = d)), t.result.entities && t.result.entities.urls && (s.profileTranslation.entities.urls = [...(s.profileTranslation.entities.urls ?? []), ...t.result.entities.urls])), n(P.updateOrAddOne(e, (0, _.Z)(s)));
                                }
                            }
                            await m();
                        };
                        ...
                        (s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(P.updateOrAddOne(e, (0, _.Z)(s))), i.abort();
                    }
                };
            const M = (e) => {
                ...
                v = (e, t) => I.selectFetchStatus(e, t.userId),
                S = (0, b.Z)()
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-e019dbda.e821794a.js.map
