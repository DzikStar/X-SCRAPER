    ...
    ["bundle.UserProfile-e019dbda"],
    {
                    ...
                    const s = r.useMemo(() => {
                            ...
                            if (1 === e.metrics.length) {
                                ...
                                const a = n.metric_type,
                                    { value: o } = (0, _.fX)({ compareData: null, data: { [a]: { metrics: { [a]: n.metric_value }, fromTime: "", toTime: "" } }, metric: e.metrics[0].metricType }),
            ...
            const h = l.default.create((e) => ({ root: { marginHorizontal: "auto", width: "100%" }, rootMedium: { position: "absolute", bottom: 0, start: 0, end: 0 }, rootLarge: { maxWidth: 1e3 }, fabStaysAboveSafeArea: { top: `calc(${l.default.iPhoneOffsetBottom} - ${u.ZM.getAppBarHeight()} - ${e.spaces.space20})` }, fab: { bottom: e.spaces.space20, alignSelf: "flex-end", end: e.spaces.space20 }, fabLarge: { end: e.spaces.space20 }, fabMicro: { bottom: e.spaces.space16, end: e.spaces.space16 }, buttonMicro: { height: e.spaces.space40, width: e.spaces.space40 } })),
                f = (e) => {
                    const { "aria-label": t, label: n, onPress: f, scribeComponent: b, ...g } = e,
                        { loggedInUserId: _ } = a.useContext(p.rC),
                        y = (0, m.z)(),
                        w = a.useCallback(
                            (e) => {
            ...
            const y = (e, t) => _.ZP.select(e, t.userId),
                ...
                M = (e) => {
                    const { analytics: t, createLocalApiErrorHandler: n, isFollowing: i, isSuperFollowing: l, promotedContent: d, style: b, unfollow: g, user: _, userId: y } = e,
                        ...
                        k = r.useCallback(
                            (e) => {
                                const { action: n, element: r } = e,
                                    ...
                                    s = [];
                                _ ? s.push({ ...o, ...f.Z.getUserItem(_, d) }) : o && s.push(o);
                        ...
                        S = r.useCallback(
                            (e) => {
                                y && (k({ element: "super_follow_subscribe_button", action: "unfollow" }), g(y, { promotedContent: d }).catch(n(p.X))), e();
                            },
                            [n, d, g, y, k],
                        ),
                        Z = r.useCallback(
        ...
        179562: (e, t, n) => {
            ...
            var r = n(807896),
                ...
                E = n(926597),
                P = n(298219);
            const I = (0, T.ZP)({ namespace: "translationsProfiles", fetchOneContext: "FETCH_PROFILE_TRANSLATION", fetchOneEndpoint: (e) => (t, n) => e.withEndpoint(w.Z).fetchProfileTranslation(t, n).then(k), fetchOneParams: (e) => ({ profileUserId: e }) });
            I.fetchStreamedGrokTranslation =
                (e, t, n) =>
                async (n, r, { api: a }) => {
                    const o = Date.now(),
                        s = { content_type: "BIO", id: e, dst_lang: t.userLanguage },
                        i = { profileUserId: e, profileTranslation: { entities: { urls: [] }, translation: "", streamedTranslationFetchStatus: p.iF.LOADING, translationSource: "Grok", localizedSourceLanguage: "" } };
                    n(I.updateOrAddOne(e, (0, _.Z)(i)));
                    const l = new AbortController();
                    try {
                        const r = await a.fetchClient.dispatch("/2/grok/translation.json", { method: "POST", credentials: "include", body: JSON.stringify(s), signal: l.signal });
                        if (!r.ok) throw ((i.profileTranslation.translationState = u.H.ERROR), (i.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(I.updateOrAddOne(e, (0, _.Z)(i))), new Error(`invalid response ${r.status}`));
                        const d = r.body?.getReader();
                        if (!d) throw ((i.profileTranslation.translationState = u.H.ERROR), (i.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(I.updateOrAddOne(e, (0, _.Z)(i))), new Error("reader not present"));
                        const c = new TextDecoder();
                        let m = "",
                            h = "";
                        const f = async (r) => {
                            const { done: a, value: s } = await (0, P.yE)("PROFILE_TIMEOUT_BETWEEN_CHUNKS", () => d.read(), r ? "FIRST_CHUNK" : "BETWEEN_CHUNKS");
                            if (a) {
                                if ((t.analytics.scribe({ component: "grok_button_translation", element: "time_to_last_token_bio", action: "complete", data: { duration_ms: Date.now() - o } }), 0 === m.length)) throw new Error("empty string when done");
                                return (i.profileTranslation.translationState = u.H.SUCCESS), (i.profileTranslation.streamedTranslationFetchStatus = p.iF.LOADED), (i.profileTranslation.translation = m), void n(I.updateOrAddOne(e, (0, _.Z)(i)));
                            }
                            r && t.analytics.scribe({ component: "grok_button_translation", element: "time_to_first_token_bio", action: "complete", data: { duration_ms: Date.now() - o } });
                            const l = c.decode(s);
                            if (((h += l), h.includes("\n"))) {
                                const t = h.split("\n");
                                h = t.pop();
                                for (const r of t) {
                                    ...
                                    if ("BIO" === t.result?.content_type) {
                                        ...
                                        if ((r && ((m += r), (i.profileTranslation.translation = m)), n?.urls)) {
                                            const { errors: t, result: r } = (0, E.b)(n.urls);
                                            t.length > 0 && (0, D.ZP)(`invalid url entities in translating profile:${e} - ${t.join(",")}`), (i.profileTranslation.entities.urls = [...(i.profileTranslation.entities.urls ?? []), ...r]);
                                        }
                                    }
                                    n(I.updateOrAddOne(e, (0, _.Z)(i)));
                                }
                        ...
                        (i.profileTranslation.translationState = u.H.ERROR), (i.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(I.updateOrAddOne(e, (0, _.Z)(i))), l.abort(), (0, D.ZP)(`Failed to translate profile:${e} to ${t.userLanguage} - ${String(r)}`), r instanceof P.mn ? t.analytics.scribe({ component: "grok_button_translation", element: "FIRST_CHUNK" === r.type ? "error_timeout_first_token_bio" : "error_timeout_within_tokens_bio", action: "error" }) : t.analytics.scribe({ component: "grok_button_translation", element: "error_bio", action: "error" });
                    }
                };
            const k = (e) => {
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._fetchTranslation = () => {
                            const { analytics: e, createLocalApiErrorHandler: t, fetchStreamedGrokTranslation: n, fetchTranslation: r, translation: a, translationFetchStatus: o, userId: s, userLanguage: i } = this.props,
                                l = this._useGrokTranslation(),
                                d = a?.profileTranslation;
                            if (d?.translationState !== u.H.SUCCESS)
                                if (l) {
                                    if (d?.streamedTranslationFetchStatus === p.ZP.LOADING) return;
                                    n(s, { userLanguage: i, analytics: e });
                                } else o !== p.ZP.LOADING && r(s).catch(t());
                        }),
        ...
        507986: (e, t, n) => {
            n.d(t, { Z: () => r });
            n(202784);
            const r = (0, n(523561).Z)({ loader: () => Promise.all([n.e("icons.21"), n.e("icons.3"), n.e("modules.common-e907d115"), n.e("modules.common-e019dbda"), n.e("icons.7"), n.e("shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.SideNav~loader.SideNavRedesign~loader.Typeahe"), n.e("loader.ProfileClusterFollow")]).then(n.bind(n, 751154)) });
        },
        103335: (e, t, n) => {
            n.d(t, { Z: () => a });
            var r = n(856674);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-e019dbda.fb0f6eaa.js.map
