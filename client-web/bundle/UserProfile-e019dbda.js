    ...
    ["bundle.UserProfile-e019dbda"],
    {
                ...
                g = () => {
                    ...
                    return r.createElement(
                        a.Z,
                        {
                            ...
                            renderContent: () => r.createElement(o.Z, null, r.createElement(s.ZP, { style: _.popoverTitle }, f), r.createElement(s.ZP, null, b)),
                            withArrow: !0,
                        },
                        r.createElement(o.Z, null, r.createElement(i.ZP, { icon: r.createElement(u.default, { style: _.icon, type: "primaryOutlined" }), size: "xSmall" }, h)),
                    );
                },
                _ = l.default.create((e) => ({ icon: { color: e.colors.blue500 }, popover: { padding: e.spaces.space16 }, popoverTitle: { marginBottom: e.spaces.space8 } }));
        },
        789831: (e, t, n) => {
            n.d(t, { Z: () => d });
            var r = n(807896),
            ...
            const g = l.Z,
                ...
                y = ({ setIsRenderingProfileSpotlight: e, userRef: t }) => {
                    ...
                    return (
                        ...
                        a ? o.createElement(d.Z, { style: _.container }, o.createElement(f.Z, { profileSpotlightRef: a, setIsRenderingProfileSpotlight: e, userRef: r })) : null
                    );
                },
                w = r.Z,
        ...
        177997: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                g = n(725405),
                _ = n(945181);
            const y = ({ metric: e, metricResult: t }) => {
                const n = t.metric_type,
                    o = t.metric_value;
                if (!o) return null;
                const a = n,
                    s = { [a]: { metrics: { [a]: o }, fromTime: "", toTime: "" } };
                return r.createElement(d.Z, { testID: e }, r.createElement(_.Fd, { compareData: null, data: s, metric: n }));
            };
            var w = n(336636);
            const D = h().d7f8a117,
                T = h().cae20e93,
                E = h().gc767fda,
                P = h().c7c85e0c,
                M = ({ config: e, data: t, dismiss: n, impress: o }) => {
                    const a = (0, g.Z)();
                    r.useEffect(() => {
                    ...
                    const s = r.useMemo(() => {
                            if (e.metrics.length > 1)
                                return r.createElement(
                                    ...
                                    e.metrics.map((e) => {
                                        ...
                                        return n?.metric_value ? r.createElement(y, { key: e.metricType, metric: e.metricType, metricResult: n }) : null;
                                    }),
                                );
                            if (1 === e.metrics.length) {
                                ...
                                const o = n.metric_type,
                                    { value: a } = (0, _.fX)({ compareData: null, data: { [o]: { metrics: { [o]: n.metric_value }, fromTime: "", toTime: "" } }, metric: e.metrics[0].metricType }),
                                    s = _.Kg[n.metric_type];
                                return s.summary ? r.createElement(c.ZP, { weight: "medium" }, s.summary({ value: a, period: T({ days: e.periodInDays }) })) : null;
                            }
                            return null;
                    ...
                    return r.createElement(d.Z, { style: v.container, testID: "analytics-preview" }, r.createElement(d.Z, { style: v.heading }, e.metrics.length > 1 ? r.createElement(c.ZP, { size: "headline2", weight: "bold" }, D({ days: e.periodInDays })) : null, r.createElement(c.ZP, { color: "gray700", size: "subtext3" }, E), r.createElement(u.ZP, { icon: r.createElement(f.default, null), onClick: i, style: v.dismissButton, testID: "dismiss-button", type: "primaryText" })), r.createElement(d.Z, { style: v.content }, s, r.createElement(u.ZP, { icon: r.createElement(b.default, null), link: { pathname: "/i/premium_sign_up", state: { referring_page: "account_analytics" } }, size: "xSmall", style: v.unlockButton, type: "primaryFilled" }, P)));
                },
                Z = (e) => {
                    ...
                    return (
                        ...
                        a ? r.createElement(M, (0, l.Z)({}, e, { data: n })) : (o.scribe({ action: "not_matched" }), null)
                    );
                },
                I = r.memo(Z),
                v = m.default.create((e) => ({ container: { marginHorizontal: e.spaces.space16, backgroundColor: e.colors.unreadCellBackground, borderRadius: e.borderRadii.large, padding: e.spaces.space16 }, content: { justifyContent: "space-between", flexDirection: "row", flexWrap: "wrap" }, tiles: { flexDirection: "row", gap: e.spaces.space48 }, heading: { flexDirection: "row", alignItems: "center", gap: e.spaces.space16 }, unlockButton: { alignSelf: "flex-end", marginTop: e.spaces.space12 }, dismissButton: { marginStart: "auto" } })),
                ...
                C = (e) => {
                    ...
                    return (
                        ...
                        s ? r.createElement(a.nO, { namespace: { component: "analytics_preview" } }, r.createElement(i.H, { errorConfig: { context: "AnalyticPreview" }, suspenseFallback: null }, r.createElement(I, { config: e.config, dismiss: t, impress: n }))) : null
                    );
                },
                O = () => {
            ...
            const h = l.default.create((e) => ({ root: { marginHorizontal: "auto", width: "100%" }, rootMedium: { position: "absolute", bottom: 0, start: 0, end: 0 }, rootLarge: { maxWidth: 1e3 }, fabStaysAboveSafeArea: { top: `calc(${l.default.iPhoneOffsetBottom} - ${u.ZM.getAppBarHeight()} - ${e.spaces.space20})` }, fab: { bottom: e.spaces.space20, alignSelf: "flex-end", end: e.spaces.space20 }, fabLarge: { end: e.spaces.space20 }, fabMicro: { bottom: e.spaces.space16, end: e.spaces.space16 }, buttonMicro: { height: e.spaces.space40, width: e.spaces.space40 } })),
                f = (e) => {
                    const { "aria-label": t, label: n, onPress: f, scribeComponent: b, ...g } = e,
                        { loggedInUserId: _ } = o.useContext(p.rC),
                        y = (0, m.z)(),
                        w = o.useCallback(
                            (e) => {
                                y.scribe({ component: b, action: "click" }), f && f(e);
                            },
                            [y, f, b],
                        ),
            ...
            function m({ user: e }) {
                ...
                return s && !e.protected && h && (e.statuses_count ?? 0) > p && (e.followers_count ?? 0) > m
                    ? r.createElement(o.ZP, {
                          ...
                          onPress: function () {
                              n.scribe({ element: "grok_profile_summary", action: "click" }), a({ text: `@${e.screen_name}`, autoSubmit: !0, source: "user_profile_summary" });
                          },
                          type: "primaryText",
                      })
                    : null;
        ...
        948503: (e, t, n) => {
            ...
            const m = i().a9ae1e78,
                ...
                h = ({ style: e, user: t }) => {
                    ...
                    return r.createElement(u.Z, { displayMode: c.BH.search, userFullName: t.name, userId: t.id_str }, (t) => r.createElement(a.ZP, { "aria-label": m, hoverLabel: { label: m }, icon: p, onPress: t(l, h), style: e, type: "primaryText" }));
                };
        },
        26088: (e, t, n) => {
            n.d(t, { Z: () => M });
            ...
            var r = n(202784),
                ...
                g = n(668214),
                _ = n(919022);
            const y = (e, t) => _.ZP.select(e, t.userId),
                w = (0, g.Z)()
                    .propsFromState(() => ({ user: y }))
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, b.zr)("SUPER_FOLLOW_BUTTON_CONTAINER"), unfollow: _.ZP.unfollow }))
                    .withAnalytics(),
                D = d().b63c46ed,
                T = d().ja66a2b5,
                E = (e) => {
                    const { analytics: t, createLocalApiErrorHandler: n, isFollowing: i, isSuperFollowing: l, promotedContent: d, style: b, unfollow: g, user: _, userId: y } = e,
                        w = (0, o.useHistory)(),
                        E = (0, o.useLocation)(),
                        M = _?.screen_name,
                        Z = i ? r.createElement(c.default, null) : r.createElement(u.default, { style: P.superFollowsIcon }),
                        I = r.useCallback(
                            (e) => {
                                const { action: n, element: r } = e,
                                    ...
                                    s = [];
                                _ ? s.push({ ...a, ...f.Z.getUserItem(_, d) }) : a && s.push(a);
                        ...
                        v = r.useCallback(
                            (e) => {
                                y && (I({ element: "super_follow_subscribe_button", action: "unfollow" }), g(y, { promotedContent: d }).catch(n(p.X))), e();
                            },
                            [n, d, g, y, I],
                        ),
                        S = r.useCallback(
                            (e) => {
                                const t = [{ Icon: m.default, text: T({ screenName: M }), onClick: v }];
                    ...
                    return r.createElement(s.ZP, {
                        ...
                        icon: Z,
                        onPress: () => {
                            !M || i || l || (I({ element: "super_follow_subscribe_button", action: "click" }), w.push(`/${M}/creator-subscriptions/subscribe`, { referring_page: "profile_intent" }));
                        },
                ...
                return r.createElement(
                    ...
                    d
                        ? r.createElement(
                              ...
                              r.createElement(s.ZP, { "aria-label": M, hoverLabel: Z, icon: r.createElement(D.default, null), onPress: f, style: O.close, type: "primaryText" }),
                                  ...
                                  .map(([e, t]) => {
                                      ...
                                      if (a) {
                                          const s = a.url
                                                  ? void 0
                                                  : function () {
                                                        o.Z.setString(String(t)), n((0, E.fz)({ text: k({ service: a.label }) }));
                                                    },
        ...
        179562: (e, t, n) => {
            ...
            var r = n(807896),
                ...
                P = n(926597),
                M = n(298219);
            const Z = (0, T.ZP)({ namespace: "translationsProfiles", fetchOneContext: "FETCH_PROFILE_TRANSLATION", fetchOneEndpoint: (e) => (t, n) => e.withEndpoint(w.Z).fetchProfileTranslation(t, n).then(I), fetchOneParams: (e) => ({ profileUserId: e }) });
            Z.fetchStreamedGrokTranslation =
                (e, t, n) =>
                async (n, r, { api: o }) => {
                    const a = { content_type: "BIO", id: e, dst_lang: t.userLanguage },
                    ...
                    n(Z.updateOrAddOne(e, (0, _.Z)(s)));
                    const i = new AbortController();
                    try {
                        const t = await o.fetchClient.dispatch("/2/grok/translation.json", { method: "POST", credentials: "include", body: JSON.stringify(a), signal: i.signal });
                        if (!t.ok) throw ((s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(Z.updateOrAddOne(e, (0, _.Z)(s))), new Error(`invalid response ${t.status}`));
                        const r = t.body?.getReader();
                        if (!r) throw ((s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(Z.updateOrAddOne(e, (0, _.Z)(s))), new Error("reader not present"));
                        const l = new TextDecoder();
                        let d = "",
                            c = "";
                        const m = async (t) => {
                            const o = t ? M.T9 : M.UG,
                                { done: a, value: i } = await (0, M.yE)("PROFILE_TIMEOUT_BETWEEN_CHUNKS", () => r.read(), o, t ? "timeout to first chunk" : "timeout between chunks");
                            if (a) {
                                if (0 === d.length) throw new Error("empty string when done");
                                return (s.profileTranslation.translationState = u.H.SUCCESS), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.LOADED), (s.profileTranslation.translation = d), void n(Z.updateOrAddOne(e, (0, _.Z)(s)));
                            }
                            const h = l.decode(i);
                            if (((c += h), c.includes("\n"))) {
                                const t = c.split("\n");
                                ...
                                for (const r of t) {
                                    ...
                                    if ("BIO" === t.result?.content_type) {
                                        const { entities: n, text: r } = t.result;
                                        if ((r && ((d += r), (s.profileTranslation.translation = d)), n?.urls)) {
                                            const { errors: t, result: r } = (0, P.b)(n.urls);
                                            t.length > 0 && (0, D.ZP)(`invalid url entities in translating profile:${e} - ${t.join(",")}`), (s.profileTranslation.entities.urls = [...(s.profileTranslation.entities.urls ?? []), ...r]);
                                        }
                                    }
                                    n(Z.updateOrAddOne(e, (0, _.Z)(s)));
                                }
                        ...
                        (s.profileTranslation.translationState = u.H.ERROR), (s.profileTranslation.streamedTranslationFetchStatus = p.iF.FAILED), n(Z.updateOrAddOne(e, (0, _.Z)(s))), i.abort(), (0, D.ZP)(`Failed to translate profile:${e} to ${t.userLanguage} - ${String(r)}`);
                    }
                };
            const I = (e) => {
                ...
                v = E.Z.register(Z),
                S = (e, t) => v.select(e, t.userId),
                k = (e, t) => v.selectFetchStatus(e, t.userId),
                A = (0, b.Z)()
                    .propsFromState(() => ({ translation: S, translationFetchStatus: k, userLanguage: g.VT }))
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, f.zr)("TRANSLATE_USER_BIO"), fetchTranslation: v.fetchOneIfNeeded, fetchStreamedGrokTranslation: v.fetchStreamedGrokTranslation }))
                    .withAnalytics(),
                C = i().ad7a451e;
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._fetchTranslation = () => {
                            const { createLocalApiErrorHandler: e, fetchStreamedGrokTranslation: t, fetchTranslation: n, translation: r, translationFetchStatus: o, userId: a, userLanguage: s } = this.props,
                            ...
                            if (l?.translationState !== u.H.SUCCESS)
                                if (i) {
                                    ...
                                    t(a, { userLanguage: s });
                                } else o !== p.ZP.LOADING && n(a).catch(e());
                        }),
                        ...
                        (this._renderTranslation = () => {
                            ...
                            return o.createElement(a.Z, g);
                        });
                }
                render() {
                    const { analytics: e, createLocalApiErrorHandler: t, disableTranslation: n, fetchStreamedGrokTranslation: s, fetchTranslation: i, grokTranslatedBio: u, style: m, translation: h, translationFetchStatus: f, userId: b, userLanguage: g, withOriginalText: _, ...y } = this.props;
                    if (u) {
                        const e = (0, c.t)(g, u.source_language);
                        return o.createElement(d.Z, { disableTranslation: this.props.disableTranslation, fetchTranslation: l.Z, isInitiallyTranslated: !0, key: `${b}-auto-translation`, originLanguage: e, streamedTranslationFetchStatus: p.ZP.LOADED, style: m, translateButtonText: C, translateTargetType: "bio", translatedMessage: this._renderGrokTranslatedBio(), translationFetchStatus: p.ZP.LOADED, translationSource: "Grok", useGrokTranslation: "auto", withOriginalText: _ }, o.createElement(a.Z, (0, r.Z)({}, y, { userId: b })));
                    }
                    return o.createElement(d.Z, { disableTranslation: this.props.disableTranslation, fetchTranslation: this._fetchTranslation, key: `${b}-translation`, originLanguage: h && h.profileTranslation.localizedSourceLanguage, streamedTranslationFetchStatus: h && h.profileTranslation.streamedTranslationFetchStatus, style: m, translateButtonText: C, translateTargetType: "bio", translatedMessage: this._renderTranslation(), translationFetchStatus: f, translationSource: h && h.profileTranslation.translationSource, useGrokTranslation: this._useGrokTranslation(), withOriginalText: _ }, o.createElement(a.Z, (0, r.Z)({}, y, { userId: b })));
                }
            }
            O.contextType = h.rC;
            const F = A(O);
        ...
        965728: (e, t, n) => {
            n.d(t, { C_: () => g, I5: () => h, K2: () => b, L$: () => d, Rb: () => f, nk: () => p, sI: () => w, xr: () => _ });
            var r = n(202784),
                o = n(483677),
                a = n(782578),
                s = n(401339),
            ...
            const l = (e, t) => `rgba(${e.rgb.red}, ${e.rgb.green}, ${e.rgb.blue}, ${t})`,
                d = (e) => {
                    ...
                    return t ? { rgb: _(t), rgba: l(t, 0.9) } : m;
                },
                ...
                w = () => {
                    const [e, t] = r.useReducer(y, { isZoomed: !1, showControls: !0 });
                    return {
        ...
        947650: (e, t, n) => {
            ...
            const h = (e, t) => e[d][t],
                f = (e, t) => {
                    if (t) {
                        const n = _(e, t);
                        return (0, o.b)(l.ZP.selectMany(e, n), (e) => !!e);
                    }
                    return u;
                },
                        ...
                        void 0 !== g(n(), e)
                            ...
                            : t(
                                  (
                                      (e) =>
                                      (t, n, { api: o }) =>
                                          (0, s._O)(t, { request: o.withEndpoint(r.Z).fetchFollowersYouFollow, params: { user_id: e, count: 3, with_total_count: !0 } })({ actionTypes: m, context: "FETCH_KNOWN_FOLLOWERS", meta: { user_id: e } }, (e) => {
                                              if (e) {
                                                  const { entities: t } = e;
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.UserProfile-e019dbda.0a2f3bea.js.map
