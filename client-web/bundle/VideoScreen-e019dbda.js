    ...
    ["bundle.VideoScreen-e019dbda", "bundle.Articles-e019dbda", "shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae"],
    {
                ...
                x = ({ isLegacy: e, isWide: d }) =>
                    n.ub({
                        splice: (a) => {
                            ...
                            let t = "";
                            for (let e = 0; e < c; e++) t += `verticalGridItem-${e}-${u} `;
                            const m = !!s && c < l.length;
                            M.push(O({ "aria-owns": t, itemMetadata: i, moduleEntryId: u, sortIndex: h }));
                            for (let d = 0; d < c; d += b) {
                                const a = d / b,
                                    o = l.slice(d, Math.min(c, d + b)),
                                    r = m && d + b >= c;
                                M.push(L({ entryToFocus: s?.entryToFocus, isLegacy: e, itemMetadata: i, items: o, moduleEntryId: u, numColumns: b, rowIndex: a, shouldDisplayBorder: r, sortIndex: h }));
                            }
        ...
        335632: (e, d, a) => {
            ...
            const c = (e) => ({
                ...
                t = ({ shouldStoreTypeaheadItem: e }) => r.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [b.Z.Hero]: c({}), [b.Z.Cell]: c({ shouldStoreTypeaheadItem: e }), [b.Z.CellWithProminentSocialContext]: c({}) } }),
                m = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.8"),
            ...
            const We = { loader: () => Promise.all([a.e("icons.8"), a.e("icons.13"), a.e("icons.21"), a.e("icons.20"), a.e("icons.14"), a.e("icons.3"), a.e("icons.24"), a.e("icons.11"), a.e("icons.10"), a.e("shared~loader.Typeahead~loader.AppModules~loader.DMDrawer~ondemand.HoverCard~ondemand.NotFound~bundle.AboutTh"), a.e("shared~loader.Typeahead~loader.DMDrawer~ondemand.HoverCard~bundle.ReaderMode~bundle.AudioSpacePeek~bundle.Bir"), a.e("loader.VerticalGridItemHandler")]).then(a.bind(a, 395267)), loaderKey: "topicTileLoader", strategy: l.Z.OnDemand },
                ...
                $e = ({ bookmarkFolderId: e, displayBlocked: d = !1, errorContext: a = "", hideReplyContextMode: l, isCompact: n = !1, isInSidebar: u = !1, isLegacy: b = !1, shouldSelfThreadIncludeAvatar: c = !1, shouldStoreTypeaheadItem: m, showUnsupportedTombstone: A = !1, showWithheldBannerOnMyTweets: p = !0, tweetDismissable: I = !1, withMessageGaps: f = !0, withMuteConversation: C = !1, withRemoveFromBookmarks: R = !1, withSelfThreadCTA: Z = !1, withThirdPartyCards: H = !0, withTweetActionsDisabled: O = !1, withUserPresence: L = !1 }) => ({
                    ...
                    [o.ZP.TimelineModule]: (0, te.I)({ isLegacy: b }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.VideoScreen-e019dbda.e7e3b4fa.js.map
