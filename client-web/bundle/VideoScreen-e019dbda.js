...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.VideoScreen-e019dbda", "bundle.Articles-e019dbda", "shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae"],
    {
        ...
        560520: (e, d, a) => {
            a.d(d, { Z: () => l });
            var o = a(351322);
            const r = { loader: () => Promise.all([a.e("icons.5"), a.e("icons.2"), a.e("icons.20"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("icons.7"), a.e("icons.17"), a.e("icons.12"), a.e("icons.3"), a.e("icons.13"), a.e("loader.ThreadHeaderHandler")]).then(a.bind(a, 79056)), loaderKey: "threadHeaderEntryLoader", strategy: a(509738).Z.OnDemand },
                l = o.OZ(r);
        },
        367879: (e, d, a) => {
            a.d(d, { Z: () => i });
            ...
            const u =
                    ...
                    (d) => {
                        const {
                            ...
                            c = [];
                        return r && c.push((0, s.Z)(i, r, d, t)), 1 === u.length && u[0].type === o.ZP.Message ? c.push({ ...u[0] }) : c.push(l({ entryId: i, itemMetadata: D, items: u, sortIndex: t, displayType: e, shouldCountTowardsAdSpacing: h })), a && c.push((0, n.Z)(i, a, D, t)), c;
                    },
        ...
        929482: (e, d, a) => {
                ...
                x = ({ isLegacy: e, isWide: d }) =>
                    n.ub({
                        splice: (a) => {
                            ...
                            let M = "";
                            for (let e = 0; e < b; e++) M += `verticalGridItem-${e}-${u} `;
                            const m = !!s && b < l.length;
                            t.push(O({ "aria-owns": M, itemMetadata: i, moduleEntryId: u, sortIndex: h }));
                            for (let d = 0; d < b; d += c) {
                                const a = d / c,
                                    o = l.slice(d, Math.min(b, d + c)),
                                    r = m && d + c >= b;
                                t.push(L({ entryToFocus: s?.entryToFocus, isLegacy: e, itemMetadata: i, items: o, moduleEntryId: u, numColumns: c, rowIndex: a, shouldDisplayBorder: r, sortIndex: h }));
                            }
            ...
            const F = n.ub({
                ...
                U = ({ isInSidebar: e = !1, isLegacy: d = !1, isWide: a = !1 } = Object.freeze({})) => ({ [r.ZP.TimelineModule]: _({ isLegacy: d, isWide: a }), [r.no.ModuleImpressionPlaceholder]: t.Z, [r.no.ModuleHeader]: h.Z, [r.no.ModuleFooter]: (0, D.Z)({ isInSidebar: e }), [r.no.ModuleShowMore]: (0, c.Z)({ isInSidebar: e }), [r.no.ConversationModuleGap]: i.Z, [r.no.ModuleCarouselTimeline]: u.Z, [r.no.ModuleVerticalGridList]: v.Z, [r.no.ModuleVerticalGridTimelineRow]: E.Z });
        },
        877445: (e, d, a) => {
            a.d(d, { Z: () => n });
            var o = a(351322),
        ...
        335632: (e, d, a) => {
            ...
            const b = (e) => ({
                ...
                M = ({ shouldStoreTypeaheadItem: e }) => r.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [c.Z.Hero]: b({}), [c.Z.Cell]: b({ shouldStoreTypeaheadItem: e }), [c.Z.CellWithProminentSocialContext]: b({}) } }),
                m = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.5"),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.VideoScreen-e019dbda.497d965a.js.map
