    ...
    ["bundle.VideoScreen-e019dbda", "bundle.Articles-e019dbda", "shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae"],
    {
            ...
            const u =
                    ...
                    (d) => {
                        const {
                            ...
                            t = [];
                        return r && t.push((0, s.Z)(i, r, d, b)), 1 === u.length && u[0].type === o.ZP.Message ? t.push({ ...u[0] }) : t.push(l({ entryId: i, itemMetadata: D, items: u, sortIndex: b, displayType: e, shouldCountTowardsAdSpacing: h })), a && t.push((0, n.Z)(i, a, D, b)), t;
                    },
        ...
        929482: (e, d, a) => {
                ...
                x = ({ isLegacy: e, isWide: d }) =>
                    n.ub({
                        splice: (a) => {
                            ...
                            for (let d = 0; d < M; d += t) {
                                const a = d / t,
                                    o = l.slice(d, Math.min(M, d + t)),
                                    r = m && d + t >= M;
                                b.push(L({ entryToFocus: s?.entryToFocus, isLegacy: e, itemMetadata: i, items: o, moduleEntryId: u, numColumns: t, rowIndex: a, shouldDisplayBorder: r, sortIndex: h }));
                            }
            ...
            const F = n.ub({
                ...
                U = ({ isInSidebar: e = !1, isLegacy: d = !1, isWide: a = !1 } = Object.freeze({})) => ({ [r.ZP.TimelineModule]: _({ isLegacy: d, isWide: a }), [r.no.ModuleImpressionPlaceholder]: b.Z, [r.no.ModuleHeader]: h.Z, [r.no.ModuleFooter]: (0, D.Z)({ isInSidebar: e }), [r.no.ModuleShowMore]: (0, t.Z)({ isInSidebar: e }), [r.no.ConversationModuleGap]: i.Z, [r.no.ModuleCarouselTimeline]: u.Z, [r.no.ModuleVerticalGridList]: v.Z, [r.no.ModuleVerticalGridTimelineRow]: E.Z });
        },
        877445: (e, d, a) => {
            a.d(d, { Z: () => n });
            var o = a(351322),
        ...
        335632: (e, d, a) => {
            ...
            const M = (e) => ({
                ...
                c = ({ shouldStoreTypeaheadItem: e }) => r.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [t.Z.Hero]: M({}), [t.Z.Cell]: M({ shouldStoreTypeaheadItem: e }), [t.Z.CellWithProminentSocialContext]: M({}) } }),
                m = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.23"),
            ...
            const We = { loader: () => Promise.all([a.e("icons.23"), a.e("icons.2"), a.e("icons.10"), a.e("icons.19"), a.e("icons.24"), a.e("icons.21"), a.e("shared~loader.Typeahead~loader.AppModules~loader.DMDrawer~ondemand.HoverCard~ondemand.NotFound~bundle.AboutTh"), a.e("shared~loader.Typeahead~loader.DMDrawer~ondemand.HoverCard~bundle.ReaderMode~bundle.AudioSpacePeek~bundle.Bir"), a.e("loader.VerticalGridItemHandler")]).then(a.bind(a, 395267)), loaderKey: "topicTileLoader", strategy: l.Z.OnDemand },
                ...
                $e = ({ bookmarkFolderId: e, displayBlocked: d = !1, errorContext: a = "", hideReplyContextMode: l, isCompact: n = !1, isInSidebar: u = !1, isLegacy: t = !1, shouldSelfThreadIncludeAvatar: M = !1, shouldStoreTypeaheadItem: m, showUnsupportedTombstone: A = !1, showWithheldBannerOnMyTweets: p = !0, tweetDismissable: I = !1, withMessageGaps: f = !0, withMuteConversation: C = !1, withRemoveFromBookmarks: R = !1, withSelfThreadCTA: Z = !1, withThirdPartyCards: H = !0, withTweetActionsDisabled: O = !1, withUserPresence: L = !1 }) => ({
                    ...
                    [o.ZP.Tweet]: (0, Ke.Z)({ bookmarkFolderId: e, displayBlocked: d, dismissable: I, hideReplyContextMode: l, isCompact: n, shouldSelfThreadIncludeAvatar: M, showWithheldBannerOnMyTweets: p, shouldStoreTypeaheadItem: m, withActionsDisabled: O, withMuteConversation: C, withRemoveFromBookmarks: R, withUserPresence: L }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.VideoScreen-e019dbda.5ef9272a.js.map
