...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.VideoScreen-e019dbda", "bundle.Articles-e019dbda", "shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae"],
    {
        ...
        560520: (e, d, a) => {
            a.d(d, { Z: () => l });
            var o = a(351322);
            const r = { loader: () => Promise.all([a.e("icons.13"), a.e("icons.7"), a.e("icons.1"), a.e("icons.20"), a.e("icons.11"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("icons.25"), a.e("loader.ThreadHeaderHandler")]).then(a.bind(a, 79056)), loaderKey: "threadHeaderEntryLoader", strategy: a(509738).Z.OnDemand },
                l = o.OZ(r);
        },
        367879: (e, d, a) => {
            a.d(d, { Z: () => i });
            ...
            const u =
                    ...
                    (d) => {
                        const {
                            ...
                            b = [];
                        return r && b.push((0, s.Z)(i, r, d, c)), 1 === u.length && u[0].type === o.ZP.Message ? b.push({ ...u[0] }) : b.push(l({ entryId: i, itemMetadata: D, items: u, sortIndex: c, displayType: e, shouldCountTowardsAdSpacing: h })), a && b.push((0, n.Z)(i, a, D, c)), b;
                    },
        ...
        929482: (e, d, a) => {
                ...
                x = ({ isLegacy: e, isWide: d }) =>
                    n.ub({
                        splice: (a) => {
                            ...
                            c.push(O({ "aria-owns": M, itemMetadata: i, moduleEntryId: u, sortIndex: h }));
                            for (let d = 0; d < t; d += b) {
                                const a = d / b,
                                    o = l.slice(d, Math.min(t, d + b)),
                                    r = m && d + b >= t;
                                c.push(L({ entryToFocus: s?.entryToFocus, isLegacy: e, itemMetadata: i, items: o, moduleEntryId: u, numColumns: b, rowIndex: a, shouldDisplayBorder: r, sortIndex: h }));
                            }
            ...
            const F = n.ub({
                ...
                U = ({ isInSidebar: e = !1, isLegacy: d = !1, isWide: a = !1 } = Object.freeze({})) => ({ [r.ZP.TimelineModule]: _({ isLegacy: d, isWide: a }), [r.no.ModuleImpressionPlaceholder]: c.Z, [r.no.ModuleHeader]: h.Z, [r.no.ModuleFooter]: (0, D.Z)({ isInSidebar: e }), [r.no.ModuleShowMore]: (0, b.Z)({ isInSidebar: e }), [r.no.ConversationModuleGap]: i.Z, [r.no.ModuleCarouselTimeline]: u.Z, [r.no.ModuleVerticalGridList]: v.Z, [r.no.ModuleVerticalGridTimelineRow]: E.Z });
        },
        877445: (e, d, a) => {
            a.d(d, { Z: () => n });
            var o = a(351322),
        ...
        335632: (e, d, a) => {
            ...
            const t = (e) => ({
                ...
                M = ({ shouldStoreTypeaheadItem: e }) => r.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [b.Z.Hero]: t({}), [b.Z.Cell]: t({ shouldStoreTypeaheadItem: e }), [b.Z.CellWithProminentSocialContext]: t({}) } }),
                m = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.0"),
                            ...
                            o.useEffect(() => {
                                ...
                                return (
                                    (0, n.ZP)().then(({ LivePipeline: o }) => {
                                        if (s.current && o.isSupportedAndReady(a)) {
                                            const { teardown: a } = o.get().subscribeTopic(e, u);
                                            d = a;
                                        }
                                    }),
                                    () => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.VideoScreen-e019dbda.929be15a.js.map
