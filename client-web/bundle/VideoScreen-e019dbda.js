...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["bundle.VideoScreen-e019dbda", "bundle.Articles-e019dbda", "shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae"],
    {
        935114: (e, d, a) => {
            a.d(d, { Z: () => s });
            var o = a(732032),
        ...
        560520: (e, d, a) => {
            a.d(d, { Z: () => l });
            var o = a(351322);
            const r = { loader: () => Promise.all([a.e("icons.24"), a.e("icons.2"), a.e("icons.10"), a.e("icons.5"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("icons.4"), a.e("icons.19"), a.e("icons.14"), a.e("icons.26"), a.e("loader.ThreadHeaderHandler")]).then(a.bind(a, 79056)), loaderKey: "threadHeaderEntryLoader", strategy: a(509738).Z.OnDemand },
                l = o.OZ(r);
        },
        367879: (e, d, a) => {
            a.d(d, { Z: () => i });
            ...
            const p = ({ itemMetadata: e, moduleEntryId: d, shouldCountTowardsAdSpacing: a, sortIndex: o }) => ({ type: r.no.ModuleImpressionPlaceholder, entryId: `impressionPlaceholder-${d}`, content: P(), itemMetadata: e, shouldCountTowardsAdSpacing: a, sortIndex: o }),
                I = n.ub({
                    splice: (e, d = {}) => {
                        ...
                        u.push(p({ moduleEntryId: o, itemMetadata: { clientEventInfo: r }, shouldCountTowardsAdSpacing: n, sortIndex: s }));
                        const h = i.some((e) => e.treeDisplay);
                        return u.concat(h ? f(i, s) : k(i, D, e));
                    },
                }),
                k = (e, d, a) => {
                    const o = [],
                    ...
                    return (
                        e.forEach((n, s) => {
                            const D = 0 === s,
                                i = D ? void 0 : e[s - 1];
                            let u = !1;
                            i && i.type === r.ZP.Tweet && n.type === r.ZP.Tweet && ((u = S(i, n, d)), u && o.push(R(a, d, i.content.id)));
                            const h = { isStart: D, isEnd: s === e.length - 1, position: "descendant", showReplyContext: D || u },
                                M = n.type === r.ZP.Tweet ? C({ item: n, conversationPosition: h, conversationTreeMetadata: void 0, isFirst: D, sortIndex: l }) : T({ item: n, conversationPosition: h, sortIndex: l });
                            o.push(M);
                        }),
                        o
                    );
                    ...
                    return (
                        a.toArray().forEach((a, l) => {
                            const { conversationTreeMetadata: n, entry: s } = a,
                                ...
                                h = s.type === r.ZP.Tweet ? C({ isFirst: D, item: s, conversationPosition: u, conversationTreeMetadata: i, sortIndex: d }) : T({ item: s, conversationPosition: u, conversationTreeMetadata: i, sortIndex: d });
                            o.push(h);
                        }),
                        o
                    );
                    ...
                    n.ub({
                        splice: (a) => {
                            const {
                                ...
                                M = [];
                            M.push(p({ moduleEntryId: D, itemMetadata: a.itemMetadata, shouldCountTowardsAdSpacing: u, sortIndex: h })), r && M.push((0, N.Z)(D, r, a, h));
                            const t = e && !d ? 2 : 3,
                                c = n || s?.initialItemsCount || l.length;
                            let b = "";
                            for (let e = 0; e < c; e++) b += `verticalGridItem-${e}-${D} `;
                            const m = !!s && c < l.length;
                            M.push(O({ "aria-owns": b, itemMetadata: i, moduleEntryId: D, sortIndex: h }));
                            for (let d = 0; d < c; d += t) {
                                const a = d / t,
                                    o = l.slice(d, Math.min(c, d + t)),
                                    r = m && d + t >= c;
                                M.push(L({ entryToFocus: s?.entryToFocus, isLegacy: e, itemMetadata: i, items: o, moduleEntryId: D, numColumns: t, rowIndex: a, shouldDisplayBorder: r, sortIndex: h }));
                            }
            ...
            const F = n.ub({
                    splice: (e) => {
                        const {
                            ...
                            D = [];
                        return D.push(p({ moduleEntryId: r, itemMetadata: e.itemMetadata, shouldCountTowardsAdSpacing: n, sortIndex: s })), a && D.push((0, N.Z)(r, a, e, s)), D.push(...o.map((e) => ({ ...e, sortIndex: s, parentModuleMetadata: (0, K.Z)({}, l.moduleMetadata) }))), d && D.push((0, Z.Z)(r, d, e.itemMetadata, s)), D;
                    },
                ...
                U = ({ isInSidebar: e = !1, isLegacy: d = !1, isWide: a = !1 } = Object.freeze({})) => ({ [r.ZP.TimelineModule]: _({ isLegacy: d, isWide: a }), [r.no.ModuleImpressionPlaceholder]: M.Z, [r.no.ModuleHeader]: h.Z, [r.no.ModuleFooter]: (0, u.Z)({ isInSidebar: e }), [r.no.ModuleShowMore]: (0, t.Z)({ isInSidebar: e }), [r.no.ConversationModuleGap]: i.Z, [r.no.ModuleCarouselTimeline]: D.Z, [r.no.ModuleVerticalGridList]: v.Z, [r.no.ModuleVerticalGridTimelineRow]: E.Z });
        },
        877445: (e, d, a) => {
            a.d(d, { Z: () => n });
            var o = a(351322),
        ...
        335632: (e, d, a) => {
            ...
            const O = { loader: () => a.e("loader.newsArticleHandler").then(a.bind(a, 110045)), loaderKey: "newsCellLoader", strategy: l.Z.OnDemand },
                ...
                x = r.ov({ selectDisplayType: (e) => e.content.newsDisplayType, handlers: { [H.Z.Cell]: O, [H.Z.PreviewCard]: L } }),
                E = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.24"),
            ...
            const V = { loader: () => Promise.all([a.e("icons.29"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-c9d567be"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-7a04a44b"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-db6b2e3a"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2a74f407"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-f3039e62"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e75d887d"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-b93f71f2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-743779ef"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e851f17f"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-29ff9b73"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d622e6ad"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a"), a.e("loader.promptHandler")]).then(a.bind(a, 32694)), loaderKey: "onboardingLikesStartPromptLoader", strategy: l.Z.OnDemand },
                ...
                q = r.OZ(Q),
                J = { loader: () => a.e("loader.ScoreEventSummaryHandler").then(a.bind(a, 31917)), loaderKey: "defaultScoreEventSummaryLoader", strategy: l.Z.OnDemand },
                X = r.OZ(J);
            var ee = a(652815),
                de = a(222069);
            ...
            var ne = a(560520),
                se = a(515330);
            const De = { loader: () => Promise.all([a.e("icons.15"), a.e("icons.29"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-c9d567be"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-7a04a44b"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-db6b2e3a"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2a74f407"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-f3039e62"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e75d887d"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-b93f71f2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-743779ef"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e851f17f"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-29ff9b73"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d622e6ad"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a"), a.e("loader.TileHandler")]).then(a.bind(a, 407920)), loaderKey: "standardHandlerLoader", strategy: l.Z.OnDemand },
                ie = { loader: () => Promise.all([a.e("icons.15"), a.e("icons.29"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-c9d567be"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-7a04a44b"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-db6b2e3a"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2a74f407"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-f3039e62"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e75d887d"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-b93f71f2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-743779ef"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e851f17f"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-29ff9b73"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d622e6ad"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a"), a.e("loader.TileHandler")]).then(a.bind(a, 101298)), loaderKey: "broadcastLoader", strategy: l.Z.OnDemand },
                ue = { loader: () => Promise.all([a.e("icons.15"), a.e("icons.29"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-c9d567be"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-7a04a44b"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-db6b2e3a"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2a74f407"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-f3039e62"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e75d887d"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-b93f71f2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-743779ef"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e851f17f"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-29ff9b73"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d622e6ad"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a"), a.e("loader.TileHandler")]).then(a.bind(a, 984637)), loaderKey: "callToActionLoader", strategy: l.Z.OnDemand },
                he = { loader: () => Promise.all([a.e("icons.15"), a.e("icons.29"), a.e("modules.common-e907d115"), a.e("modules.common-e019dbda"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-c9d567be"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-7a04a44b"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-db6b2e3a"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2a74f407"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-f3039e62"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e75d887d"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-b93f71f2"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-743779ef"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e851f17f"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-29ff9b73"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d622e6ad"), a.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a"), a.e("loader.TileHandler")]).then(a.bind(a, 549323)), loaderKey: "scoreCardLoader", strategy: l.Z.OnDemand },
                Me = r.ov({ selectDisplayType: (e) => (0, F.Z)(e.content.content) || "", handlers: { [se.Y.Standard]: De, [se.Y.ScoreCard]: he, [se.Y.Broadcast]: ie, [se.Y.CallToAction]: ue } }),
                te = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.24"),
            ...
            var _e = a(269011),
                Ue = a(118101);
            const We = { loader: () => Promise.all([a.e("icons.24"), a.e("icons.2"), a.e("icons.10"), a.e("icons.15"), a.e("icons.27"), a.e("icons.12"), a.e("icons.16"), a.e("icons.5"), a.e("icons.22"), a.e("shared~loader.Typeahead~loader.AppModules~loader.DMDrawer~ondemand.HoverCard~ondemand.NotFound~bundle.AboutTh"), a.e("shared~loader.Typeahead~loader.DMDrawer~ondemand.HoverCard~bundle.ReaderMode~bundle.AudioSpacePeek~bundle.Bir"), a.e("loader.VerticalGridItemHandler")]).then(a.bind(a, 395267)), loaderKey: "topicTileLoader", strategy: l.Z.OnDemand },
                Ve = r.ov({ selectDisplayType: (e) => (0, F.Z)(e.content.content) || "", handlers: { [Ue.NA.TopicTile]: We } }),
                $e = ({ bookmarkFolderId: e, displayBlocked: d = !1, errorContext: a = "", hideReplyContextMode: l, isCompact: n = !1, isInSidebar: D = !1, isLegacy: t = !1, shouldSelfThreadIncludeAvatar: c = !1, shouldStoreTypeaheadItem: m, showUnsupportedTombstone: A = !1, showWithheldBannerOnMyTweets: P = !0, tweetDismissable: I = !1, withMessageGaps: f = !0, withMuteConversation: C = !1, withRemoveFromBookmarks: R = !1, withSelfThreadCTA: Z = !1, withThirdPartyCards: H = !0, withTweetActionsDisabled: O = !1, withUserPresence: L = !1 }) => ({
                    [o.ZP.Article]: s,
                    [o.ZP.Card]: ce,
                    ...
                    [o.ZP.Tweet]: (0, Ke.Z)({ bookmarkFolderId: e, displayBlocked: d, dismissable: I, hideReplyContextMode: l, isCompact: n, shouldSelfThreadIncludeAvatar: c, showWithheldBannerOnMyTweets: P, shouldStoreTypeaheadItem: m, withActionsDisabled: O, withMuteConversation: C, withRemoveFromBookmarks: R, withUserPresence: L }),
                    ...
                    [o.no.ModuleShowMore]: (0, pe.Z)({ isInSidebar: D }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/bundle.VideoScreen-e019dbda.f6e20daa.js.map
