        ...
        690186: (e, o, t) => {
            ...
            a("c39b0e24", "X"),
                ...
                a("b28602eb", function (e) {
                    return "Toto léto získáte " + e.percentage + "% slevu";
                }),
                a("he77d8e6", "Časově omezená nabídka"),
            ...
            a("i560665f", "Další informace"),
                ...
                a("bf970edd", function (e) {
                    return "Prohledávání  𝕏  na dotaz „" + e.query + "“";
                }),
                a("ad342369", function (e) {
                    return "Hledání dotazu „" + e.query + "“ mezi uživateli 𝕏";
                }),
                a("g008d475", function (e) {
                    return "Procházení " + e.url;
                }),
                ...
                a("j9006405", function (e) {
                    return "Prohledávání postů na  𝕏  uživatelem @" + e.username;
                }),
                a("a2dd07e5", function (e) {
                    return "Prohledávání postů na  𝕏  uživatelem @" + e.username + " na dotaz „" + e.query + "“";
                }),
                a("e99fb7a3", function (e) {
                    return "Prohledávání postů na  𝕏  uživatelem @" + e.username + " na dotaz **„" + e.query + "“**";
                }),
                a("a02d1657", function (e) {
                    return "Spuštění kódu" + e.ttc_tool_usage_card;
                }),
                a("aa9d42c0", "Vyhledávání na webu"),
                a("c731d702", "Searching on X"),
                a("d0e02476", "Searching users on X"),
                a("c43ef93e", "Prohlížení webové stránky"),
                a("dab166ec", "Searching user posts on X"),
                a("jb097f6e", "Spuštění kódu"),
                ...
                a("d6b533dc", "Ohodnotit tento překlad:"),
                a("j2f9ab6e", "Děkujeme vám za vaši zpětnou vazbu!"),
                ...
                a("ba10dab6", "Automaticky přeložil Grok"),
                a("he9c9634", "Nemůžeme načíst překlad."),
                a("j2198c98", "Skrýt přeložený post"),
                a("d4d35bea", "Překládání..."),
                a("f4f69be8", "Zobrazit originál"),
                a("e3097a5c", "Zobrazit automaticky přeložený post"),
                a("e0f81ff3", "Překlad:"),
                a("j2862695", function (e) {
                    return "Překlad z " + e.originLanguage + " od";
                }),
                a("b7cb4fab", "Překlad od"),
                a("e0bffbf8", "O automatickém překladu"),
                a("e839db3a", "Zavřít"),
                a("e7a86c77", function (e) {
                    return "Automaticky přeložit " + e.language;
                }),
                a("c60b9e5c", "Změny se projeví u nově načteného obsahu."),
                a("f9317b98", "nastavení jazyka"),
                a("hba0547a", "Nastavení se nepodařilo aktualizovat. Zkuste to znovu později."),
                ...
                a("a599bbfa", "Přidat na seznam / Odebrat ze seznamu"),
                ...
                a("g00b4c55", function (e) {
                    return "Sdílet profil @" + e.screenName + " prostřednictvím…";
                }),
            ...
            a("fc56c8b1", function (e) {
                ...
                a("b0a889d4", "Jako obrázek"),
                a("a111fb48", "Jako tabulka"),
                a("bccc65f0", "Grok se může mýlit. Vždy si ověřte původní zdroje."),
                a("bd202fe6", "Generování karty"),
                ...
                a("ha9c4cf8", "Zobrazit zdroj"),
                a("ecad5d78", "Uložit obrázek"),
                ...
                a("db6c20cf", function (e) {
                    return "Ukázat vše (" + e.count + ")";
                }),
                a("df601d92", "Relevantní uživatelé"),
                a("a4cfb8a8", "Procházení"),
            ...
            a("f19846b2", "Miniatura videa"),
                ...
                a("icdb6d74", "Navrhl experimentální přispěvatel s umělou inteligencí, který reaguje na žádosti o poznámku. Stejně jako všichni přispěvatelé, i umělá inteligence může dělat chyby – ověřte si přesnost."),
                ...
                a("j42c88b6", "Experimentální tvůrce poznámek s umělou inteligencí"),
            ...
            a("ed88e742", "Zkopírovat odkaz na téma"),
                ...
                a("f7cf3d36", "Grok je bezplatný asistent s umělou inteligencí navržený xAI pro maximalizaci pravdivosti a objektivity. Grok nabízí hledání v reálném čase, generování obrázků, analýzu trendů a další."),
                a("hc965308", "Zábava"),
                a("eb78b77e", "Režim Zábava"),
                a("ac164552", "Jít na grok.com"),
            ...
            a("b075c68a", "Upravit pracovní pozici"),
                ...
                a("dde0dbe0", "Využijte naši letní nabídku, která končí:"),
                a("f8a50ba7", function (e) {
                    return "Letní nabídka končí " + e.date + ".";
                }),
                ...
                a("ibf92e4a", "Platba proběhla úspěšně"),
                a("bdf0fb06", "Vaše předplatné bylo aktivováno."),
                a("ddfd6718", "Platba selhala"),
                a("d42fa852", "Při zpracování vaší platby nastal problém. Zkuste to prosím znovu."),
                a("g055a9ce", "Otevřít aplikaci X"),
            ...
            a("c5d9c77a", "Vypadá to, že se vyskytl drobný zádrhel. Nemějte ale obavy, není to vaše chyba. Zavřete toto okno a zkuste to znovu."),
                ...
                a("h7e1c146", "Delegované účty nejsou momentálně podporovány."),
                ...
                return (
                    ...
                    (v = [
                        ...
                        },
                        {
                            key: "c4c230bf",
                            get: function () {
                                return ["Grok bude automaticky překládat na základě vašeho použití X a ", ". Nastavení automatického překladu můžete také přepnout níže."];
                            },
                        },
                        {
                            key: "db79453f",
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/cs.16e7e6fa.js.map
