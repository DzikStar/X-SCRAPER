        ...
        690186: (e, o, t) => {
            ...
            a("b7800bec", "Propagujte nabídku pracovní pozice textem v rozsahu maximálně 200 znaků. Zobrazuje se v postech, doporučeních a vyhledávání."),
                ...
                a("dc9661b3", function (e) {
                    return e.seconds + " sekund" + n(e.seconds, "y", "", "a", "");
                }),
            ...
            v._validateParameterTypeNumber, v._validateParameterPresence;
            var l = v._numberRound,
                m = (v._numberFormat, v._numberFormatterFn),
                k = v._pluralGeneratorFn,
                b = (v._currencyNameFormat, v._currencyFormatterFn),
                f = (v._validateParameterTypeDate, v._dateToPartsFormat, v._dateToPartsFormatterFn),
                z = (v._dateFormat, v._dateFormatterFn),
                h = v._relativeTimeFormatterFn,
                j = v._unitFormatterFn;
            (v.a827863013 = m(["", , 1, 0, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("truncate"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", many: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", many: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", many: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", many: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", many: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", many: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", many: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", many: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", many: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", many: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", many: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", many: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], v("cs").pluralGenerator({}))),
                (v.b521027023 = m(["", , 1, 0, 3, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b573964695 = m(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("round"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a130957221 = m(["", , 1, 0, 0, , , , , , "", "0", "-0", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b234962737 = m(["", , 2, 0, 0, , , , , , "", "00", "-00", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1429047994 = m(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("truncate"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", many: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", many: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", many: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", many: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", many: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", many: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", many: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", many: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", many: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", many: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", many: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", many: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], v("cs").pluralGenerator({}))),
                (v.a98449830 = m(["", , 1, 0, 1, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1714886803 = m(["", , 1, 0, 0, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", l("round"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a2044652564 = m(["", , 1, 0, 1, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", l("round"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b76845684 = m(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("truncate"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", many: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", many: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", many: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", many: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", many: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", many: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", many: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", many: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", many: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", many: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", many: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", many: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], v("cs").pluralGenerator({}))),
                (v.b1919193361 = m(["", , 1, 1, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("truncate"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1307298669 = m(["", , 1, 2, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("truncate"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b800117329 = m(["", , 1, 0, 0, 1, 2, , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", many: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", many: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", many: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", many: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", many: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", many: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", many: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", many: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", many: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", many: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", many: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", many: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], v("cs").pluralGenerator({}))),
                (v.b328382886 = m(["", , 1, 2, 2, , , 0, 3, , " 'AED'", "#,##0.00 'AED'", "-#,##0.00 'AED' 'AED'", "-", " 'AED'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a109584705 = m(["", , 1, 0, 0, , , , 3, , " 'ALL'", "#,##0 'ALL'", "-#,##0 'ALL' 'ALL'", "-", " 'ALL'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a57648892 = m(["", , 1, 2, 2, , , 0, 3, , " 'ARS'", "#,##0.00 'ARS'", "-#,##0.00 'ARS' 'ARS'", "-", " 'ARS'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a100130858 = m(["", , 1, 2, 2, , , 0, 3, , " 'AU$'", "#,##0.00 'AU$'", "-#,##0.00 'AU$' 'AU$'", "-", " 'AU$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a452915880 = m(["", , 1, 2, 2, , , 0, 3, , " 'BAM'", "#,##0.00 'BAM'", "-#,##0.00 'BAM' 'BAM'", "-", " 'BAM'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a545267980 = m(["", , 1, 2, 2, , , 0, 3, , " 'BDT'", "#,##0.00 'BDT'", "-#,##0.00 'BDT' 'BDT'", "-", " 'BDT'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a625614307 = m(["", , 1, 2, 2, , , 0, 3, , " 'BGN'", "#,##0.00 'BGN'", "-#,##0.00 'BGN' 'BGN'", "-", " 'BGN'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1303494916 = m(["", , 1, 3, 3, , , 0, 3, , " 'BHD'", "#,##0.000 'BHD'", "-#,##0.000 'BHD' 'BHD'", "-", " 'BHD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1356354898 = m(["", , 1, 2, 2, , , 0, 3, , " 'R$'", "#,##0.00 'R$'", "-#,##0.00 'R$' 'R$'", "-", " 'R$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1374808475 = m(["", , 1, 0, 0, , , , 3, , " 'BYR'", "#,##0 'BYR'", "-#,##0 'BYR' 'BYR'", "-", " 'BYR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1302555200 = m(["", , 1, 2, 2, , , 0, 3, , " 'CA$'", "#,##0.00 'CA$'", "-#,##0.00 'CA$' 'CA$'", "-", " 'CA$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1534358971 = m(["", , 1, 2, 2, , , 0, 3, , " 'CHF'", "#,##0.00 'CHF'", "-#,##0.00 'CHF' 'CHF'", "-", " 'CHF'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1888286151 = m(["", , 1, 0, 0, , , , 3, , " 'CLP'", "#,##0 'CLP'", "-#,##0 'CLP' 'CLP'", "-", " 'CLP'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1793868372 = m(["", , 1, 2, 2, , , 0, 3, , " 'CN¥'", "#,##0.00 'CN¥'", "-#,##0.00 'CN¥' 'CN¥'", "-", " 'CN¥'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1974173604 = m(["", , 1, 0, 0, , , , 3, , " 'COP'", "#,##0 'COP'", "-#,##0 'COP' 'COP'", "-", " 'COP'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1341578562 = m(["", , 1, 2, 2, , , 0, 3, , " 'Kč'", "#,##0.00 'Kč'", "-#,##0.00 'Kč' 'Kč'", "-", " 'Kč'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1782599586 = m(["", , 1, 2, 2, , , 0, 3, , " 'DKK'", "#,##0.00 'DKK'", "-#,##0.00 'DKK' 'DKK'", "-", " 'DKK'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1359626968 = m(["", , 1, 2, 2, , , 0, 3, , " 'DZD'", "#,##0.00 'DZD'", "-#,##0.00 'DZD' 'DZD'", "-", " 'DZD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1004994904 = m(["", , 1, 2, 2, , , 0, 3, , " 'EGP'", "#,##0.00 'EGP'", "-#,##0.00 'EGP' 'EGP'", "-", " 'EGP'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a954662950 = m(["", , 1, 2, 2, , , 0, 3, , " '€'", "#,##0.00 '€'", "-#,##0.00 '€' '€'", "-", " '€'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1970801821 = m(["", , 1, 2, 2, , , 0, 3, , " '£'", "#,##0.00 '£'", "-#,##0.00 '£' '£'", "-", " '£'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a801412172 = m(["", , 1, 2, 2, , , 0, 3, , " 'GHS'", "#,##0.00 'GHS'", "-#,##0.00 'GHS' 'GHS'", "-", " 'GHS'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1143114942 = m(["", , 1, 2, 2, , , 0, 3, , " 'GTQ'", "#,##0.00 'GTQ'", "-#,##0.00 'GTQ' 'GTQ'", "-", " 'GTQ'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1731397819 = m(["", , 1, 2, 2, , , 0, 3, , " 'HK$'", "#,##0.00 'HK$'", "-#,##0.00 'HK$' 'HK$'", "-", " 'HK$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1967819195 = m(["", , 1, 2, 2, , , 0, 3, , " 'HRK'", "#,##0.00 'HRK'", "-#,##0.00 'HRK' 'HRK'", "-", " 'HRK'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a2049089043 = m(["", , 1, 2, 2, , , 0, 3, , " 'HUF'", "#,##0.00 'HUF'", "-#,##0.00 'HUF' 'HUF'", "-", " 'HUF'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1603812521 = m(["", , 1, 0, 0, , , , 3, , " 'IDR'", "#,##0 'IDR'", "-#,##0 'IDR' 'IDR'", "-", " 'IDR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1604031158 = m(["", , 1, 2, 2, , , 0, 3, , " 'ILS'", "#,##0.00 'ILS'", "-#,##0.00 'ILS' 'ILS'", "-", " 'ILS'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1547696377 = m(["", , 1, 2, 2, , , 0, 3, , " 'INR'", "#,##0.00 'INR'", "-#,##0.00 'INR' 'INR'", "-", " 'INR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1244562852 = m(["", , 1, 0, 0, , , , 3, , " 'IQD'", "#,##0 'IQD'", "-#,##0 'IQD' 'IQD'", "-", " 'IQD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1180839903 = m(["", , 1, 0, 0, , , , 3, , " 'ISK'", "#,##0 'ISK'", "-#,##0 'ISK' 'ISK'", "-", " 'ISK'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b296106785 = m(["", , 1, 0, 0, , , , 3, , " 'JP¥'", "#,##0 'JP¥'", "-#,##0 'JP¥' 'JP¥'", "-", " 'JP¥'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b29427853 = m(["", , 1, 2, 2, , , 0, 3, , " 'KES'", "#,##0.00 'KES'", "-#,##0.00 'KES' 'KES'", "-", " 'KES'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1305204137 = m(["", , 1, 0, 0, , , , 3, , " '₩'", "#,##0 '₩'", "-#,##0 '₩' '₩'", "-", " '₩'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1476459114 = m(["", , 1, 3, 3, , , 0, 3, , " 'KWD'", "#,##0.000 'KWD'", "-#,##0.000 'KWD' 'KWD'", "-", " 'KWD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a572707839 = m(["", , 1, 2, 2, , , 0, 3, , " 'KZT'", "#,##0.00 'KZT'", "-#,##0.00 'KZT' 'KZT'", "-", " 'KZT'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a999593178 = m(["", , 1, 0, 0, , , , 3, , " 'LBP'", "#,##0 'LBP'", "-#,##0 'LBP' 'LBP'", "-", " 'LBP'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1617210090 = m(["", , 1, 2, 2, , , 0, 3, , " 'MAD'", "#,##0.00 'MAD'", "-#,##0.00 'MAD' 'MAD'", "-", " 'MAD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1903501600 = m(["", , 1, 2, 2, , , 0, 3, , " 'MKD'", "#,##0.00 'MKD'", "-#,##0.00 'MKD' 'MKD'", "-", " 'MKD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b2048839405 = m(["", , 1, 2, 2, , , 0, 3, , " 'MX$'", "#,##0.00 'MX$'", "-#,##0.00 'MX$' 'MX$'", "-", " 'MX$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1977728288 = m(["", , 1, 2, 2, , , 0, 3, , " 'MYR'", "#,##0.00 'MYR'", "-#,##0.00 'MYR' 'MYR'", "-", " 'MYR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1609243409 = m(["", , 1, 2, 2, , , 0, 3, , " 'NGN'", "#,##0.00 'NGN'", "-#,##0.00 'NGN' 'NGN'", "-", " 'NGN'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1382980764 = m(["", , 1, 2, 2, , , 0, 3, , " 'NOK'", "#,##0.00 'NOK'", "-#,##0.00 'NOK' 'NOK'", "-", " 'NOK'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1104077422 = m(["", , 1, 2, 2, , , 0, 3, , " 'NZ$'", "#,##0.00 'NZ$'", "-#,##0.00 'NZ$' 'NZ$'", "-", " 'NZ$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a108505651 = m(["", , 1, 2, 2, , , 0, 3, , " 'PEN'", "#,##0.00 'PEN'", "-#,##0.00 'PEN' 'PEN'", "-", " 'PEN'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a196240146 = m(["", , 1, 2, 2, , , 0, 3, , " 'PHP'", "#,##0.00 'PHP'", "-#,##0.00 'PHP' 'PHP'", "-", " 'PHP'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a514150007 = m(["", , 1, 0, 0, , , , 3, , " 'PKR'", "#,##0 'PKR'", "-#,##0 'PKR' 'PKR'", "-", " 'PKR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a308909708 = m(["", , 1, 2, 2, , , 0, 3, , " 'PLN'", "#,##0.00 'PLN'", "-#,##0.00 'PLN' 'PLN'", "-", " 'PLN'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a885186812 = m(["", , 1, 2, 2, , , 0, 3, , " 'QAR'", "#,##0.00 'QAR'", "-#,##0.00 'QAR' 'QAR'", "-", " 'QAR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b2125162773 = m(["", , 1, 2, 2, , , 0, 3, , " 'RON'", "#,##0.00 'RON'", "-#,##0.00 'RON' 'RON'", "-", " 'RON'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1789706013 = m(["", , 1, 0, 0, , , , 3, , " 'RSD'", "#,##0 'RSD'", "-#,##0 'RSD' 'RSD'", "-", " 'RSD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1964470119 = m(["", , 1, 2, 2, , , 0, 3, , " 'RUB'", "#,##0.00 'RUB'", "-#,##0.00 'RUB' 'RUB'", "-", " 'RUB'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1634773122 = m(["", , 1, 2, 2, , , 0, 3, , " 'SAR'", "#,##0.00 'SAR'", "-#,##0.00 'SAR' 'SAR'", "-", " 'SAR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1526721165 = m(["", , 1, 2, 2, , , 0, 3, , " 'SEK'", "#,##0.00 'SEK'", "-#,##0.00 'SEK' 'SEK'", "-", " 'SEK'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1475927510 = m(["", , 1, 2, 2, , , 0, 3, , " 'SGD'", "#,##0.00 'SGD'", "-#,##0.00 'SGD' 'SGD'", "-", " 'SGD'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b561641720 = m(["", , 1, 2, 2, , , 0, 3, , " 'THB'", "#,##0.00 'THB'", "-#,##0.00 'THB' 'THB'", "-", " 'THB'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1958444360 = m(["", , 1, 3, 3, , , 0, 3, , " 'TND'", "#,##0.000 'TND'", "-#,##0.000 'TND' 'TND'", "-", " 'TND'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b254109227 = m(["", , 1, 2, 2, , , 0, 3, , " 'TRY'", "#,##0.00 'TRY'", "-#,##0.00 'TRY' 'TRY'", "-", " 'TRY'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b1275852328 = m(["", , 1, 2, 2, , , 0, 3, , " 'NT$'", "#,##0.00 'NT$'", "-#,##0.00 'NT$' 'NT$'", "-", " 'NT$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a199558221 = m(["", , 1, 0, 0, , , , 3, , " 'TZS'", "#,##0 'TZS'", "-#,##0 'TZS' 'TZS'", "-", " 'TZS'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a130999030 = m(["", , 1, 2, 2, , , 0, 3, , " 'UAH'", "#,##0.00 'UAH'", "-#,##0.00 'UAH' 'UAH'", "-", " 'UAH'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a547725638 = m(["", , 1, 0, 0, , , , 3, , " 'UGX'", "#,##0 'UGX'", "-#,##0 'UGX' 'UGX'", "-", " 'UGX'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a613076992 = m(["", , 1, 2, 2, , , 0, 3, , " 'US$'", "#,##0.00 'US$'", "-#,##0.00 'US$' 'US$'", "-", " 'US$'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1131172273 = m(["", , 1, 2, 2, , , 0, 3, , " 'VEF'", "#,##0.00 'VEF'", "-#,##0.00 'VEF' 'VEF'", "-", " 'VEF'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1617162956 = m(["", , 1, 0, 0, , , , 3, , " 'VND'", "#,##0 'VND'", "-#,##0 'VND' 'VND'", "-", " 'VND'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a282785349 = m(["", , 1, 2, 2, , , 0, 3, , " 'ZAR'", "#,##0.00 'ZAR'", "-#,##0.00 'ZAR' 'ZAR'", "-", " 'ZAR'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a630952766 = m(["", , 1, 2, 2, , , 0, 3, , " 'ZMW'", "#,##0.00 'ZMW'", "-#,##0.00 'ZMW' 'ZMW'", "-", " 'ZMW'", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.b573308511 = m(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1173513924 = m(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", many: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", many: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", many: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", many: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", many: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", many: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", many: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", many: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", many: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", many: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", many: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", many: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], v("cs").pluralGenerator({}))),
                (v.a618782214 = m(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l(), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", many: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", many: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", many: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", many: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", many: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", many: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", many: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", many: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", many: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", many: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", many: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", many: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], v("cs").pluralGenerator({}))),
                (v.a1114979047 = m(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", l("round"), "∞", "NaN", { ".": ",", ",": " ", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (v.a1609705439 = k(function (e) {
                    var o = String(e).split("."),
                        t = o[0],
                        a = !o[1];
                    return 1 == e && a ? "one" : t >= 2 && t <= 4 && a ? "few" : a ? "other" : "many";
                })),
                (v.b1912819999 = b(v("cs").numberFormatter({ raw: "#,##0.00 'AED'" }))),
                (v.a233771680 = b(v("cs").numberFormatter({ raw: "#,##0 'ALL'" }))),
                (v.a1464230527 = b(v("cs").numberFormatter({ raw: "#,##0.00 'ARS'" }))),
                (v.b597662991 = b(v("cs").numberFormatter({ raw: "#,##0.00 'AU$'" }))),
                (v.a832605267 = b(v("cs").numberFormatter({ raw: "#,##0.00 'BAM'" }))),
                (v.b599446929 = b(v("cs").numberFormatter({ raw: "#,##0.00 'BDT'" }))),
                (v.a1891289208 = b(v("cs").numberFormatter({ raw: "#,##0.00 'BGN'" }))),
                (v.b1802465917 = b(v("cs").numberFormatter({ raw: "#,##0.000 'BHD'" }))),
                (v.b1288330491 = b(v("cs").numberFormatter({ raw: "#,##0.00 'R$'" }))),
                (v.a801002886 = b(v("cs").numberFormatter({ raw: "#,##0 'BYR'" }))),
                (v.b1977214053 = b(v("cs").numberFormatter({ raw: "#,##0.00 'CA$'" }))),
                (v.b2397280 = b(v("cs").numberFormatter({ raw: "#,##0.00 'CHF'" }))),
                (v.b461058342 = b(v("cs").numberFormatter({ raw: "#,##0 'CLP'" }))),
                (v.a1571611379 = b(v("cs").numberFormatter({ raw: "#,##0.00 'CN¥'" }))),
                (v.b2093514595 = b(v("cs").numberFormatter({ raw: "#,##0 'COP'" }))),
                (v.b1064054451 = b(v("cs").numberFormatter({ raw: "#,##0.00 'Kč'" }))),
                (v.a251102557 = b(v("cs").numberFormatter({ raw: "#,##0.00 'DKK'" }))),
                (v.a478351827 = b(v("cs").numberFormatter({ raw: "#,##0.00 'DZD'" }))),
                (v.b1412956077 = b(v("cs").numberFormatter({ raw: "#,##0.00 'EGP'" }))),
                (v.b1815548129 = b(v("cs").numberFormatter({ raw: "#,##0.00 '€'" }))),
                (v.a1930113484 = b(v("cs").numberFormatter({ raw: "#,##0.00 '£'" }))),
                (v.b1248911569 = b(v("cs").numberFormatter({ raw: "#,##0.00 'GHS'" }))),
                (v.a753939709 = b(v("cs").numberFormatter({ raw: "#,##0.00 'GTQ'" }))),
                (v.b1567994752 = b(v("cs").numberFormatter({ raw: "#,##0.00 'HK$'" }))),
                (v.a549967776 = b(v("cs").numberFormatter({ raw: "#,##0.00 'HRK'" }))),
                (v.b1225634232 = b(v("cs").numberFormatter({ raw: "#,##0.00 'HUF'" }))),
                (v.b1341934774 = b(v("cs").numberFormatter({ raw: "#,##0 'IDR'" }))),
                (v.a1491756529 = b(v("cs").numberFormatter({ raw: "#,##0.00 'ILS'" }))),
                (v.b1056832556 = b(v("cs").numberFormatter({ raw: "#,##0.00 'INR'" }))),
                (v.a1204870373 = b(v("cs").numberFormatter({ raw: "#,##0 'IQD'" }))),
                (v.b1114685504 = b(v("cs").numberFormatter({ raw: "#,##0 'ISK'" }))),
                (v.b1633578098 = b(v("cs").numberFormatter({ raw: "#,##0 'JP¥'" }))),
                (v.b1235148568 = b(v("cs").numberFormatter({ raw: "#,##0.00 'KES'" }))),
                (v.a1826981297 = b(v("cs").numberFormatter({ raw: "#,##0 '₩'" }))),
                (v.a1425578537 = b(v("cs").numberFormatter({ raw: "#,##0.000 'KWD'" }))),
                (v.a251188700 = b(v("cs").numberFormatter({ raw: "#,##0.00 'KZT'" }))),
                (v.a2054230567 = b(v("cs").numberFormatter({ raw: "#,##0 'LBP'" }))),
                (v.b1728979887 = b(v("cs").numberFormatter({ raw: "#,##0.00 'MAD'" }))),
                (v.b1443877669 = b(v("cs").numberFormatter({ raw: "#,##0.00 'MKD'" }))),
                (v.a1790027102 = b(v("cs").numberFormatter({ raw: "#,##0.00 'MX$'" }))),
                (v.b1502919909 = b(v("cs").numberFormatter({ raw: "#,##0.00 'MYR'" }))),
                (v.a1330176748 = b(v("cs").numberFormatter({ raw: "#,##0.00 'NGN'" }))),
                (v.b245615849 = b(v("cs").numberFormatter({ raw: "#,##0.00 'NOK'" }))),
                (v.a726585993 = b(v("cs").numberFormatter({ raw: "#,##0.00 'NZ$'" }))),
                (v.b1254177240 = b(v("cs").numberFormatter({ raw: "#,##0.00 'PEN'" }))),
                (v.a1465592105 = b(v("cs").numberFormatter({ raw: "#,##0.00 'PHP'" }))),
                (v.b109605846 = b(v("cs").numberFormatter({ raw: "#,##0 'PKR'" }))),
                (v.a663381231 = b(v("cs").numberFormatter({ raw: "#,##0.00 'PLN'" }))),
                (v.a1348102271 = b(v("cs").numberFormatter({ raw: "#,##0.00 'QAR'" }))),
                (v.b1778421648 = b(v("cs").numberFormatter({ raw: "#,##0.00 'RON'" }))),
                (v.a1485301566 = b(v("cs").numberFormatter({ raw: "#,##0 'RSD'" }))),
                (v.b1091916670 = b(v("cs").numberFormatter({ raw: "#,##0.00 'RUB'" }))),
                (v.a538755645 = b(v("cs").numberFormatter({ raw: "#,##0.00 'SAR'" }))),
                (v.b406600984 = b(v("cs").numberFormatter({ raw: "#,##0.00 'SEK'" }))),
                (v.a1168002321 = b(v("cs").numberFormatter({ raw: "#,##0.00 'SGD'" }))),
                (v.b553909261 = b(v("cs").numberFormatter({ raw: "#,##0.00 'THB'" }))),
                (v.a533403831 = b(v("cs").numberFormatter({ raw: "#,##0.000 'TND'" }))),
                (v.a389663430 = b(v("cs").numberFormatter({ raw: "#,##0.00 'TRY'" }))),
                (v.b68997632 = b(v("cs").numberFormatter({ raw: "#,##0.00 'NT$'" }))),
                (v.b1272016620 = b(v("cs").numberFormatter({ raw: "#,##0 'TZS'" }))),
                (v.b556882491 = b(v("cs").numberFormatter({ raw: "#,##0.00 'UAH'" }))),
                (v.a931238715 = b(v("cs").numberFormatter({ raw: "#,##0 'UGX'" }))),
                (v.b1876202021 = b(v("cs").numberFormatter({ raw: "#,##0.00 'US$'" }))),
                (v.a383716970 = b(v("cs").numberFormatter({ raw: "#,##0.00 'VEF'" }))),
                (v.b275942795 = b(v("cs").numberFormatter({ raw: "#,##0 'VND'" }))),
                (v.b146473898 = b(v("cs").numberFormatter({ raw: "#,##0.00 'ZAR'" }))),
                (v.a2056781437 = b(v("cs").numberFormatter({ raw: "#,##0.00 'ZMW'" }))),
                (v.a1474917837 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "d. M.", timeSeparator: ":" })),
                (v.a2127662256 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "d. M. y", timeSeparator: ":" })),
                (v.a1698889183 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "h:mm a", timeSeparator: ":", dayPeriods: { am: "dop.", pm: "odp." } })),
                (v.b1548936620 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "E d. M.", timeSeparator: ":", days: { E: { 1: { sun: "ne", mon: "po", tue: "út", wed: "st", thu: "čt", fri: "pá", sat: "so" } } } })),
                (v.a1506271185 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "E d. M. y", timeSeparator: ":", days: { E: { 1: { sun: "ne", mon: "po", tue: "út", wed: "st", thu: "čt", fri: "pá", sat: "so" } } } })),
                (v.b1541548452 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "d. MMMM", timeSeparator: ":", months: { M: { 4: { 1: "ledna", 2: "února", 3: "března", 4: "dubna", 5: "května", 6: "června", 7: "července", 8: "srpna", 9: "září", 10: "října", 11: "listopadu", 12: "prosince" } } } })),
                (v.b1007751626 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "d. MMMM y H:mm:ss z", timeSeparator: ":", months: { M: { 4: { 1: "ledna", 2: "února", 3: "března", 4: "dubna", 5: "května", 6: "června", 7: "července", 8: "srpna", 9: "září", 10: "října", 11: "listopadu", 12: "prosince" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: ["+H;-H", "+H:mm;-H:mm"] })),
                (v.a343112203 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "d. M. y h:mm a", timeSeparator: ":", dayPeriods: { am: "dop.", pm: "odp." } })),
                (v.a314787369 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "d. MMMM y", timeSeparator: ":", months: { M: { 4: { 1: "ledna", 2: "února", 3: "března", 4: "dubna", 5: "května", 6: "června", 7: "července", 8: "srpna", 9: "září", 10: "října", 11: "listopadu", 12: "prosince" } } } })),
                (v.a120950760 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "d. M. h:mm a", timeSeparator: ":", dayPeriods: { am: "dop.", pm: "odp." } })),
                (v.b1393169789 = f({ 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "dd.MM.yy", timeSeparator: ":" })),
                (v.a193787367 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "y", timeSeparator: ":" })),
                (v.a1869688944 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "LLLL y", timeSeparator: ":", months: { L: { 4: { 1: "leden", 2: "únor", 3: "březen", 4: "duben", 5: "květen", 6: "červen", 7: "červenec", 8: "srpen", 9: "září", 10: "říjen", 11: "listopad", 12: "prosinec" } } } })),
                (v.b1867729597 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "EEEE d. MMMM y H:mm:ss zzzz", timeSeparator: ":", days: { E: { 4: { sun: "neděle", mon: "pondělí", tue: "úterý", wed: "středa", thu: "čtvrtek", fri: "pátek", sat: "sobota" } } }, months: { M: { 4: { 1: "ledna", 2: "února", 3: "března", 4: "dubna", 5: "května", 6: "června", 7: "července", 8: "srpna", 9: "září", 10: "října", 11: "listopadu", 12: "prosince" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: "+HH:mm;-HH:mm" })),
                (v.a5886621 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "d. M. y H:mm:ss", timeSeparator: ":" })),
                (v.b2146064057 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "dd. MM. y", timeSeparator: ":" })),
                (v.b737825276 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "H:mm", timeSeparator: ":" })),
                (v.a121467190 = f({ 1: v("cs").numberFormatter({ raw: "0" }), 2: v("cs").numberFormatter({ raw: "00" }) }, { pattern: "E h:mm a", timeSeparator: ":", days: { E: { 1: { sun: "ne", mon: "po", tue: "út", wed: "st", thu: "čt", fri: "pá", sat: "so" } } }, dayPeriods: { am: "dop.", pm: "odp." } })),
                (v.a2126977063 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "LLLL y", timeSeparator: ":", months: { L: { 4: { 1: "leden", 2: "únor", 3: "březen", 4: "duben", 5: "květen", 6: "červen", 7: "červenec", 8: "srpen", 9: "září", 10: "říjen", 11: "listopad", 12: "prosinec" } } } })),
                (v.b1567489212 = f({}, { pattern: "cccc", timeSeparator: ":", days: { c: { 4: { sun: "neděle", mon: "pondělí", tue: "úterý", wed: "středa", thu: "čtvrtek", fri: "pátek", sat: "sobota" } } } })),
                (v.b344458800 = f({ 1: v("cs").numberFormatter({ raw: "0" }) }, { pattern: "d. M. y", timeSeparator: ":" })),
                (v.a1474232644 = f({}, { pattern: "LLLL", timeSeparator: ":", months: { L: { 4: { 1: "leden", 2: "únor", 3: "březen", 4: "duben", 5: "květen", 6: "červen", 7: "červenec", 8: "srpen", 9: "září", 10: "říjen", 11: "listopad", 12: "prosinec" } } } })),
                (v.a1083510756 = z(v("cs").dateToPartsFormatter({ skeleton: "MMMd" }))),
                (v.b1416022663 = z(v("cs").dateToPartsFormatter({ skeleton: "yMMMd" }))),
                (v.a862728630 = z(v("cs").dateToPartsFormatter({ skeleton: "hm" }))),
                (v.b797654243 = z(v("cs").dateToPartsFormatter({ skeleton: "MMMEd" }))),
                (v.b973778904 = z(v("cs").dateToPartsFormatter({ skeleton: "yMMMEd" }))),
                (v.b790266075 = z(v("cs").dateToPartsFormatter({ skeleton: "MMMMd" }))),
                (v.b1399158707 = z(v("cs").dateToPartsFormatter({ datetime: "long" }))),
                (v.a770970772 = z(v("cs").dateToPartsFormatter({ skeleton: "yMMMdhm" }))),
                (v.a1216709568 = z(v("cs").dateToPartsFormatter({ date: "long" }))),
                (v.a1935867967 = z(v("cs").dateToPartsFormatter({ skeleton: "MMMdhm" }))),
                (v.a796614604 = z(v("cs").dateToPartsFormatter({ date: "short" }))),
                (v.b1911395536 = z(v("cs").dateToPartsFormatter({ skeleton: "y" }))),
                (v.a1478281863 = z(v("cs").dateToPartsFormatter({ skeleton: "yMMM" }))),
                (v.a2035830618 = z(v("cs").dateToPartsFormatter({ datetime: "full" }))),
                (v.a1820803828 = z(v("cs").dateToPartsFormatter({ datetime: "medium" }))),
                (v.b1394781680 = z(v("cs").dateToPartsFormatter({ skeleton: "yMMdd" }))),
                (v.a1451959117 = z(v("cs").dateToPartsFormatter({ time: "short" }))),
                (v.b29706177 = z(v("cs").dateToPartsFormatter({ skeleton: "Ehm" }))),
                (v.b1416707856 = z(v("cs").dateToPartsFormatter({ skeleton: "yMMMM" }))),
                (v.b1958896293 = z(v("cs").dateToPartsFormatter({ skeleton: "EEEE" }))),
                (v.b1180619353 = z(v("cs").dateToPartsFormatter({ date: "medium" }))),
                (v.a1082825563 = z(v("cs").dateToPartsFormatter({ skeleton: "MMMM" }))),
                (v.b1340149059 = h(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { "relativeTime-type-future": { "relativeTimePattern-count-one": "za {0} den", "relativeTimePattern-count-few": "za {0} dny", "relativeTimePattern-count-many": "za {0} dne", "relativeTimePattern-count-other": "za {0} dní" }, "relativeTime-type-past": { "relativeTimePattern-count-one": "před {0} dnem", "relativeTimePattern-count-few": "před {0} dny", "relativeTimePattern-count-many": "před {0} dne", "relativeTimePattern-count-other": "před {0} dny" }, "relative-type--2": "předevčírem", "relative-type--1": "včera", "relative-type-0": "dnes", "relative-type-1": "zítra", "relative-type-2": "pozítří" })),
                (v.b1161681758 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "sekundy", one: "{0} sekunda", few: "{0} sekundy", many: "{0} sekundy", other: "{0} sekund", perUnitPattern: "{0} za sekundu" } })),
                (v.a1246322242 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "minuty", one: "{0} minuta", few: "{0} minuty", many: "{0} minuty", other: "{0} minut", perUnitPattern: "{0} za minutu" } })),
                (v.a319849810 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "hodiny", one: "{0} hodina", few: "{0} hodiny", many: "{0} hodiny", other: "{0} hodin", perUnitPattern: "{0} za hodinu" } })),
                (v.a2006692707 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", many: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (v.a1111164163 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "m", one: "{0} m", few: "{0} m", many: "{0} m", other: "{0} m", perUnitPattern: "{0}/m" } })),
                (v.b170612717 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "h", one: "{0} h", few: "{0} h", many: "{0} h", other: "{0} h", perUnitPattern: "{0}/h" } })),
                (v.a1394316209 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "d", one: "{0} d", few: "{0} d", many: "{0} d", other: "{0} d", perUnitPattern: "{0}/d" } })),
                (v.a1975107696 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "dny", one: "{0} den", few: "{0} dny", many: "{0} dne", other: "{0} dní", perUnitPattern: "{0} za den" } })),
                (v.b499082283 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "m", one: "{0} m", few: "{0} m", many: "{0} m", other: "{0} m", perUnitPattern: "{0}/měs." } })),
                (v.b703954540 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "měsíce", one: "{0} měsíc", few: "{0} měsíce", many: "{0} měsíce", other: "{0} měsíců", perUnitPattern: "{0} za měsíc" } })),
                (v.a1233949676 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "r", one: "{0} r", few: "{0} r", many: "{0} r", other: "{0} r", perUnitPattern: "{0}/r" } })),
                (v.a1800639339 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "roky", one: "{0} rok", few: "{0} roky", many: "{0} roku", other: "{0} let", perUnitPattern: "{0} za rok" } })),
                (v.a80927530 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", many: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (v.a1714607498 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "min", one: "{0} min", few: "{0} min", many: "{0} min", other: "{0} min", perUnitPattern: "{0}/min" } })),
                (v.b1236234118 = j(v("cs").numberFormatter({}), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "h", one: "{0} h", few: "{0} h", many: "{0} h", other: "{0} h", perUnitPattern: "{0}/h" } })),
                (v.b20266801 = j(v("cs").numberFormatter({ minimumFractionDigits: 1, maximumFractionDigits: 1, round: "truncate" }), v("cs").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", many: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                a("d58baa7f", v.a827863013),
                a("ia24dc8d", v.b521027023),
                a("iab73d4b", v.b573964695),
                a("i3b7a017", v.b1161681758),
                a("ie5d110f", v.a1246322242),
                a("df5f11b3", v.a319849810),
                a("e8733ed9", v.a2006692707),
                a("be59d8c3", v.a1111164163),
                a("i3d087db", v.b170612717),
                a("ga8d18c9", v.a1394316209),
                a("a91e7d49", v.a1975107696),
                a("id952a69", v.b499082283),
                a("ga09ab65", v.b703954540),
                a("c83b901d", v.a1233949676),
                a("a55b9fed", v.a1800639339),
                a("ccaa970f", v.a1083510756),
                a("jade381b", v.b1416022663),
                a("d725a289", v.a862728630),
                a("g08cbabb", v.b1429047994),
                a("c333da63", v.b1340149059),
                a("h8054d91", v.b797654243),
                a("i61fef37", v.a80927530),
                a("ba705e27", v.a1714607498),
                a("j86b0d8d", v.b1236234118),
                a("f668e929", v.a98449830),
                a("i2785009", v.a1714886803),
                a("c778d80b", v.a2044652564),
                a("e8d93005", v.b76845684),
                a("d46781af", v.b20266801),
                a("ba316f05", v.b1919193361),
                a("c0bdd345", v.a1307298669),
                a("aa2aa1a1", v.b973778904),
                a("da44942d", v.b790266075),
                a("a54d3ef5", v.b1399158707),
                a("bfbc051d", v.a770970772),
                a("ba2e82a1", v.a1216709568),
                a("fc209bb7", v.a1935867967),
                a("cf8abf59", v.b800117329),
                a("a9f397f3", v.a796614604),
                a("d857e44d", v.b1912819999),
                a("cb87e3db", v.a233771680),
                a("a9d5ffd1", v.a1464230527),
                a("a0e8371d", v.b597662991),
                a("gcc50dc9", v.a832605267),
                a("a6a43585", v.b599446929),
                a("a0cc8f2d", v.a1891289208),
                a("i31c32c5", v.b1802465917),
                a("i7dc69e9", v.b1288330491),
                a("c14a6c03", v.a801002886),
                a("jaa3d537", v.b1977214053),
                a("a824080b", v.b2397280),
                a("d9c0bedb", v.b461058342),
                a("bf8c0613", v.a1571611379),
                a("i8163625", v.b2093514595),
                a("adb53ba1", v.b1064054451),
                a("iabf697d", v.a251102557),
                a("a1a0555b", v.a478351827),
                a("f266f3d9", v.b1412956077),
                a("a9a8652b", v.b1815548129),
                a("dbf40761", v.a1930113484),
                a("b0d993d9", v.b1248911569),
                a("ac1308e1", v.a753939709),
                a("a7889ab3", v.b1567994752),
                a("c614f5cd", v.a549967776),
                a("i55d57e3", v.b1225634232),
                a("e4b6002b", v.b1341934774),
                a("d28e983b", v.a1491756529),
                a("e8c9232d", v.b1056832556),
                a("c8994ae1", v.a1204870373),
                a("f821c2a5", v.b1114685504),
                a("j348b9c9", v.b1633578098),
                a("i6f93b9b", v.b1235148568),
                a("c6150bd5", v.a1826981297),
                a("i8921e09", v.a1425578537),
                a("ef239279", v.a251188700),
                a("hecdb149", v.a2054230567),
                a("fdd039b7", v.b1728979887),
                a("f30c2c37", v.b1443877669),
                a("d9ea7bff", v.a1790027102),
                a("ea3df4b7", v.b1502919909),
                a("jaac21bb", v.a1330176748),
                a("hb435ced", v.b245615849),
                a("ce699d81", v.a726585993),
                a("bc56d3d7", v.b1254177240),
                a("f8561913", v.a1465592105),
                a("g6485d53", v.b109605846),
                a("ff561cc1", v.a663381231),
                a("b42011d3", v.a1348102271),
                a("a6660bcd", v.b1778421648),
                a("f9b80449", v.a1485301566),
                a("gdee4d5d", v.b1091916670),
                a("h36f2103", v.a538755645),
                a("a19ad037", v.b406600984),
                a("g713f699", v.a1168002321),
                a("ff2e39af", v.b553909261),
                a("be34316d", v.a533403831),
                a("aef81b75", v.a389663430),
                a("fcce70a5", v.b68997632),
                a("jc9d352f", v.b1272016620),
                a("be1cb8c5", v.b556882491),
                a("j9371501", v.a931238715),
                a("j7d4397d", v.b1876202021),
                a("d61441dd", v.a383716970),
                a("e2a99e97", v.b275942795),
                a("f7ce19ab", v.b146473898),
                a("b2a0213f", v.a2056781437),
                a("d7d71245", v.b1911395536),
                a("a2f2faab", v.a1478281863),
                a("g8d1b99b", v.a2035830618),
                a("d0a77c9b", v.a1820803828),
                a("e18e399b", v.b1394781680),
                a("b6ca7bcb", v.a1451959117),
                a("h0e4cdf5", v.b29706177),
                a("g727ddcf", v.b1416707856),
                a("f3b9b9a7", v.b1958896293),
                a("h3629783", v.b1180619353),
                a("a20c68af", v.a1082825563),
                a("ja781451", v.b573308511),
                a("cfa1a7b9", v.a1173513924),
                a("eefcd267", v.a618782214),
                a("fa8afc43", v.a1114979047);
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/cs.20effe2a.js.map
