...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["i18n/da"],
    {
        154736: (e, r, n) => {
            ...
            function d(e, r, n) {
                return "one" == ((t = e), (i = !String(t).split(".")[1]), 1 == t && i ? "one" : "other") ? r : n;
                var t, i;
            }
            t("c39b0e24", "X"),
                t("jb38600c", "Ingen"),
            ...
            t("e3275464", "Send"),
                ...
                t("acb2baa0", "Skab billeder"),
                t("fe9ad897", function (e) {
                    return "Rediger billede" + e.ttc_grok_preset;
                }),
                t("h30fd372", "Prøv Stemme-tilstand"),
            ...
            t("ed99baea", "Tidlig beta-adgang"),
                ...
                t("a67ed4d6", "Du har nået grænsen for at tilføje noter til denne forfatters posts for nu"),
                t("ic484166", "For at opretholde en høj notekvalitet og forhindre spam er der en grænse for, hvor mange noter man kan skrive om en bestemt indlægsforfatter i en given tidsperiode. Grænsen er baseret på, hvor nyttige folk har fundet ens tidligere noter om den pågældende forfatter. Prøv igen senere."),
                ...
                t("b8719c22", "Hjælp med at finde ud af, om folk med forskellige perspektiver har liket posts."),
                t("jcdf97d4", "Hvad kan du lide ved denne post?"),
                t("d4d7b67e", "Hvad kan du ikke lide ved denne post?"),
                t("ed5156fa", "Der opstod en fejl under lagring af din bedømmelse. Prøv igen."),
                t("d0ed3636", "Du har bedømt denne post"),
                ...
                t("d0b29562", "Bedøm flere posts nu"),
                t("i36ea87a", "Jeg er enig med den"),
                t("d5befc34", "Jeg har lært noget interessant"),
                t("je26ecf2", "Den har en vigtig pointe"),
                t("e4e331aa", "Den er samlende omkring et emne, der ofte er polariserende"),
                t("ed61ff2a", "Den er hjerteligt eller rørende"),
                t("gc3104d8", "Den er inspirerende eller spændende"),
                t("j8c4400e", "Den er sjov"),
                t("j4738406", "Der er ikke noget, jeg kan lide ved den"),
                t("d93d1666", "Jeg er ikke enig med den"),
                t("d6130466", "Der er intet meningsfuldt indhold i den"),
                t("d96835b6", "Den interesserer mig ikke"),
                t("b7ba4150", "Der er ikke noget, jeg ikke kan lide ved den"),
            ...
            t("h18f86a4", "Slet mappe"),
                ...
                t("h707b180", "Opdatering af dit abonnement er fuldført"),
            ...
            t("f4d07bd2", "Inkluder valgfrie oplysninger for at gøre det lettere for ansøgere at finde dine stillinger med søgning."),
                ...
                t("e9334fe6", "Data opdateres med få minutters mellemrum"),
                t("a6d7b1d0", "Baseret på interne data af X"),
                t("h71a00e6", "Du sparer tid med annoncefri"),
                t("f6c50ec0", "Din reklamefri prøveperiode er slut"),
                t("e1d1fbca", "Du har undgået"),
                t("a82d7abd", function (e) {
                    return e.numberOfAds + " annoncer";
                }),
                t("ff074c76", "Du ser flere af de posts, du ønsker."),
                t("cbc38428", "Forbliv annoncefri med Premium+"),
                t("b9028f60", "Tilbage til min annoncefri prøveperiode"),
                t("e081d6a0", "Nej tak, jeg vil gerne se annoncer igen"),
                t("fee73dca", "Sparer skønsmæssigt"),
                t("ic073e4e", "Din tid er dyrebar."),
                t("eb866e88", "Anslået 1-årig tidsbesparelse"),
                t("ce72f092", "Baseret på din hidtidige brug."),
                ...
                t("cc10f019", function (e) {
                    return e.minutes + " minut" + i(e.minutes, "", "ter");
                }),
                t("f9b6b7d3", function (e) {
                    return e.hours + " time" + i(e.hours, "", "r");
                }),
                t("a9af8753", function (e) {
                    return e.days + " dag" + i(e.days, "", "e") + ", " + e.hours + " time" + i(e.hours, "", "r");
                }),
                t("b93d00e5", function (e) {
                    return e.days + " dag" + i(e.days, "", "e");
                }),
                t("dc9661b3", function (e) {
                    return e.seconds + " second" + d(e.seconds, "", "s");
                }),
                t("g2c63852", "100% gratis. Der kræves ikke noget kreditkort."),
                t("be88be23", function (e) {
                    return "Din " + e.durationInDays + " dages annoncefri prøveperiode er aktiveret";
                }),
                t("b63766a6", "Rul videre uden annoncer"),
                t("h028f7e0", "Brug mere tid på det indhold, du elsker"),
                t("dd68eef6", "Oplev Premium+ luksuslivet"),
                t("g8a2f217", function (e) {
                    return "Nyd uden annoncer for " + e.durationInDays + " dage";
                }),
                ...
                t("de8bcdaa", "Fordeling af de mennesker, der har set din post"),
                t("cfa1ef16", "Boost"),
                t("d267afa2", "Under 20"),
                t("db81cab0", "20-29"),
                t("f173716e", "30-39"),
                ...
                t("f1196a04", "Boost-analyse"),
                t("bb66e3fc", "Promovering-analyse"),
                t("g512ddcc", "Organisk statistik"),
                t("j9256524", "Opdeling af din boost-effektivitet"),
                t("ceeb3016", "Opdeling af din promoveringspræstation"),
                ...
                return (
                    ...
                    (d = [
                        ...
                        },
                        {
                            key: "a7eaa695",
                            get: function () {
                                return ["Hjælper med at finde posts, "];
                            },
                        },
                        {
                            key: "f863bea7",
                            get: function () {
                                return ["Det skader ikke posts, men kan hjælpe med at ", " populære posts"];
                            },
                        },
                        {
                            key: "e59bfa27",
                            get: function () {
                                return ["", " for denne eksperimentelle funktion"];
                            },
                        },
                        {
                            key: "ffd3d1a1",
                        ...
                        },
                        {
                            ...
                            get: function () {
                                var e,
                                    r = s.Children.toArray(this.props.children),
                                    n = ((e = this.props.$i18n), l[f[e]] || g);
            ...
            var b = u._numberRound,
                c = (u._numberFormat, u._numberFormatterFn),
                m = u._pluralGeneratorFn,
                v = (u._currencyNameFormat, u._currencyFormatterFn),
                p = (u._validateParameterTypeDate, u._dateToPartsFormat, u._dateToPartsFormatterFn),
                h = (u._dateFormat, u._dateFormatterFn),
                y = u._relativeTimeFormatterFn,
                j = u._unitFormatterFn;
            (u.a1512798386 = c(["", , 1, 0, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 t", other: "0 t" }, 4: { one: "00 t", other: "00 t" }, 5: { one: "000 t", other: "000 t" }, 6: { one: "0 mio", other: "0 mio" }, 7: { one: "00 mio", other: "00 mio" }, 8: { one: "000 mio", other: "000 mio" }, 9: { one: "0 mia", other: "0 mia" }, 10: { one: "00 mia", other: "00 mia" }, 11: { one: "000 mia", other: "000 mia" }, 12: { one: "0 bio", other: "0 bio" }, 13: { one: "00 bio", other: "00 bio" }, 14: { one: "000 bio", other: "000 bio" }, maxExponent: 14 }], u("da").pluralGenerator({}))),
                (u.b509021250 = c(["", , 1, 0, 3, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1222389628 = c(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b2146337608 = c(["", , 1, 0, 0, , , , , , "", "0", "-0", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b2111625700 = c(["", , 2, 0, 0, , , , , , "", "00", "-00", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b744112621 = c(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 t", other: "0 t" }, 4: { one: "00 t", other: "00 t" }, 5: { one: "000 t", other: "000 t" }, 6: { one: "0 mio", other: "0 mio" }, 7: { one: "00 mio", other: "00 mio" }, 8: { one: "000 mio", other: "000 mio" }, 9: { one: "0 mia", other: "0 mia" }, 10: { one: "00 mia", other: "00 mia" }, 11: { one: "000 mia", other: "000 mia" }, 12: { one: "0 bio", other: "0 bio" }, 13: { one: "00 bio", other: "00 bio" }, 14: { one: "000 bio", other: "000 bio" }, maxExponent: 14 }], u("da").pluralGenerator({}))),
                (u.a1570431033 = c(["", , 1, 0, 1, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b786150682 = c(["", , 1, 0, 0, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", b("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b456384921 = c(["", , 1, 0, 1, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", b("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a529374361 = c(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 t", other: "0 t" }, 4: { one: "00 t", other: "00 t" }, 5: { one: "000 t", other: "000 t" }, 6: { one: "0 mio", other: "0 mio" }, 7: { one: "00 mio", other: "00 mio" }, 8: { one: "000 mio", other: "000 mio" }, 9: { one: "0 mia", other: "0 mia" }, 10: { one: "00 mia", other: "00 mia" }, 11: { one: "000 mia", other: "000 mia" }, 12: { one: "0 bio", other: "0 bio" }, 13: { one: "00 bio", other: "00 bio" }, 14: { one: "000 bio", other: "000 bio" }, maxExponent: 14 }], u("da").pluralGenerator({}))),
                (u.a762550972 = c(["", , 1, 1, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b305924294 = c(["", , 1, 2, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1077208706 = c(["", , 1, 0, 0, 1, 2, , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 t", other: "0 t" }, 4: { one: "00 t", other: "00 t" }, 5: { one: "000 t", other: "000 t" }, 6: { one: "0 mio", other: "0 mio" }, 7: { one: "00 mio", other: "00 mio" }, 8: { one: "000 mio", other: "000 mio" }, 9: { one: "0 mia", other: "0 mia" }, 10: { one: "00 mia", other: "00 mia" }, 11: { one: "000 mia", other: "000 mia" }, 12: { one: "0 bio", other: "0 bio" }, 13: { one: "00 bio", other: "00 bio" }, 14: { one: "000 bio", other: "000 bio" }, maxExponent: 14 }], u("da").pluralGenerator({}))),
                (u.b712302553 = c(["", , 1, 2, 2, , , 0, 3, , " 'AED'", "#,##0.00 'AED'", "-#,##0.00 'AED' 'AED'", "-", " 'AED'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b761503084 = c(["", , 1, 0, 0, , , , 3, , " 'ALL'", "#,##0 'ALL'", "-#,##0 'ALL' 'ALL'", "-", " 'ALL'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b326270775 = c(["", , 1, 2, 2, , , 0, 3, , " 'ARS'", "#,##0.00 'ARS'", "-#,##0.00 'ARS' 'ARS'", "-", " 'ARS'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b283788809 = c(["", , 1, 2, 2, , , 0, 3, , " 'AU$'", "#,##0.00 'AU$'", "-#,##0.00 'AU$' 'AU$'", "-", " 'AU$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a68996213 = c(["", , 1, 2, 2, , , 0, 3, , " 'BAM'", "#,##0.00 'BAM'", "-#,##0.00 'BAM' 'BAM'", "-", " 'BAM'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a161348313 = c(["", , 1, 2, 2, , , 0, 3, , " 'BDT'", "#,##0.00 'BDT'", "-#,##0.00 'BDT' 'BDT'", "-", " 'BDT'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a241694640 = c(["", , 1, 2, 2, , , 0, 3, , " 'BGN'", "#,##0.00 'BGN'", "-#,##0.00 'BGN' 'BGN'", "-", " 'BGN'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b320102705 = c(["", , 1, 3, 3, , , 0, 3, , " 'BHD'", "#,##0.000 'BHD'", "-#,##0.000 'BHD' 'BHD'", "-", " 'BHD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b953097407 = c(["", , 1, 2, 2, , , 0, 3, , " 'R$'", "#,##0.00 'R$'", "-#,##0.00 'R$' 'R$'", "-", " 'R$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a503720686 = c(["", , 1, 0, 0, , , , 3, , " 'BYR'", "#,##0 'BYR'", "-#,##0 'BYR' 'BYR'", "-", " 'BYR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a918635533 = c(["", , 1, 2, 2, , , 0, 3, , " 'CA$'", "#,##0.00 'CA$'", "-#,##0.00 'CA$' 'CA$'", "-", " 'CA$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1150439304 = c(["", , 1, 2, 2, , , 0, 3, , " 'CHF'", "#,##0.00 'CHF'", "-#,##0.00 'CHF' 'CHF'", "-", " 'CHF'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1017198362 = c(["", , 1, 0, 0, , , , 3, , " 'CLP'", "#,##0 'CLP'", "-#,##0 'CLP' 'CLP'", "-", " 'CLP'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1409948705 = c(["", , 1, 2, 2, , , 0, 3, , " 'CN¥'", "#,##0.00 'CN¥'", "-#,##0.00 'CN¥' 'CN¥'", "-", " 'CN¥'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1103085815 = c(["", , 1, 0, 0, , , , 3, , " 'COP'", "#,##0 'COP'", "-#,##0 'COP' 'COP'", "-", " 'COP'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1670381627 = c(["", , 1, 2, 2, , , 0, 3, , " 'CZK'", "#,##0.00 'CZK'", "-#,##0.00 'CZK' 'CZK'", "-", " 'CZK'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b823859282 = c(["", , 1, 2, 2, , , 0, 3, , " 'kr.'", "#,##0.00 'kr.'", "-#,##0.00 'kr.' 'kr.'", "-", " 'kr.'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1743546635 = c(["", , 1, 2, 2, , , 0, 3, , " 'DZD'", "#,##0.00 'DZD'", "-#,##0.00 'DZD' 'DZD'", "-", " 'DZD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1388914571 = c(["", , 1, 2, 2, , , 0, 3, , " 'EGP'", "#,##0.00 'EGP'", "-#,##0.00 'EGP' 'EGP'", "-", " 'EGP'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b279254733 = c(["", , 1, 2, 2, , , 0, 3, , " '€'", "#,##0.00 '€'", "-#,##0.00 '€' '€'", "-", " '€'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a736884138 = c(["", , 1, 2, 2, , , 0, 3, , " '£'", "#,##0.00 '£'", "-#,##0.00 '£' '£'", "-", " '£'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a417492505 = c(["", , 1, 2, 2, , , 0, 3, , " 'GHS'", "#,##0.00 'GHS'", "-#,##0.00 'GHS' 'GHS'", "-", " 'GHS'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a759195275 = c(["", , 1, 2, 2, , , 0, 3, , " 'GTQ'", "#,##0.00 'GTQ'", "-#,##0.00 'GTQ' 'GTQ'", "-", " 'GTQ'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1347478152 = c(["", , 1, 2, 2, , , 0, 3, , " 'HK$'", "#,##0.00 'HK$'", "-#,##0.00 'HK$' 'HK$'", "-", " 'HK$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1583899528 = c(["", , 1, 2, 2, , , 0, 3, , " 'HRK'", "#,##0.00 'HRK'", "-#,##0.00 'HRK' 'HRK'", "-", " 'HRK'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1665169376 = c(["", , 1, 2, 2, , , 0, 3, , " 'HUF'", "#,##0.00 'HUF'", "-#,##0.00 'HUF' 'HUF'", "-", " 'HUF'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1820066986 = c(["", , 1, 0, 0, , , , 3, , " 'IDR'", "#,##0 'IDR'", "-#,##0 'IDR' 'IDR'", "-", " 'IDR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b281101775 = c(["", , 1, 2, 2, , , 0, 3, , " '₪'", "#,##0.00 '₪'", "-#,##0.00 '₪' '₪'", "-", " '₪'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b267248960 = c(["", , 1, 2, 2, , , 0, 3, , " '₹'", "#,##0.00 '₹'", "-#,##0.00 '₹' '₹'", "-", " '₹'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b2115650641 = c(["", , 1, 0, 0, , , , 3, , " 'IQD'", "#,##0 'IQD'", "-#,##0 'IQD' 'IQD'", "-", " 'IQD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b2051927692 = c(["", , 1, 0, 0, , , , 3, , " 'ISK'", "#,##0 'ISK'", "-#,##0 'ISK' 'ISK'", "-", " 'ISK'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1167194574 = c(["", , 1, 0, 0, , , , 3, , " 'JP¥'", "#,##0 'JP¥'", "-#,##0 'JP¥' 'JP¥'", "-", " 'JP¥'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b413347520 = c(["", , 1, 2, 2, , , 0, 3, , " 'KES'", "#,##0.00 'KES'", "-#,##0.00 'KES' 'KES'", "-", " 'KES'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a580276156 = c(["", , 1, 0, 0, , , , 3, , " '₩'", "#,##0 '₩'", "-#,##0 '₩' '₩'", "-", " '₩'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b493066903 = c(["", , 1, 3, 3, , , 0, 3, , " 'KWD'", "#,##0.000 'KWD'", "-#,##0.000 'KWD' 'KWD'", "-", " 'KWD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a188788172 = c(["", , 1, 2, 2, , , 0, 3, , " 'KZT'", "#,##0.00 'KZT'", "-#,##0.00 'KZT' 'KZT'", "-", " 'KZT'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a128505389 = c(["", , 1, 0, 0, , , , 3, , " 'LBP'", "#,##0 'LBP'", "-#,##0 'LBP' 'LBP'", "-", " 'LBP'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1233290423 = c(["", , 1, 2, 2, , , 0, 3, , " 'MAD'", "#,##0.00 'MAD'", "-#,##0.00 'MAD' 'MAD'", "-", " 'MAD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1519581933 = c(["", , 1, 2, 2, , , 0, 3, , " 'MKD'", "#,##0.00 'MKD'", "-#,##0.00 'MKD' 'MKD'", "-", " 'MKD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1862208224 = c(["", , 1, 2, 2, , , 0, 3, , " 'MX$'", "#,##0.00 'MX$'", "-#,##0.00 'MX$' 'MX$'", "-", " 'MX$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1933319341 = c(["", , 1, 2, 2, , , 0, 3, , " 'MYR'", "#,##0.00 'MYR'", "-#,##0.00 'MYR' 'MYR'", "-", " 'MYR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1993163076 = c(["", , 1, 2, 2, , , 0, 3, , " 'NGN'", "#,##0.00 'NGN'", "-#,##0.00 'NGN' 'NGN'", "-", " 'NGN'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1766900431 = c(["", , 1, 2, 2, , , 0, 3, , " 'NOK'", "#,##0.00 'NOK'", "-#,##0.00 'NOK' 'NOK'", "-", " 'NOK'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1487997089 = c(["", , 1, 2, 2, , , 0, 3, , " 'NZ$'", "#,##0.00 'NZ$'", "-#,##0.00 'NZ$' 'NZ$'", "-", " 'NZ$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b275414016 = c(["", , 1, 2, 2, , , 0, 3, , " 'PEN'", "#,##0.00 'PEN'", "-#,##0.00 'PEN' 'PEN'", "-", " 'PEN'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b187679521 = c(["", , 1, 2, 2, , , 0, 3, , " 'PHP'", "#,##0.00 'PHP'", "-#,##0.00 'PHP' 'PHP'", "-", " 'PHP'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b356937782 = c(["", , 1, 0, 0, , , , 3, , " 'PKR'", "#,##0 'PKR'", "-#,##0 'PKR' 'PKR'", "-", " 'PKR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b75009959 = c(["", , 1, 2, 2, , , 0, 3, , " 'PLN'", "#,##0.00 'PLN'", "-#,##0.00 'PLN' 'PLN'", "-", " 'PLN'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a501267145 = c(["", , 1, 2, 2, , , 0, 3, , " 'QAR'", "#,##0.00 'QAR'", "-#,##0.00 'QAR' 'QAR'", "-", " 'QAR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1785884856 = c(["", , 1, 2, 2, , , 0, 3, , " 'RON'", "#,##0.00 'RON'", "-#,##0.00 'RON' 'RON'", "-", " 'RON'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1634173494 = c(["", , 1, 0, 0, , , , 3, , " 'RSD'", "#,##0 'RSD'", "-#,##0 'RSD' 'RSD'", "-", " 'RSD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1946577510 = c(["", , 1, 2, 2, , , 0, 3, , " 'RUB'", "#,##0.00 'RUB'", "-#,##0.00 'RUB' 'RUB'", "-", " 'RUB'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b2018692789 = c(["", , 1, 2, 2, , , 0, 3, , " 'SAR'", "#,##0.00 'SAR'", "-#,##0.00 'SAR' 'SAR'", "-", " 'SAR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1910640832 = c(["", , 1, 2, 2, , , 0, 3, , " 'SEK'", "#,##0.00 'SEK'", "-#,##0.00 'SEK' 'SEK'", "-", " 'SEK'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1859847177 = c(["", , 1, 2, 2, , , 0, 3, , " 'SGD'", "#,##0.00 'SGD'", "-#,##0.00 'SGD' 'SGD'", "-", " 'SGD'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b340535994 = c(["", , 1, 2, 2, , , 0, 3, , " '฿'", "#,##0.00 '฿'", "-#,##0.00 '฿' '฿'", "-", " '฿'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1353130725 = c(["", , 1, 3, 3, , , 0, 3, , " 'TND'", "#,##0.000 'TND'", "-#,##0.000 'TND' 'TND'", "-", " 'TND'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b638028894 = c(["", , 1, 2, 2, , , 0, 3, , " 'TRY'", "#,##0.00 'TRY'", "-#,##0.00 'TRY' 'TRY'", "-", " 'TRY'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b1659771995 = c(["", , 1, 2, 2, , , 0, 3, , " 'NT$'", "#,##0.00 'NT$'", "-#,##0.00 'NT$' 'NT$'", "-", " 'NT$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b671529568 = c(["", , 1, 0, 0, , , , 3, , " 'TZS'", "#,##0 'TZS'", "-#,##0 'TZS' 'TZS'", "-", " 'TZS'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b252920637 = c(["", , 1, 2, 2, , , 0, 3, , " 'UAH'", "#,##0.00 'UAH'", "-#,##0.00 'UAH' 'UAH'", "-", " 'UAH'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b323362151 = c(["", , 1, 0, 0, , , , 3, , " 'UGX'", "#,##0 'UGX'", "-#,##0 'UGX' 'UGX'", "-", " 'UGX'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a619596971 = c(["", , 1, 2, 2, , , 0, 3, , " '$'", "#,##0.00 '$'", "-#,##0.00 '$' '$'", "-", " '$'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a747252606 = c(["", , 1, 2, 2, , , 0, 3, , " 'VEF'", "#,##0.00 'VEF'", "-#,##0.00 'VEF' 'VEF'", "-", " 'VEF'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a582123198 = c(["", , 1, 0, 0, , , , 3, , " '₫'", "#,##0 '₫'", "-#,##0 '₫' '₫'", "-", " '₫'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b101134318 = c(["", , 1, 2, 2, , , 0, 3, , " 'ZAR'", "#,##0.00 'ZAR'", "-#,##0.00 'ZAR' 'ZAR'", "-", " 'ZAR'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a247033099 = c(["", , 1, 2, 2, , , 0, 3, , " 'ZMW'", "#,##0.00 'ZMW'", "-#,##0.00 'ZMW' 'ZMW'", "-", " 'ZMW'", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.b426198860 = c(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a893165335 = c(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 t", other: "0 t" }, 4: { one: "00 t", other: "00 t" }, 5: { one: "000 t", other: "000 t" }, 6: { one: "0 mio", other: "0 mio" }, 7: { one: "00 mio", other: "00 mio" }, 8: { one: "000 mio", other: "000 mio" }, 9: { one: "0 mia", other: "0 mia" }, 10: { one: "00 mia", other: "00 mia" }, 11: { one: "000 mia", other: "000 mia" }, 12: { one: "0 bio", other: "0 bio" }, 13: { one: "00 bio", other: "00 bio" }, 14: { one: "000 bio", other: "000 bio" }, maxExponent: 14 }], u("da").pluralGenerator({}))),
                (u.a338433625 = c(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 t", other: "0 t" }, 4: { one: "00 t", other: "00 t" }, 5: { one: "000 t", other: "000 t" }, 6: { one: "0 mio", other: "0 mio" }, 7: { one: "00 mio", other: "00 mio" }, 8: { one: "000 mio", other: "000 mio" }, 9: { one: "0 mia", other: "0 mia" }, 10: { one: "00 mia", other: "00 mia" }, 11: { one: "000 mia", other: "000 mia" }, 12: { one: "0 bio", other: "0 bio" }, 13: { one: "00 bio", other: "00 bio" }, 14: { one: "000 bio", other: "000 bio" }, maxExponent: 14 }], u("da").pluralGenerator({}))),
                (u.b1383633926 = c(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", b("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (u.a1621711212 = m(function (e) {
                    var r = String(e).split("."),
                        n = r[0],
                        t = Number(r[0]) == e;
                    return 1 != e && (t || (0 != n && 1 != n)) ? "other" : "one";
                })),
                (u.a496616110 = v(u("da").numberFormatter({ raw: "#,##0.00 'AED'" }))),
                (u.b1651759507 = v(u("da").numberFormatter({ raw: "#,##0 'ALL'" }))),
                (u.b421300660 = v(u("da").numberFormatter({ raw: "#,##0.00 'ARS'" }))),
                (u.a1811773118 = v(u("da").numberFormatter({ raw: "#,##0.00 'AU$'" }))),
                (u.b1052925920 = v(u("da").numberFormatter({ raw: "#,##0.00 'BAM'" }))),
                (u.a1809989180 = v(u("da").numberFormatter({ raw: "#,##0.00 'BDT'" }))),
                (u.a5758021 = v(u("da").numberFormatter({ raw: "#,##0.00 'BGN'" }))),
                (u.a606970192 = v(u("da").numberFormatter({ raw: "#,##0.000 'BHD'" }))),
                (u.a1121105618 = v(u("da").numberFormatter({ raw: "#,##0.00 'R$'" }))),
                (u.b1084528301 = v(u("da").numberFormatter({ raw: "#,##0 'BYR'" }))),
                (u.a432222056 = v(u("da").numberFormatter({ raw: "#,##0.00 'CA$'" }))),
                (u.b1887928467 = v(u("da").numberFormatter({ raw: "#,##0.00 'CHF'" }))),
                (u.a1948377767 = v(u("da").numberFormatter({ raw: "#,##0 'CLP'" }))),
                (u.b313919808 = v(u("da").numberFormatter({ raw: "#,##0.00 'CN¥'" }))),
                (u.a315921514 = v(u("da").numberFormatter({ raw: "#,##0 'COP'" }))),
                (u.a1345381658 = v(u("da").numberFormatter({ raw: "#,##0.00 'CZK'" }))),
                (u.b1634428630 = v(u("da").numberFormatter({ raw: "#,##0.00 'kr.'" }))),
                (u.b1407179360 = v(u("da").numberFormatter({ raw: "#,##0.00 'DZD'" }))),
                (u.a996480032 = v(u("da").numberFormatter({ raw: "#,##0.00 'EGP'" }))),
                (u.a593887980 = v(u("da").numberFormatter({ raw: "#,##0.00 '€'" }))),
                (u.a44582297 = v(u("da").numberFormatter({ raw: "#,##0.00 '£'" }))),
                (u.a1160524540 = v(u("da").numberFormatter({ raw: "#,##0.00 'GHS'" }))),
                (u.b1131591478 = v(u("da").numberFormatter({ raw: "#,##0.00 'GTQ'" }))),
                (u.a841441357 = v(u("da").numberFormatter({ raw: "#,##0.00 'HK$'" }))),
                (u.b1335563411 = v(u("da").numberFormatter({ raw: "#,##0.00 'HRK'" }))),
                (u.a1183801877 = v(u("da").numberFormatter({ raw: "#,##0.00 'HUF'" }))),
                (u.a1067501335 = v(u("da").numberFormatter({ raw: "#,##0 'IDR'" }))),
                (u.b393774658 = v(u("da").numberFormatter({ raw: "#,##0.00 '₪'" }))),
                (u.a1352603553 = v(u("da").numberFormatter({ raw: "#,##0.00 '₹'" }))),
                (u.b680660814 = v(u("da").numberFormatter({ raw: "#,##0 'IQD'" }))),
                (u.a1294750605 = v(u("da").numberFormatter({ raw: "#,##0 'ISK'" }))),
                (u.a775858011 = v(u("da").numberFormatter({ raw: "#,##0 'JP¥'" }))),
                (u.a1174287541 = v(u("da").numberFormatter({ raw: "#,##0.00 'KES'" }))),
                (u.b58549890 = v(u("da").numberFormatter({ raw: "#,##0 '₩'" }))),
                (u.b459952650 = v(u("da").numberFormatter({ raw: "#,##0.000 'KWD'" }))),
                (u.b1634342487 = v(u("da").numberFormatter({ raw: "#,##0.00 'KZT'" }))),
                (u.a168699380 = v(u("da").numberFormatter({ raw: "#,##0 'LBP'" }))),
                (u.a680456222 = v(u("da").numberFormatter({ raw: "#,##0.00 'MAD'" }))),
                (u.a965558440 = v(u("da").numberFormatter({ raw: "#,##0.00 'MKD'" }))),
                (u.b95504085 = v(u("da").numberFormatter({ raw: "#,##0.00 'MX$'" }))),
                (u.a906516200 = v(u("da").numberFormatter({ raw: "#,##0.00 'MYR'" }))),
                (u.b555354439 = v(u("da").numberFormatter({ raw: "#,##0.00 'NGN'" }))),
                (u.b2131147036 = v(u("da").numberFormatter({ raw: "#,##0.00 'NOK'" }))),
                (u.b1158945194 = v(u("da").numberFormatter({ raw: "#,##0.00 'NZ$'" }))),
                (u.a1155258869 = v(u("da").numberFormatter({ raw: "#,##0.00 'PEN'" }))),
                (u.b419939082 = v(u("da").numberFormatter({ raw: "#,##0.00 'PHP'" }))),
                (u.b1995137033 = v(u("da").numberFormatter({ raw: "#,##0 'PKR'" }))),
                (u.b1222149956 = v(u("da").numberFormatter({ raw: "#,##0.00 'PLN'" }))),
                (u.b537428916 = v(u("da").numberFormatter({ raw: "#,##0.00 'QAR'" }))),
                (u.a631014461 = v(u("da").numberFormatter({ raw: "#,##0.00 'RON'" }))),
                (u.b400229621 = v(u("da").numberFormatter({ raw: "#,##0 'RSD'" }))),
                (u.a1317519439 = v(u("da").numberFormatter({ raw: "#,##0.00 'RUB'" }))),
                (u.b1346775542 = v(u("da").numberFormatter({ raw: "#,##0.00 'SAR'" }))),
                (u.a2002835125 = v(u("da").numberFormatter({ raw: "#,##0.00 'SEK'" }))),
                (u.b717528866 = v(u("da").numberFormatter({ raw: "#,##0.00 'SGD'" }))),
                (u.a1855526848 = v(u("da").numberFormatter({ raw: "#,##0.00 '฿'" }))),
                (u.b1352127356 = v(u("da").numberFormatter({ raw: "#,##0.000 'TND'" }))),
                (u.b1495867757 = v(u("da").numberFormatter({ raw: "#,##0.00 'TRY'" }))),
                (u.b1954528819 = v(u("da").numberFormatter({ raw: "#,##0.00 'NT$'" }))),
                (u.a1137419489 = v(u("da").numberFormatter({ raw: "#,##0 'TZS'" }))),
                (u.a1852553618 = v(u("da").numberFormatter({ raw: "#,##0.00 'UAH'" }))),
                (u.b954292472 = v(u("da").numberFormatter({ raw: "#,##0 'UGX'" }))),
                (u.a533234088 = v(u("da").numberFormatter({ raw: "#,##0.00 '$'" }))),
                (u.b1501814217 = v(u("da").numberFormatter({ raw: "#,##0.00 'VEF'" }))),
                (u.a2133493314 = v(u("da").numberFormatter({ raw: "#,##0 '₫'" }))),
                (u.b2032005085 = v(u("da").numberFormatter({ raw: "#,##0.00 'ZAR'" }))),
                (u.a171250250 = v(u("da").numberFormatter({ raw: "#,##0.00 'ZMW'" }))),
                (u.a749989856 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "d. MMM", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a1129731325 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "d. MMM y", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a679141554 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "h.mm a", timeSeparator: ".", dayPeriods: { am: "AM", pm: "PM" } })),
                (u.a1748099745 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "E d. MMM", timeSeparator: ".", days: { E: { 1: { sun: "søn.", mon: "man.", tue: "tir.", wed: "ons.", thu: "tor.", fri: "fre.", sat: "lør." } } }, months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a635183396 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "E d. MMM y", timeSeparator: ".", days: { E: { 1: { sun: "søn.", mon: "man.", tue: "tir.", wed: "ons.", thu: "tor.", fri: "fre.", sat: "lør." } } }, months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a1755487913 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "d. MMMM", timeSeparator: ".", months: { M: { 4: { 1: "januar", 2: "februar", 3: "marts", 4: "april", 5: "maj", 6: "juni", 7: "juli", 8: "august", 9: "september", 10: "oktober", 11: "november", 12: "december" } } } })),
                (u.b1732679607 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "d. MMMM y 'kl'. HH.mm.ss z", timeSeparator: ".", months: { M: { 4: { 1: "januar", 2: "februar", 3: "marts", 4: "april", 5: "maj", 6: "juni", 7: "juli", 8: "august", 9: "september", 10: "oktober", 11: "november", 12: "december" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: ["+H;-H", "+H.mm;-H.mm"] })),
                (u.b890805480 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "d. MMM y h.mm a", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } }, dayPeriods: { am: "AM", pm: "PM" } })),
                (u.a237748668 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "d. MMMM y", timeSeparator: ".", months: { M: { 4: { 1: "januar", 2: "februar", 3: "marts", 4: "april", 5: "maj", 6: "juni", 7: "juli", 8: "august", 9: "september", 10: "oktober", 11: "november", 12: "december" } } } })),
                (u.b750137029 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "d. MMM h.mm a", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } }, dayPeriods: { am: "AM", pm: "PM" } })),
                (u.a513597776 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "dd/MM/y", timeSeparator: "." })),
                (u.a2100554932 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "y", timeSeparator: "." })),
                (u.a1144760963 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "MMM y", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a1702309718 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "EEEE 'den' d. MMMM y 'kl'. HH.mm.ss zzzz", timeSeparator: ".", days: { E: { 4: { sun: "søndag", mon: "mandag", tue: "tirsdag", wed: "onsdag", thu: "torsdag", fri: "fredag", sat: "lørdag" } } }, months: { M: { 4: { 1: "januar", 2: "februar", 3: "marts", 4: "april", 5: "maj", 6: "juni", 7: "juli", 8: "august", 9: "september", 10: "oktober", 11: "november", 12: "december" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: "+HH.mm;-HH.mm" })),
                (u.b865201168 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "d. MMM y HH.mm.ss", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a1150972308 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "dd/MM/y", timeSeparator: "." })),
                (u.a1168942289 = p({ 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "HH.mm", timeSeparator: "." })),
                (u.b1425938237 = p({ 1: u("da").numberFormatter({ raw: "0" }), 2: u("da").numberFormatter({ raw: "00" }) }, { pattern: "E h.mm a", timeSeparator: ".", days: { E: { 1: { sun: "søn.", mon: "man.", tue: "tir.", wed: "ons.", thu: "tor.", fri: "fre.", sat: "lør." } } }, dayPeriods: { am: "AM", pm: "PM" } })),
                (u.a1129046132 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "MMMM y", timeSeparator: ".", months: { M: { 4: { 1: "januar", 2: "februar", 3: "marts", 4: "april", 5: "maj", 6: "juni", 7: "juli", 8: "august", 9: "september", 10: "oktober", 11: "november", 12: "december" } } } })),
                (u.b1364206429 = p({ 1: u("da").numberFormatter({ raw: "0" }) }, { pattern: "d. MMM y", timeSeparator: ".", months: { M: { 3: { 1: "jan.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "maj", 6: "jun.", 7: "jul.", 8: "aug.", 9: "sep.", 10: "okt.", 11: "nov.", 12: "dec." } } } })),
                (u.a749304663 = p({}, { pattern: "MMMM", timeSeparator: ".", months: { M: { 4: { 1: "januar", 2: "februar", 3: "marts", 4: "april", 5: "maj", 6: "juni", 7: "juli", 8: "august", 9: "september", 10: "oktober", 11: "november", 12: "december" } } } })),
                (u.a2002550103 = p({}, { pattern: "cccc", timeSeparator: ".", days: { c: { 4: { sun: "søndag", mon: "mandag", tue: "tirsdag", wed: "onsdag", thu: "torsdag", fri: "fredag", sat: "lørdag" } } } })),
                (u.a358582775 = h(u("da").dateToPartsFormatter({ skeleton: "MMMd" }))),
                (u.a1881013702 = h(u("da").dateToPartsFormatter({ skeleton: "yMMMd" }))),
                (u.b157018999 = h(u("da").dateToPartsFormatter({ skeleton: "hm" }))),
                (u.b1795585174 = h(u("da").dateToPartsFormatter({ skeleton: "MMMEd" }))),
                (u.b1844866693 = h(u("da").dateToPartsFormatter({ skeleton: "yMMMEd" }))),
                (u.b1788197006 = h(u("da").dateToPartsFormatter({ skeleton: "MMMMd" }))),
                (u.b2124086688 = h(u("da").dateToPartsFormatter({ datetime: "long" }))),
                (u.b462946911 = h(u("da").dateToPartsFormatter({ skeleton: "yMMMdhm" }))),
                (u.a1139670867 = h(u("da").dateToPartsFormatter({ date: "long" }))),
                (u.a1064780178 = h(u("da").dateToPartsFormatter({ skeleton: "MMMdhm" }))),
                (u.b1591585127 = h(u("da").dateToPartsFormatter({ date: "short" }))),
                (u.b4627971 = h(u("da").dateToPartsFormatter({ skeleton: "y" }))),
                (u.a753353882 = h(u("da").dateToPartsFormatter({ skeleton: "yMMM" }))),
                (u.a1310902637 = h(u("da").dateToPartsFormatter({ datetime: "full" }))),
                (u.a949716039 = h(u("da").dateToPartsFormatter({ datetime: "medium" }))),
                (u.a1902254685 = h(u("da").dateToPartsFormatter({ skeleton: "yMMdd" }))),
                (u.b936240614 = h(u("da").dateToPartsFormatter({ time: "short" }))),
                (u.b1577111604 = h(u("da").dateToPartsFormatter({ skeleton: "Ehm" }))),
                (u.a1880328509 = h(u("da").dateToPartsFormatter({ skeleton: "yMMMM" }))),
                (u.a2094600314 = h(u("da").dateToPartsFormatter({ date: "medium" }))),
                (u.a357897582 = h(u("da").dateToPartsFormatter({ skeleton: "MMMM" }))),
                (u.a1611143022 = h(u("da").dateToPartsFormatter({ skeleton: "EEEE" }))),
                (u.a1069287050 = y(u("da").numberFormatter({}), u("da").pluralGenerator({}), { "relativeTime-type-future": { "relativeTimePattern-count-one": "om {0} dag", "relativeTimePattern-count-other": "om {0} dage" }, "relativeTime-type-past": { "relativeTimePattern-count-one": "for {0} dag siden", "relativeTimePattern-count-other": "for {0} dage siden" }, "relative-type--2": "i forgårs", "relative-type--1": "i går", "relative-type-0": "i dag", "relative-type-1": "i morgen", "relative-type-2": "i overmorgen" })),
                (u.b1545601425 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0} pr. {1}", unitProperties: { displayName: "sekunder", one: "{0} sekund", other: "{0} sekunder", perUnitPattern: "{0} pr. sekund" } })),
                (u.a862402575 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0} pr. {1}", unitProperties: { displayName: "minutter", one: "{0} minut", other: "{0} minutter", perUnitPattern: "{0} pr. min." } })),
                (u.b914067873 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0} pr. {1}", unitProperties: { displayName: "timer", one: "{0} time", other: "{0} timer", perUnitPattern: "{0} pr. time" } })),
                (u.b1867887120 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "sek", one: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (u.a1531551632 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "min", one: "{0} m", other: "{0} min", perUnitPattern: "{0}/min" } })),
                (u.b554532384 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "time", one: "{0} t", other: "{0} t", perUnitPattern: "{0}/t" } })),
                (u.a1797573700 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "dag", one: "{0} d", other: "{0} d", perUnitPattern: "{0}/d" } })),
                (u.a1104019907 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0} pr. {1}", unitProperties: { displayName: "dage", one: "{0} dag", other: "{0} dage", perUnitPattern: "{0} pr. dag" } })),
                (u.a484309928 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "måned", one: "{0} m", other: "{0} m", perUnitPattern: "{0}/m" } })),
                (u.b300697049 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0} pr. {1}", unitProperties: { displayName: "måneder", one: "{0} måned", other: "{0} måneder", perUnitPattern: "{0} pr. måned" } })),
                (u.a850030009 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "år", one: "{0} år", other: "{0} år", perUnitPattern: "{0}/år" } })),
                (u.a566721656 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0} pr. {1}", unitProperties: { displayName: "år", one: "{0} år", other: "{0} år", perUnitPattern: "{0} om året" } })),
                (u.a1064319741 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "sekunder", one: "{0} sek.", other: "{0} sek.", perUnitPattern: "{0}/sek." } })),
                (u.b1596967587 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "minutter", one: "{0} min.", other: "{0} min.", perUnitPattern: "{0}/min." } })),
                (u.b832976627 = j(u("da").numberFormatter({}), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "timer", one: "{0} t", other: "{0} t", perUnitPattern: "{0} /t" } })),
                (u.a1908688061 = j(u("da").numberFormatter({ minimumFractionDigits: 1, maximumFractionDigits: 1, round: "truncate" }), u("da").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "sek", one: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                t("d58baa7f", u.a1512798386),
                t("ia24dc8d", u.b509021250),
                t("iab73d4b", u.a1222389628),
                t("i3b7a017", u.b1545601425),
                t("ie5d110f", u.a862402575),
                t("df5f11b3", u.b914067873),
                t("e8733ed9", u.b1867887120),
                t("be59d8c3", u.a1531551632),
                t("i3d087db", u.b554532384),
                t("ga8d18c9", u.a1797573700),
                t("a91e7d49", u.a1104019907),
                t("id952a69", u.a484309928),
                t("ga09ab65", u.b300697049),
                t("c83b901d", u.a850030009),
                t("a55b9fed", u.a566721656),
                t("ccaa970f", u.a358582775),
                t("jade381b", u.a1881013702),
                t("d725a289", u.b157018999),
                t("g08cbabb", u.b744112621),
                t("c333da63", u.a1069287050),
                t("h8054d91", u.b1795585174),
                t("i61fef37", u.a1064319741),
                t("ba705e27", u.b1596967587),
                t("j86b0d8d", u.b832976627),
                t("f668e929", u.a1570431033),
                t("i2785009", u.b786150682),
                t("c778d80b", u.b456384921),
                t("e8d93005", u.a529374361),
                t("d46781af", u.a1908688061),
                t("ba316f05", u.a762550972),
                t("c0bdd345", u.b305924294),
                t("aa2aa1a1", u.b1844866693),
                t("da44942d", u.b1788197006),
                t("a54d3ef5", u.b2124086688),
                t("bfbc051d", u.b462946911),
                t("ba2e82a1", u.a1139670867),
                t("fc209bb7", u.a1064780178),
                t("cf8abf59", u.a1077208706),
                t("a9f397f3", u.b1591585127),
                t("d857e44d", u.a496616110),
                t("cb87e3db", u.b1651759507),
                t("a9d5ffd1", u.b421300660),
                t("a0e8371d", u.a1811773118),
                t("gcc50dc9", u.b1052925920),
                t("a6a43585", u.a1809989180),
                t("a0cc8f2d", u.a5758021),
                t("i31c32c5", u.a606970192),
                t("i7dc69e9", u.a1121105618),
                t("c14a6c03", u.b1084528301),
                t("jaa3d537", u.a432222056),
                t("a824080b", u.b1887928467),
                t("d9c0bedb", u.a1948377767),
                t("bf8c0613", u.b313919808),
                t("i8163625", u.a315921514),
                t("adb53ba1", u.a1345381658),
                t("iabf697d", u.b1634428630),
                t("a1a0555b", u.b1407179360),
                t("f266f3d9", u.a996480032),
                t("a9a8652b", u.a593887980),
                t("dbf40761", u.a44582297),
                t("b0d993d9", u.a1160524540),
                t("ac1308e1", u.b1131591478),
                t("a7889ab3", u.a841441357),
                t("c614f5cd", u.b1335563411),
                t("i55d57e3", u.a1183801877),
                t("e4b6002b", u.a1067501335),
                t("d28e983b", u.b393774658),
                t("e8c9232d", u.a1352603553),
                t("c8994ae1", u.b680660814),
                t("f821c2a5", u.a1294750605),
                t("j348b9c9", u.a775858011),
                t("i6f93b9b", u.a1174287541),
                t("c6150bd5", u.b58549890),
                t("i8921e09", u.b459952650),
                t("ef239279", u.b1634342487),
                t("hecdb149", u.a168699380),
                t("fdd039b7", u.a680456222),
                t("f30c2c37", u.a965558440),
                t("d9ea7bff", u.b95504085),
                t("ea3df4b7", u.a906516200),
                t("jaac21bb", u.b555354439),
                t("hb435ced", u.b2131147036),
                t("ce699d81", u.b1158945194),
                t("bc56d3d7", u.a1155258869),
                t("f8561913", u.b419939082),
                t("g6485d53", u.b1995137033),
                t("ff561cc1", u.b1222149956),
                t("b42011d3", u.b537428916),
                t("a6660bcd", u.a631014461),
                t("f9b80449", u.b400229621),
                t("gdee4d5d", u.a1317519439),
                t("h36f2103", u.b1346775542),
                t("a19ad037", u.a2002835125),
                t("g713f699", u.b717528866),
                t("ff2e39af", u.a1855526848),
                t("be34316d", u.b1352127356),
                t("aef81b75", u.b1495867757),
                t("fcce70a5", u.b1954528819),
                t("jc9d352f", u.a1137419489),
                t("be1cb8c5", u.a1852553618),
                t("j9371501", u.b954292472),
                t("j7d4397d", u.a533234088),
                t("d61441dd", u.b1501814217),
                t("e2a99e97", u.a2133493314),
                t("f7ce19ab", u.b2032005085),
                t("b2a0213f", u.a171250250),
                t("d7d71245", u.b4627971),
                t("a2f2faab", u.a753353882),
                t("g8d1b99b", u.a1310902637),
                t("d0a77c9b", u.a949716039),
                t("e18e399b", u.a1902254685),
                t("b6ca7bcb", u.b936240614),
                t("h0e4cdf5", u.b1577111604),
                t("g727ddcf", u.a1880328509),
                t("h3629783", u.a2094600314),
                t("a20c68af", u.a357897582),
                t("ja781451", u.b426198860),
                t("cfa1a7b9", u.a893165335),
                t("f3b9b9a7", u.a1611143022),
                t("eefcd267", u.a338433625),
                t("fa8afc43", u.b1383633926);
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/da.2eb9ee6a.js.map
