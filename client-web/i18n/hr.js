...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["i18n/hr"],
    {
        777511: (a, e, i) => {
            ...
            function t(a, e, i) {
                return "one" == ((o = a), (n = !String(o).split(".")[1]), 1 == o && n ? "one" : "other") ? e : i;
                var o, n;
            }
            o("c39b0e24", "X"),
                o("jb38600c", "Nema"),
                ...
                o("fd127276", "Upravljanje pristupnim ključevima"),
            ...
            o("i560665f", "Saznajte više"),
                ...
                o("fe8aeb88", "Pristupni ključevi pružaju dodatnu zaštitu koja se može povezati s vašim biometrijskim podacima."),
            ...
            o("he258678", "X za tvrtke"),
                ...
                o("f2b1e83e", "Grok i suradnici trećih strana"),
            ...
            o("e111f531", function (a) {
                ...
                o("fe9ad897", function (a) {
                    return "Uredi sliku" + a.ttc_grok_preset;
                }),
            ...
            o("if2909ba", "Vrijeme gledanja"),
                ...
                o("i6f6191a", "Hvala!"),
                o("h5575012", "Slažem se i pošalji"),
            ...
            o("b925c18c", "Vrsta plaće"),
                ...
                o("f9b6b7d3", function (a) {
                    return a.hours + " " + n(a.hours, "sata", "sat", "h");
                }),
                o("a9af8753", function (a) {
                    return a.days + " dan" + n(a.days, "a", "", "a") + ", " + a.hours + " " + n(a.hours, "sata", "sat", "h");
                }),
                o("b93d00e5", function (a) {
                    return a.days + " dan" + n(a.days, "a", "", "a");
                }),
                o("dc9661b3", function (a) {
            ...
            o("b0b22805", function (a) {
                ...
                o("c20f7e9f", function (a) {
                    return n(a.otherUsersCount, "još njih " + a.otherUsersCount, u.createElement(u.Fragment, null, "", a.secondName), "još njih " + a.otherUsersCount);
                }),
            ...
            var u = i(202784),
                ...
                s = { d764af97: 0, j55320df: 0, g1bf440b: 0, aee9e7fb: 0, d6998bab: 1, ec2cede5: 0 };
            function v(a) {
                return a;
            }
            var p = (function (a) {
                ...
                return (
                    ...
                    (t = [
                        ...
                        },
                        {
                            key: "ffd3d1a1",
                            get: function () {
                                return ["Ocjene su anonimizirane i dostupne javnosti radi transparentnosti. "];
                            },
                        },
                        {
                            key: "bd9cf141",
            ...
            var c = k._numberRound,
                l = (k._numberFormat, k._numberFormatterFn),
                b = k._pluralGeneratorFn,
                m = (k._currencyNameFormat, k._currencyFormatterFn),
                f = (k._validateParameterTypeDate, k._dateToPartsFormat, k._dateToPartsFormatterFn),
                z = (k._dateFormat, k._dateFormatterFn),
                g = k._relativeTimeFormatterFn,
                P = k._unitFormatterFn;
            (k.a1673306623 = l(["", , 1, 0, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], k("hr").pluralGenerator({}))),
                (k.b378804789 = l(["", , 1, 0, 3, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1874145295 = l(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b415659701 = l(["", , 1, 0, 0, , , , , , "", "0", "-0", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b218135 = l(["", , 2, 0, 0, , , , , , "", "00", "-00", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b583604384 = l(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], k("hr").pluralGenerator({}))),
                (k.b304867764 = l(["", , 1, 0, 1, , , , 3, , "%", "#,##0%", "-#,##0%%", "-", "%", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1821600953 = l(["", , 1, 0, 0, , , , 3, , "%", "#,##0%", "-#,##0%%", "-", "%", c("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2143600582 = l(["", , 1, 0, 1, , , , 3, , "%", "#,##0%", "-#,##0%%", "-", "%", c("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1815786458 = l(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], k("hr").pluralGenerator({}))),
                (k.b1537136887 = l(["", , 1, 1, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1689355143 = l(["", , 1, 2, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b35860779 = l(["", , 1, 0, 0, 1, 2, , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], k("hr").pluralGenerator({}))),
                (k.a1731287668 = l(["", , 1, 2, 2, , , 0, 3, , " 'AED'", "#,##0.00 'AED'", "-#,##0.00 'AED' 'AED'", "-", " 'AED'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1619520665 = l(["", , 1, 0, 0, , , , 3, , " 'ALL'", "#,##0 'ALL'", "-#,##0 'ALL' 'ALL'", "-", " 'ALL'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a2117319446 = l(["", , 1, 2, 2, , , 0, 3, , " 'ARS'", "#,##0.00 'ARS'", "-#,##0.00 'ARS' 'ARS'", "-", " 'ARS'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2105613212 = l(["", , 1, 2, 2, , , 0, 3, , " 'AUD'", "#,##0.00 'AUD'", "-#,##0.00 'AUD' 'AUD'", "-", " 'AUD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1782380862 = l(["", , 1, 2, 2, , , 0, 3, , " 'BAM'", "#,##0.00 'BAM'", "-#,##0.00 'BAM' 'BAM'", "-", " 'BAM'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1690028762 = l(["", , 1, 2, 2, , , 0, 3, , " 'BDT'", "#,##0.00 'BDT'", "-#,##0.00 'BDT' 'BDT'", "-", " 'BDT'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1609682435 = l(["", , 1, 2, 2, , , 0, 3, , " 'BGN'", "#,##0.00 'BGN'", "-#,##0.00 'BGN' 'BGN'", "-", " 'BGN'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1878217182 = l(["", , 1, 3, 3, , , 0, 3, , " 'BHD'", "#,##0.000 'BHD'", "-#,##0.000 'BHD' 'BHD'", "-", " 'BHD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1296608816 = l(["", , 1, 2, 2, , , 0, 3, , " 'BRL'", "#,##0.00 'BRL'", "-#,##0.00 'BRL' 'BRL'", "-", " 'BRL'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b354296895 = l(["", , 1, 0, 0, , , , 3, , " 'BYR'", "#,##0 'BYR'", "-#,##0 'BYR' 'BYR'", "-", " 'BYR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b903188870 = l(["", , 1, 2, 2, , , 0, 3, , " 'CAD'", "#,##0.00 'CAD'", "-#,##0.00 'CAD' 'CAD'", "-", " 'CAD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b700937771 = l(["", , 1, 2, 2, , , 0, 3, , " 'CHF'", "#,##0.00 'CHF'", "-#,##0.00 'CHF' 'CHF'", "-", " 'CHF'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a159180781 = l(["", , 1, 0, 0, , , , 3, , " 'CLP'", "#,##0 'CLP'", "-#,##0 'CLP' 'CLP'", "-", " 'CLP'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b511615966 = l(["", , 1, 2, 2, , , 0, 3, , " 'CNY'", "#,##0.00 'CNY'", "-#,##0.00 'CNY' 'CNY'", "-", " 'CNY'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a245068234 = l(["", , 1, 0, 0, , , , 3, , " 'COP'", "#,##0 'COP'", "-#,##0 'COP' 'COP'", "-", " 'COP'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b180995448 = l(["", , 1, 2, 2, , , 0, 3, , " 'CZK'", "#,##0.00 'CZK'", "-#,##0.00 'CZK' 'CZK'", "-", " 'CZK'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a277070968 = l(["", , 1, 2, 2, , , 0, 3, , " 'DKK'", "#,##0.00 'DKK'", "-#,##0.00 'DKK' 'DKK'", "-", " 'DKK'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a700043586 = l(["", , 1, 2, 2, , , 0, 3, , " 'DZD'", "#,##0.00 'DZD'", "-#,##0.00 'DZD' 'DZD'", "-", " 'DZD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1054675650 = l(["", , 1, 2, 2, , , 0, 3, , " 'EGP'", "#,##0.00 'EGP'", "-#,##0.00 'EGP' 'EGP'", "-", " 'EGP'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1457330806 = l(["", , 1, 2, 2, , , 0, 3, , " 'EUR'", "#,##0.00 'EUR'", "-#,##0.00 'EUR' 'EUR'", "-", " 'EUR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1608430039 = l(["", , 1, 2, 2, , , 0, 3, , " 'GBP'", "#,##0.00 'GBP'", "-#,##0.00 'GBP' 'GBP'", "-", " 'GBP'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1433884570 = l(["", , 1, 2, 2, , , 0, 3, , " 'GHS'", "#,##0.00 'GHS'", "-#,##0.00 'GHS' 'GHS'", "-", " 'GHS'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1092181800 = l(["", , 1, 2, 2, , , 0, 3, , " 'GTQ'", "#,##0.00 'GTQ'", "-#,##0.00 'GTQ' 'GTQ'", "-", " 'GTQ'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b474346251 = l(["", , 1, 2, 2, , , 0, 3, , " 'HKD'", "#,##0.00 'HKD'", "-#,##0.00 'HKD' 'HKD'", "-", " 'HKD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b267477547 = l(["", , 1, 2, 2, , , 0, 3, , " 'HRK'", "#,##0.00 'HRK'", "-#,##0.00 'HRK' 'HRK'", "-", " 'HRK'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b186207699 = l(["", , 1, 2, 2, , , 0, 3, , " 'HUF'", "#,##0.00 'HUF'", "-#,##0.00 'HUF' 'HUF'", "-", " 'HUF'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a962049405 = l(["", , 1, 0, 0, , , , 3, , " 'IDR'", "#,##0 'IDR'", "-#,##0 'IDR' 'IDR'", "-", " 'IDR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a455639396 = l(["", , 1, 2, 2, , , 0, 3, , " 'ILS'", "#,##0.00 'ILS'", "-#,##0.00 'ILS' 'ILS'", "-", " 'ILS'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a511974177 = l(["", , 1, 2, 2, , , 0, 3, , " 'INR'", "#,##0.00 'INR'", "-#,##0.00 'INR' 'INR'", "-", " 'INR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1321299074 = l(["", , 1, 0, 0, , , , 3, , " 'IQD'", "#,##0 'IQD'", "-#,##0 'IQD' 'IQD'", "-", " 'IQD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1385022023 = l(["", , 1, 0, 0, , , , 3, , " 'ISK'", "#,##0 'ISK'", "-#,##0 'ISK' 'ISK'", "-", " 'ISK'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2095399751 = l(["", , 1, 0, 0, , , , 3, , " 'JPY'", "#,##0 'JPY'", "-#,##0 'JPY' 'JPY'", "-", " 'JPY'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a2030242701 = l(["", , 1, 2, 2, , , 0, 3, , " 'KES'", "#,##0.00 'KES'", "-#,##0.00 'KES' 'KES'", "-", " 'KES'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1152484810 = l(["", , 1, 0, 0, , , , 3, , " 'KRW'", "#,##0 'KRW'", "-#,##0 'KRW' 'KRW'", "-", " 'KRW'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2051181380 = l(["", , 1, 3, 3, , , 0, 3, , " 'KWD'", "#,##0.000 'KWD'", "-#,##0.000 'KWD' 'KWD'", "-", " 'KWD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1662588903 = l(["", , 1, 2, 2, , , 0, 3, , " 'KZT'", "#,##0.00 'KZT'", "-#,##0.00 'KZT' 'KZT'", "-", " 'KZT'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b729512192 = l(["", , 1, 0, 0, , , , 3, , " 'LBP'", "#,##0 'LBP'", "-#,##0 'LBP' 'LBP'", "-", " 'LBP'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b618086652 = l(["", , 1, 2, 2, , , 0, 3, , " 'MAD'", "#,##0.00 'MAD'", "-#,##0.00 'MAD' 'MAD'", "-", " 'MAD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b331795142 = l(["", , 1, 2, 2, , , 0, 3, , " 'MKD'", "#,##0.00 'MKD'", "-#,##0.00 'MKD' 'MKD'", "-", " 'MKD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a49619031 = l(["", , 1, 2, 2, , , 0, 3, , " 'MXN'", "#,##0.00 'MXN'", "-#,##0.00 'MXN' 'MXN'", "-", " 'MXN'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a81942266 = l(["", , 1, 2, 2, , , 0, 3, , " 'MYR'", "#,##0.00 'MYR'", "-#,##0.00 'MYR' 'MYR'", "-", " 'MYR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a450427145 = l(["", , 1, 2, 2, , , 0, 3, , " 'NGN'", "#,##0.00 'NGN'", "-#,##0.00 'NGN' 'NGN'", "-", " 'NGN'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a676689790 = l(["", , 1, 2, 2, , , 0, 3, , " 'NOK'", "#,##0.00 'NOK'", "-#,##0.00 'NOK' 'NOK'", "-", " 'NOK'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a985145804 = l(["", , 1, 2, 2, , , 0, 3, , " 'NZD'", "#,##0.00 'NZD'", "-#,##0.00 'NZD' 'NZD'", "-", " 'NZD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2126791091 = l(["", , 1, 2, 2, , , 0, 3, , " 'PEN'", "#,##0.00 'PEN'", "-#,##0.00 'PEN' 'PEN'", "-", " 'PEN'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2039056596 = l(["", , 1, 2, 2, , , 0, 3, , " 'PHP'", "#,##0.00 'PHP'", "-#,##0.00 'PHP' 'PHP'", "-", " 'PHP'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1214955363 = l(["", , 1, 0, 0, , , , 3, , " 'PKR'", "#,##0 'PKR'", "-#,##0 'PKR' 'PKR'", "-", " 'PKR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1926387034 = l(["", , 1, 2, 2, , , 0, 3, , " 'PLN'", "#,##0.00 'PLN'", "-#,##0.00 'PLN' 'PLN'", "-", " 'PLN'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1350109930 = l(["", , 1, 2, 2, , , 0, 3, , " 'QAR'", "#,##0.00 'QAR'", "-#,##0.00 'QAR' 'QAR'", "-", " 'QAR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b65492219 = l(["", , 1, 2, 2, , , 0, 3, , " 'RON'", "#,##0.00 'RON'", "-#,##0.00 'RON' 'RON'", "-", " 'RON'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a776155913 = l(["", , 1, 0, 0, , , , 3, , " 'RSD'", "#,##0 'RSD'", "-#,##0 'RSD' 'RSD'", "-", " 'RSD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a95200435 = l(["", , 1, 2, 2, , , 0, 3, , " 'RUB'", "#,##0.00 'RUB'", "-#,##0.00 'RUB' 'RUB'", "-", " 'RUB'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a424897432 = l(["", , 1, 2, 2, , , 0, 3, , " 'SAR'", "#,##0.00 'SAR'", "-#,##0.00 'SAR' 'SAR'", "-", " 'SAR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a532949389 = l(["", , 1, 2, 2, , , 0, 3, , " 'SEK'", "#,##0.00 'SEK'", "-#,##0.00 'SEK' 'SEK'", "-", " 'SEK'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a583743044 = l(["", , 1, 2, 2, , , 0, 3, , " 'SGD'", "#,##0.00 'SGD'", "-#,##0.00 'SGD' 'SGD'", "-", " 'SGD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1498028834 = l(["", , 1, 2, 2, , , 0, 3, , " 'THB'", "#,##0.00 'THB'", "-#,##0.00 'THB' 'THB'", "-", " 'THB'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1383722094 = l(["", , 1, 3, 3, , , 0, 3, , " 'TND'", "#,##0.000 'TND'", "-#,##0.000 'TND' 'TND'", "-", " 'TND'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1805561327 = l(["", , 1, 2, 2, , , 0, 3, , " 'TRY'", "#,##0.00 'TRY'", "-#,##0.00 'TRY' 'TRY'", "-", " 'TRY'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1929313141 = l(["", , 1, 2, 2, , , 0, 3, , " 'TWD'", "#,##0.00 'TWD'", "-#,##0.00 'TWD' 'TWD'", "-", " 'TWD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1529547149 = l(["", , 1, 0, 0, , , , 3, , " 'TZS'", "#,##0 'TZS'", "-#,##0 'TZS' 'TZS'", "-", " 'TZS'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b2104297712 = l(["", , 1, 2, 2, , , 0, 3, , " 'UAH'", "#,##0.00 'UAH'", "-#,##0.00 'UAH' 'UAH'", "-", " 'UAH'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1181379732 = l(["", , 1, 0, 0, , , , 3, , " 'UGX'", "#,##0 'UGX'", "-#,##0 'UGX' 'UGX'", "-", " 'UGX'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1592667078 = l(["", , 1, 2, 2, , , 0, 3, , " 'USD'", "#,##0.00 'USD'", "-#,##0.00 'USD' 'USD'", "-", " 'USD'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1104124469 = l(["", , 1, 2, 2, , , 0, 3, , " 'VEF'", "#,##0.00 'VEF'", "-#,##0.00 'VEF' 'VEF'", "-", " 'VEF'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b111942414 = l(["", , 1, 0, 0, , , , 3, , " 'VND'", "#,##0 'VND'", "-#,##0 'VND' 'VND'", "-", " 'VND'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1952511393 = l(["", , 1, 2, 2, , , 0, 3, , " 'ZAR'", "#,##0.00 'ZAR'", "-#,##0.00 'ZAR' 'ZAR'", "-", " 'ZAR'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.b1604343976 = l(["", , 1, 2, 2, , , 0, 3, , " 'ZMW'", "#,##0.00 'ZMW'", "-#,##0.00 'ZMW' 'ZMW'", "-", " 'ZMW'", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1169375047 = l(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a165136106 = l(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], k("hr").pluralGenerator({}))),
                (k.b389595604 = l(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], k("hr").pluralGenerator({}))),
                (k.b731878259 = l(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", c("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (k.a1751927673 = b(function (a) {
                ...
                (k.a529544955 = m(k("hr").numberFormatter({ raw: "#,##0.00 'AED'" }))),
                (k.b1618830662 = m(k("hr").numberFormatter({ raw: "#,##0 'ALL'" }))),
                (k.b388371815 = m(k("hr").numberFormatter({ raw: "#,##0.00 'ARS'" }))),
                (k.a1844701963 = m(k("hr").numberFormatter({ raw: "#,##0.00 'AUD'" }))),
                (k.b1019997075 = m(k("hr").numberFormatter({ raw: "#,##0.00 'BAM'" }))),
                (k.a1842918025 = m(k("hr").numberFormatter({ raw: "#,##0.00 'BDT'" }))),
                (k.a38686866 = m(k("hr").numberFormatter({ raw: "#,##0.00 'BGN'" }))),
                (k.a639899037 = m(k("hr").numberFormatter({ raw: "#,##0.000 'BHD'" }))),
                (k.a1154034463 = m(k("hr").numberFormatter({ raw: "#,##0.00 'BRL'" }))),
                (k.b1051599456 = m(k("hr").numberFormatter({ raw: "#,##0 'BYR'" }))),
                (k.a465150901 = m(k("hr").numberFormatter({ raw: "#,##0.00 'CAD'" }))),
                (k.b1854999622 = m(k("hr").numberFormatter({ raw: "#,##0.00 'CHF'" }))),
                (k.a1981306612 = m(k("hr").numberFormatter({ raw: "#,##0 'CLP'" }))),
                (k.b280990963 = m(k("hr").numberFormatter({ raw: "#,##0.00 'CNY'" }))),
                (k.a348850359 = m(k("hr").numberFormatter({ raw: "#,##0 'COP'" }))),
                (k.a1378310503 = m(k("hr").numberFormatter({ raw: "#,##0.00 'CZK'" }))),
                (k.b1601499785 = m(k("hr").numberFormatter({ raw: "#,##0.00 'DKK'" }))),
                (k.b1374250515 = m(k("hr").numberFormatter({ raw: "#,##0.00 'DZD'" }))),
                (k.a1029408877 = m(k("hr").numberFormatter({ raw: "#,##0.00 'EGP'" }))),
                (k.a626816825 = m(k("hr").numberFormatter({ raw: "#,##0.00 'EUR'" }))),
                (k.a77511142 = m(k("hr").numberFormatter({ raw: "#,##0.00 'GBP'" }))),
                (k.a1193453385 = m(k("hr").numberFormatter({ raw: "#,##0.00 'GHS'" }))),
                (k.b1098662633 = m(k("hr").numberFormatter({ raw: "#,##0.00 'GTQ'" }))),
                (k.a874370202 = m(k("hr").numberFormatter({ raw: "#,##0.00 'HKD'" }))),
                (k.b1302634566 = m(k("hr").numberFormatter({ raw: "#,##0.00 'HRK'" }))),
                (k.a1216730722 = m(k("hr").numberFormatter({ raw: "#,##0.00 'HUF'" }))),
                (k.a1100430180 = m(k("hr").numberFormatter({ raw: "#,##0 'IDR'" }))),
                (k.b360845813 = m(k("hr").numberFormatter({ raw: "#,##0.00 'ILS'" }))),
                (k.a1385532398 = m(k("hr").numberFormatter({ raw: "#,##0.00 'INR'" }))),
                (k.b647731969 = m(k("hr").numberFormatter({ raw: "#,##0 'IQD'" }))),
                (k.a1327679450 = m(k("hr").numberFormatter({ raw: "#,##0 'ISK'" }))),
                (k.a808786856 = m(k("hr").numberFormatter({ raw: "#,##0 'JPY'" }))),
                (k.a1207216386 = m(k("hr").numberFormatter({ raw: "#,##0.00 'KES'" }))),
                (k.b25621045 = m(k("hr").numberFormatter({ raw: "#,##0 'KRW'" }))),
                (k.b427023805 = m(k("hr").numberFormatter({ raw: "#,##0.000 'KWD'" }))),
                (k.b1601413642 = m(k("hr").numberFormatter({ raw: "#,##0.00 'KZT'" }))),
                (k.a201628225 = m(k("hr").numberFormatter({ raw: "#,##0 'LBP'" }))),
                (k.a713385067 = m(k("hr").numberFormatter({ raw: "#,##0.00 'MAD'" }))),
                (k.a998487285 = m(k("hr").numberFormatter({ raw: "#,##0.00 'MKD'" }))),
                (k.b62575240 = m(k("hr").numberFormatter({ raw: "#,##0.00 'MXN'" }))),
                (k.a939445045 = m(k("hr").numberFormatter({ raw: "#,##0.00 'MYR'" }))),
                (k.b522425594 = m(k("hr").numberFormatter({ raw: "#,##0.00 'NGN'" }))),
                (k.b2098218191 = m(k("hr").numberFormatter({ raw: "#,##0.00 'NOK'" }))),
                (k.b1126016349 = m(k("hr").numberFormatter({ raw: "#,##0.00 'NZD'" }))),
                (k.a1188187714 = m(k("hr").numberFormatter({ raw: "#,##0.00 'PEN'" }))),
                (k.b387010237 = m(k("hr").numberFormatter({ raw: "#,##0.00 'PHP'" }))),
                (k.b1962208188 = m(k("hr").numberFormatter({ raw: "#,##0 'PKR'" }))),
                (k.b1189221111 = m(k("hr").numberFormatter({ raw: "#,##0.00 'PLN'" }))),
                (k.b504500071 = m(k("hr").numberFormatter({ raw: "#,##0.00 'QAR'" }))),
                (k.a663943306 = m(k("hr").numberFormatter({ raw: "#,##0.00 'RON'" }))),
                (k.b367300776 = m(k("hr").numberFormatter({ raw: "#,##0 'RSD'" }))),
                (k.a1350448284 = m(k("hr").numberFormatter({ raw: "#,##0.00 'RUB'" }))),
                (k.b1313846697 = m(k("hr").numberFormatter({ raw: "#,##0.00 'SAR'" }))),
                (k.a2035763970 = m(k("hr").numberFormatter({ raw: "#,##0.00 'SEK'" }))),
                (k.b684600021 = m(k("hr").numberFormatter({ raw: "#,##0.00 'SGD'" }))),
                (k.a1888455693 = m(k("hr").numberFormatter({ raw: "#,##0.00 'THB'" }))),
                (k.b1319198511 = m(k("hr").numberFormatter({ raw: "#,##0.000 'TND'" }))),
                (k.b1462938912 = m(k("hr").numberFormatter({ raw: "#,##0.00 'TRY'" }))),
                (k.b1921599974 = m(k("hr").numberFormatter({ raw: "#,##0.00 'TWD'" }))),
                (k.a1170348334 = m(k("hr").numberFormatter({ raw: "#,##0 'TZS'" }))),
                (k.a1885482463 = m(k("hr").numberFormatter({ raw: "#,##0.00 'UAH'" }))),
                (k.b921363627 = m(k("hr").numberFormatter({ raw: "#,##0 'UGX'" }))),
                (k.a566162933 = m(k("hr").numberFormatter({ raw: "#,##0.00 'USD'" }))),
                (k.b1468885372 = m(k("hr").numberFormatter({ raw: "#,##0.00 'VEF'" }))),
                (k.b2128545137 = m(k("hr").numberFormatter({ raw: "#,##0 'VND'" }))),
                (k.b1999076240 = m(k("hr").numberFormatter({ raw: "#,##0.00 'ZAR'" }))),
                (k.a204179095 = m(k("hr").numberFormatter({ raw: "#,##0.00 'ZMW'" }))),
                (k.a1146861939 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "d. MMM", timeSeparator: ":", months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.a547864010 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "d. MMM y.", timeSeparator: ":", months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.b1130499323 = f({ 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "hh:mm a", timeSeparator: ":", dayPeriods: { am: "AM", pm: "PM" } })),
                (k.a1166232430 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "E, d. MMM", timeSeparator: ":", days: { E: { 1: { sun: "ned", mon: "pon", tue: "uto", wed: "sri", thu: "čet", fri: "pet", sat: "sub" } } }, months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.b222834185 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "E, d. MMM y.", timeSeparator: ":", days: { E: { 1: { sun: "ned", mon: "pon", tue: "uto", wed: "sri", thu: "čet", fri: "pet", sat: "sub" } } }, months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.a1173620598 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "d. MMMM", timeSeparator: ":", months: { M: { 4: { 1: "siječnja", 2: "veljače", 3: "ožujka", 4: "travnja", 5: "svibnja", 6: "lipnja", 7: "srpnja", 8: "kolovoza", 9: "rujna", 10: "listopada", 11: "studenoga", 12: "prosinca" } } } })),
                (k.b1335807524 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "d. MMMM y. 'u' HH:mm:ss z", timeSeparator: ":", months: { M: { 4: { 1: "siječnja", 2: "veljače", 3: "ožujka", 4: "travnja", 5: "svibnja", 6: "lipnja", 7: "srpnja", 8: "kolovoza", 9: "rujna", 10: "listopada", 11: "studenoga", 12: "prosinca" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: ["+H; -H", "+H:mm; -H:mm"] })),
                (k.b1719546715 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "d. MMM y. hh:mm a", timeSeparator: ":", months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } }, dayPeriods: { am: "AM", pm: "PM" } })),
                (k.a1384467663 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "d. MMMM y.", timeSeparator: ":", months: { M: { 4: { 1: "siječnja", 2: "veljače", 3: "ožujka", 4: "travnja", 5: "svibnja", 6: "lipnja", 7: "srpnja", 8: "kolovoza", 9: "rujna", 10: "listopada", 11: "studenoga", 12: "prosinca" } } } })),
                (k.b1608154610 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "d. MMM hh:mm a", timeSeparator: ":", months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } }, dayPeriods: { am: "AM", pm: "PM" } })),
                (k.a1702148253 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "dd. MM. y.", timeSeparator: ":" })),
                (k.b1005861887 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "y.", timeSeparator: ":" })),
                (k.a1541633046 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "LLL y.", timeSeparator: ":", months: { L: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.a2099181801 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "EEEE, d. MMMM y. 'u' HH:mm:ss (zzzz)", timeSeparator: ":", days: { E: { 4: { sun: "nedjelja", mon: "ponedjeljak", tue: "utorak", wed: "srijeda", thu: "četvrtak", fri: "petak", sat: "subota" } } }, months: { M: { 4: { 1: "siječnja", 2: "veljače", 3: "ožujka", 4: "travnja", 5: "svibnja", 6: "lipnja", 7: "srpnja", 8: "kolovoza", 9: "rujna", 10: "listopada", 11: "studenoga", 12: "prosinca" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: "+HH:mm; -HH:mm" })),
                (k.b1723218749 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "d. MMM y. HH:mm:ss", timeSeparator: ":", months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.a569104993 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "dd. MM. y.", timeSeparator: ":" })),
                (k.b1937474530 = f({ 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "HH:mm", timeSeparator: ":" })),
                (k.b1690230576 = f({ 1: k("hr").numberFormatter({ raw: "0" }), 2: k("hr").numberFormatter({ raw: "00" }) }, { pattern: "E h:mm a", timeSeparator: ":", days: { E: { 1: { sun: "ned", mon: "pon", tue: "uto", wed: "sri", thu: "čet", fri: "pet", sat: "sub" } } }, dayPeriods: { am: "AM", pm: "PM" } })),
                (k.a547178817 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "LLLL y.", timeSeparator: ":", months: { L: { 4: { 1: "siječanj", 2: "veljača", 3: "ožujak", 4: "travanj", 5: "svibanj", 6: "lipanj", 7: "srpanj", 8: "kolovoz", 9: "rujan", 10: "listopad", 11: "studeni", 12: "prosinac" } } } })),
                (k.a1121119990 = f({ 1: k("hr").numberFormatter({ raw: "0" }) }, { pattern: "d. MMM y.", timeSeparator: ":", months: { M: { 3: { 1: "sij", 2: "velj", 3: "ožu", 4: "tra", 5: "svi", 6: "lip", 7: "srp", 8: "kol", 9: "ruj", 10: "lis", 11: "stu", 12: "pro" } } } })),
                (k.a1146176746 = f({}, { pattern: "LLLL", timeSeparator: ":", months: { L: { 4: { 1: "siječanj", 2: "veljača", 3: "ožujak", 4: "travanj", 5: "svibanj", 6: "lipanj", 7: "srpanj", 8: "kolovoz", 9: "rujan", 10: "listopad", 11: "studeni", 12: "prosinac" } } } })),
                (k.b1895545110 = f({}, { pattern: "cccc", timeSeparator: ":", days: { c: { 4: { sun: "nedjelja", mon: "ponedjeljak", tue: "utorak", wed: "srijeda", thu: "četvrtak", fri: "petak", sat: "subota" } } } })),
                (k.a755454858 = z(k("hr").dateToPartsFormatter({ skeleton: "MMMd" }))),
                (k.a1299146387 = z(k("hr").dateToPartsFormatter({ skeleton: "yMMMd" }))),
                (k.b1966659876 = z(k("hr").dateToPartsFormatter({ skeleton: "hm" }))),
                (k.a1917514807 = z(k("hr").dateToPartsFormatter({ skeleton: "MMMEd" }))),
                (k.a1592083022 = z(k("hr").dateToPartsFormatter({ skeleton: "yMMMEd" }))),
                (k.a1924902975 = z(k("hr").dateToPartsFormatter({ skeleton: "MMMMd" }))),
                (k.b1727214605 = z(k("hr").dateToPartsFormatter({ datetime: "long" }))),
                (k.b1291688146 = z(k("hr").dateToPartsFormatter({ skeleton: "yMMMdhm" }))),
                (k.b2008577434 = z(k("hr").dateToPartsFormatter({ date: "long" }))),
                (k.a206762597 = z(k("hr").dateToPartsFormatter({ skeleton: "MMMdhm" }))),
                (k.b403034650 = z(k("hr").dateToPartsFormatter({ date: "short" }))),
                (k.a1183922506 = z(k("hr").dateToPartsFormatter({ skeleton: "y" }))),
                (k.a1150225965 = z(k("hr").dateToPartsFormatter({ skeleton: "yMMM" }))),
                (k.a1707774720 = z(k("hr").dateToPartsFormatter({ datetime: "full" }))),
                (k.a91698458 = z(k("hr").dateToPartsFormatter({ datetime: "medium" }))),
                (k.a1320387370 = z(k("hr").dateToPartsFormatter({ skeleton: "yMMdd" }))),
                (k.a252309863 = z(k("hr").dateToPartsFormatter({ time: "short" }))),
                (k.b1841403943 = z(k("hr").dateToPartsFormatter({ skeleton: "Ehm" }))),
                (k.a1298461194 = z(k("hr").dateToPartsFormatter({ skeleton: "yMMMM" }))),
                (k.a284959437 = z(k("hr").dateToPartsFormatter({ date: "medium" }))),
                (k.a754769665 = z(k("hr").dateToPartsFormatter({ skeleton: "MMMM" }))),
                (k.a2008015105 = z(k("hr").dateToPartsFormatter({ skeleton: "EEEE" }))),
                (k.a1102215895 = g(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { "relativeTime-type-future": { "relativeTimePattern-count-one": "za {0} dan", "relativeTimePattern-count-few": "za {0} dana", "relativeTimePattern-count-other": "za {0} dana" }, "relativeTime-type-past": { "relativeTimePattern-count-one": "prije {0} dan", "relativeTimePattern-count-few": "prije {0} dana", "relativeTimePattern-count-other": "prije {0} dana" }, "relative-type--2": "prekjučer", "relative-type--1": "jučer", "relative-type-0": "danas", "relative-type-1": "sutra", "relative-type-2": "prekosutra" })),
                (k.a897988796 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "sekunde", one: "{0} sekunda", few: "{0} sekunde", other: "{0} sekundi", perUnitPattern: "{0}/s" } })),
                (k.b988974500 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "minute", one: "{0} minuta", few: "{0} minute", other: "{0} minuta", perUnitPattern: "{0}/min" } })),
                (k.b1742809108 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "sati", one: "{0} sat", few: "{0} sata", other: "{0} sati", perUnitPattern: "{0}/h" } })),
                (k.a1370171645 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (k.a474643101 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "min", one: "{0} m", few: "{0} m", other: "{0} m", perUnitPattern: "{0}/min" } })),
                (k.a1889057837 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "h", one: "{0} h", few: "{0} h", other: "{0} h", perUnitPattern: "{0}/h" } })),
                (k.a1876399191 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "d.", one: "{0} d.", few: "{0} d.", other: "{0} d.", perUnitPattern: "{0}/d." } })),
                (k.a246002326 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "dani", one: "{0} dan", few: "{0} dana", other: "{0} dana", perUnitPattern: "{0} dnevno" } })),
                (k.b1073804549 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "mj.", one: "{0} mj.", few: "{0} mj.", other: "{0} mj.", perUnitPattern: "{0}/mj." } })),
                (k.b221871558 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "mjeseci", one: "{0} mjesec", few: "{0} mjeseca", other: "{0} mjeseci", perUnitPattern: "{0} mjesečno" } })),
                (k.b1001347066 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "g.", one: "{0} g.", few: "{0} g.", other: "{0} g.", perUnitPattern: "{0}/g." } })),
                (k.b262019579 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "godine", one: "{0} godina", few: "{0} godine", other: "{0} godina", perUnitPattern: "{0} godišnje" } })),
                (k.b493794736 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (k.a1139885232 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "min", one: "{0} min", few: "{0} min", other: "{0} min", perUnitPattern: "{0}/min" } })),
                (k.b754151136 = P(k("hr").numberFormatter({}), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "h", one: "{0} h", few: "{0} h", other: "{0} h", perUnitPattern: "{0}/h" } })),
                (k.b2079324911 = P(k("hr").numberFormatter({ minimumFractionDigits: 1, maximumFractionDigits: 1, round: "truncate" }), k("hr").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                o("d58baa7f", k.a1673306623),
                o("ia24dc8d", k.b378804789),
                o("iab73d4b", k.a1874145295),
                o("i3b7a017", k.a897988796),
                o("ie5d110f", k.b988974500),
                o("df5f11b3", k.b1742809108),
                o("e8733ed9", k.a1370171645),
                o("be59d8c3", k.a474643101),
                o("i3d087db", k.a1889057837),
                o("ga8d18c9", k.a1876399191),
                o("a91e7d49", k.a246002326),
                o("id952a69", k.b1073804549),
                o("ga09ab65", k.b221871558),
                o("c83b901d", k.b1001347066),
                o("a55b9fed", k.b262019579),
                o("ccaa970f", k.a755454858),
                o("jade381b", k.a1299146387),
                o("d725a289", k.b1966659876),
                o("g08cbabb", k.b583604384),
                o("c333da63", k.a1102215895),
                o("h8054d91", k.a1917514807),
                o("i61fef37", k.b493794736),
                o("ba705e27", k.a1139885232),
                o("j86b0d8d", k.b754151136),
                o("f668e929", k.b304867764),
                o("i2785009", k.a1821600953),
                o("c778d80b", k.b2143600582),
                o("e8d93005", k.b1815786458),
                o("d46781af", k.b2079324911),
                o("ba316f05", k.b1537136887),
                o("c0bdd345", k.a1689355143),
                o("aa2aa1a1", k.a1592083022),
                o("da44942d", k.a1924902975),
                o("a54d3ef5", k.b1727214605),
                o("bfbc051d", k.b1291688146),
                o("ba2e82a1", k.b2008577434),
                o("fc209bb7", k.a206762597),
                o("cf8abf59", k.b35860779),
                o("a9f397f3", k.b403034650),
                o("d857e44d", k.a529544955),
                o("cb87e3db", k.b1618830662),
                o("a9d5ffd1", k.b388371815),
                o("a0e8371d", k.a1844701963),
                o("gcc50dc9", k.b1019997075),
                o("a6a43585", k.a1842918025),
                o("a0cc8f2d", k.a38686866),
                o("i31c32c5", k.a639899037),
                o("i7dc69e9", k.a1154034463),
                o("c14a6c03", k.b1051599456),
                o("jaa3d537", k.a465150901),
                o("a824080b", k.b1854999622),
                o("d9c0bedb", k.a1981306612),
                o("bf8c0613", k.b280990963),
                o("i8163625", k.a348850359),
                o("adb53ba1", k.a1378310503),
                o("iabf697d", k.b1601499785),
                o("a1a0555b", k.b1374250515),
                o("f266f3d9", k.a1029408877),
                o("a9a8652b", k.a626816825),
                o("dbf40761", k.a77511142),
                o("b0d993d9", k.a1193453385),
                o("ac1308e1", k.b1098662633),
                o("a7889ab3", k.a874370202),
                o("c614f5cd", k.b1302634566),
                o("i55d57e3", k.a1216730722),
                o("e4b6002b", k.a1100430180),
                o("d28e983b", k.b360845813),
                o("e8c9232d", k.a1385532398),
                o("c8994ae1", k.b647731969),
                o("f821c2a5", k.a1327679450),
                o("j348b9c9", k.a808786856),
                o("i6f93b9b", k.a1207216386),
                o("c6150bd5", k.b25621045),
                o("i8921e09", k.b427023805),
                o("ef239279", k.b1601413642),
                o("hecdb149", k.a201628225),
                o("fdd039b7", k.a713385067),
                o("f30c2c37", k.a998487285),
                o("d9ea7bff", k.b62575240),
                o("ea3df4b7", k.a939445045),
                o("jaac21bb", k.b522425594),
                o("hb435ced", k.b2098218191),
                o("ce699d81", k.b1126016349),
                o("bc56d3d7", k.a1188187714),
                o("f8561913", k.b387010237),
                o("g6485d53", k.b1962208188),
                o("ff561cc1", k.b1189221111),
                o("b42011d3", k.b504500071),
                o("a6660bcd", k.a663943306),
                o("f9b80449", k.b367300776),
                o("gdee4d5d", k.a1350448284),
                o("h36f2103", k.b1313846697),
                o("a19ad037", k.a2035763970),
                o("g713f699", k.b684600021),
                o("ff2e39af", k.a1888455693),
                o("be34316d", k.b1319198511),
                o("aef81b75", k.b1462938912),
                o("fcce70a5", k.b1921599974),
                o("jc9d352f", k.a1170348334),
                o("be1cb8c5", k.a1885482463),
                o("j9371501", k.b921363627),
                o("j7d4397d", k.a566162933),
                o("d61441dd", k.b1468885372),
                o("e2a99e97", k.b2128545137),
                o("f7ce19ab", k.b1999076240),
                o("b2a0213f", k.a204179095),
                o("d7d71245", k.a1183922506),
                o("a2f2faab", k.a1150225965),
                o("g8d1b99b", k.a1707774720),
                o("d0a77c9b", k.a91698458),
                o("e18e399b", k.a1320387370),
                o("b6ca7bcb", k.a252309863),
                o("h0e4cdf5", k.b1841403943),
                o("g727ddcf", k.a1298461194),
                o("h3629783", k.a284959437),
                o("a20c68af", k.a754769665),
                o("ja781451", k.a1169375047),
                o("cfa1a7b9", k.a165136106),
                o("f3b9b9a7", k.a2008015105),
                o("eefcd267", k.b389595604),
                o("fa8afc43", k.b731878259);
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/hr.d19beb8a.js.map
