    ...
    ["i18n/hr"],
    {
        777511: (a, e, i) => {
            ...
            o("c39b0e24", "X"),
                ...
                o("b28602eb", function (a) {
                    return "Ostvarite " + a.percentage + " % popusta ovoga ljeta";
                }),
                o("he77d8e6", "Vremenski ograničena ponuda"),
            ...
            o("i560665f", "Saznajte više"),
                ...
                o("cbdddb0a", "Završeno"),
                o("ie2bbeed", function (a) {
                    return 'Pretražuje se upit "' + a.query + '"';
                }),
                o("b0d1e205", function (a) {
                    return 'Traži se **"' + a.query + '"**';
                }),
                o("bf970edd", function (a) {
                    return 'Pretražuje se upit "' + a.query + '" na platformi 𝕏';
                }),
                o("ad342369", function (a) {
                    return 'Pretražuje se upit "' + a.query + '" među korisnicima na platformi 𝕏';
                }),
                o("g008d475", function (a) {
                    return "Pregledavanje web-mjesta " + a.url;
                }),
                o("c91e3971", function (a) {
                    return "Pregledava se " + a.url + ' za "' + a.query + '"';
                }),
                o("acb9b845", function (a) {
                    return "Pregledava se " + a.url + ' za **"' + a.query + '"**';
                }),
                o("j9006405", function (a) {
                    return "Pretražuju se objave korisnika @" + a.username + " na platformi 𝕏";
                }),
                o("a2dd07e5", function (a) {
                    return "Pretražuju se objave korisnika @" + a.username + ' za upit "' + a.query + '" na platformi 𝕏';
                }),
                o("e99fb7a3", function (a) {
                    return "Pretražuju se objave korisnika @" + a.username + ' za upit **"' + a.query + '"** na platformi 𝕏';
                }),
                o("a02d1657", function (a) {
                    return "Izvršavanje koda" + a.ttc_tool_usage_card;
                }),
                o("aa9d42c0", "Traženje na webu"),
                o("c731d702", "Searching on X"),
                o("d0e02476", "Searching users on X"),
                o("c43ef93e", "Pregledavanje web-stranice"),
                o("dab166ec", "Searching user posts on X"),
                o("jb097f6e", "Izvršavanje koda"),
                ...
                o("d6b533dc", "Ocijenite taj prijevod:"),
                o("j2f9ab6e", "Hvala na povratnim informacijama!"),
                ...
                o("ba10dab6", "Automatski prijevod kojeg pruža Grok"),
                o("he9c9634", "Nije moguće dohvatiti prijevod"),
                o("j2198c98", "Sakrij prevedenu objavu"),
                o("d4d35bea", "Prevođenje..."),
                o("f4f69be8", "Prikaži original"),
                o("e3097a5c", "Prikaži automatski prijevod objave"),
                o("e0f81ff3", "Prijevod:"),
                o("j2862695", function (a) {
                    return "Translated from " + a.originLanguage + " by";
                }),
                o("b7cb4fab", "Prevedeno pomoću servisa "),
                o("e0bffbf8", "O automatskom prijevodu"),
                o("e839db3a", "Odbaci"),
                o("e7a86c77", function (a) {
                    return "Automatski prijevod na " + a.language;
                }),
                o("c60b9e5c", "Promjene će se primijeniti za novi učitani sadržaj."),
                o("f9317b98", "postavkama jezika"),
                o("hba0547a", "Ažuriranje postavki nije uspjelo. Pokušajte ponovno kasnije."),
                ...
                o("a599bbfa", "Dodaj/ukloni s popisa"),
                ...
                o("g00b4c55", function (a) {
                    return "Podijeli @" + a.screenName + " putem...";
                }),
            ...
            o("fc56c8b1", function (a) {
                ...
                o("b0a889d4", "Kao slika"),
                o("a111fb48", "Kao proračunska tablica"),
                o("bccc65f0", "Grok može pogriješiti. Uvijek provjerite izvornik."),
                o("bd202fe6", "Generira se kartica"),
                o("bfd161bc", "Usporedi"),
                ...
                o("ha9c4cf8", "Prikaži izvor"),
                o("ecad5d78", "Spremi sliku"),
                o("d2d1d398", "Kopirano!"),
                ...
                o("dc17968a", "Pet"),
                o("j310a2d6", "Sub"),
                o("db6c20cf", function (a) {
                    return "Prikaži sve (" + a.count + ")";
                }),
                o("df601d92", "Relevantni korisnici"),
                o("a4cfb8a8", "Pregledavanje"),
            ...
            o("f19846b2", "Sličica videozapisa"),
                ...
                o("icdb6d74", "Predložio eksperimentalni AI suradnik kao odgovor na zahtjev za zabilješku. Kao i svi suradnici, AI može pogriješiti — provjerite točnost."),
                ...
                o("j42c88b6", "Eksperimentalni AI alat za pisanje bilješki"),
            ...
            o("ed88e742", "Kopiraj poveznicu na temu"),
                ...
                o("f7cf3d36", "Grok je besplatni AI asistent kojeg pruža xAI radi povećavanja istinitosti i objektivnosti objava. Grok nudi pretraživanje u stvarnom vremenu, generiranje slika, analiziranje trendova i još mnogo toga."),
                o("hc965308", "Zabava"),
                o("eb78b77e", "Zabavni način rada"),
                o("ac164552", "Otvori grok.com"),
            ...
            o("b075c68a", "Uredi posao"),
                ...
                o("dde0dbe0", "Iskoristite našu ljetnu ponudu koja istječe:"),
                o("f8a50ba7", function (a) {
                    return "Ljetna ponuda istječe " + a.date + ".";
                }),
                ...
                o("dc9661b3", function (a) {
                    return a.seconds + " sekund" + n(a.seconds, "e", "a", "i");
                }),
                ...
                o("ibf92e4a", "Uspješno plaćanje"),
                o("bdf0fb06", "Vaša pretplata je aktivirana."),
                o("ddfd6718", "Plaćanje nije uspjelo"),
                o("d42fa852", "Došlo je do problema s obradom plaćanja. Pokušajte ponovno."),
                o("g055a9ce", "Otvorite aplikaciju 𝕏"),
            ...
            o("c5d9c77a", "Izgleda da je došlo do manjih poteškoća u radu. Ne brinite, nije vaša greška. Zatvorite taj prozor i pokušajte ponovno."),
                ...
                o("h7e1c146", "Trenutačno nisu podržani delegirani računi."),
                ...
                return (
                    ...
                    (v = [
                        ...
                        },
                        {
                            key: "c4c230bf",
                            get: function () {
                                return ["Grok će automatski prevoditi ovisno o vašoj upotrebi platforme X i ", ". U nastavku možete uključiti i postavke automatskog prijevoda."];
                            },
                        },
                        {
                            key: "db79453f",
            ...
            })(i(111677)._ActualI18NFormatMessage || j.Component);
            ...
            (p.a1673306623 = c(["", , 1, 0, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", k("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 tis'.'", few: "0 tis'.'", other: "0 tis'.'" }, 4: { one: "00 tis'.'", few: "00 tis'.'", other: "00 tis'.'" }, 5: { one: "000 tis'.'", few: "000 tis'.'", other: "000 tis'.'" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mlr'.'", few: "0 mlr'.'", other: "0 mlr'.'" }, 10: { one: "00 mlr'.'", few: "00 mlr'.'", other: "00 mlr'.'" }, 11: { one: "000 mlr'.'", few: "000 mlr'.'", other: "000 mlr'.'" }, 12: { one: "0 bil'.'", few: "0 bil'.'", other: "0 bil'.'" }, 13: { one: "00 bil'.'", few: "00 bil'.'", other: "00 bil'.'" }, 14: { one: "000 bil'.'", few: "000 bil'.'", other: "000 bil'.'" }, maxExponent: 14 }], p("hr").pluralGenerator({}))),
                ...
                (p.b1727214605 = f(p("hr").dateToPartsFormatter({ datetime: "long" }))),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/hr.52dca7da.js.map
