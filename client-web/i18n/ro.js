        ...
        79767: (e, a, i) => {
            ...
            t("c39b0e24", "X"),
                ...
                t("b28602eb", function (e) {
                    return "Primește " + e.percentage + "% reducere vara aceasta";
                }),
                t("he77d8e6", "Ofertă disponibilă pentru o perioadă limitată"),
            ...
            t("b0abbb17", "Află mai multe"),
                ...
                t("bf970edd", function (e) {
                    return "Se caută „" + e.query + "” pe 𝕏";
                }),
                t("ad342369", function (e) {
                    return "Caută „" + e.query + "” în utilizatorii 𝕏";
                }),
                t("g008d475", function (e) {
                    return "Navighează pe " + e.url;
                }),
                ...
                t("j9006405", function (e) {
                    return "Se caută postări pe 𝕏 ale utilizatorului @" + e.username;
                }),
                t("a2dd07e5", function (e) {
                    return "Se caută postări pe 𝕏 ale utilizatorului @" + e.username + " referitoare la „" + e.query + "”";
                }),
                t("e99fb7a3", function (e) {
                    return "Se caută postări pe 𝕏 ale utilizatorului @" + e.username + " referitoare la **„" + e.query + "”**";
                }),
                t("a02d1657", function (e) {
                    return "Execută codul" + e.ttc_tool_usage_card;
                }),
                t("aa9d42c0", "Searching the web"),
                t("dce1817a", "Searching on 𝕏"),
                t("f7151564", "Searching users on 𝕏"),
                t("c43ef93e", "Browsing web page"),
                t("jb097f6e", "Execută codul"),
                ...
                t("d6b533dc", "Evaluează această traducere:"),
                t("j2f9ab6e", "Mulțumim pentru feedback!"),
                ...
                t("ba10dab6", "Tradus automat de Grok"),
                t("he9c9634", "Nu s-a putut prelua traducerea"),
                t("j2198c98", "Ascunde postarea tradusă"),
                t("d4d35bea", "Se traduce..."),
                t("f4f69be8", "Afișează versiunea originală"),
                t("e3097a5c", "Afișează traducerea automată a postării"),
                ...
                t("a599bbfa", "Adaugă/elimină din Liste"),
                ...
                t("g00b4c55", function (e) {
                    return "Distribuie @" + e.screenName + " prin...";
                }),
            ...
            t("iba0f45d", function (e) {
                ...
                t("b0a889d4", "Ca imagine"),
                t("a111fb48", "Ca foaie de calcul"),
                t("bccc65f0", "Grok poate face greșeli. Verifică întotdeauna sursele originale."),
                t("bd202fe6", "Se generează cardul"),
                t("bfd161bc", "Compară"),
                ...
                t("ha9c4cf8", "Vezi sursă"),
                t("ecad5d78", "Salvează imaginea"),
                t("d2d1d398", "Copiat!"),
                ...
                t("db6c20cf", function (e) {
                    return "Afișează tot (" + e.count + ")";
                }),
                t("df601d92", "Utilizatori relevanți"),
                t("a4cfb8a8", "Navighează pe"),
            ...
            t("f8fc0b48", "Creează un folder"),
                ...
                t("f7cf3d36", "Grok este un asistent AI gratuit, conceput de xAI pentru a maximiza adevărul și obiectivitatea. Grok oferă căutări în timp real, generare de imagini, analiza tendințelor și multe altele."),
                t("hc965308", "Distractiv"),
                t("eb78b77e", "Modul distractiv"),
                t("ac164552", "Mergi la grok.com"),
            ...
            t("af1cfd46", "Integrare ATS"),
                ...
                t("dde0dbe0", "Bucură-te de oferta verii până pe:"),
                t("f8a50ba7", function (e) {
                    return "Oferta verii se încheie pe " + e.date + ".";
                }),
                ...
                t("b9028f60", "Înapoi la versiunea de încercare fără reclame"),
                ...
                t("ibf92e4a", "Plată reușită"),
                t("bdf0fb06", "Your subscription has been activated."),
                t("ddfd6718", "Plata a eșuat"),
                t("d42fa852", "A survenit o problemă la procesarea plății. Încearcă din nou."),
            ...
            t("i5f14be7", function (e) {
                ...
                t("h7e1c146", "Conturile delegate nu sunt momentan acceptate."),
            ...
            (p.b322696590 = b(["", , 1, 0, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], p("ro").pluralGenerator({}))),
                (p.b95283842 = b(["", , 1, 0, 3, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b636222020 = b(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1003334920 = b(["", , 1, 0, 0, , , , , , "", "0", "-0", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1038280740 = b(["", , 2, 0, 0, , , , , , "", "00", "-00", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1715359699 = b(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], p("ro").pluralGenerator({}))),
                (p.b1555114375 = b(["", , 1, 0, 1, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b85257946 = b(["", , 1, 0, 0, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", m("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a244507815 = b(["", , 1, 0, 1, , , , 3, , " %", "#,##0 %", "-#,##0 % %", "-", " %", m("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a936959577 = b(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], p("ro").pluralGenerator({}))),
                (p.b1640076164 = b(["", , 1, 1, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1586415866 = b(["", , 1, 2, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1348242626 = b(["", , 1, 0, 0, 1, 2, , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], p("ro").pluralGenerator({}))),
                (p.a594047463 = b(["", , 1, 2, 2, , , 0, 3, , " 'AED'", "#,##0.00 'AED'", "-#,##0.00 'AED' 'AED'", "-", " 'AED'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b715757356 = b(["", , 1, 0, 0, , , , 3, , " 'ALL'", "#,##0 'ALL'", "-#,##0 'ALL' 'ALL'", "-", " 'ALL'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a980079241 = b(["", , 1, 2, 2, , , 0, 3, , " 'ARS'", "#,##0.00 'ARS'", "-#,##0.00 'ARS' 'ARS'", "-", " 'ARS'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1052113879 = b(["", , 1, 2, 2, , , 0, 3, , " 'AUD'", "#,##0.00 'AUD'", "-#,##0.00 'AUD' 'AUD'", "-", " 'AUD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1375346229 = b(["", , 1, 2, 2, , , 0, 3, , " 'BAM'", "#,##0.00 'BAM'", "-#,##0.00 'BAM' 'BAM'", "-", " 'BAM'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1467698329 = b(["", , 1, 2, 2, , , 0, 3, , " 'BDT'", "#,##0.00 'BDT'", "-#,##0.00 'BDT' 'BDT'", "-", " 'BDT'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1548044656 = b(["", , 1, 2, 2, , , 0, 3, , " 'BGN'", "#,##0.00 'BGN'", "-#,##0.00 'BGN' 'BGN'", "-", " 'BGN'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1522042127 = b(["", , 1, 3, 3, , , 0, 3, , " 'BHD'", "#,##0.000 'BHD'", "-#,##0.000 'BHD' 'BHD'", "-", " 'BHD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1861118275 = b(["", , 1, 2, 2, , , 0, 3, , " 'BRL'", "#,##0.00 'BRL'", "-#,##0.00 'BRL' 'BRL'", "-", " 'BRL'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a549466414 = b(["", , 1, 0, 0, , , , 3, , " 'BYR'", "#,##0 'BYR'", "-#,##0 'BYR' 'BYR'", "-", " 'BYR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b2040429075 = b(["", , 1, 2, 2, , , 0, 3, , " 'CAD'", "#,##0.00 'CAD'", "-#,##0.00 'CAD' 'CAD'", "-", " 'CAD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1838177976 = b(["", , 1, 2, 2, , , 0, 3, , " 'CHF'", "#,##0.00 'CHF'", "-#,##0.00 'CHF' 'CHF'", "-", " 'CHF'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1062944090 = b(["", , 1, 0, 0, , , , 3, , " 'CLP'", "#,##0 'CLP'", "-#,##0 'CLP' 'CLP'", "-", " 'CLP'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1648856171 = b(["", , 1, 2, 2, , , 0, 3, , " 'CNY'", "#,##0.00 'CNY'", "-#,##0.00 'CNY' 'CNY'", "-", " 'CNY'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1148831543 = b(["", , 1, 0, 0, , , , 3, , " 'COP'", "#,##0 'COP'", "-#,##0 'COP' 'COP'", "-", " 'COP'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1318235653 = b(["", , 1, 2, 2, , , 0, 3, , " 'CZK'", "#,##0.00 'CZK'", "-#,##0.00 'CZK' 'CZK'", "-", " 'CZK'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b860169237 = b(["", , 1, 2, 2, , , 0, 3, , " 'DKK'", "#,##0.00 'DKK'", "-#,##0.00 'DKK' 'DKK'", "-", " 'DKK'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b437196619 = b(["", , 1, 2, 2, , , 0, 3, , " 'DZD'", "#,##0.00 'DZD'", "-#,##0.00 'DZD' 'DZD'", "-", " 'DZD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b82564555 = b(["", , 1, 2, 2, , , 0, 3, , " 'EGP'", "#,##0.00 'EGP'", "-#,##0.00 'EGP' 'EGP'", "-", " 'EGP'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a320090601 = b(["", , 1, 2, 2, , , 0, 3, , " 'EUR'", "#,##0.00 'EUR'", "-#,##0.00 'EUR' 'EUR'", "-", " 'EUR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1549297052 = b(["", , 1, 2, 2, , , 0, 3, , " 'GBP'", "#,##0.00 'GBP'", "-#,##0.00 'GBP' 'GBP'", "-", " 'GBP'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1723842521 = b(["", , 1, 2, 2, , , 0, 3, , " 'GHS'", "#,##0.00 'GHS'", "-#,##0.00 'GHS' 'GHS'", "-", " 'GHS'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a2065545291 = b(["", , 1, 2, 2, , , 0, 3, , " 'GTQ'", "#,##0.00 'GTQ'", "-#,##0.00 'GTQ' 'GTQ'", "-", " 'GTQ'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1611586456 = b(["", , 1, 2, 2, , , 0, 3, , " 'HKD'", "#,##0.00 'HKD'", "-#,##0.00 'HKD' 'HKD'", "-", " 'HKD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1404717752 = b(["", , 1, 2, 2, , , 0, 3, , " 'HRK'", "#,##0.00 'HRK'", "-#,##0.00 'HRK' 'HRK'", "-", " 'HRK'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1323447904 = b(["", , 1, 2, 2, , , 0, 3, , " 'HUF'", "#,##0.00 'HUF'", "-#,##0.00 'HUF' 'HUF'", "-", " 'HUF'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1865812714 = b(["", , 1, 0, 0, , , , 3, , " 'IDR'", "#,##0 'IDR'", "-#,##0 'IDR' 'IDR'", "-", " 'IDR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b681600809 = b(["", , 1, 2, 2, , , 0, 3, , " 'ILS'", "#,##0.00 'ILS'", "-#,##0.00 'ILS' 'ILS'", "-", " 'ILS'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b625266028 = b(["", , 1, 2, 2, , , 0, 3, , " 'INR'", "#,##0.00 'INR'", "-#,##0.00 'INR' 'INR'", "-", " 'INR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b2069904913 = b(["", , 1, 0, 0, , , , 3, , " 'IQD'", "#,##0 'IQD'", "-#,##0 'IQD' 'IQD'", "-", " 'IQD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b2006181964 = b(["", , 1, 0, 0, , , , 3, , " 'ISK'", "#,##0 'ISK'", "-#,##0 'ISK' 'ISK'", "-", " 'ISK'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1191636442 = b(["", , 1, 0, 0, , , , 3, , " 'JPY'", "#,##0 'JPY'", "-#,##0 'JPY' 'JPY'", "-", " 'JPY'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a893002496 = b(["", , 1, 2, 2, , , 0, 3, , " 'KES'", "#,##0.00 'KES'", "-#,##0.00 'KES' 'KES'", "-", " 'KES'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b248721501 = b(["", , 1, 0, 0, , , , 3, , " 'KRW'", "#,##0 'KRW'", "-#,##0 'KRW' 'KRW'", "-", " 'KRW'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1349077929 = b(["", , 1, 3, 3, , , 0, 3, , " 'KWD'", "#,##0.000 'KWD'", "-#,##0.000 'KWD' 'KWD'", "-", " 'KWD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1495138188 = b(["", , 1, 2, 2, , , 0, 3, , " 'KZT'", "#,##0.00 'KZT'", "-#,##0.00 'KZT' 'KZT'", "-", " 'KZT'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a174251117 = b(["", , 1, 0, 0, , , , 3, , " 'LBP'", "#,##0 'LBP'", "-#,##0 'LBP' 'LBP'", "-", " 'LBP'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1755326857 = b(["", , 1, 2, 2, , , 0, 3, , " 'MAD'", "#,##0.00 'MAD'", "-#,##0.00 'MAD' 'MAD'", "-", " 'MAD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1469035347 = b(["", , 1, 2, 2, , , 0, 3, , " 'MKD'", "#,##0.00 'MKD'", "-#,##0.00 'MKD' 'MKD'", "-", " 'MKD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1087621174 = b(["", , 1, 2, 2, , , 0, 3, , " 'MXN'", "#,##0.00 'MXN'", "-#,##0.00 'MXN' 'MXN'", "-", " 'MXN'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1055297939 = b(["", , 1, 2, 2, , , 0, 3, , " 'MYR'", "#,##0.00 'MYR'", "-#,##0.00 'MYR' 'MYR'", "-", " 'MYR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b686813060 = b(["", , 1, 2, 2, , , 0, 3, , " 'NGN'", "#,##0.00 'NGN'", "-#,##0.00 'NGN' 'NGN'", "-", " 'NGN'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b460550415 = b(["", , 1, 2, 2, , , 0, 3, , " 'NOK'", "#,##0.00 'NOK'", "-#,##0.00 'NOK' 'NOK'", "-", " 'NOK'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b152094401 = b(["", , 1, 2, 2, , , 0, 3, , " 'NZD'", "#,##0.00 'NZD'", "-#,##0.00 'NZD' 'NZD'", "-", " 'NZD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1030936000 = b(["", , 1, 2, 2, , , 0, 3, , " 'PEN'", "#,##0.00 'PEN'", "-#,##0.00 'PEN' 'PEN'", "-", " 'PEN'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1118670495 = b(["", , 1, 2, 2, , , 0, 3, , " 'PHP'", "#,##0.00 'PHP'", "-#,##0.00 'PHP' 'PHP'", "-", " 'PHP'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b311192054 = b(["", , 1, 0, 0, , , , 3, , " 'PKR'", "#,##0 'PKR'", "-#,##0 'PKR' 'PKR'", "-", " 'PKR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1231340057 = b(["", , 1, 2, 2, , , 0, 3, , " 'PLN'", "#,##0.00 'PLN'", "-#,##0.00 'PLN' 'PLN'", "-", " 'PLN'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1807617161 = b(["", , 1, 2, 2, , , 0, 3, , " 'QAR'", "#,##0.00 'QAR'", "-#,##0.00 'QAR' 'QAR'", "-", " 'QAR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1202732424 = b(["", , 1, 2, 2, , , 0, 3, , " 'RON'", "#,##0.00 'RON'", "-#,##0.00 'RON' 'RON'", "-", " 'RON'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1679919222 = b(["", , 1, 0, 0, , , , 3, , " 'RSD'", "#,##0 'RSD'", "-#,##0 'RSD' 'RSD'", "-", " 'RSD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b1042039770 = b(["", , 1, 2, 2, , , 0, 3, , " 'RUB'", "#,##0.00 'RUB'", "-#,##0.00 'RUB' 'RUB'", "-", " 'RUB'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b712342773 = b(["", , 1, 2, 2, , , 0, 3, , " 'SAR'", "#,##0.00 'SAR'", "-#,##0.00 'SAR' 'SAR'", "-", " 'SAR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b604290816 = b(["", , 1, 2, 2, , , 0, 3, , " 'SEK'", "#,##0.00 'SEK'", "-#,##0.00 'SEK' 'SEK'", "-", " 'SEK'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b553497161 = b(["", , 1, 2, 2, , , 0, 3, , " 'SGD'", "#,##0.00 'SGD'", "-#,##0.00 'SGD' 'SGD'", "-", " 'SGD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a360788629 = b(["", , 1, 2, 2, , , 0, 3, , " 'THB'", "#,##0.00 'THB'", "-#,##0.00 'THB' 'THB'", "-", " 'THB'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a489014107 = b(["", , 1, 3, 3, , , 0, 3, , " 'TND'", "#,##0.000 'TND'", "-#,##0.000 'TND' 'TND'", "-", " 'TND'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a668321122 = b(["", , 1, 2, 2, , , 0, 3, , " 'TRY'", "#,##0.00 'TRY'", "-#,##0.00 'TRY' 'TRY'", "-", " 'TRY'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a792072936 = b(["", , 1, 2, 2, , , 0, 3, , " 'TWD'", "#,##0.00 'TWD'", "-#,##0.00 'TWD' 'TWD'", "-", " 'TWD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b625783840 = b(["", , 1, 0, 0, , , , 3, , " 'TZS'", "#,##0 'TZS'", "-#,##0 'TZS' 'TZS'", "-", " 'TZS'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1053429379 = b(["", , 1, 2, 2, , , 0, 3, , " 'UAH'", "#,##0.00 'UAH'", "-#,##0.00 'UAH' 'UAH'", "-", " 'UAH'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.b277616423 = b(["", , 1, 0, 0, , , , 3, , " 'UGX'", "#,##0 'UGX'", "-#,##0 'UGX' 'UGX'", "-", " 'UGX'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1565060013 = b(["", , 1, 2, 2, , , 0, 3, , " 'USD'", "#,##0.00 'USD'", "-#,##0.00 'USD' 'USD'", "-", " 'USD'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a2053602622 = b(["", , 1, 2, 2, , , 0, 3, , " 'VEF'", "#,##0.00 'VEF'", "-#,##0.00 'VEF' 'VEF'", "-", " 'VEF'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a791820895 = b(["", , 1, 0, 0, , , , 3, , " 'VND'", "#,##0 'VND'", "-#,##0 'VND' 'VND'", "-", " 'VND'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1205215698 = b(["", , 1, 2, 2, , , 0, 3, , " 'ZAR'", "#,##0.00 'ZAR'", "-#,##0.00 'ZAR' 'ZAR'", "-", " 'ZAR'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1553383115 = b(["", , 1, 2, 2, , , 0, 3, , " 'ZMW'", "#,##0.00 'ZMW'", "-#,##0.00 'ZMW' 'ZMW'", "-", " 'ZMW'", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a348458740 = b(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a1473766743 = b(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], p("ro").pluralGenerator({}))),
                (p.a919035033 = b(["", , 1, 0, 2, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m(), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], p("ro").pluralGenerator({}))),
                (p.a1052721722 = b(["", , 1, 0, 0, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("round"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }])),
                (p.a2035448620 = z(function (e) {
                ...
                (p.a1808121130 = A(p("ro").dateToPartsFormatter({ skeleton: "MMMEd" }))),
                (p.b1799120965 = A(p("ro").dateToPartsFormatter({ skeleton: "yMMMEd" }))),
                (p.a1815509298 = A(p("ro").dateToPartsFormatter({ skeleton: "MMMMd" }))),
                (p.b345270112 = A(p("ro").dateToPartsFormatter({ datetime: "long" }))),
                (p.a955170657 = A(p("ro").dateToPartsFormatter({ skeleton: "yMMMdhm" }))),
                (p.a1127855507 = A(p("ro").dateToPartsFormatter({ date: "long" }))),
                (p.a1110525906 = A(p("ro").dateToPartsFormatter({ skeleton: "MMMdhm" }))),
                (p.b1957861287 = A(p("ro").dateToPartsFormatter({ date: "short" }))),
                (p.b370904131 = A(p("ro").dateToPartsFormatter({ skeleton: "y" }))),
                (p.b1762796838 = A(p("ro").dateToPartsFormatter({ skeleton: "yMMM" }))),
                (p.b1205248083 = A(p("ro").dateToPartsFormatter({ datetime: "full" }))),
                (p.a995461767 = A(p("ro").dateToPartsFormatter({ datetime: "medium" }))),
                (p.a1210993693 = A(p("ro").dateToPartsFormatter({ skeleton: "yMMdd" }))),
                (p.b1302516774 = A(p("ro").dateToPartsFormatter({ time: "short" }))),
                (p.b1381183092 = A(p("ro").dateToPartsFormatter({ skeleton: "Ehm" }))),
                (p.a1189067517 = A(p("ro").dateToPartsFormatter({ skeleton: "yMMMM" }))),
                (p.b905007698 = A(p("ro").dateToPartsFormatter({ skeleton: "EEEE" }))),
                (p.b670026054 = A(p("ro").dateToPartsFormatter({ date: "medium" }))),
                (p.a2136714158 = A(p("ro").dateToPartsFormatter({ skeleton: "MMMM" }))),
                (p.b806037430 = h(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { "relativeTime-type-future": { "relativeTimePattern-count-one": "peste {0} zi", "relativeTimePattern-count-few": "peste {0} zile", "relativeTimePattern-count-other": "peste {0} de zile" }, "relativeTime-type-past": { "relativeTimePattern-count-one": "acum {0} zi", "relativeTimePattern-count-few": "acum {0} zile", "relativeTimePattern-count-other": "acum {0} de zile" }, "relative-type--2": "alaltăieri", "relative-type--1": "ieri", "relative-type-0": "azi", "relative-type-1": "mâine", "relative-type-2": "poimâine" })),
                (p.b239251409 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0} pe {1}", unitProperties: { displayName: "secunde", one: "{0} secundă", few: "{0} secunde", other: "{0} de secunde", perUnitPattern: "{0} pe secundă" } })),
                (p.b2126214705 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0} pe {1}", unitProperties: { displayName: "minute", one: "{0} minut", few: "{0} minute", other: "{0} de minute", perUnitPattern: "{0} pe minut" } })),
                (p.a504049695 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0} pe {1}", unitProperties: { displayName: "ore", one: "{0} oră", few: "{0} ore", other: "{0} de ore", perUnitPattern: "{0} pe oră" } })),
                (p.b595972176 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (p.b1491500720 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "m", one: "{0} m", few: "{0} m", other: "{0} m", perUnitPattern: "{0}/min." } })),
                (p.a751817632 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "oră", one: "{0} h", few: "{0} h", other: "{0} h", perUnitPattern: "{0}/h" } })),
                (p.b1485421948 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "zi", one: "{0} z", few: "{0} z", other: "{0} z", perUnitPattern: "{0}/zi" } })),
                (p.a1149765635 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0} pe {1}", unitProperties: { displayName: "zile", one: "{0} zi", few: "{0} zile", other: "{0} de zile", perUnitPattern: "{0} pe zi" } })),
                (p.b1968512536 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "l", one: "{0} l", few: "{0} l", other: "{0} l", perUnitPattern: "{0}/lună" } })),
                (p.a711274599 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0} pe {1}", unitProperties: { displayName: "luni", one: "{0} lună", few: "{0} luni", other: "{0} de luni", perUnitPattern: "{0} pe lună" } })),
                (p.b2138587271 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "a", one: "{0} a", few: "{0} a", other: "{0} a", perUnitPattern: "{0}/an" } })),
                (p.a1984839224 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0} pe {1}", unitProperties: { displayName: "ani", one: "{0} an", few: "{0} ani", other: "{0} de ani", perUnitPattern: "{0} pe an" } })),
                (p.b1388502723 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                (p.a245177245 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "min.", one: "{0} min.", few: "{0} min.", other: "{0} min.", perUnitPattern: "{0}/min." } })),
                (p.a178995021 = C(p("ro").numberFormatter({}), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "ore", one: "{0} oră", few: "{0} ore", other: "{0} ore", perUnitPattern: "{0}/h" } })),
                (p.a216304654 = C(p("ro").numberFormatter({ minimumFractionDigits: 1, maximumFractionDigits: 1, round: "truncate" }), p("ro").pluralGenerator({}), { compoundUnitPattern: "{0}/{1}", unitProperties: { displayName: "s", one: "{0} s", few: "{0} s", other: "{0} s", perUnitPattern: "{0}/s" } })),
                t("d58baa7f", p.b322696590),
                t("ia24dc8d", p.b95283842),
                t("iab73d4b", p.b636222020),
                t("i3b7a017", p.b239251409),
                t("ie5d110f", p.b2126214705),
                t("df5f11b3", p.a504049695),
                t("e8733ed9", p.b595972176),
                t("be59d8c3", p.b1491500720),
                t("i3d087db", p.a751817632),
                t("ga8d18c9", p.b1485421948),
                t("a91e7d49", p.a1149765635),
                t("id952a69", p.b1968512536),
                t("ga09ab65", p.a711274599),
                t("c83b901d", p.b2138587271),
                t("a55b9fed", p.a1984839224),
                t("ccaa970f", p.a2137399351),
                t("jade381b", p.a1189752710),
                t("d725a289", p.a1373321929),
                t("g08cbabb", p.a1715359699),
                t("c333da63", p.b806037430),
                t("h8054d91", p.a1808121130),
                t("i61fef37", p.b1388502723),
                t("ba705e27", p.a245177245),
                t("j86b0d8d", p.a178995021),
                t("f668e929", p.b1555114375),
                t("i2785009", p.b85257946),
                t("c778d80b", p.a244507815),
                t("e8d93005", p.a936959577),
                t("d46781af", p.a216304654),
                t("ba316f05", p.b1640076164),
                t("c0bdd345", p.a1586415866),
                t("aa2aa1a1", p.b1799120965),
                t("da44942d", p.a1815509298),
                t("a54d3ef5", p.b345270112),
                t("bfbc051d", p.a955170657),
                t("ba2e82a1", p.a1127855507),
                t("fc209bb7", p.a1110525906),
                t("cf8abf59", p.a1348242626),
                t("a9f397f3", p.b1957861287),
                t("d857e44d", p.b1378708370),
                t("cb87e3db", p.a767883309),
                t("a9d5ffd1", p.a1998342156),
                t("a0e8371d", p.b63551362),
                t("gcc50dc9", p.a1366716896),
                t("a6a43585", p.b65335300),
                t("a0cc8f2d", p.b1869566459),
                t("i31c32c5", p.b1268354288),
                t("i7dc69e9", p.b754218862),
                t("c14a6c03", p.a1335114515),
                t("jaa3d537", p.b1443102424),
                t("a824080b", p.a531714349),
                t("d9c0bedb", p.a73053287),
                t("bf8c0613", p.a2105723008),
                t("i8163625", p.b1559402966),
                t("adb53ba1", p.b529942822),
                t("iabf697d", p.a785214186),
                t("a1a0555b", p.a1012463456),
                t("f266f3d9", p.b878844448),
                t("a9a8652b", p.b1281436500),
                t("dbf40761", p.b1830742183),
                t("b0d993d9", p.b714799940),
                t("ac1308e1", p.a1288051338),
                t("a7889ab3", p.b1033883123),
                t("c614f5cd", p.a1084079405),
                t("i55d57e3", p.b691522603),
                t("e4b6002b", p.b807823145),
                t("d28e983b", p.a2025868158),
                t("e8c9232d", p.b522720927),
                t("c8994ae1", p.a1738982002),
                t("f821c2a5", p.b580573875),
                t("j348b9c9", p.b1099466469),
                t("i6f93b9b", p.b701036939),
                t("c6150bd5", p.b1933874370),
                t("i8921e09", p.a1959690166),
                t("ef239279", p.a785300329),
                t("hecdb149", p.b1706625100),
                t("fdd039b7", p.b1194868258),
                t("f30c2c37", p.b909766040),
                t("d9ea7bff", p.b1970828565),
                t("ea3df4b7", p.b968808280),
                t("jaac21bb", p.a1864288377),
                t("hb435ced", p.a288495780),
                t("ce699d81", p.a1260697622),
                t("bc56d3d7", p.b720065611),
                t("f8561913", p.a1999703734),
                t("g6485d53", p.a424505783),
                t("ff561cc1", p.a1197492860),
                t("b42011d3", p.a1882213900),
                t("a6660bcd", p.b1244310019),
                t("f9b80449", p.a2019413195),
                t("gdee4d5d", p.b557805041),
                t("h36f2103", p.a1072867274),
                t("a19ad037", p.a127510645),
                t("g713f699", p.a1702113950),
                t("ff2e39af", p.b19797632),
                t("be34316d", p.a1067515460),
                t("aef81b75", p.a923775059),
                t("fcce70a5", p.a465113997),
                t("jc9d352f", p.b737904991),
                t("be1cb8c5", p.b22770862),
                t("j9371501", p.a1465350344),
                t("j7d4397d", p.b1342090392),
                t("d61441dd", p.a917828599),
                t("e2a99e97", p.a258168834),
                t("f7ce19ab", p.a387637731),
                t("b2a0213f", p.b1704074230),
                t("d7d71245", p.b370904131),
                t("a2f2faab", p.b1762796838),
                t("g8d1b99b", p.b1205248083),
                t("d0a77c9b", p.a995461767),
                t("e18e399b", p.a1210993693),
                t("b6ca7bcb", p.b1302516774),
                t("h0e4cdf5", p.b1381183092),
                t("g727ddcf", p.a1189067517),
                t("f3b9b9a7", p.b905007698),
                t("h3629783", p.b670026054),
                t("a20c68af", p.a2136714158),
                t("ja781451", p.a348458740),
                t("cfa1a7b9", p.a1473766743),
                t("eefcd267", p.a919035033),
                t("fa8afc43", p.a1052721722);
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/ro.5b488ffa.js.map
