        ...
        79767: (e, a, i) => {
            ...
            t("c39b0e24", "X"),
                ...
                t("b28602eb", function (e) {
                    return "Primește o reducere de " + e.percentage + "% vara aceasta";
                }),
            ...
            t("b0abbb17", "Află mai multe"),
                ...
                t("ad342369", function (e) {
                    return "Se caută utilizatori 𝕏 pentru „" + e.query + "”";
                }),
            ...
            var m = f._numberRound,
                ...
                v = (f._validateParameterTypeDate, f._dateToPartsFormat, f._dateToPartsFormatterFn),
            ...
            (f.b322696590 = b(["", , 1, 0, 1, , , , 3, , "", "#,##0.###", "-#,##0.###", "-", "", m("truncate"), "∞", "NaN", { ".": ",", ",": ".", "%": "%", "+": "+", "-": "-", E: "E", "‰": "‰" }, , { 3: { one: "0 K", few: "0 K", other: "0 K" }, 4: { one: "00 K", few: "00 K", other: "00 K" }, 5: { one: "000 K", few: "000 K", other: "000 K" }, 6: { one: "0 mil'.'", few: "0 mil'.'", other: "0 mil'.'" }, 7: { one: "00 mil'.'", few: "00 mil'.'", other: "00 mil'.'" }, 8: { one: "000 mil'.'", few: "000 mil'.'", other: "000 mil'.'" }, 9: { one: "0 mld'.'", few: "0 mld'.'", other: "0 mld'.'" }, 10: { one: "00 mld'.'", few: "00 mld'.'", other: "00 mld'.'" }, 11: { one: "000 mld'.'", few: "000 mld'.'", other: "000 mld'.'" }, 12: { one: "0 tril'.'", few: "0 tril'.'", other: "0 tril'.'" }, 13: { one: "00 tril'.'", few: "00 tril'.'", other: "00 tril'.'" }, 14: { one: "000 tril'.'", few: "000 tril'.'", other: "000 tril'.'" }, maxExponent: 14 }], f("ro").pluralGenerator({}))),
                ...
                (f.b1378708370 = g(f("ro").numberFormatter({ raw: "#,##0.00 'AED'" }))),
                (f.a767883309 = g(f("ro").numberFormatter({ raw: "#,##0 'ALL'" }))),
                (f.a1998342156 = g(f("ro").numberFormatter({ raw: "#,##0.00 'ARS'" }))),
                (f.b63551362 = g(f("ro").numberFormatter({ raw: "#,##0.00 'AUD'" }))),
                (f.a1366716896 = g(f("ro").numberFormatter({ raw: "#,##0.00 'BAM'" }))),
                (f.b65335300 = g(f("ro").numberFormatter({ raw: "#,##0.00 'BDT'" }))),
                (f.b1869566459 = g(f("ro").numberFormatter({ raw: "#,##0.00 'BGN'" }))),
                (f.b1268354288 = g(f("ro").numberFormatter({ raw: "#,##0.000 'BHD'" }))),
                (f.b754218862 = g(f("ro").numberFormatter({ raw: "#,##0.00 'BRL'" }))),
                (f.a1335114515 = g(f("ro").numberFormatter({ raw: "#,##0 'BYR'" }))),
                (f.b1443102424 = g(f("ro").numberFormatter({ raw: "#,##0.00 'CAD'" }))),
                (f.a531714349 = g(f("ro").numberFormatter({ raw: "#,##0.00 'CHF'" }))),
                (f.a73053287 = g(f("ro").numberFormatter({ raw: "#,##0 'CLP'" }))),
                (f.a2105723008 = g(f("ro").numberFormatter({ raw: "#,##0.00 'CNY'" }))),
                (f.b1559402966 = g(f("ro").numberFormatter({ raw: "#,##0 'COP'" }))),
                (f.b529942822 = g(f("ro").numberFormatter({ raw: "#,##0.00 'CZK'" }))),
                (f.a785214186 = g(f("ro").numberFormatter({ raw: "#,##0.00 'DKK'" }))),
                (f.a1012463456 = g(f("ro").numberFormatter({ raw: "#,##0.00 'DZD'" }))),
                (f.b878844448 = g(f("ro").numberFormatter({ raw: "#,##0.00 'EGP'" }))),
                (f.b1281436500 = g(f("ro").numberFormatter({ raw: "#,##0.00 'EUR'" }))),
                (f.b1830742183 = g(f("ro").numberFormatter({ raw: "#,##0.00 'GBP'" }))),
                (f.b714799940 = g(f("ro").numberFormatter({ raw: "#,##0.00 'GHS'" }))),
                (f.a1288051338 = g(f("ro").numberFormatter({ raw: "#,##0.00 'GTQ'" }))),
                (f.b1033883123 = g(f("ro").numberFormatter({ raw: "#,##0.00 'HKD'" }))),
                (f.a1084079405 = g(f("ro").numberFormatter({ raw: "#,##0.00 'HRK'" }))),
                (f.b691522603 = g(f("ro").numberFormatter({ raw: "#,##0.00 'HUF'" }))),
                (f.b807823145 = g(f("ro").numberFormatter({ raw: "#,##0 'IDR'" }))),
                (f.a2025868158 = g(f("ro").numberFormatter({ raw: "#,##0.00 'ILS'" }))),
                (f.b522720927 = g(f("ro").numberFormatter({ raw: "#,##0.00 'INR'" }))),
                (f.a1738982002 = g(f("ro").numberFormatter({ raw: "#,##0 'IQD'" }))),
                (f.b580573875 = g(f("ro").numberFormatter({ raw: "#,##0 'ISK'" }))),
                (f.b1099466469 = g(f("ro").numberFormatter({ raw: "#,##0 'JPY'" }))),
                (f.b701036939 = g(f("ro").numberFormatter({ raw: "#,##0.00 'KES'" }))),
                (f.b1933874370 = g(f("ro").numberFormatter({ raw: "#,##0 'KRW'" }))),
                (f.a1959690166 = g(f("ro").numberFormatter({ raw: "#,##0.000 'KWD'" }))),
                (f.a785300329 = g(f("ro").numberFormatter({ raw: "#,##0.00 'KZT'" }))),
                (f.b1706625100 = g(f("ro").numberFormatter({ raw: "#,##0 'LBP'" }))),
                (f.b1194868258 = g(f("ro").numberFormatter({ raw: "#,##0.00 'MAD'" }))),
                (f.b909766040 = g(f("ro").numberFormatter({ raw: "#,##0.00 'MKD'" }))),
                (f.b1970828565 = g(f("ro").numberFormatter({ raw: "#,##0.00 'MXN'" }))),
                (f.b968808280 = g(f("ro").numberFormatter({ raw: "#,##0.00 'MYR'" }))),
                (f.a1864288377 = g(f("ro").numberFormatter({ raw: "#,##0.00 'NGN'" }))),
                (f.a288495780 = g(f("ro").numberFormatter({ raw: "#,##0.00 'NOK'" }))),
                (f.a1260697622 = g(f("ro").numberFormatter({ raw: "#,##0.00 'NZD'" }))),
                (f.b720065611 = g(f("ro").numberFormatter({ raw: "#,##0.00 'PEN'" }))),
                (f.a1999703734 = g(f("ro").numberFormatter({ raw: "#,##0.00 'PHP'" }))),
                (f.a424505783 = g(f("ro").numberFormatter({ raw: "#,##0 'PKR'" }))),
                (f.a1197492860 = g(f("ro").numberFormatter({ raw: "#,##0.00 'PLN'" }))),
                (f.a1882213900 = g(f("ro").numberFormatter({ raw: "#,##0.00 'QAR'" }))),
                (f.b1244310019 = g(f("ro").numberFormatter({ raw: "#,##0.00 'RON'" }))),
                (f.a2019413195 = g(f("ro").numberFormatter({ raw: "#,##0 'RSD'" }))),
                (f.b557805041 = g(f("ro").numberFormatter({ raw: "#,##0.00 'RUB'" }))),
                (f.a1072867274 = g(f("ro").numberFormatter({ raw: "#,##0.00 'SAR'" }))),
                (f.a127510645 = g(f("ro").numberFormatter({ raw: "#,##0.00 'SEK'" }))),
                (f.a1702113950 = g(f("ro").numberFormatter({ raw: "#,##0.00 'SGD'" }))),
                (f.b19797632 = g(f("ro").numberFormatter({ raw: "#,##0.00 'THB'" }))),
                (f.a1067515460 = g(f("ro").numberFormatter({ raw: "#,##0.000 'TND'" }))),
                (f.a923775059 = g(f("ro").numberFormatter({ raw: "#,##0.00 'TRY'" }))),
                (f.a465113997 = g(f("ro").numberFormatter({ raw: "#,##0.00 'TWD'" }))),
                (f.b737904991 = g(f("ro").numberFormatter({ raw: "#,##0 'TZS'" }))),
                (f.b22770862 = g(f("ro").numberFormatter({ raw: "#,##0.00 'UAH'" }))),
                (f.a1465350344 = g(f("ro").numberFormatter({ raw: "#,##0 'UGX'" }))),
                (f.b1342090392 = g(f("ro").numberFormatter({ raw: "#,##0.00 'USD'" }))),
                (f.a917828599 = g(f("ro").numberFormatter({ raw: "#,##0.00 'VEF'" }))),
                (f.a258168834 = g(f("ro").numberFormatter({ raw: "#,##0 'VND'" }))),
                (f.a387637731 = g(f("ro").numberFormatter({ raw: "#,##0.00 'ZAR'" }))),
                (f.b1704074230 = g(f("ro").numberFormatter({ raw: "#,##0.00 'ZMW'" }))),
                (f.b1766160864 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "d MMM", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.a438470333 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "d MMM y", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.b2085484814 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "h:mm a", timeSeparator: ":", dayPeriods: { am: "a.m.", pm: "p.m." } })),
                (f.a1056838753 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "E, d MMM", timeSeparator: ":", days: { E: { 1: { sun: "dum.", mon: "lun.", tue: "mar.", wed: "mie.", thu: "joi", fri: "vin.", sat: "sâm." } } }, months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.a680929124 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "E, d MMM y", timeSeparator: ":", days: { E: { 1: { sun: "dum.", mon: "lun.", tue: "mar.", wed: "mie.", thu: "joi", fri: "vin.", sat: "sâm." } } }, months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.a1064226921 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "d MMMM", timeSeparator: ":", months: { M: { 4: { 1: "ianuarie", 2: "februarie", 3: "martie", 4: "aprilie", 5: "mai", 6: "iunie", 7: "iulie", 8: "august", 9: "septembrie", 10: "octombrie", 11: "noiembrie", 12: "decembrie" } } } })),
                (f.a46136969 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "d MMMM y, HH:mm:ss z", timeSeparator: ":", months: { M: { 4: { 1: "ianuarie", 2: "februarie", 3: "martie", 4: "aprilie", 5: "mai", 6: "iunie", 7: "iulie", 8: "august", 9: "septembrie", 10: "octombrie", 11: "noiembrie", 12: "decembrie" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: ["+H;-H", "+H:mm;-H:mm"] })),
                (f.a527312088 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "d MMM y, h:mm a", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } }, dayPeriods: { am: "a.m.", pm: "p.m." } })),
                (f.a225933308 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "d MMMM y", timeSeparator: ":", months: { M: { 4: { 1: "ianuarie", 2: "februarie", 3: "martie", 4: "aprilie", 5: "mai", 6: "iunie", 7: "iulie", 8: "august", 9: "septembrie", 10: "octombrie", 11: "noiembrie", 12: "decembrie" } } } })),
                (f.b704391301 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "d MMM, h:mm a", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } }, dayPeriods: { am: "a.m.", pm: "p.m." } })),
                (f.a147321616 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "dd.MM.y", timeSeparator: ":" })),
                (f.a1734278772 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "y", timeSeparator: ":" })),
                (f.b1371389757 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "MMM y", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.b813841002 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "EEEE, d MMMM y, HH:mm:ss zzzz", timeSeparator: ":", days: { E: { 4: { sun: "duminică", mon: "luni", tue: "marți", wed: "miercuri", thu: "joi", fri: "vineri", sat: "sâmbătă" } } }, months: { M: { 4: { 1: "ianuarie", 2: "februarie", 3: "martie", 4: "aprilie", 5: "mai", 6: "iunie", 7: "iulie", 8: "august", 9: "septembrie", 10: "octombrie", 11: "noiembrie", 12: "decembrie" } } }, gmtFormat: "GMT{0}", gmtZeroFormat: "GMT", hourFormat: "+HH:mm;-HH:mm" })),
                (f.b819455440 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "d MMM y, HH:mm:ss", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.a459711316 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "dd.MM.y", timeSeparator: ":" })),
                (f.a802666129 = v({ 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "HH:mm", timeSeparator: ":" })),
                (f.b1230009725 = v({ 1: f("ro").numberFormatter({ raw: "0" }), 2: f("ro").numberFormatter({ raw: "00" }) }, { pattern: "E h:mm a", timeSeparator: ":", days: { E: { 1: { sun: "dum.", mon: "lun.", tue: "mar.", wed: "mie.", thu: "joi", fri: "vin.", sat: "sâm." } } }, dayPeriods: { am: "a.m.", pm: "p.m." } })),
                (f.a437785140 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "MMMM y", timeSeparator: ":", months: { M: { 4: { 1: "ianuarie", 2: "februarie", 3: "martie", 4: "aprilie", 5: "mai", 6: "iunie", 7: "iulie", 8: "august", 9: "septembrie", 10: "octombrie", 11: "noiembrie", 12: "decembrie" } } } })),
                (f.b513600617 = v({}, { pattern: "cccc", timeSeparator: ":", days: { c: { 4: { sun: "duminică", mon: "luni", tue: "marți", wed: "miercuri", thu: "joi", fri: "vineri", sat: "sâmbătă" } } } })),
                (f.a166134499 = v({ 1: f("ro").numberFormatter({ raw: "0" }) }, { pattern: "d MMM y", timeSeparator: ":", months: { M: { 3: { 1: "ian.", 2: "feb.", 3: "mar.", 4: "apr.", 5: "mai", 6: "iun.", 7: "iul.", 8: "aug.", 9: "sept.", 10: "oct.", 11: "nov.", 12: "dec." } } } })),
                (f.b1766846057 = v({}, { pattern: "LLLL", timeSeparator: ":", months: { L: { 4: { 1: "ianuarie", 2: "februarie", 3: "martie", 4: "aprilie", 5: "mai", 6: "iunie", 7: "iulie", 8: "august", 9: "septembrie", 10: "octombrie", 11: "noiembrie", 12: "decembrie" } } } })),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/i18n/ro.857ee91a.js.map
