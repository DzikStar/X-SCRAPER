...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["icons.5"],
    {
        ...
        97301: (e, t, l) => {
            ...
            const o = (e = {}) => {
                const t = r.useContext(a.Z),
                    { direction: l } = (0, c.Z)();
                return (0, i.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [n.Z.root, e.style, t && n.Z.iconRTL], viewBox: "0 0 24 24", children: r.createElement("g", null, r.createElement("path", { d: "M15.043 3.54l1.414 1.42L9.414 12l7.043 7.04-1.414 1.42L6.586 12l8.457-8.46z" })) }, { writingDirection: l });
            };
                ...
                return (0, i.Z)(
                    "svg",
                    {
                        ...
                        children: r.createElement(
                            "g",
                            null,
                            r.createElement("circle", { cx: "114", cy: "100", fill: "#97E3FF", r: "100" }),
                            ...
                            r.createElement("path", { d: "M167.127 35.26c0-.755-.685-1.35-1.468-1.2-.584.11-.985.654-.985 1.247v.024c0 9.596-7.777 17.373-17.37 17.373h-32.43v7.11h52.25v-24.55z", fill: "#71C9F8" }),
                            r.createElement("path", { d: "M114.875 59.81v7.11h32.43c9.594 0 17.37 7.778 17.37 17.372 0 .664.498 1.258 1.16 1.293.708.037 1.293-.525 1.293-1.224V59.81h-52.253z", fill: "#1DA1F2" }),
                            r.createElement("path", { d: "M117.256 51.336H94.513v17.526h22.743c1.05-2.72 1.63-5.673 1.63-8.763s-.58-6.045-1.63-8.765z", fill: "#005FD1" }),
                            r.createElement("path", { d: "M86.66 71.786c6.455 6.455 16.92 6.455 23.374 0L86.66 48.412c-6.455 6.454-6.455 16.92 0 23.374z", fill: "#1DA1F2" }),
                            r.createElement("path", { d: "M86.66 48.412l23.374 23.374c6.455-6.455 6.455-16.92 0-23.374-6.455-6.455-16.92-6.455-23.374 0zM55.498 50.37c-12.823 0-23.218 15.963-23.218 35.655s10.395 35.655 23.218 35.655 23.218-15.963 23.218-35.655S68.32 50.37 55.498 50.37zm54.372 25.17s8.258.495 8.258 10.485-8.258 10.484-8.258 10.484l-.104.04c1.162.773 2.466 1.22 3.85 1.22 4.814 0 8.716-5.26 8.716-11.746 0-6.486-3.902-11.745-8.716-11.745-1.384 0-2.688.445-3.85 1.22l.104.04z", fill: "#005FD1" }),
                            r.createElement("path", { d: "M118.13 86.025c0-9.99-8.26-10.484-8.26-10.484L71.66 60.434l-.002.004c4.35 6.48 7.058 15.547 7.058 25.59h39.413z", fill: "#71C9F8" }),
                            r.createElement("path", { d: "M78.716 86.025c0 10.042-2.707 19.108-7.057 25.588v.005l38.21-15.11s8.26-.494 8.26-10.483H78.715zM66.943 64.05c-1.884-2.892-5.876-7.746-11.445-7.746s-9.56 4.854-11.445 7.747c-3.71 5.7-5.84 13.71-5.84 21.976 0 4.058.517 8.053 1.478 11.745 1 3.828 2.475 7.33 4.364 10.23 1.884 2.893 5.876 7.747 11.445 7.747s9.56-4.854 11.444-7.747c1.89-2.902 3.365-6.403 4.362-10.23.962-3.692 1.477-7.686 1.477-11.745 0-8.266-2.13-16.275-5.84-21.974z", fill: "#1DA1F2" }),
                            r.createElement("path", { d: "M48.667 89.86H4.437c-2.117 0-3.834-1.72-3.834-3.836S2.32 82.19 4.437 82.19h44.23c2.117 0 3.834 1.718 3.834 3.835s-1.714 3.834-3.832 3.834zM11.79 117.78c-1.642 0-3.16-1.06-3.665-2.71-.62-2.025.517-4.17 2.542-4.79l36.877-11.304c2.027-.622 4.168.518 4.79 2.542.62 2.024-.518 4.168-2.543 4.79L12.916 117.61c-.374.116-.753.17-1.125.17zm36.878-44.536c-.372 0-.75-.055-1.125-.17L10.667 61.77c-2.024-.62-3.162-2.765-2.542-4.79.62-2.023 2.763-3.163 4.79-2.54L49.79 65.742c2.025.62 3.163 2.765 2.543 4.79-.506 1.65-2.024 2.71-3.665 2.71z", fill: "#71C9F8" }),
                            r.createElement("path", { d: "M195.102 91.667l-19.888-15.164c-1.684-1.284-2.008-3.69-.724-5.373 1.283-1.684 3.688-2.01 5.373-.724l7.45 5.68-.098-12.44L207.18 78.73c1.69 1.277 2.025 3.68.75 5.37s-3.682 2.024-5.37.748l-7.556-5.708.098 12.525zm-7.795-35.647l.098-12.525-7.555 5.708c-1.69 1.277-4.094.942-5.37-.748-1.276-1.69-.942-4.093.748-5.37l19.966-15.087-.097 12.44 7.45-5.68c1.683-1.283 4.09-.958 5.372.725 1.282 1.684.96 4.09-.726 5.373L187.307 56.02zm-49.792 28.836v86.68c27.554 0 49.89-19.405 49.89-43.34s-22.337-43.34-49.89-43.34z", fill: "#1DA1F2" }),
                            r.createElement("path", { d: "M87.624 128.195c0 2.594.263 5.135.766 7.603.412 2.024.99 4 1.713 5.916 3.06 8.103 8.794 15.15 16.298 20.358-.475 5.433-3.29 10.207-7.45 13.354 2.195.663 4.52 1.024 6.928 1.024 6.53 0 12.446-2.622 16.774-6.872 4.696 1.27 9.688 1.956 14.865 1.956V84.856c-27.554 0-49.89 19.404-49.89 43.34z", fill: "#005FD1" }),
                            r.createElement("circle", { cx: "114.937", cy: "141.92", fill: "#71C9F8", r: "4.781" }),
                            r.createElement("path", { d: "M114.937 110.842c-3.924 0-5.977 2.406-5.977 4.782 0 1.213 1.983 10.063 3.647 17.274.25 1.084 1.216 1.853 2.33 1.853s2.08-.766 2.33-1.85c1.664-7.21 3.647-16.06 3.647-17.275 0-2.376-2.054-4.782-5.977-4.782z", fill: "#71C9F8" }),
                            r.createElement("circle", { cx: "160.092", cy: "141.92", fill: "#97E3FF", r: "4.781" }),
                            r.createElement("path", { d: "M160.092 110.842c-3.924 0-5.977 2.406-5.977 4.782 0 1.213 1.983 10.063 3.647 17.274.25 1.084 1.216 1.853 2.33 1.853s2.08-.766 2.33-1.85c1.664-7.21 3.647-16.06 3.647-17.275 0-2.376-2.055-4.782-5.98-4.782zm-22.577 26.298v9.562c2.643 0 4.782-2.142 4.782-4.782 0-2.643-2.14-4.78-4.782-4.78z", fill: "#97E3FF" }),
                            r.createElement("path", { d: "M132.733 141.92c0 2.64 2.14 4.782 4.782 4.782v-9.562c-2.643 0-4.782 2.137-4.782 4.78z", fill: "#71C9F8" }),
                            r.createElement("path", { d: "M139.845 132.897c1.664-7.21 3.647-16.06 3.647-17.274 0-2.376-2.053-4.782-5.977-4.782v23.91c1.113 0 2.08-.767 2.33-1.852z", fill: "#97E3FF" }),
                            r.createElement("path", { d: "M131.538 115.623c0 1.213 1.983 10.063 3.647 17.274.25 1.085 1.216 1.853 2.33 1.853v-23.908c-3.924 0-5.977 2.406-5.977 4.78z", fill: "#71C9F8" }),
                        ),
                    },
                    { writingDirection: t },
                );
        ...
        338017: (e, t, l) => {
            ...
            const n = (e = {}) => {
                const { direction: t } = (0, c.Z)();
                return (0, i.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [a.Z.root, e.style], viewBox: "0 0 32 32", children: r.createElement("g", null, r.createElement("path", { d: "M26 4H6C4.346 4 3 5.346 3 7v18c0 1.654 1.346 3 3 3h20c1.654 0 3-1.346 3-3V7c0-1.654-1.346-3-3-3zm1 21c0 .551-.449 1-1 1H6c-.551 0-1-.449-1-1V7c0-.551.449-1 1-1h20c.551 0 1 .449 1 1v18zM16 10H8v7h8v-7zm-2 5h-4v-3h4v3zm5-5h5v2h-5v-2zm0 5h5v2h-5v-2zM8 20h16v2H8v-2z" })) }, { writingDirection: t });
            };
        ...
        438097: (e, t, l) => {
            ...
            const n = (e = {}) => {
                const { direction: t } = (0, c.Z)();
                return (0, i.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [a.Z.root, e.style], viewBox: "0 0 24 24", children: r.createElement("g", null, r.createElement("path", { d: "M5.292 18C6.94 16.159 9.335 15 12 15s5.06 1.159 6.708 3M5.292 18C6.94 19.841 9.335 21 12 21s5.06-1.159 6.708-3M5.292 18C3.867 16.408 3 14.305 3 12c0-4.97 4.03-9 9-9s9 4.03 9 9c0 2.305-.867 4.408-2.292 6", fill: "none", stroke: "currentColor", strokeWidth: "1.5" }), r.createElement("path", { d: "M9.288 8.534l1.342-.67c.101-.051.183-.133.233-.234l.671-1.342c.192-.384.74-.384.931 0l.672 1.342c.05.101.132.183.233.233l1.342.671c.384.192.384.74 0 .932l-1.342.67c-.101.051-.183.133-.233.234l-.671 1.342c-.192.384-.74.384-.931 0l-.672-1.342c-.05-.101-.132-.183-.233-.233l-1.342-.671c-.384-.192-.384-.74 0-.932z", fill: "currentColor" })) }, { writingDirection: t });
            };
            n.metadata = { width: 24, height: 24 };
            const o = n;
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/icons.5.e1e5bb6a.js.map
