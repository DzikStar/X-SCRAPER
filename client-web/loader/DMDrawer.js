        ...
        761693: (e, t, r) => {
            ...
            function ne({ analytics: e, buttonType: t, conversationTitle: r, handleToggleVisibility: i, isExpanded: o }) {
                ...
                return a.createElement(
                    ...
                    o ? a.createElement(W.ZP, { "aria-label": ee, hoverLabel: { label: ee }, icon: a.createElement(Q.default, null), onPress: i, type: t }) : a.createElement(W.ZP, { "aria-label": re, hoverLabel: { label: re }, icon: a.createElement(J.default, null), onPress: i, type: t }),
                );
            }
            ...
            function Ge({ dmDrawerOnClick: e, drawerCacheKey: t }) {
                ...
                const s = o.map((e) => e.conversation_id),
                    ...
                    v = d && (g > 0 || u > 0),
                    m = () => a.createElement(Ke.Z, { allowUntrustedInbox: v, secondaryInboxCounts: h });
                return a.createElement(Be.Z, { accessibilityTitle: Ve, analytics: r, conversationIds: s, customCellClick: e, fetchInboxHistory: () => n(c.fetchTrustedInboxHistory()), isDrawer: !0, renderEmptyDMInbox: () => a.createElement(We.Z, { messageRequestPivot: m() }), renderStickyContent: m, updateLastSeenEventId: () => n(c.updateTrustedLastSeenEventId()), virtualScrollerCacheKey: t, withPinnedInbox: !0 });
            }
            const qe = "dmDrawerInbox";
            function Xe({ renderHeader: e }) {
                const t = (0, l.I0)();
                return a.createElement(
                    h.Z,
                    { style: je.fill },
            ...
            const je = D.default.create((e) => ({ fill: { flex: 1, alignSelf: "stretch" }, viewportView: { ...D.default.absoluteFillObject, overflowY: "auto" } })),
            ...
            function $e({ isHeaderHighlighted: e, onDrawerOpen: t, triggerHeaderHighlight: r }) {
                ...
                return a.createElement(Ae.nO, { namespace: Ye }, a.createElement(a.Fragment, null, !n && i(), n && a.createElement(Xe, { renderHeader: i })));
            }
            const Qe = D.default.create((e) => ({ headerRoot: { position: "sticky", top: 0, zIndex: e.componentZIndices.appBarZIndex } })),
                Je = 3e3,
                et = { isGlobal: !0, isSticky: !0 },
                tt = { isGlobal: !0, isSticky: !1 };
            function rt({ hasConversations: e, isHideDMDrawerPath: t, width: r = f.Z.dmDrawerWidth.max }) {
            ...
            function at({ isHideDMDrawerPath: e, width: t }) {
                ...
                return (
                    ...
                    a.createElement(rt, { hasConversations: g, isHideDMDrawerPath: e, width: t })
                );
            }
            function nt({ width: e }) {
                ...
                return a.createElement(at, { isHideDMDrawerPath: o, width: e });
            }
        },
        661810: (e, t, r) => {
            r.d(t, { Z: () => o });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.DMDrawer.abd8c66a.js.map
