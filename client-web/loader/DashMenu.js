                ...
                L = ({ createLocalApiErrorHandler: e, delegateUser: r, multiAccountUsers: n, onClose: o, showMultiAccountOverflowPip: l, switchAccount: i }) => {
                    ...
                    return t.createElement(
                        ...
                        (() => {
                            ...
                            return n.map((e) => t.createElement(b.Z, { "aria-label": U({ screenname: e.screen_name }), key: e.user_id, onPress: M(e.user_id, !!e.badgeCount, e.is_protected), role: "button", style: V.link }, t.createElement(w.default, { decoration: p(e.badgeCount), size: "large", uri: e.avatar_image_url })));
                        })(),
                        (() => {
                ...
                render() {
                    ...
                    return t.createElement(b.ZP.Consumer, null, ({ direction: b }) => {
                        const y = "rtl" === b,
                            ...
                            M = A ? v.animateOpen : v.animateClose,
                            C = s.Z.reducedMotionEnabled ? null : M;
                        return t.createElement(h.Z.Modal, null, t.createElement(p.Z, null, t.createElement(m.Z, null, t.createElement(a.Z, { onClick: this._handleMaskClick, onKeyUp: this._handleEsc, style: [v.mask, k, C, f ? v.backgroundBlur : null, "left" === r ? v.alignLeft : v.alignRight] }, (0, u.Z)("div", { role: "dialog", onTransitionEnd: this._handleTransitionEnd, ref: this._setAnimationNode, onClick: S, style: [v.root, f ? v.backgroundRootBlur : null, E, C, l], children: t.createElement(t.Fragment, null, D ? t.createElement(d.Z, { leftControl: "left" === r ? e : "right" === r ? this._renderCloseButton(n) : null, rightControl: "left" === r ? this._renderCloseButton(n) : "right" === r ? e : null, style: w, subtitle: i, title: c }) : null, t.createElement(a.Z, { style: v.contentContainer }, o)) })))));
                    });
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.DashMenu.31e1f02a.js.map
