    ...
    ["loader.DashMenu"],
    {
        906433: (e, t, r) => {
            ...
            const m = () => c().d9ef2842,
                h = c().d86bbf0f,
                p = c().h6beb5fb,
                f = ({ badgeCount: e, decoration: t, icon: r, iconColor: i, label: d, link: c, onClick: f, pip: g, rightControl: b, testID: D }) =>
                    n.createElement(
                        o.Z,
                        { style: w.dashMenuItem },
                        n.createElement(
                            a.Z,
                            { link: c, onClick: f, style: w.link, testID: D },
                            n.createElement(
                                o.Z,
                                { style: w.item },
                                r
        ...
        120735: (e, t, r) => {
            ...
            var D = r(906433),
                E = r(879526);
            const C = ({ acceptedFollowerCount: e, analytics: t, pendingFollowerCount: r, viewerUser: i, onClose: c = d.Z }) => {
                    const { featureSwitches: m, userClaims: h } = (0, u.QZ)(),
                        { coreItems: p, countrySpecificItems: f } = (0, E.O)({ analytics: t, featureSwitches: m, onClose: c, userClaims: h, viewerUser: i, acceptedFollowerCount: e, pendingFollowerCount: r });
        ...
        569591: (e, t, r) => {
            ...
            var n = r(202784),
                ...
                I = r(956817);
            const S = (0, P.Z)()
                    .propsFromState(() => ({ multiAccountUsers: A.$4, showMultiAccountOverflowPip: A.Zt, delegateUser: _.sy }))
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, x.zr)("DASH_MENU_ACCOUNT_SWITCH"), switchAccount: I.y })),
                U = d().da4691aa,
                F = d().c7e55ccf,
                T = d().d86bbf0f,
                N = d().h6beb5fb,
                ...
                B = ({ createLocalApiErrorHandler: e, delegateUser: t, multiAccountUsers: r, onClose: a, showMultiAccountOverflowPip: s, switchAccount: l }) => {
                    const i = (0, C.z)(),
                        ...
                        Z = n.useCallback(
                            (t, r, n) => () => {
                                i.scribe({ ...L, section: n ? "switch_to_protected_account" : "switch_account", element: r ? "account_bubble_badged" : "account_bubble", action: "click" }), l({ user_id: t }).catch(e(E.y));
                            },
                            [i, e, l],
                        ),
                        x = n.useCallback(() => {
                    ...
                    return n.createElement(
                        ...
                        (() => {
                            ...
                            return r.map((e) => n.createElement(f.Z, { "aria-label": F({ screenname: e.screen_name }), key: e.user_id, onPress: Z(e.user_id, !!e.badgeCount, e.is_protected), role: "button", style: W.link }, n.createElement(w.default, { decoration: h(e.badgeCount), size: "large", uri: e.avatar_image_url })));
                        })(),
                        (() => {
                            const e = m ? n.createElement(D.default, { testID: M.Z.iconMore }) : n.createElement(b.default, { testID: M.Z.iconPlus });
                            return n.createElement(o.Z, null, n.createElement(g.ZP, { "aria-label": U, icon: e, link: "/account/switch", onPress: x, size: "small", testID: M.Z.switcher, type: "primaryOutlined" }), s ? n.createElement(p.Z, { pip: !0, truncatedCountFormatter: N, unreadCountLabel: T }) : null);
                        })(),
                    );
                },
            ...
            const G = d().i5f7b6b8,
                ...
                K = (e) => {
                    ...
                    const b = (e) => {
                        if (!h) return null;
                        const { creator_subscriptions_count: t, followers_count: r, friends_count: s, highlightedLabel: l, is_blue_verified: c, name: u, profile_image_url_https: g, protected: b, screen_name: D, translator_type: E, verified: C, verified_type: k } = h;
                        return (0, m.ZP)() ? n.createElement(o.Z, { style: j.dropdownMinWidth }, d ? d() : n.createElement(z.Z, { onClose: i, withMoreSideNavOverflow: p })) : n.createElement(o.Z, { style: [e && j.scrollableContentPadding, (0, m.ZP)() && j.menuContentWidth] }, n.createElement(o.Z, { "aria-label": G, style: j.header }, n.createElement(a.Z, { decoration: R, isAllowedToViewOptions: $(f), isLoggedIn: !0, isUserBlueVerified: c, isUserProtected: b, isUserStatsWithLink: !0, isUserVerified: C, onAvatarClick: w, onScreenNameClick: w, subscriptionsCount: t, userAvatarSize: "xLarge", userAvatarUri: g, userFollowersCount: r, userFriendsCount: s, userHighlightedLabel: l, userName: u, userScreenName: D, userTranslatorType: E, userVerifiedType: k, withNameWrap: !0 })), d ? d() : n.createElement(z.Z, { onClose: i }));
                    };
                    return (0, m.ZP)() ? n.createElement(u.Z, { animateInDuration: "long", isFixed: !0, onDismiss: i, preferredHorizontalOrientation: "right", preferredVerticalOrientation: "up" }, b(!1)) : n.createElement(s.Z, { align: t, onDismissed: i, style: j.drawer, withTopBar: !1 }, b(!0));
                },
                Y = H(K),
        ...
        525271: (e, t, r) => {
            ...
            class D extends n.Component {
                ...
                render() {
                    const { additionalControl: e, align: t, buttonType: r, children: a, style: s, subtitle: l, title: c, topBarStyle: w, withBackgroundBlur: g, withTopBar: b, withTransparentMask: D } = this.props,
                        { isVisible: k } = this.state;
                    return n.createElement(f.ZP.Consumer, null, ({ direction: f }) => {
                        const _ = "rtl" === f,
                            y = k ? C.visibleDrawer : ("left" === t) === _ ? C.offscreenRightDrawer : C.offscreenLeftDrawer,
                            v = k && !D ? C.maskWithBg : C.maskTransparent,
                            Z = k ? C.animateOpen : C.animateClose,
                            M = i.Z.reducedMotionEnabled ? null : Z;
                        return n.createElement(p.Z.Modal, null, n.createElement(h.Z, null, n.createElement(m.Z, null, n.createElement(o.Z, { onClick: this._handleMaskClick, onKeyUp: this._handleEsc, style: [C.mask, v, M, g ? C.backgroundBlur : null, "left" === t ? C.alignLeft : C.alignRight] }, (0, u.Z)("div", { role: "dialog", onTransitionEnd: this._handleTransitionEnd, ref: this._setAnimationNode, onClick: E, style: [C.root, g ? C.backgroundRootBlur : null, y, M, s], children: n.createElement(n.Fragment, null, b ? n.createElement(d.Z, { leftControl: "left" === t ? e : "right" === t ? this._renderCloseButton(r) : null, rightControl: "left" === t ? this._renderCloseButton(r) : "right" === t ? e : null, style: w, subtitle: l, title: c }) : null, n.createElement(o.Z, { style: C.contentContainer }, a)) })))));
                    });
                }
                _renderCloseButton(e) {
                    return n.createElement(c.ZP, { "aria-label": g, icon: b, onPress: this._handleMaskClick, type: e });
                }
            }
        ...
        266704: (e, t, r) => {
            ...
            (E.Promoted = (e) => {
                ...
                (E.Suspended = function ({ onAvatarClick: e, onScreenNameClick: t, userScreenName: r }) {
                    ...
                    return n.createElement(f, { errorMessage: D, isAllowedToViewOptions: { avatar: !1, badges: !0, description: !1, followButton: !1, followIndicator: !0, followersYouKnow: !1, fullName: !1, label: !1, stats: !1, subscriptionsCount: !1 }, isLoggedIn: !1, isUserProtected: o.protected, isUserStatsWithLink: o.isUserStatsWithLink, isUserVerified: o.verified, knownFollowers: { avatarUrls: [], names: [] }, onAvatarClick: e, onScreenNameClick: t, userAvatarUri: o.profile_image_url_https, userDescription: o.description, userEntities: o.entities, userFollowersCount: o.followers_count, userFriendsCount: o.friends_count, userId: o.id_str, userName: r, userScreenName: r, userWithFollowsYou: o.followed_by, userWithheldDescription: void 0, userWithheldEntities: void 0 });
                });
        },
        646797: (e, t, r) => {
            r.d(t, { Z: () => i });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.DashMenu.44df176a.js.map
