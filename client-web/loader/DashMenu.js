            ...
            const x = (0, Z.Z)()
                ...
                L = ({ createLocalApiErrorHandler: e, delegateUser: r, multiAccountUsers: n, onClose: o, showMultiAccountOverflowPip: l, switchAccount: i }) => {
                    ...
                    return t.createElement(
                        ...
                        (() => {
                            const e = m ? t.createElement(g.default, { testID: _.Z.iconMore }) : t.createElement(D.default, { testID: _.Z.iconPlus });
                            return t.createElement(a.Z, null, t.createElement(f.ZP, { "aria-label": B, icon: e, link: "/account/switch", onPress: M, size: "small", testID: _.Z.switcher, type: "primaryOutlined" }), l ? t.createElement(h.Z, { pip: !0, truncatedCountFormatter: T, unreadCountLabel: F }) : null);
                        })(),
                    );
                },
            ...
            class g extends t.Component {
                ...
                render() {
                    ...
                    return t.createElement(b.ZP.Consumer, null, ({ direction: b }) => {
                        ...
                        return t.createElement(h.Z.Modal, null, t.createElement(p.Z, null, t.createElement(m.Z, null, t.createElement(a.Z, { onClick: this._handleMaskClick, onKeyUp: this._handleEsc, style: [A.mask, C, _, f ? A.backgroundBlur : null, "left" === r ? A.alignLeft : A.alignRight] }, (0, u.Z)("div", { role: "dialog", onTransitionEnd: this._handleTransitionEnd, ref: this._setAnimationNode, onClick: S, style: [A.root, f ? A.backgroundRootBlur : null, k, _, l], children: t.createElement(t.Fragment, null, D ? t.createElement(d.Z, { leftControl: "left" === r ? e : "right" === r ? this._renderCloseButton(n) : null, rightControl: "left" === r ? this._renderCloseButton(n) : "right" === r ? e : null, style: w, subtitle: i, title: c }) : null, t.createElement(a.Z, { style: A.contentContainer }, o)) })))));
                    });
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.DashMenu.853790ba.js.map
