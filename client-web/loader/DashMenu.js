    ...
    ["loader.DashMenu"],
    {
        ...
        569591: (e, r, n) => {
            ...
            const x = (0, Z.Z)()
                    ...
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, _.zr)("DASH_MENU_ACCOUNT_SWITCH"), switchAccount: B.y })),
                I = d().da4691aa,
                U = d().c7e55ccf,
                F = d().d86bbf0f,
                T = d().h6beb5fb,
                ...
                L = ({ createLocalApiErrorHandler: e, delegateUser: r, multiAccountUsers: n, onClose: o, showMultiAccountOverflowPip: l, switchAccount: i }) => {
                    ...
                    return t.createElement(
                        ...
                        (() => {
                            ...
                            return n.map((e) => t.createElement(b.Z, { "aria-label": U({ screenname: e.screen_name }), key: e.user_id, onPress: k(e.user_id, !!e.badgeCount, e.is_protected), role: "button", style: V.link }, t.createElement(w.default, { decoration: p(e.badgeCount), size: "large", uri: e.avatar_image_url })));
                        })(),
                        (() => {
                            const e = m ? t.createElement(g.default, { testID: M.Z.iconMore }) : t.createElement(D.default, { testID: M.Z.iconPlus });
                            return t.createElement(a.Z, null, t.createElement(f.ZP, { "aria-label": I, icon: e, link: "/account/switch", onPress: _, size: "small", testID: M.Z.switcher, type: "primaryOutlined" }), l ? t.createElement(h.Z, { pip: !0, truncatedCountFormatter: T, unreadCountLabel: F }) : null);
                        })(),
                    );
                },
                ...
                render() {
                    ...
                    return t.createElement(b.ZP.Consumer, null, ({ direction: b }) => {
                        const y = "rtl" === b,
                            ...
                            C = A && !g ? v.maskWithBg : v.maskTransparent,
                            k = A ? v.animateOpen : v.animateClose,
                            M = s.Z.reducedMotionEnabled ? null : k;
                        return t.createElement(h.Z.Modal, null, t.createElement(p.Z, null, t.createElement(m.Z, null, t.createElement(a.Z, { onClick: this._handleMaskClick, onKeyUp: this._handleEsc, style: [v.mask, C, M, f ? v.backgroundBlur : null, "left" === r ? v.alignLeft : v.alignRight] }, (0, u.Z)("div", { role: "dialog", onTransitionEnd: this._handleTransitionEnd, ref: this._setAnimationNode, onClick: S, style: [v.root, f ? v.backgroundRootBlur : null, E, M, l], children: t.createElement(t.Fragment, null, D ? t.createElement(d.Z, { leftControl: "left" === r ? e : "right" === r ? this._renderCloseButton(n) : null, rightControl: "left" === r ? this._renderCloseButton(n) : "right" === r ? e : null, style: w, subtitle: i, title: c }) : null, t.createElement(a.Z, { style: v.contentContainer }, o)) })))));
                    });
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.DashMenu.c74463aa.js.map
