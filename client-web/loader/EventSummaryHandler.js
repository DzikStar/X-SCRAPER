    ...
    ["loader.EventSummaryHandler"],
    {
        ...
        308192: (e, t, r) => {
            ...
            var n = r(459643),
                ...
                H = r(741692),
                L = r(686689);
            const R = ({ badge: e, groupedTrends: t, hasProminentSocialContext: r, linkColor: n, promotedContent: o, promotedTrendDescription: i, publisher: a, publisherTitleColor: s = "text", richContext: c, scoreEvent: d, shouldTruncateTitle: p, style: u, supportingText: g, textColor: h = "gray700", timeString: C, title: v, titleFontSize: y = "body", titleWeight: b = "bold" }) => {
                    const S = k.Z.getTextDirection(v),
                        E = r ? void 0 : B.title;
                    return l.createElement(m.Z, { style: u }, l.createElement(_.ZP, { color: s, dir: S, numberOfLines: p ? 3 : void 0, size: y, style: E, weight: b, withHashflags: !0 }, v), r ? null : l.createElement(P.Z, { color: h, style: B.aboveTitle }, g ? l.createElement(_.ZP, { color: h, numberOfLines: 1, size: "subtext2" }, g) : null, a ? l.createElement(H.S3, { author: a, color: s, size: "subtext2" }) : null, e || C ? $(C, e, h) : null), l.createElement(M.Z, { groupedTrends: t, linkColor: n, textColor: h }), r ? l.createElement(m.Z, { style: B.belowTitle }, d ? V(d) : (e || C) && a ? O({ badge: e, publisher: a, textColor: h, timeString: C }) || $(C, e, h) : null) : null, o && o.advertiser ? l.createElement(l.Fragment, null, l.createElement(_.ZP, { color: h }, i), l.createElement(D.Z, { color: "white", promotedContent: o, style: B.promotedIndicator })) : null, c ? l.createElement(L.Z, { color: h, entities: c.entities, rtl: c.rtl, size: "subtext2", text: c.text }) : null);
                },
                ...
                V = (e) => {
                    ...
                    return l.createElement(z.Z, { category: t, gameClock: n, gameClockPeriod: o, gameState: r, startTimeMillis: a, teams: i, winnerId: s, withCategory: !1 });
                },
                $ = (e, t, r) => (t && t.text ? l.createElement(A.ZP, { type: "live" }, t.text) : e ? l.createElement(m.Z, { style: B.timestamp }, l.createElement(_.ZP, { color: r, numberOfLines: 1, size: "subtext2" }, e)) : null),
            ...
            const q = (e, t) => t.entry.content,
                ...
                K = (e) => {
                    const { badge: t, dataSaverMode: r, feedbackItems: n, groupedTrends: i, hasProminentSocialContext: a, id: s, image: c, isInSidebar: d, link: h, onClick: C, onImpression: y, publisher: S, richContext: w, saveAsRecentSearch: f, scoreEvent: x, shouldStoreTypeaheadItem: Z, socialContext: T, supportingText: k, timeString: _, title: P, topic: M } = e,
                        D = (0, b.hC)("responsive_web_trends_ui_top_articles");
                    l.useEffect(() => {
                        y && y();
                    }, []);
                    const F = l.useCallback(() => {
                            C(), f && Z && Z(o.Z.ItemType.EVENT) && f({ event: { id: s, image: c || { url: "", height: 0, width: 0 }, supportText: k, title: P, type: E.g2.Event } });
                        }, [s, c, C, f, Z, k, P]),
                        z = l.useMemo(() => (n?.length ? l.createElement(I.Z, { feedbackItems: n }) : null), [n]);
                    return l.createElement(p.$6, null, (e) => l.createElement(u.Z, { link: e.withAnchorless(h), onClick: F, style: te.rootLink, withDarkerInteractiveBackground: d }, a && T ? l.createElement(g.Z, { rightControl: z, style: te.socialContextRow }, l.createElement(ee, { socialContext: T, topic: M })) : null, l.createElement(m.Z, { style: te.row }, D && l.createElement(v.Z, { dataSaverMode: r, icon: "news", image: c, isCellWithProminentSocialContext: a, scoreEvent: x, type: a ? "fixed" : void 0 }), l.createElement(W, { badge: t, groupedTrends: i, hasProminentSocialContext: a, publisher: S, richContext: w, scoreEvent: x, style: D ? te.detailsTrendUI : te.details, supportingText: k, timeString: _, title: P }), !D && l.createElement(v.Z, { dataSaverMode: r, icon: "news", image: c, isCellWithProminentSocialContext: a, scoreEvent: x, type: a ? "fixed" : void 0 }))));
                },
                X = ({ socialContext: e, topic: t }) => {
                    const { contextType: r, landingUrl: n, text: o, topicContext: i } = e,
                        a = i && (0, f.SJ)(i),
                        s = l.useMemo(() => (t ? l.createElement(l.Fragment, null, l.createElement(h.Z, { style: te.topicMiddot }), l.createElement(x.ZP, { isTransparent: !0, size: "smallCompact", textMode: Z.q.FollowTopic, topic: t })) : null), [t]);
            ...
            const ye = (e, t) => t.entry.content,
                ...
                Ee = (e, t) => {
                    ...
                    return r ? ve.ZP.select(e, r) : void 0;
                },
                we = (e, t) => {
                ...
                Te = "white",
                Ie = (e) => {
                    const { badge: t, broadcast: r, coverMediaFromTweet: n, feedbackItems: o, groupedTrends: i, image: a, link: s, manualCrops: c, onClick: d, onImpression: u, promotedContent: g, promotedTrendDescription: h, publisher: C, richContext: v, supportingText: y, timeString: S, title: E, tweetId: w } = e;
                    l.useEffect(() => {
                        u && u();
                    }, []);
                    const f = E.length > 80 ? "headline1" : "title4",
                        x = (0, b.hC)("rweb_sourcemap_migration");
                    return l.createElement(p.$6, null, (e) => l.createElement(l.Fragment, null, l.createElement(ne.Z, { link: e.withAnchorless(s), onClick: d, style: x && ke.containerRedesign, testID: Ze }, l.createElement(pe, { broadcast: r, coverMediaFromTweet: n, image: a, manualCrops: c, promotedContent: g, tweetId: w }), l.createElement(m.Z, { style: _e }, l.createElement(W, { badge: t, groupedTrends: i, linkColor: Te, promotedContent: g, promotedTrendDescription: h, publisher: C, publisherTitleColor: Te, richContext: v, shouldTruncateTitle: !0, supportingText: y, textColor: Te, timeString: S, title: E, titleFontSize: f, titleWeight: "heavy" }))), o?.length ? l.createElement(m.Z, { style: ke.menuContainer }, l.createElement(I.Z, { feedbackItems: o, isDisplayedOnMedia: !0 })) : null));
                },
            ...
            const He = (e, t) => t.entry.content,
                ...
                Ve = (0, j.Z)()
                    ...
                    .adjustStateProps(({ eventSummary: e, publisher: t, topic: r }) => {
                        ...
                        const l = (0, ze.Du)({ isCellWithProminentSocialContext: n === d.Z.CellWithProminentSocialContext, socialContext: e.socialContext, topic: r }),
                    ...
                    .propsFromActions(() => ({ logTrend: Ae.dS, createLocalApiErrorHandler: (0, Fe.zr)("URT_EVENT_SUMMARY") }))
        ...
        204744: (e, t, r) => {
            r.d(t, { DI: () => S, H$: () => p, OB: () => E, Ww: () => d, YB: () => m, hj: () => C, qF: () => y });
            r(901951);
            var n = r(499627),
                o = r(390387);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.EventSummaryHandler.a8c1b34a.js.map
