...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.ExploreNews"],
    {
        568527: (e, l, t) => {
            ...
            function g() {
                ...
                const t = n.useMemo(() => {
                        ...
                        for (let n = 0; n < 9 && t < l.length; n++) e.secondList.push(l[t]), t++;
                        for (; t < l.length; ) e.fourthList.push(l[t]), t++;
                        return e;
                    }, [l]),
                    r = (t) => {
                        (0, u.Ib)(e, { articleId: t, allArticleIds: l.map((e) => e.id) });
                    },
                ...
                return n.createElement(
                    ...
                    t.thirdList.length > 0 &&
                        n.createElement(
                            ...
                            t.thirdList.map((e) => n.createElement(m.Z, { article: e, headerImgContainerStyle: h.headerImgContainerStyle, headerImgStyle: h.headerImgStyle, infoContainerStyle: h.secondListArticleInfoContainer, key: `${e.id}-third-list`, layout: "imageLeft", onClick: () => r(e.id), routeToExploreNews: !0, size: "normal", style: h.article, summaryNumLines: 2, useRowReactions: !0 })),
                        ),
                    t.fourthList.length > 0 &&
                        n.createElement(
                            ...
                            null,
                            n.createElement(c.Z, null),
                            t.fourthList.map((e) => n.createElement(m.Z, { article: e, hideImg: !0, hideReactions: !0, hideSummary: !0, key: `${e.id}-fourth-list`, layout: "imageLeft", onClick: () => r(e.id), routeToExploreNews: !0, size: "normal", style: h.article })),
                        ),
                    n.createElement(i.Z, { axis: "y", size: "space48" }),
                );
            }
            const h = r.default.create((e) => ({ container: { flex: 1, backgroundColor: e.colors.navigationBackground }, article: { borderRadius: 0, padding: e.spaces.space16 }, highlightedArticleHeaderImg: { minHeight: 280, borderRadius: 0 }, highlightedArticle: { gap: e.spaces.space8, padding: 0 }, highlightedArticleTitle: { fontSize: e.fontSizes.title3, lineHeight: 30 }, highlightedInfoContainer: { padding: e.spaces.space16 }, secondListArticleInfoContainer: { flex: 3 }, sentiment: { maxWidth: 300, height: "100%" }, headerImgContainerStyle: { height: "max-content" }, headerImgStyle: { aspectRatio: 1, height: "unset", flex: "unset" } }));
        },
        507504: (e, l, t) => {
            t.d(l, { Z: () => F });
            t(136728);
                                                        ...
                                                        selections: [
                                                            {
                                                                ...
                                                                selections: [
                                                                    ...
                                                                    (p = { alias: null, args: null, concreteType: "NewsTimeline", kind: "LinkedField", name: "timeline", plural: !1, selections: [{ alias: null, args: null, concreteType: "NewsTimelineEvent", kind: "LinkedField", name: "events", plural: !0, selections: [d, (h = { alias: null, args: null, kind: "ScalarField", name: "timestamp", storageKey: null })], storageKey: null }, c], storageKey: null }),
                                                                    (y = {
                                                                        alias: null,
                                                                        args: null,
                                                            ...
                                                            (C = {
                                                                ...
                                                                selections: [
                                                                    ...
                                                                    { alias: null, args: null, concreteType: "SentimentScore", kind: "LinkedField", name: "sentiment_scores", plural: !0, selections: [{ alias: null, args: null, kind: "ScalarField", name: "sentiment_type", storageKey: null }, { alias: null, args: null, kind: "ScalarField", name: "sentiment_value", storageKey: null }, { alias: null, args: null, kind: "ScalarField", name: "num_posts", storageKey: null }, h], storageKey: null },
                                                                ],
                                                                storageKey: null,
                                                            }),
                                                        ],
            ...
            const F = function ({ limit: e }) {
                const l = T()(L, { limit: e }).deepsearchArticlesHomePageResult || [],
                    t = [];
                return (
                    l.forEach((e) => {
        ...
        563586: (e, l, t) => {
            ...
            function f({ hideDefault: e, hovered: l, imgStyle: t, style: a, url: r }) {
                return e && r === y ? null : n.createElement(i.Z, { style: [k.headerImgContainer, a], withoutInteractiveStyles: !0 }, ({ isHovered: e }) => n.createElement(p.Z, { resizeMode: "cover", source: r, style: [k.headerImg, l ? k.hoveredHeaderImg : void 0, t] }));
            }
            const k = r.default.create((e) => ({ headerImgContainer: { flex: 1, height: 200, width: "100%", overflow: "hidden", borderRadius: e.borderRadii.medium }, headerImg: { width: "100%", height: "100%", transition: "all 0.5s ease", transform: "scale(1)" }, hoveredHeaderImg: { cursor: "pointer", transform: "scale(1.05)" } }));
            var C = t(477575),
                _ = t(858496),
                S = t(978086);
            function w({ article: e, commentsStyle: l, containerStyle: t, headerImgContainerStyle: r, headerImgStyle: p, hideDefaultImg: y, hideImg: k, hideReactions: w, hideSummary: T, hoveredBgColor: L, infoContainerStyle: F, layout: v = "imageTop", onClick: K, reactionsContainerStyle: x, routeToExploreNews: b, sentimentStyle: E, showSentiment: H, size: A = "normal", style: Z, summaryNumLines: R, titleNumLines: N, titleStyle: z, useRowReactions: D }) {
                const B = (0, o.Z)(),
                    P = (0, c.I0)(),
                    { isCompactLayout: $ } = (0, u.Z)(),
                    M = n.useMemo(() => {
                        if (!e) return [];
                        const l = [];
                        return (
                    ...
                    Q = n.useMemo(() => {
                        ...
                        return l.push(...M.slice(0, 3)), l;
                    }, [e, M]);
                n.useEffect(() => {
                    P(d.Z.fetchMultipleIfNeeded(Q));
                }, [P, Q]);
                const U = { full: { container: I.fullContainer, headerImgContainer: I.fullHeaderImgContainer }, imageLeft: { container: I.imageLeftContainer, headerImgContainer: I.imageLeftHeaderImgContainer }, imageTop: { container: I.imageTopContainer, headerImgContainer: I.imageTopHeaderImgContainer }, imageBelowTitle: { container: I.imageBelowTitleContainer, headerImgContainer: I.imageBelowTitleHeaderImgContainer } },
                    q = { normal: {}, large: { container: I.largeContainer, title: I.largeTitle, summary: I.largeSummary, lastUpdated: I.largeLastUpdated, comments: I.largeComments } },
                    O = n.useCallback(() => {
                        K && K();
                    }, [K]),
                    V = n.useCallback(() => {
                        (0, m._$)(B, { articleId: e.id });
                    }, [e, B]),
                    G = U[v],
                    W = q[A],
                    X = e.header_img_url || "",
                    Y = !k && X,
                    j = b ? `/i/news/a/${e.id}` : `/i/news/article/${e.id}`,
                    J = n.createElement(a.Z, { style: [I.infoContainer, $ ? I.compactInfoContainer : void 0, F] }, n.createElement(S.Z, { numberOfLines: N, text: e.title, textStyle: [W.title, z] }), "imageBelowTitle" === v && Y && n.createElement(f, { imgStyle: p, onClick: O, style: [G.headerImgContainer, r], url: X }), n.createElement(C.Z, { isLive: !!e.live_article, textStyle: W.lastUpdated, timestamp: e.last_updated_at }), !!e.summary && !T && n.createElement(g.Z, { numberOfLines: R, sources: [], style: [I.summary, W.summary], text: e.summary }), !w && n.createElement(a.Z, { style: [I.reactionsContainer, D ? I.rowReactionsContainer : void 0, x] }, e.sentiment && H && n.createElement(_.Z, { articleId: e.id, sentiment: e.sentiment, showPercentages: !0, style: E }), n.createElement(h.Z, { disableClick: !0, numPosts: Number(e.total_trend_posts), postIds: M, style: [W.comments, l], textStyle: I.commentsText, variant: "outline" })));
                return n.createElement(i.Z, { link: j, onClick: O, style: [I.interactiveContainer, t], withoutInteractiveStyles: !0 }, ({ isHovered: e }) => n.createElement(a.Z, { style: [I.container, G.container, W.container, e ? I.hoveredContainer : void 0, e && L ? { backgroundColor: L } : void 0, Z] }, n.createElement(s.D, { id: "news_article_card", onFullyVisible: V, position: "top", testID: "news_article_card" }), J, Y && "imageBelowTitle" !== v && n.createElement(f, { hideDefault: y, hovered: e, imgStyle: p, onClick: O, style: [G.headerImgContainer, r], url: X })));
            }
            const I = r.default.create((e) => ({ interactiveContainer: { display: "flex", width: "100%" }, container: { flex: 1, display: "flex", width: "100%", gap: e.spaces.space16, backgroundColor: "transparent", borderRadius: e.borderRadii.large, transition: "all 0.2s ease", padding: e.spaces.space12 }, hoveredContainer: { backgroundColor: "light" === e.paletteName ? e.colors.gray0 : "transparent", cursor: "pointer" }, largeContainer: { gap: e.spaces.space36 }, fullContainer: { flexDirection: "row" }, imageLeftContainer: { flexDirection: "row-reverse" }, imageTopContainer: { flexDirection: "column-reverse" }, imageBelowTitleContainer: { flexDirection: "column" }, fullHeaderImgContainer: { flex: 1, width: "100%", height: "100%", minHeight: 350 }, imageLeftHeaderImgContainer: { flex: 1, width: "100%", height: "100%" }, imageTopHeaderImgContainer: { flex: 1, width: "100%", minHeight: 200 }, imageBelowTitleHeaderImgContainer: { flex: 1, width: "100%", height: "100%", minHeight: 350 }, infoContainer: { flex: 1, display: "flex", flexDirection: "column", gap: e.spaces.space8 }, compactInfoContainer: { padding: e.spaces.space8 }, summary: { color: e.colors.gray900 }, largeSummary: {}, headerImgContainer: { flex: 1 }, headerImgInteractiveContainer: { width: "100%", flex: 1 }, reactionsContainer: { display: "flex", flexDirection: "column", gap: e.spaces.space8 }, rowReactionsContainer: { flexDirection: "row" }, largeTitle: { fontSize: e.fontSizes.title1, lineHeight: 40 }, largeLastUpdated: { fontSize: e.fontSizes.subtext1 }, largeComments: { fontSize: e.fontSizes.subtext2 }, commentsText: { color: e.colors.gray900 } }));
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.ExploreNews.622ea8da.js.map
