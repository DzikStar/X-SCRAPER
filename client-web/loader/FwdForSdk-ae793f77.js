                ...
                (() => {
                    ...
                    if (!s.g.fs) {
                        ...
                        s.g.fs = {
                            ...
                            write(e, s, n, i, o, r) {
                                if (0 !== n || i !== s.length || null !== o) return void r(t());
                                r(null, this.writeSync(e, s));
                            },
                            chmod(e, s, n) {
                                n(t());
                            },
                    ...
                    s.g.Go = class {
                        constructor() {
                            ...
                            const t = () => new DataView(this._inst.exports.memory.buffer),
                                ...
                                d = (t, e, s) => {
                                    const n = new Array(e);
                                    for (let s = 0; s < e; s++) n[s] = l(t + 8 * s);
                                    return n;
                                },
                                h = (t, e) => n.decode(new DataView(this._inst.exports.memory.buffer, t, e)),
                            ...
                            (this.importObject = {
                                wasi_snapshot_preview1: {
                                    ...
                                    fd_seek: () => 0,
                                    proc_exit: (t) => {
                                        throw ((this.exited = !0), (this.exitCode = t), this._resolveExitPromise(), r);
                                    },
                                ...
                                gojs: {
                                    ...
                                    "syscall/js.valueDelete": (t, e, n) => {
                                        const i = s(t),
                                            o = h(e, n);
                                        Reflect.deleteProperty(i, o);
                                    },
                                    "syscall/js.valueIndex": (t, e) => a(Reflect.get(s(t), e)),
                                    "syscall/js.valueSetIndex": (t, e, n) => {
                                        Reflect.set(s(t), e, s(n));
                                    },
                                    "syscall/js.valueCall": (e, n, i, o, r, l, a) => {
                                        const u = s(n),
                                            f = h(i, o),
                                            w = d(r, l);
                                        try {
                                            const s = Reflect.get(u, f);
                                            c(e, Reflect.apply(s, u, w)), t().setUint8(e + 8, 1);
                                        } catch (s) {
                                            c(e, s), t().setUint8(e + 8, 0);
                                        }
                                    },
                                    "syscall/js.valueInvoke": (e, n, i, o, r) => {
                                        try {
                                            const r = s(n),
                                                l = d(i, o);
                                            c(e, Reflect.apply(r, void 0, l)), t().setUint8(e + 8, 1);
                                        } catch (s) {
                                            c(e, s), t().setUint8(e + 8, 0);
                                        }
                                    },
                                    "syscall/js.valueNew": (e, n, i, o, r) => {
                                        const l = s(n),
                                            a = d(i, o);
                                        try {
                                    ...
                                    "syscall/js.valuePrepareString": (n, i) => {
                                        const o = String(s(i)),
                                            r = e.encode(o);
                                        c(n, r), t().setInt32(n + 8, r.length, !0);
                                    },
                                    ...
                                    "syscall/js.copyBytesToGo": (e, n, i, o, r) => {
                                        let l = e,
                                            a = e + 4;
                                        const c = u(n, i),
                                            d = s(r);
                                        if (!(d instanceof Uint8Array || d instanceof Uint8ClampedArray)) return void t().setUint8(a, 0);
                                        const h = d.subarray(0, c.length);
                                        c.set(h), t().setUint32(l, h.length, !0), t().setUint8(a, 1);
                                    },
                                    "syscall/js.copyBytesToJS": (e, n, i, o, r) => {
                                        let l = e,
                                            a = e + 4;
                                        const c = s(n),
                                            d = u(i, o);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.FwdForSdk-ae793f77.7aea6cda.js.map
