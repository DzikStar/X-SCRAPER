(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.HWCard"],
    {
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => z, KJ: () => k, LI: () => S, P7: () => h, PW: () => E, QF: () => b, Qm: () => w, Tr: () => T, b$: () => p, db: () => F, et: () => y, fR: () => f, iH: () => $, lD: () => g, su: () => v, u4: () => Z, wX: () => x });
            var r = n(202784),
                o = n(674132),
                a = n.n(o),
                i = n(394123),
            ...
            const f = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                $ = [{ blockType: h.header1, label: y, component: S({ size: "title1", extendedWidth: !0, children: y }) }, { blockType: h.header2, label: E, component: S({ size: "title3", weight: "heavy", children: E }) }, T],
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.HWCard.8f6b8dba.js.map
