(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.HWCard", "icons/IconBulletedList-js"],
    {
        ...
        403911: (e, t, n) => {
            ...
            const $ = { result: [], entities: {}, slice_info: {} },
                ...
                P = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarkFolderTimeline: ({ bookmark_collection_id: n, cursor: o }) => e.graphQL(m(), { bookmark_collection_id: n, cursor: o, includePromotedContent: !0, ...(0, i.d)(t) }, F).then((e) => e?.bookmark_collection_timeline?.timeline || T.cY),
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => z, KJ: () => k, LI: () => S, P7: () => b, PW: () => E, QF: () => h, Qm: () => w, Tr: () => T, b$: () => p, db: () => P, et: () => v, fR: () => f, iH: () => $, lD: () => g, su: () => y, u4: () => F, wX: () => x });
            var o = n(202784),
                r = n(111677),
                a = n.n(r),
                i = n(394123),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.HWCard.7fbd7e9a.js.map
