        ...
        403911: (e, t, n) => {
            ...
            const $ = { result: [], entities: {}, slice_info: {} },
                ...
                Z = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarkFolderTimeline: ({ bookmark_collection_id: n, cursor: r }) => e.graphQL(m(), { bookmark_collection_id: n, cursor: r, includePromotedContent: !0, ...(0, i.d)(t) }, P).then((e) => e?.bookmark_collection_timeline?.timeline || S.cY),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.HWCard.b0a1c0ca.js.map
