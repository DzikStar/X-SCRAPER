    ...
    ["loader.HWCard"],
    {
        ...
        879113: (e, t, n) => {
            ...
            class _ extends r.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: n, fetchStatus: o, icon: a, loadingMessage: i, onRequestRetry: c, render: _, renderFailure: p, retryMessage: f, retryable: h } = this.props;
                    switch (o) {
                        case d:
                            return h ? r.createElement(l.Z, { icon: a, onRequestRetry: c, retryMessage: f }) : n ? r.createElement(s.m, { failureMessage: n }) : p();
                        case m:
        ...
        524496: (e, t, n) => {
            ...
            const k = r.memo(function (e) {
                    ...
                    return (
                        ...
                        r.createElement(c.ZP, null, ({ containerWidth: e }) => r.createElement(a.Z, { style: v.fontFamily }, r.createElement(o.Editor, { blockRenderMap: g, blockRendererFn: k, blockStyleFn: (0, d.su)(p.Z.isNarrowScreenWidth(e)), editorState: b, onChange: l.Z, readOnly: !0, webDriverTestID: "longformRichTextComponent" })))
                    );
                }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.HWCard.3333a65a.js.map
