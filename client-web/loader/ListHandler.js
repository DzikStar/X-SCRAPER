            ...
            const N = "cellThumbnail",
                ...
                V = (e) => {
                    const { dataSaverMode: a, decoration: l, facepileUrls: c, followersContext: u, isFollowing: m, isListPinned: y, isSelected: D, listId: w, listVisibility: M, media: k, memberCount: v, membersContext: S, mode: _, name: Z, onClick: C, pinnedTimelinesCount: I, role: P, user: E, withBottomBorder: A, withHoverCard: F, withSubscribe: T = !1 } = e,
                        ...
                        V = !I || I < x,
                        j = `/i/lists/${w}`,
                        $ = n.useCallback((e) => (e ? n.createElement(z.Z, { basePath: j, listId: w, wrapperStyle: { maxWidth: "100%" } }, e) : null), [j, w]),
                        ...
                        q = n.useMemo(() => l || (D ? n.createElement(b.default, { style: W.iconCheckmark }) : _ === f.H.Reordering || _ === f.H.Pinning ? n.createElement(L, { couldPinList: V, isListPinned: y, listId: w, mode: _, name: Z }) : T ? n.createElement(p.Z, { isFollowing: m, isMinimal: !0, listId: w, listName: Z, user: E }) : void 0), [V, l, y, m, D, w, _, Z, E, T]),
                        Q = (0, R.z)(),
                        J = n.useCallback(
                            (e) => {
                    ...
                    return n.createElement(i.Z, { "aria-checked": D, link: { pathname: j, anchorless: !0 }, onPress: J, role: P, style: [W.root, A && W.bottomBorder], testID: O }, n.createElement(r.Z, { style: W.listContainer }, n.createElement(r.Z, { style: W.leftColumn }, $(X), n.createElement(r.Z, { style: W.listAttribution }, n.createElement(r.Z, { style: W.nameContainer }, $(G), S ? n.createElement(t.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2" }, n.createElement(o.Z, null), S) : null), c && u ? n.createElement(r.Z, { style: W.rowContainer }, n.createElement(d.Z, { style: W.facepile, userAvatarUrls: c }), n.createElement(t.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2" }, u)) : E ? n.createElement(s.Z, { affiliateBadgeInfo: E.highlightedLabel, avatarSize: "small", color: "text", isBlueVerified: E.is_blue_verified, isProtected: E.protected, isVerified: E.verified, name: E.name, nameSize: "subtext2", profileImageUrl: E.profile_image_url_https, screenName: E.screen_name, screenNameSize: "subtext2", verifiedType: E.verified_type, withHoverCard: F, withLink: !0, withScreenName: !0 }) : null)), n.createElement(r.Z, { style: W.rightColumn }, q)));
                },
        ...
        690344: (e, a, l) => {
            ...
            const K = B,
                z = ({ dataSaverMode: e, listRef: a }) => {
                    const l = L()(K, a).list;
                    return i.createElement(O, { dataSaverMode: e, list: l });
                },
                H = i.memo(z),
                N = F,
                O = (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.ListHandler.55948c7a.js.map
