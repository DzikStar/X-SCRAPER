    ...
    ["loader.ListHandler", "icons/IconPlus-js"],
    {
        ...
        53821: (e, a, l) => {
            ...
            var n = l(202784),
                ...
                Z = l(601576);
            const C = (0, S.Z)()
                    .propsFromActions(() => ({ addToast: Z.fz, createLocalApiErrorHandler: (0, M.zr)("TOGGLE_PIN_LIST"), pinTimeline: _.qM, unpinTimeline: _.bK }))
                    .withAnalytics(),
                A = m().c5d23126,
                I = m().j44ec610,
                E = m().d8a032a2,
                ...
                T = m().cdb33880,
                L = (e) => {
                    const { addToast: a, analytics: l, couldPinList: t, createLocalApiErrorHandler: r, isListPinned: i, listId: o, mode: d, name: s, pinTimeline: c, unpinTimeline: u } = e,
                        m = n.useMemo(() => (d === f.H.Reordering ? n.createElement(w.default, null) : i ? n.createElement(D.default, null) : n.createElement(k.default, { style: t ? null : x.disabledPin })), [t, i, d]),
                        b = n.useMemo(() => {
                            if (d === f.H.Pinning) return { label: i ? I : A };
                        }, [i, d]),
                        h = n.useCallback(() => {
                            if (t || i) {
                                const e = i ? "unpin_button" : "pin_button";
                                l.scribe({ element: e, action: "click" }), i ? u({ id: o, name: s, type: v.FO.LIST }).catch(r) : c({ id: o, name: s, type: v.FO.LIST }).catch(r);
                            } else l.scribe({ element: "unpinnable_button", action: "click" }), a({ text: E });
                        }, [a, l, t, r, i, o, s, c, u]),
                        g = n.useMemo(() => (d === f.H.Reordering ? F : i ? T : P), [i, d]);
            ...
            const N = "cellThumbnail",
                ...
                O = (e) => {
                    const { dataSaverMode: a, decoration: l, facepileUrls: c, followersContext: u, isFollowing: m, isListPinned: y, isSelected: w, listId: D, listVisibility: k, media: v, memberCount: M, membersContext: S, mode: _, name: Z, onClick: C, pinnedTimelinesCount: A, role: I, user: E, withBottomBorder: F, withHoverCard: P, withSubscribe: T = !1 } = e,
                        ...
                        G = n.useMemo(() => n.createElement(t.Z, { style: j.name }, n.createElement(r.ZP, { numberOfLines: 1, weight: "bold" }, Z), "private" === k ? n.createElement(r.ZP, { size: "body", style: j.icon }, n.createElement(b.default, { "aria-label": V, style: j.iconLock })) : null), [k, Z]),
                        X = n.useMemo(() => n.createElement(t.Z, { style: j.thumbnailImage, testID: N }, n.createElement(R.Z, { cropCandidates: v.crop, dataSaverMode: a, icon: "lists", image: v.image, type: "fixed" })), [a, v.crop, v.image]),
                        Q = n.useMemo(() => l || (w ? n.createElement(h.default, { style: j.iconCheckmark }) : _ === f.H.Reordering || _ === f.H.Pinning ? n.createElement(B, { couldPinList: O, isListPinned: y, listId: D, mode: _, name: Z }) : T ? n.createElement(p.Z, { isFollowing: m, isMinimal: !0, listId: D, listName: Z, user: E }) : void 0), [O, l, y, m, w, D, _, Z, E, T]),
                        q = (0, K.z)(),
                        J = n.useCallback(
                            (e) => {
                                q.contextualScribeNamespace.element ? q.scribeAction("click") : q.scribe({ component: "list", action: "click" }), C?.(e, { listId: D, member_count: M });
                            },
                            [q, C, D, M],
                        );
                    return n.createElement(i.Z, { "aria-checked": w, link: { pathname: W, anchorless: !0 }, onPress: J, role: I, style: [j.root, F && j.bottomBorder], testID: U }, n.createElement(t.Z, { style: j.listContainer }, n.createElement(t.Z, { style: j.leftColumn }, $(X), n.createElement(t.Z, { style: j.listAttribution }, n.createElement(t.Z, { style: j.nameContainer }, $(G), S ? n.createElement(r.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2" }, n.createElement(o.Z, null), S) : null), c && u ? n.createElement(t.Z, { style: j.rowContainer }, n.createElement(d.Z, { style: j.facepile, userAvatarUrls: c }), n.createElement(r.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2" }, u)) : E ? n.createElement(s.Z, { affiliateBadgeInfo: E.highlightedLabel, avatarSize: "small", color: "text", isBlueVerified: E.is_blue_verified, isProtected: E.protected, isVerified: E.verified, name: E.name, nameSize: "subtext2", profileImageUrl: E.profile_image_url_https, screenName: E.screen_name, screenNameSize: "subtext2", verifiedType: E.verified_type, withHoverCard: P, withLink: !0, withScreenName: !0 }) : null)), n.createElement(t.Z, { style: j.rightColumn }, Q)));
                },
        ...
        374235: (e, a, l) => {
            ...
            function u(e) {
                ...
                return n.createElement(r.Z, { renderContent: () => n.createElement(t.Z, { style: m.root }, n.createElement(d.Z, { basePath: a, listId: i, withEditButton: !1, withRoundedCorners: !0 })), shouldDisable: b, wrapperStyle: s }, l);
            }
        ...
        989816: (e, a, l) => {
            ...
            const h = (0, m.Z)()
                ...
                p = (e) => {
                    ...
                    return n.createElement(c.Z, { customText: b, displayMode: s.BH.subscribe, userFullName: p?.name }, (e) => n.createElement(t.Z, { buttonIcons: u ? g : void 0, disabled: r, displayMode: u ? "only-icon" : void 0, isFollowing: o, onFollow: e(y), onUnfollow: e(w), showRelationshipChangeConfirmation: !1, size: "small", style: f.followButton, type: "list" }));
                },
        ...
        631449: (e, a, l) => {
            ...
            const k = (e, a) => (a.listId ? b.Z.select(e, a.listId) : void 0),
                ...
                M = (e, a) => D.tt(e, a.listId);
            const S = (0, p.Z)().propsFromState(() => ({ list: k, author: v, dataSaverMode: y.IX, pinnedTimelinesCount: f.Hm, media: M }))(function (e) {
            ...
            const A = ({ entry: e, feedbackItems: a, module: l, renderEntry: n, shouldDisplayPin: t, ...r }) => {
                    const o = t ? Z.H.Pinning : void 0;
                    return e.itemContentRef ? s.createElement(F, (0, i.Z)({}, r, { itemContentRef: e.itemContentRef, mode: o })) : s.createElement(P, (0, i.Z)({}, r, { itemContent: e.content, mode: o }));
                },
                I = s.memo(A),
                E = d,
                ...
                P = ({ itemContent: e, mode: a, shouldDisplayPin: l, ...n }) => {
                    const t = (0, m.hC)("responsive_web_redux_use_fragment_enabled"),
                        r = s.useMemo(() => (0, h.D9)(C.Dx, b.Z, e.id), [e.id]);
                    return t ? s.createElement(C.ZP, (0, i.Z)({ isMember: e.isMember, listRef: r, mode: a }, n)) : s.createElement(_, (0, i.Z)({ isMember: e.isMember, listId: e.id, mode: a }, n));
                },
                T = (e) =>
                    r
                        .iH({
        ...
        690344: (e, a, l) => {
            ...
            const D = g().j681933e,
                k = (e) => {
                    ...
                    return i.createElement(y.Z, { basePath: d, listId: n }, i.createElement(u.Z, { link: d, onPress: s, style: v.root }, i.createElement(f.Z, { cropCandidates: t.crop, dataSaverMode: a, icon: "lists", image: t.image }), i.createElement(c.Z, { style: v.name }, i.createElement(m.ZP, { align: "center", numberOfLines: 1, size: "subtext2" }, r ? r.trim() : null), l ? i.createElement(p.default, { "aria-label": D, style: v.iconLock }) : null)));
                },
                v = b.default.create((e) => ({ root: { alignItems: "center", backgroundColor: e.colors.cellBackground, padding: e.spaces.space12 }, name: { alignSelf: "stretch", paddingTop: e.spaces.space4, flexDirection: "row", justifyContent: "center", width: e.spaces.space80 }, iconLock: { color: e.colors.text, marginHorizontal: e.spaces.space4 } })),
                M = i.memo(k);
            var S = l(668214),
                _ = l(38562),
                Z = l(510588);
            const C = (e, a) => a.entry.content.id,
                A = (e, a) => d.Z.select(e, C(0, a)),
                I = (e, a) => Z.tt(e, C(0, a)),
                E = (0, S.Z)()
                    .propsFromState(() => ({ listId: C, list: A, dataSaverMode: _.IX, media: I }))
            ...
            const R = L,
                ...
                U = (e) => {
                    const a = B()(N, e.list),
                        l = (0, K.u)(a);
                    return i.createElement(M, { dataSaverMode: e.dataSaverMode, isPrivate: "Private" === a.mode, listId: a.id_str, media: l, name: a.name || "" });
                },
                V = (e) => {
                    ...
                    if (r) return i.createElement(U, { dataSaverMode: a, list: c });
                    {
                        ...
                        return i.createElement(M, { dataSaverMode: a, isPrivate: l, listId: n, media: t, name: r });
                    }
                },
                O = E(i.memo(V)),
                j = r
            ...
            const o = t().add55942,
                ...
                b = {
                    customErrorHandler: ({ errors: e }) => {
                        if (e) {
                            if (e.filter((e) => e?.code === r.ZP.ListAdminRightsError).length) return (0, i.mf)({ text: s });
                        }
        ...
        510588: (e, a, l) => {
            l.d(a, { $5: () => u, By: () => f, DV: () => k, Fz: () => g, Ge: () => w, Ns: () => _, Wy: () => h, _g: () => M, ax: () => y, cx: () => p, l1: () => v, tt: () => S, xh: () => b });
            var n = l(614983),
                t = l.n(n),
                r = l(842799),
                i = l(286e3),
        ...
        642153: (e, a, l) => {
            ...
            const o = (e) => {
                    ...
                    return n.createElement(
                        ...
                        c.map((e, t) => n.createElement(i.default, { backgroundColor: a, borderColor: a, borderWidth: b ? "none" : l, key: t, size: s, style: [0 !== t && { marginStart: -1 * r.default.theme.spacesPx[u ? "space4" : "space12"] }, { zIndex: m - t }], uri: e })),
                    );
                },
                d = r.default.create((e) => ({ root: { flexDirection: "row", flexShrink: 0, overflow: "hidden", flexWrap: "wrap", justifyContent: "center" } }));
        },
        470397: (e, a, l) => {
            l.d(a, { Z: () => o });
            l(136728);
            ...
            const o = ({ children: e, color: a = "gray700", size: l, style: i }) => {
                    ...
                    return (
                        ...
                        o.length ? n.createElement(t.Z, { style: [d.middotGroup, i] }, o) : null
                    );
                },
        ...
        379327: (e, a, l) => {
            ...
            const o = (e = {}) => {
                const { direction: a } = (0, r.Z)();
                return (0, t.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [i.Z.root, e.style], viewBox: "0 0 24 24", children: n.createElement("g", null, n.createElement("path", { d: "M11 11V4h2v7h7v2h-7v7h-2v-7H4v-2h7z" })) }, { writingDirection: a });
            };
            o.metadata = { width: 24, height: 24 };
            const d = o;
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.ListHandler.f82f615a.js.map
