            ...
            const N = "cellThumbnail",
                ...
                O = (e) => {
                    const { dataSaverMode: a, decoration: l, facepileUrls: c, followersContext: u, isFollowing: m, isListPinned: y, isSelected: D, listId: w, listVisibility: M, media: v, memberCount: k, membersContext: _, mode: S, name: Z, onClick: I, pinnedTimelinesCount: C, role: P, user: E, withBottomBorder: A, withHoverCard: F, withSubscribe: T = !1 } = e,
                        ...
                        B = x.getNumberValue("home_timeline_spheres_max_user_owned_or_subscribed_lists_count", H.F),
                        O = !C || C < B,
                        j = `/i/lists/${w}`,
                        $ = n.useCallback((e) => (e ? n.createElement(R.Z, { basePath: j, listId: w, wrapperStyle: { maxWidth: "100%" } }, e) : null), [j, w]),
                        ...
                        X = n.useMemo(() => n.createElement(r.Z, { style: W.thumbnailImage, testID: N }, n.createElement(K.Z, { cropCandidates: v.crop, dataSaverMode: a, icon: "lists", image: v.image, type: "fixed" })), [a, v.crop, v.image]),
                        q = n.useMemo(() => l || (D ? n.createElement(b.default, { style: W.iconCheckmark }) : S === f.H.Reordering || S === f.H.Pinning ? n.createElement(L, { couldPinList: O, isListPinned: y, listId: w, mode: S, name: Z }) : T ? n.createElement(p.Z, { isFollowing: m, isMinimal: !0, listId: w, listName: Z, user: E }) : void 0), [O, l, y, m, D, w, S, Z, E, T]),
                        Q = (0, z.z)(),
                        J = n.useCallback(
                            (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.ListHandler.6f5c3fca.js.map
