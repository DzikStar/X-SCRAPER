...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ...
    {
        312778: (e, t, n) => {
            n.r(t), n.d(t, { Markdown: () => z, default: () => A });
            var r = n(202784),
                a = n(719870),
                l = n(325686);
            const o = (e, t, n, r, a) => ({
            ...
            var C = n(366929);
            function x({ content: e, isBlock: t = !1 }) {
                const n = r.useRef(null),
                    [a, o] = r.useState(!1);
                r.useLayoutEffect(() => {
                    if (n.current)
                        try {
                            C.Z.render(e, n.current, { trust: !1, output: "mathml", displayMode: t, throwOnError: !0 }), o(!1);
                        } catch {
                            o(!0);
                        }
                }, [e, t, n]);
                const s = r.useMemo(() => [t ? L.block : null], [t]);
            ...
            const P = f.default.create((e) => ({ list: { marginBlockStart: "0.5em", marginBlockEnd: "0.5em", paddingInlineStart: "2em", display: "flex", flexDirection: "column", gap: "0.3em" }, listItem: { fontFamily: e.fontFamilies.normal, lineHeight: "140%" } }));
            function T({ children: e, isRootLevel: t, token: n }) {
                return r.createElement(E, { style: t && _.paragraph, token: n }, e);
            }
            const _ = f.default.create((e) => ({ paragraph: { display: "block" } }));
            function R({ disableLinks: e, token: t }) {
                const n = t.header
                        ? r.createElement(
                              "tr",
                              { style: W.tableRow },
            ...
            function I({ disableLinks: e, isRootLevel: t, token: n }) {
                ...
                switch (n.type) {
                    ...
                    case "table":
                        return r.createElement(R, { disableLinks: e, token: n });
                    case "space":
                    ...
                    case "blockLatex":
                        return r.createElement(x, { content: n.text, isBlock: !0 });
                    case "inlineLatex":
                        return r.createElement(x, { content: n.text });
                    default:
                        return r.createElement(T, { isRootLevel: t, token: n }, a);
                }
            }
        ...
        301758: (e, t, n) => {
            ...
            const b = (e, t) => t.tweetId,
                ...
                f = (0, u.Z)()
                    .propsFromState(() => ({ community: h, hydratedTweet: k.Z.createHydratedTweetSelector(b) }))
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, m.zr)("QUOTE_TWEET_CONTAINER"), fetchCommunityIfNeeded: p.ZP.fetchOneIfNeeded }))(({ community: e, createLocalApiErrorHandler: t, fetchCommunityIfNeeded: n, hydratedTweet: m, onAvatarClick: u, onMediaClick: p, onPress: k, onScreenNameClick: b, tweetId: h, withBirdwatchPivot: f = !0, ...y }) => {
                    const { featureSwitches: g, viewerUserId: E } = a.useContext(d.rC),
                        w = (0, c.z)(),
                        C = m?.community_id_str;
                    a.useEffect(() => {
                        C && (0, s.Z)(e) && n(C).catch(t());
                    }, [e, C, t, n]);
                    const x = a.useCallback(
                            (e) => {
                                w.scribeAction("click"), k && k(e);
                            },
                            [k, w],
                        ),
                        L = !!f,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.Markdown.93c3e17a.js.map
