    ...
    ["loader.MediaPreviewVideoPlayer"],
    {
        298607: (e, t, r) => {
            ...
            class A extends n.PureComponent {
                ...
                render() {
                    ...
                    return "number" == typeof i && "number" == typeof r && r > 0 ? n.createElement(M.Z, { accessibilityLabelValueText: B({ currentTime: (0, k.mr)(i), durationTime: (0, k.mr)(r) }), "aria-label": e, color: "white", keepLTR: !0, keyboardStep: 5, max: r, min: 0, onActive: this._handleActive, onChange: this._handleChange, step: "any", value: i, withHidingThumb: !0 }) : null;
                }
            }
            const F = A,
                L = a().j25d7cca,
                    ...
                    if (
                        ...
                        (this._renderActionButton = (e, t) => {
                            const { controls: r, isPlaying: o } = t,
                                ...
                                c = (0, k.Ci)(t),
                                u = I(l) ? "xSmall" : "medium";
                            return !c || c.isLive ? null : o || (r && "PLAY_REQUESTED" === r.playState) ? n.createElement(T.Z, { "aria-label": Z.gF, hoverLabelPreferredHorizontalOrientation: "end", hoverLabelWithExtraSpace: this.props.showScrubber, icon: n.createElement(p.default, null), onPress: i, size: u }) : r.isReplayButtonShown ? n.createElement(T.Z, { "aria-label": Z.Js, hoverLabelPreferredHorizontalOrientation: "end", hoverLabelWithExtraSpace: this.props.showScrubber, icon: n.createElement(m.default, null), onPress: s, size: u }) : n.createElement(T.Z, { "aria-label": Z.M2, hoverLabelPreferredHorizontalOrientation: "end", hoverLabelWithExtraSpace: this.props.showScrubber, icon: n.createElement(v.default, null), onPress: a, size: u });
                        }),
                        (this._renderFullScreenButton = (e, t) => {
                            const { fullscreen: r } = t,
                                ...
                                a = I(o) ? "xSmall" : "medium";
                            return r.isFullscreen ? n.createElement(T.Z, { "aria-label": Z.iG, hoverLabelPreferredHorizontalOrientation: "start", hoverLabelWithExtraSpace: this.props.showScrubber, icon: n.createElement(i, { isFullscreen: r.isFullscreen }), onPress: this._exitFullScreen(e), size: a }) : n.createElement(T.Z, { "aria-label": Z.lO, hoverLabelPreferredHorizontalOrientation: "start", hoverLabelWithExtraSpace: this.props.showScrubber, icon: n.createElement(i, { isFullscreen: r.isFullscreen }), onPress: this._requestFullScreen(e), size: a });
                        }),
                        (this._fullScreenIcon = ({ isFullscreen: e, style: t }) => {
                            const { hidden: r, shown: o } = N;
                            return n.createElement(n.Fragment, null, n.createElement(b.default, { style: e ? r : o }), n.createElement(S.default, { style: e ? o : r }));
                        }),
                        (this._requestFullScreen = (e) => () => {
                            e.fullScreen(this.props.containerRef);
                        }),
                        (this._exitFullScreen = (e) => () => e.exitFullScreen()),
                        (this._getScrubToFraction = (0, y.Z)((e) => (t) => (0, k.aZ)(e, t))),
                        ...
                        (this._renderVolume = (e, t) => {
                            const { isMuted: r, volume: o } = t,
                                ...
                                u = r ? s : i,
                                d = r ? Z.cm : Z.GS;
                            return n.createElement(_.Z, { accessibilityLabelIcon: d, accessibilityLabelSlider: Z.Nj, containerHeight: l, isMuted: r, onHideSlider: this._showScrubberHandler(!0), onMuteToggle: u, onShowSlider: this._showScrubberHandler(!1), onSliderChange: this._setVolumePercent(a), size: I(c) ? "xSmall" : "medium", volumePercent: 100 * o });
                        }),
                        ...
                        (this._getTimestampValues = (e) => {
                            ...
                            return { duration: a, currentTime: (0, k.SY)(e) };
                        }),
        ...
        864386: (e, t, r) => {
            ...
            class v extends o.Component {
                ...
                render() {
                    ...
                    return o.createElement(v.ObserverContext.Provider, { value: t }, o.createElement(v.Context.Provider, { value: this.getContext() }, e));
                }
            }
            (v.Context = p), (v.ObserverContext = m);
        },
        986460: (e, t, r) => {
        ...
        41871: (e, t, r) => {
            ...
            class b extends o.PureComponent {
                ...
                render() {
                    const { accessibilityLabelIcon: e, accessibilityLabelSlider: t, containerHeight: r, isMuted: a, onHideSlider: s, onMuteToggle: u, onShowSlider: b, onSliderChange: g, pullRight: f, sliderColor: y, volumePercent: C, withGraySliderTrack: _, withNavigationSliderBackground: w, ...E } = this.props,
                        T = a ? o.createElement(l.default, null) : o.createElement(c.default, null),
                        P = w ? S.sliderWithNavigationBackground : S.sliderWithDefaultBackground;
                    return o.createElement(h.Z, { disabled: !g, onFocusRingGained: g ? this._showSlider : void 0, onFocusRingLost: g ? this._hideSlider : void 0, onHoverIn: g ? this._showSlider : void 0, onHoverOut: g ? this._hideSlider : void 0 }, o.createElement(i.Z, { onKeyDown: g ? this._handleKeyDown : void 0 }, o.createElement(d.ZP, (0, n.Z)({ "aria-label": e, icon: T, onLayout: this._handleButtonLayoutChange, onPress: u, pullRight: f, type: "onMediaText" }, E)), g && o.createElement(h.Z, { onFocusRingGained: b, onFocusRingLost: s }, ({ isFocusedWithin: e }) => o.createElement(i.Z, { style: [S.sliderBackground, P, this._getSliderMarginStyles(E.size), e || this._shouldShowSlider(this.state) ? null : m.default.visuallyHidden, !!r && { maxHeight: this.state.sliderMaxHeight }] }, o.createElement(p.Z, { accessibilityLabelValueText: v({ volumePercent: C }), "aria-label": t, color: y || "white", isVertical: !0, keyboardStep: 10, max: 100, min: 0, onActive: this._handleSliderActive, onChange: g, step: 1, value: a ? 0 : C || 0, withGrayBackground: _ })))));
                }
            }
            b.defaultProps = { pullRight: !1 };
            const S = m.default.create((e) => ({ sliderBackground: { bottom: 0, borderRadius: e.borderRadii.xLarge, height: `calc(${e.spaces.space64}*2)`, start: e.spaces.space4, position: "absolute", padding: e.spaces.space12, paddingVertical: e.spaces.space16, end: e.spaces.space4 }, sliderWithDefaultBackground: { backgroundColor: e.colors.translucentBlack30 }, sliderWithNavigationBackground: { backgroundColor: e.colors.navigationBackground, boxShadow: e.boxShadows.xSmall } })),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.MediaPreviewVideoPlayer.e6be283a.js.map
