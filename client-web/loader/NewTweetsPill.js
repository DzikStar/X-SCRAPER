            ...
            const k = d.default.create((e) => {
                ...
                S = x(function (e) {
                    ...
                    const c = t?.richText ? a.createElement(l.Z, { entities: t.richText.entities, text: t.richText.text }) : (e.label ?? T),
                        u = t ? k.show : k.hide;
                    return a.createElement(n.Z, { role: "status", style: u }, a.createElement(m, { ariaHidden: !t, ariaLabel: E, label: c, onClick: i, userAvatarUrls: e.userImageUrls }));
                });
        },
        642153: (e, t, r) => {
            r.d(t, { Z: () => o });
            ...
            const o = (e) => {
                    ...
                    return a.createElement(
                        n.Z,
                        { style: [i.root, o, { height: s.default.getSizeStyle(c)?.height }] },
                        u.map((e, n) => a.createElement(s.default, { backgroundColor: t, borderColor: t, borderWidth: m ? "none" : r, key: n, size: c, style: [0 !== n && { marginStart: -1 * l.default.theme.spacesPx[d ? "space4" : "space12"] }, { zIndex: p - n }], uri: e })),
                    );
                },
                i = l.default.create((e) => ({ root: { flexDirection: "row", flexShrink: 0, overflow: "hidden", flexWrap: "wrap", justifyContent: "center" } }));
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.NewTweetsPill.ba41dcba.js.map
