    ...
    ["loader.NotificationHandler"],
    {
        41903: (e, t, n) => {
            ...
            const ze = ({ focused: e, text: t }) => r.createElement(be.Z, { alignment: t.alignment, color: "gray700", entities: t.entities, id: e ? "notification-additional-context" : void 0, rtl: t.rtl, text: t.text }),
                ...
                Ue = Object.freeze([je.colorDeepGray, je.icon]),
                Be = Object.freeze([je.colorGreen, je.icon]),
                Ve = Object.freeze([je.colorOrange, je.icon]),
                Le = Object.freeze([je.colorPlum, je.icon]),
                ...
                Xe = r.createElement(x.default, { style: Ue }),
                et = r.createElement(C.default, { style: Re }),
                tt = r.createElement(w.default, { style: Me }),
                nt = r.createElement(v.default, { style: Ue }),
                ot = r.createElement(k.default, { style: Ue }),
                lt = r.createElement(Z.default, { style: je.icon }),
                at = r.createElement(z.default, { style: je.icon }),
                it = r.createElement(I.default, { style: Re }),
                rt = r.createElement(A.default, { style: Re }),
                ct = r.createElement(P.default, { style: Ue }),
                st = r.createElement(D.default, { style: Re }),
                dt = r.createElement(S.default, { style: Be }),
                ...
                yt = r.createElement(R.default, { style: Ve }),
                _t = r.createElement(M.default, { style: Ve }),
                Et = r.createElement(U.default, { style: je.icon }),
                bt = r.createElement(B.default, { style: je.icon }),
                ht = r.createElement(V.default, { style: Le }),
                xt = r.createElement(L.default, { style: Me }),
                Ct = r.createElement(N.default, { style: Re }),
                wt = r.createElement(F.default, { style: Re }),
                vt = r.createElement(G.default, { style: Be }),
                kt = r.createElement(Q.default, { style: je.icon }),
                Zt = { alert_bell_icon: Qe, bar_chart_icon: Ge, bell_icon: Qe, birdwatch_icon: We, bird_icon: pt, briefcase_icon: Ye, coin_icon: at, communities_icon: $e, conversation_bubble_icon: yt, heart_icon: Je, heart_plus_icon: Ke, histogram_icon: ct, lightning_bolt_icon: et, list_icon: Xe, live_icon: tt, lock_icon: nt, magic_rec_icon: pt, milestone_icon: lt, news_icon: ot, person_icon: it, play_icon: rt, promoted_icon: st, radar_stroke_icon: kt, reply_icon: yt, report_icon: qe, recommendation_icon: mt, retweet_icon: dt, safety_icon: ut, security_alert_icon: Et, security_unknown_icon: bt, shield_icon: _t, spaces_icon: gt, stacked_cards_icon: pt, super_follows_icon: ht, super_follows_error_icon: xt, topic_icon: ft, trending_icon: pt, verified_general_icon: Ct, verified_notable_icon: wt, money_icon: vt },
                zt = (e) => {
                    ...
                    const y = r.useCallback(() => {
                        ...
                        k = (0, W.HD)(n),
                        Z = r.useMemo(() => x.aggregateUserActionsV1.fromUsers.map((e) => e.user).filter(Boolean), [x.aggregateUserActionsV1.fromUsers]),
                        z = v && !Z.length && !w,
                        I = b && b.id && Zt[b.id] ? Zt[b.id] : pt,
                        A = C && ("string" == typeof C ? { pathname: C } : C),
                        P = (0, K.hC)("rweb_sourcemap_migration"),
                        D = (0, J.z)(),
                        S = r.useMemo(() => [je.root, p ? je.reducedHorizontalPadding : je.horizontalPadding, D && je.rootRedesign, g && je.unread, k && je.compactContainer], [p, D, g, k]),
                        T = r.useMemo(() => [je.itemContent, je.timelineRowText, z && je.curationPadding], [z]),
                        O = k ? "medium" : void 0;
                    return r.createElement(d.$6, null, (e) => r.createElement(m.Z, { "aria-labelledby": o ? [De, Se, Te, Oe].join(" ") : void 0, link: A ? e.withAnchorless(A) : void 0, onBlur: E, onClick: y, onFocus: _, role: "article", style: S, testID: Pe }, w ? r.createElement(he.Z, { avatarSize: O, contextType: w.contextType, link: w.landingUrl ? (0, X.s9)(w.landingUrl) : void 0, style: je.socialContext, text: w.text }) : null, r.createElement(u.Z, { avatarCell: I, avatarCellStyle: [je.itemIcon, p && je.edgeToEdgeItemIcon, P && je.itemIconRedesign], avatarSize: O, cellStyle: T, style: p && je.edgeToEdgeSocialContext }, Z.length ? r.createElement(c.Z, { style: je.userAvatarList }, r.createElement(q, { users: Z })) : null, r.createElement(be.Z, { alignment: h.alignment, entities: h.entities, id: o ? De : void 0, rtl: h.rtl, text: h.text }), r.createElement(Ie, { focused: o, template: x }), r.createElement(we, { focused: o, link: C, template: x })), v ? r.createElement(c.Z, { style: [je.curationControl, D && je.curationControlRedesign] }, v) : null));
                },
                It = (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.NotificationHandler.33adb7ba.js.map
