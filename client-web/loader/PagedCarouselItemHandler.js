        ...
        301758: (e, t, r) => {
            ...
            const w = (e, t) => t.tweetId,
                ...
                b = (0, p.Z)()
                    ...
                    const { featureSwitches: y, viewerUserId: x } = n.useContext(d.rC),
                        E = (0, l.z)(),
                        g = u?.community_id_str;
                    n.useEffect(() => {
                        g && (0, a.Z)(e) && r(g).catch(t());
                    }, [e, g, t, r]);
                    const k = n.useCallback(
                            (e) => {
                                E.scribeAction("click"), C && C(e);
                            },
                            [C, E],
                        ),
                        T = !!b,
                        f = u && (0, i.D$)(u, x, e),
                        I = f && (0, i.rl)(f);
                    return n.createElement(s.ZP.Provider, { value: { isEditTweetConsumptionEnabled: () => y.isTrue("responsive_web_edit_tweet_enabled") || y.isTrue("subscriptions_feature_labs_1004") } }, n.createElement(c.Z, (0, o.Z)({}, _, { loggedInUserId: x, onAvatarClick: p, onMediaClick: m, onPress: k, onScreenNameClick: w, shouldShowAltLabelAlways: !0, socialContextProps: I, tweet: u, withBirdwatchPivot: T })));
                });
        },
        562154: (e, t, r) => {
            ...
            const x = (e, t) => {
                ...
                g = (0, b.Z)()
                    .propsFromState(() => ({ tweet: x }))
                    .propsFromActions(({ module: e }) => ({ applyReactionInstructions: e.applyReactionInstructions, createLocalApiErrorHandler: (0, h.zr)("PAGED_CAROUSEL_FEEDBACK_ITEM"), processCallback: y.Z }))(c.memo(E)),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.PagedCarouselItemHandler.45871a6a.js.map
