(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.ProfileClusterFollow", "icons/IconFollowArrowLeft-js", "icons/IconSparkle-js"],
    {
        801301: (e) => {
        ...
        751154: (e, t, r) => {
            ...
            const T = "profile-cluster-follow",
                ...
                U = (0, x.Z)()
                    .propsFromState(() => ({ fetchStatus: v, recommendations: Z }))
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, I.zr)("WHO_TO_FOLLOW_CONTAINER"), fetchRecommendationsIfNeeded: S.yY }))
                    .withAnalytics(),
                P = { component: "suggest_profile_cluster_follow", element: "user", action: "results" },
        ...
        994305: (e, t, r) => {
                    ...
                    switch (t.type) {
                        ...
                        case x: {
                            const r = L(t.meta),
                                ...
                                n = (t.payload && t.payload.result ? t.payload.result : v).map((e) => o.recommendations[e]);
            ...
            const Z = [],
                v = [],
                U = (e, { displayLocation: t, similarToUserId: r }) => {
                    const o = e[C][L({ displayLocation: t, similarToUserId: r })];
                    return o && o.recommendations ? o.recommendations : Z;
                },
                ...
                R = (e) => (t, r, o) => {
                    const n = r(),
                        ...
                        i = U(n, { displayLocation: a, similarToUserId: l }),
                        c = P(n, { displayLocation: a, similarToUserId: l }) === w.ZP.LOADED;
                    return i && c
                        ? Promise.resolve(s())
                        : t(
                              (
        ...
        537439: (e, t, r) => {
            ...
            const v = n().ae408b76,
                ...
                k = ({ contextType: e, iconColor: t, iconSize: r, link: s, retweetData: n, text: x, topicData: T, userAvatarUrls: v }) => {
                    const { isSelfRetweet: k, name: Q, screenName: B } = n || {},
                        M = ((e, t, r, s = []) => {
                            const n = A[t],
                                ...
                                v = o.createElement(l.default, { style: x }),
                                U = o.createElement(i.default, { style: x }),
                                P = o.createElement(c.default, { style: x }),
                    ...
                    switch (e) {
                        ...
                        case Z.Q.Pin:
                            return { Icon: M, text: x || U };
                        case Z.Q.ReplyPin:
                            return { Icon: M, text: P };
                        case Z.Q.Topic:
            ...
            class p extends o.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: r, id: i, onLayout: c, rightControl: d, style: m, testID: p, textColor: f, textSize: y, topControl: _, weight: E, withBottomBorder: w, withLeftPadding: b, withTextCentered: C, ...g } = this.props,
                        ...
                        { cellStyle: Z, viewStyle: v } = this._getStyles();
                    return T ? o.createElement(l.ZP.UseProps, null, (n) => o.createElement(o.Fragment, null, _ || null, o.createElement(s.Z, { onLayout: c, style: [m, v, n.socialContextRefreshEnabled() && !b && h.socialContextRefresh] }, o.createElement(a.Z, { avatarCell: I || (b ? null : void 0), avatarCellStyle: [r, h.socialContextIconColumn, !b && h.unsetIconWidth, n.socialContextRefreshEnabled() && !b && h.socialContextRefreshIcon], avatarSize: e, cellStyle: Z }, o.createElement(s.Z, { style: h.cellWrapper }, o.createElement(s.Z, { style: [h.socialContextTextColumn, n.socialContextRefreshEnabled() && !b && h.socialContextRefreshTextColumn] }, S ? this._renderLink(S, L) : L), d || null)), t || null))) : null;
                }
                _renderLink(e, t) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.ProfileClusterFollow.4dcf22ca.js.map
