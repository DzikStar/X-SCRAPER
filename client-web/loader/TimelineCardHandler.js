    ...
    ["loader.TimelineCardHandler", "icons/IconBookmarkPlusStroke-js", "icons/IconChevronRight-js", "icons/IconFollowArrowLeft-js", "icons/IconNumberedList-js", "icons/IconSound-js", "icons/IconSparkle-js"],
    {
                ...
                f =
                    ...
                    (i, a, { api: s }) => {
                        const { event: c, impression_id: u } = o,
                            h = `${n}-${t ?? "undefined"}-${u ?? "undefined"}-${c ?? "undefined"}`;
                        if (m.has(c) && p(a(), h)) return Promise.resolve();
        ...
        524496: (e, t, n) => {
            ...
            const k = o.memo(function (e) {
                    ...
                    const h = [(0, _.ez)(a, s), _.aF, _.RU];
                    e.disable_entityLinkDecorator || h.push((0, _.NA)(a, s));
                    ...
                    return (
                        ...
                        o.createElement(c.ZP, null, ({ containerWidth: e }) => o.createElement(i.Z, { style: v.fontFamily }, o.createElement(r.Editor, { blockRenderMap: g, blockRendererFn: k, blockStyleFn: (0, d.su)(p.Z.isNarrowScreenWidth(e)), editorState: b, onChange: l.Z, readOnly: !0, webDriverTestID: "longformRichTextComponent" })))
                    );
                }),
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => x, KJ: () => k, LI: () => T, P7: () => f, PW: () => E, QF: () => b, Qm: () => w, Tr: () => S, b$: () => h, db: () => F, et: () => y, fR: () => p, iH: () => Z, lD: () => g, su: () => v, u4: () => z, wX: () => $ });
            var o = n(202784),
                r = n(111677),
                i = n.n(r),
                a = n(394123),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TimelineCardHandler.901f51ea.js.map
