(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.TimelineCardHandler"],
    {
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => x, KJ: () => k, LI: () => S, P7: () => h, PW: () => E, QF: () => b, Qm: () => w, Tr: () => T, b$: () => f, db: () => P, et: () => v, fR: () => p, iH: () => z, lD: () => g, su: () => y, u4: () => F, wX: () => $ });
            var o = n(202784),
                r = n(332920),
                a = n.n(r),
                i = n(394123),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TimelineCardHandler.796aa4da.js.map
