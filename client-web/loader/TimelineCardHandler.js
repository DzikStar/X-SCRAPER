(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.TimelineCardHandler", "icons/IconBoldCompact-js", "icons/IconItalic-js", "icons/IconQuoteStroke-js"],
    {
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => x, KJ: () => k, LI: () => T, P7: () => h, PW: () => E, QF: () => b, Qm: () => w, Tr: () => S, b$: () => f, db: () => Z, et: () => y, fR: () => p, iH: () => z, lD: () => g, su: () => v, u4: () => F, wX: () => $ });
            var o = n(202784),
                r = n(111677),
                i = n.n(r),
                a = n(394123),
            ...
            const p = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                z = [{ blockType: h.header1, label: y, component: T({ size: "title1", extendedWidth: !0, children: y }) }, { blockType: h.header2, label: E, component: T({ size: "title3", weight: "heavy", children: E }) }, S],
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TimelineCardHandler.d585fbaa.js.map
