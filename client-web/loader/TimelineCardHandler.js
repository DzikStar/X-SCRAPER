    ...
    ["loader.TimelineCardHandler"],
    {
            ...
            const z = { result: [], entities: {}, slice_info: {} },
                $ = (e, t) => {
                    const n = t?.bookmark_all_delete,
                        r = "Done" === n;
                    return r || (0, o.ZP)("GQL Bookmarks: Failed to delete all bookmarks"), (0, i.jB)(e) || !r;
                },
                x = (0, i.kj)((e) => {
                ...
                F = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarksTimeline: ({ count: n, cursor: r }) => e.graphQL(_(), { count: n, cursor: r, includePromotedContent: !0, ...(0, a.d)(t) }, (e, t) => !t?.bookmark_timeline_v2?.timeline).then((e) => e?.bookmark_timeline_v2?.timeline || S.cY),
                    fetchBookmarkFolderTimeline: ({ bookmark_collection_id: n, cursor: r }) => e.graphQL(m(), { bookmark_collection_id: n, cursor: r, includePromotedContent: !0, ...(0, a.d)(t) }, Z).then((e) => e?.bookmark_collection_timeline?.timeline || S.cY),
        ...
        138896: (e, t, n) => {
            ...
            const d = (e, t) => s.Z.select(e, t.entry?.content?.id),
                ...
                _ = c(i.memo(u)),
                h = o.iH({ component: _, shouldDisplayBorder: (0, r.Z)(!1), isFocusable: (0, r.Z)(!0) }).getHandler();
        },
        518966: (e, t, n) => {
            "use strict";
            n.d(t, { h: () => s });
            ...
            const a = o().ef504d80,
                l = o().cef96d5a,
                s = { defaultToast: { text: o().b2542f56 }, [i.ZP.DuplicateBookmark]: { toast: { text: l } }, [i.ZP.ProtectedTweetBookmarkError]: { toast: { text: a } }, showToast: !0 };
        },
        349972: (e, t, n) => {
            "use strict";
            n.d(t, { j: () => o });
        ...
        694180: (e, t, n) => {
            ...
            const s = {},
                ...
                m = (0, r.Z)([i.dx.IMPRESSION, i.dx.DWELL]),
                u = (0, r.Z)([i.AJ.TREND_VIEW, i.AJ.SPOTLIGHT_IMPRESSION]),
            ...
            const h = (e, t) => !!e.promotedContent[t],
                p =
                    ...
                    (t, n, { api: r }) => {
                        const { event: i, impression_id: a, promoted_trend_id: s } = e,
                            c = `trend-${s}-${i}`;
                        if (u.has(i) && h(n(), c)) return Promise.resolve();
                ...
                f =
                    ...
                    (i, a, { api: s }) => {
                        ...
                        if (m.has(c) && h(a(), p)) return Promise.resolve();
                        const f = e && "earned" === e.toLowerCase() ? "1" : null,
                            b = { ...r, earned: f, epoch_ms: Date.now() };
                        return (0, l._O)(i, { params: b, request: s.withEndpoint(o.Z).log })({ actionTypes: d, context: "APP_PROMOTED_CONTENT_LOG", meta: b }, (e, t) => {
        ...
        977154: (e, t, n) => {
            ...
            var r = n(403911),
                ...
                a = n(218951);
            const l = "bookmarks",
                s = (0, a.Z)({ timelineId: l, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchBookmarksTimeline, getEndpointParams: ({ count: e, cursor: t }) => ({ count: e, cursor: "string" == typeof t ? t : void 0 }) }, formatResponse: o.Z, context: "FETCH_BOOKMARKS_TIMELINE", perfKey: "bookmarksGraphQL" }),
                d = s,
                c = (e) => (0, a.Z)({ timelineId: `bookmarkFolder-${e}`, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchBookmarkFolderTimeline, getEndpointParams: ({ cursor: t }) => ({ cursor: "string" == typeof t ? t : void 0, bookmark_collection_id: e }) }, formatResponse: o.Z, context: "FETCH_BOOKMARK_FOLDER_TIMELINE", perfKey: "bookmarkFolderGraphQL" }),
                m =
                    () =>
        ...
        529509: (e, t, n) => {
            ...
            class p extends r.Component {
                render() {
                    ...
                    return r.createElement(l.Z, { duration: "long", show: void 0 !== n, type: "fade" }, n ? r.createElement(c.Z, { "aria-label": u, interactiveStyles: null, link: a ? ((h = a), `/${h}/followers_you_follow`) : void 0 }, ({ isHovered: n, isPressed: l }) => r.createElement(o.Z, { style: f.content }, !e && m ? r.createElement(d.Z, { userAvatarUrls: t }) : null, r.createElement(s.ZP, { color: "gray700", size: "subtext2", style: [!e && f.message, (n || l) && !!a && f.underline, i] }, e && m ? r.createElement(d.Z, { style: f.inlineFacepile, userAvatarUrls: t }) : null, _))) : r.createElement(o.Z, { style: f.content }, r.createElement(s.ZP, { color: "gray700", size: "subtext2" }, _)));
                    var h;
                }
                _renderMessage() {
            ...
            const f = m.default.create((e) => ({ content: { flexDirection: "row" }, message: { flexShrink: 1, marginStart: e.spaces.space12 }, underline: { textDecorationLine: "underline" }, inlineFacepile: { verticalAlign: "middle", marginEnd: e.spaces.space4 } }));
        },
        135904: (e, t, n) => {
            "use strict";
            n.d(t, { c: () => i, n: () => o });
        ...
        524496: (e, t, n) => {
            ...
            const b = { [d.P7.atomic]: { element: "section" }, [d.P7.header1]: { element: "h1", wrapper: r.createElement(s.ZP, null) }, [d.P7.header2]: { element: "h2", wrapper: r.createElement(s.ZP, null) } },
                g = (0, a.Z)(b).reduce((e, [t, n]) => e.set(t, n), o.DefaultDraftBlockRenderMap);
            let w = !1;
            const k = r.memo(function (e) {
                    ...
                    const p = [(0, _.ez)(a, s), _.aF, _.RU];
                    e.disable_entityLinkDecorator || p.push((0, _.NA)(a, s));
                    ...
                    return (
                        ...
                        r.createElement(c.ZP, null, ({ containerWidth: e }) => r.createElement(i.Z, { style: v.fontFamily }, r.createElement(o.Editor, { blockRenderMap: g, blockRendererFn: k, blockStyleFn: (0, d.su)(h.Z.isNarrowScreenWidth(e)), editorState: b, onChange: l.Z, readOnly: !0, webDriverTestID: "longformRichTextComponent" })))
                    );
                }),
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => x, KJ: () => k, LI: () => T, P7: () => f, PW: () => E, QF: () => b, Qm: () => w, Tr: () => S, b$: () => p, db: () => F, et: () => y, fR: () => h, iH: () => z, lD: () => g, su: () => v, u4: () => Z, wX: () => $ });
            var r = n(202784),
                o = n(674132),
                i = n.n(o),
                a = n(394123),
            ...
            const h = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                b = (e) => [{ buttonTestId: "btn-blockquote", Icon: d.default, key: f.blockquote, onPress: e(f.blockquote) }],
                g = (e) => [
                    { buttonTestId: "btn-ul", Icon: c.default, key: f.bulleted, onPress: e(f.bulleted) },
                    { buttonTestId: "btn-ol", Icon: m.default, key: f.numbered, onPress: e(f.numbered) },
                ],
                w = "LINK",
                ...
                S = { blockType: f.paragraph, label: D, component: T({ size: "body", children: D }) },
                z = [{ blockType: f.header1, label: y, component: T({ size: "title1", extendedWidth: !0, children: y }) }, { blockType: f.header2, label: E, component: T({ size: "title3", weight: "heavy", children: E }) }, S],
        ...
        894023: (e, t, n) => {
            ...
            const l = (e = {}) => {
                const { direction: t } = (0, i.Z)();
                return (0, o.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [a.Z.root, e.style], viewBox: "0 0 24 24", children: r.createElement("g", null, r.createElement("path", { d: "M4 7h3v2H4v2h3v2H4v2h3v2H4v2h3v2H2V3h13v5h-2V5H4v2zm18 4v10H10V11h12zm-2 2h-8v2h3v2h-3v2h8v-6z" })) }, { writingDirection: t });
            };
            l.metadata = { width: 24, height: 24 };
            const s = l;
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TimelineCardHandler.860a47ca.js.map
