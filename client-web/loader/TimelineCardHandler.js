(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.TimelineCardHandler"],
    {
        ...
        403911: (e, t, n) => {
            ...
            const z = { result: [], entities: {}, slice_info: {} },
                ...
                Z = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarkFolderTimeline: ({ bookmark_collection_id: n, cursor: o }) => e.graphQL(m(), { bookmark_collection_id: n, cursor: o, includePromotedContent: !0, ...(0, a.d)(t) }, F).then((e) => e?.bookmark_collection_timeline?.timeline || S.cY),
        ...
        779802: (e, t, n) => {
            "use strict";
            n.d(t, { $u: () => D, Ak: () => x, KJ: () => k, LI: () => T, P7: () => f, PW: () => E, QF: () => b, Qm: () => w, Tr: () => S, b$: () => p, db: () => Z, et: () => y, fR: () => h, iH: () => z, lD: () => g, su: () => v, u4: () => F, wX: () => $ });
            var o = n(202784),
                r = n(674132),
                i = n.n(r),
                a = n(394123),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TimelineCardHandler.86ea535a.js.map
