    ...
    ["loader.TrendHandler"],
    {
        ...
        691067: (e, t, a) => {
            ...
            function y({ description: e, images: t, isLive: a, lastUpdatedAtText: n, link: r, metaDescription: i, name: o, onClick: d, testID: y, thumbnailImage: v, totalTrendPostsText: x, userAvatarUrls: E, withDarkerInteractiveBackground: C }) {
                ...
                return s.createElement(u.Z, { "aria-labelledby": T, link: r ? w.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: b.root, testID: y, withDarkerInteractiveBackground: C }, k);
            }
            ...
            var v = a(530525),
                ...
                C = a(470397),
                w = a(126962);
            function T({ attachment: e, description: t, displayMode: a, domainContext: n, images: r, link: i, metaDescription: d, name: m, onClick: f, renderQuoteTweet: y, socialContext: b, testID: T, thumbnailImage: k, trendFeedbackMenu: D, withDarkerInteractiveBackground: I, withTrendingLabel: M }) {
                const _ = s.useContext(p.ZP),
                    z = (0, g.b)(),
                    A = s.createElement(l.Z, { style: "full" === a ? Z.content : Z.contentHalf }, s.createElement(l.Z, { style: Z.horizontalContainer }, s.createElement(l.Z, { style: Z.textContainer }, s.createElement(c.ZP, { color: "text", numberOfLines: 2, size: "full" === a ? "headline2" : "body", style: Z.text, weight: "bold", withInteractiveStyling: !1 }, m), d ? s.createElement(c.ZP, { color: "gray700", numberOfLines: 2, size: "body", style: Z.descriptionText }, d) : null, s.createElement(C.Z, null, n ? s.createElement(c.ZP, { color: "gray700", size: "subtext2", withoutTwemojiAndHashflags: !0 }, n) : null), b ? s.createElement(w.Z, (0, o.Z)({ style: Z.socialContext }, b)) : null), k ? s.createElement(l.Z, { style: Z.imageContainer }, s.createElement(E.Z, { ratio: h.default.theme.aspectRatios.square }, s.createElement(v.Z, { "aria-label": "trend-image", aspectMode: x.Z.SQUARE, image: { url: k.original_img_url, height: k.original_img_height, width: k.original_img_width } }))) : null, D ? s.createElement(l.Z, { style: Z.caret }, D) : null), y ? s.createElement(l.Z, { style: Z.quoteTweet }, y({ isCondensed: !0 })) : null, e ? s.createElement(l.Z, { style: Z.attachmentWrapper }, e) : null);
                return s.createElement(u.Z, { "aria-labelledby": z, link: i ? _.withAnchorless(i) : void 0, onPress: f, role: i ? void 0 : "article", style: Z.root, testID: T, withDarkerInteractiveBackground: I }, A);
            }
            ...
            var k = a(676145),
                ...
                I = a(628526),
                M = a(442730);
            function _({ attachment: e, description: t, domainContext: a, groupedTrends: n = [], link: r, metaDescription: i, name: o, onClick: d, promotedContent: m, promotedLabel: h, rank: f, renderQuoteTweet: y, testID: b, trendFeedbackMenu: v, withDarkerInteractiveBackground: x }) {
                const E = s.useContext(p.ZP),
                    w = (0, g.b)(),
                    T = i ? s.createElement(c.ZP, { color: "gray700", dir: ((Z = i), (0, k.Z)(Z) && Z.length ? M.Z.getTextDirection(Z, { fromEnd: !0 }) : void 0), size: "subtext2", style: z.metaDescription }, i) : null;
                var Z;
                const _ = s.createElement(C.Z, null, f ? s.createElement(c.ZP, { "aria-hidden": !0, color: "gray700", size: "subtext2" }, f) : null, a ? s.createElement(c.ZP, { color: "gray700", size: "subtext2" }, a) : null),
                    A = s.createElement(c.ZP, { dir: M.Z.getTextDirection(o), style: z.name, weight: "bold", withHashflags: !0 }, o);
                return s.createElement(u.Z, { "aria-labelledby": w, link: r ? E.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: z.root, testID: b, withDarkerInteractiveBackground: x }, s.createElement(l.Z, { id: w, style: z.content }, _, A, t ? s.createElement(c.ZP, { color: "gray700", style: z.description }, t) : null, y ? s.createElement(l.Z, { style: z.quoteTweet }, y({ isCondensed: !0 })) : null, e ? s.createElement(l.Z, { style: z.attachmentWrapper }, e) : null, n.length ? s.createElement(I.Z, { groupedTrends: n }) : null, T, m ? s.createElement(c.ZP, { color: "gray700", size: "subtext2", style: z.promotedIndicatorWrapper }, s.createElement(D.Z, { label: h, promotedContent: m })) : null, v ? s.createElement(l.Z, { style: z.trendFeedbackMenuWrapper }, v) : null));
            }
            ...
            const X = [],
                ...
                ne = ({ cards: e, createLocalApiErrorHandler: t, entry: { content: a }, feedbackItems: n, logTrend: r, withThirdPartyCards: i }) => {
                    const l = (0, H.z)(),
                        c = A.eY(),
                        d = c ? "half" : "full",
                        { associatedTweetIds: m, description: p, groupedTrends: u, images: g, is_ai_trend: h, is_live: f, last_updated_at: b, name: v, promotedMetadata: x, rank: E, socialContext: C, thumbnailImage: w, total_trend_posts: Z, url: k } = a,
                    ...
                    return R ? s.createElement(y, { description: p, images: g, isLive: f, lastUpdatedAtText: b ? (0, $.pi)(new Date(Number(b)), !0) : void 0, link: K, metaDescription: Q ? void 0 : I, name: v, onClick: V, testID: ae, thumbnailImage: w, totalTrendPostsText: Z ? `${(0, $.uf)(Number(Z))} comments` : void 0, userAvatarUrls: F?.userAvatarUrls, withDarkerInteractiveBackground: c }) : z ? s.createElement(T, { attachment: O, description: p, displayMode: d, domainContext: D, images: g, link: K, metaDescription: Q ? void 0 : I, name: v, onClick: V, renderQuoteTweet: Y, socialContext: F, testID: ae, thumbnailImage: w, trendFeedbackMenu: j, withDarkerInteractiveBackground: c, withTrendingLabel: !0 }) : s.createElement(_, { attachment: O, description: p, domainContext: D, groupedTrends: G, link: K, metaDescription: Q ? void 0 : I, name: v, onClick: N, promotedContent: Q, promotedLabel: Q ? I : void 0, rank: E, renderQuoteTweet: Y, testID: ae, trendFeedbackMenu: j, withDarkerInteractiveBackground: c });
                },
                re = te(s.memo(ne)),
                ie = (e) =>
                    i
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TrendHandler.24f868da.js.map
