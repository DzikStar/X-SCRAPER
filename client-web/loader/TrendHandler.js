    ...
    ["loader.TrendHandler"],
    {
        ...
        691067: (e, t, a) => {
            ...
            function f({ description: e, images: t, isLive: a, lastUpdatedAtText: n, link: r, metaDescription: i, name: o, onClick: d, testID: f, thumbnailImage: b, totalTrendPostsText: E, userAvatarUrls: x, withDarkerInteractiveBackground: w }) {
                ...
                return l.createElement(u.Z, { "aria-labelledby": Z, link: r ? C.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: y.root, testID: f, withDarkerInteractiveBackground: w }, k);
            }
            ...
            var b = a(530525),
                ...
                w = a(470397),
                C = a(126962);
            function Z({ attachment: e, description: t, displayMode: a, domainContext: n, images: r, link: i, metaDescription: d, name: m, onClick: v, renderQuoteTweet: f, socialContext: y, testID: Z, thumbnailImage: k, trendFeedbackMenu: D, withDarkerInteractiveBackground: M, withTrendingLabel: I }) {
                const z = l.useContext(p.ZP),
                    _ = (0, h.b)(),
                    A = l.createElement(s.Z, { style: "full" === a ? T.content : T.contentHalf }, l.createElement(s.Z, { style: T.horizontalContainer }, l.createElement(s.Z, { style: T.textContainer }, l.createElement(c.ZP, { color: "text", numberOfLines: 2, size: "full" === a ? "headline2" : "body", style: T.text, weight: "bold", withInteractiveStyling: !1 }, m), d ? l.createElement(c.ZP, { color: "gray700", numberOfLines: 2, size: "body", style: T.descriptionText }, d) : null, l.createElement(w.Z, null, n ? l.createElement(c.ZP, { color: "gray700", size: "subtext2", withoutTwemojiAndHashflags: !0 }, n) : null), y ? l.createElement(C.Z, (0, o.Z)({ style: T.socialContext }, y)) : null), k ? l.createElement(s.Z, { style: T.imageContainer }, l.createElement(x.Z, { ratio: g.default.theme.aspectRatios.square }, l.createElement(b.Z, { "aria-label": "trend-image", aspectMode: E.Z.SQUARE, image: { url: k.original_img_url, height: k.original_img_height, width: k.original_img_width } }))) : null, D ? l.createElement(s.Z, { style: T.caret }, D) : null), f ? l.createElement(s.Z, { style: T.quoteTweet }, f({ isCondensed: !0 })) : null, e ? l.createElement(s.Z, { style: T.attachmentWrapper }, e) : null);
                return l.createElement(u.Z, { "aria-labelledby": _, link: i ? z.withAnchorless(i) : void 0, onPress: v, role: i ? void 0 : "article", style: T.root, testID: Z, withDarkerInteractiveBackground: M }, A);
            }
            ...
            var k = a(676145),
                ...
                M = a(628526),
                I = a(442730);
            function z({ attachment: e, description: t, domainContext: a, groupedTrends: n = [], link: r, metaDescription: i, name: o, onClick: d, promotedContent: m, promotedLabel: g, rank: v, renderQuoteTweet: f, testID: y, trendFeedbackMenu: b, withDarkerInteractiveBackground: E }) {
                const x = l.useContext(p.ZP),
                    C = (0, h.b)(),
                    Z = i ? l.createElement(c.ZP, { color: "gray700", dir: ((T = i), (0, k.Z)(T) && T.length ? I.Z.getTextDirection(T, { fromEnd: !0 }) : void 0), size: "subtext2", style: _.metaDescription }, i) : null;
                var T;
                const z = l.createElement(w.Z, null, v ? l.createElement(c.ZP, { "aria-hidden": !0, color: "gray700", size: "subtext2" }, v) : null, a ? l.createElement(c.ZP, { color: "gray700", size: "subtext2" }, a) : null),
                    A = l.createElement(c.ZP, { dir: I.Z.getTextDirection(o), style: _.name, weight: "bold", withHashflags: !0 }, o);
                return l.createElement(u.Z, { "aria-labelledby": C, link: r ? x.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: _.root, testID: y, withDarkerInteractiveBackground: E }, l.createElement(s.Z, { id: C, style: _.content }, z, A, t ? l.createElement(c.ZP, { color: "gray700", style: _.description }, t) : null, f ? l.createElement(s.Z, { style: _.quoteTweet }, f({ isCondensed: !0 })) : null, e ? l.createElement(s.Z, { style: _.attachmentWrapper }, e) : null, n.length ? l.createElement(M.Z, { groupedTrends: n }) : null, Z, m ? l.createElement(c.ZP, { color: "gray700", size: "subtext2", style: _.promotedIndicatorWrapper }, l.createElement(D.Z, { label: g, promotedContent: m })) : null, b ? l.createElement(s.Z, { style: _.trendFeedbackMenuWrapper }, b) : null));
            }
            ...
            var A = a(771099),
                ...
                V = a(370751),
                F = a(260137);
            const { CardNames: W } = R.default,
                N = Object.freeze({ [W.LIVE_EVENT]: !0, [W.MOMENT]: !0, [W.SUMMARY]: !0, [W.SUMMARY_LARGE_IMAGE]: !0, [W.AUDIOSPACE]: !0 }),
                O = (0, V.Z)([W.LIVE_EVENT, W.AUDIOSPACE]);
            const G = { locationKey: "trend", tweetUserId: "TREND_CARD_NO_TWEET_USER_ID" },
                K = ({ card: e, withThirdPartyCards: t }) => {
                    ...
                    return (function ({ card: e, withThirdPartyCards: t }) {
                        return !(!N[e.name] || (!O.has(e.name) && !t));
                    })({ card: e, withThirdPartyCards: t })
                        ? l.createElement(F.default, { card: a, cardContext: G, cardState: "secondary" })
                        : null;
                },
                q = l.memo(K);
            var Q = a(71620),
            ...
            const X = [],
                ...
                ne = ({ cards: e, createLocalApiErrorHandler: t, entry: { content: a }, feedbackItems: n, logTrend: r, withThirdPartyCards: i }) => {
                    const s = (0, P.z)(),
                        c = A.eY(),
                        d = c ? "half" : "full",
                        { associatedTweetIds: m, description: p, groupedTrends: u, images: h, is_ai_trend: g, is_live: v, last_updated_at: y, name: b, promotedMetadata: E, rank: x, socialContext: w, thumbnailImage: C, total_trend_posts: T, url: k } = a,
                        { domainContext: D, metaDescription: M } = a.trendMetadata,
                        { featureSwitches: I } = l.useContext($.rC),
                        _ = I.isTrue("responsive_web_trends_ui_top_articles") && g,
                        R = I.isTrue("responsive_web_grok_trend_news_cell_enabled") && g,
                    ...
                    l.useEffect(() => {
                        s.scribeAction("impression"), F(S.AJ.TREND_VIEW);
                    }, [s, F]);
                    const W = l.useCallback(() => {
                            s.scribeAction("search"), F(S.AJ.TREND_CLICK);
                        }, [s, F]),
                        N = l.useCallback(() => {
                            s.scribeAction("click"), F(S.AJ.TREND_CLICK);
                        }, [s, F]),
                        ...
                        Y = l.useMemo(() => (m?.length ? (e) => l.createElement(B.Z, (0, o.Z)({}, e, { tweetId: m[0], withLink: !0 })) : void 0), [m]),
                        j = l.useMemo(() => (n?.length ? l.createElement(U.Z, { feedbackItems: n }) : void 0), [n]);
                    return R ? l.createElement(f, { description: p, images: h, isLive: v, lastUpdatedAtText: y ? (0, L.pi)(new Date(Number(y)), !0) : void 0, link: K, metaDescription: Q ? void 0 : M, name: b, onClick: N, testID: ae, thumbnailImage: C, totalTrendPostsText: T ? `${(0, L.uf)(Number(T))} comments` : void 0, userAvatarUrls: V?.userAvatarUrls, withDarkerInteractiveBackground: c }) : _ ? l.createElement(Z, { attachment: O, description: p, displayMode: d, domainContext: D, images: h, link: K, metaDescription: Q ? void 0 : M, name: b, onClick: N, renderQuoteTweet: Y, socialContext: V, testID: ae, thumbnailImage: C, trendFeedbackMenu: j, withDarkerInteractiveBackground: c, withTrendingLabel: !0 }) : l.createElement(z, { attachment: O, description: p, domainContext: D, groupedTrends: G, link: K, metaDescription: Q ? void 0 : M, name: b, onClick: W, promotedContent: Q, promotedLabel: Q ? M : void 0, rank: x, renderQuoteTweet: Y, testID: ae, trendFeedbackMenu: j, withDarkerInteractiveBackground: c });
                },
                re = te(l.memo(ne)),
                ie = (e) =>
                    i
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TrendHandler.74242b5a.js.map
