    ...
    ["loader.TrendHandler"],
    {
        ...
        691067: (e, t, a) => {
            ...
            function f({ description: e, images: t, isLive: a, lastUpdatedAtText: n, link: r, metaDescription: i, name: o, onClick: d, testID: f, thumbnailImage: b, totalTrendPostsText: x, userAvatarUrls: E, withDarkerInteractiveBackground: C }) {
                ...
                return l.createElement(u.Z, { "aria-labelledby": Z, link: r ? w.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: y.root, testID: f, withDarkerInteractiveBackground: C }, k);
            }
            ...
            function Z({ attachment: e, description: t, displayMode: a, domainContext: n, images: r, link: i, metaDescription: d, name: m, onClick: v, renderQuoteTweet: f, socialContext: y, testID: Z, thumbnailImage: k, trendFeedbackMenu: D, withDarkerInteractiveBackground: I, withTrendingLabel: M }) {
                const _ = l.useContext(p.ZP),
                    z = (0, g.b)(),
                    A = l.createElement(s.Z, { style: "full" === a ? T.content : T.contentHalf }, l.createElement(s.Z, { style: T.horizontalContainer }, l.createElement(s.Z, { style: T.textContainer }, l.createElement(c.ZP, { color: "text", numberOfLines: 2, size: "full" === a ? "headline2" : "body", style: T.text, weight: "bold", withInteractiveStyling: !1 }, m), d ? l.createElement(c.ZP, { color: "gray700", numberOfLines: 2, size: "body", style: T.descriptionText }, d) : null, l.createElement(C.Z, null, n ? l.createElement(c.ZP, { color: "gray700", size: "subtext2", withoutTwemojiAndHashflags: !0 }, n) : null), y ? l.createElement(w.Z, (0, o.Z)({ style: T.socialContext }, y)) : null), k ? l.createElement(s.Z, { style: T.imageContainer }, l.createElement(E.Z, { ratio: h.default.theme.aspectRatios.square }, l.createElement(b.Z, { "aria-label": "trend-image", aspectMode: x.Z.SQUARE, image: { url: k.original_img_url, height: k.original_img_height, width: k.original_img_width } }))) : null, D ? l.createElement(s.Z, { style: T.caret }, D) : null), f ? l.createElement(s.Z, { style: T.quoteTweet }, f({ isCondensed: !0 })) : null, e ? l.createElement(s.Z, { style: T.attachmentWrapper }, e) : null);
                return l.createElement(u.Z, { "aria-labelledby": z, link: i ? _.withAnchorless(i) : void 0, onPress: v, role: i ? void 0 : "article", style: T.root, testID: Z, withDarkerInteractiveBackground: I }, A);
            }
            const T = h.default.create((e) => ({ root: { display: "flex", paddingHorizontal: e.componentDimensions.gutterHorizontal }, caret: { marginStart: `calc(${h.default.theme.spaces.space12} * -1)` }, metaDescription: { marginTop: e.spaces.space4 }, imageContainer: { marginStart: e.componentDimensions.gutterHorizontal, borderRadius: e.borderRadii.large, maxHeight: `calc(${h.default.theme.spaces.space40} * 2)`, maxWidth: `calc(${h.default.theme.spaces.space40} * 2)`, minHeight: `calc(${h.default.theme.spaces.space40} + ${h.default.theme.spaces.space20})`, minWidth: `calc(${h.default.theme.spaces.space40} + ${h.default.theme.spaces.space20})`, height: "20%", width: "20%", overflow: "hidden" }, content: { flexGrow: 1, position: "relative", paddingTop: e.spaces.space20, paddingBottom: e.spaces.space20 }, contentHalf: { flexGrow: 1, position: "relative", borderBottomWidth: e.borderWidths.small, borderColor: e.colors.gray50, paddingTop: e.spaces.space16, paddingBottom: e.spaces.space16 }, horizontalContainer: { flex: 1, flexDirection: "row" }, textContainer: { flex: 1 }, socialContext: { marginTop: e.spaces.space2 }, text: { marginBottom: e.spaces.space4 }, descriptionText: { marginBottom: e.spaces.space4 }, quoteTweet: { marginTop: e.spaces.space8 }, attachmentWrapper: { alignSelf: "stretch", marginBottom: e.spaces.space4, marginTop: e.spaces.space12 } }));
            var k = a(676145),
                D = a(378729),
                I = a(628526),
                M = a(442730);
            function _({ attachment: e, description: t, domainContext: a, groupedTrends: n = [], link: r, metaDescription: i, name: o, onClick: d, promotedContent: m, promotedLabel: h, rank: v, renderQuoteTweet: f, testID: y, trendFeedbackMenu: b, withDarkerInteractiveBackground: x }) {
                const E = l.useContext(p.ZP),
                    w = (0, g.b)(),
                    Z = i ? l.createElement(c.ZP, { color: "gray700", dir: ((T = i), (0, k.Z)(T) && T.length ? M.Z.getTextDirection(T, { fromEnd: !0 }) : void 0), size: "subtext2", style: z.metaDescription }, i) : null;
                var T;
                const _ = l.createElement(C.Z, null, v ? l.createElement(c.ZP, { "aria-hidden": !0, color: "gray700", size: "subtext2" }, v) : null, a ? l.createElement(c.ZP, { color: "gray700", size: "subtext2" }, a) : null),
                    A = l.createElement(c.ZP, { dir: M.Z.getTextDirection(o), style: z.name, weight: "bold", withHashflags: !0 }, o);
                return l.createElement(u.Z, { "aria-labelledby": w, link: r ? E.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: z.root, testID: y, withDarkerInteractiveBackground: x }, l.createElement(s.Z, { id: w, style: z.content }, _, A, t ? l.createElement(c.ZP, { color: "gray700", style: z.description }, t) : null, f ? l.createElement(s.Z, { style: z.quoteTweet }, f({ isCondensed: !0 })) : null, e ? l.createElement(s.Z, { style: z.attachmentWrapper }, e) : null, n.length ? l.createElement(I.Z, { groupedTrends: n }) : null, Z, m ? l.createElement(c.ZP, { color: "gray700", size: "subtext2", style: z.promotedIndicatorWrapper }, l.createElement(D.Z, { label: h, promotedContent: m })) : null, b ? l.createElement(s.Z, { style: z.trendFeedbackMenuWrapper }, b) : null));
            }
            ...
            const { CardNames: W } = R.default,
                ...
                O = (0, F.Z)([W.LIVE_EVENT, W.AUDIOSPACE]);
            const G = { locationKey: "trend", tweetUserId: "TREND_CARD_NO_TWEET_USER_ID" },
                K = ({ card: e, withThirdPartyCards: t }) => {
                    ...
                    return (function ({ card: e, withThirdPartyCards: t }) {
                        ...
                        ? l.createElement(V.default, { card: a, cardContext: G, cardState: "secondary" })
                        : null;
                },
                q = l.memo(K);
            var Q = a(71620),
            ...
            const X = [],
                ...
                ne = ({ cards: e, createLocalApiErrorHandler: t, entry: { content: a }, feedbackItems: n, logTrend: r, withThirdPartyCards: i }) => {
                    const s = (0, H.z)(),
                        ...
                        { featureSwitches: M } = l.useContext(L.rC),
                        z = M.isTrue("responsive_web_trends_ui_top_articles") && h,
                        R = M.isTrue("responsive_web_grok_trend_news_cell_enabled") && h,
                    ...
                    l.useEffect(() => {
                        s.scribeAction("impression"), V(P.AJ.TREND_VIEW);
                    }, [s, V]);
                    const W = l.useCallback(() => {
                            s.scribeAction("search"), V(P.AJ.TREND_CLICK);
                        }, [s, V]),
                        N = l.useCallback(() => {
                            s.scribeAction("click"), V(P.AJ.TREND_CLICK);
                        }, [s, V]),
                    ...
                    return R ? l.createElement(f, { description: p, images: g, isLive: v, lastUpdatedAtText: y ? (0, $.pi)(new Date(Number(y)), !0) : void 0, link: K, metaDescription: Q ? void 0 : I, name: b, onClick: N, testID: ae, thumbnailImage: w, totalTrendPostsText: T ? `${(0, $.uf)(Number(T))} comments` : void 0, userAvatarUrls: F?.userAvatarUrls, withDarkerInteractiveBackground: c }) : z ? l.createElement(Z, { attachment: O, description: p, displayMode: d, domainContext: D, images: g, link: K, metaDescription: Q ? void 0 : I, name: b, onClick: N, renderQuoteTweet: Y, socialContext: F, testID: ae, thumbnailImage: w, trendFeedbackMenu: j, withDarkerInteractiveBackground: c, withTrendingLabel: !0 }) : l.createElement(_, { attachment: O, description: p, domainContext: D, groupedTrends: G, link: K, metaDescription: Q ? void 0 : I, name: b, onClick: W, promotedContent: Q, promotedLabel: Q ? I : void 0, rank: E, renderQuoteTweet: Y, testID: ae, trendFeedbackMenu: j, withDarkerInteractiveBackground: c });
                },
                re = te(l.memo(ne)),
                ie = (e) =>
                    i
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TrendHandler.a0a862ea.js.map
