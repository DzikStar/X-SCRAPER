    ...
    ["loader.TrendHandler"],
    {
        ...
        691067: (e, t, a) => {
            ...
            var n = a(459643),
                ...
                g = a(392237),
                v = a(823161);
            function f({ description: e, images: t, isLive: a, lastUpdatedAtText: n, link: r, metaDescription: i, name: o, onClick: d, socialContext: f, testID: b, thumbnailImage: C, totalTrendPostsText: x, withDarkerInteractiveBackground: E }) {
                const w = l.useContext(p.ZP),
                    Z = (0, h.b)(),
                    T = (f?.userAvatarUrls || []).slice(0, 3),
                    k = l.createElement(
                        s.Z,
                        { style: y.content },
                        l.createElement(
                            ...
                            C ? l.createElement(s.Z, { style: y.imageContainer }, l.createElement(m.Z, { resizeMode: "cover", source: C.original_img_url, style: y.image })) : null,
                            l.createElement(
                                s.Z,
                ...
                return l.createElement(u.Z, { "aria-labelledby": Z, link: r ? w.withAnchorless(r) : void 0, onPress: d, role: r ? void 0 : "article", style: y.root, testID: b, withDarkerInteractiveBackground: E }, k);
            }
            ...
            const X = [],
                ...
                ne = ({ cards: e, createLocalApiErrorHandler: t, entry: { content: a }, feedbackItems: n, logTrend: r, withThirdPartyCards: i }) => {
                    const s = (0, H.z)(),
                        ...
                        { featureSwitches: M } = l.useContext($.rC),
                        _ = M.isTrue("responsive_web_trends_ui_top_articles") && g,
                        U = M.isTrue("responsive_web_grok_trend_news_cell_enabled") && g,
                    ...
                    return U ? l.createElement(f, { description: p, images: h, isLive: v, lastUpdatedAtText: y ? (0, B.pi)(new Date(Number(y)), !0) : void 0, link: K, metaDescription: Q ? void 0 : I, name: b, onClick: V, testID: ae, thumbnailImage: w, totalTrendPostsText: T ? `${(0, B.uf)(Number(T))} comments` : void 0, withDarkerInteractiveBackground: c }) : _ ? l.createElement(Z, { attachment: O, description: p, displayMode: d, domainContext: D, images: h, link: K, metaDescription: Q ? void 0 : I, name: b, onClick: V, renderQuoteTweet: Y, socialContext: F, testID: ae, thumbnailImage: w, trendFeedbackMenu: j, withDarkerInteractiveBackground: c, withTrendingLabel: !0 }) : l.createElement(z, { attachment: O, description: p, domainContext: D, groupedTrends: G, link: K, metaDescription: Q ? void 0 : I, name: b, onClick: N, promotedContent: Q, promotedLabel: Q ? I : void 0, rank: x, renderQuoteTweet: Y, testID: ae, trendFeedbackMenu: j, withDarkerInteractiveBackground: c });
                },
                re = te(l.memo(ne)),
                ie = (e) =>
                    i
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TrendHandler.130eea6a.js.map
