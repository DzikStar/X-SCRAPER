            ...
            const k = m().g6185a9e,
                ...
                B = (e) => {
                    const { dismiss: t, isModal: i, midConversationTweet: n, value: l } = e,
                        ...
                        F = !!n,
                        P = F && !n?.entities?.user_mentions?.some((e) => e.id_str !== n.user.id_str);
                    let D = x;
                    return (
                        P ? (D = S) : F && (D = Z),
                        a.createElement(
                            ...
                            a.createElement(
                                ...
                                a.createElement(c.Z, { Icon: P ? g.default : v.default, actionText: D, isSelected: C.k.by_invitation === l, onClick: u(C.k.by_invitation), selectable: !0, style: R.menuRow, withIconAsThumbnail: !0 }),
                                B &&
                                    !n &&
                                    a.createElement(d.Z, {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-6107ac1a.b3694cca.js.map
