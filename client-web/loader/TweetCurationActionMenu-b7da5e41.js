...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.TweetCurationActionMenu-b7da5e41"],
    {
        ...
        841772: (e, t, i) => {
            ...
            const Jt = _().bb16cc76,
                ei = _().de21174c,
                ti = (e, t) => o.createElement(Yt.Z, { onCancel: t, onConfirm: e });
            var ii = i(383494),
                ni = i(232130),
                oi = i(40904),
                si = i(391366);
            const ri = _().e2d6c17e,
                ...
                mi = _().cfd2f35e,
                _i = _().d751694c,
                pi = (0, Qe.ju)("https://support.x.com/articles/20175032"),
                wi = ({ addFlag: e, addToast: t, createLocalApiErrorHandler: i, muteTweet: n, scribeAction: s, shouldShowMuteEducationTip: r, tweet: a, unmuteTweet: l }) => {
                    const c = () => {
                            e(P.EM);
                        },
                        d = () => {
                        ...
                        u = {
                            ...
                            onClick: () => {
                                n(a.id_str).then(
                                    () => {
                                        t({ action: { label: di, onAction: d }, text: li });
                                    },
                                    (e) => {
                            ...
                            confirmation: r ? { render: (e, t) => o.createElement(Ye.Z, { actionLabel: ui, graphic: ni.default, graphicDisplayMode: "illustration", headline: hi, onAction: e, onClose: t, onImpression: c, onTertiaryAction: t, subtext: _i, supportUrl: pi, tertiaryActionLabel: mi }) } : void 0,
                            Icon: oi.default,
                        },
                        h = { text: ai, onClick: d, Icon: si.default };
            ...
            var Ai = i(523561);
            const vi = _().d1c1e2c2,
                Ei = (0, Ai.Z)({ loader: () => i.e("ondemand.CommunityTweetPinning").then(i.bind(i, 828856)) }),
                ki = _().f5cdcc2c,
            ...
            var cn = i(963879);
            const dn = _().cac6a24a,
                un = (0, Ai.Z)({ loader: () => i.e("ondemand.CommunityTweetPinning").then(i.bind(i, 760844)) }),
                hn = _().f9478972,
                mn = _().c5491b5d;
            var _n = i(71620),
                pn = i(143322),
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getMuteOrUnmuteAction = () => {
                            ...
                            return (0, ii.Z)({ ...c, mute: o, unmute: a, user: l, dismissUserFromConversation: i, promotedContent: s, muteAdUpsellEnabled: d, history: n, hasPremiumPlus: this._hasPremiumPlus });
                        }),
                        ...
                        (this._getHighlightUpsellOnPinAction = () => {
                            ...
                            return u && c && d && !h
                                ...
                                : (({ addToast: e, createLocalApiErrorHandler: t, pin: i, scribeAction: n, tweetId: o }) => ({
                                      confirmation: { text: gi, headline: fi, label: Ci },
                                      testID: V,
                                      text: bi,
                                      onClick: () => {
                                          i(o).then(
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    t && (V.highlightOrUndo = t),
                                        ...
                                        L && !this._shouldDisable(S, N.d.MuteConversation) && (V.muteOrUnmuteConversation = wi({ ...Q, addFlag: _, muteTweet: c, shouldShowMuteEducationTip: x, tweet: S, unmuteTweet: h })),
                                        U &&
                                    ...
                                    E && j && (V.promotedTweetDismiss = Ii({ onTweetDismiss: E, hasPremiumPlus: this._hasPremiumPlus, promotedDismissUpsellEnabled: this.context.featureSwitches.isTrue("subscriptions_hide_ad_upsell_enabled"), history: y })),
                                        ...
                                        L && (V.muteOrUnmuteConversation = wi({ ...Q, addFlag: _, muteTweet: c, shouldShowMuteEducationTip: x, tweet: S, unmuteTweet: h })),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-b7da5e41.b11457ba.js.map
