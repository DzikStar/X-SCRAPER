    ...
    ["loader.TweetCurationActionMenu-e019dbda"],
    {
        ...
        923936: (e, t, n) => {
            ...
            const w = o().i419d136,
                ...
                T = i.memo(({ isBlueUpsellEligible: e, onCancel: t, onConfirm: n, onHighlight: a, onPinTweet: o, onUndohighlight: r, tweetId: d }) => {
                    ...
                    return i.createElement(f.OE, { fetchPolicy: "network-only", render: k, variables: T });
                }),
        ...
        59021: (e, t, n) => {
            ...
            function p(e) {
                ...
                n && ((m = { element: "appeal_tweet_warning" }), (_ = "/i/report/appeal_tweet_warning"), (f = u.C2.AppealTweetWarning), (w = s.default), (A = h.appealTweetWarning));
                return {
                    Icon: w,
                    onClick: () => {
        ...
        33669: (e, t, n) => {
            ...
            const h = u().cfd2f35e,
                _ = i.Z,
                f = (0, m.z)(_, { errorConfig: { context: "TWITTER_HIGHLIGHT_TWEET_CONFIRMATION_CONTEXT" } }),
                w = a.memo(({ onCancel: e, onConfirm: t, onHighlight: n, onUndohighlight: i, tweetId: l }) => {
                    ...
                    return a.createElement(f, { fetchPolicy: "network-only", render: m, variables: s });
                }),
        ...
        811507: (e, t, n) => {
            ...
            const h = (e, t) => (0, d.t5)(e, d.EM),
                ...
                g = (0, a.Z)()
                    .propsFromState(() => ({ userCountry: s.GG, userLanguage: s.VT, shouldShowMuteEducationTip: h, shouldShowHideReplyTip: _, shouldShowConversationControlsTip: f, disableRemoveFromCommunity: w, community: A }))
        ...
        847607: (e, t, n) => {
            ...
            const d = a().hb568af4,
                ...
                _ = a().i29533b3,
                f = a().h129c3c3,
                w = (e) => (e ? ((e) => _({ screenName: e }))(e) : m),
                A = (e) => (e ? ((e) => f({ screenName: e }))(e) : h);
        },
        142156: (e, t, n) => {
            n.d(t, { w: () => a });
            var i = n(674132);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-e019dbda.5a277e5a.js.map
