                    ...
                    const [c, m] = i.useState(!1),
                        ...
                        k = i.useCallback(
                            ({ data: e, fetchStatus: n, retry: a }) => {
                                ...
                                return i.createElement(b.Z, { allowBackNavigation: !1, enableMaskForDismiss: !1, role: "alertdialog", style: D.loadingSheet, type: "center", withMask: !0 }, n === _.ZP.FAILED ? i.createElement(p.Z, { onRequestRetry: a }) : i.createElement(h.Z, null));
                            },
                            [x, I, t, Z],
                        );
                    ...
                    const C = () => {
                        ...
                        D = {
                            ...
                            onClick: () => {
                                a(v.id_str).then(
                                    () => {
                                        t({ action: { label: _, onAction: T }, text: h });
                                    },
                                    (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-e019dbda.8c41bfaa.js.map
