    ...
    ["loader.TweetCurationActionMenu-e019dbda"],
    {
        ...
        713842: (e, t, i) => {
                            ...
                            ({ data: t, fetchStatus: r, retry: s }) => {
                                if (r === vt.ZP.LOADED) {
                                    const r = !!t?.tweet_result_by_rest_id?.result?.highlights_info?.highlighted,
                                        { confirmLabel: s, onAction: l, subtext: c, title: d } = (0, At.rg)(r, i, n);
            ...
            const Kt = function ({ addToast: e, createLocalApiErrorHandler: t, highlight: i, isBlueUpsellEligible: n, pin: r, scribeAction: s, tweetId: a, undoHighlight: l }) {
                const c = () => {
                        l(a).then((t) => {
                            e(t?.tweet_highlights_delete?.success ? { text: At.sp, withClearButton: !0 } : { text: Xt, withClearButton: !0, withAutoDismiss: !0 });
                        }),
                            s({ element: "undoHighlight" });
                    },
                    d = () => {
                        i(a).then((t) => {
                            e(t?.tweet_highlights_put?.success ? { action: { label: ft.d, onAction: c }, text: At.I9, withClearButton: !0 } : { text: Xt, withClearButton: !0, withAutoDismiss: !0 });
                        }),
                            s({ element: "highlight" });
                    },
                    u = () => {
                            ...
                            if (s.isTrue("highlights_tweets_action_enabled") && !this._shouldDisable(i, N.d.Highlight)) {
                                ...
                                return l
                                    ? (({ addToast: e, highlight: t, scribeAction: i, tweetId: n, undoHighlight: r }) => {
                                          const s = () => {
                                                  r(n).then((t) => {
                                                      e(t?.tweet_highlights_delete?.success ? { text: At.sp, withClearButton: !0 } : { text: Zt, withClearButton: !0, withAutoDismiss: !0 });
                                                  }),
                                                      i({ element: "undoHighlight" });
                                              },
                                              a = () => {
                                                  t(n).then((t) => {
                                                      e(t?.tweet_highlights_put?.success ? { action: { label: ft.d, onAction: s }, text: At.I9, withClearButton: !0 } : { text: Zt, withClearButton: !0, withAutoDismiss: !0 });
                                                  }),
                                                      i({ element: "highlight" });
                                              };
                        ...
                        (this._getHighlightUpsellOnPinAction = () => {
                            ...
                            return u && c && d && !h
                                ...
                                : (({ addToast: e, createLocalApiErrorHandler: t, pin: i, scribeAction: n, tweetId: o }) => ({
                                      confirmation: { text: gi, headline: Ai, label: Ci },
                                      testID: V,
                                      text: fi,
                                      onClick: () => {
                                          i(o).then(
                            ...
                            if (
                                (R.isTrue("responsive_web_show_similar_posts_action_enabled") &&
                                    ...
                                    (V.relatedPosts = (({ isArticle: e, landingUrl: t, scribeAction: i }) => ({
                                        ...
                                        Icon: wt.default,
                                    }))({ landingUrl: g.url, isArticle: J, scribeAction: K })),
                                H &&
                                    ...
                                    t && (V.highlightOrUndo = t),
                                        ...
                                        this._shouldDisable(I, N.d.Delete) ||
                                            (V.delete = (({ addToast: e, createLocalApiErrorHandler: t, deleteTweet: i, featureSwitches: n, onDeleteTweet: s, scribeAction: a, tweet: c, userClaims: d }) => {
                                                ...
                                                return {
                                                    confirmation: { label: ge, headline: Ce({ entity: m }), text: l.Z.getOriginalTweet(c).isEdited && (u || h) ? Se({ entity: m }) : p && l.Z.isArticlePost(c) ? o.createElement(o.Fragment, null, ye, o.createElement(r.Z, { style: Ee.additionalInfo }, De)) : ye, confirmButtonType: "destructiveFilled" },
                                                    isEmphasized: !0,
                                                    text: ge,
                                                    onClick: () => {
                                                        i(c.id_str).then(
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-e019dbda.ea7fd77a.js.map
