    ...
    ["loader.TweetCurationActionMenu-e019dbda"],
    {
                ...
                d = ({ addToast: e, createLocalApiErrorHandler: t, follow: n, promotedContent: i, scribeAction: o, user: d }) => ({
                    ...
                    onClick: () => {
                        n(d.id_str, { promotedContent: i }).then(
                            () => {
                                o({ element: "follow" }), o({ action: "follow", element: "tweet_curation_action_menu" }), d.protected ? e({ text: c({ screenName: d.screen_name }) }) : e({ text: l({ screenName: d.screen_name }) });
                            },
                            t({ ...a.H, showToast: !0 }),
                        ),
        ...
        172894: (e, t, n) => {
            ...
            var i = n(202784),
                ...
                r = n.n(o),
                a = n(883437);
            const s = (0, n(523561).Z)({ loader: () => Promise.all([n.e("icons.23"), n.e("icons.28"), n.e("ondemand.LeaveThisConversation")]).then(n.bind(n, 265008)) }),
                c = r().bb16cc76,
                l = r().de21174c,
            ...
            const c = ({ addToast: e, createLocalApiErrorHandler: t, dismissUserFromConversation: n, hasPremiumPlus: c, history: l, mute: d, muteAdUpsellEnabled: u, promotedContent: m, scribeAction: h, unmute: _, user: p }) => {
                const f = () => {
                        _(p.id_str, { promotedContent: m }).then(() => {
                            ...
                            h({ element: "unmute" }),
                            h({ action: "unmute_user", element: "tweet_curation_action_menu" });
                    },
                    {
                        Icon: b,
                        onClick: w,
                        ...
                        () => {
                            d(p.id_str, { promotedContent: m }).then(() => {
                                ...
                                h({ element: "mute" }),
                                h({ action: "mute_user", element: "tweet_curation_action_menu" });
                        },
                        f,
                    );
                    ...
                    const A = () => {
                        ...
                        Z = () => {
                            y(v.id_str).then(
                                ...
                                (e) => {
                                    n({ showToast: !0 })(e), a({ element: "tweet", action: "unmute_conversation_error" });
                                },
                            ),
                                a({ element: "tweet", action: "unmute_conversation" });
                        },
                        x = {
                            text: m,
                            onClick: () => {
                                o(v.id_str).then(
                                    ...
                                    (e) => {
                                        n({ showToast: !0 })(e), a({ element: "tweet", action: "mute_conversation_error" });
                                    },
                                ),
                                    a({ element: "tweet", action: "mute_conversation" });
                            },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-e019dbda.3b1da18a.js.map
