    ...
    ["loader.TweetCurationActionMenu-e019dbda"],
    {
                        ...
                        return (
                            ...
                            s
                                ? n.createElement(
                                      ...
                                      n.createElement(w, { errorHandler: d(t.errorConfig.options || {}), key: s.fetchKey, retry: m }, (t, i) => (t ? o({ fetchStatus: _.ZP.FAILED, error: t, data: null, retry: i }) : n.createElement(b, { query: e, queryRef: s, render: o }))),
                                  )
                                : null
                        );
                    };
        ...
        713842: (e, t, i) => {
            ...
            const R = (e) => (0, P.t5)(e, P.FX),
                ...
                M = O(({ addFlag: e, shouldShowConversationControlsTip: t }) => {
                    ...
                    return (
                        ...
                        o.createElement(r.Z, { ref: i, style: B.inlineCallout }, n && a ? o.createElement(Z.Z, { text: F, textStyle: B.textStyle, withRightArrow: !0 }) : null)
                    );
                });
            var N = i(533128),
                $ = i(851623),
            ...
            const it = _().ge5067bc,
                ...
                ot = _().d66f0338,
                rt = `${_().cfc8cb50}\n\n${_().if8dc5f0}`,
                st = (0, Ke.ju)("https://help.x.com/using-twitter/mentions-and-replies?lang=browser#hidden-reply"),
                at = _().b2615c6d,
                lt = _().i62a03aa,
                ct = _().cfd2f35e,
                dt = _().a6450e84,
                ...
                mt = ({ addFlag: e, addToast: t, createLocalApiErrorHandler: i, hideReply: n, isSoftBlockEnabled: r, onBlock: s, onTweetDismiss: a, scribeAction: l, shouldShowHideReplyTip: c, tweet: d }) => {
                    ...
                    return {
                        confirmation: c
                            ? { render: (e, t) => (({ onConfirm: e, onCancel: t, onHideReplyImpression: i = () => {} }) => o.createElement(Qe.Z, { actionLabel: it, graphic: et.default, headline: ot, onAction: e, onClose: t, onImpression: i, onTertiaryAction: t, subtext: rt, supportUrl: st, tertiaryActionLabel: ct }))({ onConfirm: e, onCancel: t, onHideReplyImpression: u }) }
                            : {
                                  render: (e, t) => {
                                      const {
                                          user: { screen_name: i },
            ...
            const kt = _().cfd2f35e,
                ...
                St = o.memo(({ onCancel: e, onConfirm: t, onHighlight: i, onUndohighlight: n, tweetId: r }) => {
                        ...
                        l = o.useCallback(
                            ({ data: t, fetchStatus: r, retry: s }) => {
                                if (r === At.ZP.LOADED) {
                                    ...
                                    return o.createElement(Ye.Z, { cancelButtonLabel: kt, confirmButtonLabel: s, confirmButtonType: "primary", headline: d, onCancel: e, onConfirm: a(l), text: c });
                                }
                                return o.createElement(yt.Z, { allowBackNavigation: !1, enableMaskForDismiss: !1, role: "alertdialog", style: Dt.loadingSheet, type: "center", withMask: !0 }, r === At.ZP.FAILED ? o.createElement(Tt.Z, { onRequestRetry: s }) : o.createElement(vt.Z, null));
                            },
                            [i, n, a, e],
                        );
                    return o.createElement(xt, { fetchPolicy: "network-only", render: l, variables: s });
                }),
            ...
            const Ot = _().i419d136,
                    ...
                    const [l, c] = o.useState(!1),
                        ...
                        _ = o.useCallback(
                            ({ data: e, fetchStatus: i, retry: n }) => {
                                if (i === At.ZP.LOADED) {
                                    return !!e?.tweet_result_by_rest_id?.result?.highlights_info?.highlighted ? o.createElement(Ye.Z, { confirmButtonLabel: Bt, confirmButtonType: "primary", headline: Ot, onCancel: t, onConfirm: m, text: Ft }) : o.createElement(Qe.Z, { actionLabel: Mt, footer: u, graphicDisplayMode: "none", headline: "Highlight your best content instead", onAction: h, onClose: t, onSecondaryAction: m, onTertiaryAction: t, secondaryActionLabel: Bt, subtext: "With Highlights, you can curate all your best posts on your profile.", tertiaryActionLabel: Nt, withCloseButton: !0 });
                                }
                                return o.createElement(yt.Z, { allowBackNavigation: !1, enableMaskForDismiss: !1, role: "alertdialog", style: qt.loadingSheet, type: "center", withMask: !0 }, i === At.ZP.FAILED ? o.createElement(Tt.Z, { onRequestRetry: n }) : o.createElement(vt.Z, null));
                            },
                            [h, m, t, u],
                        );
                ...
                Gt = _().d04f95c0,
                Xt = _().ef4602ec;
            const Jt = function ({ addToast: e, createLocalApiErrorHandler: t, highlight: i, isBlueUpsellEligible: n, pin: r, scribeAction: s, tweetId: a, undoHighlight: l }) {
                const c = () => {
                        l(a).then((t) => {
            ...
            var Kt = i(883437),
                Qt = i(523561);
            const Yt = (0, Qt.Z)({ loader: () => Promise.all([i.e("icons.6"), i.e("shared~loader.Dock~bundle.DockPeek~bundle.Grok~bundle.LiveEvent~loader.TimelineFrameHandler~loader.J-f4267732"), i.e("shared~loader.Dock~bundle.DockPeek~bundle.Grok~bundle.LiveEvent~loader.TimelineFrameHandler~loader.J-80af7626"), i.e("ondemand.LeaveThisConversation")]).then(i.bind(i, 265008)) }),
                ei = _().bb16cc76,
                ti = _().de21174c,
                ii = (e, t) => o.createElement(Yt, { onCancel: t, onConfirm: e });
            var ni = i(383494),
                oi = i(232130),
                ri = i(40904),
                si = i(391366);
            const ai = _().e2d6c17e,
                ...
                _i = _().cfd2f35e,
                pi = _().d751694c,
                wi = (0, Ke.ju)("https://support.x.com/articles/20175032"),
                bi = ({ addFlag: e, addToast: t, createLocalApiErrorHandler: i, muteTweet: n, scribeAction: r, shouldShowMuteEducationTip: s, tweet: a, unmuteTweet: l }) => {
                    const c = () => {
                            e(P.EM);
                        },
                        d = () => {
                        ...
                        u = {
                            ...
                            confirmation: s ? { render: (e, t) => o.createElement(Qe.Z, { actionLabel: hi, graphic: oi.default, graphicDisplayMode: "illustration", headline: mi, onAction: e, onClose: t, onImpression: c, onTertiaryAction: t, subtext: pi, supportUrl: wi, tertiaryActionLabel: _i }) } : void 0,
                            Icon: ri.default,
                        },
                ...
                vi = _().a50c911e,
                Ai = _().d1c1e2c2,
                Ei = (0, Qt.Z)({ loader: () => i.e("ondemand.CommunityTweetPinning").then(i.bind(i, 828856)) }),
                ki = _().f5cdcc2c,
            ...
            function Mi(e) {
                ...
                let d = { element: "report_tweet" },
                    ...
                    h = pt.C2.Tweet,
                    m = Fi.default,
                    _ = s && a.Z.isQuickPromote(n) ? Ni.reportPost : a.Z.shouldShowAdDisclosure(n) ? Ni.reportAd : Ni.reportTweet({ entity: c });
                ...
                return {
                    ...
                    onClick: () => {
                        ...
                        if (!(o.community_id_str || o.card?.name === Oi.sj.BROADCAST || o.card?.name === Oi.sj.PERISCOPE_BROADCAST || (n && !e.featureSwitches.isTrue("responsive_web_ocf_reportflow_promoted_enabled"))) && (0, pt.Yw)(e.featureSwitches, h)) {
                            const t = (0, pt.j_)({ clientReferer: window.location.pathname, conversationSection: a, isMedia: s, isPromoted: void 0 !== n, reportType: h, reportedTweet: o, reportedUser: o.user.id_str, scribeNamespace: e.analytics.contextualScribeNamespace });
            ...
            var cn = i(963879);
            const dn = _().cac6a24a,
                un = (0, Qt.Z)({ loader: () => i.e("ondemand.CommunityTweetPinning").then(i.bind(i, 760844)) }),
                hn = _().f9478972,
                mn = _().c5491b5d;
            var _n = i(71620),
                pn = i(143322),
            ...
            const An = (e, t) => (0, P.t5)(e, P.EM),
                ...
                Dn = (0, H.Z)()
                    .propsFromState(() => ({ userCountry: gn.GG, userLanguage: gn.VT, shouldShowMuteEducationTip: An, shouldShowHideReplyTip: En, shouldShowConversationControlsTip: kn, disableRemoveFromCommunity: In, community: xn }))
                    .propsFromActions(() => ({ addFlag: P.pj, addToast: Cn.fz, block: vn.ZP.block, changeConversationControls: yn.Z.changeConversationControls, createLocalApiErrorHandler: (0, _n.zr)("TWEET_CURATION_ACTION_SHEET_CONTAINER"), deleteTweet: Sn, dismissUserFromConversation: Tn.f0, follow: vn.ZP.follow, hideReply: yn.Z.hideReply, unmentionUserFromConversation: yn.Z.unmentionUserFromConversation, mute: fn.r, muteTweet: yn.Z.mute, pin: bn.Yd, removeConversationControls: yn.Z.removeConversationControls, removeTag: yn.Z.removeTag, unblock: vn.ZP.unblock, unfollow: vn.ZP.unfollow, unhideReply: yn.Z.unhideReply, unmute: vn.ZP.unmute, unmuteTweet: yn.Z.unmute, unpin: bn.oc, highlight: yn.Z.highlight, undoHighlight: yn.Z.undoHighlight, unpublishArticleEntity: pn.ZP.unpublish }))
                    .withAnalytics(),
                Pn = /\/mediaViewer$/;
            class Un extends o.Component {
                    ...
                    super(...e),
                        ...
                        (this._handleOnChangeConversationControls = (e) => {
                            ...
                            e === g.k.all
                                ? r &&
                                  r(s.id_str).then(() => {
                                      t({ text: a }), i.scribe({ element: Fn.all, action: "click", data: { items: [x.Z.getChangeConversationControlsItem(s, e)] } });
                                  }, o(E.w))
                                : n &&
                                  n(s.id_str, { policy: e, screenName: s.user?.screen_name }).then(() => {
                                      t({ text: a }), i.scribe({ element: Fn[e], action: "click", data: { items: [x.Z.getChangeConversationControlsItem(s, e)] } });
                                  }, o(E.w));
                        }),
                            ...
                            if (s.isTrue("highlights_tweets_action_enabled") && !this._shouldDisable(i, N.d.Highlight)) {
                                ...
                                return l
                                    ? (({ addToast: e, highlight: t, scribeAction: i, tweetId: n, undoHighlight: r }) => {
                                          ...
                                          return { confirmation: { render: (e, t) => o.createElement(Pt, { onCancel: t, onConfirm: e, onHighlight: a, onUndohighlight: s, tweetId: n }) }, onClick() {}, Icon: bt.default, text: Ut, testID: Y };
                        ...
                        (this._getHighlightUpsellOnPinAction = () => {
                            ...
                            return u && c && d && !h
                                ? Jt({ addToast: e, scribeAction: s, tweetId: o.id_str, undoHighlight: r, highlight: i, pin: n, createLocalApiErrorHandler: t, isBlueUpsellEligible: d && !h })
                        ...
                        (this._getActionItems = (e, t) => {
                            const { deleteTweet: i, follow: n, hideReply: s, muteTweet: c, removeTag: d, unmentionUserFromConversation: u, unmuteTweet: h, unpin: m } = this.props,
                                { addFlag: _, addToast: p, analytics: w, createLocalApiErrorHandler: b, feedbackItems: f, forwardPivotDisplayType: g, forwardPivotLandingUrl: C, history: y, isPinned: T, onDeleteTweet: A, onTweetDismiss: E, promotedContent: k, shouldShowHideReplyTip: I, shouldShowMuteEducationTip: x, tweet: S, userCountry: D, userLanguage: P, withChangeConversationControls: U, withHideReply: Z, withMuteConversation: L, withUnhideReply: H, withViewHiddenReplies: R } = this.props,
                                { featureSwitches: O, userClaims: F, viewerUserId: B } = this.context,
                                { user: M } = S,
                                $ = [],
                                j = a.Z.isPromoted(k) && a.Z.shouldShowAdDisclosure(k),
                                V = {},
                                J = this._scribeAction,
                                K = { addToast: p, createLocalApiErrorHandler: b, scribeAction: J },
                                Q = M.id_str === B;
                            Object.assign(V, this._getCommunityActions()),
                                j && (V.adInfo = se({ featureSwitches: O, promotedContent: k, scribeAction: J })),
                                Q &&
                                    ...
                                    })({ tweet: S, scribeAction: J, featureSwitches: O })),
                                ...
                                M.protected ||
                                    ...
                                    })({ permalink: S.permalink, scribeAction: J, tweet: S, featureSwitches: O }));
                            const Y = l.Z.isArticlePost(S) && O.isTrue("responsive_web_twitter_article_seed_tweet_enabled") && F.isTrueAndEnabled("subscriptions_feature_article_composer");
                            if (Y) {
                            ...
                            if (
                                (O.isTrue("responsive_web_show_similar_posts_action_enabled") &&
                                    ...
                                    (V.relatedPosts = (({ isArticle: e, landingUrl: t, scribeAction: i }) => ({
                                        ...
                                        Icon: bt.default,
                                    }))({ landingUrl: C.url, isArticle: Y, scribeAction: J })),
                                R &&
                                    ...
                                    (V.viewHiddenReplies = (({ permalink: e, scribeAction: t }) => ({
                                        ...
                                        Icon: tt.default,
                                    }))({ permalink: S.permalink, scribeAction: J })),
                                ((e, t) => {
                                ...
                                if (
                                    (M.blocking ||
                                        this._shouldDisable(S, N.d.ListsAddRemove, void 0, void 0, Q) ||
                                        (V.addOrRemoveFromList = (({ scribeAction: e, user: t }) =>
                                            (0, W.k)(t, () => {
                                                e({ element: "add_to_list" });
                                            }))({ user: M, scribeAction: J })),
                                    this._birdwatchNoteWritingEnabled && !S.isStaleEdit && (V.birdwatch = this._birdwatchAction({ scribeAction: J, tweetId: S.id_str })),
                                    this._birdwatchNoteRequestEnabled && !S.isStaleEdit && (V.birdwatchRequest = this._birdwatchRequestAction({ scribeAction: J, tweetId: S.id_str })),
                                    Q)
                                ) {
                                    T
                                    ...
                                    t && (V.highlightOrUndo = t),
                                        this._shouldIncludeTweetAppealOption() && (V.appealTweetWarning = Mi({ analytics: w, history: y, isAppealTweetWarning: !0, promotedContent: k, scribeAction: J, tweet: S, featureSwitches: O, reporterCountry: D, reporterLanguage: P })),
                                        L && !this._shouldDisable(S, N.d.MuteConversation) && (V.muteOrUnmuteConversation = bi({ ...K, addFlag: _, muteTweet: c, shouldShowMuteEducationTip: x, tweet: S, unmuteTweet: h })),
                                        U &&
                                        ...
                                        this._shouldDisable(S, N.d.Delete) ||
                                            (V.delete = (({ addToast: e, createLocalApiErrorHandler: t, deleteTweet: i, featureSwitches: n, onDeleteTweet: s, scribeAction: a, tweet: c, userClaims: d }) => {
                                                ...
                                                return {
                                                    confirmation: { label: Ce, headline: ye({ entity: _ }), text: l.Z.getOriginalTweet(c).isEdited && (u || h) ? ve({ entity: _ }) : m && l.Z.isArticlePost(c) ? o.createElement(o.Fragment, null, Te, o.createElement(r.Z, { style: Ie.additionalInfo }, ke)) : Te, confirmButtonType: "destructiveFilled" },
                                                    isEmphasized: !0,
                                                    text: Ce,
                                                    onClick: () => {
                                                        i(c.id_str).then(
                                            ...
                                            })({ ...K, deleteTweet: i, onDeleteTweet: A, tweet: S, featureSwitches: O, userClaims: F }));
                                } else
                                    E && j && (V.promotedTweetDismiss = Ii({ onTweetDismiss: E, hasPremiumPlus: this._hasPremiumPlus, promotedDismissUpsellEnabled: this.context.featureSwitches.isTrue("subscriptions_hide_ad_upsell_enabled"), history: y })),
                                        M.blocking ||
                                                ...
                                                ? (({ addToast: e, createLocalApiErrorHandler: t, promotedContent: i, scribeAction: n, unfollow: o, user: r }) => ({
                                                      ...
                                                      onClick: () => {
                                                          o(r.id_str, { promotedContent: i }).then((t) => {
                                                              e({ text: Yi({ screenName: r.screen_name }) });
                                                          }, t(Ki.X)),
                                                              n({ element: "unfollow" }),
                                                              n({ action: "unfollow", element: "tweet_curation_action_menu" });
                                                      },
                                                      Icon: Ji.default,
                                                  }))({ ...K, unfollow: this.props.unfollow, promotedContent: k, user: M })
                                                : (({ addToast: e, createLocalApiErrorHandler: t, follow: i, promotedContent: n, scribeAction: o, user: r }) => ({
                                                      ...
                                                      onClick: () => {
                                                          i(r.id_str, { promotedContent: n }).then(
                                                              () => {
                                                                  o({ element: "follow" }), o({ action: "follow", element: "tweet_curation_action_menu" }), r.protected ? e({ text: Xe({ screenName: r.screen_name }) }) : e({ text: Je({ screenName: r.screen_name }) });
                                                              },
                                                              t({ ...Ve.H, showToast: !0 }),
                                                          ),
                                                      ...
                                                      Icon: ze.default,
                                                  }))({ ...K, follow: n, promotedContent: k, user: M })),
                                            O.allTrue(["super_follow_android_web_subscription_enabled", "creator_subscriptions_subscribe_action_tweet_menu_enabled"]) &&
                                                ...
                                                (V.subscribe = (({ history: e, scribeAction: t, user: i }) => ({
                                                    ...
                                                    Icon: Vi.default,
                                                    testID: te,
                                                }))({ scribeAction: J, history: y, user: M })),
                                            (V.muteOrUnmute = this._getMuteOrUnmuteAction())),
                                        L && (V.muteOrUnmuteConversation = bi({ ...K, addFlag: _, muteTweet: c, shouldShowMuteEducationTip: x, tweet: S, unmuteTweet: h })),
                                        Z && (V.hideReply = mt({ ...K, addFlag: _, hideReply: s, isSoftBlockEnabled: O.isTrue("xprofile_blocked_by_view_enabled"), onBlock: this._handleBlock, onTweetDismiss: E, shouldShowHideReplyTip: I, tweet: S })),
                                        H &&
                                        ...
                                        (V.blockOrUnblock = (0, v.op)({ blockAction: this._handleBlock, isSoftBlockEnabled: O.isTrue("xprofile_blocked_by_view_enabled"), source: v.SC.TWEET_CARET, testID: z, unblockAction: this._handleUnblock, user: M }));
                            B && !Q && !S.isPreviewDisplay
                                ? (V.report = Mi({ analytics: w, history: y, promotedContent: k, scribeAction: J, tweet: S, featureSwitches: O, reporterCountry: D, reporterLanguage: P }))
                                : !B &&
                                  D &&
                                  (function (e) {
                                  ...
                                  })({ promotedContent: k, scribeAction: J, tweet: S, featureSwitches: O })),
                            ...
                            return (
                                !Q &&
                                    ...
                                    })({ tweet: S, promotedContent: k, scribeAction: J, reportUrl: ee })),
                                t &&
                                    ...
                                    (V.downloadVideo = (({ downloadVideoLink: e, scribeAction: t }) => ({
                                        ...
                                        Icon: xe.default,
                                        testID: te,
                                    }))({ downloadVideoLink: t, scribeAction: J })),
                                Rn.forEach((e) => {
                        ...
                        (this._scribeAction = ({ action: e, additionalData: t, element: i }) => {
                            ...
                            let a = s?.items ? s : { ...(s || {}), items: [x.Z.getTweetItem(r, o)] };
                ...
                render() {
                    ...
                    return i
                        ...
                        : h
                          ? o.createElement(r.Z, { style: Zn.dismissButton }, o.createElement(y.Z, { onClick: this._handleImmediateDismissClick }))
                          : o.createElement(
                                r.Z,
                                { style: Zn.overflowMenu },
                                l ? o.createElement(M, null) : null,
                                o.createElement(b.Z, { controlled: !0, disallowedReplyControls: [], isActiveCreator: e, midConversationTweet: a, onChange: this._handleOnChangeConversationControls, setDisallowedReplyControls: () => {}, value: m }, ({ openPopover: e }) => o.createElement(u.Z, (0, n.Z)({}, s, { isDisabled: t, onClick: this._onMenuClick, renderActionMenu: this._renderCurationActionMenu(e), testID: $.Z.caret }))),
                                l ? o.createElement(M, null) : null,
                ...
                _getCommunityActions() {
                    ...
                    const {
                        ...
                        h = !l && c;
                    if ((u.id_str !== r && h && (this._shouldDisable(t, N.d.HideCommunityTweet) || (e.hideTweet = ((e, t) => ({ text: wt, Icon: _t.default, link: { pathname: `/i/report/${pt.C2.HideCommunityTweet}/${e}`, state: { scribeNamespace: t } } }))(n, { ...s, element: "hide_tweet" })), this._shouldDisable(t, N.d.RemoveFromCommunity) || (e.removeCommunityMember = ((e, t, i) => ({ text: Pi, Icon: Di.default, link: { pathname: `/i/report/${pt.C2.RemoveCommunityMember}/${e.id_str}?community_id=${t}`, state: { scribeNamespace: i } } }))(u, i, { ...s, element: "remove_community_member" }))), this._shouldDisable(t, N.d.SearchUsersPost) || (e.searchUsersPost = ((e, t, i) => ({ text: zi({ screenName: e.screen_name }), Icon: qi.default, link: { pathname: `/i/communities/${t}/search/?q=(from:${e.screen_name})`, state: { scribeNamespace: i } } }))(u, i, { ...s, element: "search_users_post" })), I.X7.includes(d?.actions.pin_action_result.__typename) && !this._shouldDisable(t, N.d.PinCommunityTweet))) {
                        const t = "CommunityTweetPinActionReplace" === a?.actions?.pin_action_result?.__typename;
                        e.pinCommunityTweet = ((e, t, i) => ({ text: Ai, Icon: Ht.default, onClick() {}, confirmation: { render: (n, r) => o.createElement(Ei, { communityId: t, isReplacing: i, onCancel: r, onConfirm: n, tweetId: e }) } }))(n, i, t);
                    }
                ...
                _shouldIncludeTweetAppealOption() {
                    const { forwardPivotDisplayType: e, isNsfwUser: t, tweet: i, userCountry: n, userLanguage: o } = this.props,
                        { featureSwitches: r, viewerUserId: s } = this.context;
                    return (0, S.rT)({ viewerUserId: s, featureSwitches: r, forwardPivotDisplayType: e, tweet: i, userCountry: n, userLanguage: o }) || (0, S.V4)({ viewerUserId: s, featureSwitches: r, isNsfwUser: t, tweet: i, userCountry: n, userLanguage: o });
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-e019dbda.b86cc4ea.js.map
