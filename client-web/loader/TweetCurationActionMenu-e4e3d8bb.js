...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.TweetCurationActionMenu-e4e3d8bb"],
    {
        587103: (e, t, i) => {
            i.d(t, { Z: () => n });
            i(202784);
            const n = (0, i(523561).Z)({ loader: () => Promise.all([i.e("icons.8"), i.e("ondemand.LeaveThisConversation")]).then(i.bind(i, 265008)) });
        },
        376293: (e, t, i) => {
            ...
            const E = r().cfd2f35e,
                ...
                k = ({ blockAction: e, blockSubtext: t, source: i, testID: n, unblockAction: s, unblockSubtext: a, user: r }) => {
                    let o,
                        c = d.Z;
                    const E = S(r);
                    switch (i) {
                    ...
                    return { confirmation: E, onClick: c, testID: n, shortcutKey: o, Icon: f(r.blocking), text: h(r), subText: M({ user: r, blockSubtext: t, unblockSubtext: a }) };
                },
                f = (e) => (e ? c.default : o.default),
                ...
                C = ({ confirmation: e, handleConfirm: t, onClose: i }) => {
                    const { confirmButtonType: a, headline: r, label: o, text: c } = e;
                    return n.createElement(s.Z, { cancelButtonLabel: E, confirmButtonLabel: o, confirmButtonType: a, headline: r, onCancel: i, onConfirm: t, text: c });
                };
        },
        350968: (e, t, i) => {
            i.d(t, { I9: () => d, rg: () => p, sp: () => l });
            var n = i(111677),
                s = i.n(n);
            const a = s().eaae42ce,
                r = s().h032d096,
                ...
                E = s().af40a8e0,
                u = s().e68b09b4,
                p = (e, t, i) => (e ? { title: r, subtext: c, onAction: i, confirmLabel: u } : { title: a, subtext: o, onAction: t, confirmLabel: E });
        },
        712816: (e, t, i) => {
            i.d(t, { d: () => s });
            var n = i(111677);
        ...
        163390: (e, t, i) => {
            i.d(t, { OX: () => u, Od: () => l, PN: () => p, uq: () => d, wR: () => m });
            var n = i(251067),
                s = i(522171),
                a = i(111677),
                r = i.n(a),
        ...
        572657: (e, t, i) => {
            ...
            const r = (e, t) => `articleEntitiesSlice-${e}-${t}`,
                ...
                d = { fetchIfNeeded: (e, t) => c(e, t).fetchIfNeeded(), selectFetchStatus: (e, t, i) => c(t, i).selectFetchStatus(e), selectSliceModule: c, selectArticleEntities: (e, t, i) => c(t, i).selectItems(e), articleEntitiesSliceModule: o };
        },
        143322: (e, t, i) => {
            i.d(t, { ZP: () => O });
            var n = i(925873),
            ...
            const _ = (e, t, i) => {
                ...
                b = {
                    ...
                    updateCoverMedia: (0, l.Tx)(v, "updateCoverMedia", { getParams: (e, { mediaCategory: t, mediaId: i } = {}) => ({ articleEntityId: e, mediaId: i, mediaCategory: t }), getApiMethod: (e) => e.withEndpoint(a.Z).updateArticleEntityCoverMedia, context: "UPDATE_ARTICLE_COVER_MEDIA", mapResponseToActions: A }),
                    updateContent: (0, l.Tx)(v, "update", { getParams: (e, { content_state: t } = {}) => ({ articleEntityId: e, content_state: t }), getApiMethod: (e) => e.withEndpoint(a.Z).updateArticleEntityContent, context: "UPDATE_ARTICLE_ENTITY", mapResponseToActions: A }),
                    updateTitle: (0, l.Tx)(v, "updateTitle", { getParams: (e, { title: t } = {}) => ({ articleEntityId: e, title: t }), getApiMethod: (e) => e.withEndpoint(a.Z).updateArticleEntityTitle, context: "UPDATE_ARTICLE_ENTITY_TITLE", mapResponseToActions: A }),
                        ...
                        mapResponseToActions: (e, t, i) => (e) => {
                            ...
                            if (e && n) {
                                const { entities: i, result: a } = e,
                                    ...
                                    o = _(n, t, g.iN.DRAFT);
                                return i && r ? (0, s.Z)([(0, d.dP)(i), o?.injectItems([r])]) : void 0;
                            }
                        },
                    }),
                        ...
                        mapResponseToActions: (e, t, i) => (t) => {
                            ...
                            if (n && o) {
                                ...
                                const d = n?.metadata?.tweet_results?.result?.rest_id,
                                    l = d ? [(0, y.ZP)(c, o, y.uh.articles).injectEntry(r.Se({ id: d, sortIndex: d }))] : [];
                        ...
                        mapResponseToActions: (e, t, i) => (t) => {
                            ...
                            if (n && r) {
                                ...
                                const c = n?.metadata?.tweet_results?.result?.rest_id,
                                    d = c ? Object.keys(y.uh).map((e) => (0, y.ZP)(o, r, y.uh[e]).removeTweets({ [c]: !0 })) : [];
                                return [F.updateOne(e, n), ...a, ...d];
                            }
                        },
                    }),
                },
                ...
                C = M("SET_PREV_ARTICLE_ENTITY_ID"),
            ...
            const K = (e, t) => {
                ...
                F = {
                    ...
                    selectEditorState: (e) => e[k].editorState,
                    ...
                    selectAuthorId: K,
                    selectCoverMediaId: (e) => e[k].coverMediaId,
                    selectMediaBeingEdited: (e) => e[k].mediaBeingEdited,
                    selectMediaEntityKeyBeingEdited: (e) => e[k].mediaEntityKeyBeingEdited,
                    selectMediaEntityKeyToFilesMap: (e) => e[k].mediaEntityKeyToFilesMap,
                    selectMediaIdToLocalMediaIdMap: (e) => e[k].mediaIdToLocalMediaIdMap,
                    selectPrevMediaEntityKeys: (e) => e[k].prevMediaEntityKeys,
                    selectPrevArticleEntityMedia: (e) => e[k].prevArticleEntityMedia,
                    selectTweetId: (e, t) => {
                        const i = v.select(e, t),
                    ...
                    selectPrevArticleEntityId: (e) => e[k].prevArticleEntityId,
                    selectIsArticleEntityLoading: (e) => e[k].isArticleEntityLoading,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.TweetCurationActionMenu-e4e3d8bb.66cb5a2a.js.map
