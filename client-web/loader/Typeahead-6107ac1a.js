(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.Typeahead-6107ac1a", "loader.AudioDock", "loader.AudioContextVoiceMedia", "icons/IconChevronRight-js"],
    {
        642153: (e, t, i) => {
            "use strict";
            i.d(t, { Z: () => a });
            ...
            class f extends r.PureComponent {
                ...
                render() {
                    const { "aria-label": e, avatar: t, compact: i, disabled: s, link: n, mode: a, onClick: l, secondaryAction: c, selected: p, style: f, testID: w, text: E } = this.props,
                        ...
                        I = [y.root, i && y.compact, s && y.disabled, p && y.selected, f],
                    ...
                    return r.createElement(o.Z, { style: I, testID: w }, r.createElement(u.Z, { "aria-label": e || (a ? g[a] : ""), disabled: s, interactiveStyles: v, link: n, onPress: l, style: S }, this._renderAvatar(), r.createElement(d.ZP, { color: p ? "whiteOnColor" : "text", numberOfLines: 1, selectable: !1, style: y.text, weight: "bold" }, E), b), c ? r.createElement(u.Z, { "aria-label": c["aria-label"] || (c.mode ? g[c.mode] : ""), disabled: s || c.disabled, hoverLabel: { label: c.hoverLabel || (c.mode ? g[c.mode] : "") }, interactiveStyles: v, onPress: this._handleSecondaryClick, style: y.secondaryControl }, r.createElement(o.Z, { style: y.secondaryBorder }, _)) : null);
                }
                _renderIcon(e = !0, t) {
        ...
        537439: (e, t, i) => {
            ...
            const P = s().ae408b76,
                ...
                N = ({ contextType: e, iconColor: t, iconSize: i, link: o, retweetData: s, text: v, topicData: x, userAvatarUrls: P }) => {
                    const { isSelfRetweet: N, name: k, screenName: z } = s || {},
                        H = ((e, t, i, o = []) => {
                            const s = L[t],
                                v = [i ? { color: T.default.theme.colors[i] } : B.colorDeepGray, s],
                                x = r.createElement(n.default, { style: v }),
                                P = r.createElement(a.default, { style: v }),
                                R = r.createElement(l.default, { style: v }),
                                D = r.createElement(c.default, { style: v }),
                                F = r.createElement(d.default, { style: v }),
                                Z = r.createElement(h.default, { style: B.circle }),
                                A = r.createElement(u.default, { style: v }),
                                M = r.createElement(m.default, { style: v }),
                                N = r.createElement(p.default, { style: v }),
                                k = r.createElement(g.default, { style: v }),
                                z = r.createElement(f.default, { style: v }),
                                H = r.createElement(y.default, { style: v }),
                                G = r.createElement(w.default, { style: v }),
                                U = r.createElement(E.default, { style: v }),
                                j = r.createElement(b.default, { style: v }),
                                Q = r.createElement(_.default, { style: v }),
                                W = r.createElement(I.default, { style: v }),
                                $ = r.createElement(C.Z, { borderColor: "cellBackground", userAvatarSize: t, userAvatarUrls: o }),
                                V = r.createElement(S.default, { style: v });
                            switch (e) {
                                case O.Q.Pin:
                                case O.Q.ReplyPin:
                                    return x;
                    ...
                    switch (e) {
                        case O.Q.Retweet:
                            return { Icon: H, text: v || M(k, N), link: z ? `https://twitter.com/${z}` : void 0 };
                        case O.Q.Pin:
                            return { Icon: H, text: v || R };
                        case O.Q.ReplyPin:
                            return { Icon: H, text: D };
                        case O.Q.Topic:
                            return { Icon: H, "aria-label": "Recommendation" === x?.functionalityType || "RecWithEducation" === x?.functionalityType ? Z({ topicName: v }) : F({ topicName: v }), text: v ? r.createElement(A, { text: v }) : null, link: o };
                        default:
                            return { Icon: H, text: v ? r.createElement(A, { text: v }) : null, link: o };
                    }
                };
        },
        126962: (e, t, i) => {
            ...
            class m extends r.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: i, id: l, onLayout: c, rightControl: d, style: u, testID: m, textColor: g, textSize: f, topControl: y, weight: w, withBottomBorder: E, withLeftPadding: b, withTextCentered: _, ...I } = this.props,
                        { Icon: S, "aria-label": v, link: C, text: x } = (0, h.Z)(I),
                        T = r.createElement(s.ZP, { "aria-label": v, color: g, id: l, numberOfLines: 2, size: f, testID: m, weight: w, withoutTwemojiAndHashflags: !0 }, x),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.Typeahead-6107ac1a.8362939a.js.map
