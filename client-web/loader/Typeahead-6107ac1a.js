    ...
    ["loader.Typeahead-6107ac1a", "loader.AudioDock", "loader.AudioContextVoiceMedia"],
    {
        ...
        973014: (e, t, r) => {
            ...
            class f extends i.PureComponent {
                ...
                render() {
                    ...
                    return i.createElement(o.Z, { style: S, testID: w }, i.createElement(u.Z, { "aria-label": e || (a ? g[a] : ""), disabled: s, interactiveStyles: v, link: n, onPress: l, style: I }, this._renderAvatar(), i.createElement(d.ZP, { color: p ? "whiteOnColor" : "text", numberOfLines: 1, selectable: !1, style: y.text, weight: "bold" }, E), b), c ? i.createElement(u.Z, { "aria-label": c["aria-label"] || (c.mode ? g[c.mode] : ""), disabled: s || c.disabled, hoverLabel: { label: c.hoverLabel || (c.mode ? g[c.mode] : "") }, interactiveStyles: v, onPress: this._handleSecondaryClick, style: y.secondaryControl }, i.createElement(o.Z, { style: y.secondaryBorder }, _)) : null);
                }
                _renderIcon(e = !0, t) {
        ...
        537439: (e, t, r) => {
            ...
            const P = s().ae408b76,
                ...
                N = ({ contextType: e, iconColor: t, iconSize: r, link: o, retweetData: s, text: v, topicData: x, userAvatarUrls: P }) => {
                    const { isSelfRetweet: N, name: k, screenName: z } = s || {},
                        H = ((e, t, r, o = []) => {
                            const s = M[t],
                                v = [r ? { color: T.default.theme.colors[r] } : B.colorDeepGray, s],
                                x = i.createElement(n.default, { style: v }),
                    ...
                    switch (e) {
                        case O.Q.Retweet:
                            return { Icon: H, text: v || L(k, N), link: z ? `https://twitter.com/${z}` : void 0 };
                        case O.Q.Pin:
                            return { Icon: H, text: v || R };
                        case O.Q.ReplyPin:
                            return { Icon: H, text: D };
                        case O.Q.Topic:
                            return { Icon: H, "aria-label": "Recommendation" === x?.functionalityType || "RecWithEducation" === x?.functionalityType ? A({ topicName: v }) : F({ topicName: v }), text: v ? i.createElement(Z, { text: v }) : null, link: o };
                        default:
                            return { Icon: H, text: v ? i.createElement(Z, { text: v }) : null, link: o };
                    }
                };
        },
        126962: (e, t, r) => {
            ...
            class m extends i.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: r, id: l, onLayout: c, rightControl: d, style: u, testID: m, textColor: g, textSize: f, topControl: y, weight: w, withBottomBorder: E, withLeftPadding: b, withTextCentered: _, ...S } = this.props,
                        { Icon: I, "aria-label": v, link: C, text: x } = (0, h.Z)(S),
                        T = i.createElement(s.ZP, { "aria-label": v, color: g, id: l, numberOfLines: 2, size: f, testID: m, weight: w, withoutTwemojiAndHashflags: !0 }, x),
            ...
            class d {
                ...
                _sendXhr(e, t, r, i, o, n, a, c, d = 0) {
                    ...
                    const p = new Date(),
                        ...
                        E = (e) => {
                            this._stats(t, e || "unknown-error", { requestStartTime: p, segmentBytes: d }), "function" == typeof o && o(S(b) || { code: w.INVALID_RES_STATUS, mediaId: this.mediaId });
                        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.Typeahead-6107ac1a.0667810a.js.map
