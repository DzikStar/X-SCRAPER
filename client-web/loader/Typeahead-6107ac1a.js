            ...
            const P = s().ae408b76,
                ...
                N = ({ contextType: e, iconColor: t, iconSize: r, link: o, retweetData: s, text: v, topicData: x, userAvatarUrls: P }) => {
                    const { isSelfRetweet: N, name: k, screenName: z } = s || {},
                        H = ((e, t, r, o = []) => {
                            const s = B[t],
                                v = [r ? { color: T.default.theme.colors[r] } : M.colorDeepGray, s],
                                ...
                                A = i.createElement(h.default, { style: M.circle }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.Typeahead-6107ac1a.a5919c1a.js.map
