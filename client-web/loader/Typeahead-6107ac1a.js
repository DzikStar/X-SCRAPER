    ...
    ["loader.Typeahead-6107ac1a", "loader.AudioDock", "loader.AudioContextVoiceMedia"],
    {
            ...
            class f extends r.PureComponent {
                ...
                render() {
                    const { "aria-label": e, avatar: t, compact: i, disabled: s, link: n, mode: a, onClick: l, secondaryAction: c, selected: p, style: f, testID: w, text: E } = this.props,
                        ...
                        v = [y.root, i && y.compact, s && y.disabled, p && y.selected, f],
            ...
            const P = s().ae408b76,
                ...
                N = ({ contextType: e, iconColor: t, iconSize: i, link: o, retweetData: s, text: S, topicData: x, userAvatarUrls: P }) => {
                    const { isSelfRetweet: N, name: k, screenName: z } = s || {},
                        H = ((e, t, i, o = []) => {
                            const s = B[t],
                                S = [i ? { color: T.default.theme.colors[i] } : L.colorDeepGray, s],
                                ...
                                F = r.createElement(h.default, { style: L.circle }),
                                ...
                                Q = r.createElement(_.default, { style: S }),
                                W = r.createElement(v.default, { style: S }),
        ...
        126962: (e, t, i) => {
            ...
            class m extends r.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: i, id: l, onLayout: c, rightControl: d, style: u, testID: m, textColor: g, textSize: f, topControl: y, weight: w, withBottomBorder: E, withLeftPadding: b, withTextCentered: _, ...v } = this.props,
                        { Icon: I, "aria-label": S, link: C, text: x } = (0, h.Z)(v),
            ...
            function r(e) {
                ...
                return {
                    uploadStart: function (e, t) {
                        i.set(e, { time: Date.now(), bytes: t }), o || (o = Date.now());
                    },
                    uploadFinish: function (l, c) {
                        const d = i.get(l);
                        d &&
                            ((r += c - d.bytes),
                            i.delete(l),
                            ++s === t &&
                                (function () {
                                    ...
                                    const s = r / i;
                                    if (s < 5e3 && 1 === t) return;
                                    !n || n.byterate < s ? ((t += 1), e(), (n = { byterate: s, poolSize: t })) : ((t -= 2), (t = Math.max(t, 1)), (n = null));
                                    a();
                                })());
                    },
                    reset: a,
            ...
            class d {
                ...
                _sendXhr(e, t, i, r, o, n, a, c, d = 0) {
                    ...
                    const p = new Date(),
                        ...
                        E = (e) => {
                            this._stats(t, e || "unknown-error", { requestStartTime: p, segmentBytes: d }), "function" == typeof o && o(v(b) || { code: w.INVALID_RES_STATUS, mediaId: this.mediaId });
                        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.Typeahead-6107ac1a.801817fa.js.map
