    ...
    ["loader.UserHandler-bc6ccf4c"],
    {
        ...
        537439: (e, t, n) => {
            ...
            const B = a().ae408b76,
                ...
                W = ({ contextType: e, iconColor: t, iconSize: n, link: o, retweetData: a, text: S, topicData: k, userAvatarUrls: B }) => {
                    const { isSelfRetweet: W, name: M, screenName: H } = a || {},
                        Q = ((e, t, n, o = []) => {
                            const a = A[t],
                                S = [n ? { color: P.default.theme.colors[n] } : z.colorDeepGray, a],
                                k = r.createElement(i.default, { style: S }),
                                B = r.createElement(l.default, { style: S }),
                                F = r.createElement(c.default, { style: S }),
                                D = r.createElement(s.default, { style: S }),
                                ...
                                W = r.createElement(p.default, { style: S }),
                                M = r.createElement(f.default, { style: S }),
                                ...
                                V = r.createElement(x.default, { style: S }),
                    ...
                    switch (e) {
                        case T.Q.Retweet:
                            return { Icon: Q, text: S || _(M, W), link: H ? `https://twitter.com/${H}` : void 0 };
                        case T.Q.Pin:
            ...
            class h extends r.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: n, id: c, onLayout: s, rightControl: d, style: m, testID: h, textColor: f, textSize: g, topControl: y, weight: b, withBottomBorder: C, withLeftPadding: w, withTextCentered: E, ...x } = this.props,
                        ...
                        P = r.createElement(a.ZP, { "aria-label": S, color: f, id: c, numberOfLines: 2, size: g, testID: h, weight: b, withoutTwemojiAndHashflags: !0 }, k),
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return r.createElement(s.ZP.Consumer, null, ({ direction: c }) => r.createElement(i.ZP, { color: e ? n : a, dir: c, style: [S.inner, e && "blue500" === n && S.blue500] }, r.createElement(o.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), l, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: s, showBackgroundWhenActive: d } = this.props,
                                ...
                                h = d && i && !e?.isHovered;
                            return r.createElement(c.Z, { hoverLabel: o, interactiveStyles: m, interactivityState: e, style: [u.default.absoluteFill, v[h ? "haloBackground" : n], !s && S.iconBackground, "small" === a && S.iconSmallBoundingBox, h && S.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && h) return r.createElement(d.ZP, { animation: p || m.Bf, animationContainerStyle: x[t], animationStyle: k, onAnimationEnd: l, onAnimationStart: c, onError: s });
                            {
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            s
                                ...
                                : r.createElement(c.Z, { "aria-haspopup": f ? "menu" : void 0, "aria-label": e, disabled: l, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: m, link: h, onClick: this._handlePress, preventFocusShift: p, renderMenu: f, style: [S.triggerAreaRoot, S.outlineNone], testID: b }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.UserHandler-bc6ccf4c.7348742a.js.map
