    ...
    ["loader.UserHandler-bc6ccf4c"],
    {
        ...
        537439: (e, t, n) => {
            ...
            const B = a().ae408b76,
                ...
                W = ({ contextType: e, iconColor: t, iconSize: n, link: o, retweetData: a, text: Z, topicData: S, userAvatarUrls: B }) => {
                    const { isSelfRetweet: W, name: M, screenName: Q } = a || {},
                        z = ((e, t, n, o = []) => {
                            const a = A[t],
                                Z = [n ? { color: P.default.theme.colors[n] } : H.colorDeepGray, a],
                                ...
                                I = r.createElement(u.default, { style: H.circle }),
                                R = r.createElement(m.default, { style: Z }),
                                _ = r.createElement(h.default, { style: Z }),
                                W = r.createElement(p.default, { style: Z }),
                    ...
                    switch (e) {
                        case T.Q.Retweet:
                            return { Icon: z, text: Z || _(M, W), link: Q ? `https://twitter.com/${Q}` : void 0 };
                        case T.Q.Pin:
                            return { Icon: z, text: Z || F };
                        case T.Q.ReplyPin:
                            return { Icon: z, text: L };
                        case T.Q.Topic:
                            return { Icon: z, "aria-label": "Recommendation" === S?.functionalityType || "RecWithEducation" === S?.functionalityType ? I({ topicName: Z }) : D({ topicName: Z }), text: Z ? r.createElement(R, { text: Z }) : null, link: o };
                        default:
        ...
        126962: (e, t, n) => {
            ...
            class h extends r.PureComponent {
                render() {
                    const { avatarSize: e, bottomControl: t, iconStyle: n, id: c, onLayout: s, rightControl: d, style: m, testID: h, textColor: f, textSize: g, topControl: y, weight: b, withBottomBorder: w, withLeftPadding: C, withTextCentered: E, ...x } = this.props,
                        { Icon: v, "aria-label": Z, link: k, text: S } = (0, u.Z)(x),
                    ...
                    super(...e),
                        ...
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: s, showBackgroundWhenActive: d } = this.props,
                                ...
                                h = d && i && !e?.isHovered;
                            return r.createElement(c.Z, { hoverLabel: o, interactiveStyles: m, interactivityState: e, style: [u.default.absoluteFill, v[h ? "haloBackground" : n], !s && Z.iconBackground, "small" === a && Z.iconSmallBoundingBox, h && Z.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && h) return r.createElement(d.ZP, { animation: p || m.Bf, animationContainerStyle: x[t], animationStyle: S, onAnimationEnd: l, onAnimationStart: c, onError: s });
                            {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.UserHandler-bc6ccf4c.abd918ea.js.map
