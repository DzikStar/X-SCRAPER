    ...
    ["loader.UserHandler"],
    {
            ...
            const p = "block",
                ...
                v = (0, D.M)((e) => {
                    const { featureSwitches: o } = (0, c.QZ)(),
                        { onBlock: r, onClose: l, onMute: d, onRemoveFollower: D, onReportUser: v, onShare: I, onUnblock: P, onUnmute: k, user: E } = e,
                        S = [],
                        A = (o, r) => {
                    ...
                    E.followed_by &&
                        ...
                        S.push((0, u.op)({ blockAction: (e) => A(e, r), isSoftBlockEnabled: o.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: p, unblockAction: (e) => A(e, P), user: E })),
                        S.push({
                            Icon: s.default,
                            onClick: () => {
                                l(), v();
        ...
        293988: (e, o, r) => {
            ...
            const p = (e, o) => !(!o.allowPromptForPush || !m.selectShouldPromptBrowserPush(e)),
                ...
                y = l().iebc30ca,
                _ = l().dc740eb2;
            class v extends t.PureComponent {
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
        ...
        168222: (e, o, r) => {
            ...
            const b = (e, o) => {
                ...
                M = (0, p.Z)()
                    ...
                    .withAnalytics(),
                y = (e) => {
                    const { analytics: o, applyReactionInstructions: r, cellClickable: t, decoration: d, entry: i, isCarouselItem: p, onClick: w, saveAsRecentSearch: f, shouldScribeImpression: b, shouldScribeProfileClick: M, shouldStoreTypeaheadItem: y, user: v, withFollowsYou: I, withLink: P } = e,
                        {
                    ...
                    (0, c.q)(() => {
                        if ("WhoToFollow" === L) {
                            const e = v ? [n.Z.getUserItem(v)] : [];
                            v?.following ? o.scribe({ element: "followed_user", action: "impression", data: { items: e } }) : v?.muting ? o.scribe({ element: "muted_user", action: "impression", data: { items: e } }) : v?.blocking && o.scribe({ element: "blocked_user", action: "impression", data: { items: e } });
                        }
                    });
                    const T = s.useCallback(() => {
                        r({ entry: i, triggerName: m.K.ON_FOLLOW });
                    }, [r, i]);
                    return s.createElement(l.Z9, { cellClickable: t, decoration: O, displayMode: Z, isConcise: p, onClick: w, onFollowClick: T, promotedContent: A, promotedItemType: h.bj.USER, referringPage: Z, saveAsRecentSearch: f, shouldScribeImpression: b, shouldScribeProfileClick: M, shouldStoreTypeaheadItem: y, socialContext: C, style: p && _.isCarouselItem, userId: k, withFollowsYou: I, withLink: P });
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.UserHandler.2a53557a.js.map
