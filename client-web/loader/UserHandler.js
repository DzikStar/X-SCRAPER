    ...
    ["loader.UserHandler"],
    {
            ...
            const f = "block",
                ...
                P = (0, p.M)((e) => {
                    const { featureSwitches: t } = (0, c.QZ)(),
                        { onBlock: n, onClose: l, onMute: s, onRemoveFollower: p, onReportUser: P, onShare: M, onUnblock: _, onUnmute: g, user: k } = e,
                        I = [],
                        C = (t, n) => {
                    ...
                    k.followed_by &&
                        ...
                        I.push((0, u.op)({ blockAction: (e) => C(e, n), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: f, unblockAction: (e) => C(e, _), user: k })),
                        I.push({
                            Icon: i.default,
                            onClick: () => {
                                l(), P();
                            ...
                            testID: w,
                            text: v({ screenName: k.screen_name }),
                        });
        ...
        293988: (e, t, n) => {
            ...
            class P extends o.PureComponent {
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
                            ...
                            return e ? o.createElement(r.ZP, { "aria-label": w, hoverLabel: { label: v }, icon: o.createElement(s.default, null), onPress: this._handleUnfollow, style: t, type: "primaryOutlined" }) : o.createElement(r.ZP, { "aria-label": b, hoverLabel: { label: y }, icon: o.createElement(i.default, null), onPress: this._handleFollow, style: t, type: "primaryOutlined" });
                        }),
                        (this._handleFollow = () => {
                ...
                render() {
                    return o.createElement("div", null, this.state.showingPushPrompt ? o.createElement(d.Z, { fullScreen: !0, message: E }) : null, this._renderButton());
                }
        ...
        168222: (e, t, n) => {
            ...
            const w = (e, t) => {
                ...
                y = (0, f.Z)()
                    ...
                    .withAnalytics(),
                v = (e) => {
                    const { analytics: t, applyReactionInstructions: n, cellClickable: o, decoration: s, entry: d, isCarouselItem: f, onClick: D, saveAsRecentSearch: b, shouldScribeImpression: w, shouldScribeProfileClick: y, shouldStoreTypeaheadItem: v, user: P, withFollowsYou: M, withLink: _ } = e,
                        {
                            content: { id: g, promotedMetadata: k, socialContext: I },
                        } = d,
                        C = p(k),
                    ...
                    return i.createElement(l.Z9, { cellClickable: o, decoration: T, displayMode: A, isConcise: f, onClick: D, onFollowClick: F, promotedContent: C, promotedItemType: h.bj.USER, referringPage: A, saveAsRecentSearch: b, shouldScribeImpression: w, shouldScribeProfileClick: y, shouldStoreTypeaheadItem: v, socialContext: S, style: f && E.isCarouselItem, userId: g, withFollowsYou: M, withLink: _ });
                },
                E = d.default.create((e) => ({ isCarouselItem: { width: 312 } })),
                P = y(i.memo(v)),
                M = [l.ET, l.C_],
                _ = ({ cellClickable: e = !0, decoration: t, displayMode: n = a.Z.UserCompact, isCarouselItem: l, onClick: i, shouldScribeProfileClick: d = !0, shouldScribeImpression: c = !1, shouldStoreTypeaheadItem: u, withLink: h = !0 }) =>
                    s
                        .iH({
                            component: P,
                        ...
                        .getHandler(() => ({ cellClickable: e, decoration: t, displayMode: n, isCarouselItem: l, onClick: i, shouldScribeProfileClick: d, shouldScribeImpression: c, shouldStoreTypeaheadItem: u, withLink: h, withFollowsYou: !t || M.includes(t) }));
        },
        684511: (e, t, n) => {
            n.d(t, { Z: () => o });
            n(202784);
        ...
        204744: (e, t, n) => {
            n.d(t, { DI: () => v, H$: () => h, OB: () => E, Ww: () => c, YB: () => u, hj: () => D, qF: () => w });
            n(901951);
            var o = n(499627),
                r = n(390387);
        ...
        40644: (e, t, n) => {
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return o.createElement(d.ZP.Consumer, null, ({ direction: i }) => o.createElement(l.ZP, { color: e ? n : a, dir: i, style: [_.inner, e && "blue500" === n && _.blue500] }, o.createElement(r.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), s, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: r, iconSize: a, isActive: l, isDisabled: d, showBackgroundWhenActive: c } = this.props,
                                ...
                                m = c && l && !e?.isHovered;
                            return o.createElement(i.Z, { hoverLabel: r, interactiveStyles: h, interactivityState: e, style: [u.default.absoluteFill, M[m ? "haloBackground" : n], !d && _.iconBackground, "small" === a && _.iconSmallBoundingBox, m && _.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && m) return o.createElement(c.ZP, { animation: p || h.Bf, animationContainerStyle: P[t], animationStyle: k, onAnimationEnd: s, onAnimationStart: i, onError: d });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return o.createElement(a, { style: [P[t], !r && l && _.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                            const { count: e, withCount: t } = this.props;
                            return t ? o.createElement(v, { count: e }) : null;
                        }),
                        (this._handlePress = (e) => {
                    ...
                    return o.createElement(
                        ...
                        o.createElement(
                            ...
                            d
                                ...
                                : o.createElement(i.Z, { "aria-haspopup": f ? "menu" : void 0, "aria-label": e, disabled: s, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: h, link: m, onClick: this._handlePress, preventFocusShift: p, renderMenu: f, style: [_.triggerAreaRoot, _.outlineNone], testID: w }, (e) => {
            ...
            const P = u.default.create((e) => ({ small: { height: "1em", width: "1em" }, normal: { height: "1.25em", width: "1.25em" }, large: { height: "1.5em", width: "1.5em" } })),
                M = u.default.create((e) => ({ transparent: { backgroundColor: e.colors.transparent }, translucentBlack77: { backgroundColor: e.colors.translucentBlack77 }, haloBackground: { backgroundColor: e.colors.activeBlack } })),
                _ = u.default.create((e) => ({ root: { flexDirection: "row", justifyContent: "flex-start" }, triggerAreaRoot: { justifyContent: "center", minHeight: e.lineHeights.body, overflow: "visible", userSelect: "none" }, inner: { alignItems: "center", display: "flex", justifyContent: "flex-start", transitionProperty: "color", transitionDuration: "0.2s", whiteSpace: "nowrap" }, iconFaded: { opacity: 0.4 }, iconBackground: { borderRadius: e.borderRadii.infinite, margin: -8 }, iconSmallBoundingBox: { margin: -6 }, outlineNone: { outlineStyle: "none" }, blue500: { color: e.colors.blue500 }, white: { color: e.colors.white }, haloBoundingBox: { margin: -6 } })),
                g = "224.5%",
                k = { width: g, height: g };
        },
        551611: (e, t, n) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.UserHandler.bc7973ca.js.map
