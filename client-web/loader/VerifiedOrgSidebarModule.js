                        ...
                        re = t.useMemo(
                            () =>
                                t.createElement(
                                    ...
                                    K ? t.createElement(w.Z, { onClick: te("get_support") }, t.createElement(s.Z, { style: J.link }, t.createElement(o.ZP, { weight: "medium" }, U), t.createElement(p.default, { style: J.icon }))) : t.createElement(s.Z, { link: F.A9, onClick: te("get_support"), style: J.link }, t.createElement(o.ZP, { weight: "medium" }, U), t.createElement(p.default, { style: J.icon })),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.VerifiedOrgSidebarModule.1da6acba.js.map
