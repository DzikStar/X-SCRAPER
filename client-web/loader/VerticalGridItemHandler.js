    ...
    ["loader.VerticalGridItemHandler"],
    {
        395267: (e, t, r) => {
            ...
            const g = b.default.create((e) => ({ base: { flexGrow: 1, backgroundColor: e.colors.cellBackground, justifyContent: "space-between" }, icon: { alignSelf: "flex-end", color: e.colors.white, marginEnd: e.spaces.space12, paddingTop: e.spaces.space12, width: e.spaces.space20, height: e.spaces.space20 }, border: { flexGrow: 1, borderColor: e.colors.borderColor, borderRadius: e.borderRadii.large, borderWidth: e.borderWidths.medium }, containerClicked: { backgroundColor: e.colors.primary, borderColor: e.colors.primary, borderWidth: e.borderWidths.medium }, containerUnclicked: { flexDirection: "column-reverse" }, text: { alignSelf: "flex-start", bottom: 0, marginBottom: e.spaces.space12, marginHorizontal: e.spaces.space12, position: "absolute" }, mainContainer: { padding: 0 }, wrapper: { padding: e.spaces.space4 } })),
                ...
                w = b.default.create((e) => ({ base: { flexGrow: 1, backgroundColor: e.colors.primary, justifyContent: "center" }, centerTile: { margin: e.spaces.space8 }, container: { padding: 0, borderRadius: e.borderRadii.large }, wrapper: { padding: e.spaces.space4, borderRadius: e.borderRadii.large } })),
                C = ({ "aria-label": e, link: t, onClick: r, text: o }) => {
                    const l = m.Z.generate({ backgroundColor: b.default.theme.colors.primary, color: b.default.theme.colors.white }),
                        n = a.createElement(h.Z, { "aria-label": e, interactiveStyles: l, style: w.base }, a.createElement(u.ZP, { align: "center", color: "whiteOnColor", numberOfLines: 3, size: "headline2", style: w.centerTile, weight: "bold" }, o));
                    return a.createElement(d.Z, { style: w.wrapper }, a.createElement(f.Z, { "aria-label": e, containerStyle: w.container, link: t, onClick: r, upper: n, withInteractiveStyling: !0 }));
                };
            var k = r(111677),
                Z = r.n(k),
                v = r(324688),
            ...
            const T = (0, I.Z)()
                ...
                H = T((e) => {
                    const { analytics: t, createLocalApiErrorHandler: r, follow: o, isRecommended: l, style: n, topic: c, unfollow: d, url: p } = e,
                        ...
                        f = a.useRef(!1),
                        g = (e, t, r) => (c.following ? e(k(r)) : e(w(t))),
                        w = (e) => (l) => {
                            o(c.id)
                                .catch(r())
                                .then(e && e(c.id)),
                    ...
                    return a.createElement(S.Z, { customText: h, displayMode: E.BH.topic }, (e) =>
                        a.createElement(v.m.Consumer, null, ({ onFollow: t, onInitialize: r, onUnfollow: o }) => {
                            ...
                            return a.createElement(a.Fragment, null, n === i.pI.DoubleStateDefault ? a.createElement(y, (0, s.Z)({}, c, { isSelected: u })) : a.createElement(C, c));
                        }),
                    );
                }),
                P = (e, t) => {
        ...
        165822: (e, t, r) => {
            ...
            const c = i.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                s = ({ "aria-label": e, containerStyle: t, disabled: r, interactiveStyles: s, isCompact: d, link: p, lower: u, onClick: m, stackLayoutLowerStyle: h, stackLayoutUpperStyle: b, upper: f, withInsetFocusRing: g = !0, withInteractiveStyling: y = !1 }) => {
                    const w = s ?? n.Z.generate({ backgroundColor: i.default.theme.colors.transparent, color: i.default.theme.colors.primary, insetFocusRing: g }),
                        C = o.createElement(o.Fragment, null, o.createElement(l.Z, { style: [c.defaultUpperContainerStyle, b, d && { height: "auto" }] }, f), u ? o.createElement(l.Z, { style: [c.defaultLowerContainerStyle, h] }, u) : null);
                    return o.createElement(a.Z, { "aria-label": e, disabled: r, interactive: y, interactiveStyles: y ? w : void 0, link: p, onClick: m, style: [c.root, t] }, C);
                };
        },
        98440: (e, t, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.VerticalGridItemHandler.d5c1833a.js.map
