    ...
    ["loader.VerticalGridItemHandler"],
    {
        ...
        165822: (e, t, r) => {
            ...
            const c = i.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                s = ({ "aria-label": e, containerStyle: t, disabled: r, interactiveStyles: s, isCompact: d, link: p, lower: u, onClick: m, stackLayoutLowerStyle: b, stackLayoutUpperStyle: f, upper: y, withInsetFocusRing: w = !0, withInteractiveStyling: g = !1 }) => {
                    const h = s ?? a.Z.generate({ backgroundColor: i.default.theme.colors.transparent, color: i.default.theme.colors.primary, insetFocusRing: w }),
                    ...
                    return o.createElement(n.Z, { "aria-label": e, disabled: r, interactive: g, interactiveStyles: g ? h : void 0, link: p, onClick: m, style: [c.root, t] }, C);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.VerticalGridItemHandler.7bcb626a.js.map
