                ...
                constructor(...e) {
                    super(...e),
                        (this._renderContent = (e, t) => {
                            ...
                            return r.createElement(s.ZP.Consumer, null, ({ direction: l }) => r.createElement(i.ZP, { color: e ? n : a, dir: l, style: [k.inner, e && "blue500" === n && k.blue500] }, r.createElement(o.Z, { ref: this.props.actionIconContainerRef }, t ? this._renderButton(t) : null, this._renderIcon()), c, this._renderCount()));
                        }),
                        (this._renderButton = (e) => {
                            const { activeColor: t, backgroundColor: n, hoverLabel: o, iconSize: a, isActive: i, isDisabled: s, showBackgroundWhenActive: u } = this.props,
                                ...
                                h = u && i && !e?.isHovered;
                            return r.createElement(l.Z, { hoverLabel: o, interactiveStyles: m, interactivityState: e, style: [d.default.absoluteFill, x[h ? "haloBackground" : n], !s && k.iconBackground, "small" === a && k.iconSmallBoundingBox, h && k.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            ...
                            if (!d.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && h) return r.createElement(u.ZP, { animation: p || m.Bf, animationContainerStyle: C[t], animationStyle: P, onAnimationEnd: c, onAnimationStart: l, onError: s });
                            {
                                const a = n && e ? e : this.props.Icon;
                                return r.createElement(a, { style: [C[t], !o && i && k.iconFaded] });
                            }
                        }),
                        (this._renderCount = () => {
                    ...
                    return r.createElement(
                        ...
                        r.createElement(
                            ...
                            s
                                ...
                                : r.createElement(l.Z, { "aria-haspopup": f ? "menu" : void 0, "aria-label": e, disabled: c, enableKeyboardShortcuts: n, focusable: t, interactiveStyles: null, keyboardShortcut: m, link: h, onClick: this._handlePress, preventFocusShift: p, renderMenu: f, style: [k.triggerAreaRoot, k.outlineNone], testID: E }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.WideLayout-752e56d7.d4383a8a.js.map
