(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loader.WideLayout"],
    {
            ...
            const _ = "block",
                ...
                k = (0, p.M)((e) => {
                    ...
                    S.followed_by &&
                        ...
                        v.push((0, u.op)({ blockAction: (e) => M(e, n), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: _, unblockAction: (e) => M(e, E), user: S })),
                        v.push({
                            Icon: i.default,
                            onClick: () => {
                                a(), k();
        ...
        893904: (e, t, n) => {
            ...
            const f = l.default.create((e) => ({ container: { height: "100%" }, sticky: { position: "sticky" }, fixed: { position: "fixed" }, static: { position: "static" } })),
                g = (0, c.Z)(m);
        },
        293988: (e, t, n) => {
            "use strict";
        ...
        130888: (e, t, n) => {
            ...
            const D = (e, t, n) => {
                ...
                I = (0, p.Z)()
                    .propsFromState(() => ({ focalTweetId: k, viewerUserId: _._h, tweetMap: f.Z.selectAll, users: g.ZP.selectAll }))
        ...
        62857: (e, t, n) => {
            ...
            var r = n(807896),
                ...
                h = n(663550),
                p = n(409438);
            const _ = ({ displayMode: e = p.Z.UserDetailed, renderUserCell: t, userIds: n }) =>
                o.createElement(
                    u.Z,
                    { role: "list" },
            ...
            const w = (e, t) => t.userIds,
                ...
                I = (e, t) => {
                    ...
                    return n.reduce((t, n) => {
                        ...
                        return (t[n] = r === f.ZP.NONE ? f.ZP.LOADING : r), t;
                    }, {});
                },
                E = (0, b.Z)()
                    .propsFromState(() => ({
            ...
            class S extends o.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderContent = () => {
                            ...
                            return o.createElement(_, (0, r.Z)({}, i, { userIds: e }));
                        }),
                        (this._handleFetch = () => {
                ...
                render() {
                    return o.createElement(c.Z, { "aria-label": P, fetchStatus: this.state.allUsersUnavailable ? f.ZP.LOADED : this.props.fetchStatus, onRequestRetry: this._handleFetch, render: this._renderContent, retryable: !1 });
                }
                _fetchUsersIfNeeded() {
        ...
        912937: (e, t, n) => {
            ...
            function w({ fallbackSlotId: e, primarySlotId: t }) {
                const n = r.useRef("ad-" + D++).current,
                    ...
                    l = r.useRef(!1),
                    i = r.useRef(!1),
                    { userClaims: d } = r.useContext(f.rC),
            ...
            const k = s.default.create((e) => ({ root: { paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.spaces.space12, borderBottomWidth: e.borderWidths.small, borderBottomStyle: "solid", borderBottomColor: e.colors.borderColor }, adContainer: { minHeight: 250, minWidth: 300, width: "100%", alignItems: "center", justifyContent: "center", backgroundColor: "transparent", position: "relative" }, emptyContainer: { minHeight: 0, height: 0, overflow: "hidden" }, adSlot: { width: "100%", height: "100%", position: "absolute", top: 0, start: 0, end: 0, minWidth: 300, minHeight: 250 }, hiddenSlot: { display: "none" } })),
                I = function (e) {
                    return r.createElement(_.Z, { style: k.root }, r.createElement(r.Suspense, { fallback: r.createElement(o.Z, { style: k.emptyContainer }) }, r.createElement(g, e)));
                },
                E = l().a526aa66,
                P = l().ef625010,
                S = l().d228a9a0,
            ...
            const R = "profile_accounts_sidebar",
                O = (e, t) => U.Ic(e, { displayLocation: R, similarToUserId: t.userId }),
                x = (e, t) => U.UD(e, { displayLocation: R, similarToUserId: t.userId }),
                N = (e, t) => {
                    const n = O(e, t),
                        r = [];
                    return (
                        n.forEach(({ user_id: t }) => {
                            const n = C.ZP.select(e, t);
                            n && r.push(n);
                        }),
                        r
                    );
                ...
                K = (0, A.Z)()
                    ...
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, F.zr)("WHO_TO_FOLLOW_CONTAINER"), fetchRecommendationsIfNeeded: U.yY }))
        ...
        847607: (e, t, n) => {
            ...
            const l = o().hb568af4,
                ...
                f = o().i29533b3,
                g = o().h129c3c3,
                y = (e) => (e ? ((e) => f({ screenName: e }))(e) : p),
                b = (e) => (e ? ((e) => g({ screenName: e }))(e) : _);
        },
        417714: (e, t, n) => {
            "use strict";
            n.d(t, { l: () => c });
        ...
        994305: (e, t, n) => {
            ...
            var h = n(387466),
                p = n(120071);
            const _ = (e) => ({ ...p.k(e), excluded: [], pc: !0 }),
                f = ({ apiClient: e, featureSwitches: t }) => ({
                    fetch(n, r = {}) {
                        const o = { ..._(t), ...n, ...(0, h.Y)(t) };
                        ...
                        : t(
                              (
                                  ...
                                  (t, n, { api: r, featureSwitches: o }) => {
                                      ...
                                      return (0, y._O)(t, { request: d ? r.withEndpoint(f).fetchSidebarUserRecommendations : r.withEndpoint(f).fetch, params: { display_location: s, itsInterests: a, limit: l, user_id: i } })({ actionTypes: { REQUEST: I, SUCCESS: E, FAILURE: P }, context: "FETCH_RECOMMENDATIONS", meta: { displayLocation: s, similarToUserId: i } }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.WideLayout.7efe6e7a.js.map
