            ...
            const f = "block",
                ...
                w = (0, p.M)((e) => {
                    const { featureSwitches: t } = (0, c.QZ)(),
                        { onBlock: n, onClose: a, onMute: l, onRemoveFollower: p, onReportUser: w, onShare: I, onUnblock: E, onUnmute: S, user: P } = e,
                        v = [],
                        M = (t, n) => {
            ...
            const k = (e, t) => t.userIds,
                ...
                I = (e, t) => {
                    ...
                    return n.reduce((t, n) => {
                        ...
                        return r && (t[n] = r === _.ZP.NONE ? _.ZP.LOADING : r), t;
                    }, {});
                },
                E = (0, b.Z)()
                    .propsFromState(() => ({
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.WideLayout.2536be0a.js.map
