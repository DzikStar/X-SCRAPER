    ...
    ["loader.newsArticleHandler"],
    {
        ...
        110045: (e, t, r) => {
            ...
            const f = (0, b.Z)().propsFromState(() => ({ dataSaverMode: v.IX })),
                ...
                w = "100px",
                z = "70px",
                E = m.default.create((e) => ({ root: { flexDirection: "row", paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.componentDimensions.gutterVertical }, coverImage: { height: "100%", width: "100%" }, coverContainer: { backgroundColor: e.colors.gray200, borderRadius: e.borderRadii.xLarge, height: "15%", maxHeight: w, maxWidth: w, minHeight: z, minWidth: z, overflow: "hidden", width: "15%" }, details: { flex: 1, marginEnd: e.spaces.space12 }, title: { marginHorizontal: 0, marginVertical: e.spaces.space2 } })),
                I = f(o.memo(y)),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.newsArticleHandler.0383e9ba.js.map
