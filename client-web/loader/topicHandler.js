    ...
    ["loader.topicHandler"],
    {
        ...
        117004: (e, t, o) => {
            ...
            const P = (e, t) => I.Z.select(e, t.entry.content.topicId),
                ...
                L = (e) => {
                    ...
                    return p === l.xV.Pivot ? i.createElement(c.Z, { style: H.root }, i.createElement(a.Z, { link: `/i/topics/${n.id}`, onClick: h, text: n.name })) : i.createElement(_, { notInterestedOnClick: m, topic: n, withActionIcon: u });
                },
                H = s.default.create((e) => ({ root: { margin: e.spaces.space4 } })),
                R = z(i.memo(L)),
                B = ({ shouldDisplayBorder: e = !1 }) => n.iH({ component: R, isFocusable: (0, r.Z)(!0), getScribeDataItem: A.H, shouldDisplayBorder: (0, r.Z)(e) }).getHandler();
        },
        204744: (e, t, o) => {
            o.d(t, { DI: () => w, H$: () => h, OB: () => I, Ww: () => d, YB: () => p, hj: () => y, qF: () => v });
            o(901951);
            var r = o(499627),
                n = o(390387);
        ...
        973014: (e, t, o) => {
            ...
            class y extends r.PureComponent {
                ...
                render() {
                    const { "aria-label": e, avatar: t, compact: o, disabled: i, link: c, mode: a, onClick: s, secondaryAction: l, selected: u, style: y, testID: v, text: g } = this.props,
                    ...
                    return r.createElement(n.Z, { style: k, testID: v }, r.createElement(h.Z, { "aria-label": e || (a ? f[a] : ""), disabled: i, interactiveStyles: C, link: c, onPress: s, style: S }, this._renderAvatar(), r.createElement(d.ZP, { color: u ? "whiteOnColor" : "text", numberOfLines: 1, selectable: !1, style: b.text, weight: "bold" }, g), w), l ? r.createElement(h.Z, { "aria-label": l["aria-label"] || (l.mode ? f[l.mode] : ""), disabled: i || l.disabled, hoverLabel: { label: l.hoverLabel || (l.mode ? f[l.mode] : "") }, interactiveStyles: C, onPress: this._handleSecondaryClick, style: b.secondaryControl }, r.createElement(n.Z, { style: b.secondaryBorder }, I)) : null);
                }
                _renderIcon(e = !0, t) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.topicHandler.c8b7baaa.js.map
