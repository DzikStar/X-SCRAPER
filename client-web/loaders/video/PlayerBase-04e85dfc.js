...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loaders.video.PlayerBase-04e85dfc"],
    {
        373516: (e, t, r) => {
        ...
        228698: (e, t, r) => {
            r.d(t, { $y: () => v, A3: () => d, A9: () => A, AB: () => z, BA: () => j, BN: () => Z, Cx: () => W, D0: () => c, DE: () => f, ET: () => Te, EX: () => s, F3: () => a, Gf: () => i, H4: () => F, JZ: () => o, K5: () => b, KE: () => k, Ku: () => D, LO: () => m, M8: () => C, Mf: () => J, Mn: () => M, OA: () => X, OI: () => Ee, OM: () => B, PB: () => le, PY: () => _e, Pt: () => K, QF: () => g, RM: () => se, Rf: () => E, Sb: () => de, Sg: () => U, U9: () => Y, Ug: () => ie, VE: () => n, Vi: () => he, WS: () => w, Yz: () => ae, a: () => pe, a$: () => O, ak: () => L, cW: () => q, cg: () => ne, er: () => ee, fc: () => fe, gA: () => y, hV: () => Se, hz: () => u, li: () => V, p1: () => x, pK: () => re, pQ: () => l, pm: () => h, qA: () => S, s2: () => Q, s3: () => _, s8: () => N, sO: () => $, sX: () => ce, uJ: () => p, uW: () => H, v3: () => Ie, w7: () => I, x9: () => T, xb: () => ue, xl: () => R, xq: () => P, y4: () => te, zG: () => ye, ze: () => oe, zn: () => G });
            const s = { PAUSE_REQUESTED: "PAUSE_REQUESTED", PLAY_REQUESTED: "PLAY_REQUESTED" },
                ...
                U = "REQUEST_VOLUME_CHANGE",
                A = (e, t) => ({ type: U, volume: t, playerId: e }),
        ...
        768256: (e, t, r) => {
            r.d(t, { Am: () => l, HY: () => d, MD: () => T, Se: () => f, ZP: () => S, aX: () => y, fi: () => I, ni: () => c, ql: () => E, uE: () => u });
            var s = r(470833),
                n = r(356841),
                a = r(426582),
                o = r(842337),
        ...
        842337: (e, t, r) => {
            r.d(t, { $w: () => E, K4: () => I, Ou: () => l, Se: () => m, Y4: () => o, ZP: () => R, bH: () => p, cJ: () => i, iV: () => d, vq: () => y });
            r(571372);
            var s = r(789403),
                n = r(768256),
                a = r(915331);
        ...
        724429: (e, t, r) => {
            ...
            var d = r(842337),
                p = r(828063),
                h = r(418577);
            const y = { ...s.Se, ...n.Se, ...E, ...i.Se, ...d.Se, ...p.Se, ...h.Se, ...c.Se, percentVisible: 1, percentOfViewportOccupied: 1, sizesInfo: {} },
                T = [
                    s.ZP,
                    i.ZP,
                    (e, t) => {
        ...
        773975: (e, t, r) => {
            r.d(t, { $9: () => v, Bw: () => o, Dk: () => u, Eo: () => l, Ev: () => N, FI: () => b, IV: () => E, Iu: () => U, JA: () => S, Ky: () => i, PC: () => y, RR: () => g, Se: () => Q, UL: () => p, XB: () => P, ZP: () => x, fh: () => d, ho: () => I, pp: () => f, qV: () => D, qx: () => c });
            var s = r(22525),
                n = r(104591),
                a = r(228698);
            const o = "TICK",
                ...
                O = "BUFFER_START",
                U = (e) => ({ type: O, playerId: e }),
                A = "BUFFER_END",
                D = (e) => ({ type: A, playerId: e }),
                k = "BITRATE_SWITCHED",
        ...
        677138: (e, t, r) => {
            ...
            var P = r(297310),
                O = r(104591),
                U = r(418577);
            const { BUFFERING_COMPLETED: A, BUFFERING_REQUESTED: D, IDLE: k, PREBUFFERING_COMPLETED: b } = U.BufferStateRequest,
                F = (e, t) => {
                    Object.keys(t).forEach((r) => {
                        r = parseInt(r, 10);
                        const s = t?.[r],
                            { bufferingStatus: n, targetDuration: a } = s || {};
                        !(n === A) && void 0 !== n && !(n === b) && a && e.dispatch((0, U.HP)(r, D, P.dN * a));
                    });
                },
                N = [
                    o.Z,
                    ...
                    (e) => (t) => (r) => {
                        ...
                        switch (r.type) {
                                        ...
                                        ((e, t, r) => {
                                            Object.keys(t).forEach((s) => {
                                                ...
                                                const n = t?.[s],
                                                    ...
                                                    c = void 0 !== a,
                                                    l = a === b;
                                                a !== A && "PLAY_REQUESTED" !== o?.playState && !i && c && s !== r && !l && e.dispatch((0, U.HP)(s, k, 0));
                                            });
                                        })(e, s, r.playerId);
                                } else if (E && !u) {
                                    const t = E * P.dN;
                            ...
                            case U.YF:
                                if (d) {
                                    r.bufferingStatus === A && ("PLAY_REQUESTED" === n?.controls?.playState || n?.isPlaying) && F(e, s);
                                }
                                break;
                            case U.Go:
                                if (r.targetDuration && d) {
                                    const t = (0, T.ks)(s, (e) => (e?.isPlaying || "PLAY_REQUESTED" === e?.controls?.playState) && void 0 !== e?.bufferingStatus && e?.bufferingStatus !== A);
                                    if (void 0 === t || t.playerId === r.playerId) {
                                        const t = r.targetDuration * P.dN;
                                        e.dispatch((0, U.$u)(r.playerId, t));
                                    } else t.playerId !== r.playerId && e.dispatch((0, U.HP)(r.playerId, k, 0));
