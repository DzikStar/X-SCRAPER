...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["loaders.video.PlayerBase-bd05098c"],
    {
        396682: (e, t, i) => {
            i.d(t, { Z: () => j });
            i(571372), i(136728);
                ...
                constructor({ source: e = {}, videoConfig: t, domElement: s, httpClient: c, twitterAuthedHttpClient: p, options: u = {} }) {
                    (this.teardown = () => {
                        ...
                        (this.fullScreen = (e) => {
                            ...
                            return N.Z.dispatch((0, H.Zx)(this.id, t, this.video.getVideoTag())), this;
                        }),
                        (this.exitFullScreen = () => (N.Z.dispatch((0, H.g3)(this.id)), this)),
                        (this.hideControls = () => (
                            this.playerReadyPromise.then(() => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/loaders.video.PlayerBase-bd05098c.2803b22a.js.map
