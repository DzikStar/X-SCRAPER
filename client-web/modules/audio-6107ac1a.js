            ...
            function m(e, a) {
                return e
                    ? e.map(({ user_results: e, ...t }) => {
                          ...
                          return e?.result && "User" === e.result.__typename && ((o.is_blue_verified = e.result.is_blue_verified), (o.verified_type = e.result.legacy?.verified_type), (o.highlightedLabel = (0, u.H)(e.result.identity_profile_labels_highlighted_label?.label))), o;
                      })
                    : [];
            }
            function p(e) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/modules.audio-6107ac1a.55ad2afa.js.map
