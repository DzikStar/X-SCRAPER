        ...
        176340: (e, a, t) => {
            ...
            const E = ({ apiClient: e, featureSwitches: a, jotaiStore: r }) => ({
                    ...
                    search(a, t) {
                        ...
                        return e
                            .graphQL(M(), { query: a, filter: t }, R(r, a))
                            .catch(C(r))
                            .then((e) =>
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/modules.audio-6107ac1a.350d5b4a.js.map
