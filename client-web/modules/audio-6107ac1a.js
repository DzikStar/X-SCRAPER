        ...
        176340: (e, a, o) => {
            ...
            const E = ({ apiClient: e, featureSwitches: a, jotaiStore: t }) => ({
                    ...
                    unsubscribeFromScheduledSpaceById(a) {
                        ...
                        return e.graphQL(N(), { id: a }, L(o, a)).catch(C(o)).then(z(o));
                    },
                    ...
                    addSharing: (a, o) => e.graphQL(f(), { audio_space_id: a, sharing: { shared_tweet: { tweet_id: o } } }, L("addSharing", a)),
                    deleteSharing: (a, o) => e.graphQL(y(), { audio_space_id: a, sharing_id: o }, L("deleteSharing", a)),
                }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/modules.audio-6107ac1a.e11201da.js.map
