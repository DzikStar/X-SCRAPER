    ...
    ["ondemand.ComposeScheduling-2aa5c1ed"],
    {
        418462: (e, t, i) => {
            ...
            const H = (e) => r.createElement(R.ArticleCard, e),
                ...
                q = (e) => r.createElement(R.ActionsBar, (0, n.Z)({}, e, { isDisabled: !0 })),
                D = (e) => null,
        ...
        774526: (e, t, i) => {
            ...
            function q(e) {
                const { cardCacheLocationKey: t, forwardPivotInfo: i, id: o, inlineCalloutInfo: s, innerForwardPivotInfo: d, innerNudges: c, isMediaMaxHeightEnabled: p, loggedInUserId: _, onCardLinkClick: y, onQuoteTweetClick: x, onQuoteTweetMediaClick: k, onQuotedTweetAvatarClick: I, onQuotedTweetScreenNameClick: M, pollTranslations: A, preventVideoPlayback: P, promotedContent: Z, quoteTweetSingleImageMinAspectRatio: L, quoteTweetSocialContextProps: U, quotedTweetTombstoneInfo: q, renderJetfuelFrame: B, renderQuoteTweetTombstone: $, renderTranslationFeedback: W, singleImageMaxAspectRatio: j, style: J, tweet: X, withActionsDisabled: Y, withAltTextBadge: ee, withCardLinks: te, withCenterCrop: ie, withCondensedQuoteTweet: ne, withHalvedMediaSize: re, withQuoteTweetBirdwatchPivot: ae, withQuoteTweetHeaderLinks: oe, withQuoteTweetLink: se, withQuoteTweetMedia: de, withUserHoverCard: le } = V(e),
                    ...
                    Te = () => {
                        const t = E.Z.getOriginalTweet(X),
                            i = z(e),
                            n =
                                p &&
                                !i &&
                        ...
                        return t && t.is_quote_status ? r.createElement(b.Z, { forwardPivotInfo: t.quoted_status?.softIntervention || d, id: ge, isCondensed: ne, loggedInUserId: _, mediaContentStyles: !ne && G({ withEdgeToEdgeContent: he, withHalvedMediaSize: re, backgroundColor: a, withMaxHeight: n, isInQuoteTweet: !0 }), mediaMaxHeight: n ? (he ? S : Ce > 0 ? Ce : R) : void 0, nudges: c, onAvatarClick: I, onMediaClick: k, onPress: x, onScreenNameClick: M, preventVideoPlayback: P, promotedContent: Z, shouldRenderIfBlocked: !!q, shouldShowAltLabelAlways: ee, singleImageMaxAspectRatio: j, singleImageMinAspectRatio: L, socialContextProps: U, tweet: t.quoted_status, withActionsDisabled: Y, withBirdwatchPivot: ae, withCenterCrop: ie, withHeaderLinks: oe, withLink: se, withMediaAsTextLinks: !de, withUserHoverCard: le }) : null;
                    },
                    be = () => !!Z?.adMetadataContainer?.unifiedCardOverride,
                    ve = B(),
                    ye = ((e, t) => {
                    ...
                    xe = (() => {
                        if (i && i.displayType === g.x.SoftIntervention) {
                            ...
                            return r.createElement(w.Z, { displayType: e, isTweetNonCompliant: "non_compliant" === X.limited_actions, landingUrl: t, softInterventionDisplayType: n, text: a, tweetId: X.id_str });
                        }
                    })(),
                    ke = s ? r.createElement(C.Z, s) : null,
                    Ie = (() => {
                        ...
                        if (
                            ...
                            return null;
                        const i = m.default.getLegacyOrUnifiedCard(pe, Z, { isDynamicFollowCardPresentAndEnabled: O(e), isDynamicProductCardPresentAndEnabled: be(), withCardLinks: te, hasMedia: z(e) }),
                            a = E.Z.isArticlePost(pe);
                        return i && !(a && "NoCard" === i?.unifiedCard?.card_fetch_state) ? r.createElement(u.Z, (0, n.Z)({}, i, { cardContext: { locationKey: t || H, tweetId: pe.id_str, tweetPermalink: pe.permalink, tweetUserId: pe.user.id_str, viewerUserId: _, withActionsDisabled: Y, mediaVisibilityResults: pe.mediaVisibilityResults, grokShareAttachment: pe.grok_share_attachment, pollTranslations: A, renderTranslationFeedback: W }, id: we, onCardLinkClick: y, preventVideoPlayback: P, promotedContent: Z })) : null;
                    })(),
                    Me = ((e) => {
                        const { possibly_sensitive: t, quoted_status: i } = pe;
                        return ((!!i?.possibly_sensitive && !!(pe.quoted_status && pe.quoted_status.entities && pe.quoted_status.entities.media && pe.quoted_status.entities.media.length > 0 && de) && !q) || (t && !m.default.isPollCard(pe.card?.name))) && e ? r.createElement(v.Z, { revealableTombstoneConfig: v.Z.sensitiveMediaTombstoneConfig }, e) : e;
                    })(
                        (() => {
                            const e = Te();
                            return e && q ? $({ children: e, config: q, id: ge }) : e;
                        })() || Ie,
                    );
                if (!(ye || Me || xe || ve)) return null;
                return r.createElement(a.Z, { "aria-labelledby": `${ge} ${we}`, id: o, ref: ue, style: [D.gap, J] }, ye || ke || xe ? r.createElement(a.Z, { style: D.mediaPivotGap }, ye, ke, xe) : null, z(e) ? null : ve, Me);
            }
            ...
            function K(e) {
                ...
                const oe = j.isVerticalVideoNoBlackBars(),
                    ...
                    le = oe && Y && te < 1 ? te : void 0;
                return r.createElement(a.Z, { ref: W, style: [se && { maxWidth: de }, le ? D.squareRow : void 0] }, r.createElement(A.Z, { authorId: X.user.id_str, authorScreenName: X.user.screen_name, cacheLocationKey: w || H, customHoverBackgroundColor: ie && J ? ae : void 0, displayMediaAttribution: !0, displayMediaMetadata: n, enableKeyboardShortcuts: o, forwardPivotInfo: s, hasSensitiveMedia: X.possibly_sensitive, loggedInUserId: l, mediaAltTranslations: u, mediaContentStyles: [G({ withEdgeToEdgeContent: J, withHalvedMediaSize: q, backgroundColor: ae, withMaxHeight: ie })], mediaDetails: t, mediaMaxHeight: ie ? re : void 0, mediaTagsLink: `${X.permalink}/media_tags`, mediaVisibilityResults: X.mediaVisibilityResults || e.tweet.mediaVisibilityResults, nudges: g, onClick: C, onClickMediaTags: _, onGrokClick: p, onPlaybackStarted: T, parentTweetId: e.tweet.id_str, preventPlayback: b, promotedContent: v, renderPrerollActionMenu: y, shouldShowAltLabelAlways: L, showAltTranslation: k, showBorder: !(ie && J), showRoundCorners: O, singleImageMaxAspectRatio: I, singleImageMinAspectRatio: M, style: [ie && !J && D.explicitlySized, le ? { aspectRatio: te } : void 0], tweetCreatedAt: X.created_at, tweetId: X.id_str, tweetText: X.text, videoAspectRatio: le, withCenterCrop: U, withHalvedMediaSize: q, withMediaTagsIcon: B, withPostPlayback: !0 }));
            }
            function G(e) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-2aa5c1ed.b7295a4a.js.map
