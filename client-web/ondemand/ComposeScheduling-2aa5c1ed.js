            ...
            function q(e) {
                const { cardCacheLocationKey: t, forwardPivotInfo: i, id: o, inlineCalloutInfo: s, innerForwardPivotInfo: d, innerNudges: c, isMediaMaxHeightEnabled: p, loggedInUserId: _, onCardLinkClick: y, onQuoteTweetClick: x, onQuoteTweetMediaClick: k, onQuotedTweetAvatarClick: I, onQuotedTweetScreenNameClick: M, pollTranslations: A, preventVideoPlayback: P, promotedContent: Z, quoteTweetSingleImageMinAspectRatio: L, quoteTweetSocialContextProps: U, quotedTweetTombstoneInfo: q, renderGrokTranslationHeaderForQuote: B, renderJetfuelFrame: $, renderQuoteTweetTombstone: W, renderTranslationFeedback: j, singleImageMaxAspectRatio: J, style: X, tweet: Y, withActionsDisabled: ee, withAltTextBadge: te, withCardLinks: ie, withCenterCrop: ne, withCondensedQuoteTweet: re, withHalvedMediaSize: ae, withQuoteTweetBirdwatchPivot: oe, withQuoteTweetHeaderLinks: se, withQuoteTweetLink: de, withQuoteTweetMedia: le, withUserHoverCard: ce } = V(e),
                    ...
                    Ae = ((e) => {
                        ...
                        return ((!!i?.possibly_sensitive && !!(Ce.quoted_status && Ce.quoted_status.entities && Ce.quoted_status.entities.media && Ce.quoted_status.entities.media.length > 0 && le) && !q) || (t && !m.default.isPollCard(Ce.card?.name))) && e ? r.createElement(v.Z, { revealableTombstoneConfig: v.Z.sensitiveMediaTombstoneConfig }, e) : e;
                    })(
                        (() => {
                            const e = be();
                            return e && q ? W({ children: e, config: q, id: pe }) : e;
                        })() || Me,
                    );
                if (!(xe || Ae || ke || ye)) return null;
                return r.createElement(a.Z, { "aria-labelledby": `${pe} ${ge}`, id: o, ref: me, style: [D.gap, X] }, xe || Ie || ke ? r.createElement(a.Z, { style: D.mediaPivotGap }, xe, Ie, ke) : null, z(e) ? null : ye, Ae);
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-2aa5c1ed.efecc81a.js.map
