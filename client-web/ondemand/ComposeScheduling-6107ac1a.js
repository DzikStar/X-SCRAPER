    ...
    ["ondemand.ComposeScheduling-6107ac1a"],
    {
        266704: (e, r, t) => {
            ...
            class h extends o.PureComponent {
                ...
                _renderUserAvatar() {
                    const { isAllowedToViewOptions: e, onAvatarClick: r, promotedContent: t, userAvatarSize: s, userAvatarUri: l, userScreenName: a } = this.props,
                        { avatar: c } = e;
                    return o.createElement(n.Z, { style: f.row }, o.createElement(i.ZP.Provider, { value: { userAvatarLabel: w } }, o.createElement(d.default, { onClick: r, promotedContent: t, screenName: a, size: s, uri: c ? l : void 0, withLink: !0 })), this._renderDecoration());
                }
                _renderHeader(e) {
                ...
                _renderUserName() {
                    const { isAllowedToViewOptions: e, isUserBlueVerified: r, isUserProtected: t, isUserVerified: n, onScreenNameClick: s, promotedContent: i, userHighlightedLabel: l, userName: a, userScreenName: c, userTranslatorType: d, userVerifiedType: u, userWithFollowsYou: p, withNameWrap: w } = this.props,
                        { badges: h, followIndicator: f, fullName: g } = e;
                    return o.createElement(m.Z, { affiliateBadgeInfo: l, badgeContext: "account", isBlueVerified: h ? r : void 0, isProtected: h ? t : void 0, isVerified: h ? n : void 0, name: g ? a : c, nameSize: "headline2", onLinkClick: s, promotedContent: i, screenName: c, translatorType: h ? d : void 0, verifiedType: h ? u : void 0, withFollowsYou: f && p, withLink: !0, withNameWrap: w, withStackedLayout: !0 });
                }
            ...
            (C.Promoted = (e) => {
                ...
                return o.createElement(h, (0, g.Z)({}, p, { followButton: r, isAllowedToViewOptions: { avatar: !1, badges: !0, description: !0, followButton: !0, followIndicator: !0, followersYouKnow: !0, fullName: !0, label: !0, stats: !1, subscriptionsCount: !1 }, isLoggedIn: !0, isUserProtected: t, isUserStatsWithLink: w.isUserStatsWithLink, isUserVerified: n, knownFollowers: s, onAvatarClick: i, onScreenNameClick: l, promotedContent: a, userAvatarUri: w.profile_image_url_https, userDescription: c, userEntities: w.entities, userFollowersCount: w.followers_count, userFriendsCount: w.friends_count, userId: d, userName: u, userScreenName: m, userWithFollowsYou: w.followed_by, userWithheldDescription: void 0, userWithheldEntities: void 0, withUserAvatar: !1 }));
            }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-6107ac1a.4384591a.js.map
