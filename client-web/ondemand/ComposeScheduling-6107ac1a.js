    ...
    ["ondemand.ComposeScheduling-6107ac1a"],
    {
        266704: (e, r, t) => {
            ...
            class h extends o.PureComponent {
                ...
                _renderUserName() {
                    const { isAllowedToViewOptions: e, isUserBlueVerified: r, isUserProtected: t, isUserVerified: s, onScreenNameClick: n, promotedContent: i, userHighlightedLabel: l, userName: a, userScreenName: c, userTranslatorType: d, userVerifiedType: u, userWithFollowsYou: p, withNameWrap: w } = this.props,
                        { badges: h, followIndicator: f, fullName: v } = e;
                    return o.createElement(m.Z, { affiliateBadgeInfo: l, badgeContext: "account", isBlueVerified: h ? r : void 0, isProtected: h ? t : void 0, isVerified: h ? s : void 0, name: v ? a : c, nameSize: "headline2", onLinkClick: n, promotedContent: i, screenName: c, translatorType: h ? d : void 0, verifiedType: h ? u : void 0, withFollowsYou: f && p, withLink: !0, withNameWrap: w, withStackedLayout: !0 });
                }
            ...
            (C.Promoted = (e) => {
                ...
                return o.createElement(h, (0, v.Z)({}, p, { followButton: r, isAllowedToViewOptions: { avatar: !1, badges: !0, description: !0, followButton: !0, followIndicator: !0, followersYouKnow: !0, fullName: !0, label: !0, stats: !1, subscriptionsCount: !1 }, isLoggedIn: !0, isUserProtected: t, isUserStatsWithLink: w.isUserStatsWithLink, isUserVerified: s, knownFollowers: n, onAvatarClick: i, onScreenNameClick: l, promotedContent: a, userAvatarUri: w.profile_image_url_https, userDescription: c, userEntities: w.entities, userFollowersCount: w.followers_count, userFriendsCount: w.friends_count, userId: d, userName: u, userScreenName: m, userWithFollowsYou: w.followed_by, userWithheldDescription: void 0, userWithheldEntities: void 0, withUserAvatar: !1 }));
            }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-6107ac1a.f536f9aa.js.map
