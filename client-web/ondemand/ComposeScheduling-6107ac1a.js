...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.ComposeScheduling-6107ac1a"],
    {
        418462: (e, t, r) => {
            ...
            function R({ renderActionsBar: e = H, renderActionMenu: t = B, renderArticleCard: r = N, renderCallToAction: n = F, renderEditCallout: o = D, renderEducation: a = V, renderHighlightedUserLabel: d = q, renderPlace: c = W, renderPromotedUserProfileCard: u = Q, renderPromotedDetails: p = $, renderPromotionStatusBadge: h = O, renderReplyContext: g = z, renderRichContent: f = K, renderMedia: _ = Y, renderTweetHeader: b = j, renderStats: v = G, renderText: T = X, renderTimestamp: k = J, renderTombstone: y = ee, renderUserAvatar: E = te, renderUserFollowIndicator: I = re, renderUserName: x = ne, promotedContent: A, quotedTweetTombstoneInfo: Z, socialContext: S, tweetContext: P, staticLinkConfig: R = L, tweet: ie, ...oe }) {
        ...
        774526: (e, t, r) => {
            ...
            function H(e) {
                const { cardCacheLocationKey: t, forwardPivotInfo: r, id: a, inlineCalloutInfo: s, innerForwardPivotInfo: l, innerNudges: c, isMediaMaxHeightEnabled: g, loggedInUserId: f, onCardLinkClick: k, onQuoteTweetClick: y, onQuoteTweetMediaClick: E, onQuotedTweetAvatarClick: I, onQuotedTweetScreenNameClick: x, preventVideoPlayback: A, promotedContent: M, quoteTweetSingleImageMinAspectRatio: S, quoteTweetSocialContextProps: U, quotedTweetTombstoneInfo: R, renderJetfuelFrame: H, renderQuoteTweetTombstone: V, singleImageMaxAspectRatio: Q, style: Y, tweet: j, withActionsDisabled: G, withAltTextBadge: J, withCardLinks: X, withCenterCrop: ee, withCondensedQuoteTweet: te, withHalvedMediaSize: re, withQuoteTweetBirdwatchPivot: ne, withQuoteTweetHeaderLinks: ie, withQuoteTweetLink: oe, withQuoteTweetMedia: ae, withUserHoverCard: se } = D(e),
                    [le, de] = B(),
                    ce = p.ZP.useProps(),
                    ...
                    fe = () => {
                        ...
                        return t && t.is_quote_status ? i.createElement(v.Z, { forwardPivotInfo: t.quoted_status?.softIntervention || l, id: pe, isCondensed: te, loggedInUserId: f, mediaContentStyles: !te && K({ withEdgeToEdgeContent: ue, withHalvedMediaSize: re, backgroundColor: o, withMaxHeight: n, isInQuoteTweet: !0 }), mediaMaxHeight: n ? (ue ? L : he > 0 ? he : P) : void 0, nudges: c, onAvatarClick: I, onMediaClick: E, onPress: y, onScreenNameClick: x, preventVideoPlayback: A, promotedContent: M, shouldRenderIfBlocked: !!R, shouldShowAltLabelAlways: J, singleImageMaxAspectRatio: Q, singleImageMinAspectRatio: S, socialContextProps: U, tweet: t.quoted_status, withActionsDisabled: G, withBirdwatchPivot: ne, withCenterCrop: ee, withHeaderLinks: ie, withLink: oe, withMediaAsTextLinks: !ae, withUserHoverCard: se }) : null;
                    },
                    ...
                    ye = (() => {
                        ...
                        if (
                            ...
                            return null;
                        const r = m.default.getLegacyOrUnifiedCard(we, M, { isDynamicFollowCardPresentAndEnabled: O(e), isDynamicProductCardPresentAndEnabled: _e(), withCardLinks: X, hasMedia: $(e) }),
                            o = Z.Z.isArticlePost(we);
                        return r && !(o && "NoCard" === r?.unifiedCard?.card_fetch_state) ? i.createElement(u.Z, (0, n.Z)({}, r, { cardContext: { locationKey: t || N, tweetId: we.id_str, tweetPermalink: we.permalink, tweetUserId: we.user.id_str, viewerUserId: f, withActionsDisabled: G, mediaVisibilityResults: we.mediaVisibilityResults, grokShareAttachment: we.grok_share_attachment }, id: me, onCardLinkClick: k, preventVideoPlayback: A, promotedContent: M })) : null;
                    })(),
                    Ee = ((e) => {
                        ...
                        (() => {
                            const e = fe();
                            return e && R ? V({ children: e, config: R, id: pe }) : e;
                        })() || ye,
                    );
                if (!(ve || Ee || Te || be)) return null;
                return i.createElement(o.Z, { "aria-labelledby": `${pe} ${me}`, id: a, ref: de, style: [F.gap, Y] }, ve || ke || Te ? i.createElement(o.Z, { style: F.mediaPivotGap }, ve, ke, Te) : null, $(e) ? null : be, Ee);
            }
            const F = E.default.create((e) => ({ gap: { gap: e.spaces.space4 }, jetfuelCard: { paddingTop: e.spaces.space2 }, mediaPivotGap: { gap: e.spaces.space4 }, explicitlySized: { alignSelf: "flex-start" }, edgeToEdgeSingleVideoWithMaxHeight: { display: "block", start: "50%", translate: `calc(-50% + ${e.spacesPx.space16}px)` }, negativeMargin: { marginHorizontal: -e.spacesPx.space16 }, centerItems: { alignItems: "center" } }));
            ...
            function z(e) {
                ...
                if (J.card && m.default.isSpaceCard(J.card.name)) return i.createElement(o.Z, { style: F.gap }, i.createElement(y.Z, { audioSpaceId: J.card?.binding_values.id?.string_value, clipMetadata: J.card?.binding_values.clip_metadata?.string_value }));
                const ae = l && ne > 0 && (ee || X),
                    se = ie * (ee ? te : Math.max(1, te));
                return i.createElement(o.Z, { ref: Y, style: ae && { maxWidth: se } }, i.createElement(A.Z, { authorId: J.user.id_str, authorScreenName: J.user.screen_name, cacheLocationKey: w || N, customHoverBackgroundColor: re && G ? oe : void 0, displayMediaAttribution: !0, displayMediaMetadata: n, enableKeyboardShortcuts: a, forwardPivotInfo: s, hasSensitiveMedia: J.possibly_sensitive, loggedInUserId: d, mediaAltTranslations: u, mediaContentStyles: [K({ withEdgeToEdgeContent: G, withHalvedMediaSize: H, backgroundColor: oe, withMaxHeight: re })], mediaDetails: t, mediaMaxHeight: re ? ie : void 0, mediaTagsLink: `${J.permalink}/media_tags`, mediaVisibilityResults: J.mediaVisibilityResults || e.tweet.mediaVisibilityResults, nudges: h, onClick: C, onClickMediaTags: f, onGrokClick: g, onPlaybackStarted: b, parentTweetId: e.tweet.id_str, preventPlayback: v, promotedContent: T, renderPrerollActionMenu: k, shouldShowAltLabelAlways: U, showAltTranslation: E, showBorder: !(re && G), showRoundCorners: O, singleImageMaxAspectRatio: I, singleImageMinAspectRatio: x, style: re && !G && F.explicitlySized, tweetCreatedAt: J.created_at, tweetId: J.id_str, tweetText: J.text, withCenterCrop: R, withHalvedMediaSize: H, withMediaTagsIcon: V, withPostPlayback: !0 }));
            }
            function K(e) {
                const { backgroundColor: t, isInQuoteTweet: r = !1, withEdgeToEdgeContent: n, withHalvedMediaSize: i, withMaxHeight: o } = e;
                return [n && !r && !i && F.negativeMargin, o && n && [F.centerItems, { backgroundColor: t }]];
            }
        },
        266704: (e, t, r) => {
            r.d(t, { Z: () => b });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-6107ac1a.9b0d11aa.js.map
