            ...
            class w extends i.PureComponent {
                ...
                _renderUserAvatar() {
                    const { isAllowedToViewOptions: e, onAvatarClick: t, promotedContent: r, userAvatarSize: o, userAvatarUri: s, userScreenName: l } = this.props,
                        { avatar: d } = e;
                    return i.createElement(n.Z, { style: g.row }, i.createElement(a.ZP.Provider, { value: { userAvatarLabel: p } }, i.createElement(c.default, { onClick: t, promotedContent: r, screenName: l, size: o, uri: d ? s : void 0, withLink: !0 })), this._renderDecoration());
                }
                _renderHeader(e) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-6107ac1a.d07479ea.js.map
