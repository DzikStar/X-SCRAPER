...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.ComposeScheduling-bc6ccf4c", "icons/IconChevronDown-js", "icons/IconSchedule-js"],
    {
        418462: (e, t, r) => {
            r.d(t, { a: () => R, q: () => P });
            var n = r(807896),
                ...
                A = r(782261),
                S = r(782299);
            const P = Object.freeze({ ActionsBar: _.Z, ActionMenu: f.Z, CallToAction: a.ZP, EditCallout: b.Z, Education: T.Z, HighlightedUserLabel: d.Z, Media: k.Z, Place: o.ZP, PromotedDetails: u.Z, PromotedUserProfileCard: y.Z, ReplyContext: E.ZP, RichContent: I.Z, SocialContext: w.Z, Text: x.Z, Tombstone: g.Z, Timestamp: h.Z, UserAvatar: Z.Z, UserFollowIndicator: S.Z, UserName: M.Z, ArticleCard: v.Z }),
            ...
            function R({ renderActionsBar: e = H, renderActionMenu: t = B, renderArticleCard: r = N, renderCallToAction: n = V, renderEditCallout: o = D, renderEducation: a = F, renderHighlightedUserLabel: d = q, renderPlace: c = z, renderPromotedUserProfileCard: u = Q, renderPromotedDetails: h = W, renderPromotionStatusBadge: w = $, renderReplyContext: g = O, renderRichContent: f = K, renderMedia: _ = j, renderTweetHeader: v = G, renderStats: b = Y, renderText: T = X, renderTimestamp: k = J, renderTombstone: y = ee, renderUserAvatar: E = te, renderUserFollowIndicator: I = re, renderUserName: x = ne, promotedContent: Z, quotedTweetTombstoneInfo: M, socialContext: S, tweetContext: P, staticLinkConfig: R = L, tweet: ie, ...oe }) {
                const ae = A.Z.getOriginalTweet(ie),
                    ...
                    he = {
                        ...
                        renderRichContent: (e) => f({ forwardPivotInfo: ie.softIntervention, id: se.richContent, quotedTweetTombstoneInfo: M, tweet: ie, withAltTextBadge: !0, withCardLinks: !1, withCondensedQuoteTweet: !0, withMediaTagsIcon: !1, withQuoteTweetHeaderLinks: !1, withQuoteTweetLink: !0, withQuoteTweetMedia: !0, ...e }),
            ...
            const N = (e) => i.createElement(P.ArticleCard, e),
                ...
                W = (e) => i.createElement(P.PromotedDetails, e),
                Q = (e) => null,
                $ = (e) => null,
        ...
        189655: (e, t, r) => {
            ...
            const l = a.default.create((e) => ({ root: { borderWidth: e.borderWidths.small, borderColor: e.colors.borderColor, borderStyle: "solid", borderRadius: e.borderRadii.large } })),
                d = function ({ followButton: e, isUserProtected: t, isUserVerified: r, knownFollowers: a, link: d, onClick: c, onScreenNameClick: u, promotedContent: m, style: h, userDescription: p, userId: w, userName: g, userScreenName: C }) {
                    return n.createElement(i.Z, { style: h }, n.createElement(o.Z, { link: d, onClick: c, style: l.root }, n.createElement(s.Z.Promoted, { followButton: e, isUserProtected: t, isUserVerified: r, knownFollowers: a, onScreenNameClick: u, promotedContent: m, userDescription: p, userId: w, userName: g, userScreenName: C })));
                };
        },
        774526: (e, t, r) => {
            r.d(t, { Y: () => O, Z: () => H });
            ...
            function H(e) {
                const { cardCacheLocationKey: t, forwardPivotInfo: r, id: a, inlineCalloutInfo: s, innerForwardPivotInfo: l, innerNudges: c, isMediaMaxHeightEnabled: g, loggedInUserId: f, onCardLinkClick: k, onQuoteTweetClick: y, onQuoteTweetMediaClick: E, onQuotedTweetAvatarClick: I, onQuotedTweetScreenNameClick: x, pollTranslations: Z, preventVideoPlayback: A, promotedContent: S, quoteTweetSingleImageMinAspectRatio: U, quoteTweetSocialContextProps: R, quotedTweetTombstoneInfo: H, renderGrokTranslationHeaderForQuote: F, renderJetfuelFrame: Q, renderQuoteTweetTombstone: j, renderTranslationFeedback: G, singleImageMaxAspectRatio: Y, style: J, tweet: X, withActionsDisabled: ee, withAltTextBadge: te, withCardLinks: re, withCenterCrop: ne, withCondensedQuoteTweet: ie, withHalvedMediaSize: oe, withQuoteTweetBirdwatchPivot: ae, withQuoteTweetHeaderLinks: se, withQuoteTweetLink: le, withQuoteTweetMedia: de, withUserHoverCard: ce } = D(e),
                    [ue, me] = B(),
                    he = h.ZP.useProps(),
                    pe = he.withEdgeToEdgeContent(),
                    we = (0, v.b)(),
                    ge = (0, v.b)(),
                    Ce = M.Z.getOriginalTweet(X),
                    fe = he.compactMediaMaxHeight(),
                    ...
                    xe = (() => {
                        ...
                        if (
                            ...
                            return null;
                        const r = m.default.getLegacyOrUnifiedCard(Ce, S, { isDynamicFollowCardPresentAndEnabled: $(e), isDynamicProductCardPresentAndEnabled: Te(), withCardLinks: re, hasMedia: W(e) }),
                            o = M.Z.isArticlePost(Ce);
                        return r && !(o && "NoCard" === r?.unifiedCard?.card_fetch_state) ? i.createElement(u.Z, (0, n.Z)({}, r, { cardContext: { locationKey: t || N, tweetId: Ce.id_str, tweetPermalink: Ce.permalink, tweetUserId: Ce.user.id_str, viewerUserId: f, withActionsDisabled: ee, mediaVisibilityResults: Ce.mediaVisibilityResults, grokShareAttachment: Ce.grok_share_attachment, pollTranslations: Z, renderTranslationFeedback: G }, id: we, onCardLinkClick: k, preventVideoPlayback: A, promotedContent: S })) : null;
                    })(),
                    Ze = ((e) => {
                        const { possibly_sensitive: t, quoted_status: r } = Ce;
                        return ((!!r?.possibly_sensitive && !!(Ce.quoted_status && Ce.quoted_status.entities && Ce.quoted_status.entities.media && Ce.quoted_status.entities.media.length > 0 && de) && !H) || (t && !m.default.isPollCard(Ce.card?.name))) && e ? i.createElement(T.Z, { revealableTombstoneConfig: T.Z.sensitiveMediaTombstoneConfig }, e) : e;
                    })(
                        (() => {
                            const e = be();
                ...
                return i.createElement(o.Z, { "aria-labelledby": `${ge} ${we}`, id: a, ref: me, style: [V.gap, J] }, ye || Ie || Ee ? i.createElement(o.Z, { style: V.mediaPivotGap }, ye, Ie, Ee) : null, W(e) ? null : ke, Ze);
            }
            ...
            function O(e) {
                const { mediaDetails: t, ...r } = e,
                    { displayMediaMetadata: n, enableKeyboardShortcuts: a, forwardPivotInfo: s, isMediaMaxHeightEnabled: l, loggedInUserId: d, mediaAltTranslations: u, mediaCacheLocationKey: p, nudges: w, onGrokClick: g, onMediaClick: C, onMediaTagsClick: f, onPlaybackStarted: v, preventVideoPlayback: b, promotedContent: T, renderPrerollActionMenu: k, showAltTranslation: E, singleImageMaxAspectRatio: I, singleImageMinAspectRatio: x, withAltTextBadge: U, withCenterCrop: R, withHalvedMediaSize: H, withMediaTagsIcon: F, withRoundMediaCorners: $ } = D(r),
                    [O, j] = B(),
                    G = h.ZP.useProps(),
        ...
        266704: (e, t, r) => {
            ...
            (v.Promoted = (e) => {
                ...
                return n.createElement(w, (0, C.Z)({}, h, { followButton: t, isAllowedToViewOptions: { avatar: !1, badges: !0, description: !0, followButton: !0, followIndicator: !0, followersYouKnow: !0, fullName: !0, label: !0, stats: !1, subscriptionsCount: !1 }, isLoggedIn: !0, isUserProtected: r, isUserStatsWithLink: p.isUserStatsWithLink, isUserVerified: i, knownFollowers: o, onAvatarClick: a, onScreenNameClick: s, promotedContent: l, userAvatarUri: p.profile_image_url_https, userDescription: d, userEntities: p.entities, userFollowersCount: p.followers_count, userFriendsCount: p.friends_count, userId: c, userName: u, userScreenName: m, userWithFollowsYou: p.followed_by, userWithheldDescription: void 0, userWithheldEntities: void 0, withUserAvatar: !1 }));
            }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-bc6ccf4c.b96e2f3a.js.map
