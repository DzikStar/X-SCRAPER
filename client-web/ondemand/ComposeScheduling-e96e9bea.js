...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.ComposeScheduling-e96e9bea"],
    {
        625661: (e, t, i) => {
            i.d(t, { ZP: () => h });
            var n = i(202784),
            ...
            class h extends n.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: i, fixed: s, hideBackButton: r, isFullWidth: a, isLarge: d, leftControl: c, middleControl: h, position: m, rightControl: _, secondaryBar: p, style: g, subtitle: f, title: w, titleDomId: y, titleIconCell: T, titleIconCellSize: E, withBackground: b, withWideContainer: x } = this.props,
                        { isModal: C } = this.context,
                        D = r ? c : n.createElement(o.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        S = (function (e, t, i) {
                            return e && !(t && i);
                        })(!!b, C, !!p);
                    return n.createElement(n.Fragment, null, n.createElement(l.Z, { centerTitle: t, centeredLogo: i, isFullWidth: a, isLarge: d, leftControl: D, middleControl: h, position: u(m, C, s), rightControl: _, style: g, subtitle: f, title: w, titleDomId: y, titleIconCell: T, titleIconCellSize: E, withBackground: S, withWideContainer: x }), p || null);
                }
                render() {
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: i, backLocation: r, centerTitle: a, hideBackButton: o, history: l, isFullWidth: u, isLarge: h, middleControl: m, onBackClick: p, rightControl: g, secondaryBar: f, subtitle: w, title: y } = this.props,
                                { isModal: T } = this.context;
                            return n.createElement(s.Z, { style: T ? [_.childViewAppBarRoot, _.appBarZindex] : _.appBarZindex }, n.createElement(c.ZP, { backButtonType: i || (T ? "close" : "back"), backLocation: r, centerTitle: a, fixed: !T, hideBackButton: o, history: l, isFullWidth: u, isLarge: h, middleControl: m, onBackClick: p, ref: e, rightControl: g, secondaryBar: f, style: [T && _.appBarModal, t], subtitle: w, title: y, titleDomId: d.Q_ }));
                        }),
        ...
        943245: (e, t, i) => {
            ...
            const r = ["da", "de", "en", "en-gb", "es", "et", "eu", "fi", "fil", "fr", "ga", "gl", "ht", "hu", "id", "it", "lt", "lv", "nl", "no", "ms", "pl", "pt", "sk", "sl", "sv", "tr", "vi"],
                ...
                c = ({ displayTextRange: e, entities: t, language: i, text: r }) => {
                    if (!e || !d(i, e[1] - e[0])) return !1;
                    const a = ((e, t) => {
        ...
        964917: (e, t, i) => {
            i.d(t, { FP: () => g, Hf: () => d, Q$: () => f, UD: () => p, V2: () => u, yD: () => _ });
            var n = i(439058),
                s = i(499627),
                r = i(917799),
                a = i(312771);
        ...
        214151: (e, t, i) => {
            ...
            function H({ addToast: e, analytics: t, deleteScheduledTweet: i, history: d, language: c, scheduledFor: u, scheduledTweetId: w, updateAllComposers: y }) {
                const T = (0, f.o3)(u),
                    ...
                    X = n.useMemo(() => n.createElement(s.Z, { style: q.bottomBar }, n.createElement(r.ZP, { onPress: K, size: "xSmall", type: "brandText" }, v)), [K]),
                    J = n.useMemo(() => {
                    ...
                    me = he ? A : L;
                return n.createElement(m.Z, { appBarRef: b, backButtonType: "close", bottomBar: X, documentTitle: Z, history: d, rightControl: J, title: Z }, n.createElement(s.Z, { style: q.form }, n.createElement(s.Z, { style: q.formItem }, n.createElement(_.Z, { scheduledFor: O })), n.createElement(s.Z, { style: q.formItem }, n.createElement(a.ZP, { color: "gray700" }, F), n.createElement(o.Z, { day: se, errorMessage: ce ? me : "", errors: ce ? U : z, label: F, maxSelectableYear: le, minSelectableYear: oe, month: re, onChange: Y, style: q.date, withCalendar: !0, year: ae })), n.createElement(s.Z, { style: q.formItem }, n.createElement(l.Z, { errorText: ue ? L : "", hour: ie, invalid: ue, label: P, minute: ne, onChange: $ })), de && n.createElement(s.Z, { style: q.formItem }, n.createElement(a.ZP, { color: "gray700" }, R), n.createElement(a.ZP, { size: "headline1" }, de))));
            }
        ...
        867751: (e, t, i) => {
            ...
            const ne = ({ mediaEntities: e, replyUserInfo: t, restID: i, tweetCreateRequest: n, userMentions: s }) => {
                    const { displayRangeEnd: r, displayRangeStart: a } = (0, v.Z)(n?.status || ""),
                        o =
                            e &&
                            ((e) => {
                                const t = e.map((e) =>
            ...
            class de extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderReplyContext = () => {
                            ...
                            if (!s || (0, _.Z)(s)) return n.createElement(E.ZP, { color: "gray700", size: "subtext2" }, oe);
                            ...
                            const o = a?.legacy,
                                ...
                                d = o && o.id_str,
                                c = l && l.screen_name,
                                u = s.legacy && s.legacy.entities,
                                h = (u && u.user_mentions) || [],
                                m = this._getFilteredMentions(h, r),
                                p = n.createElement(b.ZP, { displayTextRange: [280, 280], inReplyToScreenName: c, inReplyToUserIdStr: d, linkType: "none", size: "subtext2", tweetPermalink: "", userMentionsEntities: m });
                            return n.createElement(x.Z, { contextType: "Reply", iconSize: "large", style: ce.socialContext, text: p, weight: "bold", withLeftPadding: !1 });
                        }),
                ...
                render() {
                            ...
                            ? e.scheduling_info
                                ? ((e) => {
                                      const t = e.tweet_create_request,
                                          ...
                                          s = i?.core?.user_results.result?.legacy ? { ...i.core.user_results.result.legacy, screen_name: i.core.user_results.result.core?.screen_name } : void 0,
                                          r = e.media_entities,
                                ...
                                : ((e) => {
                                      const t = "PostTweetRequest" === e.tweet_create_request?.type ? e.tweet_create_request : void 0,
                                          i = e.replied_tweet_results?.result,
                                          n = "Tweet" === i?.__typename && "User" === i?.core?.user_results.result?.__typename && i?.core?.user_results.result?.legacy ? { ...i?.core?.user_results.result?.legacy, screen_name: i.core.user_results.result.core?.screen_name } : void 0,
                                          s = e.media_entities,
                    ...
                    const h = r.attachment_url,
                        ...
                        w = Boolean(f && (0, _.Z)(d)),
                        { displayRangeEnd: y, displayRangeStart: b, validRangeEnd: S, validRangeStart: Z } = (0, v.Z)(p),
                        B = S - Z < y - b ? `${p.substring(Z, S + 1)}...` : p,
                        k = this._getImages(t),
                        I = this._getLabelInfo(t),
                        P = r?.thread_tweets?.length ?? 0;
                    return n.createElement(s.Z, { style: [ce.listItem, g && ce.scheduleFail], testID: se }, c && u ? n.createElement(C.Z, { renderMedia: (e) => n.createElement(C.Z.Media, (0, T.Z)({}, e, { videoOptions: { ...e.videoOptions, hidePreviewPlayButton: !0 } })), renderReplyContext: (e) => (!d || (0, _.Z)(d) ? n.createElement(E.ZP, { color: "gray700", size: "subtext2" }, oe) : n.createElement(C.Z.ReplyContext, (0, T.Z)({}, e, { displayTextRange: [280, 280], linkType: "none", tweetPermalink: "" }))), renderText: (t) => n.createElement(n.Fragment, null, n.createElement(C.Z.Text, (0, T.Z)({}, t, { entities: void 0 })), g || w ? n.createElement(s.Z, { style: ce.leftColumn }, n.createElement(ee, { isDraft: !m, unsentTweetId: e.rest_id })) : null), renderTimestamp: (e) => this._renderLegend(o, m, w, e.id), renderUserAvatar: () => null, renderUserName: () => null, role: "button", tweet: u }) : n.createElement(s.Z, { style: ce.unsentTweet }, n.createElement(s.Z, { style: ce.content }, this._renderLegend(o, m, w)), n.createElement(s.Z, { style: ce.tweetContent }, f && this._renderReplyContext(), h && n.createElement(x.Z, { contextType: "Retweet", iconSize: "large", style: ce.socialContext, text: h, weight: "bold", withLeftPadding: !1 }), n.createElement(s.Z, { style: ce.content }, n.createElement(s.Z, { style: ce.leftColumn }, n.createElement(D.Z, { displayTextRange: [Z, S], style: ce.tweetText, text: B }), P > 0 && n.createElement(E.ZP, { color: "gray500", size: "subtext1" }, le({ count: P })), (g || w) && n.createElement(ee, { isDraft: !m, unsentTweetId: e.rest_id })), k.length > 0 && n.createElement(s.Z, { style: [ce.imageContainer, ce.rightColumn] }, n.createElement(L, { cacheLocationKey: "unsentTweets", hideAcceptOverlay: !0, images: k, onClick: this._handleImageClick, singleImageMaxAspectRatio: 1, singleImageMinAspectRatio: 1 }), I && n.createElement(E.ZP, { size: "subtext3" }, n.createElement(te.ZP, { durationInMilliseconds: I.duration, type: I.type })))))));
                }
                    ...
                    super(...e),
                        ...
                        (this._renderSegmentedControl = () => {
                            const e = [
                                ...
                                { to: "/compose/post/unsent/scheduled", key: ve, label: ve },
                            ];
                        ...
                        (this._handleClick = (e) => () => {
                            ...
                            const { rest_id: i, tweet_create_request: n } = e,
                                ...
                                d = l && l.split("/status/")[1].match(_e.Wq.id),
                                c = d ? d[0] : void 0,
                                ...
                                m = n?.thread_tweets ?? [],
                                _ = "PostTweetRequest" === n?.type ? n.media_ids : void 0;
                                ...
                                g = Promise.all(e.map(({ url: e }) => (0, ue.f)(e)))
                                    ...
                                    .then((t) =>
                                        t.map((t, i) => {
                                            ...
                                            return (n || s) && this.props.setMediaMetadata(t.id, { ...(0, p.Z)(n ? { altText: n } : null), ...(0, p.Z)(s ? { sensitiveMediaWarning: s } : null) }), t.id;
                                        }),
                                    );
                            }
                            g.then((e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.ComposeScheduling-e96e9bea.39e0974a.js.map
