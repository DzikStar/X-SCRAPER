    ...
    ["ondemand.Debugger", "icons/IconChevronDown-js"],
    {
        232678: (e, t, n) => {
            ...
            const P = "application/font-woff",
                L = "image/jpeg",
                D = { woff: P, woff2: P, ttf: "application/font-truetype", eot: "application/vnd.ms-fontobject", png: "image/png", jpg: L, jpeg: L, gif: "image/gif", tiff: "image/tiff", svg: "image/svg+xml", webp: "image/webp" };
            function I(e) {
                const t = (function (e) {
                    const t = /\.([^./]*?)$/g.exec(e);
                    return t ? t[1] : "";
                      ...
                      ? (async function (e, t) {
                            if (e.currentSrc) {
                                const t = document.createElement("canvas"),
                                    n = t.getContext("2d");
                                return (t.width = e.clientWidth), (t.height = e.clientHeight), null == n || n.drawImage(e, 0, 0, t.width, t.height), Z(t.toDataURL());
                            }
                            const n = e.poster,
                                r = I(n);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Debugger.91dd992a.js.map
