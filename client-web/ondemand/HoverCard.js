...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.HoverCard"],
    {
        ...
        527409: (e, t, n) => {
            n.r(t), n.d(t, { ListDetail: () => k, default: () => A, formatNumber: () => I });
            var r = n(202784),
                o = n(272175),
                s = n(325686),
                i = n(98538),
            ...
            const S = (e, t) => {
                ...
                x = (e, t) => {
                    const n = S(e, t),
                        r = n?.user;
                    return r ? Z.ZP.select(e, r) : void 0;
                },
                T = (e, t) => C.tt(e, t.listId),
                P = (0, y.Z)()
                    .propsFromState(() => ({ list: S, user: x, viewerUserId: v._h, media: T }))
                    .withAnalytics(),
                I = f().d58baa7f,
                F = f().ca5d0a82,
                N = f().j681933e;
            class k extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderImage = () => {
                            ...
                            return r.createElement(d.Z, { ratio: 3 }, r.createElement(s.Z, { style: B.placeholderImageContainer }));
                        }),
                        (this._renderListDescription = () => {
                            ...
                            if (e) {
                                const { description: n, member_count: i, mode: a, name: l, subscriber_count: c } = e,
                                    ...
                                    m = i || 0,
                                    h = "private" === a;
                                return r.createElement(s.Z, { style: B.description }, r.createElement(s.Z, { style: [B.name, B.text] }, r.createElement(u.ZP, { align: "center", size: "headline1", weight: "bold" }, l.trim()), h ? r.createElement(g.default, { "aria-label": N, style: B.iconLock }) : null), n ? r.createElement(r.Fragment, null, r.createElement(o.ql, { prioritizeSeoTags: !0 }, r.createElement("meta", { content: n.trim(), property: "og:description" })), r.createElement(u.ZP, { align: "center", style: B.text }, n.trim())) : null, t ? r.createElement(p.Z, { affiliateBadgeInfo: t.highlightedLabel, isBlueVerified: t.is_blue_verified, isProtected: t.protected, isVerified: t.verified, name: t.name, onLinkClick: this._handleUserNamePress, profileImageUrl: t.profile_image_url_https, screenName: t.screen_name, style: B.text, verifiedType: t.verified_type, withLink: !0 }) : null, this._renderCount(d, m), this._renderActionButton());
                            }
                        }),
                        ...
                        (this._renderActionButton = () => {
                            ...
                            if (t && t.user) {
                                const a = n?.blocking;
                                return t.user === o && i ? r.createElement(m.ZP, { link: `${e}/info`, onPress: this._handleEditPress, style: B.button, type: "primaryOutlined" }, F) : t.user !== o ? r.createElement(s.Z, { style: B.button }, r.createElement(b.Z, { disabled: a, isFollowing: !!t.following, listId: t.id_str, listName: t.name, user: n })) : null;
                            }
                        }),
                        (this._scribe = (e) => {
                ...
                render() {
                    ...
                    return e ? r.createElement(s.Z, { style: [B.container, t && B.hoverCard] }, this._renderImage(), this._renderListDescription()) : null;
                }
            }
        ...
        904694: (e, t, n) => {
            n.r(t), n.d(t, { TopicHeader: () => z, default: () => H });
            var r = n(202784),
                o = n(325686),
                s = n(111677),
                i = n.n(s),
            ...
            const h = m.default.create((e) => ({ buttonBottomMargin: { marginBottom: e.spaces.space16 }, buttonLeftMargin: { marginStart: e.spaces.space20 }, buttonTopMargin: { marginTop: e.spaces.space20 }, buttonWrap: { flexWrap: "wrap-reverse" }, condensedContext: { marginTop: e.spaces.space16, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, condensedContextV2: { marginTop: e.spaces.space16 }, iconCustom: { alignSelf: "flex-start", borderRadius: e.borderRadii.infinite, height: e.spaces.space32, width: e.spaces.space32, marginTop: e.spaces.space8, marginBottom: e.spaces.space8 }, facepile: { marginBottom: e.spaces.space16, alignSelf: "flex-start" }, facepileV2: { marginEnd: e.spaces.space8, marginTop: e.spaces.space16 }, interactiveStyle: { flexShrink: 1 }, interactiveStyleV2: { flexDirection: "row", alignItems: "center" }, knownFollowersContainer: { marginTop: e.spaces.space16, marginBottom: e.spaces.space16, flexDirection: "row", justifyContent: "space-between", flexGrow: 1, flexShrink: 1 }, underline: { textDecorationLine: "underline" } })),
                f = ({ children: e, context: t, imageSrc: n, knownFollowers: s, onFacepilesClick: f, onFacepilesImpression: g, subtitle: w, title: _, withAdditionalControls: b = !1 }) => {
                    const { firstUsername: y, knownFollowersAvatarUrls: E, trendingFollowersUrl: v, usersCount: Z } = s || {},
                        C = s && s.knownFollowersAvatarUrls.length > 3;
                    r.useEffect(() => {
                        C && g && g();
                    }, [C, g]);
                    const S = n ? r.createElement(c.Z, { source: n, style: h.iconCustom }) : null,
                        x = t ? r.createElement(o.Z, { style: b ? h.condensedContextV2 : h.condensedContext }, r.createElement(a.ZP, { align: "left", color: "gray700", numberOfLines: 3, size: "subtext2" }, t), r.createElement(o.Z, { style: b ? h.buttonTopMargin : [h.buttonBottomMargin, h.buttonLeftMargin] }, e)) : null,
                        ...
                        P = s && C ? T : x;
                    return r.createElement(r.Fragment, null, S, r.createElement(a.ZP, { size: "title2", weight: "heavy" }, _), w ? r.createElement(a.ZP, { color: "gray700", size: "subtext2", weight: "bold" }, w) : null, P);
                };
            var g = n(791632),
                w = n(321835),
                _ = n(946409),
                ...
                N = n(466380),
                k = n(919022);
            const B = (e, t) => N.Z.select(e, t.topicId),
                A = (e, t) => k.ZP.selectMany(e, t.facepile?.userIds || []),
                O = (e, t) => {
                    const n = A(e, t);
                    return (0, P.Z)(n, (e) => (!e || e.blocking || e.muting ? void 0 : e));
                },
                M = (0, F.Z)()
                    .propsFromState(() => ({ topic: B, users: O }))
            ...
            (z.contextType = v.rC), (z.defaultProps = { displayType: y.el.Basic });
        ...
        365112: (e, t, n) => {
            ...
            const T = (0, S.W3)([S.pL]),
                ...
                I = (e, t) => S.ZP.selectByScreenName(e, t.screenName),
                F = (e, t) => S.ZP.selectIsUserNotFound(e, t.screenName),
                N = (e, t) => S.ZP.selectIsUserSuspended(e, t.screenName),
                k = (e, t) => S.ZP.selectIsUserWithheld(e, t.screenName),
                B = (e, t) => {
                    const n = I(e, t);
                    return n?.highlightedLabel;
                },
                A = (e, t) => {
                    const n = ((e, t) => S.ZP.selectIdByScreenName(e, t.screenName))(e, t);
                    return { avatarUrls: x.vx(e, n), count: x.mM(e, n), names: x.Z8(e, n) };
                },
                O = (0, v.Z)()
                    .propsFromState(() => ({ displaySensitiveMedia: C.f1, fetchStatus: P, isNotFound: F, isSuspended: N, isWithheld: k, knownFollowers: A, user: I, userHighlightedLabel: B }))
                    .propsFromActions(() => ({ createLocalApiErrorHandler: (0, E.zr)("USER_PROFILE_CARD"), fetchOneUserByScreenNameIfNeeded: S.ZP.fetchOneByScreenNameIfNeeded, fetchKnownFollowersIfNeeded: Z.Hq }))
                    .withAnalytics();
        ...
        510588: (e, t, n) => {
            n.d(t, { $5: () => u, By: () => w, DV: () => E, Fz: () => f, Ge: () => b, Ns: () => S, Wy: () => h, _g: () => Z, ax: () => _, cx: () => g, l1: () => v, tt: () => C, xh: () => m });
            var r = n(614983),
                o = n.n(r),
                s = n(842799),
                i = n(286e3),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.HoverCard.e1c8d37a.js.map
