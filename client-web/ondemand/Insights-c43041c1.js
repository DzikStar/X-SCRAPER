        ...
        742266: (e, t, a) => {
            ...
            const d = ({ fullWidth: e = !1 }) => {
                const t = (0, r.d)(),
                    { business: a } = (0, o.M1)(),
                    d = (0, u.nO)();
                return (0, n.jsx)(i.z, { onClick: () => t.push(`${d}`), size: "xSmallCompact", variant: "insightsSecondary", icon: (0, n.jsx)(s.Z, { className: "text-gray-700" }), children: (0, n.jsx)("div", { className: (0, l.Z)("text-subtext2 md:text-subtext3 font-normal", { "hidden md:block": !e }), children: a.radar.allQueries }) });
            };
        },
        3170: (e, t, a) => {
            a.d(t, { A: () => d });
