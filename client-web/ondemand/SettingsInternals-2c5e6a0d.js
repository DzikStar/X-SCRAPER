    ...
    ["ondemand.SettingsInternals-2c5e6a0d"],
    {
        ...
        928088: (e, t, n) => {
            ...
            const a = n(392237).default.create((e) => ({ root: { paddingHorizontal: e.componentDimensions.gutterHorizontal, paddingVertical: e.componentDimensions.gutterVertical } })),
                i = function ({ children: e }) {
                    return o.createElement(r.Z, { style: a.root }, e);
                };
        },
        88307: (e, t, n) => {
            n.d(t, { Z: () => c });
            ...
            class s extends o.Component {
                ...
                render() {
                    ...
                    return o.createElement(r.Z, { style: [l.root, s && l.bottomBorder] }, o.createElement(a.ZP, null, e), i ? (t && n ? this._renderSubtextAndLink() : o.createElement(a.ZP, { color: "gray700", size: "subtext2" }, i)) : null);
                }
            }
        ...
        80512: (e, t, n) => {
            ...
            class u extends o.Component {
                constructor() {
                    super(),
                        (this._handleGateToggle = () => {
                            const { defaultOption: e, name: t, offValue: n, onChange: o, options: r, value: a } = this.props;
                            o(t, a === n ? e?.value || r[0].value : n);
                        }),
                ...
                render() {
                    const { "aria-label": e, description: t, disabled: n, label: l, name: d, offValue: u, onChange: m, options: h, value: g } = this.props;
                    return o.createElement(r.Z, { "aria-label": e, "aria-labelledby": l && !e ? this._labelId : void 0, role: "group", style: [p.root, n && p.disabled] }, o.createElement(o.Fragment, null, l ? o.createElement(r.Z, { id: this._labelId, role: "label", style: p.header }, o.createElement(r.Z, { style: p.label }, o.createElement(i.ZP, { weight: "bold" }, l), o.createElement(c.Z, { disabled: n, onValueChange: this._handleGateToggle, value: g !== u })), t ? o.createElement(i.ZP, { color: "gray700", size: "subtext2" }, t) : null) : null, h && o.createElement(a.Z, { onAnimateComplete: this._handleAnimationComplete, show: g !== u }, o.createElement(r.Z, null, o.createElement(r.Z, { style: p.radioGroup, tabIndex: 0 }, o.createElement(s.Z, { "aria-label": e || l, disabled: n, name: d, onChange: m, options: h, ref: this._setRadioGroupRef, value: g }))))));
                }
            }
        ...
        403556: (e, t, n) => {
            ...
            class w extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: o, children: a, color: i, isActive: c, isCompact: d, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: w, style: v, to: k } = this.props,
                        { location: _ } = this.state,
                        Z = k ? this._getMemoizedLink(k, w) : void 0,
                        S = c ? c(k) : _?.pathname === Z?.pathname,
                        P = f.Z.generate({ backgroundColor: "transparent", color: s.default.theme.colors.text, insetFocusRing: !0 }),
                        B = g ? "medium" : S ? "bold" : "medium";
                    return r.createElement(b.Z, { "aria-label": t, "aria-selected": S, focusable: !!S, interactiveStyles: P, link: Z, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? E.pill : E.link, u && S ? E.active : null, d ? (u ? E.compactPill : E.compactLink) : null, p ? E.roundedRect : null, v], withoutInteractiveStyles: g || u }, ({ isFocused: t, isHovered: c }) => r.createElement(l.Z, { style: u && E.flexGrow }, r.createElement(m.ZP, { size: g ? "headline2" : void 0, style: [E.text, { color: this._getTextColor(S, c, g, u) }, d && E.compactText, g && t && E.focusedText], weight: B }, e && r.createElement(e, { style: E.icon }), a, g || u ? null : r.createElement(l.Z, { style: S && [E.border, { backgroundColor: s.default.theme.colors[i] }] })), n ? r.createElement(h.Z, { count: n, standalone: !0, style: [E.badge, n >= 10 && E.multiDigitBadge, n >= 20 && E.truncatedCountBadge], truncatedCountFormatter: C, unreadCountLabel: y, withBorder: !1 }) : o ? r.createElement(h.Z, { pip: !0, standalone: !0, style: E.badgePip, textColor: "red500", unreadCountLabel: x, withBorder: !1 }) : null));
                }
            }
            ...
            const E = s.default.create((e) => ({
                ...
                _ = ({ alignFirstItem: e, "aria-label": t, isCompact: n, isPillLink: s, isRoundedRect: l, links: c, style: d, visibleItemIndex: u }) => {
                    const p = c
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-2c5e6a0d.e460c52a.js.map
