...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.SettingsInternals-394f886d"],
    {
        ...
        80697: (e, t, n) => {
            n.r(t), n.d(t, { SettingsSecurityScreen: () => H, default: () => z, loginVerificationLabel: () => y, passwordResetProtectLabel: () => P });
            n(136728);
            var s = n(202784),
                a = n(325686),
                r = n(688715),
            ...
            const C = (0, S.Z)()
                ...
                A = p().afe4a358,
                I = p().dc096238,
                D = (0, r.ju)("https://help.x.com/managing-your-account/two-factor-authentication"),
                F = (0, r.ju)("https://help.x.com/safety-and-security/account-security-tips"),
                B = (0, r.ju)("https://help.x.com/rules-and-policies/verification-policy"),
                U = p().i859a9d4,
                N = { page: "settings", section: "security" },
                R = Object.freeze({});
                    ...
                    super(e, t),
                        ...
                        (this._handlePasswordSubmit = (e) => {
                            ...
                            n({ ...s, current_password: e }).then(
                                () => {
                                    this.setState({ showPasswordDialog: !1, data: R });
                                },
                                t({ showToast: !0 }),
                            );
                        }),
                        ...
                        (this.state = { showPasswordDialog: !1, data: R });
                }
                render() {
                    const { location: e } = this.props,
                        { showPasswordDialog: t } = this.state;
                    return s.createElement(_.nO, { namespace: N }, s.createElement(m.Z, null, s.createElement(g.Z, { location: e, onPasswordSubmit: this._handlePasswordSubmit, promptForPassword: t, title: w }, s.createElement(a.Z, null, s.createElement(o.Z, { description: Z }), this._renderTwoFactorAuthentication(), s.createElement(i.Z, null), this._renderIDVerification(), s.createElement(i.Z, null), this._renderPasswordResetProtect(), this._renderPasskeys()))));
                }
                _renderTwoFactorAuthentication() {
                    return s.createElement(s.Fragment, null, s.createElement(c.Z, { text: y }), s.createElement(l.Z, { label: y, link: "/settings/account/login_verification" }), s.createElement(o.Z, { description: L, learnMoreLabel: U, learnMoreLink: D }));
                }
                _renderIDVerification() {
                    return this.context.featureSwitches.isTrue("identity_verification_settings_enabled") ? s.createElement(s.Fragment, null, s.createElement(c.Z, { text: A }), s.createElement(l.Z, { label: A, link: "/settings/account/id_verification" }), s.createElement(o.Z, { description: I, learnMoreLabel: U, learnMoreLink: B })) : null;
                }
                _renderPasswordResetProtect() {
                    const { protectPasswordReset: e } = this.props;
                    return s.createElement(s.Fragment, null, s.createElement(c.Z, { text: T }), s.createElement(h.Z, { checked: !!e, label: P, name: "protect_password_reset", onChange: this._handleProtectPasswordResetChanged }), s.createElement(o.Z, { description: k, learnMoreLabel: U, learnMoreLink: F }));
                }
                _renderPasskeys() {
                    return this.context.featureSwitches.isTrue("identity_verification_passkey_settings_enabled") ? s.createElement(s.Fragment, null, s.createElement(h.Z, { checked: this.props.hasPasskey, label: x, name: "passkey", onChange: this._handlePasskeyChanged }), s.createElement(o.Z, { description: v })) : null;
                }
            }
            H.contextType = u.rC;
            const z = C(H);
            ...
            class I extends s.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._render = () => {
                            const { session: e } = this.props;
                            return e ? s.createElement(a.Z, null, s.createElement(g.Z, { session: e, withBottomBorder: !1, withSummary: !0 }), this._renderDateAndTime(e), this._renderLocation(e)) : s.createElement(r.Z, { header: A });
                        });
                }
                componentDidMount() {
                    this._fetchSessionsIfNeeded();
                ...
                render() {
                    const { fetchStatus: e, location: t, session: n } = this.props,
                        a = n ? n.name : "";
                    return s.createElement(m.Z, null, s.createElement(_.Z, { location: t, title: a }, s.createElement(u.Z, { "aria-label": v, fetchStatus: e, onRequestRetry: this._handleRetry, render: this._render })));
                }
                _renderDateLabel(e) {
                ...
                _renderDateAndTime(e) {
                    return s.createElement(a.Z, null, e?.last_seen_time_ms ? s.createElement(a.Z, null, s.createElement(i.Z, null), s.createElement(c.Z, { text: T }), s.createElement(a.Z, { style: [F.labelContainer, !e?.is_current_session && F.bottomBorder] }, s.createElement(o.ZP, { color: "gray700", size: "subtext2" }, this._renderDateLabel(e)))) : null, e?.is_current_session ? null : s.createElement(p.Z, { confirmationSheetConfirmButtonLabel: L.confirmButtonLabel, confirmationSheetConfirmButtonType: "primary", confirmationSheetHeadline: L.headline, confirmationSheetText: L.text, label: y, onConfirmationSheetConfirm: this._handleLogOut, withBottomBorder: !1 }));
                }
                _renderLocation(e) {
                    const t = e.location;
                    return t ? s.createElement(a.Z, null, s.createElement(i.Z, null), s.createElement(c.Z, { text: k }), s.createElement(a.Z, { style: F.labelContainer }, s.createElement(o.ZP, { color: "gray700", size: "subtext2" }, t))) : null;
                }
            }
            const D = w(I),
            ...
            class h extends s.PureComponent {
                render() {
                    ...
                    switch (e.toString().toLowerCase()) {
                        case "mobile":
                            return s.createElement(a.Z, { Icon: r.default, color: "neutral" });
                        case "laptop":
                            return s.createElement(a.Z, { Icon: o.default, color: "neutral" });
                        case "tablet":
                            return s.createElement(a.Z, { Icon: i.default, color: "neutral" });
                        case "tv":
                            return s.createElement(a.Z, { Icon: c.default, color: "neutral" });
                        default:
                            return s.createElement(a.Z, { Icon: l.default, color: "neutral" });
                    }
                }
            }
        },
            ...
            class u extends s.PureComponent {
                _renderLocationAndDateLabel() {
                    const { session: e } = this.props,
                        ...
                        n = e.location,
                        c = t ? s.createElement(a.Z, { cutoff: "years", humanReadable: !0, timestamp: Number(t) }) : null,
                        l = e.is_current_session ? s.createElement(r.ZP, { background: "primary" }, p) : c;
        ...
        371590: (e, t, n) => {
            ...
            function v({ isSubscriber: e }) {
                ...
                return s.createElement(o.Z, { disabled: h, onPress: d, role: "button", style: A.root, testID: "manage_creator_subscriptions", withInteractiveStyling: !0 }, s.createElement(a.Z, { style: A.contentContainer }, s.createElement(a.Z, { style: A.thumbnailContainer }, s.createElement(p.default, null)), s.createElement(a.Z, { style: A.content }, s.createElement(i.ZP, null, L), s.createElement(i.ZP, { color: "gray700", size: "subtext2" }, T)), h ? s.createElement(c.Z, null) : null, s.createElement(u.default, { style: A.icon })));
            }
                    ...
                    super(e, t),
                        ...
                        (this._renderWoeLocations = () => {
                            ...
                            return s.createElement(
                                a.Z,
                                null,
                                s.createElement(a.Z, { style: F.searchBox }, s.createElement(r.Z, { Icon: l.default, autoFocus: !1, onChange: this._handleInputChange, onClear: this._handleInputClear, placeholder: I, value: this.state.query, withClearButton: !0 })),
                                s.createElement(
                                    a.Z,
                                    null,
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderWoeContent = () => {
                            ...
                            return s.createElement(a.Z, null, s.createElement(r.Z, { checked: e, helpText: D, label: A, name: "personalized_trends", onChange: this._handleItemChanged }), !e && s.createElement(a.Z, null, s.createElement(o.Z, null), s.createElement(i.Z, { description: n, label: R, link: M })));
                        }),
                        ...
                        (this._renderPlaceContent = () => {
                            ...
                            return s.createElement(a.Z, null, d && s.createElement(s.Fragment, null, s.createElement(o.Z, null), s.createElement(c.Z, { text: N }), s.createElement(r.Z, { checked: t[O], helpText: B, label: I, name: O, onChange: this._handleItemChanged })), s.createElement(c.Z, { text: v }), s.createElement(r.Z, { checked: t[j], helpText: x, label: k, name: j, onChange: this._handleItemChanged, testID: Z }), !t[j] && s.createElement(a.Z, null, s.createElement(i.Z, { description: l, label: H, link: p, testID: y })), h && s.createElement(s.Fragment, null, s.createElement(o.Z, null), s.createElement(c.Z, { text: U }), s.createElement(r.Z, { checked: t[W], helpText: F, label: A, name: W, onChange: this._handleItemChanged })));
                        });
                }
                componentDidMount() {
        ...
        829824: (e, t, n) => {
            ...
            function g() {
                ...
                return (
                    ...
                    s.createElement(r.Z, { title: m }, s.createElement(o.ZP, null, _))
                );
            }
            function f(e) {
                const { featureSwitches: t } = s.useContext(l.rC),
                    n = (0, p.v9)(u.Qb),
                    r = (0, h.Xh)(a.b7, t);
                return n || r ? e.children : s.createElement(g, null);
            }
        },
        902339: (e, t, n) => {
            n.d(t, { Z: () => _ });
        ...
        170069: (e, t, n) => {
            ...
            var s = n(202784),
                ...
                r = n(731708),
                o = n(392237);
            const i = ({ children: e }) => s.createElement(a.Z, { style: c.labelContainer }, s.createElement(a.Z, { style: c.contentContainer }, s.createElement(a.Z, { style: c.appText }, s.createElement(r.ZP, { color: "gray700", size: "subtext2" }, e)))),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-394f886d.6a8ae4aa.js.map
