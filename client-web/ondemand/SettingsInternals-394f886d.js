    ...
    ["ondemand.SettingsInternals-394f886d"],
    {
                ...
                constructor(e, t) {
                    super(e, t),
                        (this._render = () => {
                            ...
                            return s.createElement(r.Z, null, s.createElement(r.Z, null, s.createElement(a.ZP, { color: "gray700", size: "subtext2", style: [w.Z.infoText, w.Z.bottomBorder] }, this._isLoggedIn ? A : D)), s.createElement(o.Z, { checked: this._getSwitchAllValue(), helpText: F, key: "switchAll", label: I, name: "switchAll", onChange: this._handleSwitchAllChanged, type: "switch" }), s.createElement(i.Z, null), s.createElement(c.Z, { text: B }), s.createElement(o.Z, { checked: p, helpText: j, key: "allowPersonalization", label: W, learnMoreLink: (0, l.ju)("https://support.x.com/articles/20170405"), name: "allowPersonalization", onChange: this._handleBooleanChanged }), s.createElement(o.Z, { checked: e, helpText: M, key: "allowDeviceAccess", label: O, learnMoreLink: (0, l.ju)("https://support.x.com/articles/20175257"), name: "allowDeviceAccess", onChange: this._handleBooleanChanged }), this._isLoggedIn && s.createElement(o.Z, { checked: t, helpText: G, key: "allowLocationHistoryUse", label: q, name: "allowLocationHistoryUse", onChange: this._handleBooleanChanged }), s.createElement(i.Z, null), s.createElement(c.Z, { text: H }), !this.context.featureSwitches.isTrue("ucpd_enabled") && this._renderCookiePersonalizationSetting(), s.createElement(o.Z, { checked: n, helpText: K, key: "allowPartnerships", label: J, learnMoreLink: (0, l.ju)("https://support.x.com/articles/20175379"), name: "allowPartnerships", onChange: this._handleBooleanChanged }), this._isLoggedIn && s.createElement(d.Z, { label: R, link: "/settings/your_twitter_data" }), u && s.createElement(h.Z, { cancelButtonLabel: V, confirmButtonLabel: N, onCancel: this._handleCancelDisableEU, onConfirm: this._handleDisableEUCookies, text: U }), m && s.createElement(h.Z, { confirmButtonLabel: z.confirmButtonLabel, headline: z.headline, onCancel: this._handleCancelSwitchAll, onConfirm: this._handleConfirmSwitchAll, text: z.text }));
                        }),
        ...
        630518: (e, t, n) => {
            ...
            class B extends s.Component {
                ...
                render() {
                    const { fetchStatus: e, location: t } = this.props;
                    return s.createElement(u.Z, null, s.createElement(m.Z, { location: t, title: C }, s.createElement(h.Z, { fetchStatus: e, onRequestRetry: this._handleFetchDevices, render: this._renderOCFPhone })));
                }
                _renderDeleteButton() {
                    const {
                    ...
                    let n = P;
                    return t && "Sms" in e && (n = "Totp" in e || "U2fSecurityKey" in e ? F : I), s.createElement(d.Z, { confirmationSheetConfirmButtonLabel: n.confirmButtonLabel, confirmationSheetConfirmButtonType: "destructiveFilled", confirmationSheetHeadline: n.headline, confirmationSheetText: n.text, label: T, onConfirmationSheetConfirm: this._handleRemove, withBottomBorder: !1 });
                }
            }
            B.contextType = p.rC;
            const H = w(B);
        ...
        325163: (e, t, n) => {
            ...
            const g = (0, p.Z)()
                ...
                E = ({ clearUsernameAvailability: e, createLocalApiErrorHandler: t, history: n, location: a, updateSettings: o, viewerUser: h }) => {
                    ...
                    return s.createElement(c.Z, null, g ? s.createElement(r.Z, { headline: S, onCancel: w, onConfirm: C, testID: "screenNameConfirmationSheet", text: b }) : null, s.createElement(d.Z, { location: a, onSubmit: Z, submitDisabled: !L, title: f }, s.createElement(l.Z, { onScreenNameChanged: y })));
                },
                w = g(E);
        },
        650667: (e, t, n) => {
            ...
            class x extends s.Component {
                ...
                render() {
                    ...
                    return s.createElement(l.Z, { history: t, title: w }, s.createElement(c.Z, { fetchStatus: e, onRequestRetry: this._handleFetchSettings, render: this._render }));
                }
            }
            const v = S(x);
        },
        ...
        996703: (e, t, n) => {
            ...
            const w = (e, t) => {
                ...
                C = (0, S.Z)()
                    .propsFromState(() => ({ fetchStatus: b.UD, session: w }))
        ...
        972934: (e, t, n) => {
            ...
            class u extends s.PureComponent {
                ...
                _renderDeviceIcon() {
                    const { session: e } = this.props;
                    return s.createElement(h.Z, { deviceType: e.icon_type });
                }
                _renderDeviceName() {
                    const { session: e } = this.props;
                    return e.name;
        ...
        371590: (e, t, n) => {
            ...
            function v({ isSubscriber: e }) {
                ...
                return s.createElement(o.Z, { disabled: d, onPress: h, role: "button", style: A.root, testID: "manage_creator_subscriptions", withInteractiveStyling: !0 }, s.createElement(r.Z, { style: A.contentContainer }, s.createElement(r.Z, { style: A.thumbnailContainer }, s.createElement(p.default, null)), s.createElement(r.Z, { style: A.content }, s.createElement(i.ZP, null, L), s.createElement(i.ZP, { color: "gray700", size: "subtext2" }, T)), d ? s.createElement(c.Z, null) : null, s.createElement(u.default, { style: A.icon })));
            }
        ...
        703178: (e, t, n) => {
            ...
            var s = n(202784),
                ...
                w = n(991851);
            const C = (0, S.Z)()
                    .propsFromState(() => ({ placeTrendsLocations: w.YQ, placeTrendsLocationsFetchStatus: w.IZ, placeTrendsSettings: w.oo, woeTrendsLocations: w.SN, woeTrendsLocationsFetchStatus: w.Qy, woeTrendsLocationSettings: b.um }))
            ...
            class I extends s.Component {
                    ...
                    super(e, t),
                        ...
                        (this._renderWoeLocations = () => {
                            ...
                            return s.createElement(
                                r.Z,
                                null,
                                s.createElement(r.Z, { style: F.searchBox }, s.createElement(a.Z, { Icon: l.default, autoFocus: !1, onChange: this._handleInputChange, onClear: this._handleInputClear, placeholder: D, value: this.state.query, withClearButton: !0 })),
                                s.createElement(
                                    r.Z,
                                    null,
                ...
                render() {
                    ...
                    return s.createElement(u.Z, { backButtonType: "back", backLocation: "/settings/trends", history: e, title: v }, this._usePlaceTrendLocations ? s.createElement(s.Fragment, null, s.createElement(a.Z, { Icon: l.default, autoFocus: !1, onChange: this._handleInputChange, onClear: this._handleInputClear, placeholder: D, style: F.searchBox, testID: Z, value: this.state.query, withClearButton: !0 }), s.createElement(p.Z, { "aria-label": A, fetchStatus: t, onRequestRetry: this._handleRetry, render: this._renderScroller })) : s.createElement(p.Z, { "aria-label": A, fetchStatus: n, onRequestRetry: this._handleRetry, render: this._renderWoeLocations }));
                }
            }
            I.contextType = _.rC;
        ...
        451735: (e, t, n) => {
            ...
            var s = n(202784),
                ...
                w = n(991851);
            const C = (0, S.Z)()
                    .propsFromState(() => ({ allSettings: b.l4, placeTrendSettings: w.oo, placeTrendSettingsFetchStatus: w.JH }))
            ...
            class G extends s.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderWoeContent = () => {
                            ...
                            return s.createElement(r.Z, null, s.createElement(a.Z, { checked: e, helpText: I, label: A, name: "personalized_trends", onChange: this._handleItemChanged }), !e && s.createElement(r.Z, null, s.createElement(o.Z, null), s.createElement(i.Z, { description: n, label: z, link: M })));
                        }),
                        ...
                        (this._renderPlaceContent = () => {
                            ...
                            return s.createElement(r.Z, null, h && s.createElement(s.Fragment, null, s.createElement(o.Z, null), s.createElement(c.Z, { text: R }), s.createElement(a.Z, { checked: t[O], helpText: B, label: D, name: O, onChange: this._handleItemChanged })), s.createElement(c.Z, { text: v }), s.createElement(a.Z, { checked: t[W], helpText: x, label: k, name: W, onChange: this._handleItemChanged, testID: Z }), !t[W] && s.createElement(r.Z, null, s.createElement(i.Z, { description: l, label: U, link: p, testID: y })), d && s.createElement(s.Fragment, null, s.createElement(o.Z, null), s.createElement(c.Z, { text: H }), s.createElement(a.Z, { checked: t[j], helpText: F, label: A, name: j, onChange: this._handleItemChanged })));
                        });
                }
                componentDidMount() {
                ...
                _renderPolicySection() {
                    return s.createElement(r.Z, null, s.createElement(o.Z, null), s.createElement(c.Z, { text: N }), s.createElement(m.b, { label: V, link: this._policySectionUrl }));
                }
            }
            G.contextType = _.rC;
            const Q = C(G);
        ...
        609848: (e, t, n) => {
            ...
            class A extends s.Component {
                ...
                componentDidUpdate(e) {
                    e.fetchStatus === S.ZP.LOADED && this.props.fetchStatus === S.ZP.NONE && this._makeFetch();
                }
                _renderPasswordPrompt() {
                    const { titleHeader: e } = this.props,
                        { passwordError: t } = this.state,
                        n = s.createElement(a.ZP, { link: { pathname: (0, o.ju)("https://x.com/i/flow/password_reset"), external: !0, openInSameFrame: !0 } }, k);
                    return s.createElement(s.Fragment, null, e ? s.createElement(i.Z, { text: e }) : null, s.createElement(r.Z, { style: [E.Z.viewItem, E.Z.bottomBorder] }, s.createElement(a.ZP, { color: "gray700", size: "subtext2" }, P)), s.createElement(c.Z, { errorText: t, helperText: n, invalid: !!t, label: T, name: "current_password", onChange: this._handleChange, onSubmitEditing: this._handlePasswordSubmit, type: "password", value: this.state.password }), s.createElement(l.Z, { style: D.buttonContainer }, s.createElement(d.ZP, { disabled: !1, onPress: this._handlePasswordSubmit, style: D.button, type: "brandFilled" }, x)));
                }
                render() {
                    const { fetchStatus: e, location: t, render: n } = this.props,
                        { verificationRequired: r } = this.state,
                        a = e === S.ZP.FAILED && r;
                    return s.createElement(s.Fragment, null, a ? (this._passwordlessSsoEnabled ? s.createElement(b.Z, { to: { pathname: "/i/flow/verify_account_ownership", state: { input: { requested_variant: t.pathname } } } }) : this._renderPasswordPrompt()) : s.createElement(_.Z, { fetchStatus: e, onRequestRetry: this._handleFetch, render: n }));
                }
            }
