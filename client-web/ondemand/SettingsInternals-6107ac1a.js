    ...
    ["ondemand.SettingsInternals-6107ac1a", "icons/IconAward-js", "icons/IconDeviceTv-js", "icons/IconFeedback-js", "bundle.UserFollowLists-bc6ccf4c"],
    {
        ...
        723587: (e, t, n) => {
            ...
            const S = r().ee05e96b,
                ...
                M = ({ "aria-describedby": e, buttonType: t, disabled: n, displayMode: l, id: o, isSuperFollowEligible: a, isSuperFollowing: r, isTransparent: s, name: d, onSuperFollow: c, onUnSuperFollow: p, size: m, style: h, testID: g }) => {
                    const f = i.useCallback(() => {
                        ...
                        D = i.useCallback(() => {
                            const e = r ? T : a ? S({ followType: L, screenName: d }) : null;
                ...
                q = i.createElement(k.default, null),
                A = r().ddac1f1d,
                $ = r().j8e33c40;
            class G extends i.Component {
                    ...
                    super(e, t),
                        ...
                        (this._getDescribedByText = () => {
                            ...
                            switch (o) {
                                ...
                                case D.topic:
                                case D.list:
                                    i && e.unSuperFollow ? (a = e.unSuperFollow) : t ? (a = n ? H({ followType: e.superFollow, screenName: r }) : E({ followType: e.unfollow, screenName: r })) : t || (a = E({ followType: e.follow, screenName: r }));
                                    break;
                                case D.community:
                                    a = t ? V({ screenName: r }) : E({ followType: e.follow, screenName: r });
                                    break;
                                case D.spaces:
                                    t ? (a = E({ followType: e.unfollow, screenName: r })) : t || (a = E({ followType: e.follow, screenName: r }));
                                    break;
                                default:
                                    a = "";
                            }
                        ...
                        (this._getText = () => {
                            const { buttonText: e, name: t, type: n } = this.props,
                                i = void 0 !== t ? t : "",
                                l = W({ title: t }),
                                o = { [D.user]: { ariaFollowName: void 0 !== t ? `@${String(t)}` : "", confirmationHeadline: z({ screenName: t }), confirmationSheetText: U }, [D.topic]: { ariaFollowName: i, confirmationHeadline: l, confirmationSheetText: N }, [D.list]: { ariaFollowName: i, confirmationHeadline: l, confirmationSheetText: void 0 }, [D.community]: { ariaFollowName: i, confirmationHeadline: A({ communityName: t }), confirmationSheetText: $ }, [D.spaces]: { ariaFollowName: void 0 !== t ? `@${String(t)}` : "", confirmationHeadline: z({ screenName: t }), confirmationSheetText: U } };
                ...
                render() {
                    const { "aria-describedby": e, buttonIcons: t, disabled: n, displayMode: l, id: o, isFollowed: a, isFollowing: r, isSuperFollowEligible: s, isSuperFollowing: d, isTransparent: c, showRelationshipChangeConfirmation: p, size: m, style: h, testID: g, type: f, withConfirmationSheetText: b } = this.props,
                        { ariaFollowName: y, confirmationHeadline: w, confirmationSheetText: v, followBackLabel: k, followLabel: _, followingLabel: C, superFollowLabel: F, superFollowingLabel: S, unSuperFollowLabel: x, unfollowLabel: L } = this._getText(),
                    ...
                    a && !r && k && (E = k);
                    let H = K;
                    (d || (r && s)) && (d && S ? ((H = P), (E = S)) : s && F && ((H = P), (E = F)));
                    const V = y.length > 0 && void 0 !== E ? H({ followType: E, screenName: y }) : "",
                        z = "primaryFilled";
                    let W, U, N, A;
                    const $ = c ? "brandText" : z,
                    ...
                    f === D.community ? (W = r ? L : _) : f === D.spaces ? ((W = r ? L : _), (U = Q), (N = J)) : d && x ? ((A = I(c)), (W = x)) : r ? ((W = T ? C : L), (U = T ? $ : G), (N = c ? "brandText" : "primaryOutlined"), s && F && ((A = B(c)), (W = F), (N = void 0), (U = void 0))) : ((W = a && k ? k : _), (U = c ? "brandText" : z), (N = c ? "brandText" : z));
                    const X = this._getDescribedById();
                    return i.createElement(i.Fragment, null, i.createElement(u.Z, { "aria-describedby": X, "aria-label": V, buttonDefaultLabel: E, buttonHoverLabel: W, buttonHoverType: U, buttonType: N, confirmationSheetConfirmLabel: L, confirmationSheetHeadline: w, confirmationSheetText: b ? v : void 0, customButtonConfig: A, disabled: n, displayMode: l, icon: M, id: o, onClick: this._handlePress, onHoverOut: this._handleHoverOut, showRelationshipChangeConfirmation: j && p, size: m, style: h, testID: g }), void 0 === e ? this._renderDescribedBy(X) : null);
                }
            }
            const j = G;
            var Q = n(311687);
            ...
            class pe extends i.Component {
                ...
                render() {
                    const { "aria-describedby": e, buttonIcons: t, buttonText: n, buttonType: l, disabled: o, displayMode: a, id: r, isBlocking: s, isFollowRequestSent: d, isFollowed: c, isFollowing: u, isSuperFollowEligible: p, isSuperFollowing: m, isTransparent: h, name: g, onCancelPendingFollow: f, onFollow: b, onSuperFollow: w, onUnSuperFollow: v, onUnblock: k, onUnfollow: _, relationshipMode: C, showRelationshipChangeConfirmation: F, size: S, style: x, testIDs: L, type: T, withConfirmationSheetText: R } = this.props,
                        B = s,
                        I = d,
                        Z = C === le.subscribe && (p || m);
                    return B ? i.createElement(y, { disabled: o, displayMode: a, onUnblock: k, showRelationshipChangeConfirmation: F, size: S, style: x, testID: L?.unblock, userScreenName: g }) : I ? i.createElement(ie, { disabled: o, displayMode: a, onCancelPendingFollow: f, showRelationshipChangeConfirmation: F, size: S, style: x, testID: L?.cancel, userScreenName: g }) : Z ? i.createElement(M, { "aria-describedby": e, buttonType: l, disabled: o, displayMode: a, id: r, isSuperFollowEligible: p, isSuperFollowing: m, isTransparent: h, name: g, onSuperFollow: w, onUnSuperFollow: v, size: S, style: x, testID: m ? L?.manageSubscription : L?.subscribe }) : i.createElement(j, { "aria-describedby": e, buttonIcons: t, buttonText: n, disabled: o, displayMode: a, id: r, isFollowed: c, isFollowing: u, isSuperFollowEligible: p, isSuperFollowing: m, isTransparent: h, name: g, onFollow: b, onSuperFollow: w, onUnSuperFollow: v, onUnfollow: _, showRelationshipChangeConfirmation: F, size: S, style: x, testID: u ? L?.unfollow : L?.follow, type: T, withConfirmationSheetText: R });
                }
                _validateProps() {
            ...
            class k extends l.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: n, badgePip: i, children: o, color: a, isActive: d, isCompact: c, isPillLink: u, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: k, style: C, to: F } = this.props,
                        ...
                        L = d ? d(F) : S?.pathname === x?.pathname,
                        T = f.Z.generate({ backgroundColor: "transparent", color: r.default.theme.colors.text, insetFocusRing: !0 }),
                        R = g ? "medium" : L ? "bold" : "medium";
                    return l.createElement(b.Z, { "aria-label": t, "aria-selected": L, focusable: !!L, interactiveStyles: T, link: x, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? _.pill : _.link, u && L ? _.active : null, c ? (u ? _.compactPill : _.compactLink) : null, p ? _.roundedRect : null, C], withoutInteractiveStyles: g || u }, ({ isFocused: t, isHovered: d }) => l.createElement(s.Z, { style: u && _.flexGrow }, l.createElement(m.ZP, { size: g ? "headline2" : void 0, style: [_.text, { color: this._getTextColor(L, d, g, u) }, c && _.compactText, g && t && _.focusedText], weight: R }, e && l.createElement(e, { style: _.icon }), o, g || u ? null : l.createElement(s.Z, { style: L && [_.border, { backgroundColor: r.default.theme.colors[a] }] })), n ? l.createElement(h.Z, { count: n, standalone: !0, style: [_.badge, n >= 10 && _.multiDigitBadge, n >= 20 && _.truncatedCountBadge], truncatedCountFormatter: v, unreadCountLabel: y, withBorder: !1 }) : i ? l.createElement(h.Z, { pip: !0, standalone: !0, style: _.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-6107ac1a.17c2fcba.js.map
