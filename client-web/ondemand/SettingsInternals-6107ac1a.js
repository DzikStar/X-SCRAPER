    ...
    ["ondemand.SettingsInternals-6107ac1a", "icons/IconDeviceLaptop-js", "icons/IconDevicePhone-js"],
    {
        ...
        779610: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                c = n(392237);
            const d = (e) => {
                    const { decoration: t, description: n, disabled: d = !1, isActive: p = !1, label: m, link: h, onPress: g, paddingHorizontal: f, renderRightContent: y, role: b = "tab", styleOverride: v, testID: k = "pivot", thumbnail: _, thumbnailSize: C, withoutArrow: w = !1 } = e,
                        x = [u.thumbnailContainer, "medium" === C && u.thumbnailContainerMedium],
                        E = "string" == typeof m ? r.createElement(l.ZP, null, m) : m,
                        S = "object" == typeof h && h.external && !h.openInSameFrame,
                        Z = n ? ("string" == typeof n ? r.createElement(l.ZP, { color: "gray700", size: "subtext2", testID: `${k}-description` }, n) : n) : null,
                        R = r.useMemo(() => ("space0" === f ? { paddingHorizontal: 0 } : { paddingHorizontal: f ? c.default.theme.spaces[f] : c.default.theme.componentDimensions.gutterHorizontal }), [f]);
                    return r.createElement(s.Z, { "aria-selected": "tab" === b ? p : null, disabled: d, link: d ? void 0 : h, onPress: g, role: b, style: [u.root, R, d && u.disabled, v], testID: k, withInteractiveStyling: !!h || !!g }, r.createElement(a.Z, { style: u.contentContainer }, _ ? r.createElement(a.Z, { style: x }, _) : null, r.createElement(a.Z, { style: u.content }, E, Z), y ? y() : null, (!h && !g) || d || w ? null : S ? r.createElement(i.default, { style: u.icon }) : r.createElement(o.default, { style: u.icon })), t);
                },
            ...
            class o extends r.Component {
                ...
                render() {
                    const { description: e, learnMoreLabel: t, learnMoreLink: n } = this.props,
                        i = l.root;
                    return t && n ? r.createElement(a.ZP, { color: "gray700", size: "subtext2", style: i }, e, " ", this._renderLearnMore()) : r.createElement(a.ZP, { color: "gray700", size: "subtext2", style: i }, e);
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-6107ac1a.c37b7e0a.js.map
