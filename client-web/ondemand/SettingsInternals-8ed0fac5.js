...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.SettingsInternals-8ed0fac5"],
    {
        ...
        296196: (e, t, s) => {
                ...
                switch (t.type) {
                    ...
                    case h.SUCCESS: {
                        const { query: s } = t.meta || {},
                            ...
                            u = { ...e.searchResults, [s]: { ...i, lastCursor: r?.cursor, conversationIds: d, error: o, fetchStatus: l.ZP.LOADED } };
                ...
                P =
                    ...
                    (t, s, { api: r }) => {
                        const n = s(),
                            ...
                            f = !!S;
                        S && c && o && (l.cursor = S);
                        const I = E._O(t, { params: l, request: r.withEndpoint(u.Z).search }),
                            C = (e) => {
                                if (e && e.result) {
                        ...
                        return !T || T?.error || a || (o && f) ? I({ actionTypes: h, context: "SEARCH", meta: { query: l.query, cursor: l.cursor, preserveResults: a, fetchNextPage: o } }, C) : (t({ type: "rweb/directMessages/SEARCH_SUCCESS", payload: { result: T }, meta: { query: c, cursor: S } }), Promise.resolve());
                    },
                N =
                    (e) =>
                    (t, s, { featureSwitches: r, userPersistence: n }) => {
                        ...
                        return n.get(T).then((s) => {
                            ...
                            return !r.includes(e) && r.push(e), r.length > o && r.shift(), t(I(r)), n.set(T, { recentSearches: r });
                        });
                    },
                g =
                    (e) =>
            ...
            var F = s(923965);
            const v = (0, r.UY)({ conversations: o.ZP, entries: a.ZP, inbox: i.ZP, search: R, updates: F.ZP });
            n.Z.register({ [_.Yf]: v });
            const Z = v;
        },
        806528: (e, t, s) => {
            s.d(t, { Bz: () => d, ZW: () => p, ey: () => E, fw: () => i, iG: () => S, wM: () => c });
            var r = s(499627),
                n = s(341276);
            const o = "geoLocation",
            ...
            const i = (e) => e[o],
                ...
                E = (e) => ({ payload: e, type: u }),
                l = "rweb/geoLocation/SET_POSITION",
                S = () => (e, t) =>
                    _()
                        .then((t) => e({ payload: t, type: l }))
                        .catch((t) => (e(E(n.S.denied)), Promise.reject(t))),
        ...
        642721: (e, t, s) => {
            s.d(t, { $o: () => L, AE: () => v, Lk: () => O, R_: () => Z, UD: () => C, UK: () => m, WW: () => I, ck: () => b, fd: () => f, kM: () => F, mz: () => A, xZ: () => D });
            var r = s(745978),
                n = s(499627),
                o = s(917799),
                a = s(312771);
            const i = "mutedKeywords",
                ...
                d = 6048e5,
                u = `rweb/${i}`,
                E = o.dg(u, "FETCH_DISCOURAGED_KEYWORDS"),
                l = o.dg(u, "FETCH_MUTED_KEYWORDS"),
                S = o.dg(u, "ADD_MUTED_KEYWORD"),
                p = o.dg(u, "DELETE_MUTED_KEYWORD"),
                _ = o.dg(u, "UPDATE_MUTED_KEYWORD"),
            ...
            const f = (e) => e[i].discouragedKeywords,
                    ...
                    (e, t, { userPersistence: s }) =>
                        f(t()).length
                            ...
                            : s.get(c, d).then((r) => {
                                  ...
                                  return n && n.length ? (e(w(n)), Promise.resolve()) : e(y()).then(() => s.set(c, { discouragedKeywords: f(t()) }));
                              }),
                y =
                    (e = {}) =>
                    (t, s, { api: n }) =>
                        o._O(t, { params: e, request: n.withEndpoint(r.Z).fetchDiscouragedKeywords })({ actionTypes: E, context: "FETCH_DISCOURAGED_KEYWORDS" }),
                R = `${u}/INIT_DISCOURAGED_KEYWORDS`,
                ...
                P = `${u}/SET_DEFAULT_OPTIONS`,
                N = `${u}/DEFAULT_OPTIONS_LOADED`,
                g = (e) => ({ type: P, payload: { default_options: e } }),
                D =
                    () =>
                    (e, t, { userPersistence: s }) =>
                ...
                F =
                    (e) =>
                    (t, s, { userPersistence: r }) => (t(g(e)), r.set(c, { defaultOptions: e })),
                v =
                    (e) =>
                    (t, s, { api: n }) =>
        ...
        450476: (e, t, s) => {
            ...
            const i = "notificationFilters",
                ...
                u = Object.freeze({ REQUEST: "rweb/notificationFilters/ENABLE_NOTIFICATION_FILTER_REQUEST", SUCCESS: "rweb/notificationFilters/ENABLE_NOTIFICATION_FILTER_SUCCESS", FAILURE: "rweb/notificationFilters/ENABLE_NOTIFICATION_FILTER_FAILURE" }),
                E = Object.freeze({ REQUEST: "rweb/notificationFilters/DISABLE_NOTIFICATION_FILTER_REQUEST", SUCCESS: "rweb/notificationFilters/DISABLE_NOTIFICATION_FILTER_SUCCESS", FAILURE: "rweb/notificationFilters/DISABLE_NOTIFICATION_FILTER_FAILURE" }),
            ...
            const S = (e) => e[i].notificationFilters,
                ...
                h =
                    ...
                    (t, s, { api: n, userPersistence: a }) =>
                        o
                            .AB(t, { params: { [e]: !0 }, request: n.withEndpoint(r.Z).updateNotificationFilters })({ actionTypes: u, context: "ACTION_ENABLE_NOTIFICATION_FILTER", meta: { filterName: e } })
                            .then((e) => {
                                a.set(c, S(s()));
                            }),
                f =
                    ...
                    (t, s, { api: n, userPersistence: a }) =>
                        o
                            .AB(t, { params: { [e]: !1 }, request: n.withEndpoint(r.Z).updateNotificationFilters })({ actionTypes: E, context: "ACTION_DISABLE_NOTIFICATION_FILTER", meta: { filterName: e } })
                            .then((e) => {
                                a.set(c, S(s()));
                            });
        },
        694180: (e, t, s) => {
            ...
            const c = {},
                ...
                E = (0, r.Z)([o.dx.IMPRESSION, o.dx.DWELL]),
                l = (0, r.Z)([o.AJ.TREND_VIEW, o.AJ.SPOTLIGHT_IMPRESSION]),
                S = (e) => ({ payload: { eventKey: e }, type: u });
                ...
                _ =
                    ...
                    (t, s, { api: r }) => {
                        const { event: o, impression_id: a, promoted_trend_id: c } = e,
                            u = `trend-${c}-${o}`;
                        if (l.has(o) && p(s(), u)) return Promise.resolve();
                        const E = { promoted_trend_id: c, event: o, impression_id: a };
                        return (0, i._O)(t, { params: E, request: r.withEndpoint(n.Z).log })({ actionTypes: d, context: "APP_PROMOTED_CONTENT_LOG", meta: E }, (e, t) => {
                            if (!t && l.has(o)) return [S(u)];
                        });
                    },
                T =
                    ({ disclosureType: e, itemId: t, itemType: s, params: r }) =>
                    (o, a, { api: c }) => {
                        const { event: u, impression_id: l } = r,
                            _ = `${s}-${t ?? "undefined"}-${l ?? "undefined"}-${u ?? "undefined"}`;
                        if (E.has(u) && p(a(), _)) return Promise.resolve();
        ...
        204744: (e, t, s) => {
            s.d(t, { DI: () => C, H$: () => l, OB: () => A, Ww: () => u, YB: () => E, hj: () => T, qF: () => f });
            s(901951);
            var r = s(499627),
                n = s(390387);
                ...
                (s, d, { api: u, featureSwitches: E }) =>
                    s(c.ZP.mute(e, t)).then(() => {
                        const t = d(),
                            ...
                            u = (0, n._h)(d()),
                            E = u ? [(0, a.ZP)({ useLatest: !1, userId: u }).removeTweets(c), (0, a.ZP)({ useLatest: !0, userId: u }).removeTweets(c)] : [],
                            l = (0, i.k9)();
        ...
        123072: (e, t, s) => {
            ...
            const c = "safeSearch",
                d = `rweb/${c}`,
                u = o.dg(d, "FETCH_SEARCH_SETTINGS"),
                E = o.dg(d, "UPDATE_SEARCH_SETTINGS"),
            ...
            const S = (e) => e[c].searchSettings,
                ...
                _ =
                    ...
                    (e, t, { api: s }) => {
                        const n = i.x0(t());
                        if (!n) return Promise.resolve(e({ type: u.FAILURE }));
                        return o._O(e, { params: { userId: n }, request: s.withEndpoint(r.Z).fetch })({ actionTypes: u, context: "FETCH_SEARCH_SETTINGS" });
                    },
                T =
                    (e, t) =>
                    (s, n, { api: a }) => {
                        const c = n(),
                            d = i.x0(c);
                        if (!d) return Promise.resolve(s({ type: u.FAILURE }));
                        const l = { ...S(c), userId: d };
                        l[e] = t;
                        return o.AB(s, { params: l, request: a.withEndpoint(r.Z).set })({ actionTypes: E, context: "ACTION_UPDATE_SEARCH_SETTINGS", meta: { settingName: e, settingValue: t } });
                    };
        },
        853568: (e, t, s) => {
            s.d(t, { U: () => r });
        ...
        715684: (e, t, s) => {
            ...
            var r = s(24949),
                ...
                c = s(917799),
                d = s(312771);
            const u = `${s(291020).Y}/sessions`,
                E = `rweb/${u}`,
                l = c.dg(E, "FETCH_SESSIONS"),
                S = c.dg(E, "REVOKE_SESSION"),
                p = c.dg(E, "REVOKE_ALL_SESSIONS"),
        ...
        948985: (e, t, s) => {
            ...
            const h = {
                ...
                f = (0, u.ZP)({ namespace: "applications", customActions: h });
            ...
            const I = E.Z.register(f),
                ...
                O =
                    ...
                    (s, r, { api: n }) => {
                        const o = r();
                        return f.selectAppsById(o, e).length > 0 ? Promise.resolve() : s(m(t));
                    },
                m =
                    (e) =>
                    (t, s, { api: r }) =>
        ...
        116635: (e, t, s) => {
            ...
            const c = `${i.Y}/contacts`,
                d = `rweb/${i.Y}`,
                u = (0, o.dg)(d, "FETCH_ADDRESS_BOOK"),
                E = { cursor: null, contacts: [], fetchStatus: a.ZP.NONE };
            n.Z.register({
                [c]: function (e = E, t) {
                    if (!t) return e;
                    let s;
            ...
            const l = (e) => e[c].contacts,
                ...
                T =
                    (e) =>
                    (t, s, { api: n }) =>
                        (0, o._O)(t, { request: n.withEndpoint(r.Z).fetchAddressBook, params: e })({ actionTypes: u, context: "FETCH_ADDRESS_BOOK" });
        },
        558477: (e, t, s) => {
            s.d(t, { Z: () => u });
            var r = s(226395),
        ...
        823647: (e, t, s) => {
            ...
            const c = `${s(291020).Y}/email_notifications`,
                d = `rweb/${c}`,
                u = o.dg(d, "FETCH_EMAIL_NOTIFICATIONS"),
                E = o.dg(d, "UPDATE_EMAIL_NOTIFICATIONS"),
            ...
            const p = (e) => e[c].fetchStatus,
                ...
                h =
                    ...
                    (e, t, { api: s }) => {
                        const n = i.x0(t());
                        return o._O(e, { params: { userId: n }, request: s.withEndpoint(r.Z).fetch })({ actionTypes: u, context: "FETCH_EMAIL_NOTIFICATIONS" });
                    },
                f =
                    (e) =>
                    (t, s, { api: n }) => {
                        const a = i.x0(s());
                        return o.AB(t, { params: { userId: a, settings: e }, request: n.withEndpoint(r.Z).update })({ actionTypes: E, context: "UPDATE_EMAIL_NOTIFICATIONS", meta: e });
                    };
        },
        446418: (e, t, s) => {
            ...
            const c = "loginVerification",
                d = "U2fSecurityKey",
                u = { REQUEST: "rweb/settings/loginVerification/FETCH_LOGIN_VERIFICATION_SETTINGS_REQUEST", SUCCESS: "rweb/settings/loginVerification/FETCH_LOGIN_VERIFICATION_SETTINGS_SUCCESS", FAILURE: "rweb/settings/loginVerification/FETCH_LOGIN_VERIFICATION_SETTINGS_FAILURE" },
                E = { REQUEST: "rweb/settings/loginVerification/DELETE_SECURITY_KEY_REQUEST", SUCCESS: "rweb/settings/loginVerification/DELETE_SECURITY_KEY_SUCCESS", FAILURE: "rweb/settings/loginVerification/DELETE_SECURITY_KEY_FAILURE" },
            ...
            const _ = (e) => e[c],
                ...
                h =
                    ...
                    (e, t, { api: s, featureSwitches: n }) => {
                        const a = i.x0(t());
                        return (0, o._O)(e, { params: { userId: a }, request: s.withEndpoint(r.Z).fetchLoginVerificationSettings })({ actionTypes: u, context: "FETCH_LOGIN_VERIFICATION_SETTINGS" });
                    },
                f =
                    (e) =>
                    (t, s, { api: n }) =>
                ...
                I =
                    ({ securityKeyId: e }) =>
                    (t, s, { api: n }) =>
                        (0, o._O)(t, { request: n.withEndpoint(r.Z).disable2FAMethod, params: { methodId: e } })({ actionTypes: E, context: "DELETE_SECURITY_KEY", meta: { securityKeyId: e } }),
                C =
                    () =>
                    (e, t, { api: s }) =>
        ...
        618448: (e, t, s) => {
            ...
            const u = (e) => e[i].temporaryPassword,
                E = (e) => e[i].fetchStatus,
                l =
                    () =>
                    (e, t, { api: s }) =>
        ...
        673110: (e, t, s) => {
            ...
            const c = "verifyPassword",
                d = `rweb/${i.Y}/${c}`,
                u = (0, o.dg)(d, "VERIFY_PASSWORD"),
                E = { fetchStatus: a.ZP.NONE };
            n.Z.register({
                [c]: function (e = E, t) {
                    if (!t) return e;
                    switch (t.type) {
                        case u.REQUEST:
                            return { ...e, fetchStatus: a.ZP.LOADING };
                        case u.SUCCESS:
                            return { ...e, fetchStatus: a.ZP.LOADED };
                        case u.FAILURE:
                            return { ...e, error: t.payload, fetchStatus: a.ZP.FAILED };
                        default:
                            return e;
            ...
            const l = (e) => e[c].fetchStatus,
                S =
                    (e) =>
                    (t, s, { api: n }) =>
                        (0, o._O)(t, { params: { password: e }, request: n.withEndpoint(r.Z).verifyPassword })({ actionTypes: u, context: "VERIFY_PASSWORD" });
        },
        466380: (e, t, s) => {
            s.d(t, { Z: () => l });
            var r = s(807469),
        ...
        991851: (e, t, s) => {
            ...
            const c = "trends",
                d = "locations",
                u = Object.freeze({ REQUEST: "rweb/trends/placeTrendsLocations/FETCH_TRENDS_LOCATIONS_REQUEST", SUCCESS: "rweb/trends/placeTrendsLocations/FETCH_TRENDS_LOCATIONS_SUCCESS", FAILURE: "rweb/trends/placeTrendsLocations/FETCH_TRENDS_LOCATIONS_FAILURE" }),
                E = Object.freeze({ REQUEST: "rweb/trends/woeTrendsLocations/FETCH_TRENDS_LOCATIONS_REQUEST", SUCCESS: "rweb/trends/woeTrendsLocations/FETCH_TRENDS_LOCATIONS_SUCCESS", FAILURE: "rweb/trends/woeTrendsLocations/FETCH_TRENDS_LOCATIONS_FAILURE" }),
            ...
            const S = (e) => e[c][d].placeTrendsLocations,
                ...
                h =
                    (e) =>
                    (t, s, { api: r }) =>
                        a._O(t, { params: e, request: r.withEndpoint(o.Z).fetchPlaceTrendsLocations })({ actionTypes: u, context: "FETCH_TRENDS_LOCATIONS" }),
                f =
                    () =>
                    (e, t, { api: s }) =>
                ...
                I =
                    () =>
                    (e, t, { api: s }) =>
                        a._O(e, { params: {}, request: s.withEndpoint(o.Z).fetchWoeTrendsLocations })({ actionTypes: E, context: "FETCH_TRENDS_LOCATIONS" });
            var C = s(401388),
                A = s(390387),
                O = s(371493);
            const m = "settings",
            ...
            const L = (e) => e[c][m] && e[c][m].settings,
                ...
                P = () => (e, t) => (U(t()) === i.ZP.LOADED ? Promise.resolve() : e((e, t, { api: s }) => (A.Qb(t()) ? a._O(e, { request: s.withEndpoint(o.Z).fetchPlaceTrendSettings })({ actionTypes: R, context: "FETCH_TRENDS_SETTINGS" }) : Promise.resolve()))),
                N =
                    (e) =>
                    (t, s, { api: r }) => {
        ...
        336429: (e, t, s) => {
            ...
            const d = (e, t = {}) => {
                ...
                E = (e, t, s) => ({ globalObjects: t, timeline: { responseObjects: s, instructions: e.length ? [{ type: a.Z.AddEntries, parameters: { entries: e } }] : [] } }),
                l = { feedbackActions: {} },
                S = (e) =>
                    (0, n.Z)({
        ...
        371493: (e, t, s) => {
            s.d(t, { $N: () => I, G0: () => f, Jj: () => C, O9: () => p, S: () => _, fy: () => T, jz: () => A, nm: () => h, qk: () => E, uI: () => l });
            var r = s(912021),
                n = s(644829),
                o = s(740527),
                a = s(750085),
            ...
            const p = ({ contentType: e, displayLocation: t, exploreGraphQLEnabled: s = !1, focalTweetId: r, includePageConfiguration: a = !1, initialTabId: i, profileUserId: u }) => {
                ...
                h = (0, r.Z)((e) => p({ exploreGraphQLEnabled: e, contentType: u.Trends })),
                f = (0, r.Z)((e) => p({ exploreGraphQLEnabled: e, displayLocation: E.WebSidebar })),
                I = () => (e, t) =>
                    e(
                        (0, i.CY)(t())
            ...
            const d = "search-",
                ...
                _ = ({ query: e, searchMode: t = o.N3.Top, querySource: s, searchFilters: a, vertical: i, urtEndpointOptions: p, searchTimelinesGraphQLEnabled: _ }) => {
                    const T = S(s),
                        ...
                        f = h ? "-pf" : "",
                        I = a && a.locationFilter && !e.includes(u) ? `${e}${u}` : e,
                        C = { timelineId: `${d}${I}-${t}${T}${f}`, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchSearch, getEndpointParams: (e) => ({ ...p?.requestParams, q: I, social_filter: h, vertical: i, ...l[t], ...e }) }, context: "FETCH_SEARCH_TIMELINE", perfKey: "search", staleIntervalMs: t === o.N3.Live ? 5e3 : void 0, timelineType: "search" };
                    if (_) {
                        const e = h && !I.includes(E) ? `${I}${E}` : I,
                            a = ((e) => {
                                switch (e) {
                                    case o.N3.Image:
                                        return "Photos";
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-8ed0fac5.c61bc51a.js.map
