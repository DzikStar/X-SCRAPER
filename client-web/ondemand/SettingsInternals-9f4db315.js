            ...
            const b = "block",
                ...
                E = (0, p.M)((e) => {
                    ...
                    S.followed_by &&
                        ...
                        x.push((0, u.op)({ blockAction: (e) => P(e, r), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: b, unblockAction: (e) => P(e, C), user: S })),
                        x.push({
                            Icon: i.default,
                            onClick: () => {
                                a(), E();
        ...
        980407: (e, t, r) => {
            ...
            class h extends n.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: r, backLocation: s, centerTitle: a, hideBackButton: l, history: i, isFullWidth: u, isLarge: m, middleControl: h, onBackClick: b, rightControl: g, secondaryBar: f, subtitle: _, title: y } = this.props,
                                { isModal: Z } = this.context;
                            return n.createElement(o.Z, { style: Z ? [p.childViewAppBarRoot, p.appBarZindex] : p.appBarZindex }, n.createElement(d.ZP, { backButtonType: r || (Z ? "close" : "back"), backLocation: s, centerTitle: a, fixed: !Z, hideBackButton: l, history: i, isFullWidth: u, isLarge: m, middleControl: h, onBackClick: b, ref: e, rightControl: g, secondaryBar: f, style: [Z && p.appBarModal, t], subtitle: _, title: y, titleDomId: c.Q_ }));
                        }),
                ...
                render() {
                    ...
                    return n.createElement(i.Z, null, n.createElement(u.Z.Configure, { documentTitle: l, headerless: !0, title: b }), n.createElement(o.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [p.root, f && p.rootModal] }, !f && _, n.createElement(s.Z, { isFullWidth: c, isLarge: d, style: [p.container, f && p.containerModal, a] }, f ? n.createElement(m.Z, { style: p.viewport }, _, r) : r), t ? n.createElement(o.Z, { style: [p.bottomBarModal, !f && !g && p.bottomBarMobile] }, n.createElement(s.Z, { isFullWidth: c, isLarge: d }, t)) : null));
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-9f4db315.70a2b8ca.js.map
