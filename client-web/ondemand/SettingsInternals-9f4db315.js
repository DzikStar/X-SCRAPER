            ...
            const m = "block",
                ...
                S = (0, p.M)((e) => {
                    ...
                    E.followed_by &&
                        ...
                        T.push((0, u.op)({ blockAction: (e) => k(e, n), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: u.SC.FOLLOWERS_LIST, testID: m, unblockAction: (e) => k(e, P), user: E })),
                        T.push({
                            Icon: l.default,
                            onClick: () => {
                                o(), S();
                    ...
                    const I = T.map(({ Icon: e, onClick: t, testID: n, text: r }) => ({ text: r, onClick: t, Icon: e, testID: n }));
                    return r.createElement(i.Z, { items: I, onCloseRequested: o });
                });
        },
        811105: (e, t, n) => {
            "use strict";
        ...
        507651: (e, t, n) => {
            ...
            const l = (e) => {
                    const t = (0, i.useHistory)(),
                        { isCompact: n, ...l } = e;
                    return s.createElement(o.Z, (0, r.Z)({}, l, { isCompact: n || (0, a.HD)(t) }));
                },
                c = s.memo(l);
        },
        293988: (e, t, n) => {
            ...
            class q extends r.Component {
                ...
                render() {
                    const { buttonType: e, isLoggedIn: t, isSuperFollowSubscriptionEnabled: n, isTransparent: o, relationshipMode: a, showRelationshipChangeConfirmation: l, size: c, style: d, user: u, userId: _ } = this.props,
                        ...
                        b = u?.screen_name,
                        w = b ? `/${b}` : "",
                        y = { follow: Z(_), unfollow: E(_), cancel: I(_), block: T(_), unblock: k(_), subscribe: U(_), manageSubscription: A(_) },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-9f4db315.e8938dfa.js.map
