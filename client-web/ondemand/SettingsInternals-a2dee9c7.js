                                        ...
                                        selections: [
                                            {
                                                ...
                                                selections: [
                                                    ...
                                                    { kind: "InlineFragment", selections: [a, { alias: null, args: null, concreteType: "UserVerificationInfo", kind: "LinkedField", name: "verification_info", plural: !1, selections: [r, s, l, (c = { alias: null, args: null, kind: "ScalarField", name: "id", storageKey: null }), o], storageKey: null }, c], type: "User", abstractKey: null },
                                                ],
                                                storageKey: null,
                                            },
                                            c,
        ...
        786033: (e, t, n) => {
            ...
            var i,
                ...
                o = {
                    ...
                    kind: "Request",
                    operation: { argumentDefinitions: [a, i, r], kind: "Operation", name: "useIDVerificationSessionUrlMutation", selections: l },
                            ...
                            ? e.graphQL(o(), { count: t?.count, query: t.query, withAttachments: !0, withConversationQueryHighlights: !0, withMessageQueryHighlights: !0, withMessages: !0 }, h).then((e) => {
                                  ...
                                  if (n && "DMMessageSlice" === n?.__typename) {
                                      const e = n?.items,
                                          ...
                                          { entities: c, result: u } = (0, i.Fv)(a, [s.ZP]);
                    ...
                    const t = (0, o.$)(),
                        ...
                        i = ((e, t) => {
                            ...
                            const { __typename: i, facepile: a, topic: r, ...s } = n,
                                o = a && (0, l.Zn)(e, a);
                            return { ...s, topicId: (0, l.S0)(e, r), facepile: o };
                        })(t, e),
                        a = ((e, t) => {
                            const { navBar: n } = t;
                            if (!n) return {};
        ...
        771613: (e, t, n) => {
            ...
            const c = Object.freeze({ GROUP: "GroupDm", ONE_TO_ONE: "OneToOneDm", UNKNOWN: "Unknown" }),
                    ...
                    { message_data: { attachment: { card: l.Z, tweet: { status: o.Z } } } },
                    {
                        processStrategy: (e, t, n) => {
                            ...
                            const p = i?.conversation?.rest_id,
                                ...
                                { card: f, media: y, tweet_results: b, urls_entity: v } = g?.attachments?.[0] || {};
                            if (
                                (f?.legacy && (d = { card: f }),
                                v?.length &&
                                    g.text &&
                                ...
                                const { display_url: n, expanded_url: i, id_str: a, indices: r, url: s } = t || {},
                                ...
                                d = { tweet: { status: { ...b?.result, legacy: { ...b?.result?.legacy, extended_entities: c } }, display_url: n, expanded_url: i, indices: r, url: s, id: a } };
                            }
                            const k = y ? (0, a.m)(y) : null;
                            k && k.type && ("photo" === k.type ? (d = { photo: k }) : "video" === k.type ? (d = { video: k }) : "animated_gif" === k.type && (d = { animated_gif: k }));
                            const w = { affects_sort: o, request_id: c, time: h, type: _, conversation_id: p, message_data: { id: r, text: m || g?.text, entities: g?.entities, recipient_id: g?.recipient_results?.result?.rest_id, sender_id: g?.sender_results?.result.rest_id, attachment: d }, id: r };
                            return (0, s.Z)(w, t, n);
                        },
                ...
                m = new i.fK.Entity(
                    ...
                    {
                        processStrategy: (e, t, n) => {
                            const { id: i, labels: a, legacy: l, perspectival_conversation_metadata: o, rest_id: u, tag: d } = e || {},
                                m = {},
                                _ = [];
                            ...
                            const f = l?.metadata?.conversation_type === c.GROUP ? r.eD.GROUP : r.eD.ONE_TO_ONE,
                                y = { ...l?.perspectival_conversation_metadata, ...l?.metadata, ...o, id: i, conversation_id: u, avatar: p, labels: a, last_readable_event_id: h, type: f, participants: _, users: m, tag: d };
                            return (0, s.Z)(y, t, n);
                        },
        ...
        917009: (e, t, n) => {
            ...
            const o = s().af40a8e0,
                c = (e) => {
                    ...
                    return i.createElement(a.ZP, { "aria-label": t, hoverLabel: { label: o }, icon: i.createElement(l.default, null), link: n, pullRight: !0, type: "primaryText" });
                };
        },
        947135: (e, t, n) => {
            "use strict";
            ...
            class s extends i.Component {
                ...
                render() {
                    ...
                    return i.createElement(i.Fragment, null, i.createElement(a.Z, { align: e, color: t, label: c, onPress: this._handleClick }), this.state.showConfirmation ? i.createElement(r.Z, { confirmButtonLabel: n, confirmButtonType: s, headline: l, onCancel: this._handleCancel, onConfirm: this._handleConfirm, text: o }) : null);
                }
            }
            ...
            const g = "block",
                ...
                w = (0, p.M)((e) => {
                    const { featureSwitches: t } = (0, u.QZ)(),
                        { onBlock: n, onClose: s, onMute: l, onRemoveFollower: p, onReportUser: w, onShare: S, onUnblock: T, onUnmute: F, user: I } = e,
                        C = [],
                        P = (t, n) => {
                    ...
                    I.followed_by &&
                        ...
                        C.push((0, d.op)({ blockAction: (e) => P(e, n), isSoftBlockEnabled: t.isTrue("xprofile_blocked_by_view_enabled"), source: d.SC.FOLLOWERS_LIST, testID: g, unblockAction: (e) => P(e, T), user: I })),
                        C.push({
                            Icon: o.default,
                            onClick: () => {
                                s(), w();
                    ...
                    const Z = C.map(({ Icon: e, onClick: t, testID: n, text: i }) => ({ text: i, onClick: t, Icon: e, testID: n }));
                    return i.createElement(r.Z, { items: Z, onCloseRequested: s });
                });
        },
        811105: (e, t, n) => {
            "use strict";
            ...
            const c = o().c174e46e,
                u = o().a39075ff,
                d = s.default.create((e) => ({ listItem: { display: "list-item", listStyleType: "disc", marginBottom: e.spaces.space12, marginStart: e.spaces.space12 }, scopesHeader: { marginBottom: e.spaces.space12, marginTop: e.spaces.space12 }, toggleMoreLink: { color: e.colors.link, weight: "bold" } })),
                m = (e) => {
                    ...
                    return i.createElement(
                        i.Fragment,
                        null,
                        i.createElement(r.ZP, { style: d.scopesHeader, weight: "bold" }, s),
                        i.createElement(
                            a.Z,
                            { role: "list" },
                        ...
                        p && l ? i.createElement(r.ZP, { onPress: m, style: d.toggleMoreLink }, c) : null,
                        p && !l ? i.createElement(r.ZP, { onPress: m, style: d.toggleMoreLink }, u({ n: t.length - 3 })) : null,
                    );
                };
        },
        534763: (e, t, n) => {
            ...
            function c(e) {
                ...
                return a.createElement(s.Z, (0, i.Z)({}, o, { thumbnail: a.createElement(l, { Icon: t, iconColor: n, testID: r }), thumbnailSize: "large" }));
            }
            function u(e) {
                const { link: t, ...n } = e;
                return a.createElement(s.Z, (0, i.Z)({}, n, { link: { external: !0, pathname: e.link } }));
            }
        },
        864479: (e, t, n) => {
            "use strict";
            ...
            var i = n(807896),
                a = n(202784),
                r = n(771099);
            const s = (e) => (t) => a.createElement(r.$6, null, (n) => a.createElement(e, (0, i.Z)({}, t, { isInSidebar: n })));
        },
        507651: (e, t, n) => {
            "use strict";
            n.d(t, { Z: () => c });
            ...
            const o = (e) => {
                    const t = (0, r.useHistory)(),
                        { isCompact: n, ...o } = e;
                    return a.createElement(s.Z, (0, i.Z)({}, o, { isCompact: n || (0, l.HD)(t) }));
                },
                c = a.memo(o);
        },
        293988: (e, t, n) => {
                ...
                constructor(e) {
                    super(e),
                        (this._renderButton = () => {
                            ...
                            return e ? i.createElement(a.ZP, { "aria-label": y, hoverLabel: { label: v }, icon: i.createElement(l.default, null), onPress: this._handleUnfollow, style: t, type: "primaryOutlined" }) : i.createElement(a.ZP, { "aria-label": f, hoverLabel: { label: b }, icon: i.createElement(o.default, null), onPress: this._handleFollow, style: t, type: "primaryOutlined" });
                        }),
                        (this._handleFollow = () => {
            ...
            class y extends i.Component {
                    ...
                    super(...e),
                        ...
                        (this._handleMuteOrUnmuteToggleHelper = () => {
                            ...
                            return a
                                ? a.muting
                                    ? i(r).then((t) => {
                                          e({ text: (0, l.X6)(a.screen_name) }), this._scribeAction("unmute_user");
                                      }, t(c.G))
                                    : n(r).then((t) => {
                                          e({ text: (0, l.FK)(a.screen_name) }), this._scribeAction("mute_user");
                                      }, t(o.W))
                                : Promise.resolve();
                        });
                }
                render() {
                    ...
                    const t = e.muting ? "destructiveOutlined" : "brandOutlined",
                        n = e.muting ? r.default : s.default,
                        ...
                        return (
                            ...
                            s
                                ? i.createElement(
                                      ...
                                      i.createElement(h, { errorHandler: u(t.errorConfig.options || {}), key: s.fetchKey, retry: _ }, (t, n) => (t ? a({ fetchStatus: p.ZP.FAILED, error: t, data: null, retry: n }) : i.createElement(f, { query: e, queryRef: s, render: a }))),
                                  )
                                : null
                        );
                    };
            ...
            class b extends i.Component {
                ...
                render() {
                    ...
                    return i.createElement(
                        a.Z,
                        null,
                        i.createElement(s.Z, { autoComplete: "off", autoCorrect: !1, errorText: r, invalid: u, label: f, name: "typedScreenName", onChange: this._handleTypedFieldChange, spellCheck: "false", value: this.state.value }),
                    ...
                    super(...e),
                        ...
                        (this._handleUnmuteToggleHelper = () => {
                            ...
                            return a
                                ? a.dm_muting
                                    ? i(r).then((t) => {
                                          e({ text: w({ name: a.name }) }), this._scribeAction("unmute_user");
                                      }, t(u.G))
                                    : n(r).then((t) => {
                                          e({ text: k({ name: a.name }) }), this._scribeAction("mute_user");
                                      }, t(c.W))
                                : Promise.resolve();
                        });
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsInternals-a2dee9c7.3312e69a.js.map
