                        ...
                        y = i.useMemo(
                            () =>
                                u.filter(Boolean).map(({ label: l, viewType: s, ...r }, u) => {
                                    const o = m ? [S.linkRedesign, 0 === u && S.firstLinkRedesign, e && 0 === u && S.withNoPaddingStart] : void 0;
                                    return i.createElement(w, (0, n.Z)({ viewType: s }, r, { isCompact: a, isPillLink: t, isRoundedRect: d, isWebRedesign: m, style: o }), l);
                                }),
                            [e, a, t, d, m, u],
                        );
                    return i.createElement(s.Z, { "aria-label": l, buttonsContainerStyle: t && S.gap, childrenStyle: !m && S.flexGrow, key: g, style: [t ? null : S.segmentedControl, m && S.leftAligned, o], visibleItemIndex: c }, y);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsMonetization-6107ac1a.c869112a.js.map
