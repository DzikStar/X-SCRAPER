    ...
    ["ondemand.SettingsMonetization-6107ac1a"],
    {
        ...
        717626: (e, l, a) => {
            ...
            var n,
                ...
                m = {
                    ...
                    params: { id: "RiK0_QUvm0KSB9p4zmKX7A", metadata: {}, name: "MonetizationAwardsRevenueQuery", operationKind: "query", text: null },
                };
        ...
        967670: (e, l, a) => {
            ...
            var n,
                ...
                c = {
                    ...
                    params: { id: "vdXS8UOf-txo1QARuqMgZQ", metadata: { sliceInfoPath: ["viewer", "user_results", "result", "awards_granted_slice", "slice_info"] }, name: "MonetizationAwardsTransactionsQuery", operationKind: "query", text: null },
                };
        ...
        403556: (e, l, a) => {
            ...
            class b extends i.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": l, badgeCount: a, badgePip: n, children: s, color: r, isActive: u, isCompact: o, isPillLink: c, isRoundedRect: g, isWebRedesign: y, retainScrollPosition: b, style: w, to: T } = this.props,
                        { location: S } = this.state,
                        v = T ? this._getMemoizedLink(T, b) : void 0,
                        L = u ? u(T) : S?.pathname === v?.pathname,
                        R = k.Z.generate({ backgroundColor: "transparent", color: t.default.theme.colors.text, insetFocusRing: !0 }),
                        x = y ? "medium" : L ? "bold" : "medium";
                    return i.createElement(_.Z, { "aria-label": l, "aria-selected": L, focusable: !!L, interactiveStyles: R, link: v, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [c ? f.pill : f.link, c && L ? f.active : null, o ? (c ? f.compactPill : f.compactLink) : null, g ? f.roundedRect : null, w], withoutInteractiveStyles: y || c }, ({ isFocused: l, isHovered: u }) => i.createElement(d.Z, { style: c && f.flexGrow }, i.createElement(p.ZP, { size: y ? "headline2" : void 0, style: [f.text, { color: this._getTextColor(L, u, y, c) }, o && f.compactText, y && l && f.focusedText], weight: x }, e && i.createElement(e, { style: f.icon }), s, y || c ? null : i.createElement(d.Z, { style: L && [f.border, { backgroundColor: t.default.theme.colors[r] }] })), a ? i.createElement(m.Z, { count: a, standalone: !0, style: [f.badge, a >= 10 && f.multiDigitBadge, a >= 20 && f.truncatedCountBadge], truncatedCountFormatter: h, unreadCountLabel: F, withBorder: !1 }) : n ? i.createElement(m.Z, { pip: !0, standalone: !0, style: f.badgePip, textColor: "red500", unreadCountLabel: K, withBorder: !1 }) : null));
                }
            }
            ...
            const f = t.default.create((e) => ({
                ...
                S = ({ alignFirstItem: e, "aria-label": l, isCompact: a, isPillLink: t, isRoundedRect: d, links: u, style: o, visibleItemIndex: c }) => {
                    const g = u
                            .filter(Boolean)
                            .map((e) => e.key)
                            .join("-"),
                        ...
                        y = i.useMemo(
                            () =>
                                u.filter(Boolean).map(({ label: l, viewType: s, ...r }, u) => {
                                    const o = m ? [T.linkRedesign, 0 === u && T.firstLinkRedesign, e && 0 === u && T.withNoPaddingStart] : void 0;
                                    return i.createElement(w, (0, n.Z)({ viewType: s }, r, { isCompact: a, isPillLink: t, isRoundedRect: d, isWebRedesign: m, style: o }), l);
                                }),
                            [e, a, t, d, m, u],
                        );
                    return i.createElement(s.Z, { "aria-label": l, buttonsContainerStyle: t && T.gap, childrenStyle: !m && T.flexGrow, key: g, style: [t ? null : T.segmentedControl, m && T.leftAligned, o], visibleItemIndex: c }, y);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsMonetization-6107ac1a.7a2fc5aa.js.map
