    ...
    ["ondemand.SettingsMonetization-b308cbaf"],
    {
        ...
        315984: (e, t, a) => {
            ...
            const h = d().g1b8020c,
                ...
                v = ({ fetchNext: e, items: t }) => {
                    const a = x();
                    return r.createElement(r.Fragment, null, r.createElement(i.Z, { text: h }), t.length > 0 ? r.createElement(s.Z, { role: "list" }, r.createElement(y.Z, { assumedItemHeight: 68, cacheKey: "recentAwardsList", footer: null, identityFunction: b, items: t, onNearEnd: e, renderer: a, withoutHeadroom: !0 })) : r.createElement(o.ZP, { color: "gray700", style: P.emptyState }, _));
                },
                I = ({ fetchNext: e, items: t }) => {
                    const a = x();
                    return r.createElement(r.Fragment, null, r.createElement(s.Z, { style: P.gap }, r.createElement(m.Z, null)), r.createElement(i.Z, { text: f }), r.createElement(s.Z, { role: "list" }, r.createElement(y.Z, { assumedItemHeight: 68, cacheKey: "awardsList", footer: null, identityFunction: b, items: t, onNearEnd: e, renderer: a, withoutHeadroom: !0 })));
                },
                D = ({ fetchNext: e, slice: t }) => {
                    const a = c()(w, t),
            ...
            const _ = d().f883322d,
                ...
                x = ({ item: e }) => {
                    const t = c()(b, e),
                        ...
                        l = t.created_at_msec,
                        i = n ? (0, f.x)({ amount: n, formatter: 100 }) : r.createElement(h.default, { testID: "icon-minus" });
                    return r.createElement(s.Z, { role: "listitem" }, r.createElement(Z.Z, { style: I.root }, r.createElement(s.Z, { style: I.details }, r.createElement(o.ZP, { color: "gray700", weight: "bold" }, w(new Date(l))), r.createElement(o.ZP, { color: "gray700" }, _({ transactionId: a }))), r.createElement(o.ZP, { color: "green500", weight: "bold" }, i)));
                },
                v = r.memo(x),
                ...
                k = ({ emptyStateDescription: e, items: t }) => r.createElement(r.Fragment, null, r.createElement(i.Z, { text: D }), t.length > 0 ? r.createElement(s.Z, { role: "list" }, t.map(H)) : r.createElement(o.ZP, { color: "gray700", style: C.emptyState }, e)),
                N = ({ fetchNext: e, items: t }) => r.createElement(r.Fragment, null, r.createElement(s.Z, { style: C.gap }, r.createElement(m.Z, null)), r.createElement(i.Z, { text: S }), r.createElement(s.Z, { role: "list" }, r.createElement(g.Z, { assumedItemHeight: 64, cacheKey: "payoutsList", footer: null, identityFunction: z, items: t, onNearEnd: e, renderer: H, withoutHeadroom: !0 }))),
                F = ({ emptyStateDescription: e, fetchNext: t, slice: a }) => {
                    const n = c()(P, a),
                        { otherItems: s, recentItems: l } = (0, y.yD)(n);
                    return r.createElement(r.Fragment, null, r.createElement(k, { emptyStateDescription: e, items: l }), s.length > 0 && r.createElement(N, { fetchNext: t, items: s }));
                },
                T = r.memo(F),
                C = p.default.create((e) => ({ header: { marginHorizontal: e.spaces.space12 }, gap: { marginVertical: e.spaces.space8 }, emptyState: { marginVertical: e.spaces.space12, textAlign: "center" } }));
        },
        839681: (e, t, a) => {
            a.d(t, { Z: () => D });
            var n = a(564018),
            ...
            const h = d().g1b8020c,
                ...
                x = ({ emptyStateDescription: e, fetchNext: t, items: a, type: n }) => {
                    const l = b(n);
                    return r.createElement(r.Fragment, null, r.createElement(i.Z, { text: h }), a.length > 0 ? r.createElement(s.Z, { role: "list" }, r.createElement(y.Z, { assumedItemHeight: 64, cacheKey: "recentSubscribersList", footer: null, identityFunction: w, items: a, onNearEnd: t, renderer: l, withoutHeadroom: !0 })) : r.createElement(o.ZP, { color: "gray700", style: S.emptyState }, e));
                },
                v = ({ fetchNext: e, items: t, type: a }) => {
                    const n = b(a);
                    return r.createElement(r.Fragment, null, r.createElement(s.Z, { style: S.gap }, r.createElement(m.Z, null)), r.createElement(i.Z, { text: f }), r.createElement(s.Z, { role: "list" }, r.createElement(y.Z, { assumedItemHeight: 64, cacheKey: "subscribersList", footer: null, identityFunction: w, items: t, onNearEnd: e, renderer: n, withoutHeadroom: !0 })));
                },
                ...
                D = r.memo(I),
                S = p.default.create((e) => ({ header: { marginHorizontal: e.spaces.space12 }, gap: { marginVertical: e.spaces.space8 }, emptyState: { marginVertical: e.spaces.space12, textAlign: "center" } }));
        },
        822441: (e, t, a) => {
            a.d(t, { Z: () => b });
            var n = a(469363),
            ...
            const h = n.Z,
                ...
                w = ({ item: e, type: t }) => {
                    ...
                    return p && r.createElement(s.Z, { role: "listitem" }, r.createElement(i.Z, { link: u, style: x.root }, "User" === p.__typename ? r.createElement(s.Z, { style: x.user }, r.createElement(E.Z, { size: "xLarge", user: p }), r.createElement(Z.Z, { style: x.userName, user: p, withStackedLayout: !0 })) : r.createElement(o.ZP, null, _), r.createElement(o.ZP, { color: "gray700", style: x.paymentAmount, weight: "bold" }, g)));
                },
                b = r.memo(w),
        ...
        534763: (e, t, a) => {
            ...
            function o(e) {
                ...
                return r.createElement(l.Z, (0, n.Z)({}, i, { thumbnail: r.createElement(c, { Icon: t, iconColor: a, testID: s }), thumbnailSize: "large" }));
            }
            function m(e) {
                const { link: t, ...a } = e;
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsMonetization-b308cbaf.b35c419a.js.map
