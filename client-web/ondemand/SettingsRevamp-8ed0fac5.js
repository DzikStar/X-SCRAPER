...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.SettingsRevamp-8ed0fac5"],
    {
        ...
        685731: (e, t, r) => {
            r.d(t, { Gi: () => T, Mk: () => p, ZV: () => b, aU: () => R, d3: () => l, fS: () => O, pt: () => C });
            r(202784);
            var n = r(674132),
                s = r.n(n),
                a = r(336629),
            ...
            const C = (e, t, r) => (Array.isArray(e) ? e.filter((e) => e.charge_interval === r && e.metadata.purchasable).find((e) => (t ? !0 === e.metadata?.seated : !1 === e.metadata?.seated)) : void 0);
            function T(e, t) {
                if (e && t) return t?.prices?.find((t) => t?.charge_interval === e);
            }
            function l(e, t = !1, r, n = !1, s = !0) {
        ...
        661461: (e, t, r) => {
            ...
            const _ = (e) => e[E].languages,
                ...
                b = () => (e, t) => (t()[E].fetchStatus === c.ZP.LOADED ? Promise.resolve() : e(C())),
                C =
                    () =>
                    (e, t, { api: r }) =>
        ...
        189953: (e, t, r) => {
            r.d(t, { $t: () => ie, A0: () => be, BA: () => re, BS: () => L, CH: () => y, CR: () => $, Cr: () => A, DX: () => Y, Dh: () => T, Dn: () => D, En: () => E, FF: () => M, FV: () => N, Gy: () => w, HF: () => R, IK: () => s, JO: () => V, Jt: () => ne, KH: () => U, L0: () => W, Lc: () => i, OW: () => g, Oj: () => m, P9: () => x, Q_: () => a, Qg: () => k, Qh: () => J, Sv: () => c, TY: () => G, Tv: () => z, UN: () => h, VK: () => o, WK: () => te, Ws: () => u, Xg: () => q, Xi: () => H, Y8: () => S, Yb: () => p, Yf: () => n, Yx: () => d, ZN: () => j, ar: () => B, cA: () => Re, cw: () => ae, dK: () => _, dO: () => l, dZ: () => F, dw: () => de, f1: () => Se, j$: () => Ce, k$: () => K, lQ: () => ee, lh: () => b, li: () => oe, lm: () => C, mq: () => Te, my: () => f, nK: () => P, o$: () => v, px: () => ce, qd: () => Q, ru: () => _e, ub: () => I, vc: () => Z, vi: () => O, wG: () => se, x5: () => X, yB: () => ue, z2: () => Ee });
            const n = "grok",
                ...
                C = Object.freeze({ REQUEST: "rweb/UNPIN_GROK_CONVERSATION/REQUEST", SUCCESS: "rweb/UNPIN_GROK_CONVERSATION/SUCCESS", FAILURE: "rweb/UNPIN_GROK_CONVERSATION/FAILURE" }),
                ...
                l = Object.freeze({ REQUEST: "rweb/GROK_USER_EVENTS_LOG/REQUEST", SUCCESS: "rweb/GROK_USER_EVENTS_LOG/SUCCESS", FAILURE: "rweb/GROK_USER_EVENTS_LOG/FAILURE" }),
                p = "rweb/grok/DELETE_CONVERSATION",
                ...
                K = "rweb/grok/GROK_RESPONSE_DEEPSEARCH_UPDATE",
                ...
                oe = "rweb/grok/SELECT_COMPOSER_MODE",
                ...
                Ce = "rweb/grok/SET_GROK_INPUT_ADVANCED_SETTINGS",
        ...
        231817: (e, t, r) => {
            ...
            const d = `${r(291020).Y}/dm_registered_devices`,
                ...
                C = { fetchStatus: u.ZP.NONE, devices: {} };
            function T(e = C, t) {
                if (!t) return e;
                switch (t.type) {
                    case R.REQUEST:
                    ...
                    case R.SUCCESS:
                        return { ...e, error: null, fetchStatus: u.ZP.LOADED, devices: (0, s.Z)(l(t.payload), (e) => e.registration_token) };
                    case b.SUCCESS:
            ...
            o.Z.register({ [d]: T });
            const l = (e) => e?.public_keys || [],
                p = (e) => e[d].devices,
                O = (0, n.P1)(p, (e) => Object.values(e).sort((e, t) => t.registration_ts - e.registration_ts)),
                U = (e, t) => p(e)[t],
                A = (e) => e[d].fetchStatus,
        ...
        715684: (e, t, r) => {
            ...
            function C(e = b, t) {
                ...
                switch (t.type) {
                    ...
                    case d.SUCCESS:
                        return { ...e, error: null, fetchStatus: E.ZP.LOADED, sessions: (0, s.Z)(l(t.payload), (e) => e.token) };
                    case _.SUCCESS:
            ...
            const l = (e) => (e?.viewer?.user_results?.result?.sessions_list ? e.viewer.user_results.result.sessions_list : e.viewer?.user?.sessions_list ? e.viewer.user.sessions_list : e.sessions ? e.sessions.map(T) : []),
                p = (e) => e[u].sessions,
                O = (0, n.P1)(p, (e) => Object.values(e)),
                U = (e, t) => p(e)[t],
                A = (e) => e[u].fetchStatus,
        ...
        948985: (e, t, r) => {
            ...
            const T = {
                    revokeApplication: {
                        reducer: (e, t) => {
                            if (t.type === l.customActionTypes.revokeApplication.SUCCESS) {
                    ...
                    revokeOauth2Token: {
                        reducer: (e, t) => {
                            if (t.type === l.customActionTypes.revokeOauth2Token.SUCCESS) {
                                const { revoked: r } = t.payload,
                                    { entityId: n } = t.meta,
                                    s = e.entities[n];
                                return { ...e, entities: { ...e.entities, [n]: { ...s, revoked: r } } };
                ...
                l = (0, u.ZP)({ namespace: "applications", customActions: T });
            (l.selectUniqUnrevokedApps = (0, n.P1)(l.selectAll, (e) => {
                const t = Object.values(e).filter((e) => !0 !== e.revoked);
                return (0, s.Z)(t, (e) => e.app_id);
            })),
                (l.selectAppsById = (0, n.P1)(
                    l.selectAll,
                    (e, t) => t,
                    (e, t) => Object.values(e).filter((e) => e.app_id === t),
                ));
            const p = S.Z.register(l),
                O = (e) => e[d].fetchStatus,
                ...
                A =
                    ...
                    (r, n, { api: s }) => {
                        const a = n();
                        return l.selectAppsById(a, e).length > 0 ? Promise.resolve() : r(I(t));
                    },
                I =
                    (e) =>
                    (t, r, { api: n }) =>
        ...
        365265: (e, t, r) => {
            r.d(t, { $B: () => T, F$: () => l, Ne: () => I, RC: () => A, VR: () => p, dF: () => U, h9: () => C, hu: () => h, pC: () => O, qB: () => f, tF: () => b, v1: () => m, xN: () => P });
            var n = r(372551),
                s = r(147595),
                a = r(499627),
                i = r(917799),
            ...
            const b = (e, t) => {
                ...
                p = (e) => e[o].productSubscriptions.fetchStatus,
                ...
                m =
                    () =>
                    (e, t, { api: r }) => {
                        const s = (0, i._O)(e, { params: {}, request: r.withEndpoint(n.Z).fetchProductSubscriptions }),
                            a = p(t());
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsRevamp-8ed0fac5.086348fa.js.map
