...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.SettingsRevamp-8ed0fac5"],
    {
        ...
        928233: (e, t, r) => {
            ...
            const u = async (e, t, { api: r, devicePersistence: n }) => {
                    try {
                        const S = s.x0(t());
                        if (!S) return;
                        await n.delete(c + "" + S);
                        ...
                        let R = await n.get(u);
                        const _ = async () => {
                            const e = (0, i.sM)(await crypto.subtle.exportKey("spki", R.publicKey));
                            await E()(
                                async (t) => {
                                    try {
                                        await n.set(u, R), (await n.get(u)) ? await r.withEndpoint(a.Z).register({ registration_id: Math.round(1e5 * Math.random()), identity_key: e, device_id: R.deviceId }) : t(new Error("Could not set value in IndexedDB. Bailing out."));
                                    } catch (e) {
                                ...
                                await n.set(u, { ...R, isRegistered: !0 });
                        };
                        R || (R = await (0, o.oo)()), R.isRegistered || (await _()), (0, o.W1)(R.privateKey), e(s.Pv(R.deviceId));
                    } catch (e) {
                ...
                _ = async (e, t, { api: r, devicePersistence: n }) => {
                    ...
                    const i = S.deviceId,
                        c = await (0, o.oo)(i);
                    await n.delete(a), await n.set(a, c), await e(u);
                };
        },
        704879: (e, t, r) => {
        ...
        189953: (e, t, r) => {
            r.d(t, { $t: () => se, A0: () => be, BA: () => re, BS: () => p, CH: () => y, CR: () => W, Cr: () => U, DX: () => z, Dh: () => C, Dn: () => f, En: () => i, FF: () => Q, FV: () => m, Gy: () => G, HF: () => _, IK: () => E, JO: () => Y, Jt: () => ne, KH: () => I, L0: () => q, Lc: () => s, OW: () => P, Oj: () => l, P9: () => x, Q_: () => a, Qg: () => k, Qh: () => X, Sv: () => S, TY: () => K, Tv: () => B, UN: () => h, VK: () => o, WK: () => te, Ws: () => c, Xg: () => $, Xi: () => H, Y8: () => d, Yb: () => A, Yf: () => n, Yx: () => u, ZN: () => j, ar: () => V, cA: () => _e, cw: () => ae, dK: () => R, dO: () => T, dZ: () => F, dw: () => ue, f1: () => de, j$: () => Oe, k$: () => M, lQ: () => ee, lh: () => b, li: () => oe, lm: () => O, mq: () => Ce, my: () => g, nK: () => L, o$: () => D, px: () => Se, qd: () => Z, ru: () => Re, ub: () => N, vc: () => v, vi: () => w, wG: () => Ee, x5: () => J, yB: () => ce, z2: () => ie });
            const n = "grok",
                ...
                R = Object.freeze({ REQUEST: "rweb/FETCH_GROK_SHARE/REQUEST", SUCCESS: "rweb/FETCH_GROK_SHARE/SUCCESS", FAILURE: "rweb/FETCH_GROK_SHARE/FAILURE" }),
                ...
                T = Object.freeze({ REQUEST: "rweb/GROK_USER_EVENTS_LOG/REQUEST", SUCCESS: "rweb/GROK_USER_EVENTS_LOG/SUCCESS", FAILURE: "rweb/GROK_USER_EVENTS_LOG/FAILURE" }),
                ...
                M = "rweb/grok/GROK_RESPONSE_DEEPSEARCH_UPDATE",
                ...
                Re = "rweb/grok/UPDATE_PERFORMANCE_METRICS",
        ...
        231817: (e, t, r) => {
            ...
            var n = r(24949),
                ...
                c = r(312771),
                d = r(390387);
            const u = `${r(291020).Y}/dm_registered_devices`,
                R = `rweb/${u}`,
                _ = i.dg(R, "FETCH_REGISTERED_DEVICES"),
                b = i.dg(R, "DEREGISTER_DEVICE"),
            ...
            function C(e = O, t) {
                ...
                switch (t.type) {
                    ...
                    case _.SUCCESS:
                        return { ...e, error: null, fetchStatus: c.ZP.LOADED, devices: (0, E.Z)(T(t.payload), (e) => e.registration_token) };
                    case b.SUCCESS:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsRevamp-8ed0fac5.ce2633ca.js.map
