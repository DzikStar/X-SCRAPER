    ...
    ["ondemand.SettingsRevamp-9f4db315"],
    {
        ...
        6157: (e, t, r) => {
            ...
            function A({ apiClient: e }) {
                return {
                    clearConversations: (t, r) => e.graphQL(s(), {}).then((e) => (e.clear_grok_conversations?.grok_deletion_error?.error_code && (0, i.ZP)("GraphQL clear grok conversations failed."), e)),
                    setPreferences: ({ grokMode: t, grokModelOptionId: r }) => e.graphQL(D(), { grokMode: t, grokModelOptionId: r }).then((e) => (e.set_grok_preferences?.preference_update_error?.error_code && (0, i.ZP)("GraphQL set grok preferences failed."), e)),
        ...
        372551: (e, t, r) => {
            ...
            var n = r(376920),
                ...
                d = r(936961),
                _ = r.n(d);
            const p = ({ apiClient: e, featureSwitches: t }) => ({ fetchSubscriptionProductDetails: (t) => e.graphQL(u(), t).then((e) => e.web_subscription_product_details), fetchSubscriptionProductCheckoutUrl: (t) => e.graphQL(c(), t).then((e) => e.subscriptioncheckoutsession_create_for_blue?.session_url), fetchNotABotCheckoutUrl: (t) => e.graphQL(o(), t).then((e) => e.subscriptioncheckoutsession_create_for_not_a_bot?.session_url), fetchProductSubscriptions: (t) => e.graphQL(a(), t).then((e) => e.viewer_v2?.list_product_subscriptions), switchTier: (t) => e.graphQL(_(), t).then((e) => e) });
        },
        860747: (e, t, r) => {
            "use strict";
            r.d(t, { Z: () => v });
            ...
            const b = u().j087774e,
                ...
                w = ({ user: e }) => {
                    const { featureSwitches: t } = a.useContext(_.rC),
                        ...
                        n = o()(y, e);
                    return r && n.award_eligible ? a.createElement(a.Fragment, null, a.createElement(m.H, { Icon: d.default, description: a.createElement(s.ZP, { color: "gray700", size: "subtext2", style: k.spacing }, a.createElement(f.Z, { revenueType: g.AU.awards_revenue, title: h, user: n })), label: b, link: p.OB.dashboard.root })) : null;
                },
                v = a.memo(w),
        ...
        281629: (e, t, r) => {
            ...
            const _ = ({ disabled: e = !1, formattedPayoutAmount: t, scribeComponent: r, styleOverride: _, ...p }) => {
                    ...
                    return n.createElement(u.Z, { description: x, disabled: e, label: C, link: v, onPress: v ? E : void 0, paddingHorizontal: "space8", styleOverride: _, testID: w, thumbnail: Z });
                },
                p = n.memo(_),
        ...
        794721: (e, t, r) => {
            ...
            const d = l().df29646e,
                _ = n.Z,
                p = (e) => {
                    const { user: t, revenueType: r = u.AU.superfollows_revenue, title: n = d } = e,
                        i = o()(_, t),
                        [c, l] = (0, u.$)(i, r),
                        [p, m] = (0, u.LF)(i),
        ...
        199213: (e, t, r) => {
            ...
            const y = u().b0ac642a,
                ...
                C = (e) => {
                    const { revenueType: t, showHelperText: r, showProgress: c, stripeStatus: l, type: u, user: d } = e;
                    return "Completed" !== l ? n.createElement(a.Z, { style: E.root }, n.createElement(i.Z, { text: w }), n.createElement(o.ZP, { color: "gray700", style: E.subtext }, k), n.createElement(s.ZP, { link: x }, v)) : n.createElement(a.Z, { style: E.root }, c && n.createElement(h.Z, { revenueType: t, user: d }), r && n.createElement(o.ZP, { color: "gray700", size: "subtext2" }, y), n.createElement(f, { type: u }));
                },
                Z = n.memo(C),
            ...
            const f = u().d7b51c68,
                ...
                y = (e) => {
                    const { description: t, isActiveCreator: r, user: n } = e,
                        i = o()(h, n);
                    return a.createElement(m.H, { Icon: d.default, description: t || (r && a.createElement(s.ZP, { color: "gray700", size: "subtext2", style: v.spacing }, a.createElement(g.Z, { title: b, user: i }))), iconColor: "plum500", label: f, link: r ? _.Vt.dashboard.root : p.Jz });
                },
                w = a.memo(y),
        ...
        534763: (e, t, r) => {
            ...
            const s = (e) => {
                    ...
                    return a.createElement(t, { style: r ? { color: i.default.theme.colors[r] } : c.thumbnail, testID: n });
                },
                c = i.default.create((e) => ({ thumbnail: { color: e.colors.gray700 } }));
            function l(e) {
                const { Icon: t, iconColor: r, testID: i, ...c } = e;
                return a.createElement(o.Z, (0, n.Z)({}, c, { thumbnail: a.createElement(s, { Icon: t, iconColor: r, testID: i }), thumbnailSize: "large" }));
            }
            function u(e) {
                const { link: t, ...r } = e;
                return a.createElement(o.Z, (0, n.Z)({}, r, { link: { external: !0, pathname: e.link } }));
            }
        },
        873372: (e, t, r) => {
            "use strict";
            ...
            function x() {
                ...
                return i.createElement(u.Z, { checked: r, label: w, name: "allowGamblingPersonalization", onChange: n });
            }
            const C = { context: "ads_categories_container" };
            function Z() {
                const { featureSwitches: e } = (0, f.QZ)();
                return e.isTrue("ad_categories_setting_enabled") ? i.createElement(i.Fragment, null, i.createElement(d.Z, null), i.createElement(_.Z, { text: h }), i.createElement(p.Z, { description: y }), i.createElement(b.H, { errorConfig: C }, i.createElement(x, null)), i.createElement(d.Z, null)) : null;
            }
        },
        664918: (e, t, r) => {
            "use strict";
            r.d(t, { D0: () => c, c$: () => u, fD: () => s, iB: () => p, jk: () => l });
            var n = r(366097),
                a = r(163889);
            const i = 2,
                o = 1e3,
            ...
            function c(e) {
                const t = (0, n.bL)(e);
                return t ? (d(t) ? (_(t) ? (t[1] ? s.AcceptAllCookies : t[2] ? s.RefuseNonEssentialCookies : ((0, a.ZP)("Invalid consent signal state"), s.Invalid)) : s.NotSet) : s.Invalid) : s.NotSet;
            }
            function l(e) {
                (0, n.kA)({ consent_version: i, text_version: o, 1: !0 }, e);
            }
            function u(e) {
                (0, n.kA)({ consent_version: i, text_version: o, 2: !0 }, e);
            }
            function d(e) {
                return !(e[1] && e[2]);
            }
            ...
            function p(e) {
                const t = (0, n.bL)(e);
                return !t || !d(t) || !_(t) || t.consent_version < i || t.text_version < o;
            }
        },
        888802: (e, t, r) => {
            "use strict";
            ...
            const f = m().e26dbcd0,
                b = m().aea7dda8,
                h = (0, u.ju)("https://help.x.com/using-x/x-premium"),
                y = a.Z,
                w = n.Z;
            function v({ userPreferences: e }) {
                ...
                return i.createElement(i.Fragment, null, i.createElement(d.Z, { checked: a, disabled: !1, helpText: b, label: f, learnMoreLink: h, name: "hideSubscriptionsCustomization", onChange: o }), i.createElement(_.Z, null));
            }
        ...
        440630: (e, t, r) => {
            ...
            function v({ preferences: e }) {
                ...
                return e.map((e) => {
                    if (a && (!h[e].condition || h[e].condition(a, n))) return i.createElement(u.Z, { checked: !!t.user_preferences[e], helpText: h[e].description, key: e, label: h[e].title, learnMoreLink: h[e].link, name: e, onChange: o });
                });
            }
            const k = { context: "user_preferences_container" };
            function x(e) {
                return i.createElement(b.H, { errorConfig: k }, i.createElement(v, e));
            }
        },
        78940: (e, t, r) => {
            "use strict";
        ...
        310116: (e, t, r) => {
            ...
            const y = p().i586f3e0,
                w = p().a8d516a4,
                v = (0, u.ju)("https://help.x.com/using-x/about-grok"),
                k = a.Z,
                x = n.Z;
            function C({ userPreferences: e }) {
                ...
                return i.createElement(i.Fragment, null, i.createElement(d.Z, { checked: C, disabled: u, helpText: w, label: y, learnMoreLink: v, name: "allowXaiDataSharingCustomization", onChange: Z }));
            }
        ...
        867621: (e, t, r) => {
            ...
            function k({ userPreferences: e }) {
                const t = (0, m.v9)(g.ZP.selectLoggedInUser),
                    ...
                    o = t?.birthdate,
                    c = new Date(),
                    d = { year: c.getFullYear(), month: c.getMonth(), day: c.getDay() },
                    _ = !!r && !(0, b.T)(n, o || d),
                ...
                return "hide" === a ? null : i.createElement(i.Fragment, null, i.createElement(u.Z, { checked: C, disabled: _ || "disable" === a, helpText: y, label: h, name: "allowXaiMemory", onChange: Z }));
            }
        ...
        987317: (e, t, r) => {
            ...
            function C({ userPreferences: e }) {
                ...
                return i.createElement(i.Fragment, null, i.createElement(d.Z, { checked: C, disabled: u, helpText: w, label: y, learnMoreLink: v, name: "allowXaiPersonalizationCustomization", onChange: Z }));
            }
            ...
            const c = a().a5d4fda0,
                l = (e = c, t = !0) => ({
                    customErrorHandler: (r) => {
                        const { context: n } = r;
                        return (!r) instanceof i.Z && (r.message = `Strato error occurred in ${n.id}: ${n.action}`), (0, s.ZP)(r, { extra: { context: n, isStrato: !0 } }), t ? (0, o.mf)({ text: e }) : [];
                    },
                });
        },
        831558: (e, t, r) => {
            "use strict";
            r.d(t, { HI: () => l, W1: () => _, oo: () => u, pe: () => c });
            ...
            async function l(e, t) {
                const r = await crypto.subtle.generateKey({ name: "ECDH", namedCurve: "P-256" }, !0, ["deriveBits"]),
                    ...
                    u = await crypto.subtle.encrypt({ name: "AES-GCM", iv: c }, l, (0, i.cv)(e)),
                    d = await crypto.subtle.exportKey("raw", r.publicKey);
                return (0, i.sM)((0, i.cL)(d, u));
            }
            const u = async (e) => ({ ...(await crypto.subtle.generateKey({ name: "ECDH", namedCurve: "P-256" }, !1, ["deriveBits"])), deviceId: e ?? a().v4(), isRegistered: !1 });
            let d;
            const _ = (e) => {
                d = e;
            };
        ...
        928233: (e, t, r) => {
            ...
            const _ = async (e, t, { api: r, devicePersistence: n }) => {
                    try {
                        ...
                        const m = async () => {
                            ...
                            await a()(
                                async (t) => {
                                    try {
                                        await n.set(_, p), (await n.get(_)) ? await r.withEndpoint(i.Z).register({ registration_id: Math.round(1e5 * Math.random()), identity_key: e, device_id: p.deviceId }) : t(new Error("Could not set value in IndexedDB. Bailing out."));
                                    } catch (e) {
                        ...
                        p || (p = await (0, c.oo)()), p.isRegistered || (await m()), (0, c.W1)(p.privateKey), e(o.Pv(p.deviceId));
                    } catch (e) {
                ...
                p = async (e, t, { api: r, devicePersistence: n }) => {
                    ...
                    const i = d(a),
                        s = await n.get(i);
                    s && "unregistered" !== s.status && ((s.status = "unregistered"), delete s.privateKey, delete s.publicKey, await n.set(i, s), (0, c.W1)(void 0));
                },
                m = async (e, t, { api: r, devicePersistence: n }) => {
                    ...
                    const l = s.deviceId,
                        u = await (0, c.oo)(l);
                    await n.delete(i), await n.set(i, u), await e(_);
                };
        },
        704879: (e, t, r) => {
            "use strict";
            r.d(t, { Jx: () => o, RG: () => n, cL: () => s, cv: () => i, sM: () => a });
        ...
        321330: (e, t, r) => {
            ...
            const s = i().f75d1806,
                ...
                l = i().hedf9d7c,
                u = () => {
                    const { userClaims: e } = n.useContext(o.rC),
        ...
        685731: (e, t, r) => {
            ...
            function g(e) {
                return "number" == typeof e?.tax_amount_local_micro ? d : u;
            }
            ...
            function h(e, t = !1, r, n = !1, a = !0) {
                const u = (0, l.gS)(r, "Discount", { status: n ? "pending" : "active" }),
                    d = (0, s.x)({ amount: m(e, t), currencyCode: e?.currency_code?.toUpperCase(), removeTrailingZeros: !0 });
                return u && e.charge_interval ? (0, o.V)({ selectedInterval: e.charge_interval, duration: u.promotion_metadata?.duration_in_interval, discountedFormattedPrice: (0, i.T)({ price: e, percentOff: u.promotion_metadata?.percent_off, includeTax: t, annualPriceMonthly: !1 }), formattedPrice: d, includeDiscountedPrice: !0, includeThenLabel: a }) : e.charge_interval === c.rv.Year ? p({ price: d }) : e.charge_interval === c.rv.Month ? _({ price: d }) : "";
            }
            const y = (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsRevamp-9f4db315.330ea4ca.js.map
