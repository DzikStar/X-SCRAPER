    ...
    ["ondemand.SettingsRevamp-9f4db315"],
    {
        ...
        873372: (e, t, r) => {
            ...
            function x() {
                ...
                return i.createElement(d.Z, { checked: r, label: w, name: "allowGamblingPersonalization", onChange: n });
            }
        ...
        664918: (e, t, r) => {
            ...
            function p(e) {
                const t = (0, n.bL)(e);
                return !t || !u(t) || !_(t) || t.consent_version < i || t.text_version < o;
            }
        },
        888802: (e, t, r) => {
            "use strict";
        ...
        440630: (e, t, r) => {
            ...
            function v({ preferences: e }) {
                ...
                return e.map((e) => {
                    if (a && (!h[e].condition || h[e].condition(a, n))) return i.createElement(d.Z, { checked: !!t.user_preferences[e], helpText: h[e].description, key: e, label: h[e].title, learnMoreLink: h[e].link, name: e, onChange: o });
                });
            }
        ...
        928233: (e, t, r) => {
            ...
            const _ = async (e, t, { api: r, devicePersistence: n }) => {
                ...
                m = async (e, t, { api: r, devicePersistence: n }) => {
                    ...
                    const l = s.deviceId,
                        d = await (0, c.oo)(l);
                    await n.delete(i), await n.set(i, d), await e(_);
                };
        },
        704879: (e, t, r) => {
            "use strict";
