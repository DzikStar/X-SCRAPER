    ...
    ["ondemand.SettingsRevamp-9f4db315", "shared~ondemand.SettingsMonetization~ondemand.SettingsSuperFollows~ondemand.SettingsAwards~bundle.SuperFollow"],
    {
        ...
        6157: (e, t, a) => {
            ...
            function I({ apiClient: e }) {
                return {
                    ...
                    fetchHistory: ({ cursor: t }) => e.graphQL(g(), { cursor: t }).then((e) => e),
        ...
        290402: (e, t, a) => {
            ...
            const p = l().aa6e3300,
                u = ({ retryMessage: e, ...t }, a) => {
                    ...
                    return n.createElement(o.Z, (0, r.Z)({}, t, { icon: s ? void 0 : n.createElement(d.default, { style: g.icon }), retryMessage: s ? e : p }));
                },
        ...
        980407: (e, t, a) => {
            ...
            class g extends r.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: a, backLocation: i, centerTitle: o, hideBackButton: s, history: c, isFullWidth: p, isLarge: u, middleControl: g, onBackClick: h, rightControl: m, secondaryBar: b, subtitle: f, title: A } = this.props,
                                { isModal: w } = this.context;
                            return r.createElement(n.Z, { style: w ? [_.childViewAppBarRoot, _.appBarZindex] : _.appBarZindex }, r.createElement(d.ZP, { backButtonType: a || (w ? "close" : "back"), backLocation: i, centerTitle: o, fixed: !w, hideBackButton: s, history: c, isFullWidth: p, isLarge: u, middleControl: g, onBackClick: h, ref: e, rightControl: m, secondaryBar: b, style: [w && _.appBarModal, t], subtitle: f, title: A, titleDomId: l.Q_ }));
                        }),
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: a, containerStyle: o, documentTitle: s, isFullWidth: l, isLarge: d, renderHeader: g, title: h, withoutBottomBarMobile: m } = this.props,
                        { isModal: b } = this.context,
                        f = g ? g(this._renderChildViewAppBar()) : this._renderChildViewAppBar();
                    return r.createElement(c.Z, null, r.createElement(p.Z.Configure, { documentTitle: s, headerless: !0, title: h }), r.createElement(n.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [_.root, b && _.rootModal] }, !b && f, r.createElement(i.Z, { isFullWidth: l, isLarge: d, style: [_.container, b && _.containerModal, o] }, b ? r.createElement(u.Z, { style: _.viewport }, f, a) : a), t ? r.createElement(n.Z, { style: [_.bottomBarModal, !b && !m && _.bottomBarMobile] }, r.createElement(i.Z, { isFullWidth: l, isLarge: d }, t)) : null));
                }
            }
            (g.defaultProps = { isFullWidth: !1, isLarge: !1 }), (g.contextType = o.Z);
            ...
            const b = d().j087774e,
                ...
                w = ({ user: e }) => {
                    const { featureSwitches: t } = n.useContext(u.rC),
                        ...
                        r = o()(A, e);
                    return a && r.award_eligible ? n.createElement(n.Fragment, null, n.createElement(_.H, { Icon: p.default, description: n.createElement(s.ZP, { color: "gray700", size: "subtext2", style: y.spacing }, n.createElement(m.Z, { revenueType: h.AU.awards_revenue, title: f, user: r })), label: b, link: g.OB.dashboard.root })) : null;
                },
                v = n.memo(w),
        ...
        281629: (e, t, a) => {
            ...
            var r = a(202784),
                ...
                d = a(779610),
                p = a(725405);
            const u = ({ disabled: e = !1, formattedPayoutAmount: t, scribeComponent: a, styleOverride: u, ...g }) => {
                    const h = (0, p.Z)(),
                        { Icon: m, description: b, heading: f, iconBGColor: A, id: w, link: v, pill: y } = g,
                        x = r.useMemo(() => r.createElement(n.Z, { style: _.description }, r.createElement(i.ZP, { color: "gray700", size: "subtext2" }, b), t && r.createElement(i.ZP, { size: "subtext2", style: _.amount, weight: "bold" }, t)), [b, t]),
                        C = r.useMemo(() => r.createElement(n.Z, { style: _.heading }, y && r.createElement(o.ZP, { background: y.color }, r.createElement(i.ZP, { size: "subtext3", weight: "medium" }, y.label)), r.createElement(i.ZP, { weight: "bold" }, f)), [f, y]),
                ...
                g = r.memo(u),
                _ = l.default.create((e) => ({ heading: { flexDirection: "column", gap: e.spaces.space2 }, description: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", color: e.colors.gray700 }, amount: { flexBasis: "auto", flexGrow: 0, flexShrink: 0 } }));
        },
        794721: (e, t, a) => {
            "use strict";
            a.d(t, { Z: () => _ });
            ...
            const p = l().df29646e,
                ...
                g = (e) => {
                    const { user: t, revenueType: a = d.AU.superfollows_revenue, title: r = p } = e,
                        ...
                        m = n.useMemo(() => ({ label: `/${_}`, value: l }), [l, _]);
                    return n.createElement(s.Z, { progressBarConfig: h, statConfig: m, title: r, valueCurrent: c, valueMax: g });
                },
                _ = n.memo(g);
        },
        199213: (e, t, a) => {
            ...
            const u = d().f139168e,
                g = d().ee0510c2,
                _ = Object.freeze({ earnings: { link: "/settings/monetization/earnings", text: u, size: "xLarge" }, payoutHistory: { link: "/settings/monetization/payout_history", text: g } }),
                h = (e) => {
                    const { type: t } = e;
                    if (!t) return null;
                    const { link: a, size: n, text: i } = _[t];
            ...
            const m = d().d7b51c68,
                ...
                A = (e) => {
                    const { description: t, isActiveCreator: a, user: r } = e,
                        i = o()(f, r);
                    return n.createElement(_.H, { Icon: p.default, description: t || (a && n.createElement(s.ZP, { color: "gray700", size: "subtext2", style: v.spacing }, n.createElement(h.Z, { title: b, user: i }))), iconColor: "plum500", label: m, link: a ? u.Vt.dashboard.root : g.Jz });
                },
                w = n.memo(A),
        ...
        698537: (e, t, a) => {
            ...
            const c = a.p + "Arrow.bbf355fa.png",
                ...
                g = a.p + "Award@3x.7a6f947a.png",
                _ = a.p + "Badge.22294b2a.png",
                ...
                V = a.p + "CoinsStairs.295fdeaa.png",
                K = a.p + "CoinsStairs@2x.22eb2a2a.png",
                Q = a.p + "CoinsStairs@3x.ea04943a.png",
                j = a.p + "CoinsThumbs.d702e22a.png",
                W = a.p + "CoinsThumbs@2x.b8a2cd1a.png",
                O = a.p + "CoinsThumbs@3x.695f875a.png",
                ...
                ge = a.p + "Gem@2x.9fdab1ea.png",
                _e = a.p + "Gem@3x.9f51f0ca.png",
                ...
                Ve = a.p + "Puzzle@3x.3231b3aa.png",
                Ke = a.p + "PuzzlePieces.5917591a.png",
                Qe = a.p + "PuzzlePieces@2x.d239439a.png",
                je = a.p + "PuzzlePieces@3x.ed9bd73a.png",
                We = a.p + "Ribbon.a0d66a6a.png",
                Oe = a.p + "Ribbon@2x.d981e09a.png",
                ...
                gt = a.p + "TrafficBarricadeAlt@2x.6cf6d65a.png",
                _t = a.p + "TrafficBarricadeAlt@3x.aaf995da.png",
                ...
                vt = {
                    ...
                    Award: { variants: [p, u, g], width: 80, height: 96 },
                    Badge: { variants: [_, h, m], width: 48, height: 48 },
                    Crown: { variants: [ie], width: 88, height: 88 },
                    Bonus: { variants: [w, v, y], width: 48, height: 48 },
                    Gem: { variants: [ue, ge, _e], width: 48, height: 48 },
                    ...
                    PuzzlePieces: { variants: [Ke, Qe, je], width: 36, height: 36 },
                    Ribbon: { variants: [We, Oe, Ye], width: 36, height: 36 },
        ...
        873372: (e, t, a) => {
            ...
            function k() {
                ...
                return e.isTrue("ad_categories_setting_enabled") ? i.createElement(i.Fragment, null, i.createElement(p.Z, null), i.createElement(u.Z, { text: f }), i.createElement(g.Z, { description: A }), i.createElement(b.H, { errorConfig: C }, i.createElement(x, null)), i.createElement(p.Z, null)) : null;
            }
        },
        664918: (e, t, a) => {
            "use strict";
            a.d(t, { D0: () => c, c$: () => d, fD: () => s, iB: () => g, jk: () => l });
            var r = a(366097),
                n = a(163889);
            const i = 2,
                o = 1e3,
        ...
        440630: (e, t, a) => {
            ...
            const f = {
                    allow_for_you_recommendations: {
                        condition: function (e, t) {
                            return !!e.birthdate && (0, g.k)(e.birthdate.year, e.birthdate.month, e.birthdate.day) && t.isTrue("settings_for_you_recommendation_enabled");
                        },
            ...
            function v({ preferences: e }) {
                const t = s()(w, {}),
                    ...
                    n = (0, _.v9)(h.ZP.selectViewerUser);
                function o(e, r) {
        ...
        310116: (e, t, a) => {
            ...
            function C({ userPreferences: e }) {
                const t = (0, h.v9)(m.ZP.selectLoggedInUser),
                    ...
                    d = !!a && !(0, f.T)(r, n || c),
                    { __id: u, allow_xai_data_sharing: g } = l()(y, e),
                    [b] = s()(x),
                    C = !!g,
                    k = i.useCallback(() => {
                        function e(e) {
        ...
        987317: (e, t, a) => {
            ...
            function C({ userPreferences: e }) {
                const t = (0, h.v9)(m.ZP.selectLoggedInUser),
                    ...
                    c = { year: o.getFullYear(), month: o.getMonth(), day: o.getDay() },
                    d = !!a && !f(r, n || c),
                    { __id: u, allow_xai_personalization: g } = l()(y, e),
                    [b] = s()(x),
                    C = !!g,
                    k = i.useCallback(() => {
                        function e(e) {
        ...
        928233: (e, t, a) => {
            ...
            const u = async (e, t, { api: a, devicePersistence: r }) => {
                    try {
                        ...
                        let g = await r.get(u);
                        const _ = async () => {
                            const e = (0, l.sM)(await crypto.subtle.exportKey("spki", g.publicKey));
                            await n()(
                                async (t) => {
                                    try {
                                        await r.set(u, g), (await r.get(u)) ? await a.withEndpoint(i.Z).register({ registration_id: Math.round(1e5 * Math.random()), identity_key: e, device_id: g.deviceId }) : t(new Error("Could not set value in IndexedDB. Bailing out."));
                                    } catch (e) {
                                ...
                                await r.set(u, { ...g, isRegistered: !0 });
                        };
                        g || (g = await (0, c.oo)()), g.isRegistered || (await _()), (0, c.W1)(g.privateKey), e(o.Pv(g.deviceId));
                    } catch (e) {
        ...
        685731: (e, t, a) => {
            "use strict";
            a.d(t, { Gi: () => b, Mk: () => A, ZV: () => h, aU: () => _, d3: () => f, fS: () => w, pt: () => m });
            a(202784);
            var r = a(111677),
                n = a.n(r),
                i = a(336629),
            ...
            function f(e, t = !1, a, r = !1, n = !0) {
                const d = (0, l.gS)(a, "Discount", { status: r ? "pending" : "active" }),
                    p = (0, s.x)({ amount: _(e, t), currencyCode: e?.currency_code?.toUpperCase(), removeTrailingZeros: !0 });
                return d && e.charge_interval ? (0, o.V)({ selectedInterval: e.charge_interval, duration: d.promotion_metadata?.duration_in_interval, discountedFormattedPrice: (0, i.T)({ price: e, percentOff: d.promotion_metadata?.percent_off, includeTax: t, annualPriceMonthly: !1 }), formattedPrice: p, includeDiscountedPrice: !0, includeThenLabel: n }) : e.charge_interval === c.rv.Year ? g({ price: p }) : e.charge_interval === c.rv.Month ? u({ price: p }) : "";
            }
            const A = (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsRevamp-9f4db315.eb87917a.js.map
