...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.SettingsRevamp-bc6ccf4c", "icons/IconActivity-js", "icons/IconBadgeStroke-js", "icons/IconChevronRight-js", "icons/IconConnectArrows-js", "icons/IconDeviceTablet-js", "icons/IconDeviceTv-js", "icons/IconIllustrationSparkleOn-js"],
    {
        661810: (e, t, n) => {
            n.d(t, { Z: () => l });
            var r = n(202784),
        ...
        879113: (e, t, n) => {
            ...
            class h extends r.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: n, fetchStatus: a, icon: o, loadingMessage: l, onRequestRetry: d, render: h, renderFailure: g, retryMessage: v, retryable: p } = this.props;
                    switch (a) {
                        case s:
                            return p ? r.createElement(i.Z, { icon: o, onRequestRetry: d, retryMessage: v }) : n ? r.createElement(c.m, { failureMessage: n }) : g();
                        case u:
        ...
        536606: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                s = n(392237);
            const d = (e) => {
                const { decoration: t, isCompact: n, progressBarConfig: d, statConfig: m, title: h, valueCurrent: g, valueMax: v } = e,
                    p = (0, l.F)(),
                ...
                return r.createElement(a.Z, { style: u.root }, r.createElement(a.Z, { style: u.decoration }, t), r.createElement(a.Z, { style: u.title }, r.createElement(o.ZP, { size: "subtext2", weight: "medium" }, h)), r.createElement(a.Z, { id: p, style: u.valueLabel }, m.value ? r.createElement(c.Z, null, r.createElement(c.Z.Value, null, m.value), r.createElement(c.Z.Label, null, m.label)) : r.createElement(o.ZP, { weight: "bold" }, m.label)), r.createElement(a.Z, { style: n ? u.progressBarContainerCompact : u.progressBarContainer, testID: "progressBarStats-progressBarContainer" }, r.createElement(i.Z, { "aria-describedby": p, "aria-valuemax": v, colorValue: f, progress: g / v, progressStyle: b, style: E })));
            };
                        ...
                        r.useEffect(() => {
                            if (f.current)
                                if (l.Z.reducedMotionEnabled) p((n) => ({ ...n, oldText: null, text: t, pendingText: null, pendingCount: null, count: e.count }));
                                    ...
                                    t === v.text || ((0, o.Z)(e.count) && v.count === e.count) ? p((e) => ({ ...e, pendingCount: null, pendingText: null })) : (p((n) => ({ ...n, pendingCount: e.count, pendingText: t })), v.animating || u(e.count, t, p));
                                }
                        }, [t]),
                        r.useEffect(() => {
                            f.current &&
                                ...
                                (v.oldText
                                    ? window.requestAnimationFrame(() =>
                                          window.requestAnimationFrame(() => {
                                              f.current && p((e) => ({ ...e, animating: !0 }));
                                          }),
                                      )
                                    : v.pendingText && u(v.pendingCount, v.pendingText, p));
                        }, [v.animating, v.oldText]),
                        r.useMemo(() => {
                            const e = m[v.transitionDirection],
                                t = v.oldText && !l.Z.reducedMotionEnabled,
                                o = !v.animating && v.oldText && !l.Z.reducedMotionEnabled,
                                c = { ...h, ...(v.animating ? e.post : e.active) },
                                s = { ...(o ? e.pre : e.active) };
                            return r.createElement(
                                a.Z,
                                { style: [g.root, n] },
                                t ? r.createElement("span", { style: c }, r.createElement(i.ZP, d, v.oldText)) : null,
                                r.createElement(
                                    "span",
                                    {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.SettingsRevamp-bc6ccf4c.6753c63a.js.map
