    ...
    ["ondemand.Verified-1c2d1ef4"],
    {
        ...
        56106: (e, l, n) => {
            ...
            var a = {
                ...
                abstractKey: null,
                hash: "3de9270e80291ab4ee0c3cb44589e6ef",
            };
            const i = a;
        },
        143011: (e, l, n) => {
                                        ...
                                        selections: [
                                            {
                                                ...
                                                selections: [
                                                    ...
                                                    { kind: "InlineFragment", selections: [(r = { alias: null, args: null, kind: "ScalarField", name: "rest_id", storageKey: null }), { alias: null, args: (t = [{ kind: "Variable", name: "count", variableName: "count" }]), concreteType: "BusinessTeamAffiliatesSlice", kind: "LinkedField", name: "business_team_affiliates", plural: !1, selections: [{ alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "items_results", plural: !0, selections: [(u = { alias: null, args: null, kind: "ScalarField", name: "id", storageKey: null }), { kind: "RequiredField", field: { alias: null, args: null, concreteType: null, kind: "LinkedField", name: "result", plural: !1, selections: [s, { kind: "InlineFragment", selections: [{ alias: null, args: null, concreteType: "ApiUser", kind: "LinkedField", name: "legacy", plural: !1, selections: [(o = { alias: null, args: null, kind: "ScalarField", name: "id_str", storageKey: null }), (d = { alias: null, args: null, kind: "ScalarField", name: "profile_image_url_https", storageKey: null }), (c = { alias: null, args: null, kind: "ScalarField", name: "screen_name", storageKey: null }), (g = { alias: null, args: null, kind: "ScalarField", name: "name", storageKey: null }), { kind: "RequiredField", field: (m = { alias: null, args: null, kind: "ScalarField", name: "protected", storageKey: null }), action: "THROW", path: "viewer.user_results.result.business_team_affiliates.items_results.result.legacy.protected" }], storageKey: null }], type: "User", abstractKey: null }], storageKey: null }, action: "THROW", path: "viewer.user_results.result.business_team_affiliates.items_results.result" }], storageKey: null }], storageKey: null }, (y = { kind: "ClientExtension", selections: [{ alias: null, args: null, kind: "ScalarField", name: "__id", storageKey: null }] })], type: "User", abstractKey: null },
                                                ],
                                                storageKey: null,
                                            },
                                        ],
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-1c2d1ef4.98cada7a.js.map
