    ...
    ["ondemand.Verified-7c4dcfe2"],
    {
        ...
        392772: (e, l, s) => {
            ...
            function y({ screenName: e }) {
                const l = (0, x.useLazyLoadQuery)(j, { screenName: e });
            ...
            var F = s(607499);
            const K = s(73367),
                S = ({ businessScreenName: e, text: l, userScreenName: s, userTitle: i }) => {
                    const r = (0, x.useLazyLoadQuery)(K, { screen_names: [e, s] }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-7c4dcfe2.550d9f1a.js.map
