        ...
        354146: (e, l, a) => {
            ...
            const p = ({ SubscribeButton: e, cta: l, description: a, disclaimer: i, disclaimerLink: t, features: c, featuresTitle: o, highlight: p, priceElements: f, selectedInterval: h, selectedTier: b, title: v }) => {
                ...
                const j = "month" === f.baseInterval ? f.baseCost : f.annualBaseMonthly,
                    ...
                    S = "Custom" === f.baseCost ? a : "year" === f.baseInterval ? y.landing.pricing.billedAnnually({ cost: f.baseCost ?? "" }) : y.landing.pricing.billedMonthly,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-8eba0336.9f8dd95a.js.map
