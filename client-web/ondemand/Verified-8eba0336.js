    ...
    ["ondemand.Verified-8eba0336"],
    {
        ...
        313270: (e, a, l) => {
            ...
            var n = l(552322),
                ...
                m = l(921347),
                p = l(994120);
            const x = ({ SubscribeButton: e, cta: a, description: l, disclaimer: i, disclaimerLink: t, features: c, featuresTitle: o, highlight: x, priceElements: h, selectedInterval: f, selectedTier: b, title: v }) => {
                const { business: y } = (0, g.M1)();
                if (!h) return null;
                const j = "month" === h.baseInterval ? h.baseCost : h.annualBaseMonthly,
                    { discountedCost: k, annualBaseMonthly: N, percentOff: w, endsAtMsec: _, promoLabel: F } = h.promotionInfo || {},
                    C = (_ && (0, m.v)(_)) || "",
                    L = "Custom" === h.baseCost ? null : y.landing.month,
                    S = "Custom" === h.baseCost ? l : "year" === h.baseInterval ? y.landing.pricing.billedAnnually({ cost: h.baseCost ?? "" }) : y.landing.pricing.billedMonthly,
                    M = k && y.landing.pricing.offerAnualBilling({ discountedCost: k ?? "", baseCost: h.baseCost ?? "" });
                return (0, n.jsxs)(u.Zb, {
                    decoration: F,
                    className: "flex w-full max-w-[360px] flex-col justify-between gap-8 px-7 py-6",
                    children: [(0, n.jsxs)("div", { className: "flex flex-col gap-2", children: [(0, n.jsxs)("div", { className: "flex items-center gap-2 flex-wrap", children: [(0, n.jsx)(r.x, { size: "headline1", weight: "bold", children: v }), w ? (0, n.jsx)("div", { className: "rounded-full text-subtext3 dark:text-white text-black flex h-[18px] items-center justify-center bg-green-50 p-2 font-medium", children: y.landing.pricing.percentageOff({ percentOff: w, endDate: C }) }) : x && (0, n.jsx)("div", { className: "rounded-full text-subtext3 text-background flex h-[18px] items-center justify-center bg-green-500 px-2 font-[600]", children: x })] }), (0, n.jsxs)("div", { className: "flex flex-col", children: [(0, n.jsxs)("div", { className: "items-baseline flex flex-row flex-wrap", children: [(0, n.jsx)("span", { className: (0, d.Z)("text-title1", k ? "md:text-title3 text-title3 line-through font-normal" : "font-extrabold"), children: j }), N && (0, n.jsx)("span", { className: "text-title3 font-extrabold text-green-500 ms-1", children: N }), L && (0, n.jsxs)(r.x, { size: "body", className: "opacity-60", children: ["/ ", L] })] }), (0, n.jsx)(r.x, { size: "body", className: "opacity-60 mt-1", children: M || S })] }), "Enterprise" !== b && "string" == typeof a ? (0, n.jsx)(e, { priceElements: h, selectedTier: b, selectedInterval: f, buttonLabel: h.buttonLabel || a }) : a, (0, n.jsxs)("div", { className: "mt-2 flex flex-col gap-2.5", children: [(0, n.jsx)(r.x, { weight: "normal", children: o }), c.map((e) => (0, n.jsxs)("div", { className: "flex items-start gap-2", children: [(0, n.jsx)(p.Z, { className: "text-text size-5 shrink-0" }), (0, n.jsx)(r.x, { weight: "normal", children: e })] }, e))] })] }), i && (0, n.jsxs)(r.x, { size: "subtext3", color: "gray700", children: [i, " ", t && (0, n.jsx)(s.r, { href: t, className: "text-blue-300", children: y.landing.pricing.learnMore })] })],
                });
            };
            var h;
            !(function (e) {
                (e.Basic = "Basic"), (e.FullAccess = "FullAccess"), (e.Enterprise = "Enterprise");
            })(h || (h = {}));
            const f = ({ SubscribeButton: e, basicPrices: a, enterpriseUrl: l, fullAccessPrices: p, interval: h = "Year", onIntervalChange: f, showTitle: b = !0, includeHandleMarketing: v = !1 }) => {
                const y = (0, c.a)("(max-width: 768px)"),
                    [j, k] = (0, o.useState)(h),
                    { business: N } = (0, g.M1)(),
                    w = b ? N.landing.pricing.title : void 0,
                    _ = a?.Year?.promotionInfo?.endsAtMsec || p?.Year?.promotionInfo?.endsAtMsec,
                    F = _ && (0, m.v)(_),
                    ...
                    M = N.landing.pricing.basicFeaturesOffer(j),
                ...
                return (0, n.jsxs)(u.$0, {
                    ...
                    id: "pricing",
                    children: [
                        (0, n.jsxs)("div", { className: "flex items-center gap-2", children: [(0, n.jsx)("span", { className: (0, d.Z)("cursor-pointer transition-colors", { "text-gray-500": "Year" === j, "text-text": "Month" === j }), onClick: () => S("Month"), children: N.landing.pricing.monthly }), (0, n.jsx)(i.r, { checked: "Year" === j, onCheckedChange: (e) => S(e ? "Year" : "Month"), size: "small", className: "data-[state=checked]:bg-gray-400 data-[state=unchecked]:bg-gray-400", thumbClassName: "data-[state=checked]:bg-text data-[state=unchecked]:bg-text" }), (0, n.jsxs)("div", { className: (0, d.Z)("relative flex cursor-pointer items-baseline gap-1 transition-colors", { "text-gray-500": "Month" === j, "text-text": "Year" === j }), onClick: () => S("Year"), children: [N.landing.pricing.yearly, (C || a?.Year.percentageSavedLabel) && (0, n.jsx)("div", { className: (0, d.Z)("pointer-events-none absolute start-[calc(100%+8px)] cursor-default select-none transition-opacity", { "opacity-0": "Month" === j, "opacity-100": "Year" === j }), children: (0, n.jsx)("span", { className: "text-subtext2 whitespace-nowrap text-green-500", children: C || a?.Year.percentageSavedLabel }) })] })] }),
                        (0, n.jsxs)("div", { className: "flex w-full flex-col items-center justify-center gap-12 md:flex-row md:items-stretch", children: [(0, n.jsx)(x, { title: N.landing.pricing.basic, priceElements: a?.[j], features: M, featuresTitle: N.landing.pricing.basicFeaturesTitle, SubscribeButton: e, selectedTier: "Basic", selectedInterval: j, cta: N.landing.pricing.basicCta }), (0, n.jsx)(x, { title: N.landing.pricing.fullAccess, priceElements: p?.[j], features: B, featuresTitle: N.landing.pricing.fullAccessFeaturesTitle, highlight: N.landing.pricing.highlight, SubscribeButton: e, selectedTier: "FullAccess", selectedInterval: j, cta: N.landing.pricing.fullAccessCta, disclaimer: "Month" === j ? N.landing.pricing.affiliatesDisclaimerMonthly : N.landing.pricing.affiliatesDisclaimerYearly, disclaimerLink: "https://help.x.com/en/using-x/verified-organizations#verifiedorgs-pricing" }), l && (0, n.jsx)(x, { title: N.landing.pricing.enterprise, description: N.landing.pricing.enterpriseDescription, priceElements: L, features: [...N.landing.pricing.enterpriseFeatures], featuresTitle: N.landing.pricing.enterpriseFeaturesTitle, SubscribeButton: e, selectedTier: "Enterprise", selectedInterval: j, cta: (0, n.jsx)(s.r, { href: l, className: "mt-auto w-full", children: (0, n.jsx)(t.z, { variant: "insightsBright", className: "my-4 h-[36px] w-full", children: N.landing.pricing.enterpriseCta }) }) })] }),
        ...
        509345: (e, a, l) => {
            ...
            const n = {
                    ...
                    name: "avatar_user",
                    selections: [
                        { kind: "RequiredField", field: { alias: null, args: null, concreteType: "UserAvatar", kind: "LinkedField", name: "avatar", plural: !1, selections: [{ kind: "RequiredField", field: { alias: null, args: null, kind: "ScalarField", name: "image_url", storageKey: null }, action: "LOG", path: "avatar.image_url" }], storageKey: null }, action: "LOG", path: "avatar" },
                        { kind: "RequiredField", field: { alias: null, args: null, concreteType: "UserCore", kind: "LinkedField", name: "core", plural: !1, selections: [{ kind: "RequiredField", field: { alias: null, args: null, kind: "ScalarField", name: "screen_name", storageKey: null }, action: "LOG", path: "core.screen_name" }], storageKey: null }, action: "LOG", path: "core" },
                    ...
                    selections: [
                        ...
                        },
                        {
                            ...
                            field: {
                                ...
                                plural: !1,
                                selections: [
                                    { kind: "RequiredField", field: { alias: null, args: null, kind: "ScalarField", name: "name", storageKey: null }, action: "LOG", path: "core.name" },
                                    { kind: "RequiredField", field: { alias: null, args: null, kind: "ScalarField", name: "screen_name", storageKey: null }, action: "LOG", path: "core.screen_name" },
                                ],
                                storageKey: null,
                            },
                            action: "LOG",
                        ...
                        { kind: "RequiredField", field: { alias: null, args: null, concreteType: "UserPrivacy", kind: "LinkedField", name: "privacy", plural: !1, selections: [{ alias: null, args: null, kind: "ScalarField", name: "protected", storageKey: null }], storageKey: null }, action: "LOG", path: "privacy" },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-8eba0336.591b642a.js.map
