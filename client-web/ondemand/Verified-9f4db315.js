...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.Verified-9f4db315"],
    {
            ...
            const y = h().c2333081,
                ...
                v = ({ allowExtendedPasteStyles: e, characterLimit: t, editable: n = !0, editorClass: f, editorStyles: p, initialState: h = "", limitedRichText: v = !1, numberOfLines: _ = 10, onChange: C, textSizesOverride: $ }) => {
                    ...
                    const D = r.useMemo(() => x?.getCurrentContent(), [x]),
                        ...
                        T = (0, b.c6)(x);
                    let k = T;
                    T > 1 && (k = s.ZP.getFormattedCount(T));
                    const z = r.useMemo(() => {
                            const e = !!t && T > t;
                            return r.createElement(i.Z, null, r.createElement(c.ZP, { color: e ? "red500" : "gray900", numberOfLines: 1, size: "subtext1", style: S.textCountLabel }, y({ count: k })));
                        }, [T, k, t]),
                        P = r.useMemo(() => ({ allowExtendedPasteStyles: e, editorState: x, element: d.Z, stripPastedStyles: !0 }), [e, x]);
                    return r.createElement(i.Z, null, n ? r.createElement(i.Z, { style: S.richTextWrapper }, r.createElement(u.b, { inputStyle: S.container, isInputFullWidth: !0, limitedRichText: v, numberOfLines: _, onChange: O, richTextInputContext: P, textSizesOverride: $, toolbarRightControl: z })) : r.createElement(r.Fragment, null, D && D.hasText() ? r.createElement(i.Z, { style: S.richTextWrapper }, r.createElement(i.Z, { style: S.readOnlyContainer }, r.createElement(m.Z, { contentState: (0, o.convertToRaw)(D) }))) : null));
                };
        },
        253493: (e, t, n) => {
            n.d(t, { Z: () => S });
            ...
            class y extends r.Component {
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: n, appBarStyle: o, backLocation: i, documentTitle: l, headerless: s, history: c, leftControl: u, middleControl: p, onBackClick: h, rightControl: g, screenType: y, searchBoxOptions: w, secondaryBar: S, showSubtitleOnRoot: v, showSubtitleOnWideDetail: _, subtitle: C, title: $, titleIconCell: x, titleIconCellSize: E, withDetailOpen: D, withSearchBox: O, withTweetButton: T, withWideContainer: k } = this.props,
                        z = "root" === y,
                        P = "secondaryRoot" === y,
                        Z = "primaryDetail" === y,
                        B = (Z && _) || (z && v),
                        F = z || (Z && e),
                        I = z ? d.ey : Z ? d.vX : void 0,
                        L = r.createElement(a.Z, { style: b.appBarContainer }, r.createElement(m.ZP, { backLocation: i, fixed: !1, hideBackButton: F, history: c, leftControl: u, middleControl: p, onBackClick: h, rightControl: g, secondaryBar: S, style: o, subtitle: B ? C : void 0, title: $, titleDomId: I, titleIconCell: x, titleIconCellSize: E, withWideContainer: k })),
                        N = z || (P && D) ? null : r.createElement(f.Z.Configure, { SideNavButton: t, TabBar: n, backLocation: i, documentTitle: l, headerless: s, middleControl: p, onBackClick: h, rightControl: g, searchBoxOptions: w, subtitle: C, title: $, withSearchBox: O, withTweetButton: T });
                    return r.createElement(r.Fragment, null, N, L);
                }
            }
            ...
            const w = (0, u.ZP)(y),
                S = (e) => {
                    ...
                    return (0, i.HD)(t) ? e.children || null : r.createElement(w, e);
                };
        },
        282559: (e, t, n) => {
            n.d(t, { v: () => s });
        ...
        478414: (e, t, n) => {
            n.d(t, { Hx: () => s, K: () => i, bb: () => l, gv: () => a, kg: () => c, yW: () => d });
            var r = n(779802),
                o = n(392237);
        ...
        685731: (e, t, n) => {
            n.d(t, { Gi: () => b, Mk: () => w, ZV: () => h, aU: () => p, d3: () => y, fS: () => S, pt: () => g });
            n(202784);
            var r = n(111677),
                o = n.n(r),
                i = n(336629),
        ...
        116868: (e, t, n) => {
            ...
            const r = window?.location?.host ? `https://${window?.location?.host}` : "https://www.x.com",
                o = ({ apiClient: e, featureSwitches: t }) => ({
                    postConversion(t, n, o, i = {}) {
                        const a = { conversions: [{ basePixel: t, eventPixel: n, twclid: o }] };
                        return e.postUnversioned("/i/capi", a, { ...i, "content-type": "application/json" }, r).then((e) => e.data);
                    },
                });
            var i = n(917799);
            const a =
                    (e, t, n, r, a) =>
                    async (s, c, { api: d, userPersistence: u }) => {
                        const m = await l(u, n, r, a);
                        return m ? (0, i.Vg)(s, { params: { basePixel: e, eventPixel: t, twclid: m }, request: ({ basePixel: e, eventPixel: t, twclid: n } = {}, r) => d.withEndpoint(o).postConversion(e, t, n, r) })("POST_CONVERSION") : Promise.resolve(null);
                    },
                l = async (e, t, n, r) => {
                    let o = t;
        ...
        689212: (e, t, n) => {
            ...
            const a = Object.freeze({ CONFIG_LOADED: "rweb/verifiedOrgConfig/LOADED", CONFIG_REQUEST: "rweb/verifiedOrgConfig/REQUEST", SET_CONFIG: "rweb/verifiedOrgConfig/SET" }),
                ...
                c = { currentTab: i.p.ACCOUNTS },
                d = Object.freeze({ fetchStatus: o.ZP.NONE, config: c });
            const u = (e) => e[l].fetchStatus,
                m = (e) => e[l].config.currentTab || i.p.ACCOUNTS,
                f = (e) => ({ payload: e, type: a.CONFIG_LOADED }),
                p =
                    (e) =>
                    (t, n, { userPersistence: r }) => (t({ payload: e, type: a.SET_CONFIG }), r.set(s, e));
            r.Z.register(
                {
                    [l]: function (e = d, t) {
                        switch (t.type) {
        ...
        798156: (e, t, n) => {
            e.exports = n.p + "illustration-paper-plane.771a84da.png";
        },
        198433: (e, t, n) => {
            e.exports = n.p + "illustration-traffic-light.1da0d6da.png";
        },
        491339: (e, t, n) => {
            e.exports = n.p + "illustration-uturn.e2dcd6aa.png";
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-9f4db315.db33793a.js.map
