    ...
    ["ondemand.Verified-9f69d4bc"],
    {
        ...
        313270: (e, a, l) => {
            ...
            var n = l(552322),
                ...
                m = l(921347),
                p = l(522302);
            const x = ({ SubscribeButton: e, cta: a, description: l, disclaimer: i, disclaimerLink: t, features: c, featuresTitle: o, highlight: x, priceElements: f, selectedInterval: h, selectedTier: b, title: v }) => {
                const { business: y } = (0, g.M1)();
                if (!f) return null;
                const j = "month" === f.baseInterval ? f.baseCost : f.annualBaseMonthly,
            ...
            const h = ({ SubscribeButton: e, basicPrices: a, enterpriseUrl: l, fullAccessPrices: p, interval: f = "Year", onIntervalChange: h, showTitle: b = !0, includeHandleMarketing: v = !1 }) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-9f69d4bc.15e51a3a.js.map
