        ...
        313270: (e, l, a) => {
            ...
            const p = ({ SubscribeButton: e, basicPrices: l, enterpriseUrl: a, fullAccessPrices: x, interval: p = "Year", onIntervalChange: h, showTitle: b = !0, includeHandleMarketing: v = !1 }) => {
                ...
                return (0, n.jsxs)(u.$0, {
                    ...
                    id: "pricing",
                    children: [
                        (0, n.jsxs)("div", { className: "flex items-center gap-2", children: [(0, n.jsx)("span", { className: (0, d.Z)("cursor-pointer transition-colors", { "text-gray-500": "Year" === j, "text-text": "Month" === j }), onClick: () => S("Month"), children: N.landing.pricing.monthly }), (0, n.jsx)(i.r, { checked: "Year" === j, onCheckedChange: (e) => S(e ? "Year" : "Month"), size: "small", className: "data-[state=checked]:bg-gray-400 data-[state=unchecked]:bg-gray-400", thumbClassName: "data-[state=checked]:bg-text data-[state=unchecked]:bg-text" }), (0, n.jsxs)("div", { className: (0, d.Z)("relative flex cursor-pointer items-baseline gap-1 transition-colors", { "text-gray-500": "Month" === j, "text-text": "Year" === j }), onClick: () => S("Year"), children: [N.landing.pricing.yearly, (C || l?.Year.percentageSavedLabel) && (0, n.jsx)("div", { className: (0, d.Z)("pointer-events-none absolute start-[calc(100%+8px)] cursor-default select-none transition-opacity", { "opacity-0": "Month" === j, "opacity-100": "Year" === j }), children: (0, n.jsx)("span", { className: "text-subtext2 whitespace-nowrap text-green-500", children: C || l?.Year.percentageSavedLabel }) })] })] }),
                        (0, n.jsxs)("div", { className: "flex w-full flex-col items-center justify-center gap-12 md:flex-row md:items-stretch", children: [(0, n.jsx)(f, { title: N.landing.pricing.basic, priceElements: l?.[j], features: M, featuresTitle: N.landing.pricing.basicFeaturesTitle, SubscribeButton: e, selectedTier: "Basic", selectedInterval: j, cta: N.landing.pricing.basicCta }), (0, n.jsx)(f, { title: N.landing.pricing.fullAccess, priceElements: x?.[j], features: B, featuresTitle: N.landing.pricing.fullAccessFeaturesTitle, highlight: N.landing.pricing.highlight, SubscribeButton: e, selectedTier: "FullAccess", selectedInterval: j, cta: N.landing.pricing.fullAccessCta, disclaimer: "Month" === j ? N.landing.pricing.affiliatesDisclaimerMonthly : N.landing.pricing.affiliatesDisclaimerYearly, disclaimerLink: "https://help.x.com/en/using-x/verified-organizations#verifiedorgs-pricing" }), a && (0, n.jsx)(f, { title: N.landing.pricing.enterprise, description: N.landing.pricing.enterpriseDescription, priceElements: L, features: [...N.landing.pricing.enterpriseFeatures], featuresTitle: N.landing.pricing.enterpriseFeaturesTitle, SubscribeButton: e, selectedTier: "Enterprise", selectedInterval: j, cta: (0, n.jsx)(s.r, { href: a, className: "mt-auto w-full", children: (0, n.jsx)(t.z, { variant: "insightsBright", className: "my-4 h-[36px] w-full", children: N.landing.pricing.enterpriseCta }) }) })] }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-9f69d4bc.f7ef490a.js.map
