    ...
    ["ondemand.Verified-d2eb5610"],
    {
                                ...
                                selections: [
                                    {
                                        ...
                                        action: "THROW",
                                        path: "user_results_by_screen_names.result",
                                    },
                                ],
                                storageKey: null,
                            },
                            action: "THROW",
                            path: "user_results_by_screen_names",
                        },
                    ],
                    type: "Query",
                    abstractKey: null,
        ...
        392772: (e, l, s) => {
            ...
            const F = s(73367),
                K = ({ businessScreenName: e, text: l, userScreenName: s, userTitle: i }) => {
                    const t = (0, x.useLazyLoadQuery)(F, { screen_names: [e, s] }),
                ...
                C = ({ SubscribeButton: e, basicPrices: l, enterpriseUrl: s, fullAccessPrices: r, interval: c = "Year", onIntervalChange: o, sectionConfig: d, includeHandleMarketing: u = !1 }) => {
                        ...
                        children: m.map((d, m) => {
                            ...
                            return (() => {
                                switch (b) {
                                    ...
                                    case "pricing":
                                        return (0, a.jsx)(t.n, { basicPrices: l, fullAccessPrices: r, interval: c, onIntervalChange: o, SubscribeButton: e, showTitle: x, enterpriseUrl: s, includeHandleMarketing: u }, `${b}-${m}`);
                                    case "wallOfLove":
        ...
        199237: (e, l, s) => {
            ...
            var c = s(387695),
                        ...
                        [
                            function (l, n) {
                                ...
                                function c(l) {
                                    ...
                                    return (0, t.jsx)(o.Provider, { value: d, children: n });
                                }
                                return (
                                    (s = [...s, n]),
                ...
                [x, b] = m(g),
                f = a.forwardRef((e, l) => {
                    const { __scopeSwitch: s, name: r, checked: o, defaultChecked: d, required: g, disabled: m, value: p = "on", onCheckedChange: b, ...f } = e,
                        [h, v] = a.useState(null),
                        w = (0, i.e)(l, (e) => v(e)),
                        k = a.useRef(!1),
                    ...
                    return (0, t.jsxs)(x, {
                        ...
                        children: [
                            ...
                            N && (0, t.jsx)(y, { control: h, bubbles: !k.current, name: r, value: p, checked: _, required: g, disabled: m, style: { transform: "translateX(-100%)" } }),
                        ],
                    });
                });
            f.displayName = g;
            var h = "SwitchThumb",
                v = a.forwardRef((e, l) => {
                    const { __scopeSwitch: s, ...a } = e,
                        n = b(h, s);
                    return (0, t.jsx)(u.WV.span, { "data-state": j(n.checked), "data-disabled": n.disabled ? "" : void 0, ...a, ref: l });
                });
            v.displayName = h;
            var y = (e) => {
                ...
                return (
                    ...
                    (0, t.jsx)("input", { type: "checkbox", "aria-hidden": !0, defaultChecked: s, ...i, tabIndex: -1, ref: r, style: { ...e.style, ...u, position: "absolute", pointerEvents: "none", opacity: 0, margin: 0 } })
                );
            };
            function j(e) {
        ...
        699629: (e, l, s) => {
            ...
            var a = s(787321),
                ...
                i = s(641645);
            function t(e, l, s) {
                const t = (0, i._)(e, l) / n.vh;
                return (0, a.u)(s?.roundingMethod)(t);
            }
        },
        641645: (e, l, s) => {
            s.d(l, { _: () => n });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-d2eb5610.3cab89aa.js.map
