    ...
    ["ondemand.Verified-e019dbda"],
    {
        ...
        664052: (e, t, n) => {
            ...
            const y = h().c2333081,
                ...
                _ = ({ allowExtendedPasteStyles: e, characterLimit: t, editable: n = !0, editorClass: f, editorStyles: p, initialState: h = "", limitedRichText: _ = !1, numberOfLines: C = 10, onChange: T, textSizesOverride: E }) => {
                    const [$, v] = r.useState(w(h));
                    (0, g.q)(() => {
                        p && f && (0, l.fH)(p, f);
                    });
                    const D = r.useMemo(() => $?.getCurrentContent(), [$]),
                        O = r.useCallback(
                            (e) => {
                    ...
                    const x = r.useMemo(() => {
                            const e = !!t && I > t;
                            return r.createElement(i.Z, null, r.createElement(s.ZP, { color: e ? "red500" : "gray900", numberOfLines: 1, size: "subtext1", style: S.textCountLabel }, y({ count: z })));
                        }, [I, z, t]),
                        k = r.useMemo(() => ({ allowExtendedPasteStyles: e, editorState: $, element: d.Z, stripPastedStyles: !0 }), [e, $]);
                    return r.createElement(i.Z, null, n ? r.createElement(i.Z, { style: S.richTextWrapper }, r.createElement(u.b, { inputStyle: S.container, isInputFullWidth: !0, limitedRichText: _, numberOfLines: C, onChange: O, richTextInputContext: k, textSizesOverride: E, toolbarRightControl: x })) : r.createElement(r.Fragment, null, D && D.hasText() ? r.createElement(i.Z, { style: S.richTextWrapper }, r.createElement(i.Z, { style: S.readOnlyContainer }, r.createElement(m.Z, { contentState: (0, o.convertToRaw)(D) }))) : null));
                };
        },
        253493: (e, t, n) => {
            n.d(t, { Z: () => S });
            ...
            class y extends r.Component {
                ...
                _renderInlineNav({ isTwoColumnLayout: e }) {
                    const { SideNavButton: t, TabBar: n, appBarStyle: o, backLocation: i, documentTitle: l, headerless: c, history: s, leftControl: u, middleControl: p, onBackClick: h, rightControl: g, screenType: y, searchBoxOptions: w, secondaryBar: S, showSubtitleOnRoot: _, showSubtitleOnWideDetail: C, subtitle: T, title: E, titleIconCell: $, titleIconCellSize: v, withDetailOpen: D, withSearchBox: O, withTweetButton: I, withWideContainer: z } = this.props,
                        x = "root" === y,
                        k = "secondaryRoot" === y,
                        B = "primaryDetail" === y,
                        P = (B && C) || (x && _),
                        L = x || (B && e),
                        F = x ? d.ey : B ? d.vX : void 0,
                        Z = r.createElement(a.Z, { style: b.appBarContainer }, r.createElement(m.ZP, { backLocation: i, fixed: !1, hideBackButton: L, history: s, leftControl: u, middleControl: p, onBackClick: h, rightControl: g, secondaryBar: S, style: o, subtitle: P ? T : void 0, title: E, titleDomId: F, titleIconCell: $, titleIconCellSize: v, withWideContainer: z })),
                        A = x || (k && D) ? null : r.createElement(f.Z.Configure, { SideNavButton: t, TabBar: n, backLocation: i, documentTitle: l, headerless: c, middleControl: p, onBackClick: h, rightControl: g, searchBoxOptions: w, subtitle: T, title: E, withSearchBox: O, withTweetButton: I });
                    return r.createElement(r.Fragment, null, A, Z);
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.Verified-e019dbda.61dba0da.js.map
