        ...
        125691: (e, t, s) => {
            ...
            function A({ media: e }) {
                ...
                return (
                    ...
                    e.shouldRender ? (e.shouldRender && t ? (0, n.jsx)(N.Et, { src: t, type: o.com.x.models.dm.DmMediaType.Companion.from(e.media.mediaType), dimensions: e.media.dimension, className: " border border-gray-200 rounded-2xl" }) : (0, n.jsx)(i.x, { size: "subtext2", weight: "medium", color: "gray900", children: "Media" })) : null
                );
            }
                    ...
                    children: (0, n.jsx)("div", {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [
                                ...
                                j.replyingTo ? (0, n.jsx)(S, { replyingTo: j.replyingTo, onRemoveReply: () => e.composer.onEvent(o.com.x.dms.composer.composer.ChatComposerEvent.RemoveReplyClicked) }) : null,
                                (0, n.jsxs)("div", {
                                                ...
                                                (0, n.jsxs)("div", {
                                                    ...
                                                    children: [
                                                        (0, n.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                j.attachment ? (0, n.jsx)(D, { attachment: j.attachment, onRemoveAttachment: () => e.composer.onEvent(o.com.x.dms.composer.composer.ChatComposerEvent.DiscardAttachmentClicked) }) : null,
                                                                (0, n.jsx)(w.o, {
                                                        ...
                                                        j.rightButton !== z.SendInactive ? (0, n.jsx)(m.z, { className: "mb-1", onClick: A, icon: (0, n.jsx)(l.Z, {}), size: "small", variant: "brandFilled" }) : void 0,
                                                        (0, n.jsx)(d.J, {
                ...
                (0, p.useEffect)(() => {
                    ...
                    (0, p.useEffect)(() => {
                        ...
                        const n = (s) => {
                            ...
                            switch (s.key) {
                                case "ArrowDown":
                                    s.preventDefault(), l((e) => Math.min(e + 1, n.length - 1));
                                    break;
                                case "ArrowUp":
        ...
        264531: (e, t, s) => {
            ...
            const r = { DEBUG: "DEBUG", INFO: "INFO", WARN: "WARN", ERROR: "ERROR" },
                ...
                l = ({ children: e, settings: t }) => {
                    const s = { ...a, ...t };
                    return (0, n.jsx)(c.Provider, { value: s, children: e });
                },
                i = () => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-14817e23.ba1212ea.js.map
