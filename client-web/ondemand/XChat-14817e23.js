...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.XChat-14817e23"],
    {
        125691: (e, t, n) => {
            ...
            function N({ attachment: e, onRemoveAttachment: t }) {
                ...
                if (e === i.com.x.models.dm.ChatComposerAttachment.Loading) n = (0, s.jsx)("div", { className: "flex items-center justify-center bg-gray-100 rounded-2xl px-4 py-3", children: (0, s.jsx)(j.P, {}) });
                    ...
                    e instanceof i.com.x.models.dm.ChatComposerAttachment.File && (n = (0, s.jsx)(b.Q, { className: "rounded-2xl mb-2 max-w-[300px]", filename: e.file.originalFilename, fileSize: e.file.fileSize }));
                }
                return null === n ? null : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)("div", { className: "flex flex-col gap-2", children: (0, s.jsxs)("div", { className: "relative self-start rounded-2xl", children: [n, e.showRemoveButton && (0, s.jsx)("div", { className: "absolute -top-2 -right-2", children: (0, s.jsx)(d.z, { variant: "primaryFilled", size: "xSmall", icon: (0, s.jsx)(o.Z, {}), onClick: t }) })] }) }), (0, s.jsx)("div", { className: "w-full h-px bg-gray-200" })] });
            }
            function E({ replyingTo: e, onRemoveReply: t }) {
                return (0, s.jsxs)("div", { className: "flex px-2.5 w-full items-center justify-between", children: [(0, s.jsxs)("div", { className: "flex gap-1", children: [e.senderInfo?.user?.displayName ? (0, s.jsxs)(c.x, { size: "subtext2", weight: "medium", color: "gray900", children: ["Replying to ", e.senderInfo.user.displayName] }) : null, (0, s.jsx)(c.x, { size: "subtext2", color: "gray500", children: e.textContent })] }), (0, s.jsx)(d.z, { variant: "primaryFilled", size: "xSmall", icon: (0, s.jsx)(o.Z, {}), onClick: t })] });
            }
            ...
            function M({ component: e }) {
                ...
                (0, h.E)(b, C),
                    ...
                    (0, m.useEffect)(() => {
                        null == n.attachment && w.current && (w.current.value = "");
                    }, [n.attachment]);
                const y = () => {
                ...
                return (0, s.jsx)(v.S, {
                    children: (0, s.jsx)("div", {
                        ...
                        children: (0, s.jsxs)("div", {
                            ...
                            children: [
                                n.isEditing ? (0, s.jsxs)("div", { className: "flex px-2.5 w-full items-center justify-between", children: [(0, s.jsxs)("div", { className: "flex gap-1", children: [(0, s.jsx)(a.Z, {}), (0, s.jsx)(c.x, { size: "subtext2", weight: "medium", color: "gray900", children: "Edit message" })] }), (0, s.jsx)(d.z, { variant: "primaryFilled", size: "xSmall", icon: (0, s.jsx)(o.Z, {}), onClick: () => e.composer.onEvent(i.com.x.dms.composer.composer.ChatComposerEvent.DiscardEditDraft) })] }) : null,
                                        ...
                                        (0, s.jsx)("form", {
                                            ...
                                            children: (0, s.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    n.rightButton !== I.SendInactive ? (0, s.jsx)(d.z, { className: "mb-1", onClick: y, icon: (0, s.jsx)(l.Z, {}), size: "small", variant: "brandFilled" }) : void 0,
                                                ],
                                            }),
                                        }),
                                    ],
        ...
        264531: (e, t, n) => {
            n.d(t, { B$: () => a, BH: () => d, XE: () => c, mp: () => l, rF: () => x, tc: () => u, xq: () => m });
            var s = n(552322),
                i = n(202784);
            const a = { DEBUG: "DEBUG", INFO: "INFO", WARN: "WARN", ERROR: "ERROR" },
                o = { path: "/dms", showDebugOptions: !1, logLevel: a.ERROR, bottomBarHeight: 0, newDBWorker: !1, rwebElements: void 0 },
                    ...
                    return (
                        ...
                        (0, s.jsxs)(w.g, {
                            ...
                            children: [
                                ...
                                d && (0, s.jsx)("div", { className: "flex items-center w-full px-4 ", children: (0, s.jsx)(E, { component: d }) }),
                            ],
                        })
                    );
                },
        ...
        780361: (e, t, n) => {
            ...
            function V({ component: e, setShowAddGroupParticipants: t, showAddGroupParticipants: n }) {
                ...
                if (g.contents === U.ConversationInfoContents.Loading) return (0, s.jsx)(E.g, { className: "flex flex-col w-full items-center self-center min-h-dvh md:h-dvh relative overflow-y-auto", children: (0, s.jsx)(O, {}) });
                if (!(g.contents instanceof U.ConversationInfoContents.Loaded)) return null;
                const P = g.contents.convId,
                    z = P instanceof a.com.x.models.dm.XConversationId.Group,
                    B = g.contents.metadata.title instanceof a.com.x.dms.model.DmTitleState.OneToOne,
                                                ...
                                                (0, s.jsx)("div", {
                                                    ...
                                                    children: (0, s.jsx)(k.x, {
                                                        ...
                                                        onCustomAvatarNeedsResolving: (t) => {
                                                            (0, M.G)() || e.onEvent(new a.com.x.dms.convinfo.ConversationInfoEvent.ResolveCustomAvatar(t));
                                                        },
                                                        isInlineFacepile: !0,
                                                    }),
                                                }),
                                        ...
                                        (0, s.jsx)("div", {
                                            ...
                                            children:
                                                ...
                                                (0, s.jsx)(p.z, {
                                                    variant: "brandText",
                                                    onClick: () => {
                                                        e.onEvent(new a.com.x.dms.convinfo.ConversationInfoEvent.EditGroupClicked(P));
                                                    },
        ...
        238750: (e, t, n) => {
            ...
            function E({ previewWithMetadata: e, actionsDialog: t, onEvent: n, children: i }) {
                const { t: a } = (0, k.$G)(),
                    o = t?.actions
                        .asJsReadonlyArrayView()
                        .map((t) =>
                            ((e, t, n, i) => {
                                const a = () => i(new N.ConversationActionClicked(t.preview.conversationId, n));
                                switch (n.name) {
                                    case "MarkRead":
                                        return { text: e("Mark as read"), icon: (0, s.jsx)(g.Z, {}), onClick: a };
                                    case "MarkUnread":
                                        return { text: e("Mark as unread"), icon: (0, s.jsx)(j.Z, {}), onClick: a };
                                    case "MuteConversation":
                                        return { text: e("Mute conversation"), icon: (0, s.jsx)(w.Z, {}), onClick: a };
                                    case "UnmuteConversation":
                                        return { text: e("Unmute conversation"), icon: (0, s.jsx)(C.Z, {}), onClick: a };
                                    case "RemoveChat":
                                        return { text: e("Delete conversation"), icon: (0, s.jsx)(b.Z, {}), destructive: !0, onClick: a };
            ...
            const I = ({ previewWithMetadata: e }) => {
                    ...
                    const t = e.preview.latestMessagePreview,
                        ...
                        r = [];
                    if (t.messageText) o && r.push((0, s.jsx)(h.x, { as: "span", color: "inherit", size: "inherit", weight: "bold", children: `${a}: ` }, 1)), r.push((0, s.jsx)(h.x, { as: "span", color: "inherit", size: "inherit", weight: "inherit", children: t.messageText }, 2));
                        ...
                        o ? (r.push((0, s.jsx)(h.x, { as: "span", color: "inherit", size: "inherit", weight: "inherit", children: a }, 3)), r.push((0, s.jsx)(h.x, { as: "span", color: "inherit", size: "inherit", weight: "inherit", children: ` sent ${e}` }, 4))) : r.push((0, s.jsx)(h.x, { as: "span", color: "inherit", size: "inherit", weight: "inherit", children: `Sent ${e}` }, 5));
                    }
                    return r;
                },
                R = i.com.x.dms.ReadByOthersIndicator,
                M = ({ onEvent: e, previewWithMetadata: t, actionsDialog: n, isSelected: a, withSeparator: o = !1, isSearch: r }) => {
                        ...
                        w = (0, s.jsx)("div", {
                            ...
                            children: (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsxs)("div", { style: { transitionTimingFunction: "cubic-bezier(0, 0.5, 0.6, 1)" }, className: "flex items-center grow gap-3 rounded-lg  transition-colors duration-100", children: [(0, s.jsx)(p.x, { avatarSize: "xxLarge", titleState: t.metadata.title, onCustomAvatarNeedsResolving: (n) => e(new i.com.x.dms.convlist.ConversationListEvent.CustomAvatarNeedsResolving(t.conversationId, n)), isInlineFacepile: !0 }), (0, s.jsxs)("div", { className: "flex-1 flex-row flex self-stretch py-2 pb-3 border-b " + (o ? "border-gray-50" : "border-transparent"), children: [(0, s.jsxs)("div", { className: "flex-1 gap-5", children: [(0, s.jsx)(u.R, { name: t.metadata.title.title, badges: j ? (0, f.r)(t.metadata.title.otherUser) : void 0, screenName: j ? t.metadata.title.otherUser?.screenName : void 0 }), (0, s.jsx)(h.x, { color: "gray700", weight: t.isUnreadByMe ? "bold" : "normal", numberOfLines: 2, className: "break-all min-h-[2.5rem]", children: (0, s.jsx)(I, { previewWithMetadata: t }) })] }), (0, s.jsxs)("div", { className: "flex flex-col items-end", children: [(0, s.jsxs)("div", { className: "flex flex-row gap-1 items-center h-5", children: [(0, s.jsx)(h.x, { size: "subtext1", color: "gray700", children: g && (0, s.jsx)(v.Q, { timestamp: g }) }), (0, s.jsx)(c.Z, { width: "20", height: "20", className: "text-gray-300 -mr-1" })] }), (0, s.jsxs)("div", { className: "flex flex-row gap-1 items-center h-5", children: [t.isMuted && (0, s.jsx)(d.Z, { width: "14", height: "14", className: "text-gray-300" }), t.showReadByOthersIndicator === R.Read && (0, s.jsx)(m.Z, { width: "14", height: "14", className: "text-gray-300" }), t.showReadByOthersIndicator === R.Unread && (0, s.jsx)(x.Z, { width: "14", height: "14", className: "text-gray-300" })] })] })] })] }),
                                ],
                            }),
                        });
                    return r ? w : (0, s.jsx)(E, { previewWithMetadata: t, actionsDialog: n, onEvent: e, children: w });
                },
                A = ({ onEvent: e, isSearch: t, conversations: n, actionsDialog: l }) => {
                    const c = (0, r.a)(),
                        d = (0, o.useRef)(null),
                        m = (0, o.useRef)({ start: 0, end: 0 }),
                        x = (0, o.useCallback)((e) => (l?.convId.id === e ? l : null), [l]),
                        u = (0, o.useCallback)(() => {
                            const t = d.current;
                            if (!t) return;
                            const { start: s, end: a } = m.current,
                                o = t.findStartIndex(),
                                r = t.findEndIndex();
                            if (s !== o || a !== r) {
                                const t = i.kotlin.collections.KtList.fromJsArray(n.slice(o, r + 1).map((e) => e.conversationId));
                                e(new i.com.x.dms.convlist.ConversationListEvent.VisibleConversationIdsChanged(t)), (m.current = { start: o, end: r });
                            }
                        }, [e, n.slice]),
                        h = (0, o.useCallback)(
                            (a, o) => {
                                const r = a.conversationId.id === c,
                                    l = o + 1 < n.length && n[o + 1]?.conversationId.id === c;
                                return (0, s.jsx)(
                                    "div",
                                    {
                                        onClick: () => {
                                        ...
                                        children: (0, s.jsx)(M, { previewWithMetadata: a, actionsDialog: x(a.preview?.conversationId.id || ""), onEvent: e, isSelected: r, withSeparator: !l && !r, isSearch: t }),
                                    },
                    ...
                    return (0, s.jsx)(a.T, { api: d, onScroll: u, items: n, renderItem: h, className: "!h-full scrollbar-thin-custom" });
                };
        },
        897995: (e, t, n) => {
            n.d(t, { Y: () => l });
                        ...
                        children: [
                            ...
                            (0, s.jsx)("div", {
                                ...
                                children: n.times.asJsReadonlyArrayView().map((i, a) => {
                                    const o = i ? (0, v.S)({ diffSeconds: i.inWholeMilliseconds / 1e3, style: "long" }) : t("None"),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-14817e23.484369aa.js.map
