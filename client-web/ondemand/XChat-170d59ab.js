    ...
    ["ondemand.XChat-170d59ab"],
    {
        124389: (k, r, e) => {
            !(function (k, r) {
                ...
                function kk() {
                    (e = this),
                        (this.ecr_1 = v([q("<", "&gt;"), q(">", "&lt;"), q('"', "&quot;"), q("'", "&apos;"), q("&", "&amp;")])),
                        (this.fcr_1 = X(0, this.ecr_1)),
                        (this.gcr_1 = v([
                            q("'", "&apos;"),
                            q(" ", "&nbsp"),
                            q(" ", "&nbsp;"),
                ...
                function ek() {
                    ...
                    (this.lcr_1 = Q([new ak(rk().ecr_1), new ak(k), s.kcr(1, 8), s.kcr(14, 31), s.kcr(127, 132), s.kcr(134, 159), new mk()])), (this.mcr_1 = Q([new ak(rk().gcr_1)])), (this.ncr_1 = Q([new ak(rk().icr_1), s.kcr(1, 8), s.kcr(14, 31), s.kcr(127, 132), s.kcr(134, 159)])), (this.ocr_1 = Q([new ak(rk().hcr_1), new pk([])])), (this.pcr_1 = Q([new ak(rk().jcr_1), new pk([])])), (this.qcr_1 = Q([new ak(rk().fcr_1), new pk([])]));
                }
                function ak(k) {
                    tk.call(this);
                    this.tcr_1 = E();
                    ...
                    for (var r = 2147483647, e = 0, a = k.p(); a.q(); ) {
                        ...
                        var c = D(o, 0),
                            s = L(c),
                            l = S(x(s));
                        this.ucr_1.k(new _(l));
                        var n = o.length;
                        n < r && (r = n), n > e && (e = n);
                    }
                    (this.vcr_1 = r), (this.wcr_1 = e);
                }
                function tk() {}
                function ok() {
                    tk.call(this);
                ...
                function pk(k) {
                    nk(), tk.call(this);
                    var r;
                    (r = 0 === k.length ? nk().zcr_1 : G(k.slice())), (this.ycr_1 = r);
                }
                function gk() {}
                function dk(k, r) {
                    ok.call(this), (this.dcs_1 = k), (this.ecs_1 = r);
                }
                function mk() {
                    ok.call(this);
                }
                ...
                function fk() {
                    (this.acs_1 = 65536), (this.bcs_1 = 1114111);
                }
                h(tk, "StringTranslator"),
                    ...
                    y(fk, "CharsUtils"),
                    (g(W).ccr = function (k, r, e) {
                        for (var a = this.bcr_1.p(); a.q(); ) {
                            var t = a.r().ccr(k, r, e);
                            if (0 !== t) return t;
                        }
                        return 0;
                    ...
                    (g(ek).rcr = function (k) {
                        return this.pcr_1.dcr(k);
                    }),
                    (g(ek).scr = function (k) {
                        return this.rcr(k);
                    }),
                    (g(ak).ccr = function (k, r, e) {
                        var a = D(k, r),
                            t = L(a),
                            o = S(x(t));
                        if (this.ucr_1.w(new _(o))) {
                            var i = this.wcr_1;
                            ((r + this.wcr_1) | 0) > k.length && (i = (k.length - r) | 0);
                            var c = i,
                                s = this.vcr_1;
                            if (s <= c)
                                do {
                    ...
                    (g(ok).ccr = function (k, r, e) {
                        var a = D(k, r),
                            t = L(a);
                        return this.xcr(t, e) ? 1 : 0;
                    }),
                    (g(pk).ccr = function (k, r, e) {
                        var a = k.length;
                        if (D(k, r) === H(38) && r < ((a - 2) | 0) && D(k, (r + 1) | 0) === H(35)) {
                            ...
                            var b = h;
                            if (b > 65535)
                                for (var q = l.ccs(b), v = 0, w = q.length; v < w; ) {
                                    var y = q[v];
                                    (v = (v + 1) | 0), e.g9(y);
                                }
                            else {
                    ...
                    (g(gk).kcr = function (k, r) {
                        return new dk(M(k, r), !0);
                    }),
                    (g(dk).xcr = function (k, r) {
                        return this.ecs_1 === this.dcs_1.zl(k) && (r.f9("&#"), r.f9(Y(k, 10)), r.g9(H(59)), !0);
                    }),
                    (g(mk).xcr = function (k, r) {
                        var e,
                            a = H(55296);
                        if (k >= L(a)) {
                            var t = H(57343);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-170d59ab.4638b4ba.js.map
