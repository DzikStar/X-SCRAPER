    ...
    ["ondemand.XChat-170d59ab"],
    {
        124389: (k, r, e) => {
            !(function (k, r) {
                ...
                function kk() {
                    (e = this),
                        (this.sbo_1 = v([q("<", "&gt;"), q(">", "&lt;"), q('"', "&quot;"), q("'", "&apos;"), q("&", "&amp;")])),
                        (this.tbo_1 = X(0, this.sbo_1)),
                        (this.ubo_1 = v([
                            q("'", "&apos;"),
                            q(" ", "&nbsp"),
                            q(" ", "&nbsp;"),
                ...
                function ek() {
                    ...
                    (this.zbo_1 = Q([new ak(rk().sbo_1), new ak(k), s.ybo(1, 8), s.ybo(14, 31), s.ybo(127, 132), s.ybo(134, 159), new mk()])), (this.abp_1 = Q([new ak(rk().ubo_1)])), (this.bbp_1 = Q([new ak(rk().wbo_1), s.ybo(1, 8), s.ybo(14, 31), s.ybo(127, 132), s.ybo(134, 159)])), (this.cbp_1 = Q([new ak(rk().vbo_1), new pk([])])), (this.dbp_1 = Q([new ak(rk().xbo_1), new pk([])])), (this.ebp_1 = Q([new ak(rk().tbo_1), new pk([])]));
                }
                function ak(k) {
                    tk.call(this);
                    this.hbp_1 = E();
                    ...
                    for (var r = 2147483647, e = 0, a = k.p(); a.q(); ) {
                        ...
                        var l = D(o, 0),
                            s = L(l),
                            c = S(x(s));
                        this.ibp_1.k(new _(c));
                        var n = o.length;
                        n < r && (r = n), n > e && (e = n);
                    }
                    (this.jbp_1 = r), (this.kbp_1 = e);
                }
                function tk() {}
                function ok() {
                    tk.call(this);
                ...
                function pk(k) {
                    nk(), tk.call(this);
                    var r;
                    (r = 0 === k.length ? nk().nbp_1 : G(k.slice())), (this.mbp_1 = r);
                }
                function gk() {}
                function dk(k, r) {
                    ok.call(this), (this.rbp_1 = k), (this.sbp_1 = r);
                }
                function mk() {
                    ok.call(this);
                }
                ...
                function fk() {
                    (this.obp_1 = 65536), (this.pbp_1 = 1114111);
                }
                h(tk, "StringTranslator"),
                    ...
                    y(fk, "CharsUtils"),
                    (g(W).qbo = function (k, r, e) {
                        for (var a = this.pbo_1.p(); a.q(); ) {
                            var t = a.r().qbo(k, r, e);
                            if (0 !== t) return t;
                        }
                        return 0;
                    ...
                    (g(ek).fbp = function (k) {
                        return this.dbp_1.rbo(k);
                    }),
                    (g(ek).gbp = function (k) {
                        return this.fbp(k);
                    }),
                    (g(ak).qbo = function (k, r, e) {
                        var a = D(k, r),
                            t = L(a),
                            o = S(x(t));
                        if (this.ibp_1.w(new _(o))) {
                            var i = this.kbp_1;
                            ((r + this.kbp_1) | 0) > k.length && (i = (k.length - r) | 0);
                            var l = i,
                                s = this.jbp_1;
                            if (s <= l)
                                do {
                    ...
                    (g(ok).qbo = function (k, r, e) {
                        var a = D(k, r),
                            t = L(a);
                        return this.lbp(t, e) ? 1 : 0;
                    }),
                    (g(pk).qbo = function (k, r, e) {
                        var a = k.length;
                        if (D(k, r) === H(38) && r < ((a - 2) | 0) && D(k, (r + 1) | 0) === H(35)) {
                            ...
                            var b = h;
                            if (b > 65535)
                                for (var q = c.qbp(b), v = 0, w = q.length; v < w; ) {
                                    var y = q[v];
                                    (v = (v + 1) | 0), e.a9(y);
                                }
                            else {
                                ...
                                if (E) throw z("Invalid Char code: " + b);
                                var S = F(b);
                                e.a9(S);
                            }
                    ...
                    (g(gk).ybo = function (k, r) {
                        return new dk(M(k, r), !0);
                    }),
                    (g(dk).lbp = function (k, r) {
                        return this.sbp_1 === this.rbp_1.ql(k) && (r.z8("&#"), r.z8(Y(k, 10)), r.a9(H(59)), !0);
                    }),
                    (g(mk).lbp = function (k, r) {
                        var e,
                            a = H(55296);
                        if (k >= L(a)) {
                            var t = H(57343);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-170d59ab.b5b9082a.js.map
