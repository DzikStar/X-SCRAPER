    ...
    ["ondemand.XChat-42fadb5c"],
    {
        125550: (e, s, t) => {
            ...
            const p = ({ groupId: e, token: s }) => {
                    ...
                    return (
                        ...
                        (0, n.jsx)("div", { className: "flex flex-1 w-full h-full transition-colors", children: t ? (0, n.jsx)(u, { component: t, navigate: o }) : (0, n.jsx)("div", { className: "h-full flex items-center", children: (0, n.jsx)(r.P, {}) }) })
                    );
                },
                u = ({ component: e, navigate: s }) => {
                    const { t } = (0, i.$G)(),
                        r = (0, x._)(e.state);
                    return (0, n.jsx)("div", {
        ...
        707513: (e, s, t) => {
            ...
            function g({ urlCard: e, onEvent: s }) {
                ...
                let t = null;
                return e instanceof h.UrlCard.Resolved && (t = e.bannerImage && (0, n.jsx)("img", { src: e.bannerImage, loading: "lazy", alt: e.displayTitle || e.displayHostname, className: "max-w-[320px] max-h-[400px] rounded-t-2xl rounded-b-none border border-gray-200 shadow-md" })), e instanceof h.UrlCard.Loading && (t = (0, n.jsx)("div", { className: "flex items-center justify-center h-32 pt-2 w-full", children: (0, n.jsx)(u.P, {}) })), (0, n.jsxs)("div", { className: "flex flex-col gap-0.5 bg-gray-100 cursor-pointer transition-colors duration-100", onClick: () => window.open(e.urlToOpen, "_blank"), children: [t, (0, n.jsxs)("div", { className: "flex flex-col gap-0.5 px-8 py-4 hover:bg-gray-50/50", children: [e.displayTitle && (0, n.jsx)(l.x, { weight: "medium", children: e.displayTitle }), (0, n.jsxs)("div", { className: "flex items-center gap-1", children: [(0, n.jsx)(l.x, { color: "gray900", size: "subtext2", children: e.displayHostname }), (0, n.jsx)(o.Z, { className: "text-gray-500 size-4" })] })] })] });
            }
            var v = t(83083);
            ...
            function b({ attachment: e, isReceived: s, onEvent: t, className: r }) {
                if (e instanceof j.Post) return (0, n.jsx)(p, { isReceived: s, post: e, onEvent: t, className: r });
        ...
        289752: (e, s, t) => {
            ...
            function m({ src: e, type: s, dimensions: t, className: i }) {
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [
                        "Video" === s.name ? (0, n.jsx)("div", { className: (0, o.cn)("max-w-[300px] max-h-[400px]", i), children: (0, n.jsx)(d.q, { src: e, poster: e, type: "video/mp4", autoPlay: !0, muted: !0, loop: !0, playsInline: !0, style: { width: `${r}px`, height: `${c}px` } }) }) : (0, n.jsx)("img", { src: e, loading: "lazy", alt: "attachment", className: (0, o.cn)("max-w-[300px] max-h-[400px] cursor-pointer bg-gray-50 border border-gray-200 shadow-md", i), style: { width: `${r}px`, height: `${c}px` }, onClick: () => x(!0) }),
                        (0, n.jsx)(a.e, {
                            mediaItems: p,
                            initialIndex: 0,
                            isOpen: m,
            ...
            function x({ dimensions: e }) {
                const { width: s, height: t } = u(e);
                return (0, n.jsx)("div", { className: "bg-gray-50 flex items-center justify-center", style: { width: `${s}px`, height: `${t}px` }, children: (0, n.jsx)(i.P, {}) });
            }
            function p({ dimensions: e }) {
                const { width: s, height: t } = u(e);
                return (0, n.jsxs)("div", { className: "bg-gray-50 flex flex-col gap-1.5 items-center justify-center text-gray-700", style: { width: `${s}px`, height: `${t}px` }, children: [(0, n.jsx)(c.Z, {}), (0, n.jsx)(r.x, { color: "gray700", children: "Failed to load" })] });
            }
            function u(e) {
