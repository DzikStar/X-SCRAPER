    ...
    ["ondemand.XChat-e96e9bea"],
    {
        ...
        196594: (u, e, a) => {
            ...
            const m = (0, t.Z)("#{punct}#{spacesGroup}#{invalidCharsGroup}#{directionalMarkersGroup}", { punct: b.Z, spacesGroup: h.Z, invalidCharsGroup: f, directionalMarkersGroup: l }),
                ...
                x = (0, t.Z)(/(?:#{validSubdomain}*#{validDomainName}(?:#{validGTLD}|#{validCCTLD}|#{validPunycode}))/, { validDomainName: p, validSubdomain: v, validGTLD: s, validCCTLD: r, validPunycode: i }),
                y = /[0-9]+/,
                k = /\u0400-\u04FF/,
                ...
                N = /[a-z0-9!?\*'@\(\);:&=\+\$\/%#\[\]\-_\.,~|]/i,
                A = /[a-z0-9\-_&=#\/]/i,
                P = (0, t.Z)("((#{validUrlPrecedingChars})((https?:\\/\\/)?(#{validDomain})(?::(#{validPortNumber}))?(\\/#{validUrlPath}*)?(\\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?))", { validUrlPrecedingChars: Z, validDomain: x, validPortNumber: y, validUrlPath: z, validUrlQueryChars: N, validUrlQueryEndingChars: A }, "gi"),
                F = /[-_.\/]$/,
                E = (0, t.Z)(/^https?:\/\/t\.co\/([a-z0-9]+)(?:\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?/, { validUrlQueryChars: N, validUrlQueryEndingChars: A }, "i"),
        ...
        527735: (u, e, a) => {
            ...
            var d = a(552322),
                t = a(202784),
                c = a(332161);
            const r = ({ destructive: u, icon: e, onClick: a, text: r }) => (0, d.jsxs)("button", { type: "button", className: "px-6 flex items-center h-10 min-w-10 gap-3 w-full justify-start border-transparent hover:bg-gray-50 focus:brightness-100 " + (u ? "text-destructive" : "text-text"), onClick: a, children: [e && (0, t.cloneElement)(e, { className: "size-[22px]" }), (0, d.jsx)(c.x, { color: "inherit", numberOfLines: 1, size: "body", weight: "bold", children: r })] });
            var s = a(305399),
                i = a(110929),
                n = a(194787);
            const o = (0, i.j)("bg-background h-fit fixed bottom-0 left-0 right-0 outline-none", { variants: { borderRadius: { "2xLarge": "rounded-t-2xl", "3xLarge": "rounded-t-3xl", full: "rounded-t-full", large: "rounded-t-lg", medium: "rounded-t-md", none: "rounded-t-none", small: "rounded-t-sm", xLarge: "rounded-t-xl", true: "rounded-t" } } });
            function l({ borderRadius: u = "medium", children: e, className: a, title: t, trigger: c, withHandle: r, ...s }) {
                return (0, d.jsxs)(n.dy.Root, { ...s, children: [(0, d.jsx)(n.dy.Trigger, { asChild: !0, children: c }), (0, d.jsxs)(n.dy.Portal, { children: [(0, d.jsx)(n.dy.Overlay, { className: "fixed inset-0 bg-black/40" }), (0, d.jsxs)(n.dy.Content, { className: o({ borderRadius: u, className: a }), children: [r && (0, d.jsx)(n.dy.Handle, { className: "my-2" }), t && (0, d.jsx)(n.dy.Title, { children: t }), e] })] })] });
            }
            var f = a(437712);
            function b({ children: u, open: e, onOpenChange: a, trigger: t }) {
                return (0, s.a)("(min-width: 768px)") ? (0, d.jsx)(f.J, { open: e, onOpenChange: a, trigger: t, withArrow: !0, children: u }) : (0, d.jsx)(l, { open: e, onOpenChange: a, trigger: t, children: u });
            }
            const h = ({ items: u, open: e, onOpenChange: a, trigger: t }) => (0, d.jsx)(b, { trigger: t, open: e, onOpenChange: a, children: (0, d.jsx)("div", { className: "flex flex-col items-start justify-start rounded-sm gap-1", children: u.map((u) => (0, d.jsx)(r, { ...u }, u.text)) }) });
        },
        959992: (u, e, a) => {
            "use strict";
            a.d(e, { r: () => c });
        ...
        789764: (u, e, a) => {
            ...
            function c({ size: u = "medium", spacing: e = 12, urls: a, resolution: c, stackOrder: r = "descending" }) {
                ...
                return (0, d.jsx)("div", { className: "flex", style: { marginInlineStart: `${e}px` }, children: a.map((a, r) => (0, d.jsx)("div", { className: "rounded-full bg-background p-0.5", style: { marginInlineStart: -1 * e, zIndex: s[r]?.index }, children: (0, d.jsx)(t.q, { size: u, shape: "circle", url: a, resolution: c, className: s[r]?.scale }) }, `${a}${r}`)) });
            }
        },
        472275: (u, e, a) => {
            "use strict";
        ...
        597322: (u, e, a) => {
            ...
            var d = a(202784),
                ...
                o = a(234622);
            a(536188);
            const l = i.default.create((u) => ({ root: { width: "100%", display: "block", height: "100dvh" }, narrowRoot: { height: "unset" }, webviewRoot: { height: "100%" } })),
                f = (u) => {
                    const e = (0, s.JS)(),
                        a = (0, r.useHistory)(),
                        { id: i, token: f } = (0, r.useParams)();
                    return (i && f) || a.push("/i/chat"), d.createElement(o.i, null, d.createElement(n.Z, { history: a, isFullWidth: !0, primaryContent: () => d.createElement(c.Z, { style: [l.root, e && l.narrowRoot] }, d.createElement(t.N, { groupId: i, settings: { path: "/i/chat" }, token: f })), sidebarContent: null }));
                };
        },
        647665: (u, e, a) => {
            "use strict";
            ...
            const l = i.default.create((u) => ({ root: { width: "100%", display: "block", height: "100dvh" }, narrowRoot: { height: "unset" }, webviewRoot: { height: "100%" } })),
                f = (u) => {
                    const e = (0, s.JS)(),
                        a = (0, r.useHistory)(),
                        { xChatPinMode: i, xChatPinRegister: f } = (0, r.useParams)();
                    return d.createElement(o.i, null, d.createElement(n.Z, { history: a, isFullWidth: !0, primaryContent: () => d.createElement(c.Z, { style: [l.root, e && l.narrowRoot] }, d.createElement(t.x, { mode: i ?? "new", settings: { path: "/i/chat" }, shouldRegister: "register" === f })), sidebarContent: null }));
                };
        },
        476644: (u, e, a) => {
            "use strict";
            ...
            const f = i.default.create((u) => ({ root: { width: "100%", display: "block", height: "100dvh" }, narrowRoot: { height: "unset" }, webviewRoot: { height: "100%" } })),
                b = (u) => {
                    const e = (0, s.JS)(),
                        a = (0, r.useHistory)(),
                        i = (0, l.hC)("rweb_xchat_debug_enabled");
                    return d.createElement(o.i, null, d.createElement(n.Z, { history: a, isFullWidth: !0, primaryContent: () => d.createElement(c.Z, { style: [f.root, e && f.narrowRoot] }, d.createElement(t.H, { settings: { path: "/i/chat", showDebugOptions: i } })), sidebarContent: null }));
                };
        },
        115290: (u, e, a) => {
            var d = a(482609),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-e96e9bea.c02d543a.js.map
