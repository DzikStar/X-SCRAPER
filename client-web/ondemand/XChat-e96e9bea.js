    ...
    ["ondemand.XChat-e96e9bea"],
    {
        928220: (u, e, a) => {
            ...
            const r = (0, d.Z)(/[#{spacesGroup}]/, { spacesGroup: s.Z }),
                i = (0, d.Z)("(^|#{spaces})(\\$)(#{cashtag})(?=$|\\s|[#{punct}])", { cashtag: t, spaces: r, punct: c.Z }, "gi");
            function n(u) {
                ...
                return (
                    u.replace(i, (u, a, d, t, c) => {
                        const s = c + a.length,
                            r = s + t.length + 1;
                        return e.push({ cashtag: t, indices: [s, r] }), "";
                    }),
                    e
                );
            }
        ...
        303676: (u, e, a) => {
            ...
            const c = /[#＃]/,
                ...
                h = /_\u200c\u200d\ua67e\u05be\u05f3\u05f4\uff5e\u301c\u309b\u309c\u30a0\u30fb\u3003\u0f0b\u0f0c\xb7/,
                b = (0, t.Z)(/(?:[#{bmpLetterAndMarks}#{bmpNumerals}#{hashtagSpecialChars}]|(?=#{nonBmpCodePairs})(?:#{astralLetterAndMarks}|#{astralNumerals}))/, { bmpLetterAndMarks: i, bmpNumerals: f, hashtagSpecialChars: h, nonBmpCodePairs: n, astralLetterAndMarks: r, astralNumerals: o }),
                m = /(?:[^\uD800-\uDFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF])/,
                g = (0, t.Z)(/(?:^|\uFE0E|\uFE0F|$|(?!#{hashtagAlphaNumeric}|&)#{codePoint})/, { codePoint: m, hashtagAlphaNumeric: b }),
                p = (0, t.Z)(/(#{hashtagBoundary})(#{hashSigns})(?!\uFE0F|\u20E3)(#{hashtagAlphaNumeric}*#{hashtagAlpha}#{hashtagAlphaNumeric}*)/gi, { hashtagBoundary: g, hashSigns: c, hashtagAlphaNumeric: b, hashtagAlpha: l });
            function v(u, e) {
                if (!u || !u.match(c)) return [];
                let a = [];
                if (
                    (u.replace(p, (u, e, d, t, c, r) => {
                        if (!r.slice(c + u.length).match(s)) {
                            const u = c + e.length,
                                d = u + t.length + 1;
        ...
        196594: (u, e, a) => {
            ...
            const s = RegExp("(?:(?:한국|香港|澳門|新加坡|台灣|台湾|中國|中国|გე|ລາວ|ไทย|ලංකා|ഭാരതം|ಭಾರತ|భారత్|சிங்கப்பூர்|இலங்கை|இந்தியா|ଭାରତ|ભારત|ਭਾਰਤ|ভাৰত|ভারত|বাংলা|भारोत|भारतम्|भारत|ڀارت|پاکستان|موريتانيا|مليسيا|مصر|قطر|فلسطين|عمان|عراق|سورية|سودان|تونس|بھارت|بارت|ایران|امارات|المغرب|السعودية|الجزائر|البحرين|الاردن|ישראל|հայ|қаз|укр|срб|рф|мон|мкд|ею|бел|бг|ευ|ελ|zw|zm|za|yt|ye|ws|wf|vu|vn|vi|vg|ve|vc|va|uz|uy|us|um|uk|ug|ua|tz|tw|tv|tt|tr|tp|to|tn|tm|tl|tk|tj|th|tg|tf|td|tc|sz|sy|sx|sv|su|st|ss|sr|so|sn|sm|sl|sk|sj|si|sh|sg|se|sd|sc|sb|sa|rw|ru|rs|ro|re|qa|py|pw|pt|ps|pr|pn|pm|pl|pk|ph|pg|pf|pe|pa|om|nz|nu|nr|np|no|nl|ni|ng|nf|ne|nc|na|mz|my|mx|mw|mv|mu|mt|ms|mr|mq|mp|mo|mn|mm|ml|mk|mh|mg|mf|me|md|mc|ma|ly|lv|lu|lt|ls|lr|lk|li|lc|lb|la|kz|ky|kw|kr|kp|kn|km|ki|kh|kg|ke|jp|jo|jm|je|it|is|ir|iq|io|in|im|il|ie|id|hu|ht|hr|hn|hm|hk|gy|gw|gu|gt|gs|gr|gq|gp|gn|gm|gl|gi|gh|gg|gf|ge|gd|gb|ga|fr|fo|fm|fk|fj|fi|eu|et|es|er|eh|eg|ee|ec|dz|do|dm|dk|dj|de|cz|cy|cx|cw|cv|cu|cr|co|cn|cm|cl|ck|ci|ch|cg|cf|cd|cc|ca|bz|by|bw|bv|bt|bs|br|bq|bo|bn|bm|bl|bj|bi|bh|bg|bf|be|bd|bb|ba|az|ax|aw|au|at|as|ar|aq|ao|an|am|al|ai|ag|af|ae|ad|ac)(?=[^0-9a-zA-Z@+-]|$))"),
                ...
                i = /(?:xn--[\-0-9a-z]+)/,
                n = (0, t.Z)(/(?:(?:[\-a-z0-9#{latinAccentChars}]+)\.)+(?:#{validGTLD}|#{validCCTLD}|#{validPunycode})/gi, { latinAccentChars: c.Z, validGTLD: r, validCCTLD: s, validPunycode: i }),
                l = {
                    toAscii: (u) => {
            ...
            var h = a(26883),
                b = a(721280);
            const m = (0, t.Z)("#{punct}#{spacesGroup}#{invalidCharsGroup}#{directionalMarkersGroup}", { punct: h.Z, spacesGroup: b.Z, invalidCharsGroup: f, directionalMarkersGroup: o }),
                ...
                x = (0, t.Z)(/(?:#{validSubdomain}*#{validDomainName}(?:#{validGTLD}|#{validCCTLD}|#{validPunycode}))/, { validDomainName: p, validSubdomain: v, validGTLD: r, validCCTLD: s, validPunycode: i }),
                w = /[0-9]+/,
                y = /\u0400-\u04FF/,
                ...
                A = /[-_.\/]$/,
                P = (0, t.Z)(/^https?:\/\/t\.co\/([a-z0-9]+)(?:\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?/, { validUrlQueryChars: L, validUrlQueryEndingChars: M }, "i"),
                            ...
                            if (t) {
                                ...
                                if (
                                    (c.replace(n, (u) => {
                                        ...
                                        return (l = e + u.length), (t = { url: u, indices: [i + e, i + l] }), a.push(t), "";
                                    }),
                                    null === t)
                                )
                                    continue;
                                s && ((t.url = d.replace(c, t.url)), (t.indices[1] = r));
                            }
                    }
                    return a;
                };
        ...
        776604: (u, e, a) => {
            ...
            function o({ borderRadius: u = "medium", children: e, className: a, title: t, trigger: c, withHandle: s, ...r }) {
            ...
            function h({ children: u, open: e, onOpenChange: a, trigger: t }) {
                return (0, r.a)("(min-width: 768px)") ? (0, d.jsx)(f.J, { open: e, onOpenChange: a, trigger: t, withArrow: !0, children: u }) : (0, d.jsx)(o, { open: e, onOpenChange: a, trigger: t, children: u });
            }
            const b = ({ items: u, open: e, onOpenChange: a, trigger: t }) => (0, d.jsx)(h, { trigger: t, open: e, onOpenChange: a, children: (0, d.jsx)("div", { className: "flex flex-col items-start justify-start rounded-sm gap-1", children: u.map((u) => (0, d.jsx)(s, { ...u }, u.text)) }) });
        },
        475694: (u, e, a) => {
            "use strict";
            a.d(e, { o: () => c });
            ...
            function c({ size: u = "medium", spacing: e = 12, urls: a, resolution: c, stackOrder: s = "descending" }) {
                return (0, d.jsx)("div", { className: "flex", style: { marginInlineStart: `${e}px` }, children: a.map((r, i) => (0, d.jsx)("div", { className: "rounded-full bg-background p-0.5", style: { marginInlineStart: -1 * e, zIndex: "ascending" === s ? i : a.length - i }, children: (0, d.jsx)(t.q, { size: u, shape: "circle", url: r, resolution: c }) }, `${r}${i}`)) });
            }
        },
        335944: (u, e, a) => {
            "use strict";
                                                                  ...
                                                                  (0, d.jsx)("div", {
                                                                      ...
                                                                      children:
                                                                          ...
                                                                          (0, d.jsx)("button", {
                                                                              ...
                                                                              className: "p-2 bg-black/30 text-white/75 hover:bg-black/50 hover:text-white transition-all [-webkit-tap-highlight-color:transparent] [tap-highlight-color:transparent] touch-none",
                                                                              "aria-label": "next",
                                                                              children: (0, d.jsx)(r.Z, { className: "w-4 h-4" }),
                                                                          }),
                                                                  }),
                                                              ],
                                                          }),
        ...
        849335: (u, e, a) => {
            ...
            const r = (0, c.forwardRef)(function ({ className: u, size: e = "medium", thumbClassName: a, ...c }, r) {
                return (0, d.jsx)(t.fC, { className: (0, s.cn)("focus-visible:ring-offset-background data-[state=checked]:bg-primary rounded-full focus-visible:ring-primary inline-flex shrink-0 cursor-pointer items-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=unchecked]:bg-gray-500", "medium" === e ? "h-3 w-10" : "h-2 w-6", u), ...c, ref: r, children: (0, d.jsx)(t.bU, { className: (0, s.cn)("rounded-full pointer-events-none block shadow-md ring-0 transition-transform data-[state=checked]:bg-blue-300 data-[state=unchecked]:bg-gray-50", "medium" === e ? "size-5 data-[state=checked]:translate-x-5 data-[state=checked]:rtl:-translate-x-5 data-[state=unchecked]:translate-x-0" : "size-3.5 data-[state=checked]:translate-x-2.5 data-[state=checked]:rtl:-translate-x-2.5 data-[state=unchecked]:translate-x-0", a) }) });
            });
        },
        338175: (u, e, a) => {
            "use strict";
        ...
        11099: (u, e, a) => {
            ...
            a.d(e, { Z: () => t });
            var d = a(552322);
            const t = (u) => (0, d.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "1em", height: "1em", display: "flex", fill: "currentColor", role: "img", ...u, children: (0, d.jsx)("path", { d: "M1.998 4.499c0-.828.671-1.499 1.5-1.499h17c.828 0 1.5.671 1.5 1.499v2.858l-10 4.545-10-4.547V4.499zm0 5.053V19.5c0 .828.671 1.5 1.5 1.5h17c.828 0 1.5-.672 1.5-1.5V9.554l-10 4.545-10-4.547z" }) });
        },
        903201: (u, e, a) => {
            "use strict";
            a.d(e, { Z: () => t });
        ...
        647665: (u, e, a) => {
            ...
            var d = a(202784),
                ...
                l = a(234622);
            a(470201);
            const o = i.default.create((u) => ({ root: { width: "100%", display: "block", height: "100dvh" }, narrowRoot: { height: "unset" }, webviewRoot: { height: "100%" } })),
                f = (u) => {
                    const e = (0, r.JS)(),
                        a = (0, s.useHistory)(),
                        { xChatPinMode: i, xChatPinRegister: f } = (0, s.useParams)();
                    return d.createElement(l.i, null, d.createElement(n.Z, { history: a, isFullWidth: !0, primaryContent: () => d.createElement(c.Z, { style: [o.root, e && o.narrowRoot] }, d.createElement(t.x, { mode: i ?? "new", settings: { path: "/i/chat" }, shouldRegister: "register" === f })), sidebarContent: null }));
                };
        },
        476644: (u, e, a) => {
            "use strict";
            ...
            var d = a(202784),
                ...
                l = a(234622),
                o = (a(434882), a(952793));
            const f = i.default.create((u) => ({ root: { width: "100%", display: "block", height: "100dvh" }, narrowRoot: { height: "unset" }, webviewRoot: { height: "100%" } })),
                h = (u) => {
                    const e = (0, r.JS)(),
                        a = (0, s.useHistory)(),
                        i = (0, o.hC)("rweb_xchat_debug_enabled");
                    return d.createElement(l.i, null, d.createElement(n.Z, { history: a, isFullWidth: !0, primaryContent: () => d.createElement(c.Z, { style: [f.root, e && f.narrowRoot] }, d.createElement(t.H, { settings: { path: "/i/chat", showDebugOptions: i } })), sidebarContent: null }));
                };
        },
        278003: (u, e, a) => {
            var d = a(482609),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-e96e9bea.e9fe30da.js.map
