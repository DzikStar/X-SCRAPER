    ...
    ["ondemand.XChat-e96e9bea"],
    {
        ...
        303676: (u, e, a) => {
            ...
            const c = /[#＃]/,
                ...
                h = /_\u200c\u200d\ua67e\u05be\u05f3\u05f4\uff5e\u301c\u309b\u309c\u30a0\u30fb\u3003\u0f0b\u0f0c\xb7/,
                b = (0, t.Z)(/(?:[#{bmpLetterAndMarks}#{bmpNumerals}#{hashtagSpecialChars}]|(?=#{nonBmpCodePairs})(?:#{astralLetterAndMarks}|#{astralNumerals}))/, { bmpLetterAndMarks: r, bmpNumerals: f, hashtagSpecialChars: h, nonBmpCodePairs: n, astralLetterAndMarks: i, astralNumerals: o }),
                m = /(?:[^\uD800-\uDFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF])/,
        ...
        196594: (u, e, a) => {
            ...
            const m = (0, t.Z)("#{punct}#{spacesGroup}#{invalidCharsGroup}#{directionalMarkersGroup}", { punct: h.Z, spacesGroup: b.Z, invalidCharsGroup: f, directionalMarkersGroup: o }),
                ...
                z = (0, t.Z)(/[\+\-a-z#{cyrillicLettersAndMarks}0-9=_#\/#{latinAccentChars}]|(?:#{validUrlBalancedParens})/i, { cyrillicLettersAndMarks: y, latinAccentChars: c.Z, validUrlBalancedParens: C }),
                j = (0, t.Z)("(?:(?:#{validGeneralUrlPathChars}*(?:#{validUrlBalancedParens}#{validGeneralUrlPathChars}*)*#{validUrlPathEndingChars})|(?:@#{validGeneralUrlPathChars}+/))", { validGeneralUrlPathChars: k, validUrlBalancedParens: C, validUrlPathEndingChars: z }, "i"),
                Z = (0, t.Z)(/(?:[^A-Za-z0-9@＠$#＃#{invalidCharsGroup}]|[#{directionalMarkersGroup}]|^)/, { invalidCharsGroup: f, directionalMarkersGroup: o }),
                L = /[a-z0-9!?\*'@\(\);:&=\+\$\/%#\[\]\-_\.,~|]/i,
                M = /[a-z0-9\-_&=#\/]/i,
                N = (0, t.Z)("((#{validUrlPrecedingChars})((https?:\\/\\/)?(#{validDomain})(?::(#{validPortNumber}))?(\\/#{validUrlPath}*)?(\\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?))", { validUrlPrecedingChars: Z, validDomain: x, validPortNumber: w, validUrlPath: j, validUrlQueryChars: L, validUrlQueryEndingChars: M }, "gi"),
                P = /[-_.\/]$/,
        ...
        721793: (u, e, a) => {
            ...
            a.d(e, { Z: () => t });
            var d = a(552322);
            const t = (u) => (0, d.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "1em", height: "1em", display: "flex", fill: "currentColor", role: "img", ...u, children: (0, d.jsx)("path", { d: "M11.996 2c-4.062 0-7.49 3.021-7.999 7.051L2.866 18H7.1c.463 2.282 2.481 4 4.9 4s4.437-1.718 4.9-4h4.236l-1.143-8.958C19.48 5.017 16.054 2 11.996 2zM9.171 18h5.658c-.412 1.165-1.523 2-2.829 2s-2.417-.835-2.829-2z" }) });
        },
        468428: (u, e, a) => {
            "use strict";
            a.d(e, { Z: () => t });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-e96e9bea.08c7c10a.js.map
