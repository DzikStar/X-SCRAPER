...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["ondemand.XChat-eca6a814"],
    {
        ...
        228805: (e, s, t) => {
            ...
            var ee = t(437712),
                se = t(651782);
            const te = ({ remainingReactions: e }) => {
                    const s = (0, o.useRef)(null),
                        t = (0, se.X)(s);
                    return (0, n.jsx)("div", { className: "relative", children: (0, n.jsx)(ee.J, { open: t, side: "top", trigger: (0, n.jsx)("div", { ref: s, className: "inline-flex items-center bg-gray-50 rounded-full px-2 pt-0.5 shadow-sm gap-1 border border-background cursor-pointer", children: (0, n.jsx)(d.x, { size: "body", children: "…" }) }), children: (0, n.jsx)("div", { className: "grid gap-2 p-2 pr-0 border border-border rounded-lg bg-background shadow-lg mx-auto [grid-template-columns:repeat(auto-fit,minmax(3rem,1fr))] max-w-[calc(6*3rem+5*0.5rem)]", children: e.map((e) => (0, n.jsxs)("div", { className: "flex flex-row items-center gap-2", children: [(0, n.jsx)(R.c, { emoji: e.reaction }), (0, n.jsx)(d.x, { size: "subtext2", weight: "bold", children: e.users.asJsReadonlyArrayView().length })] }, e.reaction)) }) }) });
                },
                ne = ({ emoji: e, count: s, users: t }) => {
                    const a = (0, o.useRef)(null),
                        r = (0, se.X)(a),
                        i = t.map((e) => e.name),
                        l = i.length > 1 ? `${i.slice(0, -1).join(", ")} and ${i[i.length - 1]}` : i[0];
                    return (0, n.jsx)("div", { className: "relative", children: (0, n.jsx)(ee.J, { open: r, side: "top", trigger: (0, n.jsxs)("div", { ref: a, className: "inline-flex items-center bg-gray-50 rounded-full px-2 pt-0.5 shadow-sm gap-1 border border-background cursor-pointer", children: [(0, n.jsx)("div", { className: "scale-80 mt-1", children: (0, n.jsx)(R.c, { emoji: e }) }), s > 1 && (0, n.jsx)(d.x, { size: "subtext2", weight: "bold", color: "gray700", children: s })] }), children: (0, n.jsxs)("div", { className: "flex flex-row items-center gap-2 p-2 border border-border rounded-lg bg-background shadow-lg", children: [(0, n.jsxs)(d.x, { size: "subtext2", weight: "medium", children: [l, " reacted with"] }), (0, n.jsx)(R.c, { emoji: e })] }) }) });
                },
                ae = ({ reaction: e }) => (0, n.jsx)(ne, { emoji: e.reaction, count: e.users.asJsReadonlyArrayView().length, users: e.users.asJsReadonlyArrayView() }),
                re = ({ isReceived: e, reactions: s }) => {
                    const t = s.slice(4);
                    return (0, n.jsxs)("div", { className: `relative flex ${e ? "flex-row-reverse" : "flex-row"} gap-1 justify-end -mt-[10px] mx-3`, children: [s.slice(0, 4).map((e) => (0, n.jsx)(ae, { reaction: e }, e.reaction)), t.length > 0 && (0, n.jsx)(te, { remainingReactions: t })] });
                };
            var ie = t(407602),
                oe = t(840489),
                le = t(463341);
            const ce = i.com.x.dms.chat.DmEvent,
                de = i.com.x.models.KMPRect,
                me = ({ messageItem: e, messageFocusedDialog: s, isMessageFocused: t, onEvent: a }) => {
                    ...
                    return (0, n.jsx)(ee.J, {
                        ...
                        trigger: (0, n.jsx)("div", {
                            ...
                            children: (0, n.jsx)(E.z, {
                                ...
                                icon: (0, n.jsx)(ie.Z, {}),
                                onClick: () => {
                                    null === s ? (l(!0), a(new ce.MessageDoubleClicked(e, new de(0, 0, 0, 0), !1))) : (l(!1), a(ce.MessageFocusedDialogDismissed));
                                },
                            }),
                        }),
                        open: null !== s && r,
                        onOpenChange: (e) => {
                            !e && r && (a(ce.MessageFocusedDialogDismissed), l(!1), d(!1));
                        },
                                ...
                                ? (0, n.jsx)(le.Bu, {
                                      children: (0, n.jsx)(R.h, {
                                          onReactionClicked: (s) => {
                                              ...
                                              a(new ce.ReactionPickerItemClick(t, e)), a(ce.MessageFocusedDialogDismissed), l(!1), d(!1);
                                          },
                                      ...
                                      children: [
                                                          ...
                                                          children: s.map((s) =>
                                                              (0, n.jsx)(
                                                                  "button",
                                                                  {
                                                                      ...
                                                                      onClick: () => {
                                                                          a(new ce.ReactionPickerItemClick(s, e));
                                                                      },
                                          ...
                                          (0, n.jsx)("div", {
                                              ...
                                              children: (0, n.jsx)("button", {
                                                  ...
                                                  onClick: () => {
                                                      a(ce.MessageReactionsClicked), d(!0);
                                                  },
            ...
            const pe = i.com.x.dms.chat.DmEvent,
                fe = ({ isReceived: e, replyPreview: s, replierInfo: t, onEvent: a }) => {
                    const r = t.id,
                        { senderId: o } = s,
                        l = t.displayName,
                    ...
                    return (0, n.jsxs)("div", { className: `flex flex-col mt-0.5 gap-1 ${e ? "items-start" : "items-end"} cursor-pointer`, onClick: () => s.sequenceNumber && a(new pe.ReplyBubbleClicked(s.sequenceNumber)), children: [s.showReplyNames && (0, n.jsxs)("div", { className: "flex gap-1 px-2 " + (e ? "text-start" : "text-end"), children: [(0, n.jsx)(ue.Z, { className: "inline-block text-text/70" }), (0, n.jsx)(d.x, { as: "span", className: "text-text/40", size: "subtext2", children: j })] }), s.attachment && (s.attachment instanceof i.com.x.dms.model.MessageItemAttachment.Media && s.attachment.type === i.com.x.models.dm.DmMediaType.File ? (0, n.jsx)(xe.K, { filename: s.attachment.filename, fileSize: s.attachment.fileSize }) : s.attachment instanceof i.com.x.dms.model.MessageItemAttachment.Media.FromServer && s.attachment.uriState instanceof i.com.x.dms.model.MediaUriState.ResolvedMedia && (0, n.jsx)(he.Et, { src: s.attachment.uriState.uri, type: s.attachment.type, dimensions: s.attachment.dimensions, className: "rounded-2xl !w-[25%] !h-[25%]", showAsStatic: !0 })), s.attachment instanceof i.com.x.dms.model.MessageItemAttachment.UrlCard && (0, n.jsx)(ge.C, { urlCard: s.attachment }), s.previewText && (0, n.jsx)("div", { className: "flex flex-col px-3 py-1.5 rounded-2xl gap-3 border " + (s.senderIsCurrentUser ? "border-primary/50" : "border-gray-400"), children: (0, n.jsx)(d.x, { color: s.senderIsCurrentUser ? "primary" : "gray900", size: "subtext1", numberOfLines: 2, children: s.previewText }) })] });
                };
            var je = t(305399),
                ve = t(515790),
                we = t(589259),
            ...
            function De({ participants: e }) {
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, n.jsx)("div", { className: t.length === e.length ? "max-h-[300px] overflow-y-auto" : "", children: (0, n.jsx)(be.I, { className: "mt-2", children: (0, n.jsx)(Ne.b, { participants: t, menuItemsMap: new Map(), handleParticipantClicked: () => {}, handleParticipantMenuButtonClicked: () => {} }) }) }),
                    ],
                });
            }
            const Se = ({ participant: e }) => (e && e.user ? (0, n.jsxs)("div", { className: "flex-1 flex gap-3 items-center py-3", children: [(0, n.jsx)(Ie.s, { url: e.user.profileImageUrl, size: "medium" }), (0, n.jsx)(we.R, { name: e.user.displayName, badges: (0, Ce.r)(e.user), weight: "normal" })] }) : null);
            function Re({ messageDetailsState: e, onDismiss: s }) {
                ...
                return (
                    ...
                    (0, n.jsx)(ye.h, {
                        ...
                        trigger: (0, n.jsx)("div", {}),
                        children: (0, n.jsx)("div", { className: "p-4 max-w-[750px] min-w-[300px] mx-auto border border-gray-200 rounded-lg", children: a?.details && (0, n.jsxs)("div", { className: "flex flex-col gap-2 mt-2", children: [c.length > 0 && (0, n.jsx)(De, { participants: c }), (0, n.jsx)("div", { className: "flex flex-row gap-2", children: (0, n.jsx)(d.x, { size: "subtext1", weight: "medium", children: t("Sent by") }) }), (0, n.jsx)("div", { className: "px-4 rounded-xl bg-gray-0", children: (0, n.jsx)(Se, { participant: a.details.sentBy }) })] }) }),
                    })
                );
            }
            var ke = t(167285),
                Ee = t(242782);
            const Me = ({ isReceived: e, timestamp: s, hasTTL: t, participants: a, showDetails: r, readStatus: i, setShowDetails: o }) => (0, n.jsxs)("div", { className: "flex items-center ml-auto shrink-0 gap-1", children: [(0, n.jsx)(d.x, { size: "subtext3", color: e ? "gray700" : "white", children: (0, ke.H)(s) }), t && (0, n.jsx)(ve.Z, { className: "w-3.5 h-3.5 " + (e ? "text-text/60" : "text-white/60") }), !e && (a.length > 0 ? (0, n.jsx)(ye.h, { open: r, onOpenChange: o, trigger: (0, n.jsx)("div", { className: "z-20 -ms-[2px] cursor-pointer", children: (0, n.jsx)(Ee.Z, { className: "w-4 h-4 text-white" }) }), children: (0, n.jsx)("div", { className: "p-4 max-w-[500px] min-w-[300px] mx-auto border border-gray-200 rounded-lg", children: (0, n.jsx)(De, { participants: a }) }) }) : "Read" === i ? (0, n.jsx)(Ee.Z, { className: "w-4 h-4 text-white" }) : null)] });
            function $e({ messageItem: e, messageFocusedDialog: s, showMessageInfoDialog: t, messageInfoDialog: a, messageInfoDialogDismissed: r, onEvent: l }) {
                const { t: c } = (0, u.$G)(),
                    m = (0, je.a)("(max-width: 768px)"),
                        ...
                        (0, n.jsx)("div", {
                            ...
                            children: (0, n.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, n.jsxs)("div", { className: "flex flex-col gap-1 " + (x ? "items-start" : "items-end"), style: { gridArea: "content" }, children: [e.replyPreview && e.senderInfo && e.senderInfo.user && (0, n.jsx)(fe, { replyPreview: e.replyPreview, replierInfo: e.senderInfo.user, isReceived: x, onEvent: l }), e.attachment ? (0, n.jsxs)("div", { className: "flex max-w-1/3 overflow-hidden rounded-2xl relative", children: [(0, n.jsx)(_.P, { attachment: e.attachment, isReceived: x, onEvent: l, className: "rounded-2xl" }), y && !h && (0, n.jsx)("div", { className: "absolute bottom-2 right-2 rounded-full text-gray-700 shadow-md", children: (0, n.jsx)(ve.Z, { className: "w-4 h-4" }) })] }) : null, e.supersizeEmoji && (0, n.jsx)("div", { className: "flex gap-2 px-1 tracking-widest", children: e.textContent?.match(/(\p{Emoji_Presentation}|\p{Emoji}\uFE0F)/gu)?.map((e, s) => (0, n.jsx)(R.c, { emoji: e }, `${e}-${s}`)) }), h ? (0, n.jsx)("div", { className: "flex justify-end px-4 py-2 rounded-2xl " + (e.supersizeEmoji ? "" : x ? "bg-gray-100" : "bg-blue-500"), children: e.textContent && (0, n.jsx)(Y, { textContent: e.textContent, textEntities: e.textEntities.asJsReadonlyArrayView(), isReceived: x, messageFooter: b && (0, n.jsx)(Me, { isReceived: x, timestamp: e.createdTimestamp.epochSeconds, hasTTL: y, readStatus: e?.messageInfo?.readStatus?.name, participants: w, showDetails: j, setShowDetails: v }) }) }) : null] }),
                                    (0, n.jsxs)("div", {
                                        className: `${m ? "w-16" : "w-32"} flex items-center gap-1 ${x ? "flex-row" : "flex-row-reverse"}`,
                                        style: { gridArea: "actions" },
                                        children: [
                                            (0, n.jsx)(me, { messageItem: e, messageFocusedDialog: s, isMessageFocused: g, onEvent: l }),
                                    ...
                                    (0, n.jsxs)("div", { className: "flex flex-col", style: { gridArea: "message-info" }, children: [e.reactions && e.reactions.asJsReadonlyArrayView().length > 0 && (0, n.jsx)(re, { isReceived: x, reactions: e.reactions.asJsReadonlyArrayView() }), e.messageInfo && (0, n.jsx)(O, { messageInfo: e.messageInfo, showSignatureVerificationIssuesIcon: e.showSignatureVerificationIssuesIcon, isReceived: x })] }),
                                ],
                            }),
                        }),
                    ],
            ...
            function Ue({ sendingStatusItem: e }) {
                return "Failed" === e.status.name ? (0, n.jsxs)("div", { className: "flex justify-end py-1 px-4 gap-1 me-2", children: [(0, n.jsx)(d.x, { size: "subtext2", color: "red500", children: "Failed" }), (0, n.jsx)(T.Z, { width: "14", height: "14", className: "text-red-500" })] }) : null;
            }
            function Ae({ chatItem: e, messageFocusedDialog: s, onEvent: t, showMessageInfoDialog: a, messageInfoDialog: r, messageInfoDialogDismissed: o }) {
                return e instanceof i.com.x.dms.model.MessageItemReceived || e instanceof i.com.x.dms.model.MessageItemSent || e instanceof i.com.x.dms.model.MessageItemPending ? (0, n.jsx)($e, { messageItem: e, messageFocusedDialog: s, onEvent: t, showMessageInfoDialog: a, messageInfoDialog: r, messageInfoDialogDismissed: o }) : e instanceof i.com.x.dms.model.SendingStatusItem ? (0, n.jsx)(Ue, { sendingStatusItem: e }) : e instanceof i.com.x.dms.model.InformationalItem ? (0, n.jsx)(S, { informationalItem: e }) : null;
            }
            const Fe = (0, o.memo)(Ae);
            var Te = t(97759);
            const ze = ({ component: e, numItems: s, composerHeight: t }) => {
                const { apiRef: a, addOnScrollListener: r } = (0, le.Nb)(),
                    [l, c] = (0, o.useState)(!1),
                    d = (0, o.useCallback)(() => {
                        const e = a.current;
                        if (!e) return;
            ...
            var Pe = t(676337);
            const Ve = i.com.x.dms.chat.DmEvent,
                Je = i.com.x.dms.model.MessageItemSent,
                Le = i.com.x.dms.model.MessageItemReceived,
            ...
            function Ze({ component: e, isTypingIndicatorShown: s, composerHeight: t }) {
                const c = (0, l._)(e.state),
                    ...
                    { apiRef: x, dispatchOnScroll: h } = (0, le.Nb)(),
                    g = (0, o.useRef)(!1),
                    ...
                    f = (0, o.useCallback)(() => {
                        if (x.current && m) {
                            const s = x.current.findStartIndex(),
                                ...
                                n = d
                                    .slice(s, t + 1)
                                    .filter((e) => e instanceof Le || e instanceof Je)
                                                  ...
                                                  return (0, n.jsx)(
                                                      Fe,
                                                      {
                                                          ...
                                                          messageInfoDialogDismissed: () => {
                                                              e.onEvent(Ve.MessageDetailsDismissed);
                                                          },
                                                      },
                                                      s.uniqueKey,
                                                  );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-eca6a814.8d9ac31a.js.map
