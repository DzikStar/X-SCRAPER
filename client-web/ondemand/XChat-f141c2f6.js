    ...
    ["ondemand.XChat-f141c2f6"],
    {
        ...
        922150: (e, s, r) => {
            ...
            const x = n.com.x.dms.pin.PinEntryTitle,
                ...
                h = n.com.x.dms.pin.PinEntryError;
            function p({ component: e }) {
                const { t: s } = (0, m.$G)();
                const r = (0, u.a)("(max-width: 768px)"),
                    i = (0, l._)(e.state),
                    p = (0, a.useRef)(null);
                (0, a.useEffect)(() => {
                ...
                return i.isProcessing
                    ? (0, t.jsx)("div", { className: "flex w-full h-screen items-center", children: (0, t.jsx)(o.P, {}) })
                    : (0, t.jsxs)("div", {
                          className: `flex flex-col h-screen w-full ${r ? "items-start" : "items-center"} flex-grow gap-4 py-12 px-12`,
                          onClick: () => {
                              p.current && p.current.focus();
                          },
                          children: [
            ...
            function v({ mode: e, shouldRegister: s }) {
                const [r, o] = (0, a.useState)(null),
                    l = (0, i.n)(),
                    u = (0, f.s)();
                return (
                    (0, a.useEffect)(() => {
                        const r = new n.com.x.export.CancellationSignal(),
                            t = l.dmPinEntryComponent(
                                (function (e, s) {
                                    switch (e) {
                                        case "recovery":
                                            return y.Recovery;
                    ...
                    (0, t.jsx)(t.Fragment, { children: null != r ? (0, t.jsx)(p, { component: r }) : (0, t.jsx)(c.x, { children: "Loading" }) })
                );
            }
        },
        517922: (e, s, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.XChat-f141c2f6.6179bc6a.js.map
