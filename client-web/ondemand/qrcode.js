    ...
    ["ondemand.qrcode"],
    {
            ...
            var e = {
                single_source_shortest_paths: function (t, n, r) {
                    ...
                    var s,
                        ...
                        h,
                        f,
                        g = e.PriorityQueue.make();
                    for (g.push(n, 0); !g.empty(); ) for (u in ((a = (s = g.pop()).value), (c = s.cost), (l = t[a] || {}))) l.hasOwnProperty(u) && ((h = c + l[u]), (f = i[u]), (void 0 === i[u] || f > h) && ((i[u] = h), g.push(u, h), (o[u] = a)));
        ...
        374061: (t, e, n) => {
            ...
            function a(t, e, n, i, s) {
                ...
                2 === u ? ((s = n), (n = e), (e = i = void 0)) : 3 === u && (e.getContext && void 0 === s ? ((s = i), (i = void 0)) : ((s = i), (i = n), (n = e), (e = void 0)));
                try {
        ...
        244812: (t, e, n) => {
            const r = n(361850).getSymbolSize;
            ...
            (e.isValid = function (t) {
                ...
                (e.getPenaltyN1 = function (t) {
                    ...
                    for (let u = 0; u < e; u++) {
                        ...
                        for (let c = 0; c < e; c++) {
                            let e = t.get(u, c);
                            e === s ? o++ : (o >= 5 && (r += n + (o - 5)), (s = e), (o = 1)), (e = t.get(c, u)), e === a ? i++ : (i >= 5 && (r += n + (i - 5)), (a = e), (i = 1));
                        }
        ...
        410585: (t, e, n) => {
            ...
            function m(t, e, n) {
                ...
                return (function (t, e, n) {
                    const o = r.getSymbolTotalCodewords(e),
                        i = l.getTotalCodewordsCount(e, n),
                        s = o - i,
                    ...
                    let v,
                        I,
                        M = 0;
                    for (v = 0; v < A; v++) for (I = 0; I < a; I++) v < E[I].length && (B[M++] = E[I][v]);
                    for (v = 0; v < p; v++) for (I = 0; I < a; I++) B[M++] = y[I][v];
                    return B;
                })(o, t, e);
            }
            function E(t, e, n, o) {
                ...
                const l = f.getBestVersionForData(i, n);
                ...
                return (
                    ...
                    isNaN(o) && (o = c.getBestMask(d, w.bind(null, d, n))),
                    c.applyMask(o, d),
                    w(d, n, o),
                    { modules: d, version: e, errorCorrectionLevel: n, maskPattern: o, segments: i }
                );
            }
            e.create = function (t, e) {
                ...
                let n,
                    i,
                    s = o.M;
                return void 0 !== e && ((s = o.from(e.errorCorrectionLevel, o.M)), (n = f.from(e.version)), (i = c.from(e.maskPattern)), e.toSJISFunc && r.setToSJISFunction(e.toSJISFunc)), E(t, n, s, i);
            };
        },
        341806: (t, e, n) => {
            const r = n(859792);
        ...
        956041: (t, e, n) => {
            ...
            function f(t, e, n) {
                const r = [];
                let o;
                for (; null !== (o = t.exec(n)); ) r.push({ data: o[0], index: o.index, mode: e, length: o[0].length });
                return r;
            }
            function g(t) {
                const e = f(u.NUMERIC, r.NUMERIC, t),
                    n = f(u.ALPHANUMERIC, r.ALPHANUMERIC, t);
                let o, i;
                c.isKanjiModeEnabled() ? ((o = f(u.BYTE, r.BYTE, t)), (i = f(u.KANJI, r.KANJI, t))) : ((o = f(u.BYTE_KANJI, r.BYTE, t)), (i = []));
                return e
                    .concat(n, o, i)
                    .sort(function (t, e) {
                ...
                (e.fromString = function (t, n) {
                    const o = (function (t) {
                            ...
                            for (let n = 0; n < t.length; n++) {
                                ...
                                switch (o.mode) {
                                    case r.NUMERIC:
                                        e.push([o, { data: o.data, mode: r.ALPHANUMERIC, length: o.length }, { data: o.data, mode: r.BYTE, length: o.length }]);
                                        break;
                                    case r.ALPHANUMERIC:
                            ...
                            for (let s = 0; s < t.length; s++) {
                                ...
                                for (let t = 0; t < a.length; t++) {
                                    ...
                                    for (let t = 0; t < i.length; t++) {
                                        const s = i[t];
                                        n[s] && n[s].node.mode === c.mode ? ((o[s][l] = d(n[s].lastCount + c.length, c.mode) - d(n[s].lastCount, c.mode)), (n[s].lastCount += c.length)) : (n[s] && (n[s].lastCount = c.length), (o[s][l] = d(c.length, c.mode) + 4 + r.getCharCountIndicator(c.mode, e)));
                                    }
                                }
                                i = u;
                            }
                        ...
                        (function (t, e, n) {
                            ...
                            for (let u = 0; u < t.length; u++) {
                                const c = Math.floor(u % e),
                                    l = Math.floor(u / e);
                                c || s || (s = !0), t[u] ? (a++, (u > 0 && c > 0 && t[u - 1]) || ((r += s ? i("M", c + n, 0.5 + l + n) : i("m", o, 0)), (o = 0), (s = !1)), (c + 1 < e && t[u + 1]) || ((r += i("h", a)), (a = 0))) : o++;
                            }
                            return r;
                        })(u, a, s.margin) +
                        '"/>',
                    f = 'viewBox="0 0 ' + c + " " + c + '"',
                    g = '<svg xmlns="http://www.w3.org/2000/svg" ' + (s.width ? 'width="' + s.width + '" height="' + s.width + '" ' : "") + f + ' shape-rendering="crispEdges">' + l + h + "</svg>\n";
        ...
        309283: (t, e) => {
            ...
            (e.getOptions = function (t) {
                ...
                const e = void 0 === t.margin || null === t.margin || t.margin < 0 ? 4 : t.margin,
                    ...
                    o = t.scale || 4;
                return { width: r, scale: r ? 4 : o, margin: e, color: { dark: n(t.color.dark || "#000000ff"), light: n(t.color.light || "#ffffffff") }, type: t.type, rendererOpts: t.rendererOpts || {} };
            }),
                    ...
                    for (let e = 0; e < a; e++)
                        for (let n = 0; n < a; n++) {
                            ...
                            if (e >= u && n >= u && e < a - u && n < a - u) {
                                h = c[i[Math.floor((e - u) / s) * o + Math.floor((n - u) / s)] ? 1 : 0];
                            }
                            (t[l++] = h.r), (t[l++] = h.g), (t[l++] = h.b), (t[l] = h.a);
                        }
                });
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/ondemand.qrcode.deeb841a.js.map
