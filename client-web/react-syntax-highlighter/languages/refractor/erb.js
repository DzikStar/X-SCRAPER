...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["react-syntax-highlighter_languages_refractor_erb", "react-syntax-highlighter_languages_refractor_markupTemplating", "react-syntax-highlighter_languages_refractor_ruby"],
    {
        331386: (e, n, t) => {
            var r = t(143811),
                a = t(246546);
            function i(e) {
                e.register(r),
                    e.register(a),
                    (function (e) {
                        (e.languages.erb = { delimiter: { pattern: /^(\s*)<%=?|%>(?=\s*$)/, lookbehind: !0, alias: "punctuation" }, ruby: { pattern: /\s*\S[\s\S]*/, alias: "language-ruby", inside: e.languages.ruby } }),
            ...
            (e.exports = i), (i.displayName = "erb"), (i.aliases = []);
        },
        246546: (e) => {
            function n(e) {
                !(function (e) {
                            ...
                            value: function (t, r, a, i) {
                                if (t.language === r) {
                                    ...
                                    (t.code = t.code.replace(a, function (e) {
                                        ...
                                        for (var a, o = s.length; -1 !== t.code.indexOf((a = n(r, o))); ) ++o;
                                        return (s[o] = e), a;
                                    })),
                        ...
                        tokenizePlaceholders: {
                            value: function (t, r) {
                                if (t.language === r && t.tokenStack) {
                                    ...
                                    !(function s(o) {
                                        for (var l = 0; l < o.length && !(a >= i.length); l++) {
                                            var u = o[l];
                                            if ("string" == typeof u || (u.content && "string" == typeof u.content)) {
                                                ...
                                                if (b > -1) {
                                                    ...
                                                    var f = d.substring(0, b),
                                                        m = new e.Token(r, e.tokenize(c, t.grammar), "language-" + r, c),
                                                        y = d.substring(b + p.length),
                                                        h = [];
                                                    f && h.push.apply(h, s([f])), h.push(m), y && h.push.apply(h, s([y])), "string" == typeof u ? o.splice.apply(o, [l, 1].concat(h)) : (u.content = h);
                                                }
            ...
            function n(e) {
                !(function (e) {
                    ...
                    e.languages.insertBefore("ruby", "keyword", {
                        "regex-literal": [
                            { pattern: RegExp(/%r/.source + t + /[egimnosux]{0,6}/.source), greedy: !0, inside: { interpolation: n, regex: /[\s\S]+/ } },
                        ...
                        e.languages.insertBefore("ruby", "string", {
                            "string-literal": [
                                { pattern: RegExp(/%[qQiIwWs]?/.source + t), greedy: !0, inside: { interpolation: n, string: /[\s\S]+/ } },
                            ...
                            "command-literal": [
                                { pattern: RegExp(/%x/.source + t), greedy: !0, inside: { interpolation: n, command: { pattern: /[\s\S]+/, alias: "string" } } },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/react-syntax-highlighter_languages_refractor_erb.89928c4a.js.map
