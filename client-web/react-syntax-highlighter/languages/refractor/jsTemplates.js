            ...
            function t(e) {
                !(function (e) {
                    var t = e.languages.javascript["template-string"],
                        ...
                        s = r.pattern.source;
                    function i(t, r) {
                        if (e.languages[t]) return { pattern: RegExp("((?:" + r + ")\\s*)" + n), lookbehind: !0, greedy: !0, inside: { "template-punctuation": { pattern: /^`|`$/, alias: "string" }, "embedded-code": { pattern: /[\s\S]+/, alias: t } } };
                    }
                    function o(e, t) {
                    ...
                    function l(t) {
                        ...
                        if (3 === s.length) {
                            var i = [1, 1];
                            i.push.apply(i, p(s[1], e.languages.javascript, "javascript")), s.splice.apply(s, i);
                        }
                        return new e.Token("interpolation", s, r.alias, t);
                    }
                    function u(t, n, r) {
                        var a = e.tokenize(t, { interpolation: { pattern: RegExp(s), lookbehind: !0 } }),
                            i = 0,
                            u = {},
                            c = p(
                                a
                                    .map(function (e) {
                                        ...
                                        for (var n, a = e.content; -1 !== t.indexOf((n = o(i++, r))); );
                                        return (u[n] = a), n;
                                    })
                                    .join(""),
                                n,
