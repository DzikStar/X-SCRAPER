...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["react-syntax-highlighter_languages_refractor_latte", "react-syntax-highlighter_languages_refractor_markupTemplating", "react-syntax-highlighter_languages_refractor_php"],
    {
        623332: (e, a, t) => {
            var n = t(246546),
                i = t(196974);
            function s(e) {
                e.register(n),
                    e.register(i),
                    (function (e) {
                        e.languages.latte = { comment: /^\{\*[\s\S]*/, "latte-tag": { pattern: /(^\{(?:\/(?=[a-z]))?)(?:[=_]|[a-z]\w*\b(?!\())/i, lookbehind: !0, alias: "important" }, delimiter: { pattern: /^\{\/?|\}$/, alias: "punctuation" }, php: { pattern: /\S(?:[\s\S]*\S)?/, alias: "language-php", inside: e.languages.php } };
                        var a = e.languages.extend("markup", {});
                        e.languages.insertBefore("inside", "attr-value", { "n-attr": { pattern: /n:[\w-]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+))?/, inside: { "attr-name": { pattern: /^[^\s=]+/, alias: "important" }, "attr-value": { pattern: /=[\s\S]+/, inside: { punctuation: [/^=/, { pattern: /^(\s*)["']|["']$/, lookbehind: !0 }], php: { pattern: /\S(?:[\s\S]*\S)?/, inside: e.languages.php } } } } } }, a.tag),
                            e.hooks.add("before-tokenize", function (t) {
                                if ("latte" === t.language) {
                                    e.languages["markup-templating"].buildPlaceholders(t, "latte", /\{\*[\s\S]*?\*\}|\{[^'"\s{}*](?:[^"'/{}]|\/(?![*/])|("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|\/\*(?:[^*]|\*(?!\/))*\*\/)*\}/g), (t.grammar = a);
                                }
                            }),
                            e.hooks.add("after-tokenize", function (a) {
                                e.languages["markup-templating"].tokenizePlaceholders(a, "latte");
                            });
                    })(e);
            }
            (e.exports = s), (s.displayName = "latte"), (s.aliases = []);
        },
        246546: (e) => {
            function a(e) {
                !(function (e) {
                            ...
                            value: function (t, n, i, s) {
                                if (t.language === n) {
                                    ...
                                    (t.code = t.code.replace(i, function (e) {
                                        ...
                                        for (var i, l = r.length; -1 !== t.code.indexOf((i = a(n, l))); ) ++l;
                                        return (r[l] = e), i;
                                    })),
                        ...
                        tokenizePlaceholders: {
                            value: function (t, n) {
                                if (t.language === n && t.tokenStack) {
                                    ...
                                    !(function r(l) {
                                        for (var o = 0; o < l.length && !(i >= s.length); o++) {
                                            var p = l[o];
                                            if ("string" == typeof p || (p.content && "string" == typeof p.content)) {
                                                ...
                                                if (g > -1) {
                                                    ...
                                                    var f = u.substring(0, g),
                                                        h = new e.Token(n, e.tokenize(c, t.grammar), "language-" + n, c),
                                                        m = u.substring(g + b.length),
                                                        y = [];
                                                    f && y.push.apply(y, r([f])), y.push(h), m && y.push.apply(y, r([m])), "string" == typeof p ? l.splice.apply(l, [o, 1].concat(y)) : (p.content = y);
                                                }
                                            } else p.content && r(p.content);
                                        }
                                        return l;
                                    })(t.tokens);
                                }
                    ...
                    (function (e) {
                        ...
                        var r = { pattern: /\{\$(?:\{(?:\{[^{}]+\}|[^{}]+)\}|[^{}])+\}|(^|[^\\{])\$+(?:\w+(?:\[[^\r\n\[\]]+\]|->\w+)?)/, lookbehind: !0, inside: e.languages.php },
                            l = [
                                ...
                                { pattern: /<<<(?:"([^"]+)"[\r\n](?:.*[\r\n])*?\1;|([a-z_]\w*)[\r\n](?:.*[\r\n])*?\2;)/i, alias: "heredoc-string", greedy: !0, inside: { delimiter: { pattern: /^<<<(?:"[^"]+"|[a-z_]\w*)|[a-z_]\w*;$/i, alias: "symbol", inside: { punctuation: /^<<<"?|[";]$/ } }, interpolation: r } },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/react-syntax-highlighter_languages_refractor_latte.90c04b3a.js.map
