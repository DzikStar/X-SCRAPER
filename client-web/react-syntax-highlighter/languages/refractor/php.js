...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["react-syntax-highlighter_languages_refractor_php", "react-syntax-highlighter_languages_refractor_markupTemplating"],
    {
        246546: (e) => {
            function a(e) {
                !(function (e) {
                                    ...
                                    !(function r(l) {
                                        for (var o = 0; o < l.length && !(i >= s.length); o++) {
                                            ...
                                            if ("string" == typeof d || (d.content && "string" == typeof d.content)) {
                                                var c = s[i],
                                                    p = t.tokenStack[c],
                                                    b = "string" == typeof d ? d : d.content,
                                                    u = a(n, c),
                                                    g = b.indexOf(u);
                                                if (g > -1) {
                                                    ++i;
                                                    var f = b.substring(0, g),
                                                        y = new e.Token(n, e.tokenize(p, t.grammar), "language-" + n, p),
                                                        h = b.substring(g + u.length),
                                                        m = [];
                                                    f && m.push.apply(m, r([f])), m.push(y), h && m.push.apply(m, r([h])), "string" == typeof d ? l.splice.apply(l, [o, 1].concat(m)) : (d.content = m);
                                                }
                                            } else d.content && r(d.content);
                                        }
                                        return l;
                                    })(t.tokens);
                                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/react-syntax-highlighter_languages_refractor_php.0523dc2a.js.map
