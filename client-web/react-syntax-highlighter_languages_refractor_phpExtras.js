...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["react-syntax-highlighter_languages_refractor_phpExtras", "react-syntax-highlighter_languages_refractor_markupTemplating", "react-syntax-highlighter_languages_refractor_php"],
    {
        246546: (e) => {
            function a(e) {
                !(function (e) {
                                    ...
                                    !(function r(l) {
                                        for (var o = 0; o < l.length && !(i >= s.length); o++) {
                                            ...
                                            if ("string" == typeof p || (p.content && "string" == typeof p.content)) {
                                                var d = s[i],
                                                    c = t.tokenStack[d],
                                                    b = "string" == typeof p ? p : p.content,
                                                    u = a(n, d),
                                                    g = b.indexOf(u);
                                                if (g > -1) {
                                                    ++i;
                                                    var f = b.substring(0, g),
                                                        h = new e.Token(n, e.tokenize(c, t.grammar), "language-" + n, c),
                                                        y = b.substring(g + u.length),
                                                        m = [];
                                                    f && m.push.apply(m, r([f])), m.push(h), y && m.push.apply(m, r([y])), "string" == typeof p ? l.splice.apply(l, [o, 1].concat(m)) : (p.content = m);
                                                }
        ...
        691791: (e, a, t) => {
            var n = t(196974);
            function i(e) {
                e.register(n), e.languages.insertBefore("php", "variable", { this: { pattern: /\$this\b/, alias: "keyword" }, global: /\$(?:GLOBALS|HTTP_RAW_POST_DATA|_(?:COOKIE|ENV|FILES|GET|POST|REQUEST|SERVER|SESSION)|argc|argv|http_response_header|php_errormsg)\b/, scope: { pattern: /\b[\w\\]+::/, inside: { keyword: /\b(?:parent|self|static)\b/, punctuation: /::|\\/ } } });
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/react-syntax-highlighter_languages_refractor_phpExtras.1214eeca.js.map
