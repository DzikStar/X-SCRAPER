...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["react-syntax-highlighter_languages_refractor_t4Vb", "react-syntax-highlighter_languages_refractor_basic", "react-syntax-highlighter_languages_refractor_t4Templating", "react-syntax-highlighter_languages_refractor_vbnet"],
    {
        21562: (E) => {
            function T(E) {
        ...
        320179: (E) => {
            function T(E) {
                !(function (E) {
                    function T(E, T, R) {
                        return { pattern: RegExp("<#" + E + "[\\s\\S]*?#>"), alias: "block", inside: { delimiter: { pattern: RegExp("^<#" + E + "|#>$"), alias: "important" }, content: { pattern: /[\s\S]+/, inside: T, alias: R } } };
                    }
        ...
        225414: (E, T, R) => {
            var N = R(320179),
                I = R(20886);
            function O(E) {
                E.register(N), E.register(I), (E.languages["t4-vb"] = E.languages["t4-templating"].createT4("vbnet"));
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/react-syntax-highlighter_languages_refractor_t4Vb.1cc1ca8a.js.map
