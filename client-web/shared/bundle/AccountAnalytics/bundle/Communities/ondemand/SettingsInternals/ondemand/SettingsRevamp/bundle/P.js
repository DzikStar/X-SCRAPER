...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AccountAnalytics~bundle.Communities~ondemand.SettingsInternals~ondemand.SettingsRevamp~bundle.P"],
    {
        606161: (e, n, r) => {
            ...
            e.exports = {
                loadQuery: function (e, n, r, o, y) {
                    ...
                    var m,
                        ...
                        _,
                        w,
                        C = null !== (p = null == o ? void 0 : o.fetchPolicy) && void 0 !== p ? p : "store-or-network",
                        P = (0, t.default)((0, t.default)({}, null == o ? void 0 : o.networkCacheConfig), {}, { force: !0 }),
                        g = !1,
                        Q = function (n, r) {
                        ...
                        E = function (n) {
                            ...
                            var t = new l(),
                                ...
                                o = i(e, u, function () {
                                    return e.getNetwork().execute(n, r, P);
                                }).subscribe({
                                    error: function (e) {
                                        (q = e), t.error(e);
                                    },
                    ...
                    if ("PreloadableConcreteRequest" === n.kind) {
                        ...
                        if (null != I) D(I);
                            ...
                            var T = "store-only" === C ? null : E(k),
                                A = c.onLoad(w, function (n) {
                                    _();
                                    var t = s(n, r, P);
                                    (m = e.retain(t)),
                                        null != T &&
                        ...
                        var O = f(n);
                        (w = null != (k = O.params).cacheID ? k.cacheID : k.id), D(O);
                    }
                    var F = !1,
                        W = !1,
                        L = !1,
        ...
        928123: (e, n, r) => {
            ...
            e.exports = function (e, n, r) {
                var a,
                    ...
                    v = n.source,
                    y = n.variables,
                    p = n.networkCacheConfig,
                    m = u(e, y, p);
                if ("PreloadedQuery_DEPRECATED" === n.kind)
                    m.request.node.params.name !== n.name && i(!1),
                        (a = {
                            componentDisplayName: "usePreloadedQuery()",
                            fetchKey: f,
                            fetchObservable: c(s, m.request.identifier, function () {
                                return s === n.environment && null != v ? s.executeWithSource({ operation: m, source: v }) : s.execute({ operation: m });
                            }),
                            fetchPolicy: d,
                            query: m,
                    ...
                    var h = l(s, m);
                    a = { componentDisplayName: "usePreloadedQuery()", fetchObservable: null != v && s === n.environment ? v.ifEmpty(h) : (n.environment, h), fetchKey: f, fetchPolicy: d, query: m, renderPolicy: null == r ? void 0 : r.UNSTABLE_renderPolicy };
                }
                return t(a);
            };
        },
                ...
                return y.ENABLE_ACTIVITY_COMPATIBILITY
                    ...
                    : (function (e, n) {
                          ...
                          return (
                              ...
                              s(
                                  function () {
                                      if (!0 === g.current) return (g.current = !1), void ("NullQueryReference" !== p.kind && P(p.variables, { fetchPolicy: p.fetchPolicy, networkCacheConfig: p.networkCacheConfig }));
                                      var n = v.current;
                                      if (c.current) {
                                          var r,
                                              u = (0, t.default)(n);
                              ...
                              ["NullQueryReference" === p.kind ? null : p, P, C]
                          );
                      })(e, n);
            };
        },
        667368: (e, n, r) => {
            ...
            e.exports = function (e, n) {
                var r = null != n ? n : y,
                    ...
                    v = o(),
                    m = f(null);
                null == m.current && (m.current = new Set([r]));
                var h,
                    b = d(function () {
                        return r;
                    }),
                    ...
                    C = w[0],
                    P = w[1];
                r !== C && (null === (h = m.current) || void 0 === h || h.add(r), P(r), _(r));
                var g = c(
                        function () {
                            var e;
                            v.current && (null === (e = m.current) || void 0 === e || e.add(y), _(y));
                        },
                        [v],
                    ),
                    Q = c(
                        function (n, r) {
                            ...
                            if (v.current) {
                                ...
                                null === (o = m.current) || void 0 === o || o.add(c), _(c);
                            }
                        },
                        [a, e, _, v],
                    ),
                    R = c(function (e, n) {
                        var r,
                            u,
                            o = null !== (r = m.current) && void 0 !== r ? r : new Set(),
                            i = (0, t.default)(o);
                        try {
                            for (i.s(); !(u = i.n()).done; ) {
                                var a = u.value;
                                a !== n && "NullQueryReference" !== a.kind && (p(e) ? a.dispose && a.dispose() : a.releaseQuery && a.releaseQuery());
                            }
                        } catch (e) {
                            i.e(e);
                        } finally {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~bundle.Communities~ondemand.SettingsInternals~ondemand.SettingsRevamp~bundle.P.c46040da.js.map
