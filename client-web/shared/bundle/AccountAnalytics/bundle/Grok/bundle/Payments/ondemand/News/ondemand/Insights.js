            ...
            /*! decimal.js-light v2.5.1 https://github.com/MikeMcl/decimal.js-light/LICENCE */ !(function () {
                ...
                (w.absoluteValue = w.abs =
                    ...
                    (w.squareRoot = w.sqrt =
                        function () {
                            ...
                            for (r = O(c), u = !1, 0 == (i = Math.sqrt(+c)) || i == 1 / 0 ? (((e = N(c.d)).length + r) % 2 == 0 && (e += "0"), (i = Math.sqrt(e)), (r = l((r + 1) / 2) - (r < 0 || r % 2)), (n = new h((e = i == 1 / 0 ? "5e" + r : (e = i.toExponential()).slice(0, e.indexOf("e") + 1) + r)))) : (n = new h(i.toString())), i = s = (t = h.precision) + 3; ; )
                                if (((n = (o = n).plus(b(c, o, s + 2)).times(0.5)), N(o.d).slice(0, s) === (e = N(n.d)).slice(0, s))) {
                    ...
                    (w.toDecimalPlaces = w.todp =
                        function (r, e) {
                            var t = this,
                                n = t.constructor;
                            return (t = new n(t)), void 0 === r ? t : (E(r, 0, o), void 0 === e ? (e = n.rounding) : E(e, 0, 8), A(t, r + O(t) + 1, e));
                        }),
                    ...
                    (w.toSignificantDigits = w.tosd =
                        function (r, e) {
                            ...
                            return void 0 === r ? ((r = t.precision), (e = t.rounding)) : (E(r, 1, o), void 0 === e ? (e = t.rounding) : E(e, 0, 8)), A(new t(this), r, e);
                        }),
                    (w.toString =
                        w.valueOf =
                        w.val =
                ...
                function x(r, e) {
                    ...
                    for (f += ((Math.log(a(2, l)) / Math.LN10) * 2 + 5) | 0, t = n = o = new d(i), d.precision = f; ; ) {
                        if (((n = A(n.times(r), f)), (t = t.times(++c)), N((s = o.plus(b(n, t, f))).d).slice(0, f) === N(o.d).slice(0, f))) {
                ...
                function D(r, e) {
                    ...
                    if (p.eq(i)) return new w(0);
                    if ((null == e ? ((u = !1), (a = m)) : (a = e), p.eq(10))) return null == e && (u = !0), _(w, a);
                    if (((a += 10), (w.precision = a), (n = (t = N(v)).charAt(0)), (s = O(p)), !(Math.abs(s) < 15e14))) return (l = _(w, a + 2, m).times(s + "")), (p = D(new w(n + "." + t.slice(1)), a - 10).plus(l)), (w.precision = m), null == e ? ((u = !0), A(p, m)) : p;
                    for (; (n < 7 && 1 != n) || (1 == n && t.charAt(1) > 3); ) (n = (t = N((p = p.times(r)).d)).charAt(0)), g++;
                    for (s = O(p), n > 1 ? ((p = new w("0." + t)), s++) : (p = new w(n + "." + t.slice(1))), h = c = p = b(p.minus(i), p.plus(i), a), d = A(p.times(p), a), o = 3; ; ) {
                        if (((c = A(c.times(d), a)), N((l = h.plus(b(c, new w(o), a))).d).slice(0, a) === N(h.d).slice(0, a))) return (h = h.times(2)), 0 !== s && (h = h.plus(_(w, a + 2, m).times(s + ""))), (h = b(h, new w(g), a)), (w.precision = m), null == e ? ((u = !0), A(h, m)) : h;
                        (h = l), (o += 2);
                    }
                }
                function q(r, e) {
                    ...
                    if ((e = e.slice(n, i))) {
                        ...
                        for (; n--; ) e += "0";
                        if ((r.d.push(+e), u && (r.e > v || r.e < -v))) throw Error(h + t);
                ...
                function A(r, e, t) {
                    ...
                    if ((n = e - s) < 0) (n += 7), (i = e), (d = w[(p = 0)]);
                    else {
                        if ((p = Math.ceil((n + 1) / 7)) >= (o = w.length)) return r;
                        for (d = o = w[p], s = 1; o >= 10; o /= 10) s++;
                        i = (n %= 7) - 7 + s;
                    }
                    if ((void 0 !== t && ((f = (d / (o = a(10, s - i - 1))) % 10 | 0), (c = e < 0 || void 0 !== w[p + 1] || d % o), (c = t < 4 ? (f || c) && (0 == t || t == (r.s < 0 ? 3 : 2)) : f > 5 || (5 == f && (4 == t || c || (6 == t && (n > 0 ? (i > 0 ? d / a(10, s - i) : 0) : w[p - 1]) % 10 & 1) || t == (r.s < 0 ? 8 : 7))))), e < 1 || !w[0])) return c ? ((o = O(r)), (w.length = 1), (e = e - o - 1), (w[0] = a(10, (7 - (e % 7)) % 7)), (r.e = l(-e / 7) || 0)) : ((w.length = 1), (w[0] = r.e = r.s = 0)), r;
                    if ((0 == n ? ((w.length = p), (o = 1), p--) : ((w.length = p + 1), (o = a(10, 7 - n)), (w[p] = i > 0 ? ((d / a(10, s - i)) % a(10, i) | 0) * o : 0)), c))
                        for (;;) {
                            if (0 == p) {
                                (w[0] += o) == g && ((w[0] = 1), ++r.e);
                                break;
                            }
                            if (((w[p] += o), w[p] != g)) break;
                            (w[p--] = 0), (o = 1);
                        }
                    for (n = w.length; 0 === w[--n]; ) w.pop();
