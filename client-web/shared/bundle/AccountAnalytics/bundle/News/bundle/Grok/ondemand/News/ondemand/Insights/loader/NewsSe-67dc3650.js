...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AccountAnalytics~bundle.News~bundle.Grok~ondemand.News~ondemand.Insights~loader.NewsSe-67dc3650"],
    {
        210724: (t, r, e) => {
            e.d(r, { X: () => b });
            var n = e(202784),
                                ...
                                ? (function (t) {
                                      ...
                                      if (n > 0) {
                                          var x = p({ cx: r, cy: e, radius: n, angle: l, sign: f, isExternal: !0, cornerRadius: o, cornerIsExternal: u }),
                                              ...
                                              D = M.lineTangency,
                                              L = M.theta,
                                              N = u ? Math.abs(l - s) : Math.abs(l - s) - E - L;
                                          if (N < 0 && 0 === o) return "".concat(P, "L").concat(r, ",").concat(e, "Z");
                                          P += "L"
                                              .concat(D.x, ",")
                                              .concat(D.y, "\n      A")
                                              .concat(o, ",")
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~bundle.News~bundle.Grok~ondemand.News~ondemand.Insights~loader.NewsSe-67dc3650.6b45fcea.js.map
