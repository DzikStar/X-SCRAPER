    ...
    ["shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.Verified~ondemand.XChat-5d959941"],
    {
        446368: (e, t, r) => {
            ...
            class b {
                ...
                scribe(e, t) {
                    ...
                    const a = { ...t, _category_: "client_event", client_app_id: t?.client_app_id ?? c.env.NEXT_PUBLIC_APP_ID ?? c.env.APP_ID, client_event_sequence_number: ++this.sequenceNumber, client_event_sequence_start_timestamp: this.sequenceStartTimestamp, event_namespace: r, format_version: 2, triggered_on: n };
                    this.buffer.push(a), this.flush();
                }
                flush = "undefined" != typeof window ? m()(this.flushImmediate, 3e3, { trailing: !0 }) : this.flushImmediate;
                flushImmediate(e) {
        ...
        642783: (e, t, r) => {
            ...
            var n = r(552322),
                ...
                g = r(625067);
            const d = "night_mode";
            const m = { 0: "light", 1: "dim", 2: "dark" },
                c = (Object.fromEntries(Object.entries(m).map(([e, t]) => [t, Number(e)])), () => (0, g.Qc)(document.cookie)[d]),
                b = (e) => {
                    const t = Number(e);
                    return m[t] ?? x();
                },
            ...
            function w({ children: e }) {
                return !!f() ? (0, n.jsx)(v, { children: e }) : (0, n.jsx)(y.Provider, { value: null, children: e });
            }
            var k = r(634979),
                j = r(727071);
            function z({ analytics: e, children: t, i18nInput: r, router: g, pathname: d, useParams: m, searchParams: x }) {
                return (
                    (0, u.useLayoutEffect)(() => {
                        const e = () => {
                            const e = b(c());
                    ...
                    (0, n.jsx)(o.p, { router: g, children: (0, n.jsx)(k.H, { pathname: d, children: (0, n.jsx)(j.d, { useParams: m, children: (0, n.jsx)(s.x, { searchParams: x, children: (0, n.jsx)(i.TM, { i18nInput: r, children: (0, n.jsx)(w, { children: (0, n.jsxs)(a.UH, { analytics: e, children: [t, (0, n.jsx)(l.x, {})] }) }) }) }) }) }) })
                );
            }
        },
        607499: (e, t, r) => {
        ...
        993165: (e, t, r) => {
            ...
            const g = (0, l.j)("", { variants: { size: { large: "size-[22px]", medium: "size-5", small: "size-[18px]", xLarge: "size-6", xSmall: "size-4", xSmallCompact: "size-4" } } }),
                ...
                m = (0, l.j)("inline-flex items-center justify-center gap-1 border border-solid transition focus-visible:outline disabled:pointer-events-none disabled:opacity-50", {
                    variants: {
                ...
                c = (0, i.forwardRef)(function ({ asChild: e, backgroundColor: t = "background", borderRadius: r = "full", children: s, className: c, color: b = "text", hoverLabel: x, icon: p, size: h = "medium", variant: y, ...f }, v) {
                    const w = e ? a.g7 : "button";
                    return (0, n.jsx)(u.O, { label: x, children: (0, n.jsx)(w, { className: m({ className: (0, l.cx)(!y && "outline-primary hover:brightness-90 focus:brightness-90 active:brightness-75", c), size: h, variant: y, ...(s && { padding: h }), ...(!y && { backgroundColor: t, borderRadius: r, color: b }) }), ref: v, ...f, children: (0, n.jsxs)(i.Fragment, { children: [p && (0, i.cloneElement)(p, { className: g({ size: h }) }), "string" == typeof s ? (0, n.jsx)(o.x, { color: "inherit", numberOfLines: 1, size: h && d[h], weight: "bold", children: s }) : s] }) }) });
                });
        },
        287326: (e, t, r) => {
            r.d(t, { O: () => i });
        ...
        332161: (e, t, r) => {
            ...
            function u({ as: e, className: t, color: r, numberOfLines: l, size: u = "body", underline: g, weight: d = "normal", breakText: m = "words", ...c }) {
                const b = "a" === e,
                    x = b ? i.r : (e ?? o);
                return (0, n.jsx)(x, { ...c, className: s({ className: (0, a.cx)(b && !1 !== g && "hover:underline", t), color: r ?? (b ? "primary" : "text"), numberOfLines: l, size: u, underline: g, weight: d, breakText: m }) });
            }
        },
        19745: (e, t, r) => {
            r.d(t, { x: () => l });
        ...
        589259: (e, t, r) => {
            ...
            function d({ affiliation: e, isProtected: t, isSubscriber: r, isTranslator: a, verifiedType: d }) {
                const m = [];
                return "business" === d && m.push((0, n.jsx)(l.Z, {}, "business")), "government" === d && m.push((0, n.jsx)(i.Z, {}, "government")), "user" === d && m.push((0, n.jsx)(o.Z, { className: "fill-badge" }, "User")), r && m.push((0, n.jsx)(s.Z, { className: "fill-plum-500" }, "subscriber")), a && m.push((0, n.jsx)(u.Z, { className: "fill-yellow-500" }, "translator")), t && m.push((0, n.jsx)(g.Z, {}, "protected")), e && m.push((0, n.jsx)("img", { alt: e.label, className: "rounded-sm h-[1em] w-[1em]", loading: "lazy", src: e.url }, "affiliation")), m.length ? (0, n.jsx)("div", { className: "flex gap-1", children: m }) : null;
            }
            var m = r(332161),
                c = r(351417);
            function b({ badges: e, color: t = "text", isStacked: r, name: l, screenName: i, size: o = "body", weight: s = "bold", withLink: u, screenNameColor: g = "gray700", screenNameSize: b }) {
                const x = i && u;
                return (0, n.jsxs)("div", { className: (0, a.Z)("overflow-hidden", r ? "flex-col items-start gap-0" : "flex items-center gap-1"), children: [(0, n.jsxs)("div", { className: "flex items-center gap-0.5 shrink-0 max-w-full", children: [(0, n.jsx)(m.x, { color: t, numberOfLines: 1, size: o, breakText: "all", weight: s, ...(x && { as: "a", href: `https://x.com/${i}`, target: "external" === u ? "_blank" : void 0 }), children: l }), e && Object.keys(e).length && (0, n.jsx)("div", { className: "shrink-0", children: (0, n.jsx)(m.x, { size: o, children: (0, n.jsx)(d, { ...e }) }) })] }), i && (0, n.jsx)(c.Q, { screenName: i, size: b || o, withLink: u, color: g })] });
            }
        },
        305399: (e, t, r) => {
            r.d(t, { a: () => a });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.Verified~ondemand.XChat-5d959941.0c6fa5aa.js.map
