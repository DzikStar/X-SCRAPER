    ...
    ["shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.Verified~ondemand.XChat-5d959941"],
    {
        446368: (e, t, r) => {
            ...
            class x {
                ...
                flush = "undefined" != typeof window ? c()(this.flushImmediate, 15e3, { trailing: !0 }) : this.flushImmediate;
                flushImmediate(e) {
        ...
        436059: (e, t, r) => {
            ...
            var n = r(552322),
                ...
                s = r(809691),
                u = r(669833);
            const g = (0, l.j)("", { variants: { size: { large: "size-[22px]", medium: "size-5", small: "size-[18px]", xLarge: "size-6", xxLargeCompact: "size-4", xSmall: "size-4", xSmallCompact: "size-4" } } }),
                d = { large: "body", medium: "body", small: "subtext1", xLarge: "headline2", xxLargeCompact: "body", xSmall: "subtext1", xSmallCompact: "body" },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.Verified~ondemand.XChat-5d959941.0efae30a.js.map
