...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.XChat-866ab763"],
    {
        ...
        123010: (e, t, r) => {
            ...
            function o({ color: e, displayTextRange: t, entities: r, lang: o, linkColor: l, numberOfLines: c, size: d, text: u, underlineLinks: h }) {
                const f = (0, s.useMemo)(() => {
                    ...
                    const o = Array.from((0, a.decode)(u)).slice(e, s);
                    if (!r) return o.join("");
                    const c = [],
                        d = (function (e) {
                    ...
                    return (
                        d
                            ...
                            .forEach((t) => {
                                ...
                                if (r < 0 || a > o.length || r >= a) return;
                                r > f && c.push((0, n.jsx)(i.x, { as: "span", color: "inherit", size: "inherit", children: o.slice(f, r).join("") }, `${f}-${r}`));
                                const s = (function (e, t, r, a, s) {
                                    const o = `entity-${e.type}-${t}-${r}`;
                                    switch (e.type) {
                                        case "hashtag":
                                            return (0, n.jsx)(i.x, { as: "a", color: a, href: `https://x.com/hashtag/${e.text}`, size: "inherit", underline: s, children: `#${e.text}` }, o);
                                        case "symbol":
                                            return (0, n.jsx)(i.x, { as: "a", color: a, href: `https://x.com/search?q=$${e.text}`, size: "inherit", underline: s, children: `$${e.text}` }, o);
                                        case "url":
                                            return (0, n.jsx)(i.x, { as: "a", color: a, href: e.url, size: "inherit", target: "_blank", rel: "noopener noreferrer", underline: s, children: e.displayUrl }, o);
                                        case "mention":
                                            return e.isUnmentioned ? (0, n.jsx)(i.x, { as: "span", color: "inherit", size: "inherit", children: `@${e.screenName}` }, o) : (0, n.jsx)(i.x, { as: "a", color: a, href: `https://x.com/${e.screenName}`, size: "inherit", underline: s, children: `@${e.screenName}` }, o);
                                    }
                                })(t, r, a, l, h);
                                s && c.push(s), (f = a);
                            }),
                        f < o.length && c.push((0, n.jsx)(i.x, { as: "span", color: "inherit", size: "inherit", children: o.slice(f).join("") }, `${f}-${o.length}`)),
                        c
                    );
                }, [u, t, r, l, h]);
                return (0, n.jsx)(i.x, { color: e, dir: "auto", lang: o, numberOfLines: c, size: d, children: f });
            }
        },
        437712: (e, t, r) => {
            r.d(t, { J: () => i });
            ...
            function i({ borderRadius: e = "medium", children: t, open: r, onOpenChange: i, trigger: o, withArrow: l, ...c }) {
                return (0, n.jsxs)(a.fC, { open: r, onOpenChange: i, children: [o && (0, n.jsx)(a.xz, { asChild: !0, children: o }), (0, n.jsx)(a.h_, { children: (0, n.jsxs)(a.VY, { ...c, className: s({ borderRadius: e }), children: [t, l && (0, n.jsx)(a.Eh, { className: "fill-background" })] }) })] });
            }
        },
        253511: (e, t, r) => {
            r.d(t, { E: () => o });
        ...
        34681: (e, t, r) => {
            r.d(t, { $N: () => x, Be: () => v, GG: () => h, PK: () => u, Vq: () => c, cN: () => g, cZ: () => m, fK: () => p, hg: () => d, t9: () => f });
            var n = r(552322),
                a = r(123825),
                s = r(840489),
                i = r(202784),
            ...
            const c = a.fC,
                ...
                u = a.h_,
                h = a.x8,
                f = i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(a.aV, { ref: r, className: (0, l.cn)("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80", e), ...t }));
            f.displayName = a.aV.displayName;
            const m = i.forwardRef(({ children: e, className: t, withCloseButton: r = !0, ...s }, i) => (0, n.jsxs)(u, { children: [(0, n.jsx)(f, {}), (0, n.jsxs)(a.VY, { ref: i, className: (0, l.cn)("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-100 px-6 pt-6 shadow-lg duration-200 rounded-xl", t), ...s, children: [e, r && (0, n.jsxs)(a.x8, { tabIndex: -1, className: "ring-offset-background focus:ring-ring absolute right-4 top-4 rounded opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-gray-200 data-[state=open]:text-gray-700", children: [(0, n.jsx)(o.Z, { className: "h-4 w-4 text-gray-900" }), (0, n.jsx)("span", { className: "sr-only", children: "Close" })] })] })] }));
            ...
            const g = ({ className: e, ...t }) => (0, n.jsx)("div", { className: (0, l.cn)("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", e), ...t });
            g.displayName = "DialogFooter";
            const x = i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(a.Dx, { ref: r, className: (0, s.Z)("text-title4 text-text font-medium tracking-tight", e), ...t }));
            x.displayName = a.Dx.displayName;
            const v = i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(a.dk, { ref: r, className: (0, l.cn)("text-sm text-gray-700", e), ...t }));
            v.displayName = a.dk.displayName;
        },
        305163: (e, t, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.XChat-866ab763.abae78da.js.map
