...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.XChat-e96e9bea"],
    {
            ...
            function o({ color: e, displayTextRange: t, entities: r, lang: o, linkColor: l, numberOfLines: c, size: d, text: u, underlineLinks: h }) {
                ...
                if (r) {
                    ...
                    d.forEach((r) => {
                        ...
                        const [o, d] = i;
                        o < 0 || d > f.length || (d !== e && o > e && m.push((0, n.jsx)(a.x, { as: "span", color: "inherit", size: "inherit", children: (0, s.decode)(c.subsegment(e, o)) }, `${e}-${o}`)), "hashtags" === r.type && m.push((0, n.jsx)(a.x, { as: "a", color: l, href: `https://x.com/hashtag/${r.text}`, size: "inherit", underline: h, children: `#${(0, s.decode)(r.text)}` }, `${o}-${d}`)), "symbols" === r.type && m.push((0, n.jsx)(a.x, { as: "a", color: l, href: `https://x.com/search?q=$${r.text}`, size: "inherit", underline: h, children: `$${(0, s.decode)(r.text)}` }, `${o}-${d}`)), "urls" === r.type && m.push((0, n.jsx)(a.x, { as: "a", color: l, href: r.url, size: "inherit", target: "_blank", rel: "noopener noreferrer", underline: h, children: (0, s.decode)(r.displayUrl) }, `${o}-${d}`)), "mentions" === r.type && (r.isUnmentioned ? m.push((0, n.jsx)(a.x, { as: "span", color: "inherit", size: "inherit", children: `@${(0, s.decode)(r.screenName)}` }, `${o}-${d}`)) : m.push((0, n.jsx)(a.x, { as: "a", color: l, href: `https://x.com/${r.screenName}`, size: "inherit", underline: h, children: `@${(0, s.decode)(r.screenName)}` }, `${o}-${d}`))), (e = d));
                    }),
        ...
        164695: (e, t, r) => {
            r.d(t, { $N: () => p, Be: () => x, PK: () => u, Vq: () => c, cZ: () => f, fK: () => m, hg: () => d, t9: () => h });
            var n = r(552322),
                s = r(123825),
                a = r(840489),
                i = r(202784),
            ...
            const c = s.fC,
                d = s.xz,
                u = s.h_,
                h = (s.x8, i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(s.aV, { ref: r, className: (0, o.cn)("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80", e), ...t })));
            h.displayName = s.aV.displayName;
            const f = i.forwardRef(({ children: e, className: t, ...r }, a) => (0, n.jsxs)(u, { children: [(0, n.jsx)(h, {}), (0, n.jsxs)(s.VY, { ref: a, className: (0, o.cn)("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-100 p-6 shadow-lg duration-200 sm:rounded-xl", t), ...r, children: [e, (0, n.jsxs)(s.x8, { tabIndex: -1, className: "ring-offset-background focus:ring-ring absolute right-4 top-4 rounded opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-gray-200 data-[state=open]:text-gray-700", children: [(0, n.jsx)(l.Z, { className: "h-4 w-4 text-gray-900" }), (0, n.jsx)("span", { className: "sr-only", children: "Close" })] })] })] }));
            ...
            const p = i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(s.Dx, { ref: r, className: (0, a.Z)("text-title4 text-text font-medium tracking-tight", e), ...t }));
            p.displayName = s.Dx.displayName;
            const x = i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(s.dk, { ref: r, className: (0, o.cn)("text-sm text-gray-700", e), ...t }));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.XChat-e96e9bea.c7b207da.js.map
