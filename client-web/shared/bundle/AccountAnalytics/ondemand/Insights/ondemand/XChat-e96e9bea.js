    ...
    ["shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.XChat-e96e9bea"],
    {
        ...
        164695: (e, t, r) => {
            ...
            const c = a.fC,
                d = a.xz,
                u = a.h_,
                h = (a.x8, i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(a.aV, { ref: r, className: (0, l.cn)("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80", e), ...t })));
            h.displayName = a.aV.displayName;
            const f = i.forwardRef(({ children: e, className: t, ...r }, s) => (0, n.jsxs)(u, { children: [(0, n.jsx)(h, {}), (0, n.jsxs)(a.VY, { ref: s, className: (0, l.cn)("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-100 p-6 shadow-lg duration-200 sm:rounded-xl", t), ...r, children: [e, (0, n.jsxs)(a.x8, { tabIndex: -1, className: "ring-offset-background focus:ring-ring absolute right-4 top-4 rounded opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-gray-200 data-[state=open]:text-gray-700", children: [(0, n.jsx)(o.Z, { className: "h-4 w-4 text-gray-900" }), (0, n.jsx)("span", { className: "sr-only", children: "Close" })] })] })] }));
            ...
            const p = i.forwardRef(({ className: e, ...t }, r) => (0, n.jsx)(a.dk, { ref: r, className: (0, l.cn)("text-sm text-gray-700", e), ...t }));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~ondemand.Insights~ondemand.XChat-e96e9bea.d7ddfbca.js.map
