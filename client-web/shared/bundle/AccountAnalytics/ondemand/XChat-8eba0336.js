    ...
    ["shared~bundle.AccountAnalytics~ondemand.XChat-8eba0336"],
    {
        697597: (e, t, r) => {
            ...
            function u({ children: e, className: t, src: r, startPosition: n, ...d }) {
                ...
                return (0, s.jsxs)("div", { ref: h, className: t, children: [(0, s.jsx)("video", { height: "100%", ref: x, width: "100%", ...d }), (0, s.jsx)(c.Provider, { value: { api: f, state: u }, children: e })] });
            }
            function m() {
            ...
            var h = r(436059),
                v = r(58124);
            const x = (e) => (0, s.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "1em", height: "1em", display: "flex", fill: "currentColor", role: "img", ...e, children: (0, s.jsx)("path", { d: "M13 3h8v8h-2V6.41l-5.043 5.05-1.414-1.42L17.586 5H13V3zm-1.543 10.96L6.414 19H11v2H3v-8h2v4.59l5.043-5.05 1.414 1.42z" }) });
            function f(e) {
                const { api: t, state: r } = d(),
                    n = r.isFullscreen ? (0, s.jsx)(v.Z, {}) : (0, s.jsx)(x, {}),
                    a = "Full screen";
        ...
        921879: (e, t, r) => {
            ...
            var s = r(552322),
                ...
                l = r(202784),
                i = r(801074);
            function o({ api: e, className: t, footer: r, header: n, id: o, items: c, nearEndThreshold: d = 5, nearStartThreshold: u = 2, onAtEnd: m, onAtStart: h, onNearEnd: v, onNearStart: x, onScroll: f, renderItem: p, ...g }) {
                ...
                const T = a()(() => v?.(), 500),
                    ...
                    C = (0, l.useCallback)(
                        (e) => {
                            ...
                            f?.(e, s), "backward" === s && (0 === r && h?.(), t.findStartIndex() <= u && N()), "forward" === s && (r + t.viewportSize - t.scrollSize == 0 && m?.(), E - t.findEndIndex() <= d && T()), (j.current = r);
                        },
                        [E, T, N, d, u, m, h, f],
                    );
                return (0, s.jsxs)("div", {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountAnalytics~ondemand.XChat-8eba0336.2f7acaca.js.map
