            ...
            class C extends a.Component {
                ...
                render() {
                    const { children: e, dataSaverMode: t, getVideoRef: i, style: r, variants: s, ...o } = this.props,
                        l = (0, w.IM)((0, I.rD)(s), t);
                    return (0, D.Z)("video", { ...o, children: [l.map((e) => a.createElement("source", { key: e.src, src: e.src, type: e.type })), e], ref: this._setVideoRef, style: r });
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AccountVerification~bundle.SettingsProfile~loader.MediaPickerWithPreview.665bd29a.js.map
