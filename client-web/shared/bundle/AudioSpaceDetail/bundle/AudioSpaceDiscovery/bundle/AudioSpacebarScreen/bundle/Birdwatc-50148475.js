    ...
    ["shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-50148475"],
    {
        ...
        879113: (e, o, t) => {
            ...
            class m extends n.Component {
                ...
                render() {
                    const { "aria-label": e, color: o, failureMessage: t, fetchStatus: r, icon: c, loadingMessage: i, onRequestRetry: d, render: m, renderFailure: u, retryMessage: v, retryable: g } = this.props;
                    switch (r) {
                        case s:
                            return g ? n.createElement(l.Z, { icon: c, onRequestRetry: d, retryMessage: v }) : t ? n.createElement(a.m, { failureMessage: t }) : u();
                        case h:
        ...
        738584: (e, o, t) => {
            ...
            function m({ children: e, periodic: o }) {
                const t = o ? u.PeriodicContext.Consumer : u.Context.Consumer;
            ...
            class u extends r.Component {
                ...
                render() {
                    const { guestsState: e, playerApi: o, playerState: t, stablePlayerState: c } = this.state,
                        { additionalBadges: l, aspectRatio: d, basePlayerClass: h, children: I, includeDisputeLinkInCopyrightErrorMessage: m, isFullScreen: g, objectFitVideo: p, onApiReady: S, onScroll: C, onStateUpdate: k, playerId: y, size: f, ...w } = this.props,
            ...
            (u.Consumer = m), (u.defaultProps = { aspectRatio: l.default.theme.aspectRatios.landscape, size: "fill" }), (u.Context = r.createContext({ aspectRatio: l.default.theme.aspectRatios.landscape, guestsState: null, playerApi: null, playerState: null, containerRef: null })), (u.PeriodicContext = r.createContext({ aspectRatio: l.default.theme.aspectRatios.landscape, guestsState: null, playerApi: null, playerState: null, containerRef: null }));
        ...
        893164: (e, o, t) => {
            ...
            const I = i().a9edea48;
            function m(e) {
                const { displayBackgroundImage: o = !1, errorMessage: t, iconPlayError: c, imageSrc: i, onReloadPress: m } = e;
                return n.createElement(r.Z, { style: [h.default.absoluteFill, o ? null : u.blankOverlay] }, o ? n.createElement(n.Fragment, null, n.createElement(r.Z, { style: u.backgroundImage }, i && n.createElement(d.Z, { resizeMode: "cover", source: i, style: h.default.absoluteFill })), n.createElement(r.Z, { style: u.overlay })) : null, n.createElement(r.Z, { style: u.errorContainer }, n.createElement(r.Z, null, c ? n.createElement(l.default, { style: u.playErrorIcon }) : null), n.createElement(r.Z, { focusable: !0 }, n.createElement(a.ZP, { style: o ? u.errorMsgTextWhite : u.errorMsgTextGray }, t)), m ? n.createElement(s.ZP, { onPress: m, style: u.buttonContainer, type: "brandFilled" }, I) : null));
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-50148475.2ce07e9a.js.map
