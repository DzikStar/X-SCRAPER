...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-50148475"],
    {
        ...
        879113: (e, o, t) => {
            ...
            class u extends n.Component {
                ...
                render() {
                    ...
                    switch (r) {
                        case s:
                            return g ? n.createElement(a.Z, { icon: c, onRequestRetry: d, retryMessage: v }) : t ? n.createElement(l.m, { failureMessage: t }) : m();
                        case I:
        ...
        738584: (e, o, t) => {
            ...
            class m extends r.Component {
                ...
                render() {
                    const { guestsState: e, playerApi: o, playerState: t, stablePlayerState: c } = this.state,
                        { additionalBadges: a, aspectRatio: d, basePlayerClass: I, children: h, includeDisputeLinkInCopyrightErrorMessage: u, isFullScreen: g, objectFitVideo: p, onApiReady: S, onScroll: k, onStateUpdate: C, playerId: y, size: w, ...f } = this.props,
                        b = { aspectRatio: this.props.aspectRatio, guestsState: e, playerApi: o, playerState: t, containerRef: this._containerRef },
                        M = { ...b, playerState: c };
                    return r.createElement(
                        i.Z,
                        { isFullScreen: g, onScroll: k, ratio: d, style: [v.root, v[w]] },
                        this.state.hasError
                            ...
                            : r.createElement(
                                  ...
                                  r.createElement(
                                      ...
                                      { value: b },
                                      r.createElement(s.Z.RegistrationContext.Consumer, null, ({ registerPlayer: e }) => r.createElement(I, (0, n.Z)({}, f, { customOverlay: this._renderCustomOverlay(), displayOptions: { objectFitVideo: p }, setPlayerApi: this._handlePlayerApi(e) }))),
                                  ),
                              ),
                    );
                }
            ...
            const v = a.default.create({ root: { position: "relative" }, fill: { width: "100%", height: "100%" }, small: { width: 480, height: 270 }, medium: { width: 640, height: 360 }, large: { width: 800, height: 450 } }),
                g = m;
        },
        395367: (e, o, t) => {
            t.d(o, { Z: () => i });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-50148475.f08301fa.js.map
