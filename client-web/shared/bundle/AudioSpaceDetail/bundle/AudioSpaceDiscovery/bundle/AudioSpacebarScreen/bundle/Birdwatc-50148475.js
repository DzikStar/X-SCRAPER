            ...
            class m extends i.Component {
                ...
                render() {
                    const { guestsState: e, playerApi: t, playerState: r, stablePlayerState: l } = this.state,
                        { additionalBadges: o, aspectRatio: d, basePlayerClass: h, children: v, includeDisputeLinkInCopyrightErrorMessage: u, isFullScreen: p, objectFitVideo: y, onApiReady: b, onScroll: Z, onStateUpdate: w, playerId: z, size: f, ...E } = this.props,
                        C = { aspectRatio: this.props.aspectRatio, guestsState: e, playerApi: t, playerState: r, containerRef: this._containerRef },
                        M = { ...C, playerState: l };
                    return i.createElement(
                        n.Z,
                        { isFullScreen: p, onScroll: Z, ratio: d, style: [g.root, g[f]] },
                        this.state.hasError
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-50148475.9ecd2d7a.js.map
