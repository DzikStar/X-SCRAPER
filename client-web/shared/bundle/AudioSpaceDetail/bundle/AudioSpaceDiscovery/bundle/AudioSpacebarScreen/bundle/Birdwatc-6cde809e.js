            ...
            const be = { base: { display: "flex", flexShrink: 1, flexBasis: "auto", width: "100%", height: "100%", overflow: "hidden" }, aspectRatioStyle: (e) => ({ aspectRatio: `${e ?? "auto"}`, width: "auto" }), posterImage: { height: "100%", width: "100%", zIndex: -1, position: "absolute" } },
                fe = ({ props: e, scribeContext: t, style: o }) => {
                    const r = e.url("src"),
                        ...
                        v = a.useMemo(() => Z((e, t, { api: o }) => o.getHttpClient()), [Z]),
                    ...
                    const P = a.useCallback(
                        ...
                        T = a.useMemo(() => ({ page: b || t.page, section: f || t.section, component: t.component, element: t.element }), [b, f, t]),
                        F = a.useMemo(() => {
            ...
            const Ee = new Map([
                ...
                Ae = (e, t, o, i, n, c, d) => {
                    ...
                    const b = [...g, ...y],
                        ...
                        S = h.mods.get(Z)?.ids ?? [],
                        v = n >= r.default.theme.breakpoints.small ? (h.mods.get(s.Wj.sm)?.ids ?? []) : [],
                        ...
                        P = v.concat(k).concat(w).concat(x).concat(C),
                        R = M.concat(I).concat(E),
                        T = (0, Ie.Z)(b.concat(P).concat(R)),
                        F = (0, Ie.Z)(f),
                        j = (0, Ie.Z)($.concat(S)),
                        ...
                        V = Be(e).map((o, a) => Ae(e.dom.el(o), t, a.toString(), W, n, !B, !0)),
                        H = D?.length ? [...D, ...V] : V,
                        G = Re.has(p);
                    let _ = !1,
                        N = !1,
                        L = !1,
                        z = !1;
                    if ((d || c) && H.length > 0) for (const e of H) if ((e.propagateHorizontalGrowth && (_ = !0), e.propagateVerticalGrowth && (N = !0), e.hasGrowth && (L = !0), e.hasAllGrowth && (z = !0), _ && N && L && z)) break;
                    const O =
                            !0 === d &&
                            !((e) => {
                    ...
                    return { comp: A ? a.createElement(je, { key: o, scribeData: A }, a.createElement(We, { activeStyle: F, childElems: D, context: W, el: e, hoverStyle: j, style: U, type: String(p) })) : a.createElement(We, { activeStyle: F, childElems: D, context: W, el: e, hoverStyle: j, key: o, style: U, type: String(p) }), hasGrowth: Y, hasAllGrowth: q, propagateHorizontalGrowth: O, propagateVerticalGrowth: Q };
                },
                Be = (e) =>
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-6cde809e.6bbef8ea.js.map
