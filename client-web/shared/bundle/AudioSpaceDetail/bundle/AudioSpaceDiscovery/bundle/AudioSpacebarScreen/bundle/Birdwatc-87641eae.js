                ...
                L = ({ isLegacy: e, isWide: d }) =>
                    n.ub({
                        splice: (a) => {
                            ...
                            M.push(O({ "aria-owns": t, itemMetadata: D, moduleEntryId: u, sortIndex: h }));
                            for (let d = 0; d < b; d += c) {
                                const a = d / c,
                                    o = l.slice(d, Math.min(b, d + c)),
                                    r = m && d + c >= b;
                                M.push(x({ entryToFocus: s?.entryToFocus, isLegacy: e, itemMetadata: D, items: o, moduleEntryId: u, numColumns: c, rowIndex: a, shouldDisplayBorder: r, sortIndex: h }));
                            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae.2fe36d7a.js.map
