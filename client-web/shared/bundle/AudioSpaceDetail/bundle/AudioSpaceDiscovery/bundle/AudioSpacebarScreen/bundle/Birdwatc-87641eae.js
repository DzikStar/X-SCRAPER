    ...
    ["shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae"],
    {
                ...
                L = ({ isLegacy: e, isWide: d }) =>
                    n.ub({
                        splice: (a) => {
                            ...
                            b.push(O({ "aria-owns": t, itemMetadata: i, moduleEntryId: u, sortIndex: h }));
                            for (let d = 0; d < c; d += M) {
                                const a = d / M,
        ...
        335632: (e, d, a) => {
            ...
            const c = (e) => ({
                ...
                t = ({ shouldStoreTypeaheadItem: e }) => r.ov({ selectDisplayType: (e) => e.content.displayType, handlers: { [M.Z.Hero]: c({}), [M.Z.Cell]: c({ shouldStoreTypeaheadItem: e }), [M.Z.CellWithProminentSocialContext]: c({}) } }),
                m = {
                    loader: () =>
                        Promise.all([
                            a.e("icons.0"),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-87641eae.ffaab63a.js.map
