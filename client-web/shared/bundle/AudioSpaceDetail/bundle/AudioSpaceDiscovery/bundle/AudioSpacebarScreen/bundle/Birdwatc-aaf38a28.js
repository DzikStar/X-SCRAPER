...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-aaf38a28"],
    {
        154462: (e, l, t) => {
            ...
            l.ZP = void 0;
            var s = t(526);
            l.S_ = s.updateAudioLevels;
            var i = t(790978);
            l.eu = i.updateGuestInfo;
            var c = r(t(187632));
            (l.$4 = c.default), (l.mC = c.registerExperience);
            var h = r(t(427193));
            (l.Nu = h.resetGuestState), (l.Nt = h.teardownExperience);
            var o = h.default;
            l.ZP = o;
        },
        526: (e, l, t) => {
            t(332501), t(43105), (l.__esModule = !0), (l.default = l.InitialState = l.updateAudioLevels = l.UPDATE_AUDIO_LEVELS = void 0);
            var r = "UPDATE_AUDIO_LEVELS";
            l.UPDATE_AUDIO_LEVELS = r;
            l.updateAudioLevels = function (e, l) {
                return { type: r, audioLevels: l, experienceId: e };
            };
            var s = { guests: {}, host: 0 };
            l.InitialState = s;
            l.default = function (e, l) {
                if ((void 0 === e && (e = s), l.type === r)) {
                    for (var t = l.audioLevels, i = t[0], c = t.slice(1), h = {}, o = 0; o < c.length; o++) h[o] = c[o];
                    return Object.assign({}, e, { guests: h, host: i });
                }
                return e;
            };
        },
        790978: (e, l) => {
            (l.__esModule = !0), (l.default = l.updateGuestInfo = l.UPDATE_GUEST_INFO = void 0);
            var t = "UPDATE_GUEST_INFO";
            l.UPDATE_GUEST_INFO = t;
            l.updateGuestInfo = function (e, l) {
                return { type: t, guestInfo: l, experienceId: e };
            };
            l.default = function (e, l) {
                if ((void 0 === e && (e = {}), l.type === t)) {
                    for (var r = l.guestInfo, s = {}, i = 0; i < r.length; i++) {
                        var c = r[i],
                            h = c.ParticipantIndex,
                            o = c.ProfileUrl,
                            n = c.SessionId,
                            d = c.StreamName,
                            v = c.UserId,
                            a = c.UserName;
                        s[i] = { ParticipantIndex: h, ProfileUrl: o, SessionId: n, StreamName: d, UserId: v, UserName: a };
                    }
                    return s;
                }
                return e;
        ...
        187632: (e, l, t) => {
            var r = t(171600);
            t(543450), t(271245), t(966466), t(977208), t(334769), (l.__esModule = !0), (l.default = l.registerExperience = l.REGISTER_EXPERIENCE = void 0);
            var s = r(t(373408)),
                i = t(427193),
                c = "REGISTER_EXPERIENCE";
            l.REGISTER_EXPERIENCE = c;
            l.registerExperience = function () {
                return { type: c };
            };
            l.default = function (e) {
                return function (l) {
                    return function (t) {
                        if (t.type === c) {
                            var r = e.getState(),
                                h = Object.keys(r.hydraExperiences || {}).map(function (e) {
                                    return Number.parseInt(e, 10);
                                }),
                                o = Math.max.apply(Math, (0, s.default)(h)) + 1;
                            return Number.isFinite(o) || (o = 0), e.dispatch((0, i.initializeExperience)(o)), o;
                        }
                        return l(t);
                    };
                };
        ...
        427193: (e, l, t) => {
            var r = t(634590),
                s = t(171600);
            t(43105), (l.__esModule = !0), (l.default = l.resetGuestState = l.RESET_GUEST_STATE = l.teardownExperience = l.TEARDOWN_EXPERIENCE = l.initializeExperience = l.INITIALIZE_EXPERIENCE = void 0);
            var i = t(10674),
                c = s(t(790978)),
                h = r(t(526)),
                o = "INITIALIZE_EXPERIENCE";
            l.INITIALIZE_EXPERIENCE = o;
            l.initializeExperience = function (e) {
                return { type: o, experienceId: e };
            };
            var n = "TEARDOWN_EXPERIENCE";
            l.TEARDOWN_EXPERIENCE = n;
            l.teardownExperience = function (e) {
                return { type: n, experienceId: e };
            };
            var d = "RESET_GUEST_STATE";
            l.RESET_GUEST_STATE = d;
            l.resetGuestState = function (e) {
                return { type: d, experienceId: e };
            };
            var v = { audioLevels: h.InitialState, guests: {} },
                a = (0, i.combineReducers)({ audioLevels: h.default, guests: c.default });
            l.default = function (e, l, t) {
                var r;
                if ((void 0 === e && (e = {}), void 0 === t && (t = a), void 0 !== l.experienceId))
                    switch (l.type) {
                        case o:
                        case d:
                            return Object.assign({}, e, (((r = {})[l.experienceId] = v), r));
                        case n:
                            var s = Object.assign({}, e);
                            return delete s[l.experienceId], s;
                        default:
                            var i,
                                c = t(e[l.experienceId], l);
                            return Object.assign({}, e, (((i = {})[l.experienceId] = c), i));
                    }
                return e;
            };
        },
        10674: (e, l, t) => {
            t(743108), t(334769), (l.__esModule = !0), (l.combineReducers = void 0);
            l.combineReducers = function (e) {
                return function (l, t) {
                    return Object.keys(e).reduce(function (r, s) {
                        return (r[s] = e[s](l[s], t)), r;
                    }, {});
                };
            };
        },
        ...
        97759: (e, l, t) => {
            t.d(l, { Z: () => s });
            var r = t(552322);
            const s = (e) => (0, r.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "1em", height: "1em", display: "flex", fill: "currentColor", role: "img", ...e, children: (0, r.jsx)("path", { d: "M13 3v13.59l5.043-5.05 1.414 1.42L12 20.41l-7.457-7.45 1.414-1.42L11 16.59V3h2z" }) });
        },
        787923: (e, l, t) => {
            t.d(l, { Z: () => s });
            var r = t(552322);
        ...
        458872: (e, l, t) => {
            t.d(l, { Z: () => s });
            var r = t(552322);
            const s = (e) => (0, r.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "1em", height: "1em", display: "flex", fill: "currentColor", role: "img", ...e, children: (0, r.jsx)("path", { d: "M7.414 13l5.043 5.04-1.414 1.42L3.586 12l7.457-7.46 1.414 1.42L7.414 11H21v2H7.414z" }) });
        },
        533210: (e, l, t) => {
            t.d(l, { Z: () => s });
            var r = t(552322);
        ...
        14313: (e, l, t) => {
            t.d(l, { Z: () => s });
            var r = t(552322);
            const s = (e) => (0, r.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "1em", height: "1em", display: "flex", fill: "currentColor", role: "img", ...e, children: (0, r.jsx)("path", { d: "M12 3.59l7.457 7.45-1.414 1.42L13 7.41V21h-2V7.41l-5.043 5.05-1.414-1.42L12 3.59z" }) });
        },
        932395: (e, l, t) => {
            t.d(l, { Z: () => s });
            var r = t(552322);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-aaf38a28.f135a9ea.js.map
