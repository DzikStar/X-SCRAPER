(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-b336079b"],
    {
        ...
        996223: (e, a, r) => {
            ...
            r(631673);
            const B = "/i/jf";
            function E({ path: e, systemActionHandlers: a }) {
                const [r] = (0, t.KO)(i.f0);
                return "undefined" == typeof window ? null : r.isTrue("rweb_jetfuel_sdkv2_with_x_web") ? d.createElement(w.E7, { systemActionHandlers: a }, d.createElement(d.Suspense, { fallback: d.createElement(c.J, null) }, d.createElement(_, { isHighlights: !1, key: `${location.pathname.slice(B.length) + location.search}`, path: location.pathname.slice(B.length) + location.search, renderEmptyState: () => null }))) : d.createElement(w.E7, { systemActionHandlers: a }, d.createElement(d.Suspense, { fallback: d.createElement(c.J, null) }, d.createElement(P, { path: e })));
            }
            function P({ path: e }) {
                const a = (0, o.useLocation)(),
                    r = e ?? a.pathname.slice(B.length) + a.search;
                (0, k.E)();
                const n = (0, M._3)(r, { refreshTimeMs: 1e4 });
            ...
            const _ = ({ isHighlights: e, path: a, renderEmptyState: r }) => {
                ...
                (T["x-jf-client-theme"] = Z), (T["x-jf-v"] = "JP-4"), j && (T.timezone = j), _ && (T["accept-language"] = (0, b.o)(_));
                const L = ((e, a) => (e ? v.mH : a ? v.OG : v.CP))(O, x),
                    R = {
                        httpPOST: async (e, a) => {
                            let r,
                                d = !1;
                            ...
                            try {
                                (r = await M.jetfuelForm(n, T, Object.fromEntries(a.entries()), L)), (d = !0);
                            } catch (e) {
                                (d = !1), l(!0);
                            }
                            return { ok: d, data: r };
                    ...
                    N = { "x.com.GenericURT": D.Z, "x.com.Video": y.Z, StoryPager: A.Z, "StoryPager.Story": m.Z, SignupArkoseSecurityChallenge: f.Z };
                d.useEffect(() => {
                    document.body.setAttribute("data-theme", Z ?? "light");
                }, [Z]);
                const H = (0, n.GZ)("svelte", { net: R, history: s, analytics: I });
                return H.addComponentOverride(N), d.createElement(d.Fragment, null, c && r ? r() : d.createElement(n.mQ, { analytics: I, jfPath: location.pathname.slice(B.length) + location.search, key: `${location.pathname.slice(B.length) + location.search}-${h}`, r: H }));
            };
        },
        996568: (e, a, r) => {
            "use strict";
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSpacebarScreen~bundle.Birdwatc-b336079b.a240170a.js.map
