    ...
    ["shared~bundle.AudioSpacePeek~bundle.Communities~loader.CommunityHandler"],
    {
        ...
        544239: (e, t, n) => {
            ...
            function A(e) {
                const { handlePinOrUnpin: t, isPinned: n } = e,
                    o = r.useMemo(() => (n ? r.createElement(b.default, { "aria-label": I }) : r.createElement(f.default, { "aria-label": S })), [n]),
                    a = r.useCallback(
                        (e) => {
                            e.preventDefault(), t();
                        },
        ...
        699910: (e, t, n) => {
            ...
            const Z = "rules-container",
                ...
                I = Object.freeze({ Default: "Default", Pivot: "Pivot", Reorder: "Reorder" }),
                _ = (e, t) => {
                ...
                M = ({ badgeStyle: e, displayType: t = I.Default, explanation: n, getPivotLink: o, headerContainerStyle: l, headerExplanationStyle: s, heading: c, limit: d, onReorder: u, ruleContainerStyle: m, rules: p, withBottomMargin: g = !1, withHeader: b = !0 }) => {
                    const f = { badgeStyle: e },
                        E = ((e, t, n) => (t ? e.slice(0, t) : e).map((e, t) => ({ label: e.name, description: e.description, decoration: _(t + 1, n) })))(p, d, f),
                        C = (e) => _(e, f);
                    return E.length > 0 ? r.createElement(i.Z, { style: g ? B.bottomMargin : null, testID: Z }, b ? r.createElement(h, { containerStyle: l, explanation: n, explanationStyle: s, heading: c }) : null, t === I.Pivot && o ? r.createElement(y, { getPivotLink: o, renderBadge: C, rules: p }) : t === I.Reorder && u ? r.createElement(S, { onReorder: u, renderBadge: C, rules: p }) : r.createElement(a.Z, { containerStyle: m, items: E })) : null;
                };
        },
        724328: (e, t, n) => {
            n.d(t, { E: () => i });
            ...
            const W = m().e6057014,
                ...
                Y = (e) => {
                    const [t, n] = i.useState(void 0),
                        ...
                        S = v?.join_action_result,
                        _ = v?.leave_action_result,
                        B = (0, p.Wh)(k),
                        A = S?.reason === q.ViewerJoinRequestRequired,
                        Y = S?.reason === q.ViewerRequestPending,
                        Q = i.useCallback(() => {
                            ...
                            Z && Z(), !r && o && n(o), r && (e && e.length > 0 ? u(!0) : A ? w(x).catch(y({})) : f(x).then(C).catch(y({})));
                        }, [g, x, y, b, f, A, S, w, C, Z]),
                        X = i.useCallback(() => {
        ...
        581335: (e, t, n) => {
            ...
            const S = (e, t) => {
                ...
                I = (0, w.Z)()
                    .propsFromState(() => ({ community: S, fetchStatus: k.YE, isCommunityMember: k.Cp }))
        ...
        779610: (e, t, n) => {
            ...
            const d = (e) => {
                    const { decoration: t, description: n, disabled: d = !1, isActive: m = !1, label: p, link: h, onPress: g, paddingHorizontal: y, renderRightContent: b, role: f = "tab", styleOverride: E, testID: C = "pivot", thumbnail: Z, thumbnailSize: w, withoutArrow: v = !1 } = e,
                        ...
                        S = n ? ("string" == typeof n ? r.createElement(l.ZP, { color: "gray700", size: "subtext2", testID: `${C}-description` }, n) : n) : null,
                        I = r.useMemo(() => ("space0" === y ? { paddingHorizontal: 0 } : { paddingHorizontal: y ? c.default.theme.spaces[y] : c.default.theme.componentDimensions.gutterHorizontal }), [y]);
                    return r.createElement(s.Z, { "aria-selected": "tab" === f ? m : null, disabled: d, link: d ? void 0 : h, onPress: g, role: f, style: [u.root, I, d && u.disabled, E], testID: C, withInteractiveStyling: !!h || !!g }, r.createElement(i.Z, { style: u.contentContainer }, Z ? r.createElement(i.Z, { style: x }, Z) : null, r.createElement(i.Z, { style: u.content }, P, S), b ? b() : null, (!h && !g) || d || v ? null : k ? r.createElement(o.default, { style: u.icon }) : r.createElement(a.default, { style: u.icon })), t);
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.AudioSpacePeek~bundle.Communities~loader.CommunityHandler.4cc42c2a.js.map
