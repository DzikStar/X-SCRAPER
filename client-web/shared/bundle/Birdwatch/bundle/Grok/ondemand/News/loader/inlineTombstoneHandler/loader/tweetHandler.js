    ...
    ["shared~bundle.Birdwatch~bundle.Grok~ondemand.News~loader.inlineTombstoneHandler~loader.tweetHandler"],
    {
        ...
        400196: (e, t, i) => {
                ...
                ze = (0, we.Z)()
                    ...
                    .adjustStateProps(({ articleDomains: e, community: t, contextTweet: i, displaySensitiveMedia: n, explicitSocialContext: o, isActiveCreator: s, isInEditHistory: r, isNsfwUser: a, isPinned: d, pinnedRepliesEducationFlag: l, quoteTweetCommunity: c, topic: h, tweet: u, tweetDetailNav: p, urtAdvertiser: b, urtPromotedContent: _, userCountry: m, userLanguage: w, viewerUser: C }) => {
                        const S = u && (0, me.D$)(u, C?.id_str),
                            ...
                            f = (0, _e.uA)(t?.role),
                            T = o || S;
                        return { contextTweet: i, displaySensitiveMedia: n, isActiveCreator: s, isCardArticle: v, isInEditHistory: r, isNsfwUser: a, isPinned: d, pinnedRepliesEducationFlag: l, promotedContentAdvertiser: b || void 0, quoteTweetSocialContextProps: g, socialContext: T, socialContextColor: (0, _e.J2)(t, T), topic: h, tweet: Ue(u, { urtPromotedContent: _, urtAdvertiser: b }), tweetDetailNav: p, userCountry: m, userLanguage: w, viewerUser: C, withCommunityModerationAuthority: f };
                    })
            ...
            class ct extends o.Component {
                ...
                _renderContent() {
                    const { analytics: e, bookmarkFolderId: t, contextTweet: i, contextualClientEventInfo: n, conversationPosition: s, conversationTreeMetadata: a, displayBlocked: d, feedbackItems: l, forwardPivotInfo: c, hasModeratedReplies: h, hideConversationControlsEducationText: u, hideExclusivityInfoEducationTextInReplies: p, hideTrustedFriendsEducationTextInReplies: b, hitHighlights: _, injectedFeedbackItem: m, innerForwardPivotInfo: C, innerNudges: S, isCompact: A, isReaderMode: v, isUnread: y, linkify: k, location: g, nudges: f, promotedContentAdvertiser: T, quoteTweetSocialContextProps: I, quotedTweetTombstoneInfo: E, replyBadge: P, replyContext: x, rootTweetAuthorId: D, shouldSelfThreadIncludeAvatar: M, showReplyFilterInlineCallout: B, socialContext: Z, socialContextColor: U, topic: R, topicFollowPrompt: L, tweet: F, viewerUser: N, withActions: O, withActionsDisabled: H, withBirdwatchPivots: V, withCardLinks: W, withInlineMedia: q, withQuotedTweetLinks: z, withRemoveFromBookmarks: Q, withSelfThread: G, withSocialContext: j, withUserPresence: X } = this.props,
                        { enableKeyboardShortcuts: $ } = this.state,
                        Y = r.Z.getOriginalTweet(F),
                        ee = this._getPromotedContent(),
                        te = g.state?.overflow,
                        ie = g.state?.column?.showSmallMedia;
                    let ne = j;
                    j && this.context.featureSwitches.isTrue("rweb_home_mixer_enable_social_context_filter_social_contexts") && (ne = Z && Z.contextType in lt);
                    const oe = { ...{ bookmarkFolderId: t, contextTweet: i, contextualClientEventInfo: n, conversationPosition: s, conversationTreeMetadata: a, displayBlocked: d, enableKeyboardShortcuts: $, forwardPivotInfo: c, handleLikeOrUnlike: this._handleLikeOrUnlike, hasModeratedReplies: h, hideConversationControlsEducationText: u, hideExclusivityInfoEducationTextInReplies: p, hideTrustedFriendsEducationTextInReplies: b, hitHighlights: _, injectedFeedbackItem: m, innerForwardPivotInfo: C, innerNudges: S, isCompact: A, linkify: k, nudges: f, primaryFeedbackItem: l?.[0], promotedContentAdvertiser: T, quotedTweetTombstoneInfo: E, quoteTweetSocialContextProps: I, replyBadge: P, replyContext: x, rootTweetAuthorId: D, shouldSelfThreadIncludeAvatar: M, showReplyFilterInlineCallout: B, socialContext: Z, socialContextColor: U, topic: R, topicFollowPrompt: L, tweet: F, viewerUser: N, withActions: O, withActionsDisabled: H, withBirdwatchPivots: V, withCardLinks: W, withCondensedQuoteTweet: ie, withHalvedMediaSize: ie, withInlineMedia: q, withQuotedTweetLinks: z, withRemoveFromBookmarks: Q, withSelfThread: G, withSocialContext: ne, withUnreadStyles: y, withUserPresence: X }, ...(v ? this._getReaderModeTweetProps() : this._getBaseTweetProps()) },
                        se = o.createElement(J.nO, { data: this._getMemoizedScribeData(Y, ee, te, void 0, e.contextualScribeData) }, o.createElement(w.Z, { enabled: !!$, handlers: this._getShortcutKeyHandlers() }, o.createElement(K.ZP, oe)));
                    return ee ? o.createElement(nt, { id: F.id_str, onFullyVisible: this._handleFullyVisible, onResize: this._handleResize, onVisible: this._handleImpression }, se) : se;
                }
                _shouldRender() {
                    const { tweet: e } = this.props;
            ...
            const n = (0, i(523561).Z)({
                loader: () =>
                    Promise.all([
                        ...
                        i.e("loader.TweetCurationActionMenu-e96e9bea"),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Birdwatch~bundle.Grok~ondemand.News~loader.inlineTombstoneHandler~loader.tweetHandler.370f894a.js.map
