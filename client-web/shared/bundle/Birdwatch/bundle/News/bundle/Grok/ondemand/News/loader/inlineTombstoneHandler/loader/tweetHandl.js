...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.Birdwatch~bundle.News~bundle.Grok~ondemand.News~loader.inlineTombstoneHandler~loader.tweetHandl"],
    {
        ...
        400196: (e, t, i) => {
            ...
            const A = k.default.create(({ spaces: e }) => ({ header: { alignItems: "flex-start", flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginBottom: e.space20 }, headerSectionLeft: { flex: "1" }, headerUndoButton: { minWidth: e.space72 } }));
            var I = i(143670);
            ...
            const E = k.default.create(({ spaces: e }) => ({ icon: { marginEnd: e.space24 }, item: { paddingHorizontal: e.space8 } })),
                P = _().f376e9d4,
                x = _().d7c93b6c,
                M = _().b3abacee;
            ...
            const U = k.default.create((e) => ({ container: { paddingTop: e.spaces.space12, paddingStart: e.spaces.space16, paddingEnd: e.spaces.space16 } }));
            var R = i(530525),
                B = i(439592),
                D = i(529356);
            const L = i.p + "pin-tweet-reply.767a297a.png",
                ...
                H = _().e8a14626,
                O = _().d41305a8,
                V = ({ style: e }) => o.createElement(s.Z, { style: e }, o.createElement(R.Z, { "aria-label": O, aspectMode: B.Z.exact(1.5), image: L })),
                W = ({ onClose: e }) => o.createElement(D.Z, { actionLabel: F, graphic: V, graphicDisplayMode: "illustrationFullWidth", headline: N, isFullHeightOnMobile: !1, onAction: e, onClose: e, subtext: H, withCloseButton: !1 });
            var K = i(808692),
                q = i(622200),
                z = i(459284),
                Q = i(376293),
            ...
            const Re = (e, t) => (0, fe.MW)(e, t.tweetId),
                ...
                He = xe.Z.createHydratedTweetSelectorWeakMap((e, t) => Ne(t.tweetId)),
                Oe = (e, t) => {
                    const i = He(e, t),
                        n = i?.quoted_status;
                    return n ? (0, ge.z0)(e, n) : void 0;
                ...
                ze = (0, be.Z)()
                    .propsFromState(() => ({ articleDomains: ke.cb, community: Fe, contextTweet: Ke, displaySensitiveMedia: Se.f1, explicitSocialContext: De, isActiveCreator: Ie.WM, isInEditHistory: Me.l0, isNsfwUser: Se.EF, isPinned: Re, pinnedRepliesEducationFlag: qe, quoteTweetCommunity: Oe, topic: Le, tweet: He, tweetDetailNav: ye.wZ, urtAdvertiser: We, urtPromotedContent: Ve, userCountry: Ie.GG, userLanguage: Ie.VT, viewerUser: Ue.ZP.selectViewerUser }))
                    ...
                    .propsFromActions(() => ({ addToast: Ee.fz, addPinnedReplyEducationFlag: () => (0, ve.pj)(ve.vA), block: Ue.ZP.block, createLocalApiErrorHandler: (0, me.zr)("TWEET_CONTAINER_CONTEXT"), fetchCommunityIfNeeded: ge.ZP.fetchOneIfNeeded, fetchTopicIfNeeded: Pe.Z.fetchOneIfNeeded, like: xe.Z.like, log: Te.cM, mute: Ae.r, onUnretweet: Ze.Z, richScribeAction: Ce.richScribeAction, setArticlesVisited: ke.Ji, undoTopicNotInterested: Pe.Z.undoNotInterested, unblock: Ue.ZP.unblock, unlike: xe.Z.unlike, unmute: Ue.ZP.unmute }));
            var Qe = i(759469),
                Ge = i(125363);
            var je = i(390686),
                Xe = i(555492),
                    ...
                    super(e, t),
                        ...
                        (this._getBaseTweetProps = () => {
                            ...
                            return {
                                ...
                                promotedContent: E,
                                renderCurationActionMenu: y && !b.isPreview ? this._getRenderCurationActionMenu(s && s.displayType, s && s.landingUrl, n, a, g, d, c, x, this._handleCaretClick, h, E, S, f, v, T, A, U, I, i, R, C, k, this._setLeaveBehindActionItems, this._shouldRenderImmediateDismiss()) : void 0,
                                renderPrerollActionMenu: this._getRenderPrerollActionMenu(a, d, h, E, S, C, k),
                        ...
                        (this._getRenderCurationActionMenu = (0, p.Z)((e, t, i, n, s, r, a, l, d, c, h, u, _, m, p, w, b, C, k, g, v, y, f, T) => () => o.createElement(z.Z, { feedbackItems: i, forwardPivotDisplayType: e, forwardPivotLandingUrl: t, isActiveCreator: n, isDisabled: s, isNsfwUser: r, isPinned: a, onMenuClick: d, onTweetDismiss: c, promotedContent: h, setLeaveBehindActionItems: f, tweet: u, userCountry: v, userLanguage: y, withChangeConversationControls: b, withChangeConversationControlsTooltip: g, withCommunityModerationAuthority: m, withHideReply: _, withImmediateDismiss: T, withMuteConversation: p, withUnhideReply: w, withViewHiddenReplies: C }))),
        ...
        383494: (e, t, i) => {
            ...
            const l = ({ addToast: e, createLocalApiErrorHandler: t, dismissUserFromConversation: i, hasPremiumPlus: l, history: d, mute: c, muteAdUpsellEnabled: h, promotedContent: u, scribeAction: _, unmute: m, user: p }) => {
                ...
                return { Icon: b, text: k, onClick: C, shortcutKey: a.uq.mute };
            };
        },
        459284: (e, t, i) => {
            i.d(t, { Z: () => n });
            i(202784);
            const n = (0, i(523561).Z)({ loader: () => Promise.all([i.e("icons.8"), i.e("icons.15"), i.e("icons.3"), i.e("icons.12"), i.e("icons.21"), i.e("icons.16"), i.e("icons.17"), i.e("icons.0"), i.e("shared~loader.DMDrawer~bundle.ReaderMode~bundle.Articles~bundle.AudioSpacePeek~bundle.Birdwatch~bundle.Brande"), i.e("shared~loader.Dock~bundle.DockPeek~bundle.Grok~bundle.LiveEvent~loader.TimelineFrameHandler~loader.J-f4267732"), i.e("shared~loader.Dock~bundle.DockPeek~bundle.Grok~bundle.LiveEvent~loader.TimelineFrameHandler~loader.J-80af7626"), i.e("shared~bundle.AccountAnalytics~ondemand.SettingsInternals~ondemand.SettingsRevamp~bundle.Payments~bundle.Prem"), i.e("shared~bundle.Birdwatch~bundle.News~bundle.Grok~ondemand.News~loader.inlineTombstoneHandler~loader.tweetHandl"), i.e("loader.TweetCurationActionMenu-a2dee9c7"), i.e("loader.TweetCurationActionMenu-e019dbda"), i.e("loader.TweetCurationActionMenu-8ed0fac5")]).then(i.bind(i, 713842)) });
        },
        775412: (e, t, i) => {
            i.d(t, { W: () => a });
            var n = i(111677),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Birdwatch~bundle.News~bundle.Grok~ondemand.News~loader.inlineTombstoneHandler~loader.tweetHandl.e0457ffa.js.map
