    ...
    ["shared~bundle.Communities~loader.ListHandler"],
    {
        346252: (e, a, l) => {
            ...
            const h = Object.freeze({ Fixed: "fixed", Variable: "variable" }),
                b = (e) => {
                    const { category: a, eventState: l, gameClock: n, gameClockPeriod: t, participants: o, startTimeMillis: d, winnerId: s } = e,
                        c = (0, u.bH)(a, l, o, t, s);
                    return r.createElement(i.Z, { "aria-label": c, category: a, containerStyle: g.scoreCardTile, gameClock: n, gameClockPeriod: t, gameState: l, isCompact: !0, startTimeMillis: d, teams: o, winnerId: s });
                },
                ...
                f = (e) => {
                    const { cropCandidates: a, dataSaverMode: l, icon: i, image: s, isCellWithProminentSocialContext: u, scoreEvent: h, type: f = "variable" } = e,
                        y = p({ isCellWithProminentSocialContext: u, type: f });
                    return r.createElement(n.Z, { style: [g.coverContainer, y] }, h ? b(h) : !s || (0, c.Z)(s) || l ? (l || (0, c.Z)(s) ? r.createElement(d.Z, { ratio: 1 }, r.createElement(m.Vm, { icon: i })) : null) : r.createElement(t.Z, { "aria-label": "", aspectMode: o.Z.SQUARE, cropCandidates: a, image: s }));
                };
        },
        53821: (e, a, l) => {
            l.d(a, { Z: () => V });
            var r = l(202784),
                ...
                I = l(601576);
            const E = (0, k.Z)()
                    .propsFromActions(() => ({ addToast: I.fz, createLocalApiErrorHandler: (0, M.zr)("TOGGLE_PIN_LIST"), pinTimeline: _.qM, unpinTimeline: _.bK }))
                    .withAnalytics(),
                P = m().c5d23126,
                T = m().j44ec610,
                v = m().d8a032a2,
                ...
                A = m().cdb33880,
                R = (e) => {
                    const { addToast: a, analytics: l, couldPinList: n, createLocalApiErrorHandler: t, isListPinned: o, listId: d, mode: i, name: s, pinTimeline: c, unpinTimeline: u } = e,
                        m = r.useMemo(() => (i === f.H.Reordering ? r.createElement(w.default, null) : o ? r.createElement(D.default, null) : r.createElement(C.default, { style: n ? null : F.disabledPin })), [n, o, i]),
                        h = r.useMemo(() => {
                            if (i === f.H.Pinning) return { label: o ? T : P };
                        }, [o, i]),
                        b = r.useCallback(() => {
                            if (n || o) {
                                const e = o ? "unpin_button" : "pin_button";
                                l.scribe({ element: e, action: "click" }), o ? u({ id: d, name: s, type: S.FO.LIST }).catch(t) : c({ id: d, name: s, type: S.FO.LIST }).catch(t);
                            } else l.scribe({ element: "unpinnable_button", action: "click" }), a({ text: v });
                        }, [a, l, n, t, o, d, s, c, u]),
                        p = r.useMemo(() => (i === f.H.Reordering ? Z : o ? A : x), [o, i]);
                    return r.createElement(y.ZP, { "aria-label": p, hoverLabel: h, icon: m, onPress: i === f.H.Pinning ? b : void 0, testID: "list-icon-button", type: "brandText" });
                },
            ...
            const O = "cellThumbnail",
                ...
                $ = (e) => {
                    const { dataSaverMode: a, decoration: l, facepileUrls: c, followersContext: u, isFollowing: m, isListPinned: y, isSelected: w, listId: D, listVisibility: C, media: S, memberCount: M, membersContext: k, mode: _, name: I, onClick: E, pinnedTimelinesCount: P, role: T, user: v, withBottomBorder: Z, withHoverCard: x, withSubscribe: A = !1 } = e,
                        { featureSwitches: R } = (0, p.QZ)(),
                        F = R.getNumberValue("home_timeline_spheres_max_user_owned_or_subscribed_lists_count", K.F),
                        $ = !P || P < F,
                        V = `/i/lists/${D}`,
                        G = r.useCallback((e) => (e ? r.createElement(H.Z, { basePath: V, listId: D, wrapperStyle: { maxWidth: "100%" } }, e) : null), [V, D]),
                        j = r.useMemo(() => r.createElement(n.Z, { style: W.name }, r.createElement(t.ZP, { numberOfLines: 1, weight: "bold" }, I), "private" === C ? r.createElement(t.ZP, { size: "body", style: W.icon }, r.createElement(h.default, { "aria-label": U, style: W.iconLock })) : null), [C, I]),
                        q = r.useMemo(() => r.createElement(n.Z, { style: W.thumbnailImage, testID: O }, r.createElement(z.Z, { cropCandidates: S.crop, dataSaverMode: a, icon: "lists", image: S.image, type: "fixed" })), [a, S.crop, S.image]),
                        Q = r.useMemo(() => l || (w ? r.createElement(b.default, { style: W.iconCheckmark }) : _ === f.H.Reordering || _ === f.H.Pinning ? r.createElement(L, { couldPinList: $, isListPinned: y, listId: D, mode: _, name: I }) : A ? r.createElement(g.Z, { isFollowing: m, isMinimal: !0, listId: D, listName: I, user: v }) : void 0), [$, l, y, m, w, D, _, I, v, A]),
                        Y = (0, B.z)(),
                        X = r.useCallback(
                            (e) => {
                                Y.contextualScribeNamespace.element ? Y.scribeAction("click") : Y.scribe({ component: "list", action: "click" }), E?.(e, { listId: D, member_count: M });
                            },
                            [Y, E, D, M],
                        );
                    return r.createElement(o.Z, { "aria-checked": w, link: { pathname: V, anchorless: !0 }, onPress: X, role: T, style: [W.root, Z && W.bottomBorder], testID: N }, r.createElement(n.Z, { style: W.listContainer }, r.createElement(n.Z, { style: W.leftColumn }, G(q), r.createElement(n.Z, { style: W.listAttribution }, r.createElement(n.Z, { style: W.nameContainer }, G(j), k ? r.createElement(t.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2" }, r.createElement(d.Z, null), k) : null), c && u ? r.createElement(n.Z, { style: W.rowContainer }, r.createElement(i.Z, { style: W.facepile, userAvatarUrls: c }), r.createElement(t.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2" }, u)) : v ? r.createElement(s.Z, { affiliateBadgeInfo: v.highlightedLabel, avatarSize: "small", color: "text", isBlueVerified: v.is_blue_verified, isProtected: v.protected, isVerified: v.verified, name: v.name, nameSize: "subtext2", profileImageUrl: v.profile_image_url_https, screenName: v.screen_name, screenNameSize: "subtext2", verifiedType: v.verified_type, withHoverCard: x, withLink: !0, withScreenName: !0 }) : null)), r.createElement(n.Z, { style: W.rightColumn }, Q)));
                },
        ...
        878162: (e, a, l) => {
            ...
            const i = (0, l(523561).Z)({
                loader: () =>
                    Promise.all([
                        ...
                        l.e("shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-2b309ab6"),
            ...
            function u(e) {
                const { basePath: a, children: l, listId: o, wrapperStyle: s } = e,
                    u = (0, c.oR)(),
                    h = r.useCallback(() => (0, d.Dd)(u.getState()), [u]);
                return r.createElement(t.Z, { renderContent: () => r.createElement(n.Z, { style: m.root }, r.createElement(i, { basePath: a, listId: o, withEditButton: !1, withRoundedCorners: !0 })), shouldDisable: h, wrapperStyle: s }, l);
            }
        ...
        741692: (e, a, l) => {
            ...
            const u = "placeholderIcon",
                m = ({ author: e, color: a = "text", size: l = "subtext2", style: n, withHoverCard: o = !0, withLink: d = !1, withScreenName: i = !1 }) => r.createElement(t.Z, { affiliateBadgeInfo: e.highlightedLabel, avatarSize: { subtext2: "small", body: "medium", headline1: "large" }[l], color: a, isBlueVerified: e.is_blue_verified, isProtected: e.protected, isVerified: e.verified, name: e.name, nameSize: l, profileImageUrl: e.profile_image_url_https, screenName: e.screen_name, screenNameSize: l, style: [p.authorUserName, n], verifiedType: e.verified_type, withHoverCard: o, withLink: d, withScreenName: i }),
                h = ({ style: e }) => r.createElement(n.Z, { style: [p.lightningBadge, e] }, r.createElement(d.default, { style: p.lightningIcon })),
                b = ({ icon: e }) => r.createElement(n.Z, { style: p.placeholderIconContainer, testID: u }, "news" === e ? r.createElement(i.default, { style: p.placeholderIcon }) : "lists" === e ? r.createElement(s.default, { style: p.placeholderIcon }) : r.createElement(c.default, { style: p.placeholderIcon })),
        ...
        989816: (e, a, l) => {
            ...
            const b = (0, m.Z)()
                    ...
                    .withAnalytics(),
                p = { followIcon: r.createElement(o.default, null), followingIcon: r.createElement(d.default, null) },
                g = (e) => {
                    const { analytics: a, createLocalApiErrorHandler: l, disabled: t, follow: o, isFollowing: d, isMinimal: u, listId: m, listName: h, unfollow: b, user: g } = e,
                        y = r.useCallback(() => {
                            a.scribeAction("follow"), o(m).catch(l(i.lg));
                        }, [a, l, o, m]),
                        w = r.useCallback(() => {
                            a.scribeAction("unfollow"), b(m).catch(l(i.Sm));
                        }, [a, l, m, b]);
                    return r.createElement(c.Z, { customText: h, displayMode: s.BH.subscribe, userFullName: g?.name }, (e) => r.createElement(n.Z, { buttonIcons: u ? p : void 0, disabled: t, displayMode: u ? "only-icon" : void 0, isFollowing: d, onFollow: e(y), onUnfollow: e(w), showRelationshipChangeConfirmation: !1, size: "small", style: f.followButton, type: "list" }));
                },
            ...
            var r,
                n = {
                    ...
                    selections: [
                        ...
                        { alias: null, args: null, concreteType: "UserResults", kind: "LinkedField", name: "owner_results", plural: !1, selections: [{ alias: null, args: null, concreteType: null, kind: "LinkedField", name: "result", plural: !1, selections: [{ kind: "InlineFragment", selections: [{ alias: "author", args: null, concreteType: "ApiUser", kind: "LinkedField", name: "legacy", plural: !1, selections: [{ alias: null, args: null, kind: "ScalarField", name: "id_str", storageKey: null }, r, { kind: "RequiredField", field: { alias: null, args: null, kind: "ScalarField", name: "protected", storageKey: null }, action: "THROW", path: "owner_results.result.author.protected" }, { alias: null, args: null, kind: "ScalarField", name: "profile_image_url_https", storageKey: null }, { alias: null, args: null, kind: "ScalarField", name: "screen_name", storageKey: null }, { kind: "RequiredField", field: { alias: null, args: null, kind: "ScalarField", name: "verified", storageKey: null }, action: "THROW", path: "owner_results.result.author.verified" }], storageKey: null }], type: "User", abstractKey: null }], storageKey: null }], storageKey: null },
                        { args: null, kind: "FragmentSpread", name: "useBannerImage_list" },
                    ],
                    type: "List",
                    abstractKey: null,
                };
            n.hash = "76a4e2bef500a63f094981909c5eb075";
            const t = n;
            var o = l(202784),
                d = (l(585488), l(277660)),
                i = l.n(d),
            ...
            const d = n().a3484d22,
                ...
                u = (e, a, l, r, n) => {
                    const u = l && n ? ((e, a) => (e && a ? e.find((e) => e.id === a) : void 0))(l, n) : void 0,
                        ...
                        p = l && l[1] ? c(l[1]) : "",
                        g = r || "",
                        f = u ? i({ winner: u.fullName }) : "",
                        y = a === o.D.Completed ? (u ? f : d) : g;
        ...
        320588: (e, a, l) => {
            ...
            const d = n().add55942,
                ...
                s = n().e20fc756,
                c = n().hae1c934,
                u = { customErrorHandler: () => (0, o.mf)({ text: d }), showToast: !0 },
                m = { customErrorHandler: () => (0, o.mf)({ text: i }), showToast: !0 },
                h = {
        ...
        165822: (e, a, l) => {
            ...
            var r = l(202784),
                ...
                o = l(530732),
                d = l(392237);
            const i = d.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                s = ({ "aria-label": e, containerStyle: a, disabled: l, isCompact: s, link: c, lower: u, onClick: m, stackLayoutLowerStyle: h, stackLayoutUpperStyle: b, upper: p, withInsetFocusRing: g = !0, withInteractiveStyling: f = !1 }) => {
                    const y = t.Z.generate({ backgroundColor: d.default.theme.colors.transparent, color: d.default.theme.colors.primary, insetFocusRing: g }),
                        w = r.createElement(r.Fragment, null, r.createElement(n.Z, { style: [i.defaultUpperContainerStyle, b, s && { height: "auto" }] }, p), u ? r.createElement(n.Z, { style: [i.defaultLowerContainerStyle, h] }, u) : null);
                    return r.createElement(o.Z, { "aria-label": e, disabled: l, interactive: f, interactiveStyles: f ? y : void 0, link: c, onClick: m, style: [i.root, a] }, w);
                };
        },
        745185: (e, a, l) => {
            l.d(a, { Z: () => y });
            ...
            class b extends r.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderTeamName = () => {
                            ...
                            return r.createElement(o.Z, { style: g.teamNameContainer }, r.createElement(i.ZP, { color: p(e), numberOfLines: 1, style: { textOverflow: "ellipsis" }, weight: "heavy" }, a));
                        }),
                        (this._renderImage = () => {
                            const {
                                    isCompact: e,
                                ...
                                i = l ? s.Z.exact(l.width / l.height) : s.Z.SQUARE;
                            return r.createElement(o.Z, { style: [g.imageContainer, t, e && g.compactImageContainer] }, r.createElement(d.Z, { "aria-label": "", aspectMode: i, image: l || a || "", onError: this._handleImageError, rounded: !l }));
                        }),
                        ...
                        (this._renderScore = () => {
                            const { category: e, gameState: a, team: l, winnerId: n } = this.props,
                                { color: t, id: d, score: s, secondaryScore: c } = l,
                                u = d === n,
                                b = !n,
                            ...
                            return y ? r.createElement(o.Z, { style: [g.teamScore, f && g.losingTeamScore] }, r.createElement(i.ZP, { color: p(t), numberOfLines: 1, size: w, weight: "heavy" }, C), c ? r.createElement(i.ZP, { color: p(t), numberOfLines: 1, size: D, weight: "bold" }, c) : null) : null;
                        }),
                ...
                render() {
                    const {
                        ...
                        d = !a || !t;
                    return r.createElement(o.Z, { style: [g.root, n, a && g.compactRoot] }, this._renderImage(), d ? this._renderTeamName() : null, this._renderScore());
                }
            }
            function p(e) {
                return e
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderGameStatus = () => {
                            const { category: e, gameClock: a, gameClockPeriod: l, gameState: n, isCompact: o, startTimeMillis: d, teams: i, winnerId: s } = this.props;
                            return r.createElement(t.Z, { category: e, gameClock: a, gameClockPeriod: l, gameState: n, startTimeMillis: d, teams: i, winnerId: s, withCategory: !o });
                        }),
                        (this._renderTeamRow = (e, a) => {
                            const { category: l, gameState: n, isCompact: t, winnerId: o } = this.props,
                                { id: d } = e;
                            return r.createElement(f, { category: l, fallbackColor: a % 2 == 0 ? "gray300" : "gray700", gameState: n, isCompact: t, key: d, team: e, winnerId: o });
                        });
                }
                render() {
                    const { "aria-label": e, containerStyle: a, isCompact: l, link: t, onClick: o, teams: d } = this.props;
                    if (d) {
                        const i = d && d.map(this._renderTeamRow);
                        return r.createElement(n.Z, { "aria-label": e, containerStyle: a, isCompact: l, link: t, lower: l ? void 0 : this._renderGameStatus(), onClick: o, upper: i, withInteractiveStyling: !0 });
                    }
                    return null;
                }
            }
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderTodayTomorrow = (e, a) => {
                            const l = u(a);
                            return r.createElement(d.Z, null, r.createElement(o.ZP, { color: "gray700", size: "subtext2", weight: "bold" }, 0 === e ? y : w), r.createElement(o.ZP, { color: "gray700", size: "subtext2" }, l));
                        }),
                        (this._renderDateTime = (e) => {
                            const a = u(e),
                                l = c(e);
                            return r.createElement(d.Z, null, r.createElement(o.ZP, { color: "gray700", size: "subtext2", weight: "bold" }, l), r.createElement(o.ZP, { color: "gray700", size: "subtext2" }, a));
                        }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Communities~loader.ListHandler.e90accba.js.map
