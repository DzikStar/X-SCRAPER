    ...
    ["shared~bundle.Delegate~bundle.AdvancedSearch"],
    {
        625661: (e, t, o) => {
            ...
            class h extends a.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: o, fixed: r, hideBackButton: i, isFullWidth: l, isLarge: d, leftControl: c, middleControl: h, position: u, rightControl: b, secondaryBar: m, style: g, subtitle: f, title: y, titleDomId: C, titleIconCell: k, titleIconCellSize: B, withBackground: _, withWideContainer: x } = this.props,
                        { isModal: Z } = this.context,
                        w = i ? c : a.createElement(n.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        E = (function (e, t, o) {
                            return e && !(t && o);
                        })(!!_, Z, !!m);
                    return a.createElement(a.Fragment, null, a.createElement(s.Z, { centerTitle: t, centeredLogo: o, isFullWidth: l, isLarge: d, leftControl: w, middleControl: h, position: p(u, Z, r), rightControl: b, style: g, subtitle: f, title: y, titleDomId: C, titleIconCell: k, titleIconCellSize: B, withBackground: E, withWideContainer: x }), m || null);
                }
                render() {
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: o, backLocation: i, centerTitle: l, hideBackButton: n, history: s, isFullWidth: p, isLarge: h, middleControl: u, onBackClick: m, rightControl: g, secondaryBar: f, subtitle: y, title: C } = this.props,
                                { isModal: k } = this.context;
                            return a.createElement(r.Z, { style: k ? [b.childViewAppBarRoot, b.appBarZindex] : b.appBarZindex }, a.createElement(c.ZP, { backButtonType: o || (k ? "close" : "back"), backLocation: i, centerTitle: l, fixed: !k, hideBackButton: n, history: s, isFullWidth: p, isLarge: h, middleControl: u, onBackClick: m, ref: e, rightControl: g, secondaryBar: f, style: [k && b.appBarModal, t], subtitle: y, title: C, titleDomId: d.Q_ }));
                        }),
        ...
        449479: (e, t, o) => {
            ...
            class u extends a.Component {
                ...
                render() {
                    const { "aria-posinset": e, "aria-setsize": t, checked: o, disabled: p, helpText: u, label: m, name: g, testID: f } = this.props,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Delegate~bundle.AdvancedSearch.7589046a.js.map
