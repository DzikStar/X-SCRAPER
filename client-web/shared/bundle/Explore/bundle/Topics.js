    ...
    ["shared~bundle.Explore~bundle.Topics", "bundle.AudioSpaceDetail"],
    {
        ...
        337523: (e, a, n) => {
            ...
            class G extends t.Component {
                ...
                render() {
                    ...
                    const p = this._getModule(i, n?.tabs?.initialTabId, a, s),
                        ...
                        h = m ? 1e3 * m : void 0;
                    return t.createElement(b.nO, { namespace: this._getTimelineNamespace() }, t.createElement(_.Z, { entryConfiguration: e, module: p, pollingIntervalMsOverride: h, prerollDisplayLocation: o, refreshControl: r, renderEmptyState: d, renderUnavailable: l, title: c, withoutHeadroom: u }));
                }
            }
            G.contextType = P.rC;
            const F = L(G);
            ...
            function Q(e) {
                ...
                return t.createElement(W.Z, { style: K.root }, t.createElement(b.nO, { data: i, namespace: s }, t.createElement(z.Z, { displayType: n, facepile: o, onFollowHeaderOffscreen: ({ isOffscreen: e }) => l(!e), topicId: d, topicLandingContext: r, withDivider: !0 })));
            }
        ...
        403556: (e, a, n) => {
            ...
            class M extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": a, badgeCount: n, badgePip: t, children: r, color: d, isActive: s, isCompact: c, isPillLink: u, isRoundedRect: p, isWebRedesign: h, retainScrollPosition: M, style: A, to: k } = this.props,
                        ...
                        h = o.useMemo(
                            () =>
                                s.filter(Boolean).map(({ label: a, viewType: r, ...d }, s) => {
                                    ...
                                    return o.createElement(A, (0, t.Z)({ viewType: r }, d, { isCompact: n, isPillLink: l, isRoundedRect: i, isWebRedesign: b, style: c }), a);
                                }),
                            [e, n, l, i, b, s],
                        );
                    return o.createElement(r.Z, { "aria-label": a, buttonsContainerStyle: l && k.gap, childrenStyle: !b && k.flexGrow, key: p, style: [l ? null : k.segmentedControl, b && k.leftAligned, c], visibleItemIndex: u }, h);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Explore~bundle.Topics.12ad314a.js.map
