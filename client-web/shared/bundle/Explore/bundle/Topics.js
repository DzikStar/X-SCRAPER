    ...
    ["shared~bundle.Explore~bundle.Topics", "bundle.AudioSpaceDetail"],
    {
        ...
        337523: (e, a, n) => {
            ...
            class G extends t.Component {
                ...
                render() {
                    ...
                    const p = this._getModule(i, n?.tabs?.initialTabId, a, s),
                        ...
                        b = m ? 1e3 * m : void 0;
                    return t.createElement(h.nO, { namespace: this._getTimelineNamespace() }, t.createElement(Z.Z, { entryConfiguration: e, module: p, pollingIntervalMsOverride: b, prerollDisplayLocation: o, refreshControl: d, renderEmptyState: r, renderUnavailable: l, title: c, withoutHeadroom: u }));
                }
            }
            G.contextType = B.rC;
            const F = L(G);
            ...
            function Q(e) {
                ...
                return t.createElement(W.Z, { style: K.root }, t.createElement(h.nO, { data: i, namespace: s }, t.createElement(z.Z, { displayType: n, facepile: o, onFollowHeaderOffscreen: ({ isOffscreen: e }) => l(!e), topicId: r, topicLandingContext: d, withDivider: !0 })));
            }
            ...
            const be = $.default.create((e) => ({ rightControl: { flexDirection: "row" }, followButtonContainer: { justifyContent: "center", paddingEnd: e.spaces.space4 } })),
                ge = ue(function (e) {
                    const a = e.navBar.topicId ? e.navBar.topicId : "",
                        ...
                        b = (0, s.Z)({}, d, m);
                    return r ? t.createElement(h.nO, { data: p, namespace: b }, t.createElement(t.Fragment, null, i ? t.createElement(de.Z, { canonical: pe(a), description: r.description, title: r.name, type: "article" }) : null, l ? t.createElement(oe.Z, { deepLink: me(a) }) : null, t.createElement(W.Z, { style: be.rightControl }, t.createElement(W.Z, { style: be.followButtonContainer }, t.createElement(te.Z, { animateMount: !0, show: n, type: "fade" }, t.createElement(re.ZP, { size: "medium", textMode: le.q.FollowTopic, topic: r }))), u ? t.createElement(ie.ZP, { copyLinkShareLabel: he, scribeNamespace: b, url: pe(a) }) : null))) : null;
                }),
                fe = i().e9f1fbcc,
                De = t.createElement(c.Z, null),
                we = (e) => {
                    const { TabBar: a, backLocation: n, documentTitle: o, entryConfiguration: l, fab: i, getTabLink: c, hasTabNavigation: f, history: D, initialFetchStatus: w, initialPageNamespace: y, logoButton: M, module: C, onBackClick: S, pageConfiguration: A, prerollDisplayLocation: k, renderEmptyState: I, renderUnavailable: N, rightControl: v, selectedTabId: E, sidebarContent: P, timelinePrefix: B, title: _, withAppLinks: Z, withBottomLoginSignupBar: x, withDeferredView: R, withOpenGraphMeta: L, withSearchBox: G, withTweetButton: O } = e,
                        W = (0, d.tj)(),
                        ...
                        ae = R ? u.Z : t.Fragment,
                        ne = t.createElement(t.Fragment, null, X, t.createElement(ae, null, t.createElement(F, { entryConfiguration: $, initialModule: C, prerollDisplayLocation: k, renderEmptyState: I, renderUnavailable: N, selectedTabId: E, timelinePrefix: B, title: _, withoutHeadroom: !0 }))),
                        te = i ? t.createElement(p.Z, { component: r.Z, fab: i }, ne) : ne,
                        oe = c && f ? t.createElement(T, { getTabLink: c, module: C, selectedTabId: E }) : void 0;
        ...
        403556: (e, a, n) => {
            ...
            class M extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": a, badgeCount: n, badgePip: t, children: d, color: r, isActive: s, isCompact: c, isPillLink: u, isRoundedRect: p, isWebRedesign: b, retainScrollPosition: M, style: S, to: A } = this.props,
                        { location: k } = this.state,
                        I = A ? this._getMemoizedLink(A, M) : void 0,
                        N = s ? s(A) : k?.pathname === I?.pathname,
                        T = g.Z.generate({ backgroundColor: "transparent", color: l.default.theme.colors.text, insetFocusRing: !0 }),
                        v = b ? "medium" : N ? "bold" : "medium";
                    return o.createElement(f.Z, { "aria-label": a, "aria-selected": N, focusable: !!N, interactiveStyles: T, link: I, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? C.pill : C.link, u && N ? C.active : null, c ? (u ? C.compactPill : C.compactLink) : null, p ? C.roundedRect : null, S], withoutInteractiveStyles: b || u }, ({ isFocused: a, isHovered: s }) => o.createElement(i.Z, { style: u && C.flexGrow }, o.createElement(m.ZP, { size: b ? "headline2" : void 0, style: [C.text, { color: this._getTextColor(N, s, b, u) }, c && C.compactText, b && a && C.focusedText], weight: v }, e && o.createElement(e, { style: C.icon }), d, b || u ? null : o.createElement(i.Z, { style: N && [C.border, { backgroundColor: l.default.theme.colors[r] }] })), n ? o.createElement(h.Z, { count: n, standalone: !0, style: [C.badge, n >= 10 && C.multiDigitBadge, n >= 20 && C.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: D, withBorder: !1 }) : t ? o.createElement(h.Z, { pip: !0, standalone: !0, style: C.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
                        ...
                        b = o.useMemo(
                            () =>
                                s.filter(Boolean).map(({ label: a, viewType: d, ...r }, s) => {
                                    const c = h ? [A.linkRedesign, 0 === s && A.firstLinkRedesign, e && 0 === s && A.withNoPaddingStart] : void 0;
                                    return o.createElement(S, (0, t.Z)({ viewType: d }, r, { isCompact: n, isPillLink: l, isRoundedRect: i, isWebRedesign: h, style: c }), a);
                                }),
                            [e, n, l, i, h, s],
                        );
                    return o.createElement(d.Z, { "aria-label": a, buttonsContainerStyle: l && A.gap, childrenStyle: !h && A.flexGrow, key: p, style: [l ? null : A.segmentedControl, h && A.leftAligned, c], visibleItemIndex: u }, b);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Explore~bundle.Topics.c86aca6a.js.map
