    ...
    ["shared~bundle.Explore~bundle.Topics", "bundle.AudioSpaceDetail"],
    {
            ...
            class G extends t.Component {
                ...
                render() {
                    ...
                    const p = this._getModule(i, n?.tabs?.initialTabId, a, s),
                        ...
                        b = m ? 1e3 * m : void 0;
                    return t.createElement(h.nO, { namespace: this._getTimelineNamespace() }, t.createElement(Z.Z, { entryConfiguration: e, module: p, pollingIntervalMsOverride: b, prerollDisplayLocation: o, refreshControl: r, renderEmptyState: d, renderUnavailable: l, title: c, withoutHeadroom: u }));
                }
            }
            G.contextType = B.rC;
            const F = L(G);
        ...
        403556: (e, a, n) => {
            ...
            class M extends o.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": a, badgeCount: n, badgePip: t, children: r, color: d, isActive: s, isCompact: c, isPillLink: u, isRoundedRect: p, isWebRedesign: b, retainScrollPosition: M, style: S, to: A } = this.props,
                    ...
                    return o.createElement(f.Z, { "aria-label": a, "aria-selected": N, focusable: !!N, interactiveStyles: T, link: I, onPress: this._handleClick, ref: this._setRef, role: "tab", style: [u ? C.pill : C.link, u && N ? C.active : null, c ? (u ? C.compactPill : C.compactLink) : null, p ? C.roundedRect : null, S], withoutInteractiveStyles: b || u }, ({ isFocused: a, isHovered: s }) => o.createElement(i.Z, { style: u && C.flexGrow }, o.createElement(m.ZP, { size: b ? "headline2" : void 0, style: [C.text, { color: this._getTextColor(N, s, b, u) }, c && C.compactText, b && a && C.focusedText], weight: v }, e && o.createElement(e, { style: C.icon }), r, b || u ? null : o.createElement(i.Z, { style: N && [C.border, { backgroundColor: l.default.theme.colors[d] }] })), n ? o.createElement(h.Z, { count: n, standalone: !0, style: [C.badge, n >= 10 && C.multiDigitBadge, n >= 20 && C.truncatedCountBadge], truncatedCountFormatter: y, unreadCountLabel: D, withBorder: !1 }) : t ? o.createElement(h.Z, { pip: !0, standalone: !0, style: C.badgePip, textColor: "red500", unreadCountLabel: w, withBorder: !1 }) : null));
                }
            }
                        ...
                        b = o.useMemo(
                            () =>
                                s.filter(Boolean).map(({ label: a, viewType: r, ...d }, s) => {
                                    ...
                                    return o.createElement(S, (0, t.Z)({ viewType: r }, d, { isCompact: n, isPillLink: l, isRoundedRect: i, isWebRedesign: h, style: c }), a);
                                }),
                            [e, n, l, i, h, s],
                        );
                    return o.createElement(r.Z, { "aria-label": a, buttonsContainerStyle: l && A.gap, childrenStyle: !h && A.flexGrow, key: p, style: [l ? null : A.segmentedControl, h && A.leftAligned, c], visibleItemIndex: u }, b);
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Explore~bundle.Topics.e1fe1cca.js.map
