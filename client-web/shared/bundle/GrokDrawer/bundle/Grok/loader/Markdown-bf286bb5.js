...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-bf286bb5"],
    {
        186794: (e, t, n) => {
            n.d(t, { Z: () => A });
            n(136728);
            ...
            function F({ analytics: e, button: t, buttonOverrides: n, disabled: l, isInputCompact: s, isToggled: i, onButtonEnter: d, onButtonLeave: m, onDisabledClick: E, onEnabledClick: k, onHomeScreen: x, statusKey: _ }) {
                ...
                return Y
                    ...
                    : i || "FileInput" !== N.enabledOnClickBehavior
                      ? a.createElement(L, { dropdownMenuItems: ae, handleMouseEnter: ee, handleMouseLeave: te, hideTooltip: () => V(!1), isHoveringButton: G, isInputCompact: s, isToggled: i, showTooltip: A, tooltipText: X }, a.createElement(C.ZP, oe, re))
                      : a.createElement(
                            L,
                            { handleMouseEnter: ee, handleMouseLeave: te, isHoveringButton: G, isToggled: i, showTooltip: A, tooltipText: X },
                            a.createElement(
                                f.Z,
                                (0, b.Z)({}, oe, {
                                    accept: v.$.join(","),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-bf286bb5.2553b2da.js.map
