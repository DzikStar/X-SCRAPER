    ...
    ["shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-e4e3d8bb"],
    {
        ...
        246277: (e, t, a) => {
            ...
            const P = ({ status: e, expectedChunks: t = [0.25, 0.5, 0.75, 1], intermediateResults: a = [], url: n, aspectRatio: r, isModerated: l, withActionRow: s, openMediaToEdit: c, onImageSize: m, mediaId: u, mediaUrl: p, allMediaIds: h, allMediaUrls: g }) => {
                    ...
                    return (
                        ...
                        o.createElement(i.Z, { style: C.container }, "loading" === e ? o.createElement(i.Z, { style: C.logoContainer }, o.createElement(k.x1, { style: C.grokIcon })) : null, "loading" === e || "aborted" === e || D ? o.createElement(o.Fragment, null, o.createElement(i.Z, { style: [C.content, M] }, o.createElement(i.Z, { style: l || "aborted" === e ? C.contentModerated : void 0 }, w)), o.createElement(i.Z, { style: [C.content, I] }, w)) : null, o.createElement(d.Z, { resizeMode: "cover", source: D || l ? void 0 : n, style: [C.finalImage, { aspectRatio: r ?? (P || 4 / 3) }] }), s && "aborted" !== e ? o.createElement(i.Z, { style: [C.actionRow, C.animation] }, o.createElement(E.rO, { allMediaIds: h, allMediaUrls: g, buttonSize: "medium", buttonType: "onMediaText", contentUrl: n, isLoading: "ready" !== e, mediaId: u, mediaUrl: p, setEditMode: c || (() => {}), withStartAlignment: !0 })) : null)
                    );
                },
            ...
            function T({ allMediaIds: e, allMediaUrls: t, aspectRatio: a, centerJustify: h, disableClickWhileLoading: g = !0, filename: v, height: k, intermediateResults: E, isInputAttachmentPreview: C, isModerated: A, mediaId: T, mediaUrl: F, menuItems: O, mimetype: j, onClick: N, onImageSize: B, onRemove: G, openMediaToEdit: W, preloadedImageUrl: H, status: K, style: J, url: V, useActionRowButtons: $, width: X }) {
                ...
                if (C) {
                    ...
                    return o.createElement(
                        ...
                        G && (Q || (!Q && ne)) ? o.createElement(o.Fragment, null, o.createElement(u.ZP, { "aria-label": R, hoverLabel: _, icon: o.createElement(w.default, null), onClick: pe, size: "xSmall", style: [z.removeBtn, z.inputAttachmentPreviewRemoveBtn], type: "onMediaDominantColorFilled" })) : null,
                    );
                }
                return o.createElement(i.Z, { style: [z.documentContainer, he ? z.documentContainerActive : null, J] }, o.createElement(i.Z, { style: z.iconContainer }, o.createElement(D.default, { style: z.documentIcon })), o.createElement(i.Z, { style: z.documentNameContainer }, o.createElement(m.ZP, { hoverLabel: { label: v }, numberOfLines: 1, selectable: !1, size: "subtext2", weight: "medium" }, v), o.createElement(p.Z, { size: "space4" }), o.createElement(m.ZP, { color: "gray700", selectable: !1, size: "subtext3", weight: "normal" }, Z)), G && (Q || (!Q && ne)) ? o.createElement(o.Fragment, null, o.createElement(p.Z, { size: "space4" }), o.createElement(u.ZP, { "aria-label": R, hoverLabel: _, icon: o.createElement(w.default, null), onClick: pe, size: "xSmall", style: z.removeBtn, type: "primaryText" })) : null);
            }
        ...
        86657: (e, t, a) => {
            ...
            function R({ allFileAttachments: e, allIntermediateImageResults: t, aspectRatio: a, centerJustify: i, extraMenuItems: l, file: R, height: Z, index: _, intermediateResults: x, isAborted: U, isImageActionsEnabled: L = !0, isInputAttachmentPreview: S, isLoading: T, messageId: z, onClick: F, onImageSize: O, onRemove: j, onViewed: N, preloadedImageUrl: B, style: G, useActionRowButtons: W, width: H, withMediaCarousel: K }) {
                ...
                const { conversationKey: ie } = (0, D.ZP)(),
                    le = n.useCallback(
                        ({ editMode: a } = {}) => {
                            let n = R.mediaId;
                            const o = R.url;
