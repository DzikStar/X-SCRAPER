...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-e4e3d8bb"],
    {
        ...
        207137: (e, t, a) => {
            a.d(t, { BC: () => d, FI: () => s, Pm: () => i, gO: () => r, zk: () => o });
        ...
        309373: (e, t, a) => {
            ...
            const s =
                ...
                ({ analysisEntityId: a, editingMessageId: s, fileAttachments: d, mode: c, onStart: m, returnCitations: u, returnSearchResults: p = !0, features: h = { eagerTweets: !0, serverHistory: !0 }, text: g, trendPromptIdStr: y, imageGenerationCount: b, isReasoning: f, isDeepsearch: D, personalityId: w }) =>
                async (c, y, { api: M, featureSwitches: I }) => {
                    ...
                    const A = k.selectMode(y()),
                        ...
                        Z = k.selectConversationWithLocalMessages(y()),
                        _ = (0, o.F9)(y()),
                        x = R.indexOf(s);
                    ...
                    const S = [...Z.slice(0, x).map((e) => ({ message: e.message, fileAttachments: e.fileAttachments, sender: e.sender, isDeepsearch: e.isDeepsearch, isReasoning: e.isReasoning })), { sender: U.sender, fileAttachments: d, message: g, isDeepsearch: D, isReasoning: f }],
                        T = (0, o.en)(y());
                    let z = {};
                    T && T.toolOverrides && (z = T.toolOverrides);
                    const F = { responses: S, systemPromptName: A, conversationId: E, grokModelOptionId: _, resampleResponseId: U.userChatItemId, returnSearchResults: p, returnCitations: u, requestFeatures: h, ...(a && 1 === S.length ? { analysisEntityId: a } : void 0), promptMetadata: L, imageGenerationCount: b, enableSideBySide: !P && !C, isDeepsearch: D, isReasoning: f, personalityId: w, toolOverrides: z, deepsearchArgs: D ? T?.deepsearchArgs : void 0 };
                    ...
                    const O = I.isTrue("responsive_web_grok_enable_add_response_keepalive") && (D || f),
                        j = I.getNumberValue("responsive_web_grok_add_response_num_retries", 0);
                    (0, l.D)({ grokModule: k, requestBody: F, analytics: e, dispatch: c, api: M, eventTag: "rewrite", flags: { enableGrokApiHost: v, enableKeepalive: O, numRetries: j } });
                };
        },
        480243: (e, t, a) => {
            a.d(t, { W: () => h });
            ...
            function h() {
                const e = c()(),
                    ...
                    [n, r] = (0, i.KO)(u);
                o.useEffect(() => {
                    s()(e, m, {}, { networkCacheConfig: { force: !1 } })
                        .toPromise()
                        .then((e) => {
                ...
                return { userPersonalities: t, setGrokPersonality: l, getPersonality: (e) => t.find((t) => t.personality_id === e), currentPersonalityId: n };
            }
        },
        246277: (e, t, a) => {
            a.d(t, { $: () => S, Z: () => T });
            ...
            const P = ({ status: e, expectedChunks: t = [0.25, 0.5, 0.75, 1], intermediateResults: a = [], url: n, aspectRatio: r, isModerated: l, withActionRow: s, openMediaToEdit: c, onImageSize: m, mediaId: u, mediaUrl: p, allMediaIds: h, allMediaUrls: g }) => {
                    ...
                    return (
                        ...
                        o.createElement(i.Z, { style: C.container }, "loading" === e ? o.createElement(i.Z, { style: C.logoContainer }, o.createElement(k.x1, { style: C.grokIcon })) : null, "loading" === e || "aborted" === e || w ? o.createElement(o.Fragment, null, o.createElement(i.Z, { style: [C.content, M] }, o.createElement(i.Z, { style: l || "aborted" === e ? C.contentModerated : void 0 }, D)), o.createElement(i.Z, { style: [C.content, I] }, D)) : null, o.createElement(d.Z, { resizeMode: "cover", source: w || l ? void 0 : n, style: [C.finalImage, { aspectRatio: r ?? (P || 4 / 3) }] }), s && "aborted" !== e ? o.createElement(i.Z, { style: [C.actionRow, C.animation] }, o.createElement(E.rO, { allMediaIds: h, allMediaUrls: g, buttonSize: "medium", buttonType: "onMediaText", contentUrl: n, isLoading: "ready" !== e, mediaId: u, mediaUrl: p, setEditMode: c || (() => {}), withStartAlignment: !0 })) : null)
                    );
                },
            ...
            function T({ allMediaIds: e, allMediaUrls: t, aspectRatio: a, centerJustify: h, disableClickWhileLoading: g = !0, filename: v, height: k, intermediateResults: E, isInputAttachmentPreview: C, isModerated: A, mediaId: T, mediaUrl: F, menuItems: O, mimetype: j, onClick: N, onImageSize: B, onRemove: G, openMediaToEdit: W, preloadedImageUrl: H, status: K, style: J, url: V, useActionRowButtons: $, width: X }) {
                const { handlers: Y, interactivityState: q } = (0, l.x)({}),
                    Q = (0, s.yu)(),
                    [ee, te] = o.useState(!1),
                    ae = O && O.length > 0,
                    [ne, oe] = o.useState(!1),
                    re = Q ? 60 : 80,
                    ie = { width: 1.5 * re, height: re },
                    le = o.useCallback((e) => {
                        e.stopPropagation(), te(!0);
                    }, []),
                    se = o.useCallback(() => te(!1), []),
                    de = !X || !k || (X > 200 && k > 150),
                    ce = o.useMemo(() => ({ width: X ?? "auto", height: k ?? "auto", outline: "none" }), [X, k]),
                    me = o.useCallback(
                        (e) => {
                    ...
                    { isInputFocused: ue } = (0, I.w)();
                if (S.includes(j)) {
                    const l = "ready" === K && ae && q.isHovered && !$;
                    return o.createElement(
                        r.Z,
                        (0, n.Z)({ disabled: (g && !V) || "aborted" === K }, Y, {
                            onLongPress: Q ? le : void 0,
                            onMouseEnter: () => {
                                oe(!0);
                            },
                            onMouseLeave: () => {
                            ...
                            onPress: N,
                            style: [h && { justifyContent: "center" }, ce, A ? z.noClick : void 0, J],
                        }),
                        C ? (!V || V.startsWith("blob:") ? o.createElement(i.Z, { style: [z.inputAttachmentPreview, z.inputAttachmentPreviewPlaceholder, { width: X ?? re, height: k ?? re }] }) : o.createElement(d.Z, { resizeMode: "cover", source: H || V, style: [z.inputAttachmentPreview, { width: X ?? re, height: k ?? re }] })) : o.createElement(P, { allMediaIds: e, allMediaUrls: t, aspectRatio: a, intermediateResults: E, isModerated: A, mediaId: T, mediaUrl: F, onImageSize: B, openMediaToEdit: W, resizeMode: "cover", status: K, url: H || V, withActionRow: $ && q.isHovered }),
                        "error" === K ? o.createElement(i.Z, { style: z.errorContainer }, o.createElement(y.default, { color: c.default.theme.colors.gray600, style: z.errorIcon }), de ? o.createElement(m.ZP, { size: "body", style: z.errorMessage }, x) : null) : A || "aborted" === K ? o.createElement(i.Z, { style: z.errorContainer }, o.createElement(b.default, { color: c.default.theme.colors.text, style: z.errorIconLarge })) : null,
                        o.createElement(i.Z, { style: z.imageButtonContainer }, l ? o.createElement(u.ZP, { "aria-label": U, hoverLabel: L, icon: o.createElement(f.default, null), onClick: le, size: "xSmall", type: "onMediaDominantColorFilled" }) : null, ae && ee ? o.createElement(M.Z, { onDismiss: se }, o.createElement(r.Z, { onPress: se }, O)) : null, G && (Q || (!Q && ne)) ? o.createElement(u.ZP, { "aria-label": R, hoverLabel: _, icon: o.createElement(D.default, null), onClick: me, size: "xSmall", style: z.removeBtn, type: "onMediaDominantColorFilled" }) : null),
                    );
                }
                if (C) {
                    const e = (function (e) {
                    ...
                    return o.createElement(
                        i.Z,
                        {
                            ...
                            style: [z.inputAttachmentPreviewFileContainer, { width: X ?? ie.width, height: k ?? ie.height }, J],
                        },
                        o.createElement(i.Z, { style: z.inputAttachmentPreviewFileContainerContent }, o.createElement(m.ZP, { hoverLabel: { label: v }, numberOfLines: 2, selectable: !1, size: "subtext2" }, v), o.createElement(i.Z, { style: z.inputAttachmentPreviewBottomContainer }, o.createElement(i.Z, { style: z.inputAttachmentPreviewFileIconContainer }, o.createElement(w.default, { style: z.inputAttachmentPreviewFileIcon })), o.createElement(m.ZP, { numberOfLines: 1, size: "subtext3" }, e.toUpperCase()))),
                        G && (Q || (!Q && ne)) ? o.createElement(o.Fragment, null, o.createElement(u.ZP, { "aria-label": R, hoverLabel: _, icon: o.createElement(D.default, null), onClick: me, size: "xSmall", style: [z.removeBtn, z.inputAttachmentPreviewRemoveBtn], type: "onMediaDominantColorFilled" })) : null,
                    );
                }
                return o.createElement(i.Z, { style: [z.documentContainer, ue ? z.documentContainerActive : null, J] }, o.createElement(i.Z, { style: z.iconContainer }, o.createElement(w.default, { style: z.documentIcon })), o.createElement(i.Z, { style: z.documentNameContainer }, o.createElement(m.ZP, { hoverLabel: { label: v }, numberOfLines: 1, selectable: !1, size: "subtext2", weight: "medium" }, v), o.createElement(p.Z, { size: "space4" }), o.createElement(m.ZP, { color: "gray700", selectable: !1, size: "subtext3", weight: "normal" }, Z)), G && (Q || (!Q && ne)) ? o.createElement(o.Fragment, null, o.createElement(p.Z, { size: "space4" }), o.createElement(u.ZP, { "aria-label": R, hoverLabel: _, icon: o.createElement(D.default, null), onClick: me, size: "xSmall", style: z.removeBtn, type: "primaryText" })) : null);
            }
        ...
        335785: (e, t, a) => {
            ...
            function c({ height: e, isInputAttachmentPreview: t, onRemove: a, selectedFile: i, width: c }) {
                ...
                if (
                    ...
                    return;
                return l.$.includes(i?.local?.type) || l.$.includes(i?.remote?.mimeType) ? n.createElement(o.Z, null, i.remote && n.createElement(o.Z, { style: m.default }, n.createElement(d.Z, { file: i.remote, height: e, isImageActionsEnabled: !1, isInputAttachmentPreview: !0, isLoading: !1, onRemove: a, preloadedImageUrl: u.current, width: c })), i.local && n.createElement(o.Z, { style: [m.default, i.remote ? m.hidden : void 0] }, n.createElement(s.Z, { file: i.local, height: e, isInputAttachmentPreview: !0, onRemove: a, width: c }), n.createElement(r.Z, { style: { top: "50%", start: "50%", position: "absolute", transform: "translate(-50%, -50%)" } }))) : n.createElement(o.Z, null, i.remote ? n.createElement(d.Z, { file: i.remote, height: e, isImageActionsEnabled: !1, isInputAttachmentPreview: !0, isLoading: !1, onRemove: a, preloadedImageUrl: u.current, width: c }) : i.local ? n.createElement(n.Fragment, null, n.createElement(s.Z, { file: i.local, height: e, isInputAttachmentPreview: !0, onRemove: a, width: c }), n.createElement(r.Z, { style: [{ top: "50%", start: "50%", position: "absolute", transform: "translate(-50%, -50%)" }, i.remote ? m.hidden : void 0] })) : null);
            }
        ...
        523253: (e, t, a) => {
            ...
            var n = a(202784),
                o = a(246277);
            function r({ file: e, height: t, isInputAttachmentPreview: a, onImageSize: r, onRemove: i, style: l, width: s }) {
                const d = n.useMemo(() => URL.createObjectURL(e), [e]);
                return n.createElement(o.Z, { filename: e.name, height: t, isInputAttachmentPreview: a, mimetype: e.type, onImageSize: r, onRemove: i, status: "ready", style: l, url: d, width: s });
            }
        },
        86657: (e, t, a) => {
            a.d(t, { Z: () => R });
            ...
            function R({ allFileAttachments: e, allIntermediateImageResults: t, aspectRatio: a, centerJustify: i, extraMenuItems: l, file: R, height: Z, index: _, intermediateResults: x, isAborted: U, isImageActionsEnabled: L = !0, isInputAttachmentPreview: S, isLoading: T, messageId: z, onClick: F, onImageSize: O, onRemove: j, onViewed: N, preloadedImageUrl: B, style: G, useActionRowButtons: W, width: H, withMediaCarousel: K }) {
                ...
                const { conversationKey: ie } = (0, w.ZP)(),
                    le = n.useCallback(
                        ({ editMode: a } = {}) => {
                            ...
                            if (($.scribe({ element: "expand_image", action: "click", data: { event_info: JSON.stringify({ mediaId: n, mediaUrl: o, allMediaIds: e ? e.map((e) => e.mediaId) : void 0, allMediaUrls: e ? e.map((e) => e.url) : void 0 }) } }), K)) {
                                ...
                                V.push({ pathname: n, state: { file: R, messageId: z, conversationKey: ie, index: _, editMode: a, fileAttachments: e, intermediateImageResults: t } });
                            } else {
                        ...
                        [R, V, oe, N, ie, _, z, K, e, $, t],
                    ),
                    se = n.useCallback(() => {
                        le({ editMode: !0 });
                    }, [le]),
                    de = n.useMemo(() => (re ? "ready" : U ? "aborted" : T || X ? "loading" : "error"), [re, T, U, X]),
                    ce = n.useMemo(() => (K && ae ? [n.createElement(r.Z, { Icon: s.default, actionText: C, key: "editImage", onClick: (e) => le({ editMode: !0 }) })] : []), [ae, K, le]),
                    me = n.useMemo(
                        () =>
                            ne
                                ? [
                    ...
                    ue = n.useCallback(() => (F ? F(le) : le()), [F, le]);
                return n.createElement(M.Z, { allMediaIds: e ? e.map((e) => e.mediaId || "") : void 0, aspectRatio: a, centerJustify: i, disableClickWhileLoading: !K, filename: R.fileName, height: Z, intermediateResults: x, isInputAttachmentPreview: S, isModerated: !!R.moderated, mediaId: R.mediaId, menuItems: me, mimetype: R.mimeType, onClick: ue, onImageSize: O, onRemove: j, openMediaToEdit: se, preloadedImageUrl: B, status: de, style: G, url: re, useActionRowButtons: W, width: H });
            }
        },
        774038: (e, t, a) => {
            ...
            function N(e) {
                const t = n.useMemo(() => e || { fileName: "", mimeType: "" }, [e]),
                    ...
                    l = n.useMemo(() => ((t.url && i) || t.isPublic ? t.url : o ? URL.createObjectURL(o) : void 0), [o, i, t.isPublic, t.url]);
                return (
                    n.useEffect(() => {
                ...
                return n.createElement(
                    ...
                    O
                        ? n.createElement(
                              ...
                              !R && n.createElement(l.ZP, { style: W.white }, z),
                          )
                        : null,
                );
            }
            function G({ contentUrl: e, conversationKey: t, grokFile: a, onSend: o, setEditMode: i }) {
                const l = (0, A.k)(),
                    d = (0, M.I0)(),
                    c = (0, w.Z)(),
                            ...
                            h.current ||
                                ...
                                (async () => {
                                    ...
                                    if (a && a.mediaId) r.push(a);
                                        ...
                                        const t = await (0, D.f)(e, !0, !0),
                                            a = new AbortController(),
                                            n = await l(((i = t), (s = "edit_grok.jpeg"), new File([i], s, { type: i.type })), a);
                                        r.push(n);
                                    }
                                    var i, s;
                ...
                return n.createElement(r.Z, { onClick: (e) => e.stopPropagation(), style: W.container, withGutter: !0 }, !Z && n.createElement(s.Z, { backButtonType: "close", onClick: () => i(!1) }), n.createElement(E.Z, { conversationKey: t, disableFileUploads: !0, hasAccess: !0, isIdle: !0, mode: "", placeholder: O, promptSender: g, useMagicWandIcon: !0, useNonExpanded: !0 }));
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-e4e3d8bb.bc13864a.js.map
