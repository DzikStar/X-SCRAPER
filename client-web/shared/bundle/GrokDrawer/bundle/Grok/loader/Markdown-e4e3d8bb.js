...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-e4e3d8bb"],
    {
        839090: (e, t, a) => {
            a.d(t, { Z: () => n });
            a(202784);
        ...
        207137: (e, t, a) => {
            a.d(t, { BC: () => d, FI: () => l, Pm: () => i, gO: () => r, zk: () => o });
            ...
            function r(e, t = n()) {
                const a = new Date(t);
                return a.setHours(a.getHours() - 24), o(e, a);
            }
            function i(e, t = n()) {
                const a = new Date(t);
                return a.setHours(a.getHours() + 24), o(e, a);
            ...
            function d(e, t) {
                const a = new Date();
                return t < a || t < e ? 0 : Math.min(1, (a - e) / (t - e));
            }
        },
        270172: (e, t, a) => {
            a.d(t, { X: () => o });
            ...
            const o =
                ...
                (t, a, { api: o }) => {
                    const r = (0, n.j)(e);
                    return o.fetchClient.dispatch(r, { method: "GET", credentials: "include" }).then((e) => e.blob());
                };
        },
        309373: (e, t, a) => {
            a.d(t, { X: () => l });
            ...
            const l =
                ...
                ({ analysisEntityId: a, editingMessageId: l, fileAttachments: d, mode: c, onStart: m, returnCitations: u, returnSearchResults: p = !0, features: h = { eagerTweets: !0, serverHistory: !0 }, text: g, trendPromptIdStr: y, imageGenerationCount: b, isReasoning: f, isDeepsearch: w, personalityId: M }) =>
                async (c, y, { api: D, featureSwitches: I }) => {
                    const v = !n.ZP.isTwitterApp() && I.isTrue("responsive_web_grok_api_enable_grok_host"),
                        k = (0, o.bD)(t),
                        E = k.selectConversationId(y()),
                        P = n.ZP.isAndroid(),
                        C = n.ZP.isIOS();
                    if (!E) return void (0, r.Uk)(e, "edit function failed to find a conversationId");
                    const A = k.selectMode(y()),
                        R = k.selectMessageIds(y()),
                        _ = k.selectConversationWithLocalMessages(y()),
                        Z = (0, o.F9)(y()),
                        x = R.indexOf(l);
                    if (-1 === x) return void (0, r.Uk)(e, "edit function couldn't find an actionable response");
                    const U = _[x];
                    ...
                    const S = [..._.slice(0, x).map((e) => ({ message: e.message, fileAttachments: e.fileAttachments, sender: e.sender, isDeepsearch: e.isDeepsearch, isReasoning: e.isReasoning })), { sender: U.sender, fileAttachments: d, message: g, isDeepsearch: w, isReasoning: f }],
                        T = (0, o.en)(y());
                    let z = {};
                    T && T.toolOverrides && (z = T.toolOverrides);
                    const F = { responses: S, systemPromptName: A, conversationId: E, grokModelOptionId: Z, resampleResponseId: U.userChatItemId, returnSearchResults: p, returnCitations: u, requestFeatures: h, ...(a && 1 === S.length ? { analysisEntityId: a } : void 0), promptMetadata: L, imageGenerationCount: b, enableSideBySide: !P && !C, isDeepsearch: w, isReasoning: f, personalityId: M, toolOverrides: z, deepsearchArgs: w ? T?.deepsearchArgs : void 0 };
                    null != k.selectCurrentResponseMessage(y()) && (await c((0, i.I)({ analytics: e, conversationKey: t }))), g && c(k.commitEditChanges(l, g, d)), (0, r.dd)(e, { conversationLength: S.length, isDeepsearch: F.isDeepsearch || void 0, isReasoning: F.isReasoning || void 0 }), m?.();
                    ...
                    (0, s.D)({ grokModule: k, requestBody: F, analytics: e, dispatch: c, api: D, eventTag: "rewrite", flags: { enableGrokApiHost: v, enableKeepalive: O, numRetries: j }, featureSwitches: I });
                };
        },
        480243: (e, t, a) => {
            a.d(t, { W: () => h });
        ...
        246277: (e, t, a) => {
            ...
            var n = a(807896),
                ...
                k = a(457566),
                E = a(774038);
            const P = ({ status: e, expectedChunks: t = [0.25, 0.5, 0.75, 1], intermediateResults: a = [], url: n, aspectRatio: r, isModerated: s, withActionRow: l, openMediaToEdit: c, onImageSize: m, mediaId: u, mediaUrl: p, allMediaIds: h, allMediaUrls: g }) => {
                                    ...
                                    .map((e, t) => {
                                        ...
                                        return y > e.progress
                                            ...
                                            : o.createElement(d.Z, {
                                                  ...
                                                  resizeMode: "cover",
                                                  source: e.imageUrl,
                                                  style: [C.image, { aspectRatio: n }],
                                              });
                                    }),
                            [a, y, r],
                        ),
                        M = a.length > 0 && y > 0,
                        D = o.useMemo(() => ({ top: 0, height: 100 * y + "%", overflow: "hidden", transitionProperty: "height, mask", transitionDuration: `${f}ms`, transitionTimingFunction: 1 === y ? "ease-in" : "linear", zIndex: 50, mask: y < 1 ? "linear-gradient(\n        to bottom,\n        rgba(0, 0, 0, 1) 0%,\n        rgba(0, 0, 0, 1) calc(100% - 5px),\n        rgba(0, 0, 0, 0) 100%\n      )" : void 0 }), [y, f]),
                    ...
                    return (
                        ...
                        o.createElement(i.Z, { style: C.container }, "loading" === e ? o.createElement(i.Z, { style: C.logoContainer }, o.createElement(k.x1, { style: C.grokIcon })) : null, "loading" === e || "aborted" === e || M ? o.createElement(o.Fragment, null, o.createElement(i.Z, { style: [C.content, D] }, o.createElement(i.Z, { style: s || "aborted" === e ? C.contentModerated : void 0 }, w)), o.createElement(i.Z, { style: [C.content, I] }, w)) : null, o.createElement(d.Z, { resizeMode: "cover", source: M || s ? void 0 : n, style: [C.finalImage, { aspectRatio: r ?? (P || 4 / 3) }] }), l && "aborted" !== e ? o.createElement(i.Z, { style: [C.actionRow, C.animation] }, o.createElement(E.rO, { allMediaIds: h, allMediaUrls: g, buttonSize: "medium", buttonType: "onMediaText", contentUrl: n, isLoading: "ready" !== e, mediaId: u, mediaUrl: p, setEditMode: c || (() => {}), withStartAlignment: !0 })) : null)
                    );
                },
                ...
                A = ({ expectedChunks: e, progress: t }) => {
                    const a = o.useRef(Date.now());
                    return o.useMemo(() => {
                ...
                U = g().g10600b0,
                L = { label: U },
                S = ["image/jpeg", "image/webp", "image/png"];
            function T({ allMediaIds: e, allMediaUrls: t, aspectRatio: a, centerJustify: h, disableClickWhileLoading: g = !0, filename: v, height: k, intermediateResults: E, isInputAttachmentPreview: C, isModerated: A, mediaId: T, mediaUrl: F, menuItems: O, mimetype: j, onClick: N, onImageSize: B, onRemove: H, openMediaToEdit: W, preloadedImageUrl: G, status: K, style: J, url: V, useActionRowButtons: $, width: X }) {
                const { handlers: Y, interactivityState: q } = (0, s.x)({}),
                    Q = (0, l.yu)(),
                    [ee, te] = o.useState(!1),
                    ae = O && O.length > 0,
                    [ne, oe] = o.useState(!1),
                    ...
                    ce = o.useCallback(() => te(!1), []),
                    me = !X || !k || (X > 200 && k > 150),
                    ue = o.useMemo(() => ({ width: X ?? "100%", height: k ?? "auto", outline: "none" }), [X, k]),
                    pe = o.useCallback(
                        (e) => {
                    ...
                    { isInputFocused: he } = (0, I.w)();
                if (S.includes(j)) {
                    const s = "ready" === K && ae && q.isHovered && !$;
                    return o.createElement(
                        r.Z,
                        (0, n.Z)({ disabled: (g && !V) || ie }, Y, {
                            onLongPress: Q ? de : void 0,
                            onMouseEnter: () => {
                                oe(!0);
                            },
                            onMouseLeave: () => {
                        ...
                        C ? (!V || V.startsWith("blob:") ? o.createElement(i.Z, { style: [z.inputAttachmentPreview, z.inputAttachmentPreviewPlaceholder, { width: X ?? se, height: k ?? se }] }) : o.createElement(d.Z, { resizeMode: "cover", source: G || V, style: [z.inputAttachmentPreview, { width: X ?? se, height: k ?? se }] })) : o.createElement(P, { allMediaIds: e, allMediaUrls: t, aspectRatio: a, intermediateResults: E, isModerated: A, mediaId: T, mediaUrl: F, onImageSize: B, openMediaToEdit: W, resizeMode: "cover", status: K, url: G || V, withActionRow: $ && q.isHovered }),
                        ...
                        o.createElement(i.Z, { style: z.imageButtonContainer }, s ? o.createElement(u.ZP, { "aria-label": U, hoverLabel: L, icon: o.createElement(f.default, null), onClick: de, size: "xSmall", type: "onMediaDominantColorFilled" }) : null, ae && ee ? o.createElement(D.Z, { onDismiss: ce }, o.createElement(r.Z, { onPress: ce }, O)) : null, H && (Q || (!Q && ne)) ? o.createElement(u.ZP, { "aria-label": R, hoverLabel: Z, icon: o.createElement(w.default, null), onClick: pe, size: "xSmall", style: z.removeBtn, type: "onMediaDominantColorFilled" }) : null),
                    );
                }
                if (C) {
                    const e = (function (e) {
                    ...
                    return o.createElement(
                        i.Z,
                        {
                            ...
                            style: [z.inputAttachmentPreviewFileContainer, { width: X ?? le.width, height: k ?? le.height }, J],
                        },
                        o.createElement(i.Z, { style: z.inputAttachmentPreviewFileContainerContent }, o.createElement(m.ZP, { hoverLabel: { label: v }, numberOfLines: 2, selectable: !1, size: "subtext2" }, v), o.createElement(i.Z, { style: z.inputAttachmentPreviewBottomContainer }, o.createElement(i.Z, { style: z.inputAttachmentPreviewFileIconContainer }, o.createElement(M.default, { style: z.inputAttachmentPreviewFileIcon })), o.createElement(m.ZP, { numberOfLines: 1, size: "subtext3" }, e.toUpperCase()))),
                        H && (Q || (!Q && ne)) ? o.createElement(o.Fragment, null, o.createElement(u.ZP, { "aria-label": R, hoverLabel: Z, icon: o.createElement(w.default, null), onClick: pe, size: "xSmall", style: [z.removeBtn, z.inputAttachmentPreviewRemoveBtn], type: "onMediaDominantColorFilled" })) : null,
                    );
                }
                return o.createElement(i.Z, { style: [z.documentContainer, he ? z.documentContainerActive : null, J] }, o.createElement(i.Z, { style: z.iconContainer }, o.createElement(M.default, { style: z.documentIcon })), o.createElement(i.Z, { style: z.documentNameContainer }, o.createElement(m.ZP, { hoverLabel: { label: v }, numberOfLines: 1, selectable: !1, size: "subtext2", weight: "medium" }, v), o.createElement(p.Z, { size: "space4" }), o.createElement(m.ZP, { color: "gray700", selectable: !1, size: "subtext3", weight: "normal" }, _)), H && (Q || (!Q && ne)) ? o.createElement(o.Fragment, null, o.createElement(p.Z, { size: "space4" }), o.createElement(u.ZP, { "aria-label": R, hoverLabel: Z, icon: o.createElement(w.default, null), onClick: pe, size: "xSmall", style: z.removeBtn, type: "primaryText" })) : null);
            }
            const z = c.default.create((e) => ({
        ...
        335785: (e, t, a) => {
            ...
            var n = a(202784),
                ...
                l = a(523253),
                d = a(86657);
            function c({ height: e, isInputAttachmentPreview: t, onRemove: a, selectedFile: i, width: c }) {
        ...
        523253: (e, t, a) => {
            ...
            var n = a(202784),
                o = a(246277);
            function r({ file: e, height: t, isInputAttachmentPreview: a, onImageSize: r, onRemove: i, style: s, width: l }) {
                const d = n.useMemo(() => URL.createObjectURL(e), [e]);
                return n.createElement(o.Z, { filename: e.name, height: t, isInputAttachmentPreview: a, mimetype: e.type, onImageSize: r, onRemove: i, status: "ready", style: s, url: d, width: l });
            }
        },
        86657: (e, t, a) => {
            a.d(t, { Z: () => R });
            ...
            function R({ allFileAttachments: e, allIntermediateImageResults: t, aspectRatio: a, centerJustify: i, extraMenuItems: s, file: R, height: _, index: Z, intermediateResults: x, isAborted: U, isImageActionsEnabled: L = !0, isInputAttachmentPreview: S, isLoading: T, messageId: z, onClick: F, onImageSize: O, onRemove: j, onViewed: N, preloadedImageUrl: B, style: H, useActionRowButtons: W, width: G, withMediaCarousel: K }) {
                const J = (0, b.I0)(),
                    V = (0, o.useHistory)(),
                    $ = (0, y.z)(),
                    [X, Y] = n.useState(!1),
                    ...
                    ae = (0, h.hC)("responsive_web_grok_image_edit"),
                    ne = L && (!ee || te),
                    oe = !!R?.url && A.includes(new URL(R.url).hostname),
                    re = n.useMemo(() => ((R.url && oe) || R.isPublic ? R.url : q ? URL.createObjectURL(q) : void 0), [q, oe, R.isPublic, R.url]);
                n.useEffect(() => {
                ...
                }, [R.url, R.isPublic, Y, oe, R.mimeType, J]);
                const { conversationKey: ie } = (0, M.ZP)(),
                    se = n.useCallback(
                        ({ editMode: a } = {}) => {
                            let n = R.mediaId;
                            const o = R.url;
                            if (!n && o) {
                                n = new URL(o).searchParams.get("mediaId") ?? void 0;
                            }
                            if (($.scribe({ element: "expand_image", action: "click", data: { event_info: JSON.stringify({ mediaId: n, mediaUrl: o, allMediaIds: e ? e.map((e) => e.mediaId) : void 0, allMediaUrls: e ? e.map((e) => e.url) : void 0 }) } }), K)) {
                                const n = "/i/grok/media-carousel";
                                V.push({ pathname: n, state: { file: R, messageId: z, conversationKey: ie, index: Z, editMode: a, fileAttachments: e, intermediateImageResults: t } });
                            } else {
                                const e = !n || oe ? "/i/grok/media" : `/i/grok/media/${n}`;
                                V.push({ pathname: e, state: { file: R } });
                            }
                            N && N({ ...R, mediaId: n });
                        },
                        [R, V, oe, N, ie, Z, z, K, e, $, t],
                    ),
                    le = n.useCallback(() => {
                        se({ editMode: !0 });
                    }, [se]),
                    de = n.useMemo(() => (re ? "ready" : U ? "aborted" : T || X ? "loading" : "error"), [re, T, U, X]),
                    ce = n.useMemo(() => (K && ae ? [n.createElement(r.Z, { Icon: l.default, actionText: C, key: "editImage", onClick: (e) => se({ editMode: !0 }) })] : []), [ae, K, se]),
                    me = n.useMemo(
                        () =>
                            ne
                                ? [
                                      n.createElement(r.Z, {
                                          ...
                                          onClick: (e) => {
                                              (async () => {
                                                  if (($.scribe({ element: "save_image_button", action: "click" }), re)) {
                                                      const e = await (0, g.f)(re, !0, !0),
                                                          t = URL.createObjectURL(e);
                                                      (0, u.uv)(t, "image.jpg");
                                                  }
                                              })();
                                      ...
                                      n.createElement(r.Z, {
                                          ...
                                          onClick: (e) => {
                                              (async () => {
                                                  if (($.scribe({ element: "copy_image_button", action: "click" }), re)) {
                                                      const e = await (0, g.f)(re, !0, !0),
                                                          t = URL.createObjectURL(e);
                                                      (0, u.VJ)(t)
                                                          .then(() => {
                                      ...
                                      n.createElement(r.Z, {
                                          ...
                                          onClick: (e) => {
                                              (async () => {
                                                  if (($.scribe({ element: "post_image_button", action: "click" }), !re)) return;
                                                  const e = await (0, g.f)(re, !0, !0),
                                                      t = URL.createObjectURL(e);
                ...
                return n.createElement(D.Z, { allMediaIds: e ? e.map((e) => e.mediaId || "") : void 0, aspectRatio: a, centerJustify: i, disableClickWhileLoading: !K, filename: R.fileName, height: _, intermediateResults: x, isInputAttachmentPreview: S, isModerated: !!R.moderated, mediaId: R.mediaId, menuItems: me, mimetype: R.mimeType, onClick: ue, onImageSize: O, onRemove: j, openMediaToEdit: le, preloadedImageUrl: B, status: de, style: H, url: re, useActionRowButtons: W, width: G });
            }
        },
        774038: (e, t, a) => {
            a.d(t, { N6: () => N, eQ: () => H, rO: () => B });
            a(543673), a(240753), a(128399), a(136728);
            var n = a(202784),
                o = a(107267),
                r = a(108362),
                ...
                A = a(737368),
                R = a(305442);
            const _ = b.ZP.isTwitterApp(),
                Z = b.ZP.isTwitterApp() ? (b.ZP.isAndroid() ? "grok_android" : "grok_ios") : "grok",
                x = m().j826e722,
                U = m().a9325f10,
                L = m().f88553c8,
                S = m().g0b12442,
            ...
            function N(e) {
                const t = n.useMemo(() => e || { fileName: "", mimeType: "" }, [e]),
                    a = (0, D.I0)(),
                    [o, r] = n.useState(),
                    i = n.useMemo(() => !!t?.url && j.includes(new URL(t.url).hostname), [t]),
                    s = n.useMemo(() => ((t.url && i) || t.isPublic ? t.url : o ? URL.createObjectURL(o) : void 0), [o, i, t.isPublic, t.url]);
                return (
                    n.useEffect(() => {
                        ...
                        a((0, I.X)(e))
                            ...
                            .catch();
                    }, [t.url, t.isPublic, i, t.mimeType, a]),
                    s
                );
            }
            function B({ allMediaIds: e, allMediaUrls: t, buttonSize: a = "xLarge", buttonType: l = "alwaysBlack", contentUrl: d, isLoading: c, mediaId: m, mediaUrl: b, setEditMode: I, withStartAlignment: v }) {
                const E = (0, D.I0)(),
                    P = (0, M.Z)(),
                    A = (0, o.useHistory)(),
                    { isGrokDrawer: R } = (0, C.ZP)(),
                    O = (0, f.hC)("responsive_web_grok_image_edit"),
                    j = (0, f.hC)("responsive_web_grok_enable_android_image_donwload");
                    ...
                    (!_ || j) &&
                        n.createElement(
                            ...
                            n.createElement(i.ZP, {
                                disabled: c,
                                hoverLabel: { label: x },
                                icon: n.createElement(u.default, { style: W.white }),
                                key: "saveImage",
                                onClick: (a) => {
                                    (async () => {
                                        if ((P.scribe({ page: Z, element: "save_image_button", action: "click", data: { event_info: JSON.stringify({ mediaId: m, mediaUrl: b, allMediaIds: e, allMediaUrls: t }) } }), d)) {
                                            if (_) {
                                                const e = window.webkit?.messageHandlers?.grokWebviewEventMessageHandler;
                                                return void (e && window.webkit.messageHandlers.grokWebviewEventMessageHandler.postMessage({ message: "saveImage", data: { mediaUrl: b } }));
                                            }
                            ...
                            n.createElement(i.ZP, {
                                disabled: c,
                                hoverLabel: { label: U },
                                icon: n.createElement(p.default, { style: W.white }),
                                key: "copyImage",
                                onClick: (a) => {
                                    (async () => {
                                        if ((P.scribe({ page: Z, element: "copy_image_button", action: "click", data: { event_info: JSON.stringify({ mediaId: m, mediaUrl: b, allMediaIds: e, allMediaUrls: t }) } }), d)) {
                                            const e = await (0, w.f)(d, !0, !0),
                                                t = URL.createObjectURL(e);
                                            (0, y.VJ)(t)
                                                .then(() => {
                            ...
                            n.createElement(i.ZP, {
                                disabled: c,
                                hoverLabel: { label: T },
                                icon: n.createElement(h.default, { style: W.white }),
                                key: "postImage",
                                onClick: (a) => {
                                    (async () => {
                                        if ((P.scribe({ page: Z, element: "post_image_button", action: "click", data: { event_info: JSON.stringify({ mediaId: m, mediaUrl: b, allMediaIds: e, allMediaUrls: t }) } }), !d)) return;
                    ...
                    O
                        ? n.createElement(
                              i.ZP,
                              {
                                  disabled: c,
                                  hoverLabel: { label: F },
                                  icon: n.createElement(g.default, { style: W.white }),
                                  key: "editImage",
                                  onClick: (a) => {
                                      (async () => {
                                          P.scribe({ page: Z, element: "edit_image_button", action: "click", data: { event_info: JSON.stringify({ mediaId: m, mediaUrl: b, allMediaIds: e, allMediaUrls: t }) } }), I && I(!0);
                                      })();
                                  },
                                  size: a,
                                  style: W.button,
                              ...
                              !R && n.createElement(s.ZP, { style: W.white }, z),
                          )
                        : null,
                );
            }
            function H({ contentUrl: e, conversationKey: t, grokFile: a, onSend: o, setEditMode: i }) {
                const s = (0, A.k)(),
                    d = (0, D.I0)(),
                    c = (0, M.Z)(),
                    ...
                    g = n.useCallback(
                        (n) => {
                            h.current ||
                                ...
                                (async () => {
                                    const r = [];
                                    if (a && a.mediaId) r.push(a);
                                    else {
                                        const t = await (0, w.f)(e, !0, !0),
                                            a = new AbortController(),
                                            n = await s(((i = t), (l = "edit_grok.jpeg"), new File([i], l, { type: i.type })), a);
                                        r.push(n);
                                    }
                                    var i, l;
                                    const h = { ...n, attachments: r, imageGenerationCount: p, promptMetadata: { promptSource: "IMAGE_EDIT", action: "INPUT", properties: { imageUrl: a?.url || e } } };
                                    m || u(), d((0, v.u)({ analytics: c, conversationKey: t })(h)), o();
                                })());
                        },
                        [p, d, c, s, e, t, o, a, m, u],
                    );
                return n.createElement(r.Z, { onClick: (e) => e.stopPropagation(), style: W.container, withGutter: !0 }, !_ && n.createElement(l.Z, { backButtonType: "close", onClick: () => i(!1) }), n.createElement(E.Z, { conversationKey: t, disableFileUploads: !0, hasAccess: !0, isIdle: !0, mode: "", placeholder: O, promptSender: g, useMagicWandIcon: !0, useNonExpanded: !0 }));
            }
            const W = d.default.create((e) => ({ button: { backdropFilter: "blur(8px)" }, container: { padding: e.spaces.space12, flexDirection: "row", gap: e.spaces.space20, justifyContent: "center" }, containerCorner: { padding: e.spaces.space4, flexDirection: "row", gap: e.spaces.space8, justifyContent: "center" }, center: { justifyContent: "center", alignItems: "center" }, flex: { flex: 1 }, white: { color: "white" } }));
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.GrokDrawer~bundle.Grok~loader.Markdown-e4e3d8bb.7a332d5a.js.map
