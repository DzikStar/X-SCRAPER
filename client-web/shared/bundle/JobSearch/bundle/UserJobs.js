    ...
    ["shared~bundle.JobSearch~bundle.UserJobs"],
    {
        ...
        471957: (e, n, a) => {
            ...
            const w = ({ fallbackName: e, user: n }) => {
                    const a = i()(k.fR, n);
                    return a && a.legacy && a.legacy.name && a.legacy.screen_name ? l.createElement(b.ZP, { size: "subtext2", style: v.userName }, l.createElement(r.Z, { style: v.name }, l.createElement(b.ZP, { numberOfLines: 1 }, a.legacy.name), l.createElement(p.Z, { isVerified: a.legacy.verified, verifiedType: a.legacy.verified_type ?? void 0 })), l.createElement(f.Z, { screenName: a.legacy.screen_name, size: "subtext2" })) : e ? l.createElement(b.ZP, { size: "subtext2", weight: "normal" }, e) : null;
                },
        ...
        985124: (e, n, a) => {
            a.d(n, { $J: () => i, WA: () => C, ZC: () => v, cj: () => R, eo: () => t.eo, hb: () => H, kW: () => d, pg: () => A, rP: () => o, u4: () => q, xk: () => z });
            var t = a(89217),
                l = a(674132),
                r = a.n(l);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.JobSearch~bundle.UserJobs.d4b73aba.js.map
