    ...
    ["shared~bundle.JobSearch~bundle.UserJobs~loader.WideLayout"],
    {
        822502: (e, n, t) => {
            ...
            const w = ({ fallbackName: e, user: n }) => {
                    const t = d()(I.fR, n);
                    return t && t.legacy && t.legacy.name && t.legacy.screen_name ? o.createElement(k.ZP, { size: "subtext2", style: C.userName }, o.createElement(c.Z, { style: C.name }, o.createElement(k.ZP, { numberOfLines: 1 }, t.legacy.name), o.createElement(h.Z, { isVerified: t.verification?.verified ?? !1, verifiedType: t.verification?.verified_type ?? void 0 })), o.createElement(f.Z, { screenName: t.legacy.screen_name, size: "subtext2" })) : e ? o.createElement(k.ZP, { size: "subtext2", weight: "normal" }, e) : null;
                },
        ...
        910113: (e, n, t) => {
            ...
            const v = m,
                ...
                F = ({ item: e, itemId: n, itemIndex: t }) => {
                    ...
                    return i && s ? y.createElement(h.Z, { actions: [f.h5], companyProfile: c, job: s, jobId: n, jobIndex: t, onClick: m, relayId: u, user: o, userSentiment: d }) : null;
                };
        },
        318178: (e, n, t) => {
            ...
            const S = c,
                ...
                w = ({ Icon: e, SelectedIcon: n, activeStyle: t, hoverStyle: a, isSelected: l, label: r, onClick: i, sentiment: s }) => {
                    ...
                    return u.createElement(
                        d.Z,
                        null,
                        u.createElement(p.Z, { interactiveStyles: null, onClick: (e) => i(s, e), style: C.sentimentActionContainer }, ({ isHovered: t }) => u.createElement(u.Fragment, null, l ? u.createElement(n, { style: o(t) }) : u.createElement(e, { style: o(t) }), u.createElement(g.ZP, { size: "subtext2", style: { ...o(t) } }, r))),
                    );
                },
        ...
        665971: (e, n, t) => {
            ...
            const k = m,
                h = ({ actions: e, jobId: n }) => {
                    ...
                    return y.createElement(f, { actions: e, jobId: n, relayId: l, userRelayId: a?.user_results?.result?.__id, userSentiment: r });
                },
                f = ({ actions: e, jobId: n, relayId: t, userRelayId: a, userSentiment: l }) => {
                    const r = (0, g.hC)("recruiting_job_recommendations_enabled");
                    return e && 0 !== e.length && r ? y.createElement(y.Fragment, null, e.includes(p.pN) && y.createElement(p.ZP, { jobId: n, relayId: t, type: p.pN, userRelayId: a, userSentiment: l }), e.includes(p.h5) && y.createElement(p.ZP, { jobId: n, relayId: t, type: p.h5, userRelayId: a, userSentiment: l })) : null;
                },
                v = f;
        },
        89217: (e, n, t) => {
            t.d(n, { Ju: () => m, Qw: () => y, eo: () => c });
            var a = t(674132),
                l = t.n(a);
            const r = l().c69eb656,
                i = l().g46ae43c,
                ...
                y = Object.freeze({ annually: { label: u, value: 1 }, hourly: { label: d, value: 2 } });
        },
        457458: (e, n, t) => {
            t.d(n, { G: () => c, M: () => o });
            t(571372);
        ...
        491915: (e, n, t) => {
            ...
            function b(e) {
                ...
                return (
                    ...
                    a.createElement(l.Z, null, a.createElement(l.Z, { style: [e.animationContainerStyle, f.centerAnimation] }, a.createElement("div", { ref: d, style: e.animationStyle }), o && c.current && m && a.createElement(p, { animation: c.current, autoplay: n })))
                );
            }
            b.Prepare = function () {
                return (
        ...
        40644: (e, n, t) => {
            ...
            class _ extends a.PureComponent {
                    ...
                    super(...e),
                        ...
                        (this._renderButton = (e) => {
                            const { activeColor: n, backgroundColor: t, hoverLabel: l, iconSize: r, isActive: i, isDisabled: c, showBackgroundWhenActive: u } = this.props,
                                ...
                                y = u && i && !e?.isHovered;
                            return a.createElement(o.Z, { hoverLabel: l, interactiveStyles: m, interactivityState: e, style: [d.default.absoluteFill, E[y ? "haloBackground" : t], !c && F.iconBackground, "small" === r && F.iconSmallBoundingBox, y && F.haloBoundingBox] });
                        }),
                        (this._renderIcon = () => {
                            const { ActiveIcon: e, iconSize: n, isActive: t, isDisabled: l, isFaded: i, onAnimationEnd: s, onAnimationStart: o, onError: c, showAnimation: y, transitionAnimationUrl: p } = this.props;
                            if (!d.default.theme.highContrastEnabled && !r.Z.reducedMotionEnabled && e && y) return a.createElement(u.ZP, { animation: p || m.Bf, animationContainerStyle: S[n], animationStyle: w, onAnimationEnd: s, onAnimationStart: o, onError: c });
                            {
                ...
                render() {
                    const { "aria-label": e, focusable: n, enableKeyboardShortcuts: t, isActive: i, isDisabled: s, isPresentational: c, keyboardShortcut: m, link: y, preventFocusShift: p, renderMenu: g, renderWrapper: b = a.Fragment, style: k, testID: h } = this.props,
                    ...
                    return a.createElement(
                        ...
                        a.createElement(
                            ...
                            c
                                ...
                                : a.createElement(o.Z, { "aria-haspopup": g ? "menu" : void 0, "aria-label": e, disabled: s, enableKeyboardShortcuts: t, focusable: n, interactiveStyles: null, keyboardShortcut: m, link: y, onClick: this._handlePress, preventFocusShift: p, renderMenu: g, style: [F.triggerAreaRoot, F.outlineNone], testID: h }, (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.JobSearch~bundle.UserJobs~loader.WideLayout.b68743ea.js.map
