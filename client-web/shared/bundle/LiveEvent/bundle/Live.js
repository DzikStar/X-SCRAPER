        ...
        365470: (e, t, a) => {
            ...
            function Be(e) {
                ...
                const V = r.useMemo(() => {
                    ...
                    J = r.useCallback(() => r.createElement(M.aM, null, r.createElement(o.Z, { style: [Ue.container, H ? Ue.navBorder : void 0] }, r.createElement(o.Z, { style: Ue.videoContainer }, r.createElement(L, null, Q), a && r.createElement(o.Z, { style: Ue.title }, r.createElement(S.H, { broadcastId: a, canEdit: W, remoteTitle: V })), r.createElement(ie, { broadcast: t, broadcastId: a, broadcaster: l, isLive: t?.state === A.N8.Running })), j && X)), [X, Q, t, a, l, W, j, H, V]);
                return r.createElement(
                    x.nO,
                    { namespace: Ne },
                    r.createElement(
                        ...
                        r.createElement(D.Z, { title: V, withMeta: !1 }),
                        r.createElement(h.Z, { "aria-label": Ae, fetchStatus: F, onRequestRetry: $, render: J }),
                    ),
                );
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.LiveEvent~bundle.Live.011544aa.js.map
