...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.LiveEvent~loader.JetfuelFrame~loader.TimelineFrameHandler~loader.PremiumLoaders-0a0af2-7bc11170"],
    {
        95894: (e, t, r) => {
            r.d(t, { Z: () => m });
            var a = r(202784),
            ...
            const d = o.default.create((e) => ({ dropdown: { padding: e.spaces.space16 }, item: { marginBottom: e.spaces.space8 }, divider: { marginTop: e.spaces.space8 } })),
                m = ({ children: e, props: t, scribeContext: r, style: o }) => {
                    const m = t.element("popover"),
                        [u, h] = a.useState(!1);
                    return a.createElement(s.Z, { style: { position: "relative", display: "inline-block" } }, a.createElement(n.Z, { onPress: () => h(!0), style: [{ flexShrink: 1 }, o] }, e), u && m && a.createElement(l.default, { contentStyle: d.dropdown, onDismiss: () => h(!1) }, a.createElement(c.b.Provider, { value: { dismiss: () => h(!1) } }, a.createElement(i.Z, { parentContext: r, payload: m }))));
                };
        },
        77481: (e, t, r) => {
            r.d(t, { Z: () => i });
            ...
            const d = l.default.create((e) => ({ sheet: { backgroundColor: "rgba(0,0,0,0)" }, sheetFullScreen: { justifyContent: "center" } })),
                m = ({ children: e, props: t, scribeContext: r, style: l }) => {
                    const m = t.element("cover"),
                        u = t.bool("blurBackground") ?? !0,
                        [h, p] = a.useState(!1),
                        f = o.ZP.isMobileOS();
                    return a.createElement(a.Fragment, null, h && m ? a.createElement(s.Z, { onMaskClick: () => p(!1), role: "preview", style: [d.sheet, f && d.sheetFullScreen], type: "full", withMask: u }, a.createElement(c.b.Provider, { value: { dismiss: () => p(!1) } }, a.createElement(i.Z, { parentContext: r, payload: m }))) : null, a.createElement(n.Z, { onPress: () => p(!0), style: [{ flexShrink: 1 }, l] }, e));
                };
        },
        710856: (e, t, r) => {
            r.d(t, { Z: () => l });
            ...
            const l = (e) => `#${Math.max(0, Math.min(e, 16777215)).toString(16).padStart(6, "0")}`,
                ...
                i = ({ props: e, style: t }) => {
                    const r = e.str("fill"),
                        ...
                        c = e.str("width"),
                        d = e.str("height"),
                        m = { width: c && !c.endsWith("%") ? `${c}px` : c, height: d && !d.endsWith("%") ? `${d}px` : d, background: s, borderRadius: l ? 9999 : i, flexShrink: 1 };
                    return a.createElement(n.Z, { style: [t, m] });
                };
        },
        233531: (e, t, r) => {
            r.d(t, { Z: () => h });
            ...
            const d = 0,
                ...
                b = ({ children: e, props: t, scribeContext: r, style: n }) => {
                    const d = t.element("content"),
                        m = t.enum("mode") ?? h,
                        u = t.bool("bgInteraction") ?? !0,
                        [p, f] = a.useState(!1);
                    return a.createElement(a.Fragment, null, p && d && a.createElement(o.Z, { onMaskClick: () => f(!1), role: "preview", type: "bottom", withMask: u }, a.createElement(c.b.Provider, { value: { dismiss: () => f(!1) } }, a.createElement(l.Z, { style: { width: "100%", height: g(m) } }, a.createElement(i.Z, { parentContext: r, payload: d })))), a.createElement(s.Z, { onPress: () => f(!0), style: [{ flexShrink: 1 }, n] }, e));
                };
        },
        422089: (e, t, r) => {
            r.d(t, { Z: () => M });
            ...
            const w = Object.freeze({ light: "default", dark: "dim", darker: "dark", business: "business" }),
                ...
                M = ({ props: e }) => {
                    const t = e.str("publicKey") ?? e.str("webKey"),
                        ...
                        [I, L] = a.useState(F ? S : x),
                        [z, N] = a.useState(F ? E : v),
                                ...
                                try {
                                    ...
                                    switch (r.eventId) {
                                        ...
                                        case "challenge-shown":
                                            g.Z.shownChallenge(c, B, t || "0", t || "0"), _(g.t.interactive), D("shown");
                                            break;
                                        ...
                                        case "challenge-iframeSize":
                                            L(r.payload.frameHeight), N(r.payload.frameWidth);
                                            break;
            ...
            const w = Object.freeze({ light: "default", dark: "dim", darker: "dark", business: "business" }),
                ...
                M = ({ p: e }) => {
                    const t = e.str("publicKey") ?? e.str("webKey"),
                        ...
                        j = a.useMemo(() => (F ? Math.min((window.innerWidth - 32) / E, (window.innerHeight - 32) / S) : 1), [F]),
                        H = M.query?.guestId,
                        B = a.useMemo(() => (P && "string" == typeof H ? H : P ? "" : m || ""), [P, H, m]),
                        V = a.useCallback(() => {
                                ...
                                try {
                                    ...
                                    switch (r.eventId) {
                                        case "challenge-suppressed":
                                            ...
                                            break;
                                        case "challenge-shown":
                                            b.Z.shownChallenge(d, B, t || "0", t || "0"), _(b.t.interactive), D("shown");
                                            break;
                                        case "challenge-complete": {
                    ...
                    return (
                        ...
                        a.createElement(s.Z, { style: C.container }, a.createElement(s.Z, { style: [C.spinner, { height: I }] }, "loading" === Q || "loaded" === Q ? a.createElement(c.Z, null) : "complete" === Q ? a.createElement(l.Z, { style: C.label }, Z) : null), a.createElement("iframe", { height: I, id: "arkoseFrame", onLoad: V, src: [`https://iframe.arkoselabs.com/${O}/index.html?theme=${$}`, W && `&data=${W}`].filter(Boolean).join(""), style: { MozTransform: `scale(${j})`, OTransform: `scale(${j})`, WebkitTransform: `scale(${j})`, borderWidth: 0, MozTransformOrigin: "50% 0", OTransformOrigin: "50% 0", WebkitTransformOrigin: "50% 0", alignSelf: "center" }, title: "arkoseFrame", width: z }))
                    );
                };
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.LiveEvent~loader.JetfuelFrame~loader.TimelineFrameHandler~loader.PremiumLoaders-0a0af2-7bc11170.06df8baa.js.map
