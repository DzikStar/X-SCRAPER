...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.LiveEvent~loader.JetfuelFrame~loader.TimelineFrameHandler~loader.PremiumLoaders-c8bf8e-6515a53a"],
    {
        267663: (e, t, n) => {
            n.d(t, { Z: () => a });
            var r = n(202784),
                ...
                s = ({ children: e, onClose: t }) => {
                    const [n, s] = r.useState({ stories: [], activeStory: 0 }),
                        ...
                        g = r.useCallback(
                            ...
                            [m, n.activeStory, n.stories.length],
                        ),
                        y = { navigateStory: m, navigateElement: u, storyPagerState: n, initializeStories: p, initializeStoryElements: h, onClose: d, horizontalDragFraction: c, setHorizontalDragFraction: l, navigateStoryWithTransition: g };
            ...
            const l = ({ isActive: e, isComplete: t }) => {
                ...
                p = ({ children: e, props: t }) => {
                    const n = t.int("index") ?? 0,
                        { initializeStoryElements: a, navigateElement: p, navigateStoryWithTransition: h, storyPagerState: m } = (0, c.rX)(),
                        u = m.stories[n],
                        { setTracksFinished: g, tracksFinished: y } = (0, s.wR)();
                    r.useEffect(() => {
                        if (y) {
                            const e = m.stories[m.activeStory];
                            e.activeElement === e.elements.length - 1 ? h(1) : p(1), g?.(!1);
                        }
                    }, [p, h, g, m.activeStory, m.stories, y]),
                        (0, o.q)(() => {
                            a(e?.length || 0, n);
                        });
                    const f = u?.activeElement || 0;
                    if (e && u)
        ...
        421855: (e, t, n) => {
            ...
            const w = ({ children: e }) => {
                    const { horizontalDragFraction: t, initializeStories: n, navigateElement: w, navigateStoryWithTransition: E, setHorizontalDragFraction: b, storyPagerState: S } = (0, v.rX)(),
                        ...
                        F = I?.left || 0,
                        [P, M] = r.useState(!1),
                        [T, H, R] = (0, o.Zx)(({ windowWidth: e }) => [e > s.default.theme.breakpoints.medium, e > s.default.theme.breakpoints.large, e > s.default.theme.breakpoints.xLarge]),
                        D = !T,
                        $ = (90 * t).toFixed(1),
                        B = (100 * t).toFixed(1),
                        W = 0 === t || 1 === t || -1 === t ? `transform ${f.o}ms ease-in` : "none",
                        A = r.useMemo(() => ({ transition: W, transform: `translateZ(-${z / 2}px) rotate3d(0,1,0,${$}deg)` }), [$, W, z]),
                        L = r.useMemo(() => ({ transition: W, transform: `translateX(${B}%)` }), [W, B]),
                        X = r.useMemo(() => {
                            if (D) return { transform: `translateZ(${z / 2}px)` };
                        }, [D, z]),
                        _ = r.useMemo(() => (D ? { transform: `rotate3d(0,1,0,-90deg) translateZ(${z / 2}px)` } : { transform: "translateX(-100%)" }), [D, z]),
                        G = r.useMemo(() => (D ? { transform: `rotate3d(0,1,0,90deg) translateZ(${z / 2}px)` } : { transform: "translateX(100%)" }), [D, z]),
                        j = r.useCallback(
                            (e) => {
                    ...
                    let Q = {};
                    T ? (Q = x.height600) : H ? (Q = x.height680) : R && (Q = x.height800);
                    ...
                    if (e && k) {
                        const t = e[S.activeStory],
                            n = e[S.activeStory - 1],
                            a = e[S.activeStory + 1];
                        return r.createElement(i.Z, { onPointerDown: K, onPointerMove: J, onPointerUp: U, ref: C, style: [x.container, T && x.containerWideScreen, Q] }, r.createElement(i.Z, { style: D && x.perspectiveZone }, r.createElement(i.Z, { style: [x.cubeContainer, D ? A : L] }, r.createElement(i.Z, { style: [x.storyLeft, Q, _] }, n && !Z && Y, n && ee, r.createElement(y.rh, { isFocused: !1 }, n)), r.createElement(i.Z, { style: [x.focusedStory, Q, X] }, !Z && Y, ee, r.createElement(y.rh, { isFocused: !0, isMuted: P }, t)), r.createElement(i.Z, { style: [x.storyRight, Q, G] }, a && !Z && Y, a && ee, r.createElement(y.rh, { isFocused: !1 }, a)))));
                    }
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.LiveEvent~loader.JetfuelFrame~loader.TimelineFrameHandler~loader.PremiumLoaders-c8bf8e-6515a53a.21b1903a.js.map
