    ...
    ["shared~bundle.News~ondemand.News", "bundle.AudioSpaceDetail"],
    {
        ...
        862300: (e, t, n) => {
            ...
            function w({ blurAmount: e, imageOpacity: t, imageUrl: n, style: a }) {
                return n ? l.createElement(_.Z, { resizeMode: "cover", source: n, style: [E.banner, { opacity: t }, { filter: `blur(${e || 0}px)` }, a] }) : null;
            }
            ...
            function M({ commentPostIds: e, commentsPillContainerStyle: t, commentsPillStyle: n, numComments: i, posts: s, postsCarouselContentStyle: o, postsCarouselStyle: c, style: u }) {
                ...
                return l.createElement(
                    ...
                    l.createElement(
                        N.Z,
                        { buttonsContainerStyle: { ...W.carouselContent, ...(o || {}) }, style: [W.carousel, c] },
                        m.map((e, t) =>
                            l.createElement(B.Z, {
                                ...
                                numberOfLines: 3,
                                onClick: () => {
                                    (0, b.U8)(d, { postId: e, allPostIds: m });
                                },
                                postId: e,
                    ...
                    l.createElement(H.Z, { containerStyle: t, disableClick: !0, numPosts: i, postIds: e, style: [W.commentsPill, n], textStyle: W.commentsPillText, variant: "outline" }),
                );
            }
            ...
            var V = n(373981),
                ...
                $ = n(519896),
                O = n(383675);
            const G = "What is the world saying?";
            function q({ article: e, isExplore: t }) {
                ...
                return l.createElement(a.Z, { style: [j.container, t || n ? { paddingHorizontal: "0%" } : { paddingHorizontal: "27%" }] }, l.createElement(I, { style: j.header, text: G }), i && l.createElement(Q, { timelineId: i }));
            }
            function Q({ timelineId: e }) {
                const t = X(e);
                return t ? l.createElement(U.Z, { anchoring: V.Z, module: t, onTimelinePoll: () => {}, prerollDisplayLocation: $.Nw.OTHER, refreshControl: null, renderEmptyState: () => null, title: "" }) : null;
            }
            const X = (e) => l.useMemo(() => e && (0, O.R)(e, !1), [e]),
            ...
            function te({ image_caption: e, image_height: t = 400, image_size: n, image_url: i }) {
                ...
                return (
                    ...
                    i ? l.createElement(a.Z, { style: ne.container }, l.createElement(_.Z, { resizeMode: "contain", source: i, style: [ne.img, { width: s.width, height: s.height }] }), !!e && l.createElement(u.ZP, { style: ne.caption }, e)) : null
                );
            }
            ...
            var le = n(282279);
            function ae({ onSectionVisible: e, section: t, sources: n, style: i }) {
                const { isCompactLayout: s } = (0, h.Z)();
                return l.createElement(a.Z, { style: [ie.section, i] }, l.createElement(J.D, { id: "news_article_section", onFullyVisible: e, position: "top", testID: "news_article_section" }), !!t.title && l.createElement(I, { text: t.title }), !!t.content.text && l.createElement(S.Z, { sources: n, style: ie.body, text: t.content.text }), t.content.bullets && l.createElement(Z, { bulletpoints: t.content.bullets }), !!t.content.image_url && l.createElement(te, { image_caption: t.content.image_caption, image_size: t.content.image_size, image_url: t.content.image_url }), t.content.website && l.createElement(le.Z, { website: t.content.website }), t.content.post && l.createElement(a.Z, { style: [ie.outerTweetContainer, s ? ie.compactOuterTweetContainer : void 0] }, l.createElement(a.Z, { style: ie.tweetContainer }, l.createElement(Y.ZP, { displayPromotedContent: !0, isCompact: s, tweetId: t.content.post.post_results.rest_id, withActions: !0 }))));
            }
            ...
            var se = n(2025);
            const re = "What is the MSM saying?";
            function oe({ sources: e, style: t }) {
                const n = (0, r.Z)(),
                    i = l.useMemo(() => {
                        const t = [];
                        return (
                ...
                return l.createElement(
                    a.Z,
                    { style: [ce.container, t] },
                    l.createElement(I, { style: ce.sourcesSubHeader, text: re }),
                    l.createElement(
                        N.Z,
            ...
            const ce = s.default.create((e) => ({ container: { width: "100%" }, sourcesSubHeader: { marginBottom: e.spaces.space16 }, carousel: { width: "100%" }, carouselContent: { display: "flex", flexDirection: "row", gap: e.spaces.space12 }, websiteContainer: { height: "100%", maxWidth: 250 }, website: { height: "100%" } }));
            var ue = n(978086);
            function de({ article: e, isExplore: t = !1 }) {
                (0, y.Z)({});
                const n = (0, r.Z)(),
                    s = (0, o.I0)(),
                    u = (0, i.Z)(),
                ...
                l.useEffect(() => {
                    s(c.Z.fetchMultiple(x));
                }, [s, x]);
                const T = l.useCallback(
                        (t) => {
                            e && (0, b.xi)(n, { articleId: e.id, sectionIdx: t, totalNumSections: e.sections.length });
                        },
                        [e, n],
                    ),
                    v = l.useMemo(() => {
                ...
                return e
                    ? l.createElement(
                          ...
                          l.createElement(
                              a.Z,
                              { style: me.container },
                              l.createElement(a.Z, { style: me.bannerContainer }, !t && l.createElement(a.Z, { style: f }), l.createElement(a.Z, { style: me.banner }, l.createElement(w, { imageUrl: e.header_img_url, style: t ? me.exploreBanner : void 0 }), e.header_img_post_id && l.createElement(F, { postId: e.header_img_post_id.post_results.rest_id, style: t ? me.exploreImageAttribution : void 0 })), !t && l.createElement(a.Z, { style: f })),
                              l.createElement(
                                  a.Z,
                                  { style: me.content },
                                  ...
                                  l.createElement(
                                      a.Z,
                                      { style: [me.centerComponents, d && me.compactCenterComponents] },
                                      l.createElement(a.Z, { style: me.headerContainer }, l.createElement(ue.Z, { text: e.title, textStyle: me.title }), l.createElement(A.Z, { textStyle: me.lastUpdatedAt, timestamp: e.last_updated_at }), !!e.summary && l.createElement(S.Z, { sources: [], style: me.summary, text: e.summary })),
                                      l.createElement(a.Z, { style: me.postsContainer }, _ && l.createElement(R.Z, { article: e, hideTitle: !0, isInline: !0 }), e.posts && e.posts.length > 0 && l.createElement(M, { commentPostIds: E, numComments: Number(e.total_trend_posts), posts: e.posts })),
                                                ...
                                                selections: [
                                                    ...
                                                    }),
                                                    {
                                                        ...
                                                        selections: [
                                                                ...
                                                                selections: [
                                                                    d,
                                                                    {
                                                                        ...
                                                                        selections: [
                                                                            ...
                                                                            (_ = { kind: "InlineFragment", selections: [{ alias: "inline_header", args: null, kind: "ScalarField", name: "content", storageKey: null }], type: "InlineHeader", abstractKey: null }),
                                                                            ...
                                                                            (O = { kind: "InlineFragment", selections: [(H = { alias: null, args: null, kind: "ScalarField", name: "last_time_updated", storageKey: null }), (B = { alias: null, args: null, kind: "ScalarField", name: "question", storageKey: null }), { alias: null, args: null, concreteType: "SentimentScore", kind: "LinkedField", name: "sentiment_scores", plural: !0, selections: [(M = { alias: null, args: null, kind: "ScalarField", name: "num_posts", storageKey: null }), (W = { alias: null, args: null, kind: "ScalarField", name: "sentiment_type", storageKey: null }), (V = { alias: null, args: null, kind: "ScalarField", name: "sentiment_value", storageKey: null }), h], storageKey: null }, (U = { alias: null, args: null, kind: "ScalarField", name: "sentiment_types", storageKey: null }), ($ = { alias: null, args: null, kind: "ScalarField", name: "trend_id", storageKey: null })], type: "TrendSentiment", abstractKey: null }),
                                                                        ],
                                                                        storageKey: null,
                                                                    },
                                                                ],
                                                            ...
                                                            (G = { alias: null, args: null, concreteType: "GrokBraveSearch", kind: "LinkedField", name: "sources", plural: !0, selections: [E, S, x, F, T, v, Z, K, C, I, L, P, z, D, d, m, A], storageKey: null }),
                                                            (q = { alias: null, args: null, concreteType: "Post", kind: "LinkedField", name: "posts", plural: !0, selections: o, storageKey: null }),
                                                        ],
                                                        storageKey: null,
                                                    },
                                                    (Q = { alias: null, args: null, concreteType: "TrendSentiment", kind: "LinkedField", name: "sentiment_data", plural: !1, selections: [$, B, H, U, { alias: null, args: null, concreteType: "SentimentScore", kind: "LinkedField", name: "sentiment_scores", plural: !0, selections: [W, V, M, h], storageKey: null }], storageKey: null }),
                                                ],
                                                type: "AiTrend",
                                                abstractKey: null,
                                            },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.News~ondemand.News.53a052fa.js.map
