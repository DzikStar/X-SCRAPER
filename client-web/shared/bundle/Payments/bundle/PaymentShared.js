    ...
    ["shared~bundle.Payments~bundle.PaymentShared"],
    {
        ...
        969564: (e, n, a) => {
            ...
            var o = a(712696),
                u = a.n(o),
                d = a(68290);
            const c = Object.freeze({ Delayed: "Delayed", RealTime: "RealTime" });
            var m = a(514639);
            const y = r,
                ...
                g = () => {
                    ...
                    return (
                        o?.forEach(({ fees: e, processing_time: n, transfer_method_type: a }) => {
                            const l = n?.processing_time_type === c.RealTime,
                                s = { settleTimeMessage: l ? "Instant" : (({ count: e }) => `Up to ${e} business days`)({ count: n?.max_duration_in_business_days ?? 3 }), Icon: l ? d.default : void 0, processingTime: n, fees: e },
                                t = a?.pull_transfer_method_type,
                                o = a?.push_transfer_method_type;
                            t && r.set(t, s), o && i.set(o, s);
                        }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.Payments~bundle.PaymentShared.86494cea.js.map
