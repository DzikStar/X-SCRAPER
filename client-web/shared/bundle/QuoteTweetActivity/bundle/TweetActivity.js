(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.QuoteTweetActivity~bundle.TweetActivity"],
    {
        ...
        652904: (e, t, i) => {
            ...
            class l extends r.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const l = _ || s;
                    ((l && _ !== s) || (!l && i !== n) || r !== a || o) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        886191: (e, t, i) => {
            ...
            const m = s().c09de2d4,
                g = s().ae111c99,
                v = r.createElement(s().I18NFormatMessage, { $i18n: "e7e44bab" }, r.createElement(_.ZP, { link: "/settings/search" }, s().f191a2ba));
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getModule = () => {
                            ...
                            return this._getMemoizedModule(e, t, r, i, n, _, s);
                        }),
                        ...
                        (this._getMemoizedModule = (0, o.Z)((e, t, i, r, _, n, a) => (0, w.Z)({ query: e, searchMode: i, querySource: t, searchFilters: r, vertical: _, urtEndpointOptions: n, searchTimelinesGraphQLEnabled: a }))),
        ...
        864702: (e, t, i) => {
            ...
            var r = i(111677),
                ...
                a = i(51525);
            const s = _().i1801686,
                o = { [n.ZP.GenericForbidden]: { toast: (0, a.j)() }, [n.ZP.InvalidRequestUrl]: { toast: { text: s, withClearButton: !0 } }, showToast: !0 };
        },
        883432: (e, t, i) => {
            "use strict";
            i.d(t, { Z: () => r });
        ...
        481918: (e, t, i) => {
            ...
            var r = i(413798),
                ...
                n = i(218951),
                a = i(952257);
            const s = (e) => (0, n.Z)({ timelineId: `retweetersGraphQL-${e}`, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchRetweetedBy, getEndpointParams: ({ count: t, cursor: i }) => ({ count: t, cursor: "string" == typeof i ? i : void 0, tweetId: e }) }, formatResponse: _.Z, context: "FETCH_TWEET_ACTIVITY_RETWEETS", perfKey: "retweetersGraphQL", staleIntervalMs: a.J });
        },
        774006: (e, t, i) => {
            "use strict";
            i.d(t, { Z: () => b, u: () => h });
            ...
            const l = "search-",
                ...
                b = ({ query: e, searchMode: t = n.N3.Top, querySource: i, searchFilters: a, vertical: s, urtEndpointOptions: h, searchTimelinesGraphQLEnabled: b }) => {
                    const u = w(i),
                        m = a && a.peopleFilter ? "searcher_follows" : void 0,
                        g = m ? "-pf" : "",
                        v = a && a.locationFilter && !e.includes(c) ? `${e}${c}` : e,
                        y = { timelineId: `${l}${v}-${t}${u}${g}`, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchSearch, getEndpointParams: (e) => ({ ...h?.requestParams, q: v, social_filter: m, vertical: s, ...p[t], ...e }) }, context: "FETCH_SEARCH_TIMELINE", perfKey: "search", staleIntervalMs: t === n.N3.Live ? 5e3 : void 0, timelineType: "search" };
                    if (b) {
                        const e = m && !v.includes(d) ? `${v}${d}` : v,
                            ...
                            s = `gql-${l}${v}-${t}${u}${g}`;
                        return (0, o.Z)({ ...y, timelineId: s, context: "FETCH_SEARCH_GRAPHQL_TIMELINE", formatResponse: _.Z, network: { getEndpointParams: ({ count: t, cursor: r }) => ({ rawQuery: e, count: t, product: a, querySource: i, cursor: "string" == typeof r ? r : void 0 }), getEndpoint: (e) => e.withEndpoint(r.Z).fetchSearchGraphQL } });
                    }
                    return (0, o.Z)(y);
                };
        },
        ...
        748138: (e, t, i) => {
            ...
            const s = (e = {}) => {
                ...
                return (0, _.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [a.Z.root, e.style], viewBox: "0 0 24 24", children: r.createElement("g", null, r.createElement("path", { d: "M23 3v14h-2V5H5V3h18zM10 17c1.1 0 2-1.34 2-3s-.9-3-2-3-2 1.34-2 3 .9 3 2 3zM1 7h18v14H1V7zm16 10c-1.1 0-2 .9-2 2h2v-2zm-2-8c0 1.1.9 2 2 2V9h-2zM3 11c1.1 0 2-.9 2-2H3v2zm0 4c2.21 0 4 1.79 4 4h6c0-2.21 1.79-4 4-4v-2c-2.21 0-4-1.79-4-4H7c0 2.21-1.79 4-4 4v2zm0 4h2c0-1.1-.9-2-2-2v2z" })) }, { writingDirection: t });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.QuoteTweetActivity~bundle.TweetActivity.df5213ba.js.map
