            ...
            const l = "search-",
                ...
                b = ({ query: e, searchMode: t = n.N3.Top, querySource: i, searchFilters: a, vertical: s, urtEndpointOptions: h, searchTimelinesGraphQLEnabled: b }) => {
                    const u = w(i),
                        ...
                        f = { timelineId: `${l}${v}-${t}${u}${g}`, network: { getEndpoint: (e) => e.withEndpoint(r.Z).fetchSearch, getEndpointParams: (e) => ({ ...h?.requestParams, q: v, social_filter: m, vertical: s, ...p[t], ...e }) }, context: "FETCH_SEARCH_TIMELINE", perfKey: "search", staleIntervalMs: t === n.N3.Live ? 5e3 : void 0, timelineType: "search" };
                    if (b) {
                        const e = m && !v.includes(d) ? `${v}${d}` : v,
                            ...
                            s = `gql-${l}${v}-${t}${u}${g}`;
                        return (0, o.Z)({ ...f, timelineId: s, context: "FETCH_SEARCH_GRAPHQL_TIMELINE", formatResponse: _.Z, network: { getEndpointParams: ({ count: t, cursor: r }) => ({ rawQuery: e, count: t, product: a, querySource: i, cursor: "string" == typeof r ? r : void 0 }), getEndpoint: (e) => e.withEndpoint(r.Z).fetchSearchGraphQL } });
                    }
                    return (0, o.Z)(f);
                };
        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.QuoteTweetActivity~bundle.TweetActivity.234bb81a.js.map
