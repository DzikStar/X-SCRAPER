        ...
        403911: (e, t, o) => {
            ...
            const x = { result: [], entities: {}, slice_info: {} },
                ...
                A = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarksTimeline: ({ count: o, cursor: a }) => e.graphQL(m(), { count: o, cursor: a, includePromotedContent: !0, ...(0, i.d)(t) }, (e, t) => !t?.bookmark_timeline_v2?.timeline).then((e) => e?.bookmark_timeline_v2?.timeline || S.cY),
                    fetchBookmarkFolderTimeline: ({ bookmark_collection_id: o, cursor: a }) => e.graphQL(p(), { bookmark_collection_id: o, cursor: a, includePromotedContent: !0, ...(0, i.d)(t) }, C).then((e) => e?.bookmark_collection_timeline?.timeline || S.cY),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044.072a521a.js.map
