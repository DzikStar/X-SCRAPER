        ...
        403911: (e, t, o) => {
            ...
            const I = { result: [], entities: {}, slice_info: {} },
                ...
                Q = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarkFolderTimeline: ({ bookmark_collection_id: o, cursor: a }) => e.graphQL(p(), { bookmark_collection_id: o, cursor: a, includePromotedContent: !0, ...(0, i.d)(t) }, L).then((e) => e?.bookmark_collection_timeline?.timeline || x.cY),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044.b7ca74da.js.map
