        ...
        403911: (e, t, o) => {
            ...
            const S = { result: [], entities: {}, slice_info: {} },
                ...
                A = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    fetchBookmarksTimeline: ({ count: o, cursor: a }) => e.graphQL(b(), { count: o, cursor: a, includePromotedContent: !0, ...(0, i.d)(t) }, (e, t) => !t?.bookmark_timeline_v2?.timeline).then((e) => e?.bookmark_timeline_v2?.timeline || F.cY),
        ...
        6157: (e, t, o) => {
            ...
            function Q({ apiClient: e }) {
                return {
                    ...
                    fetchHistory: ({ cursor: t }) => e.graphQL(b(), { cursor: t }).then((e) => e),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-4974a044.d788df8a.js.map
