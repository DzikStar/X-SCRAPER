                    ...
                    super(e, t),
                        ...
                        (this._renderTweetText = (e) => {
                            ...
                            const w = this.context.featureSwitches.isTrue("responsive_web_twitter_article_seed_tweet_summary_enabled"),
                                ...
                                I = ke.Bq(_, S);
                            let Z = null;
                            _.note_tweet && (Z = { ..._.note_tweet });
                            const P = this._getInlineMediaSpec(Z, _),
                                A = !!_.grok_translated_post,
                                L = { text: _.grok_translated_post?.translation ?? "", destinationLanguage: _.grok_translated_post?.destination_language ?? "", entities: _.grok_translated_post?.entities ?? {}, display_text_range: [0, _.grok_translated_post?.translation?.length ?? 0] };
                            return r.createElement(Me.Z, null, r.createElement(v.z, { context: Z }, r.createElement(Ve.Z, null, r.createElement(de.Z, { article: w ? _.article : void 0, disableTranslation: A || _.user.protected, displayTextRange: this.state.showGrokTranslation ? L.display_text_range : I.display_text_range, entities: this.state.showGrokTranslation ? L.entities : I.entities, excludeCardUrl: y, headerWhenTranslationDisabled: A ? this._renderGrokTranslationHeader("text", c, _.lang) : void 0, hitHighlights: i ? void 0 : t, id: e, inlineMediaSpec: P, isFocal: i, isPreviewDisplay: _.isPreviewDisplay, isTranslatable: !A && _.is_translatable, lang: this.state.showGrokTranslation ? L.destinationLanguage : _.lang, linkify: !!i || n, onEntityClick: o, onMediaTranslation: this._handleMediaTranslations, onToggleTranslation: this._handleTranslationToggle, permalink: _.permalink, quotedTweetId: _.quoted_status && _.quoted_status.id_str, quotedTweetPermalink: _.quoted_status_permalink, renderTranslationFeedback: this._getTranslationFeedbackRenderer("inside-text"), size: m, style: T, supplementalLang: _.supplemental_language, text: this.state.showGrokTranslation ? L.text : I.text, transformHashtagLink: b, transformUrl: this._transformUrl, tweetId: _.id_str, unmentionedUserIds: _.unmentioned_user_ids, withCardLinks: i ? void 0 : h, withMediaLinks: i ? void 0 : !u, withOriginalText: i, withQuoteLinks: (!i && p) || d.Z.isQuotedTweetUnavailable(_), withUnicodeEmojis: !1 }))));
                        }),
