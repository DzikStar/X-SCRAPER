        ...
        808692: (e, t, i) => {
            ...
            class Pt extends r.Component {
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._renderGrokTranslationHeader = (e) => {
                            ...
                            if ("quote-text" === e && this.props.tweet.quoted_status?.grok_translated_post) return r.createElement(le.O, { position: "top", style: At.translationHeaderInQuote, translationStatus: "loaded", withAction: !1 });
                        }),
                ...
                _richContentProps() {
                    ...
                    return { cardCacheLocationKey: P, displayMediaMetadata: a, enableKeyboardShortcuts: t, filterOutInlineMedia: a || I, forwardPivotInfo: k.softIntervention || i, inlineCalloutInfo: n, innerForwardPivotInfo: o, innerNudges: s, isMediaMaxHeightEnabled: R, loggedInUserId: this.context.viewerUserId, mediaAltTranslations: this.state.mediaAltTranslations, mediaCacheLocationKey: P, nudges: c, onCardLinkClick: h, onGrokClick: this._onGrokClick, onMediaClick: u, onQuotedTweetAvatarClick: m, onQuotedTweetScreenNameClick: w, onQuoteTweetClick: p, onQuoteTweetMediaClick: _, pollTranslations: D, preventVideoPlayback: g, promotedContent: T, quotedTweetTombstoneInfo: b, quoteTweetSingleImageMinAspectRatio: at, quoteTweetSocialContextProps: C, renderGrokTranslationHeaderForQuote: () => this._renderGrokTranslationHeader("quote-text"), renderJetfuelFrame: this._renderJetfuelFrame(), renderPrerollActionMenu: this._getPrerollActionMenuRenderer({}), renderQuoteTweetTombstone: (e) => r.createElement(Qe.Z, e), renderTranslationFeedback: this._getTranslationFeedbackRenderer("below-poll"), showAltTranslation: this.state.showTranslation, singleImageMaxAspectRatio: st, singleImageMinAspectRatio: a ? 0.1 : at, style: At.richContent, tweet: k, withActionsDisabled: M, withAltTextBadge: v, withCardLinks: y, withCenterCrop: !0, withCondensedQuoteTweet: (!a && d.Z.hasMedia(F, !S)) || !!E, withHalvedMediaSize: x, withMediaTagsIcon: a, withQuoteTweetBirdwatchPivot: !0, withQuoteTweetHeaderLinks: !1, withQuoteTweetLink: l, withQuoteTweetMedia: S, withRoundMediaCorners: B, withTweetMedia: S, withUserHoverCard: Z };
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2.5361e91a.js.map
