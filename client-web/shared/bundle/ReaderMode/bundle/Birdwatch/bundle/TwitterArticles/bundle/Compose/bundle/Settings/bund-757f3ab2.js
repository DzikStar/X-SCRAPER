...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2"],
    {
        808692: (e, t, i) => {
            ...
            class Pt extends r.Component {
                    ...
                    super(e, t),
                        ...
                        (this._renderAtGrokPromo = () => {
                            ...
                            const n = !!e.in_reply_to_status_id_str,
                                ...
                                s = this._random <= i;
                            return n && !o && s ? r.createElement(Bt, null) : null;
                        }),
                        ...
                        (this._renderLoggedOutReadRepliesPivot = () => {
                            ...
                            return t && i > 5 && this.context.featureSwitches.isTrue("responsive_web_logged_out_read_replies_pivot_enabled") ? r.createElement(a.Z, null, r.createElement(w.Z, { Icon: Q.default, destinationUrl: o, element: "logged_out_read_replies_pivot", entityId: e.id_str, isForQuoteTweet: !1, label: xt({ replyCount: n }) }), c) : c;
                        }),
                        (this._renderStaleEditCallout = (e) => {
                            const { onStaleEditLinkClick: t, tweet: i } = this.props,
                                n = d.Z.getOriginalTweet(i),
                                o = T.F();
                            return r.createElement(a.Z, { style: [At.detailItemContainer, At.detailItem] }, r.createElement(a.Z, { style: At.staleEditCallout }, r.createElement(f.Z, { editType: "stale", id: e, textMode: "standalone" })), r.createElement(v.ZP, { "aria-describedby": o, link: d.Z.getTweetLatestVersionPermalink(n), onClick: t, style: At.staleEditLink }, ht), r.createElement(s.Z, { id: o, style: { display: "none" } }, ut));
                        }),
                        (this._renderModeratedRepliesIcon = () => {
                            const { hasModeratedReplies: e, onModeratedIconClick: t, tweet: i } = this.props;
                            return e ? r.createElement(y.Z, { link: `${i.permalink}/hidden`, onPress: t }) : null;
                        }),
                        ...
                        (this._willRenderInlineReply = () => {
                            ...
                            if (!e) return !1;
                            return i && !(0, ue.$y)(t, e, ue.d.Reply) && ((0, ge.ZP)() || !1);
                        }),
                        (this._handleLayout = (e) => {
                            this._isMounted && this.setState({ width: e.nativeEvent.layout.width });
                        }),
                        (this._renderTweetTextHWTweet = (e) => {
                            const { hitHighlights: t, isFocal: i, linkify: o, onEntityClick: s, to: a, tweet: l, tweetTextSize: c, withCardLinks: h, withInlineMedia: u, withQuotedTweetLinks: p, withReaderModeActive: _ } = this.props,
                                { isExpanded: m } = this.state,
                                w = d.Z.getOriginalTweet(l),
                                g = this.context.featureSwitches.isTrue("responsive_web_twitter_article_seed_tweet_summary_enabled");
                            let C;
                            C = c || e.size;
                            const b = w?.community_id_str,
                                T = b ? (e, t) => new URL(`/i/communities/${b}/hashtag/${t}`, e) : void 0;
                            let f;
                            !m && !_ && w.note_tweet && w.note_tweet.is_expandable && (f = this.context.featureSwitches.isTrue("rweb_timeline_inline_show_more_enabled") ? () => this.setState({ isExpanded: !0 }) : this._getMaybeRedirectedTweetLink(a, !0));
                            const v = { ...e, transformHashtagLink: T, hitHighlights: t, linkify: o, onEntityClick: s, size: C, transformUrl: this._transformUrl, unmentionedUserIds: w.unmentioned_user_ids, withCardLinks: h, withMediaLinks: !u, withShowMore: f, withQuoteLinks: p || d.Z.isQuotedTweetUnavailable(w), withUnicodeEmojis: !1, article: g ? w?.article : void 0 };
                            let y;
                            y = m || _ ? Te.Bq(w, { featureSwitches: this.context.featureSwitches }) : { text: w.text, entities: w.entities, display_text_range: w.display_text_range };
                            const E = !i && !this.context.featureSwitches.isTrue("longform_notetweets_rich_text_timeline_enabled");
                            let x = null;
                            w.note_tweet && (x = { ...w.note_tweet, richtext_tags: E ? [] : w.note_tweet.richtext_tags });
                            const S = _ ? this._getInlineMediaSpec(x, w) : void 0,
                                Z = !!w.grok_translated_post,
                                I = { text: w.grok_translated_post?.translation ?? "", entities: w.grok_translated_post?.entities ?? {}, display_text_range: [0, w.grok_translated_post?.translation?.length ?? 0] };
                            return r.createElement(r.Fragment, null, r.createElement(Ue.Z, null, r.createElement(k.z, { context: x }, r.createElement(Ne.Z, null, r.createElement(de.Z, (0, n.Z)({}, v, { disableTranslation: Z || w.user.protected, displayTextRange: this.state.showGrokTranslation ? I.display_text_range : y.display_text_range, entities: this.state.showGrokTranslation ? I.entities : y.entities, inlineMediaSpec: S, isFocal: i, isPreviewDisplay: w.isPreviewDisplay, isTranslatable: !Z && w.is_translatable, lang: w.lang, numberOfLines: this._shouldShowAdLabel() || m || _ ? void 0 : 10, onMediaTranslation: this._handleMediaTranslations, onToggleTranslation: this._handleTranslationToggle, permalink: w.permalink, supplementalLang: w.supplemental_language, text: this.state.showGrokTranslation ? I.text : y.text, tweetId: w.id_str, withOriginalText: i })), Z && this._renderTranslatedByMessage()))), w.isPreviewDisplay && this._renderPreviewCta(), this._renderAtGrokPromo());
                        }),
                        (this._renderTranslatedByMessage = () => (this.state.showGrokTranslation ? r.createElement(v.ZP, { color: "gray900", size: "subtext2", style: At.translatedBy, weight: "normal" }, le.li, r.createElement(E.Z, { size: "space2" }), r.createElement($.default, null), r.createElement(x.ZP, { backgroundColor: "transparent", borderColor: "transparent", size: "smallCompact", style: At.translateButton }, r.createElement(v.ZP, { color: "blue500", onClick: () => this.setState({ showGrokTranslation: !1 }), size: "subtext2", weight: "normal" }, Zt))) : r.createElement(v.ZP, { color: "gray900", size: "subtext2", style: At.translatedBy, weight: "normal" }, r.createElement($.default, null), r.createElement(x.ZP, { backgroundColor: "transparent", borderColor: "transparent", size: "smallCompact", style: At.translateButton }, r.createElement(v.ZP, { color: "blue500", onClick: () => this.setState({ showGrokTranslation: !0 }), size: "subtext2", weight: "normal" }, It))))),
                            ...
                            if (e?.inline_media)
                                return {
                                    ...
                                    render: (e) => {
                                        ...
                                        const s = [o];
                                        return r.createElement(a.Z, { style: At.inline_media }, r.createElement(S.Y, (0, n.Z)({}, this._richContentProps(), { mediaDetails: s })));
                                    },
                                };
                        }),
                        (this._renderTweetText = (e) => {
                            ...
                            const m = this.context.featureSwitches.isTrue("responsive_web_twitter_article_seed_tweet_summary_enabled"),
                                ...
                                b = C ? (e, t) => new URL(`/i/communities/${C}/hashtag/${t}`, e) : void 0,
                                T = "true" === s?.experiment_values?.pac_in_timeline && Z.default.isFollowerCard(s?.adMetadataContainer?.dynamicCardContent?.card_type),
                                f = Z.default.isCardDisabled(p.card?.name),
                                v = !p || !p.card || f || a.is_quote_status || T ? void 0 : p.card.url,
                        ...
                        (this._renderArticleContent = () => {
                            ...
                            return d.Z.isArticlePost(n) && n.article && o ? (n.isPreviewDisplay ? r.createElement(P.Z, { articleEntity: n.article, hasSensitiveContent: n.possibly_sensitive, mediaVisibilityResults: n.mediaVisibilityResults }) : r.createElement(De.ZP, { minContentThreshold: 5, publishedPost: n, renderInTweet: !0, twitterArticle: n.article, withActionBar: !0 })) : null;
                        }),
                        ...
                        (this._getFoSnRViolationAuthorAppealInfo = () => {
                            const { onFosnrAuthorAppealClick: e, tweet: t } = this.props,
                                ...
                                d = j.default;
                            return l ? r.createElement(A.Z.Custom, { Icon: d, action: { label: Tt, link: { pathname: "/i/safety/report_story_start", state: { input: { requested_variant: JSON.stringify(l) } } } }, backgroundColor: "primary0", onAction: e, style: At.fosnrAuthorAppealLabel, text: o, withColoredIcon: !0 }) : null;
                        }),
                        ...
                        (this._getActionMenuRenderer = ({ promotedContentA11yId: e, withViews: t }) => {
                            const { isFocal: i, renderCurationActionMenu: n, tweet: o } = this.props,
                                ...
                                T = !(!this.props.viewerUser?.is_blue_verified && !this.props.viewerUser?.verified_type),
                                f = !((!w && !T) || !Rt(g) || this.context.featureSwitches.isTrue("gryphon_hide_quick_promote")),
                                y = _.views?.count ?? 0,
                                k = !(!this.props.withSocialContext || !this.props.socialContext);
                            return () => r.createElement(L.Fo, { query: m }, (n) => r.createElement(a.Z, { style: At.actionsContainer }, n ? r.createElement(ie.C, { buttonType: "primaryFilled", size: (0, ge.ZP)() ? "small" : "xSmall", userId: h.id_str }) : p ? r.createElement(ie.C, { buttonType: "primaryFilled", isSuperFollowSubscriptionEnabled: l, referringPage: "subscribe_tweet_details", relationshipMode: "subscribe", size: (0, ge.ZP)() ? "small" : "xSmall", userId: h.id_str }) : f ? r.createElement(Ye.Z, { hasSocialContext: k, isFocal: i, permalink: o.permalink, tweetId: o.id_str, tweetText: o.text }) : null, u ? r.createElement(v.ZP, { "aria-label": e, color: "gray700" }, ct) : null, t && !u && y ? r.createElement(v.ZP, { "aria-label": ft({ count: y }), color: "gray700" }, C.ZP.getTruncatedCount(y)) : null, b, s));
                        }),
                ...
                render() {
                    const { conversationTreeMetadata: e, forwardPivotInfo: t, hideConversationControlsEducationText: i, hideExclusivityInfoEducationTextInReplies: o, hideTrustedFriendsEducationTextInReplies: s, isCompact: u, isFocal: p, onBlur: m, onClick: w, onFocus: g, onPromotedUserProfileCardClick: C, promotedContent: b, quotedTweetTombstoneInfo: f, readerModeAvailable: y, socialContext: k, to: E, tweet: x, withReaderModeActive: S, withTimestamp: Z, withUnreadStyles: I } = this.props,
                        ...
                        N = !(this.props.viewerUser?.id_str !== P?.user?.id_str || !P.user.professional),
                        H = !(!this.props.viewerUser?.is_blue_verified && !this.props.viewerUser?.verified_type),
                        D = P.quick_promote_eligibility?.eligibility,
                        O = !((!N && !H) || !Rt(D) || this.context.featureSwitches.isTrue("gryphon_hide_quick_promote")),
                    ...
                    return p
                        ? r.createElement(M.j, { tweet: x }, ([n, d]) => {
                              const c = V ? r.createElement(Xe.Z, { id: n.promotionStatusLabel, status: Mt(D), style: At.promotionStatus }) : null,
                                  u = e ? r.createElement(v.ZP, { id: n.conversationLevel, style: l.default.visuallyHidden }, lt({ conversationTreeDepth: e.depth.toString() })) : null,
                                  p = P.tombstoneInfo || x.tombstoneInfo,
                                  T = r.createElement(r.Fragment, null, p ? this._renderTombstone(n.tombstone, p) : null, this._renderReplyContext({ id: n.replyContext }), r.createElement(a.Z, null, this._renderTweetText(n.text)), r.createElement(a.Z, null, this._renderRichContent({ id: n.richContent })), P.isPreviewDisplay && this._renderPreviewCta(), r.createElement(a.Z, null, U ? r.createElement(ke.nO, { namespace: bt }, r.createElement(_.ZP.Provider, { value: { followButtonAtBottomOfPromotedUserCard: R } }, r.createElement(h.Z.PromotedUserProfileCard, { followButton: r.createElement(ie.C, { promotedContent: b, userId: P.user.id_str }), isUserProtected: P.user.protected, isUserVerified: P.user.verified, link: { pathname: `/${P.user.screen_name}`, anchorless: !0, state: { promotedTweetState: b } }, onClick: C, onScreenNameClick: C, promotedContent: b, style: At.promotedUserCard, userDescription: P.user.description, userId: P.user.id_str, userName: P.user.name, userScreenName: P.user.screen_name }))) : null));
                              ...
                              r.createElement(
                                  ...
                                  r.createElement(
                                      ...
                                      r.createElement(h.Z, {
                                          ...
                                          renderPromotedUserProfileCard: (e) => (U ? r.createElement(ke.nO, { namespace: bt }, r.createElement(_.ZP.Provider, { value: { followButtonAtBottomOfPromotedUserCard: R } }, r.createElement(h.Z.PromotedUserProfileCard, (0, n.Z)({}, e, { followButton: r.createElement(ie.C, { promotedContent: b, userId: e.userId }), link: { pathname: `/${P.user.screen_name}`, anchorless: !0, state: { promotedTweetState: b } }, onClick: C, onScreenNameClick: C, style: At.promotedUserCard })))) : null),
                                          ...
                                          renderSocialContext: (e) => this._renderSocialContext({ id: e.id }),
                                          ...
                                          socialContext: k ? { contextType: k.contextType, isSelfRetweet: k.isSelfRetweet, link: k.landingUrl ? (0, fe.s9)(k.landingUrl) : void 0, name: k.name, screenName: k.screenName, text: k.text } : void 0,
                ...
                _renderTweetRelativeTimestamp(e) {
                    ...
                    return r.createElement(N.Z, { id: e, link: n ? { pathname: o.permalink, state: { contextTweetId: o.id_str, promotedContent: t } } : void 0, timestamp: o.created_at });
                }
                ...
                _renderTweetStats() {
                    return this.context.featureSwitches.isTrue("tweet_awards_web_non_focal_tweet_coins_enabled") ? () => r.createElement(a.Z, { style: At.tweetStats }, this._renderCoinsCount(!0)()) : Y.Z;
                }
                _renderCoinsCount(e) {
                    ...
                    return o && s && s > 0 ? () => r.createElement($e.Z, { coinCount: s, isLabel: e, link: `${n}/coins` }) : Y.Z;
                }
                _renderFocalContent(e) {
                    const { onAnalyticsClick: t, onEngagementsClick: i, onLatestEditLinkClick: n, tweet: o } = this.props,
                        ...
                        T = wt(b),
                        y = `${gt(b)} · ${T}`,
                        k = this.context.featureSwitches.isTrue("view_counts_public_visibility_enabled"),
                        E = _?.count,
                    ...
                    return r.createElement(
                        r.Fragment,
                        null,
                        r.createElement(a.Z, { style: At.footerContainer }, r.createElement(a.Z, { style: At.footerContent }, r.createElement(O.Z, { linkColor: "gray700", renderCoinCount: this._renderCoinsCount(), renderEditCallout: m ? (t) => r.createElement(f.Z, { editType: t.editType, id: e.a11yIds.editCallout, textMode: t.textMode }) : Y.Z, renderPlace: p ? () => r.createElement(v.ZP, { color: p.id ? "gray700" : void 0, link: p.id ? `/places/${p.id}` : void 0 }, p.full_name) : Y.Z, renderTimestamp: (e) => r.createElement(N.Z, { "aria-describedby": e["aria-describedby"], "aria-label": m ? `${_t} ${pt} ${y}` : void 0, link: m ? d.Z.getTweetEditHistoryRoute(s) : u, onPress: m ? n : void 0, prefix: e.prefix, relative: !1, timestamp: l }), renderViewCount: x && k ? () => r.createElement(V.Z, null, r.createElement(v.ZP, null, r.createElement(G().I18NFormatMessage, { $i18n: "c1976bcf" }, r.createElement(V.Z.Value, { animated: !0, count: Number(E) }, G().f396c105({ displayCount: x })), r.createElement(V.Z.Label, null, G().aa037e65({ count: Number(E) }))))) : Y.Z, style: At.timeLocSource }), r.createElement(a.Z, { style: At.footerIcons }, this._renderModeratedRepliesIcon())), this._withAdLabel ? null : this._renderPromotedDetails(), e.promotionStatusBadge),
                        ...
                        Z ? r.createElement(Oe.Z, { variant: "PostAnalytics", wrapperStyles: At.postEngagementsUpsell }) : null,
                ...
                _renderHeader(e) {
                    ...
                    return r.createElement(r.Fragment, null, t && n && i && this.context.featureSwitches.isTrue("topics_context_controls_inline_prompt_enabled") ? (0, tt.Z)({ defaultRef: this._defaultInlinePromptRef, topic: i, topicFollowPrompt: n }) : this._renderSocialContext({ id: e.socialContext }));
                }
                _renderSelfThreadCTA() {
                    ...
                    return this._shouldShowSelfThread() ? r.createElement(He.Z, { avatarUrl: o ? n.user.profile_image_url_https : void 0, onClick: e, onImpression: t, style: At.selfThreadCTA, to: i.permalink, userName: n.user.screen_name, withConversationLine: o }) : null;
                }
                ...
                _renderSocialContext({ id: e }) {
                    const { conversationPosition: t, injectedFeedbackItem: i, isFocal: o, onUndoTopicNotInterestedClick: s, promotedContent: a, socialContext: l, socialContextColor: d, topic: h, withSocialContext: u } = this.props;
                    if (!u || !l || c.Z.isPromoted(a)) return null;
                    const { featureSwitches: p } = this.context,
                        _ = t && !this._getIsConversationStart(),
                        { contextType: m, isSelfRetweet: w, landingUrl: g, name: C, screenName: b, text: T, topicContext: f } = l,
                        v = g ? (0, fe.s9)(g) : void 0;
                    if (f && h && (0, et.eM)({ featureSwitches: p, isExpanded: o, topic: h, topicContext: f })) return r.createElement(et.pZ, { onUndoTopicNotInterestedClick: s });
                    const y = { contextType: m, iconSize: "large", withLeftPadding: !_ && !this._getWithTopLine(), text: T },
                        k = f && h ? (0, et.cN)({ featureSwitches: p, iconSize: y.iconSize, injectedFeedbackItem: i, isExpanded: o, socialContext: l, topic: h, withLeftPadding: y.withLeftPadding }) : y;
                    return r.createElement(se.Z, (0, n.Z)({}, k, { iconColor: d, id: e, link: v, onClick: m === Ie.Z.Topic ? this._handleSocialContextClick : void 0, retweetData: { name: C, screenName: b, isSelfRetweet: w }, style: At.socialContext, testID: Ge.Z.socialContext, textColor: d, weight: "bold" }));
                }
                ...
                _renderTombstone(e, t) {
                    const { conversationTreeMetadata: i, isFocal: n, onClick: o, tweet: s } = this.props,
                        ...
                        { richText: c } = t;
                    return l && t && c ? r.createElement(a.Z, { id: e, style: At.spacingVertical }, r.createElement(ae.Z, { actionLink: n ? void 0 : l.permalink, actionText: n ? void 0 : at, conversationTreeMetadata: i, inline: !0, onClick: n ? void 0 : o }, r.createElement(oe.Z, { entities: c.entities, rtl: c.rtl, text: c.text }))) : null;
                }
                _hasPhoto() {
                    const { tweet: e } = this.props,
                        t = d.Z.getOriginalTweet(e),
                ...
                _richContentProps() {
                    const { featureSwitches: e } = this.context,
                        { enableKeyboardShortcuts: t, forwardPivotInfo: i, inlineCalloutInfo: n, innerForwardPivotInfo: o, innerNudges: s, isFocal: a, linkableQuotedTweet: l, nudges: c, onCardLinkClick: h, onMediaClick: u, onQuoteTweetClick: p, onQuoteTweetMediaClick: _, onQuotedTweetAvatarClick: m, onQuotedTweetScreenNameClick: w, preventVideoPlayback: g, promotedContent: C, quoteTweetSocialContextProps: b, quotedTweetTombstoneInfo: T, tweet: f, withAltTextBadge: v, withCardLinks: y, withCondensedQuoteTweet: k, withHalvedMediaSize: E, withInlineMedia: x, withReaderModeActive: S, withUserHoverCard: Z } = this.props,
                        I = a ? "DETAIL" : "TIMELINE",
                    ...
                    return { onGrokClick: this._onGrokClick, cardCacheLocationKey: I, displayMediaMetadata: a, enableKeyboardShortcuts: t, forwardPivotInfo: f.softIntervention || i, inlineCalloutInfo: n, innerForwardPivotInfo: o, innerNudges: s, isMediaMaxHeightEnabled: R, loggedInUserId: this.context.viewerUserId, mediaAltTranslations: this.state.mediaAltTranslations, mediaCacheLocationKey: I, nudges: c, onCardLinkClick: h, onMediaClick: u, onQuoteTweetClick: p, onQuoteTweetMediaClick: _, onQuotedTweetAvatarClick: m, onQuotedTweetScreenNameClick: w, preventVideoPlayback: g, promotedContent: C, quoteTweetSocialContextProps: b, quotedTweetTombstoneInfo: T, showAltTranslation: this.state.showTranslation, singleImageMaxAspectRatio: rt, style: At.richContent, tweet: f, withActionsDisabled: F, withAltTextBadge: v, withCardLinks: y, withCenterCrop: !0, withHalvedMediaSize: E, withMediaTagsIcon: a, withQuoteTweetBirdwatchPivot: !0, withQuoteTweetHeaderLinks: !1, withQuoteTweetLink: l, withQuoteTweetMedia: x, withRoundMediaCorners: B, withTweetMedia: x, withUserHoverCard: Z, quoteTweetSingleImageMinAspectRatio: ot, renderQuoteTweetTombstone: (e) => r.createElement(qe.Z, e), singleImageMinAspectRatio: a ? 0.1 : ot, withCondensedQuoteTweet: (!a && d.Z.hasMedia(M, !x)) || !!k, filterOutInlineMedia: a || S, renderPrerollActionMenu: this._getPrerollActionMenuRenderer({}), renderJetfuelFrame: this._renderJetfuelFrame() };
                }
            ...
            (Pt.contextType = te.rC), (Pt.displayName = "Tweet"), (Pt.defaultProps = { displayBlocked: !1, isFocal: !1, linkify: !0, onBirdwatchNotesIconClick: X.Z, onModeratedIconClick: X.Z, onModeratedIconShown: X.Z, replyContext: W.ZP.ReplyContextTypes.Isolated, withActions: !1, withAltTextBadge: !1, withAvatarLink: !0, withBirdwatchPivots: !0, withCardLinks: !1, withInlineMedia: !0, withQuotedTweetLinks: !1, withRemoveFromBookmarks: !1, withSocialContext: !1, withTimestampLink: !0, withUserHoverCard: !0, withUserAvatar: !0, withUserName: !0, withTimestamp: !0 });
            ...
            function Bt(e) {
                ...
                return r.createElement(a.Z, { style: At.askGrokPromo }, r.createElement(ce.D, { id: "grok_post_atgrok_button", onFullyVisible: n, position: "bottom", testID: "grok_post_atgrok_button" }), r.createElement(x.ZP, { icon: r.createElement(ne.x1, null), link: "/i/grok", onClick: i, type: "primaryFilled" }, St));
            }
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-757f3ab2.8c1ed27a.js.map
