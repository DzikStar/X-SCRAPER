    ...
    ["shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a", "bundle.DirectMessages-6ac0f1a5"],
    {
        ...
        654917: (e, t, n) => {
            ...
            function h() {
                ...
                return { messageIds: o, access: E, status: v, grokSettingsStatus: x, conversationKey: t, conversationId: w, analysisEntityId: C, accessRestrictedReasons: y, fetchConversationIdStatus: h, fetchConversationIdError: g, mode: _, model: b, changeMode: O, changeModel: J, usingExperiment: S };
            }
        },
        979512: (e, t, n) => {
            n.d(t, { Z: () => M });
                ...
                return {
                    openGrok: a.useCallback(
                        async ({ autoSubmit: e, conversationId: a, imageUrl: o, isDeepsearch: d, isImageEdit: u, isReasoning: p, mediaId: m, promptMetadata: f, source: h, text: g }) => {
                            ...
                            const O = {};
                            if ((("post_image_annotation" !== h && "post_image_annotation_fullscreen" !== h) || ((O.imageGen = !0), (0, S.u1)(t, "post_image_annotation_fullscreen" === h, m)), "grok_image_feed" === h && (O.imageGen = !0), c.pathname.startsWith("/i/grok") && !c.pathname.startsWith("/i/grok/feed"))) return void i((0, y.u)({ analytics: t, conversationKey: R })({ text: g, attachments: I ? [I] : void 0, mode: k.IK.REGULAR, returnCitations: M, promptMetadata: f, imageGenerationCount: T, toolOverrides: O, source: h, isDeepsearch: d, isReasoning: p }));
                            const J = a ?? s()();
                            if (a) {
                                const e = a || "";
                                await i((0, w.d)(e, t));
                            } else i((0, x.Ki)(J));
                            if ((F && P ? ((0, S.YW)(t, h), U && i(_.bi(v.S.COLLAPSED)), i((0, b.bi)(C.j.EXPANDED))) : A.push("/i/grok"), e)) i((0, y.u)({ analytics: t, conversationKey: J })({ text: g, attachments: I ? [I] : void 0, mode: k.IK.REGULAR, promptMetadata: f, returnCitations: M, imageGenerationCount: T, toolOverrides: O, source: h, isDeepsearch: d, isReasoning: p }));
                            else {
        ...
        623494: (e, t, n) => {
            n.d(t, { DE: () => f, G$: () => r, HO: () => E, HR: () => Z, JO: () => _, Jm: () => C, NH: () => M, RC: () => g, S7: () => J, UV: () => F, Uk: () => k, YI: () => d, YW: () => O, ZY: () => h, az: () => c, c3: () => s, dP: () => x, dd: () => m, eS: () => b, eV: () => S, hf: () => v, hq: () => l, kl: () => y, mm: () => p, op: () => w, pv: () => i, qQ: () => A, u1: () => I, y6: () => u, zC: () => R, zX: () => P });
            var a = n(163889);
            function o() {
            ...
            function E(e, t) {
                N(e)({ element: "grok-post-analyze", action: "start", data: { event_source: t ? "post_details" : "timeline" } });
            }
            function I(e, t, n) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a.a6209f1a.js.map
