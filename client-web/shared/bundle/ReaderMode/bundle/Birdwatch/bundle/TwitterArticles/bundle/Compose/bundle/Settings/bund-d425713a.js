...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ...
    {
        187268: (e, t, a) => {
            a.d(t, { Ez: () => v, QK: () => w, Sd: () => y, eC: () => k, j: () => b, jU: () => S, ky: () => h, w$: () => C });
            ...
            function b(e) {
                switch (e.name) {
                    ...
                    case h.BrowsePage: {
                        ...
                        return e.args.query ? m.uk.GenericURLQueryFormatter({ url: t, query: e.args.query }) : m.uk.BrowsePageFormatter({ url: t });
                    }
            ...
            function C(e, t) {
                ...
                switch (e) {
                    ...
                    default:
                        return n.createElement(p.default, a);
                }
            }
        },
        14544: (e, t, a) => {
            ...
            const c = (e) => {
                ...
                return n.createElement(r.Z, { onMouseUp: a }, e.children, n.createElement(s.Z, { onMouseUpRef: t }));
            };
            function l(e) {
                const t = (0, o.QZ)();
                return t.featureSwitches.isTrue("responsive_web_grok_text_selection_enabled") && (0, i.$)(t) ? n.createElement(c, null, e.children) : e.children;
            }
        },
        620988: (e, t, a) => {
        ...
        654917: (e, t, a) => {
            ...
            function _() {
                ...
                const U = n.useCallback(
                        async (e, t) => {
                            g !== e && (s(a.setMode(e)), o.ZP.isTwitterApp() || (await s((0, d.O)(e, b))), (0, p.RC)(t, e));
                        },
                        [s, a, g, b],
                    ),
                    I = n.useCallback(
                        async (e, t, a) => {
                            e !== b && (s((0, u.j1)(e, t)), o.ZP.isTwitterApp() || (await s((0, d.O)(g, e))), (0, p.JO)(a, e));
                        },
                        [s, g, b],
                    );
                return { messageIds: r, access: E, status: x, grokSettingsStatus: v, conversationKey: t, conversationId: w, analysisEntityId: S, accessRestrictedReasons: y, fetchConversationIdStatus: _, fetchConversationIdError: f, mode: g, model: b, changeMode: U, changeModel: I, usingExperiment: C };
            }
        },
        979512: (e, t, a) => {
            a.d(t, { Z: () => O });
            ...
            function O() {
                const e = n.useContext(h.ge),
                    ...
                    { conversationKey: P } = (0, U.ZP)(),
                    J = (0, d.cm)(),
                    R = !c.pathname.startsWith("/messages") && !c.pathname.match(".*/status/.+/photo/.+") && !c.pathname.startsWith("/i/grok/feed"),
                    W = (0, r.useHistory)(),
                    Z = (0, F.k)(),
                    M = (0, I.Z)("drawer"),
                ...
                return {
                    openGrok: n.useCallback(
                        async ({ autoSubmit: e, conversationId: n, imageUrl: r, isDeepsearch: u, isImageEdit: d, isReasoning: p, mediaId: m, promptMetadata: h, source: _, text: f }) => {
                            if (!(0, E.$)(a)) return void W.push("/i/grok");
                            let F;
                            if ((("post_analysis_timeline" !== _ && "post_analysis_details_page" !== _) || (0, C.HO)(t, "post_analysis_details_page" === _), r))
                                try {
                                    const e = await (0, l.o2)(r);
                                    F = await Z(e, new AbortController());
                                } catch (e) {
                                    i({ text: X });
                                }
                            const U = {};
                            if ((("post_image_annotation" !== _ && "post_image_annotation_fullscreen" !== _) || ((U.imageGen = !0), (0, C.u1)(t, "post_image_annotation_fullscreen" === _, m)), "grok_image_feed" === _ && (U.imageGen = !0), c.pathname.startsWith("/i/grok") && !c.pathname.startsWith("/i/grok/feed"))) return void o((0, y.u)({ analytics: t, conversationKey: P })({ text: f, attachments: F ? [F] : void 0, mode: k.IK.REGULAR, returnCitations: O, promptMetadata: h, imageGenerationCount: M, toolOverrides: U, source: _, isDeepsearch: u, isReasoning: p }));
                            const I = n ?? s()();
                            if (n) {
                                const e = n || "";
                                await o((0, w.d)(e, t));
                            } else o((0, v.Ki)(I));
                            if ((J && R ? ((0, C.YW)(t, _), T && o(g.bi(x.S.COLLAPSED)), o((0, b.bi)(S.j.EXPANDED))) : W.push("/i/grok"), e)) o((0, y.u)({ analytics: t, conversationKey: I })({ text: f, attachments: F ? [F] : void 0, mode: k.IK.REGULAR, promptMetadata: h, returnCitations: O, imageGenerationCount: M, toolOverrides: U, source: _, isDeepsearch: u, isReasoning: p }));
                            else {
                                const e = { text: f, attachments: F ? [F] : [] };
                                d && F ? (e.modeButtonFilterKey = "ImageEdit") : u ? (e.modeButtonFilterKey = "Research") : p && (e.modeButtonFilterKey = "Reasoning"), o((0, v.Uo)(I, e));
                            }
                        },
                        [T, i, o, t, a, W, Z, J, P, O, R, c.pathname, M],
                    ),
                };
            }
        },
        ...
        623494: (e, t, a) => {
            a.d(t, { DE: () => h, G$: () => i, HO: () => E, HR: () => X, JO: () => g, Jm: () => S, NH: () => O, RC: () => f, S7: () => I, UV: () => J, Uk: () => k, YI: () => u, YW: () => U, ZY: () => _, az: () => c, c3: () => s, dP: () => v, dd: () => m, eS: () => b, eV: () => C, hf: () => x, hq: () => l, kl: () => y, mm: () => p, op: () => w, pv: () => o, qQ: () => W, u1: () => F, y6: () => d, zC: () => P, zX: () => R });
            var n = a(163889);
            function r() {
                return `online:${window.navigator.onLine}|effectiveType:${window.navigator.connection?.effectiveType ?? "unknown"}`;
            }
            function o(e, t) {
                Z(e)({ element: "api-add-response", action: "start", data: { event_info: JSON.stringify(t) } });
            }
            function s(e, t) {
                Z(e)({ element: "api-add-response-regenerate", action: "start", data: { event_info: JSON.stringify(t) } });
            }
            function i(e, t) {
                Z(e)({ element: "selected-side-by-side", action: "click", data: { event_info: JSON.stringify(t) } });
            }
            function c(e, t, a) {
                Z(e)({ element: "client-home-log", action: t, data: { event_info: JSON.stringify(a) } });
            }
            function l(e, t) {
                Z(e)({ element: "deepsearch-premature-stream-close-log", action: "error", data: { event_info: JSON.stringify({ errorMessage: t.errorMessage }), duration_ms: t.durationMs } });
            }
            function u(e, t) {
                Z(e)({ element: "deepsearch-premature-manual-stream-stop", action: "click", data: { event_info: JSON.stringify(t.messageTagCounts), duration_ms: t.durationMs } });
            }
            function d(e, t) {
                Z(e)({ element: "deepsearch-duration", action: "complete", data: { duration_ms: t } });
            }
            function p(e, t, a) {
                Z(e)({ element: "api-add-response-retry", action: "start", data: { event_info: JSON.stringify({ numRetriesExecuted: t, error: a }) } });
            }
            function m(e, t) {
                Z(e)({ element: "api-add-response-edit", action: "start", data: { event_info: JSON.stringify(t) } });
            }
            function h(e) {
            ...
            function f(e, t) {
                Z(e)({ element: "grok_mode", action: "change", data: { event_info: t } });
            }
            function g(e, t) {
                Z(e)({ element: "grok_model", action: "change", data: { event_info: t } });
            }
            function x(e, t) {
                Z(e)({ element: "tweet-carousel", action: "change", data: { event_info: t.toString() } });
            }
            function v(e, t) {
                Z(e)({ element: "file-attachment", action: "add", data: { event_info: t } });
            }
            function w(e, t) {
                Z(e)({ element: "file-attachment", action: "fail", data: { event_info: t } });
            }
            function y(e, t, a) {
                Z(e)({ element: "api-add-response", action: "error", data: { event_info: `${t.message}\n${t.stack}\n${r()}` } }), (0, n.Hj)(t, { level: "warning", extra: a });
            }
            function k(e, t) {
                Z(e)({ element: "api-add-response", action: "fail", data: { event_info: `${t}\n${r()}` } });
            }
            function b(e, t) {
                Z(e)({ element: "response-chunk-read", action: "timer_elapsed", data: { event_info: t ? "first_chunk" : void 0 } });
            }
            function S(e) {
                Z(e)({ element: "file-upload", action: "success" });
            }
            function C(e, t) {
                Z(e)({ element: "file-upload", action: "fail", data: { event_info: t } });
            }
            function E(e, t) {
                Z(e)({ element: "grok_post_analysis_button", action: "click", data: { event_source: t ? "post_details" : "timeline" } });
            }
            function F(e, t, a) {
                Z(e)({ element: "grok-post-image-annotation", action: "start", data: { event_source: t ? "post_details" : "timeline", event_info: a ? JSON.stringify({ mediaId: a }) : void 0 } });
            }
            function U(e, t) {
                Z(e)({ element: "grok-drawer-open", action: "success", data: { event_source: t } });
            }
            function I(e, t) {
                Z(e)({ element: "grok-card-attachment", action: "show", data: { event_info: JSON.stringify({ cardType: t.cardType, variant: t.variant }) } });
            }
            function X(e, t, a) {
                Z(e)({ element: "grok-card-attachment-follow-up", action: "send", data: { event_info: JSON.stringify({ cardType: t.cardType, variant: t.variant, followUpText: a }) } });
            }
            function O(e) {
                Z(e)({ element: "open-grok-memory-drawer", action: "start", data: {} });
            }
            function P(e, t) {
                Z(e)({ element: "grok-memory-detail", action: "click", data: { event_info: t } });
            }
            function J(e, t) {
                Z(e)({ element: "grok-memory-forget", action: "click", data: { event_info: t } });
            }
            function R(e, t, a) {
                Z(e)({ element: "grok-memory-forget", action: "error", data: { event_info: JSON.stringify({ conversationId: t, error: a }) } });
            }
            function W(e, t) {
                Z(e)({ element: "grok-memory-detail", action: "click", data: { event_info: t } });
            }
        ...
        545389: (e, t, a) => {
            a.d(t, { Z: () => n });
            const n = ({ featureSwitches: e, isOwnPost: t, isPremium: a, surface: n, tweet: o }) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-d425713a.2a70dd3a.js.map
