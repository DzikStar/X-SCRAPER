        ...
        574663: (e, t, a) => {
            ...
            function $(e) {
                ...
                const G = () => {
                    ...
                    z = n.createElement(s.RD.Consumer, null, ({ direction: e }) => ("loading" === L ? n.createElement(o.ZP, { align: "center", color: "link", dir: e, size: "subtext2", style: [R.callout, "top" === _ && R.calloutOnTop, y] }, Z, n.createElement(o.ZP, { color: "link", onClick: G, role: "button" }, h.B), n.createElement(i.Z, { size: 13, style: R.loading })) : "failed" === L ? n.createElement(o.ZP, { align: "center", color: "gray700", dir: e, size: "subtext2", style: [R.callout, "top" === _ && R.calloutOnTop, y] }, Z, h.k7, " ", b && n.createElement(o.ZP, { color: "link", onClick: I, role: "button" }, h.so)) : "loaded" === L ? n.createElement(o.ZP, { align: "center", color: "gray700", dir: e, size: "subtext2", style: [R.callout, "top" === _ && R.calloutOnTop, y] }, Z, "auto" === S ? h.gz : h.li, d && n.createElement(o.ZP, { color: "link", onClick: G, role: "button", style: R.toggle, withInteractiveStyling: !0 }, h.eE), f && A) : null != E ? n.createElement(o.ZP, { "aria-expanded": !1, color: "link", size: "subtext2", style: [R.callout, "top" === _ && R.calloutOnTop, y], withInteractiveStyling: !0 }, Z, n.createElement(o.ZP, { color: "link", onClick: C, role: "button" }, E), f && A) : void 0));
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.ReaderMode~bundle.Birdwatch~bundle.TwitterArticles~bundle.Compose~bundle.Settings~bund-e75d887d.1f69d9ba.js.map
