...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.SettingsExtendedProfile~bundle.WorkHistory~bundle.JobSearch~ondemand.Verified~bundle.UserJobs~b", "icons/IconBulletedList-js"],
    {
        949626: (e, n, t) => {
            t.d(n, { Z: () => r });
            t(202784);
        ...
        779802: (e, n, t) => {
            t.d(n, { $u: () => z, Ak: () => I, KJ: () => D, LI: () => x, P7: () => b, PW: () => S, QF: () => p, Qm: () => y, Tr: () => v, b$: () => g, db: () => T, et: () => w, fR: () => h, iH: () => E, lD: () => $, su: () => k, u4: () => H, wX: () => P });
            var o = t(202784),
                r = t(111677),
                l = t.n(r),
                i = t(394123),
            ...
            const h = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                y = "LINK",
                D = (e) => [{ buttonTestId: "btn-link", Icon: m.default, key: y, onPress: e }],
                k = (e, n) => (t) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.SettingsExtendedProfile~bundle.WorkHistory~bundle.JobSearch~ondemand.Verified~bundle.UserJobs~b.8a9b37fa.js.map
