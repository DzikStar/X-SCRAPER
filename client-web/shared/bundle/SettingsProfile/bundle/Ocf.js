...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.SettingsProfile~bundle.Ocf", "loader.MediaPickerWithPreview", "icons/IconCropWide-js", "icons/IconEye-js", "icons/IconSearchPlusStroke-js"],
    {
        625661: (e, t, i) => {
            i.d(t, { ZP: () => p });
            var o = i(202784),
            ...
            class p extends o.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: i, fixed: n, hideBackButton: a, isFullWidth: r, isLarge: c, leftControl: d, middleControl: p, position: u, rightControl: m, secondaryBar: g, style: _, subtitle: E, title: f, titleDomId: y, titleIconCell: b, titleIconCellSize: v, withBackground: S, withWideContainer: C } = this.props,
                        { isModal: w } = this.context,
                        P = a ? d : o.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        R = (function (e, t, i) {
                            return e && !(t && i);
                        })(!!S, w, !!g);
                    return o.createElement(o.Fragment, null, o.createElement(l.Z, { centerTitle: t, centeredLogo: i, isFullWidth: r, isLarge: c, leftControl: P, middleControl: p, position: h(u, w, n), rightControl: m, style: _, subtitle: E, title: f, titleDomId: y, titleIconCell: b, titleIconCellSize: v, withBackground: R, withWideContainer: C }), g || null);
                }
                render() {
            ...
            class v extends o.Component {
                render() {
                    const { borderRadius: e, description: t, innerStyle: i, maskStyle: s, mediaItem: l, onAddMediaFiles: c, onCrop: d, onRemove: h, rootStyle: p, withDragDrop: u } = this.props,
                        m = l && !l.uploader,
                        g = o.createElement(o.Fragment, null, this._renderPreview(), m ? null : o.createElement(o.Fragment, null, o.createElement(n.Z, { style: [C.mask, s, S[e]] }), o.createElement(n.Z, { style: [C.overlaidContent, i] }, o.createElement(n.Z, { style: C.buttonsContainer }, this._renderMediaEdit(), d ? this._renderMediaCrop() : null, h ? this._renderMediaRemove() : null), t ? o.createElement(a.ZP, { align: "center", color: "gray700", size: "subtext1", style: C.description }, t) : null)));
                    return o.createElement(n.Z, { style: [C.container, p, S[e]] }, u && c ? o.createElement(r.ZP, { onFilesAdded: c, style: [C.dragDropContainer, S[e]] }, g) : g);
                }
                _renderMediaRemove() {
                    const { onRemove: e } = this.props;
                    return o.createElement(s.ZP, { "aria-label": f, hoverLabel: { label: f }, icon: o.createElement(u.default, null), onPress: e, size: "large", style: C.buttonLeftPadding, type: "onMediaDominantColorFilled" });
                }
                _renderMediaCrop() {
                    const { onCrop: e } = this.props;
                    return o.createElement(s.ZP, { "aria-label": y, icon: o.createElement(m.default, null), onPress: e, size: "large", style: C.buttonLeftPadding, type: "onMediaDominantColorFilled" });
                }
                _renderMediaEdit() {
                    const { acceptGifs: e, acceptVideo: t, "aria-label": i, icon: n, multiple: a, onAddMediaFiles: r, onEdit: l } = this.props;
                    return r ? o.createElement(g.Z, { acceptGifs: e, acceptVideo: t, "aria-label": i, icon: n, multiple: a, onChange: r, size: "large", style: C.mediaPicker, type: "onMediaDominantColorFilled" }) : o.createElement(s.ZP, { "aria-label": i, icon: n, onPress: l, size: "large", type: "onMediaDominantColorFilled" });
                }
                _renderPreview() {
                    const { aspectRatio: e, borderRadius: t, currentContent: i, mediaItem: n } = this.props;
                    return n ? o.createElement(l.Z, { ratio: e }, o.createElement(_.Z, { borderRadius: t, enableGif: !1, mediaItem: n, style: C.mediaPreview, withCloseButton: !1 })) : i;
                }
            }
            v.defaultProps = { acceptGifs: !1, acceptVideo: !1, aspectRatio: 1, borderRadius: E.A.NONE, icon: b };
            const S = c.default.create((e) => ({ infinite: { borderRadius: e.borderRadii.infinite }, medium: { borderRadius: e.borderRadii.small }, none: { borderRadius: e.borderRadii.none } })),
        ...
        980407: (e, t, i) => {
            ...
            class u extends o.Component {
                constructor(...e) {
                    super(...e),
                        (this._renderChildViewAppBar = () => {
                            const { appBarRef: e, appBarStyle: t, backButtonType: i, backLocation: a, centerTitle: r, hideBackButton: s, history: l, isFullWidth: h, isLarge: p, middleControl: u, onBackClick: g, rightControl: _, secondaryBar: E, subtitle: f, title: y } = this.props,
                                { isModal: b } = this.context;
                            return o.createElement(n.Z, { style: b ? [m.childViewAppBarRoot, m.appBarZindex] : m.appBarZindex }, o.createElement(d.ZP, { backButtonType: i || (b ? "close" : "back"), backLocation: a, centerTitle: r, fixed: !b, hideBackButton: s, history: l, isFullWidth: h, isLarge: p, middleControl: u, onBackClick: g, ref: e, rightControl: _, secondaryBar: E, style: [b && m.appBarModal, t], subtitle: f, title: y, titleDomId: c.Q_ }));
                        }),
                ...
                render() {
                    const { "aria-hidden": e, bottomBar: t, children: i, containerStyle: r, documentTitle: s, isFullWidth: c, isLarge: d, renderHeader: u, title: g, withoutBottomBarMobile: _ } = this.props,
                        { isModal: E } = this.context,
                        f = u ? u(this._renderChildViewAppBar()) : this._renderChildViewAppBar();
                    return o.createElement(l.Z, null, o.createElement(h.Z.Configure, { documentTitle: s, headerless: !0, title: g }), o.createElement(n.Z, { "aria-hidden": e, onLayout: this._handleLayout, style: [m.root, E && m.rootModal] }, !E && f, o.createElement(a.Z, { isFullWidth: c, isLarge: d, style: [m.container, E && m.containerModal, r] }, E ? o.createElement(p.Z, { style: m.viewport }, f, i) : i), t ? o.createElement(n.Z, { style: [m.bottomBarModal, !E && !_ && m.bottomBarMobile] }, o.createElement(a.Z, { isFullWidth: c, isLarge: d }, t)) : null));
                }
            }
        ...
        873637: (e, t, i) => {
            ...
            class m extends n.Component {
                ...
                render() {
                    return this.state.orientedImage ? this._renderCropper() : n.createElement(r.Z, { "aria-label": u, style: g.activityIndicator });
                }
                _renderCropper() {
                    const { cropperRef: e, defaultAspectRatio: t, defaultCropData: i, media: o, withAspectRatioOptions: r, withZoomControl: l } = this.props,
                        ...
                        { cropData: d, originalMediaFile: h = {} } = o || {};
                    return c ? n.createElement(a.Z, { style: g.cropper }, n.createElement(s.Z, { circle: this.props.circle, defaultAspectRatio: (i && i.aspectRatio) || (d && d.aspectRatio) || t, defaultCropData: i || d, image: { src: c.url, width: h.width, height: h.height }, ref: e, withAspectRatioOptions: r, withZoomControl: l })) : null;
                }
            }
            const g = l.default.create((e) => ({ cropper: { backgroundColor: e.colors.navigationBackground, flexGrow: 1 }, activityIndicator: { flexGrow: 1 } })),
                _ = n.forwardRef((e, t) => n.createElement(m, (0, o.Z)({}, e, { cropperRef: t })));
        },
        330815: (e, t, i) => {
            i.d(t, { Z: () => w });
            var o = i(202784),
            ...
            class y extends o.Component {
                constructor(e) {
                    super(e),
                        ...
                        (this._renderAppBarRightControl = () => {
                            ...
                            return o.createElement(a.ZP, { disabled: e, onPress: this._handleApplyButtonClick, size: "small", testID: _, type: "primaryFilled" }, f);
                        }),
                        (this._handleBackClick = () => {
                ...
                render() {
                    const { defaultAspectRatio: e, history: t, title: i, withAspectRatioOptions: n, withZoomControl: a } = this.props,
                        r = this._getMedia();
                    return o.createElement(c.Z, { backButtonType: "back", containerStyle: b.root, documentTitle: i || E, history: t, onBackClick: this._handleBackClick, rightControl: this._renderAppBarRightControl(), title: i || E }, o.createElement(d.Z, { defaultAspectRatio: e, media: r, ref: this._cropper, withAspectRatioOptions: n, withZoomControl: a }));
                }
            }
            const b = n.default.create((e) => ({ root: { flexShrink: 1, height: 650 } })),
                v = g(y);
            var S = i(757700);
            const C = n.default.create((e) => ({ modal: { width: 600, maxWidth: "90vw" } })),
                w = (e) => o.createElement(S.ZP, { clickMaskToClose: !1, modalSize: "fitChildren", style: C.modal }, o.createElement(v, e));
        },
        199127: (e, t, i) => {
            ...
            class c extends o.Component {
                ...
                render() {
                    const { acceptGifs: e, acceptVideo: t, "aria-label": i, aspectRatio: a, borderRadius: r, currentContent: s, description: l, innerStyle: c, maskStyle: d, mediaItem: h, onCrop: p, onRemove: u, rootStyle: m } = this.props;
                    return o.createElement(n.Z, { acceptGifs: e, acceptVideo: t, "aria-label": i, aspectRatio: a, borderRadius: r, currentContent: s, description: l, innerStyle: c, maskStyle: d, mediaItem: h, onAddMediaFiles: this._handleAddMediaFiles, onCrop: p, onRemove: u, rootStyle: m, withDragDrop: !0 });
                }
            }
        ...
        652904: (e, t, i) => {
            ...
            class c extends o.Component {
                ...
                componentDidUpdate(e) {
                    ...
                    const c = n || s;
                    ((c && n !== s) || (!c && i !== a) || o !== r || l) && this._performPageUpdates(this.props);
                }
                render() {
        ...
        508765: (e, t, i) => {
            i.d(t, { C6: () => y, GJ: () => N, HR: () => A, Il: () => D, NJ: () => I, OG: () => V, T_: () => U, Xw: () => P, Ys: () => k, _D: () => C, b4: () => O, ck: () => T, g3: () => Z, o8: () => x, u$: () => v, vW: () => b });
            var o = i(226395),
                n = i(499627),
                a = i(917799),
                r = i(56519),
            ...
            const l = `${i(291020).Y}/profile`,
                c = `rweb/${l}`,
                d = a.dg(c, "REMOVE_PROFILE_BANNER"),
                h = a.dg(c, "UPDATE_PROFILE"),
                p = a.dg(c, "UPDATE_PROFILE_AVATAR"),
                u = a.dg(c, "UPDATE_PROFILE_BANNER"),
                m = a.dg(c, "UPLOAD_MEDIA"),
                g = Object.freeze({ REQUEST: "rweb/settings/profile/ENABLE_VERIFIED_PHONE_LABEL_REQUEST", SUCCESS: "rweb/settings/profile/ENABLE_VERIFIED_PHONE_LABEL_SUCCESS", FAILURE: "rweb/settings/profile/ENABLE_VERIFIED_PHONE_LABEL_FAILURE" }),
                _ = Object.freeze({ REQUEST: "rweb/settings/profile/DISABLE_VERIFIED_PHONE_LABEL_REQUEST", SUCCESS: "rweb/settings/profile/DISABLE_VERIFIED_PHONE_LABEL_SUCCESS", FAILURE: "rweb/settings/profile/DISABLE_VERIFIED_PHONE_LABEL_FAILURE" }),
            ...
            const y = (e) => e[l].avatarMediaId,
                ...
                v = (e) => e[l].profileSettings,
                S = "rweb/settings/profile/ADD_AVATAR_MEDIA",
                C = (e) => ({ meta: { mediaId: e }, type: S }),
                ...
                x =
                    (e) =>
                    (t, i, { api: n }) =>
                        a._O(t, { params: e, request: n.withEndpoint(o.Z).removeProfileBanner })({ actionTypes: d, context: "ACTION_REMOVE_USER_BANNER" }, (e) => {
                    ...
                    (n, l, { api: c }) => {
                        ...
                        return n(d).then(
                            ([o]) => {
                                ...
                                return a._O(n, { params: { media_id: o.uploadId }, request: i(c) })({ actionTypes: h, context: t }, (e) => {
                ...
                V =
                    () =>
                    (e, t, { api: i }) =>
                        a._O(e, { request: i.withEndpoint(o.Z).enableVerifiedPhoneLabel, params: {} })({ actionTypes: g, context: "ACTION_ENABLE_VERIFIED_PHONE_LABEL" }),
                N =
                    () =>
                    (e, t, { api: i }) =>
                        a._O(e, { request: i.withEndpoint(o.Z).disableVerifiedPhoneLabel, params: {} })({ actionTypes: _, context: "ACTION_DISABLE_VERIFIED_PHONE_LABEL" });
            n.Z.register({
                [l]: function (e = f, t) {
                    if (!t) return e;
                    switch (t.type) {
        ...
        548485: (e, t, i) => {
            ...
            const b = f.default.create((e) => ({ mask: { backgroundColor: "transparent", borderWidth: e.spaces.space4, borderColor: e.colors.primary, boxShadow: `0 0 0 9999px ${e.colors.activeFaintGray}` }, circle: { borderRadius: e.borderRadii.infinite } })),
                v = ({ circle: e, height: t, width: i }) => o.createElement(a.Z, { pointerEvents: "none", style: [b.mask, { width: i, height: t }, e && b.circle] });
            var S = i(807896),
                C = i(452661),
                w = i(933895);
            class P extends o.Component {
                ...
                render() {
                    ...
                    return o.createElement(a.Z, (0, S.Z)({}, s, { onWheel: this._handleWheel, ref: this._setRef }, this._panResponder.panHandlers), this.props.children);
                }
            ...
            class x extends o.Component {
                constructor(e) {
                    ...
                    super(e),
                        ...
                        (this._renderControls = () => {
                            ...
                            return t || r ? o.createElement(a.Z, { style: T.controlsContainer }, t ? o.createElement(a.Z, { style: T.ratioContainer }, o.createElement(m.ZP, { "aria-label": M, borderColor: "transparent", color: i === n ? "primary" : "gray700", hoverLabel: { label: B }, icon: o.createElement(l.default, null), onPress: this._setAspectRatio(n), size: "medium" }), o.createElement(m.ZP, { "aria-label": A, borderColor: "transparent", color: i === 16 / 9 ? "primary" : "gray700", hoverLabel: { label: Z }, icon: o.createElement(c.default, null), onPress: this._setAspectRatio(16 / 9), size: "medium" }), o.createElement(m.ZP, { "aria-label": D, borderColor: "transparent", color: 1 === i ? "primary" : "gray700", hoverLabel: { label: L }, icon: o.createElement(d.default, null), onPress: this._setAspectRatio(1), size: "medium" })) : null, r ? o.createElement(a.Z, { style: T.zoomContainer }, o.createElement(E.Z, { "aria-label": I, max: this._maxScale, maxIcon: o.createElement(h.default, { style: T.icon }), min: 0, minIcon: o.createElement(p.default, { style: T.icon }), onChange: this._handleScaleChange, step: "any", value: this.state.imageScale })) : null) : null;
                        }),
                        ...
                        (this._getImageDimensions = () => {
                            const { imageScale: e } = this.state,
                                ...
                                { height: n, width: a } = _.Z.getCoverDimensions({ width: o, height: i }, t);
                        ...
                        (this._getMaskDimensions = () => {
                            const { aspectRatio: e, containerHeight: t, containerWidth: i } = this.state,
                                { height: o, width: n } = _.Z.getContainDimensions({ width: i - 50, height: t - 50 }, e);
                ...
                render() {
                    ...
                    return o.createElement(a.Z, { style: T.container }, o.createElement(R, { onLayout: this._handleLayout, onPanEnd: this._handlePanEnd, onPanMove: this._handlePanMove, onPinchMove: i ? this._handlePinchMove : void 0, onWheel: i ? this._handleWheel : void 0, style: T.root }, d ? o.createElement(o.Fragment, null, o.createElement(g.Z, { source: { uri: t.src, width: s, height: r }, style: [T.image, n] }), o.createElement(v, { circle: e, height: l, width: c })) : null), d ? this._renderControls() : null);
                }
        ...
        779610: (e, t, i) => {
            ...
            var o = i(202784),
                ...
                c = i(392237);
            const d = (e) => {
                    const { decoration: t, description: i, disabled: d = !1, isActive: p = !1, label: u, link: m, onPress: g, paddingHorizontal: _, renderRightContent: E, role: f = "tab", styleOverride: y, testID: b = "pivot", thumbnail: v, thumbnailSize: S, withoutArrow: C = !1 } = e,
                        w = [h.thumbnailContainer, "medium" === S && h.thumbnailContainerMedium],
                        ...
                        M = o.useMemo(() => ("space0" === _ ? { paddingHorizontal: 0 } : { paddingHorizontal: _ ? c.default.theme.spaces[_] : c.default.theme.componentDimensions.gutterHorizontal }), [_]);
                    return o.createElement(l.Z, { "aria-selected": "tab" === f ? p : null, disabled: d, link: d ? void 0 : m, onPress: g, role: f, style: [h.root, M, d && h.disabled, y], testID: b, withInteractiveStyling: !!m || !!g }, o.createElement(n.Z, { style: h.contentContainer }, v ? o.createElement(n.Z, { style: w }, v) : null, o.createElement(n.Z, { style: h.content }, P, I), E ? E() : null, (!m && !g) || d || C ? null : R ? o.createElement(a.default, { style: h.icon }) : o.createElement(r.default, { style: h.icon })), t);
                },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.SettingsProfile~bundle.Ocf.dc56b45a.js.map
