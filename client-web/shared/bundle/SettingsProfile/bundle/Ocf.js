...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.SettingsProfile~bundle.Ocf", "loader.MediaPickerWithPreview", "icons/IconCameraPlusStroke-js", "icons/IconChevronRight-js", "icons/IconSearchPlusStroke-js"],
    {
        625661: (e, t, i) => {
            i.d(t, { ZP: () => p });
            var o = i(202784),
            ...
            class p extends o.Component {
                ...
                _renderContent() {
                    const { backButtonType: e, centerTitle: t, centeredLogo: i, fixed: n, hideBackButton: a, isFullWidth: r, isLarge: c, leftControl: d, middleControl: p, position: u, rightControl: m, secondaryBar: g, style: _, subtitle: E, title: f, titleDomId: y, titleIconCell: b, titleIconCellSize: S, withBackground: C, withWideContainer: v } = this.props,
                        { isModal: w } = this.context,
                        P = a ? d : o.createElement(s.Z, { backButtonType: e, onClick: this._handleBackClick }),
                        R = (function (e, t, i) {
                            return e && !(t && i);
                        })(!!C, w, !!g);
                    return o.createElement(o.Fragment, null, o.createElement(l.Z, { centerTitle: t, centeredLogo: i, isFullWidth: r, isLarge: c, leftControl: P, middleControl: p, position: h(u, w, n), rightControl: m, style: _, subtitle: E, title: f, titleDomId: y, titleIconCell: b, titleIconCellSize: S, withBackground: R, withWideContainer: v }), g || null);
                }
                render() {
            ...
            class S extends o.Component {
                render() {
                    const { borderRadius: e, description: t, innerStyle: i, maskStyle: s, mediaItem: l, onAddMediaFiles: c, onCrop: d, onRemove: h, rootStyle: p, withDragDrop: u } = this.props,
                        m = l && !l.uploader,
                        g = o.createElement(o.Fragment, null, this._renderPreview(), m ? null : o.createElement(o.Fragment, null, o.createElement(n.Z, { style: [v.mask, s, C[e]] }), o.createElement(n.Z, { style: [v.overlaidContent, i] }, o.createElement(n.Z, { style: v.buttonsContainer }, this._renderMediaEdit(), d ? this._renderMediaCrop() : null, h ? this._renderMediaRemove() : null), t ? o.createElement(a.ZP, { align: "center", color: "gray700", size: "subtext1", style: v.description }, t) : null)));
                    return o.createElement(n.Z, { style: [v.container, p, C[e]] }, u && c ? o.createElement(r.ZP, { onFilesAdded: c, style: [v.dragDropContainer, C[e]] }, g) : g);
                }
                _renderMediaRemove() {
                ...
                _renderMediaEdit() {
                    ...
                    return r ? o.createElement(g.Z, { acceptGifs: e, acceptVideo: t, "aria-label": i, icon: n, multiple: a, onChange: r, size: "large", style: v.mediaPicker, type: "onMediaDominantColorFilled" }) : o.createElement(s.ZP, { "aria-label": i, icon: n, onPress: l, size: "large", type: "onMediaDominantColorFilled" });
                }
                _renderPreview() {
                    const { aspectRatio: e, borderRadius: t, currentContent: i, mediaItem: n } = this.props;
                    return n ? o.createElement(l.Z, { ratio: e }, o.createElement(_.Z, { borderRadius: t, enableGif: !1, mediaItem: n, style: v.mediaPreview, withCloseButton: !1 })) : i;
                }
            }
            S.defaultProps = { acceptGifs: !1, acceptVideo: !1, aspectRatio: 1, borderRadius: E.A.NONE, icon: b };
            const C = c.default.create((e) => ({ infinite: { borderRadius: e.borderRadii.infinite }, medium: { borderRadius: e.borderRadii.small }, none: { borderRadius: e.borderRadii.none } })),
        ...
        508765: (e, t, i) => {
            i.d(t, { C6: () => y, GJ: () => N, HR: () => A, Il: () => D, NJ: () => I, OG: () => V, T_: () => U, Xw: () => P, Ys: () => k, _D: () => v, b4: () => O, ck: () => x, g3: () => Z, o8: () => T, u$: () => S, vW: () => b });
            var o = i(226395),
                n = i(499627),
                a = i(917799),
                r = i(56519),
        ...
        548485: (e, t, i) => {
            ...
            class T extends o.Component {
                ...
                render() {
                    ...
                    return o.createElement(a.Z, { style: x.container }, o.createElement(R, { onLayout: this._handleLayout, onPanEnd: this._handlePanEnd, onPanMove: this._handlePanMove, onPinchMove: i ? this._handlePinchMove : void 0, onWheel: i ? this._handleWheel : void 0, style: x.root }, d ? o.createElement(o.Fragment, null, o.createElement(g.Z, { source: { uri: t.src, width: s, height: r }, style: [x.image, n] }), o.createElement(S, { circle: e, height: l, width: c })) : null), d ? this._renderControls() : null);
                }
        ...
        779610: (e, t, i) => {
            ...
            var o = i(202784),
                ...
                c = i(392237);
            const d = (e) => {
                    const { decoration: t, description: i, disabled: d = !1, isActive: p = !1, label: u, link: m, onPress: g, paddingHorizontal: _, renderRightContent: E, role: f = "tab", styleOverride: y, testID: b = "pivot", thumbnail: S, thumbnailSize: C, withoutArrow: v = !1 } = e,
                    ...
                    return o.createElement(l.Z, { "aria-selected": "tab" === f ? p : null, disabled: d, link: d ? void 0 : m, onPress: g, role: f, style: [h.root, M, d && h.disabled, y], testID: b, withInteractiveStyling: !!m || !!g }, o.createElement(n.Z, { style: h.contentContainer }, S ? o.createElement(n.Z, { style: w }, S) : null, o.createElement(n.Z, { style: h.content }, P, I), E ? E() : null, (!m && !g) || d || v ? null : R ? o.createElement(a.default, { style: h.icon }) : o.createElement(r.default, { style: h.icon })), t);
                },
        ...
        58399: (e, t, i) => {
            ...
            const l = (e = {}) => {
                const t = o.useContext(r.Z),
                    { direction: i } = (0, a.Z)();
                return (0, n.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [s.Z.root, e.style, t && s.Z.iconRTL], viewBox: "0 0 24 24", children: o.createElement("g", null, o.createElement("path", { d: "M14.586 12L7.543 4.96l1.414-1.42L17.414 12l-8.457 8.46-1.414-1.42L14.586 12z" })) }, { writingDirection: i });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.SettingsProfile~bundle.Ocf.796d5e0a.js.map
