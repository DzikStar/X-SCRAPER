    ...
    ["shared~bundle.SettingsRevamp~bundle.SettingsTransparency", "icons/IconEye-js"],
    {
        ...
        609848: (e, t, r) => {
            ...
            var o = r(202784),
                ...
                v = r(673110);
            const Z = (0, _.Z)()
                    .propsFromState(() => ({ verifyPasswordFetchStatus: v.UD }))
                    .propsFromActions(() => ({ verifyPassword: v.Gv, createLocalApiErrorHandler: (0, E.zr)("PASSWORD_GATEWAY") })),
                k = u().fe36fe10,
                S = u().dec3c9b8,
                P = u().hccd9dbe,
                D = u().d1091f50,
                        ...
                        (this._handlePasswordSubmit = () => {
                            ...
                            "" !== r &&
                                t(r)
                                    ...
                                    .catch(e({ [m.ZP.InvalidCurrentPassword]: { customAction: () => this.setState({ passwordError: x }) }, showToast: !0 }));
                        }),
                        (this._makeFetch = () => {
            ...
            (I.contextType = b.rC), (I.defaultProps = { titleHeader: k });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.SettingsRevamp~bundle.SettingsTransparency.a57e427a.js.map
