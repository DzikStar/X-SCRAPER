...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.TV~bundle.Account-ddbcca7b"],
    {
        965612: (e, t, n) => {
            n.d(t, { Z: () => o });
            var r = n(202784);
        ...
        905346: (e, t, n) => {
            ...
            const R = ({ content: e, displayType: t, getSetPositionFn: n, handleNoriginArrowPress: o, name: i, onFocus: l, onFocusChild: u, onReady: w, onSelectVideo: v, playVideoPreview: y, title: b, videoCardStyle: R }) => {
                    const P = r.useRef(null),
                        _ = (0, c.Z)(i) || i,
                        F = (0, d.z)(),
                        Z = r.useMemo(() => e.filter((e) => !!e?.id_str), [e]),
                        z = r.useRef(Array(Z?.length).fill(null)),
                        { direction: A } = (0, k.Z)(),
                        M = "rtl" === A,
                        T = r.useCallback(
                            (e) => {
                                ...
                                switch (e.key) {
                                    case "ArrowLeft":
                                        r = M ? Math.min(t + 1, Z.length - 1) : Math.max(t - 1, 0);
                                        break;
                                    case "ArrowRight":
                                        r = M ? Math.max(t - 1, 0) : Math.min(t + 1, Z.length - 1);
                                        break;
                                    default:
                                        return !1;
                                }
                            ...
                            ({ index: e, item: n }) => {
                                ...
                                switch (t) {
                                    case g.Y.VIDEO:
                                        ...
                                        break;
                                    case g.Y.SHORT_VIDEO:
                                        i = r.createElement(h.e, { analytics: F, handleNoriginArrowPress: o, isNearView: e >= a - 1 && e <= a + 7, key: n.id_str, name: (0, f.X)(e.toString()), onFocus: L[e], onPress: v, playVideoPreview: y, tweet: n });
                                        break;
                                    default:
                                        i = null;
                                }
                                return r.createElement(
                                    s.Z,
                                    {
                                        ...
                                        style: e === Z.length - 1 ? void 0 : x.item,
                                    },
                                    i,
                                );
                            },
                            [F, t, Z.length, o, L, w, v, y, I],
                        ),
                        O = r.useMemo(() => Z.map((e, t) => $({ item: e, index: t })), [Z, $]),
                        V = r.useCallback(
                            (e) => {
        ...
        686010: (e, t, n) => {
            ...
            const d = (e) => {
                    ...
                    const W = o.useMemo(() => (d ? d({ hasFocus: D, hasFocusedChild: H }) : F), [d, D, H, F]),
                        N = o.useCallback(
                            (e) => {
                                D || H || V();
                                const t = E?.(e);
                    ...
                    return (0, c.ZP)("Arrow", D || (z && H) ? b : void 0, O), (0, c.ZP)("EscapeOrBack", D || (z && H) ? k : void 0, O), (0, c.ZP)(u.NW, D || (z && H) ? E : void 0, O), o.createElement(i.FocusContext.Provider, { value: O }, o.createElement(s.Z, (0, r.Z)({}, M, { onClick: N, ref: B, style: [W, p.noOutline], tabIndex: -1, testID: Z || T }), "function" == typeof a ? a({ hasFocus: D, hasFocusedChild: H }) : a));
                },
            ...
            const f = { behavior: "smooth", block: "start", inline: "nearest" },
                w = ({ autoFocus: e, content: t, flatListStyle: n, gridStyle: o, name: u, onSelectVideo: w, playVideoPreview: y, returnToFirstElementOnEscape: b, scrollOptions: C, style: k, title: S, width: E = 3, withScrollRestoration: R = !0 }) => {
                    const x = (0, g.z)(),
                        { direction: P } = (0, l.Z)(),
                        _ = r.useRef(null),
                        F = r.useRef(Array(t?.length).fill(null)),
                        Z = (0, d.Z)(`${u}.video-0`);
                    (0, p.ZP)(R);
                    const z = r.useCallback(
                            (e) => {
                                if (b && Z && (0, i.getCurrentFocusKey)() !== Z) return (0, i.setFocus)(Z), !0;
                            },
                            [Z, b],
                        ),
                        A = r.useCallback(
                    ...
                    const T = (0, d.Z)(`${s}.video-0`),
                        ...
                        V = r.useCallback(
                            (e) => {
                                ...
                                return s ? (Z.scribe({ element: "tv-grid", action: n }), (0, i.setFocus)(`${P}.video-${o}`), (F.current = !1), !0) : ((F.current = !0), !1);
                            },
                            [Z, t?.length, z, P, R],
                        ),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.TV~bundle.Account-ddbcca7b.f942057a.js.map
