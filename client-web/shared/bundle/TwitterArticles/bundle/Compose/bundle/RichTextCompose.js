    ...
    ["shared~bundle.TwitterArticles~bundle.Compose~bundle.RichTextCompose", "shared~bundle.AccountVerification~bundle.SettingsProfile~bundle.UserLists~loader.MediaPickerWithPreview"],
    {
        136092: (e, t, r) => {
            ...
            const R = (0, P.P1)([(e) => e.editorState.getCurrentContent().getPlainText(), (e) => e.isThread, (e, t) => t.featureSwitches, (e, t) => t.userClaims], (e, t, r, n) => {
                ...
                })(() => ({ editorState: o.Z.initEditorState(""), hasOverflowStyle: !1, isThread: !1, isFocused: !1, isEditorFocused: !1, isRichTextInput: !0, transform: { lookup: {}, order: [] } }), { name: "ComposerStore", freeze: !1, selectors: n, mutations: (e) => ({ editorState: E(e), editorStateRaw: _(e), toggleInlineStyle: w(e), defer_editorState: C(e) }) });
            function B(e, t) {
        ...
        304059: (e, t, r) => {
            ...
            const D = (0, R.Z)({
                    loader: () =>
                        Promise.all([r.e("icons.0"), r.e("icons.10"), r.e("icons.20"), r.e("icons.14"), r.e("modules.common-e907d115"), r.e("modules.common-e019dbda"), r.e("icons.24"), r.e("modules.audio-6107ac1a"), r.e("modules.audio-b953418a"), r.e("modules.audio-7c51e6a7"), r.e("modules.audio-04db59e9"), r.e("modules.audio-76583d6c"), r.e("modules.audio-b7a8a5fb"), r.e("modules.audio-51f6e793"), r.e("modules.audio-e019dbda"), r.e("modules.audio-262c94d4"), r.e("modules.audio-c6fe4ea4"), r.e("icons.26"), r.e("icons.3"), r.e("icons.9"), r.e("shared~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.LiveEvent~loader.M-85aa903d"), r.e("shared~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.LiveEvent~loader.M-c8e3a520"), r.e("shared~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.LiveEvent~loader.M-658f42e4"), r.e("shared~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.LiveEvent~loader.M-1f16c288"), r.e("shared~loaders.video.VideoPlayerDefaultUI~loaders.video.VideoPlayerMiniUI~loaders.video.VideoPlayerHashtagHig"), r.e("loader.MediaPreviewVideoPlayer")])
            ...
            class G extends n.Component {
                ...
                render() {
                    ...
                    return n.createElement(a.ZP, null, ({ windowWidth: t }) => {
                        ...
                        return n.createElement(i.Z, { "aria-label": e || L, onLayout: this._handleMediaPreviewLayout, role: h, style: [b, V.cursor, R && V.gifPlayButton, I] }, this._renderPreview(), R && !Z && n.createElement(s.Z, { "aria-label": B, onPress: this._handleGifClick, size: "small" }), T ? n.createElement(P.ZP, { type: P.AM }) : null, E && !D ? n.createElement(o.Z, { align: "left", altLabel: e }) : null, n.createElement(i.Z, { style: V.editMedia }, S ? n.createElement(l.ZP, { "aria-label": z, hoverLabel: { label: z }, icon: n.createElement(p.default, null), size: "small", type: "onMediaDominantColorFilled" }) : null, x && C ? n.createElement(l.ZP, { "aria-label": F, icon: n.createElement(m.default, { style: V.editSensitiveWarningIcon }), onPress: c, size: "small", type: "onMediaDominantColorFilled" }) : null, x ? n.createElement(l.ZP, { "aria-label": M, icon: r ? n.createElement(f.default, null) : void 0, onPress: d, size: r ? "xSmall" : "small", type: "onMediaDominantColorFilled" }, r ? void 0 : k) : null), _ ? n.createElement(l.ZP, { "aria-label": O, hoverLabel: { label: A }, icon: n.createElement(g.default, null), onPress: u, size: "small", style: V.buttonRight, type: "onMediaDominantColorFilled" }) : null);
                    });
                }
                _renderPreview() {
        ...
        490834: (e, t, r) => {
            ...
            var Z = r(668214),
                R = r(601576);
            const T = (0, Z.Z)().propsFromActions(() => ({ addToast: R.fz }))(({ addToast: e, gifUrl: t, provider: r }) => n.createElement(P, { addToast: e, gifUrl: t, provider: r }));
        },
        26232: (e, t, r) => {
            "use strict";
            r.d(t, { Z: () => b });
        ...
        779610: (e, t, r) => {
            ...
            const c = (e) => {
                    const { decoration: t, description: r, disabled: c = !1, isActive: h = !1, label: p, link: m, onPress: f, paddingHorizontal: g, renderRightContent: y, role: b = "tab", styleOverride: v, testID: E = "pivot", thumbnail: _, thumbnailSize: S, withoutArrow: x = !1 } = e,
                        ...
                        P = r ? ("string" == typeof r ? n.createElement(o.ZP, { color: "gray700", size: "subtext2", testID: `${E}-description` }, r) : r) : null,
                    ...
                    return n.createElement(l.Z, { "aria-selected": "tab" === b ? h : null, disabled: c, link: c ? void 0 : m, onPress: f, role: b, style: [u.root, Z, c && u.disabled, v], testID: E, withInteractiveStyling: !!m || !!f }, n.createElement(i.Z, { style: u.contentContainer }, _ ? n.createElement(i.Z, { style: w }, _) : null, n.createElement(i.Z, { style: u.content }, C, P), y ? y() : null, (!m && !f) || c || x ? null : I ? n.createElement(a.default, { style: u.icon }) : n.createElement(s.default, { style: u.icon })), t);
                },
                ...
                render() {
                    ...
                    return n.createElement(
                        ...
                        n.createElement(c.ZP.Consumer, null, ({ direction: e }) => {
                            ...
                            return n.createElement(
                                i.Z,
                                { style: [o.Z.border, g.container, t && o.Z.disabled, _ && o.Z.focusedBorderValid, x && o.Z.invalidBorderColor, _ && x && o.Z.focusedBorderInvalid, y] },
                                this._renderLabel(),
                                n.createElement(
                                    h,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.TwitterArticles~bundle.Compose~bundle.RichTextCompose.2e073efa.js.map
