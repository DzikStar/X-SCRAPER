...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.TwitterArticles~bundle.ComposeMedia-bc6ccf4c", "icons/IconCropOriginal-js", "icons/IconSearchPlusStroke-js"],
    {
        548485: (e, t, s) => {
            s.d(t, { Z: () => I });
            var i = s(202784),
            ...
            class m extends r.Component {
                ...
                render() {
                    const { guestsState: e, playerApi: t, playerState: s, stablePlayerState: a } = this.state,
                        { additionalBadges: o, aspectRatio: h, basePlayerClass: d, children: p, includeDisputeLinkInCopyrightErrorMessage: u, isFullScreen: y, objectFitVideo: b, onApiReady: f, onScroll: _, onStateUpdate: v, playerId: S, size: C, ...P } = this.props,
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderTimestampLabel = () => {
                            ...
                            return i.createElement(r.Z, { style: [Y.labelWrapper, { [o]: O(a, t), [l]: O(t - s, t), width: O(s - a, t) }] }, i.createElement(v.ZP, { background: "maskColor", style: [Y.label, !e && Y.visibilityHidden] }, G({ timestamp: this._generateTimestampLabelString() })));
                        }),
                        (this._setRootRef = (e) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.TwitterArticles~bundle.ComposeMedia-bc6ccf4c.2502a71a.js.map
