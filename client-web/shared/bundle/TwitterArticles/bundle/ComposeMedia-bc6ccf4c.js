...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~bundle.TwitterArticles~bundle.ComposeMedia-bc6ccf4c", "icons/IconCropWide-js", "icons/IconSearchPlusStroke-js"],
    {
        548485: (e, t, s) => {
            s.d(t, { Z: () => I });
            var i = s(202784),
        ...
        403556: (e, t, s) => {
            ...
            class v extends r.Component {
                ...
                render() {
                    const { Icon: e, "aria-label": t, badgeCount: s, badgePip: i, children: a, color: n, isActive: c, isCompact: h, isPillLink: d, isRoundedRect: p, isWebRedesign: g, retainScrollPosition: v, style: P, to: w } = this.props,
                        { location: x } = this.state,
                        R = w ? this._getMemoizedLink(w, v) : void 0,
            ...
            class m extends r.Component {
                ...
                render() {
                    const { guestsState: e, playerApi: t, playerState: s, stablePlayerState: a } = this.state,
                        { additionalBadges: o, aspectRatio: h, basePlayerClass: d, children: p, includeDisputeLinkInCopyrightErrorMessage: u, isFullScreen: y, objectFitVideo: b, onApiReady: f, onScroll: _, onStateUpdate: S, playerId: v, size: C, ...P } = this.props,
            ...
            class K extends i.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderTimestampLabel = () => {
                            ...
                            return i.createElement(r.Z, { style: [Y.labelWrapper, { [o]: O(a, t), [l]: O(t - s, t), width: O(s - a, t) }] }, i.createElement(S.ZP, { background: "maskColor", style: [Y.label, !e && Y.visibilityHidden] }, V({ timestamp: this._generateTimestampLabelString() })));
                        }),
                        (this._setRootRef = (e) => {
                ...
                render() {
                    ...
                    return i.createElement(v.ZP.Consumer, null, ({ direction: c }) => {
                        ...
                        return i.createElement(r.Z, (0, g.Z)({ ref: this._setRootRef, style: [Y.root, n && Y.cursorGrab] }, this._panResponderTermination.panHandlers), this._renderTimestampLabel(), i.createElement(r.Z, { onLayout: this._handleLayout, style: Y.trimmerWrapper }, i.createElement(r.Z, { style: Y.intervalsContainer }, i.createElement(D, { duration: e, trimmerWidth: o })), i.createElement(i.Fragment, null, i.createElement(r.Z, { style: [Y.discardArea, Y.transition, { width: O(a, e) }] }), i.createElement(r.Z, { style: Y.keepArea }, i.createElement(G, { currentValue: a, maxValue: t, minValue: 0, onKeyDown: this._handleKeyDown, onKeyUp: this._handleKeyUp, onMoveChange: this._handlePanResponderChange, onMoveEnd: this._handlePanResponderEnd, onMoveStart: this._handlePanResponderGrant, side: w, style: [Y.trimmerScrubber, { [d]: `-${l}px` }] }), i.createElement(r.Z, { style: Y.keepAreaCenter }, n ? null : i.createElement(r.Z, { style: [Y.playBarArea, Y.transition, { width: O(s, t - a) }] })), i.createElement(G, { currentValue: t, maxValue: e, minValue: a, onKeyDown: this._handleKeyDown, onKeyUp: this._handleKeyUp, onMoveChange: this._handlePanResponderChange, onMoveEnd: this._handlePanResponderEnd, onMoveStart: this._handlePanResponderGrant, side: x, style: [Y.trimmerScrubber, { [p]: `-${l}px` }] })), i.createElement(r.Z, { style: [Y.discardArea, Y.transition, { width: `calc(100% - ${O(t, e)})` }] }))));
                    });
                }
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.TwitterArticles~bundle.ComposeMedia-bc6ccf4c.702ac2fa.js.map
