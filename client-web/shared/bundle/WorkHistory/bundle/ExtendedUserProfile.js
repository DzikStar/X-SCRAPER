    ...
    ["shared~bundle.WorkHistory~bundle.ExtendedUserProfile"],
    {
        ...
        96702: (e, t, n) => {
            ...
            const S = ({ content: e }) => (
                    ...
                    o.createElement(o.Fragment, null, e && e.hasText() && o.createElement(D.Z, { className: $.Hx }, o.createElement(r.Z, { style: _.richText }, o.createElement(h.Z, { contentState: (0, p.convertToRaw)(e) }))))
                ),
                ...
                x = ({ content: e, previewHeight: t, shouldTruncate: n = !0 }) => {
                        ...
                        ? o.createElement(
                              ...
                              o.createElement(
                                  r.Z,
                                  {
                                      ...
                                      ref: u,
                                      style: f && !c ? { ..._.previewContainer, maxHeight: t } : void 0,
                                  },
                                  o.createElement(S, { content: m }),
                                  f && !c ? o.createElement(r.Z, { style: _.fade }) : null,
                              ),
                              f && o.createElement(k.ZP, { color: "link", onPress: () => d(!c), size: "subtext1", style: _.link, withInteractiveStyling: !0 }, c ? "Show less" : "Show more"),
                          )
                        : null;
                },
                v = l.default.create((e) => ({ row: { flexDirection: "row", gap: e.spaces.space8 } })),
                I = ({ block: e, isEditing: t }) => {
                    const { hasWorkHistorySection: n, sectionType: l } = (0, a.eF)(),
                        d = e.result?.content,
                        u = o.useMemo(() => l === i.NB.ABOUT && n, [n, l]);
                    return o.createElement(r.Z, { style: { ...v.row, ...(t ? { justifyContent: "space-between" } : {}) } }, o.createElement(x, { content: d?.value, previewHeight: 0.4 * window.innerHeight, shouldTruncate: u }), t ? o.createElement(r.Z, { style: v.row }, o.createElement(b, null), o.createElement(c.Z, { onCompleted: s.Z, useIconButton: !0 })) : null);
                };
            var Z = n(470397),
                z = n(823161),
                C = n(674132),
            ...
            const w = f().b721eb38,
                $ = ({ blocks: e, isEditing: t = !1 }) => {
                    const { sectionId: n, sectionVisibility: l } = (0, k.eF)(),
                        ...
                        S = (0, p.hC)("xprofile_section_visibility_enabled"),
                        _ = s.Z.generate({ backgroundColor: "transparent", color: c.default.theme.colors.text });
                    if (!t && !e?.length) return null;
                    const x = i === m,
                        v = (0, h.Kh)(e?.slice(), g.GL);
                    return o.createElement(r.Z, { style: D.root }, o.createElement(r.Z, { style: D.header }, o.createElement(d.ZP, { size: "title4", weight: "bold" }, w), S && x && o.createElement(d.ZP, { hoverLabel: { label: (0, E.Q)(l) } }, o.createElement(E.K3, { style: D.visibilityIcon, visibility: l })), S && t && o.createElement(E.ZP, { currentVisibility: l, sectionId: n })), o.createElement(r.Z, null, e?.length ? o.createElement(y.Z, { blocks: v, isEditing: t }) : o.createElement(o.Fragment, null, t ? o.createElement(u.Z, { interactiveStyles: _, onClick: $, style: D.container }, o.createElement(d.ZP, null, "Tell us about yourself"), o.createElement(b.default, null)) : null)));
                },
                ...
                _ = ({ isEditing: e = !1, section: t }) => (t && t.id ? o.createElement(S, { isEditing: e, section: t }) : o.createElement($, { isEditing: e }));
        },
        164349: (e, t, n) => {
            n.d(t, { Z: () => _ });
            n(136728);
            ...
            const w = f().a622dfcc,
                $ = ({ blocks: e, isEditing: t = !1 }) => {
                    ...
                    if (!t && !e?.length) return null;
                    const x = i === m,
                        v = (0, h.Kh)(e?.slice(), g.lw),
                        I = (0, h.s1)(v);
                    return o.createElement(r.Z, { style: D.root }, o.createElement(r.Z, { style: D.headerSection }, o.createElement(d.ZP, { size: "title4", weight: "bold" }, w), S && x && o.createElement(d.ZP, { hoverLabel: { label: (0, E.Q)(l) } }, o.createElement(E.K3, { style: D.visibilityIcon, visibility: l })), S && t && o.createElement(E.ZP, { currentVisibility: l, sectionId: n })), o.createElement(r.Z, { style: D.blocksList }, I && I.length > 0 ? o.createElement(y.Z, { blocks: I, isEditing: t }) : null, o.createElement(o.Fragment, null, t ? o.createElement(u.Z, { interactiveStyles: _, onClick: $, style: D.container }, o.createElement(d.ZP, null, "Add experience"), o.createElement(b.default, null)) : null)));
                },
        ...
        732368: (e, t, n) => {
            ...
            const $ = i,
                ...
                S = h().baffe39a,
                _ = h().je07e266,
                x = (e) => (e === E.pR.PUBLIC ? S : e === E.pR.PRIVATE ? _ : ""),
        ...
        779802: (e, t, n) => {
            n.d(t, { $u: () => S, Ak: () => Z, KJ: () => E, LI: () => _, P7: () => g, PW: () => D, QF: () => h, Qm: () => k, Tr: () => x, b$: () => p, db: () => C, et: () => $, fR: () => b, iH: () => v, lD: () => y, su: () => w, u4: () => z, wX: () => I });
            var o = n(202784),
                r = n(674132),
                l = n.n(r),
                i = n(394123),
            ...
            const b = { bold: "BOLD", italic: "ITALIC", strikethrough: "STRIKETHROUGH" },
                ...
                D = l().b92b6156,
                S = l().ec5ed598,
                _ = ({ children: e, extendedWidth: t, size: n, weight: r }) => o.createElement(f.ZP, { extendedWidth: t, size: n, weight: r }, e),
                x = { blockType: g.paragraph, label: S, component: _({ size: "body", children: S }) },
                v = [{ blockType: g.header1, label: $, component: _({ size: "title1", extendedWidth: !0, children: $ }) }, { blockType: g.header2, label: D, component: _({ size: "title3", weight: "heavy", children: D }) }, x],
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~bundle.WorkHistory~bundle.ExtendedUserProfile.825269fa.js.map
