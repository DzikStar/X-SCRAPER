(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-0157ee89"],
    {
            ...
            const c = new (class {
                ...
                dispatch(e, t, s, n = 0) {
                    const a = JSON.stringify({ ...t }),
                        i = { method: s, path: e, headers: { "Content-Type": "application/json", authorization: this.guestServiceToken }, data: a, timeout: n };
                    return this.client.dispatch(i).catch(this._maybeReinit(i)).then(u.Z);
                }
                post(e, t) {
                    const s = `/api/v1/${e}`;
                ...
                _getNtpMetadata() {
                    const e = 1e9 * (0, i.c)(new Date().getUTCDate());
        ...
        239496: (e, t, s) => {
            ...
            class o {
                ...
                dispatch(e, t, s, n = 0) {
                    ...
                    return this.client.dispatch(a).then(i.Z);
                }
                post(e, t) {
                    const s = `/${e}`;
                    return this.dispatch(s, t, "POST");
        ...
        656898: (e, t, s) => {
            "use strict";
            s.d(t, { $e: () => y, Cm: () => R, QG: () => P, bP: () => S, bd: () => w, lo: () => f });
            var n = s(565058),
                a = s(400752),
                i = s(776342),
                o = s(111677),
            ...
            const b = (0, n.cn)(null),
                f = (0, n.cn)(null, (e, t, s) => {
                    ...
                    a && n === c.Q.speaker && t(u.cI, c.Q.cohost), (s?.state !== i.default.SpaceState.Ended && s?.state !== i.default.SpaceState.TimedOut) || e(d.CP) || e(m.MG) || s?.rest_id !== e(u.rm) || t(h.dq, { isEnded: !0 });
                }),
                P = (0, n.cn)(null, (e, t) => {
                    t(b, null);
                }),
                R = {
                    ...
                    spaceStateAtom: (0, n.cn)((e) => {
                        const t = e(b),
                            s = t?.state;
                        return { NotStarted: s === i.default.SpaceState.NotStarted, PrePublished: s === i.default.SpaceState.PrePublished, Running: s === i.default.SpaceState.Running, TimedOut: s === i.default.SpaceState.TimedOut, Ended: s === i.default.SpaceState.Ended, Canceled: s === i.default.SpaceState.Canceled, loaded: Boolean(t), loading: !t, error: !t, joined: !0, recording: Boolean(t?.is_space_available_for_replay) && s === i.default.SpaceState.Running, joinable: !t?.disallow_join, replayable: Boolean(t?.is_space_available_for_replay) && (s === i.default.SpaceState.Ended || s === i.default.SpaceState.TimedOut), clippable: Boolean(t?.is_space_available_for_clipping), superFollowersOnly: t?.narrow_cast_space_type === i.default.AudienceEnum.superFollowersOnly };
                    }),
        ...
        304148: (e, t, s) => {
            ...
            const u = (0, n.cn)((e) => {
                    const t = e(o.RS);
                    return (0, i.Z)(t.map((e) => [e.guest_user_id, e]));
                }),
                c = () => (0, a.Dv)(o.RS).filter((e) => e.session_state === r.p$.RequestSubmitted);
        },
        358809: (e, t, s) => {
            "use strict";
            s.d(t, { G: () => o });
            ...
            class o {
                constructor({ janusUrl: e, store: t, vidManToken: s }) {
                    (this.create = () => this._dispatch(this.janusUrl, { janus: "create" })),
                        ...
                        (this.janusUrl = e),
                        (this.networkHelper = new i.ZP(s, t));
                }
            }
        },
        456766: (e, t, s) => {
            ...
            class d {
                            ...
                            this._running &&
                                this.janusApi
                                    ...
                                    .then(
                                        ...
                                        (e) => {
                                            404 === e.status ? (this.handlers.onJanusRestart(), (0, n.fH)(n.vw.prod) || (0, o.ZP)(e, { level: "warning" })) : this._running && (0, o.ZP)(e);
                                        },
                                    )
                                    .finally(() => {
                                        this._startJanusVideoRoomPollerIfNeeded();
                        ...
                        (this.handleResponse = (e) => {
                            if (e.plugindata?.data.error && e.plugindata.data.error_code) {
                                const { error: t, error_code: s } = e.plugindata.data,
                                    n = new l(s, t);
                                return e.transaction ? this.transactionStore.reject(e.transaction, n) : (0, o.ZP)(n), void (433 === s && this.handlers.onJanusRestart());
                            }
                ...
                stop() {
                    (this._running = !1), (0, n.fH)(n.vw.prod) || (0, o.ZP)("janus poller stopped", { level: "warning" }), this.janusApi.longPollAbortController?.abort();
                }
                listen(e) {
                    return (
                    ...
                    (this.detach = () => this._dispatch({ janus: "detach" })),
                        ...
                        (this._dispatch = (e) => {
                            const t = `${this.config.janusURL}/${this.config.janusSessionId}/${this.config.handlerId}`,
                                ...
                                i = { transaction: s, ...e };
                            return this.networkHelper.post(t, i).then((e) => {
        ...
        4643: (e, t, s) => {
            ...
            class c {
                constructor(e, t, s = {}) {
                    (this.credentials = e), d() && (s.filters = [...(s.filters ?? []), u.oT]), _ && (s.dispatcher = _), (s.errorFilter = h), (this.client = new o.ZP(s));
                }
                httpRequest(e, t, s, n = 0, a) {
                    const o = JSON.stringify(t),
                        u = { method: s, path: e, headers: { "Content-Type": "application/json", Authorization: this.credentials }, data: o, timeout: n, signal: a };
                    return i()((e) =>
        ...
        400915: (e, t, s) => {
            ...
            function r() {
                const e = (0, a.Dv)(i.cI);
                return { role: e || o.Q.listener, isUserSpeakingRole: [o.Q.host, o.Q.cohost, o.Q.speaker].includes(e), isUserAdminRole: [o.Q.host, o.Q.cohost].includes(e) };
            }
            const u = (0, n.cn)(!1),
                c = (0, n.cn)(
                    (e) => e(u),
        ...
        521799: (e, t, s) => {
            ...
            const o = (e, t) =>
                t(e)
                    .then((t) => {
                        const { data: s, headers: n, host: i, params: o, ...u } = e,
        ...
        708482: (e, t, s) => {
            ...
            var n = s(10622),
                a = s.n(n);
            function i(e, t, s, n) {
                return a()(e, t, s, n ? { networkCacheConfig: { metadata: { isFatalError: n } } } : void 0).toPromise();
            }
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-0157ee89.fdc5572a.js.map
