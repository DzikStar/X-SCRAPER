...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-4514ff28"],
    {
        ...
        133272: (e, t, r) => {
            ...
            const c = (e = {}) => {
                const { direction: t } = (0, o.Z)();
                return (0, n.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [a.Z.root, e.style], viewBox: "0 0 24 24", children: i.createElement("g", null, i.createElement("path", { d: "M17 7v4c0 2.76-2.239 5-5 5s-5-2.24-5-5V7c0-2.76 2.239-5 5-5s5 2.24 5 5zm-4 12.947c4.677-.504 7.228-4.469 7.949-6.631l-1.896-.635c-.074.217-1.866 5.318-7.052 5.318s-6.979-5.102-7.051-5.316l-1.897.633c.721 2.162 3.271 6.127 7.949 6.631V22h2v-2.053H13z" })) }, { writingDirection: t });
            };
            c.metadata = { width: 24, height: 24 };
            const s = c;
        },
                ...
                return s(t, r).then(
                    (t) => (
                        (function (e, t, r, n, o, a) {
                            ...
                            switch ((e.save(), o)) {
                                case i.Z.TOP_RIGHT:
                                    e.scale(-1, 1), (s = t.width - c.width - c.left), (u = -r);
                                    break;
                                case i.Z.BOTTOM_RIGHT:
                                    e.rotate(Math.PI), (s = t.width - c.width - c.left), (l = t.height - c.height - c.top), (u = -r), (g = -n);
                                    break;
                                case i.Z.BOTTOM_LEFT:
                                    e.scale(1, -1), (l = t.height - c.height - c.top), (g = -n);
                                    break;
                                case i.Z.LEFT_TOP:
                                    e.translate(r / 2, n / 2), e.rotate(-Math.PI / 2), e.scale(-1, 1), (s = c.top), (l = c.left), (h = c.height), (d = c.width), (u = -n / 2), (g = -r / 2), (m = n), (f = r);
                                    break;
                                case i.Z.LEFT_BOTTOM:
                                    e.translate(r / 2, n / 2), e.rotate(Math.PI / 2), (s = c.top), (l = t.height - c.width - c.left), (h = c.height), (d = c.width), (u = -n / 2), (g = -r / 2), (m = n), (f = r);
                                    break;
                                case i.Z.RIGHT_BOTTOM:
                                    e.translate(r / 2, n / 2), e.rotate(Math.PI / 2), e.scale(-1, 1), (s = t.width - c.height - c.top), (l = t.height - c.width - c.left), (h = c.height), (d = c.width), (u = -n / 2), (g = -r / 2), (m = n), (f = r);
                                    break;
                                case i.Z.RIGHT_TOP:
                                    e.translate(r / 2, n / 2), e.rotate(-Math.PI / 2), (s = t.width - c.height - c.top), (l = c.left), (h = c.height), (d = c.width), (u = -n / 2), (g = -r / 2), (m = n), (f = r);
                            }
            ...
            const i = Object.freeze({ UNKNOWN: 0, TOP_LEFT: 1, TOP_RIGHT: 2, BOTTOM_RIGHT: 3, BOTTOM_LEFT: 4, LEFT_TOP: 5, LEFT_BOTTOM: 6, RIGHT_BOTTOM: 7, RIGHT_TOP: 8 }),
                n = (e, t, r = 65536) => {
                    ...
                    function o(o, a, c) {
                        const s = o - n,
                            l = s + a;
                        if (s >= 0 && l <= i.length) c(i.subarray(s, l), o);
                        else {
                            const s = new FileReader();
                            (s.onload = function () {
                                (i = new Uint8Array(this.result)), (n = o), c(i.subarray(0, a), o);
                            }),
                                (s.onerror = t.bind(null, 0)),
                                null !== e && s.readAsArrayBuffer(e.slice(o, o + Math.max(r, a)));
                        }
                    }
                    function a(e) {
                        ...
                        function i(t, i) {
                            let n = 0;
                            for (let o = 0; o < i; o++) n = (n << 8) + e[t + (r ? o : i - 1 - o)];
                            return n;
                        }
                        const n = e.length > 8 && i(4, 4);
                    ...
                    e instanceof Blob
                        ? o(0, 10, function e(r, i) {
                              const n = r[1];
                              if (r.length < 4 || 255 !== r[0] || 217 === n) return void t(0);
                              const c = n < 208 || n > 217 ? (r[2] << 8) + r[3] : 0;
                              225 === n && c > 8 && "Exif\0\0" === String.fromCharCode.apply(null, r.subarray(4, 10)) ? o(i + 10, c - 8, a) : o(i + 2 + c, 10, e);
                          })
                        : t(0);
                },
                o = (e, t) => {
        ...
        276259: (e, t, r) => {
            r.d(t, { Lw: () => n, Re: () => d, VJ: () => c, ZF: () => u, hv: () => s, ku: () => i, qp: () => o, uv: () => a, v5: () => h });
            ...
            const o = (e, t) =>
                ...
                s = async (e, t) => {
                    ...
                    for (; r && r.size > t; )
                        try {
                            i > 0.2 ? ((i *= 0.7), (r = await l(r, 1, i))) : (r = await l(r, 0.7, i));
                        } catch (e) {
                            r = void 0;
                        }
                    return r;
        ...
        364837: (e, t, r) => {
            ...
            const a = 1,
                ...
                l = (e) => {
                    if ((0, o.DS)(e)) {
                        if (e.isGif) {
                            const { height: t, img: r, orientation: o, width: a } = e;
                            return (0, i.$i)(r, a, t, o).then(
                                (e) => (0, i.q8)(e),
                                (e) => {
                                    throw new n.Z("Gif preview could not be generated", s);
                                },
                            );
                        }
                        {
                            const e = new n.Z("The provided image must be a gif", c);
        ...
        205074: (e, t, r) => {
            ...
            function a(e, t) {
                const r = (function (e) {
                    ...
                    [n, o] = r ? [e.height, e.width] : [e.width, e.height];
        ...
        653843: (e, t, r) => {
            r.d(t, { Y7: () => g, ZP: () => y, m2: () => p });
            var i = r(19697),
                n = r(790187),
                o = r(549755),
                a = r(205074),
                c = r(276259);
            function s(e, { maxDimension: t, maxFileSize: r, targetQuality: i }) {
                return (function (e, t, r, i) {
                    function n(o, a) {
                        return l(e, e.width, e.height, o, a).then((e) => {
                            const s = e.width > r || e.height > r,
                                l = e.toDataURL("image/jpeg", i),
                                h = l.split(";base64,")[1],
                                d = (0, c.ku)(h);
                            if (s || d > t) {
                                let e = 0.8;
                                return s && (e = o > a ? r / o : r / a), n(o * e, a * e);
                            }
                            return l;
                        });
                    }
            ...
            function l(e, t, r, n, o) {
                const a = t / 2,
                    c = r / 2;
                return e instanceof HTMLCanvasElement && t <= n && r <= o ? Promise.resolve(e) : a <= n && c <= o ? (0, i.$i)(e, n, o) : (0, i.$i)(e, a, c).then((e) => l(e, e.width, e.height, n, o));
            }
            const h = 5242880,
                d = 4096,
                u = 0.85,
                ...
                f = (e, t = h, r = d) => {
                    const { height: i, size: n, width: o } = e;
                    return o > r || i > r || n > t;
                },
                w = (e, t) => t || { top: 0, left: 0, width: e.width, height: e.height },
                v = (e, t) => {
                    const { height: r, left: i, top: n, width: o } = w(e, t);
                    return !(0 === n && 0 === i && o === e.width && r === e.height);
                };
            function p(e, t) {
                const { maxFileSize: r = h, maxDimension: i = d, cropData: n, jpgPixelsPerByteForResize: o } = t || {},
                    a = "image/jpeg" === e.type,
                    c = (e.width * e.height) / e.size;
                return m(e) || f(e, r, i) || v(e, n) || (a && !!o && c < o);
            }
            const E = (e, t) => {
            ...
            function y(e, t) {
                const { maxFileSize: r = h, maxDimension: n = d, targetQuality: c = u, cropData: l } = t || {},
                    m = w(e, l);
                ...
                const f = (e) => s(e, { maxFileSize: r, maxDimension: n, targetQuality: c });
                return e
                    .withDimensionsAndOrientation()
                    .then(({ img: e, orientation: t }) => {
                        const r = ({ height: r, width: n }) => (0, i.$i)(e, n, r, t, m);
                        return Z(e)
                            .then(() => ((e) => e(E(m, n)))(r))
                            .then(f);
                    })
            ...
            function c(e) {
                ...
                function u(e) {
                    return function (t) {
                        ...
                        e.current.equality(n, r, t, i) || ((e.current.slice = n), (e.current.state = t), e.current.onUpdate(e.current.slice));
                    };
                }
                return {
                    getState: function () {
                    ...
                    useSlice: function (e, t) {
                        const r = t?.equalityFn || s.equality,
                            n = a.Z,
                            o = i.useRef({ state: c, slice: e(c), selector: e, equality: r, onUpdate: n });
                        (o.current.selector = e), (o.current.equality = r);
                        const [l, d] = i.useState(() => o.current.slice);
                        return (
                            i.useEffect(() => {
                                let e = !0;
                    ...
                    subscribe: function (e, t, r) {
                        const i = r?.equalityFn || s.equality,
                            n = { current: { state: c, slice: e(c), selector: e, equality: i, onUpdate: t } },
                            o = h(u(n));
        ...
        465233: (e, t, r) => {
            ...
            var i = r(716406);
            function n(e) {
                return "object" != typeof e || null === e ? e : Array.isArray(e) ? e.map(n) : (0, i.Z)(e, (e) => n(e));
            }
        },
        459643: (e, t, r) => {
            r.d(t, { Z: () => i });
        ...
        326399: (e, t, r) => {
            ...
            const c = (e, t, r) => {
                const c = (0, n.Z)(r) ? Array(t.length).fill(r) : r,
                    s = t.map((e) =>
                        (0, n.Z)(e)
                            ? (t) => {
                                  const r = "object" == typeof t ? t?.[e] : void 0;
                                  return (0, n.Z)(r) || (0, i.Z)(r) || a(r) ? r : void 0;
                              }
                            : e,
                    );
        ...
        822240: (e, t, r) => {
            ...
            const i = (e, t, r = 1) => {
                const i = [];
                for (let n = e; r > 0 ? n < t : n > t; n += r) i.push(n);
                return i;
            };
        },
        684565: (e, t, r) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-4514ff28.7e474c3a.js.map
