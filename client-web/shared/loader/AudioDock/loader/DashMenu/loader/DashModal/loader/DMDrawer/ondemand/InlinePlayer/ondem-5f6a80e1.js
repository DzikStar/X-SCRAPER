...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-5f6a80e1"],
    {
        114519: (e, t, n) => {
            n.d(t, { L: () => c });
            var r = n(202784),
        ...
        186061: (e, t, n) => {
            ...
            function f(e) {
                ...
                return {
                    interactiveViewProps: {
                        ...
                        style: [y.container, t, c.onClick ? {} : { cursor: "default" }],
                        ...c,
                    },
                    contentStyle: [y.content, { backgroundColor: s, minHeight: u }],
                    isNarrow: i,
                    isSmall: o,
                    borderStyles: t,
                };
            ...
            const y = d.default.create((e) => ({ container: { overflow: "hidden" }, content: { padding: e.spaces.space12 } })),
        ...
        819844: (e, t, n) => {
            ...
            function g(e) {
                const { caption: t, captionTextSize: n, withSpeaker: i = !0, ...l } = e,
                    { speaker: s } = t;
                return a.createElement(o.Z, { style: [E.root, !i && E.missingSpeakerSpacer] }, i ? a.createElement(m, (0, r.Z)({}, l, { speaker: s, timestamp: t.timestamp })) : null, a.createElement(c.ZP, { lang: t.lang, size: n, style: E.captionText }, t.text));
            }
            const E = l.default.create((e) => ({ root: { paddingBottom: "0.25em", flex: 1 }, missingSpeakerSpacer: { paddingTop: "0.1em" }, captionText: { lineHeight: "1.5em", paddingVertical: "0.1em", fontWeight: e.highContrastEnabled ? e.fontWeights.heavy : e.fontWeights.regular } })),
                y = (e) => ({ width: e, height: e });
            function b(e) {
                const { size: t } = e,
                    n = Math.floor(t / 4.5);
            ...
            function C(e, t) {
                return { animationDelay: 0.5 * e + "s", borderRadius: "100%", ...y(t) };
            }
            ...
            function k(e) {
                ...
                return (
                    ...
                    a.createElement(
                        ...
                        { ref: h, style: P.root },
                        a.createElement(i.Z, {
                            ListFooterComponent: a.createElement(A, { footerHeight: n, unintelligible: s }),
            ...
            const P = l.default.create((e) => ({ root: { height: "100%", width: "100%", flex: 1 }, captionsContainer: { maxHeight: "100%", height: "100%", scrollbarWidth: "none" } }));
        ...
        868871: (e, t, n) => {
            ...
            function b(e) {
                const t = r.useRef(new E.Z.Value(0)).current,
                    ...
                    i = { entry: E.Z.spring(t, { toValue: n[1], useNativeDriver: !1 }) };
                return (
                    r.useEffect(() => {
                        t.setValue(n[0]), i.entry.start();
                    }, [e.caption]),
                    r.createElement(E.Z.View, { style: [w.container, { transform: [{ translate3d: "0, 0, 0" }], opacity: t.interpolate(a.opacity) }] }, r.createElement(y.ZP, { color: "whiteOnColor", numberOfLines: e.numberOfLines, size: e.size, weight: e.weight }, e.caption))
                );
            }
            ...
            function Z(e) {
                let t = A;
                return (
                    e.speed && (t = Math.min(Math.max(e.speed, P), L)),
                    r.createElement(
                        E.Z.View,
                        { style: M.container },
                        r.createElement(
            ...
            function x(e) {
                const t = r.useRef(new E.Z.Value(0)).current,
                    ...
                    i = E.Z.sequence([E.Z.delay(e.delay * e.index), E.Z.spring(t, { toValue: n[1], useNativeDriver: !1 })]);
                return (
                    r.useEffect(() => {
                        i.start();
                    }, []),
                    r.createElement(r.Fragment, null, r.createElement(E.Z.Text, { style: [M.word, { transform: [{ translate3d: "0, 0, 0" }], opacity: t.interpolate(a.opacity) }] }, e.word), e.excludeWhitespace ? null : r.createElement(k, null))
                );
            }
            function k() {
                    ...
                    (function () {
                        ...
                        return new Promise((e) => {
                            ...
                            (t.style.position = "fixed"),
                                ...
                                (t.style.opacity = "0"),
                                T.render(r.createElement(y.ZP, S), t, () => {
                    ...
                    r.useEffect(() => {
                        n &&
                            ...
                            I({ text: e, width: n, height: a }).then((e) => {
                                o(
                                    (function (e, t) {
                                        const n = e.map((e) => (0, R.Z)(e).weightedLength),
            ...
            function D() {
                ...
                return null === e ? r.createElement(F, null) : void 0 === e ? r.createElement(a.Z, { style: N.captionContainer }) : r.createElement(O, { caption: e });
            }
            function O(e) {
                const t = p(),
            ...
            function F() {
                ...
                return r.createElement(a.Z, { style: N.captionContainer }, r.createElement(a.Z, { style: N.unavailableContainer }, r.createElement(s.default, { borderColor: "white", borderWidth: "medium", size: "jumbo", uri: e.avatar_url }), r.createElement(H, { space: "space8" }), r.createElement(a.Z, { style: N.unavailableNameContainer }, r.createElement(u.Z, { color: "white", isBlueVerified: e.is_blue_verified, isVerified: e.is_verified, name: e.display_name, nameSize: "subtext1", style: N.unavailableUserName, weight: "bold" }), r.createElement(d.Z, { color: "white", screenName: e.twitter_screen_name || "", size: "subtext1", style: N.unavailableScreenName }))));
            }
            function H(e) {
            ...
            function ne(e) {
                ...
                return r.createElement(a.Z, { style: [ae.previewContainer, { backgroundColor: t }] }, r.createElement(y.ZP, { color: "whiteOnColor", numberOfLines: 2, size: "body", weight: "bold" }, e.title), r.createElement(re, e));
            }
            function re(e) {
            ...
            const Ee = r.memo(function () {
                    ...
                    const m = e.getState(),
                        ...
                        h = (0, o.TZ)(m),
                        g = [ye.container, h],
                        E = [ye.content, { backgroundColor: f }];
                    return r.createElement(
                        i.Z,
                        {
                            onClick: u,
                        ...
                        r.createElement(a.Z, { style: E }, r.createElement(K, null), r.createElement(D, null), r.createElement(he, { barCount: d }), r.createElement(ne.WithContext, { backgroundColor: f })),
                    );
                }),
                ye = l.default.create((e) => ({ container: { overflow: "hidden" }, content: { paddingVertical: e.spaces.space12, paddingHorizontal: e.spaces.space16 } })),
        ...
        279046: (e, t, n) => {
            ...
            E.generateText = function (e) {
                ...
                switch (e.labelType) {
                    ...
                    case "plusCount":
                        return y.plusCount({ count: t });
                    case "plusOthers":
                        return y.plusOthers({ count: t });
                    case "tunedIn":
                        return y.tunedIn({ count: t });
                    default:
                        return y.others({ count: t });
                }
            };
            const y = { others: l().gfe2830f, otherListeners: l().dbeae6cf, plusCount: l().d2543d97, plusOthers: l().dc718e53, tunedIn: l().d6f2056f },
            ...
            function k(e) {
                ...
                return a.createElement(i.Z, { style: P.container }, a.createElement(i.Z, { style: P.gradientBar }, a.createElement(S.Z.Animated, null)), a.createElement(i.Z, { style: P.content }, a.createElement(i.Z, { style: P.text }, a.createElement(i.Z, { style: P.participantsRow }, e.activeSpeakers), a.createElement(g.ZP, { color: "gray700", numberOfLines: 1 }, a.createElement(M, e))), a.createElement(v.ZP, { "aria-label": A.close, borderColor: "transparent", color: "text", icon: a.createElement(w.default, null), onPress: t, size: "medium", testID: "close" })));
            }
            function M(e) {
                return e.totalParticipants ? a.createElement(a.Fragment, null, a.createElement(E, { count: e.totalParticipants - 1, labelType: "plusOthers" }), a.createElement(C.Z, null), e.title) : e.title;
            }
            const A = { close: l().af8fa2ae },
            ...
            function L(e) {
                ...
                return a.createElement(
                    o,
                    null,
                    a.createElement(u.Z, { id: "SpaceDock" }, (t, n) => a.createElement(i.Z, (0, r.Z)({ ref: t() }, n({ style: l })), a.createElement(R, e))),
                );
            }
            function R(e) {
            ...
            (L.formatCountShort = p), (L.ParticipantsCount = E);
            const T = { dock: l().jbc5f47a },
        ...
        776342: (e, t, n) => {
            ...
            var r = n(202784),
                ...
                g = n(648347);
            function E(e) {
                return e.state === g.ku.live ? r.createElement(y, e) : e.state === g.ku.scheduled ? r.createElement(b, e) : e.state === g.ku.ended ? r.createElement(w, e) : e.state === g.ku.canceled ? r.createElement(v, e) : e.state === g.ku.replay ? r.createElement(C, e) : null;
            }
            function y(e) {
            ...
            function R(e) {
                ...
                if (!n && !t) return null;
                let a, o, l, c, s, u, d, m;
                return t ? ((o = t.image_url), (a = t.name), (l = void 0), (c = void 0), (u = "square"), (s = !1), (d = void 0), (m = void 0)) : n && ((a = n.display_name), (o = n.avatar_url), (l = n.is_blue_verified), (c = n.is_verified), (d = n.verified_type), (s = !0), (m = n.highlightedLabel)), r.createElement(i.Z, { style: z.hostInfoContainer }, r.createElement(i.Z, { style: z.hostNameContainer }, r.createElement(P.default, { "aria-hidden": !0, borderColor: "white", borderWidth: "small", focusable: !1, hasAdaptiveImage: s, shape: u, size: "medium", style: z.userAvatar, uri: o }), r.createElement(L.Z, { affiliateBadgeInfo: m, color: "white", isBlueVerified: l, isVerified: c, name: a, nameSize: "subtext1", verifiedType: d, weight: "normal", withStackedLayout: !0 })), r.createElement(T, e));
            }
            function T(e) {
            ...
            function I(e) {
                return r.createElement(A.ZP, { background: "translucentWhite", style: z.hostInfoLabel }, e.children);
            }
            ...
            function ne(e) {
                ...
                return r.createElement(o.Z, l, r.createElement(i.Z, { style: n, testID: "wrapperView" }, m === g.ku.unavailable ? r.createElement(X, null) : u && d && m ? r.createElement(re, (0, a.Z)({}, e, { borderStyles: t, isNarrow: c, isSmall: s })) : r.createElement(W.Z, null)));
            }
            function re(e) {
                return r.createElement(r.Fragment, null, r.createElement(R, e), r.createElement(J, e), r.createElement(E, e), r.createElement(ae, e));
            }
            function ae(e) {
            ...
            (ne.Button = function (e) {
                ...
                else if (i) e.isHost ? ((c = q.startNow), (u = r.createElement(D.default, null))) : e.hasReminderSet ? ((c = q.reminderSet), (u = r.createElement(O.default, null)), (s = "onMediaOutlined")) : ((c = q.setReminder), (u = r.createElement(F.default, null)));
                else if (o) {
                    const t = r.createElement(H.default, null);
                ...
                return (
                    r.useEffect(() => {
                        ...
                        let r = requestAnimationFrame(function t() {
                            ...
                            const { barWidth: a, bars: i, height: s, maxBarHeight: u, width: d, xMove: m, xStart: E } = v.current;
                            n.clearRect(0, 0, d, s);
                            for (let t = 0; t < l; t++) {
                                const [r, , l] = i[t],
                                    d = l * u,
                                ...
                                const g = Math.max(0.5, p - a),
                                    y = E + t * m,
                                    b = (s - g) / 2;
                                n.beginPath(), n.moveTo(y, b), (n.strokeStyle = e.color || c), (n.lineWidth = a), (n.lineCap = "round"), n.lineTo(y, b + g), n.stroke();
                            }
                            (v.current.shouldAnimate = p(v)),
                    ...
                    r.createElement("canvas", { ref: w, style: E })
                );
            }
        ...
        254683: (e, t, n) => {
            ...
            const E = i.default.create((e) => ({ root: { display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row" } })),
                y = function ({ size: e, ...t }) {
                    const n = { ...l(e) };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-5f6a80e1.7ef56e0a.js.map
