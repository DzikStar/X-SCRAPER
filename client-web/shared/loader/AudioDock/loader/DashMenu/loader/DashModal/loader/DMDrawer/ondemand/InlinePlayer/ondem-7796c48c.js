        ...
        782642: (e, t, s) => {
            ...
            const r = () => {
                    const e = (0, n.I0)(),
                        ...
                        s = o.useRef(null);
                    return (
                        o.useEffect(() => () => clearTimeout(s.current), [t]),
                        o.useCallback(
                            (o) => {
                                e((0, i.fz)(o)), (s.current = setTimeout(() => t(), 3e3));
                            },
                            [e, t],
                        )
                    );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-7796c48c.1f36b02a.js.map
