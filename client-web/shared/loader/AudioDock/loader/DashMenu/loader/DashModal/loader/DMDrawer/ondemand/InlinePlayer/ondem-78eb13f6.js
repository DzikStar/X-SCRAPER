...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-78eb13f6", "loader.Typeahead-50b6b1eb"],
    {
        275365: (e, t, s) => {
        ...
        613195: (e, t, s) => {
            ...
            const R = r().fb4ee2f6,
                ...
                U = u.dg(N.A7, "FETCH_CONVERSATION_FROM_PARTICIPANTS"),
                ...
                V = u.dg(N.A7, "MARK_CONVERSATION_READ"),
                Z = u.dg(N.A7, "DISABLE_MENTION_CONVERSATION_NOTIFICATIONS"),
                B = u.dg(N.A7, "DISABLE_CONVERSATION_NOTIFICATIONS"),
                j = u.dg(N.A7, "ENABLE_MENTION_CONVERSATION_NOTIFICATIONS"),
                F = u.dg(N.A7, "ENABLE_CONVERSATION_NOTIFICATIONS"),
            ...
            const W = (e = {}, t = {}, s = []) => {
                ...
                _e =
                    ...
                    (s, n, { api: a }) => {
                        const r = t.join(",");
                        return u
                            ._O(s, { params: { conversationId: e, joinedParticipantIds: r }, request: a.withEndpoint(o.Z).addParticipants })({ actionTypes: b, context: D, meta: { conversationId: e, participantIds: t } }, (e) => {
                                if (e) {
                                    const { entities: t } = e;
                ...
                Ee =
                    (e) =>
                    (t, s, { api: n }) =>
                        u._O(t, { params: { participantIds: e }, request: n.withEndpoint(o.Z).fetchConversationFromParticipants })({ actionTypes: U, meta: { participantIds: e } }),
                Ie =
                    (e = {}) =>
                    (t, s) => {
                        const n = s(),
                ...
                pe =
                    ...
                    (t, s) => {
                        ...
                        return !$(n, a) && r ? t(ue({ conversationId: a, min_id: r, min_buffer: 15, context: M, min_position: r })) : Promise.resolve();
                    },
                Te =
                    (e) =>
                    (t, s, { api: n }) =>
                ...
                fe = (e, t) => ({ type: V.REQUEST, meta: { conversationId: e, lastReadEventId: t } }),
                Me =
                    (e) =>
                    (t, s, { api: n }) => {
                        const a = s(),
                            ...
                            d = !re(a, e);
                        if (e && i && d) {
                            return u.AB(t, { params: { conversationId: e, last_read_event_id: i }, request: n.withEndpoint(o.Z).markRead })({ actionTypes: V, bypassFailureOnErrors: () => !0, context: "APP_DM_UPDATE_CONVERSATION_READ_STATE", meta: { conversationId: e, lastReadEventId: i } });
                        }
                        return Promise.resolve();
                    },
                he = "rweb/directMessages/REMOVE_CONVERSATION",
                Pe = (e) => [{ payload: e, type: he }, (0, O.J_)(e)],
                be = "rweb/directMessages/TOGGLE_CONVERSATION_NOTIFICATIONS",
                we = (e, t) => ({ meta: { conversationId: e }, payload: t, type: be }),
                Ue =
                    (e = {}) =>
                    (t, s, { api: n }) => {
                ...
                Le =
                    ...
                    (t, s, { api: n }) => {
                        const { conversationId: a } = e;
                        return u.AB(t, { params: e, request: n.withEndpoint(o.Z).enableNotifications })({ actionTypes: F, context: "ACTION_ENABLE_NOTIFICATIONS", meta: { conversationId: a } });
                    },
                xe =
                    (e = {}) =>
                    (t, s, { api: n }) => {
                        ...
                        return u.AB(t, { params: r, request: n.withEndpoint(o.Z).updateMentionNotificationsSetting })({ actionTypes: Z, context: "ACTION_DISABLE_DM_MENTION_NOTIFICATIONS", meta: { conversationId: a } });
                    },
                Ve =
                    (e = {}) =>
                    (t, s, { api: n }) => {
                        ...
                        return u.AB(t, { params: r, request: n.withEndpoint(o.Z).updateMentionNotificationsSetting })({ actionTypes: j, context: "ACTION_ENABLE_DM_MENTION_NOTIFICATIONS", meta: { conversationId: a } });
                    },
                Ze =
                    (e = {}) =>
                    (t, s, { api: n }) =>
                ...
                je = (e) => ({ type: Y.SUCCESS, meta: { conversationId: e.conversation_id, name: e.conversation_name } }),
                Fe = "rweb/directMessages/UPDATE_CONVERSATION_MAX_ENTRY_ID",
                Ye = (e, t) => ({ meta: { conversationId: e }, payload: t, type: Fe }),
        ...
        627279: (e, t, s) => {
            s.d(t, { I7: () => g, J_: () => P, MY: () => B, Ob: () => q, WK: () => H, WO: () => M, ZP: () => v, _d: () => K, gm: () => G, gz: () => k, iN: () => Q, kv: () => w, pt: () => b, px: () => L, rU: () => F, s$: () => V, wC: () => f, zT: () => W });
            var n = s(468811),
                a = s.n(n),
                r = s(744531),
                i = s(933277),
            ...
            const y = (e, t) => {
                ...
                f =
                    ...
                    (t, s, { api: n }) => {
                        const a = C(...e);
                        return t([L(a.conversation_id, a.id, a), q(a), F(a)]);
                    },
                M =
                    (...e) =>
                    (t, s, { api: n }) => {
                ...
                b = (e, t) => ({ payload: e, type: t ? m.REQUEST : S.REQUEST }),
                w =
                ...
                U = "rweb/directMessages/ADD_ENTRY",
                L = (e, t, s) => ({ meta: { conversationId: e, requestId: t }, payload: s, type: U }),
                x = "rweb/directMessages/EDIT_ENTRY",
                V = (e, t, s) => ({ meta: { conversationId: e, requestId: t }, payload: s, type: x }),
                Z = "rweb/directMessages/REMOVE_ENTRY",
                B = (e, t, s) => ({ meta: { conversationId: e, requestId: t }, payload: s, type: Z }),
                j = "rweb/directMessages/ADD_REACTION",
                F = (e) => ({ payload: { ...e, type: l.Cr.REACTION_CREATE }, type: j }),
        ...
        720277: (e, t, s) => {
            s.d(t, { $7: () => se, A4: () => ne, B7: () => g, C2: () => K, Gk: () => h, Kf: () => V, MB: () => w, Oq: () => Y, Pt: () => f, Re: () => F, Sb: () => B, UD: () => P, Z3: () => Z, ZI: () => q, ZP: () => v, aB: () => M, g4: () => x, gN: () => R, j7: () => X, k5: () => j, kK: () => z, kL: () => ae, oH: () => Q, s0: () => te, vC: () => J, xS: () => b });
            var n = s(161821),
                a = s(401388),
                r = s(948322),
                i = s(856674),
            ...
            const y = (e, t) => ({ last_seen_event_id: N(e.last_seen_event_id, t.last_seen_event_id), trusted_last_seen_event_id: N(e.trusted_last_seen_event_id, t.trusted_last_seen_event_id), untrusted_last_seen_event_id: N(e.untrusted_last_seen_event_id, t.untrusted_last_seen_event_id) }),
                ...
                f = (e) => D(e)[T.xR.Inbox],
                M = (e) => D(e)[T.xR.Untrusted],
                h = (e) => D(e)[T.xR.UntrustedLowQuality],
                P = (e) => f(e).fetchStatus,
                b = (e) => P(e) === c.ZP.LOADING,
                w = (e) => P(e) === c.ZP.LOADED,
                U = { [T._2.PRIMARY]: (e) => e.trusted, [T._2.SECONDARY]: (e, t, s) => (t ? !(e.trusted || e.muted || (s && e.nsfw) || e.low_quality) : !(e.trusted || e.muted || (s && e.nsfw))), [T._2.TERTIARY]: (e, t, s) => (t ? !e.trusted && (e.muted || e.low_quality || (s && e.nsfw)) : !e.trusted && (e.muted || (s && e.nsfw))) },
                L = (e, t) => {
                    const s = (0, u.Rh)(e),
                        a = (0, u.a5)(e);
                    return (0, n.Z)((0, I.FS)(e)).filter((e) => U[t](e.data, s, a));
                },
                x = (e, t) =>
                    L(e, t)
                        .map((e) => e.data)
        ...
        798538: (e, t, s) => {
            s.d(t, { Ah: () => w, Bw: () => D, De: () => F, E4: () => R, G6: () => M, Hd: () => S, Tu: () => U, W8: () => P, bG: () => O, m1: () => Z, q9: () => b, qK: () => g, rA: () => x, vb: () => y });
            s(136728);
            var n = s(468811),
                a = s.n(n),
                r = s(364837),
            ...
            const m = (e) => {
                ...
                O =
                    ...
                    (t, s, { api: n }) => {
                        ...
                        null === M && (M = []);
                        const [P] = A.m3(f, M),
                            { mediaFile: b, mediaMetadata: w } = P || {},
                            L = v.length > 0 && v.join(","),
                            x = {};
                        b && b.isGif ? (x.extraInitParams = "&media_category=dm_gif") : b && b.isVideo && (x.extraInitParams = "&media_category=dm_video");
                        const V = A.$i(M, x),
                            Z = [t(V)],
                            B = U(f, S),
                            { found_media_origin: j } = B || {};
                        return (
                            b && b.isGif && Z.push((0, r.R)(b)),
                            Promise.all(Z).then(
                                ([[s], a]) => {
                                    const r = w?.altText || w?.defaultAltText || "",
                                        O = !!r;
                                    let v;
                                    (j || O) && (v = { media_id: s.uploadId, found_media_origin: j, ...(!!O && { alt_text: { text: r || "" } }) }), b?.isVideo && _ && (v = { media_id: s.uploadId, allow_download_status: { allow_download: "true" } });
                                    return (s && v ? t(A.o6(v)) : Promise.resolve()).then(
                                        () => {
                                            ...
                                            const f = (0, i.Z)([H(S), { type: l.H_.REQUEST }, { type: "rweb/dmComposer/SEND_MESSAGE_REQUEST" }, S && (0, E.px)(S, y, O)]);
                                            return (
                                                t(f),
                                                n
                                                    .withEndpoint(d.Z)
                                                    ...
                                                    .then(
                                                        ...
                                                        (e) => {
                                                            const s = m({ attachment: _, conversation_id: S, error: !0, id: y, localMediaId: M, recipient_ids: L, sender_id: p, text: C }),
                                ...
                                (e) => (t((0, i.Z)([(0, o.Z)(M) && F(S, M), Q(S)])), Promise.reject(e)),
                            )
                        );
                    },
                v = (e, t) => e[p][t],
                ...
                M = (e, t) => ({ type: f, conversationId: e, cardUrl: t }),
                h = (e, t) => {
                    const s = v(e, t);
                ...
                Z = (e) => ({ type: V, conversationId: e }),
                B = "rweb/dmComposer/REMOVE_MEDIA",
                j = (e) => ({ type: B, conversationId: e }),
                F = (e, t) => (s) => {
                    s(A.WU(t)), s([Z(e), j(e)]);
                },
        ...
        550293: (e, t, s) => {
            s.d(t, { DO: () => E, VP: () => p, bi: () => A, gw: () => c, kX: () => _ });
            var n = s(499627),
                a = s(511582);
            const r = "rweb.dmDrawerVisibility",
                i = { poppedOutConversationId: null, drawerVisibility: a.S.COLLAPSED },
                o = "dmDrawer";
            const d = (e) => e[o],
                c = (e) => d(e).poppedOutConversationId,
                _ = (e) => d(e).drawerVisibility,
                u = "rweb/dmDrawer/POP_OUT_CONVERSATION",
                E =
                    (e) =>
                    (t, s, { userPersistence: n }) => (n.set(r, { visibility: a.S.EXPANDED }), t({ payload: { conversationId: e }, type: u })),
                I = "rweb/dmDrawer/SET_DRAWER_VISIBILITY",
                l = (e) => ({ payload: { visibility: e }, type: I }),
                A =
                    (e) =>
                    (t, s, { userPersistence: n }) => (n.set(r, { visibility: e }), e === a.S.CLOSED && t({ type: u }), t(l(e))),
                p =
                    () =>
            ...
            n.Z.register({
                [o]: function (e = i, t) {
                    ...
                    switch (t.type) {
                        case u:
                            return t.payload ? { ...e, poppedOutConversationId: t.payload.conversationId, drawerVisibility: a.S.EXPANDED } : e;
                        case I:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-78eb13f6.72719f7a.js.map
