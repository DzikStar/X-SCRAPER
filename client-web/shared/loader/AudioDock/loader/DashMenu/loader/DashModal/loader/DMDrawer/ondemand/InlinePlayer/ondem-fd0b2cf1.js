...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-fd0b2cf1"],
    {
        ...
        838859: (e, t, n) => {
            ...
            const I = (0, f.v)((e, t) => {
                    const n = [t(E), t(M), t(j), t(P), t(L), t(T), t(O), t(Y), t(B), t(q), t(K), t(N)];
                    return () => {
                        n.forEach((e) => e());
                    };
                }),
        ...
        509599: (e, t, n) => {
            n.d(t, { C: () => T, CP: () => J, F$: () => K, FG: () => $, Go: () => B, Ix: () => C, PO: () => A, RS: () => F, Xn: () => G, ZO: () => O, cS: () => N, d3: () => E, jQ: () => W, jm: () => H, lw: () => D, of: () => V, p5: () => U, qH: () => X, qx: () => R, sJ: () => Y, tq: () => k, zX: () => Z });
            n(571372);
            var r = n(202784),
                s = n(961111),
                o = n.n(s),
            ...
            const L = (0, a.xu)((e) => (0, i.cn)((t) => t(k(e).resolved)?.media_key)),
                ...
                q = (0, a.xu)((e) => (0, w.K9)((t) => t(B(e)).then((n) => n.getCallStatus(e, t(m.fU))))),
                F = (0, i.cn)((e) => {
                    const t = e(m.rm);
                    return t ? (e(q(t).resolved)?.guest_sessions ?? []) : [];
                }),
                K = (0, i.cn)((e) => new Set(e(F).map(({ twitter_user_id: e }) => e))),
                N = (0, i.cn)((e) => {
                    const t = new Map();
                    return (
                        e(F).forEach((e) => {
                ...
                U = (0, i.cn)((e) => {
                    const t = e(F).find((t) => t.guest_user_id === e(S.t9));
                    return t?.is_employee ?? !1;
                }),
                J = (0, a.xu)((e) =>
                    (0, w.K9)((t) =>
                        t(q(e)).then(({ guest_sessions: e }) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.InlinePlayer~ondem-fd0b2cf1.71c2cffa.js.map
