...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.AudioDock~loader.Dock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.Inline-4dc04b0b", "icons/IconMediaDock-js", "icons/IconPlus-js"],
    {
        797553: (t, e, i) => {
            ...
            class I extends s.Component {
                    ...
                    super(t, e),
                        ...
                        (this._updatePosition = () => {
                            ...
                            const { height: h, left: d, top: c, width: u } = l,
                                ...
                                I = this.props.preferredVerticalOrientation,
                                E = ((t, e) => (t && "center" !== e ? ("left" === e ? "right" : "left") : e))(t, this.props.preferredHorizontalOrientation),
                                S = this.state.verticalOrientation || (({ canOrientDown: t, canOrientUp: e, verticalPreference: i }) => ((e && t) || (!e && !t) ? i : e ? "up" : "down"))({ verticalPreference: I, canOrientUp: _, canOrientDown: y }),
                                O = this.state.horizontalOrientation || (({ canOrientCenter: t, canOrientLeft: e, canOrientRight: i, horizontalPreference: n }) => ("center" === n && t ? "center" : !e || ("left" !== n && i) ? "right" : "left"))({ horizontalPreference: E, canOrientLeft: f, canOrientRight: w, canOrientCenter: b }),
                ...
                render() {
                    const { animateInDuration: t, animateType: e, children: i, contentStyle: o, disableMask: a, isFixed: h, onDismiss: u, preventFocusShift: I, withKeyboardNavigation: E } = this.props,
                        ...
                        ({ direction: t }) => (
                            ...
                            s.createElement(
                                ...
                                s.createElement(
                                    f.Z.Dropdown,
                                    null,
                                    s.createElement(m.Z.Consumer, null, (e) => s.createElement(w.Z.Consumer, null, ({ isModal: i }) => s.createElement(p.Z, { history: e, isModal: i, onDismiss: u }, I ? N(t) : s.createElement(c.Z, null, s.createElement(x, null, N(t)))))),
                                ),
                            )
                        ),
                    );
            ...
            I.defaultProps = { preferredHorizontalOrientation: "left", preferredVerticalOrientation: "down", animateType: "slide", animateInDuration: "normal", withKeyboardNavigation: !0 };
        },
        393058: (t, e, i) => {
            i.d(e, { Z: () => o });
            const n = {},
        ...
        194504: (t, e, i) => {
            ...
            class R extends n.Component {
                    ...
                    super(...t),
                        ...
                        (this._getLeftOffset = (t) => {
                            const e = this._list.current,
                                ...
                                s = this._isRTL();
                            let o = 0;
                            return (o = s ? (E(s) && s ? -1 * Math.min(0, i) : -1 * Math.min(0, i - (n - t))) : i), Math.ceil(o);
                        }),
                ...
                _renderPreviousButton(t) {
                    ...
                    return n.createElement(s.Z, { onClick: this._handlePreviousClick, style: [x.navButton, u, o, d && x.hiddenNavButton, !p.Z.reducedMotionEnabled && x.navButtonAnimation], testID: "ScrollSnap-prevButtonWrapper" }, n.createElement(m.ZP, { "aria-label": I, disabled: d, dominantColor: e, icon: c, onClick: this._handlePreviousClick, onLayout: this._handleButtonLayout, type: "onMediaDominantColorFilled" }));
                }
                _renderNextButton(t) {
            ...
            class d {
                ...
                _sendXhr(t, e, i, n, s, r, a, h, d = 0) {
                    ...
                    const m = new Date(),
                        ...
                        v = (t) => {
                            this._stats(e, t || "unknown-error", { requestStartTime: m, segmentBytes: d }), "function" == typeof s && s(I(y) || { code: w.INVALID_RES_STATUS, mediaId: this.mediaId });
                        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.AudioDock~loader.Dock~loader.DashMenu~loader.DashModal~loader.DMDrawer~ondemand.Inline-4dc04b0b.bb61d5ca.js.map
