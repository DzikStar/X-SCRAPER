...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5"],
    {
        ...
        759469: (e, t, n) => {
            ...
            const F = (e) => {
                    if (e.result?.legacy) return { id_str: e.result.id, profile_image_url_https: e.result.legacy.profile_image_url_https || "", protected: e.result.legacy.protected || !1, verified: e.result.legacy.verified || !1, is_blue_verified: !!e.result.is_blue_verified, name: e.result.legacy.name || "", screen_name: e.result.legacy.screen_name || "" };
                },
                U = ({ component: e }) => {
                                ...
                                switch (e.__typename) {
                                    ...
                                    case "CardTwitterListDetailsComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            ...
                                            r && r.legacy && (d = { id_str: r.id, profile_image_url_https: r.legacy.profile_image_url_https || "", protected: !!r.legacy.protected, verified: !!r.legacy.verified, is_blue_verified: !!r.is_blue_verified, name: r.legacy.name || "", screen_name: r.legacy.screen_name || "" });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5.65cee79a.js.map
