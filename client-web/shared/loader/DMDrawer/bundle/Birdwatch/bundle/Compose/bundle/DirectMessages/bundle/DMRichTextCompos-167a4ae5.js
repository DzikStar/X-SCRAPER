    ...
    ["shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5"],
    {
            ...
            const y = (e, t) => t.tweetId,
                ...
                I = (0, p.Z)()
                    ...
                    const { featureSwitches: h, viewerUserId: T } = a.useContext(c.rC),
                        b = (0, l.z)(),
                        g = _?.community_id_str;
                    a.useEffect(() => {
                        g && (0, r.Z)(e) && n(g).catch(t());
                    }, [e, g, t, n]);
        ...
        734408: (e, t, n) => {
            ...
            const w = ({ cardId: e, cardType: t, converterOptions: n, data: i }) => {
                ...
                var z;
                const Z = B?.data.media_list.some((e) => e.id && M[e.id] && ("uc_video" === M[e.id].type || "animated_gif" === M[e.id].type));
                Z && B && (W[l.Fw.SWIPEABLE_MEDIA_STATIC] = { type: l.Qe.SWIPEABLE_MEDIA, data: { media_list: B.data.media_list.map((e) => ({ destination: e.destination, id: f(e.id), overlay: { type: l._5.PLAY } })) } });
                const Q = [...(k.length ? k : []), ...(Z ? [l.Fw.SWIPEABLE_MEDIA_STATIC] : []), ...U.filter((e) => !(K.includes(e) || (Z && e === H)))];
                return { cardState: l.uW.DEFAULT, layout: { [l.uW.DEFAULT]: { size: "large" }, [l.uW.CONDENSED]: { size: "large" }, [l.uW.STATIC]: { size: "large" } }, card: { card_name: t, displayOptions: { shouldAutoAdvance: h(s) }, on_visibility: { scribe: "show" }, id: e, components: { [l.uW.DEFAULT]: U, [l.uW.STATIC]: Q }, destinations: R, media_entities: { ...M, ...F }, components_data: W, ucLayout: L, experiment_signals: S } };
            };
        },
        759469: (e, t, n) => {
            n.d(t, { gb: () => z, ZP: () => Z });
                ...
                j = (e) => {
                    switch (e.__typename) {
                        ...
                        case "CardAppStoreWithDockedMediaDestination":
                            return { type: "browser", data: { url_data: { url: R(e.app_store_data) || g.$H }, scribe: f.bQ.UC_APP_STORE_OPEN_LINK, promoted_log: f.YE.UNIFIED_CARD_COMPONENT_APP_STORE_CLICK } };
            ...
            const F = (e) => {
                ...
                W = ({ component: e, componentDataIndex: t, componentIndex: n, slideIndex: i }) => {
                    ...
                    const r = L("media", i, n),
                        d = [r],
                        l = {},
                        c = { type: g.Qe.MEDIA, data: { destination: o, id: e.media.media_id } };
                    l[r] = c;
                                ...
                                switch (e.__typename) {
                                    ...
                                    case "CardFacepileComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            ...
                                            const s = e.users_results ? e.users_results.map(F).filter(Boolean) : [],
                                                r = L("facepile", n, t),
                                                d = { type: g.Qe.FACEPILE, data: { facepileUsers: s.reduce((e, t) => ({ ...e, [t.id_str]: t }), {}), total_user_count: e.total_user_count, type: e.user_relationship_type, destination: a } };
                                    ...
                                    case "CardAppStoreDetailsComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            const i = L("app_store_details", n, t),
                                                ...
                                                c = { type: g.Qe.APP_STORE_DETAILS, data: { title: d, footer: l, destination: a } };
                                                ...
                                                o = {
                                                    ...
                                                    data: {
                                                        buttons: e.buttons.map((e, a) => {
                                                            ...
                                                            return (i[s] = r), { type: f.lW.GENERIC, data: { index: a + 1, icon: e.icon_type?.toLowerCase(), destination: s, cta: "Cta" === e.button_type ? v.v.getCtaString(e.action || "") : e.text ? e.text.content : "", is_rtl: "Custom" === e.button_type ? e.text?.is_rtl : void 0, isAppDetails: o === g.TW.APP_STORE || o === g.TW.APP_STORE_WITH_DOCKED_MEDIA, styleType: M(e.style) } };
                                                        }),
                                                    },
                                                };
                                    ...
                                    case "CardDetailsComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            const i = L("details", n, t),
                                                ...
                                                o = e.destination_obj ? j(e.destination_obj) : {},
                                                s = { [a]: o },
                                                r = { type: g.Qe.DETAILS, data: { title: e.title, destination: a } };
                                    ...
                                    case "CardSwipeableMediaComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            ...
                                            e.full_media_list &&
                                                e.full_media_list.forEach((e, i) => {
                                                    ...
                                                    if ((a.push(l), (o = { ...o, ...d.destinationObjects }), (s = { ...s, ...d.mediaEntities }), "ApiVideo" === e.media.media_info?.__typename)) {
                                                        const e = { destination: d.destinationKey, id: x(d.mediaEntityKey), overlay: { type: g._5.PLAY } };
                                                        r.push(e);
                                                    }
                                            ...
                                            const d = { type: g.Qe.SWIPEABLE_MEDIA, data: { media_list: a } },
                                                l = { [i]: d };
                                            return r.length && (l[g.Fw.SWIPEABLE_MEDIA_STATIC] = { type: g.Qe.SWIPEABLE_MEDIA, data: { media_list: r } }), { componentKeys: [i], staticComponentKeys: r.length ? [g.Fw.SWIPEABLE_MEDIA_STATIC] : [i], destinationObjects: o, mediaEntities: s, componentsData: l };
                                        })({ component: e, slideIndex: t, componentIndex: i });
                                        break;
                                    case "CardTwitterListDetailsComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            ...
                                            const l = { type: g.Qe.TWITTER_LIST_DETAILS, data: { title: e.name, destination: a, memberCount: e.member_count, attribution: r } };
                                ...
                                if ("CardMediaWithDetailsHorizontal" === t?.__typename)
                                    return (({ cardId: e, cardType: t, component: n }) => {
                                        ...
                                        const o = { [i]: a },
                                            ...
                                            l = { type: g.Qe.TOPIC_DETAILS, data: { destination: i, ...(r?.content ? { description: { ...r } } : null), title: { content: d?.content || "", is_rtl: d?.is_rtl || !1 } } },
            ...
            const B = Object.freeze({
                    ...
                    [g.sj.BROADCAST]: { conversionHandler: r.K, shouldRenderCard: r.Q },
                    [g.sj.DIRECT_STORE_LINK_APP]: { conversionHandler: d.T, shouldRenderCard: d.B },
                    [g.sj.IMAGE_DIRECT_MESSAGE]: { conversionHandler: l.a, shouldRenderCard: l.R },
                    [g.sj.LIVE_EVENT]: { conversionHandler: c.q, shouldRenderCard: c.C },
                    [g.sj.MESSAGE_ME]: { conversionHandler: _.I, shouldRenderCard: _.i },
                            ...
                            const o = (0, H.FL)(i, "image_value", "player_image_original"),
                                ...
                                l = (e) =>
                                    [1, 2, 3, 4]
                                        ...
                                        .filter(Boolean),
                                c = l(g.Fw.DESTINATION),
                                _ = l(g.Fw.DESTINATION_STATIC),
                                p = (0, H.N8)(i, "user_value", "recipient"),
                                m = p && a[p.id_str],
                                u = p.id_str !== n.tweetUserId && m;
                            return { cardState: g.uW.DEFAULT, layout: { [g.uW.DEFAULT]: { size: "large" }, [g.uW.CONDENSED]: { size: "large" }, [g.uW.STATIC]: { size: "large" } }, card: { card_name: t, on_visibility: { scribe: "show" }, id: e, components: { [g.uW.DEFAULT]: [g.Fw.MEDIA, ...(u ? [g.Fw.DETAILS] : []), g.Fw.BUTTON_GROUP], [g.uW.STATIC]: [g.Fw.MEDIA_STATIC, ...(u ? [g.Fw.DETAILS] : []), g.Fw.BUTTON_GROUP_STATIC] }, destinations: { [g.Fw.DESTINATION]: { type: g._g.ACTION, data: { action_data: { persist: !1, type: "dm", recipient: p.id_str }, auth_required: !0, scribe: "click", promoted_log: f.YE.DM_BUTTON_CLICK } }, [g.Fw.DESTINATION_STATIC]: { type: g._g.BROWSER, data: { url_data: { url: n.tweetPermalink || g.$H }, scribe: "open_link", promoted_log: f.YE.CARD_URL_CLICK } } }, media_entities: { [g.Fw.IMAGE_ENTITY]: (0, H.WW)(o || {}), [g.Fw.VIDEO_ENTITY]: { type: "video", aspect_ratio: r, content_id: (0, H.SI)(i, "string_value", "player_content_id") || (0, H.cT)(s), ...(d ? { duration_ms: 1e3 * parseInt(d, 10) } : null), vmap_url: s, poster_image: o, publisher_id: (0, H.SI)(i, "string_value", "player_owner_id") || n.tweetUserId, variants: [{ src: (0, H.SI)(i, "string_value", "player_hls_url"), type: "application/x-mpegURL" }] } }, components_data: { [g.Fw.MEDIA]: { type: g.Qe.MEDIA, data: { id: g.Fw.VIDEO_ENTITY } }, [g.Fw.MEDIA_STATIC]: { type: g.Qe.MEDIA, data: { id: g.Fw.IMAGE_ENTITY, destination: g.Fw.DESTINATION_STATIC } }, ...(u ? { [g.Fw.DETAILS]: { type: g.Qe.DETAILS, data: { attribution: m } } } : null), [g.Fw.BUTTON_GROUP]: { type: g.Qe.BUTTON_GROUP, data: { buttons: c } }, [g.Fw.BUTTON_GROUP_STATIC]: { type: g.Qe.BUTTON_GROUP, data: { buttons: _ } } } } };
                        },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5.2efd9afa.js.map
