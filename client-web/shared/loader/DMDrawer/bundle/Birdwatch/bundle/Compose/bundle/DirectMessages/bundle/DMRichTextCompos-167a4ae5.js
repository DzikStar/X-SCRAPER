    ...
    ["shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5"],
    {
        ...
        734408: (e, t, n) => {
            ...
            const c = { media: !0, details: !0, button_group: !0, app_store_details: !0, swipeable_media: !0, twitter_list_details: !0, community_details: !0, job_details: !0, dpa_details: !0, grok_share: !0, media_with_details_horizontal: !0 },
                ...
                I = (e) => {
                    const { destination: t, employment_type: n, formatted_salary: i, formatted_salary_max: a, formatted_salary_min: o, location: s, profile_user: r, salary_interval: d, salary_max: _, salary_min: c, short_description: p, title: m } = e.data;
                    return { type: l.Qe.JOB_DETAILS, data: { destination: t, employment_type: n, formatted_salary: i, formatted_salary_min: o, formatted_salary_max: a, location: s, profile_user: r, salary_interval: d, salary_max: _, salary_min: c, short_description: p, title: m } };
                },
                C = (e, t) => {
                    let n = !1,
                        i = !1;
            ...
            const S = ({ cardId: e, cardType: t, converterOptions: n, data: i }) => {
                ...
                const { app_store_data: C, component_objects: v, components: D, destination_objects: S, experiment_signals: w, layout: L, media_entities: x, users: P } = s,
                    R =
                        ((N = S),
                        (j = C),
        ...
        759469: (e, t, n) => {
            ...
            const D = "AndroidApp",
                ...
                P = (e) => {
                    const t = (t) => t.map((t) => e.find(({ type: e }) => e === t)).find(Boolean);
                    return "android" === v.v.getMobileOS() ? t([D, O, S]) : t([O, S, D]);
                },
                R = (e) => {
                    const t = P(e);
                    if (!t) return;
            ...
            const F = (e) => {
                ...
                W = ({ component: e, componentDataIndex: t, componentIndex: n, slideIndex: i }) => {
                    ...
                    return { componentKeys: d, staticComponentKeys: m, destinationObjects: a, mediaEntities: { [c.key]: c.entity, [p.key]: p.entity }, componentsData: l, destinationKey: o, mediaEntityKey: c.key };
                },
                k = (e) => {
                                    ...
                                    case "CardAppStoreDetailsComponent":
                                        a = (({ component: e, componentIndex: t, slideIndex: n }) => {
                                            const i = L("app_store_details", n, t),
                                                ...
                                                _ = { type: b.Qe.APP_STORE_DETAILS, data: { title: d, footer: l, destination: a } };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5.39f0964a.js.map
