    ...
    ["shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5", "icons/IconAward-js"],
    {
        ...
        301758: (e, t, n) => {
            ...
            const y = (e, t) => t.tweetId,
                ...
                I = (0, p.Z)()
                    ...
                    const { featureSwitches: h, viewerUserId: g } = a.useContext(c.rC),
                        T = (0, l.z)(),
        ...
        734408: (e, t, n) => {
            ...
            const w = ({ cardId: e, cardType: t, converterOptions: n, data: i }) => {
                ...
                const { app_store_data: C, component_objects: A, components: D, destination_objects: w, experiment_signals: S, layout: L, media_entities: x, users: P } = s,
                    R =
                        ((N = w),
                        (j = C),
                                                ...
                                                o = {
                                                    ...
                                                    data: {
                                                        buttons: e.buttons.map((e, a) => {
                                                            ...
                                                            return (i[s] = r), { type: f.lW.GENERIC, data: { index: a + 1, icon: e.icon_type?.toLowerCase(), destination: s, cta: "Cta" === e.button_type ? A.v.getCtaString(e.action || "") : e.text ? e.text.content : "", is_rtl: "Custom" === e.button_type ? e.text?.is_rtl : void 0, isAppDetails: o === b.TW.APP_STORE || o === b.TW.APP_STORE_WITH_DOCKED_MEDIA, styleType: M(e.style) } };
                                                        }),
                                                    },
                                                };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.Birdwatch~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompos-167a4ae5.507fe38a.js.map
