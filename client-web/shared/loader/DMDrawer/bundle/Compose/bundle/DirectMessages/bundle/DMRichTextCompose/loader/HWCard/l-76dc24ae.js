        ...
        260137: (e, d, a) => {
            ...
            class O extends n.Component {
                ...
                render() {
                    ...
                    return d ? n.createElement(E.Z, { ratio: e }, n.createElement(y.Z, { style: M.default.absoluteFill }, n.createElement(g.Z, { "aria-label": G, fetchStatus: a, onRequestRetry: this._handleFetchTweet, render: this._renderInlinePlayer }))) : null;
                }
            }
            O.contextType = C.rC;
            const U = L(O);
                ...
                ke = (0, v.ZP)(
                    we((e) => {
                        ...
                        const h = se.Z.getOriginalTweet(l),
                            ...
                            y = M.default.isDarkMode() ? "translucentWhite35" : "gray200";
                        return n.createElement(ce.ZP, { "aria-label": m ? ye : ve, borderColor: y, icon: m ? Me : ge, onClick: f, size: p ? "medium" : "large" });
                    }),
                );
            var Ie = a(632658),
                Te = a(23134);
                    ...
                    super(e, d),
                        ...
                        (this._handleScribeEvent = ({ action: e, cardName: d, carouselEventDetails: a, clickContext: r, componentType: n, ctaIndex: l, element: s, isAuthRequired: c, isMessageMe: u }) => {
                            ...
                            const f = p && this._isLiveEventCard() ? t.default.getBindingValue(p.binding_values, "event_id") : void 0,
                                y = { ...(C ? { element: C } : null), action: S, data: { ...(v && { click_tracking_embed_details: v }), items: [{ ...w.Z.getHWCardItem({ action: S, adFreeLabelEligible: !1, componentType: n, cardName: d, carouselEventDetails: a, clickContext: r, ctaIndex: l, impressionId: A, isDataSaverEnabled: h, isUCAppInstall: "unified_card_app_store_open_link" === e, liveEventId: f, tweetId: _.tweetId, tweetUserId: _.tweetUserId, ...(u ? { viewingUserId: D } : null) }) }] } };
                            b.scribe(y);
                        }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompose~loader.HWCard~l-76dc24ae.f2a5a42a.js.map
