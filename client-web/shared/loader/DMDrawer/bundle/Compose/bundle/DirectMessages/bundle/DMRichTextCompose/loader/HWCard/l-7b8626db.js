...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.DMDrawer~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompose~loader.HWCard~l-7b8626db", "icons/IconItalic-js", "icons/IconNewsStroke-js", "icons/IconNumberedList-js", "icons/IconRatingNoMargin-js"],
    {
        705048: (e, t, a) => {
            a.d(t, { Z: () => D });
            var r = a(202784),
            ...
            const Z = n().e82adfeb,
                ...
                D = ({ continueInGrokEnabled: e, conversation: t, destination: a, mediaVisibilityResults: l, metadata: n, openGrok: w }) => {
                    ...
                    const j = (t[U].deepsearch_headers && t[U].deepsearch_headers.length > 0) || (t[U].deepsearchHeaders && t[U].deepsearchHeaders.length > 0),
                        ...
                        N = t[O].mediaUrls[0],
                        A = t[U].mediaUrls[0],
                        J = l?.blurred_image_interstitial?.title.text,
                        G = l?.blurred_image_interstitial?.text.text,
                        q = () => (A ? n?.text || S : n?.text ? n.text : "FUN" === t[O].grokMode ? R : T);
                    return r.createElement(m.Z, { componentType: "grok_share", destinationKey: a }, ({ link: a, onClick: l }) =>
                        r.createElement(
                            r.Fragment,
                            null,
                            r.createElement(
                                s.Z,
                                { style: A ? B.rootImage : B.root },
                                r.createElement(
                                    g.Z,
                                    {
                                        interactive: !1,
                                    ...
                                    A ? null : r.createElement(s.Z, { style: [A ? B.paddingImage : B.padding, B.header] }, r.createElement(s.Z, { style: B.headerContent }, N ? r.createElement(s.Z, { style: B.blurContainer }, r.createElement(h.Z, { source: { uri: N }, style: [B.headerImage, y ? B.blur : void 0] })) : null, r.createElement(s.Z, { style: B.headerTextContent }, t[0] && t[0].analysis_post ? r.createElement(s.Z, { style: B.quoteTweetContainer }, r.createElement(f.Z, { isCondensed: !0, shouldShowBorder: !1, tweet: t[0].analysis_post, withLink: !1 })) : r.createElement(c.ZP, { numberOfLines: 1, size: "headline2", style: B.headerText, weight: "bold" }, F), r.createElement(c.ZP, { color: "gray900", size: "subtext2" }, q())))),
                                    r.createElement(
                                        s.Z,
                                        { style: A ? B.contentImage : B.content },
                                        A
                                            ? r.createElement(r.Fragment, null, r.createElement(h.Z, { source: { uri: A }, style: B.image }), r.createElement(s.Z, { style: B.imageOverlay }, r.createElement(c.ZP, { color: "white", numberOfLines: 1, size: "headline2", weight: "bold" }, F), r.createElement(c.ZP, { color: "white", size: "subtext2" }, q())), y ? r.createElement(s.Z, { style: B.sensitiveContent }, r.createElement(o.default, { style: B.blurIcon }), r.createElement(s.Z, { style: B.sensitiveLabels }, J ? r.createElement(c.ZP, { color: "whiteOnColor", size: "body", weight: "bold" }, J) : null, G ? r.createElement(c.ZP, { color: "whiteOnColor", size: "body" }, G) : null), r.createElement(d.ZP, { onPress: x, type: "onMediaLightFilled" }, $)) : null)
                                            : r.createElement(u.Z, null, ({ isHovered: e }) =>
                                                  r.createElement(
                                                      s.Z,
                                                      { style: B.paddingBody },
                                                      j
                                                      ...
                                                      P || j
                                                          ? r.createElement(
                                                                c.ZP,
                                                                {
                                                                    color: "link",
                                                                    onClick: (e) => {
                                                                        !j && W <= 8 && (e.stopPropagation(), e.preventDefault(), H(W + 24));
                                                                    },
                            ...
                            e && void 0 !== C
                                ? r.createElement(
                                      d.ZP,
                                      {
                                          ...
                                          onPress: () => {
                                              Z.scribe({ element: "grok_create_your_version", action: "click", data: { event_source: C, tweet_id: I } }), w?.({ text: F, imageUrl: N, autoSubmit: !0, source: "grok_share_card" + (A ? "_image" : "_text") });
                                          },
                                          style: B.footer,
                                          type: "primaryFilled",
                                      },
                                      r.createElement(c.ZP, { size: "body", style: B.labelBtnPadding, weight: "bold" }, A ? M : L),
                                  )
                                : null,
                        ),
                    );
        ...
        362075: (e, t, a) => {
            ...
            class d extends s.Component {
                ...
                render() {
                    const { allowClipboardWrite: e, allowForms: t, allowTopNavigation: a, dangerouslyDisableSandbox: r, src: i, style: c, title: d } = this.props,
                        ...
                        u = (0, o.Z)("iframe", { allow: `${h.join("; ")}`, allowFullScreen: !0, onLoad: this.props.onLoad, ref: this._handleRef, src: (0, n.ju)(i), style: p.iframe, title: d, ...(r ? null : { sandbox: `allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts${t ? " allow-forms" : ""}${a ? " allow-top-navigation" : ""}` }) });
                    return s.createElement(l.Z, { style: m ? [p.root, p.modalPadding, c] : [p.root, c] }, u);
                }
            }
            d.contextType = i.t;
            const p = c.default.create((e) => ({ root: { overflow: "auto", WebkitOverflowScrolling: "touch" }, modalPadding: { paddingTop: e.componentDimensions.appBarHeight }, iframe: { borderWidth: 0, flexGrow: 1 } })),
                m = s.forwardRef((e, t) => s.createElement(d, (0, r.Z)({ forwardedRef: t }, e)));
        },
        65042: (e, t, a) => {
            a.d(t, { Z: () => I });
            var r = a(202784),
            ...
            const b = ({ displayType: e }) => {
                ...
                v = (e) => {
                    ...
                    const { is_blue_verified: s, name: l, profile_image_url_https: n, screen_name: o, verified: i, verified_type: d } = a,
                        ...
                        m = !!o,
                        g = r.createElement(u.Z, { isBlueVerified: s, isVerified: i, name: l, screenName: o || "<none>", verifiedType: d, weight: p, withScreenName: m });
                    return (({ displayType: e }) => "carousel" === e)(e) && n ? r.createElement(c.Z, { avatarCell: r.createElement(h.default, { shape: "square", size: "small", uri: n }), avatarCellStyle: _.avatarCell, avatarSize: "small", style: _.avatarRow }, g) : g;
                },
                E = (e) => {
                    const { location: t } = e;
                ...
                x = (e) => {
                    ...
                    return a || t ? r.createElement(s.Z, { style: _.metaRow }, a ? r.createElement(s.Z, { style: _.withIcon }, w(e) ? r.createElement(i.ZP, { color: "gray700", size: "body" }, r.createElement(n.default, null)) : null, r.createElement(i.ZP, { color: "gray700" }, (0, f.M)(a, l))) : null, t ? r.createElement(s.Z, { style: _.withIcon }, w(e) ? r.createElement(i.ZP, { color: "gray700", size: "body" }, r.createElement(o.default, null)) : null, r.createElement(i.ZP, { color: "gray700" }, g.eo[t])) : null) : null;
                },
                Z = ({ shortDescription: e }) => {
                    const t = (0, f.G)(e);
                    return t ? r.createElement(s.Z, { style: _.richTextWrapper }, r.createElement(p.Z, { contentState: t })) : null;
                },
                _ = m.default.create((e) => ({ job: { display: "flex", flexDirection: "column", gap: e.spaces.space8 }, carouselJob: { display: "flex", flexDirection: "column", gap: e.spaces.space8 }, fullMeta: { gap: "inherit" }, carouselMeta: { gap: "inherit" }, compactMeta: { display: "flex", flexDirection: "row", alignItems: "center", gap: e.spaces.space12 }, withIcon: { display: "flex", flexDirection: "row", alignItems: "center", gap: e.spaces.space4 }, locationWithIcon: { display: "flex", flexDirection: "row", alignItems: "center", gap: e.spaces.space4, flex: 1 }, elidedText: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, dontShrinkMeBro: { display: "flex", flexShrink: 0 }, metaRow: { display: "flex", flexDirection: "row", alignItems: "center", gap: e.spaces.space12 }, richTextWrapper: { color: e.colors.gray900, fontSize: e.fontSizes.body, fontFamily: e.fontFamilies.normal, fontWeight: e.fontWeights.regular, marginTop: e.spaces.space12 }, avatarRow: { alignItems: "center" }, avatarCell: { flexBasis: e.spaces.space12 } })),
                I = (e) => {
        ...
        89217: (e, t, a) => {
            ...
            const l = s().c69eb656,
                ...
                d = s().f8337bd6,
                p = s().i935bf88,
                m = Object.freeze({ 1: d, 2: p }),
                h = Object.freeze({ annually: { label: d, value: 1 }, hourly: { label: p, value: 2 } });
        },
        457458: (e, t, a) => {
            a.d(t, { G: () => c, M: () => i });
            a(571372);
        ...
        856661: (e, t, a) => {
            ...
            const o = (e = {}) => {
                ...
                return (0, s.Z)("svg", { ...e, role: e["aria-label"] ? e.role || "img" : void 0, "aria-hidden": void 0 === e["aria-label"], style: [n.Z.root, e.style], viewBox: "0 0 24 24", children: r.createElement("g", null, r.createElement("path", { d: "M9 6h3.731L9.184 18H5v2h10v-2h-3.731l3.547-12H19V4H9v2z" })) }, { writingDirection: t });
            };
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.Compose~bundle.DirectMessages~bundle.DMRichTextCompose~loader.HWCard~l-7b8626db.55699bba.js.map
