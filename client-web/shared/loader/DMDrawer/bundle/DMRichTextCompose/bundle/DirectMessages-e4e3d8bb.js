    ...
    ["shared~loader.DMDrawer~bundle.DMRichTextCompose~bundle.DirectMessages-e4e3d8bb"],
    {
        524084: (e, r, t) => {
            ...
            var o = t(202784),
                n = t(523561),
                a = t(195560);
            const s = (0, n.Z)({ loader: () => t.e("loader.AbsolutePower").then(t.bind(t, 590136)), renderPlaceholder: (e, r) => o.createElement(a.Z, { hasError: e, onRetry: r }) });
        },
        684511: (e, r, t) => {
            t.d(r, { Z: () => o });
            t(202784);
        ...
        847607: (e, r, t) => {
            t.d(r, { Aq: () => u, FK: () => v, GS: () => d, N1: () => m, PY: () => h, X6: () => E, cm: () => i });
            t(202784);
            var o = t(111677),
                n = t.n(o),
                a = t(391366),
        ...
        47743: (e, r, t) => {
            t.d(r, { nO: () => o.nO, YT: () => _, yN: () => E, X2: () => C, FI: () => y });
            var o = t(481681),
                n = t(205074);
            function a(e) {
            ...
            const _ = ({ excludeReplyUser: e, inReplyToStatus: r, viewerUserId: t }) => {
                    ...
                    l.forEach((e) => {
                        ...
                        c.forEach(({ name: e, screen_name: r, user_id: t }) => {
                            f[t] = { id_str: t, name: e, screen_name: r };
                        });
                    const D = (e) => {
                        ...
                        _ = (0, m.Z)((0, p.Z)([...D(d), ...D(i), s.id_str, ...l.flatMap((e) => D(e)), ...c.map((e) => e.user_id)])).filter((e) => e !== t);
                    let E = t && s.id_str === t ? [t, ..._] : _;
                ...
                C = (e, r = !1, t = o.nO) => E({ mixedMediaUploadEnabled: r, maxNumberOfMedia: t })(e),
                y = (e, r = !1) => {
                    const t = e.split(f.V.WordBoundary);
                    return (
                        r && t.pop(),
                        !!t.find((e) => {
        ...
        965728: (e, r, t) => {
            t.d(r, { C_: () => _, I5: () => p, K2: () => D, L$: () => l, Rb: () => f, nk: () => m, sI: () => C, xr: () => v });
            var o = t(202784),
                n = t(483677),
                a = t(782578),
                s = t(393058),
            ...
            const i = (e, r) => `rgba(${e.rgb.red}, ${e.rgb.green}, ${e.rgb.blue}, ${r})`,
                ...
                C = () => {
                    const [e, r] = o.useReducer(E, { isZoomed: !1, showControls: !0 });
                    return {
        ...
        296196: (e, r, t) => {
            ...
            const w = (e) => e[f.Yf].search?.recentSearches,
                I = (e, r) => {
                    const t = e[f.Yf].search?.searchResults;
                    if (t) {
                        const e = t[r];
                ...
                Z =
                    ...
                    (r, t, { api: o }) => {
                        const n = t(),
                            ...
                            v = !!m;
                        m && i && a && (h.cursor = m);
                        const E = u._O(r, { params: h, request: o.withEndpoint(c.Z).search }),
                            C = (e) => {
                                if (e && e.result) {
                        ...
                        return !D || D?.error || s || (a && v) ? E({ actionTypes: _, context: "SEARCH", meta: { query: h.query, cursor: h.cursor, preserveResults: s, fetchNextPage: a } }, C) : (r({ type: "rweb/directMessages/SEARCH_SUCCESS", payload: { result: D }, meta: { query: i, cursor: m } }), Promise.resolve());
                    },
                A =
                    (e) =>
                    (r, t, { featureSwitches: o, userPersistence: n }) => {
                        ...
                        return n.get(D).then((t) => {
                            ...
                            return !o.includes(e) && o.push(e), o.length > a && o.shift(), r(E(o)), n.set(D, { recentSearches: o });
                        });
                    },
                R =
                    (e) =>
                    (r, t, { userPersistence: o }) =>
                        o.get(D).then((t) => {
                            ...
                            return n.splice(n.indexOf(e), 1), r({ payload: n, type: M }), o.set(D, { recentSearches: n });
                        }),
                x =
                    () =>
        ...
        882122: (e, r, t) => {
            ...
            const i = "knownFollowers",
                l = `rweb/${i}`,
                c = [],
                u = (0, a.dg)(l, "FETCH_KNOWN_FOLLOWERS"),
                h = {};
            n.Z.register({
                [i]: function (e = h, r) {
                    if (!r) return e;
            ...
            const m = (e, r) => e[i][r],
                p = (e, r) => {
                    if (r) {
                        const n = _(e, r);
                        return (t = d.ZP.selectMany(e, n)), (o = (e) => !!e), t.filter(o);
                    }
                    var t, o;
                    return c;
                },
                f = (e, r) => p(e, r).filter(({ name: e, profile_image_url_https: r }) => !!r?.length && !!e?.length),
                D = (e, r) => {
                    let t;
                    if (r) {
                        const o = m(e, r);
                        ...
                        void 0 !== D(t(), e)
                            ...
                            : r(
                                  (
                                      (e) =>
                                      (r, t, { api: n }) =>
                                          (0, a._O)(r, { request: n.withEndpoint(o.Z).fetchFollowersYouFollow, params: { user_id: e, count: 3, with_total_count: !0 } })({ actionTypes: u, context: "FETCH_KNOWN_FOLLOWERS", meta: { user_id: e } }, (e) => {
                                              if (e) {
                                                  const { entities: r } = e;
                                                  return r ? [(0, s.dP)(r)] : void 0;
                                              }
                                          })
                                  )(e),
                              );
                ...
                D =
                    ...
                    (a, s, { api: i }) => {
                        const { event: c, impression_id: h } = o,
                            f = `${t}-${r ?? "undefined"}-${h ?? "undefined"}-${c ?? "undefined"}`;
        ...
        818581: (e, r, t) => {
            ...
            const m = (e) => e[i].userPreferences,
                p = () => (e, r) => (r()[i].fetchStatus === s.ZP.LOADED ? Promise.resolve() : e(f())),
                f =
                    () =>
                    (e, r, { api: t }) => {
                        const n = d.x0(r());
        ...
        127218: (e, r, t) => {
            ...
            function _(e, r, t) {
                ...
                return o.useMemo(() => {
                    ...
                    return i ? { subsequentFetchStatus: f.ZP.FAILED, error: i, fetchNext: l, fetchPrevious: m, refetch: D, data: C, hasNext: Boolean(t), hasPrevious: Boolean(o) } : { subsequentFetchStatus: n ? f.ZP.LOADING : f.ZP.NONE, error: void 0, fetchNext: l, fetchPrevious: m, refetch: D, data: C, hasNext: Boolean(t), hasPrevious: Boolean(o) };
                }, [e, C, n, i, _, v, E]);
            }
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DMDrawer~bundle.DMRichTextCompose~bundle.DirectMessages-e4e3d8bb.e3bae4ba.js.map
