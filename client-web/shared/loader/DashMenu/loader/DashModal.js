            ...
            const J = c().a15648a4,
                ...
                Te = ({ analytics: e, featureSwitches: i, onClose: l = P.Z, userClaims: r, viewerUser: c, acceptedFollowerCount: Te, pendingFollowerCount: Ze }) => {
                    ...
                    const Ie = (0, q.v9)(H.Lz),
                        Ae = ({ link: e }) => !(Ie && (("string" == typeof e && ((e.startsWith("/settings") && !De.has(e)) || e.includes("ads.twitter.com") || e.includes("studio.twitter.com") || e.includes("analytics.twitter.com") || e.includes("ads.x.com") || e.includes("studio.x.com") || e.includes("analytics.x.com"))) || ("object" == typeof e && e.pathname.startsWith("/i/flow")))),
                        Re = c?.screen_name || "",
                        qe = (0, a.iv)().width,
                        ...
                        Qi = n.useContext(x.hC),
                        Wi = (0, O.Z)([Ei, D.yw.Lists > Qi && Re ? yi : void 0, D.yw.Premium > Qi && ei ? Fi : void 0, D.yw.PremiumSignup > Qi && qi ? zi() : void 0, D.yw.Bookmarks > Qi ? ki : void 0, D.yw.Payments > Qi && oi ? Ci : void 0, D.yw.Communities > Qi && di ? xi : void 0, D.yw.Articles > Qi && Xe ? fi : void 0, D.yw.CommunityNotes > Qi && He ? gi : void 0, D.yw.Analytics > Qi && _i ? Zi() : void 0, Si, D.yw.VerifiedOrgDash > Qi && Bi && Je ? Oi : void 0, (((!Je || r.isLegacyVerifiedOrg()) && D.yw.VerifiedOrgSignup > Qi) || (r.isVerifiedOrgAffiliate() && !r.isVerifiedOrg())) && i.isTrue("blue_business_vo_nav_for_legacy_verified") ? Pi() : void 0, si ? Ti : void 0, Qe ? vi : void 0, Ze || Te ? hi : void 0, Li, D.yw.Jobs > Qi && ri ? Ai : void 0, void 0, ti ? Ui : void 0, ai ? ji : void 0, Di ? Ii : void 0, Ki]).filter(Ae);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.DashMenu~loader.DashModal.e9b03e1a.js.map
