...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Dock~bundle.Articles~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSp-3ec0edf6"],
    {
        290402: (e, t, i) => {
            i.d(t, { Z: () => y });
            var n = i(807896),
            ...
            const h = c().aa6e3300,
                p = ({ retryMessage: e, ...t }, i) => {
                    ...
                    return r.createElement(o.Z, (0, n.Z)({}, t, { icon: a ? void 0 : r.createElement(d.default, { style: u.icon }), retryMessage: a ? e : h }));
                },
        ...
        959658: (e, t, i) => {
            ...
            var h = i(687103),
                ...
                y = i(952793);
            function m() {
                const e = (0, y.hC)("hashfetti_enabled"),
                    t = (0, y.hC)("hashfetti_all_hashflags"),
                    i = (0, y.D2)("hashfetti_duration_ms").getNumberValue(4e3),
                    n = (0, y.D2)("hashfetti_particle_count").getNumberValue(30),
                    { query: s } = r.useContext(d),
                    o = (0, h.Ck)();
                if (!e || !s || p.Z.reducedMotionEnabled) return null;
                const a = (0, u.Z)(s);
                let l;
                for (const e of a) {
        ...
        638537: (e, t, i) => {
            ...
            const a = r().e40252de,
                ...
                m = (e) => {
                    ...
                    return t && ((r.text = n ? p : c), (r.subText = void 0)), r;
                },
                f = (e) => {
        ...
        324260: (e, t, i) => {
            ...
            const a = Object.freeze({ Pinnable: "Pinnable", Pinned: "Pinned", NotPinnable: "NotPinnable" }),
                ...
                h = { [a.NotPinnable]: "", [a.Pinnable]: r().j9aedfdc, [a.Pinned]: r().c034211a },
                p = { [a.NotPinnable]: "", [a.Pinnable]: r().ie4538b4, [a.Pinned]: r().ad135a24 },
                u = { [a.NotPinnable]: "", [a.Pinnable]: r().ee369efc, [a.Pinned]: r().c3e7f572 },
                y = { [a.NotPinnable]: !1, [a.Pinnable]: !0, [a.Pinned]: !0 },
                m = (e) => !!y[e],
                f = (e) => (e?.content?.id && (0, o.Z)(e.content.id) ? e.content.id : null);
            const _ = "click",
                b = "pinned_reply";
            function g(e, t) {
                const { feedbackAction: i, feedbackEntry: n, feedbackKey: r, pinReply: o, scribe: l, scribeData: c, scribeNamespace: y, unpinReply: g } = t,
        ...
        107914: (e, t, i) => {
            ...
            var n = i(856430),
                ...
                y = i(372703),
                m = i(576513);
            const f = { [m.Z.FEEDBACK_CLOSE]: n.default, [m.Z.FEEDBACK]: r.default, [m.Z.FROWN]: s.default, [m.Z.SMILE]: o.default, [m.Z.MODERATION]: a.default, [m.Z.TOPIC]: l.default, [m.Z.TOPIC_CLOSE]: c.default, [m.Z.FLAG]: d.default, [m.Z.NO]: h.default, [m.Z.SPEAKER]: p.default, [m.Z.SPEAKER_OFF]: u.default },
                _ = { [y.ZP.SeeFewer]: s.default, [y.ZP.SeeMore]: o.default, [y.ZP.DontLike]: s.default },
                b = (e) => {
        ...
        371277: (e, t, i) => {
                    ...
                    const r = new E(),
                        s = (t) => {
                            ...
                            if (n && o) {
                                ...
                                const o = e[t.entryId];
                                if (o && o.length) r.addEntry((0, m.Z)({ entry: t, feedbackKeys: o }), n), r.getIncrementedPosition();
                                else if (n.splice) {
                                    const e = n.splice(t),
            ...
            const w = (e) => {
                    ...
                    return (
                        ...
                        r || t === p.ZP.FAILED ? n.createElement(l.Z, { fetchStatus: t, onRequestRetry: i, render: S.Z }) : n.createElement(A.Z, { style: F.placeholder })
                    );
                },
            ...
            class x {
                constructor(e, t) {
                    ...
                    const i = (e, t) => {
                        ...
                        this._handlerStatusMap.set(e, { handler: i.render ? i : void 0, key: e, loader: i.loader ? i : void 0, strategy: i.loader ? i.strategy : void 0, status: i.render || i.splice || i.isOmitted ? p.ZP.LOADED : p.ZP.NONE });
                    };
                ...
                getFetchStatus() {
                    ...
                    for (let i = 0; i < e.length; i++) {
                        const { status: n } = e[i];
                        if (n === p.ZP.FAILED) return p.ZP.FAILED;
                        if (n === p.ZP.LOADING) return p.ZP.LOADING;
                        n === p.ZP.NONE && (t = !0);
                    }
                    return t ? p.ZP.NONE : p.ZP.LOADED;
                }
                                ...
                                i = (0, R.Z)(
                                    ...
                                    (i) => {
                                        const r = B(e, i, t.handlers[i]),
                                            ...
                                            o = s?.status === p.ZP.LOADING || s?.status === p.ZP.FAILED;
                                        return s && s.loader && o
                                            ? ((a = () => {
                                                  this._loadHandler(s);
                                              }),
                    ...
                    return Promise.all(
                        e.map((e) => {
                            const { type: t } = e,
                                ...
                                s = this._handlerStatusMap.get(r);
                            if (s && !s.handler && s.status !== p.ZP.LOADING && s.loader) return this._loadHandler(s);
                        }),
                    );
                }
                retryAll() {
                    const e = this._filterHandlerInfoBy(({ status: e }) => e === p.ZP.FAILED);
                ...
                _loadHandler(e, t) {
                    ...
                    if (!i && n && r !== p.ZP.LOADING)
                        return (
                            (e.status = p.ZP.LOADING),
                            v()(
                                () =>
                                    n.loader().then(({ default: t }) => {
                                        (e.status = p.ZP.LOADED), (e.handler = "function" == typeof t ? t(n.loaderOptions || {}) : t), H.set(e.key, t);
                                    }),
                                { retries: 4, minTimeout: 2e3, maxTimeout: 5e3 },
                            )
                                .catch((t) => {
                                    (e.status = p.ZP.FAILED), (0, c.ZP)(`Failed to load URT loader for ${e.key}`, { extra: { error: t } });
                                })
                                .finally(() => {
                ...
                _getUnloadedHandlersByStrategy(e) {
                    return this._filterHandlerInfoBy(({ status: t, strategy: i }) => i === e && (t === p.ZP.NONE || t === p.ZP.FAILED));
                }
            }
            x.ssrEagerLoad = P.Z;
            const U = s().i9028824;
            class K extends n.Component {
                            ...
                            const { dismissedEntries: e, entries: t, pinnedEntry: i, preprocessEntryList: n } = this.props,
                                ...
                                s = (({ dismissedEntries: e, entries: t, handlerRegistry: i, pinnedEntry: n }) => {
                                    ...
                                    return (
                                        n && o(n),
                                        t.forEach((t) => {
                                            o(t), t.type === d.ZP.TimelineModule && t.content.displayType === h.u.VerticalGrid && t.content.items.forEach(o);
                                            const i = e[t.entryId];
                                            i && s.push((0, m.Z)({ entry: t, feedbackKeys: i }));
                                        }),
                                        s
                                    );
                ...
                componentDidUpdate(e, t) {
                    ...
                    e.entryConfiguration !== r && this._createAndSubscribeToHandlerRegistryManager(), t.fetchStatus !== s && s === p.ZP.FAILED && (0, c.ZP)("URT HandlerRegistryProvider: Failed to load critical handlers"), (e.entries === n && e.dismissedEntries === i) || this._handlerRegistryManager.loadOnDemand(this._getEntriesNeedingLoad());
                }
                render() {
        ...
        238776: (e, t, i) => {
            ...
            const B = [],
                ...
                ne = (0, C.Z)()
                    .propsFromState(() => ({ activeCover: Y, alert: W, bottomFetchStatus: K, canRefresh: G, dismissedEntries: q, droppedAds: X, entries: H, initialFetchStatus: U, isRestrictedSession: N._S, newTweetsBarContent: te, perfKey: ie, pinnedEntry: V, pollingIntervalMs: Q, previewEntries: x, timelineExist: J, timelineId: j, topFetchStatus: z, unavailableReason: $, wasAtleastOneEntryHoisted: ee }))
            ...
            class pe extends r.PureComponent {
                constructor(e, t) {
                    super(e, t),
                        (this._lastRefresh = -1),
                        (this._render = () => {
                            const { analytics: e, apiErrorHandlerMap: t, bottomFetchStatus: i, createLocalApiErrorHandler: s, dismissedEntries: o, entries: a, entryConfiguration: l, fetchBottom: c, fetchInitial: d, fetchInitialOrTop: h, fetchOptions: p, fetchTopOptions: u, loadingAccessibilityLabel: m, markAllRead: f, olderAtTop: _, onEntriesRendered: g, perfKey: E, pinnedEntry: T, preprocessEntryList: I, processCallback: v, renderUnavailable: k, shouldFetchInitialOnBottomRetry: R, timelineExist: P, timelineRef: D, unavailableReason: A, updateInstreamVideoEntries: Z, withoutHeadroom: S, ...w } = this.props;
                            return r.createElement(
                                r.Fragment,
                                null,
                        ...
                        (this._getForegroundPoller = (e) => {
                            ...
                            return new v.Z(e).interval(() => {
                                ("active" === s.Z.currentState || ((0, p.HD)(t) && !this._shouldSkipPoll())) && this._foregroundPollAction();
                            });
                        }),
            ...
            (pe.defaultProps = { apiErrorHandlerMap: {}, fetchOptions: de, fetchTopOptions: de, entryConfiguration: he, loadingAccessibilityLabel: le, olderAtTop: !1, onEntriesRendered: h.Z, preprocessEntryList: (e) => e, renderEmptyState: () => r.createElement(a.Z, { message: ce }), scroller: m.C, newTweetsPill: _.Z, showLoadingFooter: !0, timelineRef: h.Z, withoutHeadroom: !1 }), (pe.contextType = S.rC);
            const ue = ne((0, I.Z)(pe));
        },
        351322: (e, t, i) => {
            ...
            const f = function (e) {
                ...
                return t && i ? n.createElement(m, e) : e.children;
            };
            i(136728);
            var _ = i(459679),
                b = i(71620),
            ...
            const re = N().gf5e9ea6,
                ...
                oe = (e, { addToast: t, block: i, createLocalApiErrorHandler: n, feedbackActions: r, feedbackEntry: s, feedbackMethods: o, gracefullyReloadTimeline: a, history: l, pinReply: c, richList: d, richTopic: h, richUsers: p, scribe: u, scribeData: y, scribeNamespace: m, setTopicNotInterested: f, toggleListMuting: _, topicFollow: b, topicUnfollow: g, unblock: E, undoTopicNotInterested: T, unpinReply: I }) =>
                    r.map((r) => {
                        const { clientEventInfo: v, excludeFromActionMenu: k, feedbackKey: R, feedbackType: P, prompt: D, subprompt: A } = r,
                            Z = ((e, t) => {
                                const { addToast: i, block: n, createLocalApiErrorHandler: r, feedbackAction: s, feedbackEntry: o, feedbackKey: a, history: l, richList: c, richTopic: d, richUsers: h, scribe: p, scribeData: u, scribeNamespace: y, setTopicNotInterested: m, toggleListMuting: f, topicFollow: _, topicUnfollow: b, unblock: g, undoTopicNotInterested: E } = t;
                                ...
                                if (s.richBehavior.reportList) {
                                    const { listId: e } = s.richBehavior.reportList,
                                        t = { pathname: `/i/report/list/${e}`, state: { clientReferer: window.location.pathname, scribeNamespace: y } };
                                    return { feedbackKey: a, onClick: () => l.push(t) };
                                }
                                if (s.richBehavior.toggleMuteList && c) {
                                    const { id_str: e } = c;
                                    return {
                                        ...(0, V.Z)({ hideSubtext: !0, list: c, toggleMute: f, scribe: (e) => p({ ...y, ...e }, u) }),
                                        feedbackKey: a,
                                        onUndo: () => {
                                            f(e, { mute: !1 });
                                        },
                                ...
                                if (s.richBehavior.toggleFollowTopicV2 && d) {
                                    ...
                                    return {
                                        ...
                                        onClick: () => {
                                            (e ? b(t) : _(t)).then(() => {
                                                i({ text: e ? ee({ name: n }) : te({ name: n }) }), p({ ...y, element: e ? "feedback_unfollow_topic" : "feedback_follow_topic", action: "click" }, u);
                                            });
                                        },
                                        feedbackKey: a,
                                        skipDefaultAction: !0,
                                ...
                                if (s.richBehavior.markNotInterestedTopic && d) {
                                    const { id: e, name: t } = d,
                                        n = o.type === $.ZP.Topic && o.content?.topicDisplayType === q.M6.Pill,
                                        r = (0, B.DE)(s, o),
                                        l = (0, B.S4)(s, o),
                                        c = (0, B.C_)(s, o),
                                        h = r ? "click" : "not_interested",
                                        f = () => {
                                            E(e), n && p({ ...y, element: l, action: c }, u);
                                        };
                                    return {
                                        text: Q({ name: t }),
                                        Icon: U.default,
                                        onClick: () => {
                                            m(e).then(() => {
                                                p({ ...y, element: l, action: h }, u), n && i({ text: X, action: { label: ie, onAction: f } });
                                            });
                                        },
                                        onUndo: f,
                                        feedbackKey: a,
                                ...
                                return x();
                            })(e, { addToast: t, block: i, createLocalApiErrorHandler: n, feedbackAction: r, feedbackEntry: s, feedbackKey: R, gracefullyReloadTimeline: a, history: l, pinReply: c, richList: d, richTopic: h, richUsers: p, scribe: u, scribeData: y, scribeNamespace: m, setTopicNotInterested: f, toggleListMuting: _, topicFollow: b, topicUnfollow: g, unblock: E, undoTopicNotInterested: T, unpinReply: I });
                        return {
                            text: D || "",
                            subText: A,
                            Icon: (0, ne.w)(r),
            ...
            class le extends n.Component {
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getSynthesizedFeedbackItems = () => {
                            const { addToast: e, analytics: t, applyFeedbackAction: i, block: n, config: r, createLocalApiErrorHandler: s, entry: o, feedbackActions: a, gracefullyReloadTimeline: l, pinReply: c, richFeedbackList: d, richFeedbackTopic: h, richFeedbackUsers: p, scribe: u, setTopicNotInterested: y, toggleListMuting: m, topicFollow: f, topicUnfollow: _, unblock: b, undoFeedbackAction: g, undoTopicNotInterested: E, unpinReply: T } = this.props,
                            ...
                            return this._getMemoizedFeedbackItems(e, i, n, s, a, I, l, c, d, h, p, u, k, R, y, m, f, _, b, g, E, T);
                        }),
                        (this._getMemoizedFeedbackItems = (0, c.Z)((e, t, i, n, r, s, o, a, l, c, d, h, p, u, y, m, f, _, b, g, E, T) => oe(this.context.featureSwitches, { addToast: e, block: i, createLocalApiErrorHandler: n, feedbackActions: r, feedbackEntry: s, feedbackMethods: { applyFeedbackAction: t, undoFeedbackAction: g }, gracefullyReloadTimeline: o, history: this.context.history, pinReply: a, richList: l, richTopic: c, richUsers: d, scribe: h, scribeData: p, scribeNamespace: u, setTopicNotInterested: y, toggleListMuting: m, topicFollow: f, topicUnfollow: _, unblock: b, undoTopicNotInterested: E, unpinReply: T }))),
                ...
                render() {
                    ...
                    return n.createElement(h.nO, { data: this._getEntryScribeData(i, t.getScribeDataItem), namespace: this._getEntryScribeNamespace(a, i, t.defaultScribeNamespace) }, n.createElement(f, { entryId: i.entryId }, n.createElement(c, (0, o.Z)({ entry: i, feedbackItems: l, module: r, renderEntry: s }, d))));
                }
                _getInjectedProps() {
            ...
            var he = i(392237),
                pe = i(952428);
            const ue = he.default.create((e) => ({ divider: { display: "block", borderBottomColor: e.colors.borderColor, borderBottomWidth: 1 }, item: { display: "block" } })),
                ye = ({ children: e }) => e,
                me =
                    ...
                    (i, o, a, l) => {
                        ...
                        return n.createElement(ye, { displayType: l, entry: i }, n.createElement(pe.Z, { style: s(i) ? ue.divider : ue.item, viewRef: d, withInteractiveStyling: t(i) }, c));
                    },
                ...
                Re = ({ render: e, divider: t, shouldDisplayBorder: i = Te, isClickable: n = Ie, getScribeDataItem: r = ge, isFocusable: s = ve, isEmpty: o, isLoadingPlaceholder: a }) => ({ render: me(e, { shouldDisplayBorder: i, isClickable: n, isFocusable: s }), splice: void 0, divider: t || Ee, getScribeDataItem: r, isEmpty: o, shouldDisplayBorder: i, isLoadingPlaceholder: a }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.Articles~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSp-3ec0edf6.0bf4cfaa.js.map
