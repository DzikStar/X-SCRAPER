        ...
        959658: (e, _, t) => {
            ...
            function c() {
                const e = (0, m.hC)("hashfetti_enabled"),
                    _ = (0, m.hC)("hashfetti_all_hashflags"),
                    t = (0, m.D2)("hashfetti_duration_ms").getNumberValue(4e3),
                    a = (0, m.D2)("hashfetti_particle_count").getNumberValue(30),
            ...
            const g = u,
                h = l.default.create((e) => ({ container: { pointerEvents: "none", position: "fixed", width: "100%", height: "100%", top: 0, start: 0 } }));
        },
        334346: (e, _, t) => {
            "use strict";
            t.d(_, { C: () => s, Z: () => o });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.Articles~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSp-8aa1f3e4.4a27582a.js.map
