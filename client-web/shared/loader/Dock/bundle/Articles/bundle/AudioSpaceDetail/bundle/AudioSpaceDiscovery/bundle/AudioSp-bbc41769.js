            ...
            const se = (e) => ({ ...ae.k(e), ...le.kX(e), cursor: -1 }),
                ...
                we = ({ apiClient: e, featureSwitches: t }) => ({
                    ...
                    createSubscribers(n, r) {
                        const { list_id: l } = n;
                        return e.graphQL(O(), { listId: l, ...(0, a.S)(t) }, ue).then((e) => (0, i.Fv)(e.list_subscribe_v3, s.Z));
                    },
                    ...
                    toggleMute(t, n) {
                        ...
                        return r ? e.graphQL(G(), { listId: i }) : e.graphQL(J(), { listId: i });
                    },
                    editList(n, r) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.Articles~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSp-bbc41769.79b8c3ba.js.map
