...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Dock~bundle.Articles~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSp-c6c15d67"],
    {
        638537: (e, t, i) => {
            i.d(t, { Z: () => m });
            var n = i(111677),
        ...
        324260: (e, t, i) => {
            ...
            function g(e, t) {
                const { feedbackAction: i, feedbackEntry: n, feedbackKey: r, pinReply: o, scribe: l, scribeData: c, scribeNamespace: y, unpinReply: g } = t,
                    ...
                    T = (e) => {
                        l({ ...y, action: b, component: _, element: e }, c);
                    },
        ...
        107914: (e, t, i) => {
            ...
            var n = i(856430),
                ...
                y = i(372703),
                m = i(576513);
            const f = { [m.Z.FEEDBACK_CLOSE]: n.default, [m.Z.FEEDBACK]: r.default, [m.Z.FROWN]: s.default, [m.Z.SMILE]: o.default, [m.Z.MODERATION]: a.default, [m.Z.TOPIC]: l.default, [m.Z.TOPIC_CLOSE]: c.default, [m.Z.FLAG]: d.default, [m.Z.NO]: p.default, [m.Z.SPEAKER]: h.default, [m.Z.SPEAKER_OFF]: u.default },
                b = { [y.ZP.SeeFewer]: s.default, [y.ZP.SeeMore]: o.default, [y.ZP.DontLike]: s.default },
                _ = (e) => {
        ...
        238776: (e, t, i) => {
            ...
            class he extends r.PureComponent {
                constructor(e, t) {
                    super(e, t),
                        (this._lastRefresh = -1),
                        (this._render = () => {
                            const { analytics: e, apiErrorHandlerMap: t, bottomFetchStatus: i, createLocalApiErrorHandler: s, dismissedEntries: o, entries: a, entryConfiguration: l, fetchBottom: c, fetchInitial: d, fetchInitialOrTop: p, fetchOptions: h, fetchTopOptions: u, loadingAccessibilityLabel: m, markAllRead: f, olderAtTop: b, onEntriesRendered: g, perfKey: E, pinnedEntry: T, preprocessEntryList: I, processCallback: k, renderUnavailable: R, shouldFetchInitialOnBottomRetry: v, timelineExist: A, timelineRef: D, unavailableReason: P, updateInstreamVideoEntries: S, withoutHeadroom: Z, ...F } = this.props;
                            return r.createElement(
                                r.Fragment,
                                null,
                                r.createElement(se.Z, { dismissedEntries: o, entries: a, entryConfiguration: l, perfKey: E, pinnedEntry: T || void 0, preprocessEntryList: I }, (e, t, s) => r.createElement(_.Z, (0, n.Z)({}, F, { bottomFetchStatus: i || void 0, entries: t, handlerRegistry: e, hasPendingHandlers: s, onAtBottom: this._handleAtBottom, onAtTop: this._handleAtTop, onBottomRetry: this._handleBottomRetry, onEntriesRendered: this._handleEntriesRendered, onNearBottom: this._handleNearBottom, onNearTop: this._handleNearTop, onRef: this._handleTimelineRendererRef, onRefresh: this._handleRefresh, perfKey: E, processCallback: this._processCallback, withoutHeadroom: Z }))),
                ...
                _scribeAndClearDroppedAds() {
                    ...
                    i.forEach(({ adDropInfo: t, entry: i }) => {
                        const n = i.type === v.ZP.Tweet ? T.Z.getTweetURTEntryItem(i) : { id: i.entryId };
            ...
            (he.defaultProps = { apiErrorHandlerMap: {}, fetchOptions: de, fetchTopOptions: de, entryConfiguration: pe, loadingAccessibilityLabel: le, olderAtTop: !1, onEntriesRendered: p.Z, preprocessEntryList: (e) => e, renderEmptyState: () => r.createElement(a.Z, { message: ce }), scroller: m.C, newTweetsPill: b.Z, showLoadingFooter: !0, timelineRef: p.Z, withoutHeadroom: !1 }), (he.contextType = Z.rC);
            const ue = ne((0, I.Z)(he));
        },
        351322: (e, t, i) => {
            i.d(t, { KM: () => De, iH: () => Re, ov: () => fe, lC: () => ve, OZ: () => _e, ub: () => Ae });
            var n = i(202784),
                r = i(516951),
                s = i(459643),
                o = i(807896),
            ...
            const re = N().gf5e9ea6,
                ...
                oe = (e, { addToast: t, block: i, createLocalApiErrorHandler: n, feedbackActions: r, feedbackEntry: s, feedbackMethods: o, gracefullyReloadTimeline: a, history: l, pinReply: c, richList: d, richTopic: p, richUsers: h, scribe: u, scribeData: y, scribeNamespace: m, setTopicNotInterested: f, toggleListMuting: b, topicFollow: _, topicUnfollow: g, unblock: E, undoTopicNotInterested: T, unpinReply: I }) =>
                    r.map((r) => {
                        const { clientEventInfo: k, excludeFromActionMenu: R, feedbackKey: v, feedbackType: A, prompt: D, subprompt: P } = r,
                            S = ((e, t) => {
                                const { addToast: i, block: n, createLocalApiErrorHandler: r, feedbackAction: s, feedbackEntry: o, feedbackKey: a, history: l, richList: c, richTopic: d, richUsers: p, scribe: h, scribeData: u, scribeNamespace: y, setTopicNotInterested: m, toggleListMuting: f, topicFollow: b, topicUnfollow: _, unblock: g, undoTopicNotInterested: E } = t;
                                ...
                                if (s.richBehavior.toggleFollowTopicV2 && d) {
                                    ...
                                    return {
                                        ...
                                        onClick: () => {
                                            (e ? _(t) : b(t)).then(() => {
                                                i({ text: e ? ee({ name: n }) : te({ name: n }) }), h({ ...y, element: e ? "feedback_unfollow_topic" : "feedback_follow_topic", action: "click" }, u);
                                            });
                                        },
                                        feedbackKey: a,
                                        skipDefaultAction: !0,
                                ...
                                if (s.richBehavior.markNotInterestedTopic && d) {
                                    const { id: e, name: t } = d,
                                        ...
                                        f = () => {
                                            E(e), n && h({ ...y, element: l, action: c }, u);
                                        };
                                    return {
                                        text: Q({ name: t }),
                                        Icon: U.default,
                                        onClick: () => {
                                            m(e).then(() => {
                                                h({ ...y, element: l, action: p }, u), n && i({ text: X, action: { label: ie, onAction: f } });
                                            });
                                        },
                                        onUndo: f,
                                        feedbackKey: a,
                                ...
                                return x();
                            })(e, { addToast: t, block: i, createLocalApiErrorHandler: n, feedbackAction: r, feedbackEntry: s, feedbackKey: v, gracefullyReloadTimeline: a, history: l, pinReply: c, richList: d, richTopic: p, richUsers: h, scribe: u, scribeData: y, scribeNamespace: m, setTopicNotInterested: f, toggleListMuting: b, topicFollow: _, topicUnfollow: g, unblock: E, undoTopicNotInterested: T, unpinReply: I });
                        return {
                            text: D || "",
                            subText: P,
                            Icon: (0, ne.w)(r),
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._getSynthesizedFeedbackItems = () => {
                            const { addToast: e, analytics: t, applyFeedbackAction: i, block: n, config: r, createLocalApiErrorHandler: s, entry: o, feedbackActions: a, gracefullyReloadTimeline: l, pinReply: c, richFeedbackList: d, richFeedbackTopic: p, richFeedbackUsers: h, scribe: u, setTopicNotInterested: y, toggleListMuting: m, topicFollow: f, topicUnfollow: b, unblock: _, undoFeedbackAction: g, undoTopicNotInterested: E, unpinReply: T } = this.props,
                            ...
                            return this._getMemoizedFeedbackItems(e, i, n, s, a, I, l, c, d, p, h, u, R, v, y, m, f, b, _, g, E, T);
                        }),
                        (this._getMemoizedFeedbackItems = (0, c.Z)((e, t, i, n, r, s, o, a, l, c, d, p, h, u, y, m, f, b, _, g, E, T) => oe(this.context.featureSwitches, { addToast: e, block: i, createLocalApiErrorHandler: n, feedbackActions: r, feedbackEntry: s, feedbackMethods: { applyFeedbackAction: t, undoFeedbackAction: g }, gracefullyReloadTimeline: o, history: this.context.history, pinReply: a, richList: l, richTopic: c, richUsers: d, scribe: p, scribeData: h, scribeNamespace: u, setTopicNotInterested: y, toggleListMuting: m, topicFollow: f, topicUnfollow: b, unblock: _, undoTopicNotInterested: E, unpinReply: T }))),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.Articles~bundle.AudioSpaceDetail~bundle.AudioSpaceDiscovery~bundle.AudioSp-c6c15d67.c0735bda.js.map
