...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.JetfuelFrame~loader.PremiumLoaders-8c3bf7-5a644cb3"],
    {
        586548: (e, t, n) => {
            n.d(t, { Z: () => Re });
            var a = n(807896),
            ...
            const w = h().b7c6bc12,
                ...
                M = S.map((e, t) => ({ minWidth: e, maxWidth: R[t], flex: 1 })),
                B = ((e) => {
                    const t = [...e];
                            ...
                            return r.createElement(
                                ...
                                u.map(([e, o], m, u) => {
                                    ...
                                    const Z = ((e, t) => ({ transform: `translateY(${z(e) + s.sk - t}px)` }))(C, v),
                                        ...
                                        R = x(e, a),
                                        D = x(o, a),
                                        M = { colorType: R, endX: i ? 0 : S, endY: v, startX: i ? S : 0, startY: 0, strokeWidth: s.F4, style: [i ? $ : F.lineConnector, k] },
                                        B = { colorType: D, endX: i ? 0 : S, endY: 0, startX: i ? S : 0, startY: v, strokeWidth: s.F4, style: [i ? $ : F.lineConnector, Z] };
                                    return r.createElement(c.Z, { key: m, style: F.matchPairContainer }, r.createElement(b, M), r.createElement(b, B), r.createElement(I, { editable: a, match: e, matchIndex: 2 * m + l, onSelectWinner: g, roundIndex: n, style: [F.matchCard, E], viewUserPicks: d }), r.createElement(I, { editable: a, match: o, matchIndex: 2 * m + 1 + l, onSelectWinner: g, roundIndex: n, style: [F.matchCard, w], viewUserPicks: d }));
                                }),
                            );
                        }),
                    );
            ...
            const he = new Map(),
                        ...
                        r.createElement(
                            ...
                            w.map(([e, i], o, l) => {
                                const d = { editable: t, focusedRoundIndex: n, matchIndex: 2 * o, rounds: h, roundIndex: a, numDivisions: v.length, viewUserPicks: m },
                                    ...
                                    M = ((e) => ({ transform: `translateY(${ge(e) + s.sk}px)` }))(d),
                                    B = ((e, t) => ({ transform: `translateY(${ge(e) + s.sk - t}px)` }))(p, D),
                                    U = u.default.theme.scaleMultiplier * (0.5 * s.bg),
                                    W = n > a && a < f - 3,
                                    z = x(e, t),
                                    H = x(i, t);
                                return r.createElement(r.Fragment, { key: o }, C && v.map((e, t) => r.createElement(c.Z, { key: t, style: [Ce.divisionHeader, Ce.opacityNone] }, e)), r.createElement(c.Z, { style: Ce.matchPairContainer }, r.createElement(b, { colorType: z, endX: U, endY: D, startX: 0, startY: 0, style: [Ce.lineConnector, M, W && Ce.opacityNone] }), r.createElement(b, { colorType: H, endX: U, endY: 0, startX: 0, startY: D, style: [Ce.lineConnector, B, W && Ce.opacityNone] }), w ? r.createElement(c.Z, { style: [Ce.divisionHeader, g, P, !Z && Ce.opacityNone] }, w) : null, r.createElement(c.Z, { style: [Ce.matchCard, g] }, r.createElement(I, { editable: t, match: e, matchIndex: 2 * o, onSelectWinner: k, roundIndex: a, viewUserPicks: m })), $ ? r.createElement(c.Z, { style: [Ce.divisionHeader, y, R, !Z && Ce.opacityNone] }, $) : null, r.createElement(c.Z, { style: [Ce.matchCard, y] }, r.createElement(I, { editable: t, match: i, matchIndex: 2 * o + 1, onSelectWinner: k, roundIndex: a, viewUserPicks: m }))));
                            }),
                        ),
                    );
                }),
                ...
                Se = ({ props: e }) => {
                    const t = me.Z.get("screen").width,
                        ...
                        B = I.current ? {} : { transition: `transform ${s.B5}ms ease` },
                        U = r.useCallback(() => {
                            const t = new Map(),
                                n = (0, l.Py)(h);
                        ...
                        a
                            ...
                            : r.createElement(
                                  ...
                                  r.createElement(
                                      ...
                                      r.createElement(
                                          c.Z,
                                          { style: [Pe.bracketXScrollingContainer, B, M] },
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.JetfuelFrame~loader.PremiumLoaders-8c3bf7-5a644cb3.dbe3b50a.js.map
