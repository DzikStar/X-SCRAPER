                ...
                return (
                        ...
                        return this.map(function (t) {
                            var l = (function (e, t) {
                                ...
                                if (t && "function" == typeof btoa) {
                                    var s = ((o = r), (n = btoa(unescape(encodeURIComponent(JSON.stringify(o))))), (c = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(n)), "/*# ".concat(c, " */")),
                                        i = r.sources.map(function (e) {
                                            return "/*# sourceURL=".concat(r.sourceRoot || "").concat(e, " */");
                                        });
                                    return [l].concat(i).concat([s]).join("\n");
                                }
                                var o, n, c;
                                return [l].join("\n");
                            })(t, e);
                    ...
                    (t.i = function (e, l, r) {
                        ...
                        for (var n = 0; n < e.length; n++) {
                            var c = [].concat(e[n]);
                            (r && s[c[0]]) || (l && (c[2] ? (c[2] = "".concat(l, " and ").concat(c[2])) : (c[2] = l)), t.push(c));
                        }
                    }),
                    t
                );
        ...
        46062: (e, t, l) => {
            ...
            function c(e, t) {
                for (var l = {}, r = [], s = 0; s < e.length; s++) {
                    ...
                    -1 !== d ? (o[d].references++, o[d].updater(v)) : o.push({ identifier: a, updater: x(v, t), references: 1 }), r.push(a);
                }
                return r;
            }
            function h(e) {
            ...
            function v(e, t, l, r) {
                var s = l ? "" : r.media ? "@media ".concat(r.media, " {").concat(r.css, "}") : r.css;
            ...
            function x(e, t) {
                ...
                if (t.singleton) {
                    var i = g++;
                    (l = w || (w = h(t))), (r = v.bind(null, l, i, !1)), (s = v.bind(null, l, i, !0));
                } else
                    (l = h(t)),
                        (r = m.bind(null, l, t)),
                        (s = function () {
            ...
            e.exports = function (e, t) {
                ...
                return function (e) {
                    if (((e = e || []), "[object Array]" === Object.prototype.toString.call(e))) {
                        ...
                        for (var i = c(e, t), h = 0; h < l.length; h++) {
                            var a = n(l[h]);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.TimelineFrameHandler~loader.JetfuelFrame~-3db21160.7ce1245a.js.map
