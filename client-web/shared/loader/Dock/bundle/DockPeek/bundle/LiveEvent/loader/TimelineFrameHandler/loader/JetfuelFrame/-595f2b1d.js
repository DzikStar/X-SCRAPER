...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ...
    {
        244448: (e, t, a) => {
            a.d(t, { GZ: () => r.GZ, N_: () => o.N_, bk: () => o.bk, kb: () => n.Z, mQ: () => i.Z, q3: () => l.q3, rh: () => s.rh, tJ: () => r.tJ, vz: () => r.vz, wR: () => s.wR });
            var i = a(498348),
                n = a(685940),
                o = a(608222),
                r = a(752659),
        ...
        173590: (e, t, a) => {
            ...
            function f({ el: e, p: t, mods: a }) {
                const f = (0, s.oG)(),
                    ...
                    [x, y] = (0, n.useState)(),
                    [X, C] = (0, n.useState)(),
                    [j, S] = (0, n.useState)(k ? "ongoing" : "pending"),
                    Z = (0, u.Z)((e) => {
                ...
                const B = (0, n.useMemo)(() => (k ? "success" === j : !!h && ("pending" === b || "error" === b)), [b, j, k, h]);
                return (
                    (0, n.useEffect)(() => {
                        E(v);
                    }, [v, E]),
                    (0, i.jsxs)(p.q3.Provider, { value: { values: v, submit: M, change: P, submissionResult: x, submissionKey: X, submissionStatus: b, validationStatus: j, errors: g, setErrors: Z, setFocus: N, canSubmit: B }, children: [(0, i.jsx)("div", { className: a, children: (0, o.Z)(e) }), x && (0, i.jsx)(r.Z, { el: x })] })
                );
            }
        },
        261925: (e, t, a) => {
        ...
        399762: (e, t, a) => {
            ...
            function l({ p: e, el: t, mods: a }) {
                ...
                return (
                    ...
                    (0, i.jsxs)("div", { className: `relative ${a}`, ref: S, children: [(0, o.Z)(t), (0, i.jsx)("div", { className: "absolute left-0 top-0 right-0 bottom-0 flex flex-row", style: { gap: b, width: y, paddingLeft: C }, children: Array.from({ length: s }).map((e, t) => (0, i.jsx)("input", { maxLength: s, inputMode: "numeric", onChange: (e) => g(e, t), autoFocus: c && 0 === t, onKeyDown: k, ref: h[t], value: p[t] ?? "", className: "min-w-0 outline-none text-center caret-text bg-transparent text-transparent", style: { width: w } }, t)) })] })
                );
            }
        },
        631389: (e, t, a) => {
        ...
        971668: (e, t, a) => {
            ...
            var i = a(552322),
                ...
                l = a(977391);
            function s({ p: e, el: t, mods: a }) {
                const s = e.int("gapH") ?? 2,
                    c = e.int("gapV") ?? 2,
                    d = e.int("frozenCols") ?? null,
                    m = (0, o.Z)(t),
                    _ = (0, n.useMemo)(() => {
                        if (!m) return 12;
                        let e = 0;
                ...
                return (0, i.jsx)(l._p.Provider, { value: { frozenCols: d }, children: (0, i.jsx)("div", { className: `${a} ${null !== d ? "overflow-x-auto" : ""}`, children: (0, i.jsxs)("table", { style: { borderSpacing: `${s}px ${c}px` }, className: "w-full border-separate relative", children: [(0, i.jsx)("colgroup", { children: [...Array(_)].map((e, t) => (0, i.jsx)("col", { width: 100 / _ + "%" }, `grid-col-${t}-${_}`)) }), (0, i.jsx)("tbody", { children: (0, o.Z)(t) })] }) }) });
            }
        },
        790119: (e, t, a) => {
            a.d(t, { Z: () => l });
            ...
            function l({ p: e, el: t, mods: a }) {
                const l = e.int("columns") ?? 1,
                    ...
                    { frozenCols: _ } = (0, n.useContext)(r._p),
                    u = (0, n.useRef)(null);
                return (
                    (0, n.useLayoutEffect)(() => {
                        if (!u.current) return;
                        const e = u.current.cellIndex;
                        if (void 0 !== e && null !== _ && e < _) {
                            u.current.style.position = "sticky";
                            const e = u.current.getBoundingClientRect().left - (u.current.offsetParent?.getBoundingClientRect().left ?? 0);
                            u.current.style.left = `${e}px`;
                        }
                    }, [_]),
                    (0, i.jsx)("td", { ref: u, colSpan: l, className: `${c(m)} ${s(r.Eu[d])} ${null !== _ ? "whitespace-nowrap" : ""} ${a}`, children: (0, o.Z)(t) })
                );
            }
            function s(e) {
                switch (e) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.TimelineFrameHandler~loader.JetfuelFrame~-595f2b1d.5e81668a.js.map
