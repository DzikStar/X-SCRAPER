...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.TimelineFrameHandler~loader.JetfuelFrame~-8a88cd79"],
    {
        675299: (e, t, a) => {
            a.d(t, { Z: () => d });
            var r = a(202784),
        ...
        923513: (e, t, a) => {
            ...
            const n = 0,
                ...
                k = new Intl.DateTimeFormat(void 0, { dateStyle: "long" }),
                x = new Intl.DateTimeFormat(void 0, { month: "short", day: "numeric" }),
                T = ({ format: e, style: t, time: a }) => {
                    ...
                    switch (e) {
                        ...
                        case p:
                            ...
                            break;
                        case f:
                            w = `${T > 0 ? `${T}` : ""}${k % 365 > 0 ? "" + (k % 365) : ""}${b % 24 > 0 ? "" + (b % 24) : ""}${g % 60 > 0 ? "" + (g % 60) : ""}${i % 60}`;
                            break;
                        default:
                            w = "" + (i % 60);
                    }
                ...
                w = ({ props: e, style: t }) => {
                    ...
                    if (w === u || w === l || w === m || w === d || w === h || w === p || w === f) return r.createElement(T, { format: w, style: t, time: a });
                    const S = (() => {
                        switch (w) {
                            case c:
                                return g.format(a);
                            ...
                            case i:
                                return k.format(a);
                            case n:
                                return v < 120 ? "1m" : v < 3600 ? `${Math.floor(v / 60)}m` : v < 86400 ? `${Math.floor(v / 3600)}h` : v < 259200 ? `${Math.floor(v / 3600 / 24)}d` : a.getFullYear() === new Date().getFullYear() ? x.format(a) : g.format(a);
                            default:
                                return "";
                        }
                    })();
            ...
            const d = `transform ${l.B5}ms ease, opacity ${l.B5}ms ease`,
                h = ({ index: e, initialAnimationState: t = "FadingIn", isTopCard: a, match: o, numCardsVisible: h }) => {
                    const [f, g] = r.useState(t),
                        { userSelectMatchWinner: b } = (0, m.cM)(),
                        { height: k } = c.Z.get("screen"),
                        x = r.useCallback(
                            (...e) => {
                                const t = e[1],
                                    r = e[2];
                        ...
                        T = { zIndex: n.default.theme.componentZIndices.appBarZIndex + e };
                    switch (f) {
                        case "FadingIn":
                            (T.opacity = "0"),
                                setTimeout(
                        ...
                        case "SlidingIn":
                            ...
                            break;
                        case "SlidingOut":
                            T.transform = `translateY(${1.2 * k}px)`;
                            break;
                        case "TransitionOff":
                            (T.transition = ""),
                                (T.transform = `translateY(${e * n.default.theme.spacesPx.space8}px)`),
                                setTimeout(() => {
                                    g("Static");
                                }, 100);
                            break;
                        default:
                            (T.transition = d), (T.transform = `translateY(${e * n.default.theme.spacesPx.space8}px)`);
                    }
                    const w = r.useMemo(() => {
                        const e = new Map();
                        return e.set(i.bP.MARCH_MADNESS_PICK, x), e;
                    }, [x]);
                    return r.createElement(s.Z, { style: [p.cardContainer, T] }, r.createElement(u.J, { path: `/brackets/card?team1Name=${o.userTeam1?.name || ""}&team2Name=${o.userTeam2?.name || ""}&matchupId=${o?.id || ""}`, systemActionHandlers: w }));
                },
        ...
        456977: (e, t, a) => {
            a.d(t, { AH: () => w, B5: () => c, F4: () => g, IO: () => f, JJ: () => p, P4: () => h, RC: () => v, YV: () => i, ZH: () => x, aR: () => T, bg: () => u, cM: () => l, eI: () => m, ed: () => b, hF: () => P, hk: () => k, qu: () => d, sk: () => S, xi: () => y });
            var r = a(878052),
                s = a(392237),
                n = a(111677),
                o = a.n(n);
            const c = 500,
                ...
                k = s.default.theme.spacesPx.space80 + g,
                x = s.default.theme.spacesPx.space64,
                T = s.default.theme.spacesPx.space32,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.TimelineFrameHandler~loader.JetfuelFrame~-8a88cd79.5e8b1a7a.js.map
