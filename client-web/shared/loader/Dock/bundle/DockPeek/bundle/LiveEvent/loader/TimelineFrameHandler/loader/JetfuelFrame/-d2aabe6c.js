...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.TimelineFrameHandler~loader.JetfuelFrame~-d2aabe6c"],
    {
        736932: (e, t, a) => {
            a.d(t, { Z: () => l });
            var i = a(202784),
        ...
        616825: (e, t, a) => {
            ...
            const p = ({ header: e, scribeContext: t, src: a }) => {
                    ...
                    const E = i.useCallback(({ item: e }) => i.createElement(m.Z, { parentContext: t, payload: e }), [t]),
                        ...
                        T = i.useCallback(() => {}, [null, l]);
                    return v ? i.createElement(c.ZP, { style: u.error }, v) : i.createElement(r.Z, { ListFooterComponent: Z, ListHeaderComponent: S, data: p, keyExtractor: C, onEndReached: T, onEndReachedThreshold: 0.1, refreshControl: i.createElement(n.Z, { onRefresh: P, refreshing: l && "top" === k }), renderItem: E });
                },
            ...
            const k = i.createContext({ values: {}, submit: () => {}, setErrors: () => {}, change: (e, t) => {}, errors: {}, submitResult: null, setFocus: () => {}, submissionStatus: "pending", submissionResult: void 0, canSubmit: !1 }),
                b = ({ children: e, props: t, scribeContext: a, style: o }) => {
                    const [{ apiClient: l }] = (0, r.KO)(p.dd),
                        ...
                        [S, Z] = i.useState(() => ({})),
                        [P, T] = i.useState(),
                        [R, I] = i.useState(x ? "ongoing" : "pending"),
                        L = (0, m.r)((e) => {
                        ...
                        N = (0, m.r)(async () => {
                            if ("ongoing" !== E && v) {
                                ...
                                try {
                                    ...
                                    e ? (T(e.root.value), A("success")) : A("error");
                                } catch (e) {
                                    A("error");
                                }
                            }
                        ...
                        G = (0, m.r)((e, t) => {
                            Z((a) => ({ ...a, [e]: t })), A("pending"), B("pending"), T();
                        }),
                        z = i.useRef(S);
                    i.useLayoutEffect(() => {
                        z.current = S;
                    ...
                    const j = (0, m.r)((e, t) => {
                            B("ongoing"),
                                (0, f.kp)(t, e, b, l, u, !1)
                                    .then(({ jsonResponse: t }) => {
                                        z.current === e && (t && !(0, c.Z)(t) ? (L(t), B("failure")) : (L({}), B("success")));
                                    })
                                    .catch(() => {
                                        B("error");
                                    });
                    ...
                    const H = i.useMemo(() => (x ? "success" === R : "pending" === E || "error" === E), [E, R, x]);
                    return (
                        i.useEffect(() => {
                            D(S);
                        }, [S, D]),
                        i.createElement(k.Provider, { value: { values: S, submit: N, change: G, submissionResult: P, submissionStatus: E, errors: w, setErrors: L, setFocus: M, canSubmit: H } }, i.createElement(n.Z, { style: [C.form, o] }, e), P && i.createElement(_.Z, { parentContext: a, payload: P }))
                    );
                },
        ...
        795164: (e, t, a) => {
            a.d(t, { Cj: () => Z, sz: () => L, Z7: () => S, _h: () => R, QP: () => T, qM: () => I });
            var i = a(202784),
                r = a(215045),
                n = a(3348),
                o = a(325686),
            ...
            const h = 0,
                ...
                S = ({ overrideStyles: e, props: t, style: a }) => {
                    const r = t.str("name") ?? "",
                        ...
                        f = t.enum("type") ?? h,
                        { change: S, setFocus: Z, submit: P, values: T } = i.useContext(p.q3),
                        R = f === E,
                        I = f === g,
                        L = f === x,
                        M = i.useCallback(
                    ...
                    const A = i.useCallback(() => {
                        ...
                        H = T[r] ?? d,
                        F = { border: 0, outline: 0, flexShrink: 1, minWidth: 50, flexGrow: 1, ...a, ...G, ...z },
                        O = "content" === a.fieldSizing && !c.ZP.isChrome(),
                        $ = i.useRef(null),
                        [K, U] = i.useState(0),
                        J = (0, s.r)((e) => {
                            if (!O) return;
                    ...
                    if (
                        ...
                        return i.createElement(m.u.Provider, { value: N }, i.createElement("input", { autoFocus: _, name: r, onChange: q, style: { ...F, lineHeight: "number" == typeof F.lineHeight ? `${F.lineHeight}px` : F.lineHeight }, type: "date", value: t }));
                    }
                ...
                T = ({ children: e, overrideStyles: t, props: a, style: r }) => {
                    const n = a.str("name") ?? "",
                        l = a.bool("submit") ?? !1,
                        [s, c] = i.useState(null),
        ...
        665161: (e, t, a) => {
            ...
            const d = ({ overrideStyles: e, props: t, style: a }) => {
                    const d = t.str("name") ?? "",
                        ...
                        T = i.useMemo(() => u.filter((e) => b.includes(e.dial_code)), [b]),
                        R = i.useCallback(
                            (e) => {
                        ...
                        i.createElement(
                            ...
                            i.createElement(
                                ...
                                i.createElement(
                                    ...
                                    T.map((e) => i.createElement("option", { key: e.name, value: e.name }, e.name, "(", e.dial_code, ")")),
                                ),
                            ),
                            i.createElement(n.Z, {
                                autoFocus: !0,
                                ...
                                placeholderTextColor: l.default.theme.colors.gray500,
                                style: [M, { width: A }, { border: 0, outline: 0 }],
                                value: P,
                            }),
                        ),
                    );
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~bundle.DockPeek~bundle.LiveEvent~loader.TimelineFrameHandler~loader.JetfuelFrame~-d2aabe6c.3516e1ca.js.map
