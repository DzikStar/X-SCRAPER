...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Dock~ondemand.InlinePlayer~bundle.DockPeek~bundle.LiveEvent~loader.AudioOnlyVideoPlaye-9d7f6429"],
    {
        905996: (t, e, i) => {
            i.d(e, { Z: () => De });
            ...
            var Lt = (((a = {})[nt] = "creativeView"), (a[B] = "firstQuartile"), (a[x] = "midpoint"), (a[H] = "thirdQuartile"), (a[U] = "complete"), (a[O] = "resume"), (a[D] = "pause"), (a[G] = "rewind"), (a[g] = "adError"), a),
                At = (function () {
                    function t(t) {
                        var e = this;
                        Object.keys(Lt).forEach(function (i) {
                            t.on(i, function (t) {
                                e.fireBeacon(Lt[i], t);
                            });
                        }),
            ...
            var ne = (((s = {})[Y] = "playback_start"), (s[B] = "playback_25"), (s[x] = "playback_50"), (s[H] = "playback_75"), (s[R] = "playback_95"), (s[U] = "playback_complete"), (s[V] = "mrc_view"), (s[b] = "groupm_view"), (s[A] = "1sec_view"), (s[W] = "6sec_view"), (s[N] = "short_form_complete"), (s[nt] = "view"), (s[F] = "play_from_tap"), (s[at] = "view_threshold"), s),
                ae = (function () {
                    function t(t, e) {
                        var i = this;
                ...
                Ne = (function () {
                    ...
                    return (
                        ...
                        (e.updateTimingData = function (t, e, i) {
                            ...
                            a >= 1 && (e[at].timePlayedMs += n), a >= 1 ? (e[A].timePlayedMs += n) : (e[A].timePlayedMs = 0), a >= 0.5 && Ct(i) ? (e[C].timePlayedMs += n) : (e[C].timePlayedMs = 0), a >= 0.5 ? (e[V].timePlayedMs += n) : (e[V].timePlayedMs = 0), a >= 1 && !i.isMuted && (e[b].timePlayedMs += n), a >= 0.5 ? (e[it].timePlayedMs += n) : (e[it].timePlayedMs = 0), (e[W].timePlayedMs += n), a >= 0.5 && (e[W].visibilityWeightedTimePlayedMs += a * n), (e[N].timePlayedMs += n);
                        }),
                        ...
                        (e.checkViewEvents = function (t, e, i) {
                            ...
                            e[at].timePlayedMs >= (!(n = t).isLive && n.durationMs > 0 && !n.shouldLoop ? Math.min(n.durationMs - 500, qt) : qt) && (this.emitOnce(at, e, i), this.emitOnce(nt, e, i)),
                                e[A].timePlayedMs >= 1e3 && this.emitOnce(A, e, i),
                                e[b].timePlayedMs >=
                                    (function (t) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Dock~ondemand.InlinePlayer~bundle.DockPeek~bundle.LiveEvent~loader.AudioOnlyVideoPlaye-9d7f6429.18d8df2a.js.map
