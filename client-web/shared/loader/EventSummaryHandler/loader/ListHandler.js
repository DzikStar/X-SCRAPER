    ...
    ["shared~loader.EventSummaryHandler~loader.ListHandler"],
    {
        ...
        165822: (e, t, a) => {
            ...
            const i = l.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                c = ({ "aria-label": e, containerStyle: t, disabled: a, interactiveStyles: c, isCompact: d, link: m, lower: u, onClick: h, stackLayoutLowerStyle: p, stackLayoutUpperStyle: g, upper: C, withInsetFocusRing: f = !0, withInteractiveStyling: b = !1 }) => {
                    const S = c ?? o.Z.generate({ backgroundColor: l.default.theme.colors.transparent, color: l.default.theme.colors.primary, insetFocusRing: f }),
                        y = r.createElement(r.Fragment, null, r.createElement(n.Z, { style: [i.defaultUpperContainerStyle, g, d && { height: "auto" }] }, C), u ? r.createElement(n.Z, { style: [i.defaultLowerContainerStyle, p] }, u) : null);
                    return r.createElement(s.Z, { "aria-label": e, disabled: a, interactive: b, interactiveStyles: b ? S : void 0, link: m, onClick: h, style: [i.root, t] }, y);
                };
        },
        745185: (e, t, a) => {
            a.d(t, { Z: () => b });
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.EventSummaryHandler~loader.ListHandler.b4e9830a.js.map
