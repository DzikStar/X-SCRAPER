...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.EventSummaryHandler~loader.ListHandler", "icons/IconNewsStroke-js"],
    {
        346252: (e, t, a) => {
            a.d(t, { Z: () => f });
            var r = a(202784),
            ...
            const u = Object.freeze({ Fixed: "fixed", Variable: "variable" }),
                ...
                f = (e) => {
                    const { cropCandidates: t, dataSaverMode: a, icon: i, image: c, isCellWithProminentSocialContext: m, scoreEvent: u, type: f = "variable" } = e,
                        b = g({ isCellWithProminentSocialContext: m, type: f });
                    return r.createElement(n.Z, { style: [C.coverContainer, b] }, u ? p(u) : !c || (0, d.Z)(c) || a ? (a || (0, d.Z)(c) ? r.createElement(l.Z, { ratio: 1 }, r.createElement(h.Vm, { icon: i })) : null) : r.createElement(o.Z, { "aria-label": "", aspectMode: s.Z.SQUARE, cropCandidates: t, image: c }));
                };
        },
        741692: (e, t, a) => {
            a.d(t, { S3: () => h, nn: () => u, Vm: () => p });
            var r = a(202784),
                n = a(325686),
                o = a(366635),
                s = a(392237),
        ...
        250672: (e, t, a) => {
            ...
            const l = n().a3484d22,
                ...
                m = (e, t, a, r, n) => {
                    ...
                    return c({ gameCategory: u, gameState: h, accessibleGameClockPeriod: b, teamOneLabel: p, teamTwoLabel: g });
                };
        },
        93074: (e, t, a) => {
            a.d(t, { Z: () => m });
        ...
        165822: (e, t, a) => {
            ...
            const i = l.default.create((e) => ({ root: { padding: e.spaces.space12, borderRadius: e.borderRadii.large }, defaultLowerContainerStyle: { marginTop: e.spaces.space12, justifyContent: "flex-end" }, defaultUpperContainerStyle: { height: `calc(${e.spaces.space48}*2)`, overflow: "hidden", borderRadius: e.borderRadii.large } })),
                c = ({ "aria-label": e, containerStyle: t, disabled: a, interactiveStyles: c, isCompact: d, link: m, lower: h, onClick: u, stackLayoutLowerStyle: p, stackLayoutUpperStyle: g, upper: C, withInsetFocusRing: f = !0, withInteractiveStyling: b = !1 }) => {
                    const S = c ?? o.Z.generate({ backgroundColor: l.default.theme.colors.transparent, color: l.default.theme.colors.primary, insetFocusRing: f }),
                        y = r.createElement(r.Fragment, null, r.createElement(n.Z, { style: [i.defaultUpperContainerStyle, g, d && { height: "auto" }] }, C), h ? r.createElement(n.Z, { style: [i.defaultLowerContainerStyle, p] }, h) : null);
                    return r.createElement(s.Z, { "aria-label": e, disabled: a, interactive: b, interactiveStyles: b ? S : void 0, link: m, onClick: u, style: [i.root, t] }, y);
                };
        },
        745185: (e, t, a) => {
            a.d(t, { Z: () => b });
                    ...
                    super(...e),
                        ...
                        (this._renderScore = () => {
                            const { category: e, gameState: t, team: a, winnerId: n } = this.props,
                                ...
                                m = l === n,
                                p = !n,
                                f = t === h.D.Completed && !m && !p,
                                b = this._shouldRenderScore(),
                                S = this._getTeamScoreSize(u.SCORE),
                                y = d ? this._getTeamScoreSize(u.SECONDARY_SCORE) : void 0,
                        ...
                        (this._shouldRenderScore = () => {
                            ...
                            return e === h.D.Completed || e === h.D.InProgress;
                        });
                }
                render() {
                    const {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.EventSummaryHandler~loader.ListHandler.c1c9a43a.js.map
