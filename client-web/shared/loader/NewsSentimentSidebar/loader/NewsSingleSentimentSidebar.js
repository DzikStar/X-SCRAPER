        ...
        858496: (e, t, n) => {
            ...
            function $({ active: e, label: t, payload: n }) {
                if ((a.useEffect(() => {}, []), e && n && n.length)) {
                    ...
                    const t = n[0].payload.timestamp,
                        i = N(new Date(t), { year: !0, month: !0, day: !0, hour: !0, minute: !0 }),
            ...
            function A({ chartData: e, isBlurred: t, question: n, typeMetadata: i }) {
                ...
                const f = a.useCallback(
                    ...
                    b = a.useCallback((e) => N(new Date(e), { month: !0, day: !0, hour: !0 }), []),
                    w = Object.keys(u);
                return a.createElement(
                    l.Z,
                        ...
                        a.createElement(
                            ...
                            a.createElement(
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(K.u, { content: a.createElement($, null), cursor: { stroke: o.default.theme.colors.gray200, strokeDasharray: "1 0" }, isAnimationActive: !1 }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.NewsSentimentSidebar~loader.NewsSingleSentimentSidebar.fc85a8ba.js.map
