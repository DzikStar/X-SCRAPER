        ...
        537439: (e, t, i) => {
            ...
            const O = r().ae408b76,
                ...
                B = ({ contextType: e, iconColor: t, iconSize: i, link: a, retweetData: r, text: v, topicData: I, userAvatarUrls: O }) => {
                    ...
                    switch (e) {
                        case x.Q.Retweet:
                            return { Icon: U, text: v || M(Z, B), link: K ? `https://twitter.com/${K}` : void 0 };
                        case x.Q.Pin:
                            return { Icon: U, text: v || L };
                        case x.Q.ReplyPin:
                            return { Icon: U, text: R };
                        case x.Q.Topic:
                            return { Icon: U, "aria-label": "Recommendation" === I?.functionalityType || "RecWithEducation" === I?.functionalityType ? P({ topicName: v }) : C({ topicName: v }), text: v ? n.createElement(D, { text: v }) : null, link: a };
                        default:
            ...
            function n(e) {
                ...
                return {
                    uploadStart: function (e, t) {
                        i.set(e, { time: Date.now(), bytes: t }), a || (a = Date.now());
                    },
                        ...
                        c &&
                            ...
                            ++r === t &&
                                (function () {
                                    ...
                                    const r = n / i;
                                    if (r < 5e3 && 1 === t) return;
                                    !s || s.byterate < r ? ((t += 1), e(), (s = { byterate: r, poolSize: t })) : ((t -= 2), (t = Math.max(t, 1)), (s = null));
                                    l();
                                })());
                    },
                    reset: l,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.SideNav~loader.SideNavRedesign-6107ac1a.b345f12a.js.map
