    ...
    ["shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch"],
    {
        229412: (e, t, n) => {
            ...
            const x = p().c61eea74,
                ...
                L = ({ accountUsers: e, activeUser: t, handleMultiAccountSwitch: n, isUpdatedManageAccounts: a, renderUserDecoration: u, userTestId: d, withBadges: p }) => {
                    const m = (0, E.v9)(I.BP),
                        ...
                        y = r.useMemo(() => r.createElement(s.Z, { style: D.facePileContainer }, r.createElement(k.Z, { userAvatarSize: "large", userAvatarUrls: w.map((e) => e.avatar_image_url) }), C > 0 ? r.createElement(o.Z, { count: C, standalone: !0, truncatedCountFormatter: B, unreadCountLabel: T }) : null), [w, C]);
            ...
            const N = p().c61eea74,
                ...
                H = p().h6beb5fb;
            function W(e) {
                const { accountSwitch: t, accountUsers: n, activeUser: u, clearDelegateUser: d, delegateAccountCount: p, delegateUser: _, isDelegateEnabled: v, isUpdatedManageAccounts: y, onDelegateSwitch: k, onUserSwitch: Z, userTestId: S, withBadges: I = !1 } = e,
                    x = !!_,
                    ...
                    G = r.useMemo(() => r.createElement(U.ZP, { activeUserId: u.id_str, delegateUser: _, isUpdatedManageAccounts: y, key: 0, onDelegateSwitch: k ?? w.Z, renderUserDecoration: $ }), [u.id_str, _, y, k, $]),
                    j = r.useMemo(() => r.createElement(M, { accountUsers: n, activeUser: u, handleMultiAccountSwitch: B, isUpdatedManageAccounts: !!y, key: 1, renderUserDecoration: $, userTestId: S, withBadges: I }), [n, u, B, y, $, S, I]),
                    Y = [];
                return !y && v && Y.push(G), Y.push(j), y && v && Y.push(G), r.createElement(r.Fragment, null, y && v && r.createElement(s.Z, { style: z.personalAccountsLabel }, r.createElement(i.ZP, { color: "gray700", weight: "bold" }, N)), F ? r.createElement(r.Fragment, null, r.createElement(c.ZP, { affiliateBadgeInfo: u.highlightedLabel, avatarDecoration: y && r.createElement(A, { notificationCount: L + D }), avatarUri: u.profile_image_url_https, badgeContext: "account", decoration: $({ withBadges: I, isActiveUser: !_, isLoggedInUser: !0 }), displayMode: "UserCompact", isBlueVerified: u.is_blue_verified, isProtected: u.protected, isVerified: u.verified, name: u.name, onCellClick: x ? T : void 0, screenName: u.screen_name, testID: S, userId: u.id_str, verifiedType: u.verified_type, withLink: !1 }), y && r.createElement(l.Z, { style: z.accountDivider })) : null, Y, !y && (F || p || n.length) ? r.createElement(l.Z, { spacing: "space12" }) : null);
            }
        ...
        763881: (e, t, n) => {
            ...
            function Z({ hasMultiAccountBadges: e, isExpanded: t }) {
                return e ? r.createElement(E.Z, { pip: !0, style: t && S.pip, truncatedCountFormatter: U, unreadCountLabel: A }) : null;
            }
            ...
            class F extends r.Component {
                ...
                render() {
                    ...
                    return t || p ? r.createElement(u.Z, { contentStyle: T.menuContainer, enableEnterKeyToggle: !0, renderContent: h, withArrow: !0, withFixedPosition: !0 }, r.createElement(d.Z, { "aria-label": e || x, hoverLabel: i ? void 0 : { label: a || I }, interactiveStyles: c.Z.generate({ backgroundColor: "transparent", color: l.default.theme.colors.text }), onClick: this._handleAccountSwitcherClick, role: "button", style: w, testID: o }, n ? r.createElement(m.p, { forceUserId: n.userId }, r.createElement(k, { hasMultiAccountBadges: s, isExpanded: i })) : t ? r.createElement(k, { hasMultiAccountBadges: s, isExpanded: i }) : this._renderEmptyState())) : null;
                }
            }
            F.contextType = p.rC;
            ...
            const ue = o().j0a8da6e,
                ...
                fe = ne(({ clearDelegateUser: e, createLocalApiErrorHandlerAccountSwitch: t, createLocalApiErrorHandlerMultiListFetch: n, delegateAccountCount: a, delegateUser: o, fetchMultiAccountList: i, fetchStatus: c, hasMultiAccountBadges: l, isExpanded: u, loggedInUser: d, multiAccountUsers: p, style: m, switchAccount: h, withUpdatedAccountSwitcher: g }) => {
                    ...
                    const [w, C] = (0, s.KO)(M.lA),
                        ...
                        b = r.useCallback(
                            ({ hasBadge: e, isProtected: n, userId: r }) => {
                                f.scribe({ component: n ? "switch_to_protected_account" : "switch_account", element: e ? "account_badged" : "account", action: "click" }), h({ user_id: r }).catch(t(B.y));
                            },
                            [f, t, h],
                        ),
                        _ = r.useCallback(() => {
        ...
        266704: (e, t, n) => {
            ...
            class g extends r.PureComponent {
                ...
                _renderUserAvatar() {
                    const { isAllowedToViewOptions: e, onAvatarClick: t, promotedContent: n, userAvatarSize: a, userAvatarUri: i, userScreenName: c } = this.props,
                        { avatar: l } = e;
                    return r.createElement(s.Z, { style: f.row }, r.createElement(o.ZP.Provider, { value: { userAvatarLabel: h } }, r.createElement(u.default, { onClick: t, promotedContent: n, screenName: c, size: a, uri: l ? i : void 0, withLink: !0 })), this._renderDecoration());
                }
                _renderHeader(e) {
                ...
                _renderUserName() {
                    const { isAllowedToViewOptions: e, isUserBlueVerified: t, isUserProtected: n, isUserVerified: s, onScreenNameClick: a, promotedContent: o, userHighlightedLabel: i, userName: c, userScreenName: l, userTranslatorType: u, userVerifiedType: d, userWithFollowsYou: m, withNameWrap: h } = this.props,
                        { badges: g, followIndicator: f, fullName: w } = e;
                    return r.createElement(p.Z, { affiliateBadgeInfo: i, badgeContext: "account", isBlueVerified: g ? t : void 0, isProtected: g ? n : void 0, isVerified: g ? s : void 0, name: w ? c : l, nameSize: "headline2", onLinkClick: a, promotedContent: o, screenName: l, translatorType: g ? u : void 0, verifiedType: g ? d : void 0, withFollowsYou: f && m, withLink: !0, withNameWrap: h, withStackedLayout: !0 });
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch.cf9ac0ba.js.map
