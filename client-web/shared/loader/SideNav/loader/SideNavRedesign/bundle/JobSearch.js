                                ...
                                t &&
                                    r.push(
                                        n.createElement(
                                            ...
                                            n.createElement(m.default, { style: z.IconExiting }),
                                        ),
                                    ),
                                r.push(e ? n.createElement(h.default, { style: z.updatedIconCheckmarkCircleFill }) : n.createElement(g.default, { style: z.IconChevronRight })),
                                n.createElement(
                                    s.Z,
            ...
            const $ = o().h6beb5fb,
                ...
                K = ({ accountSwitch: e, accountUsers: t, activeUser: r, createLocalApiErrorHandlerAccountsFetch: s, fetchAccounts: a, fetchStatus: o, handleClose: c, manageAccountsMenuItem: l, shouldDisplayFetchRenderer: u }) => {
                    const p = t.filter((e) => e.user_id !== r?.id_str),
                        ...
                        f = n.useMemo(() => n.createElement(d.Z, { link: l.link, onClick: g, style: Y.IconMoreCircleContainer, testID: l.testID, withoutInteractiveStyles: !0 }, n.createElement(O, null, n.createElement(H.default, { style: Y.IconMoreCircle })), m > 0 && n.createElement(b.Z, { count: m, style: m > 9 && Y.notificationBadge, truncatedCountFormatter: $, unreadCountLabel: G })), [g, l.link, l.testID, m]),
                        w = n.useCallback(
            ...
            const ue = o().j0a8da6e,
                ...
                fe = re(({ clearDelegateUser: e, createLocalApiErrorHandlerAccountSwitch: t, createLocalApiErrorHandlerMultiListFetch: r, delegateAccountCount: a, delegateUser: o, fetchMultiAccountList: i, fetchStatus: c, hasMultiAccountBadges: l, isExpanded: u, loggedInUser: d, multiAccountUsers: p, style: m, switchAccount: h, withUpdatedAccountSwitcher: g }) => {
                    ...
                    const [w, C] = (0, s.KO)(N.lA),
                        ...
                        E = n.useCallback(
                            ({ hasBadge: e, isProtected: r, userId: n }) => {
                                f.scribe({ component: r ? "switch_to_protected_account" : "switch_account", element: e ? "account_badged" : "account", action: "click" }), h({ user_id: n }).catch(t(x.y));
                            },
                            [f, t, h],
                        ),
                        _ = n.useCallback(() => {
                            const { hasMultiAccountCookie: e } = (0, M.s)();
                            return e;
                        }, []),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch.056c351a.js.map
