    ...
    ["shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch"],
    {
        229412: (e, t, n) => {
            ...
            function W(e) {
                const { accountSwitch: t, accountUsers: n, activeUser: u, clearDelegateUser: d, delegateAccountCount: p, delegateUser: _, isDelegateEnabled: v, isUpdatedManageAccounts: y, onDelegateSwitch: U, onUserSwitch: Z, userTestId: S, withBadges: I = !1 } = e,
                                ...
                                t &&
                                    n.push(
                                        r.createElement(
                                            ...
                                            r.createElement(m.default, { style: R.IconExiting }),
                                        ),
                                    ),
                                n.push(e ? r.createElement(h.default, { style: R.updatedIconCheckmarkCircleFill }) : r.createElement(g.default, { style: R.IconChevronRight })),
                                r.createElement(
                                    s.Z,
                    ...
                    O = r.useCallback(({ badgeCount: e, isActiveUser: t, withBadges: n }) => (t ? (v ? r.createElement(h.default, { style: [R.IconCheckmarkCircleFill, R.userDecoration] }) : r.createElement(f.default, { style: [R.iconCheckMark, R.userDecoration] })) : e && n ? r.createElement(o.Z, { count: e, standalone: !0, style: R.userDecoration, truncatedCountFormatter: H, unreadCountLabel: V }) : void 0), [v]),
                    $ = r.useMemo(() => (y ? z : O), [y, O, z]),
                    j = r.useMemo(() => r.createElement(k.ZP, { activeUserId: u.id_str, delegateUser: _, isUpdatedManageAccounts: y, key: 0, onDelegateSwitch: U ?? w.Z, renderUserDecoration: $ }), [u.id_str, _, y, U, $]),
                    G = r.useMemo(() => r.createElement(D, { accountUsers: n, activeUser: u, handleMultiAccountSwitch: T, isUpdatedManageAccounts: !!y, key: 1, renderUserDecoration: $, userTestId: S, withBadges: I }), [n, u, T, y, $, S, I]),
                    Y = [];
                return !y && v && Y.push(j), Y.push(G), y && v && Y.push(j), r.createElement(r.Fragment, null, y && v && r.createElement(s.Z, { style: R.personalAccountsLabel }, r.createElement(i.ZP, { color: "gray700", weight: "bold" }, N)), F ? r.createElement(r.Fragment, null, r.createElement(c.ZP, { affiliateBadgeInfo: u.highlightedLabel, avatarDecoration: y && r.createElement(A, { notificationCount: B + L }), avatarUri: u.profile_image_url_https, badgeContext: "account", decoration: $({ withBadges: I, isActiveUser: !_, isLoggedInUser: !0 }), displayMode: "UserCompact", isBlueVerified: u.is_blue_verified, isProtected: u.protected, isVerified: u.verified, name: u.name, onCellClick: x ? M : void 0, screenName: u.screen_name, testID: S, userId: u.id_str, verifiedType: u.verified_type, withLink: !1 }), y && r.createElement(l.Z, { style: R.accountDivider })) : null, Y, !y && (F || p || n.length) ? r.createElement(l.Z, { spacing: "space12" }) : null);
            }
                ...
                constructor(...e) {
                    super(...e),
                        (this._renderEmptyState = () => {
                            ...
                            return e ? r.createElement(i.Z, { style: M.emptyStateWrapper }, e()) : null;
                        }),
            ...
            const $ = o().h6beb5fb,
                ...
                K = ({ accountSwitch: e, accountUsers: t, activeUser: n, createLocalApiErrorHandlerAccountsFetch: s, fetchAccounts: a, fetchStatus: o, handleClose: c, manageAccountsMenuItem: l, shouldDisplayFetchRenderer: u }) => {
                    const p = t.filter((e) => e.user_id !== n?.id_str),
                        ...
                        f = r.useMemo(() => r.createElement(d.Z, { link: l.link, onClick: g, style: Y.IconMoreCircleContainer, testID: l.testID, withoutInteractiveStyles: !0 }, r.createElement(z, null, r.createElement(H.default, { style: Y.IconMoreCircle })), m > 0 && r.createElement(E.Z, { count: m, style: m > 9 && Y.notificationBadge, truncatedCountFormatter: $, unreadCountLabel: j })), [g, l.link, l.testID, m]),
                        w = r.useCallback(
                        ...
                        C = r.useMemo(
                            () => () =>
                                p.slice(0, 2).map((e) => {
                                    ...
                                    return r.createElement(d.Z, { key: e.user_id, onClick: w({ hasBadge: !!t, isProtected: e.is_protected, userId: e.user_id }) }, r.createElement(P.default, { "aria-label": G({ screenName: e.screen_name }), decoration: t ? r.createElement(E.Z, { count: t, style: t > 9 && Y.notificationBadge, truncatedCountFormatter: $, unreadCountLabel: j }) : void 0, key: e.user_id, screenName: e.screen_name, size: "xLarge", uri: e.avatar_image_url, userId: e.user_id, withLink: !1 }));
                                }),
                            [w, p],
                        ),
                        b = r.useCallback(() => {
            ...
            const ue = o().j0a8da6e,
                ...
                fe = ne(({ clearDelegateUser: e, createLocalApiErrorHandlerAccountSwitch: t, createLocalApiErrorHandlerMultiListFetch: n, delegateAccountCount: a, delegateUser: o, fetchMultiAccountList: i, fetchStatus: c, hasMultiAccountBadges: l, isExpanded: u, loggedInUser: d, multiAccountUsers: p, style: m, switchAccount: h, withUpdatedAccountSwitcher: g }) => {
                    ...
                    const [w, C] = (0, s.KO)(D.lA),
                        ...
                        b = r.useCallback(
                            ({ hasBadge: e, isProtected: n, userId: r }) => {
                                f.scribe({ component: n ? "switch_to_protected_account" : "switch_account", element: e ? "account_badged" : "account", action: "click" }), h({ user_id: r }).catch(t(T.y));
                            },
                            [f, t, h],
                        ),
                        _ = r.useCallback(() => {
        ...
        879113: (e, t, n) => {
            ...
            class m extends r.Component {
                ...
                render() {
                    const { "aria-label": e, color: t, failureMessage: n, fetchStatus: s, icon: a, loadingMessage: o, onRequestRetry: u, render: m, renderFailure: h, retryMessage: g, retryable: f } = this.props;
                    switch (s) {
                        case l:
                            return f ? r.createElement(i.Z, { icon: a, onRequestRetry: u, retryMessage: g }) : n ? r.createElement(c.m, { failureMessage: n }) : h();
                        case d:
        ...
        465233: (e, t, n) => {
            ...
            var r = n(716406);
            function s(e) {
                return "object" != typeof e || null === e ? e : Array.isArray(e) ? e.map(s) : (0, r.Z)(e, (e) => s(e));
            }
        },
    },
]);
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch.ea2ef16a.js.map
