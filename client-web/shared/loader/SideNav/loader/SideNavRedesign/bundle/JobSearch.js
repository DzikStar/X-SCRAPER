    ...
    ["shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch"],
    {
        229412: (e, t, n) => {
            ...
            const x = p().c61eea74,
                ...
                M = p().d86bbf0f,
                T = p().h6beb5fb,
                L = ({ accountUsers: e, activeUser: t, handleMultiAccountSwitch: n, isUpdatedManageAccounts: a, renderUserDecoration: u, userTestId: d, withBadges: p }) => {
                    const m = (0, E.v9)(I.BP),
                        h = !0,
                        [g, f] = r.useState(!1),
            ...
            function W(e) {
                const { accountSwitch: t, accountUsers: n, activeUser: u, clearDelegateUser: d, delegateAccountCount: p, delegateUser: _, isDelegateEnabled: v, isUpdatedManageAccounts: y, onDelegateSwitch: U, onUserSwitch: Z, userTestId: S, withBadges: I = !1 } = e,
                    ...
                    j = r.useMemo(() => r.createElement(D, { accountUsers: n, activeUser: u, handleMultiAccountSwitch: T, isUpdatedManageAccounts: !!y, key: 1, renderUserDecoration: $, userTestId: S, withBadges: I }), [n, u, T, y, $, S, I]),
                    Y = [];
                return !y && v && Y.push(G), Y.push(j), y && v && Y.push(G), r.createElement(r.Fragment, null, y && v && r.createElement(s.Z, { style: R.personalAccountsLabel }, r.createElement(i.ZP, { color: "gray700", weight: "bold" }, N)), F ? r.createElement(r.Fragment, null, r.createElement(c.ZP, { affiliateBadgeInfo: u.highlightedLabel, avatarDecoration: y && r.createElement(A, { notificationCount: L + B }), avatarUri: u.profile_image_url_https, badgeContext: "account", decoration: $({ withBadges: I, isActiveUser: !_, isLoggedInUser: !0 }), displayMode: "UserCompact", isBlueVerified: u.is_blue_verified, isProtected: u.protected, isVerified: u.verified, name: u.name, onCellClick: x ? M : void 0, screenName: u.screen_name, testID: S, userId: u.id_str, verifiedType: u.verified_type, withLink: !1 }), y && r.createElement(l.Z, { style: R.accountDivider })) : null, Y, !y && (F || p || n.length) ? r.createElement(l.Z, { spacing: "space12" }) : null);
            }
            ...
            const $ = o().h6beb5fb,
                ...
                K = ({ accountSwitch: e, accountUsers: t, activeUser: n, createLocalApiErrorHandlerAccountsFetch: s, fetchAccounts: a, fetchStatus: o, handleClose: c, manageAccountsMenuItem: l, shouldDisplayFetchRenderer: u }) => {
                    const p = t.filter((e) => e.user_id !== n?.id_str),
                        ...
                        f = r.useMemo(() => r.createElement(d.Z, { link: l.link, onClick: g, style: Y.IconMoreCircleContainer, testID: l.testID, withoutInteractiveStyles: !0 }, r.createElement(z, null, r.createElement(H.default, { style: Y.IconMoreCircle })), m > 0 && r.createElement(E.Z, { count: m, style: m > 9 && Y.notificationBadge, truncatedCountFormatter: $, unreadCountLabel: G })), [g, l.link, l.testID, m]),
                        w = r.useCallback(
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.SideNav~loader.SideNavRedesign~bundle.JobSearch.a9e109ea.js.map
