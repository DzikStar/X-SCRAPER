...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Spacebar~loader.SidebarSpacebar", "icons/IconChevronRight-js", "icons/IconFollowArrowLeft-js", "icons/IconSound-js", "icons/IconSparkle-js"],
    {
        530568: (e, t, r) => {
            r.d(t, { B: () => oe, I: () => q });
            var a = r(202784),
            ...
            var E = r(731708),
                ...
                Z = r(124964);
            function w(e) {
                return a.createElement(u.Z, { style: x.pillTextContent }, a.createElement(E.ZP, { align: "left", color: "white", numberOfLines: 1, size: "subtext2", style: x.pillTextContent_title }, e.count ? a.createElement(E.ZP, { weight: "bold" }, a.createElement(_.Z.ParticipantsCount, { count: e.count, labelType: "plusCount" })) : null, a.createElement(Z.Z, { color: "white" }), e.title));
            }
            ...
            const $ = "https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png",
                U = { Broadcast: B().e39b368e, Space: B().ab4fc8bc, EmployeeSpace: B().b6de83a0, PrivateBroadcast: B().g3f251f2, PrivateSpace: B().d08666ba, BeFirstJoin: B().eadb5a46, HostsBroadcast: B().f9629a8f, HostsSpace: B().ia3c0ab7, HostedBy: B().hd552761, RelativePosition: B().c3ea19a5, WithParticipants: B().a5235305, socialProof: { isListening: B().df9f8243, isSpeaking: B().g2445c2f, isHosting: B().fcfd5a67, isCohosting: B().f7882829 } };
            function G(e) {
                const t = (0, A.z)(),
                    r = (0, V.I0)(),
                    o = (0, k.useHistory)(),
                    ...
                    E = a.useMemo(() => (f ? "audiospace" : h ? "livevideo" : void 0), [f, h]),
                    _ = a.useMemo(() => (u ? u.slice(0, 3) : []), [u]),
                    Z = a.useMemo(() => (f?.social_proof?.length ? f.social_proof[0] : h ? { role: I.host, user_id: m, user_id_str: p } : void 0), [f, h, m, p]);
                a.useEffect(() => {
                    if (_.length) {
                        const e = [p, ..._];
                        Z && e.push(Z.user_id_str), r(N.ZP.fetchManyIfNeeded(_));
                    }
                }, [r, Z, _, p]);
                const w = Math.max(0, C - _.length),
                    x = (0, V.v9)((e) => N.ZP.selectMany(e, _)),
                    M = a.useMemo(() => (x.length ? x.map((e) => e.profile_image_url_https ?? $) : Array(_.length).fill($)), [_, x]),
                    B = a.useMemo(() => (x.length && "Square" === x[0].profile_image_shape ? "xSmall" : "infinite"), [x]),
            ...
            function q({ isFirst: e, thread: t }) {
                const { "aria-label": r, borderRadius: c, onImpression: u, onPress: m, otherParticipantsCount: p, title: f, type: h, userAvatarUrls: g } = G(t),
                    ...
                    _ = a.useMemo(() => [Q.animatedViewPress, { transform: [{ scale: b }] }], [b]),
                ...
                return a.createElement(s.Z, { onImpression: u }, a.createElement(n.Z, { "aria-label": r, onPress: m, onPressIn: C, onPressOut: E, style: Z }, a.createElement(o.Z.View, { style: _ }, a.createElement(y, { borderRadius: c, type: h, userAvatarUrls: g }, a.createElement(w, { count: p, title: f }), a.createElement(d, null), a.createElement(l.L, { size: "space8" })))));
            }
            ...
            function re({ socialProof: e }) {
                const t = a.useMemo(() => a.createElement(X.Z, { affiliateBadgeInfo: e.user.highlightedLabel, avatarSize: "small", isBlueVerified: e.user.is_blue_verified, isVerified: e.user.verified, name: e.user.name, nameSize: "subtext2", profileImageUrl: e.user.profile_image_url_https, verifiedType: e.user.verified_type }), [e]),
                    r = a.useMemo(() => (e.role === I.host ? a.createElement(B().I18NFormatMessage, { $i18n: "d80a7547" }, t) : e.role === I.cohost ? a.createElement(B().I18NFormatMessage, { $i18n: "j7293d6b" }, t) : e.role === I.speaker ? a.createElement(B().I18NFormatMessage, { $i18n: "df79977f" }, t) : e.role === I.listener ? a.createElement(B().I18NFormatMessage, { $i18n: "ad960f39" }, t) : void 0), [t, e]);
                return a.createElement(E.ZP, { color: "gray700", numberOfLines: 1, size: "subtext2", style: ae.socialProof }, r);
            }
        ...
        109808: (e, t, r) => {
            ...
            const v = (0, m.K9)((e) => e(c.dd).withEndpoint(l.Z).spacebar()),
                ...
                Z = (0, f.W)((e, t) => {
                    ...
                    return (0, d.Cg)({ topic: a, featureSwitches: e(c.f0), onTopic: () => t(E) });
                }),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Spacebar~loader.SidebarSpacebar.fe0ee98a.js.map
