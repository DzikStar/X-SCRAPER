(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.Typeahead~loader.AppModules~loader.DMDrawer~ondemand.HoverCard~ondemand.NotFound~bundle.AboutTh"],
    {
        ...
        118823: (e, t, r) => {
            "use strict";
            r.d(t, { WP: () => ie, R2: () => ne, YW: () => q, Ig: () => te, n8: () => K, YU: () => se, Ai: () => ue, Lw: () => V, z_: () => X, qE: () => Q, tY: () => oe, iD: () => J, jv: () => Y, or: () => D, UD: () => L, cu: () => U, b: () => Z, Du: () => G, zj: () => z, W2: () => F, uz: () => x, Lg: () => B, li: () => M, $B: () => j, B7: () => N, aR: () => W, Wl: () => ae, YF: () => re, d7: () => ce, if: () => ee });
            ...
            const U = (e) => e[g].flowToken,
                ...
                q = (e) => {
                    const t =
                        ...
                        (r, n, { api: i, userPersistence: o }) => {
                            const { flow_name: a } = t;
                            return (0, p._O)(r, { params: t, request: e.task(i) })({ actionTypes: b, context: "START_FLOW", meta: { flowName: a } }).then((e) => (a && P.has(a) && e.statusText === w && o.set(E, { [a]: n()[g] }), e));
                        };
                    return {
                        clearFlow:
                            ({ clearPersistence: e } = {}) =>
                        ...
                        startFlow:
                            ...
                            (r, n, { api: i, userPersistence: o }) => {
                                const { flow_name: a } = e;
                                return (P.has(a) || "__OCF_2FA_X_CHALLENGE__" in window ? o.get(E, 36e5) : Promise.resolve(void 0)).then((n) => (a && n && n[a] ? r({ payload: n[a], type: A }) : r(t(e))));
                            },
                        submitFlow:
                            ...
                            (n, i, { api: o, userPersistence: a }) => {
                                ...
                                return (0, p._O)(n, { params: d, request: e.task(o) })({ actionTypes: m, context: "SUBMIT_FLOW", meta: { isTaskNavigation: t } }).then((e) => {
                                    const t = i()[g];
                                    if (t.flowName) {
                ...
                X =
                    ...
                    (i, o) => {
                        ...
                        "clear" === p && n && (f[n] = {});
                        const _ = I(h) && (!p || d);
                        i({ type: S, payload: { navigationContext: { action: "", ...r }, sendPinCode: _, subtaskId: n, subtaskInputs: f, navigationStack: c } });
                    },
                $ = (e, t) =>
                    Object.keys(t)
                        .map((r) => {
            ...
            const K = (e, t) => (r, n, o) => {
                ...
                ee =
                    ...
                    (t, r, { api: n }) => {
                        if (r()[g].sendPinCode || void 0 !== e.arkose_access_token) {
                            const i = e.flow_token ?? U(r()),
                                o = { ...e, flow_token: i };
                            return (0, p._O)(t, { params: o, request: n.withEndpoint(a.Z).verifyUserIdentifier })({ actionTypes: R, context: "VERIFY_IDENTIFIER" });
                        }
                ...
                re = (e, t) => (r, n) => {
                    ...
                    let c;
                    "front" === i ? (c = { location: "splash_screen" }) : "login" === i ? (c = { location: "login" }) : "home" === i ? (c = { location: "home" }) : "settings" === i ? (c = { location: "settings" }) : a ? (c = { location: "profile", profile: { profile_id: a } }) : s ? (c = { location: "search", search: s }) : u ? (c = { location: "tweet", tweet: { tweet_id: u } }) : o && (c = { location: "event", event: { event_id: o } }), c && r({ type: v, payload: c });
                },
                ne =
                    (e, t = {}) =>
                    (r, n, { api: i }) =>
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.Typeahead~loader.AppModules~loader.DMDrawer~ondemand.HoverCard~ondemand.NotFound~bundle.AboutTh.cc6073ba.js.map
