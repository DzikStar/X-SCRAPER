...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loader.inlineTombstoneHandler~loader.tweetHandler"],
    {
            ...
            const m = { header: h().d231a76a, description: h().heaba5d8, legalDisclaimer: h().i57d3ea0, buttonText: h().a0440af6, image: { darkMode: b, lightMode: p } },
                ...
                _ = ({ buttonOnSameLine: e, link: t, occasion: o, styleOverrides: u, withBackgroundImage: h }) => {
                    ...
                    const C = () => {
                        ...
                        k = y ? i.default.theme.colors[y] : i.default.theme.colors.gray900,
                        v = f ? i.default.theme.spaces[f] : i.default.theme.spaces.space16,
                    ...
                    return h ? n.createElement(r.Z, { interactiveStyles: null, link: t, onPress: C, style: D.bannerContainer }, n.createElement(d.Z, { resizeMode: "contain", source: { uri: "light" === i.default.theme.paletteName ? I.image.lightMode : I.image.darkMode }, style: { height: 85 } })) : n.createElement(a.Z, { style: [D.card, { backgroundColor: M }, { maxWidth: g }, { marginBottom: v }], testID: "popupCard" }, n.createElement(a.Z, { style: e ? D.horizontalContent : D.verticalContent }, n.createElement(a.Z, { style: e ? D.textContainer : null }, n.createElement(l.ZP, { size: "headline2", style: [D.popupTitle, { alignSelf: "flex-start" }], weight: "bold" }, I.header), n.createElement(l.ZP, { size: "subtext1", style: [D.popupDescription, { color: k }] }, I.description, " ", e ? null : I.legalDisclaimer)), n.createElement(a.Z, { style: D.buttonContainer }, n.createElement(s.ZP, { backgroundColor: "light" === i.default.theme.paletteName ? "orange300" : "orange600", borderColor: "transparent", link: t, onClick: C, size: "medium", style: [D.popupButton, { width: S }] }, I.buttonText), e && n.createElement(l.ZP, { size: "subtext3", style: [D.legalDisclaimer, { color: k }] }, I.legalDisclaimer))));
                },
        ...
        114054: (e, t, o) => {
            ...
            const U = u().j0179e90,
                L = u().ee69d769({ verb: "" }),
                N = ({ getLocationState: e, history: t }) => a.createElement(R.Z, { "aria-label": U, getLocationState: e, history: t, icon: F, label: L, scribeComponent: "floating_compose_button" }),
                F = a.createElement(Z.default, null);
            var O = o(231214),
                H = o(177371),
                z = o(533128),
                W = o(523561),
            ...
            const Ie = u().de21174c,
                ...
                Ee = () => {
                    ...
                    return (
                        ...
                        a.createElement(i.Z, { style: Be.callout }, a.createElement(ye.Z, { Icon: ke.default, action: { label: xe, link: Pe }, headline: Ie, text: Te, type: "primary" }))
                    );
                },
                Ze = u().f277e94a,
                Re = u().da59404c;
            class Ue extends a.Component {
                    ...
                    super(...e),
                        ...
                        (this._scribeAction = (e, t, o, n, a) => {
                            const { analytics: i, history: r, promotedContent: d, richScribeAction: l, tweet: s } = this.props,
                                ...
                                b = a && s && s.quoted_status ? v.Z.getTweetItem(s, d, void 0, c, {}, !0) : s ? v.Z.getTweetItem(s, d, void 0, c, {}, !1) : void 0,
                                m = { items: v.Z.leftMergeScribeItems(b ? [b] : [], h), ...(0, p.Z)(o ? { click_tracking_embed_details: o } : null), ...t };
                            if (n && s)
                                if (a) {
                                    if (s.quoted_status && s.quoted_status.user) {
                                        const e = v.Z.getUserItem(s.quoted_status.user, d);
                                        m.items.push(e);
                                    }
                                } else {
                                    const e = v.Z.getUserItem(s.user, d);
                                    m.items.push(e);
                                }
                            l({ ...u, ...e }, m);
                        }),
                        ...
                        (this._handleEntityClick = (e, t, o) => {
                            const n = f._4[t],
                                a = k.Z[t],
                                i = v.Z.getClickTrackingEmbedDetails(this.props.promotedContent, o);
                            if (n) {
                ...
                _renderIntentPrompt() {
                    ...
                    if (n && t.location.pathname.indexOf("/intent/") > -1) return a.createElement(O.Z, { forwardPivotInfo: e, history: t, location: t.location, nudges: o, tweetId: n.id_str });
                }
                _renderTweetComponent() {
                    const { analytics: e, contextTweet: t, feedbackItems: o, forwardPivotInfo: i, hasModeratedReplies: d, history: l, innerForwardPivotInfo: s, innerNudges: c, isActiveCreator: u, isNsfwUser: h, isPinned: b, location: p, nudges: m, onTweetDismiss: D, promotedContent: C, promotedContentAdvertiser: A, quoteTweetSocialContextProps: S, quotedTweetTombstoneInfo: g, readerModeAvailable: f, replyBadge: M, replyContext: k, rootTweetAuthorId: v, showReplyFilterInlineCallout: I, socialContext: T, socialContextColor: x, topic: P, topicFollowPrompt: B, tweet: E, userCountry: Z, userLanguage: R, viewerUser: U, withActions: L, withCommunityModerationAuthority: N, withHideReply: F, withInlineMedia: O, withSocialContext: H } = this.props;
                    if (!E) return null;
                    const { viewerUserId: z } = this.context,
                        { enableKeyboardShortcuts: W } = this.state,
                        V = r.Z.getOriginalTweet(E),
                        q = { contextTweet: t, enableKeyboardShortcuts: W, forwardPivotInfo: i, hasModeratedReplies: d, handleReplyFilterInlineCalloutImpression: this._handleReplyFilterInlineCalloutImpression, showReplyFilterInlineCallout: I, innerForwardPivotInfo: s, viewerUser: U, promotedContent: C, promotedContentAdvertiser: A, quotedTweetTombstoneInfo: g, quoteTweetSocialContextProps: S, readerModeAvailable: f, socialContext: T, socialContextColor: x, topic: P, topicFollowPrompt: B, tweet: E, replyBadge: M, replyContext: k, rootTweetAuthorId: v, withActions: L, withAltTextBadge: !0, withInlineMedia: O, withSocialContext: H, nudges: m, innerNudges: c },
                        K = V.user.id_str === z,
                        ...
                        a.createElement(
                            ...
                            a.createElement(
                                ...
                                (0, n.Z)({}, q, {
                                    ...
                                    renderCurationActionMenu: this._getRenderCurationActionMenu(o, i?.displayType, i?.landingUrl, l, u, h, b, p, this._handleCaretClick, D, C, r.Z.getOriginalTweet(E), $, Q, F, N, Z, R),
                                }),
                            ),
                ...
                _renderReportedTombstone() {
                    ...
                    if (e) {
                        ...
                        return a.createElement(H.Z, { actionText: Ze, lang: e.lang, onClick: this._handleShowReportedTweet }, o);
                    }
                }
            ...
            Ue.contextType = E.rC;
            const Le = (0, P.ZP)(ge(Ue)),
                Ne = (0, x.Z)(Le),
                Fe = (0, x.Z)(Le, { component: "tweet" });
        },
        886404: (e, t, o) => {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.inlineTombstoneHandler~loader.tweetHandler.e97125ca.js.map
