    ...
    ["shared~loader.inlineTombstoneHandler~loader.tweetHandler"],
    {
        ...
        114054: (e, t, o) => {
            ...
            const Ie = u().de21174c,
                Te = u().haebcf52,
                xe = u().i859a9d4,
                Ee = (0, fe.ju)("https://help.x.com/using-twitter/mentions-and-replies#mention-control"),
                Be = ve.default.create((e) => ({ callout: { marginVertical: e.spaces.space8, marginHorizontal: e.spaces.space16 } })),
                Pe = () => {
                    const e = (0, x.z)();
                    return (
                        (0, ke.q)(() => {
                        ...
                        a.createElement(i.Z, { style: Be.callout }, a.createElement(ye.Z, { Icon: Me.default, action: { label: xe, link: Ee }, headline: Ie, text: Te, type: "primary" }))
                    );
                },
                Ze = u().f277e94a,
                Re = u().da59404c;
            class Le extends a.Component {
                ...
                _renderTweetComponent() {
                    const { analytics: e, contextTweet: t, feedbackItems: o, forwardPivotInfo: i, hasModeratedReplies: d, history: l, innerForwardPivotInfo: s, innerNudges: c, isActiveCreator: u, isNsfwUser: h, isPinned: b, location: p, nudges: m, onTweetDismiss: D, promotedContent: C, promotedContentAdvertiser: A, quoteTweetSocialContextProps: S, quotedTweetTombstoneInfo: g, readerModeAvailable: f, replyBadge: v, replyContext: M, rootTweetAuthorId: k, showReplyFilterInlineCallout: I, socialContext: T, socialContextColor: x, topic: E, topicFollowPrompt: B, tweet: P, userCountry: Z, userLanguage: R, viewerUser: L, withActions: U, withCommunityModerationAuthority: H, withHideReply: N, withInlineMedia: z, withSocialContext: F } = this.props;
                    if (!P) return null;
                    const { viewerUserId: O } = this.context,
                        { enableKeyboardShortcuts: V } = this.state,
                        W = r.Z.getOriginalTweet(P),
                        q = { contextTweet: t, enableKeyboardShortcuts: V, forwardPivotInfo: i, hasModeratedReplies: d, handleReplyFilterInlineCalloutImpression: this._handleReplyFilterInlineCalloutImpression, showReplyFilterInlineCallout: I, innerForwardPivotInfo: s, viewerUser: L, promotedContent: C, promotedContentAdvertiser: A, quotedTweetTombstoneInfo: g, quoteTweetSocialContextProps: S, readerModeAvailable: f, socialContext: T, socialContextColor: x, topic: E, topicFollowPrompt: B, tweet: P, replyBadge: v, replyContext: M, rootTweetAuthorId: k, withActions: U, withAltTextBadge: !0, withInlineMedia: z, withSocialContext: F, nudges: m, innerNudges: c },
                        K = W.user.id_str === O,
                ...
                _renderInlineReply() {
                    ...
                    if (!o) return null;
                    return r && !this._shouldDisable(o, O.d.Reply) ? a.createElement(B.c_, null, (0, S.ZP)() ? a.createElement(q, { history: e, location: t, parentTweetId: n, replyPressToggle: i }) : a.createElement(m.Z, { container: s.Z, fab: this._fabReply(e), withoutBottomPadding: !0 })) : null;
                }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loader.inlineTombstoneHandler~loader.tweetHandler.9608c1ca.js.map
