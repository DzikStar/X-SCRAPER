...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.LiveEvent~loader.M-85aa903d"],
    {
        396682: (e, t, i) => {
            i.d(t, { Z: () => G });
            i(571372), i(136728);
            ...
            class q {
                constructor({ source: e = {}, videoConfig: t, domElement: s, httpClient: c, twitterAuthedHttpClient: p, options: u = {} }) {
                    (this.teardown = () => {
                        ...
                        (this.source.type !== J.P.BROADCAST && this.source.type !== J.P.STATIC_BROADCAST && this.source.type !== J.P.AUDIO_SPACE) || (this.hydraExperienceId = u.hydraExperienceId = N.Z.dispatch((0, r.mC)())),
                        (this.options = u);
                    let g = -1;
                ...
                attach(e) {
                    this.video || ((this.domElement = e), (this.video = new M(this.domElement, this.id, N.Z, this.reload, this.logger, this.options)));
                }
                _getPlayerState(e) {
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loaders.video.PlayerBase~bundle.TwitterArticles~bundle.ComposeMedia~bundle.LiveEvent~loader.M-85aa903d.e5ee0e1a.js.map
