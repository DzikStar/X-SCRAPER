...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~loaders.video.VideoPlayerDefaultUI~loaders.video.VideoPlayerPrerollUI", "icons/IconSound-js"],
    {
        215337: (e, t, n) => {
            n.d(t, { Z: () => i });
            var r = n(202784),
        ...
        162317: (e, t, n) => {
            ...
            const D = d.default.create((e) => ({ thumbnail: { backgroundColor: e.colors.translucentBlack77, borderRadius: e.borderRadii.small, display: "flex", overflow: "hidden", opacity: 1 }, thumbnailFocused: { boxShadow: `0 0 0 ${e.borderWidths.medium} ${e.colors.white}`, outlineStyle: "none" }, countdownTime: { paddingHorizontal: e.spaces.space4, minWidth: "1em", display: "flex", alignItems: "center", justifyContent: "center", fontVariant: "tabular-nums" }, iconMargin: { marginStart: "0.5em" }, iconMarginRtl: { marginEnd: "0.5em" } })),
                F = ({ onClick: e }) => {
                    ...
                    return r.createElement(L.Z, { "aria-label": S ? f.DP : C, focusable: !0, interactive: !0, interactiveStyles: null, onClick: S && e ? e : A.Z, role: "button", testID: "ControlBar-containerView" }, (e) => r.createElement(r.Fragment, null, !S && r.createElement(i.Z, { show: p }, r.createElement(a.Z, { style: [D.thumbnail, { flexDirection: s ? "row-reverse" : "row" }, e.isFocused && D.thumbnailFocused], testID: "ControlBar-videoThumbnail" }, r.createElement(o.ZP, { color: "white", size: "subtext2", style: D.countdownTime }, y), r.createElement(Z.Z, { source: n.posterImage, style: (0, I.K)(t) }))), r.createElement(i.Z, { show: S }, r.createElement(k.ZP, { focusable: !1, interactivityState: e, pointerEvents: "auto", size: "small", testID: "ControlBar-skipButton", type: "onMediaDominantColorFilled" }, r.createElement(o.ZP, { dir: "ltr", weight: "normal" }, f.Be, r.createElement(P.default, { style: s ? D.iconMarginRtl : D.iconMargin }))))));
                },
                O = "PrerollControlBar-",
                    ...
                    super(...e),
                        ...
                        (this._renderActionButton = (e, t) => {
                            const { controls: n, isPlaying: a } = t,
                                { pause: o, play: i } = e,
                                l = (0, b.Ci)(t);
                            return !l || l.isLive ? null : a || (n && "PLAY_REQUESTED" === n.playState) ? r.createElement(w.Z, { "aria-label": _.gF, hoverLabelPreferredHorizontalOrientation: "end", icon: r.createElement(g.default, null), onPress: o }) : r.createElement(w.Z, { "aria-label": _.M2, hoverLabelPreferredHorizontalOrientation: "end", icon: r.createElement(v.default, null), onPress: i });
                        }),
                        ...
                        (this._renderSkipAffordance = () => r.createElement(a.Z, { style: W.skipAffordance }, r.createElement(F, null)));
                }
                render() {
                        ...
                        (this._renderLabels = (e) =>
                            r.createElement(m.o, { periodic: !0 }, ({ playerState: t }) => {
                                const n = (0, b.Ci)(t),
                                    ...
                                    S = r.createElement(a.Z, { ref: this._descriptionLabelRef }, r.createElement(l.ZP, { key: "PrerollVideoOverlay-DescriptionLabel", style: [u.W.label, e ? $.labelSpaceLeft : u.W.spaceRight, ...(e ? h : m)] }, r.createElement(o.ZP, { numberOfLines: 1 }, f.DD)));
        ...
        452661: (e, t, n) => {
                        ...
                        if (null !== s) s.touchActive && s.currentTimeStamp > t && ((i += r && n ? s.currentPageX : r && !n ? s.currentPageY : !r && n ? s.previousPageX : s.previousPageY), (l = 1));
                            ...
                            for (var c = 0; c < o.length; c++) {
                                ...
                                if (null != u && u.touchActive && u.currentTimeStamp >= t) {
                                    (i += r && n ? u.currentPageX : r && !n ? u.currentPageY : !r && n ? u.previousPageX : u.previousPageY), l++;
                                }
                            }
                        return l > 0 ? i / l : a.noCentroid;
                    },
            ...
            var i = o.currentCentroidXOfTouchesChangedAfter,
                l = o.currentCentroidYOfTouchesChangedAfter,
                s = o.previousCentroidXOfTouchesChangedAfter,
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~loaders.video.VideoPlayerDefaultUI~loaders.video.VideoPlayerPrerollUI.5d6ca46a.js.map
