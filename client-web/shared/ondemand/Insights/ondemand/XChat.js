    ...
    ["shared~ondemand.Insights~ondemand.XChat"],
    {
        772669: (e, t, n) => {
            ...
            var r = n(552322),
                ...
                o = n(202784),
                i = n(840489);
            const s = (0, o.forwardRef)(function ({ className: e, ...t }, n) {
                ...
                u = (0, o.forwardRef)(function ({ multiline: e, ...t }, n) {
                    return e ? (0, r.jsx)(l, { ...t, ref: n }) : (0, r.jsx)(s, { ...t, ref: n });
                }),
                ...
                c = (0, o.forwardRef)(function ({ borderRadius: e, variant: t, leftContent: n, rightContent: o, ...i }, s) {
                    return (0, r.jsxs)("div", { className: d({ borderRadius: e ?? (i.multiline ? "3xLarge" : "full"), className: (0, a.cx)(n ? "ps-3" : "ps-4", o ? "pe-3" : "pe-4"), variant: t }), children: [n, (0, r.jsx)(u, { ...i, ref: s }), o] });
                });
        },
        42630: (e, t, n) => {
            n.d(t, { A: () => i, S: () => s });
        ...
        194787: (e, t, n) => {
            ...
            const p = "undefined" != typeof document && window.visualViewport;
            function m(e) {
                                                    ...
                                                    (t.style.transform = ""),
                                                        p &&
                                                            (p.height < window.innerHeight
                                                                ...
                                                                : p.addEventListener("resize", () => x(t), { once: !0 }));
                                                }));
                                        },
                                        i = () => {
                                            window.scrollTo(0, 0);
            ...
            function O(e, t) {
                ...
                return a ? parseFloat(a[1].split(", ")[T(t) ? 13 : 12]) : ((a = r.match(/^matrix\((.+)\)$/)), a ? parseFloat(a[1].split(", ")[T(t) ? 5 : 4]) : null);
            }
            function C(e, t) {
                if (!e) return () => {};
            ...
            function N({ prop: e, defaultProp: t, onChange: n = () => {} }) {
            ...
            let M = null;
            function B({ open: e, onOpenChange: t, children: n, onDrag: i, onRelease: l, snapPoints: d, shouldScaleBackground: c = !1, setBackgroundColorOnScale: f = !0, closeThreshold: p = 0.25, scrollLockTimeout: m = 100, dismissible: h = !0, handleOnly: v = !1, fadeFromIndex: g = d && d.length - 1, activeSnapPoint: w, setActiveSnapPoint: b, fixed: x, modal: E = !0, onClose: C, nested: k, noBodyStyles: B = !1, direction: F = "bottom", defaultOpen: I = !1, disablePreventScroll: L = !0, snapToSequentialPoint: j = !1, preventScrollRestoration: H = !1, repositionInputs: z = !0, onAnimationEnd: W, container: U, autoFocus: q = !1 }) {
                var Y, X;
                const [_ = !1, V] = N({
                        defaultProp: I,
                        prop: e,
                    ...
                    ce = a.useRef(0),
                    fe = a.useRef(null),
                    pe = a.useRef((null == (Y = fe.current) ? void 0 : Y.getBoundingClientRect().height) || 0),
                    me = a.useRef((null == (X = fe.current) ? void 0 : X.getBoundingClientRect().width) || 0),
                    he = a.useRef(0),
                    ve = a.useCallback((e) => {
                    ...
                    }, []),
                    {
                        ...
                        const [c, f] = N({ prop: e, defaultProp: null == n ? void 0 : n[0], onChange: t }),
                            [p, m] = a.useState("undefined" != typeof window ? { innerWidth: window.innerWidth, innerHeight: window.innerHeight } : void 0);
                        a.useEffect(() => {
                            function e() {
                        ...
                        const h = a.useMemo(() => c === (null == n ? void 0 : n[n.length - 1]) || null, [n, c]),
                                    ...
                                    (t =
                                        null == n
                                            ...
                                            : n.map((t) => {
                                                  ...
                                                  let r = 0;
                                                  if ((n && (r = parseInt(t, 10)), T(l))) {
                                                      const a = n ? r : p ? t * e.height : 0;
                                                      return p ? ("bottom" === l ? e.height - a : -e.height + a) : a;
                                                  }
                                                  const a = n ? r : p ? t * e.width : 0;
                                                  return p ? ("right" === l ? e.width - a : -e.width + a) : a;
                                              }))
                                    ? t
                                    : [];
                            }, [n, p, u]),
                            ...
                            b = a.useCallback(
                                (e) => {
                                    ...
                                    s(a), S(r.current, { transition: `transform ${D.DURATION}s cubic-bezier(${D.EASE.join(",")})`, transform: T(l) ? `translate3d(0, ${e}px, 0)` : `translate3d(${e}px, 0, 0)` }), w && a !== w.length - 1 && void 0 !== i && a !== i && a < i ? S(o.current, { transition: `opacity ${D.DURATION}s cubic-bezier(${D.EASE.join(",")})`, opacity: "0" }) : S(o.current, { transition: `opacity ${D.DURATION}s cubic-bezier(${D.EASE.join(",")})`, opacity: "1" }), f(null == n ? void 0 : n[Math.max(a, 0)]);
                                },
                                [r.current, n, w, i, o, f],
                            );
                        return (
                            ...
                            }, [c, e, n, w, b]),
                            {
                                ...
                                onRelease: function ({ draggedDistance: e, closeDrawer: t, velocity: r, dismissible: a }) {
                                    ...
                                    const s = "bottom" === l || "right" === l ? (null != y ? y : 0) - e : (null != y ? y : 0) + e,
                                        u = 0 === v,
                                        c = e > 0;
                                    if ((v === i - 1 && S(o.current, { transition: `opacity ${D.DURATION}s cubic-bezier(${D.EASE.join(",")})` }), !d && r > 2 && !c)) return void (a ? t() : b(w[0]));
                                    if (!d && r > 2 && c && w && n) return void b(w[n.length - 1]);
                                    const f = null == w ? void 0 : w.reduce((e, t) => ("number" != typeof e || "number" != typeof t ? e : Math.abs(t - s) < Math.abs(e - s) ? t : e)),
                                        p = T(l) ? window.innerHeight : window.innerWidth;
                                    if (r > 0.4 && Math.abs(e) < 0.4 * p) {
                                        const e = c ? 1 : -1;
                                ...
                                onDrag: function ({ draggedDistance: e }) {
                                    ...
                                    (("bottom" === l || "right" === l) && t < w[w.length - 1]) || (("top" === l || "left" === l) && t > w[w.length - 1]) || S(r.current, { transform: T(l) ? `translate3d(0, ${t}px, 0)` : `translate3d(${t}px, 0, 0)` });
                                },
                                snapPointsOffset: w,
                            }
                        );
                    })({ snapPoints: d, activeSnapPointProp: w, setActiveSnapPointProp: b, drawerRef: fe, fadeFromIndex: g, overlayRef: te, onSnapPointChange: ve, direction: F, container: U, snapToSequentialPoint: j });
                y({ isDisabled: !_ || J || !E || Q || !Z || !z || !L });
                const { restorePositionSetting: Se } = (function ({ isOpen: e, modal: t, nested: n, hasBeenOpened: r, preventScrollRestoration: o, noBodyStyles: i }) {
                    const [l, u] = a.useState(() => ("undefined" != typeof window ? window.location.href : "")),
                        d = a.useRef(0),
                        c = a.useCallback(() => {
                            if (s() && null === M && e && !i) {
                                M = { position: document.body.style.position, top: document.body.style.top, left: document.body.style.left, height: document.body.style.height, right: "unset" };
                        ...
                        f = a.useCallback(() => {
                            if (s() && null !== M && !i) {
                                ...
                                Object.assign(document.body.style, M),
                                    window.requestAnimationFrame(() => {
                ...
                })({ isOpen: _, modal: E, nested: null != k && k, hasBeenOpened: Z, preventScrollRestoration: H, noBodyStyles: B });
                function Te() {
                ...
                return (
                    ...
                    a.useEffect(
                        () => (
                            _ && (S(document.documentElement, { scrollBehavior: "auto" }), (ne.current = new Date())),
                            () => {
                                !(function (e, t) {
                                    if (!(e && e instanceof HTMLElement)) return;
                                    let n = P.get(e);
                        ...
                        a.createElement(
                            o.Provider,
                            {
                                value: {
                                    ...
                                    onPress: function (e) {
                                        var t, n;
                                        (h || d) && ((fe.current && !fe.current.contains(e.target)) || ((pe.current = (null == (t = fe.current) ? void 0 : t.getBoundingClientRect().height) || 0), (me.current = (null == (n = fe.current) ? void 0 : n.getBoundingClientRect().width) || 0), K(!0), (re.current = new Date()), u() && window.addEventListener("touchend", () => (ie.current = !1), { once: !0 }), e.target.setPointerCapture(e.pointerId), (le.current = T(F) ? e.pageY : e.pageX)));
                                    },
                                    onRelease: function (e) {
                                        if (!J || !fe.current) return;
                                        fe.current.classList.remove(A), (ie.current = !1), K(!1), (ae.current = new Date());
                                        const t = O(fe.current, F);
                                        if (!e || !Oe(e.target, !1) || !t || Number.isNaN(t)) return;
                                        if (null === re.current) return;
                                        const n = ae.current.getTime() - re.current.getTime(),
                                            r = le.current - (T(F) ? e.pageY : e.pageX),
                                            a = Math.abs(r) / n;
                                        if (
                                            (a > 0.05 &&
                                                (ee(!0),
                                            ...
                                            return be({ draggedDistance: r * ("bottom" === F || "right" === F ? 1 : -1), closeDrawer: Ce, velocity: a, dismissible: h }), void (null == l || l(e, !0));
                                        }
                                        if ("bottom" === F || "right" === F ? r > 0 : r < 0) return De(), void (null == l || l(e, !0));
                                        if (a > 0.4) return Ce(), void (null == l || l(e, !1));
                                        var o;
                                        ...
                                        const u = Math.min(null != (s = fe.current.getBoundingClientRect().width) ? s : 0, window.innerWidth),
                                            c = "left" === F || "right" === F;
                                        if (Math.abs(t) >= (c ? u : i) * p) return Ce(), void (null == l || l(e, !1));
                                        null == l || l(e, !0), De();
                                    },
                                    onDrag: function (e) {
                                        var t;
                                        if (fe.current && J) {
                                            const n = "bottom" === F || "right" === F ? 1 : -1,
                                                r = (le.current - (T(F) ? e.pageY : e.pageX)) * n,
                                                a = r > 0,
                                                o = d && !h && !a;
                                            if (o && 0 === we) return;
                                            const s = Math.abs(r),
                                                l = document.querySelector("[data-vaul-drawer-wrapper]");
                                            let u = s / ("bottom" === F || "top" === F ? pe.current : me.current);
                                            const f = Pe(s, a);
                                            if ((null !== f && (u = f), o && u >= 1)) return;
                                            if (!ie.current && !Oe(e.target, a)) return;
                                            if ((fe.current.classList.add(A), (ie.current = !0), S(fe.current, { transition: "none" }), S(te.current, { transition: "none" }), d && Re({ draggedDistance: r }), a && !d)) {
                                                const e = ((t = r), 8 * (Math.log(t + 1) - 2)),
                                                    a = Math.min(-1 * e, 0) * n;
                                                return void S(fe.current, { transform: T(F) ? `translate3d(0, ${a}px, 0)` : `translate3d(${a}px, 0, 0)` });
                                            }
                                            const p = 1 - u;
                                            if (((Ee || (g && we === g - 1)) && (null == i || i(e, u), S(te.current, { opacity: `${p}`, transition: "none" }, !0)), l && te.current && c)) {
                                                const e = Math.min(Te() + u * (1 - Te()), 1),
                                                    t = 8 - 8 * u,
                                                    n = Math.max(0, 14 - 14 * u);
                                                S(l, { borderRadius: `${t}px`, transform: T(F) ? `scale(${e}) translate3d(0, ${n}px, 0)` : `scale(${e}) translate3d(${n}px, 0, 0)`, transition: "none" }, !0);
                                            }
                                            if (!d) {
                                                const e = s * n;
                                                S(fe.current, { transform: T(F) ? `translate3d(0, ${e}px, 0)` : `translate3d(${e}px, 0, 0)` });
                                            }
                                        }
                                    },
                                    dismissible: h,
                                    ...
                                    onNestedDrag: function (e, t) {
                                        ...
                                        const n = (window.innerWidth - $) / window.innerWidth,
                                            r = n + t * (1 - n),
                                            a = t * $ - 16;
                                        S(fe.current, { transform: T(F) ? `scale(${r}) translate3d(0, ${a}px, 0)` : `scale(${r}) translate3d(${a}px, 0, 0)`, transition: "none" });
                                    },
                                    onNestedOpenChange: function (e) {
                                        const t = e ? (window.innerWidth - $) / window.innerWidth : 1,
                                            n = e ? -16 : 0;
                                        se.current && window.clearTimeout(se.current),
                                            S(fe.current, { transition: `transform ${D.DURATION}s cubic-bezier(${D.EASE.join(",")})`, transform: `scale(${t}) translate3d(0, ${n}px, 0)` }),
                                            !e &&
                                                fe.current &&
                                                (se.current = setTimeout(() => {
                                                    const e = O(fe.current, F);
                                                    S(fe.current, { transition: "none", transform: T(F) ? `translate3d(0, ${e}px, 0)` : `translate3d(${e}px, 0, 0)` });
                                                }, 500));
                                    },
                                    onNestedRelease: function (e, t) {
                                        const n = T(F) ? window.innerHeight : window.innerWidth,
                                            r = t ? (n - $) / n : 1,
                                            a = t ? -16 : 0;
                                        t && S(fe.current, { transition: `transform ${D.DURATION}s cubic-bezier(${D.EASE.join(",")})`, transform: T(F) ? `scale(${r}) translate3d(0, ${a}px, 0)` : `scale(${r}) translate3d(${a}px, 0, 0)` });
                                    },
                                    keyboardIsOpen: ue,
                                    modal: E,
                                    snapPointsOffset: xe,
            ...
            const F = a.forwardRef(function ({ ...e }, t) {
                const { overlayRef: n, snapPoints: o, onRelease: s, shouldFade: l, isOpen: u, modal: d, shouldAnimate: c } = i(),
                    ...
                    p = o && o.length > 0;
                if (!d) return null;
                const m = a.useCallback((e) => s(e), [s]);
                return a.createElement(r.aV, { onMouseUp: m, ref: f, "data-vaul-overlay": "", "data-vaul-snap-points": u && p ? "true" : "false", "data-vaul-snap-points-overlay": u && l ? "true" : "false", "data-vaul-animate": (null == c ? void 0 : c.current) ? "true" : "false", ...e });
            });
            F.displayName = "Drawer.Overlay";
            const I = a.forwardRef(function ({ onPointerDownOutside: e, style: t, onOpenAutoFocus: n, ...o }, s) {
                const { drawerRef: l, onPress: u, onRelease: d, onDrag: c, keyboardIsOpen: f, snapPointsOffset: p, activeSnapPointIndex: m, modal: h, isOpen: v, direction: g, snapPoints: w, container: y, handleOnly: b, shouldAnimate: x, autoFocus: R } = i(),
                    [P, S] = a.useState(!1),
                    O = E(s, l),
                    $ = a.useRef(null),
                    A = a.useRef(null),
                ...
                !(function () {
                    ...
                    a.useEffect(() => {
                        if (t && n) {
                            ...
                            if (!t) return;
                            r && !o && C(document.body, { background: "black" }), C(t, { transformOrigin: T(e) ? "top" : "left", transitionProperty: "transform, border-radius", transitionDuration: `${D.DURATION}s`, transitionTimingFunction: `cubic-bezier(${D.EASE.join(",")})` });
                            const n = C(t, { borderRadius: "8px", overflow: "hidden", ...(T(e) ? { transform: `scale(${u()}) translate3d(0, calc(env(safe-area-inset-top) + 14px), 0)` } : { transform: `scale(${u()}) translate3d(calc(env(safe-area-inset-top) + 14px), 0, 0)` }) });
                            return () => {
                                n(),
                ...
                return (
                    ...
                    a.createElement(r.VY, {
                        ...
                        onPointerUp: (e) => {
                            null == o.onPointerUp || o.onPointerUp.call(o, e), ($.current = null), (k.current = !1), d(e);
                        },
                        onPointerOut: (e) => {
                            null == o.onPointerOut || o.onPointerOut.call(o, e), M(A.current);
                        },
                        onContextMenu: (e) => {
                            null == o.onContextMenu || o.onContextMenu.call(o, e), A.current && M(A.current);
                        },
                    })
                );
            });
            I.displayName = "Drawer.Content";
            const L = a.forwardRef(function ({ preventCycle: e = !1, children: t, ...n }, r) {
                const { closeDrawer: o, isDragging: s, snapPoints: l, activeSnapPoint: u, setActiveSnapPoint: d, dismissible: c, handleOnly: f, isOpen: p, onPress: m, onDrag: h } = i(),
                    v = a.useRef(null),
                    g = a.useRef(!1);
                function w() {
                    ...
                    "div",
                    {
                        onClick: function () {
                            g.current
                                ...
                                : window.setTimeout(() => {
                                      !(function () {
                                          if (s || e || g.current) return void w();
                                          if ((w(), !l || 0 === l.length)) return void (c || o());
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~ondemand.Insights~ondemand.XChat.1a04448a.js.map
