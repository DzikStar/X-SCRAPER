        ...
        194787: (e, t, n) => {
            ...
            function B({ open: e, onOpenChange: t, children: n, onDrag: i, onRelease: l, snapPoints: d, shouldScaleBackground: c = !1, setBackgroundColorOnScale: f = !0, closeThreshold: m = 0.25, scrollLockTimeout: p = 100, dismissible: h = !0, handleOnly: v = !1, fadeFromIndex: g = d && d.length - 1, activeSnapPoint: w, setActiveSnapPoint: b, fixed: x, modal: E = !0, onClose: C, nested: k, noBodyStyles: B = !1, direction: F = "bottom", defaultOpen: I = !1, disablePreventScroll: L = !0, snapToSequentialPoint: j = !1, preventScrollRestoration: H = !1, repositionInputs: z = !0, onAnimationEnd: W, container: U, autoFocus: q = !1 }) {
                ...
                const [_ = !1, V] = N({
                    ...
                    pe = a.useRef((null == (X = fe.current) ? void 0 : X.getBoundingClientRect().width) || 0),
                    he = a.useRef(0),
                    ve = a.useCallback((e) => {
                            ...
                            }, [c, e, n, w, b]),
                            {
                                ...
                                onRelease: function ({ draggedDistance: e, closeDrawer: t, velocity: r, dismissible: a }) {
                                    ...
                                    const f = null == w ? void 0 : w.reduce((e, t) => ("number" != typeof e || "number" != typeof t ? e : Math.abs(t - s) < Math.abs(e - s) ? t : e)),
                                        m = T(l) ? window.innerHeight : window.innerWidth;
                        ...
                        a.createElement(
                            o.Provider,
                            {
                                value: {
                                    ...
                                    onPress: function (e) {
                                        var t, n;
                                        (h || d) && ((fe.current && !fe.current.contains(e.target)) || ((me.current = (null == (t = fe.current) ? void 0 : t.getBoundingClientRect().height) || 0), (pe.current = (null == (n = fe.current) ? void 0 : n.getBoundingClientRect().width) || 0), K(!0), (re.current = new Date()), u() && window.addEventListener("touchend", () => (ie.current = !1), { once: !0 }), e.target.setPointerCapture(e.pointerId), (le.current = T(F) ? e.pageY : e.pageX)));
                                    },
                                    onRelease: function (e) {
                                        ...
                                        const u = Math.min(null != (s = fe.current.getBoundingClientRect().width) ? s : 0, window.innerWidth),
                                            c = "left" === F || "right" === F;
                                        if (Math.abs(t) >= (c ? u : i) * m) return Ce(), void (null == l || l(e, !1));
                                        null == l || l(e, !0), De();
                                    },
                                    onDrag: function (e) {
                                        var t;
                                        if (fe.current && J) {
                                            ...
                                            let u = s / ("bottom" === F || "top" === F ? me.current : pe.current);
                                            const f = Pe(s, a);
                                            ...
                                            const m = 1 - u;
                                            if (((Ee || (g && we === g - 1)) && (null == i || i(e, u), S(te.current, { opacity: `${m}`, transition: "none" }, !0)), l && te.current && c)) {
            ...
            const I = a.forwardRef(function ({ onPointerDownOutside: e, style: t, onOpenAutoFocus: n, ...o }, s) {
                const { drawerRef: l, onPress: u, onRelease: d, onDrag: c, keyboardIsOpen: f, snapPointsOffset: m, activeSnapPointIndex: p, modal: h, isOpen: v, direction: g, snapPoints: w, container: y, handleOnly: b, shouldAnimate: x, autoFocus: R } = i(),
                    [P, S] = a.useState(!1),
                    O = E(s, l),
                    $ = a.useRef(null),
                    A = a.useRef(null),
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~ondemand.Insights~ondemand.XChat.c64272ba.js.map
