...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~ondemand.SettingsInternals~ondemand.SettingsRevamp"],
    {
        ...
        715684: (e, t, n) => {
            n.d(t, { Fm: () => D, TG: () => b, UD: () => S, _1: () => I, dj: () => k, kz: () => E });
            var i = n(24949),
                r = n(697926),
                a = n(744531),
                s = n(226395),
        ...
        948985: (e, t, n) => {
            ...
            const v = d.Z.register(h),
                b = (e) => e[m].fetchStatus,
                E = (e) => (t, n) => (b(n()) === o.ZP.LOADED ? Promise.resolve() : t(k(e))),
                S =
                    (e, t, n) =>
                    (n, i, { api: r }) => {
                        const a = i();
        ...
        284430: (e, t, n) => {
            ...
            const N = I().afe4a358,
                ...
                H = I().c6e731ee,
                M = I().be582166,
                Q = { [w.t.PendingResult]: I().b496bc94, [w.t.RequestLocked]: I().d8f5cce4, [w.t.IdentityNonVerifiable]: I().i8427a1e, [w.t.CanVerifyIdentity]: M },
                $ = c.createElement(L.b, { label: q, link: K.LT }),
                j = (e) => {
                    const t = e.query?.status;
                    return !(!t || Array.isArray(t)) && t === w.t.PendingResult;
                },
                B = o,
                W = s,
                                    ...
                                    ({ data: n, fetchStatus: a, retry: l }) => {
                                        ...
                                        if (a === V.ZP.LOADED && n) {
                                            ...
                                            const d = !!u.is_identity_verified_label_hidden,
                                                ...
                                                p = m === w.t.CanVerifyIdentity && j(r) ? w.t.PendingResult : m,
                                                _ = p === w.t.UnavailableMissingBlueSubscription;
                                            switch ((e.scribe({ page: "identity_verification_settings", section: p, action: "impression" }), p)) {
                                                case w.t.RequestLocked:
                                                case w.t.PendingResult:
                                                case w.t.IdentityNonVerifiable:
                                                    return c.createElement(c.Fragment, null, c.createElement(v.Z, { description: Q[p] }), $);
                                                case w.t.IdentityVerified:
                                                case w.t.UnavailableMissingBlueSubscription:
                                                    return c.createElement(f.Z, null, c.createElement(v.Z, { description: M }), c.createElement(f.Z, { style: J.layoutDimensions }, _ ? c.createElement(C.Z, { variant: "IdVerification", withColoredIcon: !0 }) : X), i ? c.createElement(f.Z, null, c.createElement(b.Z, { checked: d, disabled: _, helpText: H, label: z, name: "is_identity_verified_label_hidden", onChange: s(o, u.__id) })) : null, $);
                                                case w.t.CanVerifyIdentity:
                                                    return c.createElement(f.Z, null, c.createElement(v.Z, { description: Q[p] }), c.createElement(g.Switch, null, c.createElement(g.Route, null, c.createElement(A.Z, { to: "/settings/account/id_verification/start" }))));
                                                default:
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~ondemand.SettingsInternals~ondemand.SettingsRevamp.0d370c1a.js.map
