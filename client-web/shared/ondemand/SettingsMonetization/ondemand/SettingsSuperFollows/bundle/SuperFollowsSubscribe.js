...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~ondemand.SettingsMonetization~ondemand.SettingsSuperFollows~bundle.SuperFollowsSubscribe", "icons/IconHeartStroke-js"],
    {
        478039: (e, t, n) => {
            n.d(t, { Z: () => W });
            var o = n(807896),
        ...
        990804: (e, t, n) => {
            ...
            const B = i().hdf7226a,
                W = { label: B },
                M = i().c9940955;
            function z({ activeColor: e, color: t, count: n, enableKeyboardShortcuts: r, iconSize: a, isDisabled: i, isFaded: c, isPresentational: l, link: s, onPress: d, renderWrapper: u, style: m, testID: p, withCount: g }) {
            ...
            const G = function ({ activeColor: e, color: t, count: n, iconSize: r, isDisabled: a, isFaded: i, isPresentational: c, onPress: l, style: s, tweetLink: d, withCount: u }) {
                ...
                Y = function ({ activeColor: e, color: t, count: n, enableKeyboardShortcuts: r, iconSize: a, isDisabled: i, isFaded: c, isBookmarked: l, isPresentational: s, onError: d = I, onPress: u, style: m, testIDs: p, withCount: g }) {
                    const b = g && "number" == typeof n;
                    let f = l ? P : k;
            ...
            function le({ actionSize: e = "normal", activeColor: t, bookmarkCount: n, color: a = "gray700", displayStyle: s, enableKeyboardShortcuts: u = !0, isDisabled: m = !1, isBookmarked: p = !1, isFocalTweet: h = !1, isFromProtectedAccount: g, isLiked: b, isRetweeted: f, isPresentational: w, likeCount: y, id: E, renderAnalyticsAction: C = te, renderLikeAction: Z = ne, renderReplyAction: v = oe, renderRetweetAction: x = re, renderShareAction: k = ae, renderBookmarkAction: S = ie, replyCount: P, retweetCount: A, style: R, tweetLink: I, viewCount: D, viewState: T, withAnalytics: B = !1, withCount: W = !1, withBookmark: M = !1 }) {
                const z = o.useRef(null),
                    L = l.ZP.useProps(),
                    H = L.tweetViewCountsEnabled(),
                    F = L.testViewCountShow(),
                    N = H || F,
                    _ = B && N,
                    V = B && !_,
                    ...
                    j = o.useMemo(() => {
                        ...
                        const e = i().b03835c7,
                            ...
                            r = i().e0a8fe39,
                            a = i().c58b2ab7;
                        return (0, c.Z)([P ? e({ replyCount: P }) : null, A ? t({ retweetCount: A }) : null, f ? J : null, y ? o({ likeCount: y }) : null, b ? X : null, p && M ? ee : null, n ? r({ bookmarkCount: n }) : null, D ? a({ viewCount: D }) : null].filter(Boolean), !0);
                    }, [n, p, b, f, y, P, A, D, W, M]),
                ...
                return o.createElement(r.Z, { ref: z }, o.createElement(d, { "aria-label": j, displayStyle: s, id: E, style: R }, $, G, Q, O, q, Y, le));
            }
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~ondemand.SettingsMonetization~ondemand.SettingsSuperFollows~bundle.SuperFollowsSubscribe.8761d16a.js.map
