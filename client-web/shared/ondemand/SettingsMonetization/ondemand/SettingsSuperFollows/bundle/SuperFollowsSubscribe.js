...
(self.webpackChunk_twitter_responsive_web = self.webpackChunk_twitter_responsive_web || []).push([
    ["shared~ondemand.SettingsMonetization~ondemand.SettingsSuperFollows~bundle.SuperFollowsSubscribe"],
    {
            ...
            const v = c.default.create((e) => ({ root: { backgroundColor: e.colors.cellBackground, borderRadius: e.borderRadii.xLarge, boxShadow: e.boxShadows.medium, display: "flex", flexDirection: "row", overflow: "hidden", padding: e.spaces.space16, width: "100%" }, content: { flexGrow: 1, gap: e.spaces.space4, marginStart: e.spaces.space12 }, indicator: { alignSelf: "flex-start" } })),
                ...
                I = (e) => {
                    const { style: t, withBackgroundTweets: n, ...i } = e,
                        c = r.createElement(S, (0, o.Z)({}, i, { wordPercentWidths: A }));
                    return r.createElement(a.Z, { style: [R.root, n && R.withBackgroundTweets, t] }, n ? r.createElement(r.Fragment, null, r.createElement(a.Z, { style: R.backgroundTweets }, r.createElement(E, { wordPercentWidths: P }), r.createElement(E, { wordPercentWidths: k })), r.createElement(a.Z, { style: R.focalTweet }, c)) : c);
                };
            var D = n(783373);
            const T = s().b600eb88,
                B = s().fd75ca92,
            ...
            const k = d().da48ebf6,
                P = (e, t) => {
                    const { style: n, withVisibilityCallout: l, ...s } = e,
                        d = (0, i.D2)();
                    return r.createElement(a.Z, { style: [R.root, d && R.rootWide, n] }, r.createElement(c.ZP, { "aria-level": 2, role: "heading", size: "title4", weight: "heavy" }, k), r.createElement(S.Z, (0, o.Z)({}, s, { ref: t, style: R.description })), l && r.createElement(v, { style: R.callout }));
                },
                A = r.forwardRef(P),
                ...
                constructor(...e) {
                    super(...e),
                        ...
                        (this._renderIcon = () => {
                            ...
                            if (!u.default.theme.highContrastEnabled && !a.Z.reducedMotionEnabled && e && p) return o.createElement(d.ZP, { animation: h || m.Bf, animationContainerStyle: Z[t], animationStyle: k, onAnimationEnd: c, onAnimationStart: l, onError: s });
                            {
        ...
        721083: (e, t, n) => {
            ...
            function x({ actionMenuDescription: e, activeColor: t = "magenta500", color: n, count: i, enableActionMenu: c = !1, enableKeyboardShortcuts: m, iconSize: x, isDisabled: v, isFaded: S, isLiked: k, isPresentational: P, likeActionIconContainerRef: A, likeTransitionAnimation: R, link: I, onAnimationStart: D, onError: T = Z, onLikeActionSelect: B, onMenuCancel: W, onPress: M, style: L, testIDs: z, withCount: F }) {
                const H = F && "number" == typeof i;
                let N = k ? y : g;
                const _ = r.useMemo(() => ({ label: k ? f : g }), [k]);
                H && (N = k ? C({ count: i }) : E({ count: i }));
                ...
                })({ isLiked: k, likeTransitionAnimation: R });
        ...
        15342: (e, t, n) => {
            ...
            function v({ actionMenuDescription: e, activeColor: t = "green500", color: n, count: r, enableActionMenu: a = !1, enableKeyboardShortcuts: d, excludeRetweetAction: u, excludeRetweetWithCommentAction: m, excludeViewQuotesRetweetsAction: p, iconSize: h, isDisabled: b, isFaded: g, isPresentational: x, isRetweeted: v, onMenuCancel: S, onPress: k, onQuoteTweetActionSelect: P, onRetweetActionSelect: A, onUnretweetActionSelect: R, onViewEngagementsActionSelect: I, retweetActionSubText: D, retweetWithCommentLink: T, style: B, testIDs: W, viewQuotesRetweetsLink: M, withCount: L }) {
                const z = L && "number" == typeof r;
                let F = v ? E : w;
                z && (F = v ? Z({ count: r }) : C({ count: r }));
                const H = o.useMemo(() => ({ label: v ? y : w }), [v]),
                    ...
                    _ = o.useCallback(
                        ...
                        [e, u, m, p, v, S, P, A, R, I, D, N, T, M],
                    );
                return o.createElement(s.ZP, { ActiveIcon: i.default, Icon: c.default, activeColor: t, "aria-label": F, color: n, count: r, enableKeyboardShortcuts: d, hoverLabel: H, iconSize: h, isActive: v, isDisabled: b, isFaded: g, isPresentational: x, keyboardShortcut: l.Z.shortcuts.retweet, onPress: k, renderMenu: a ? _ : void 0, style: B, testID: v ? W?.unretweet : W?.retweet, withCount: z });
            }
        },
        990804: (e, t, n) => {
            n.d(t, { Z: () => le });
            ...
            function L({ activeColor: e, color: t, count: n, enableKeyboardShortcuts: r, iconSize: a, isDisabled: i, isFaded: c, isPresentational: l, link: s, onPress: d, renderWrapper: u, style: m, testID: p, withCount: b }) {
                const g = b && "number" == typeof n,
                    f = g ? M({ count: n }) : B;
                return o.createElement(h.ZP, { Icon: T.default, activeColor: e, "aria-label": f, color: t, count: n, enableKeyboardShortcuts: r, hoverLabel: W, iconSize: a, isDisabled: i, isFaded: c, isPresentational: l, keyboardShortcut: v.Z.shortcuts.reply, link: s, onPress: d, renderWrapper: u, style: m, testID: p, withCount: g });
            }
            const z = o.memo(L);
            var F = n(15342),
                H = n(744610),
            ...
            const G = function ({ activeColor: e, color: t, count: n, iconSize: r, isDisabled: a, isFaded: i, isPresentational: c, onPress: l, style: s, tweetLink: d, withCount: u }) {
                ...
                q = function ({ actionItems: e, actionMenuDescription: t, activeColor: n, color: r, enableKeyboardShortcuts: a, iconSize: i, isDisabled: c, isFaded: l, isPresentational: s, onMenuCancel: d, onPress: u, shouldAnimatePrompt: m, style: p, withCount: b }) {
                    ...
                    return o.createElement(H.Z.View, { style: E.current }, o.createElement(h.ZP, { Icon: V.Z, activeColor: n, "aria-label": U, color: r, enableKeyboardShortcuts: a, hoverLabel: j, iconSize: i, isDisabled: c, isFaded: l, isPresentational: s, keyboardShortcut: v.Z.shortcuts.share, onPress: u, renderMenu: l ? void 0 : f, style: p, withCount: b }));
                },
                Y = function ({ activeColor: e, color: t, count: n, enableKeyboardShortcuts: r, iconSize: a, isDisabled: i, isFaded: c, isBookmarked: l, isPresentational: s, onError: d = I, onPress: u, style: m, testIDs: p, withCount: b }) {
                    const g = b && "number" == typeof n;
                    let f = l ? P : S;
                    const w = o.useMemo(() => ({ label: l ? k : S }), [l]);
                    return (
            ...
            function le({ actionSize: e = "normal", activeColor: t, bookmarkCount: n, color: a = "gray700", displayStyle: s, enableKeyboardShortcuts: u = !0, isDisabled: m = !1, isBookmarked: p = !1, isFocalTweet: h = !1, isFromProtectedAccount: b, isLiked: g, isRetweeted: f, isPresentational: w, likeCount: y, id: E, renderAnalyticsAction: C = te, renderLikeAction: Z = ne, renderReplyAction: x = oe, renderRetweetAction: v = re, renderShareAction: S = ae, renderBookmarkAction: k = ie, replyCount: P, retweetCount: A, style: R, tweetLink: I, viewCount: D, viewState: T, withAnalytics: B = !1, withCount: W = !1, withBookmark: M = !1 }) {
                const L = o.useRef(null),
                    ...
                    $ = o.useMemo(() => x({ ...U, activeColor: t, count: P, enableKeyboardShortcuts: u, isPresentational: w, withCount: W }), [U, t, P, u, w, W, x]),
                    G = o.useMemo(() => v({ ...U, activeColor: t, count: A, enableKeyboardShortcuts: u, isFromProtectedAccount: b, isRetweeted: f, isPresentational: w, withCount: W }), [U, t, A, u, b, f, w, W, v]),
                    ...
                    q = o.useMemo(() => (M ? k({ ...U, activeColor: t, count: n, enableKeyboardShortcuts: u, isPresentational: w, isBookmarked: p, withCount: W }) : null), [M, U, t, n, u, w, p, W, k]),
                    Y = o.useMemo(() => (K ? C({ ...U, isPresentational: w, tweetLink: I }) : null), [K, U, w, I, C]),
                    le = o.useMemo(() => S({ ...U, actionItems: ce, activeColor: t, enableKeyboardShortcuts: u, isPresentational: w, withCount: W && K }), [U, t, u, w, K, W, S]);
...
//# sourceMappingURL=https://ton.local.twitter.com/responsive-web-internal/sourcemaps/client-web/shared~ondemand.SettingsMonetization~ondemand.SettingsSuperFollows~bundle.SuperFollowsSubscribe.cdb71cda.js.map
